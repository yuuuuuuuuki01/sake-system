(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function n(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=n(r);fetch(r.href,a)}})();const wa="modulepreload",ka=function(e){return"/sake-system/"+e},ct={},v=function(t,n,i){let r=Promise.resolve();if(n&&n.length>0){let d=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};var l=d;document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),c=o?.nonce||o?.getAttribute("nonce");r=d(n.map(u=>{if(u=ka(u),u in ct)return;ct[u]=!0;const p=u.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${h}`))return;const f=document.createElement("link");if(f.rel=p?"stylesheet":wa,p||(f.as="script"),f.crossOrigin="",f.href=u,c&&f.setAttribute("nonce",c),document.head.appendChild(f),p)return new Promise((x,D)=>{f.addEventListener("load",x),f.addEventListener("error",()=>D(new Error(`Unable to preload CSS for ${u}`)))})}))}function a(o){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=o,window.dispatchEvent(c),!c.defaultPrevented)throw o}return r.then(o=>{for(const c of o||[])c.status==="rejected"&&a(c.reason);return t().catch(a)})},z="https://loarwnuyvfxiscjjsmiz.supabase.co",F="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";async function Be(e,t){try{const n=new URL(`/rest/v1/${e}`,z),i=await fetch(n.toString(),{method:"POST",headers:{apikey:F,Authorization:`Bearer ${F}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(t)});if(!i.ok)throw new Error(`HTTP ${i.status}`);return(await i.json())[0]??null}catch(n){return console.warn(`Failed to insert into Supabase table ${e}`,n),null}}async function k(e,t={}){try{const n=new URL(`/rest/v1/${e}`,z);Object.entries(t).forEach(([r,a])=>{n.searchParams.set(r,a)});const i=await fetch(n.toString(),{method:"GET",headers:{apikey:F,Authorization:`Bearer ${F}`,Accept:"application/json",Prefer:"return=representation"}});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()}catch(n){return console.warn(`Failed to query Supabase table ${e}`,n),[]}}const P=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:F,SUPABASE_URL:z,supabaseInsert:Be,supabaseQuery:k},Symbol.toStringTag,{value:"Module"})),Ye="sake_auth";function Nt(e){localStorage.setItem(Ye,JSON.stringify(e))}function Tt(){return{apikey:F,"Content-Type":"application/json"}}function Sa(e){try{const[,t]=e.split(".");if(!t)return null;const n=t.replaceAll("-","+").replaceAll("_","/"),i=n.padEnd(Math.ceil(n.length/4)*4,"=");return JSON.parse(atob(i))}catch{return null}}async function jt(e,t){const n=await fetch(`${z}/auth/v1/${e}`,{method:"POST",headers:Tt(),body:JSON.stringify(t)}),i=await n.json().catch(()=>({}));if(!n.ok)throw new Error(i.error_description??i.msg??`HTTP ${n.status}`);return i}async function _a(e,t){const n=await jt("token?grant_type=password",{email:e,password:t});return Nt({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??e}}async function rt(e,t){const n=await jt("signup",{email:e,password:t});return n.access_token&&n.refresh_token&&Nt({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??e}}async function xa(){const e=Le();if(localStorage.removeItem(Ye),!!e?.access_token)try{await fetch(`${z}/auth/v1/logout`,{method:"POST",headers:{...Tt(),Authorization:`Bearer ${e.access_token}`}})}catch(t){console.warn("Supabase sign out failed",t)}}function Le(){const e=localStorage.getItem(Ye);if(!e)return null;try{const t=JSON.parse(e);return!t.access_token||!t.refresh_token?null:{access_token:t.access_token,refresh_token:t.refresh_token}}catch{return null}}function Da(){const e=Le();if(!e)return null;const t=Sa(e.access_token),n=typeof t?.email=="string"?t.email:null;return n?{email:n}:null}async function Aa(e){const t=Le();if(!t)throw new Error("not signed in");const n=await fetch(`${z}/auth/v1/user`,{method:"PUT",headers:{apikey:F,Authorization:`Bearer ${t.access_token}`,"Content-Type":"application/json"},body:JSON.stringify({password:e})});if(!n.ok){const i=await n.json().catch(()=>({}));throw new Error(i.msg??`HTTP ${n.status}`)}}const He={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
ご注文締切や納品希望日がございましたら、あわせてお知らせください。`}},Se={generatedAt:"2026-04-15T09:15:00+09:00",kpis:{todaySales:1248e3,todayDelta:8.2,monthSales:18245e3,monthDelta:5.6,unpaidCount:7,unpaidAmount:264e4},dailySales:Array.from({length:30},(e,t)=>{const n=new Date("2026-03-17T00:00:00+09:00");return n.setDate(n.getDate()+t),{date:n.toISOString(),amount:42e4+t*73123%62e4}}),salesRecords:Array.from({length:20},(e,t)=>{const n=new Date("2026-04-15T00:00:00+09:00");return n.setDate(n.getDate()-t),{id:`sale-${t+1}`,documentNo:`D${String(240100+t).padStart(6,"0")}`,date:n.toISOString(),customerCode:`C${String(t+11).padStart(4,"0")}`,customerName:["青葉商事","北斗酒販","中央フーズ","東海酒店"][t%4],amount:68e3+t%6*24500}})},Ca={generatedAt:"2026-04-15T09:15:00+09:00",records:[{id:"pay-1",customerCode:"C0011",customerName:"青葉商事",billedAmount:54e4,paymentAmount:0,balanceAmount:54e4,lastPaymentDate:null,status:"unpaid"},{id:"pay-2",customerCode:"C0012",customerName:"北斗酒販",billedAmount:72e4,paymentAmount:3e5,balanceAmount:42e4,lastPaymentDate:"2026-04-11T14:30:00+09:00",status:"partial"},{id:"pay-3",customerCode:"C0013",customerName:"中央フーズ",billedAmount:68e4,paymentAmount:68e4,balanceAmount:0,lastPaymentDate:"2026-04-14T10:00:00+09:00",status:"paid"},{id:"pay-4",customerCode:"C0014",customerName:"東海酒店",billedAmount:41e4,paymentAmount:18e4,balanceAmount:23e4,lastPaymentDate:"2026-04-10T09:10:00+09:00",status:"partial"}]},U={generatedAt:"2026-04-15T09:15:00+09:00",summary:{customerCount:164,activeCustomerCount:152,productCount:486,activeProductCount:461},customers:Array.from({length:12},(e,t)=>({id:`customer-${t+1}`,code:`C${String(t+1).padStart(4,"0")}`,name:["青葉商事","北斗酒販","中央フーズ","東海酒店","三和物産","南星リカー"][t%6],closingDay:[15,20,25,31][t%4],paymentDay:[5,10,15,20][t%4],isActive:t%5!==0})),products:Array.from({length:12},(e,t)=>({id:`product-${t+1}`,code:`P${String(t+1).padStart(5,"0")}`,janCode:`4901234567${String(t).padStart(3,"0")}`,name:["純米吟醸 720ml","本醸造 1.8L","特別純米 300ml","梅酒 500ml"][t%4],category:["清酒","焼酎","リキュール"][t%3],isActive:t%6!==0}))},Ea={generatedAt:"2026-04-15T09:15:00+09:00",lastSyncAt:"2026-04-15T09:12:21+09:00",status:"success",jobName:"daily-sync",message:"同期完了。売上・入金・マスタを最新化しました。"},Ot=Se.salesRecords.map((e,t)=>({...e,itemCount:t%4+1})),La={C0011:{customerCode:"C0011",customerName:"青葉商事",balanceAmount:54e4,salesTotal:114e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-1",date:"2026-04-15T00:00:00+09:00",documentNo:"D240100",amount:42e4},{id:"ledger-sale-2",date:"2026-04-08T00:00:00+09:00",documentNo:"D240087",amount:39e4},{id:"ledger-sale-3",date:"2026-03-28T00:00:00+09:00",documentNo:"D240059",amount:33e4}],paymentHistory:[{id:"ledger-payment-1",date:"2026-04-10T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-2",date:"2026-03-31T00:00:00+09:00",amount:3e5,method:"振込"}]},C0012:{customerCode:"C0012",customerName:"北斗酒販",balanceAmount:42e4,salesTotal:102e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-4",date:"2026-04-14T00:00:00+09:00",documentNo:"D240101",amount:36e4},{id:"ledger-sale-5",date:"2026-04-05T00:00:00+09:00",documentNo:"D240082",amount:32e4},{id:"ledger-sale-6",date:"2026-03-25T00:00:00+09:00",documentNo:"D240054",amount:34e4}],paymentHistory:[{id:"ledger-payment-3",date:"2026-04-11T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-4",date:"2026-03-30T00:00:00+09:00",amount:3e5,method:"現金"}]}},_e={productTotals:[{code:"P00001",name:"純米吟醸 720ml",amount:584e4,quantity:820,documents:148},{code:"P00002",name:"本醸造 1.8L",amount:498e4,quantity:610,documents:131},{code:"P00003",name:"特別純米 300ml",amount:356e4,quantity:1240,documents:112},{code:"P00004",name:"梅酒 500ml",amount:287e4,quantity:540,documents:89}],customerTotals:[{code:"C0011",name:"青葉商事",amount:462e4,quantity:320,documents:54},{code:"C0012",name:"北斗酒販",amount:438e4,quantity:294,documents:49},{code:"C0013",name:"中央フーズ",amount:391e4,quantity:276,documents:45},{code:"C0014",name:"東海酒店",amount:324e4,quantity:221,documents:37}]};function A(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e=="string"){const t=Number(e);return Number.isFinite(t)?t:0}return 0}function Pa(e){switch((e??"").toLowerCase()){case"paid":case"complete":case"completed":return"paid";case"partial":case"partially_paid":case"partially paid":return"partial";default:return"unpaid"}}function Ia(e){return typeof e=="boolean"?e:typeof e=="number"?e!==0:typeof e=="string"?["true","1","active","enabled","yes","y"].includes(e.toLowerCase()):!1}function y(e,t,n=""){for(const i of t){const r=e[i];if(typeof r=="string"&&r.length>0)return r}return n}function dt(e,t,n=0){for(const i of t)if(i in e)return A(e[i]);return n}function j(e,t,n=!0){for(const i of t)if(i in e)return Ia(e[i]);return n}function Rt(e,t,n){for(const i of t){const r=e[i];if(typeof r!="string"||r.length===0)continue;if(/^\d{4}-\d{2}-\d{2}$/.test(r))return new Date(`${r}T00:00:00Z`).toISOString();const a=new Date(r);if(!Number.isNaN(a.getTime()))return a.toISOString()}return n}function qt(e){return e.slice(0,7)}function Xe(e,t){return{id:String(e.id??`invoice-${t+1}`),documentNo:e.document_no??e.legacy_document_no??`D${String(240100+t).padStart(6,"0")}`,date:Rt(e,["sales_date","document_date"],new Date().toISOString()),customerCode:e.customer_code??e.legacy_customer_code??`C${String(t+1).padStart(4,"0")}`,customerName:e.customer_name??e.customer_code??e.legacy_customer_code??"不明",itemCount:0,amount:A(e.total_amount??e.billed_amount)}}function ut(e,t){const n=t.startDate?new Date(`${t.startDate}T00:00:00`):null,i=t.endDate?new Date(`${t.endDate}T23:59:59`):null,r=t.documentNo.trim().toLowerCase(),a=t.customerCode.trim().toLowerCase();return e.filter(l=>{const o=new Date(l.date);return!(n&&o<n||i&&o>i||r&&!l.documentNo.toLowerCase().includes(r)||a&&!l.customerCode.toLowerCase().includes(a))}).sort((l,o)=>new Date(o.date).getTime()-new Date(l.date).getTime())}function pt(e){const t=e.trim().toUpperCase(),n=La[t];if(n)return n;const i=Se.salesRecords.find(r=>r.customerCode.toUpperCase()===t);return{customerCode:t||"未指定",customerName:i?.customerName??"該当得意先なし",balanceAmount:0,salesTotal:0,paymentTotal:0,salesHistory:[],paymentHistory:[]}}function Na(){const e=new Map,t=new Map,n=new Map;return Ot.forEach((i,r)=>{const a=qt(i.date);e.set(a,(e.get(a)??0)+i.amount);const l=t.get(i.customerCode)??{code:i.customerCode,name:i.customerName,amount:0,quantity:0,documents:0};l.amount+=i.amount,l.quantity+=i.itemCount,l.documents+=1,t.set(i.customerCode,l);const o=`P${String(r%4+1).padStart(5,"0")}`,c=_e.productTotals[r%_e.productTotals.length],d=n.get(o)??{code:o,name:c?.name??`商品${r+1}`,amount:0,quantity:0,documents:0};d.amount+=i.amount,d.quantity+=i.itemCount*12,d.documents+=1,n.set(o,d)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(e.entries()).sort(([i],[r])=>i.localeCompare(r)).map(([i,r])=>({month:i,amount:r})),productTotals:Array.from(n.values()).sort((i,r)=>r.amount-i.amount),customerTotals:Array.from(t.values()).sort((i,r)=>r.amount-i.amount)}}async function L(e,t){try{const n=await fetch(`/sake-system/${e}`,{headers:{Accept:"application/json"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(n){return console.warn(`Failed to fetch ${e}, using fallback data`,n),t}}async function Mt(){const e=await k("daily_sales_fact",{select:"sales_date,sales_amount,document_count",order:"sales_date.desc",limit:"60"});if(e.length>0){const t=await k("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"}),i=new Date().toISOString().slice(0,10),r=i.slice(0,7),a=[...e].sort((d,u)=>d.sales_date.localeCompare(u.sales_date)).slice(-30).map(d=>({date:new Date(`${d.sales_date}T00:00:00Z`).toISOString(),amount:A(d.sales_amount)})),l=e.reduce((d,u)=>u.sales_date===i?d+A(u.sales_amount):d,0),o=e.reduce((d,u)=>u.sales_date.startsWith(r)?d+A(u.sales_amount):d,0),c=t.filter(d=>A(d.balance_amount)>0);return{generatedAt:new Date().toISOString(),kpis:{todaySales:l,todayDelta:0,monthSales:o,monthDelta:0,unpaidCount:c.length,unpaidAmount:c.reduce((d,u)=>d+A(u.balance_amount),0)},dailySales:a,salesRecords:Se.salesRecords}}return L("data/api/latest/sales-summary.json",Se)}async function Ft(){const e=await k("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"});return e.length>0?{generatedAt:new Date().toISOString(),records:e.map((t,n)=>{const i=t.legacy_customer_code??`UNKNOWN-${n+1}`;return{id:`payment-${i}-${n+1}`,customerCode:i,customerName:i,billedAmount:A(t.billed_amount),paymentAmount:A(t.paid_amount),balanceAmount:A(t.balance_amount),lastPaymentDate:null,status:Pa(t.payment_status)}})}:L("data/api/latest/payment-status.json",Ca)}async function zt(){const[e,t]=await Promise.all([k("customers"),k("products")]);if(e.length>0||t.length>0){const n=e.length?e.map((r,a)=>({id:y(r,["id","customer_id","code"],`customer-${a+1}`),code:y(r,["code","customer_code","legacy_customer_code"],`C${String(a+1).padStart(4,"0")}`),name:y(r,["name","customer_name","display_name"],`Customer ${a+1}`),closingDay:dt(r,["closing_day","close_day"],31),paymentDay:dt(r,["payment_day","due_day"],15),isActive:j(r,["is_active","active","enabled"],!0)})):U.customers,i=t.length?t.map((r,a)=>({id:y(r,["id","product_id","code"],`product-${a+1}`),code:y(r,["code","product_code"],`P${String(a+1).padStart(5,"0")}`),janCode:y(r,["jan_code","jan","barcode"],""),name:y(r,["name","product_name","display_name"],`Product ${a+1}`),category:y(r,["category","category_name"],"未分類"),isActive:j(r,["is_active","active","enabled"],!0)})):U.products;return{generatedAt:new Date().toISOString(),summary:{customerCount:e.length||U.summary.customerCount,activeCustomerCount:e.length?n.filter(r=>r.isActive).length:U.summary.activeCustomerCount,productCount:t.length||U.summary.productCount,activeProductCount:t.length?i.filter(r=>r.isActive).length:U.summary.activeProductCount},customers:n,products:i}}return L("data/api/latest/master-stats.json",U)}function Jt(){return L("data/api/latest/pipeline-meta.json",Ea)}async function xe(e){const[t,n]=await Promise.all([k("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,document_date,customer_code,legacy_customer_code,customer_name,total_amount,billed_amount",order:"sales_date.desc",limit:"200"}),k("sales_document_lines",{select:"id,header_id,document_header_id,document_no,amount,line_amount"})]);if(t.length>0){const i=new Map;n.forEach(a=>{const l=String(a.header_id??a.document_header_id??a.document_no??a.id??"");l&&i.set(l,(i.get(l)??0)+1)});const r=t.map((a,l)=>{const o=Xe(a,l),c=String(a.id??a.document_no??a.legacy_document_no??"");return{...o,itemCount:i.get(c)??o.itemCount}});return ut(r,e)}return ut(Ot,e)}async function Qe(e){const t=e.trim().toUpperCase();if(!t)return pt("");const[n,i,r]=await Promise.all([k("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,document_date,customer_code,legacy_customer_code,customer_name,total_amount,billed_amount",or:`customer_code.eq.${t},legacy_customer_code.eq.${t}`,order:"sales_date.desc",limit:"50"}),k("customer_payments",{select:"id,customer_code,legacy_customer_code,payment_date,received_date,amount,payment_amount,method,payment_method",or:`customer_code.eq.${t},legacy_customer_code.eq.${t}`,order:"payment_date.desc",limit:"50"}),k("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"})]);if(n.length>0||i.length>0){const a=n.map((c,d)=>{const u=Xe(c,d);return{id:u.id,date:u.date,documentNo:u.documentNo,amount:u.amount}}),l=i.map((c,d)=>({id:String(c.id??`payment-${d+1}`),date:Rt(c,["payment_date","received_date"],new Date().toISOString()),amount:A(c.payment_amount??c.amount),method:c.payment_method??c.method??"入金"})),o=r.find(c=>(c.legacy_customer_code??"").toUpperCase()===t);return{customerCode:t,customerName:n[0]?.customer_name??n[0]?.customer_code??n[0]?.legacy_customer_code??t,balanceAmount:A(o?.balance_amount),salesTotal:a.reduce((c,d)=>c+d.amount,0),paymentTotal:l.reduce((c,d)=>c+d.amount,0),salesHistory:a,paymentHistory:l}}return pt(t)}async function Vt(){const[e,t,n]=await Promise.all([k("daily_sales_fact",{select:"sales_date,sales_amount",order:"sales_date.asc",limit:"365"}),k("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,document_date,customer_code,legacy_customer_code,customer_name,total_amount,billed_amount",limit:"500"}),k("sales_document_lines",{select:"id,header_id,document_header_id,document_no,product_code,legacy_product_code,product_name,quantity,amount,line_amount",limit:"1000"})]);if(e.length>0){const i=new Map;e.forEach(l=>{const o=qt(l.sales_date);i.set(o,(i.get(o)??0)+A(l.sales_amount))});const r=new Map;t.forEach((l,o)=>{const c=Xe(l,o),d=r.get(c.customerCode)??{code:c.customerCode,name:c.customerName,amount:0,quantity:0,documents:0};d.amount+=c.amount,d.documents+=1,r.set(c.customerCode,d)});const a=new Map;return n.forEach((l,o)=>{const c=l.product_code??l.legacy_product_code??`P${String(o+1).padStart(5,"0")}`,d=a.get(c)??{code:c,name:l.product_name??c,amount:0,quantity:0,documents:0};d.amount+=A(l.line_amount??l.amount),d.quantity+=A(l.quantity),d.documents+=1,a.set(c,d)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(i.entries()).sort(([l],[o])=>l.localeCompare(o)).map(([l,o])=>({month:l,amount:o})).slice(-12),productTotals:a.size>0?Array.from(a.values()).sort((l,o)=>o.amount-l.amount):_e.productTotals,customerTotals:r.size>0?Array.from(r.values()).sort((l,o)=>o.amount-l.amount):_e.customerTotals}}return Na()}const ze={sales:"売上",return:"返品",export_return:"輸出戻入"};async function Ut(e){const t=e.lines.reduce((r,a)=>r+a.amount,0),n=`D${Date.now().toString().slice(-6)}`;return{id:(await Be("sales_document_headers",{legacy_document_no:n,legacy_customer_code:e.customerCode,sales_date:e.invoiceDate,document_type:e.invoiceType,staff_code:e.staffCode,total_amount:t,status:"confirmed"}))?.id??`local-${n}`,documentNo:n,totalAmount:t,status:"confirmed",createdAt:new Date().toISOString()}}const mt={documentNo:"D240122",invoiceDate:"2026-04-14",customerCode:"C0011",customerName:"青葉商事 株式会社",customerAddress:"〒123-4567 東京都千代田区〇〇 1-2-3",lines:[{productCode:"P00012",productName:"純米吟醸 720ml",quantity:6,unitPrice:12e3,unit:"本",amount:72e3},{productCode:"P00008",productName:"本醸造 1.8L",quantity:4,unitPrice:8500,unit:"本",amount:34e3},{productCode:"P00021",productName:"梅酒 500ml",quantity:12,unitPrice:5800,unit:"本",amount:69600}],totalAmount:175600,taxAmount:15960,note:""};async function Ke(e){const t=await k("sales_document_headers",{select:"*",legacy_document_no:`eq.${e}`});if(t.length>0){const n=t[0],i=A(n.total_amount);return{documentNo:e,invoiceDate:y(n,["sales_date","document_date"],""),customerCode:y(n,["legacy_customer_code","customer_code"],""),customerName:y(n,["customer_name","legacy_customer_code"],""),customerAddress:"",lines:[],totalAmount:i,taxAmount:Math.floor(i*10/110),note:""}}return{...mt,documentNo:e||mt.documentNo}}const Ta={targetYearMonth:"2026-04",closingDay:15,totalBilling:482e4,customers:[{customerCode:"C0011",customerName:"青葉商事",closingDay:15,salesAmount:54e4,taxAmount:54e3,prevBalance:28e4,paymentAmount:28e4,billingAmount:594e3,status:"open"},{customerCode:"C0012",customerName:"北斗酒販",closingDay:15,salesAmount:72e4,taxAmount:72e3,prevBalance:14e4,paymentAmount:14e4,billingAmount:792e3,status:"closed"},{customerCode:"C0013",customerName:"中央フーズ",closingDay:15,salesAmount:38e4,taxAmount:38e3,prevBalance:0,paymentAmount:0,billingAmount:418e3,status:"open"},{customerCode:"C0014",customerName:"東海酒店",closingDay:15,salesAmount:61e4,taxAmount:61e3,prevBalance:23e4,paymentAmount:15e4,billingAmount:751e3,status:"open"}]};async function We(e){return L(`data/api/latest/billing-${e}.json`,{...Ta,targetYearMonth:e})}const ja=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],Oa={generatedAt:new Date().toISOString(),months:ja,salesByProduct:[{label:"純米吟醸 720ml",values:[380,410,520,480,390,320,450,480,510,420,380,350].map(e=>e*1e4)},{label:"本醸造 1.8L",values:[290,310,380,340,280,250,320,360,390,310,280,260].map(e=>e*1e4)},{label:"梅酒 500ml",values:[210,240,310,290,230,180,260,300,320,250,200,190].map(e=>e*1e4)}],salesByCustomer:[{label:"青葉商事",values:[480,510,620,590,480,390,540,580,610,510,460,430].map(e=>e*1e4)},{label:"北斗酒販",values:[390,420,520,490,400,330,460,500,530,430,380,360].map(e=>e*1e4)}],costSimulation:[{productCode:"P00012",productName:"純米吟醸 720ml",costPrice:7200,sellPrice:12e3,margin:4800,marginRate:40},{productCode:"P00008",productName:"本醸造 1.8L",costPrice:4800,sellPrice:8500,margin:3700,marginRate:43.5},{productCode:"P00021",productName:"梅酒 500ml",costPrice:3200,sellPrice:5800,margin:2600,marginRate:44.8}]};async function Bt(){return L("data/api/latest/sales-report.json",Oa)}const Yt={planned:"計画中",active:"仕込中",done:"完了"},Ra=[{id:"j1",jikomiNo:"J2026-01",productName:"純米吟醸",riceType:"山田錦",plannedKg:400,actualKg:400,startDate:"2026-01-10",expectedDoneDate:"2026-02-20",status:"done",tankNo:"T01",note:""},{id:"j2",jikomiNo:"J2026-02",productName:"本醸造",riceType:"日本晴",plannedKg:600,actualKg:600,startDate:"2026-02-01",expectedDoneDate:"2026-03-15",status:"done",tankNo:"T02",note:""},{id:"j3",jikomiNo:"J2026-03",productName:"特別純米",riceType:"五百万石",plannedKg:500,actualKg:480,startDate:"2026-03-05",expectedDoneDate:"2026-04-20",status:"active",tankNo:"T03",note:"経過良好"},{id:"j4",jikomiNo:"J2026-04",productName:"純米大吟醸",riceType:"山田錦",plannedKg:300,actualKg:0,startDate:"2026-04-15",expectedDoneDate:"2026-06-01",status:"planned",tankNo:"T04",note:""}];async function Ht(){return L("data/api/latest/jikomi.json",Ra)}const qa=[{id:"t1",tankNo:"T01",capacity:3e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-01"},{id:"t2",tankNo:"T02",capacity:4e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-20"},{id:"t3",tankNo:"T03",capacity:3500,currentVolume:2800,productName:"特別純米",jikomiNo:"J2026-03",status:"in_use",lastUpdated:"2026-04-10"},{id:"t4",tankNo:"T04",capacity:2e3,currentVolume:0,productName:"純米大吟醸",jikomiNo:"J2026-04",status:"in_use",lastUpdated:"2026-04-15"},{id:"t5",tankNo:"T05",capacity:5e3,currentVolume:3200,productName:"本醸造（貯蔵）",jikomiNo:"J2026-02",status:"aging",lastUpdated:"2026-03-20"}];async function Xt(){return L("data/api/latest/tanks.json",qa)}const Ma=[{id:"k1",kenteiNo:"K2026-001",jikomiNo:"J2026-01",productName:"純米吟醸",kenteiDate:"2026-02-25",alcoholDegree:16.2,extractDegree:3.8,sakaMeterValue:2.5,volume:2850,taxCategory:"清酒",status:"approved"},{id:"k2",kenteiNo:"K2026-002",jikomiNo:"J2026-02",productName:"本醸造",kenteiDate:"2026-03-18",alcoholDegree:15.5,extractDegree:4.1,sakaMeterValue:1.8,volume:3600,taxCategory:"清酒",status:"submitted"},{id:"k3",kenteiNo:"K2026-003",jikomiNo:"J2026-03",productName:"特別純米",kenteiDate:"2026-04-18",alcoholDegree:0,extractDegree:0,sakaMeterValue:0,volume:0,taxCategory:"清酒",status:"pending"}];async function Qt(){return L("data/api/latest/kentei.json",Ma)}const Fa=[{id:"m1",code:"M001",name:"720ml瓶",unit:"本",currentStock:2400,minimumStock:500,unitCost:85,lastUpdated:"2026-04-10"},{id:"m2",code:"M002",name:"1.8L瓶",unit:"本",currentStock:1800,minimumStock:300,unitCost:140,lastUpdated:"2026-04-10"},{id:"m3",code:"M003",name:"300ml瓶",unit:"本",currentStock:3600,minimumStock:600,unitCost:55,lastUpdated:"2026-04-08"},{id:"m4",code:"M004",name:"キャップ（金）",unit:"個",currentStock:8e3,minimumStock:1e3,unitCost:12,lastUpdated:"2026-04-05"},{id:"m5",code:"M005",name:"ラベル（純米吟醸）",unit:"枚",currentStock:1200,minimumStock:300,unitCost:28,lastUpdated:"2026-04-01"},{id:"m6",code:"M006",name:"化粧箱（720ml）",unit:"個",currentStock:180,minimumStock:100,unitCost:320,lastUpdated:"2026-04-01"}];async function Je(){return L("data/api/latest/materials.json",Fa)}const za=[{id:"p1",documentNo:"K240050",purchaseDate:"2026-04-05",supplierCode:"S001",supplierName:"山田農場",itemName:"山田錦（精米65%）",quantity:500,unitPrice:480,amount:24e4,status:"confirmed"},{id:"p2",documentNo:"K240051",purchaseDate:"2026-04-06",supplierCode:"S002",supplierName:"日本瓶工業",itemName:"720ml瓶",quantity:1200,unitPrice:85,amount:102e3,status:"confirmed"},{id:"p3",documentNo:"K240052",purchaseDate:"2026-04-10",supplierCode:"S003",supplierName:"山本麹店",itemName:"米麹",quantity:80,unitPrice:1200,amount:96e3,status:"pending"},{id:"p4",documentNo:"K240053",purchaseDate:"2026-04-12",supplierCode:"S001",supplierName:"山田農場",itemName:"五百万石（精米60%）",quantity:300,unitPrice:420,amount:126e3,status:"pending"}],Ja=[{supplierCode:"S001",supplierName:"山田農場",totalPurchase:366e3,paidAmount:24e4,balance:126e3,nextPaymentDate:"2026-04-30",status:"partial"},{supplierCode:"S002",supplierName:"日本瓶工業",totalPurchase:102e3,paidAmount:102e3,balance:0,nextPaymentDate:"",status:"paid"},{supplierCode:"S003",supplierName:"山本麹店",totalPurchase:96e3,paidAmount:0,balance:96e3,nextPaymentDate:"2026-04-30",status:"unpaid"}],Va=[{id:"b1",billNo:"H240001",supplierName:"山田農場",amount:24e4,issueDate:"2026-03-31",dueDate:"2026-04-30",status:"holding"},{id:"b2",billNo:"H240002",supplierName:"大阪資材",amount:185e3,issueDate:"2026-03-31",dueDate:"2026-05-31",status:"holding"},{id:"b3",billNo:"H230045",supplierName:"中部農業",amount:32e4,issueDate:"2026-02-28",dueDate:"2026-03-31",status:"cleared"}],Ua=[{code:"R001",name:"山田錦（精米65%）",unit:"kg",currentStock:380,minimumStock:100,lastPurchaseDate:"2026-04-05",unitCost:480},{code:"R002",name:"五百万石（精米60%）",unit:"kg",currentStock:290,minimumStock:100,lastPurchaseDate:"2026-04-12",unitCost:420},{code:"R003",name:"米麹",unit:"kg",currentStock:62,minimumStock:20,lastPurchaseDate:"2026-04-10",unitCost:1200},{code:"R004",name:"醸造用アルコール",unit:"L",currentStock:240,minimumStock:50,lastPurchaseDate:"2026-03-20",unitCost:180},{code:"R005",name:"清酒用酵母",unit:"g",currentStock:500,minimumStock:100,lastPurchaseDate:"2026-02-15",unitCost:3200}];async function Kt(){return L("data/api/latest/purchases.json",za)}async function Wt(){return L("data/api/latest/payables.json",Ja)}async function Gt(){return L("data/api/latest/bills.json",Va)}async function Zt(){return L("data/api/latest/raw-stock.json",Ua)}const ea=[{code:"01",name:"清酒（普通酒）",taxRatePerLiter:100},{code:"02",name:"清酒（純米酒）",taxRatePerLiter:100},{code:"03",name:"清酒（吟醸酒）",taxRatePerLiter:100},{code:"04",name:"清酒（大吟醸酒）",taxRatePerLiter:100},{code:"05",name:"本格焼酎",taxRatePerLiter:250},{code:"06",name:"リキュール",taxRatePerLiter:200},{code:"07",name:"果実酒",taxRatePerLiter:100},{code:"08",name:"その他醸造酒",taxRatePerLiter:100}],Ve={export:"輸出",sample:"見本",research:"試験醸造",loss:"欠減"},Ba={targetYear:2026,targetMonth:3,companyName:"金井酒造店",companyNo:"1234567890123",companyAddress:"神奈川県秦野市堀山下182",companyRepresentative:"金井 和雄",taxOffice:"小田原税務署",rows:[{taxCategory:"01",taxCategoryName:"清酒（普通酒）",alcoholDegree:15.5,productionVolume:3800,previousBalance:0,currentAdjustment:0,exportDeduction:100,sampleDeduction:100,taxableVolume:3600,volume:3600,taxRate:100,taxAmount:36e4},{taxCategory:"02",taxCategoryName:"清酒（純米酒）",alcoholDegree:16.2,productionVolume:2900,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:50,taxableVolume:2850,volume:2850,taxRate:100,taxAmount:285e3},{taxCategory:"03",taxCategoryName:"清酒（吟醸酒）",alcoholDegree:16.5,productionVolume:1250,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:50,taxableVolume:1200,volume:1200,taxRate:100,taxAmount:12e4}],deductions:[{type:"export",categoryCode:"01",volume:100,reason:"シンガポール向け輸出",documentNo:"EX2026-003"},{type:"sample",categoryCode:"01",volume:100,reason:"展示会サンプル出荷"},{type:"sample",categoryCode:"02",volume:50,reason:"品評会出品"},{type:"sample",categoryCode:"03",volume:50,reason:"全国新酒鑑評会出品"}],totalVolume:7650,totalTax:765e3,status:"draft",submittedAt:null};async function Ge(e,t){return L(`data/api/latest/tax-${e}-${String(t).padStart(2,"0")}.json`,{...Ba,targetYear:e,targetMonth:t})}function O(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;")}function ta(e){const t=e.rows.map(i=>`    <Category>
      <Code>${O(i.taxCategory)}</Code>
      <Name>${O(i.taxCategoryName)}</Name>
...
`),n=e.deductions.map(i=>`    <Deduction type="${O(i.type)}">
      <CategoryCode>${O(i.categoryCode)}</CategoryCode>
      <Volume>${i.volume}</Volume>
      <Reason>${O(i.reason)}</Reason>${i.documentNo?`
      <DocumentNo>${O(i.documentNo)}</DocumentNo>`:""}
    </Deduction>`).join(`
...
<TaxDeclaration>
  <Header>
    ...
    <TaxpayerId>${O(e.companyNo)}</TaxpayerId>
    <TaxpayerName>${O(e.companyName)}</TaxpayerName>
    <TaxpayerAddress>${O(e.companyAddress)}</TaxpayerAddress>
    <TaxpayerRepresentative>${O(e.companyRepresentative)}</TaxpayerRepresentative>
    <TaxOffice>${O(e.taxOffice)}</TaxOffice>
...
`}function Ya(e){const t=String(e);return/[,"\n]/.test(t)?`"${t.replaceAll('"','""')}"`:t}function Ha(e){const n=["酒類コード","区分名","アルコール度数","製造数量","前月繰越","当月調整","輸出控除","見本等控除","課税数量","税率(円/L)","税額(円)"].join(","),i=e.rows.map(a=>[a.taxCategory,a.taxCategoryName,a.alcoholDegree,a.productionVolume,a.previousBalance,a.currentAdjustment,a.exportDeduction,a.sampleDeduction,a.taxableVolume,a.taxRate,a.taxAmount].map(Ya).join(",")),r=`,合計,,${e.rows.reduce((a,l)=>a+l.productionVolume,0)},,,${e.rows.reduce((a,l)=>a+l.exportDeduction,0)},${e.rows.reduce((a,l)=>a+l.sampleDeduction,0)},${e.totalVolume},,${e.totalTax}`;return"\uFEFF"+[n,...i,r].join(`
`)+`
`}function Xa(e){const t=e.rows.map(r=>{const a=Math.max(0,r.productionVolume+r.previousBalance+r.currentAdjustment-r.exportDeduction-r.sampleDeduction),l=Math.round(a*r.taxRate);return{...r,taxableVolume:a,volume:a,taxAmount:l}}),n=t.reduce((r,a)=>r+a.taxableVolume,0),i=t.reduce((r,a)=>r+a.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:i}}async function Qa(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>P);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:ta(e),submitted_at:e.submittedAt})}const Ka=Array.from({length:10},(e,t)=>({id:`ss${t+1}`,saleDate:"2026-04-15",saleTime:`${9+t}:${String(t*7%60).padStart(2,"0")}`,productCode:`P${String(t%4+1).padStart(5,"0")}`,productName:["純米吟醸 720ml","本醸造 1.8L","梅酒 500ml","特別純米 300ml"][t%4],quantity:1+t%3,unitPrice:[2200,1800,980,680][t%4],amount:(1+t%3)*[2200,1800,980,680][t%4],paymentMethod:["cash","card","paypay","cash"][t%4]})),Wa=[{id:"o1",orderNo:"ORD-2604001",orderDate:"2026-04-13",customerName:"鈴木 太郎",postalCode:"150-0001",address:"東京都渋谷区〇〇1-1",items:[{productName:"純米吟醸 720ml",quantity:2,amount:4400}],totalAmount:4400,status:"shipped",shippingDate:"2026-04-14"},{id:"o2",orderNo:"ORD-2604002",orderDate:"2026-04-14",customerName:"田中 花子",postalCode:"530-0001",address:"大阪府大阪市北区〇〇2-3",items:[{productName:"梅酒 500ml",quantity:3,amount:2940},{productName:"本醸造 1.8L",quantity:1,amount:1800}],totalAmount:4740,status:"processing",shippingDate:""},{id:"o3",orderNo:"ORD-2604003",orderDate:"2026-04-15",customerName:"佐藤 一郎",postalCode:"460-0001",address:"愛知県名古屋市中区〇〇3-5",items:[{productName:"特別純米 300ml ×6本セット",quantity:1,amount:3980}],totalAmount:3980,status:"new",shippingDate:""}];async function Ze(e){return L(`data/api/latest/store-sales-${e}.json`,Ka)}async function aa(){return L("data/api/latest/store-orders.json",Wa)}async function ke(e){const t=await Be("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function sa(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function Ga(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await k("print_layouts",t)).map(i=>({id:y(i,["id"],""),name:y(i,["name"],""),templateKey:y(i,["template_key"],""),positions:i.positions??{},isDefault:j(i,["is_default"],!1),note:y(i,["note"],""),updatedAt:y(i,["updated_at"],"")}))}async function Za(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:r}=await Promise.resolve().then(()=>P);return{supabaseInsert:r}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},i=await t("print_layouts",n);return i?{id:y(i,["id"],e.id),name:y(i,["name"],e.name),templateKey:y(i,["template_key"],e.templateKey),positions:i.positions??e.positions,isDefault:j(i,["is_default"],!1),note:y(i,["note"],""),updatedAt:y(i,["updated_at"],"")}:null}async function es(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function ts(){return(await k("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:y(t,["id"],""),name:y(t,["name"],""),email:y(t,["email"],""),displayName:y(t,["display_name"],""),signature:y(t,["signature"],""),replyTo:y(t,["reply_to"],""),isDefault:j(t,["is_default"],!1),isVerified:j(t,["is_verified"],!1),note:y(t,["note"],"")}))}async function as(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:y(n,["id"],e.id),name:y(n,["name"],e.name),email:y(n,["email"],e.email),displayName:y(n,["display_name"],""),signature:y(n,["signature"],""),replyTo:y(n,["reply_to"],""),isDefault:j(n,["is_default"],!1),isVerified:j(n,["is_verified"],!1)}:null}async function ss(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const et={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},tt={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function ns(e){const t=`${e}-01T00:00:00Z`,[n,i]=e.split("-").map(o=>parseInt(o,10)),r=new Date(n,i,0).getDate(),a=`${e}-${String(r).padStart(2,"0")}T23:59:59Z`;return(await k("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${a})`,order:"starts_at.asc"})).map(o=>({id:y(o,["id"],""),title:y(o,["title"],""),description:y(o,["description"],""),category:y(o,["category"],"general")||"general",startsAt:y(o,["starts_at"],new Date().toISOString()),endsAt:y(o,["ends_at"],""),isAllDay:j(o,["is_all_day"],!1),location:y(o,["location"],""),attendees:o.attendees??[],relatedCustomerCode:y(o,["related_customer_code"],""),relatedOrderId:y(o,["related_order_id"],""),color:y(o,["color"],""),googleEventId:y(o,["google_event_id"],"")}))}async function is(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??tt[e.category],updated_at:new Date().toISOString()})?e:null}async function ls(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function na(){return(await k("integration_settings",{order:"name.asc"})).map(t=>({id:y(t,["id"],""),name:y(t,["name"],""),provider:y(t,["provider"],""),config:t.config??{},isEnabled:j(t,["is_enabled"],!1),lastSyncAt:y(t,["last_sync_at"],""),lastStatus:y(t,["last_status"],"")}))}async function at(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function os(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const i=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,r=await fetch(i,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const a=await r.json(),{supabaseInsert:l}=await v(async()=>{const{supabaseInsert:c}=await Promise.resolve().then(()=>P);return{supabaseInsert:c}},void 0);let o=0;for(const c of a.orders){const d=`shopify_${c.id}`;await l("shopify_orders",{id:d,shopify_order_id:String(c.id),order_number:String(c.order_number??""),order_date:String(c.created_at??new Date().toISOString()),customer_name:String(c.customer?.first_name??"")+" "+String(c.customer?.last_name??""),customer_email:String(c.customer?.email??""),total_amount:Math.round(parseFloat(String(c.total_price??"0"))),financial_status:String(c.financial_status??""),fulfillment_status:String(c.fulfillment_status??"unfulfilled"),line_items:c.line_items??[],shipping_address:c.shipping_address??null,raw_payload:c}),o++}return await at({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${o}件取得成功`}),{count:o}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function cs(){return(await k("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:y(t,["id"],""),shopifyOrderId:y(t,["shopify_order_id"],""),orderNumber:y(t,["order_number"],""),orderDate:y(t,["order_date"],""),customerName:y(t,["customer_name"],""),customerEmail:y(t,["customer_email"],""),totalAmount:A(t.total_amount),financialStatus:y(t,["financial_status"],""),fulfillmentStatus:y(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function rs(e){const t=e.config.oauth_token,n=e.config.calendar_id||"primary";if(!t)return{count:0,error:"oauth_token を設定してください (Google Cloud Console で取得)"};try{const i=new Date().toISOString(),r=new Date(Date.now()+30*86400*1e3).toISOString(),a=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${i}&timeMax=${r}&singleEvents=true&orderBy=startTime`,l=await fetch(a,{headers:{Authorization:`Bearer ${t}`}});if(!l.ok)return{count:0,error:`HTTP ${l.status}`};const o=await l.json(),{supabaseInsert:c}=await v(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>P);return{supabaseInsert:u}},void 0);let d=0;for(const u of o.items){const p=`gcal_${u.id}`,h=u.start?.dateTime??u.start?.date??"",f=u.end?.dateTime??u.end?.date??"";await c("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(h),ends_at:String(f),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),d++}return await at({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${d}件取得`}),{count:d}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function ds(){return(await k("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:y(t,["id"],""),receivedAt:y(t,["received_at"],""),senderPhone:y(t,["sender_phone"],""),senderName:y(t,["sender_name"],""),imageUrl:y(t,["image_url"],""),ocrStatus:y(t,["ocr_status"],"pending")||"pending",ocrText:y(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:y(t,["linked_invoice_id"],"")}))}async function us(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const i=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,r=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return r.ok?{text:(await r.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${r.status}`}}catch(i){return{text:"",error:i instanceof Error?i.message:String(i)}}}async function ps(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const De={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Ae={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function ms(){return(await k("user_profiles",{order:"display_name.asc"})).map(t=>({id:y(t,["id"],""),email:y(t,["email"],""),displayName:y(t,["display_name"],""),staffCode:y(t,["staff_code"],""),department:y(t,["department"],"all")||"all",role:y(t,["role"],"staff")||"staff",defaultMailSenderId:y(t,["default_mail_sender_id"],""),phone:y(t,["phone"],""),avatarUrl:y(t,["avatar_url"],""),isActive:j(t,["is_active"],!0),lastSignInAt:y(t,["last_sign_in_at"],""),createdAt:y(t,["created_at"],"")}))}async function ys(e){if(!e)return null;const t=await k("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:y(n,["id"],""),email:y(n,["email"],""),displayName:y(n,["display_name"],""),staffCode:y(n,["staff_code"],""),department:y(n,["department"],"all")||"all",role:y(n,["role"],"staff")||"staff",defaultMailSenderId:y(n,["default_mail_sender_id"],""),phone:y(n,["phone"],""),avatarUrl:y(n,["avatar_url"],""),isActive:j(n,["is_active"],!0),lastSignInAt:y(n,["last_sign_in_at"],"")}}async function hs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function vs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function fs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>P);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function bs(e=100){return(await k("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:y(n,["id"],""),action:y(n,["action"],""),entityType:y(n,["entity_type"],""),entityId:y(n,["entity_id"],""),userEmail:y(n,["user_email"],""),changes:n.changes??{},createdAt:y(n,["created_at"],"")}))}const Ce={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function ia(){return(await k("slack_notifications",{order:"event_type.asc"})).map(t=>({id:y(t,["id"],""),eventType:y(t,["event_type"],"new_order"),enabled:j(t,["enabled"],!0),channel:y(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:y(t,["last_triggered_at"],"")}))}async function gs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function $s(e=50){return(await k("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:y(n,["id"],""),eventType:y(n,["event_type"],""),channel:y(n,["channel"],""),message:y(n,["message"],""),status:y(n,["status"],"sent"),error:y(n,["error"],""),sentAt:y(n,["sent_at"],"")}))}async function ws(e,t,n){const r=(await na()).find(d=>d.provider==="slack");if(!r||!r.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const a=r.config.webhook_url;if(!a)return{ok:!1,error:"Webhook URL未設定"};const o=(await ia()).find(d=>d.eventType===e&&d.enabled);if(!o)return{ok:!1,error:"通知ルールが無効"};const c=n??o.channel??r.config.default_channel??"#general";try{const d=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${Ce[e]} ${t}`,channel:c})}),u=d.ok,{supabaseInsert:p}=await v(async()=>{const{supabaseInsert:h}=await Promise.resolve().then(()=>P);return{supabaseInsert:h}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:c,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${d.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${d.status}`}}catch(d){return{ok:!1,error:d instanceof Error?d.message:String(d)}}}const de={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Pe={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function ks(){return(await k("prospects",{order:"updated_at.desc"})).map(t=>({id:y(t,["id"],""),companyName:y(t,["company_name"],""),contactName:y(t,["contact_name"],""),email:y(t,["email"],""),phone:y(t,["phone"],""),address:y(t,["address"],""),website:y(t,["website"],""),businessType:y(t,["business_type"],""),stage:y(t,["stage"],"cold"),source:y(t,["source"],""),expectedAmount:A(t.expected_amount),probability:A(t.probability),assignedStaffCode:y(t,["assigned_staff_code"],""),nextActionDate:y(t,["next_action_date"],""),nextAction:y(t,["next_action"],""),note:y(t,["note"],""),lastContactAt:y(t,["last_contact_at"],""),wonAt:y(t,["won_at"],""),lostAt:y(t,["lost_at"],""),lostReason:y(t,["lost_reason"],""),convertedCustomerCode:y(t,["converted_customer_code"],""),createdAt:y(t,["created_at"],"")}))}async function Ss(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function _s(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function xs(e){return(await k("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:y(n,["id"],""),prospectId:y(n,["prospect_id"],""),activityType:y(n,["activity_type"],"call"),title:y(n,["title"],""),description:y(n,["description"],""),activityDate:y(n,["activity_date"],""),result:y(n,["result"],""),staffCode:y(n,["staff_code"],"")}))}async function Ds(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const la=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function As(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>P);return{supabaseInsert:i}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function Cs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const b=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:tt,CALENDAR_CATEGORY_LABELS:et,DEPT_LABELS:Ae,INVOICE_TYPE_LABELS:ze,JIKOMI_STATUS_LABELS:Yt,MATERIAL_CATEGORIES:la,PROSPECT_STAGE_COLORS:Pe,PROSPECT_STAGE_LABELS:de,ROLE_LABELS:De,SEASONAL_TEMPLATES:He,SLACK_EVENT_LABELS:Ce,TAX_DEDUCTION_LABELS:Ve,TAX_RATE_CATEGORIES:ea,deleteCalendarEvent:ls,deleteMailSender:ss,deleteMaterial:Cs,deletePrintLayout:es,deleteProspect:_s,deleteUserProfile:vs,fetchAuditLogs:bs,fetchBillList:Gt,fetchBillingSummary:We,fetchCalendarEvents:ns,fetchCustomerLedger:Qe,fetchDeliveryNote:Ke,fetchFaxInbox:ds,fetchIntegrationSettings:na,fetchInvoices:xe,fetchJikomiList:Ht,fetchKenteiList:Qt,fetchMailSenders:ts,fetchMasterStats:zt,fetchMaterialList:Je,fetchMyProfile:ys,fetchPayableList:Wt,fetchPaymentStatus:Ft,fetchPipelineMeta:Jt,fetchPrintLayouts:Ga,fetchProspectActivities:xs,fetchProspects:ks,fetchPurchaseList:Kt,fetchRawMaterialStock:Zt,fetchSalesAnalytics:Vt,fetchSalesReport:Bt,fetchSalesSummary:Mt,fetchShopifyOrders:cs,fetchSlackLogs:$s,fetchSlackRules:ia,fetchStoreOrders:aa,fetchStoreSales:Ze,fetchTankList:Xt,fetchTaxDeclaration:Ge,fetchUserProfiles:ms,generateTaxCSV:Ha,generateTaxXML:ta,ocrFaxImage:us,recalculateTaxDeclaration:Xa,recordAudit:fs,saveCalendarEvent:is,saveEmailCampaign:ke,saveFaxRecord:ps,saveIntegrationSetting:at,saveInvoice:Ut,saveMailSender:as,saveMaterial:As,savePrintLayout:Za,saveProspect:Ss,saveProspectActivity:Ds,saveSlackRule:gs,saveTaxDeclaration:Qa,saveUserProfile:hs,sendEmailCampaign:sa,sendSlackNotification:ws,syncGoogleCalendar:rs,syncShopifyOrders:os},Symbol.toStringTag,{value:"Module"}));function K(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Es={open:"未締め",closed:"締め済"};function Ls(e,t){const n=e.customers.map(i=>`
      <tr>
        <td>
        ...
        <td>
          <span class="status-pill ${i.status==="closed"?"success":"warning"}">${Es[i.status]}</span>
        </td>
        <td>
  ...
  `}function oa(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function oe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ns(e){return e.salesHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':e.salesHistory.map(t=>`
      ...
      `).join("")}function Ts(e){return e.paymentHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':e.paymentHistory.map(t=>`
        <tr>
          <td>${oa(t.date)}</td>
          <td>${t.method}</td>
          <td class="numeric">${oe(t.amount)}</td>
        </tr>
      `).join("")}function js(e,t){return`
    <section class="page-head">
      <div>
  ...
  `}function me(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ye(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function ae(e,t){for(const n of t){const i=e[n];if(typeof i=="number"&&Number.isFinite(i))return i;if(typeof i=="string"){const r=Number(i);if(Number.isFinite(r))return r}}return null}function Os(e){const t=e?.productTotals;if(!t||t.length===0)return"―";const n=t.reduce((r,a)=>{const l=ae(a,["amount","salesAmount"]),o=ae(a,["marginRate","grossMarginRate"]);return l===null||l<=0||o===null?r:{weightedAmount:r.weightedAmount+l,weightedRate:r.weightedRate+l*o}},{weightedAmount:0,weightedRate:0});if(n.weightedAmount>0)return`${(n.weightedRate/n.weightedAmount).toFixed(1)}%`;const i=t.reduce((r,a)=>{const l=a,o=ae(l,["amount","salesAmount"]),c=ae(l,["grossProfit","grossAmount","margin"]),d=ae(l,["costAmount","cost","costPrice"]);if(o===null||o<=0)return r;const u=c??(d!==null?o-d:null);return u===null?r:{sales:r.sales+o,gross:r.gross+u}},{sales:0,gross:0});return i.sales>0?`${(i.gross/i.sales*100).toFixed(1)}%`:"―"}function Rs(e){const i={top:20,right:20,bottom:30,left:50},r=760-i.left-i.right,a=260-i.top-i.bottom,l=Math.max(...e.map(u=>u.amount),1),o=r/e.length,c=e.map((u,p)=>{const h=u.amount/l*a,f=i.left+p*o+4,x=i.top+a-h,D=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(u.date));return`
        <g>
          <rect x="${f}" y="${x}" width="${Math.max(o-8,8)}" height="${h}" rx="4" fill="#0F5B8D" opacity="${.58+p/e.length*.34}" />
          ${p%5===0?`<text x="${f+6}" y="252" class="chart-axis">${D}</text>`:""}
        </g>
      `}).join("");return`
  ...
  `}function qs(e,t,n,i){const r={success:"正常",warning:"注意",error:"異常",running:"実行中"},a=e.salesRecords.slice(0,10).map(l=>`
            <tr>
              <td class="mono">${l.documentNo}</td>
              <td>${ye(l.date)}</td>
              <td>${l.customerName}</td>
              <td class="numeric">${me(l.amount)}</td>
            </tr>
          `).join("");return`
    <section class="page-head">
      <div>
      ...
      <div class="meta-stack">
        ...
        <span class="meta-note">最終同期 ${ye(t.lastSyncAt)}</span>
      </div>
    </section>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${me(e.kpis.monthSales)}</p>
      ...
      <aside class="panel sync-panel">
        <div>
          ...
          <dl class="meta-list">
            ...
            <div>
              <dt>最終同期</dt>
              <dd>${ye(t.lastSyncAt)}</dd>
            </div>
            <div>
              <dt>更新時刻</dt>
              <dd>${ye(t.generatedAt)}</dd>
            </div>
          </dl>
        </div>
    ...
    ${i?Ms(i):""}
  `}function Ms(e){const t=e.prospects.reduce((l,o)=>l+o.expectedAmount*o.probability/100,0),n=e.prospects.filter(l=>l.stage==="hot"||l.stage==="negotiating").length,i=new Date().toISOString().slice(0,10),r=e.upcomingEvents.filter(l=>l.startsAt.slice(0,10)>=i).slice(0,5),a=e.tourInquiries.filter(l=>l.status==="new").length;return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
      ...
      <article class="panel">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(100px, 1fr));gap:8px;">
          ${["cold","warm","hot","contacted","negotiating","won"].map(l=>{const o=e.prospects.filter(d=>d.stage===l).length,c=e.prospects.filter(d=>d.stage===l).reduce((d,u)=>d+u.expectedAmount,0);return`
              <div style="background:${Pe[l]};color:white;padding:12px;border-radius:6px;text-align:center;">
                <div style="font-size:11px;">${de[l]}</div>
  ...
  `}function Fs(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function W(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function zs(e,t){const n=e.lines.length?e.lines.map((r,a)=>`
          <tr>
            ...
            <td>${r.unit}</td>
            <td class="numeric">${W(r.unitPrice)}</td>
            <td class="numeric">${W(r.amount)}</td>
          </tr>
    ...
    <article class="panel delivery-note-body" id="delivery-print-area">
      <div class="delivery-header">
        ...
        <div class="delivery-meta">
          <table class="delivery-meta-table">
            ...
            <tr><th>納品日</th><td>${Fs(e.invoiceDate)}</td></tr>
            <tr><th>合計金額</th><td class="numeric">${W(e.totalAmount)}（税込）</td></tr>
          </table>
      ...
      <div class="delivery-footer">
        <div class="delivery-totals">
          <div class="total-stack"><span class="total-label">小計</span><span class="total-value">${W(i)}</span></div>
          <div class="total-stack"><span class="total-label">消費税（10%）</span><span class="total-value">${W(e.taxAmount)}</span></div>
          <div class="total-stack total-grand"><span class="total-label">合計（税込）</span><span class="total-value">${W(e.totalAmount)}</span></div>
        </div>
        ${e.note?`<p class="delivery-note-text">備考：${e.note}</p>`:""}
      </div>
    </article>
  `}function q(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Js(e){return q(e).replaceAll(`
`,"<br />")}function Vs(e){const n=[...Object.values(He),{id:"custom",season:"カスタム",subject:"",body:""}].map(r=>`
        <button
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="email-preview">
          ...
          <div class="preview-box">${e.body?Js(e.body):"本文未入力"}</div>
        </div>
  ...
  `}function R(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function he(e,t){return t.length===0?"":`
  ...
  `}function Us(e,t){const n=[he("得意先",t.customers.map(r=>`
          <button
            ...
            data-path="/master"
          >
            <strong>${R(r.name)}</strong>
            <span class="table-sub mono">${R(r.code)}</span>
          </button>
        `)),he("商品",t.products.map(r=>`
          <button
            class="search-result-item"
            type="button"
            data-action="global-nav"
        ...
        `)),he("伝票",t.documents.map(r=>`
          <button
            ...
            data-path="/invoice"
          >
            <strong>${R(r.documentNo)}</strong>
            <span class="table-sub">${R(r.customerName)} / ${R(r.date)}</span>
          </button>
        `)),he("ページ",t.pages.map(r=>`
          <button
            class="search-result-item"
            type="button"
            data-action="global-nav"
            data-path="${R(r.path)}"
          >
            <strong>${R(r.title)}</strong>
            <span class="table-sub mono">${R(r.path)}</span>
          </button>
  ...
  `}function se(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ca(e){const t=e.resultsHtml.trim()?e.resultsHtml:`<p class="empty-note">${se(e.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function ve(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ht(e){return e.trim().toLowerCase()}function Bs(e,t){const n=ht(t),i=e.filter(a=>n?[a.code,a.name,a.name].map(ht).some(l=>l.includes(n)):!0).slice(0,50),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return ca({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:r,emptyMessage:"該当する得意先が見つかりません。"})}function Ys(e){return e.toISOString().slice(0,10)}function Q(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function B(e,t){return e[t]?`<div class="field-error">${Q(e[t])}</div>`:""}function G(e,t,n=""){return[n,e[t]?"has-error":""].filter(Boolean).join(" ")}function Hs(e,t,n,i){const r=Object.keys(ze).map(c=>`<option value="${c}" ${e.invoiceType===c?"selected":""}>${ze[c]}</option>`).join(""),a=e.lines.map((c,d)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${G(i,`lines.${d}.productCode`,"input-cell")}" type="text" data-line="${d}" data-field="productCode" value="${Q(c.productCode)}" placeholder="P00001" />
            <button class="picker-btn" type="button" data-action="open-product-picker" data-line="${d}" aria-label="商品検索">🔍</button>
          </div>
          ${B(i,`lines.${d}.productCode`)}
        </td>
        <td>
          <input class="${G(i,`lines.${d}.productName`,"input-cell")}" type="text" data-line="${d}" data-field="productName" value="${Q(c.productName)}" placeholder="商品名" />
          ${B(i,`lines.${d}.productName`)}
        </td>
        <td>
          <input class="${G(i,`lines.${d}.quantity`,"input-cell numeric")}" type="number" data-line="${d}" data-field="quantity" value="${c.quantity}" min="0" />
          ${B(i,`lines.${d}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${d}" data-field="unit" value="${c.unit}" placeholder="本" /></td>
        <td>
          <input class="${G(i,`lines.${d}.unitPrice`,"input-cell numeric")}" type="number" data-line="${d}" data-field="unitPrice" value="${c.unitPrice}" min="0" />
          ${B(i,`lines.${d}.unitPrice`)}
        </td>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${G(i,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||Ys(new Date)}" />
          ${B(i,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
          <div class="input-group">
            <input
              class="${G(i,"customerCode")}"
              id="inv-customer-code"
              data-autofill="customer"
              type="text"
              placeholder="C0011"
              value="${Q(e.customerCode)}"
            />
        ...
        <label class="field">
          ...
          <input
            ...
            type="text"
            placeholder="青葉商事"
            value="${Q(e.customerName)}"
          />
        </label>
        <label class="field">
          <span>担当者コード</span>
          <input id="inv-staff" type="text" placeholder="S001" value="${Q(e.staffCode)}" />
        </label>
      </div>
      ${B(i,"lines")}
    </section>
    ...
    <section class="panel">
      <label class="field">
        <span>備考</span>
        <textarea id="inv-note" rows="2" placeholder="備考・特記事項">${Q(e.note)}</textarea>
      </label>
    </section>
  ...
  `}function Xs(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function Qs(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ks(e,t){const n=e.length?e.map(i=>`
            <tr>
              ...
              <td class="numeric">${Qs(i.amount)}</td>
            </tr>
  ...
  `}function Ws(e){return new Date(e.getFullYear(),e.getMonth(),1)}function Gs(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function ra(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function da(e){const t=new Date(e),n=t.getDay();return t.setDate(t.getDate()-n),t.setHours(0,0,0,0),t}function vt(e){const t=ra(da(e),6);return t.setHours(23,59,59,999),t}function ft(e){return new Date(`${e}T00:00:00`)}function bt(e){return`${e.getMonth()+1}/${e.getDate()}`}function Zs(e){return e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function en(){const e=new Date,t=da(Gs(Ws(e),-3)),n=vt(new Date(e.getFullYear(),e.getMonth()+4,0)),i=[];let r=new Date(t);for(;r<=n;){const a=vt(r);i.push({start:new Date(r),end:a,label:`${bt(r)} - ${bt(a)}`}),r=ra(r,7)}return i}function tn(e){const t=en(),n=`160px repeat(${t.length}, minmax(56px, 1fr))`,i=t.map(a=>`
        <div class="gantt-week">
          <span>${a.label}</span>
        </div>
      `).join(""),r=e.length?e.map(a=>{const l=ft(a.startDate),o=ft(a.expectedDoneDate),c=Math.max(0,t.findIndex(p=>p.end>=l)),d=Math.max(c,t.reduce((p,h,f)=>h.start<=o?f:p,c)),u=[`仕込番号: ${a.jikomiNo}`,`銘柄: ${a.productName}`,`期間: ${a.startDate} - ${a.expectedDoneDate}`,`タンク: ${a.tankNo}`,`備考: ${a.note||"なし"}`].join(`
`);return`
  ...
  `}function gt(e,t){const n={planned:"neutral",active:"warning",done:"success"},i=e.map(o=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${n[o.status]}">${Yt[o.status]}</span>
        </td>
        <td>${o.note||"―"}</td>
      </tr>
  ...
  `}function an(e){const t={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},i=e.map(c=>`
      <tr>
  ...
  `}function sn(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function nn(e,t){return`
  ...
  `}function ln(e){return e.map(t=>`
      ...
      `).join("")}function on(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
      ...
      <div class="table-wrap">
        ...
        `:`
          <table>
            ...
            <tbody>${on(e.products)}</tbody>
          </table>
        `}
      </div>
    </section>
  `}function Te(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function rn(e,t){if(!e&&!t)return"";const n=e;return`
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 160px;">
              ...
              <select id="mat-type">
                ...
                ${la.map(i=>`<option ${n?.materialType===i?"selected":""}>${i}</option>`).join("")}
              </select>
            </label>
  ...
  `}function dn(e){const t=e.map(r=>{const l=(r.minimumStock>0?r.currentStock/r.minimumStock:1/0)<1.5;return`
        <tr>
          ...
          <td class="numeric">${Te(r.unitCost)}</td>
          <td class="numeric">${Te(r.currentStock*r.unitCost)}</td>
          <td>${r.lastUpdated}</td>
          <td>
  ...
  `}function un(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function je(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const pn={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function mn(e){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td><span class="status-pill ${n.status==="paid"?"success":n.status==="partial"?"warning":"danger"}">${pn[n.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function Z(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function $t(e){return e.trim().toLowerCase()}function yn(e,t){const n=$t(t),i=e.filter(a=>n?[a.code,a.name,a.janCode].map($t).some(l=>l.includes(n)):!0),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return ca({title:"商品検索",searchQuery:t,placeholder:"コード・名前・JANで検索",resultsHtml:r,emptyMessage:"該当する商品が見つかりません。"})}function Y(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function hn(e,t){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},i={pending:"warning",confirmed:"neutral",paid:"success"},r={unpaid:"未払い",partial:"一部支払",paid:"支払済"},a={unpaid:"warning",partial:"neutral",paid:"success"},l=e.map(p=>`
      <tr>
  ...
  `}function ne(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function vn(e,t){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},i={holding:"neutral",due:"warning",cleared:"success"},r=e.map(u=>`
      <tr>
  ...
  `}function fn(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function I(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ue(e){return`
  ...
  `}function fe(e){return`
    <div class="setup-command-row">
      <code class="inline-code">${I(e)}</code>
      ${bn(e)}
    </div>
  `}function ee(e){return`
    <div class="setup-step" data-step="${e.step}">
      ...
      <div class="setup-step-section">
        ...
        <ol class="setup-list">
          ${e.instructions.map(t=>`<li>${I(t)}</li>`).join("")}
        </ol>
      </div>
      ${e.code?Ue(e.code):""}
      <div class="setup-step-section">
        ...
        <ul class="setup-list">
          ${e.success.map(t=>`<li>${I(t)}</li>`).join("")}
        </ul>
      </div>
      <div class="setup-step-section">
        <p class="panel-title">よくあるエラー</p>
        <ul class="setup-list">
          ${e.errors.map(t=>`<li>${I(t)}</li>`).join("")}
        </ul>
      </div>
    </div>
  `}function be(e){return`
    <div class="setup-step setup-step-compact" data-step="${I(e.stepLabel)}">
      <h3>${I(e.title)}</h3>
      <div class="setup-step-section">
        <p class="panel-title">目的</p>
        <p>${I(e.purpose)}</p>
  ...
  `}function gn(e,t,n){const i={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
      ...
      <div class="relay-config-list">
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${I(t)}</span>
          </div>
          <button
            class="button secondary"
            type="button"
            data-action="copy-config"
            data-config-value="${I(t)}"
          >
            コピー
          </button>
        </div>
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${I(n)}</span>
          </div>
          <button
            class="button secondary"
            type="button"
            data-action="copy-config"
            data-config-value="${I(n)}"
          >
            コピー
          </button>
        </div>
  ...
  `}function $n(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function wn(e){return e.replace("-","/")}function kn(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,i={top:16,right:24,bottom:36,left:64},r=t-i.left-i.right,a=n-i.top-i.bottom,l=Math.max(...e.map(u=>u.amount),1),o=r/e.length,c=[0,.25,.5,.75,1].map(u=>{const p=i.top+a-a*u,h=`${Math.round(l*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${i.left}" y1="${p}" x2="${t-i.right}" y2="${p}" class="chart-grid" />
          <text x="8" y="${p+4}" class="chart-axis">${h}</text>
        </g>
      `}).join(""),d=e.map((u,p)=>{const h=u.amount/l*a,f=Math.max(o-18,24),x=i.left+p*o+(o-f)/2,D=i.top+a-h;return`
        <g>
          <rect x="${x}" y="${D}" width="${f}" height="${h}" rx="6" class="analytics-bar" />
          <text x="${x+f/2}" y="${n-10}" class="chart-axis centered-axis">${wn(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function Sn(e){return e.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
          <td class="numeric">${$n(t.amount)}</td>
          <td class="numeric">${t.quantity.toLocaleString("ja-JP")}</td>
          <td class="numeric">${t.documents.toLocaleString("ja-JP")}</td>
        </tr>
      `).join("")}function _n(e,t){const n=t==="products"?"商品別集計":"得意先別集計",i=t==="products"?e.productTotals:e.customerTotals;return`
    <section class="page-head">
      <div>
  ...
  `}function ie(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function xn(e){const t=Math.max(...e.salesByProduct.flatMap(a=>a.values),1),n=e.salesByProduct.map(a=>{const l=a.values.map((o,c)=>`
          <div class="bar-col">
            <div class="bar" style="height:${Math.round(o/t*120)}px" title="${e.months[c]}: ${ie(o)}"></div>
  ...
  `}function Dn(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function An(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function wt(e){return e.toISOString().slice(0,10)}function Cn(e,t,n){const i=e.length?e.map(r=>`
            <tr>
              ...
              <td class="numeric">${An(r.amount)}</td>
            </tr>
  ...
  `}function ge(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function En(e,t,n,i){const r={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},a={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},l={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},o=e.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
    ...
    `).join(""),c=t.map(p=>`
      <tr>
        ...
        <td class="numeric"><strong>${ge(p.totalAmount)}</strong></td>
        <td>
  ...
  `}const Oe={customers:"得意先マスタ",products:"商品マスタ",suppliers:"仕入先マスタ",staff:"担当者マスタ"},Ln={customers:{required:["legacy_customer_code","name"],optional:["kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"]},products:{required:["legacy_product_code","name"],optional:["kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"]},suppliers:{required:["legacy_supplier_code","name"],optional:["kana_name","phone","postal_code","address1","closing_day","payment_day","email"]},staff:{required:["legacy_staff_code","name"],optional:["kana_name","department"]}};function Pn(e,t,n,i){const r=Ln[e],a=Object.keys(Oe).map(o=>`
  ...
  `}const _={header:"#2196F3",code:"#4CAF50",date:"#FF9800",detail:"#9C27B0",total:"#F44336"};function In(e,t,n){const i=[{id:"documentNo",label:"伝票番号",x:155,y:4,fontSize:9,value:e.documentNo,color:_.header},{id:"vendorName",label:"社名",x:4,y:12,fontSize:10,value:t.name,color:_.header},{id:"vendorAddress",label:"住所",x:4,y:17,fontSize:7,value:t.address1,color:_.header},{id:"customerName",label:"取引先名",x:4,y:20,fontSize:10,value:`${e.customerName} ${e.customerHonorific}`,color:_.header},{id:"chainStoreCode",label:"柱店CD",x:63,y:13,fontSize:9,value:e.chainStoreCode??"",color:_.code},{id:"categoryCode",label:"分類CD",x:87,y:13,fontSize:9,value:e.categoryCode??"",color:_.code},{id:"slipNumber",label:"伝票No.",x:117,y:13,fontSize:9,value:e.documentNo,color:_.code},{id:"vendorCode",label:"取引CD",x:151,y:13,fontSize:9,value:e.slipTypeCode??"",color:_.code},{id:"partnerCode",label:"取引先CD",x:94,y:20,fontSize:10,value:e.vendorCode??"",color:_.code},{id:"orderNo",label:"受注No.",x:143,y:20,fontSize:9,value:e.orderNo??"",color:_.code},{id:"currentDate",label:"当日日付",x:10,y:3.5,fontSize:8,value:e.documentDate.replace(/-/g,"/"),color:_.date},{id:"orderDate",label:"発注日",x:180,y:13,fontSize:7.5,value:(e.orderDate??"").replace(/-/g,"/"),color:_.date},{id:"deliveryDate",label:"納品日",x:204,y:13,fontSize:7.5,value:(e.deliveryDate??"").replace(/-/g,"/"),color:_.date}];e.lines.slice(0,6).forEach((l,o)=>{const c=33+o*8.5;i.push({id:`line${o}_name`,label:`明細${o+1} 品名`,x:5,y:c,fontSize:7.5,value:l.productName+(l.spec?` ${l.spec}`:""),color:_.detail},{id:`line${o}_code`,label:`明細${o+1} CD`,x:64,y:c,fontSize:7.5,value:l.productCode,color:_.detail},{id:`line${o}_qty`,label:`明細${o+1} 数量`,x:124,y:c,fontSize:8,value:l.quantity>0?String(l.quantity):"",color:_.detail},{id:`line${o}_price`,label:`明細${o+1} 原単価`,x:163,y:c,fontSize:8,value:l.unitPrice>0?l.unitPrice.toLocaleString("ja-JP"):"",color:_.detail},{id:`line${o}_amount`,label:`明細${o+1} 原価金額`,x:176,y:c,fontSize:8,value:l.amount>0?l.amount.toLocaleString("ja-JP"):"",color:_.detail},{id:`line${o}_retail`,label:`明細${o+1} 売単価`,x:193,y:c,fontSize:8,value:l.retailPrice?l.retailPrice.toLocaleString("ja-JP"):"",color:_.detail})});const r=e.lines.reduce((l,o)=>l+(o.amount||0),0),a=e.lines.reduce((l,o)=>l+o.quantity,0);return i.push({id:"totalQty",label:"合計数量",x:125,y:89,fontSize:9,value:String(a),color:_.total},{id:"costTotal",label:"原価金額合計",x:179,y:89,fontSize:10,value:r.toLocaleString("ja-JP"),color:_.total}),n&&i.forEach(l=>{const o=n[l.id];o&&(l.x=o.x,l.y=o.y)}),i}function Nn(e,t,n,i,r){const l=In(e,t,i).map(c=>`
    ...
    <section class="panel no-print">
      ...
      <p class="form-hint" style="margin:12px 0 0;">
        ...
        色: <span style="color:${_.header}">■ヘッダ</span>
        <span style="color:${_.code}">■コード</span>
        <span style="color:${_.date}">■日付</span>
        <span style="color:${_.detail}">■明細</span>
        <span style="color:${_.total}">■合計</span>
      </p>
    </section>
    `:""}
  ...
  `}function Re(e){const t={};return e.querySelectorAll("[data-fd-id]").forEach(n=>{const i=n.dataset.fdId??"",r=parseFloat(n.style.left)||0,a=parseFloat(n.style.top)||0;t[i]={x:r,y:a}}),t}function Tn(e,t){const n=Array.from(new Set(e.map(i=>(i.address1??"").slice(0,3)).filter(Boolean))).slice(0,20);return`
    <section class="page-head">
      <div>
      ...
      <div class="meta-stack">
        <span class="panel-caption">${e.filter(i=>i.lat&&i.lng).length} 件表示中</span>
      </div>
    </section>
      ...
      <div class="filter-grid">
        <label class="field">
          ...
          <select id="map-region-filter">
            ...
            ${n.map(i=>`<option value="${i}" ${t===i?"selected":""}>${i}</option>`).join("")}
          </select>
        </label>
        <div class="filter-actions">
          ...
          <tbody>
            ${e.slice(0,50).map(i=>`
              <tr>
                ...
                <td class="numeric">${i.lastOrderAmount?"¥"+i.lastOrderAmount.toLocaleString("ja-JP"):"―"}</td>
                <td>${i.lat&&i.lng?'<span class="status-pill success">設定済</span>':'<span class="status-pill warning">未設定</span>'}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}const jn={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},On=["new","picking","packed","shipped","delivered"];function Rn(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(a=>t[a.stage].push(a));const n=On.map(a=>{const l=jn[a],o=t[a];return`
  ...
  `}function qn(e,t,n){const i=e.cart.reduce((a,l)=>a+l.amount,0);return`
  ...
  `}function Mn(e,t,n){if(e.step==="customer"){const i=e.customerQuery.toLowerCase(),r=i?t.filter(a=>a.name.toLowerCase().includes(i)||a.code.toLowerCase().includes(i)):t.slice(0,20);return`
      <section class="panel">
  ...
  `}const kt={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},St={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},_t={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function Fn(e,t){const n=e.find(a=>a.id===t)??e[0],i=e.filter(a=>a.status==="new").length,r=e.filter(a=>a.status==="confirmed").length;return`
    <section class="page-head">
      <div>
          ...
          ${e.map(a=>`
            <button class="tour-item ${n?.id===a.id?"active":""}" data-tour-id="${a.id}">
              <div class="tour-item-head">
                ...
                <span class="status-pill ${St[a.status]}">${kt[a.status]}</span>
              </div>
              <div class="tour-item-sub">
                ${_t[a.language]} · 👥 ${a.partySize}名
              </div>
...
金井酒造店`;function Vn(e,t){const n=t?e.find(r=>r.id===t):null,i=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${n||i?`
      ...
      `:""}
  `}function Un(e,t,n,i){const[r,a]=t.split("-").map($=>parseInt($,10)),l=new Date(r,a-1,1),o=new Date(r,a,0),c=l.getDay(),d=o.getDate(),u=[];for(let $=0;$<c;$++)u.push({isOutside:!0});for(let $=1;$<=d;$++)u.push({date:new Date(r,a-1,$)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter($=>$.category===n):e,h={};p.forEach($=>{const T=$.startsAt.slice(0,10);h[T]??=[],h[T].push($)});const f=new Date().toISOString().slice(0,10),x=u.map($=>{if($.isOutside)return'<div class="cal-cell cal-outside"></div>';const T=$.date,J=`${T.getFullYear()}-${String(T.getMonth()+1).padStart(2,"0")}-${String(T.getDate()).padStart(2,"0")}`,Ne=h[J]??[],$a=J===f,ot=T.getDay();return`
        <div class="cal-cell ${$a?"cal-today":""} ${ot===0?"cal-sun":ot===6?"cal-sat":""}"
             data-cal-date="${J}">
          <div class="cal-day-num">${T.getDate()}</div>
          <div class="cal-events">
            ${Ne.slice(0,3).map(V=>`
              <button class="cal-event" data-cal-event-id="${V.id}"
                      style="background:${V.color||tt[V.category]||"#0F5B8D"};"
                      title="${V.title}">
            ...
            `).join("")}
            ${Ne.length>3?`<button class="cal-event-more" data-cal-date="${J}">+${Ne.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),D=i?.isOpen?Bn(i):"",g=new Date(r,a-2,1),C=new Date(r,a,1),te=`${g.getFullYear()}-${String(g.getMonth()+1).padStart(2,"0")}`,N=`${C.getFullYear()}-${String(C.getMonth()+1).padStart(2,"0")}`,ue=(()=>{const $=new Date;return`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      <div class="cal-toolbar">
        <div class="cal-nav">
          ...
          <button class="button secondary" data-action="cal-today" data-ym="${ue}">今日</button>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(et).map(([$,T])=>`<option value="${$}" ${n===$?"selected":""}>${T}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
    ...
    ${D}
  `}function Bn(e){const t=e.event;return`
      ...
      <div class="modal-panel" onclick="event.stopPropagation()">
        ...
        <div class="modal-body">
          ...
          <div style="display:flex;gap:8px;">
            <label class="field" style="flex:1;">
              ...
              <select id="cal-category">
                ${Object.entries(et).map(([n,i])=>`<option value="${n}" ${t.category===n?"selected":""}>${i}</option>`).join("")}
              </select>
            </label>
          ...
          <div style="display:flex;gap:8px;">
            <label class="field" style="flex:1;">
              <span>開始</span>
              <input id="cal-starts" type="datetime-local" value="${t.startsAt?xt(t.startsAt):""}" />
            </label>
            <label class="field" style="flex:1;">
              <span>終了 (任意)</span>
              <input id="cal-ends" type="datetime-local" value="${t.endsAt?xt(t.endsAt):""}" />
            </label>
          </div>
          <label class="field">
            <span>場所</span>
  ...
  `}function Hn(e,t){const n=e.reduce((a,l)=>a+l.totalAmount,0),i=e.filter(a=>a.financialStatus==="paid").length,r=e.filter(a=>a.fulfillmentStatus!=="fulfilled"&&a.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function Qn(e,t,n){const i=t==="__new__"?null:e.find(l=>l.id===t),r=t==="__new__";return n?.role==="admin"?`
    <section class="page-head">
      <div>
      ...
      <section class="panel">
        ...
        <div class="filter-grid filter-grid--wide">
          ...
          <label class="field" style="flex:1 1 140px;">
            <span>部署</span>
            <select id="user-dept">
              ${Object.entries(Ae).map(([l,o])=>`<option value="${l}" ${i?.department===l?"selected":""}>${o}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 140px;">
            <span>権限</span>
            <select id="user-role">
              ${Object.entries(De).map(([l,o])=>`<option value="${l}" ${i?.role===l?"selected":""}>${o}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 160px;">
            <span>電話</span>
  ...
  `:`
    ...
    <section class="panel">
      ...
      <dl class="summary-list">
        ...
        <div><dt>部署</dt><dd>${Ae[e.department]}</dd></div>
        <div><dt>権限</dt><dd>${De[e.role]}</dd></div>
  ...
  `:`
    ...
    `}function Wn(e){const t={};return e.forEach(n=>{const i=n.userEmail??"(anonymous)";t[i]=(t[i]??0)+1}),`
    <section class="page-head">
      <div>
  ...
  `}function Gn(e){const t=e.prospects.reduce((a,l)=>a+l.expectedAmount,0),n=e.prospects.reduce((a,l)=>a+l.expectedAmount*l.probability/100,0),i=e.prospects.filter(a=>a.stage==="won").length,r=e.prospects.filter(a=>a.stage==="hot"||a.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    ${e.viewMode==="kanban"?Zn(e.prospects):ei(e.prospects)}
    ...
    <section class="panel" style="padding:12px;">
      ...
      <div class="pk-board">${["cold","warm","hot","contacted","negotiating","won","lost"].map(i=>{const r=e.filter(l=>l.stage===i),a=r.reduce((l,o)=>l+o.expectedAmount,0);return`
        <div class="pk-col" data-prospect-stage="${i}">
          <div class="pk-col-header" style="--pk-color:${Pe[i]};">
            <span class="pk-col-label">${de[i]}</span>
          ...
          <tbody>
            ${e.map(t=>`
              <tr>
                ...
                <td><span class="status-pill" style="background:${Pe[t.stage]};color:white;">${de[t.stage]}</span></td>
  ...
  `}function ti(e){if(!e.editingId)return"";const t=e.editingId==="__new__",n=t?null:e.prospects.find(i=>i.id===e.editingId);return!t&&!n?"":`
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 140px;">
              ...
              <select id="prospect-stage">
                ${Object.entries(de).map(([i,r])=>`<option value="${i}" ${n?.stage===i?"selected":""}>${r}</option>`).join("")}
              </select>
            </label>
            <label class="field" style="flex:1 1 120px;">
              <span>流入元</span>
  ...
  `}function ai(e,t,n){const i=e?.config.webhook_url??"",r=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${t.map(a=>`
              <tr>
                <td>${Ce[a.eventType]||a.eventType}</td>
                <td>
  ...
  `}const Dt={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},si={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},ni={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function E(e){return"¥"+e.toLocaleString("ja-JP")}function ce(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function ua(e,t){const n=e.reduce((a,l)=>a+l.amount,0),i=Math.floor(n*t),r=n+i;return{subtotal:n,taxAmount:i,total:r}}const w={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function S(e,t){const n=e.align??"left",i=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${i}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function qe(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),i=n-2018;return{y:i>0?String(i).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function ii(e,t,n){const i=qe(e.documentDate),r=qe(e.orderDate??e.documentDate),a=qe(e.deliveryDate??e.documentDate),l=e.lines.slice(0,6).map((g,C)=>{const te=w.detailStartY+C*w.detailRowH,N=w.detailCols,ue=[],$=(T,J)=>{J&&ue.push(S({...T,y:te,x:T.x+0},J))};return $(N.productName,g.productName+(g.spec?` ${g.spec}`:"")),$(N.productCode,g.productCode),$(N.color,g.color??""),$(N.size,[g.size,g.caseQty?`×${g.caseQty}`:""].filter(Boolean).join(" ")),$(N.unit,g.unit),$(N.quantity,g.quantity>0?g.quantity.toLocaleString("ja-JP"):""),$(N.correctedQty,g.correctedQuantity?g.correctedQuantity.toLocaleString("ja-JP"):""),$(N.discount,g.discount?g.discount.toLocaleString("ja-JP"):""),$(N.unitPrice,g.unitPrice>0?g.unitPrice.toLocaleString("ja-JP"):""),$(N.costAmount,g.amount>0?g.amount.toLocaleString("ja-JP"):""),$(N.retailPrice,g.retailPrice?g.retailPrice.toLocaleString("ja-JP"):""),$(N.note,g.receivedAmount?g.receivedAmount.toLocaleString("ja-JP"):""),ue.join("")}).join(""),o=e.lines.reduce((g,C)=>g+(C.amount||0),0),c=e.lines.reduce((g,C)=>g+(C.retailPrice||0)*(C.correctedQuantity??C.quantity),0),d=e.lines.reduce((g,C)=>g+(C.receivedAmount||0),0),u=e.lines.reduce((g,C)=>g+(C.returnAmount||0),0),p=e.lines.reduce((g,C)=>g+C.quantity,0),h=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",f=n.calibrationOffsetX||0,x=n.calibrationOffsetY||0,D=`transform: translate(${f}mm, ${x}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${h}">
        ...
        ${S(w.currentDateY,i.y)}
        ${S(w.currentDateM,i.m)}
        ${S(w.currentDateD,i.d)}
        ${S(w.documentNo,e.documentNo)}
        ${e.settlementPrint?S(w.settlementCheck,"✓"):""}

        ${S(w.vendorName,t.name)}
        ${S(w.vendorAddress,t.address1)}
        ${S(w.chainStoreCode,e.chainStoreCode??"")}
        ${S(w.categoryCode,e.categoryCode??"")}
        ${S(w.slipNumber,e.documentNo)}
        ${S(w.vendorCode,e.slipTypeCode??"")}

        ${S(w.customerName,`${e.customerName} ${e.customerHonorific}`)}
        ${S(w.orderDateY,r.y)}
        ${S(w.orderDateM,r.m)}
        ${S(w.orderDateD,r.d)}
        ${S(w.deliveryDateY,a.y)}
        ${S(w.deliveryDateM,a.m)}
        ${S(w.deliveryDateD,a.d)}
        ${S(w.orderNo,e.orderNo??"")}
        ${S(w.partnerCode,e.vendorCode??"")}

        ${l}

        ${S(w.totalQty,p.toLocaleString("ja-JP"))}
        ${S(w.receivedTotal,d.toLocaleString("ja-JP"))}
        ${S(w.returnTotal,u.toLocaleString("ja-JP"))}
        ${S(w.correctedCostTotal,o.toLocaleString("ja-JP"))}
        ${S(w.correctedRetailTotal,c.toLocaleString("ja-JP"))}
        </div>
      </div>
    </div>
  `}function li(e,t,n){const{subtotal:i,taxAmount:r,total:a}=ua(e.lines,e.taxRate),l=e.previousBalance??0,o=e.paymentAmount??0,c=l-o+a,d=e.lines.map(p=>`
      <tr>
    ...
    <div class="print-page invoice-freee ${n.fontSize}">
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${E(c)}</span>
        ...
        <div>
          ${n.showRegistrationNo?`
            <div class="freee-tax-breakdown">
              <p>＜税率内訳＞</p>
              <p>${Math.round(e.taxRate*100)}%対象: ${E(i)} / 消費税: ${E(r)}</p>
            </div>`:""}
        </div>
        <table class="freee-summary-table">
          ${l?`<tr><th>前回御請求額</th><td>${E(l)}</td></tr>`:""}
          ${o?`<tr><th>ご入金額</th><td>▲ ${E(o)}</td></tr>`:""}
          <tr><th>今回御請求 小計</th><td>${E(i)}</td></tr>
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${E(r)}</td></tr>
          <tr class="freee-sum-grand"><th>合計請求額</th><td>${E(c)}</td></tr>
        </table>
      </div>
  ...
  `}function oi(e,t,n){const{subtotal:i,taxAmount:r,total:a}=ua(e.lines,e.taxRate),l=e.lines.map(c=>`
      <tr>
        ...
        <td class="numeric">${E(c.unitPrice)}</td>
        <td class="numeric">${E(c.amount)}</td>
      </tr>
    ...
    <div class="print-page quotation-freee ${n.fontSize}">
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${E(a)}</span>
          <span class="freee-total-tax">（税込）</span>
        </div>
      </div>
      ...
      <div class="freee-summary">
        ...
        <table class="freee-summary-table">
          <tr><th>小計</th><td>${E(i)}</td></tr>
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${E(r)}</td></tr>
          <tr class="freee-sum-grand"><th>合計</th><td>${E(a)}</td></tr>
        </table>
      </div>
  ...
  `}function ci(e,t,n,i){let r="";switch(e){case"chain_store":r=ii(i,n,t);break;case"quotation":r=oi(i,n,t);break;case"invoice_monthly":r=li(i,n,t);break}const a=Object.keys(Dt).map(c=>`<button class="tab-button ${e===c?"active":""}" data-print-template="${c}">${Dt[c]}</button>`).join(""),l=i.lines.map((c,d)=>`
      <tr>
...
`}async function yi(e,t){const{supabaseInsert:n}=await v(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>P);return{supabaseInsert:o}},void 0);let i=0,r=0;const l={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const o of t){if(!o._valid)continue;const{_valid:c,_error:d,...u}=o,p={...u};if(!p.id){const h=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[h]??`${e}-${Date.now()}-${i+r}`)}for(const h of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[h]=="string"&&p[h]!==""){const f=Number(p[h]);Number.isFinite(f)&&(p[h]=f)}try{await n(l,p)!==null?i++:r++}catch{r++}}return{inserted:i,failed:r}}function hi(e){const t={empty:"空",in_use:"使用中",aging:"熟成中"},n={empty:"neutral",in_use:"warning",aging:"success"},i=e.map(d=>{const u=d.capacity>0?Math.round(d.currentVolume/d.capacity*100):0;return`
  ...
  `}function Me(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function vi(e,t,n){const i=e.rows.map((d,u)=>`
      <tr>
        ...
        <td class="numeric"><strong>${Me(d.taxAmount)}</strong></td>
        <td>
      ...
      <tr>
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="type">
            ${Object.keys(Ve).map(p=>`<option value="${p}" ${p===d.type?"selected":""}>${Ve[p]}</option>`).join("")}
          </select>
        </td>
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="categoryCode">
            ${ea.map(p=>`<option value="${p.code}" ${p.code===d.categoryCode?"selected":""}>${p.code}:${p.name}</option>`).join("")}
          </select>
        </td>
        <td class="numeric">
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${Me(e.totalTax)}</p>
        ...
        <table class="entry-table">
          ...
          <tfoot>
            <tr>
              ...
              <th></th>
              <th class="numeric">${Me(e.totalTax)}</th>
              <th></th>
            </tr>
          </tfoot>
        </table>
  ...
  `}function At(e){const n=(e==null?"":e instanceof Date?e.toISOString():String(e)).replaceAll('"','""');return/[",\n\r]/.test(n)?`"${n}"`:n}function fi(e,t,n){if(t.length===0&&(!n||n.length===0))return;const i=n&&n.length>0?n:Object.keys(t[0]??{}).map(d=>({key:d,label:d})),a=`\uFEFF${[i.map(d=>At(d.label)).join(","),...t.map(d=>i.map(u=>At(d[u.key])).join(","))].join(`\r
`)}`,l=new Blob([a],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(l),c=document.createElement("a");c.href=o,c.download=e,document.body.append(c),c.click(),c.remove(),window.setTimeout(()=>URL.revokeObjectURL(o),0)}const bi=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack"],$e=[{name:"青葉商事",email:"aoba@example.jp",area:"関東",historySegment:"seasonal"},{name:"北斗酒販",email:"hokuto@example.jp",area:"北海道",historySegment:"premium"},{name:"中央フーズ",email:"chuo@example.jp",area:"関東",historySegment:"seasonal"},{name:"東海酒店",email:"tokai@example.jp",area:"中部",historySegment:"premium"},{name:"三和物産",email:"sanwa@example.jp",area:"関西",historySegment:"liqueur"},{name:"南星リカー",email:"nansei@example.jp",area:"九州",historySegment:"seasonal"},{name:"山川酒店",email:"yamakawa@example.jp",area:"関西",historySegment:"premium"},{name:"瑞穂商店",email:"mizuho@example.jp",area:"中部",historySegment:"seasonal"}],Ct=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"}];function pa(e){const t=He[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function st(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function gi(){const e=pa("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const Ie=new Date,$i=Ie.toISOString().slice(0,7),wi=Ie.getFullYear(),ki=Ie.getMonth()+1,Si=Ie.toISOString().slice(0,10),_i="C0011",H=gi();function ma(e){const t="/sake-system/".endsWith("/")?"/sake-system/".slice(0,-1):"/sake-system/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return bi.includes(n)?n:"/"}function nt(e){switch(e){case"/cat/sales":case"/invoice":case"/ledger":case"/invoice-entry":case"/delivery":case"/billing":case"/report":return"sales";case"/cat/brewery":case"/jikomi":case"/tanks":case"/kentei":case"/materials":return"brewery";case"/cat/purchase":case"/purchase":case"/raw-material":return"purchase";case"/cat/more":case"/master":case"/analytics":case"/tax":case"/store":case"/setup":return"more";case"/email":return"email";default:return"dashboard"}}const Et=ma(location.pathname),s={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,invoiceRecords:[],customerLedger:null,salesAnalytics:null,invoiceForm:st(),invoiceSaving:!1,invoiceSavedDocNo:null,pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:$i,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:wi,taxMonth:ki,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[{id:"o1",orderNo:"ORD-240416-001",customerName:"青葉商事",orderDate:"2026-04-16",deliveryDate:"2026-04-18",stage:"new",totalAmount:54e3,itemCount:3,priority:"urgent",staffName:"田中"},{id:"o2",orderNo:"ORD-240416-002",customerName:"北斗酒販",orderDate:"2026-04-16",deliveryDate:"2026-04-20",stage:"new",totalAmount:36e3,itemCount:2,priority:"normal"},{id:"o3",orderNo:"ORD-240415-003",customerName:"中央フーズ",orderDate:"2026-04-15",deliveryDate:"2026-04-17",stage:"picking",totalAmount:128e3,itemCount:6,priority:"urgent",staffName:"佐藤"},{id:"o4",orderNo:"ORD-240415-001",customerName:"東海酒店",orderDate:"2026-04-15",stage:"packed",totalAmount:72e3,itemCount:4,priority:"normal",staffName:"山田"},{id:"o5",orderNo:"ORD-240414-002",customerName:"西川商店",orderDate:"2026-04-14",deliveryDate:"2026-04-15",stage:"shipped",totalAmount:96e3,itemCount:5,priority:"normal"},{id:"o6",orderNo:"ORD-240413-001",customerName:"南部酒販",orderDate:"2026-04-13",stage:"delivered",totalAmount:48e3,itemCount:3,priority:"normal"}],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[{id:"t1",name:"鈴木 太郎",email:"suzuki@example.com",phone:"090-1234-5678",visitDate:"2026-04-22",partySize:4,language:"ja",purpose:"家族旅行の記念に",message:"蔵見学と試飲を希望します。予算は1人5000円程度です。",status:"new",createdAt:"2026-04-16T09:00:00"},{id:"t2",name:"John Smith",email:"john@example.com",visitDate:"2026-04-25",partySize:2,language:"en",purpose:"Sake tourism research",message:"We are journalists writing about Japanese sake culture. Would love to interview the toji-san.",status:"replied",createdAt:"2026-04-15T14:30:00"},{id:"t3",name:"田中 花子",email:"tanaka@example.com",phone:"03-9999-0000",visitDate:"2026-04-28",partySize:8,language:"ja",purpose:"会社の親睦会",message:"団体での訪問になります。可能であればランチも一緒にお願いします。",status:"confirmed",createdAt:"2026-04-14T10:00:00",confirmedTime:"2026-04-28T14:00"}],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,printTemplate:"chain_store",printOptions:{...si,overlayImageUrl:`${"/sake-system/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...ni},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:Si,route:Et,currentCategory:nt(Et),sidebarOpen:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:_i,masterTab:"customers",analyticsTab:"products",emailAudienceMode:H.mode,emailRegion:H.region,emailHistorySegment:H.historySegment,emailTemplateId:H.templateId,emailSubject:H.subject,emailBody:H.body,emailSaveMessage:H.saveMessage,emailSending:!1,globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function Lt(e){return e.slice(0,10)}function xi(e){return{...e}}function Ee(){s.pickerMode=null,s.pickerQuery="",s.pickerTargetLine=null}function ya(){s.invoiceForm=st(),s.invoiceSavedDocNo=null,s.invoiceErrors={},Ee()}function ha(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,i)=>{n.productCode.trim()||(t[`lines.${i}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${i}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${i}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${i}.unitPrice`]="単価は0円以上で入力してください。")}),t}function Di(e){const t=s.invoiceForm.lines[e];t&&s.invoiceForm.lines.splice(e+1,0,xi(t))}function Ai(){const e=s.invoiceRecords[0],t=s.masterStats?.customers[0],n=s.masterStats?.products.slice(0,2)??[];s.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:s.invoiceForm.staffCode||"S001",lines:n.map((i,r)=>{const a=r===0?1:2,l=1200*(r+1);return{productCode:i.code,productName:i.name,quantity:a,unitPrice:l,unit:"本",amount:a*l}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},s.invoiceSavedDocNo=null,s.invoiceErrors={}}function Ci(e){const t=s.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,!0):!1}function Ei(e){const t=s.masterStats?.customers.find(n=>n.name===e.trim());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,!0):!1}function va(e){if(M(e),s.invoiceErrors=ha(s.invoiceForm),Object.keys(s.invoiceErrors).length>0){m();return}s.invoiceSaving=!0,m(),Ut(s.invoiceForm).then(t=>{s.invoiceSavedDocNo=t.documentNo,s.invoiceSaving=!1,s.invoiceErrors={},s.invoiceForm=st(),m()}).catch(()=>{s.invoiceSaving=!1,m()})}function fa(e){const t=s.salesFilter.startDate?new Date(s.salesFilter.startDate):null,n=s.salesFilter.endDate?new Date(`${s.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((i,r)=>new Date(r.date).getTime()-new Date(i.date).getTime()).filter(i=>{const r=new Date(i.date);return!(t&&r<t||n&&r>n)})}function ba(){switch(s.emailAudienceMode){case"area":return s.emailRegion==="all"?$e:$e.filter(e=>e.area===s.emailRegion);case"history":return $e.filter(e=>e.historySegment===s.emailHistorySegment);default:return $e}}function Li(){const e=ba();return{audienceMode:s.emailAudienceMode,region:s.emailRegion,historySegment:s.emailHistorySegment,selectedTemplateId:s.emailTemplateId,subject:s.emailSubject,body:s.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:s.emailSaveMessage,sending:s.emailSending,senderId:s.emailSenderId,senders:s.mailSenders}}function Fe(e){const t=ba(),n=s.emailAudienceMode==="area"?s.emailRegion:s.emailAudienceMode==="history"?s.emailHistorySegment:"all";return{subject:s.emailSubject.trim(),body:s.emailBody.trim(),templateId:s.emailTemplateId,audienceMode:s.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(i=>i.email),status:e}}function it(){return s.user,!1}function re(){s.globalSearchOpen=!1,s.globalQuery=""}function Pi(){const e=s.globalQuery.trim().toLowerCase();return e?{customers:s.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:s.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:s.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:Ct.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:Ct}}function Ii(){let e=[],t,n="export.csv";switch(s.route){case"/sales":e=(s.salesSummary?fa(s.salesSummary):[]).map(i=>({documentNo:i.documentNo,date:i.date,customerCode:i.customerCode,customerName:i.customerName,amount:i.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...s.paymentStatus?.records??[]].sort((i,r)=>r.balanceAmount-i.balanceAmount).map(i=>({...i})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=s.invoiceRecords.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=s.purchaseList.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=s.jikomiList.map(i=>({...i})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=s.tankList.map(i=>({...i})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=s.kenteiList.map(i=>({...i})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=s.materialList.map(i=>({...i})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":s.masterTab==="customers"?(e=s.masterStats?.customers.map(i=>({...i}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=s.masterStats?.products.map(i=>({...i}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}fi(n,e,t)}function Pt(e){const t=`${"/sake-system/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),s.route=e,s.currentCategory=nt(e),s.sidebarOpen=!1,re(),lt(e)}async function lt(e){s.actionLoading=!0,m();try{switch(e){case"/delivery":s.deliveryNote||(s.deliveryNote=await Ke(s.deliverySearchDocNo||"D240122"));break;case"/billing":s.billingSummary||(s.billingSummary=await We(s.billingYearMonth));break;case"/report":s.salesReport||(s.salesReport=await Bt());break;case"/jikomi":s.jikomiList.length===0&&(s.jikomiList=await Ht());break;case"/tanks":s.tankList.length===0&&(s.tankList=await Xt());break;case"/kentei":s.kenteiList.length===0&&(s.kenteiList=await Qt());break;case"/materials":s.materialList.length===0&&(s.materialList=await Je());break;case"/purchase":(s.purchaseList.length===0||s.payableList.length===0)&&([s.purchaseList,s.payableList]=await Promise.all([Kt(),Wt()]));break;case"/raw-material":(s.billList.length===0||s.rawStockList.length===0)&&([s.billList,s.rawStockList]=await Promise.all([Gt(),Zt()]));break;case"/tax":s.taxDeclaration||(s.taxDeclaration=await Ge(s.taxYear,s.taxMonth));break;case"/store":(s.storeSales.length===0||s.storeOrders.length===0)&&([s.storeSales,s.storeOrders]=await Promise.all([Ze(s.storeSalesDate),aa()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await v(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>b);return{fetchMailSenders:n}},void 0);if(s.mailSenders=await t(),!s.emailSenderId||!s.mailSenders.find(n=>n.id===s.emailSenderId)){const n=s.mailSenders.find(i=>i.isDefault)??s.mailSenders[0];n&&(s.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await v(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>b);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await v(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>b);return{fetchIntegrationSettings:n}},void 0);s.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await v(async()=>{const{fetchShopifyOrders:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>b);return{fetchShopifyOrders:i,fetchIntegrationSettings:r}},void 0);s.shopifyOrders=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await v(async()=>{const{fetchFaxInbox:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>b);return{fetchFaxInbox:i,fetchIntegrationSettings:r}},void 0);s.faxRecords=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await v(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>b);return{fetchUserProfiles:n}},void 0);s.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:i}=await v(async()=>{const{fetchMyProfile:a,fetchAuditLogs:l,fetchMailSenders:o}=await Promise.resolve().then(()=>b);return{fetchMyProfile:a,fetchAuditLogs:l,fetchMailSenders:o}},void 0),r=s.user?.email??s.myProfile?.email??"";r&&(s.myProfile=await t(r)),s.mailSenders.length===0&&(s.mailSenders=await i()),s.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await v(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>b);return{fetchAuditLogs:n}},void 0);s.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await v(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>b);return{fetchProspects:n}},void 0);s.prospects=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:i}=await v(async()=>{const{fetchSlackRules:r,fetchSlackLogs:a,fetchIntegrationSettings:l}=await Promise.resolve().then(()=>b);return{fetchSlackRules:r,fetchSlackLogs:a,fetchIntegrationSettings:l}},void 0);s.slackRules=await t(),s.slackLogs=await n(50),s.integrations.length===0&&(s.integrations=await i())}break;case"/":{if(s.prospects.length===0){const{fetchProspects:t}=await v(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>b);return{fetchProspects:n}},void 0);s.prospects=await t()}if(s.calendarEvents.length===0){const{fetchCalendarEvents:t}=await v(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>b);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}s.materialList.length===0&&(s.materialList=await Je())}break;default:break}}catch(t){console.warn("Route data load error",t)}finally{s.actionLoading=!1,m()}}function It(){if(it())return nn(s.authError,s.authSubmitting);if(s.loading)return'<section class="panel"><p>データを読み込んでいます。</p></section>';if(s.error)return`
      <section class="panel error-card">
        <p class="eyebrow">読込失敗</p>
        <h1>画面の初期化に失敗しました</h1>
        <p>${s.error}</p>
      </section>
    `;switch(s.route){case"/cat/sales":return pe("sales");case"/cat/brewery":return pe("brewery");case"/cat/purchase":return pe("purchase");case"/cat/more":return pe("more");case"/invoice-entry":return Hs(s.invoiceForm,s.invoiceSavedDocNo,s.invoiceSaving,s.invoiceErrors);case"/email":return Vs(Li());case"/delivery":return s.deliveryNote?zs(s.deliveryNote,s.deliverySearchDocNo):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/billing":return s.billingSummary?Ls(s.billingSummary,s.billingYearMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/report":return s.salesReport?xn(s.salesReport):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/jikomi":return s.jikomiView==="calendar"?`${gt(s.jikomiList,s.jikomiView)}${tn(s.jikomiList)}`:gt(s.jikomiList,s.jikomiView);case"/tanks":return hi(s.tankList);case"/kentei":return an(s.kenteiList);case"/materials":return dn(s.materialList)+rn(s.materialEditing,s.materialEditingIsNew);case"/purchase":return hn(s.purchaseList,s.payableList);case"/raw-material":return vn(s.billList,s.rawStockList);case"/tax":return s.taxDeclaration?vi(s.taxDeclaration,s.taxYear,s.taxMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/store":return En(s.storeSales,s.storeOrders,s.storeTab,s.storeSalesDate);case"/setup":return s.pipelineMeta?gn(s.pipelineMeta,z,F):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/import":return Pn(s.importEntity,s.importPreview,s.importing,s.importResult);case"/print":return ci(s.printTemplate,s.printOptions,s.printCompany,s.printData);case"/form-designer":return Nn(s.printData,s.printCompany,s.printOptions,s.fdSavedPositions,s.fdDesignMode);case"/map":{const e=(s.masterStats?.customers??[]).slice(0,100).map((t,n)=>({...t,lat:35.37+n%10*.02+Math.random()*.01,lng:139.29+n%10*.02+Math.random()*.01,address1:["神奈川県秦野市","東京都新宿区","横浜市西区","川崎市幸区"][n%4],businessType:["酒店","飲食店","百貨店","スーパー"][n%4],lastOrderAmount:5e4+n%10*2e4}));return Tn(e,s.mapRegionFilter)}case"/workflow":return Rn(s.workflowOrders);case"/mobile-order":return qn(s.mobileOrder,s.masterStats?.customers??[],s.masterStats?.products??[]);case"/tour":return Fn(s.tourInquiries,s.tourActiveId);case"/mail-senders":return Vn(s.mailSenders,s.mailSenderEditingId);case"/calendar":return Un(s.calendarEvents,s.calendarYearMonth,s.calendarFilterCategory,s.calendarEdit);case"/integrations":return Yn(s.integrations,s.integrationEditingId);case"/shopify":{const e=s.integrations.find(t=>t.id==="shopify");return Hn(s.shopifyOrders,e?.lastSyncAt??null)}case"/fax":return Xn(s.faxRecords,s.faxProcessing,s.faxOcrText);case"/users":return Qn(s.userProfiles,s.userEditingId,s.myProfile);case"/profile":return Kn(s.myProfile,s.auditLogs.filter(e=>e.userEmail===s.myProfile?.email),s.mailSenders);case"/audit":return Wn(s.auditLogs);case"/prospects":{const e={prospects:s.prospects,activities:s.prospectActivities,editingId:s.prospectEditingId,viewMode:s.prospectViewMode};return Gn(e)}case"/slack":{const e=s.integrations.find(t=>t.provider==="slack")??null;return ai(e,s.slackRules,s.slackLogs)}}if(!s.salesSummary||!s.paymentStatus||!s.masterStats||!s.pipelineMeta||!s.customerLedger||!s.salesAnalytics)return"";switch(s.route){case"/sales":return Cn(fa(s.salesSummary),s.salesFilter.startDate,s.salesFilter.endDate);case"/payment":return mn([...s.paymentStatus.records].sort((e,t)=>t.balanceAmount-e.balanceAmount));case"/master":return cn(s.masterStats,s.masterTab);case"/invoice":return Ks(s.invoiceRecords,s.invoiceFilter);case"/ledger":return js(s.customerLedger,s.ledgerCustomerCode);case"/analytics":return _n(s.salesAnalytics,s.analyticsTab);default:return qs(s.salesSummary,s.pipelineMeta,s.salesAnalytics,{prospects:s.prospects,upcomingEvents:s.calendarEvents,tourInquiries:s.tourInquiries,workflowOrdersCount:{new:s.workflowOrders.filter(e=>e.stage==="new").length,picking:s.workflowOrders.filter(e=>e.stage==="picking").length,packed:s.workflowOrders.filter(e=>e.stage==="packed").length,shipped:s.workflowOrders.filter(e=>e.stage==="shipped").length,total:s.workflowOrders.length},lowStockCount:s.materialList.filter(e=>e.currentStock<e.minimumStock*1.5).length})}}function Ni(){if(it())return`
      <div class="shell auth-shell">
        <main class="main auth-main">
          <div class="view">${It()}</div>
        </main>
      </div>
    `;const e={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売管理",items:[{path:"/cat/sales",label:"販売管理トップ",kicker:"Category"},{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/report",label:"集計帳票",kicker:"Report"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],brewery:[{label:"蔵内管理",items:[{path:"/cat/brewery",label:"蔵内管理トップ",kicker:"Category"},{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"}]}],purchase:[{label:"仕入管理",items:[{path:"/cat/purchase",label:"仕入管理トップ",kicker:"Category"},{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],more:[{label:"その他",items:[{path:"/cat/more",label:"その他トップ",kicker:"Category"},{path:"/tax",label:"酒税申告",kicker:"Tax"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/master",label:"マスタ",kicker:"Master"},{path:"/email",label:"メール配信",kicker:"Mail"},{path:"/setup",label:"連動設定",kicker:"Setup"}]}],email:[{label:"メール配信",items:[{path:"/email",label:"季節商品案内",kicker:"Mail"}]}]},t=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/cat/sales",label:"販売管理"},{category:"brewery",path:"/cat/brewery",label:"蔵内管理"},{category:"purchase",path:"/cat/purchase",label:"仕入管理"},{category:"more",path:"/cat/more",label:"その他"},{category:"email",path:"/email",label:"メール配信"}],n=e[s.currentCategory].map(o=>`
      ...
      `).join(""),r=s.pickerMode&&s.masterStats?s.pickerMode==="customer"?Bs(s.masterStats.customers,s.pickerQuery):yn(s.masterStats.products,s.pickerQuery):"",a=s.globalSearchOpen?Us(s.globalQuery,Pi()):"",l=s.user?`
    ...
    <div class="shell">
      ...
      <main class="main">
        ...
        <div class="view ${s.actionLoading?"is-busy":""}">${It()}</div>
      </main>
      ${r}
      ${a}
    </div>
  `}async function Ti(e){s.actionLoading=!0,m();try{s.invoiceRecords=await xe(e)}finally{s.actionLoading=!1,m()}}async function ji(e){s.actionLoading=!0,m();try{s.customerLedger=await Qe(e)}finally{s.actionLoading=!1,m()}}function M(e){s.invoiceForm={invoiceType:e.querySelector("#inv-type")?.value??s.invoiceForm.invoiceType,invoiceDate:e.querySelector("#inv-date")?.value??s.invoiceForm.invoiceDate,customerCode:e.querySelector("#inv-customer-code")?.value??s.invoiceForm.customerCode,customerName:e.querySelector("#inv-customer-name")?.value??s.invoiceForm.customerName,staffCode:e.querySelector("#inv-staff")?.value??s.invoiceForm.staffCode,lines:s.invoiceForm.lines.map((t,n)=>{const i=parseFloat(e.querySelector(`[data-line="${n}"][data-field="quantity"]`)?.value??"")||0,r=parseFloat(e.querySelector(`[data-line="${n}"][data-field="unitPrice"]`)?.value??"")||0;return{...t,productCode:e.querySelector(`[data-line="${n}"][data-field="productCode"]`)?.value??t.productCode,productName:e.querySelector(`[data-line="${n}"][data-field="productName"]`)?.value??t.productName,unit:e.querySelector(`[data-line="${n}"][data-field="unit"]`)?.value??t.unit,quantity:i,unitPrice:r,amount:i*r}}),note:e.querySelector("#inv-note")?.value??s.invoiceForm.note},s.invoiceForm.customerCode=s.invoiceForm.customerCode.trim().toUpperCase(),s.invoiceForm.customerName=s.invoiceForm.customerName.trim()}function X(e){const t=e.querySelector("input[name='email-audience-mode']:checked")?.value??s.emailAudienceMode;s.emailAudienceMode=t,s.emailRegion=e.querySelector("#email-region")?.value??s.emailRegion,s.emailHistorySegment=e.querySelector("#email-history-segment")?.value??s.emailHistorySegment,s.emailSubject=e.querySelector("#email-subject")?.value??s.emailSubject,s.emailBody=e.querySelector("#email-body")?.value??s.emailBody}function Oi(e){e.querySelector("[data-action='global-search-open']")?.addEventListener("click",()=>{s.globalSearchOpen=!0,m()}),e.querySelectorAll("[data-action='global-search-close']").forEach(a=>{a.addEventListener("click",l=>{a.classList.contains("global-search")&&l.target instanceof HTMLElement&&!l.target.classList.contains("global-search")||(re(),m())})}),e.querySelector("#global-search-input")?.addEventListener("input",a=>{s.globalQuery=a.target.value,m()}),e.querySelectorAll("[data-action='global-nav']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.path;l&&(re(),Pt(l))})}),e.querySelector("[data-action='csv-export']")?.addEventListener("click",()=>{Ii()}),e.querySelectorAll("[data-jikomi-tab]").forEach(a=>{a.addEventListener("click",()=>{s.jikomiView=a.dataset.jikomiTab,m()})}),e.querySelector("[data-action='auth-login']")?.addEventListener("click",()=>{const a=e.querySelector("#auth-email")?.value.trim()??"",l=e.querySelector("#auth-password")?.value??"";s.authSubmitting=!0,s.authError=null,m(),_a(a,l).then(async o=>{s.user=o,s.authSkipped=!1,s.authSubmitting=!1,s.authError=null;const{fetchMyProfile:c,recordAudit:d}=await v(async()=>{const{fetchMyProfile:u,recordAudit:p}=await Promise.resolve().then(()=>b);return{fetchMyProfile:u,recordAudit:p}},void 0);s.myProfile=await c(o.email),await d({action:"sign_in",userEmail:o.email}),m()}).catch(async o=>{try{const c=await rt(a,l);s.user=c,s.authSkipped=!1,s.authError=null;const{fetchMyProfile:d}=await v(async()=>{const{fetchMyProfile:u}=await Promise.resolve().then(()=>b);return{fetchMyProfile:u}},void 0);s.myProfile=await d(c.email)}catch{s.authError=o instanceof Error?o.message:"ログインに失敗しました。"}finally{s.authSubmitting=!1,m()}})}),e.querySelector("[data-action='auth-skip']")?.addEventListener("click",()=>{s.authSkipped=!0,s.authError=null,m()}),e.querySelector("[data-action='auth-logout']")?.addEventListener("click",()=>{xa().finally(()=>{location.reload()})}),e.querySelector("[data-action='sidebar-open']")?.addEventListener("click",()=>{s.sidebarOpen=!0,m()}),e.querySelectorAll("[data-action='sidebar-close']").forEach(a=>{a.addEventListener("click",()=>{s.sidebarOpen=!1,m()})}),e.querySelectorAll("[data-link]").forEach(a=>{a.addEventListener("click",l=>{l.preventDefault(),Pt(a.dataset.link)})}),e.querySelector("[data-action='sales-filter']")?.addEventListener("click",()=>{const a=e.querySelector("#sales-start")?.value??"",l=e.querySelector("#sales-end")?.value??"";s.salesFilter={startDate:a,endDate:l},m()}),e.querySelector("[data-action='invoice-filter']")?.addEventListener("click",()=>{const a={documentNo:e.querySelector("#invoice-document-no")?.value??"",startDate:e.querySelector("#invoice-start")?.value??"",endDate:e.querySelector("#invoice-end")?.value??"",customerCode:e.querySelector("#invoice-customer-code")?.value??""};s.invoiceFilter=a,Ti(a)}),e.querySelector("[data-action='ledger-search']")?.addEventListener("click",()=>{const a=e.querySelector("#ledger-customer-code")?.value??"";s.ledgerCustomerCode=a.trim().toUpperCase(),ji(s.ledgerCustomerCode)}),e.querySelectorAll("[data-tab]").forEach(a=>{a.addEventListener("click",()=>{s.masterTab=a.dataset.tab,m()})}),e.querySelectorAll("[data-analytics-tab]").forEach(a=>{a.addEventListener("click",()=>{s.analyticsTab=a.dataset.analyticsTab,m()})}),e.querySelector("[data-action='add-line']")?.addEventListener("click",()=>{M(e),s.invoiceForm.lines.push({productCode:"",productName:"",quantity:0,unitPrice:0,unit:"本",amount:0}),s.invoiceErrors={},m()}),e.querySelectorAll("[data-action='remove-line']").forEach(a=>{a.addEventListener("click",()=>{M(e);const l=parseInt(a.dataset.line??"0",10);s.invoiceForm.lines.splice(l,1),s.invoiceErrors=ha(s.invoiceForm),m()})}),e.querySelectorAll("[data-action='duplicate-line']").forEach(a=>{a.addEventListener("click",()=>{M(e),Di(parseInt(a.dataset.line??"0",10)),s.invoiceErrors={},m()})}),e.querySelector("[data-action='copy-past-invoice']")?.addEventListener("click",()=>{Ai(),m()}),e.querySelector("[data-action='open-customer-picker']")?.addEventListener("click",()=>{M(e),s.pickerMode="customer",s.pickerTargetLine=null,s.pickerQuery=s.invoiceForm.customerCode||s.invoiceForm.customerName,m()}),e.querySelectorAll("[data-action='open-product-picker']").forEach(a=>{a.addEventListener("click",()=>{M(e);const l=parseInt(a.dataset.line??"0",10),o=s.invoiceForm.lines[l];s.pickerMode="product",s.pickerTargetLine=l,s.pickerQuery=o?o.productCode||o.productName:"",m()})}),e.querySelectorAll("[data-action='modal-close']").forEach(a=>{a.addEventListener("click",l=>{a.classList.contains("modal-backdrop")&&l.target instanceof HTMLElement&&!l.target.classList.contains("modal-backdrop")||(Ee(),m())})}),e.querySelectorAll("[data-action='picker-select']").forEach(a=>{const l=()=>{const o=a.dataset.code??"",c=a.dataset.name??"";if(s.pickerMode==="customer")s.invoiceForm.customerCode=o,s.invoiceForm.customerName=c,delete s.invoiceErrors.customerCode;else if(s.pickerMode==="product"&&s.pickerTargetLine!==null){const d=s.invoiceForm.lines[s.pickerTargetLine];d&&(d.productCode=o,d.productName=c,d.amount=d.quantity*d.unitPrice,delete s.invoiceErrors[`lines.${s.pickerTargetLine}.productCode`],delete s.invoiceErrors[`lines.${s.pickerTargetLine}.productName`])}Ee(),m()};a.addEventListener("click",l),a.addEventListener("keydown",o=>{o.key==="Enter"&&l()})}),e.querySelector("#modal-search")?.addEventListener("input",a=>{s.pickerQuery=a.target.value,m()}),e.querySelector("[data-action='invoice-clear']")?.addEventListener("click",()=>{ya(),m()}),e.querySelector("[data-action='invoice-save']")?.addEventListener("click",()=>{va(e)}),e.querySelector("#inv-customer-code")?.addEventListener("blur",()=>{M(e),Ci(s.invoiceForm.customerCode)&&(delete s.invoiceErrors.customerCode,m())}),e.querySelector("#inv-customer-name")?.addEventListener("blur",()=>{M(e),Ei(s.invoiceForm.customerName)&&(delete s.invoiceErrors.customerCode,m())}),e.querySelectorAll("#inv-date, #inv-customer-code, #inv-customer-name, #inv-staff, #inv-note, [data-field], #inv-type").forEach(a=>{a.addEventListener("input",()=>{M(e),s.invoiceSavedDocNo=null})}),e.querySelector("#inv-type")?.addEventListener("change",()=>{M(e),s.invoiceSavedDocNo=null}),e.querySelector("[data-action='delivery-search']")?.addEventListener("click",()=>{const a=e.querySelector("#delivery-docno")?.value??"";s.deliverySearchDocNo=a.trim(),s.deliveryNote=null,s.actionLoading=!0,m(),Ke(s.deliverySearchDocNo||"D240122").then(l=>{s.deliveryNote=l,s.actionLoading=!1,m()})}),e.querySelector("[data-action='billing-load']")?.addEventListener("click",()=>{const a=e.querySelector("#billing-month")?.value??s.billingYearMonth;s.billingYearMonth=a,s.billingSummary=null,s.actionLoading=!0,m(),We(a).then(l=>{s.billingSummary=l,s.actionLoading=!1,m()})}),e.querySelector("[data-action='tax-load']")?.addEventListener("click",()=>{const a=parseInt(e.querySelector("#tax-year")?.value??String(s.taxYear),10),l=parseInt(e.querySelector("#tax-month")?.value??String(s.taxMonth),10);s.taxYear=a,s.taxMonth=l,s.taxDeclaration=null,s.actionLoading=!0,m(),Ge(a,l).then(o=>{s.taxDeclaration=o,s.actionLoading=!1,m()})}),e.querySelector("[data-action='tax-export-xml']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{generateTaxXML:a}=await v(async()=>{const{generateTaxXML:u}=await Promise.resolve().then(()=>b);return{generateTaxXML:u}},void 0),l=a(s.taxDeclaration),o=new Blob([l],{type:"application/xml;charset=utf-8"}),c=URL.createObjectURL(o),d=document.createElement("a");d.href=c,d.download=`tax-${s.taxYear}-${String(s.taxMonth).padStart(2,"0")}.xml`,d.click(),URL.revokeObjectURL(c)}),e.querySelector("[data-action='tax-export-csv']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{generateTaxCSV:a}=await v(async()=>{const{generateTaxCSV:u}=await Promise.resolve().then(()=>b);return{generateTaxCSV:u}},void 0),l=a(s.taxDeclaration),o=new Blob([l],{type:"text/csv;charset=utf-8"}),c=URL.createObjectURL(o),d=document.createElement("a");d.href=c,d.download=`tax-${s.taxYear}-${String(s.taxMonth).padStart(2,"0")}.csv`,d.click(),URL.revokeObjectURL(c)}),e.querySelector("[data-action='tax-save-draft']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{saveTaxDeclaration:a}=await v(async()=>{const{saveTaxDeclaration:l}=await Promise.resolve().then(()=>b);return{saveTaxDeclaration:l}},void 0);try{await a(s.taxDeclaration),alert("下書き保存しました（Supabase tax_declarationsに保存）")}catch(l){alert("保存に失敗: "+(l instanceof Error?l.message:String(l)))}}),e.querySelectorAll("[data-tax-row][data-tax-field]").forEach(a=>{a.addEventListener("change",async()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.taxRow),o=a.dataset.taxField,c=a.type==="number"?Number(a.value)||0:a.value,d=[...s.taxDeclaration.rows];d[l]={...d[l],[o]:c};const{recalculateTaxDeclaration:u}=await v(async()=>{const{recalculateTaxDeclaration:p}=await Promise.resolve().then(()=>b);return{recalculateTaxDeclaration:p}},void 0);s.taxDeclaration=u({...s.taxDeclaration,rows:d}),m()})}),e.querySelectorAll("[data-ded-row][data-ded-field]").forEach(a=>{a.addEventListener("change",()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.dedRow),o=a.dataset.dedField,c=a.type==="number"?Number(a.value)||0:a.value,d=[...s.taxDeclaration.deductions];d[l]={...d[l],[o]:c},s.taxDeclaration={...s.taxDeclaration,deductions:d},m()})}),e.querySelectorAll("input[data-tax-field]:not([data-tax-row])").forEach(a=>{a.addEventListener("change",()=>{if(!s.taxDeclaration)return;const l=a.dataset.taxField;s.taxDeclaration={...s.taxDeclaration,[l]:a.value}})}),e.querySelector("[data-action='tax-add-category']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{recalculateTaxDeclaration:a,TAX_RATE_CATEGORIES:l}=await v(async()=>{const{recalculateTaxDeclaration:d,TAX_RATE_CATEGORIES:u}=await Promise.resolve().then(()=>b);return{recalculateTaxDeclaration:d,TAX_RATE_CATEGORIES:u}},void 0),o=l[0],c={taxCategory:o.code,taxCategoryName:o.name,alcoholDegree:15,productionVolume:0,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:0,taxableVolume:0,volume:0,taxRate:o.taxRatePerLiter,taxAmount:0};s.taxDeclaration=a({...s.taxDeclaration,rows:[...s.taxDeclaration.rows,c]}),m()}),e.querySelectorAll("[data-action='tax-remove-category']").forEach(a=>{a.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.taxRow),{recalculateTaxDeclaration:o}=await v(async()=>{const{recalculateTaxDeclaration:d}=await Promise.resolve().then(()=>b);return{recalculateTaxDeclaration:d}},void 0),c=s.taxDeclaration.rows.filter((d,u)=>u!==l);s.taxDeclaration=o({...s.taxDeclaration,rows:c}),m()})}),e.querySelector("[data-action='tax-add-deduction']")?.addEventListener("click",()=>{if(!s.taxDeclaration)return;const a={type:"export",categoryCode:"01",volume:0,reason:"",documentNo:""};s.taxDeclaration={...s.taxDeclaration,deductions:[...s.taxDeclaration.deductions,a]},m()}),e.querySelectorAll("[data-action='tax-remove-deduction']").forEach(a=>{a.addEventListener("click",()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.dedRow),o=s.taxDeclaration.deductions.filter((c,d)=>d!==l);s.taxDeclaration={...s.taxDeclaration,deductions:o},m()})}),e.querySelectorAll("[data-store-tab]").forEach(a=>{a.addEventListener("click",()=>{s.storeTab=a.dataset.storeTab,m()})}),e.querySelectorAll("[data-import-entity]").forEach(a=>{a.addEventListener("click",()=>{s.importEntity=a.dataset.importEntity,s.importPreview=null,s.importResult=null,m()})}),e.querySelector("[data-action='download-template']")?.addEventListener("click",()=>{const a=mi(s.importEntity),l=new Blob([a],{type:"text/csv;charset=utf-8"}),o=URL.createObjectURL(l),c=document.createElement("a");c.href=o,c.download=`template_${s.importEntity}.csv`,c.click(),URL.revokeObjectURL(o)}),e.querySelector("[data-action='import-parse']")?.addEventListener("click",()=>{const l=e.querySelector("#import-file")?.files?.[0];if(!l){alert("CSVファイルを選択してください");return}const o=new FileReader;o.onload=()=>{const c=String(o.result??""),{columns:d,rows:u}=ui(c);s.importPreview=pi(s.importEntity,d,u),s.importResult=null,m()},o.readAsText(l,"utf-8")}),e.querySelector("[data-action='import-cancel']")?.addEventListener("click",()=>{s.importPreview=null,s.importResult=null,m()}),e.querySelectorAll("[data-print-template]").forEach(a=>{a.addEventListener("click",()=>{s.printTemplate=a.dataset.printTemplate,m()})}),e.querySelectorAll("[data-print-field]").forEach(a=>{a.addEventListener("change",()=>{const l=a.dataset.printField;let o=a.value;(l==="taxRate"||l==="previousBalance"||l==="paymentAmount")&&(o=Number(a.value)||0),s.printData={...s.printData,[l]:o},m()})}),e.querySelectorAll("[data-print-opt]").forEach(a=>{const l=()=>{const o=a.dataset.printOpt;let c;a.type==="checkbox"?c=a.checked:o==="copies"?c=Number(a.value)||1:o==="overlayOpacity"||o==="calibrationOffsetX"||o==="calibrationOffsetY"?c=Number(a.value)||0:c=a.value,s.printOptions={...s.printOptions,[o]:c},m()};a.addEventListener("change",l),a.type==="range"&&a.addEventListener("input",l)}),e.querySelectorAll("[data-print-line][data-print-lfield]").forEach(a=>{a.addEventListener("change",()=>{const l=Number(a.dataset.printLine),o=a.dataset.printLfield,c=[...s.printData.lines];let d=a.value;(o==="quantity"||o==="unitPrice")&&(d=Number(a.value)||0),c[l]={...c[l],[o]:d},c[l].amount=(Number(c[l].quantity)||0)*(Number(c[l].unitPrice)||0),s.printData={...s.printData,lines:c},m()})}),e.querySelector("[data-action='print-add-line']")?.addEventListener("click",()=>{s.printData={...s.printData,lines:[...s.printData.lines,{productCode:"",productName:"",spec:"",quantity:0,unit:"本",unitPrice:0,amount:0}]},m()}),e.querySelectorAll("[data-action='print-remove-line']").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.printLine);s.printData={...s.printData,lines:s.printData.lines.filter((o,c)=>c!==l)},m()})}),e.querySelector("[data-action='print-save-settings']")?.addEventListener("click",()=>{try{localStorage.setItem("sake_print_options",JSON.stringify(s.printOptions)),localStorage.setItem("sake_print_company",JSON.stringify(s.printCompany)),alert("印刷設定を保存しました（次回以降も使えます）")}catch(a){alert("保存失敗: "+(a instanceof Error?a.message:String(a)))}}),e.querySelector("[data-action='print-open-company']")?.addEventListener("click",()=>{const a=s.printCompany,l=prompt("会社名",a.name);if(l===null)return;const o=prompt("郵便番号",a.postalCode)??a.postalCode,c=prompt("住所",a.address1)??a.address1,d=prompt("TEL",a.tel)??a.tel,u=prompt("FAX",a.fax)??a.fax,p=prompt("適格請求書登録番号 (T+13桁)",a.registrationNo)??a.registrationNo,h=prompt("取引銀行名",a.bankName)??a.bankName,f=prompt("支店名",a.bankBranch)??a.bankBranch,x=prompt("口座番号",a.bankAccountNo)??a.bankAccountNo,D=prompt("口座名義",a.bankAccountHolder)??a.bankAccountHolder;s.printCompany={...a,name:l,postalCode:o,address1:c,tel:d,fax:u,registrationNo:p,bankName:h,bankBranch:f,bankAccountNo:x,bankAccountHolder:D},m()}),e.querySelector("[data-action='fd-toggle-design']")?.addEventListener("click",()=>{s.fdDesignMode=!s.fdDesignMode,m()}),e.querySelector("[data-action='fd-save-cloud']")?.addEventListener("click",async()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const o=(e.querySelector("#fd-layout-name")?.value??"").trim()||"デフォルト",c=Re(a),{savePrintLayout:d}=await v(async()=>{const{savePrintLayout:p}=await Promise.resolve().then(()=>b);return{savePrintLayout:p}},void 0),u={id:`bp1701_${o.replaceAll(/[^a-zA-Z0-9_-]/g,"_")}_${Date.now()}`,name:o,templateKey:"chain_store",positions:c};try{await d(u)?(alert(`☁️ クラウド保存成功: ${o}`),s.fdSavedPositions=c,localStorage.setItem("sake_fd_positions",JSON.stringify(c)),m()):(alert("保存に失敗しました。ローカルには保存されました。"),localStorage.setItem("sake_fd_positions",JSON.stringify(c)))}catch(p){alert("保存エラー: "+(p instanceof Error?p.message:""))}}),e.querySelector("[data-action='fd-save-local']")?.addEventListener("click",()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const l=Re(a);s.fdSavedPositions=l;try{localStorage.setItem("sake_fd_positions",JSON.stringify(l)),alert(`📁 このPCに保存: ${Object.keys(l).length}件`)}catch(o){alert("保存失敗: "+(o instanceof Error?o.message:""))}}),e.querySelector("[data-action='fd-export-json']")?.addEventListener("click",()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const o={templateKey:"chain_store",positions:Re(a),exportedAt:new Date().toISOString()},c=new Blob([JSON.stringify(o,null,2)],{type:"application/json"}),d=URL.createObjectURL(c),u=document.createElement("a");u.href=d,u.download=`bp1701_layout_${new Date().toISOString().slice(0,10)}.json`,u.click(),URL.revokeObjectURL(d)}),e.querySelector("[data-action='fd-import-json']")?.addEventListener("click",()=>{e.querySelector("#fd-import-file")?.click()}),e.querySelector("#fd-import-file")?.addEventListener("change",async a=>{const l=a.target.files?.[0];if(l)try{const o=await l.text(),d=JSON.parse(o).positions;if(!d)throw new Error("positions field not found");s.fdSavedPositions=d,localStorage.setItem("sake_fd_positions",JSON.stringify(d)),alert(`📥 インポート成功: ${Object.keys(d).length}件`),m()}catch(o){alert("インポート失敗: "+(o instanceof Error?o.message:""))}});const t=e.querySelector("#fd-saved-layouts");t&&s.route==="/form-designer"&&s.fdDesignMode&&(async()=>{const{fetchPrintLayouts:a}=await v(async()=>{const{fetchPrintLayouts:o}=await Promise.resolve().then(()=>b);return{fetchPrintLayouts:o}},void 0),l=await a("chain_store");l.length===0?t.innerHTML="☁️ クラウドに保存されたレイアウトはありません":(t.innerHTML=`☁️ クラウド保存済み (${l.length}件):<br/>`+l.map(o=>`<button class="button-sm secondary" data-action="fd-load-layout" data-layout-id="${o.id}" style="margin:4px 4px 0 0;">${o.name}</button>
                 <button class="button-sm secondary" data-action="fd-delete-layout" data-layout-id="${o.id}" title="削除" style="margin:4px 8px 0 0;color:var(--danger);">✕</button>`).join(""),t.querySelectorAll("[data-action='fd-load-layout']").forEach(o=>{o.addEventListener("click",()=>{const c=o.dataset.layoutId,d=l.find(u=>u.id===c);d&&(s.fdSavedPositions=d.positions,localStorage.setItem("sake_fd_positions",JSON.stringify(d.positions)),alert(`読込完了: ${d.name}`),m())})}),t.querySelectorAll("[data-action='fd-delete-layout']").forEach(o=>{o.addEventListener("click",async()=>{const c=o.dataset.layoutId;if(!c||!confirm("このレイアウトを削除しますか？"))return;const{deletePrintLayout:d}=await v(async()=>{const{deletePrintLayout:p}=await Promise.resolve().then(()=>b);return{deletePrintLayout:p}},void 0);await d(c)?(alert("削除しました"),m()):alert("削除失敗")})}))})(),e.querySelector("[data-action='fd-reset-positions']")?.addEventListener("click",()=>{confirm("フィールド位置を初期値に戻しますか？")&&(s.fdSavedPositions=null,localStorage.removeItem("sake_fd_positions"),m())});const n=e.querySelector("#fd-sel-x"),i=e.querySelector("#fd-sel-y");[n,i].forEach(a=>{a?.addEventListener("change",()=>{if(!s.fdActiveFieldId)return;const l=document.querySelector(`[data-fd-id="${s.fdActiveFieldId}"]`);l&&(n&&(l.style.left=n.value+"mm"),i&&(l.style.top=i.value+"mm"))})});const r=e.querySelector("#customer-map");r&&s.route==="/map"&&ga(r),e.querySelectorAll(".wf-card").forEach(a=>{a.addEventListener("dragstart",l=>{a.classList.add("wf-dragging"),l.dataTransfer?.setData("text/plain",a.dataset.wfOrder??"")}),a.addEventListener("dragend",()=>a.classList.remove("wf-dragging"))}),e.querySelectorAll(".wf-col").forEach(a=>{a.addEventListener("dragover",l=>l.preventDefault()),a.addEventListener("drop",l=>{l.preventDefault();const o=l.dataTransfer?.getData("text/plain"),c=a.dataset.wfStage;if(!o||!c)return;const d=s.workflowOrders.find(u=>u.id===o);d&&(d.stage=c,m())})}),e.querySelectorAll("[data-mo-step]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moStep;a.disabled||(s.mobileOrder.step=l,m())})}),e.querySelector("#mo-customer-q")?.addEventListener("input",a=>{s.mobileOrder.customerQuery=a.target.value,m()}),e.querySelector("#mo-product-q")?.addEventListener("input",a=>{s.mobileOrder.productQuery=a.target.value,m()}),e.querySelectorAll("[data-mo-select-customer]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moSelectCustomer,o=s.masterStats?.customers.find(c=>c.id===l);o&&(s.mobileOrder.selectedCustomer=o),m()})}),e.querySelectorAll("[data-mo-add-product]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moAddProduct,o=s.masterStats?.products.find(d=>d.code===l);if(!o)return;const c=1800;s.mobileOrder.cart.push({productCode:o.code,productName:o.name,quantity:1,unit:"本",unitPrice:c,amount:c}),m()})}),e.querySelectorAll("[data-mo-qty]").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.moQty),o=a.dataset.moProduct,c=s.mobileOrder.cart.find(d=>d.productCode===o);c&&(c.quantity=Math.max(0,c.quantity+l),c.amount=c.quantity*c.unitPrice,c.quantity===0&&(s.mobileOrder.cart=s.mobileOrder.cart.filter(d=>d.productCode!==o)),m())})}),e.querySelectorAll("[data-mo-remove]").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.moRemove);s.mobileOrder.cart.splice(l,1),m()})}),e.querySelector("[data-action='mo-submit']")?.addEventListener("click",async()=>{const a=e.querySelector("#mo-memo");s.mobileOrder.memo=a?.value??"";const l="MO"+Date.now().toString().slice(-8);s.mobileOrder.submittedDocNo=l,s.mobileOrder.step="done",m()}),e.querySelector("[data-action='mo-reset']")?.addEventListener("click",()=>{s.mobileOrder={step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},m()}),e.querySelectorAll("[data-tour-id]").forEach(a=>{a.addEventListener("click",()=>{s.tourActiveId=a.dataset.tourId??null,m()})}),e.querySelectorAll("[data-action='tour-insert-template']").forEach(a=>{a.addEventListener("click",()=>{const l=s.tourInquiries.find(p=>p.id===s.tourActiveId);if(!l)return;const o=a.dataset.template==="confirm"?zn:Jn,c=e.querySelector("#tour-confirmed-time"),d=o.replaceAll("{name}",l.name).replaceAll("{partySize}",String(l.partySize)).replaceAll("{confirmedTime}",c?.value??l.visitDate),u=e.querySelector("#tour-reply-body");u&&(u.value=d)})}),e.querySelector("[data-action='tour-send-reply']")?.addEventListener("click",()=>{const a=document.querySelector("[data-action='tour-send-reply']")?.dataset.tourId??"",l=s.tourInquiries.find(c=>c.id===a);if(!l)return;const o=e.querySelector("#tour-confirmed-time");l.status="confirmed",l.repliedAt=new Date().toISOString(),l.confirmedTime=o?.value??"",alert("返信メールを下書き保存し、ステータスを確定にしました（実送信はSupabase連携で実装）"),m()}),e.querySelectorAll("[data-prospect-view]").forEach(a=>{a.addEventListener("click",()=>{s.prospectViewMode=a.dataset.prospectView,m()})}),e.querySelector("[data-action='prospect-new']")?.addEventListener("click",()=>{s.prospectEditingId="__new__",m()}),e.querySelectorAll("[data-action='prospect-edit']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??null;if(s.prospectEditingId=l,l){const{fetchProspectActivities:o}=await v(async()=>{const{fetchProspectActivities:c}=await Promise.resolve().then(()=>b);return{fetchProspectActivities:c}},void 0);s.prospectActivities=await o(l)}m()})}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.prospectId??null;if(s.prospectEditingId=l,l){const{fetchProspectActivities:o}=await v(async()=>{const{fetchProspectActivities:c}=await Promise.resolve().then(()=>b);return{fetchProspectActivities:c}},void 0);s.prospectActivities=await o(l)}m()})}),e.querySelectorAll("[data-action='prospect-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.prospectEditingId=null,s.prospectActivities=[],m())})}),e.querySelector("[data-action='prospect-save']")?.addEventListener("click",async()=>{const a=s.prospectEditingId==="__new__",l=a?`p_${Date.now()}`:s.prospectEditingId??"",o={id:l,companyName:e.querySelector("#prospect-company")?.value??"",contactName:e.querySelector("#prospect-contact")?.value??"",email:e.querySelector("#prospect-email")?.value??"",phone:e.querySelector("#prospect-phone")?.value??"",businessType:e.querySelector("#prospect-business-type")?.value??"",stage:e.querySelector("#prospect-stage")?.value??"cold",source:e.querySelector("#prospect-source")?.value??"",expectedAmount:Number(e.querySelector("#prospect-amount")?.value)||0,probability:Number(e.querySelector("#prospect-probability")?.value)||0,assignedStaffCode:e.querySelector("#prospect-staff")?.value??"",nextActionDate:e.querySelector("#prospect-next-date")?.value??"",nextAction:e.querySelector("#prospect-next-action")?.value??"",note:e.querySelector("#prospect-note")?.value??""};if(!o.companyName){alert("会社名は必須です");return}const{saveProspect:c,fetchProspects:d,recordAudit:u,sendSlackNotification:p}=await v(async()=>{const{saveProspect:f,fetchProspects:x,recordAudit:D,sendSlackNotification:g}=await Promise.resolve().then(()=>b);return{saveProspect:f,fetchProspects:x,recordAudit:D,sendSlackNotification:g}},void 0);await c(o)?(a&&await p("new_prospect",`新規見込客: ${o.companyName} / 想定 ¥${o.expectedAmount.toLocaleString("ja-JP")}`).catch(()=>{}),await u({action:a?"prospect_create":"prospect_update",entityType:"prospect",entityId:l,userEmail:s.user?.email}),s.prospects=await d(),s.prospectEditingId=null,m()):alert("保存失敗")}),e.querySelectorAll("[data-action='prospect-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!confirm("削除しますか？"))return;const l=a.dataset.id??"",{deleteProspect:o,fetchProspects:c}=await v(async()=>{const{deleteProspect:d,fetchProspects:u}=await Promise.resolve().then(()=>b);return{deleteProspect:d,fetchProspects:u}},void 0);await o(l)&&(s.prospects=await c(),m())})}),e.querySelector("[data-action='prospect-add-activity']")?.addEventListener("click",async()=>{const a=e.querySelector("[data-action='prospect-add-activity']")?.dataset.id??"",l=e.querySelector("#prospect-activity-type")?.value??"call",o=e.querySelector("#prospect-activity-title")?.value??"";if(!o){alert("内容を入力してください");return}const{saveProspectActivity:c,fetchProspectActivities:d}=await v(async()=>{const{saveProspectActivity:u,fetchProspectActivities:p}=await Promise.resolve().then(()=>b);return{saveProspectActivity:u,fetchProspectActivities:p}},void 0);await c({id:`act_${Date.now()}`,prospectId:a,activityType:l,title:o,activityDate:new Date().toISOString(),staffCode:s.myProfile?.staffCode}),s.prospectActivities=await d(a),m()}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(a=>{a.addEventListener("dragstart",l=>{l.dataTransfer?.setData("text/plain",a.dataset.prospectId??"")})}),e.querySelectorAll(".pk-col[data-prospect-stage]").forEach(a=>{a.addEventListener("dragover",l=>l.preventDefault()),a.addEventListener("drop",async l=>{l.preventDefault();const o=l.dataTransfer?.getData("text/plain"),c=a.dataset.prospectStage;if(!o)return;const d=s.prospects.find(u=>u.id===o);if(d&&d.stage!==c){const u={...d,stage:c},{saveProspect:p}=await v(async()=>{const{saveProspect:h}=await Promise.resolve().then(()=>b);return{saveProspect:h}},void 0);await p(u),d.stage=c,m()}})}),e.querySelector("[data-action='slack-save']")?.addEventListener("click",async()=>{const{fetchIntegrationSettings:a,saveIntegrationSetting:l}=await v(async()=>{const{fetchIntegrationSettings:h,saveIntegrationSetting:f}=await Promise.resolve().then(()=>b);return{fetchIntegrationSettings:h,saveIntegrationSetting:f}},void 0),c=(s.integrations.length>0?s.integrations:await a()).find(h=>h.provider==="slack");if(!c)return;const d=e.querySelector("#slack-webhook")?.value??"",u=e.querySelector("#slack-default-channel")?.value??"",p=e.querySelector("#slack-enabled")?.checked??!1;await l({...c,config:{...c.config,webhook_url:d,default_channel:u},isEnabled:p}),s.integrations=await a(),alert("保存しました"),m()}),e.querySelector("[data-action='slack-save-rules']")?.addEventListener("click",async()=>{const{saveSlackRule:a,fetchSlackRules:l}=await v(async()=>{const{saveSlackRule:o,fetchSlackRules:c}=await Promise.resolve().then(()=>b);return{saveSlackRule:o,fetchSlackRules:c}},void 0);for(const o of s.slackRules){const c=e.querySelector(`[data-slack-rule-id="${o.id}"][data-slack-field="enabled"]`)?.checked??o.enabled,d=e.querySelector(`[data-slack-rule-id="${o.id}"][data-slack-field="channel"]`)?.value??o.channel;await a({...o,enabled:c,channel:d})}s.slackRules=await l(),alert("ルールを保存しました"),m()}),e.querySelector("[data-action='slack-test']")?.addEventListener("click",async()=>{const{sendSlackNotification:a}=await v(async()=>{const{sendSlackNotification:o}=await Promise.resolve().then(()=>b);return{sendSlackNotification:o}},void 0),l=await a("new_order","🧪 これはテスト通知です (syusen-cloud)");l.ok?alert("テスト送信成功"):alert("送信失敗: "+(l.error??""))}),e.querySelector("[data-action='material-receive']")?.addEventListener("click",()=>{s.materialEditing=null,s.materialEditingIsNew=!0,m()}),e.querySelectorAll("[data-action='material-adjust']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.id??"",o=s.materialList.find(c=>c.id===l);o&&(s.materialEditing=o,s.materialEditingIsNew=!1,m())})}),e.querySelectorAll("[data-action='material-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.materialEditing=null,s.materialEditingIsNew=!1,m())})}),e.querySelector("[data-action='material-save']")?.addEventListener("click",async()=>{const l={id:s.materialEditingIsNew?`mat_${Date.now()}`:s.materialEditing?.id??"",code:e.querySelector("#mat-code")?.value??"",name:e.querySelector("#mat-name")?.value??"",unit:e.querySelector("#mat-unit")?.value??"個",currentStock:Number(e.querySelector("#mat-stock")?.value)||0,minimumStock:Number(e.querySelector("#mat-min")?.value)||0,unitCost:Number(e.querySelector("#mat-cost")?.value)||0,lastUpdated:e.querySelector("#mat-last-date")?.value??new Date().toISOString().slice(0,10)};if(l.materialType=e.querySelector("#mat-type")?.value??"",!l.code||!l.name){alert("コードと品名は必須");return}const{saveMaterial:o,fetchMaterialList:c}=await v(async()=>{const{saveMaterial:u,fetchMaterialList:p}=await Promise.resolve().then(()=>b);return{saveMaterial:u,fetchMaterialList:p}},void 0);await o(l)?(s.materialList=await c(),s.materialEditing=null,s.materialEditingIsNew=!1,alert("保存しました"),m()):alert("保存失敗")}),e.querySelector("[data-action='material-delete']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='material-delete']")?.dataset.id??"";if(!a||!confirm("削除しますか？"))return;const{deleteMaterial:l,fetchMaterialList:o}=await v(async()=>{const{deleteMaterial:c,fetchMaterialList:d}=await Promise.resolve().then(()=>b);return{deleteMaterial:c,fetchMaterialList:d}},void 0);await l(a)&&(s.materialList=await o(),s.materialEditing=null,m())}),e.querySelector("[data-action='user-new']")?.addEventListener("click",()=>{s.userEditingId="__new__",m()}),e.querySelectorAll("[data-action='user-edit']").forEach(a=>{a.addEventListener("click",()=>{s.userEditingId=a.dataset.id??null,m()})}),e.querySelector("[data-action='user-cancel']")?.addEventListener("click",()=>{s.userEditingId=null,m()}),e.querySelector("[data-action='user-save']")?.addEventListener("click",async()=>{const a=s.userEditingId==="__new__",l=a?crypto.randomUUID():s.userEditingId??"",o=e.querySelector("#user-email")?.value.trim()??"",c=e.querySelector("#user-name")?.value.trim()??"";if(!o||!c){alert("名前とメールアドレスは必須です");return}const d={id:l,email:o,displayName:c,staffCode:e.querySelector("#user-code")?.value??"",department:e.querySelector("#user-dept")?.value??"all",role:e.querySelector("#user-role")?.value??"staff",phone:e.querySelector("#user-phone")?.value??"",isActive:e.querySelector("#user-active")?.checked??!0};if(a){const x=e.querySelector("#user-password")?.value??"";if(x.length<8){alert("パスワードは8文字以上必要です");return}try{await rt(o,x)}catch(D){alert("Auth登録失敗: "+(D instanceof Error?D.message:""));return}}const{saveUserProfile:u,fetchUserProfiles:p,recordAudit:h}=await v(async()=>{const{saveUserProfile:x,fetchUserProfiles:D,recordAudit:g}=await Promise.resolve().then(()=>b);return{saveUserProfile:x,fetchUserProfiles:D,recordAudit:g}},void 0);await u(d)?(await h({action:a?"user_create":"user_update",entityType:"user",entityId:l,userEmail:s.user?.email}),s.userProfiles=await p(),s.userEditingId=null,alert("保存しました"),m()):alert("保存失敗")}),e.querySelectorAll("[data-action='user-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!confirm("削除しますか？"))return;const l=a.dataset.id??"",{deleteUserProfile:o,fetchUserProfiles:c,recordAudit:d}=await v(async()=>{const{deleteUserProfile:p,fetchUserProfiles:h,recordAudit:f}=await Promise.resolve().then(()=>b);return{deleteUserProfile:p,fetchUserProfiles:h,recordAudit:f}},void 0);await o(l)?(await d({action:"user_delete",entityType:"user",entityId:l,userEmail:s.user?.email}),s.userProfiles=await c(),m()):alert("削除失敗")})}),e.querySelector("[data-action='profile-save-sender']")?.addEventListener("click",async()=>{if(!s.myProfile)return;const a=e.querySelector("#profile-sender")?.value??"",l={...s.myProfile,defaultMailSenderId:a},{saveUserProfile:o}=await v(async()=>{const{saveUserProfile:c}=await Promise.resolve().then(()=>b);return{saveUserProfile:c}},void 0);await o(l),s.myProfile=l,alert("保存しました"),m()}),e.querySelector("[data-action='profile-change-password']")?.addEventListener("click",async()=>{const a=e.querySelector("#profile-new-password")?.value??"";if(a.length<8){alert("8文字以上のパスワードを入力してください");return}try{await Aa(a),alert("パスワードを変更しました")}catch(l){alert("変更失敗: "+(l instanceof Error?l.message:""))}}),e.querySelectorAll("[data-action='int-edit']").forEach(a=>{a.addEventListener("click",()=>{s.integrationEditingId=a.dataset.id??null,m()})}),e.querySelector("[data-action='int-cancel']")?.addEventListener("click",()=>{s.integrationEditingId=null,m()}),e.querySelector("[data-action='int-save']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='int-save']")?.dataset.id??"",l=s.integrations.find(h=>h.id===a);if(!l)return;const o={...l.config};Object.keys(o).forEach(h=>{const f=e.querySelector(`#int-${h}`);f&&(o[h]=f.value)});const c=e.querySelector("#int-enabled")?.checked??!1,{saveIntegrationSetting:d,fetchIntegrationSettings:u}=await v(async()=>{const{saveIntegrationSetting:h,fetchIntegrationSettings:f}=await Promise.resolve().then(()=>b);return{saveIntegrationSetting:h,fetchIntegrationSettings:f}},void 0);await d({...l,config:o,isEnabled:c})?(s.integrations=await u(),s.integrationEditingId=null,alert("保存しました"),m()):alert("保存失敗")}),e.querySelectorAll("[data-action='int-sync-shopify'], [data-action='shopify-sync']").forEach(a=>{a.addEventListener("click",async()=>{const l=s.integrations.find(u=>u.provider==="shopify");if(!l){alert("Shopify連携が未設定です");return}a.textContent="同期中…",a.disabled=!0;const{syncShopifyOrders:o,fetchShopifyOrders:c}=await v(async()=>{const{syncShopifyOrders:u,fetchShopifyOrders:p}=await Promise.resolve().then(()=>b);return{syncShopifyOrders:u,fetchShopifyOrders:p}},void 0),d=await o(l);d.error?alert("同期失敗: "+d.error):(alert(`${d.count}件を同期しました`),s.shopifyOrders=await c()),m()})}),e.querySelectorAll("[data-action='int-sync-gcal']").forEach(a=>{a.addEventListener("click",async()=>{const l=s.integrations.find(u=>u.provider==="google_calendar");if(!l)return;a.textContent="同期中…",a.disabled=!0;const{syncGoogleCalendar:o,fetchCalendarEvents:c}=await v(async()=>{const{syncGoogleCalendar:u,fetchCalendarEvents:p}=await Promise.resolve().then(()=>b);return{syncGoogleCalendar:u,fetchCalendarEvents:p}},void 0),d=await o(l);d.error?alert("同期失敗: "+d.error):(alert(`${d.count}件を同期しました`),s.calendarEvents=await c(s.calendarYearMonth)),m()})}),e.querySelector("[data-action='fax-upload']")?.addEventListener("click",async()=>{const l=e.querySelector("#fax-file")?.files?.[0];if(!l){alert("FAX画像を選択してください");return}const o=s.integrations.find(c=>c.provider==="cloud_vision");if(!o||!o.config.api_key){alert("Cloud Vision API Key が設定されていません (/integrations で設定してください)");return}s.faxProcessing=!0,s.faxOcrText=null,m();try{const c=new FileReader;c.onload=async()=>{const d=String(c.result??""),{ocrFaxImage:u,saveFaxRecord:p,fetchFaxInbox:h}=await v(async()=>{const{ocrFaxImage:g,saveFaxRecord:C,fetchFaxInbox:te}=await Promise.resolve().then(()=>b);return{ocrFaxImage:g,saveFaxRecord:C,fetchFaxInbox:te}},void 0),f=await u(o,d),x=e.querySelector("#fax-sender-name")?.value??"",D=e.querySelector("#fax-sender-phone")?.value??"";await p({id:`fax_${Date.now()}`,receivedAt:new Date().toISOString(),senderName:x,senderPhone:D,ocrStatus:f.error?"failed":"done",ocrText:f.text}),s.faxOcrText=f.error?`エラー: ${f.error}`:f.text,s.faxRecords=await h(),s.faxProcessing=!1,m()},c.readAsDataURL(l)}catch(c){alert("OCR失敗: "+(c instanceof Error?c.message:"")),s.faxProcessing=!1,m()}}),e.querySelector("[data-action='ms-new']")?.addEventListener("click",()=>{s.mailSenderEditingId="__new__",m()}),e.querySelectorAll("[data-action='ms-edit']").forEach(a=>{a.addEventListener("click",()=>{s.mailSenderEditingId=a.dataset.id??null,m()})}),e.querySelector("[data-action='ms-cancel']")?.addEventListener("click",()=>{s.mailSenderEditingId=null,m()}),e.querySelector("[data-action='ms-save']")?.addEventListener("click",async()=>{const a=e.querySelector("[data-action='ms-save']")?.dataset.id||`sender_${Date.now()}`,l={id:a,name:e.querySelector("#ms-name")?.value||"",email:e.querySelector("#ms-email")?.value||"",displayName:e.querySelector("#ms-display-name")?.value||"",replyTo:e.querySelector("#ms-reply-to")?.value||"",signature:e.querySelector("#ms-signature")?.value||"",isDefault:e.querySelector("#ms-default")?.checked??!1,isVerified:s.mailSenders.find(u=>u.id===a)?.isVerified??!1};if(!l.name||!l.email){alert("名前とメールアドレスは必須です");return}const{saveMailSender:o,fetchMailSenders:c}=await v(async()=>{const{saveMailSender:u,fetchMailSenders:p}=await Promise.resolve().then(()=>b);return{saveMailSender:u,fetchMailSenders:p}},void 0);await o(l)?(s.mailSenders=await c(),s.mailSenderEditingId=null,alert("保存しました"),m()):alert("保存に失敗しました")}),e.querySelectorAll("[data-action='ms-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!confirm("削除しますか？"))return;const l=a.dataset.id??"",{deleteMailSender:o,fetchMailSenders:c}=await v(async()=>{const{deleteMailSender:u,fetchMailSenders:p}=await Promise.resolve().then(()=>b);return{deleteMailSender:u,fetchMailSenders:p}},void 0);await o(l)?(s.mailSenders=await c(),m()):alert("削除失敗")})}),e.querySelectorAll("[data-action='cal-prev'], [data-action='cal-next'], [data-action='cal-today']").forEach(a=>{a.addEventListener("click",async()=>{s.calendarYearMonth=a.dataset.ym??s.calendarYearMonth;const{fetchCalendarEvents:l}=await v(async()=>{const{fetchCalendarEvents:o}=await Promise.resolve().then(()=>b);return{fetchCalendarEvents:o}},void 0);s.calendarEvents=await l(s.calendarYearMonth),m()})}),e.querySelector("#cal-month-input")?.addEventListener("change",async a=>{s.calendarYearMonth=a.target.value;const{fetchCalendarEvents:l}=await v(async()=>{const{fetchCalendarEvents:o}=await Promise.resolve().then(()=>b);return{fetchCalendarEvents:o}},void 0);s.calendarEvents=await l(s.calendarYearMonth),m()}),e.querySelector("#cal-filter-category")?.addEventListener("change",a=>{s.calendarFilterCategory=a.target.value,m()}),e.querySelector("[data-action='cal-new']")?.addEventListener("click",()=>{const a=new Date;s.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:new Date(a.getTime()+3600*1e3).toISOString(),isAllDay:!1}},m()}),e.querySelectorAll("[data-cal-date]").forEach(a=>{a.tagName!=="BUTTON"&&a.addEventListener("click",l=>{if(l.target.closest(".cal-event"))return;const o=a.dataset.calDate??"";s.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:`${o}T10:00:00`,isAllDay:!1}},m()})}),e.querySelectorAll("[data-cal-event-id]").forEach(a=>{a.addEventListener("click",l=>{l.stopPropagation();const o=a.dataset.calEventId,c=s.calendarEvents.find(d=>d.id===o);c&&(s.calendarEdit={isOpen:!0,isNew:!1,event:{...c}},m())})}),e.querySelectorAll("[data-action='cal-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.calendarEdit=null,m())})}),e.querySelector("[data-action='cal-save']")?.addEventListener("click",async()=>{if(!s.calendarEdit)return;const{saveCalendarEvent:a,fetchCalendarEvents:l,CALENDAR_CATEGORY_COLORS:o}=await v(async()=>{const{saveCalendarEvent:h,fetchCalendarEvents:f,CALENDAR_CATEGORY_COLORS:x}=await Promise.resolve().then(()=>b);return{saveCalendarEvent:h,fetchCalendarEvents:f,CALENDAR_CATEGORY_COLORS:x}},void 0),c=document.querySelector("[data-action='cal-save']")?.dataset.id||s.calendarEdit.event.id||`evt_${Date.now()}`,d=e.querySelector("#cal-category")?.value??"general",u={id:c,title:e.querySelector("#cal-title")?.value??"",category:d,startsAt:new Date(e.querySelector("#cal-starts")?.value??new Date().toISOString()).toISOString(),endsAt:e.querySelector("#cal-ends")?.value?new Date(e.querySelector("#cal-ends").value).toISOString():void 0,isAllDay:e.querySelector("#cal-allday")?.checked??!1,location:e.querySelector("#cal-location")?.value??"",relatedCustomerCode:e.querySelector("#cal-customer")?.value??"",description:e.querySelector("#cal-description")?.value??"",color:o[d]};if(!u.title){alert("タイトルは必須です");return}await a(u)?(s.calendarEvents=await l(s.calendarYearMonth),s.calendarEdit=null,m()):alert("保存失敗")}),e.querySelector("[data-action='cal-delete']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='cal-delete']")?.dataset.id??"";if(!a||!confirm("削除しますか？"))return;const{deleteCalendarEvent:l,fetchCalendarEvents:o}=await v(async()=>{const{deleteCalendarEvent:d,fetchCalendarEvents:u}=await Promise.resolve().then(()=>b);return{deleteCalendarEvent:d,fetchCalendarEvents:u}},void 0);await l(a)?(s.calendarEvents=await o(s.calendarYearMonth),s.calendarEdit=null,m()):alert("削除失敗")}),e.querySelector("[data-action='import-execute']")?.addEventListener("click",async()=>{if(s.importPreview){s.importing=!0,m();try{const a=s.importPreview.rows.filter(o=>o._valid),l=await yi(s.importEntity,a);s.importResult=`取り込み完了: ${l.inserted}件成功 / ${l.failed}件失敗`,s.importPreview=null}catch(a){s.importResult=`エラー: ${a instanceof Error?a.message:String(a)}`}finally{s.importing=!1,m()}}}),e.querySelector("[data-action='store-load']")?.addEventListener("click",()=>{const a=e.querySelector("#store-date")?.value??s.storeSalesDate;s.storeSalesDate=a,s.storeSales=[],s.actionLoading=!0,m(),Ze(a).then(l=>{s.storeSales=l,s.actionLoading=!1,m()})}),e.querySelectorAll("[data-action='copy-config']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.configValue??"";if(l)try{await navigator.clipboard.writeText(l),a.textContent="コピー済み",window.setTimeout(()=>{a.textContent="コピー"},1600)}catch(o){console.warn("Clipboard copy failed",o)}})}),e.querySelector("[data-action='download-relay-config']")?.addEventListener("click",()=>{const l=JSON.stringify({supabase_url:z,supabase_anon_key:F,z_drive_path:"Z:\\",sync_modules:["sk","sh","k5","h5"],interval_minutes:5,use_odbc:!1,odbc_dsn:"MagicSake",log_level:"INFO"},null,2),o=new Blob([l],{type:"application/json;charset=utf-8"}),c=URL.createObjectURL(o),d=document.createElement("a");d.href=c,d.download="relay_config.json",d.click(),URL.revokeObjectURL(c)}),e.querySelectorAll("[data-action='copy-code']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.code??"";if(l)try{await navigator.clipboard.writeText(decodeURIComponent(l)),a.textContent="コピー済み",window.setTimeout(()=>{a.textContent="コピー"},1600)}catch(o){console.warn("Clipboard code copy failed",o)}})}),e.querySelectorAll("input[name='email-audience-mode']").forEach(a=>{a.addEventListener("change",()=>{X(e),s.emailSaveMessage=null,m()})}),e.querySelectorAll("#email-region, #email-history-segment").forEach(a=>{a.addEventListener("change",()=>{X(e),s.emailSaveMessage=null,m()})}),e.querySelector("#email-subject")?.addEventListener("input",()=>{X(e),s.emailSaveMessage=null}),e.querySelector("#email-body")?.addEventListener("input",()=>{X(e),s.emailSaveMessage=null}),e.querySelectorAll("[data-action='template-select']").forEach(a=>{a.addEventListener("click",()=>{s.emailTemplateId=a.dataset.templateId??"custom";const l=pa(s.emailTemplateId);s.emailSubject=l.subject,s.emailBody=l.body,s.emailSaveMessage=null,m()})}),e.querySelector("[data-action='email-insert-link']")?.addEventListener("click",()=>{X(e);const a=`

商品詳細はこちら: https://example.jp/products/seasonal`;s.emailBody.includes("https://example.jp/products/seasonal")||(s.emailBody=`${s.emailBody.trimEnd()}${a}`),s.emailSaveMessage=null,m()}),e.querySelector("[data-action='email-save']")?.addEventListener("click",()=>{X(e),s.actionLoading=!0,m(),ke(Fe("draft")).then(a=>{s.emailSaveMessage=`下書きを保存しました。${new Intl.DateTimeFormat("ja-JP",{month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(a.updatedAt??new Date().toISOString()))}`,s.actionLoading=!1,m()})}),e.querySelector("#email-sender")?.addEventListener("change",a=>{s.emailSenderId=a.target.value}),e.querySelector("[data-action='email-send']")?.addEventListener("click",()=>{X(e),s.actionLoading=!0,s.emailSending=!0,m();const a=Fe("sent");s.mailSenders.find(l=>l.id===s.emailSenderId),sa().then(async l=>{await ke({...a,recipientCount:l.sent}),s.emailSaveMessage=`${l.sent.toLocaleString("ja-JP")} 件送信しました。`,s.actionLoading=!1,s.emailSending=!1,m(),window.alert(`${l.sent}件送信完了`)}).catch(async()=>{await ke(Fe("draft")),s.emailSaveMessage="APIキー未設定のため下書きを保存しました。",s.actionLoading=!1,s.emailSending=!1,m(),window.alert("APIキー未設定のため下書き保存しました")})})}function m(){const e=document.querySelector("#app");e&&(e.innerHTML=Ni(),Oi(e),s.pickerMode&&e.querySelector("#modal-search")?.focus(),s.globalSearchOpen&&e.querySelector("#global-search-input")?.focus(),it()&&e.querySelector("#auth-email")?.focus(),requestAnimationFrame(()=>{for(const t of["fd-scaler","print-scaler"]){const n=e.querySelector(`#${t}`),i=n?.querySelector(".fd-canvas, .print-preview"),r=i?.querySelector(".print-page")??i;if(!n||!r)continue;const a=n.parentElement?.clientWidth??0,l=r.offsetWidth;if(a>0&&l>0&&l>a-24){const o=(a-24)/l;n.style.transform=`scale(${o})`,n.style.transformOrigin="top left",n.style.height=`${(r.offsetHeight+48)*o}px`}else n.style.transform="",n.style.height=""}}))}async function Ri(){s.loading=!0,m();try{const[e,t,n,i,r,a,l]=await Promise.all([Mt(),Ft(),zt(),Jt(),xe(s.invoiceFilter),Qe(s.ledgerCustomerCode),Vt()]);if(s.salesSummary=e,s.paymentStatus=t,s.masterStats=n,s.pipelineMeta=i,s.invoiceRecords=r,s.customerLedger=a,s.salesAnalytics=l,!s.salesFilter.startDate||!s.salesFilter.endDate){const c=[...e.salesRecords].sort((p,h)=>new Date(h.date).getTime()-new Date(p.date).getTime())[0]?.date??new Date().toISOString(),d=new Date(c),u=new Date(d);u.setDate(d.getDate()-30),s.salesFilter={startDate:Lt(u.toISOString()),endDate:Lt(d.toISOString())}}(!s.invoiceFilter.startDate||!s.invoiceFilter.endDate)&&(s.invoiceFilter={...s.invoiceFilter,startDate:s.salesFilter.startDate,endDate:s.salesFilter.endDate},s.invoiceRecords=await xe(s.invoiceFilter)),s.error=null}catch(e){s.error=e instanceof Error?e.message:"データの取得に失敗しました。"}finally{s.loading=!1,m(),lt(s.route)}}window.addEventListener("popstate",()=>{s.route=ma(location.pathname),s.currentCategory=nt(s.route),s.sidebarOpen=!1,re(),lt(s.route)});window.addEventListener("keydown",e=>{if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="k"){e.preventDefault(),s.globalSearchOpen=!0,m();return}if(e.key==="Escape"){if(s.globalSearchOpen){re(),m();return}if(s.pickerMode){Ee(),m();return}s.route==="/invoice-entry"&&!s.invoiceSaving&&(ya(),m());return}if(s.route==="/invoice-entry"&&!s.invoiceSaving&&(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault();const t=document.querySelector("#app");t&&va(t)}});s.user=Le()?Da():null;s.user?.email&&(async()=>{const{fetchMyProfile:e}=await v(async()=>{const{fetchMyProfile:t}=await Promise.resolve().then(()=>b);return{fetchMyProfile:t}},void 0);s.myProfile=await e(s.user.email),m()})();try{const e=localStorage.getItem("sake_print_options");e&&(s.printOptions={...s.printOptions,...JSON.parse(e)});const t=localStorage.getItem("sake_print_company");t&&(s.printCompany={...s.printCompany,...JSON.parse(t)});const n=localStorage.getItem("sake_fd_positions");n&&(s.fdSavedPositions=JSON.parse(n))}catch{}(function(){let t=null,n=0,i=0,r=0,a=0,l=1;document.addEventListener("mousedown",o=>{const c=o.target.closest(".fd-draggable");if(!c||!s.fdDesignMode)return;o.preventDefault();const d=c.closest(".fd-canvas");if(!d)return;const u=d.getBoundingClientRect();if(u.width===0)return;l=228.6/u.width,t=c,n=o.clientX,i=o.clientY,r=parseFloat(c.style.left)||0,a=parseFloat(c.style.top)||0,document.querySelectorAll(".fd-active").forEach(x=>x.classList.remove("fd-active")),c.classList.add("fd-active","fd-dragging"),s.fdActiveFieldId=c.dataset.fdId??null;const p=document.querySelector("#fd-selected-info");p&&(p.textContent=`選択中: ${c.title}`);const h=document.querySelector("#fd-sel-x"),f=document.querySelector("#fd-sel-y");h&&(h.value=String(r)),f&&(f.value=String(a))}),document.addEventListener("mousemove",o=>{if(!t)return;const c=(o.clientX-n)*l,d=(o.clientY-i)*l,u=Math.round((r+c)*2)/2,p=Math.round((a+d)*2)/2;t.style.left=u+"mm",t.style.top=p+"mm";const h=document.querySelector("#fd-sel-x"),f=document.querySelector("#fd-sel-y");h&&(h.value=String(u)),f&&(f.value=String(p))}),document.addEventListener("mouseup",()=>{t&&(t.classList.remove("fd-dragging"),t=null)}),document.addEventListener("keydown",o=>{if(!s.fdDesignMode||!s.fdActiveFieldId||o.key!=="ArrowLeft"&&o.key!=="ArrowRight"&&o.key!=="ArrowUp"&&o.key!=="ArrowDown"||o.target.tagName==="INPUT"||o.target.tagName==="TEXTAREA")return;const c=document.querySelector(`[data-fd-id="${s.fdActiveFieldId}"]`);if(!c)return;o.preventDefault();const d=.5;let u=parseFloat(c.style.left)||0,p=parseFloat(c.style.top)||0;o.key==="ArrowLeft"?u-=d:o.key==="ArrowRight"?u+=d:o.key==="ArrowUp"?p-=d:o.key==="ArrowDown"&&(p+=d),c.style.left=u+"mm",c.style.top=p+"mm";const h=document.querySelector("#fd-sel-x"),f=document.querySelector("#fd-sel-y");h&&(h.value=String(u)),f&&(f.value=String(p))})})();let we=null;function ga(e){const t=window.L;if(!t){e.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-secondary);">Leaflet読込中…</div>',setTimeout(()=>ga(e),500);return}if(we){try{we.remove()}catch{}we=null}e.innerHTML="";const n=t.map(e);n.setView([35.378,139.295],11),t.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"© OpenStreetMap contributors",maxZoom:19}).addTo(n),(s.masterStats?.customers??[]).slice(0,50).forEach((a,l)=>{const o=35.37+l%10*.02+(Math.random()-.5)*.01,c=139.29+Math.floor(l/10)*.04+(Math.random()-.5)*.02;t.marker([o,c]).addTo(n).bindPopup(`<strong>${a.name}</strong><br/><span style="color:#666;">${a.code}</span>`)}),we=n}Ri();
