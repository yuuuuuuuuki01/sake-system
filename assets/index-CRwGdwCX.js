...
`}function fs(e){const t=e.rows.map(c=>{const a=Math.max(0,c.productionVolume+c.previousBalance+c.currentAdjustment-c.exportDeduction-c.sampleDeduction),l=Math.round(a*c.taxRate);return{...c,taxableVolume:a,volume:a,taxAmount:l}}),n=t.reduce((c,a)=>c+a.taxableVolume,0),i=t.reduce((c,a)=>c+a.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:i}}async function bs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>D);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:ba(e),submitted_at:e.submittedAt})}const gs=Array.from({length:10},(e,t)=>({id:`ss${t+1}`,saleDate:"2026-04-15",saleTime:`${9+t}:${String(t*7%60).padStart(2,"0")}`,productCode:`P${String(t%4+1).padStart(5,"0")}`,productName:["純米吟醸 720ml","本醸造 1.8L","梅酒 500ml","特別純米 300ml"][t%4],quantity:1+t%3,unitPrice:[2200,1800,980,680][t%4],amount:(1+t%3)*[2200,1800,980,680][t%4],paymentMethod:["cash","card","paypay","cash"][t%4]})),$s=[{id:"o1",orderNo:"ORD-2604001",orderDate:"2026-04-13",customerName:"鈴木 太郎",postalCode:"150-0001",address:"東京都渋谷区〇〇1-1",items:[{productName:"純米吟醸 720ml",quantity:2,amount:4400}],totalAmount:4400,status:"shipped",shippingDate:"2026-04-14"},{id:"o2",orderNo:"ORD-2604002",orderDate:"2026-04-14",customerName:"田中 花子",postalCode:"530-0001",address:"大阪府大阪市北区〇〇2-3",items:[{productName:"梅酒 500ml",quantity:3,amount:2940},{productName:"本醸造 1.8L",quantity:1,amount:1800}],totalAmount:4740,status:"processing",shippingDate:""},{id:"o3",orderNo:"ORD-2604003",orderDate:"2026-04-15",customerName:"佐藤 一郎",postalCode:"460-0001",address:"愛知県名古屋市中区〇〇3-5",items:[{productName:"特別純米 300ml ×6本セット",quantity:1,amount:3980}],totalAmount:3980,status:"new",shippingDate:""}];async function mt(e){return P(`data/api/latest/store-sales-${e}.json`,gs)}async function ga(){return P("data/api/latest/store-orders.json",$s)}async function De(e){const t=await nt("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function $a(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function ws(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await w("print_layouts",t)).map(i=>({id:m(i,["id"],""),name:m(i,["name"],""),templateKey:m(i,["template_key"],""),positions:i.positions??{},isDefault:j(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}))}async function _s(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:c}=await Promise.resolve().then(()=>D);return{supabaseInsert:c}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},i=await t("print_layouts",n);return i?{id:m(i,["id"],e.id),name:m(i,["name"],e.name),templateKey:m(i,["template_key"],e.templateKey),positions:i.positions??e.positions,isDefault:j(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}:null}async function ks(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function Ss(){return(await w("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),signature:m(t,["signature"],""),replyTo:m(t,["reply_to"],""),isDefault:j(t,["is_default"],!1),isVerified:j(t,["is_verified"],!1),note:m(t,["note"],"")}))}async function xs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:m(n,["id"],e.id),name:m(n,["name"],e.name),email:m(n,["email"],e.email),displayName:m(n,["display_name"],""),signature:m(n,["signature"],""),replyTo:m(n,["reply_to"],""),isDefault:j(n,["is_default"],!1),isVerified:j(n,["is_verified"],!1)}:null}async function Cs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const yt={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},ht={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function As(e){const t=`${e}-01T00:00:00Z`,[n,i]=e.split("-").map(o=>parseInt(o,10)),c=new Date(n,i,0).getDate(),a=`${e}-${String(c).padStart(2,"0")}T23:59:59Z`;return(await w("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${a})`,order:"starts_at.asc"})).map(o=>({id:m(o,["id"],""),title:m(o,["title"],""),description:m(o,["description"],""),category:m(o,["category"],"general")||"general",startsAt:m(o,["starts_at"],new Date().toISOString()),endsAt:m(o,["ends_at"],""),isAllDay:j(o,["is_all_day"],!1),location:m(o,["location"],""),attendees:o.attendees??[],relatedCustomerCode:m(o,["related_customer_code"],""),relatedOrderId:m(o,["related_order_id"],""),color:m(o,["color"],""),googleEventId:m(o,["google_event_id"],"")}))}async function Ls(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??ht[e.category],updated_at:new Date().toISOString()})?e:null}async function Ds(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function wa(){return(await w("integration_settings",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),provider:m(t,["provider"],""),config:t.config??{},isEnabled:j(t,["is_enabled"],!1),lastSyncAt:m(t,["last_sync_at"],""),lastStatus:m(t,["last_status"],"")}))}async function Me(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function Es(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const i=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,c=await fetch(i,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!c.ok)return{count:0,error:`HTTP ${c.status}`};const a=await c.json(),{supabaseInsert:l}=await v(async()=>{const{supabaseInsert:r}=await Promise.resolve().then(()=>D);return{supabaseInsert:r}},void 0);let o=0;for(const r of a.orders){const d=`shopify_${r.id}`;await l("shopify_orders",{id:d,shopify_order_id:String(r.id),order_number:String(r.order_number??""),order_date:String(r.created_at??new Date().toISOString()),customer_name:String(r.customer?.first_name??"")+" "+String(r.customer?.last_name??""),customer_email:String(r.customer?.email??""),total_amount:Math.round(parseFloat(String(r.total_price??"0"))),financial_status:String(r.financial_status??""),fulfillment_status:String(r.fulfillment_status??"unfulfilled"),line_items:r.line_items??[],shipping_address:r.shipping_address??null,raw_payload:r}),o++}return await Me({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${o}件取得成功`}),{count:o}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Is(){return(await w("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),shopifyOrderId:m(t,["shopify_order_id"],""),orderNumber:m(t,["order_number"],""),orderDate:m(t,["order_date"],""),customerName:m(t,["customer_name"],""),customerEmail:m(t,["customer_email"],""),totalAmount:x(t.total_amount),financialStatus:m(t,["financial_status"],""),fulfillmentStatus:m(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function Ps(e){const t=e.config.oauth_token,n=e.config.calendar_id||"primary";if(!t)return{count:0,error:"oauth_token を設定してください (Google Cloud Console で取得)"};try{const i=new Date().toISOString(),c=new Date(Date.now()+30*86400*1e3).toISOString(),a=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${i}&timeMax=${c}&singleEvents=true&orderBy=startTime`,l=await fetch(a,{headers:{Authorization:`Bearer ${t}`}});if(!l.ok)return{count:0,error:`HTTP ${l.status}`};const o=await l.json(),{supabaseInsert:r}=await v(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>D);return{supabaseInsert:u}},void 0);let d=0;for(const u of o.items){const p=`gcal_${u.id}`,h=u.start?.dateTime??u.start?.date??"",b=u.end?.dateTime??u.end?.date??"";await r("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(h),ends_at:String(b),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),d++}return await Me({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${d}件取得`}),{count:d}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Ts(){return(await w("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),receivedAt:m(t,["received_at"],""),senderPhone:m(t,["sender_phone"],""),senderName:m(t,["sender_name"],""),imageUrl:m(t,["image_url"],""),ocrStatus:m(t,["ocr_status"],"pending")||"pending",ocrText:m(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:m(t,["linked_invoice_id"],"")}))}async function Ns(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const i=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,c=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return c.ok?{text:(await c.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${c.status}`}}catch(i){return{text:"",error:i instanceof Error?i.message:String(i)}}}async function js(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Ne={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},je={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function Os(){return(await w("user_profiles",{order:"display_name.asc"})).map(t=>({id:m(t,["id"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),staffCode:m(t,["staff_code"],""),department:m(t,["department"],"all")||"all",role:m(t,["role"],"staff")||"staff",defaultMailSenderId:m(t,["default_mail_sender_id"],""),phone:m(t,["phone"],""),avatarUrl:m(t,["avatar_url"],""),isActive:j(t,["is_active"],!0),lastSignInAt:m(t,["last_sign_in_at"],""),createdAt:m(t,["created_at"],"")}))}async function Rs(e){if(!e)return null;const t=await w("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:m(n,["id"],""),email:m(n,["email"],""),displayName:m(n,["display_name"],""),staffCode:m(n,["staff_code"],""),department:m(n,["department"],"all")||"all",role:m(n,["role"],"staff")||"staff",defaultMailSenderId:m(n,["default_mail_sender_id"],""),phone:m(n,["phone"],""),avatarUrl:m(n,["avatar_url"],""),isActive:j(n,["is_active"],!0),lastSignInAt:m(n,["last_sign_in_at"],"")}}async function qs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function Ms(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Fs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>D);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function Vs(e=100){return(await w("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),action:m(n,["action"],""),entityType:m(n,["entity_type"],""),entityId:m(n,["entity_id"],""),userEmail:m(n,["user_email"],""),changes:n.changes??{},createdAt:m(n,["created_at"],"")}))}const Oe={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function _a(){return(await w("slack_notifications",{order:"event_type.asc"})).map(t=>({id:m(t,["id"],""),eventType:m(t,["event_type"],"new_order"),enabled:j(t,["enabled"],!0),channel:m(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:m(t,["last_triggered_at"],"")}))}async function zs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function Js(e=50){return(await w("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),eventType:m(n,["event_type"],""),channel:m(n,["channel"],""),message:m(n,["message"],""),status:m(n,["status"],"sent"),error:m(n,["error"],""),sentAt:m(n,["sent_at"],"")}))}async function Bs(e,t,n){const c=(await wa()).find(d=>d.provider==="slack");if(!c||!c.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const a=c.config.webhook_url;if(!a)return{ok:!1,error:"Webhook URL未設定"};const o=(await _a()).find(d=>d.eventType===e&&d.enabled);if(!o)return{ok:!1,error:"通知ルールが無効"};const r=n??o.channel??c.config.default_channel??"#general";try{const d=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${Oe[e]} ${t}`,channel:r})}),u=d.ok,{supabaseInsert:p}=await v(async()=>{const{supabaseInsert:h}=await Promise.resolve().then(()=>D);return{supabaseInsert:h}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:r,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${d.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${d.status}`}}catch(d){return{ok:!1,error:d instanceof Error?d.message:String(d)}}}const ye={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Fe={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function Us(){return(await w("prospects",{order:"updated_at.desc"})).map(t=>({id:m(t,["id"],""),companyName:m(t,["company_name"],""),contactName:m(t,["contact_name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),address:m(t,["address"],""),website:m(t,["website"],""),businessType:m(t,["business_type"],""),stage:m(t,["stage"],"cold"),source:m(t,["source"],""),expectedAmount:x(t.expected_amount),probability:x(t.probability),assignedStaffCode:m(t,["assigned_staff_code"],""),nextActionDate:m(t,["next_action_date"],""),nextAction:m(t,["next_action"],""),note:m(t,["note"],""),lastContactAt:m(t,["last_contact_at"],""),wonAt:m(t,["won_at"],""),lostAt:m(t,["lost_at"],""),lostReason:m(t,["lost_reason"],""),convertedCustomerCode:m(t,["converted_customer_code"],""),createdAt:m(t,["created_at"],"")}))}async function ka(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function Ys(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Hs(e){return(await w("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:m(n,["id"],""),prospectId:m(n,["prospect_id"],""),activityType:m(n,["activity_type"],"call"),title:m(n,["title"],""),description:m(n,["description"],""),activityDate:m(n,["activity_date"],""),result:m(n,["result"],""),staffCode:m(n,["staff_code"],"")}))}async function Xs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const Sa=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function Gs(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function Ks(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Qs(){return(await w("delivery_locations",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),customerCode:m(t,["customer_code"],""),name:m(t,["name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:m(t,["contact_name"],""),phone:m(t,["phone"],""),deliveryNote:m(t,["delivery_note"],""),isActive:j(t,["is_active"],!0)}))}async function Ws(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function Zs(e=50){return(await w("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),callDirection:m(n,["call_direction"],"inbound"),fromNumber:m(n,["from_number"],""),toNumber:m(n,["to_number"],""),matchedCustomerCode:m(n,["matched_customer_code"],""),matchedProspectId:m(n,["matched_prospect_id"],""),durationSeconds:x(n.duration_seconds),callStatus:m(n,["call_status"],"answered"),recordingUrl:m(n,["recording_url"],""),transcript:m(n,["transcript"],""),ivryCallId:m(n,["ivry_call_id"],""),startedAt:m(n,["started_at"],""),endedAt:m(n,["ended_at"],""),notes:m(n,["notes"],"")}))}async function xa(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function en(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const i=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,c=await fetch(i,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!c.ok)return{count:0,error:`HTTP ${c.status}`};const l=(await c.json()).calls??[];let o=0;for(const r of l)await xa({id:`ivry_${r.id}`,callDirection:String(r.direction??"inbound"),fromNumber:String(r.from??""),toNumber:String(r.to??""),durationSeconds:Number(r.duration??0),callStatus:String(r.status??"answered"),recordingUrl:String(r.recording_url??""),startedAt:String(r.started_at??""),endedAt:String(r.ended_at??""),ivryCallId:String(r.id??"")}),o++;return await Me({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${o}件取得`}),{count:o}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function tn(e,t){const n=e.config.api_key,i=e.config.team_id;if(!n||!i)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let c=0;for(const a of t){if(!a.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${i}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:a.name,phone_number:a.phone,external_id:a.customerCode??"",note:a.note??""})})).ok&&c++}return{synced:c}}catch(c){return{synced:0,error:c instanceof Error?c.message:String(c)}}}async function an(){return(await w("lead_lists",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),query:m(t,["query"],""),area:m(t,["area"],""),businessType:m(t,["business_type"],""),totalCount:x(t.total_count),source:m(t,["source"],"manual"),createdAt:m(t,["created_at"],"")}))}async function sn(e){return(await w("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:m(n,["id"],""),listId:m(n,["list_id"],""),companyName:m(n,["company_name"],""),address:m(n,["address"],""),phone:m(n,["phone"],""),website:m(n,["website"],""),email:m(n,["email"],""),businessType:m(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:x(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:m(n,["place_id"],""),status:m(n,["status"],"new"),convertedProspectId:m(n,["converted_prospect_id"],""),note:m(n,["note"],"")}))}async function nn(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function Ca(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function ln(e,t,n){const i=e.config.api_key;if(!i)return{results:[],error:"Google Maps API key 未設定"};const c=`${t} ${n}`.trim(),a=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(c)}&language=ja&key=${i}`;try{const l=await fetch(a);if(!l.ok)return{results:[],error:`HTTP ${l.status}`};const o=await l.json();return o.status!=="OK"&&o.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${o.status}`}:{results:o.results.map(d=>{const u=d.geometry?.location;return{id:`place_${d.place_id}`,listId:"",companyName:String(d.name??""),address:String(d.formatted_address??""),rating:d.rating?Number(d.rating):void 0,reviewCount:d.user_ratings_total?Number(d.user_ratings_total):void 0,lat:u?.lat,lng:u?.lng,placeId:String(d.place_id??""),status:"new"}})}}catch(l){return{results:[],error:l instanceof Error?l.message:String(l)}}}async function on(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await ka(t);return n&&await Ca({...e,status:"imported",convertedProspectId:t.id}),n}async function rn(){return(await w("workflow_orders",{order:"order_date.desc"})).map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),customerName:m(t,["customer_name"],""),customerCode:m(t,["customer_code"],""),orderDate:m(t,["order_date"],""),deliveryDate:m(t,["delivery_date"],""),stage:m(t,["stage"],"new"),totalAmount:x(t.total_amount),itemCount:x(t.item_count),priority:m(t,["priority"],"normal"),staffName:m(t,["staff_name"],""),notes:m(t,["notes"],"")}))}async function cn(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function dn(){return(await w("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),visitDate:m(t,["visit_date"],""),partySize:x(t.party_size)||1,language:m(t,["language"],"ja"),purpose:m(t,["purpose"],""),message:m(t,["message"],""),status:m(t,["status"],"new"),repliedAt:m(t,["replied_at"],""),confirmedTime:m(t,["confirmed_time"],""),createdAt:m(t,["created_at"],new Date().toISOString())}))}async function un(e){const{supabaseInsert:t}=await v(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>D);return{supabaseInsert:i}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const pn=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function Aa(){return(await Promise.all(pn.map(async t=>{const[n,i]=await Promise.all([it(t.table),w(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:i[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function Ee(e,t,n=100){const i=(t-1)*n,[c,a]=await Promise.all([w(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(i)}),it(e)]);return{records:c,total:a}}async function et(e){const t=await w("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const i=JSON.parse(n);return String(i.price_group??"")}catch{return""}return""}async function La(e,t){if(e){const i=await w("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(i.length>0&&i[0].special_price)return x(i[0].special_price)}const n=await w("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?x(n[0].default_sale_price):0}const g=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:ht,CALENDAR_CATEGORY_LABELS:yt,DEPT_LABELS:je,INVOICE_TYPE_LABELS:Qe,JIKOMI_STATUS_LABELS:ca,MATERIAL_CATEGORIES:Sa,PROSPECT_STAGE_COLORS:Fe,PROSPECT_STAGE_LABELS:ye,ROLE_LABELS:Ne,SEASONAL_TEMPLATES:ot,SLACK_EVENT_LABELS:Oe,TAX_DEDUCTION_LABELS:Ze,TAX_RATE_CATEGORIES:fa,convertLeadToProspect:on,deleteCalendarEvent:Ds,deleteMailSender:Cs,deleteMaterial:Ks,deletePrintLayout:ks,deleteProspect:Ys,deleteUserProfile:Ms,fetchAuditLogs:Vs,fetchBillList:ha,fetchBillingSummary:ut,fetchCalendarEvents:As,fetchCallLogs:Zs,fetchCustomerLedger:ct,fetchCustomerPriceGroup:et,fetchDeliveryLocations:Qs,fetchDeliveryNote:dt,fetchFaxInbox:Ts,fetchIntegrationSettings:wa,fetchInvoices:Te,fetchJikomiList:da,fetchKenteiList:pa,fetchLeadItems:sn,fetchLeadLists:an,fetchMailSenders:Ss,fetchMasterStats:sa,fetchMaterialList:We,fetchMyProfile:Rs,fetchPayableList:ya,fetchPaymentStatus:aa,fetchPipelineMeta:na,fetchPrintLayouts:ws,fetchProductPrice:La,fetchProspectActivities:Hs,fetchProspects:Us,fetchPurchaseList:ma,fetchRawMaterialStock:va,fetchRawRecords:Ee,fetchRawTableList:Aa,fetchSalesAnalytics:la,fetchSalesReport:ra,fetchSalesSummary:ta,fetchShopifyOrders:Is,fetchSlackLogs:Js,fetchSlackRules:_a,fetchStoreOrders:ga,fetchStoreSales:mt,fetchSyncDashboard:ia,fetchTankList:ua,fetchTaxDeclaration:pt,fetchTourInquiriesFromDb:dn,fetchUserProfiles:Os,fetchWorkflowOrdersFromDb:rn,generateTaxCSV:vs,generateTaxXML:ba,ocrFaxImage:Ns,recalculateTaxDeclaration:fs,recordAudit:Fs,saveCalendarEvent:Ls,saveCallLog:xa,saveDeliveryLocation:Ws,saveEmailCampaign:De,saveFaxRecord:js,saveIntegrationSetting:Me,saveInvoice:oa,saveLeadItem:Ca,saveLeadList:nn,saveMailSender:xs,saveMaterial:Gs,savePrintLayout:_s,saveProspect:ka,saveProspectActivity:Xs,saveSlackRule:zs,saveTaxDeclaration:bs,saveTourInquiry:un,saveUserProfile:qs,saveWorkflowOrder:cn,searchPlaces:ln,sendEmailCampaign:$a,sendSlackNotification:Bs,syncGoogleCalendar:Ps,syncIvryCallLogs:en,syncPhoneBookToIvry:tn,syncShopifyOrders:Es},Symbol.toStringTag,{value:"Module"}));function Z(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const mn={open:"未締め",closed:"締め済"};function yn(e,t){const n=e.customers.map(i=>`
  ...
  `}function be(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ge(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function ie(e,t){for(const n of t){const i=e[n];if(typeof i=="number"&&Number.isFinite(i))return i;if(typeof i=="string"){const c=Number(i);if(Number.isFinite(c))return c}}return null}function $n(e){const t=e?.productTotals;if(!t||t.length===0)return"―";const n=t.reduce((c,a)=>{const l=ie(a,["amount","salesAmount"]),o=ie(a,["marginRate","grossMarginRate"]);return l===null||l<=0||o===null?c:{weightedAmount:c.weightedAmount+l,weightedRate:c.weightedRate+l*o}},{weightedAmount:0,weightedRate:0});if(n.weightedAmount>0)return`${(n.weightedRate/n.weightedAmount).toFixed(1)}%`;const i=t.reduce((c,a)=>{const l=a,o=ie(l,["amount","salesAmount"]),r=ie(l,["grossProfit","grossAmount","margin"]),d=ie(l,["costAmount","cost","costPrice"]);if(o===null||o<=0)return c;const u=r??(d!==null?o-d:null);return u===null?c:{sales:c.sales+o,gross:c.gross+u}},{sales:0,gross:0});return i.sales>0?`${(i.gross/i.sales*100).toFixed(1)}%`:"―"}function wn(e){const i={top:20,right:20,bottom:30,left:50},c=760-i.left-i.right,a=260-i.top-i.bottom,l=Math.max(...e.map(u=>u.amount),1),o=c/e.length,r=e.map((u,p)=>{const h=u.amount/l*a,b=i.left+p*o+4,k=i.top+a-h,L=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(u.date));return`
        <g>
  ...
  `}function _n(e,t,n,i){const c={success:"正常",warning:"注意",error:"異常",running:"実行中"},a=e.salesRecords.slice(0,10).map(l=>`
            <tr>
    ...
    ${i?kn(i):""}
  `}function kn(e){const t=e.prospects.reduce((l,o)=>l+o.expectedAmount*o.probability/100,0),n=e.prospects.filter(l=>l.stage==="hot"||l.stage==="negotiating").length,i=new Date().toISOString().slice(0,10),c=e.upcomingEvents.filter(l=>l.startsAt.slice(0,10)>=i).slice(0,5),a=e.tourInquiries.filter(l=>l.status==="new").length;return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
      ...
      <article class="panel">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(100px, 1fr));gap:8px;">
          ${["cold","warm","hot","contacted","negotiating","won"].map(l=>{const o=e.prospects.filter(d=>d.stage===l).length,r=e.prospects.filter(d=>d.stage===l).reduce((d,u)=>d+u.expectedAmount,0);return`
              <div style="background:${Fe[l]};color:white;padding:12px;border-radius:6px;text-align:center;">
  ...
  `}function Sn(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function ee(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function xn(e,t){const n=e.lines.length?e.lines.map((c,a)=>`
          <tr>
            ...
            <td>${c.unit}</td>
            <td class="numeric">${ee(c.unitPrice)}</td>
...
`,"<br />")}function An(e){const n=[...Object.values(ot),{id:"custom",season:"カスタム",subject:"",body:""}].map(c=>`
        <button
  ...
  `}function Ln(e,t){const n=[$e("得意先",t.customers.map(c=>`
          <button
  ...
  `}function we(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Lt(e){return e.trim().toLowerCase()}function Dn(e,t){const n=Lt(t),i=e.filter(a=>n?[a.code,a.name,a.name].map(Lt).some(l=>l.includes(n)):!0).slice(0,50),c=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Ea({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:c,emptyMessage:"該当する得意先が見つかりません。"})}function En(e){return e.toISOString().slice(0,10)}function W(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function H(e,t){return e[t]?`<div class="field-error">${W(e[t])}</div>`:""}function te(e,t,n=""){return[n,e[t]?"has-error":""].filter(Boolean).join(" ")}function In(e,t,n,i){const c=Object.keys(Qe).map(r=>`<option value="${r}" ${e.invoiceType===r?"selected":""}>${Qe[r]}</option>`).join(""),a=e.lines.map((r,d)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${te(i,`lines.${d}.productCode`,"input-cell")}" type="text" data-line="${d}" data-field="productCode" value="${W(r.productCode)}" placeholder="P00001" />
        ...
        <td>
          <input class="${te(i,`lines.${d}.productName`,"input-cell")}" type="text" data-line="${d}" data-field="productName" value="${W(r.productName)}" placeholder="商品名" />
          ${H(i,`lines.${d}.productName`)}
        </td>
        <td>
          <input class="${te(i,`lines.${d}.quantity`,"input-cell numeric")}" type="number" data-line="${d}" data-field="quantity" value="${r.quantity}" min="0" />
          ${H(i,`lines.${d}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${d}" data-field="unit" value="${r.unit}" placeholder="本" /></td>
        <td>
          <input class="${te(i,`lines.${d}.unitPrice`,"input-cell numeric")}" type="number" data-line="${d}" data-field="unitPrice" value="${r.unitPrice}" min="0" />
...
`);return`
  ...
  `}function Fn(e){const t={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},i=e.map(r=>`
      <tr>
  ...
  `}function Bn(e,t){const n=[...new Set(e.map(c=>c.businessType).filter(Boolean))].sort(),i=[...new Set(e.map(c=>c.areaCode).filter(Boolean))].sort();return`
  ...
  `}function Ta(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Un(e){return e.map(t=>`
      ...
      `).join("")}function Hn(e,t,n=vt){const{filtered:i,paged:c,totalPages:a}=Jn(e.customers,n);return`
    <section class="page-head">
      <div>
  ...
  `}function Je(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Xn(e,t){if(!e&&!t)return"";const n=e;return`
  ...
  `}function Gn(e){const t=e.map(c=>{const l=(c.minimumStock>0?c.currentStock/c.minimumStock:1/0)<1.5;return`
        <tr>
          ...
          <td class="numeric">${Je(c.unitCost)}</td>
          <td class="numeric">${Je(c.currentStock*c.unitCost)}</td>
          <td>${c.lastUpdated}</td>
          <td>
  ...
  `}function Kn(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function Be(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Qn={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Wn(e){return`
    <section class="page-head">
      <div>
  ...
  `}function ae(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Nt(e){return e.trim().toLowerCase()}function Zn(e,t){const n=Nt(t),i=e.filter(a=>n?[a.code,a.name,a.janCode].map(Nt).some(l=>l.includes(n)):!0),c=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Ea({title:"商品検索",searchQuery:t,placeholder:"コード・名前・JANで検索",resultsHtml:c,emptyMessage:"該当する商品が見つかりません。"})}function X(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ei(e,t){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},i={pending:"warning",confirmed:"neutral",paid:"success"},c={unpaid:"未払い",partial:"一部支払",paid:"支払済"},a={unpaid:"warning",partial:"neutral",paid:"success"},l=e.map(p=>`
      <tr>
  ...
  `}function oe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ti(e,t){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},i={holding:"neutral",due:"warning",cleared:"success"},c=e.map(u=>`
      <tr>
  ...
  `}function ni(e,t,n,i){const c={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function ii(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function li(e){return e.replace("-","/")}function oi(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,i={top:16,right:24,bottom:36,left:64},c=t-i.left-i.right,a=n-i.top-i.bottom,l=Math.max(...e.map(u=>u.amount),1),o=c/e.length,r=[0,.25,.5,.75,1].map(u=>{const p=i.top+a-a*u,h=`${Math.round(l*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
  ...
  `}function re(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function di(e){const t=Math.max(...e.salesByProduct.flatMap(a=>a.values),1),n=e.salesByProduct.map(a=>{const l=a.values.map((o,r)=>`
          <div class="bar-col">
            <div class="bar" style="height:${Math.round(o/t*120)}px" title="${e.months[r]}: ${re(o)}"></div>
  ...
  `}function ui(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function pi(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ot(e){return e.toISOString().slice(0,10)}function mi(e,t,n){const i=e.length?e.map(c=>`
            <tr>
              ...
              <td class="numeric">${pi(c.amount)}</td>
            </tr>
  ...
  `}function xe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function yi(e,t,n,i){const c={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},a={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},l={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},o=e.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
  ...
  `}function Ye(e){const t={};return e.querySelectorAll("[data-fd-id]").forEach(n=>{const i=n.dataset.fdId??"",c=parseFloat(n.style.left)||0,a=parseFloat(n.style.top)||0;t[i]={x:c,y:a}}),t}function gi(e,t,n,i,c){const a=Array.from(new Set([...e.map(d=>d.businessType??""),...t.map(d=>d.businessType??"")].filter(Boolean))),l=e.filter(d=>d.lat&&d.lng).length,o=t.filter(d=>d.lat&&d.lng).length,r=n.filter(d=>d.lat&&d.lng).length;return`
    <section class="page-head">
      <div>
  ...
  `}function Si(e,t,n){if(e.step==="customer"){const i=e.customerQuery.toLowerCase(),c=i?t.filter(a=>a.name.toLowerCase().includes(i)||a.code.toLowerCase().includes(i)):t.slice(0,20);return`
      <section class="panel">
...
金井酒造店`;function Li(e,t){const n=t?e.find(c=>c.id===t):null,i=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${n||i?`
      ...
      `:""}
  `}function Di(e,t,n,i){const[c,a]=t.split("-").map(_=>parseInt(_,10)),l=new Date(c,a-1,1),o=new Date(c,a,0),r=l.getDay(),d=o.getDate(),u=[];for(let _=0;_<r;_++)u.push({isOutside:!0});for(let _=1;_<=d;_++)u.push({date:new Date(c,a-1,_)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter(_=>_.category===n):e,h={};p.forEach(_=>{const O=_.startsAt.slice(0,10);h[O]??=[],h[O].push(_)});const b=new Date().toISOString().slice(0,10),k=u.map(_=>{if(_.isOutside)return'<div class="cal-cell cal-outside"></div>';const O=_.date,B=`${O.getFullYear()}-${String(O.getMonth()+1).padStart(2,"0")}-${String(O.getDate()).padStart(2,"0")}`,ze=h[B]??[],Ja=B===b,wt=O.getDay();return`
        <div class="cal-cell ${Ja?"cal-today":""} ${wt===0?"cal-sun":wt===6?"cal-sat":""}"
          ...
          <div class="cal-events">
            ...
            `).join("")}
            ${ze.length>3?`<button class="cal-event-more" data-cal-date="${B}">+${ze.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),L=i?.isOpen?Ei(i):"",$=new Date(c,a-2,1),E=new Date(c,a,1),ne=`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`,N=`${E.getFullYear()}-${String(E.getMonth()+1).padStart(2,"0")}`,he=(()=>{const _=new Date;return`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
  ...
  `}function Pi(e,t){const n=e.reduce((a,l)=>a+l.totalAmount,0),i=e.filter(a=>a.financialStatus==="paid").length,c=e.filter(a=>a.fulfillmentStatus!=="fulfilled"&&a.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function Ni(e,t,n){const i=t==="__new__"?null:e.find(l=>l.id===t),c=t==="__new__";return n?.role==="admin"?`
    <section class="page-head">
      <div>
  ...
  `}function Ri(e){const t=e.prospects.reduce((a,l)=>a+l.expectedAmount,0),n=e.prospects.reduce((a,l)=>a+l.expectedAmount*l.probability/100,0),i=e.prospects.filter(a=>a.stage==="won").length,c=e.prospects.filter(a=>a.stage==="hot"||a.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    <section class="panel" style="padding:12px;">
      ...
      <div class="pk-board">${["cold","warm","hot","contacted","negotiating","won","lost"].map(i=>{const c=e.filter(l=>l.stage===i),a=c.reduce((l,o)=>l+o.expectedAmount,0);return`
        <div class="pk-col" data-prospect-stage="${i}">
          <div class="pk-col-header" style="--pk-color:${Fe[i]};">
          ...
          <tbody>
            ${e.map(t=>`
              <tr>
                ...
                <td><span class="status-pill" style="background:${Fe[t.stage]};color:white;">${ye[t.stage]}</span></td>
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 140px;">
              ...
              <select id="prospect-stage">
                ${Object.entries(ye).map(([i,c])=>`<option value="${i}" ${n?.stage===i?"selected":""}>${c}</option>`).join("")}
              </select>
            </label>
            <label class="field" style="flex:1 1 120px;">
              <span>流入元</span>
  ...
  `}function Vi(e,t,n){const i=e?.config.webhook_url??"",c=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
  ...
  `}function zi(e,t,n,i){const c=new Map(t.map(p=>[p.code,p])),a=e.filter(p=>p.callDirection==="inbound").length,l=e.filter(p=>p.callDirection==="outbound").length,o=e.filter(p=>p.callStatus==="missed").length,r=e.reduce((p,h)=>p+(h.durationSeconds??0),0),d=p=>{if(p===0)return"―";const h=Math.floor(p/60),b=p%60;return h>0?`${h}分${b}秒`:`${b}秒`},u=p=>{if(p.matchedCustomerCode){const h=c.get(p.matchedCustomerCode);if(h)return`${h.name} (既存)`}return"未登録番号"};return`
    <section class="page-head">
      <div>
  ...
  `}const Ji=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function Bi(e){const t=e.activeListId?e.lists.find(a=>a.id===e.activeListId):null,n=e.items.filter(a=>a.status==="new").length,i=e.items.filter(a=>a.status==="imported").length,c=e.items.filter(a=>a.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
  ...
  `}const Vt={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},Ui={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},Yi={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function I(e){return"¥"+e.toLocaleString("ja-JP")}function pe(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function Na(e,t){const n=e.reduce((a,l)=>a+l.amount,0),i=Math.floor(n*t),c=n+i;return{subtotal:n,taxAmount:i,total:c}}const S={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function C(e,t){const n=e.align??"left",i=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${i}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function He(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),i=n-2018;return{y:i>0?String(i).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function Hi(e,t,n){const i=He(e.documentDate),c=He(e.orderDate??e.documentDate),a=He(e.deliveryDate??e.documentDate),l=e.lines.slice(0,6).map(($,E)=>{const ne=S.detailStartY+E*S.detailRowH,N=S.detailCols,he=[],_=(O,B)=>{B&&he.push(C({...O,y:ne,x:O.x+0},B))};return _(N.productName,$.productName+($.spec?` ${$.spec}`:"")),_(N.productCode,$.productCode),_(N.color,$.color??""),_(N.size,[$.size,$.caseQty?`×${$.caseQty}`:""].filter(Boolean).join(" ")),_(N.unit,$.unit),_(N.quantity,$.quantity>0?$.quantity.toLocaleString("ja-JP"):""),_(N.correctedQty,$.correctedQuantity?$.correctedQuantity.toLocaleString("ja-JP"):""),_(N.discount,$.discount?$.discount.toLocaleString("ja-JP"):""),_(N.unitPrice,$.unitPrice>0?$.unitPrice.toLocaleString("ja-JP"):""),_(N.costAmount,$.amount>0?$.amount.toLocaleString("ja-JP"):""),_(N.retailPrice,$.retailPrice?$.retailPrice.toLocaleString("ja-JP"):""),_(N.note,$.receivedAmount?$.receivedAmount.toLocaleString("ja-JP"):""),he.join("")}).join(""),o=e.lines.reduce(($,E)=>$+(E.amount||0),0),r=e.lines.reduce(($,E)=>$+(E.retailPrice||0)*(E.correctedQuantity??E.quantity),0),d=e.lines.reduce(($,E)=>$+(E.receivedAmount||0),0),u=e.lines.reduce(($,E)=>$+(E.returnAmount||0),0),p=e.lines.reduce(($,E)=>$+E.quantity,0),h=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",b=n.calibrationOffsetX||0,k=n.calibrationOffsetY||0,L=`transform: translate(${b}mm, ${k}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${h}">
        ...
        ${C(S.correctedRetailTotal,r.toLocaleString("ja-JP"))}
        </div>
      </div>
    </div>
  `}function Xi(e,t,n){const{subtotal:i,taxAmount:c,total:a}=Na(e.lines,e.taxRate),l=e.previousBalance??0,o=e.paymentAmount??0,r=l-o+a,d=e.lines.map(p=>`
      <tr>
  ...
  `}function Gi(e,t,n){const{subtotal:i,taxAmount:c,total:a}=Na(e.lines,e.taxRate),l=e.lines.map(r=>`
      <tr>
  ...
  `}function Ki(e,t,n,i){let c="";switch(e){case"chain_store":c=Hi(i,n,t);break;case"quotation":c=Gi(i,n,t);break;case"invoice_monthly":c=Xi(i,n,t);break}const a=Object.keys(Vt).map(r=>`<button class="tab-button ${e===r?"active":""}" data-print-template="${r}">${Vt[r]}</button>`).join(""),l=i.lines.map((r,d)=>`
      <tr>
...
`}async function al(e,t){const{supabaseInsert:n}=await v(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>D);return{supabaseInsert:o}},void 0);let i=0,c=0;const l={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const o of t){if(!o._valid)continue;const{_valid:r,_error:d,...u}=o,p={...u};if(!p.id){const h=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[h]??`${e}-${Date.now()}-${i+c}`)}for(const h of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[h]=="string"&&p[h]!==""){const b=Number(p[h]);Number.isFinite(b)&&(p[h]=b)}try{await n(l,p)!==null?i++:c++}catch{c++}}return{inserted:i,failed:c}}function Xe(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function sl(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function nl(e,t,n,i,c){const a=n.reduce((d,u)=>d+u.rowCount,0),l=n.map(d=>d.lastSyncAt).filter(d=>d!==null).sort().reverse()[0]??null,o=100,r=Math.max(1,Math.ceil(c/o));return`
  ...
  `}function Ge(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ll(e,t,n){const i=e.rows.map((d,u)=>`
      <tr>
  ...
  `;const o={id:c,message:e,type:t,el:l};st.push(o),i.appendChild(l),requestAnimationFrame(()=>{l.classList.add("toast-enter")});const r=()=>dl(o);l.querySelector(".toast-dismiss").addEventListener("click",r),setTimeout(()=>{l.classList.add("toast-exit"),l.addEventListener("animationend",r,{once:!0})},a)}function dl(e){const t=st.indexOf(e);t!==-1&&(st.splice(t,1),e.el.remove())}function ul(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function J(e,t={}){const{title:n="確認",confirmLabel:i="OK",cancelLabel:c="キャンセル",variant:a="primary"}=t;return new Promise(l=>{const o=document.createElement("div");o.className="modal-backdrop confirm-backdrop",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),o.innerHTML=`
    ...
    `;const r=u=>{o.classList.add("confirm-exit"),o.addEventListener("animationend",()=>{o.remove()},{once:!0}),l(u)};o.querySelector(".confirm-cancel").addEventListener("click",()=>r(!1)),o.querySelector(".confirm-ok").addEventListener("click",()=>r(!0)),o.addEventListener("click",u=>{u.target===o&&r(!1)});const d=u=>{u.key==="Escape"&&(document.removeEventListener("keydown",d),r(!1))};document.addEventListener("keydown",d),document.body.appendChild(o),requestAnimationFrame(()=>{o.querySelector(".confirm-ok")?.focus()})})}const pl=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
...
`)}`,l=new Blob([a],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(l),r=document.createElement("a");r.href=o,r.download=e,document.body.append(r),r.click(),r.remove(),window.setTimeout(()=>URL.revokeObjectURL(o),0)}const hl=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser"],Ae=[{name:"青葉商事",email:"aoba@example.jp",area:"関東",historySegment:"seasonal"},{name:"北斗酒販",email:"hokuto@example.jp",area:"北海道",historySegment:"premium"},{name:"中央フーズ",email:"chuo@example.jp",area:"関東",historySegment:"seasonal"},{name:"東海酒店",email:"tokai@example.jp",area:"中部",historySegment:"premium"},{name:"三和物産",email:"sanwa@example.jp",area:"関西",historySegment:"liqueur"},{name:"南星リカー",email:"nansei@example.jp",area:"九州",historySegment:"seasonal"},{name:"山川酒店",email:"yamakawa@example.jp",area:"関西",historySegment:"premium"},{name:"瑞穂商店",email:"mizuho@example.jp",area:"中部",historySegment:"seasonal"}],Jt=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"}];function ja(e){const t=ot[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function ft(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function vl(){const e=ja("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const Ve=new Date,fl=Ve.toISOString().slice(0,7),bl=Ve.getFullYear(),gl=Ve.getMonth()+1,$l=Ve.toISOString().slice(0,10),wl="C0011",K=vl();function Oa(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return hl.includes(n)?n:"/"}function bt(e){switch(e){case"/cat/sales":case"/invoice":case"/ledger":case"/invoice-entry":case"/delivery":case"/billing":case"/report":return"sales";case"/cat/brewery":case"/jikomi":case"/tanks":case"/kentei":case"/materials":return"brewery";case"/cat/purchase":case"/purchase":case"/raw-material":return"purchase";case"/cat/more":case"/master":case"/analytics":case"/tax":case"/store":case"/setup":case"/raw-browser":return"more";case"/email":return"email";default:return"dashboard"}}const Bt=Oa(location.pathname),s={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,invoiceForm:ft(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:fl,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:bl,taxMonth:gl,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],callLogs:[],mapFilters:{showCustomers:!0,showProspects:!0,showDelivery:!0,filterRegion:"",filterBusinessType:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...Ui,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...Yi},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:$l,route:Bt,currentCategory:bt(Bt),sidebarOpen:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:wl,masterTab:"customers",masterFilter:{...vt},analyticsTab:"products",emailAudienceMode:K.mode,emailRegion:K.region,emailHistorySegment:K.historySegment,emailTemplateId:K.templateId,emailSubject:K.subject,emailBody:K.body,emailSaveMessage:K.saveMessage,emailSending:!1,globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function Ut(e){return e.slice(0,10)}function _l(e){return{...e}}function Re(){s.pickerMode=null,s.pickerQuery="",s.pickerTargetLine=null}function Ra(){s.invoiceForm=ft(),s.invoiceSavedDocNo=null,s.invoicePriceGroup="",s.invoiceErrors={},Re()}function qa(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,i)=>{n.productCode.trim()||(t[`lines.${i}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${i}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${i}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${i}.unitPrice`]="単価は0円以上で入力してください。")}),t}function kl(e){const t=s.invoiceForm.lines[e];t&&s.invoiceForm.lines.splice(e+1,0,_l(t))}function Sl(){const e=s.invoiceRecords[0],t=s.masterStats?.customers[0],n=s.masterStats?.products.slice(0,2)??[];s.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:s.invoiceForm.staffCode||"S001",lines:n.map((i,c)=>{const a=c===0?1:2,l=1200*(c+1);return{productCode:i.code,productName:i.name,quantity:a,unitPrice:l,unit:"本",amount:a*l}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},s.invoiceSavedDocNo=null,s.invoiceErrors={}}function xl(e){const t=s.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function Cl(e){const t=s.masterStats?.customers.find(n=>n.name===e.trim());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function Ma(e){if(V(e),s.invoiceErrors=qa(s.invoiceForm),Object.keys(s.invoiceErrors).length>0){y();return}s.invoiceSaving=!0,y(),oa(s.invoiceForm).then(t=>{s.invoiceSavedDocNo=t.documentNo,s.invoiceSaving=!1,s.invoiceErrors={},s.invoiceForm=ft(),y()}).catch(()=>{s.invoiceSaving=!1,y()})}function Fa(e){const t=s.salesFilter.startDate?new Date(s.salesFilter.startDate):null,n=s.salesFilter.endDate?new Date(`${s.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((i,c)=>new Date(c.date).getTime()-new Date(i.date).getTime()).filter(i=>{const c=new Date(i.date);return!(t&&c<t||n&&c>n)})}function Va(){switch(s.emailAudienceMode){case"area":return s.emailRegion==="all"?Ae:Ae.filter(e=>e.area===s.emailRegion);case"history":return Ae.filter(e=>e.historySegment===s.emailHistorySegment);default:return Ae}}function Al(){const e=Va();return{audienceMode:s.emailAudienceMode,region:s.emailRegion,historySegment:s.emailHistorySegment,selectedTemplateId:s.emailTemplateId,subject:s.emailSubject,body:s.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:s.emailSaveMessage,sending:s.emailSending,senderId:s.emailSenderId,senders:s.mailSenders}}function Ke(e){const t=Va(),n=s.emailAudienceMode==="area"?s.emailRegion:s.emailAudienceMode==="history"?s.emailHistorySegment:"all";return{subject:s.emailSubject.trim(),body:s.emailBody.trim(),templateId:s.emailTemplateId,audienceMode:s.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(i=>i.email),status:e}}function gt(){return s.user,!1}function me(){s.globalSearchOpen=!1,s.globalQuery=""}function Ll(){const e=s.globalQuery.trim().toLowerCase();return e?{customers:s.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:s.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:s.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:Jt.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:Jt}}function Dl(){let e=[],t,n="export.csv";switch(s.route){case"/sales":e=(s.salesSummary?Fa(s.salesSummary):[]).map(i=>({documentNo:i.documentNo,date:i.date,customerCode:i.customerCode,customerName:i.customerName,amount:i.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...s.paymentStatus?.records??[]].sort((i,c)=>c.balanceAmount-i.balanceAmount).map(i=>({...i})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=s.invoiceRecords.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=s.purchaseList.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=s.jikomiList.map(i=>({...i})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=s.tankList.map(i=>({...i})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=s.kenteiList.map(i=>({...i})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=s.materialList.map(i=>({...i})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":s.masterTab==="customers"?(e=s.masterStats?.customers.map(i=>({...i}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=s.masterStats?.products.map(i=>({...i}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}yl(n,e,t)}function Yt(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),s.route=e,s.currentCategory=bt(e),s.sidebarOpen=!1,me(),$t(e)}async function $t(e){s.actionLoading=!0,y();try{switch(e){case"/delivery":s.deliveryNote||(s.deliveryNote=await dt(s.deliverySearchDocNo||"D240122"));break;case"/billing":s.billingSummary||(s.billingSummary=await ut(s.billingYearMonth));break;case"/report":s.salesReport||(s.salesReport=await ra());break;case"/jikomi":s.jikomiList.length===0&&(s.jikomiList=await da());break;case"/tanks":s.tankList.length===0&&(s.tankList=await ua());break;case"/kentei":s.kenteiList.length===0&&(s.kenteiList=await pa());break;case"/materials":s.materialList.length===0&&(s.materialList=await We());break;case"/purchase":(s.purchaseList.length===0||s.payableList.length===0)&&([s.purchaseList,s.payableList]=await Promise.all([ma(),ya()]));break;case"/raw-material":(s.billList.length===0||s.rawStockList.length===0)&&([s.billList,s.rawStockList]=await Promise.all([ha(),va()]));break;case"/tax":s.taxDeclaration||(s.taxDeclaration=await pt(s.taxYear,s.taxMonth));break;case"/store":(s.storeSales.length===0||s.storeOrders.length===0)&&([s.storeSales,s.storeOrders]=await Promise.all([mt(s.storeSalesDate),ga()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await v(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>g);return{fetchMailSenders:n}},void 0);if(s.mailSenders=await t(),!s.emailSenderId||!s.mailSenders.find(n=>n.id===s.emailSenderId)){const n=s.mailSenders.find(i=>i.isDefault)??s.mailSenders[0];n&&(s.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await v(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>g);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await v(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>g);return{fetchIntegrationSettings:n}},void 0);s.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await v(async()=>{const{fetchShopifyOrders:i,fetchIntegrationSettings:c}=await Promise.resolve().then(()=>g);return{fetchShopifyOrders:i,fetchIntegrationSettings:c}},void 0);s.shopifyOrders=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await v(async()=>{const{fetchFaxInbox:i,fetchIntegrationSettings:c}=await Promise.resolve().then(()=>g);return{fetchFaxInbox:i,fetchIntegrationSettings:c}},void 0);s.faxRecords=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await v(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>g);return{fetchUserProfiles:n}},void 0);s.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:i}=await v(async()=>{const{fetchMyProfile:a,fetchAuditLogs:l,fetchMailSenders:o}=await Promise.resolve().then(()=>g);return{fetchMyProfile:a,fetchAuditLogs:l,fetchMailSenders:o}},void 0),c=s.user?.email??s.myProfile?.email??"";c&&(s.myProfile=await t(c)),s.mailSenders.length===0&&(s.mailSenders=await i()),s.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await v(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>g);return{fetchAuditLogs:n}},void 0);s.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await v(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>g);return{fetchProspects:n}},void 0);s.prospects=await t()}break;case"/map":{const{fetchProspects:t,fetchDeliveryLocations:n,fetchIntegrationSettings:i}=await v(async()=>{const{fetchProspects:c,fetchDeliveryLocations:a,fetchIntegrationSettings:l}=await Promise.resolve().then(()=>g);return{fetchProspects:c,fetchDeliveryLocations:a,fetchIntegrationSettings:l}},void 0);s.prospects=await t(),s.deliveryLocations=await n(),s.integrations.length===0&&(s.integrations=await i())}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:n}=await v(async()=>{const{fetchCallLogs:i,fetchIntegrationSettings:c}=await Promise.resolve().then(()=>g);return{fetchCallLogs:i,fetchIntegrationSettings:c}},void 0);s.callLogs=await t(100),s.integrations.length===0&&(s.integrations=await n())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:n}=await v(async()=>{const{fetchLeadLists:i,fetchIntegrationSettings:c}=await Promise.resolve().then(()=>g);return{fetchLeadLists:i,fetchIntegrationSettings:c}},void 0);s.leadLists=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await v(async()=>{const{fetchWorkflowOrdersFromDb:n}=await Promise.resolve().then(()=>g);return{fetchWorkflowOrdersFromDb:n}},void 0);s.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await v(async()=>{const{fetchTourInquiriesFromDb:n}=await Promise.resolve().then(()=>g);return{fetchTourInquiriesFromDb:n}},void 0);s.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:i}=await v(async()=>{const{fetchSlackRules:c,fetchSlackLogs:a,fetchIntegrationSettings:l}=await Promise.resolve().then(()=>g);return{fetchSlackRules:c,fetchSlackLogs:a,fetchIntegrationSettings:l}},void 0);s.slackRules=await t(),s.slackLogs=await n(50),s.integrations.length===0&&(s.integrations=await i())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:n,fetchWorkflowOrdersFromDb:i,fetchTourInquiriesFromDb:c}=await v(async()=>{const{fetchProspects:a,fetchCalendarEvents:l,fetchWorkflowOrdersFromDb:o,fetchTourInquiriesFromDb:r}=await Promise.resolve().then(()=>g);return{fetchProspects:a,fetchCalendarEvents:l,fetchWorkflowOrdersFromDb:o,fetchTourInquiriesFromDb:r}},void 0);s.prospects.length===0&&(s.prospects=await t()),s.calendarEvents.length===0&&(s.calendarEvents=await n(s.calendarYearMonth)),s.materialList.length===0&&(s.materialList=await We()),s.workflowOrders.length===0&&(s.workflowOrders=await i()),s.tourInquiries.length===0&&(s.tourInquiries=await c())}break;default:break}}catch(t){console.warn("Route data load error",t)}finally{s.actionLoading=!1,y()}}function Ht(){if(gt())return zn(s.authError,s.authSubmitting);if(s.loading)return`
    ...
    `;const e={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売管理",items:[{path:"/cat/sales",label:"販売管理トップ",kicker:"Category"},{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/report",label:"集計帳票",kicker:"Report"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],brewery:[{label:"蔵内管理",items:[{path:"/cat/brewery",label:"蔵内管理トップ",kicker:"Category"},{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"}]}],purchase:[{label:"仕入管理",items:[{path:"/cat/purchase",label:"仕入管理トップ",kicker:"Category"},{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],more:[{label:"その他",items:[{path:"/cat/more",label:"その他トップ",kicker:"Category"},{path:"/tax",label:"酒税申告",kicker:"Tax"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/master",label:"マスタ",kicker:"Master"},{path:"/email",label:"メール配信",kicker:"Mail"},{path:"/setup",label:"連動設定",kicker:"Setup"},{path:"/raw-browser",label:"データブラウザ",kicker:"RawData"}]}],email:[{label:"メール配信",items:[{path:"/email",label:"季節商品案内",kicker:"Mail"}]}]},t=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/cat/sales",label:"販売管理"},{category:"brewery",path:"/cat/brewery",label:"蔵内管理"},{category:"purchase",path:"/cat/purchase",label:"仕入管理"},{category:"more",path:"/cat/more",label:"その他"},{category:"email",path:"/email",label:"メール配信"}],n=e[s.currentCategory].map(o=>`
      ...
      `).join(""),c=s.pickerMode&&s.masterStats?s.pickerMode==="customer"?Dn(s.masterStats.customers,s.pickerQuery):Zn(s.masterStats.products,s.pickerQuery):"",a=s.globalSearchOpen?Ln(s.globalQuery,Ll()):"",l=s.user?`
