...
`}function vn(e){const t=e.rows.map(r=>{const l=Math.max(0,r.productionVolume+r.previousBalance+r.currentAdjustment-r.exportDeduction-r.sampleDeduction),d=Math.round(l*r.taxRate);return{...r,taxableVolume:l,volume:l,taxAmount:d}}),n=t.reduce((r,l)=>r+l.taxableVolume,0),i=t.reduce((r,l)=>r+l.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:i}}async function fn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>R);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:ts(e),submitted_at:e.submittedAt})}async function Nt(e){const t=await A("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(n=>({id:m(n,["id"],""),saleDate:m(n,["sale_date"],e),saleTime:m(n,["sale_time"],""),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),quantity:b(n,["quantity"],0),unitPrice:b(n,["unit_price"],0),amount:b(n,["amount"],0),paymentMethod:m(n,["payment_method"],"cash")})):[]}async function as(){const e=await A("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),orderDate:B(t,["order_date"],""),customerName:m(t,["customer_name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["shipping_address"],""),items:[],totalAmount:b(t,["total_amount"],0),status:m(t,["status"],"new"),shippingDate:B(t,["shipping_date"],"")})):[]}async function Ye(e){const t=await et("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function ss(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function bn(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await A("print_layouts",t)).map(i=>({id:m(i,["id"],""),name:m(i,["name"],""),templateKey:m(i,["template_key"],""),positions:i.positions??{},isDefault:U(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}))}async function gn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:r}=await Promise.resolve().then(()=>R);return{supabaseInsert:r}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},i=await t("print_layouts",n);return i?{id:m(i,["id"],e.id),name:m(i,["name"],e.name),templateKey:m(i,["template_key"],e.templateKey),positions:i.positions??e.positions,isDefault:U(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}:null}async function $n(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function _n(){return(await A("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),signature:m(t,["signature"],""),replyTo:m(t,["reply_to"],""),isDefault:U(t,["is_default"],!1),isVerified:U(t,["is_verified"],!1),note:m(t,["note"],"")}))}async function wn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:m(n,["id"],e.id),name:m(n,["name"],e.name),email:m(n,["email"],e.email),displayName:m(n,["display_name"],""),signature:m(n,["signature"],""),replyTo:m(n,["reply_to"],""),isDefault:U(n,["is_default"],!1),isVerified:U(n,["is_verified"],!1)}:null}async function kn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const Rt={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},Ot={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Sn(e){const t=`${e}-01T00:00:00Z`,[n,i]=e.split("-").map(a=>parseInt(a,10)),r=new Date(n,i,0).getDate(),l=`${e}-${String(r).padStart(2,"0")}T23:59:59Z`;return(await A("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${l})`,order:"starts_at.asc"})).map(a=>({id:m(a,["id"],""),title:m(a,["title"],""),description:m(a,["description"],""),category:m(a,["category"],"general")||"general",startsAt:m(a,["starts_at"],new Date().toISOString()),endsAt:m(a,["ends_at"],""),isAllDay:U(a,["is_all_day"],!1),location:m(a,["location"],""),attendees:a.attendees??[],relatedCustomerCode:m(a,["related_customer_code"],""),relatedOrderId:m(a,["related_order_id"],""),color:m(a,["color"],""),googleEventId:m(a,["google_event_id"],"")}))}async function xn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??Ot[e.category],updated_at:new Date().toISOString()})?e:null}async function Pn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ns(){return(await A("integration_settings",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),provider:m(t,["provider"],""),config:t.config??{},isEnabled:U(t,["is_enabled"],!1),lastSyncAt:m(t,["last_sync_at"],""),lastStatus:m(t,["last_status"],"")}))}async function Te(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function An(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const i=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,r=await fetch(i,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const l=await r.json(),{supabaseInsert:d}=await g(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>R);return{supabaseInsert:o}},void 0);let a=0;for(const o of l.orders){const c=`shopify_${o.id}`;await d("shopify_orders",{id:c,shopify_order_id:String(o.id),order_number:String(o.order_number??""),order_date:String(o.created_at??new Date().toISOString()),customer_name:String(o.customer?.first_name??"")+" "+String(o.customer?.last_name??""),customer_email:String(o.customer?.email??""),total_amount:Math.round(parseFloat(String(o.total_price??"0"))),financial_status:String(o.financial_status??""),fulfillment_status:String(o.fulfillment_status??"unfulfilled"),line_items:o.line_items??[],shipping_address:o.shipping_address??null,raw_payload:o}),a++}return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${a}件取得成功`}),{count:a}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function En(){return(await A("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),shopifyOrderId:m(t,["shopify_order_id"],""),orderNumber:m(t,["order_number"],""),orderDate:m(t,["order_date"],""),customerName:m(t,["customer_name"],""),customerEmail:m(t,["customer_email"],""),totalAmount:q(t.total_amount),financialStatus:m(t,["financial_status"],""),fulfillmentStatus:m(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function Dn(e){const t=e.config.refresh_token,n=e.config.client_id,i=e.config.client_secret;if(!t||!n||!i)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const r=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:n,client_secret:i})});if(!r.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${r.status}`};const d=(await r.json()).access_token;return await Te({...e,config:{...e.config,oauth_token:d}}),e.config.oauth_token=d,{token:d}}async function Cn(e){let t=e.config.oauth_token;const n=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const i=new Date().toISOString(),r=new Date(Date.now()+30*86400*1e3).toISOString(),l=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${i}&timeMax=${r}&singleEvents=true&orderBy=startTime`;let d=await fetch(l,{headers:{Authorization:`Bearer ${t}`}});if(d.status===401){const u=await Dn(e);if(u.error)return{count:0,error:u.error};t=u.token,d=await fetch(l,{headers:{Authorization:`Bearer ${t}`}})}if(!d.ok)return{count:0,error:`HTTP ${d.status}`};const a=await d.json(),{supabaseInsert:o}=await g(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>R);return{supabaseInsert:u}},void 0);let c=0;for(const u of a.items){const p=`gcal_${u.id}`,y=u.start?.dateTime??u.start?.date??"",h=u.end?.dateTime??u.end?.date??"";await o("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(y),ends_at:String(h),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),c++}return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${c}件取得`}),{count:c}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Ln(){return(await A("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),receivedAt:m(t,["received_at"],""),senderPhone:m(t,["sender_phone"],""),senderName:m(t,["sender_name"],""),imageUrl:m(t,["image_url"],""),ocrStatus:m(t,["ocr_status"],"pending")||"pending",ocrText:m(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:m(t,["linked_invoice_id"],"")}))}async function In(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const i=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,r=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return r.ok?{text:(await r.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${r.status}`}}catch(i){return{text:"",error:i instanceof Error?i.message:String(i)}}}async function Tn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Xe={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Ke={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function qn(){return(await A("user_profiles",{order:"display_name.asc"})).map(t=>({id:m(t,["id"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),staffCode:m(t,["staff_code"],""),department:m(t,["department"],"all")||"all",role:m(t,["role"],"staff")||"staff",defaultMailSenderId:m(t,["default_mail_sender_id"],""),phone:m(t,["phone"],""),avatarUrl:m(t,["avatar_url"],""),isActive:U(t,["is_active"],!0),lastSignInAt:m(t,["last_sign_in_at"],""),createdAt:m(t,["created_at"],"")}))}async function Nn(e){if(!e)return null;const t=await A("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:m(n,["id"],""),email:m(n,["email"],""),displayName:m(n,["display_name"],""),staffCode:m(n,["staff_code"],""),department:m(n,["department"],"all")||"all",role:m(n,["role"],"staff")||"staff",defaultMailSenderId:m(n,["default_mail_sender_id"],""),phone:m(n,["phone"],""),avatarUrl:m(n,["avatar_url"],""),isActive:U(n,["is_active"],!0),lastSignInAt:m(n,["last_sign_in_at"],"")}}async function Rn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function On(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Mn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>R);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function jn(e=100){return(await A("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),action:m(n,["action"],""),entityType:m(n,["entity_type"],""),entityId:m(n,["entity_id"],""),userEmail:m(n,["user_email"],""),changes:n.changes??{},createdAt:m(n,["created_at"],"")}))}const We={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function is(){return(await A("slack_notifications",{order:"event_type.asc"})).map(t=>({id:m(t,["id"],""),eventType:m(t,["event_type"],"new_order"),enabled:U(t,["enabled"],!0),channel:m(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:m(t,["last_triggered_at"],"")}))}async function Fn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function Bn(e=50){return(await A("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),eventType:m(n,["event_type"],""),channel:m(n,["channel"],""),message:m(n,["message"],""),status:m(n,["status"],"sent"),error:m(n,["error"],""),sentAt:m(n,["sent_at"],"")}))}async function zn(e,t,n){const r=(await ns()).find(c=>c.provider==="slack");if(!r||!r.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const l=r.config.webhook_url;if(!l)return{ok:!1,error:"Webhook URL未設定"};const a=(await is()).find(c=>c.eventType===e&&c.enabled);if(!a)return{ok:!1,error:"通知ルールが無効"};const o=n??a.channel??r.config.default_channel??"#general";try{const c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${We[e]} ${t}`,channel:o})}),u=c.ok,{supabaseInsert:p}=await g(async()=>{const{supabaseInsert:y}=await Promise.resolve().then(()=>R);return{supabaseInsert:y}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:o,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${c.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${c.status}`}}catch(c){return{ok:!1,error:c instanceof Error?c.message:String(c)}}}const qe={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},st={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function Vn(){return(await A("prospects",{order:"updated_at.desc"})).map(t=>({id:m(t,["id"],""),companyName:m(t,["company_name"],""),contactName:m(t,["contact_name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),address:m(t,["address"],""),website:m(t,["website"],""),businessType:m(t,["business_type"],""),stage:m(t,["stage"],"cold"),source:m(t,["source"],""),expectedAmount:q(t.expected_amount),probability:q(t.probability),assignedStaffCode:m(t,["assigned_staff_code"],""),nextActionDate:m(t,["next_action_date"],""),nextAction:m(t,["next_action"],""),note:m(t,["note"],""),lastContactAt:m(t,["last_contact_at"],""),wonAt:m(t,["won_at"],""),lostAt:m(t,["lost_at"],""),lostReason:m(t,["lost_reason"],""),convertedCustomerCode:m(t,["converted_customer_code"],""),createdAt:m(t,["created_at"],"")}))}async function os(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function Jn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Un(e){return(await A("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:m(n,["id"],""),prospectId:m(n,["prospect_id"],""),activityType:m(n,["activity_type"],"call"),title:m(n,["title"],""),description:m(n,["description"],""),activityDate:m(n,["activity_date"],""),result:m(n,["result"],""),staffCode:m(n,["staff_code"],"")}))}async function Yn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const ls=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function Qn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function Hn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Gn(){return(await A("delivery_locations",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),customerCode:m(t,["customer_code"],""),name:m(t,["name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:m(t,["contact_name"],""),phone:m(t,["phone"],""),deliveryNote:m(t,["delivery_note"],""),isActive:U(t,["is_active"],!0)}))}async function Xn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function Kn(e=50){return(await A("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),callDirection:m(n,["call_direction"],"inbound"),fromNumber:m(n,["from_number"],""),toNumber:m(n,["to_number"],""),matchedCustomerCode:m(n,["matched_customer_code"],""),matchedProspectId:m(n,["matched_prospect_id"],""),durationSeconds:q(n.duration_seconds),callStatus:m(n,["call_status"],"answered"),recordingUrl:m(n,["recording_url"],""),transcript:m(n,["transcript"],""),ivryCallId:m(n,["ivry_call_id"],""),startedAt:m(n,["started_at"],""),endedAt:m(n,["ended_at"],""),notes:m(n,["notes"],"")}))}async function rs(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function Wn(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const i=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,r=await fetch(i,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const d=(await r.json()).calls??[];let a=0;for(const o of d)await rs({id:`ivry_${o.id}`,callDirection:String(o.direction??"inbound"),fromNumber:String(o.from??""),toNumber:String(o.to??""),durationSeconds:Number(o.duration??0),callStatus:String(o.status??"answered"),recordingUrl:String(o.recording_url??""),startedAt:String(o.started_at??""),endedAt:String(o.ended_at??""),ivryCallId:String(o.id??"")}),a++;return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${a}件取得`}),{count:a}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Zn(e,t){const n=e.config.api_key,i=e.config.team_id;if(!n||!i)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let r=0;for(const l of t){if(!l.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${i}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:l.name,phone_number:l.phone,external_id:l.customerCode??"",note:l.note??""})})).ok&&r++}return{synced:r}}catch(r){return{synced:0,error:r instanceof Error?r.message:String(r)}}}async function ei(){return(await A("lead_lists",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),query:m(t,["query"],""),area:m(t,["area"],""),businessType:m(t,["business_type"],""),totalCount:q(t.total_count),source:m(t,["source"],"manual"),createdAt:m(t,["created_at"],"")}))}async function ti(e){return(await A("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:m(n,["id"],""),listId:m(n,["list_id"],""),companyName:m(n,["company_name"],""),address:m(n,["address"],""),phone:m(n,["phone"],""),website:m(n,["website"],""),email:m(n,["email"],""),businessType:m(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:q(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:m(n,["place_id"],""),status:m(n,["status"],"new"),convertedProspectId:m(n,["converted_prospect_id"],""),note:m(n,["note"],"")}))}async function ai(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function cs(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function si(e,t,n){const i=e.config.api_key;if(!i)return{results:[],error:"Google Maps API key 未設定"};const r=`${t} ${n}`.trim(),l=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(r)}&language=ja&key=${i}`;try{const d=await fetch(l);if(!d.ok)return{results:[],error:`HTTP ${d.status}`};const a=await d.json();return a.status!=="OK"&&a.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${a.status}`}:{results:a.results.map(c=>{const u=c.geometry?.location;return{id:`place_${c.place_id}`,listId:"",companyName:String(c.name??""),address:String(c.formatted_address??""),rating:c.rating?Number(c.rating):void 0,reviewCount:c.user_ratings_total?Number(c.user_ratings_total):void 0,lat:u?.lat,lng:u?.lng,placeId:String(c.place_id??""),status:"new"}})}}catch(d){return{results:[],error:d instanceof Error?d.message:String(d)}}}async function ni(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await os(t);return n&&await cs({...e,status:"imported",convertedProspectId:t.id}),n}async function ii(){return(await A("workflow_orders",{order:"order_date.desc"})).map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),customerName:m(t,["customer_name"],""),customerCode:m(t,["customer_code"],""),orderDate:m(t,["order_date"],""),deliveryDate:m(t,["delivery_date"],""),stage:m(t,["stage"],"new"),totalAmount:q(t.total_amount),itemCount:q(t.item_count),priority:m(t,["priority"],"normal"),staffName:m(t,["staff_name"],""),notes:m(t,["notes"],"")}))}async function oi(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function li(){return(await A("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),visitDate:m(t,["visit_date"],""),partySize:q(t.party_size)||1,language:m(t,["language"],"ja"),purpose:m(t,["purpose"],""),message:m(t,["message"],""),status:m(t,["status"],"new"),repliedAt:m(t,["replied_at"],""),confirmedTime:m(t,["confirmed_time"],""),createdAt:m(t,["created_at"],new Date().toISOString())}))}async function ri(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const ci=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function ds(){return(await Promise.all(ci.map(async t=>{const[n,i]=await Promise.all([Et(t.table),A(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:i[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function Qe(e,t,n=100){const i=(t-1)*n,[r,l]=await Promise.all([A(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(i)}),Et(e)]);return{records:r,total:l}}async function $t(e){const t=await A("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const i=JSON.parse(n);return String(i.price_group??"")}catch{return""}return""}async function us(e,t){if(e){const i=await A("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(i.length>0&&i[0].special_price)return q(i[0].special_price)}const n=await A("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?q(n[0].default_sale_price):0}const di=[{code:"SAK001",name:"純米大吟醸　金井"},{code:"SAK002",name:"純米吟醸　金井"},{code:"SAK003",name:"本醸造　金井"},{code:"SAK004",name:"純米酒　金井"}],ui=[1.6,.7,1.3,1.2,.9,.7,.6,.7,.9,1,1.1,1.5],pi={SAK001:80,SAK002:150,SAK003:220,SAK004:180};function mi(){const e=new Date,t=[];for(let o=11;o>=0;o--){const c=new Date(e.getFullYear(),e.getMonth()-o,1);t.push(`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`)}const n=di,i={},r={};for(const o of n){i[o.code]={};for(const c of t){const u=parseInt(c.split("-")[1])-1,p=pi[o.code]??100,y=Math.round(p*ui[u]*(.85+Math.random()*.3));i[o.code][c]=y,r[c]=(r[c]??0)+y}}const l={},d={},a={};for(const o of n){const c=t.map(y=>i[o.code][y]??0),u=c.reduce((y,h)=>y+h,0)/c.length,p=c.reduce((y,h)=>y+(h-u)**2,0)/c.length;l[o.code]=c.reduce((y,h)=>y+h,0),d[o.code]=u,a[o.code]=Math.sqrt(p)}return{months:t,products:n,matrix:i,totals:r,productTotals:l,productAvg:d,productStdDev:a}}async function yi(e=36){const t=(()=>{const y=new Date;return y.setMonth(y.getMonth()-e),`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`})(),n=await H("product_monthly_sales",{select:"year_month,product_code,product_name,quantity",year_month:`gte.${t}`,order:"year_month.asc"});if(n.length===0)return mi();const i=new Set,r=new Map,l={},d={};for(const y of n){const h=m(y,["year_month"],""),f=m(y,["product_code"],""),w=m(y,["product_name"],f),$=b(y,["quantity"],0);!h||!f||(i.add(h),r.set(f,w),l[f]||(l[f]={}),l[f][h]=$,d[h]=(d[h]??0)+$)}const a=[...i].sort(),o=[...r.entries()].map(([y,h])=>({code:y,name:h})),c={},u={},p={};for(const y of o){const h=a.map($=>l[y.code]?.[$]??0),f=h.reduce(($,x)=>$+x,0)/(h.length||1),w=h.reduce(($,x)=>$+(x-f)**2,0)/(h.length||1);c[y.code]=h.reduce(($,x)=>$+x,0),u[y.code]=f,p[y.code]=Math.sqrt(w)}return{months:a,products:o,matrix:l,totals:d,productTotals:c,productAvg:u,productStdDev:p}}async function hi(){return(await A("product_safety_stock_params",{order:"product_code.asc"})).map(t=>({productCode:m(t,["product_code"],""),productName:m(t,["product_name"],""),unit:m(t,["unit"],"本"),avgMonthlyDemand:b(t,["avg_monthly_demand"],0),demandStdDev:b(t,["demand_std_dev"],0),leadTimeDays:b(t,["lead_time_days"],30),serviceLevel:b(t,["service_level"],.95),safetyStockQty:b(t,["safety_stock_qty"],0),reorderPoint:b(t,["reorder_point"],0),memo:m(t,["memo"],"")}))}async function vi(e){return(await A("production_plan",{year_month:`eq.${e}`,order:"product_code.asc"})).map(n=>({id:m(n,["id"],""),yearMonth:m(n,["year_month"],e),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),demandForecast:b(n,["demand_forecast"],0),safetyStockTarget:b(n,["safety_stock_target"],0),openingStock:b(n,["opening_stock"],0),requiredProduction:b(n,["required_production"],0),plannedQty:b(n,["planned_qty"],0),actualQty:b(n,["actual_qty"],0),status:m(n,["status"],"draft"),productionType:m(n,["production_type"],"monthly"),notes:m(n,["notes"],"")}))}async function fi(e){const{supabaseUpsert:t}=await g(async()=>{const{supabaseUpsert:i}=await Promise.resolve().then(()=>R);return{supabaseUpsert:i}},void 0);return await t("product_safety_stock_params",{product_code:e.productCode,product_name:e.productName,unit:e.unit,avg_monthly_demand:e.avgMonthlyDemand,demand_std_dev:e.demandStdDev,lead_time_days:e.leadTimeDays,service_level:e.serviceLevel,safety_stock_qty:e.safetyStockQty,reorder_point:e.reorderPoint,memo:e.memo,last_calc_at:new Date().toISOString(),updated_at:new Date().toISOString()})!==null}async function bi(e){const{supabaseUpsert:t}=await g(async()=>{const{supabaseUpsert:i}=await Promise.resolve().then(()=>R);return{supabaseUpsert:i}},void 0);return await t("production_plan",{...e.id?{id:e.id}:{},year_month:e.yearMonth,product_code:e.productCode,product_name:e.productName,demand_forecast:e.demandForecast,safety_stock_target:e.safetyStockTarget,opening_stock:e.openingStock,required_production:e.requiredProduction,planned_qty:e.plannedQty,actual_qty:e.actualQty,status:e.status,production_type:e.productionType,notes:e.notes,updated_at:new Date().toISOString()})!==null}const S=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:Ot,CALENDAR_CATEGORY_LABELS:Rt,DEPT_LABELS:Ke,INVOICE_TYPE_LABELS:ft,JIKOMI_STATUS_LABELS:Ya,MATERIAL_CATEGORIES:ls,PROSPECT_STAGE_COLORS:st,PROSPECT_STAGE_LABELS:qe,ROLE_LABELS:Xe,SEASONAL_TEMPLATES:Ct,SLACK_EVENT_LABELS:We,TAX_DEDUCTION_LABELS:gt,TAX_RATE_CATEGORIES:es,convertLeadToProspect:ni,deleteCalendarEvent:Pn,deleteMailSender:kn,deleteMaterial:Hn,deletePrintLayout:$n,deleteProspect:Jn,deleteUserProfile:On,fetchAnalyticsByPeriod:Gs,fetchAnnouncements:Oa,fetchAuditLogs:jn,fetchAvailablePeriods:Xs,fetchBillList:Wa,fetchBillingSummary:Tt,fetchCalendarEvents:Sn,fetchCallLogs:Kn,fetchChurnAlerts:ln,fetchCustomerAnalysis:Ua,fetchCustomerEfficiency:Ja,fetchCustomerLedger:Lt,fetchCustomerPriceGroup:$t,fetchCustomerPricing:Ba,fetchDeliveryLocations:Gn,fetchDeliveryNote:It,fetchDeliverySchedule:on,fetchDemandAnalysis:yi,fetchDemandForecasts:nn,fetchFaxInbox:Ln,fetchIntegrationSettings:ns,fetchInvoices:Ge,fetchJikomiList:Qa,fetchKenteiList:Ga,fetchLeadItems:ti,fetchLeadLists:ei,fetchMailSenders:_n,fetchMasterStats:He,fetchMaterialList:bt,fetchMyProfile:Nn,fetchPayableList:Ka,fetchPaymentStatus:Ca,fetchPipelineMeta:La,fetchPrintLayouts:bn,fetchProductABC:pn,fetchProductDaily:un,fetchProductMonthlyShipments:sn,fetchProductPower:Va,fetchProductPrice:us,fetchProductShipmentsFromTable:dn,fetchProductionPlan:vi,fetchProspectActivities:Un,fetchProspects:Vn,fetchPurchaseList:Xa,fetchRawMaterialStock:Za,fetchRawRecords:Qe,fetchRawTableList:ds,fetchSafetyStockParams:hi,fetchSalesAnalytics:Ta,fetchSalesReport:at,fetchSalesSummary:Da,fetchSeasonalProfiles:cn,fetchShopifyOrders:En,fetchSlackLogs:Bn,fetchSlackRules:is,fetchStaffCustomerBreakdown:Zs,fetchStaffProductBreakdown:en,fetchStaffTotalsByPeriod:Ws,fetchStoreOrders:as,fetchStoreSales:Nt,fetchSyncDashboard:Ia,fetchTankList:Ha,fetchTaxDeclaration:qt,fetchTourInquiriesFromDb:li,fetchUserProfiles:qn,fetchVisitPriorities:rn,fetchWorkflowOrdersFromDb:ii,generateTaxCSV:hn,generateTaxXML:ts,ocrFaxImage:In,periodToDateRange:Ks,recalculateTaxDeclaration:vn,recordAudit:Mn,resolveProductPrice:za,saveCalendarEvent:xn,saveCallLog:rs,saveDeliveryLocation:Xn,saveEmailCampaign:Ye,saveFaxRecord:Tn,saveIntegrationSetting:Te,saveInvoice:Ra,saveLeadItem:cs,saveLeadList:ai,saveMailSender:wn,saveMaterial:Qn,savePrintLayout:gn,saveProductionPlan:bi,saveProspect:os,saveProspectActivity:Yn,saveSafetyStockParams:fi,saveSlackRule:Fn,saveTaxDeclaration:fn,saveTourInquiry:ri,saveUserProfile:Rn,saveWorkflowOrder:oi,searchPlaces:si,sendEmailCampaign:ss,sendSlackNotification:zn,submitFeatureRequest:Ma,syncGoogleCalendar:Cn,syncIvryCallLogs:Wn,syncPhoneBookToIvry:Zn,syncShopifyOrders:An,updateCustomer:ja,updateProduct:Fa},Symbol.toStringTag,{value:"Module"}));function me(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const gi={open:"未締め",closed:"締め済"};function $i(e,t){const n=e.customers.map(i=>`
  ...
  `}function Re(e,t,n){const i=e.findIndex(l=>l.column===t);if(i>=0){if(e[i].direction==="asc"){const d=[...e];return d[i]={column:t,direction:"desc"},d}return e.filter((d,a)=>a!==i)}const r={column:t,direction:"asc"};return n?[...e,r]:[r]}function Pi(e,t){const n=e.findIndex(l=>l.column===t);if(n<0)return'<span class="sort-icon">⇅</span>';const i=e[n].direction==="asc"?"↑":"↓",r=e.length>1?`<small class="sort-badge">${n+1}</small>`:"";return`<span class="sort-icon active">${i}${r}</span>`}function L(e,t,n,i=""){return`<th class="sortable ${i}" data-sort-col="${e}">${t} ${Pi(n,e)}</th>`}function Xt(e){if(e==null)return"";const t=String(e).replace(/[¥,円%本日L]/g,"").trim(),n=Number(t);return Number.isFinite(n)?n:t.toLowerCase()}function Le(e,t,n){return t.length===0?e:[...e].sort((i,r)=>{for(const{column:l,direction:d}of t){const a=n[l];if(!a)continue;const o=Xt(i[a]),c=Xt(r[a]);let u=0;if(typeof o=="number"&&typeof c=="number"?u=o-c:u=String(o).localeCompare(String(c),"ja"),u!==0)return d==="asc"?u:-u}return 0})}const Ai={forecasts:[],deliveries:[],calendarMonth:new Date().toISOString().slice(0,7),selectedSegment:"all"},Kt={monthly:"通年出荷","made-to-order":"受注生産","november-only":"歳暮（11月生産）","annual-batch":"季節集中","december-settlement":"歳暮（11月生産）","seasonal-batch":"季節集中"},_e={monthly:"#0F5B8D","made-to-order":"#6b46c1","november-only":"#c05621","annual-batch":"#2f855a","december-settlement":"#c05621","seasonal-batch":"#2f855a"};function Ei(e){const t=new Date().toISOString().slice(0,10);return e.map(n=>({date:n.date,customerName:n.customerName,productName:n.productName,quantity:n.quantity,status:n.date>t?"scheduled":"delivered"}))}function Di(e){const[t,n]=e.split("-").map(Number);return new Date(t,n,0).getDate()}function Ci(e){const[t,n]=e.split("-").map(Number);return new Date(t,n-1,1).getDay()}function ms(e,t){const n=Di(t),i=Ci(t),[r,l]=t.split("-").map(Number),d=new Map;e.forEach(E=>{if(E.date.slice(0,7)===t){const k=E.date.slice(0,10);d.has(k)||d.set(k,[]),d.get(k).push(E)}});const a=e.filter(E=>E.date.slice(0,7)===t),o=a.reduce((E,k)=>E+k.quantity,0),c=new Set(a.map(E=>E.date)).size,u=new Date().toISOString().slice(0,10),p=["日","月","火","水","木","金","土"].map(E=>`<th class="dcal-header">${E}</th>`).join("");let y="",h=1;for(let E=0;E<6&&!(h>n&&E>0);E++){y+="<tr>";for(let k=0;k<7;k++)if(E===0&&k<i||h>n)y+='<td class="dcal-cell dcal-empty"></td>';else{const I=`${r}-${String(l).padStart(2,"0")}-${String(h).padStart(2,"0")}`,j=d.get(I)||[],J=I===u,C=j.reduce((Y,X)=>Y+X.quantity,0);y+=`
          <td class="dcal-cell ${J?"dcal-today":""}">
            ...
            `:""}
          </td>`,h++}y+="</tr>"}const[f,w]=l===1?[r-1,12]:[r,l-1],[$,x]=l===12?[r+1,1]:[r,l+1],_=`${f}-${String(w).padStart(2,"0")}`,D=`${$}-${String(x).padStart(2,"0")}`;return`
    <section class="panel">
      <div class="panel-header">
        <div>
          <h2>納品カレンダー</h2>
  ...
  `}function Li(e,t){const n=t==="all"?e:e.filter(a=>a.segment===t),i={all:e.length};e.forEach(a=>{i[a.segment]=(i[a.segment]??0)+1});const l=["all",...[...new Set(e.map(a=>a.segment))]].map(a=>`
  ...
  `}function Oi(e,t,n,i,r="month",l,d=[]){const a={success:"正常",warning:"注意",error:"異常",running:"実行中"},o=qi(e.allDailySales,r,l),c=o.reduce((k,I)=>k+I.amount,0),u=o.reduce((k,I)=>k+I.bottles,0),p=o.reduce((k,I)=>k+I.volumeMl,0),y=o.length,h=u>0?Math.round(c/u):0,f=p>0?Math.round(c/(p/1e3)):0,$=(o.length>0?e.allDailySales.filter(k=>{const I=o[0]?.date??"",j=o[o.length-1]?.date??"",J=Wt(I,-1),C=Wt(j,-1);return k.date>=J&&k.date<=C}):[]).reduce((k,I)=>k+I.amount,0),x=$>0?(c-$)/$*100:0,_=x>0?"+":"",D=e.salesRecords.slice(0,10).map(k=>`
            <tr>
              <td class="mono">${k.documentNo}</td>
              <td>${ot(k.date)}</td>
              <td>${k.customerName}</td>
              <td class="numeric">${W(k.amount)}</td>
            </tr>
          `).join(""),E=["today","month","90days","year","all"].map(k=>`<button class="button ${k===r?"primary":"secondary"} small" type="button" data-period="${k}">${Oe[k]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value" style="color:${x>=0?"#2f855a":"#c53d3d"}">${$>0?`${_}${x.toFixed(1)}%`:"―"}</p>
    ...
    <details class="panel collapsible-panel">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>${Le(d.length>0?o:o.slice().reverse(),d,{date:"date",amount:"amount",bottles:"bottles",volumeMl:"volumeMl",pricePerBottle:"pricePerBottle",pricePerLiter:"pricePerLiter"}).slice(0,31).map(k=>`
            <tr>
              <td class="mono">${k.date.slice(0,10)}</td>
              <td class="numeric">${W(k.amount)}</td>
              <td class="numeric">${k.bottles.toLocaleString("ja-JP")}</td>
              <td class="numeric">${(k.volumeMl/1e3).toLocaleString("ja-JP",{maximumFractionDigits:0})}</td>
              <td class="numeric">${W(k.pricePerBottle)}</td>
              <td class="numeric">${W(k.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
  ...
  `}function Mi(e){const t=e.prospects.reduce((d,a)=>d+a.expectedAmount*a.probability/100,0),n=e.prospects.filter(d=>d.stage==="hot"||d.stage==="negotiating").length,i=new Date().toISOString().slice(0,10),r=e.upcomingEvents.filter(d=>d.startsAt.slice(0,10)>=i).slice(0,5),l=e.tourInquiries.filter(d=>d.status==="new").length;return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
  ...
  `}function ji(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function ye(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Fi(e,t){const n=e.lines.length?e.lines.map((r,l)=>`
          <tr>
...
`,"<br />")}function zi(e){const n=[...Object.values(Ct),{id:"custom",season:"カスタム",subject:"",body:""}].map(r=>`
  ...
  `}function Vi(e,t){const n=[Me("得意先",t.customers.map(r=>`
          <button
  ...
  `}function je(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Zt(e){return e.trim().toLowerCase()}function Ji(e,t){const n=Zt(t),i=e.filter(l=>n?[l.code,l.name,l.name].map(Zt).some(d=>d.includes(n)):!0).slice(0,50),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
  ...
  `}function Xi(e,t,n,i,r,l){const d=e.lines.reduce((y,h)=>y+h.amount,0),a=Math.round(d*e.taxRate/100),o=d+a,c=i.length>=1?t.filter(y=>y.name.includes(i)||y.code.includes(i)).slice(0,8):[],u=r.length>=1?n.filter(y=>y.name.includes(r)||y.code.includes(r)).slice(0,8):[],p=e.fieldConfig;return e.previewMode?`
      <section class="page-head">
        <div>
...
<\/script>
  ...
  `}function ao(e,t=[]){const n=e.filter(l=>l.currentRank==="A").length,i=e.filter(l=>l.prevRank&&l.currentRank<l.prevRank).length,r=e.filter(l=>l.prevRank&&l.currentRank>l.prevRank).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>営業効率分析</h1>
          ...
          <tbody>
            ${Le(e,t,{currentRank:"currentRank",name:"name",yearAmount:"yearAmount",sharePct:"sharePct",orderDays:"orderDays",growthRate:"growthRate"}).slice(0,50).map(l=>`
              <tr>
                ...
                <td>${Wi(l.currentRank,l.prevRank)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
...
`);return`
  ...
  `}function _t(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function go(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function $o(e){return e.map(t=>`
      ...
      `).join("")}function wo(e,t,n=Mt,i=[]){const{filtered:r,paged:l,totalPages:d}=fo(e.customers,n);return`
    <section class="page-head">
      <div>
      ...
      ${t==="customers"?`
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>${$o(Le(l,i,{code:"code",name:"name",kanaName:"kanaName",businessType:"businessType",areaName:"areaName",closingDay:"closingDay",paymentDay:"paymentDay"}))}</tbody>
          </table>
        </div>
        ${na(r.length,n.page,d)}
      `:`
  ...
  `}function So(e){const t=e.map(r=>{const d=(r.minimumStock>0?r.currentStock/r.minimumStock:1/0)<1.5;return`
        <tr>
  ...
  `}function ve(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ia(e){return e.trim().toLowerCase()}function Eo(e,t){const n=ia(t),i=e.filter(l=>n?[l.code,l.name,l.janCode].map(ia).some(d=>d.includes(n)):!0),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function Ae(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function qo(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function No(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),n=Math.max(...t.map(p=>p.amount),1),i=28,r=6,l=140,d=100,a=760,o=a-l-d,c=t.length*(i+r)+16,u=t.map((p,y)=>{const h=p.amount/n*o,f=y*(i+r)+8,w=p.abcRank==="A"?"#2F855A":p.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
          ...
          <rect x="${l}" y="${f}" width="${h}" height="${i}" rx="4" fill="${w}" opacity="0.85" />
  ...
  `}function Ro(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(i=>`<th class="numeric">${i}</th>`).join(""),n=e.monthlyByCustomer.map(i=>{const r=i.values.reduce((d,a)=>d+a,0),l=i.values.map(d=>`<td class="numeric">${d>0?(d/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${i.label}</td>
          ${l}
  ...
  `}function nt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Mo(e){return e.replace("-","/")}const la={all:"全期間",yearly:"年次",monthly:"月次",weekly:"週次",daily:"日次"};function jo(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,i={top:16,right:24,bottom:36,left:64},r=t-i.left-i.right,l=n-i.top-i.bottom,d=Math.max(...e.map(u=>u.amount),1),a=r/e.length,o=[0,.25,.5,.75,1].map(u=>{const p=i.top+l-l*u,y=`${Math.round(d*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${i.left}" y1="${p}" x2="${t-i.right}" y2="${p}" class="chart-grid" />
          <text x="8" y="${p+4}" class="chart-axis">${y}</text>
        </g>
      `}).join(""),c=e.map((u,p)=>{const y=u.amount/d*l,h=Math.max(a-18,24),f=i.left+p*a+(a-h)/2,w=i.top+l-y;return`
        <g>
  ...
  `}function zo(e,t,n="all",i="",r=[],l=[],d="",a="",o=null,c="all",u="",p=[],y=[]){const h=t==="products"?"商品別集計":t==="customers"?"得意先別集計":"担当別集計",f=t==="products"?e.productTotals:t==="customers"?e.customerTotals:e.staffTotals,w=n!=="all"&&r.length>0&&t!=="staff",$=["all","yearly","monthly","weekly","daily"].map(E=>`<button class="button ${E===n?"primary":"secondary"} small" type="button" data-analytics-period="${E}">${la[E]}</button>`).join(""),x=n!=="all"&&l.length>0&&t!=="staff"?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
        ${l.map(E=>`<option value="${E}" ${E===i?"selected":""}>${E}</option>`).join("")}
      </select>`:"";let _="",D="";if(t==="staff"){const E=["all","yearly","monthly","weekly","daily"].map(C=>`<button class="button ${C===c?"primary":"secondary"} small" type="button" data-staff-period="${C}">${la[C]}</button>`).join(""),k=c!=="all"&&p.length>0?`<select id="staff-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
    ...
    ${D}
  `}function xe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Vo(e){const t=Math.max(...e.salesByProduct.flatMap(l=>l.values),1),n=e.salesByProduct.map(l=>{const d=l.values.map((a,o)=>`
          <div class="bar-col">
  ...
  `}function Je(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Qo(e,t,n,i){const r={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},l={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},d={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},a=e.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
  ...
  `}const Zo={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},el=["new","picking","packed","shipped","delivered"];function tl(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(l=>t[l.stage].push(l));const n=el.map(l=>{const d=Zo[l],a=t[l];return`
  ...
  `}function al(e,t,n){const i=e.cart.reduce((l,d)=>l+d.amount,0);return`
  ...
  `}function sl(e,t,n){if(e.step==="customer"){const i=e.customerQuery.toLowerCase(),r=i?t.filter(l=>l.name.toLowerCase().includes(i)||l.code.toLowerCase().includes(i)):t.slice(0,20);return`
      <section class="panel">
  ...
  `}const da={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},ua={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},pa={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function nl(e,t){const n=e.find(l=>l.id===t)??e[0],i=e.filter(l=>l.status==="new").length,r=e.filter(l=>l.status==="confirmed").length;return`
    <section class="page-head">
      <div>
...
金井酒造店`;function ll(e,t){const n=t?e.find(r=>r.id===t):null,i=t==="__new__";return`
    ...
    ${n||i?`
      ...
      `:""}
  `}function rl(e,t,n,i){const[r,l]=t.split("-").map(k=>parseInt(k,10)),d=new Date(r,l-1,1),a=new Date(r,l,0),o=d.getDay(),c=a.getDate(),u=[];for(let k=0;k<o;k++)u.push({isOutside:!0});for(let k=1;k<=c;k++)u.push({date:new Date(r,l-1,k)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter(k=>k.category===n):e,y={};p.forEach(k=>{const I=k.startsAt.slice(0,10);y[I]??=[],y[I].push(k)});const h=new Date().toISOString().slice(0,10),f=u.map(k=>{if(k.isOutside)return'<div class="cal-cell cal-outside"></div>';const I=k.date,j=`${I.getFullYear()}-${String(I.getMonth()+1).padStart(2,"0")}-${String(I.getDate()).padStart(2,"0")}`,J=y[j]??[],C=j===h,Y=I.getDay();return`
      ...
      `}).join(""),w=i?.isOpen?cl(i):"",$=new Date(r,l-2,1),x=new Date(r,l,1),_=`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`,D=`${x.getFullYear()}-${String(x.getMonth()+1).padStart(2,"0")}`,E=(()=>{const k=new Date;return`${k.getFullYear()}-${String(k.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(Rt).map(([k,I])=>`<option value="${k}" ${n===k?"selected":""}>${I}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
  ...
  `}function ul(e,t){const n=e.reduce((l,d)=>l+d.totalAmount,0),i=e.filter(l=>l.financialStatus==="paid").length,r=e.filter(l=>l.fulfillmentStatus!=="fulfilled"&&l.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function ml(e,t,n){const i=t==="__new__"?null:e.find(d=>d.id===t),r=t==="__new__";return n?.role==="admin"?`
    <section class="page-head">
      <div>
  ...
  `}function vl(e){const t=e.prospects.reduce((l,d)=>l+d.expectedAmount,0),n=e.prospects.reduce((l,d)=>l+d.expectedAmount*d.probability/100,0),i=e.prospects.filter(l=>l.stage==="won").length,r=e.prospects.filter(l=>l.stage==="hot"||l.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
  ...
  `}const wl=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function kl(e){const t=e.activeListId?e.lists.find(l=>l.id===e.activeListId):null,n=e.items.filter(l=>l.status==="new").length,i=e.items.filter(l=>l.status==="imported").length,r=e.items.filter(l=>l.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
    ...
    <section class="panel">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:flex-end;">
        <label class="field" style="flex:1 1 180px;">
          ...
          <select id="lb-type">
            <option value="">選択</option>
            ${wl.map(l=>`<option value="${l}" ${e.searchBusinessType===l?"selected":""}>${l}</option>`).join("")}
          </select>
        </label>
        <label class="field" style="flex:1 1 180px;">
          <span>エリア</span>
  ...
  `}const ya={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},Sl={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},xl={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function V(e){return"¥"+e.toLocaleString("ja-JP")}function Ce(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function ws(e,t){const n=e.reduce((l,d)=>l+d.amount,0),i=Math.floor(n*t),r=n+i;return{subtotal:n,taxAmount:i,total:r}}const N={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function O(e,t){const n=e.align??"left",i=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${i}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function ut(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),i=n-2018;return{y:i>0?String(i).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function Pl(e,t,n){const i=ut(e.documentDate),r=ut(e.orderDate??e.documentDate),l=ut(e.deliveryDate??e.documentDate),d=e.lines.slice(0,6).map(($,x)=>{const _=N.detailStartY+x*N.detailRowH,D=N.detailCols,E=[],k=(I,j)=>{j&&E.push(O({...I,y:_,x:I.x+0},j))};return k(D.productName,$.productName+($.spec?` ${$.spec}`:"")),k(D.productCode,$.productCode),k(D.color,$.color??""),k(D.size,[$.size,$.caseQty?`×${$.caseQty}`:""].filter(Boolean).join(" ")),k(D.unit,$.unit),k(D.quantity,$.quantity>0?$.quantity.toLocaleString("ja-JP"):""),k(D.correctedQty,$.correctedQuantity?$.correctedQuantity.toLocaleString("ja-JP"):""),k(D.discount,$.discount?$.discount.toLocaleString("ja-JP"):""),k(D.unitPrice,$.unitPrice>0?$.unitPrice.toLocaleString("ja-JP"):""),k(D.costAmount,$.amount>0?$.amount.toLocaleString("ja-JP"):""),k(D.retailPrice,$.retailPrice?$.retailPrice.toLocaleString("ja-JP"):""),k(D.note,$.receivedAmount?$.receivedAmount.toLocaleString("ja-JP"):""),E.join("")}).join(""),a=e.lines.reduce(($,x)=>$+(x.amount||0),0),o=e.lines.reduce(($,x)=>$+(x.retailPrice||0)*(x.correctedQuantity??x.quantity),0),c=e.lines.reduce(($,x)=>$+(x.receivedAmount||0),0),u=e.lines.reduce(($,x)=>$+(x.returnAmount||0),0),p=e.lines.reduce(($,x)=>$+x.quantity,0),y=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",h=n.calibrationOffsetX||0,f=n.calibrationOffsetY||0,w=`transform: translate(${h}mm, ${f}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${y}">
        ...
        ${O(N.orderDateM,r.m)}
        ${O(N.orderDateD,r.d)}
        ${O(N.deliveryDateY,l.y)}
        ${O(N.deliveryDateM,l.m)}
        ${O(N.deliveryDateD,l.d)}
  ...
  `}function Al(e,t,n){const{subtotal:i,taxAmount:r,total:l}=ws(e.lines,e.taxRate),d=e.previousBalance??0,a=e.paymentAmount??0,o=d-a+l,c=e.lines.map(p=>`
      <tr>
  ...
  `}function El(e,t,n){const{subtotal:i,taxAmount:r,total:l}=ws(e.lines,e.taxRate),d=e.lines.map(o=>`
      <tr>
    ...
    <div class="print-page quotation-freee ${n.fontSize}">
      ...
      <div class="freee-summary">
        ...
        <table class="freee-summary-table">
          ...
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${V(r)}</td></tr>
          <tr class="freee-sum-grand"><th>合計</th><td>${V(l)}</td></tr>
        </table>
      </div>
  ...
  `}function Dl(e,t,n,i){let r="";switch(e){case"chain_store":r=Pl(i,n,t);break;case"quotation":r=El(i,n,t);break;case"invoice_monthly":r=Al(i,n,t);break}const l=Object.keys(ya).map(o=>`<button class="tab-button ${e===o?"active":""}" data-print-template="${o}">${ya[o]}</button>`).join(""),d=i.lines.map((o,c)=>`
      <tr>
...
`}async function Nl(e,t){const{supabaseInsert:n}=await g(async()=>{const{supabaseInsert:a}=await Promise.resolve().then(()=>R);return{supabaseInsert:a}},void 0);let i=0,r=0;const d={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const a of t){if(!a._valid)continue;const{_valid:o,_error:c,...u}=a,p={...u};if(!p.id){const y=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[y]??`${e}-${Date.now()}-${i+r}`)}for(const y of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[y]=="string"&&p[y]!==""){const h=Number(p[y]);Number.isFinite(h)&&(p[y]=h)}try{await n(d,p)!==null?i++:r++}catch{r++}}return{inserted:i,failed:r}}function pt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function Rl(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Ol(e,t,n,i,r){const l=n.reduce((c,u)=>c+u.rowCount,0),d=n.map(c=>c.lastSyncAt).filter(c=>c!==null).sort().reverse()[0]??null,a=100,o=Math.max(1,Math.ceil(r/a));return`
    ...
    `}
  `}function F(e){return e.toLocaleString("ja-JP")}function mt(e){const[t,n]=e.split("-");return`${t.slice(2)}/${n}`}function Ml(e){return e>=.99?2.33:e>=.97?1.88:e>=.95?1.65:e>=.9?1.28:1.04}function jl(e){const{months:t,matrix:n}=e;if(t.length===0||e.products.length===0)return'<div class="chart-empty">データなし</div>';const i=e.products.slice().sort((x,_)=>(e.productTotals[_.code]??0)-(e.productTotals[x.code]??0)).slice(0,6),r=["#0F5B8D","#2F855A","#B7791F","#C53D3D","#6B46C1","#2B6CB0"],l=820,d=280,a={top:20,right:20,bottom:40,left:60},o=l-a.left-a.right,c=d-a.top-a.bottom,u=t.map(x=>i.reduce((_,D)=>_+(n[D.code]?.[x]??0),0)),p=Math.max(...u,1),y=o/t.length,h=Math.max(y-10,14),f=[0,.25,.5,.75,1].map(x=>{const _=a.top+c-c*x,D=`${Math.round(p*x/100)*100}`;return`
      <line x1="${a.left}" y1="${_}" x2="${l-a.right}" y2="${_}" class="chart-grid" />
      <text x="6" y="${_+4}" class="chart-axis">${Number(D).toLocaleString("ja-JP")}</text>
    `}).join(""),w=t.map((x,_)=>{let D=a.top+c;const E=a.left+_*y+(y-h)/2,k=i.map((X,Vt)=>{const Jt=(n[X.code]?.[x]??0)/p*c;return D-=Jt,`<rect x="${E}" y="${D}" width="${h}" height="${Jt}" fill="${r[Vt%r.length]}" opacity="0.85" rx="${Vt===i.length-1?3:0}" />`}).join(""),[I,j]=x.split("-"),J=parseInt(j),C=J===1||_%3===0,Y=J===1?`${I.slice(2)}年`:`${J}月`;return`<g>${k}${C?`<text x="${E+h/2}" y="${d-10}" class="chart-axis centered-axis">${Y}</text>`:""}</g>`}).join(""),$=i.map((x,_)=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}function Bl(e,t){const n=e.months[e.months.length-1]??"",i=e.months[e.months.length-2]??"",r=e.months.length-13,l=r>=0?e.months[r]:"",d=e.products.reduce((h,f)=>h+(e.matrix[f.code]?.[n]??0),0),a=e.products.reduce((h,f)=>h+(e.matrix[f.code]?.[i]??0),0),o=l?e.products.reduce((h,f)=>h+(e.matrix[f.code]?.[l]??0),0):0,c=a>0?(d-a)/a*100:0,u=o>0?(d-o)/o*100:0,p=h=>h>=0?"+":"",y=[1,2,3,5].map(h=>`<option value="${h}" ${h===t?"selected":""}>${h}年</option>`).join("");return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        <p class="panel-title">直近月 出荷合計</p>
        <p class="kpi-value">${F(d)} 本</p>
  ...
  `}function zl(e){const t=e.map(i=>{const r=Ml(i.serviceLevel),l=i.leadTimeDays/30,d=Math.ceil(r*i.demandStdDev*Math.sqrt(l)),a=Math.ceil(i.avgMonthlyDemand*l+d),o=d-i.safetyStockQty,c=o>0?"text-danger":o<-d*.3?"text-warning":"",u=[.9,.95,.99].map(p=>`<option value="${p}" ${Math.abs(i.serviceLevel-p)<.01?"selected":""}>${(p*100).toFixed(0)}%</option>`).join("");return`
      <tr>
        <td style="white-space:nowrap;">${i.productName}</td>
        <td class="numeric">${F(Math.round(i.avgMonthlyDemand))}</td>
        <td class="numeric">${F(Math.round(i.demandStdDev))}</td>
        <td>
        ...
        <td class="numeric"><strong>${F(d)}</strong></td>
  ...
  `}const Vl={monthly:"月次",annual:"年次",make_to_order:"受注生産",november:"11月生産"};function Jl(e,t){const n={draft:"下書き",confirmed:"確定",actual:"実績入力済"},i={draft:"neutral",confirmed:"info",actual:"success"},r=y=>Object.entries(Vl).map(([h,f])=>`<option value="${h}" ${h===y?"selected":""}>${f}</option>`).join(""),l=e.map(y=>{const h=Math.max(0,y.demandForecast+y.safetyStockTarget-y.openingStock),f=y.plannedQty>0?(y.actualQty-y.plannedQty)/y.plannedQty*100:null,w=f!==null?f>=0?"text-success":"text-danger":"";return`
      <tr>
        <td style="white-space:nowrap;">${y.productName}</td>
        <td>
          <select class="input-sm" data-action="plan-prod-type" data-code="${y.productCode}"
            style="width:92px;">${r(y.productionType)}</select>
        </td>
        <td class="numeric">${F(Math.round(y.demandForecast))}</td>
        <td class="numeric">${F(Math.round(y.safetyStockTarget))}</td>
        <td class="numeric">${F(Math.round(y.openingStock))}</td>
        <td class="numeric"><strong>${F(Math.round(h))}</strong></td>
        <td>
          <input class="input-sm" type="number" min="0"
            value="${y.plannedQty}"
            data-action="plan-qty" data-code="${y.productCode}"
            style="width:80px;text-align:right;" />
        </td>
        <td class="numeric">${y.actualQty>0?F(y.actualQty):"—"}</td>
        <td class="numeric ${w}">
          ${f!==null?`${f>=0?"+":""}${f.toFixed(1)}%`:"—"}
        </td>
        <td>
          <span class="status-pill ${i[y.status]??"neutral"}">${n[y.status]??y.status}</span>
        </td>
      </tr>
    `}).join(""),d=e.reduce((y,h)=>y+h.demandForecast,0),a=e.reduce((y,h)=>y+Math.max(0,h.demandForecast+h.safetyStockTarget-h.openingStock),0),o=e.reduce((y,h)=>y+h.plannedQty,0),c=e.reduce((y,h)=>y+h.actualQty,0),u=new Date;return`
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;">
      <label class="field" style="margin:0;flex-shrink:0;">
        <span>対象年月</span>
        <select data-action="plan-year-month" style="width:140px;">${Array.from({length:24},(y,h)=>{const f=new Date(u.getFullYear(),u.getMonth()-6+h,1),w=`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}`;return`<option value="${w}" ${w===t?"selected":""}>${w.replace("-","年")}月</option>`}).join("")}</select>
      </label>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${l||'<tr><td colspan="10" class="empty-row">データなし</td></tr>'}
            ${e.length>0?`
  ...
  `}function Ul(e,t,n,i,r,l){const a=[{key:"demand",label:"需要実績"},{key:"safety",label:"安全在庫"},{key:"plan",label:"生産計画"}].map(c=>`<button class="tab-button ${i===c.key?"active":""}"
       data-demand-tab="${c.key}">${c.label}</button>`).join("");let o="";return i==="demand"?o=e?Bl(e,l):'<section class="panel"><p>データを読み込んでいます…</p></section>':i==="safety"?o=zl(t):o=Jl(n,r),`
    <section class="page-head">
      <div>
    ...
    ${o}
  `}function ha(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Yl(e,t){return Math.floor(Math.abs(t.getTime()-e.getTime())/(1e3*60*60*24))}function Ql(e){return e==="dormant"?"休眠":"離反リスク"}function Hl(e){return e==="dormant"?"warning":"danger"}function Gl(e,t){const n=new Date,i=new Date(n);i.setMonth(i.getMonth()-3);const r=new Date(n);r.setMonth(r.getMonth()-12);const l=new Date(n);l.setFullYear(l.getFullYear()-1);const d=new Date(l.getFullYear(),l.getMonth(),1),a=new Date(l.getFullYear(),l.getMonth()+1,0),o=new Date(n.getFullYear(),n.getMonth(),1),c=new Map(t.map(f=>[f.code,f])),u=new Map;for(const f of e){if(!f.legacy_customer_code)continue;const w=u.get(f.legacy_customer_code)||[];w.push(f),u.set(f.legacy_customer_code,w)}const p=[],y=[],h=new Set;for(const[f,w]of u.entries()){const $=c.get(f),x=$?.name||(w[0]?.customer_name??f);let _=null,D=0,E=!1,k=!1,I=!1,j=!1;for(const C of w){const Y=new Date(C.sales_date);(!_||Y>_)&&(_=Y),Y>=r&&(k=!0,D+=C.total_amount),Y>=i&&(E=!0),Y>=d&&Y<=a&&(I=!0),Y>=o&&(j=!0)}if(!_)continue;const J={code:f,name:x,businessType:$?.businessType??"",areaCode:$?.areaCode??"",phone:$?.phone??"",lastOrderDate:_.toISOString().slice(0,10),daysSinceLastOrder:Yl(_,n),totalAmountLast12m:D,status:"dormant"};k&&!E&&(p.push({...J,status:"dormant"}),h.add(f)),I&&!j&&!h.has(f)&&y.push({...J,status:"at-risk"})}return p.sort((f,w)=>w.daysSinceLastOrder-f.daysSinceLastOrder),y.sort((f,w)=>w.totalAmountLast12m-f.totalAmountLast12m),{dormantCustomers:p,atRiskCustomers:y}}function Xl(e){const t=[...e.dormantCustomers,...e.atRiskCustomers],n=e.dormantCustomers.length,i=e.atRiskCustomers.length,r=e.dormantCustomers.reduce((u,p)=>u+p.totalAmountLast12m,0),l=t.map(u=>`
        <tr data-status="${u.status}" data-area="${u.areaCode}" data-biz="${u.businessType}">
          ...
          <td><span class="status-pill ${Hl(u.status)}">${Ql(u.status)}</span></td>
        </tr>
    ...
    <\/script>
  `}const ie=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],St={"year-round":"通年品",seasonal:"季節品","year-end":"歳暮品"},ne={"year-round":"#0F5B8D",seasonal:"#2f855a","year-end":"#c05621"};function Kl(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Wl(e){const t=e.reduce((l,d)=>l+d,0);if(t===0)return"year-round";if((e[10]+e[11])/t>.5)return"year-end";const i=Math.max(...e);return e.filter(l=>l>i*.1).length<=6?"seasonal":"year-round"}function Zl(e){const t=e.reduce((l,d)=>l+d,0);if(t===0)return[];const i=t/12*1.5,r=[];for(let l=0;l<12;l++)e[l]>i&&r.push(l);if(r.length===0){const l=Math.max(...e);l>0&&r.push(e.indexOf(l))}return r.sort((l,d)=>l-d)}function er(e){return e.length===0?0:(e[0]-2+12)%12}function va(e){const t=new Date().getMonth(),n=e.map(r=>{const l=Wl(r.monthlyQuantity),d=Zl(r.monthlyQuantity),a=er(d);return{code:r.code,name:r.name,category:r.category,peakMonths:d,proposalStartMonth:a,seasonType:l,monthlyQuantity:r.monthlyQuantity}}),i=[];for(let r=0;r<12;r++){const l=n.filter(d=>{if(d.peakMonths.length===0)return!1;const a=d.proposalStartMonth,o=d.peakMonths[0];return a<=o?r>=a&&r<=o:r>=a||r<=o});i.push({month:r,products:l,targetCustomers:[]})}return{products:n,proposals:i,selectedMonth:t}}function tr(e){const{products:t,proposals:n,selectedMonth:i}=e,r=new Date().getMonth(),l={"year-round":[],seasonal:[],"year-end":[]};t.forEach(p=>l[p.seasonType].push(p));const d=n[i],a=t.length,o=d?.products.length??0,c=t.filter(p=>p.peakMonths.includes(i)).length,u=d?.targetCustomers.length??0;return`
<div class="panel">
  <div class="page-head">
    <div>
  ...
  ${nr(d)}
</div>`}function ar(e,t){const n=[],i=["year-round","seasonal","year-end"];for(const r of i){const l=e[r];if(l.length!==0){n.push(`<tr><td colspan="14" style="padding:8px 8px 4px;font-weight:600;background:#f7fafc;border-bottom:1px solid #e2e8f0">
    ...
    </div>`}).filter(Boolean);return i.length===0?`<div style="padding:1rem;color:#666;text-align:center">${ie[t]}に提案対象の商品はありません</div>`:i.join("")}function nr(e){return!e||e.targetCustomers.length===0?`
  ...
  `).join("")}</tbody>
  ...
  </div>`}const ir=new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}),yt=["月","火","水","木","金"],fa=6;function or(e,t){if(!e)return 9999;const n=new Date(e);return isNaN(n.getTime())?9999:Math.floor((t.getTime()-n.getTime())/(1e3*60*60*24))}function lr(e,t){if(t.length===0)return 0;const n=[...t].sort((r,l)=>r-l);return n.filter(r=>r<=e).length/n.length}function rr(e,t){return e.includes("離反リスク")?"緊急訪問 - 離反防止ヒアリング":e.includes("季節提案タイミング")?"季節商品の提案・試飲サンプル持参":t>30?"定期巡回 - 状況確認・追加注文確認":"関係維持 - ご挨拶"}function ba(e){const t=new Date,n=e.map(o=>o.annualRevenue),i=e.map(o=>{const c=or(o.lastOrderDate,t);let u=0;const p=[];c>=60&&(u+=50,p.push("離反リスク")),o.hasSeasonalProposal&&(u+=30,p.push("季節提案タイミング")),c>=30&&c<60&&(u+=20,p.push("定期巡回"));const y=lr(o.annualRevenue,n),h=Math.round(y*20);h>0&&(u+=h,p.push("金額ウェイト"));const f=rr(p,c);return{code:o.code,name:o.name,phone:o.phone,address:o.address1,areaCode:o.areaCode,businessType:o.businessType,priorityScore:u,reasons:p,lastOrderDate:o.lastOrderDate,daysSinceOrder:c,annualRevenue:o.annualRevenue,recommendedAction:f}}).filter(o=>o.priorityScore>0).sort((o,c)=>c.priorityScore-o.priorityScore),r=new Map;for(const o of i){const c=o.areaCode||"その他";r.has(c)||r.set(c,[]),r.get(c).push(o)}const l=[...r.entries()].sort((o,c)=>c[1].reduce((u,p)=>u+p.priorityScore,0)-o[1].reduce((u,p)=>u+p.priorityScore,0)),d=[];let a=0;for(const[o,c]of l){const u=c.sort((p,y)=>y.priorityScore-p.priorityScore);for(let p=0;p<u.length&&!(a>=yt.length);p+=fa){const y=u.slice(p,p+fa);d.push({dayLabel:yt[a],area:o,visits:y}),a++}if(a>=yt.length)break}return{candidates:i,weekPlan:d,filterArea:"",filterMinScore:0}}function cr(e){const{candidates:t,weekPlan:n,filterArea:i,filterMinScore:r}=e,l=t.filter(p=>!(i&&p.areaCode!==i||r>0&&p.priorityScore<r)),d=Array.from(new Set(t.map(p=>p.areaCode))).sort(),a=l.length,o=l.filter(p=>p.priorityScore>=50).length,c=l.filter(p=>p.reasons.includes("離反リスク")).length,u=n.reduce((p,y)=>p+y.visits.length,0);return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      ${n.length===0?"<p>訪問候補がありません。</p>":dr(n)}
    </section>
  ...
  `}function ur(e){return`
    <tr>
      ...
      <td class="numeric">${ir.format(e.annualRevenue)}</td>
      <td>${e.recommendedAction}</td>
    </tr>
  `}function pr(e){const t={empty:"空",in_use:"使用中",aging:"熟成中"},n={empty:"neutral",in_use:"warning",aging:"success"},i=e.map(c=>{const u=c.capacity>0?Math.round(c.currentVolume/c.capacity*100):0;return`
        <tr>
  ...
  `}function ht(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function mr(e,t,n){const i=e.rows.map((c,u)=>`
      <tr>
  ...
  `;const a={id:r,message:e,type:t,el:d};xt.push(a),i.appendChild(d),requestAnimationFrame(()=>{d.classList.add("toast-enter")});const o=()=>fr(a);d.querySelector(".toast-dismiss").addEventListener("click",o),setTimeout(()=>{d.classList.add("toast-exit"),d.addEventListener("animationend",o,{once:!0})},l)}function fr(e){const t=xt.indexOf(e);t!==-1&&(xt.splice(t,1),e.el.remove())}function br(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function se(e,t={}){const{title:n="確認",confirmLabel:i="OK",cancelLabel:r="キャンセル",variant:l="primary"}=t;return new Promise(d=>{const a=document.createElement("div");a.className="modal-backdrop confirm-backdrop",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
      <div class="modal-panel confirm-panel">
        ...
        <div class="confirm-actions">
          ...
          <button class="button ${l} confirm-ok">${Ue(i)}</button>
        </div>
      </div>
    `;const o=u=>{a.classList.add("confirm-exit"),a.addEventListener("animationend",()=>{a.remove()},{once:!0}),d(u)};a.querySelector(".confirm-cancel").addEventListener("click",()=>o(!1)),a.querySelector(".confirm-ok").addEventListener("click",()=>o(!0)),a.addEventListener("click",u=>{u.target===a&&o(!1)});const c=u=>{u.key==="Escape"&&(document.removeEventListener("keydown",c),o(!1))};document.addEventListener("keydown",c),document.body.appendChild(a),requestAnimationFrame(()=>{a.querySelector(".confirm-ok")?.focus()})})}const gr=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
...
</svg>`,$r=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
  <circle cx="14" cy="14" r="13" stroke="currentColor" stroke-width="1.5"/>
...
`)}`,d=new Blob([l],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(d),o=document.createElement("a");o.href=a,o.download=e,document.body.append(o),o.click(),o.remove(),window.setTimeout(()=>URL.revokeObjectURL(a),0)}const wr=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser","/demand-forecast","/churn-alert","/seasonal-calendar","/visit-planner","/demand"];let be=[];async function kr(){const{supabaseQueryAll:e}=await g(async()=>{const{supabaseQueryAll:n}=await Promise.resolve().then(()=>R);return{supabaseQueryAll:n}},void 0);be=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(n=>typeof n.email=="string"&&n.email.length>0).map(n=>({name:String(n.name??""),email:String(n.email??""),area:String(n.delivery_area_code??""),historySegment:"seasonal"}))}const $a=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"},{path:"/churn-alert",title:"離反アラート・休眠顧客"},{path:"/seasonal-calendar",title:"季節提案カレンダー"},{path:"/visit-planner",title:"訪問計画・ルート最適化"},{path:"/demand",title:"需要分析・安全在庫・生産計画"}];function Ss(e){const t=Ct[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function jt(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function Sr(){const e=Ss("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const it=new Date,xr=it.toISOString().slice(0,7),Pr=it.getFullYear(),Ar=it.getMonth()+1,Er=it.toISOString().slice(0,10),Dr="C0011",de=Sr();function xs(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return wr.includes(n)?n:"/"}function Ft(e){switch(e){case"/invoice-entry":case"/quote":case"/delivery":case"/billing":case"/invoice":case"/ledger":return"sales";case"/analytics":case"/customer-analysis":case"/product-power":case"/customer-efficiency":case"/report":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":case"/churn-alert":case"/seasonal-calendar":case"/visit-planner":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":case"/demand":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const _a=xs(location.pathname),s={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:jt(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:xr,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:Pr,taxMonth:Ar,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],callLogs:[],mapFilters:{showCustomers:!0,showProspects:!0,showDelivery:!0,filterRegion:"",filterBusinessType:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...Sl,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...xl},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:Er,route:_a,currentCategory:Ft(_a),sidebarOpen:!1,announcements:[],dismissedAnnouncements:new Set,updateAvailable:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:Dr,salesPeriod:"month",customRange:{start:"",end:""},quoteState:(()=>{const e={...hs};try{const t=localStorage.getItem("quote-seal");t&&(e.sealSettings=JSON.parse(t))}catch{}return e})(),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,productPower:[],productFilter:"all",productPeriod:"year",productDaily:[],productCustomStart:"",productCustomEnd:"",productSortState:[],customerSortState:[],dashboardSortState:[],masterSortState:[],customerEfficiency:[],masterTab:"customers",masterFilter:{...Mt},analyticsTab:"products",analyticsPeriod:"all",analyticsPeriodFilter:"",analyticsPeriodRows:[],analyticsPeriodOptions:[],analyticsStaffFilter:"",analyticsTagFilter:"",analyticsStaffPeriod:"all",analyticsStaffPeriodFilter:"",analyticsStaffPeriodOptions:[],analyticsStaffTotals:[],analyticsStaffDrilldown:null,emailAudienceMode:de.mode,emailRegion:de.region,emailHistorySegment:de.historySegment,emailTemplateId:de.templateId,emailSubject:de.subject,emailBody:de.body,emailSaveMessage:de.saveMessage,emailSending:!1,demandForecast:{...Ai},churnAlert:null,seasonalCalendar:null,visitPlanner:null,demandAnalysis:null,safetyStockParams:[],productionPlan:[],demandTab:"demand",demandPlanYearMonth:new Date().toISOString().slice(0,7),demandYearsBack:3,globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function wa(e){return e.slice(0,10)}function Cr(e){return{...e}}function Ze(){s.pickerMode=null,s.pickerQuery="",s.pickerTargetLine=null}function Ps(){s.invoiceForm=jt(),s.invoiceSavedDocNo=null,s.invoicePriceGroup="",s.invoiceErrors={},Ze()}function As(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,i)=>{n.productCode.trim()||(t[`lines.${i}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${i}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${i}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${i}.unitPrice`]="単価は0円以上で入力してください。")}),t}function Lr(e){const t=s.invoiceForm.lines[e];t&&s.invoiceForm.lines.splice(e+1,0,Cr(t))}function Ir(){const e=s.invoiceRecords[0],t=s.masterStats?.customers[0],n=s.masterStats?.products.slice(0,2)??[];s.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:s.invoiceForm.staffCode||"S001",lines:n.map((i,r)=>{const l=r===0?1:2,d=1200*(r+1);return{productCode:i.code,productName:i.name,quantity:l,unitPrice:d,unit:"本",amount:l*d}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},s.invoiceSavedDocNo=null,s.invoiceErrors={}}function Tr(e){const t=s.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function qr(e){const t=s.masterStats?.customers.find(n=>n.name===e.trim());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function Es(e){if(ae(e),s.invoiceErrors=As(s.invoiceForm),Object.keys(s.invoiceErrors).length>0){v();return}s.invoiceSaving=!0,v(),Ra(s.invoiceForm).then(t=>{s.invoiceSavedDocNo=t.documentNo,s.invoiceSaving=!1,s.invoiceErrors={},s.invoiceForm=jt(),v()}).catch(()=>{s.invoiceSaving=!1,v()})}function Ds(e){const t=s.salesFilter.startDate?new Date(s.salesFilter.startDate):null,n=s.salesFilter.endDate?new Date(`${s.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((i,r)=>new Date(r.date).getTime()-new Date(i.date).getTime()).filter(i=>{const r=new Date(i.date);return!(t&&r<t||n&&r>n)})}function Cs(){switch(s.emailAudienceMode){case"area":return s.emailRegion==="all"?be:be.filter(e=>e.area===s.emailRegion);case"history":return be.filter(e=>e.historySegment===s.emailHistorySegment);default:return be}}function Nr(){const e=Cs();return{audienceMode:s.emailAudienceMode,region:s.emailRegion,historySegment:s.emailHistorySegment,selectedTemplateId:s.emailTemplateId,subject:s.emailSubject,body:s.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:s.emailSaveMessage,sending:s.emailSending,senderId:s.emailSenderId,senders:s.mailSenders}}function vt(e){const t=Cs(),n=s.emailAudienceMode==="area"?s.emailRegion:s.emailAudienceMode==="history"?s.emailHistorySegment:"all";return{subject:s.emailSubject.trim(),body:s.emailBody.trim(),templateId:s.emailTemplateId,audienceMode:s.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(i=>i.email),status:e}}function Bt(){return s.user,!1}function Ie(){s.globalSearchOpen=!1,s.globalQuery=""}function Rr(){const e=s.globalQuery.trim().toLowerCase();return e?{customers:s.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:s.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:s.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:$a.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:$a}}function Or(){let e=[],t,n="export.csv";switch(s.route){case"/sales":e=(s.salesSummary?Ds(s.salesSummary):[]).map(i=>({documentNo:i.documentNo,date:i.date,customerCode:i.customerCode,customerName:i.customerName,amount:i.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...s.paymentStatus?.records??[]].sort((i,r)=>r.balanceAmount-i.balanceAmount).map(i=>({...i})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=s.invoiceRecords.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=s.purchaseList.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=s.jikomiList.map(i=>({...i})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=s.tankList.map(i=>({...i})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=s.kenteiList.map(i=>({...i})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=s.materialList.map(i=>({...i})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":s.masterTab==="customers"?(e=s.masterStats?.customers.map(i=>({...i}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=s.masterStats?.products.map(i=>({...i}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}_r(n,e,t)}function ka(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),s.route=e,s.currentCategory=Ft(e),s.sidebarOpen=!1,Ie(),zt(e)}async function zt(e){s.actionLoading=!0,v();try{switch(e){case"/delivery":s.deliveryNote||(s.deliveryNote=await It(s.deliverySearchDocNo||"D240122"));break;case"/billing":s.billingSummary||(s.billingSummary=await Tt(s.billingYearMonth));break;case"/report":s.salesReport||(s.salesReport=await at());break;case"/product-power":s.productPower.length===0&&(s.productPower=await Va());break;case"/customer-efficiency":s.customerEfficiency.length===0&&(s.customerEfficiency=await Ja());break;case"/customer-analysis":s.customerAnalysis||(s.customerAnalysis=await Ua());break;case"/demand-forecast":if(s.demandForecast.forecasts.length===0){const{fetchDemandForecasts:t,fetchDeliverySchedule:n}=await g(async()=>{const{fetchDemandForecasts:l,fetchDeliverySchedule:d}=await Promise.resolve().then(()=>S);return{fetchDemandForecasts:l,fetchDeliverySchedule:d}},void 0),[i,r]=await Promise.all([t(),n()]);s.demandForecast.forecasts=i.map(l=>({code:l.productCode,name:l.productName,segment:l.segment,monthlyQuantity:new Array(12).fill(0),avgMonthly:Math.round(l.avgMonthly),adjustedAvg:Math.round(l.avgMonthly),nextMonthForecast:Math.round(l.forecastQuantity),annualForecast:Math.round(l.avgMonthly*12),safetyStock:Math.round(l.safetyStock)})),s.demandForecast.deliveries=Ei(r)}break;case"/churn-alert":if(!s.churnAlert){const{fetchChurnAlerts:t}=await g(async()=>{const{fetchChurnAlerts:i}=await Promise.resolve().then(()=>S);return{fetchChurnAlerts:i}},void 0),n=await t();if(n.length>0){const i=n.filter(l=>l.is_dormant).map(l=>({code:l.customer_code,name:l.customer_name,businessType:l.business_type,areaCode:l.area_code,phone:l.phone,lastOrderDate:l.last_order_date,daysSinceLastOrder:l.days_since_order,totalAmountLast12m:l.amount_12m,status:"dormant"})),r=n.filter(l=>l.is_at_risk).map(l=>({code:l.customer_code,name:l.customer_name,businessType:l.business_type,areaCode:l.area_code,phone:l.phone,lastOrderDate:l.last_order_date,daysSinceLastOrder:l.days_since_order,totalAmountLast12m:l.amount_12m,status:"at-risk"}));s.churnAlert={dormantCustomers:i,atRiskCustomers:r}}else{const{supabaseQueryAll:i}=await g(async()=>{const{supabaseQueryAll:d}=await Promise.resolve().then(()=>R);return{supabaseQueryAll:d}},void 0),[r,l]=await Promise.all([i("sales_document_headers",{select:"sales_date,legacy_customer_code,customer_name,total_amount"}),s.masterStats?Promise.resolve(s.masterStats.customers):He().then(d=>d.customers)]);s.churnAlert=Gl(r.map(d=>({sales_date:d.sales_date||"",legacy_customer_code:d.legacy_customer_code||"",customer_name:d.customer_name||"",total_amount:Number(d.total_amount)||0})),(s.masterStats?.customers??l).map(d=>({code:d.code,name:d.name,businessType:d.businessType,areaCode:d.areaCode,phone:d.phone})))}}break;case"/seasonal-calendar":if(!s.seasonalCalendar){const{fetchProductShipmentsFromTable:t}=await g(async()=>{const{fetchProductShipmentsFromTable:i}=await Promise.resolve().then(()=>S);return{fetchProductShipmentsFromTable:i}},void 0),n=await t();if(n.length>0)s.seasonalCalendar=va(n.map(i=>({code:i.code,name:i.name,category:"",monthlyQuantity:i.monthlyQuantity})));else{const{fetchProductMonthlyShipments:i}=await g(async()=>{const{fetchProductMonthlyShipments:l}=await Promise.resolve().then(()=>S);return{fetchProductMonthlyShipments:l}},void 0),r=await i();s.seasonalCalendar=va(r.map(l=>({code:l.code,name:l.name,category:"",monthlyQuantity:l.monthlyQuantity})))}}break;case"/visit-planner":if(!s.visitPlanner){const{fetchVisitPriorities:t}=await g(async()=>{const{fetchVisitPriorities:i}=await Promise.resolve().then(()=>S);return{fetchVisitPriorities:i}},void 0),n=await t();if(n.length>0)s.visitPlanner={candidates:n.map(i=>({code:i.customer_code,name:i.customer_name,phone:i.phone,address:i.address,areaCode:i.area_code,businessType:i.business_type,priorityScore:i.priority_score,reasons:i.reasons,lastOrderDate:i.last_order_date,daysSinceOrder:i.days_since_order,annualRevenue:i.annual_revenue,recommendedAction:i.recommended_action})),weekPlan:[],filterArea:"",filterMinScore:0},s.visitPlanner=ba(n.map(i=>({code:i.customer_code,name:i.customer_name,phone:i.phone,address1:i.address,areaCode:i.area_code,businessType:i.business_type,annualRevenue:i.annual_revenue,lastOrderDate:i.last_order_date,hasSeasonalProposal:i.reasons.some(r=>r.includes("季節"))})));else{const{supabaseQueryAll:i}=await g(async()=>{const{supabaseQueryAll:o}=await Promise.resolve().then(()=>R);return{supabaseQueryAll:o}},void 0),[r,l]=await Promise.all([i("sales_document_headers",{select:"sales_date,legacy_customer_code,total_amount"}),s.masterStats?Promise.resolve(s.masterStats.customers):He().then(o=>o.customers)]),d=s.masterStats?.customers??l,a=new Map;r.forEach(o=>{const c=o.legacy_customer_code||"",u=o.sales_date||"",p=Number(o.total_amount)||0,y=a.get(c);!y||u>y.lastDate?a.set(c,{lastDate:u,total:(y?.total??0)+p}):y.total+=p}),s.visitPlanner=ba(d.filter(o=>o.isActive).map(o=>({code:o.code,name:o.name,phone:o.phone,address1:o.address1,areaCode:o.areaCode,businessType:o.businessType,annualRevenue:a.get(o.code)?.total??0,lastOrderDate:a.get(o.code)?.lastDate??"",hasSeasonalProposal:!1})))}}break;case"/demand":{const{fetchDemandAnalysis:t,fetchSafetyStockParams:n,fetchProductionPlan:i}=await g(async()=>{const{fetchDemandAnalysis:r,fetchSafetyStockParams:l,fetchProductionPlan:d}=await Promise.resolve().then(()=>S);return{fetchDemandAnalysis:r,fetchSafetyStockParams:l,fetchProductionPlan:d}},void 0);if(!s.demandAnalysis){const[r,l]=await Promise.all([t(s.demandYearsBack*12),n()]);s.demandAnalysis=r,s.safetyStockParams=l}if(s.productionPlan.length===0){const r=await i(s.demandPlanYearMonth);if(r.length>0)s.productionPlan=r;else if(s.demandAnalysis&&s.safetyStockParams.length>0){const l=s.demandPlanYearMonth,d=s.demandAnalysis.months.filter(a=>a<l).slice(-3);s.productionPlan=s.safetyStockParams.filter(a=>(s.demandAnalysis.productAvg[a.productCode]??0)>=10).map(a=>{const o=d.map(p=>s.demandAnalysis.matrix[a.productCode]?.[p]??0),c=o.length>0?Math.ceil(o.reduce((p,y)=>p+y,0)/o.length):Math.ceil(a.avgMonthlyDemand),u=Math.ceil(a.safetyStockQty);return{id:"",yearMonth:l,productCode:a.productCode,productName:a.productName,demandForecast:c,safetyStockTarget:u,openingStock:0,requiredProduction:Math.max(0,c+u),plannedQty:Math.max(0,c+u),actualQty:0,status:"draft",productionType:"monthly",notes:""}})}}break}case"/jikomi":s.jikomiList.length===0&&(s.jikomiList=await Qa());break;case"/tanks":s.tankList.length===0&&(s.tankList=await Ha());break;case"/kentei":s.kenteiList.length===0&&(s.kenteiList=await Ga());break;case"/materials":s.materialList.length===0&&(s.materialList=await bt());break;case"/purchase":(s.purchaseList.length===0||s.payableList.length===0)&&([s.purchaseList,s.payableList]=await Promise.all([Xa(),Ka()]));break;case"/raw-material":(s.billList.length===0||s.rawStockList.length===0)&&([s.billList,s.rawStockList]=await Promise.all([Wa(),Za()]));break;case"/tax":s.taxDeclaration||(s.taxDeclaration=await qt(s.taxYear,s.taxMonth));break;case"/store":(s.storeSales.length===0||s.storeOrders.length===0)&&([s.storeSales,s.storeOrders]=await Promise.all([Nt(s.storeSalesDate),as()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await g(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>S);return{fetchMailSenders:n}},void 0);if(s.mailSenders=await t(),!s.emailSenderId||!s.mailSenders.find(n=>n.id===s.emailSenderId)){const n=s.mailSenders.find(i=>i.isDefault)??s.mailSenders[0];n&&(s.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await g(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>S);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await g(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>S);return{fetchIntegrationSettings:n}},void 0);s.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await g(async()=>{const{fetchShopifyOrders:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>S);return{fetchShopifyOrders:i,fetchIntegrationSettings:r}},void 0);s.shopifyOrders=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await g(async()=>{const{fetchFaxInbox:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>S);return{fetchFaxInbox:i,fetchIntegrationSettings:r}},void 0);s.faxRecords=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await g(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>S);return{fetchUserProfiles:n}},void 0);s.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:i}=await g(async()=>{const{fetchMyProfile:l,fetchAuditLogs:d,fetchMailSenders:a}=await Promise.resolve().then(()=>S);return{fetchMyProfile:l,fetchAuditLogs:d,fetchMailSenders:a}},void 0),r=s.user?.email??s.myProfile?.email??"";r&&(s.myProfile=await t(r)),s.mailSenders.length===0&&(s.mailSenders=await i()),s.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await g(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>S);return{fetchAuditLogs:n}},void 0);s.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await g(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>S);return{fetchProspects:n}},void 0);s.prospects=await t()}break;case"/map":{const{fetchProspects:t,fetchDeliveryLocations:n,fetchIntegrationSettings:i}=await g(async()=>{const{fetchProspects:r,fetchDeliveryLocations:l,fetchIntegrationSettings:d}=await Promise.resolve().then(()=>S);return{fetchProspects:r,fetchDeliveryLocations:l,fetchIntegrationSettings:d}},void 0);s.prospects=await t(),s.deliveryLocations=await n(),s.integrations.length===0&&(s.integrations=await i())}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:n}=await g(async()=>{const{fetchCallLogs:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>S);return{fetchCallLogs:i,fetchIntegrationSettings:r}},void 0);s.callLogs=await t(100),s.integrations.length===0&&(s.integrations=await n())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:n}=await g(async()=>{const{fetchLeadLists:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>S);return{fetchLeadLists:i,fetchIntegrationSettings:r}},void 0);s.leadLists=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await g(async()=>{const{fetchWorkflowOrdersFromDb:n}=await Promise.resolve().then(()=>S);return{fetchWorkflowOrdersFromDb:n}},void 0);s.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await g(async()=>{const{fetchTourInquiriesFromDb:n}=await Promise.resolve().then(()=>S);return{fetchTourInquiriesFromDb:n}},void 0);s.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:i}=await g(async()=>{const{fetchSlackRules:r,fetchSlackLogs:l,fetchIntegrationSettings:d}=await Promise.resolve().then(()=>S);return{fetchSlackRules:r,fetchSlackLogs:l,fetchIntegrationSettings:d}},void 0);s.slackRules=await t(),s.slackLogs=await n(50),s.integrations.length===0&&(s.integrations=await i())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:n,fetchWorkflowOrdersFromDb:i,fetchTourInquiriesFromDb:r}=await g(async()=>{const{fetchProspects:l,fetchCalendarEvents:d,fetchWorkflowOrdersFromDb:a,fetchTourInquiriesFromDb:o}=await Promise.resolve().then(()=>S);return{fetchProspects:l,fetchCalendarEvents:d,fetchWorkflowOrdersFromDb:a,fetchTourInquiriesFromDb:o}},void 0);s.prospects.length===0&&(s.prospects=await t()),s.calendarEvents.length===0&&(s.calendarEvents=await n(s.calendarYearMonth)),s.materialList.length===0&&(s.materialList=await bt()),s.workflowOrders.length===0&&(s.workflowOrders=await i()),s.tourInquiries.length===0&&(s.tourInquiries=await r())}break;default:break}}catch(t){console.warn("Route data load error",t)}finally{s.actionLoading=!1,v()}}function Sa(){if(Bt())return yo(s.authError,s.authSubmitting);if(s.loading)return`
    ...
    `;const e={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売業務",items:[{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/quote",label:"見積作成",kicker:"Quote"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],analytics:[{label:"分析",items:[{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/customer-analysis",label:"得意先分析",kicker:"CustABC"},{path:"/product-power",label:"商品力分析",kicker:"Power"},{path:"/customer-efficiency",label:"営業効率",kicker:"Efficiency"},{path:"/report",label:"集計帳票",kicker:"Report"}]}],crm:[{label:"営業ツール",items:[{path:"/churn-alert",label:"離反アラート",kicker:"Churn"},{path:"/seasonal-calendar",label:"季節提案",kicker:"Season"},{path:"/visit-planner",label:"訪問計画",kicker:"Visit"},{path:"/prospects",label:"新規営業",kicker:"Prospects"},{path:"/map",label:"取引先マップ",kicker:"Map"},{path:"/list-builder",label:"リスト取得",kicker:"ListBuild"},{path:"/calls",label:"通話履歴",kicker:"Calls"},{path:"/email",label:"メール配信",kicker:"Mail"}]},{label:"受注・出荷",items:[{path:"/workflow",label:"受注ワークフロー",kicker:"Workflow"},{path:"/mobile-order",label:"モバイル受注",kicker:"Mobile"},{path:"/shopify",label:"Shopify注文",kicker:"Shopify"},{path:"/fax",label:"FAX OCR",kicker:"FAX"}]}],orders:[{label:"仕入・調達",items:[{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],brewery:[{label:"製造管理",items:[{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"},{path:"/tax",label:"酒税申告",kicker:"Tax"},{path:"/demand",label:"需要・生産計画",kicker:"Demand"}]}],master:[{label:"マスタ・ツール",items:[{path:"/master",label:"マスタ管理",kicker:"Master"},{path:"/calendar",label:"カレンダー",kicker:"Calendar"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/tour",label:"酒蔵見学",kicker:"Tour"},{path:"/print",label:"印刷",kicker:"Print"}]}],settings:[{label:"システム設定",items:[{path:"/setup",label:"連動設定",kicker:"Setup"},{path:"/integrations",label:"外部連携",kicker:"API"},{path:"/slack",label:"Slack通知",kicker:"Slack"},{path:"/import",label:"データ取込",kicker:"Import"},{path:"/raw-browser",label:"データブラウザ",kicker:"RawData"},{path:"/users",label:"ユーザー管理",kicker:"Users"},{path:"/profile",label:"プロフィール",kicker:"Profile"},{path:"/audit",label:"操作ログ",kicker:"Audit"}]}]},t=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/invoice-entry",label:"販売"},{category:"analytics",path:"/analytics",label:"分析"},{category:"crm",path:"/prospects",label:"営業"},{category:"orders",path:"/purchase",label:"仕入"},{category:"brewery",path:"/jikomi",label:"製造"},{category:"master",path:"/master",label:"マスタ"},{category:"settings",path:"/setup",label:"設定"}],n=e[s.currentCategory].map(a=>`
      ...
      `).join(""),r=s.pickerMode&&s.masterStats?s.pickerMode==="customer"?Ji(s.masterStats.customers,s.pickerQuery):Eo(s.masterStats.products,s.pickerQuery):"",l=s.globalSearchOpen?Vi(s.globalQuery,Rr()):"",d=s.user?`
