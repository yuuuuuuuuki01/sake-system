...
`}function vn(e){const t=e.rows.map(r=>{const l=Math.max(0,r.productionVolume+r.previousBalance+r.currentAdjustment-r.exportDeduction-r.sampleDeduction),d=Math.round(l*r.taxRate);return{...r,taxableVolume:l,volume:l,taxAmount:d}}),n=t.reduce((r,l)=>r+l.taxableVolume,0),i=t.reduce((r,l)=>r+l.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:i}}async function fn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>j);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:ts(e),submitted_at:e.submittedAt})}async function Nt(e){const t=await D("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(n=>({id:m(n,["id"],""),saleDate:m(n,["sale_date"],e),saleTime:m(n,["sale_time"],""),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),quantity:b(n,["quantity"],0),unitPrice:b(n,["unit_price"],0),amount:b(n,["amount"],0),paymentMethod:m(n,["payment_method"],"cash")})):[]}async function as(){const e=await D("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),orderDate:V(t,["order_date"],""),customerName:m(t,["customer_name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["shipping_address"],""),items:[],totalAmount:b(t,["total_amount"],0),status:m(t,["status"],"new"),shippingDate:V(t,["shipping_date"],"")})):[]}async function Ue(e){const t=await et("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function ss(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function bn(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await D("print_layouts",t)).map(i=>({id:m(i,["id"],""),name:m(i,["name"],""),templateKey:m(i,["template_key"],""),positions:i.positions??{},isDefault:U(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}))}async function gn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:r}=await Promise.resolve().then(()=>j);return{supabaseInsert:r}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},i=await t("print_layouts",n);return i?{id:m(i,["id"],e.id),name:m(i,["name"],e.name),templateKey:m(i,["template_key"],e.templateKey),positions:i.positions??e.positions,isDefault:U(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}:null}async function $n(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function _n(){return(await D("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),signature:m(t,["signature"],""),replyTo:m(t,["reply_to"],""),isDefault:U(t,["is_default"],!1),isVerified:U(t,["is_verified"],!1),note:m(t,["note"],"")}))}async function wn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:m(n,["id"],e.id),name:m(n,["name"],e.name),email:m(n,["email"],e.email),displayName:m(n,["display_name"],""),signature:m(n,["signature"],""),replyTo:m(n,["reply_to"],""),isDefault:U(n,["is_default"],!1),isVerified:U(n,["is_verified"],!1)}:null}async function kn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const Rt={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},Ot={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Sn(e){const t=`${e}-01T00:00:00Z`,[n,i]=e.split("-").map(a=>parseInt(a,10)),r=new Date(n,i,0).getDate(),l=`${e}-${String(r).padStart(2,"0")}T23:59:59Z`;return(await D("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${l})`,order:"starts_at.asc"})).map(a=>({id:m(a,["id"],""),title:m(a,["title"],""),description:m(a,["description"],""),category:m(a,["category"],"general")||"general",startsAt:m(a,["starts_at"],new Date().toISOString()),endsAt:m(a,["ends_at"],""),isAllDay:U(a,["is_all_day"],!1),location:m(a,["location"],""),attendees:a.attendees??[],relatedCustomerCode:m(a,["related_customer_code"],""),relatedOrderId:m(a,["related_order_id"],""),color:m(a,["color"],""),googleEventId:m(a,["google_event_id"],"")}))}async function xn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??Ot[e.category],updated_at:new Date().toISOString()})?e:null}async function Pn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ns(){return(await D("integration_settings",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),provider:m(t,["provider"],""),config:t.config??{},isEnabled:U(t,["is_enabled"],!1),lastSyncAt:m(t,["last_sync_at"],""),lastStatus:m(t,["last_status"],"")}))}async function Te(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function An(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const i=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,r=await fetch(i,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const l=await r.json(),{supabaseInsert:d}=await _(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>j);return{supabaseInsert:o}},void 0);let a=0;for(const o of l.orders){const c=`shopify_${o.id}`;await d("shopify_orders",{id:c,shopify_order_id:String(o.id),order_number:String(o.order_number??""),order_date:String(o.created_at??new Date().toISOString()),customer_name:String(o.customer?.first_name??"")+" "+String(o.customer?.last_name??""),customer_email:String(o.customer?.email??""),total_amount:Math.round(parseFloat(String(o.total_price??"0"))),financial_status:String(o.financial_status??""),fulfillment_status:String(o.fulfillment_status??"unfulfilled"),line_items:o.line_items??[],shipping_address:o.shipping_address??null,raw_payload:o}),a++}return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${a}件取得成功`}),{count:a}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Dn(){return(await D("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),shopifyOrderId:m(t,["shopify_order_id"],""),orderNumber:m(t,["order_number"],""),orderDate:m(t,["order_date"],""),customerName:m(t,["customer_name"],""),customerEmail:m(t,["customer_email"],""),totalAmount:R(t.total_amount),financialStatus:m(t,["financial_status"],""),fulfillmentStatus:m(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function En(e){const t=e.config.refresh_token,n=e.config.client_id,i=e.config.client_secret;if(!t||!n||!i)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const r=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:n,client_secret:i})});if(!r.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${r.status}`};const d=(await r.json()).access_token;return await Te({...e,config:{...e.config,oauth_token:d}}),e.config.oauth_token=d,{token:d}}async function Cn(e){let t=e.config.oauth_token;const n=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const i=new Date().toISOString(),r=new Date(Date.now()+30*86400*1e3).toISOString(),l=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${i}&timeMax=${r}&singleEvents=true&orderBy=startTime`;let d=await fetch(l,{headers:{Authorization:`Bearer ${t}`}});if(d.status===401){const u=await En(e);if(u.error)return{count:0,error:u.error};t=u.token,d=await fetch(l,{headers:{Authorization:`Bearer ${t}`}})}if(!d.ok)return{count:0,error:`HTTP ${d.status}`};const a=await d.json(),{supabaseInsert:o}=await _(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>j);return{supabaseInsert:u}},void 0);let c=0;for(const u of a.items){const p=`gcal_${u.id}`,y=u.start?.dateTime??u.start?.date??"",h=u.end?.dateTime??u.end?.date??"";await o("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(y),ends_at:String(h),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),c++}return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${c}件取得`}),{count:c}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Ln(){return(await D("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),receivedAt:m(t,["received_at"],""),senderPhone:m(t,["sender_phone"],""),senderName:m(t,["sender_name"],""),imageUrl:m(t,["image_url"],""),ocrStatus:m(t,["ocr_status"],"pending")||"pending",ocrText:m(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:m(t,["linked_invoice_id"],"")}))}async function In(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const i=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,r=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return r.ok?{text:(await r.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${r.status}`}}catch(i){return{text:"",error:i instanceof Error?i.message:String(i)}}}async function Tn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Xe={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Ke={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function qn(){return(await D("user_profiles",{order:"display_name.asc"})).map(t=>({id:m(t,["id"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),staffCode:m(t,["staff_code"],""),department:m(t,["department"],"all")||"all",role:m(t,["role"],"staff")||"staff",defaultMailSenderId:m(t,["default_mail_sender_id"],""),phone:m(t,["phone"],""),avatarUrl:m(t,["avatar_url"],""),isActive:U(t,["is_active"],!0),lastSignInAt:m(t,["last_sign_in_at"],""),createdAt:m(t,["created_at"],"")}))}async function Nn(e){if(!e)return null;const t=await D("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:m(n,["id"],""),email:m(n,["email"],""),displayName:m(n,["display_name"],""),staffCode:m(n,["staff_code"],""),department:m(n,["department"],"all")||"all",role:m(n,["role"],"staff")||"staff",defaultMailSenderId:m(n,["default_mail_sender_id"],""),phone:m(n,["phone"],""),avatarUrl:m(n,["avatar_url"],""),isActive:U(n,["is_active"],!0),lastSignInAt:m(n,["last_sign_in_at"],"")}}async function Rn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function On(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function jn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>j);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function Mn(e=100){return(await D("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),action:m(n,["action"],""),entityType:m(n,["entity_type"],""),entityId:m(n,["entity_id"],""),userEmail:m(n,["user_email"],""),changes:n.changes??{},createdAt:m(n,["created_at"],"")}))}const We={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function is(){return(await D("slack_notifications",{order:"event_type.asc"})).map(t=>({id:m(t,["id"],""),eventType:m(t,["event_type"],"new_order"),enabled:U(t,["enabled"],!0),channel:m(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:m(t,["last_triggered_at"],"")}))}async function Fn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function Bn(e=50){return(await D("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),eventType:m(n,["event_type"],""),channel:m(n,["channel"],""),message:m(n,["message"],""),status:m(n,["status"],"sent"),error:m(n,["error"],""),sentAt:m(n,["sent_at"],"")}))}async function zn(e,t,n){const r=(await ns()).find(c=>c.provider==="slack");if(!r||!r.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const l=r.config.webhook_url;if(!l)return{ok:!1,error:"Webhook URL未設定"};const a=(await is()).find(c=>c.eventType===e&&c.enabled);if(!a)return{ok:!1,error:"通知ルールが無効"};const o=n??a.channel??r.config.default_channel??"#general";try{const c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${We[e]} ${t}`,channel:o})}),u=c.ok,{supabaseInsert:p}=await _(async()=>{const{supabaseInsert:y}=await Promise.resolve().then(()=>j);return{supabaseInsert:y}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:o,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${c.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${c.status}`}}catch(c){return{ok:!1,error:c instanceof Error?c.message:String(c)}}}const qe={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},st={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function Vn(){return(await D("prospects",{order:"updated_at.desc"})).map(t=>({id:m(t,["id"],""),companyName:m(t,["company_name"],""),contactName:m(t,["contact_name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),address:m(t,["address"],""),website:m(t,["website"],""),businessType:m(t,["business_type"],""),stage:m(t,["stage"],"cold"),source:m(t,["source"],""),expectedAmount:R(t.expected_amount),probability:R(t.probability),assignedStaffCode:m(t,["assigned_staff_code"],""),nextActionDate:m(t,["next_action_date"],""),nextAction:m(t,["next_action"],""),note:m(t,["note"],""),lastContactAt:m(t,["last_contact_at"],""),wonAt:m(t,["won_at"],""),lostAt:m(t,["lost_at"],""),lostReason:m(t,["lost_reason"],""),convertedCustomerCode:m(t,["converted_customer_code"],""),createdAt:m(t,["created_at"],"")}))}async function os(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function Jn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Yn(e){return(await D("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:m(n,["id"],""),prospectId:m(n,["prospect_id"],""),activityType:m(n,["activity_type"],"call"),title:m(n,["title"],""),description:m(n,["description"],""),activityDate:m(n,["activity_date"],""),result:m(n,["result"],""),staffCode:m(n,["staff_code"],"")}))}async function Un(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const ls=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function Qn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function Hn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Gn(){return(await D("delivery_locations",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),customerCode:m(t,["customer_code"],""),name:m(t,["name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:m(t,["contact_name"],""),phone:m(t,["phone"],""),deliveryNote:m(t,["delivery_note"],""),isActive:U(t,["is_active"],!0)}))}async function Xn(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function Kn(e=50){return(await D("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),callDirection:m(n,["call_direction"],"inbound"),fromNumber:m(n,["from_number"],""),toNumber:m(n,["to_number"],""),matchedCustomerCode:m(n,["matched_customer_code"],""),matchedProspectId:m(n,["matched_prospect_id"],""),durationSeconds:R(n.duration_seconds),callStatus:m(n,["call_status"],"answered"),recordingUrl:m(n,["recording_url"],""),transcript:m(n,["transcript"],""),ivryCallId:m(n,["ivry_call_id"],""),startedAt:m(n,["started_at"],""),endedAt:m(n,["ended_at"],""),notes:m(n,["notes"],"")}))}async function rs(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function Wn(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const i=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,r=await fetch(i,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const d=(await r.json()).calls??[];let a=0;for(const o of d)await rs({id:`ivry_${o.id}`,callDirection:String(o.direction??"inbound"),fromNumber:String(o.from??""),toNumber:String(o.to??""),durationSeconds:Number(o.duration??0),callStatus:String(o.status??"answered"),recordingUrl:String(o.recording_url??""),startedAt:String(o.started_at??""),endedAt:String(o.ended_at??""),ivryCallId:String(o.id??"")}),a++;return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${a}件取得`}),{count:a}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Zn(e,t){const n=e.config.api_key,i=e.config.team_id;if(!n||!i)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let r=0;for(const l of t){if(!l.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${i}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:l.name,phone_number:l.phone,external_id:l.customerCode??"",note:l.note??""})})).ok&&r++}return{synced:r}}catch(r){return{synced:0,error:r instanceof Error?r.message:String(r)}}}async function ei(){return(await D("lead_lists",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),query:m(t,["query"],""),area:m(t,["area"],""),businessType:m(t,["business_type"],""),totalCount:R(t.total_count),source:m(t,["source"],"manual"),createdAt:m(t,["created_at"],"")}))}async function ti(e){return(await D("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:m(n,["id"],""),listId:m(n,["list_id"],""),companyName:m(n,["company_name"],""),address:m(n,["address"],""),phone:m(n,["phone"],""),website:m(n,["website"],""),email:m(n,["email"],""),businessType:m(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:R(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:m(n,["place_id"],""),status:m(n,["status"],"new"),convertedProspectId:m(n,["converted_prospect_id"],""),note:m(n,["note"],"")}))}async function ai(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function cs(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function si(e,t,n){const i=e.config.api_key;if(!i)return{results:[],error:"Google Maps API key 未設定"};const r=`${t} ${n}`.trim(),l=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(r)}&language=ja&key=${i}`;try{const d=await fetch(l);if(!d.ok)return{results:[],error:`HTTP ${d.status}`};const a=await d.json();return a.status!=="OK"&&a.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${a.status}`}:{results:a.results.map(c=>{const u=c.geometry?.location;return{id:`place_${c.place_id}`,listId:"",companyName:String(c.name??""),address:String(c.formatted_address??""),rating:c.rating?Number(c.rating):void 0,reviewCount:c.user_ratings_total?Number(c.user_ratings_total):void 0,lat:u?.lat,lng:u?.lng,placeId:String(c.place_id??""),status:"new"}})}}catch(d){return{results:[],error:d instanceof Error?d.message:String(d)}}}async function ni(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await os(t);return n&&await cs({...e,status:"imported",convertedProspectId:t.id}),n}async function ii(){return(await D("workflow_orders",{order:"order_date.desc"})).map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),customerName:m(t,["customer_name"],""),customerCode:m(t,["customer_code"],""),orderDate:m(t,["order_date"],""),deliveryDate:m(t,["delivery_date"],""),stage:m(t,["stage"],"new"),totalAmount:R(t.total_amount),itemCount:R(t.item_count),priority:m(t,["priority"],"normal"),staffName:m(t,["staff_name"],""),notes:m(t,["notes"],"")}))}async function oi(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function li(){return(await D("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),visitDate:m(t,["visit_date"],""),partySize:R(t.party_size)||1,language:m(t,["language"],"ja"),purpose:m(t,["purpose"],""),message:m(t,["message"],""),status:m(t,["status"],"new"),repliedAt:m(t,["replied_at"],""),confirmedTime:m(t,["confirmed_time"],""),createdAt:m(t,["created_at"],new Date().toISOString())}))}async function ri(e){const{supabaseInsert:t}=await _(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>j);return{supabaseInsert:i}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const ci=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function ds(){return(await Promise.all(ci.map(async t=>{const[n,i]=await Promise.all([Dt(t.table),D(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:i[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function Qe(e,t,n=100){const i=(t-1)*n,[r,l]=await Promise.all([D(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(i)}),Dt(e)]);return{records:r,total:l}}async function $t(e){const t=await D("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const i=JSON.parse(n);return String(i.price_group??"")}catch{return""}return""}async function us(e,t){if(e){const i=await D("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(i.length>0&&i[0].special_price)return R(i[0].special_price)}const n=await D("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?R(n[0].default_sale_price):0}const di=[{code:"SAK001",name:"純米大吟醸　金井"},{code:"SAK002",name:"純米吟醸　金井"},{code:"SAK003",name:"本醸造　金井"},{code:"SAK004",name:"純米酒　金井"}],ui=[1.6,.7,1.3,1.2,.9,.7,.6,.7,.9,1,1.1,1.5],pi={SAK001:80,SAK002:150,SAK003:220,SAK004:180};function mi(){const e=new Date,t=[];for(let o=11;o>=0;o--){const c=new Date(e.getFullYear(),e.getMonth()-o,1);t.push(`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`)}const n=di,i={},r={};for(const o of n){i[o.code]={};for(const c of t){const u=parseInt(c.split("-")[1])-1,p=pi[o.code]??100,y=Math.round(p*ui[u]*(.85+Math.random()*.3));i[o.code][c]=y,r[c]=(r[c]??0)+y}}const l={},d={},a={};for(const o of n){const c=t.map(y=>i[o.code][y]??0),u=c.reduce((y,h)=>y+h,0)/c.length,p=c.reduce((y,h)=>y+(h-u)**2,0)/c.length;l[o.code]=c.reduce((y,h)=>y+h,0),d[o.code]=u,a[o.code]=Math.sqrt(p)}return{months:t,products:n,matrix:i,totals:r,productTotals:l,productAvg:d,productStdDev:a}}async function yi(e=36){const t=(()=>{const y=new Date;return y.setMonth(y.getMonth()-e),`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`})(),n=await H("product_monthly_sales",{select:"year_month,product_code,product_name,quantity",year_month:`gte.${t}`,order:"year_month.asc"});if(n.length===0)return mi();const i=new Set,r=new Map,l={},d={};for(const y of n){const h=m(y,["year_month"],""),f=m(y,["product_code"],""),k=m(y,["product_name"],f),g=b(y,["quantity"],0);!h||!f||(i.add(h),r.set(f,k),l[f]||(l[f]={}),l[f][h]=g,d[h]=(d[h]??0)+g)}const a=[...i].sort(),o=[...r.entries()].map(([y,h])=>({code:y,name:h})),c={},u={},p={};for(const y of o){const h=a.map(g=>l[y.code]?.[g]??0),f=h.reduce((g,x)=>g+x,0)/(h.length||1),k=h.reduce((g,x)=>g+(x-f)**2,0)/(h.length||1);c[y.code]=h.reduce((g,x)=>g+x,0),u[y.code]=f,p[y.code]=Math.sqrt(k)}return{months:a,products:o,matrix:l,totals:d,productTotals:c,productAvg:u,productStdDev:p}}async function hi(){return(await D("product_safety_stock_params",{order:"product_code.asc"})).map(t=>({productCode:m(t,["product_code"],""),productName:m(t,["product_name"],""),unit:m(t,["unit"],"本"),avgMonthlyDemand:b(t,["avg_monthly_demand"],0),demandStdDev:b(t,["demand_std_dev"],0),leadTimeDays:b(t,["lead_time_days"],30),serviceLevel:b(t,["service_level"],.95),safetyStockQty:b(t,["safety_stock_qty"],0),reorderPoint:b(t,["reorder_point"],0),memo:m(t,["memo"],""),productionType:m(t,["production_type"],"monthly")}))}async function vi(e){return(await D("production_plan",{year_month:`eq.${e}`,order:"product_code.asc"})).map(n=>({id:m(n,["id"],""),yearMonth:m(n,["year_month"],e),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),demandForecast:b(n,["demand_forecast"],0),safetyStockTarget:b(n,["safety_stock_target"],0),openingStock:b(n,["opening_stock"],0),requiredProduction:b(n,["required_production"],0),plannedQty:b(n,["planned_qty"],0),actualQty:b(n,["actual_qty"],0),status:m(n,["status"],"draft"),productionType:m(n,["production_type"],"monthly"),notes:m(n,["notes"],"")}))}async function fi(e){const{supabaseUpsert:t}=await _(async()=>{const{supabaseUpsert:i}=await Promise.resolve().then(()=>j);return{supabaseUpsert:i}},void 0);return await t("product_safety_stock_params",{product_code:e.productCode,product_name:e.productName,unit:e.unit,avg_monthly_demand:e.avgMonthlyDemand,demand_std_dev:e.demandStdDev,lead_time_days:e.leadTimeDays,service_level:e.serviceLevel,safety_stock_qty:e.safetyStockQty,reorder_point:e.reorderPoint,memo:e.memo,last_calc_at:new Date().toISOString(),updated_at:new Date().toISOString()})!==null}async function bi(e){const{supabaseUpsert:t}=await _(async()=>{const{supabaseUpsert:i}=await Promise.resolve().then(()=>j);return{supabaseUpsert:i}},void 0);return await t("production_plan",{...e.id?{id:e.id}:{},year_month:e.yearMonth,product_code:e.productCode,product_name:e.productName,demand_forecast:e.demandForecast,safety_stock_target:e.safetyStockTarget,opening_stock:e.openingStock,required_production:e.requiredProduction,planned_qty:e.plannedQty,actual_qty:e.actualQty,status:e.status,production_type:e.productionType,notes:e.notes,updated_at:new Date().toISOString()})!==null}function gi(e){if(!e)return"不明";const t=e.replace(/^.+?[都道府県]/,""),n=t.match(/^(.+?郡.+?[町村]|.+?[市区町村])/);return n?n[1]:t.substring(0,6)}async function $i(e){const[t,n]=e.split("-").map(Number),i=`${e}-01`,r=new Date(t,n,0).getDate(),l=`${e}-${String(r).padStart(2,"0")}`,d=await H("sales_document_headers",{select:"sales_date,customer_name,legacy_customer_code,total_amount",and:`(sales_date.gte.${i},sales_date.lte.${l})`,order:"sales_date.asc"}),a=await H("customers",{select:"id,address1",address1:"not.is.null"}),o={};for(const u of a)u.address1&&(o[u.id]=gi(u.address1));const c={};for(const u of d){const p=u.sales_date;if(!p)continue;const y=o[u.legacy_customer_code]||"住所未登録",h=Number(u.total_amount)||0;c[p]||(c[p]={date:p,entries:[],cityGroups:[],totalAmount:0,count:0}),c[p].entries.push({customerCode:u.legacy_customer_code||"",customerName:u.customer_name||"",city:y,amount:h}),c[p].totalAmount+=h,c[p].count++}for(const u of Object.values(c)){const p={};for(const y of u.entries)p[y.city]=(p[y.city]||0)+1;u.cityGroups=Object.entries(p).sort((y,h)=>h[1]-y[1]).map(([y,h])=>({city:y,count:h}))}return c}const S=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:Ot,CALENDAR_CATEGORY_LABELS:Rt,DEPT_LABELS:Ke,INVOICE_TYPE_LABELS:ft,JIKOMI_STATUS_LABELS:Ua,MATERIAL_CATEGORIES:ls,PROSPECT_STAGE_COLORS:st,PROSPECT_STAGE_LABELS:qe,ROLE_LABELS:Xe,SEASONAL_TEMPLATES:Ct,SLACK_EVENT_LABELS:We,TAX_DEDUCTION_LABELS:gt,TAX_RATE_CATEGORIES:es,convertLeadToProspect:ni,deleteCalendarEvent:Pn,deleteMailSender:kn,deleteMaterial:Hn,deletePrintLayout:$n,deleteProspect:Jn,deleteUserProfile:On,fetchAnalyticsByPeriod:Gs,fetchAnnouncements:Oa,fetchAuditLogs:Mn,fetchAvailablePeriods:Xs,fetchBillList:Wa,fetchBillingSummary:Tt,fetchCalendarEvents:Sn,fetchCallLogs:Kn,fetchChurnAlerts:ln,fetchCustomerAnalysis:Ya,fetchCustomerEfficiency:Ja,fetchCustomerLedger:Lt,fetchCustomerPriceGroup:$t,fetchCustomerPricing:Ba,fetchDeliveryLocations:Gn,fetchDeliveryNote:It,fetchDeliverySchedule:on,fetchDemandAnalysis:yi,fetchDemandForecasts:nn,fetchFaxInbox:Ln,fetchIntegrationSettings:ns,fetchInvoices:Ge,fetchJikomiList:Qa,fetchKenteiList:Ga,fetchLeadItems:ti,fetchLeadLists:ei,fetchMailSenders:_n,fetchMasterStats:He,fetchMaterialList:bt,fetchMyProfile:Nn,fetchPayableList:Ka,fetchPaymentStatus:Ca,fetchPipelineMeta:La,fetchPrintLayouts:bn,fetchProductABC:pn,fetchProductDaily:un,fetchProductMonthlyShipments:sn,fetchProductPower:Va,fetchProductPrice:us,fetchProductShipmentsFromTable:dn,fetchProductionPlan:vi,fetchProspectActivities:Yn,fetchProspects:Vn,fetchPurchaseList:Xa,fetchRawMaterialStock:Za,fetchRawRecords:Qe,fetchRawTableList:ds,fetchSafetyStockParams:hi,fetchSalesAnalytics:Ta,fetchSalesReport:at,fetchSalesSummary:Ea,fetchSeasonalProfiles:cn,fetchShipmentCalendar:$i,fetchShopifyOrders:Dn,fetchSlackLogs:Bn,fetchSlackRules:is,fetchStaffCustomerBreakdown:Zs,fetchStaffProductBreakdown:en,fetchStaffTotalsByPeriod:Ws,fetchStoreOrders:as,fetchStoreSales:Nt,fetchSyncDashboard:Ia,fetchTankList:Ha,fetchTaxDeclaration:qt,fetchTourInquiriesFromDb:li,fetchUserProfiles:qn,fetchVisitPriorities:rn,fetchWorkflowOrdersFromDb:ii,generateTaxCSV:hn,generateTaxXML:ts,ocrFaxImage:In,periodToDateRange:Ks,recalculateTaxDeclaration:vn,recordAudit:jn,resolveProductPrice:za,saveCalendarEvent:xn,saveCallLog:rs,saveDeliveryLocation:Xn,saveEmailCampaign:Ue,saveFaxRecord:Tn,saveIntegrationSetting:Te,saveInvoice:Ra,saveLeadItem:cs,saveLeadList:ai,saveMailSender:wn,saveMaterial:Qn,savePrintLayout:gn,saveProductionPlan:bi,saveProspect:os,saveProspectActivity:Un,saveSafetyStockParams:fi,saveSlackRule:Fn,saveTaxDeclaration:fn,saveTourInquiry:ri,saveUserProfile:Rn,saveWorkflowOrder:oi,searchPlaces:si,sendEmailCampaign:ss,sendSlackNotification:zn,submitFeatureRequest:ja,syncGoogleCalendar:Cn,syncIvryCallLogs:Wn,syncPhoneBookToIvry:Zn,syncShopifyOrders:An,updateCustomer:Ma,updateProduct:Fa},Symbol.toStringTag,{value:"Module"}));function me(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const _i={open:"未締め",closed:"締め済"};function wi(e,t){const n=e.customers.map(i=>`
  ...
  `}function Re(e,t,n){const i=e.findIndex(l=>l.column===t);if(i>=0){if(e[i].direction==="asc"){const d=[...e];return d[i]={column:t,direction:"desc"},d}return e.filter((d,a)=>a!==i)}const r={column:t,direction:"asc"};return n?[...e,r]:[r]}function Di(e,t){const n=e.findIndex(l=>l.column===t);if(n<0)return'<span class="sort-icon">⇅</span>';const i=e[n].direction==="asc"?"↑":"↓",r=e.length>1?`<small class="sort-badge">${n+1}</small>`:"";return`<span class="sort-icon active">${i}${r}</span>`}function q(e,t,n,i=""){return`<th class="sortable ${i}" data-sort-col="${e}">${t} ${Di(n,e)}</th>`}function Xt(e){if(e==null)return"";const t=String(e).replace(/[¥,円%本日L]/g,"").trim(),n=Number(t);return Number.isFinite(n)?n:t.toLowerCase()}function Le(e,t,n){return t.length===0?e:[...e].sort((i,r)=>{for(const{column:l,direction:d}of t){const a=n[l];if(!a)continue;const o=Xt(i[a]),c=Xt(r[a]);let u=0;if(typeof o=="number"&&typeof c=="number"?u=o-c:u=String(o).localeCompare(String(c),"ja"),u!==0)return d==="asc"?u:-u}return 0})}const Ei={forecasts:[],deliveries:[],calendarMonth:new Date().toISOString().slice(0,7),selectedSegment:"all"},Kt={monthly:"通年出荷","made-to-order":"受注生産","november-only":"歳暮（11月生産）","annual-batch":"季節集中","december-settlement":"歳暮（11月生産）","seasonal-batch":"季節集中"},_e={monthly:"#0F5B8D","made-to-order":"#6b46c1","november-only":"#c05621","annual-batch":"#2f855a","december-settlement":"#c05621","seasonal-batch":"#2f855a"};function Ci(e){const t=new Date().toISOString().slice(0,10);return e.map(n=>({date:n.date,customerName:n.customerName,productName:n.productName,quantity:n.quantity,status:n.date>t?"scheduled":"delivered"}))}function Li(e){const[t,n]=e.split("-").map(Number);return new Date(t,n,0).getDate()}function Ii(e){const[t,n]=e.split("-").map(Number);return new Date(t,n-1,1).getDay()}function ms(e,t){const n=Li(t),i=Ii(t),[r,l]=t.split("-").map(Number),d=new Map;e.forEach(C=>{if(C.date.slice(0,7)===t){const $=C.date.slice(0,10);d.has($)||d.set($,[]),d.get($).push(C)}});const a=e.filter(C=>C.date.slice(0,7)===t),o=a.reduce((C,$)=>C+$.quantity,0),c=new Set(a.map(C=>C.date)).size,u=new Date().toISOString().slice(0,10),p=["日","月","火","水","木","金","土"].map(C=>`<th class="dcal-header">${C}</th>`).join("");let y="",h=1;for(let C=0;C<6&&!(h>n&&C>0);C++){y+="<tr>";for(let $=0;$<7;$++)if(C===0&&$<i||h>n)y+='<td class="dcal-cell dcal-empty"></td>';else{const P=`${r}-${String(l).padStart(2,"0")}-${String(h).padStart(2,"0")}`,I=d.get(P)||[],T=P===u,L=I.reduce((B,G)=>B+G.quantity,0);y+=`
          <td class="dcal-cell ${T?"dcal-today":""}">
            ...
            `:""}
          </td>`,h++}y+="</tr>"}const[f,k]=l===1?[r-1,12]:[r,l-1],[g,x]=l===12?[r+1,1]:[r,l+1],w=`${f}-${String(k).padStart(2,"0")}`,E=`${g}-${String(x).padStart(2,"0")}`;return`
    <section class="panel">
      <div class="panel-header">
        <div>
          <h2>納品カレンダー</h2>
  ...
  `}function Mi(e,t,n,i,r="month",l,d=[]){const a={success:"正常",warning:"注意",error:"異常",running:"実行中"},o=Ri(e.allDailySales,r,l),c=o.reduce(($,P)=>$+P.amount,0),u=o.reduce(($,P)=>$+P.bottles,0),p=o.reduce(($,P)=>$+P.volumeMl,0),y=o.length,h=u>0?Math.round(c/u):0,f=p>0?Math.round(c/(p/1e3)):0,g=(o.length>0?e.allDailySales.filter($=>{const P=o[0]?.date??"",I=o[o.length-1]?.date??"",T=Wt(P,-1),L=Wt(I,-1);return $.date>=T&&$.date<=L}):[]).reduce(($,P)=>$+P.amount,0),x=g>0?(c-g)/g*100:0,w=x>0?"+":"",E=e.salesRecords.slice(0,10).map($=>`
            <tr>
              <td class="mono">${$.documentNo}</td>
              <td>${ot($.date)}</td>
              <td>${$.customerName}</td>
              <td class="numeric">${W($.amount)}</td>
            </tr>
          `).join(""),C=["today","month","90days","year","all"].map($=>`<button class="button ${$===r?"primary":"secondary"} small" type="button" data-period="${$}">${Oe[$]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value" style="color:${x>=0?"#2f855a":"#c53d3d"}">${g>0?`${w}${x.toFixed(1)}%`:"―"}</p>
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
              ${q("date","日付",d)}
              ${q("amount","売上",d,"numeric")}
              ${q("bottles","本数",d,"numeric")}
              ${q("volumeMl","液体量(L)",d,"numeric")}
              ${q("pricePerBottle","本単価",d,"numeric")}
              ${q("pricePerLiter","L単価",d,"numeric")}
            </tr>
          </thead>
          <tbody>${Le(d.length>0?o:o.slice().reverse(),d,{date:"date",amount:"amount",bottles:"bottles",volumeMl:"volumeMl",pricePerBottle:"pricePerBottle",pricePerLiter:"pricePerLiter"}).slice(0,31).map($=>`
            <tr>
              ...
              <td class="numeric">${W($.pricePerBottle)}</td>
              <td class="numeric">${W($.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
...
`,"<br />")}function Ji(e){const n=[...Object.values(Ct),{id:"custom",season:"カスタム",subject:"",body:""}].map(r=>`
  ...
  `}function Yi(e,t){const n=[je("得意先",t.customers.map(r=>`
          <button
  ...
  `}function Me(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Zt(e){return e.trim().toLowerCase()}function Ui(e,t){const n=Zt(t),i=e.filter(l=>n?[l.code,l.name,l.name].map(Zt).some(d=>d.includes(n)):!0).slice(0,50),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      <div class="quote-preview-inner">
        ...
        <div class="quote-preview-meta">
          ...
          <div class="quote-preview-info">
            ${r.showQuoteNo&&e.quoteNo?`<p>No. ${N(e.quoteNo)}</p>`:""}
            <p>${e.quoteDate}</p>
        ...
        ${r.headerNote?`<p class="quote-preview-note">${N(r.headerNote)}</p>`:""}

        ${r.showSubject&&e.subject?`<p class="quote-preview-subject">件名: ${N(e.subject)}</p>`:""}
        ...
        ${r.footerNote?`<p class="quote-preview-footer-note">${N(r.footerNote)}</p>`:""}
      </div>
    </div>
        ...
        <table>
          <thead>
            <tr>
              ...
              ${q("name","商品名",d)}
              ${q("amount","売上",d,"numeric")}
              ${q("sharePct","構成比",d,"numeric")}
              ${q("qty","本数",d,"numeric")}
              ${q("growthRate","前年同期比",d,"numeric")}
            </tr>
          </thead>
          <tbody>
...
`);return`
  ...
  `}function _t(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function _o(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function wo(e){return e.map(t=>`
      ...
      `).join("")}function So(e,t,n=jt,i=[]){const{filtered:r,paged:l,totalPages:d}=go(e.customers,n);return`
    <section class="page-head">
      <div>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function Ae(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ro(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function Oo(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),n=Math.max(...t.map(p=>p.amount),1),i=28,r=6,l=140,d=100,a=760,o=a-l-d,c=t.length*(i+r)+16,u=t.map((p,y)=>{const h=p.amount/n*o,f=y*(i+r)+8,k=p.abcRank==="A"?"#2F855A":p.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
          ...
          <rect x="${l}" y="${f}" width="${h}" height="${i}" rx="4" fill="${k}" opacity="0.85" />
  ...
  `}function jo(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(i=>`<th class="numeric">${i}</th>`).join(""),n=e.monthlyByCustomer.map(i=>{const r=i.values.reduce((d,a)=>d+a,0),l=i.values.map(d=>`<td class="numeric">${d>0?(d/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${i.label}</td>
          ${l}
  ...
  `}function nt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Fo(e){return e.replace("-","/")}const la={all:"全期間",yearly:"年次",monthly:"月次",weekly:"週次",daily:"日次"};function Bo(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,i={top:16,right:24,bottom:36,left:64},r=t-i.left-i.right,l=n-i.top-i.bottom,d=Math.max(...e.map(u=>u.amount),1),a=r/e.length,o=[0,.25,.5,.75,1].map(u=>{const p=i.top+l-l*u,y=`${Math.round(d*u/1e4).toLocaleString("ja-JP")}万円`;return`
      ...
      `}).join(""),c=e.map((u,p)=>{const y=u.amount/d*l,h=Math.max(a-18,24),f=i.left+p*a+(a-h)/2,k=i.top+l-y;return`
        <g>
          <rect x="${f}" y="${k}" width="${h}" height="${y}" rx="6" class="analytics-bar" />
  ...
  `}function Jo(e,t,n="all",i="",r=[],l=[],d="",a="",o=null,c="all",u="",p=[],y=[]){const h=t==="products"?"商品別集計":t==="customers"?"得意先別集計":"担当別集計",f=t==="products"?e.productTotals:t==="customers"?e.customerTotals:e.staffTotals,k=n!=="all"&&r.length>0&&t!=="staff",g=["all","yearly","monthly","weekly","daily"].map(C=>`<button class="button ${C===n?"primary":"secondary"} small" type="button" data-analytics-period="${C}">${la[C]}</button>`).join(""),x=n!=="all"&&l.length>0&&t!=="staff"?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
        ${l.map(C=>`<option value="${C}" ${C===i?"selected":""}>${C}</option>`).join("")}
      </select>`:"";let w="",E="";if(t==="staff"){const C=["all","yearly","monthly","weekly","daily"].map(L=>`<button class="button ${L===c?"primary":"secondary"} small" type="button" data-staff-period="${L}">${la[L]}</button>`).join(""),$=c!=="all"&&p.length>0?`<select id="staff-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
          ${p.map(L=>`<option value="${L}" ${L===u?"selected":""}>${L}</option>`).join("")}
        </select>`:"",I=(y.length>0?y:e.staffTotals).filter(L=>!d||L.name.includes(d)||L.code.includes(d)),T=c!=="all"&&u?` (${u})`:"";if(w=`
      ...
      <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;align-items:center;">
        ...
        ${T?`<span style="font-size:12px;color:var(--text-secondary);">${T}</span>`:""}
      </div>
      <div class="table-wrap">
        <table>
          <thead>
    ...
    `,o){const L=o.breakdownTab,B=c!=="all"&&u?`<span style="font-size:12px;color:var(--text-secondary);margin-left:8px;">${u}</span>`:"";E=`
...
金井酒造店`;function cl(e,t){const n=t?e.find(r=>r.id===t):null,i=t==="__new__";return`
    ...
    ${n||i?`
      ...
      `:""}
  `}function dl(e,t,n,i){const[r,l]=t.split("-").map($=>parseInt($,10)),d=new Date(r,l-1,1),a=new Date(r,l,0),o=d.getDay(),c=a.getDate(),u=[];for(let $=0;$<o;$++)u.push({isOutside:!0});for(let $=1;$<=c;$++)u.push({date:new Date(r,l-1,$)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter($=>$.category===n):e,y={};p.forEach($=>{const P=$.startsAt.slice(0,10);y[P]??=[],y[P].push($)});const h=new Date().toISOString().slice(0,10),f=u.map($=>{if($.isOutside)return'<div class="cal-cell cal-outside"></div>';const P=$.date,I=`${P.getFullYear()}-${String(P.getMonth()+1).padStart(2,"0")}-${String(P.getDate()).padStart(2,"0")}`,T=y[I]??[],L=I===h,B=P.getDay();return`
        <div class="cal-cell ${L?"cal-today":""} ${B===0?"cal-sun":B===6?"cal-sat":""}"
             data-cal-date="${I}">
          <div class="cal-day-num">${P.getDate()}</div>
          <div class="cal-events">
            ${T.slice(0,3).map(G=>`
              <button class="cal-event" data-cal-event-id="${G.id}"
                      style="background:${G.color||Ot[G.category]||"#0F5B8D"};"
                      title="${G.title}">
            ...
            `).join("")}
            ${T.length>3?`<button class="cal-event-more" data-cal-date="${I}">+${T.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),k=i?.isOpen?ul(i):"",g=new Date(r,l-2,1),x=new Date(r,l,1),w=`${g.getFullYear()}-${String(g.getMonth()+1).padStart(2,"0")}`,E=`${x.getFullYear()}-${String(x.getMonth()+1).padStart(2,"0")}`,C=(()=>{const $=new Date;return`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(Rt).map(([$,P])=>`<option value="${$}" ${n===$?"selected":""}>${P}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
  ...
  `}const ya={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},Pl={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},Al={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function Y(e){return"¥"+e.toLocaleString("ja-JP")}function Ce(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function ws(e,t){const n=e.reduce((l,d)=>l+d.amount,0),i=Math.floor(n*t),r=n+i;return{subtotal:n,taxAmount:i,total:r}}const O={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function M(e,t){const n=e.align??"left",i=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${i}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function ut(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),i=n-2018;return{y:i>0?String(i).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function Dl(e,t,n){const i=ut(e.documentDate),r=ut(e.orderDate??e.documentDate),l=ut(e.deliveryDate??e.documentDate),d=e.lines.slice(0,6).map((g,x)=>{const w=O.detailStartY+x*O.detailRowH,E=O.detailCols,C=[],$=(P,I)=>{I&&C.push(M({...P,y:w,x:P.x+0},I))};return $(E.productName,g.productName+(g.spec?` ${g.spec}`:"")),$(E.productCode,g.productCode),$(E.color,g.color??""),$(E.size,[g.size,g.caseQty?`×${g.caseQty}`:""].filter(Boolean).join(" ")),$(E.unit,g.unit),$(E.quantity,g.quantity>0?g.quantity.toLocaleString("ja-JP"):""),$(E.correctedQty,g.correctedQuantity?g.correctedQuantity.toLocaleString("ja-JP"):""),$(E.discount,g.discount?g.discount.toLocaleString("ja-JP"):""),$(E.unitPrice,g.unitPrice>0?g.unitPrice.toLocaleString("ja-JP"):""),$(E.costAmount,g.amount>0?g.amount.toLocaleString("ja-JP"):""),$(E.retailPrice,g.retailPrice?g.retailPrice.toLocaleString("ja-JP"):""),$(E.note,g.receivedAmount?g.receivedAmount.toLocaleString("ja-JP"):""),C.join("")}).join(""),a=e.lines.reduce((g,x)=>g+(x.amount||0),0),o=e.lines.reduce((g,x)=>g+(x.retailPrice||0)*(x.correctedQuantity??x.quantity),0),c=e.lines.reduce((g,x)=>g+(x.receivedAmount||0),0),u=e.lines.reduce((g,x)=>g+(x.returnAmount||0),0),p=e.lines.reduce((g,x)=>g+x.quantity,0),y=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",h=n.calibrationOffsetX||0,f=n.calibrationOffsetY||0,k=`transform: translate(${h}mm, ${f}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${y}">
        ...
        ${M(O.orderDateM,r.m)}
        ${M(O.orderDateD,r.d)}
        ${M(O.deliveryDateY,l.y)}
        ${M(O.deliveryDateM,l.m)}
        ${M(O.deliveryDateD,l.d)}
  ...
  `}function El(e,t,n){const{subtotal:i,taxAmount:r,total:l}=ws(e.lines,e.taxRate),d=e.previousBalance??0,a=e.paymentAmount??0,o=d-a+l,c=e.lines.map(p=>`
    ...
    <div class="print-page invoice-freee ${n.fontSize}">
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${Y(o)}</span>
      ...
      <div class="freee-summary">
        ...
        <table class="freee-summary-table">
          ${d?`<tr><th>前回御請求額</th><td>${Y(d)}</td></tr>`:""}
          ${a?`<tr><th>ご入金額</th><td>▲ ${Y(a)}</td></tr>`:""}
          <tr><th>今回御請求 小計</th><td>${Y(i)}</td></tr>
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${Y(r)}</td></tr>
          <tr class="freee-sum-grand"><th>合計請求額</th><td>${Y(o)}</td></tr>
        </table>
      </div>
  ...
  `}function Cl(e,t,n){const{subtotal:i,taxAmount:r,total:l}=ws(e.lines,e.taxRate),d=e.lines.map(o=>`
      <tr>
        ...
        <td class="numeric">${Y(o.unitPrice)}</td>
        <td class="numeric">${Y(o.amount)}</td>
      </tr>
    ...
    <div class="print-page quotation-freee ${n.fontSize}">
      ...
      <div class="freee-summary">
        ...
        <table class="freee-summary-table">
          ...
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${Y(r)}</td></tr>
          <tr class="freee-sum-grand"><th>合計</th><td>${Y(l)}</td></tr>
        </table>
      </div>
...
`}async function Ol(e,t){const{supabaseInsert:n}=await _(async()=>{const{supabaseInsert:a}=await Promise.resolve().then(()=>j);return{supabaseInsert:a}},void 0);let i=0,r=0;const d={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const a of t){if(!a._valid)continue;const{_valid:o,_error:c,...u}=a,p={...u};if(!p.id){const y=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[y]??`${e}-${Date.now()}-${i+r}`)}for(const y of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[y]=="string"&&p[y]!==""){const h=Number(p[y]);Number.isFinite(h)&&(p[y]=h)}try{await n(d,p)!==null?i++:r++}catch{r++}}return{inserted:i,failed:r}}function pt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function jl(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Ml(e,t,n,i,r){const l=n.reduce((c,u)=>c+u.rowCount,0),d=n.map(c=>c.lastSyncAt).filter(c=>c!==null).sort().reverse()[0]??null,a=100,o=Math.max(1,Math.ceil(r/a));return`
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="mono" style="font-size:11px;max-width:300px;overflow:hidden;text-overflow:ellipsis;" title="${c._raw_b64?c._raw_b64.slice(0,200):""}">${jl(c._raw_b64)}</td>
            </tr>
            `).join("")}
          </tbody>
        </table>
    ...
    `}
  `}function z(e){return e.toLocaleString("ja-JP")}function mt(e){const[t,n]=e.split("-");return`${t.slice(2)}/${n}`}function Fl(e){return e>=.99?2.33:e>=.97?1.88:e>=.95?1.65:e>=.9?1.28:1.04}function Bl(e){const{months:t,matrix:n}=e;if(t.length===0||e.products.length===0)return'<div class="chart-empty">データなし</div>';const i=e.products.slice().sort((x,w)=>(e.productTotals[w.code]??0)-(e.productTotals[x.code]??0)).slice(0,6),r=["#0F5B8D","#2F855A","#B7791F","#C53D3D","#6B46C1","#2B6CB0"],l=820,d=280,a={top:20,right:20,bottom:40,left:60},o=l-a.left-a.right,c=d-a.top-a.bottom,u=t.map(x=>i.reduce((w,E)=>w+(n[E.code]?.[x]??0),0)),p=Math.max(...u,1),y=o/t.length,h=Math.max(y-10,14),f=[0,.25,.5,.75,1].map(x=>{const w=a.top+c-c*x,E=`${Math.round(p*x/100)*100}`;return`
      <line x1="${a.left}" y1="${w}" x2="${l-a.right}" y2="${w}" class="chart-grid" />
      <text x="6" y="${w+4}" class="chart-axis">${Number(E).toLocaleString("ja-JP")}</text>
    `}).join(""),k=t.map((x,w)=>{let E=a.top+c;const C=a.left+w*y+(y-h)/2,$=i.map((G,Vt)=>{const Jt=(n[G.code]?.[x]??0)/p*c;return E-=Jt,`<rect x="${C}" y="${E}" width="${h}" height="${Jt}" fill="${r[Vt%r.length]}" opacity="0.85" rx="${Vt===i.length-1?3:0}" />`}).join(""),[P,I]=x.split("-"),T=parseInt(I),L=T===1||w%3===0,B=T===1?`${P.slice(2)}年`:`${T}月`;return`<g>${$}${L?`<text x="${C+h/2}" y="${d-10}" class="chart-axis centered-axis">${B}</text>`:""}</g>`}).join(""),g=i.map((x,w)=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}const Yl={monthly:"月次",annual:"年次",make_to_order:"受注生産",november:"11月生産"};function Ul(e,t,n){const i={draft:"下書き",confirmed:"確定",actual:"実績入力済"},r={draft:"neutral",confirmed:"info",actual:"success"},l=$=>Object.entries(Yl).map(([P,I])=>`<option value="${P}" ${P===$?"selected":""}>${I}</option>`).join(""),d=640,o=($=>$.map(P=>{const I=Math.max(0,P.demandForecast+P.safetyStockTarget-P.openingStock),T=P.plannedQty>0?P.plannedQty:Math.round(I),L=T>0?Math.ceil(T/d*10)/10:0,B=P.plannedQty>0?(P.actualQty-P.plannedQty)/P.plannedQty*100:null,G=B!==null?B>=0?"text-success":"text-danger":"";return`
      <tr>
        <td style="white-space:nowrap;">${P.productName}</td>
        <td>
          <select class="input-sm" data-action="plan-prod-type" data-code="${P.productCode}"
            style="width:92px;">${l(P.productionType)}</select>
        </td>
    ...
    `}).join(""))(y),c=[{key:"all",label:"全て"},{key:"monthly",label:"月次"},{key:"annual",label:"年次"},{key:"november",label:"11月生産"},{key:"make_to_order",label:"受注生産"}],u=$=>{const I=($==="all"?e:e.filter(T=>T.productionType===$)).reduce((T,L)=>{const B=Math.max(0,L.demandForecast+L.safetyStockTarget-L.openingStock);return T+(L.plannedQty>0?L.plannedQty:Math.round(B))},0);return Math.ceil(I/d*10)/10},p=c.filter($=>$.key!=="all").map($=>{const P=u($.key),I=e.filter(L=>L.productionType===$.key).length,T=$.key==="make_to_order"?e.filter(L=>L.productionType==="make_to_order"&&L.plannedQty>0).length:null;return`
      <div style="background:var(--surface-alt);border-radius:8px;padding:12px 16px;min-width:130px;">
        ...
        <p style="font-size:11px;color:var(--text-secondary);margin:4px 0 0;">${I}商品${T!==null?` · 受注${T}件`:""}</p>
      </div>
    `}).join(""),y=n==="all"?e:e.filter($=>$.productionType===n),h=y.reduce(($,P)=>$+P.demandForecast,0),f=y.reduce(($,P)=>$+Math.max(0,P.demandForecast+P.safetyStockTarget-P.openingStock),0),k=y.reduce(($,P)=>$+P.plannedQty,0),g=y.reduce(($,P)=>$+P.actualQty,0),x=u(n),w=new Date,E=Array.from({length:24},($,P)=>{const I=new Date(w.getFullYear(),w.getMonth()-6+P,1),T=`${I.getFullYear()}-${String(I.getMonth()+1).padStart(2,"0")}`;return`<option value="${T}" ${T===t?"selected":""}>${T.replace("-","年")}月</option>`}).join(""),C=c.map($=>`<button class="button ${n===$.key?"primary":"secondary"}" type="button"
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${o||'<tr><td colspan="11" class="empty-row">データなし</td></tr>'}
            ${y.length>0?`
              <tr style="background:var(--surface-alt);font-weight:700;">
                ...
                <td class="numeric">${z(k)}</td>
                <td class="numeric">${g>0?z(g):"—"}</td>
                <td class="numeric">—</td>
                <td class="numeric">${x.toFixed(1)}<span style="font-size:11px;color:var(--text-secondary);margin-left:2px;">人日</span></td>
                <td>—</td>
              </tr>`:""}
          </tbody>
        </table>
  ...
  `}function Ql(e,t,n,i,r,l,d="all"){const o=[{key:"demand",label:"需要実績"},{key:"safety",label:"安全在庫"},{key:"plan",label:"生産計画"}].map(u=>`<button class="tab-button ${i===u.key?"active":""}"
       data-demand-tab="${u.key}">${u.label}</button>`).join("");let c="";return i==="demand"?c=e?Vl(e,l):'<section class="panel"><p>データを読み込んでいます…</p></section>':i==="safety"?c=Jl(t):c=Ul(n,r,d),`
    <section class="page-head">
      <div>
    ...
    ${c}
  `}function ha(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Hl(e,t){return Math.floor(Math.abs(t.getTime()-e.getTime())/(1e3*60*60*24))}function Gl(e){return e==="dormant"?"休眠":"離反リスク"}function Xl(e){return e==="dormant"?"warning":"danger"}function Kl(e,t){const n=new Date,i=new Date(n);i.setMonth(i.getMonth()-3);const r=new Date(n);r.setMonth(r.getMonth()-12);const l=new Date(n);l.setFullYear(l.getFullYear()-1);const d=new Date(l.getFullYear(),l.getMonth(),1),a=new Date(l.getFullYear(),l.getMonth()+1,0),o=new Date(n.getFullYear(),n.getMonth(),1),c=new Map(t.map(f=>[f.code,f])),u=new Map;for(const f of e){if(!f.legacy_customer_code)continue;const k=u.get(f.legacy_customer_code)||[];k.push(f),u.set(f.legacy_customer_code,k)}const p=[],y=[],h=new Set;for(const[f,k]of u.entries()){const g=c.get(f),x=g?.name||(k[0]?.customer_name??f);let w=null,E=0,C=!1,$=!1,P=!1,I=!1;for(const L of k){const B=new Date(L.sales_date);(!w||B>w)&&(w=B),B>=r&&($=!0,E+=L.total_amount),B>=i&&(C=!0),B>=d&&B<=a&&(P=!0),B>=o&&(I=!0)}if(!w)continue;const T={code:f,name:x,businessType:g?.businessType??"",areaCode:g?.areaCode??"",phone:g?.phone??"",lastOrderDate:w.toISOString().slice(0,10),daysSinceLastOrder:Hl(w,n),totalAmountLast12m:E,status:"dormant"};$&&!C&&(p.push({...T,status:"dormant"}),h.add(f)),P&&!I&&!h.has(f)&&y.push({...T,status:"at-risk"})}return p.sort((f,k)=>k.daysSinceLastOrder-f.daysSinceLastOrder),y.sort((f,k)=>k.totalAmountLast12m-f.totalAmountLast12m),{dormantCustomers:p,atRiskCustomers:y}}function Wl(e){const t=[...e.dormantCustomers,...e.atRiskCustomers],n=e.dormantCustomers.length,i=e.atRiskCustomers.length,r=e.dormantCustomers.reduce((u,p)=>u+p.totalAmountLast12m,0),l=t.map(u=>`
...
<div class="panel">
  ...
  </div>`}const lr=["日","月","火","水","木","金","土"];function rr(e){const[t,n]=e.split("-").map(Number),i=new Date(t,n-1,1),r=new Date(t,n,0),l=[];for(let d=0;d<i.getDay();d++)l.push({outside:!0});for(let d=1;d<=r.getDate();d++)l.push({date:`${e}-${String(d).padStart(2,"0")}`});for(;l.length%7!==0;)l.push({outside:!0});return l}function cr(e,t,n){const[i,r]=t.split("-").map(Number),l=new Date(i,r-2,1),d=new Date(i,r,1),a=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}`,o=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}`,c=new Date().toISOString().slice(0,10),p=rr(t).map(k=>{if(k.outside)return'<div class="sc-cell sc-outside"></div>';const g=k.date,x=Number(g.split("-")[2]),w=new Date(`${g}T00:00:00`).getDay(),E=e?.[g],C=g===c,$=g===n;let P="",I="";return E&&(P=`<span class="sc-badge">${E.count}件</span>`,I=E.cityGroups.slice(0,3).map(T=>`<span class="sc-city-tag">${T.city}<em>${T.count}</em></span>`).join(""),E.cityGroups.length>3&&(I+=`<span class="sc-city-more">+${E.cityGroups.length-3}</span>`)),`
      <div class="sc-cell ${C?"sc-today":""} ${$?"sc-selected":""} ${E?"sc-has-data":""}"
           data-sc-date="${g}">
        <div class="sc-day-header">
          <span class="sc-day-num ${w===0?"sc-sun":w===6?"sc-sat":""}">${x}</span>
          ${P}
        </div>
        <div class="sc-cities">${I}</div>
      </div>
    `}).join(""),y=n&&e?.[n]?dr(e[n]):n?`<div class="sc-detail-empty"><p>📦 ${n.slice(5)} は出荷なし</p></div>`:'<div class="sc-detail-empty"><p>日付を選択すると出荷先一覧が表示されます</p></div>',h=Object.values(e??{}).reduce((k,g)=>k+g.count,0),f=Object.values(e??{}).reduce((k,g)=>k+g.totalAmount,0);return`
      ...
      <div class="sc-body">
        <div class="sc-calendar-col">
          <div class="sc-weekdays">
            ${lr.map((k,g)=>`<div class="sc-weekday ${g===0?"sc-sun":g===6?"sc-sat":""}">${k}</div>`).join("")}
          </div>
          <div class="sc-grid">
