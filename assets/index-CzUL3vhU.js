...
`),s=e.deductions.map(n=>`    <Deduction type="${ye(n.type)}">
      <CategoryCode>${ye(n.categoryCode)}</CategoryCode>
      <Volume>${n.volume}</Volume>
      <Reason>${ye(n.reason)}</Reason>${n.documentNo?`
      <DocumentNo>${ye(n.documentNo)}</DocumentNo>`:""}
    </Deduction>`).join(`
...
<TaxDeclaration>
  <Header>
    ...
    <TaxpayerId>${ye(e.companyNo)}</TaxpayerId>
    <TaxpayerName>${ye(e.companyName)}</TaxpayerName>
    <TaxpayerAddress>${ye(e.companyAddress)}</TaxpayerAddress>
    <TaxpayerRepresentative>${ye(e.companyRepresentative)}</TaxpayerRepresentative>
    <TaxOffice>${ye(e.taxOffice)}</TaxOffice>
...
`}function Mo(e){const t=e.rows.map(i=>{const r=Math.max(0,i.productionVolume+i.previousBalance+i.currentAdjustment-i.exportDeduction-i.sampleDeduction),c=Math.round(r*i.taxRate);return{...i,taxableVolume:r,volume:r,taxAmount:c}}),s=t.reduce((i,r)=>i+r.taxableVolume,0),n=t.reduce((i,r)=>i+r.taxAmount,0);return{...e,rows:t,totalVolume:s,totalTax:n}}async function Ro(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>B);return{supabaseInsert:s}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:Ks(e),submitted_at:e.submittedAt})}async function ka(e){const t=await N("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(s=>({id:h(s,["id"],""),saleDate:h(s,["sale_date"],e),saleTime:h(s,["sale_time"],""),productCode:h(s,["product_code"],""),productName:h(s,["product_name"],""),quantity:P(s,["quantity"],0),unitPrice:P(s,["unit_price"],0),amount:P(s,["amount"],0),paymentMethod:h(s,["payment_method"],"cash")})):[]}async function Ws(){const e=await N("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:h(t,["id"],""),orderNo:h(t,["order_no"],""),orderDate:Z(t,["order_date"],""),customerName:h(t,["customer_name"],""),postalCode:h(t,["postal_code"],""),address:h(t,["shipping_address"],""),items:[],totalAmount:P(t,["total_amount"],0),status:h(t,["status"],"new"),shippingDate:Z(t,["shipping_date"],"")})):[]}async function _t(e){const t=await Lt("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function Zs(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function Oo(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await N("print_layouts",t)).map(n=>({id:h(n,["id"],""),name:h(n,["name"],""),templateKey:h(n,["template_key"],""),positions:n.positions??{},isDefault:te(n,["is_default"],!1),note:h(n,["note"],""),updatedAt:h(n,["updated_at"],"")}))}async function jo(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>B);return{supabaseInsert:i}},void 0),s={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},n=await t("print_layouts",s);return n?{id:h(n,["id"],e.id),name:h(n,["name"],e.name),templateKey:h(n,["template_key"],e.templateKey),positions:n.positions??e.positions,isDefault:te(n,["is_default"],!1),note:h(n,["note"],""),updatedAt:h(n,["updated_at"],"")}:null}async function Fo(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const s="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:s,Authorization:`Bearer ${s}`}})).ok}catch{return!1}}async function zo(){return(await N("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),email:h(t,["email"],""),displayName:h(t,["display_name"],""),signature:h(t,["signature"],""),replyTo:h(t,["reply_to"],""),isDefault:te(t,["is_default"],!1),isVerified:te(t,["is_verified"],!1),note:h(t,["note"],"")}))}async function Bo(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0),s=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return s?{id:h(s,["id"],e.id),name:h(s,["name"],e.name),email:h(s,["email"],e.email),displayName:h(s,["display_name"],""),signature:h(s,["signature"],""),replyTo:h(s,["reply_to"],""),isDefault:te(s,["is_default"],!1),isVerified:te(s,["is_verified"],!1)}:null}async function Vo(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const Pa={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},Aa={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Jo(e){const t=`${e}-01T00:00:00Z`,[s,n]=e.split("-").map(p=>parseInt(p,10)),i=new Date(s,n,0).getDate(),r=`${e}-${String(i).padStart(2,"0")}T23:59:59Z`;return(await N("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${r})`,order:"starts_at.asc"})).map(p=>({id:h(p,["id"],""),title:h(p,["title"],""),description:h(p,["description"],""),category:h(p,["category"],"general")||"general",startsAt:h(p,["starts_at"],new Date().toISOString()),endsAt:h(p,["ends_at"],""),isAllDay:te(p,["is_all_day"],!1),location:h(p,["location"],""),attendees:p.attendees??[],relatedCustomerCode:h(p,["related_customer_code"],""),relatedOrderId:h(p,["related_order_id"],""),color:h(p,["color"],""),googleEventId:h(p,["google_event_id"],"")}))}async function Yo(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??Aa[e.category],updated_at:new Date().toISOString()})?e:null}async function Uo(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function en(){return(await N("integration_settings",{order:"name.asc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),provider:h(t,["provider"],""),config:t.config??{},isEnabled:te(t,["is_enabled"],!1),lastSyncAt:h(t,["last_sync_at"],""),lastStatus:h(t,["last_status"],"")}))}async function rt(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function Qo(e){const t=e.config.shop_domain,s=e.config.admin_token;if(!t||!s)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const n=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,i=await fetch(n,{headers:{"X-Shopify-Access-Token":s,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const r=await i.json(),{supabaseInsert:c}=await E(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>B);return{supabaseInsert:u}},void 0);let p=0;for(const u of r.orders){const y=`shopify_${u.id}`;await c("shopify_orders",{id:y,shopify_order_id:String(u.id),order_number:String(u.order_number??""),order_date:String(u.created_at??new Date().toISOString()),customer_name:String(u.customer?.first_name??"")+" "+String(u.customer?.last_name??""),customer_email:String(u.customer?.email??""),total_amount:Math.round(parseFloat(String(u.total_price??"0"))),financial_status:String(u.financial_status??""),fulfillment_status:String(u.fulfillment_status??"unfulfilled"),line_items:u.line_items??[],shipping_address:u.shipping_address??null,raw_payload:u}),p++}return await rt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得成功`}),{count:p}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function Ho(){return(await N("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:h(t,["id"],""),shopifyOrderId:h(t,["shopify_order_id"],""),orderNumber:h(t,["order_number"],""),orderDate:h(t,["order_date"],""),customerName:h(t,["customer_name"],""),customerEmail:h(t,["customer_email"],""),totalAmount:Y(t.total_amount),financialStatus:h(t,["financial_status"],""),fulfillmentStatus:h(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function Go(e){const t=e.config.refresh_token,s=e.config.client_id,n=e.config.client_secret;if(!t||!s||!n)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:s,client_secret:n})});if(!i.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${i.status}`};const c=(await i.json()).access_token;return await rt({...e,config:{...e.config,oauth_token:c}}),e.config.oauth_token=c,{token:c}}async function Xo(e){let t=e.config.oauth_token;const s=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const n=new Date().toISOString(),i=new Date(Date.now()+30*86400*1e3).toISOString(),r=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(s)}/events?timeMin=${n}&timeMax=${i}&singleEvents=true&orderBy=startTime`;let c=await fetch(r,{headers:{Authorization:`Bearer ${t}`}});if(c.status===401){const f=await Go(e);if(f.error)return{count:0,error:f.error};t=f.token,c=await fetch(r,{headers:{Authorization:`Bearer ${t}`}})}if(!c.ok)return{count:0,error:`HTTP ${c.status}`};const p=await c.json(),{supabaseInsert:u}=await E(async()=>{const{supabaseInsert:f}=await Promise.resolve().then(()=>B);return{supabaseInsert:f}},void 0);let y=0;for(const f of p.items){const v=`gcal_${f.id}`,b=f.start?.dateTime??f.start?.date??"",x=f.end?.dateTime??f.end?.date??"";await u("calendar_events",{id:v,title:String(f.summary??"(無題)"),description:String(f.description??""),category:"general",starts_at:String(b),ends_at:String(x),location:String(f.location??""),google_event_id:String(f.id??""),updated_at:new Date().toISOString()}),y++}return await rt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${y}件取得`}),{count:y}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function Ko(){return(await N("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:h(t,["id"],""),receivedAt:h(t,["received_at"],""),senderPhone:h(t,["sender_phone"],""),senderName:h(t,["sender_name"],""),imageUrl:h(t,["image_url"],""),ocrStatus:h(t,["ocr_status"],"pending")||"pending",ocrText:h(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:h(t,["linked_invoice_id"],"")}))}async function Wo(e,t){const s=e.config.api_key;if(!s)return{text:"",error:"Cloud Vision API key 未設定"};try{const n=`https://vision.googleapis.com/v1/images:annotate?key=${s}`,i=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return i.ok?{text:(await i.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${i.status}`}}catch(n){return{text:"",error:n instanceof Error?n.message:String(n)}}}async function Zo(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const kt={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Pt={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function ei(){return(await N("user_profiles",{order:"display_name.asc"})).map(t=>({id:h(t,["id"],""),email:h(t,["email"],""),displayName:h(t,["display_name"],""),staffCode:h(t,["staff_code"],""),department:h(t,["department"],"all")||"all",role:h(t,["role"],"staff")||"staff",defaultMailSenderId:h(t,["default_mail_sender_id"],""),phone:h(t,["phone"],""),avatarUrl:h(t,["avatar_url"],""),isActive:te(t,["is_active"],!0),lastSignInAt:h(t,["last_sign_in_at"],""),createdAt:h(t,["created_at"],"")}))}async function ti(e){if(!e)return null;const t=await N("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const s=t[0];return{id:h(s,["id"],""),email:h(s,["email"],""),displayName:h(s,["display_name"],""),staffCode:h(s,["staff_code"],""),department:h(s,["department"],"all")||"all",role:h(s,["role"],"staff")||"staff",defaultMailSenderId:h(s,["default_mail_sender_id"],""),phone:h(s,["phone"],""),avatarUrl:h(s,["avatar_url"],""),isActive:te(s,["is_active"],!0),lastSignInAt:h(s,["last_sign_in_at"],"")}}async function ai(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function si(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ni(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>B);return{supabaseInsert:s}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function oi(e=100){return(await N("audit_logs",{order:"created_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),action:h(s,["action"],""),entityType:h(s,["entity_type"],""),entityId:h(s,["entity_id"],""),userEmail:h(s,["user_email"],""),changes:s.changes??{},createdAt:h(s,["created_at"],"")}))}const At={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function tn(){return(await N("slack_notifications",{order:"event_type.asc"})).map(t=>({id:h(t,["id"],""),eventType:h(t,["event_type"],"new_order"),enabled:te(t,["enabled"],!0),channel:h(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:h(t,["last_triggered_at"],"")}))}async function ii(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function ri(e=50){return(await N("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),eventType:h(s,["event_type"],""),channel:h(s,["channel"],""),message:h(s,["message"],""),status:h(s,["status"],"sent"),error:h(s,["error"],""),sentAt:h(s,["sent_at"],"")}))}async function li(e,t,s){const i=(await en()).find(y=>y.provider==="slack");if(!i||!i.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const r=i.config.webhook_url;if(!r)return{ok:!1,error:"Webhook URL未設定"};const p=(await tn()).find(y=>y.eventType===e&&y.enabled);if(!p)return{ok:!1,error:"通知ルールが無効"};const u=s??p.channel??i.config.default_channel??"#general";try{const y=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${At[e]} ${t}`,channel:u})}),f=y.ok,{supabaseInsert:v}=await E(async()=>{const{supabaseInsert:b}=await Promise.resolve().then(()=>B);return{supabaseInsert:b}},void 0);return await v("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:u,message:t,status:f?"sent":"failed",error:f?null:`HTTP ${y.status}`}),f?{ok:!0}:{ok:!1,error:`HTTP ${y.status}`}}catch(y){return{ok:!1,error:y instanceof Error?y.message:String(y)}}}const It={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Ca={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function ci(){return(await N("prospects",{order:"updated_at.desc"})).map(t=>({id:h(t,["id"],""),companyName:h(t,["company_name"],""),contactName:h(t,["contact_name"],""),email:h(t,["email"],""),phone:h(t,["phone"],""),address:h(t,["address"],""),website:h(t,["website"],""),businessType:h(t,["business_type"],""),stage:h(t,["stage"],"cold"),source:h(t,["source"],""),expectedAmount:Y(t.expected_amount),probability:Y(t.probability),assignedStaffCode:h(t,["assigned_staff_code"],""),nextActionDate:h(t,["next_action_date"],""),nextAction:h(t,["next_action"],""),note:h(t,["note"],""),lastContactAt:h(t,["last_contact_at"],""),wonAt:h(t,["won_at"],""),lostAt:h(t,["lost_at"],""),lostReason:h(t,["lost_reason"],""),convertedCustomerCode:h(t,["converted_customer_code"],""),createdAt:h(t,["created_at"],"")}))}async function an(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function di(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ui(e){return(await N("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(s=>({id:h(s,["id"],""),prospectId:h(s,["prospect_id"],""),activityType:h(s,["activity_type"],"call"),title:h(s,["title"],""),description:h(s,["description"],""),activityDate:h(s,["activity_date"],""),result:h(s,["result"],""),staffCode:h(s,["staff_code"],"")}))}async function pi(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const sn=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function mi(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function yi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function hi(){return(await ee("v_customer_map")).filter(t=>t.lat&&t.lng).map(t=>({customerCode:h(t,["customer_code"],""),name:h(t,["name"],""),phone:h(t,["phone"],""),areaCode:h(t,["area_code"],""),businessType:h(t,["business_type"],""),businessTypeName:h(t,["business_type_name"],""),address1:h(t,["address1"],""),lat:Number(t.lat),lng:Number(t.lng),isAtRisk:te(t,["is_at_risk"],!1),isDormant:te(t,["is_dormant"],!1),amount12m:P(t,["amount_12m"],0),daysSinceOrder:t.days_since_order!=null?Number(t.days_since_order):null}))}const Tt=[{value:"price",label:"価格が高い"},{value:"competitor",label:"競合に切り替え"},{value:"closed",label:"廃業・閉店"},{value:"contact",label:"担当者交代"},{value:"seasonal",label:"季節要因"},{value:"pause",label:"一時的な休止"},{value:"complaint",label:"クレーム・不満"},{value:"unreachable",label:"連絡が取れない"},{value:"other",label:"その他"}];async function fi(){return(await ee("customer_churn_notes")).map(t=>({customerCode:h(t,["customer_code"],""),reason:h(t,["reason"],""),memo:h(t,["memo"],""),actionedAt:t.actioned_at?String(t.actioned_at):null,updatedAt:h(t,["updated_at"],"")}))}async function vi(e){const{supabaseUpsert:t}=await E(async()=>{const{supabaseUpsert:s}=await Promise.resolve().then(()=>B);return{supabaseUpsert:s}},void 0);await t("customer_churn_notes",{customer_code:e.customerCode,reason:e.reason,memo:e.memo,actioned_at:e.actionedAt||null,updated_at:new Date().toISOString()},"customer_code")}async function gi(){return(await N("delivery_locations",{order:"name.asc"})).map(t=>({id:h(t,["id"],""),customerCode:h(t,["customer_code"],""),name:h(t,["name"],""),postalCode:h(t,["postal_code"],""),address:h(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:h(t,["contact_name"],""),phone:h(t,["phone"],""),deliveryNote:h(t,["delivery_note"],""),isActive:te(t,["is_active"],!0)}))}async function bi(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function $i(e=50){return(await N("call_logs",{order:"started_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),callDirection:h(s,["call_direction"],"inbound"),fromNumber:h(s,["from_number"],""),toNumber:h(s,["to_number"],""),matchedCustomerCode:h(s,["matched_customer_code"],""),matchedProspectId:h(s,["matched_prospect_id"],""),durationSeconds:Y(s.duration_seconds),callStatus:h(s,["call_status"],"answered"),recordingUrl:h(s,["recording_url"],""),transcript:h(s,["transcript"],""),ivryCallId:h(s,["ivry_call_id"],""),startedAt:h(s,["started_at"],""),endedAt:h(s,["ended_at"],""),notes:h(s,["notes"],"")}))}async function nn(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function _i(e){const t=e.config.api_key,s=e.config.team_id;if(!t||!s)return{count:0,error:"IVRy API key または team_id 未設定"};try{const n=`https://api.ivry.jp/v1/teams/${s}/calls?limit=100`,i=await fetch(n,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const c=(await i.json()).calls??[];let p=0;for(const u of c)await nn({id:`ivry_${u.id}`,callDirection:String(u.direction??"inbound"),fromNumber:String(u.from??""),toNumber:String(u.to??""),durationSeconds:Number(u.duration??0),callStatus:String(u.status??"answered"),recordingUrl:String(u.recording_url??""),startedAt:String(u.started_at??""),endedAt:String(u.ended_at??""),ivryCallId:String(u.id??"")}),p++;return await rt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得`}),{count:p}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function wi(e,t){const s=e.config.api_key,n=e.config.team_id;if(!s||!n)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let i=0;for(const r of t){if(!r.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${n}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({name:r.name,phone_number:r.phone,external_id:r.customerCode??"",note:r.note??""})})).ok&&i++}return{synced:i}}catch(i){return{synced:0,error:i instanceof Error?i.message:String(i)}}}async function xi(){return(await N("lead_lists",{order:"created_at.desc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),query:h(t,["query"],""),area:h(t,["area"],""),businessType:h(t,["business_type"],""),totalCount:Y(t.total_count),source:h(t,["source"],"manual"),createdAt:h(t,["created_at"],"")}))}async function Si(e){return(await N("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(s=>({id:h(s,["id"],""),listId:h(s,["list_id"],""),companyName:h(s,["company_name"],""),address:h(s,["address"],""),phone:h(s,["phone"],""),website:h(s,["website"],""),email:h(s,["email"],""),businessType:h(s,["business_type"],""),rating:s.rating?Number(s.rating):void 0,reviewCount:Y(s.review_count),lat:s.lat?Number(s.lat):void 0,lng:s.lng?Number(s.lng):void 0,placeId:h(s,["place_id"],""),status:h(s,["status"],"new"),convertedProspectId:h(s,["converted_prospect_id"],""),note:h(s,["note"],"")}))}async function ki(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function on(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function Pi(e,t,s){const n=e.config.api_key;if(!n)return{results:[],error:"Google Maps API key 未設定"};const i=`${t} ${s}`.trim(),r=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(i)}&language=ja&key=${n}`;try{const c=await fetch(r);if(!c.ok)return{results:[],error:`HTTP ${c.status}`};const p=await c.json();return p.status!=="OK"&&p.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${p.status}`}:{results:p.results.map(y=>{const f=y.geometry?.location;return{id:`place_${y.place_id}`,listId:"",companyName:String(y.name??""),address:String(y.formatted_address??""),rating:y.rating?Number(y.rating):void 0,reviewCount:y.user_ratings_total?Number(y.user_ratings_total):void 0,lat:f?.lat,lng:f?.lng,placeId:String(y.place_id??""),status:"new"}})}}catch(c){return{results:[],error:c instanceof Error?c.message:String(c)}}}async function Ai(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},s=await an(t);return s&&await on({...e,status:"imported",convertedProspectId:t.id}),s}async function Ci(){return(await N("workflow_orders",{order:"order_date.desc"})).map(t=>({id:h(t,["id"],""),orderNo:h(t,["order_no"],""),customerName:h(t,["customer_name"],""),customerCode:h(t,["customer_code"],""),orderDate:h(t,["order_date"],""),deliveryDate:h(t,["delivery_date"],""),stage:h(t,["stage"],"new"),totalAmount:Y(t.total_amount),itemCount:Y(t.item_count),priority:h(t,["priority"],"normal"),staffName:h(t,["staff_name"],""),notes:h(t,["notes"],"")}))}async function Ei(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function Li(){return(await N("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),email:h(t,["email"],""),phone:h(t,["phone"],""),visitDate:h(t,["visit_date"],""),partySize:Y(t.party_size)||1,language:h(t,["language"],"ja"),purpose:h(t,["purpose"],""),message:h(t,["message"],""),status:h(t,["status"],"new"),repliedAt:h(t,["replied_at"],""),confirmedTime:h(t,["confirmed_time"],""),createdAt:h(t,["created_at"],new Date().toISOString())}))}async function Di(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const qi=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function rn(){return(await Promise.all(qi.map(async t=>{const[s,n]=await Promise.all([ha(t.table),N(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:s,lastSyncAt:n[0]?._synced_at??null}}))).sort((t,s)=>s.rowCount-t.rowCount)}async function wt(e,t,s=100){const n=(t-1)*s,[i,r]=await Promise.all([N(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(s),offset:String(n)}),ha(e)]);return{records:i,total:r}}async function ea(e){const t=await N("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const s=t[0].memo;if(typeof s=="string"&&s)try{const n=JSON.parse(s);return String(n.price_group??"")}catch{return""}return""}async function ln(e,t){if(e){const n=await N("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(n.length>0&&n[0].special_price)return Y(n[0].special_price)}const s=await N("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return s.length>0&&s[0].default_sale_price?Y(s[0].default_sale_price):0}const Ii=[{code:"SAK001",name:"純米大吟醸　金井"},{code:"SAK002",name:"純米吟醸　金井"},{code:"SAK003",name:"本醸造　金井"},{code:"SAK004",name:"純米酒　金井"}],Ti=[1.6,.7,1.3,1.2,.9,.7,.6,.7,.9,1,1.1,1.5],Ni={SAK001:80,SAK002:150,SAK003:220,SAK004:180};function Mi(){const e=new Date,t=[];for(let u=11;u>=0;u--){const y=new Date(e.getFullYear(),e.getMonth()-u,1);t.push(`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`)}const s=Ii,n={},i={};for(const u of s){n[u.code]={};for(const y of t){const f=parseInt(y.split("-")[1])-1,v=Ni[u.code]??100,b=Math.round(v*Ti[f]*(.85+Math.random()*.3));n[u.code][y]=b,i[y]=(i[y]??0)+b}}const r={},c={},p={};for(const u of s){const y=t.map(b=>n[u.code][b]??0),f=y.reduce((b,x)=>b+x,0)/y.length,v=y.reduce((b,x)=>b+(x-f)**2,0)/y.length;r[u.code]=y.reduce((b,x)=>b+x,0),c[u.code]=f,p[u.code]=Math.sqrt(v)}return{months:t,products:s,matrix:n,totals:i,productTotals:r,productAvg:c,productStdDev:p}}async function Ri(e=36){const t=(()=>{const b=new Date;return b.setMonth(b.getMonth()-e),`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}`})(),s=await ee("product_monthly_sales",{select:"year_month,product_code,product_name,quantity",year_month:`gte.${t}`,order:"year_month.asc"});if(s.length===0)return Mi();const n=new Set,i=new Map,r={},c={};for(const b of s){const x=h(b,["year_month"],""),k=h(b,["product_code"],""),o=h(b,["product_name"],k),l=P(b,["quantity"],0);!x||!k||(n.add(x),i.set(k,o),r[k]||(r[k]={}),r[k][x]=l,c[x]=(c[x]??0)+l)}const p=[...n].sort(),u=[...i.entries()].map(([b,x])=>({code:b,name:x})),y={},f={},v={};for(const b of u){const x=p.map(l=>r[b.code]?.[l]??0),k=x.reduce((l,d)=>l+d,0)/(x.length||1),o=x.reduce((l,d)=>l+(d-k)**2,0)/(x.length||1);y[b.code]=x.reduce((l,d)=>l+d,0),f[b.code]=k,v[b.code]=Math.sqrt(o)}return{months:p,products:u,matrix:r,totals:c,productTotals:y,productAvg:f,productStdDev:v}}async function Oi(){return(await N("product_safety_stock_params",{order:"product_code.asc"})).map(t=>({productCode:h(t,["product_code"],""),productName:h(t,["product_name"],""),unit:h(t,["unit"],"本"),avgMonthlyDemand:P(t,["avg_monthly_demand"],0),demandStdDev:P(t,["demand_std_dev"],0),leadTimeDays:P(t,["lead_time_days"],30),serviceLevel:P(t,["service_level"],.95),safetyStockQty:P(t,["safety_stock_qty"],0),reorderPoint:P(t,["reorder_point"],0),memo:h(t,["memo"],""),productionType:h(t,["production_type"],"monthly")}))}async function ji(e){return(await N("production_plan",{year_month:`eq.${e}`,order:"product_code.asc"})).map(s=>({id:h(s,["id"],""),yearMonth:h(s,["year_month"],e),productCode:h(s,["product_code"],""),productName:h(s,["product_name"],""),demandForecast:P(s,["demand_forecast"],0),safetyStockTarget:P(s,["safety_stock_target"],0),openingStock:P(s,["opening_stock"],0),requiredProduction:P(s,["required_production"],0),plannedQty:P(s,["planned_qty"],0),actualQty:P(s,["actual_qty"],0),status:h(s,["status"],"draft"),productionType:h(s,["production_type"],"monthly"),notes:h(s,["notes"],"")}))}async function Fi(e){const{SUPABASE_URL:t,SUPABASE_ANON_KEY:s}=await E(async()=>{const{SUPABASE_URL:n,SUPABASE_ANON_KEY:i}=await Promise.resolve().then(()=>B);return{SUPABASE_URL:n,SUPABASE_ANON_KEY:i}},void 0);if(!s||e.length===0)return!1;try{const n=e.map(c=>({product_code:c.productCode,product_name:c.productName,unit:c.unit,avg_monthly_demand:c.avgMonthlyDemand,demand_std_dev:c.demandStdDev,lead_time_days:c.leadTimeDays,service_level:c.serviceLevel,safety_stock_qty:c.safetyStockQty,reorder_point:c.reorderPoint,production_type:c.productionType,memo:c.memo,last_calc_at:new Date().toISOString(),updated_at:new Date().toISOString()})),i=new URL("/rest/v1/product_safety_stock_params",t),r=await fetch(i.toString(),{method:"POST",headers:{apikey:s,Authorization:`Bearer ${s}`,"Content-Type":"application/json",Prefer:"return=minimal,resolution=merge-duplicates"},body:JSON.stringify(n)});if(!r.ok){const c=await r.text();return console.error("saveSafetyStockParamsBulk failed:",r.status,c),!1}return!0}catch(n){return console.error("saveSafetyStockParamsBulk error:",n),!1}}async function zi(e){const{supabaseUpsert:t}=await E(async()=>{const{supabaseUpsert:n}=await Promise.resolve().then(()=>B);return{supabaseUpsert:n}},void 0);return await t("production_plan",{...e.id?{id:e.id}:{},year_month:e.yearMonth,product_code:e.productCode,product_name:e.productName,demand_forecast:e.demandForecast,safety_stock_target:e.safetyStockTarget,opening_stock:e.openingStock,required_production:e.requiredProduction,planned_qty:e.plannedQty,actual_qty:e.actualQty,status:e.status,production_type:e.productionType,notes:e.notes,updated_at:new Date().toISOString()})!==null}function Bi(e){if(!e)return"不明";const t=e.replace(/^.+?[都道府県]/,""),s=t.match(/^(.+?郡.+?[町村]|.+?[市区町村])/);return s?s[1]:t.substring(0,6)}async function Vi(e){const[t,s]=e.split("-").map(Number),n=`${e}-01`,i=new Date(t,s,0).getDate(),r=`${e}-${String(i).padStart(2,"0")}`,c=await ee("sales_document_headers",{select:"sales_date,customer_name,legacy_customer_code,total_amount",and:`(sales_date.gte.${n},sales_date.lte.${r})`,order:"sales_date.asc"}),p=await ee("customers",{select:"id,address1",address1:"not.is.null"}),u={};for(const f of p)f.address1&&(u[f.id]=Bi(f.address1));const y={};for(const f of c){const v=f.sales_date;if(!v)continue;const b=u[f.legacy_customer_code]||"住所未登録",x=Number(f.total_amount)||0;y[v]||(y[v]={date:v,entries:[],cityGroups:[],totalAmount:0,count:0}),y[v].entries.push({customerCode:f.legacy_customer_code||"",customerName:f.customer_name||"",city:b,amount:x}),y[v].totalAmount+=x,y[v].count++}for(const f of Object.values(y)){const v={};for(const b of f.entries)v[b.city]=(v[b.city]||0)+1;f.cityGroups=Object.entries(v).sort((b,x)=>x[1]-b[1]).map(([b,x])=>({city:b,count:x}))}return y}async function Ea(){return N("quotes",{select:"id,quote_no,quote_date,valid_until,customer_name,subject,total_amount,template_type,status,created_at",order:"quote_date.desc,created_at.desc",limit:"200"})}async function cn(e){const t=await N("quotes",{select:"*",id:`eq.${e}`});if(!t[0])return null;const s=await N("quote_lines",{select:"*",quote_id:`eq.${e}`,order:"line_no.asc"});return{...t[0],lines:s}}async function Ji(){const e=new Date().toISOString().slice(0,7)+"-01";return ee("sales_document_headers",{select:"legacy_document_no,sales_date,customer_name,legacy_customer_code,total_amount",sales_date:`gte.${e}`,order:"sales_date.asc"})}const q=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:Aa,CALENDAR_CATEGORY_LABELS:Pa,CHURN_REASONS:Tt,DEPT_LABELS:Pt,INVOICE_TYPE_LABELS:Xt,JIKOMI_STATUS_LABELS:Bs,MATERIAL_CATEGORIES:sn,PROSPECT_STAGE_COLORS:Ca,PROSPECT_STAGE_LABELS:It,ROLE_LABELS:kt,SEASONAL_TEMPLATES:va,SLACK_EVENT_LABELS:At,TAX_DEDUCTION_LABELS:Zt,TAX_RATE_CATEGORIES:Xs,convertLeadToProspect:Ai,deleteCalendarEvent:Uo,deleteMailSender:Vo,deleteMaterial:yi,deletePrintLayout:Fo,deleteProspect:di,deleteUserProfile:si,fetchAnalyticsByPeriod:oo,fetchAnnouncements:Ns,fetchAuditLogs:oi,fetchAvailablePeriods:io,fetchBillList:Hs,fetchBillingSummary:wa,fetchBrewingMonthlyTrend:vo,fetchBrewingPlanSummary:fo,fetchBrewingProductDetail:go,fetchBrewingSchedule:bo,fetchCalendarEvents:Jo,fetchCallLogs:$i,fetchChurnAlerts:Ao,fetchChurnNotes:fi,fetchCustomerAnalysis:zs,fetchCustomerEfficiency:Fs,fetchCustomerLedger:ba,fetchCustomerPriceGroup:ea,fetchCustomerPricing:Kt,fetchCustomerProductBreakdown:mo,fetchDeliveryLocations:gi,fetchDeliveryNote:_a,fetchDeliverySchedule:Po,fetchDemandAnalysis:Ri,fetchDemandForecasts:ko,fetchEntityMonthlySales:ho,fetchFaxInbox:Ko,fetchIntegrationSettings:en,fetchInvoices:ot,fetchJikomiList:Vs,fetchKenteiList:Ys,fetchLeadItems:Si,fetchLeadLists:xi,fetchMailSenders:zo,fetchMapCustomers:hi,fetchMasterStats:ga,fetchMaterialList:Wt,fetchMyProfile:ti,fetchOrderHeaders:Ji,fetchPayableList:Qs,fetchPaymentStatus:Es,fetchPeriodChartData:uo,fetchPipelineMeta:Ls,fetchPrintLayouts:Oo,fetchProductABC:qo,fetchProductCustomerBreakdown:yo,fetchProductDaily:Do,fetchProductMonthlyShipments:So,fetchProductPower:js,fetchProductPrice:ln,fetchProductShipmentsFromTable:Lo,fetchProductionPlan:ji,fetchProspectActivities:ui,fetchProspects:ci,fetchPurchaseList:Us,fetchQuoteList:Ea,fetchQuoteWithLines:cn,fetchRawMaterialStock:Gs,fetchRawRecords:wt,fetchRawTableList:rn,fetchSafetyStockParams:Oi,fetchSalesAnalytics:$a,fetchSalesReport:qt,fetchSalesSummary:Cs,fetchSeasonalProfiles:Eo,fetchShipmentCalendar:Vi,fetchShopifyOrders:Ho,fetchSlackLogs:ri,fetchSlackRules:tn,fetchStaffCustomerBreakdown:lo,fetchStaffProductBreakdown:co,fetchStaffTotalsByPeriod:ro,fetchStoreOrders:Ws,fetchStoreSales:ka,fetchSyncDashboard:Ds,fetchSystemSetting:As,fetchTankList:Js,fetchTaxDeclaration:Sa,fetchTourInquiriesFromDb:Li,fetchUserProfiles:ei,fetchVisitPriorities:Co,fetchWorkflowOrdersFromDb:Ci,generateTaxCSV:No,generateTaxXML:Ks,ocrFaxImage:Wo,periodToDateRange:qs,prevYearFilter:po,recalculateTaxDeclaration:Mo,recordAudit:ni,resolveProductPrice:xa,saveBrewingSchedule:$o,saveCalendarEvent:Yo,saveCallLog:nn,saveChurnNote:vi,saveDeliveryLocation:bi,saveEmailCampaign:_t,saveFaxRecord:Zo,saveIntegrationSetting:rt,saveInvoice:Ts,saveLeadItem:on,saveLeadList:ki,saveMailSender:Bo,saveMaterial:mi,savePrintLayout:jo,saveProductionPlan:zi,saveProspect:an,saveProspectActivity:pi,saveSafetyStockParamsBulk:Fi,saveSlackRule:ii,saveTaxDeclaration:Ro,saveTourInquiry:Di,saveUserProfile:ai,saveWorkflowOrder:Ei,searchPlaces:Pi,sendEmailCampaign:Zs,sendSlackNotification:li,submitFeatureRequest:Ms,syncGoogleCalendar:Xo,syncIvryCallLogs:_i,syncPhoneBookToIvry:wi,syncShopifyOrders:Qo,updateCustomer:Rs,updateProduct:Os,upsertBrewingStock:_o,upsertSystemSetting:ze},Symbol.toStringTag,{value:"Module"}));function Me(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Yi={open:"未締め",closed:"締め済"};function Ui(e,t){const s=e.customers.map(n=>`
      <tr>
        ...
        <td class="numeric">${Me(n.salesAmount)}</td>
        <td class="numeric">${Me(n.taxAmount)}</td>
        <td class="numeric">${Me(n.prevBalance)}</td>
        <td class="numeric">${Me(n.paymentAmount)}</td>
        <td class="numeric"><strong>${Me(n.billingAmount)}</strong></td>
        <td>
          <span class="status-pill ${n.status==="closed"?"success":"warning"}">${Yi[n.status]}</span>
        </td>
        <td>
  ...
  `}function dn(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function at(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Gi(e){return e.salesHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':e.salesHistory.map(t=>`
        <tr>
          <td>${dn(t.date)}</td>
          <td class="mono">${t.documentNo}</td>
          <td class="numeric">${at(t.amount)}</td>
        </tr>
      `).join("")}function Xi(e){return e.paymentHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':e.paymentHistory.map(t=>`
        <tr>
          <td>${dn(t.date)}</td>
          <td>${t.method}</td>
          <td class="numeric">${at(t.amount)}</td>
        </tr>
      `).join("")}function Ki(e,t){return`
    <section class="page-head">
      <div>
  ...
  `}function sr(e,t){const s=t==="all"?e:e.filter(p=>p.segment===t),n={all:e.length};e.forEach(p=>{n[p.segment]=(n[p.segment]??0)+1});const r=["all",...[...new Set(e.map(p=>p.segment))]].map(p=>`
  ...
  `}function rr(e,t,s,n,i="month",r,c=[]){const p={success:"正常",warning:"注意",error:"異常",running:"実行中"},u=Rt(e.allDailySales,i,r),y=u.reduce((R,K)=>R+K.amount,0),f=u.reduce((R,K)=>R+K.bottles,0),v=u.reduce((R,K)=>R+K.volumeMl,0),b=u.length,x=f>0?Math.round(y/f):0,k=v>0?Math.round(y/(v/1e3)):0,o=new Date,l=o.toISOString().slice(0,10),d=l.slice(0,7),m=Rt(e.allDailySales,"month").filter(R=>R.date.slice(0,10)<=l),g=m.reduce((R,K)=>R+K.amount,0);m.reduce((R,K)=>R+K.bottles,0);const $=o.getDate();new Date(o.getFullYear(),o.getMonth()+1,0).getDate();const A=(n?.orderHeaders??[]).filter(R=>R.sales_date.slice(0,7)===d),S=A.reduce((R,K)=>R+Number(K.total_amount),0),C=A.length,I=Rt(e.allDailySales,"month"),L=I.reduce((R,K)=>R+K.bottles,0),T=S>0?S:I.reduce((R,K)=>R+K.amount,0),M=S>0?"orders":"extrapolation",z=(u.length>0?e.allDailySales.filter(R=>{const K=u[0]?.date??"",Qe=u[u.length-1]?.date??"",Ie=Ya(K,-1),Te=Ya(Qe,-1);return R.date>=Ie&&R.date<=Te}):[]).reduce((R,K)=>R+K.amount,0),W=z>0?(y-z)/z*100:0,oe=W>0?"+":"",ge=e.salesRecords.slice(0,10).map(R=>`
            <tr>
              <td class="mono">${R.documentNo}</td>
              <td>${Ot(R.date)}</td>
              <td>${R.customerName}</td>
              <td class="numeric">${de(R.amount)}</td>
            </tr>
          `).join(""),ie=["today","month","future","90days","year","all"].map(R=>`<button class="button ${R===i?"primary":"secondary"} small" type="button" data-period="${R}">${ut[R]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card" style="border-left:3px solid #0968e5;">
        ...
        <p class="kpi-sub">${M==="orders"?`受注確定 ${C}件`:`出荷見込 ${L.toLocaleString("ja-JP")}本（日割り外挿）`}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">昨対比</p>
        <p class="kpi-value" style="color:${W>=0?"#2f855a":"#c53d3d"}">${z>0?`${oe}${W.toFixed(1)}%`:"―"}</p>
    ...
    <section class="content-grid">
      <article class="panel">
        <div class="panel-header">
          <div>
            <h2>日次売上</h2>
            <p class="panel-caption">${ut[i]} (${u.length}日分)</p>
          </div>
        </div>
    ...
    <details class="panel collapsible-panel">
      <summary class="panel-header clickable">
        <div>
          <h2>日次推移</h2>
          <p class="panel-caption">${ut[i]} — 売上・本数・液体量・単価（${u.length}日分）</p>
        </div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>${Je(c.length>0?u:u.slice().reverse(),c,{date:"date",amount:"amount",bottles:"bottles",volumeMl:"volumeMl",pricePerBottle:"pricePerBottle",pricePerLiter:"pricePerLiter"}).slice(0,31).map(R=>`
            <tr>
              ...
              <td class="numeric">${de(R.pricePerBottle)}</td>
              <td class="numeric">${de(R.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
  ...
  `}function dr(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function Re(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ur(e,t){const s=e.lines.length?e.lines.map((i,r)=>`
          <tr>
  ...
  `}function fe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function pr(e){return fe(e).replaceAll(`
`,"<br />")}function mr(e){const s=[...Object.values(va),{id:"custom",season:"カスタム",subject:"",body:""}].map(i=>`
        <button
        ...
        >
          ...
          <strong>${fe(i.subject||"空テンプレート")}</strong>
        </button>
      `).join(""),n=e.previewRecipients.length?e.previewRecipients.map(i=>`
            <li>
              <span>${fe(i.name)}</span>
              <span class="table-sub">${fe(i.email)} / ${fe(i.area)}</span>
            </li>
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="field">
          <span>件名</span>
          <input id="email-subject" type="text" value="${fe(e.subject)}" />
        </div>
        <div class="field">
          <span>本文</span>
          <textarea id="email-body" rows="12">${fe(e.body)}</textarea>
        </div>
      ...
      <article class="panel">
        ...
        <label class="field" style="margin-bottom:12px;">
          ...
          <select id="email-sender">
            ${e.senders.map(i=>`<option value="${i.id}" ${i.id===e.senderId?"selected":""}>${fe(i.name)} &lt;${fe(i.email)}&gt;${i.isVerified?"":" ⚠️未認証"}</option>`).join("")}
        ...
        <div class="email-preview">
          <p class="panel-title">${fe(e.subject||"件名未入力")}</p>
          <div class="preview-box">${e.body?pr(e.body):"本文未入力"}</div>
        </div>
        ${e.saveMessage?`<p class="meta-note">${fe(e.saveMessage)}</p>`:""}
        <div class="action-bar">
  ...
  `}function he(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function pt(e,t){return t.length===0?"":`
  ...
  `}function yr(e,t){const s=[pt("得意先",t.customers.map(i=>`
          <button
            ...
            data-path="/master"
          >
            <strong>${he(i.name)}</strong>
            <span class="table-sub mono">${he(i.code)}</span>
          </button>
        ...
        `)),pt("伝票",t.documents.map(i=>`
          <button
            ...
            data-path="/invoice"
          >
            <strong>${he(i.documentNo)}</strong>
            <span class="table-sub">${he(i.customerName)} / ${he(i.date)}</span>
          </button>
        `)),pt("ページ",t.pages.map(i=>`
          <button
            ...
            data-path="${he(i.path)}"
          >
            <strong>${he(i.title)}</strong>
            <span class="table-sub mono">${he(i.path)}</span>
          </button>
  ...
  `}function mt(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ua(e){return e.trim().toLowerCase()}function hr(e,t){const s=Ua(t),n=e.filter(r=>s?[r.code,r.name,r.name].map(Ua).some(c=>c.includes(s)):!0).slice(0,50),i=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return pn({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:i,emptyMessage:"該当する得意先が見つかりません。"})}function fr(e){return e.toISOString().slice(0,10)}function De(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Pe(e,t){return e[t]?`<div class="field-error">${De(e[t])}</div>`:""}function Oe(e,t,s=""){return[s,e[t]?"has-error":""].filter(Boolean).join(" ")}function vr(e,t,s,n){const i=Object.keys(Xt).map(u=>`<option value="${u}" ${e.invoiceType===u?"selected":""}>${Xt[u]}</option>`).join(""),r=e.lines.map((u,y)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${Oe(n,`lines.${y}.productCode`,"input-cell")}" type="text" data-line="${y}" data-field="productCode" value="${De(u.productCode)}" placeholder="P00001" />
            <button class="picker-btn" type="button" data-action="open-product-picker" data-line="${y}" aria-label="商品検索">🔍</button>
          </div>
          ${Pe(n,`lines.${y}.productCode`)}
        </td>
        <td>
          <input class="${Oe(n,`lines.${y}.productName`,"input-cell")}" type="text" data-line="${y}" data-field="productName" value="${De(u.productName)}" placeholder="商品名" />
          ${Pe(n,`lines.${y}.productName`)}
        </td>
        <td>
          <input class="${Oe(n,`lines.${y}.quantity`,"input-cell numeric")}" type="number" data-line="${y}" data-field="quantity" value="${u.quantity}" min="0" />
          ${Pe(n,`lines.${y}.quantity`)}
        </td>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${Oe(n,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||fr(new Date)}" />
          ${Pe(n,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
        ...
        <label class="field">
          ...
          <input
            ...
            type="text"
            placeholder="青葉商事"
            value="${De(e.customerName)}"
          />
        </label>
        <label class="field">
          <span>担当者コード</span>
          <input id="inv-staff" type="text" placeholder="S001" value="${De(e.staffCode)}" />
        </label>
      </div>
      ${Pe(n,"lines")}
    </section>
    ...
    <section class="panel">
      <label class="field">
        <span>備考</span>
        <textarea id="inv-note" rows="2" placeholder="備考・特記事項">${De(e.note)}</textarea>
      </label>
    </section>
  ...
  `}function gr(e){return"¥"+e.toLocaleString("ja-JP")}function br(e){if(!e)return"";const t=new Date(e);return`${t.getFullYear()}/${String(t.getMonth()+1).padStart(2,"0")}/${String(t.getDate()).padStart(2,"0")}`}const $r={draft:"下書き",sent:"送付済",accepted:"受注",rejected:"失注"},_r={draft:"badge-gray",sent:"badge-blue",accepted:"badge-green",rejected:"badge-red"},wr={sake:"酒販用",standard:"通常"};function xr(e,t){return`
    <section class="page-head">
    ...
    <section class="panel">
      ...
      <tr>
        ...
        <td>${br(n.quote_date)}</td>
        <td>${n.customer_name||"（未選択）"}</td>
        <td>${n.subject||""}</td>
        <td class="numeric">${gr(n.total_amount)}</td>
        <td><span class="badge ${_r[n.status]??"badge-gray"}">${$r[n.status]??n.status}</span></td>
        <td>${wr[n.template_type]??n.template_type}</td>
        <td>
  ...
  `}const mn="kanei-quote-settings",yn=[{label:"青（標準）",value:"#0968e5"},{label:"紺",value:"#1e3a8a"},{label:"藍",value:"#1d4ed8"},{label:"緑",value:"#15803d"},{label:"金",value:"#b45309"},{label:"朱",value:"#c2410c"},{label:"ワイン",value:"#881337"},{label:"墨",value:"#1f2937"}],xt={companyName:"金井酒造店",companyPostal:"257-0014",companyAddress1:"神奈川県秦野市堀山下182",companyAddress2:"",companyTel:"0463-88-1511",companyFax:"0463-88-5885",companyEmail:"info@kaneishuzo.co.jp",companyRegistrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"",bankAccountHolder:"カ）カナイシュゾウテン",defaultPaymentTerms:"月末締め翌月末払い",defaultHeaderNote:"下記のとおりお見積り申し上げます。",defaultFooterNote:"",sealImageDataUrl:"",sealSize:72,accentColor:"#0968e5"};function ta(){try{const e=localStorage.getItem(mn);if(e)return{...xt,...JSON.parse(e)}}catch{}try{const e=localStorage.getItem("quote-seal");if(e){const t=JSON.parse(e);return{...xt,sealImageDataUrl:t.imageDataUrl??"",sealSize:t.size??72}}}catch{}return{...xt}}function qe(e){localStorage.setItem(mn,JSON.stringify(e))}function $e(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function re(e,t,s,n="text",i=""){return`<div class="form-row"><label>${t}</label><input type="${n}" id="${e}" value="${$e(s)}" placeholder="${$e(i)}" /></div>`}function Sr(e,t,s,n){const i=n.map(r=>`<option value="${$e(r)}" ${s===r?"selected":""}>${$e(r)}</option>`).join("");return`<div class="form-row"><label>${t}</label><select id="${e}">${i}</select></div>`}function kr(e){return`
    <section class="page-head">
    ...
    <section class="panel">
      ...
      <div class="form-grid-2">
        ...
        ${Sr("qs-bank-type","口座種別",e.bankAccountType,["普通","当座"])}
  ...
  `}function Pr(){const e=new Date;return new Date(e.getFullYear(),e.getMonth()+3,0).toISOString().slice(0,10)}function La(e){return{id:null,quoteNo:"",quoteDate:new Date().toISOString().slice(0,10),validUntil:Pr(),customerCode:"",customerName:"",customerAddress:"",subject:"",lines:[],remarks:"",taxRate:10,deliveryDate:"",paymentTerms:e?.defaultPaymentTerms??"月末締め翌月末払い",deliveryPlace:"",templateType:"sake",previewMode:!1}}La();function O(e){return(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function pe(e){return"¥"+e.toLocaleString("ja-JP")}function Qa(e){if(!e)return"";const t=new Date(e);return isNaN(t.getTime())?e:`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function hn(e){const t=e.replace("#","");return[parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16)]}function fn(e,t,s){return"#"+[e,t,s].map(n=>Math.max(0,Math.min(255,Math.round(n))).toString(16).padStart(2,"0")).join("")}function Ct(e,t){const[s,n,i]=hn(e);return fn(s+(255-s)*t,n+(255-n)*t,i+(255-i)*t)}function vn(e,t){const[s,n,i]=hn(e);return fn(s*(1-t),n*(1-t),i*(1-t))}function Ar(e){const t=vn(e,.15),s=Ct(e,.88),n=Ct(e,.96);return`
...
`}function Cr(e){const t=vn(e,.15),s=Ct(e,.88),n=Ct(e,.96);return`
...
`}function gn(e,t){const s=e.lines.reduce((k,o)=>k+o.amount,0),n=Math.round(s*e.taxRate/100),i=s+n,r=e.templateType==="sake",c=r?'<th style="width:90px;">JANコード</th><th style="width:40px;">入数</th><th style="width:70px;">希望小売価格</th>':"",p=r?9:6,u=e.lines.map((k,o)=>{const l=r?`<td style="font-size:9px;">${O(k.janCode)}</td><td style="text-align:center;">${k.caseQty??""}</td><td style="text-align:right;">${k.retailPrice!=null?pe(k.retailPrice):""}</td>`:"";return`<tr>
      <td style="text-align:center;">${o+1}</td>
      <td class="mono" style="font-size:9px;">${O(k.productCode)}</td>
      <td>${O(k.productName)}</td>
      ${l}
      <td style="text-align:right;">${k.quantity.toLocaleString()}</td>
      <td style="text-align:center;">${O(k.unit)}</td>
      <td style="text-align:right;">${pe(k.unitPrice)}</td>
  ...
  `:"",v=t.sealImageDataUrl?`<img src="${t.sealImageDataUrl}" style="width:${t.sealSize}px;height:${t.sealSize}px;opacity:0.9;flex-shrink:0;" />`:"",b=[];e.validUntil&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">有効期限</div><div class="q-cond-value">${Qa(e.validUntil)}</div></div>`),e.paymentTerms&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">支払条件</div><div class="q-cond-value">${O(e.paymentTerms)}</div></div>`),e.deliveryDate&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">納期</div><div class="q-cond-value">${O(e.deliveryDate)}</div></div>`),e.deliveryPlace&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">納品場所</div><div class="q-cond-value">${O(e.deliveryPlace)}</div></div>`);const x=b.length>0?`<div class="q-cond-grid" style="grid-template-columns:repeat(${Math.min(b.length,4)},1fr);">${b.join("")}</div>`:"";return`
<div class="q-doc">
  <!-- タイトル行: 左=御見積書、右=見積番号・日付（右寄せ） -->
  ...
  <div class="q-parties">
    ...
    <div class="q-seller-col">
      ...
      <div class="q-seller-name-row">
        <span class="q-seller-name">${O(t.companyName)}</span>
        ${v}
      </div>
  ...
  ${f}
    ...
    `}const x=e.lines.map((k,o)=>{const l=f?`
      <td><input type="text" class="jan-input" data-line-idx="${o}" value="${O(k.janCode)}" style="width:85px;" /></td>
    ...
    `:"";return`<tr>
      <td class="mono" style="font-size:11px;">${O(k.productCode)}</td>
      <td>${O(k.productName)}</td>
      ${l}
      ...
      <td class="numeric">${pe(k.amount)}</td>
    ...
    <section class="panel">
      ...
      <div class="form-row" style="margin-bottom:12px;">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:4px;align-items:center;">
          ${yn.map(k=>`
            <button type="button" data-action="set-accent-color" data-color="${O(k.value)}" title="${O(k.label)}"
              style="width:28px;height:28px;border-radius:4px;border:3px solid ${c.accentColor===k.value?"#333":"transparent"};background:${O(k.value)};cursor:pointer;"></button>
          `).join("")}
        </div>
      </div>
      <div class="form-grid-2">
    ...
    <section class="panel">
      ...
      ${v.length>0?`<div class="search-results">${v.map(k=>`
        <button class="search-item" type="button" data-select-customer="${k.code}" data-cust-name="${O(k.name)}" data-cust-addr="${O(k.address1||"")}">
          <span class="mono">${k.code}</span> ${O(k.name)}
        </button>`).join("")}</div>`:""}
    ...
    <section class="panel">
      ...
      ${b.length>0?`<div class="search-results">${b.map(k=>{const o=r?xa(k,r):{price:k.salePrice||0,label:"卸価格"},l=k.listPrice||0,d=o.label!=="標準価格"&&o.label!=="卸価格";return`<button class="search-item" type="button" data-add-product="${k.code}" data-prod-name="${O(k.name)}" data-prod-price="${o.price}" data-prod-retail="${l}" data-prod-jan="${O(k.janCode??"")}" data-prod-unit="${O(k.unit??"本")}" data-prod-case="${k.caseQty??""}">
          <span class="mono">${k.code}</span> ${O(k.name)}
...
<script>window.onload=function(){window.print();}<\/script>
  ...
  `}function Tr(e,t=[]){const s=e.filter(r=>r.currentRank==="A").length,n=e.filter(r=>r.prevRank&&r.currentRank<r.prevRank).length,i=e.filter(r=>r.prevRank&&r.currentRank>r.prevRank).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>営業効率分析</h1>
          ...
          <tbody>
            ${Je(e,t,{currentRank:"currentRank",name:"name",yearAmount:"yearAmount",sharePct:"sharePct",orderDays:"orderDays",growthRate:"growthRate"}).slice(0,50).map(r=>`
              <tr>
                ...
                <td>${Lr(r.currentRank,r.prevRank)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function Nr(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function Mr(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Rr(e,t){const s=e.length?e.map(n=>`
            <tr>
              ...
              <td class="numeric">${Mr(n.amount)}</td>
            </tr>
...
`);return`
  ...
  `}function Vr(e){const t={pending:"未実施",submitted:"申請中",approved:"承認済"},s={pending:"neutral",submitted:"warning",approved:"success"},n=e.map(u=>`
      <tr>
  ...
  `}function Jr(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Yr(e,t){return`
  ...
  `}function Gr(e,t){const s=[...new Set(e.map(i=>i.businessType).filter(Boolean))].sort(),n=[...new Set(e.map(i=>i.areaCode).filter(Boolean))].sort();return`
  ...
  `}function aa(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Xr(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function Kr(e){return e.map(t=>`
        <tr>
      ...
      `).join("")}function ht(e){return e?`¥${e.toLocaleString("ja-JP")}`:"―"}function Wr(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${aa(t.name,20)}</td>
          <td>${t.kanaName||""}</td>
          ...
          <td>${t.unit||""}</td>
          <td>${t.bottleType||""}</td>
          <td class="numeric">${ht(t.purchasePrice)}</td>
          <td class="numeric">${ht(t.salePrice)}</td>
          <td class="numeric">${ht(t.listPrice)}</td>
          <td class="numeric">${ht(t.costPrice)}</td>
          <td>${t.riceType||""}</td>
      ...
      `).join("")}function Zr(e,t,s=Da,n=[]){const{filtered:i,paged:r,totalPages:c}=Hr(e.customers,s);return`
    <section class="page-head">
      <div>
      ...
      ${t==="customers"?`
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>${Kr(Je(r,n,{code:"code",name:"name",kanaName:"kanaName",businessType:"businessType",areaName:"areaName",closingDay:"closingDay",paymentDay:"paymentDay"}))}</tbody>
          </table>
        </div>
        ${Wa(i.length,s.page,c)}
      `:`
        <div class="table-wrap">
          <table>
            ...
            <tbody>${Wr(Je(e.products,n,{code:"code",name:"name",category:"category",alcoholDegree:"alcoholDegree",volumeMl:"volumeMl",purchasePrice:"purchasePrice",salePrice:"salePrice",listPrice:"listPrice"}))}</tbody>
          </table>
        </div>
      `}
    </section>
  `}function jt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function el(e,t){if(!e&&!t)return"";const s=e;return`
  ...
  `}function tl(e){const t=e.map(i=>{const c=(i.minimumStock>0?i.currentStock/i.minimumStock:1/0)<1.5;return`
        <tr>
  ...
  `}function al(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function Ft(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const sl={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function nl(e){return`
    <section class="page-head">
      <div>
  ...
  `}function je(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Za(e){return e.trim().toLowerCase()}function ol(e,t){const s=Za(t),n=e.filter(r=>s?[r.code,r.name,r.janCode].map(Za).some(c=>c.includes(s)):!0),i=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return pn({title:"商品検索",searchQuery:t,placeholder:"コード・名前・JANで検索",resultsHtml:i,emptyMessage:"該当する商品が見つかりません。"})}function Ae(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function il(e,t){const s={pending:"未確定",confirmed:"確定",paid:"支払済"},n={pending:"warning",confirmed:"neutral",paid:"success"},i={unpaid:"未払い",partial:"一部支払",paid:"支払済"},r={unpaid:"warning",partial:"neutral",paid:"success"},c=e.map(v=>`
      <tr>
        ...
        <td class="numeric"><strong>${Ae(v.amount)}</strong></td>
        <td>
    ...
    `).join(""),p=t.map(v=>`
      <tr>
        <td class="mono">${v.supplierCode}</td>
        <td>${v.supplierName}</td>
        <td class="numeric">${Ae(v.totalPurchase)}</td>
        <td class="numeric">${Ae(v.paidAmount)}</td>
        <td class="numeric"><strong>${Ae(v.balance)}</strong></td>
  ...
  `}function Ke(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function rl(e,t){const s={holding:"保有中",due:"期日到来",cleared:"決済済"},n={holding:"neutral",due:"warning",cleared:"success"},i=e.map(f=>`
      <tr>
  ...
  `}function sa(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function ne(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function na(e){return`
  ...
  `}function gt(e){if(!e)return"error";const s=(Date.now()-new Date(e).getTime())/(1e3*60*60);return s<1?"success":s<24?"warning":"error"}function es(e){if(!e)return"未同期";const s=(Date.now()-new Date(e).getTime())/(1e3*60*60);return s<1?"正常":s<24?"注意":"要確認"}function cl(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">
          <span class="status-pill ${gt(e.lastOverallSync)}">${es(e.lastOverallSync)}</span>
        </p>
        <p class="kpi-sub">${gt(e.lastOverallSync)==="success"?"1時間以内":gt(e.lastOverallSync)==="warning"?"24時間以内":"24時間超"}</p>
      </article>
    </section>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="status-pill ${gt(t.lastSyncAt)}">${es(t.lastSyncAt)}</span></td>
            </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function dl(e,t,s,n){const i={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    ...
    <section class="panel">
      ...
      ${vt({stepLabel:"準備1",title:"Git（ソースコード取得に使用）",purpose:"GitHubからファイルをダウンロードするためのツール",body:`
        ...
        `})}
      ${vt({stepLabel:"準備2",title:"Python（同期スクリプトの実行環境）",purpose:"リレースクリプトを動かす",body:`
          <p class="panel-title">確認方法</p>
        ...
        `})}
      ${vt({stepLabel:"準備3",title:"pip（Pythonのパッケージ管理ツール）",purpose:"requests, pyodbc などのライブラリを入れる",body:`
          <p class="panel-title">確認方法</p>
          ...
          ${ft("python get-pip.py")}
        `})}
      ${vt({stepLabel:"準備4",title:"テキストエディタ（設定ファイル編集用）",purpose:"relay_config.json を編集するため",body:`
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function tt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ul(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function pl(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),s=Math.max(...t.map(v=>v.amount),1),n=28,i=6,r=140,c=100,p=760,u=p-r-c,y=t.length*(n+i)+16,f=t.map((v,b)=>{const x=v.amount/s*u,k=b*(n+i)+8,o=v.abcRank==="A"?"#2F855A":v.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
  ...
  `}function ml(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(n=>`<th class="numeric">${n}</th>`).join(""),s=e.monthlyByCustomer.map(n=>{const i=n.values.reduce((c,p)=>c+p,0),r=n.values.map(c=>`<td class="numeric">${c>0?(c/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${n.label}</td>
          ${r}
  ...
  `}const hl={code:"code",name:"name",amount:"amount",quantity:"quantity",documents:"documents",volumeMl:"volumeMl"},ts={amount:"売上額",quantity:"出荷本数",volume:"移出量"},oa=10;function qa(e){const[t,s]=e.split("-").map(Number);return s>=oa?t:t-1}function fl(e){const t=oa-1,s=new Date(e+1,t,0).getDate();return{from:`${e}-${String(oa).padStart(2,"0")}-01`,to:`${e+1}-${String(t).padStart(2,"0")}-${String(s).padStart(2,"0")}`}}function vl(e,t,s){const n=c=>t==="quantity"?c.quantity:t==="volume"?c.volumeMl:c.amount,i=new Map;for(const c of e){const p=s==="fiscal"?`${qa(c.month)}年度`:c.month.slice(0,4);i.set(p,(i.get(p)??0)+n(c))}return{curr:[...i.entries()].sort((c,p)=>c[0].localeCompare(p[0])).map(([c,p])=>({month:c,amount:p}))}}function gl(e){const t=new Set;for(const s of e)t.add(qa(s.month));return[...t].sort((s,n)=>n-s).map(String)}function Ye(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function bl(e){return e.replace("-","/")}const as={all:"全期間",yearly:"年次",monthly:"月次",weekly:"週次",daily:"日次"};function $l(e,t="#0F5B8D",s=[],n="amount"){if(e.length===0)return'<div class="chart-empty">データなし</div>';const i=s.length>0&&s.some(m=>m.amount>0),r=760,c=280,p={top:16,right:24,bottom:36,left:n==="amount"?64:56},u=r-p.left-p.right,y=c-p.top-p.bottom,f=[...e.map(m=>m.amount),...s.map(m=>m.amount)],v=Math.max(...f,1),b=u/e.length;function x(m){if(n==="quantity")return m>=1e4?`${(m/1e4).toFixed(1)}万本`:`${Math.round(m).toLocaleString()}本`;if(n==="volume"){const g=m/1e3;return g>=1e4?`${(g/1e3).toFixed(0)}kL`:`${Math.round(g).toLocaleString()} L`}return`${Math.round(m/1e4).toLocaleString("ja-JP")}万円`}function k(m){return n==="quantity"?`${m.toLocaleString()}本`:n==="volume"?Nt(m):Ye(m)}const o=[0,.25,.5,.75,1].map(m=>{const g=p.top+y-y*m,$=x(v*m);return`<g>
        <line x1="${p.left}" y1="${g}" x2="${r-p.right}" y2="${g}" class="chart-grid" />
        <text x="4" y="${g+4}" class="chart-axis">${$}</text>
      </g>`}).join(""),l=e.map((m,g)=>{const $=i?Math.max((b-18)/2,10):Math.max(b-18,24),w=i?2:0,A=p.left+g*b+(b-(i?$*2+w:$))/2,S=m.amount/v*y,C=p.top+y-S,I=s[g]?.amount??0,L=I/v*y,T=p.top+y-L,M=i?`<rect x="${A}" y="${T}" width="${$}" height="${L}" rx="4" fill="#ccc" opacity="0.6"><title>前年 ${k(I)}</title></rect>`:"",j=i?A+$+w:A;return`<g>
      ${M}
      <rect x="${j}" y="${C}" width="${$}" height="${S}" rx="4" fill="${t}" opacity="${.6+g/e.length*.35}"><title>${k(m.amount)}</title></rect>
      <text x="${p.left+g*b+b/2}" y="${c-8}" class="chart-axis centered-axis">${bl(m.month)}</text>
    </g>`}).join(""),d=i?`
  ...
  `}function Nt(e){return e>=1e3?`${(e/1e3).toLocaleString("ja-JP",{maximumFractionDigits:1})} L`:`${e.toLocaleString("ja-JP")} ml`}function _l(e,t=!1){const s=t?7:6;return e.length===0?`<tr><td colspan="${s}" class="empty-row">データなし</td></tr>`:e.map(n=>`
    <tr>
  ...
  `).join("")}function wl(e){return e.length===0?'<tr><td colspan="7" class="empty-row">データなし</td></tr>':e.map(t=>`
    <tr>
      <td class="mono">${t.code||"―"}</td>
      <td>${t.name||"不明"}</td>
  ...
  `}function kn(e,t,s="all",n="",i=[],r=[],c="",p="",u=null,y="all",f="",v=[],b=[],x=[],k=null,o=[],l=[],d="amount",m="calendar"){const g=t==="products"?"商品別集計":t==="customers"?"得意先別集計":"担当別集計",$=t==="products"?e.productTotals:t==="customers"?e.customerTotals:e.staffTotals,A=s!=="all"&&i.length>0&&t!=="staff"?i:$,S=Je(A,x,hl),C={all:"月別",yearly:"月別推移",monthly:"日別推移",weekly:"日別推移",daily:"当日"},I=ts[d],L=V=>d==="quantity"?V.quantity:d==="volume"?V.volumeMl:V.amount,T=V=>d==="quantity"?`${V.toLocaleString()}本`:d==="volume"?Nt(V):Ye(V);let M,j=[],z,W,oe;if(k&&k.monthlySales.length>0)M=k.monthlySales.slice(-24).map(V=>({month:V.month,amount:L(V)})),z=`${k.name} の月別${I}`,W=`${k.tab==="customers"?"得意先":"商品"}: ${k.code}`,oe="#0968e5";else if(o.length>0&&s!=="all"){M=o.map(ce=>({month:ce.month,amount:L(ce)})),j=l.map(ce=>({month:ce.month,amount:L(ce)}));const V=M.reduce((ce,H)=>ce+H.amount,0),we=j.reduce((ce,H)=>ce+H.amount,0),ct=we>0?(V-we)/we*100:0,Ne=ct>0?"+":"";z=`${C[s]} ${I}（${n}）`,W=`${T(V)}${we>0?` / 前年比 ${Ne}${ct.toFixed(1)}%`:""}`,oe="#2f855a"}else{M=vl(e.monthlySales,d,m).curr,j=[];const we=M.reduce((Ne,ce)=>Ne+ce.amount,0);z=`${m==="fiscal"?"決算年度別":"暦年別"}${I}`,W=`累計 ${T(we)}（${M.length}${m==="fiscal"?"期":"年"}）`,oe="#0F5B8D"}const ge=["amount","quantity","volume"].map(V=>`<button class="tab-button ${V===d?"active":""}" data-chart-metric="${V}">${ts[V]}</button>`).join(""),ie=["all","yearly","monthly","weekly","daily"].map(V=>`<button class="button ${V===s?"primary":"secondary"} small" type="button" data-analytics-period="${V}">${as[V]}</button>`).join(""),R=m==="fiscal"&&s==="yearly"?gl(e.monthlySales):r,K=m==="fiscal"&&s==="yearly"&&!R.includes(n)?R[0]??"":n,Qe=s!=="all"&&R.length>0&&t!=="staff"?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
        ${R.map(V=>`<option value="${V}" ${V===K?"selected":""}>${m==="fiscal"&&s==="yearly"?V+"年度":V}</option>`).join("")}
      </select>`:"";let Ie="",Te="";if(t==="staff"){const V=["all","yearly","monthly","weekly","daily"].map(H=>`<button class="button ${H===y?"primary":"secondary"} small" type="button" data-staff-period="${H}">${as[H]}</button>`).join(""),we=y!=="all"&&v.length>0?`<select id="staff-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
          ${v.map(H=>`<option value="${H}" ${H===f?"selected":""}>${H}</option>`).join("")}
        </select>`:"",Ne=(b.length>0?b:e.staffTotals).filter(H=>!c||H.name.includes(c)||H.code.includes(c)),ce=y!=="all"&&f?` (${f})`:"";if(Ie=`
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${Ne.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':Ne.map(H=>`
                <tr>
    ...
    `,u){const H=u.breakdownTab,Jn=y!=="all"&&f?`<span style="font-size:12px;color:var(--text-secondary);margin-left:8px;">${f}</span>`:"";Te=`
      ...
      <article class="panel">
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>${wl(k.breakdownRows)}</tbody>
          </table>
        </div>
      </article>
    </section>
    ...
    ${Te}
  `}const ns=Object.freeze(Object.defineProperty({__proto__:null,fiscalYearToDateRange:fl,monthToFiscalYear:qa,renderSalesAnalytics:kn},Symbol.toStringTag,{value:"Module"}));function We(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function xl(e){const t=Math.max(...e.salesByProduct.flatMap(r=>r.values),1),s=e.salesByProduct.map(r=>{const c=r.values.map((p,u)=>`
          <div class="bar-col">
  ...
  `}function Sl(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function kl(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function os(e){return e.toISOString().slice(0,10)}function Pl(e,t,s){const n=e.length?e.map(i=>`
            <tr>
              ...
              <td class="numeric">${kl(i.amount)}</td>
            </tr>
  ...
  `}function bt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Al(e,t,s,n){const i={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},r={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},c={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},p=e.map(v=>`
      <tr>
        <td>${v.saleTime}</td>
        <td class="mono">${v.productCode}</td>
        <td>${v.productName}</td>
        <td class="numeric">${v.quantity}</td>
        <td class="numeric">${bt(v.unitPrice)}</td>
        <td class="numeric"><strong>${bt(v.amount)}</strong></td>
    ...
    `).join(""),u=t.map(v=>`
      <tr>
        ...
        <td class="numeric"><strong>${bt(v.totalAmount)}</strong></td>
        <td>
  ...
  `}function Bt(e){const t={};return e.querySelectorAll("[data-fd-id]").forEach(s=>{const n=s.dataset.fdId??"",i=parseFloat(s.style.left)||0,r=parseFloat(s.style.top)||0;t[n]={x:i,y:r}}),t}function ql(e,t,s){const n=[...new Set(e.map(b=>b.areaCode).filter(Boolean))].sort(),i=[...new Set(e.map(b=>b.businessTypeName||b.businessType).filter(Boolean))].sort(),r=e.filter(b=>b.isAtRisk),c=e.filter(b=>!b.isAtRisk&&b.isDormant),p=e.filter(b=>!b.isAtRisk&&!b.isDormant&&b.amount12m>0),u=e.filter(b=>!b.isAtRisk&&!b.isDormant&&b.amount12m===0),y=t.filter(b=>b.lat&&b.lng),f=JSON.stringify(e),v=JSON.stringify(y.map(b=>({name:b.name,address:b.address,lat:b.lat,lng:b.lng,phone:b.phone})));return`
    ...
    <\/script>`}const Il={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},Tl=["new","picking","packed","shipped","delivered"];function Nl(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(r=>t[r.stage].push(r));const s=Tl.map(r=>{const c=Il[r],p=t[r];return`
  ...
  `}function Ml(e,t,s){const n=e.cart.reduce((r,c)=>r+c.amount,0);return`
  ...
  `}function Rl(e,t,s){if(e.step==="customer"){const n=e.customerQuery.toLowerCase(),i=n?t.filter(r=>r.name.toLowerCase().includes(n)||r.code.toLowerCase().includes(n)):t.slice(0,20);return`
      <section class="panel">
  ...
  `}const is={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},rs={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},ls={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function Ol(e,t){const s=e.find(r=>r.id===t)??e[0],n=e.filter(r=>r.status==="new").length,i=e.filter(r=>r.status==="confirmed").length;return`
    <section class="page-head">
      <div>
...
金井酒造店`;function zl(e,t){const s=t?e.find(i=>i.id===t):null,n=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${s||n?`
      ...
      `:""}
  `}function Bl(e,t,s,n){const[i,r]=t.split("-").map(w=>parseInt(w,10)),c=new Date(i,r-1,1),p=new Date(i,r,0),u=c.getDay(),y=p.getDate(),f=[];for(let w=0;w<u;w++)f.push({isOutside:!0});for(let w=1;w<=y;w++)f.push({date:new Date(i,r-1,w)});for(;f.length%7!==0;)f.push({isOutside:!0});const v=s?e.filter(w=>w.category===s):e,b={};v.forEach(w=>{const A=w.startsAt.slice(0,10);b[A]??=[],b[A].push(w)});const x=new Date().toISOString().slice(0,10),k=f.map(w=>{if(w.isOutside)return'<div class="cal-cell cal-outside"></div>';const A=w.date,S=`${A.getFullYear()}-${String(A.getMonth()+1).padStart(2,"0")}-${String(A.getDate()).padStart(2,"0")}`,C=b[S]??[],I=S===x,L=A.getDay();return`
          ...
          <div class="cal-events">
            ${C.slice(0,3).map(T=>`
              <button class="cal-event" data-cal-event-id="${T.id}"
                      style="background:${T.color||Aa[T.category]||"#0F5B8D"};"
                      title="${T.title}">
      ...
      `}).join(""),o=n?.isOpen?Vl(n):"",l=new Date(i,r-2,1),d=new Date(i,r,1),m=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}`,g=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}`,$=(()=>{const w=new Date;return`${w.getFullYear()}-${String(w.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(Pa).map(([w,A])=>`<option value="${w}" ${s===w?"selected":""}>${A}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
    ...
    ${o}
  `}function Vl(e){const t=e.event;return`
  ...
  `}function Yl(e,t){const s=e.reduce((r,c)=>r+c.totalAmount,0),n=e.filter(r=>r.financialStatus==="paid").length,i=e.filter(r=>r.fulfillmentStatus!=="fulfilled"&&r.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function Ql(e,t,s){const n=t==="__new__"?null:e.find(c=>c.id===t),i=t==="__new__";return s?.role==="admin"?`
    <section class="page-head">
      <div>
      ...
      <section class="panel">
        ...
        <div class="filter-grid filter-grid--wide">
          ...
          <label class="field" style="flex:1 1 140px;">
            <span>部署</span>
            <select id="user-dept">
              ${Object.entries(Pt).map(([c,p])=>`<option value="${c}" ${n?.department===c?"selected":""}>${p}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 140px;">
            <span>権限</span>
            <select id="user-role">
              ${Object.entries(kt).map(([c,p])=>`<option value="${c}" ${n?.role===c?"selected":""}>${p}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 160px;">
            <span>電話</span>
  ...
  `:`
    ...
    <section class="panel">
      ...
      <dl class="summary-list">
        ...
        <div><dt>部署</dt><dd>${Pt[e.department]}</dd></div>
  ...
  `:`
    ...
    `}function Gl(e){const t={};return e.forEach(s=>{const n=s.userEmail??"(anonymous)";t[n]=(t[n]??0)+1}),`
    <section class="page-head">
      <div>
  ...
  `}function Xl(e){const t=e.prospects.reduce((r,c)=>r+c.expectedAmount,0),s=e.prospects.reduce((r,c)=>r+c.expectedAmount*c.probability/100,0),n=e.prospects.filter(r=>r.stage==="won").length,i=e.prospects.filter(r=>r.stage==="hot"||r.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    ${e.viewMode==="kanban"?Kl(e.prospects):Wl(e.prospects)}
    ...
    <section class="panel" style="padding:12px;">
      ...
      <div class="pk-board">${["cold","warm","hot","contacted","negotiating","won","lost"].map(n=>{const i=e.filter(c=>c.stage===n),r=i.reduce((c,p)=>c+p.expectedAmount,0);return`
        <div class="pk-col" data-prospect-stage="${n}">
          <div class="pk-col-header" style="--pk-color:${Ca[n]};">
          ...
          <tbody>
            ${e.map(t=>`
              <tr>
                ...
                <td>${t.businessType??"―"}</td>
                <td><span class="status-pill" style="background:${Ca[t.stage]};color:white;">${It[t.stage]}</span></td>
  ...
  `}function Zl(e){if(!e.editingId)return"";const t=e.editingId==="__new__",s=t?null:e.prospects.find(n=>n.id===e.editingId);return!t&&!s?"":`
  ...
  `}function ec(e,t,s){const n=e?.config.webhook_url??"",i=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
  ...
  `}const ac=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function sc(e){const t=e.activeListId?e.lists.find(r=>r.id===e.activeListId):null,s=e.items.filter(r=>r.status==="new").length,n=e.items.filter(r=>r.status==="imported").length,i=e.items.filter(r=>r.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
    ...
    <section class="panel">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:flex-end;">
        <label class="field" style="flex:1 1 180px;">
          ...
          <select id="lb-type">
            <option value="">選択</option>
            ${ac.map(r=>`<option value="${r}" ${e.searchBusinessType===r?"selected":""}>${r}</option>`).join("")}
          </select>
        </label>
        <label class="field" style="flex:1 1 180px;">
          <span>エリア</span>
  ...
  `}function rc(e,t,s){const{subtotal:n,taxAmount:i,total:r}=Pn(e.lines,e.taxRate),c=e.previousBalance??0,p=e.paymentAmount??0,u=c-p+r,y=e.lines.map(v=>`
      <tr>
  ...
  `}function lc(e,t,s){const{subtotal:n,taxAmount:i,total:r}=Pn(e.lines,e.taxRate),c=e.lines.map(u=>`
      <tr>
  ...
  `}function cc(e,t,s,n){let i="";switch(e){case"chain_store":i=ic(n,s,t);break;case"quotation":i=lc(n,s,t);break;case"invoice_monthly":i=rc(n,s,t);break}const r=Object.keys(ds).map(u=>`<button class="tab-button ${e===u?"active":""}" data-print-template="${u}">${ds[u]}</button>`).join(""),c=n.lines.map((u,y)=>`
      <tr>
...
`||u==="\r"?(u==="\r"&&e[p+1]===`
`&&p++,s.push(n),s.some(y=>y!=="")&&t.push(s),s=[],n=""):n+=u}if((n!==""||s.length>0)&&(s.push(n),s.some(p=>p!=="")&&t.push(s)),t.length===0)return{columns:[],rows:[]};const r=t[0].map(p=>p.trim()),c=[];for(let p=1;p<t.length;p++){const u={};r.forEach((y,f)=>{u[y]=(t[p][f]??"").trim()}),c.push(u)}return{columns:r,rows:c}}function Cn(e,t,s){const n=dc[e],i=n.filter(p=>!t.includes(p)),r=s.map(p=>{const u=[];i.length>0&&u.push(`必須列欠損: ${i.join(",")}`);for(const y of n)t.includes(y)&&!p[y]&&u.push(`${y}が空`);return{...p,_valid:u.length===0,_error:u[0]}}),c=r.filter(p=>p._valid).length;return{entity:e,columns:t,rows:r,totalRows:s.length,validRows:c,invalidRows:r.length-c}}function En(e){const s=uc[e],i={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[e];return"\uFEFF"+s.join(",")+`
`+i.join(",")+`
`}async function Ln(e,t){const{supabaseInsert:s}=await E(async()=>{const{supabaseInsert:p}=await Promise.resolve().then(()=>B);return{supabaseInsert:p}},void 0);let n=0,i=0;const c={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const p of t){if(!p._valid)continue;const{_valid:u,_error:y,...f}=p,v={...f};if(!v.id){const b=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";v.id=String(f[b]??`${e}-${Date.now()}-${n+i}`)}for(const b of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof v[b]=="string"&&v[b]!==""){const x=Number(v[b]);Number.isFinite(x)&&(v[b]=x)}try{await s(c,v)!==null?n++:i++}catch{i++}}return{inserted:n,failed:i}}const pc=Object.freeze(Object.defineProperty({__proto__:null,generateTemplateCSV:En,importToSupabase:Ln,parseCSV:An,validateImport:Cn},Symbol.toStringTag,{value:"Module"}));function Jt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function mc(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function yc(e,t,s,n,i){const r=s.reduce((y,f)=>y+f.rowCount,0),c=s.map(y=>y.lastSyncAt).filter(y=>y!==null).sort().reverse()[0]??null,p=100,u=Math.max(1,Math.ceil(i/p));return`
    <section class="page-head">
      <div>
    ...
    `}
  `}const ia=400,ra=240;function Q(e){return e.toLocaleString("ja-JP")}function Yt(e){const[t,s]=e.split("-");return`${t.slice(2)}/${s}`}function hc(e,t){return!e||e.column!==t?'<span style="opacity:0.3;margin-left:2px;">⇅</span>':e.dir==="asc"?'<span style="margin-left:2px;">↑</span>':'<span style="margin-left:2px;">↓</span>'}function ve(e,t,s,n=""){return`<th class="${n}" style="cursor:pointer;user-select:none;white-space:nowrap;"
    data-action="demand-sort" data-sort-col="${t}">${e}${hc(s,t)}</th>`}function et(e){return e>=.99?2.33:e>=.97?1.88:e>=.95?1.65:e>=.9?1.28:1.04}function fc(e){const{months:t,matrix:s}=e;if(t.length===0||e.products.length===0)return'<div class="chart-empty">データなし</div>';const n=e.products.slice().sort((d,m)=>(e.productTotals[m.code]??0)-(e.productTotals[d.code]??0)).slice(0,6),i=["#0F5B8D","#2F855A","#B7791F","#C53D3D","#6B46C1","#2B6CB0"],r=820,c=280,p={top:20,right:20,bottom:40,left:60},u=r-p.left-p.right,y=c-p.top-p.bottom,f=t.map(d=>n.reduce((m,g)=>m+(s[g.code]?.[d]??0),0)),v=Math.max(...f,1),b=u/t.length,x=Math.max(b-10,14),k=[0,.25,.5,.75,1].map(d=>{const m=p.top+y-y*d,g=`${Math.round(v*d/100)*100}`;return`
      <line x1="${p.left}" y1="${m}" x2="${r-p.right}" y2="${m}" class="chart-grid" />
      <text x="6" y="${m+4}" class="chart-axis">${Number(g).toLocaleString("ja-JP")}</text>
    `}).join(""),o=t.map((d,m)=>{let g=p.top+y;const $=p.left+m*b+(b-x)/2,w=n.map((T,M)=>{const z=(s[T.code]?.[d]??0)/v*y;return g-=z,`<rect x="${$}" y="${g}" width="${x}" height="${z}" fill="${i[M%i.length]}" opacity="0.85" rx="${M===n.length-1?3:0}" />`}).join(""),[A,S]=d.split("-"),C=parseInt(S),I=C===1||m%3===0,L=C===1?`${A.slice(2)}年`:`${C}月`;return`<g>${w}${I?`<text x="${$+x/2}" y="${c-10}" class="chart-axis centered-axis">${L}</text>`:""}</g>`}).join(""),l=n.map((d,m)=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}function vc(e){const{months:t,products:s}=e,n=s.slice().sort((c,p)=>(e.productTotals[p.code]??0)-(e.productTotals[c.code]??0)).slice(0,50),i=t.map(c=>{const[p,u]=c.split("-"),y=parseInt(u);return`<th class="numeric" style="min-width:52px;white-space:nowrap;">${y===1?`${p.slice(2)}年1月`:`${y}月`}</th>`}).join(""),r=n.map(c=>{const p=t.map(u=>{const y=e.matrix[c.code]?.[u]??0;return`<td class="numeric">${y>0?Q(y):"—"}</td>`}).join("");return`
      <tr>
  ...
  `}const $c={monthly:"月次",annual:"年次",make_to_order:"受注生産",november:"11月生産"};function _c(e,t,s,n){const i={draft:"下書き",confirmed:"確定",actual:"実績入力済"},r={draft:"neutral",confirmed:"info",actual:"success"},c=S=>Object.entries($c).map(([C,I])=>`<option value="${C}" ${C===S?"selected":""}>${I}</option>`).join(""),p=640,u=S=>S.map(C=>{const I=Math.max(0,C.demandForecast+C.safetyStockTarget-C.openingStock),L=C.plannedQty>0?C.plannedQty:Math.round(I),T=L>0?Math.ceil(L/p*10)/10:0,M=C.plannedQty>0?(C.actualQty-C.plannedQty)/C.plannedQty*100:null,j=M!==null?M>=0?"text-success":"text-danger":"";return`
      <tr>
        ...
        <td class="numeric">${Q(Math.round(C.demandForecast))}</td>
        <td class="numeric">${Q(Math.round(C.safetyStockTarget))}</td>
        <td class="numeric">${Q(Math.round(C.openingStock))}</td>
        <td class="numeric"><strong>${Q(Math.round(I))}</strong></td>
        <td>
        ...
        <td class="numeric">${C.actualQty>0?Q(C.actualQty):"—"}</td>
        <td class="numeric ${j}">
    ...
    `}).join(""),f=(s==="all"?e:e.filter(S=>S.productionType===s)).slice().sort((S,C)=>{if(!n)return 0;const I=n.dir==="asc"?1:-1,L=Math.max(0,S.demandForecast+S.safetyStockTarget-S.openingStock),T=Math.max(0,C.demandForecast+C.safetyStockTarget-C.openingStock);switch(n.column){case"plan-name":return I*S.productName.localeCompare(C.productName,"ja");case"plan-forecast":return I*(S.demandForecast-C.demandForecast);case"plan-required":return I*(L-T);case"plan-planned":return I*(S.plannedQty-C.plannedQty);case"plan-actual":return I*(S.actualQty-C.actualQty);case"plan-label":{const M=S.plannedQty>0?S.plannedQty:Math.round(L),j=C.plannedQty>0?C.plannedQty:Math.round(T);return I*(M-j)}default:return 0}}),v=u(f),b=[{key:"all",label:"全て"},{key:"monthly",label:"月次"},{key:"annual",label:"年次"},{key:"november",label:"11月生産"},{key:"make_to_order",label:"受注生産"}],x=S=>{const I=(S==="all"?e:e.filter(L=>L.productionType===S)).reduce((L,T)=>{const M=Math.max(0,T.demandForecast+T.safetyStockTarget-T.openingStock);return L+(T.plannedQty>0?T.plannedQty:Math.round(M))},0);return Math.ceil(I/p*10)/10},k=b.filter(S=>S.key!=="all").map(S=>{const C=x(S.key),I=e.filter(T=>T.productionType===S.key).length,L=S.key==="make_to_order"?e.filter(T=>T.productionType==="make_to_order"&&T.plannedQty>0).length:null;return`
        ...
        <table>
          <thead>
            <tr>
              ${ve("商品名","plan-name",n)}
              <th>生産区分</th>
              ${ve("需要予測","plan-forecast",n,"numeric")}
              <th class="numeric">安全在庫目標</th>
              <th class="numeric">期首在庫</th>
              ${ve("必要生産数","plan-required",n,"numeric")}
              ${ve("計画数","plan-planned",n,"numeric")}
              ${ve("実績数","plan-actual",n,"numeric")}
              <th class="numeric">達成率</th>
              ${ve("ラベル工数","plan-label",n,"numeric")}
              <th>状態</th>
            </tr>
          </thead>
          <tbody>
  ...
  `}function Dn(e){const[t,s]=e.split("-").map(Number),n=new Date(t,s,0).getDate();return Array.from({length:n},(i,r)=>{const c=r+1;return`${e}-${String(c).padStart(2,"0")}`})}function us(e){const t=new Date(e).getDay();return["日","月","火","水","木","金","土"][t]}function ps(e){const t=new Date(e).getDay();return t===0||t===6}function wc(e){return e.partTimers*ia+e.employees*ra}function qn(e){return e.partTimers+e.employees}function xc(e,t){const s=t.filter(c=>qn(c)>0).map(c=>c.date).sort();if(s.length===0)return t.map(c=>({date:c.date,partTimers:c.partTimers,employees:c.employees,confirmed:c.confirmed,capacity:0,items:[],totalQty:0,utilization:0}));const n={monthly:0,november:1,annual:2,make_to_order:3},i=e.filter(c=>c.plannedQty>0||Math.max(0,c.demandForecast+c.safetyStockTarget-c.openingStock)>0).map(c=>({productCode:c.productCode,productName:c.productName,productionType:c.productionType,remaining:c.plannedQty>0?c.plannedQty:Math.max(0,c.demandForecast+c.safetyStockTarget-c.openingStock)})).filter(c=>c.remaining>0).sort((c,p)=>(n[c.productionType]??99)-(n[p.productionType]??99)||p.remaining-c.remaining),r=new Map;for(const c of t){const p=wc(c);r.set(c.date,{date:c.date,partTimers:c.partTimers,employees:c.employees,confirmed:c.confirmed,capacity:p,items:[],totalQty:0,utilization:0})}for(const c of i){let p=c.remaining;if(p<=0)continue;if(s.reduce((y,f)=>{const v=r.get(f);return y+Math.max(0,v.capacity-v.totalQty)},0)<=0)break;for(const y of s){if(p<=0)break;const f=r.get(y),v=Math.max(0,f.capacity-f.totalQty);if(v<=0)continue;const b=Math.min(p,v);f.items.push({productCode:c.productCode,productName:c.productName,productionType:c.productionType,qty:b}),f.totalQty+=b,f.utilization=f.capacity>0?f.totalQty/f.capacity:0,p-=b}}return t.map(c=>r.get(c.date))}function St(e,t=1,s=1){return Dn(e).map(n=>({date:n,partTimers:ps(n)?0:t,employees:ps(n)?0:s,confirmed:!1}))}function Sc(e,t,s,n=null){const i=Dn(t),r=xc(e,s),c=new Map(r.map(L=>[L.date,L])),p=e.reduce((L,T)=>L+(T.plannedQty>0?T.plannedQty:Math.max(0,T.demandForecast+T.safetyStockTarget-T.openingStock)),0),u=r.reduce((L,T)=>L+T.totalQty,0),y=s.filter(L=>qn(L)>0).length,f=r.reduce((L,T)=>L+T.capacity,0),v=s.reduce((L,T)=>L+T.partTimers,0),b=s.reduce((L,T)=>L+T.employees,0),x=s.find(L=>L.partTimers>0)?.partTimers??1,k=s.find(L=>L.employees>0)?.employees??1,o=[0,1,2,3,4,5].map(L=>`<option value="${L}" ${L===x?"selected":""}>${L}</option>`).join(""),l=[0,1,2,3].map(L=>`<option value="${L}" ${L===k?"selected":""}>${L}</option>`).join(""),d=new Date,m=Array.from({length:24},(L,T)=>{const M=new Date(d.getFullYear(),d.getMonth()-6+T,1),j=`${M.getFullYear()}-${String(M.getMonth()+1).padStart(2,"0")}`;return`<option value="${j}" ${j===t?"selected":""}>${j.replace("-","年")}月</option>`}).join(""),g=new Date(i[0]).getDay(),$=[];for(let L=0;L<g;L++)$.push('<div style="min-height:44px;"></div>');for(const L of i){const T=c.get(L),M=new Date(L).getDay(),j=parseInt(L.split("-")[2]),z=T?.partTimers??0,W=T?.employees??0,oe=z+W,ge=T?.totalQty??0,ie=T?.utilization??0,R=L===n,K=oe===0?"var(--surface-alt)":ie>.95?"rgba(197,61,61,0.12)":ie>.7?"rgba(183,121,31,0.10)":ie>0?"rgba(47,133,90,0.08)":"var(--surface)",Qe=oe===0?"transparent":ie>.95?"#c53d3d":ie>.7?"#b7791f":ie>0?"#2f855a":"var(--border)",Ie=M===0?"#c53d3d":M===6?"#0F5B8D":"var(--text)",Te=oe>0?`<span style="font-size:8px;color:var(--text-secondary);line-height:1;">${z>0?`パ${z}`:""}${W>0?`社${W}`:""}</span>`:"";$.push(`
      <div data-action="cal-select-day" data-date="${L}"
        style="min-height:44px;padding:3px;border:${R?"2px solid #0F5B8D":"1px solid var(--border)"};border-radius:6px;
          background:${K};cursor:pointer;display:flex;flex-direction:column;
          ${R?"box-shadow:0 0 0 2px rgba(15,91,141,0.2);":""}">
        <div style="display:flex;justify-content:space-between;align-items:center;">
          <span style="font-size:12px;font-weight:600;color:${Ie};line-height:1;">${j}</span>
          ${Te}
        </div>
        ${oe>0?`
          <div style="font-size:10px;font-weight:600;color:var(--text);margin-top:auto;line-height:1;">${ge>0?Q(ge):""}</div>
          <div style="height:3px;background:var(--border);border-radius:2px;margin-top:2px;">
            <div style="height:100%;width:${Math.min(ie*100,100)}%;background:${Qe};border-radius:2px;"></div>
          </div>
        `:'<div style="font-size:9px;color:var(--text-disabled);margin-top:auto;">休</div>'}
      </div>
    `)}const A=$.length%7;if(A>0)for(let L=0;L<7-A;L++)$.push('<div style="min-height:44px;"></div>');const S=n?c.get(n):null;n&&s.find(L=>L.date===n);const C=n&&S?(()=>{const L=S,T=parseInt(n.split("-")[2]),M=us(n),j=Math.round(L.utilization*100),z=s.find(R=>R.date===n),W={monthly:"#0F5B8D",november:"#B7791F",annual:"#6B46C1",make_to_order:"#999"},oe={monthly:"月次",november:"11月",annual:"年次",make_to_order:"受注"},ge=L.items.map(R=>`
      <div style="display:flex;align-items:center;gap:8px;padding:8px 0;border-bottom:1px solid var(--border);">
        <span style="width:8px;height:8px;border-radius:50%;background:${W[R.productionType]??"#999"};flex-shrink:0;"></span>
        <div style="flex:1;min-width:0;">
          <div style="font-size:13px;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${R.productName}</div>
          <div style="font-size:11px;color:var(--text-secondary);">${oe[R.productionType]??R.productionType}</div>
        </div>
        <div style="font-size:14px;font-weight:700;white-space:nowrap;">${Q(R.qty)}<span style="font-size:11px;font-weight:400;">本</span></div>
      </div>
    `).join(""),ie=`パート${L.partTimers}人×${ia} + 社員${L.employees}人×${ra} = ${Q(L.capacity)}本`;return`
  ...
  `:"",I=[{color:"#0F5B8D",label:"月次"},{color:"#B7791F",label:"11月"},{color:"#6B46C1",label:"年次"},{color:"#999",label:"受注"}].map(L=>`<span style="display:inline-flex;align-items:center;gap:2px;font-size:10px;">
    ...
    ${C}
  `}function kc(e,t,s,n,i,r,c="all",p=null,u=[],y=null){const v=[{key:"demand",label:"需要実績"},{key:"safety",label:"安全在庫"},{key:"plan",label:"生産計画"},{key:"calendar",label:"生産カレンダー"}].map(x=>`<button class="tab-button ${n===x.key?"active":""}"
       data-demand-tab="${x.key}">${x.label}</button>`).join("");let b="";if(n==="demand")b=e?gc(e,r):'<section class="panel"><p>データを読み込んでいます…</p></section>';else if(n==="safety")b=bc(t,p);else if(n==="plan")b=_c(s,i,c,p);else if(n==="calendar")try{b=Sc(s,i,u,y)}catch(x){console.error("[renderCalendarTab] error:",x),b=`<section class="panel"><div style="color:red;padding:16px;white-space:pre-wrap;">[カレンダー描画エラー] ${String(x)}
${x?.stack??""}</div></section>`}return`
    ...
    ${b}
  `}const Ue={純米大吟醸:"#7c3aed",大吟醸:"#a855f7",純米吟醸:"#2563eb",純米:"#059669",本醸造:"#d97706",普通酒:"#6b7280",リキュール:"#e11d48",その他:"#9ca3af"},lt=["純米大吟醸","大吟醸","純米吟醸","純米","本醸造","普通酒","リキュール","その他"];function _e(e){return e.toLocaleString("ja-JP")}function me(e){return(e/1e3).toLocaleString("ja-JP",{maximumFractionDigits:1})}function Ia(e){return e<2?"#ef4444":e<=4?"#eab308":"#22c55e"}function Pc(e){return e<2?"要醸造":e<=4?"注意":"余裕あり"}function Ac(e){if(e.length===0)return'<div class="chart-empty">出荷データなし</div>';const t=[...new Set(e.map(l=>l.month))].sort(),s=lt.filter(l=>e.some(d=>d.brewCategory===l)),n={};for(const l of e)n[l.month]||(n[l.month]={}),n[l.month][l.brewCategory]=l.shipmentMl;const i=820,r=300,c={top:20,right:20,bottom:50,left:70},p=i-c.left-c.right,u=r-c.top-c.bottom,y=t.map(l=>s.reduce((d,m)=>d+(n[l]?.[m]??0),0)),f=Math.max(...y,1),v=p/t.length,b=Math.max(v-8,14),x=[0,.25,.5,.75,1].map(l=>{const d=c.top+u-u*l,m=f*l/1e3;return`
    ...
    `}).join(""),k=t.map((l,d)=>{let m=c.top+u;const g=c.left+d*v+(v-b)/2,$=s.map(L=>{const T=n[l]?.[L]??0,M=T/f*u;return m-=M,M>0?`<rect x="${g}" y="${m}" width="${b}" height="${M}" fill="${Ue[L]??"#9ca3af"}" opacity="0.85" rx="1"><title>${L}: ${me(T)}L</title></rect>`:""}).join(""),[w,A]=l.split("-"),S=parseInt(A),C=S===10||d%2===0,I=S===10?`${w}年度`:`${S}月`;return`<g>${$}${C?`<text x="${g+b/2}" y="${r-12}" class="chart-axis centered-axis" style="font-size:10px;">${I}</text>`:""}</g>`}).join(""),o=s.map(l=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}function Cc(e){const t=new Map;for(const n of e){const i=n.brewCategory;t.has(i)||t.set(i,{rows:[],totalMl:0,avgMl:0,stockL:0,months:0});const r=t.get(i);r.rows.push(n),r.totalMl+=n.totalShipmentMl,r.avgMl+=n.monthlyAvgMl,r.stockL=n.currentStockL,r.months=n.monthsRemaining}for(const[,n]of t)n.avgMl>0&&(n.months=Math.round(n.stockL*1e3/n.avgMl*10)/10);return`<div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:16px;">${lt.filter(n=>t.has(n)).map(n=>{const i=t.get(n),r=Ue[n]??"#9ca3af",c=Ia(i.months),p=Pc(i.months),u=Math.min(i.months/6*100,100);return`
        <div class="card" style="border-top:3px solid ${r};min-width:220px;flex:1;">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;font-size:12px;margin-bottom:8px;">
            <div><span style="color:#6b7280;">現在庫</span><br><strong>${_e(i.stockL)}L</strong></div>
            <div><span style="color:#6b7280;">月平均移出</span><br><strong>${me(i.avgMl)}L</strong></div>
          </div>
      ...
      `}).join("")}</div>`}function Ec(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=new Map;for(const i of e)t.has(i.brewCategory)||t.set(i.brewCategory,[]),t.get(i.brewCategory).push(i);const s=`
    <tr>
  ...
  `,n=[];for(const i of lt){const r=t.get(i);if(!r)continue;const c=Ue[i]??"#9ca3af",p=r.length>1,u=r.reduce((l,d)=>l+d.totalShipmentQty,0),y=r.reduce((l,d)=>l+d.totalShipmentMl,0),f=r.reduce((l,d)=>l+d.monthlyAvgQty,0),v=r.reduce((l,d)=>l+d.monthlyAvgMl,0),b=r.reduce((l,d)=>l+d.productCount,0),x=r[0].currentStockL,k=v>0?Math.round(x*1e3/v*10)/10:0,o=Ia(k);if(n.push(`
      <tr style="font-weight:600;background:#f9fafb;cursor:${p?"pointer":"default"};" ${p?`data-toggle-cat="${i}"`:""}>
        ...
        <td style="text-align:right;">${_e(u)}</td>
        <td style="text-align:right;">${me(y)}</td>
        <td style="text-align:right;">${_e(f)}</td>
        <td style="text-align:right;">${me(v)}</td>
        <td style="text-align:right;">${_e(x)}</td>
    ...
    `),p)for(const l of r)n.push(`
          <tr class="sub-row-${i.replace(/[^a-zA-Z0-9]/g,"_")}" style="display:none;font-size:12px;">
            ...
            <td style="text-align:right;">${_e(l.totalShipmentQty)}</td>
            <td style="text-align:right;">${me(l.totalShipmentMl)}</td>
            <td style="text-align:right;">${_e(l.monthlyAvgQty)}</td>
            <td style="text-align:right;">${me(l.monthlyAvgMl)}</td>
  ...
  `}function Lc(e){const t=new Map;for(const n of e)t.has(n.brewCategory)||t.set(n.brewCategory,{avgMl:0,stockL:n.currentStockL}),t.get(n.brewCategory).avgMl+=n.monthlyAvgMl;return`
    <div class="card" style="margin-bottom:16px;">
      ...
      ${lt.filter(n=>t.has(n)).map(n=>{const i=t.get(n),r=i.avgMl>0?Math.round(i.stockL*1e3/i.avgMl*10)/10:0,c=Ue[n]??"#9ca3af",p=Ia(r),u=Math.min(r/8*100,100);return`
  ...
  `}function Dc(e,t){if(e.length===0)return"";const s=new Map;for(const i of e)s.has(i.brewCategory)||s.set(i.brewCategory,[]),s.get(i.brewCategory).push(i);return`
    <div class="card" style="margin-bottom:16px;">
      ...
      ${lt.filter(i=>s.has(i)).map(i=>{const r=s.get(i),c=Ue[i]??"#9ca3af",p=r.filter(b=>!t.has(b.productCode)),u=p.reduce((b,x)=>b+x.annualMl,0),y=p.reduce((b,x)=>b+x.annualQty,0),f=p.reduce((b,x)=>b+x.monthlyAvgMl,0),v=r.map(b=>{const x=t.has(b.productCode);return`
          <tr style="${x?"opacity:0.4;text-decoration:line-through;":""}">
            <td style="width:36px;text-align:center;">
              <input type="checkbox" data-action="brew-product-toggle" data-code="${b.productCode}"
                ${x?"":"checked"} style="cursor:pointer;" />
            </td>
            <td style="font-size:11px;color:var(--text-secondary);">${b.productCode}</td>
            <td style="white-space:nowrap;max-width:200px;overflow:hidden;text-overflow:ellipsis;" title="${b.productName}">${b.productName}</td>
            <td style="font-size:11px;color:var(--text-secondary);">${b.subCategory}</td>
            <td style="text-align:right;">${b.volumeMl?b.volumeMl+"ml":"—"}</td>
            <td style="text-align:right;">${_e(b.annualQty)}</td>
            <td style="text-align:right;">${me(b.annualMl)}</td>
            <td style="text-align:right;">${_e(b.monthlyAvgQty)}</td>
            <td style="text-align:right;">${me(b.monthlyAvgMl)}</td>
          </tr>
        `}).join("");return`
        <div style="margin-bottom:20px;">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
            <span style="display:inline-block;width:12px;height:12px;border-radius:3px;background:${c};"></span>
            <h4 style="margin:0;font-size:14px;">${i}</h4>
            <span style="font-size:12px;color:var(--text-secondary);">
              ${p.length}/${r.length}銘柄 ・ 年間${me(u)}L ・ 月平均${me(f)}L
              ${t.size>0&&r.some(b=>t.has(b.productCode))?`<span style="color:#b7791f;">（${r.length-p.length}銘柄除外中）</span>`:""}
            </span>
          </div>
          <div class="table-wrap">
            <table class="data-table" style="font-size:12px;">
              ...
              <tfoot>
                <tr style="font-weight:600;background:var(--surface-alt);">
                  ...
                  <td></td>
                  <td></td>
                  <td style="text-align:right;">${_e(y)}</td>
  ...
  `}function qc(e,t,s,n=[],i=new Set){const r=new Date,c=r.getMonth()>=9?r.getFullYear():r.getFullYear()-1,p=Array.from({length:5},(y,f)=>{const v=c-f;return`<option value="${v}" ${v===s?"selected":""}>${v}年度 (${v}/10-${v+1}/9)</option>`}).join(""),u=e.length===0&&t.length===0?'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます...</p></div></section>':"";return u||`
    <section class="panel">
  ...
  `}function la(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e4?`${Math.round(e/1e4)}万`:new Intl.NumberFormat("ja-JP").format(e)+"円"}function Ic(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function In(e){return e?Tt.find(t=>t.value===e)?.label??e:""}function Tc(e){const t=[],s=[],n=[];for(const i of e){const r=i.amount_last_year_same_month>0?i.amount_this_month/i.amount_last_year_same_month:1,c={code:i.customer_code,name:i.customer_name,businessType:i.business_type,areaCode:i.area_code,phone:i.phone,lastOrderDate:i.last_order_date,daysSinceLastOrder:i.days_since_order,totalAmountLast12m:i.amount_12m,amount3m:i.amount_3m,amountThisMonth:i.amount_this_month,amountLastYearSameMonth:i.amount_last_year_same_month,annualRevenue:i.annual_revenue,yoyRatio:r,status:"dormant"};i.is_at_risk?t.push({...c,status:"at-risk"}):i.is_dormant?s.push({...c,status:"dormant"}):i.amount_last_year_same_month>0&&r<.8&&n.push({...c,status:"declining"})}return t.sort((i,r)=>r.totalAmountLast12m-i.totalAmountLast12m),s.sort((i,r)=>r.daysSinceLastOrder-i.daysSinceLastOrder),n.sort((i,r)=>i.yoyRatio-r.yoyRatio),{atRiskCustomers:t,dormantCustomers:s,decliningCustomers:n}}function Nc(e,t){const s=t?.reason??"",n=Tt.map(i=>`<option value="${i.value}" ${s===i.value?"selected":""}>${i.label}</option>`).join("");return`
    <select
    ...
    >
      ...
      ${n}
    </select>`}function Mc(e,t){const s={"at-risk":{label:"離反リスク",cls:"danger"},dormant:{label:"休眠",cls:"warning"},declining:{label:"下落中",cls:"info"}}[e.status],n=e.status==="declining"&&e.amountLastYearSameMonth>0?`<td class="numeric" style="color:var(--color-danger);font-weight:700;">${Math.round(e.yoyRatio*100)}%</td>`:e.status==="dormant"?`<td class="numeric" style="color:var(--color-warning);">${e.daysSinceLastOrder}日</td>`:'<td class="numeric" style="color:var(--color-danger);">今月未注文</td>',i=!!t?.actionedAt,r=i?'style="opacity:0.45;"':"",c=t?.reason?`<br><span class="status-pill info" style="font-size:0.72rem;">${In(t.reason)}</span>`:"";return`
    ...
    </tr>`}function Ut(e,t,s,n,i,r,c,p){if(i.length===0)return"";const u=i.map(y=>Mc(y,p.get(y.code))).join("");return`
    <section class="panel" id="${e}-section">
      <div class="panel-header">
        <div>
          <h2><span class="status-pill ${n}" style="margin-right:8px;">${i.length}社</span>${t}</h2>
          <p class="panel-caption">${s} — 対象売上合計: ${Ic(r)}</p>
        </div>
      </div>
      <div class="table-wrap">
    ...
    <\/script>`}const Se=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],ca={"year-round":"通年品",seasonal:"季節品","year-end":"歳暮品"},xe={"year-round":"#0F5B8D",seasonal:"#2f855a","year-end":"#c05621"};function Oc(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function jc(e){const t=e.reduce((r,c)=>r+c,0);if(t===0)return"year-round";if((e[10]+e[11])/t>.5)return"year-end";const n=Math.max(...e);return e.filter(r=>r>n*.1).length<=6?"seasonal":"year-round"}function Fc(e){const t=e.reduce((r,c)=>r+c,0);if(t===0)return[];const n=t/12*1.5,i=[];for(let r=0;r<12;r++)e[r]>n&&i.push(r);if(i.length===0){const r=Math.max(...e);r>0&&i.push(e.indexOf(r))}return i.sort((r,c)=>r-c)}function zc(e){return e.length===0?0:(e[0]-2+12)%12}function ms(e){const t=new Date().getMonth(),s=e.map(i=>{const r=jc(i.monthlyQuantity),c=Fc(i.monthlyQuantity),p=zc(c);return{code:i.code,name:i.name,category:i.category,peakMonths:c,proposalStartMonth:p,seasonType:r,monthlyQuantity:i.monthlyQuantity}}),n=[];for(let i=0;i<12;i++){const r=s.filter(c=>{if(c.peakMonths.length===0)return!1;const p=c.proposalStartMonth,u=c.peakMonths[0];return p<=u?i>=p&&i<=u:i>=p||i<=u});n.push({month:i,products:r,targetCustomers:[]})}return{products:s,proposals:n,selectedMonth:t}}function Bc(e){const{products:t,proposals:s,selectedMonth:n}=e,i=new Date().getMonth(),r={"year-round":[],seasonal:[],"year-end":[]};t.forEach(v=>r[v.seasonType].push(v));const c=s[n],p=t.length,u=c?.products.length??0,y=t.filter(v=>v.peakMonths.includes(n)).length,f=c?.targetCustomers.length??0;return`
<div class="panel">
  <div class="page-head">
    <div>
  ...
  <div style="display:flex;gap:4px;margin-bottom:1.5rem;flex-wrap:wrap">
    ${Se.map((v,b)=>{const x=b===i,k=b===n;return`<button class="button" style="padding:4px 10px;background:${k?"#0F5B8D":x?"#e2e8f0":"transparent"};color:${k?"#fff":"#333"};border:${x&&!k?"2px solid #0F5B8D":"1px solid #cbd5e0"};border-radius:4px;font-size:0.8rem;cursor:pointer" data-action="select-month" data-month="${b}">${v}${x?" ●":""}</button>`}).join("")}
  </div>
      ...
      <table style="width:100%;border-collapse:collapse;font-size:0.8rem">
        <thead>
          <tr>
            ...
            ${Se.map((v,b)=>`<th style="text-align:center;padding:6px 2px;border-bottom:2px solid #e2e8f0;min-width:36px;${b===i?"background:#f0f7ff;":""}">${v.replace("月","")}</th>`).join("")}
          </tr>
        </thead>
        <tbody>
          ${Vc(r,i)}
  ...
  ${Yc(c)}
</div>`}function Vc(e,t){const s=[],n=["year-round","seasonal","year-end"];for(const i of n){const r=e[i];if(r.length!==0){s.push(`<tr><td colspan="14" style="padding:8px 8px 4px;font-weight:600;background:#f7fafc;border-bottom:1px solid #e2e8f0">
      <span class="status-pill" style="background:${xe[i]}15;color:${xe[i]};padding:2px 8px;border-radius:9px;font-size:0.75rem">${ca[i]}</span>
    </td></tr>`);for(const c of r){const p=Se.map((u,y)=>{const f=c.peakMonths.includes(y),v=Tn(c,y),b=y===t?"outline:2px solid #0F5B8D;outline-offset:-1px;":"";let x="transparent";f?x=xe[c.seasonType]:v&&(x=xe[c.seasonType]+"40");const k=f||v?`background:${x};border-radius:3px;height:18px;width:100%;`:"";return`<td style="padding:2px;text-align:center;${b}"><div style="${k}" title="${f?"ピーク":v?"提案期間":""}"></div></td>`}).join("");s.push(`<tr style="border-bottom:1px solid #f0f0f0">
        ...
        <td style="padding:6px 8px">${u.peakMonths.map(b=>Se[b]).join(", ")}</td>
      </tr>`}).join("");return`
    <div class="table-wrap" style="margin-bottom:1rem">
      <h4 style="margin-bottom:0.5rem;display:flex;align-items:center;gap:8px">
        <span class="status-pill" style="background:${xe[i]}15;color:${xe[i]}">${ca[i]}</span>
        <span style="font-size:0.85rem;color:#666">${Se[t]}の対象: ${c.length}品</span>
      </h4>
      <table style="width:100%;border-collapse:collapse;font-size:0.8rem">
        <thead>
    ...
    </div>`}).filter(Boolean);return n.length===0?`<div style="padding:1rem;color:#666;text-align:center">${Se[t]}に提案対象の商品はありません</div>`:n.join("")}function Yc(e){return!e||e.targetCustomers.length===0?`
  ...
  <div class="table-wrap" style="margin-top:1rem">
    ...
    <tr style="border-bottom:1px solid #f0f0f0">
      ...
      <td class="mono numeric" style="padding:6px 8px">${Oc(s.lastYearAmount)}</td>
  ...
  `).join("")}</tbody>
  ...
  </div>`}const Uc=["日","月","火","水","木","金","土"];function Qc(e){const[t,s]=e.split("-").map(Number),n=new Date(t,s-1,1),i=new Date(t,s,0),r=[];for(let c=0;c<n.getDay();c++)r.push({outside:!0});for(let c=1;c<=i.getDate();c++)r.push({date:`${e}-${String(c).padStart(2,"0")}`});for(;r.length%7!==0;)r.push({outside:!0});return r}function Hc(e,t,s){const[n,i]=t.split("-").map(Number),r=new Date(n,i-2,1),c=new Date(n,i,1),p=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`,u=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`,y=new Date().toISOString().slice(0,10),v=Qc(t).map(o=>{if(o.outside)return'<div class="sc-cell sc-outside"></div>';const l=o.date,d=Number(l.split("-")[2]),m=new Date(`${l}T00:00:00`).getDay(),g=e?.[l],$=l===y,w=l===s;let A="",S="";return g&&(A=`<span class="sc-badge">${g.count}件</span>`,S=g.cityGroups.slice(0,3).map(C=>`<span class="sc-city-tag">${C.city}<em>${C.count}</em></span>`).join(""),g.cityGroups.length>3&&(S+=`<span class="sc-city-more">+${g.cityGroups.length-3}</span>`)),`
    ...
    `}).join(""),b=s&&e?.[s]?Gc(e[s]):s?`<div class="sc-detail-empty"><p>📦 ${s.slice(5)} は出荷なし</p></div>`:'<div class="sc-detail-empty"><p>日付を選択すると出荷先一覧が表示されます</p></div>',x=Object.values(e??{}).reduce((o,l)=>o+l.count,0),k=Object.values(e??{}).reduce((o,l)=>o+l.totalAmount,0);return`
      ...
      <div class="sc-body">
        <div class="sc-calendar-col">
          <div class="sc-weekdays">
            ${Uc.map((o,l)=>`<div class="sc-weekday ${l===0?"sc-sun":l===6?"sc-sat":""}">${o}</div>`).join("")}
          </div>
          <div class="sc-grid">
  ...
  `}function Gc(e){const t=e.date.replace(/-/g,"/").slice(5),s={};for(const i of e.entries)(s[i.city]??=[]).push(i);const n=Object.entries(s).sort((i,r)=>r[1].length-i[1].length).map(([i,r])=>{const c=r.sort((p,u)=>u.amount-p.amount).map(p=>`
    ...
    ${n}
  `}const Xc=new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}),Qt=["月","火","水","木","金"],ys=6;function Kc(e,t){if(!e)return 9999;const s=new Date(e);return isNaN(s.getTime())?9999:Math.floor((t.getTime()-s.getTime())/(1e3*60*60*24))}function Wc(e,t){if(t.length===0)return 0;const s=[...t].sort((i,r)=>i-r);return s.filter(i=>i<=e).length/s.length}function Zc(e,t){return e.includes("離反リスク")?"緊急訪問 - 離反防止ヒアリング":e.includes("季節提案タイミング")?"季節商品の提案・試飲サンプル持参":t>30?"定期巡回 - 状況確認・追加注文確認":"関係維持 - ご挨拶"}function hs(e){const t=new Date,s=e.map(u=>u.annualRevenue),n=e.map(u=>{const y=Kc(u.lastOrderDate,t);let f=0;const v=[];y>=60&&(f+=50,v.push("離反リスク")),u.hasSeasonalProposal&&(f+=30,v.push("季節提案タイミング")),y>=30&&y<60&&(f+=20,v.push("定期巡回"));const b=Wc(u.annualRevenue,s),x=Math.round(b*20);x>0&&(f+=x,v.push("金額ウェイト"));const k=Zc(v,y);return{code:u.code,name:u.name,phone:u.phone,address:u.address1,areaCode:u.areaCode,businessType:u.businessType,priorityScore:f,reasons:v,lastOrderDate:u.lastOrderDate,daysSinceOrder:y,annualRevenue:u.annualRevenue,recommendedAction:k}}).filter(u=>u.priorityScore>0).sort((u,y)=>y.priorityScore-u.priorityScore),i=new Map;for(const u of n){const y=u.areaCode||"その他";i.has(y)||i.set(y,[]),i.get(y).push(u)}const r=[...i.entries()].sort((u,y)=>y[1].reduce((f,v)=>f+v.priorityScore,0)-u[1].reduce((f,v)=>f+v.priorityScore,0)),c=[];let p=0;for(const[u,y]of r){const f=y.sort((v,b)=>b.priorityScore-v.priorityScore);for(let v=0;v<f.length&&!(p>=Qt.length);v+=ys){const b=f.slice(v,v+ys);c.push({dayLabel:Qt[p],area:u,visits:b}),p++}if(p>=Qt.length)break}return{candidates:n,weekPlan:c,filterArea:"",filterMinScore:0}}function ed(e){const{candidates:t,weekPlan:s,filterArea:n,filterMinScore:i}=e,r=t.filter(v=>!(n&&v.areaCode!==n||i>0&&v.priorityScore<i)),c=Array.from(new Set(t.map(v=>v.areaCode))).sort(),p=r.length,u=r.filter(v=>v.priorityScore>=50).length,y=r.filter(v=>v.reasons.includes("離反リスク")).length,f=s.reduce((v,b)=>v+b.visits.length,0);return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      ${s.length===0?"<p>訪問候補がありません。</p>":td(s)}
    </section>
  ...
  `}function ad(e){return`
    <tr>
      ...
      <td class="numeric">${Xc.format(e.annualRevenue)}</td>
      <td>${e.recommendedAction}</td>
    </tr>
  `}function sd(e){const t={empty:"空",in_use:"使用中",aging:"熟成中"},s={empty:"neutral",in_use:"warning",aging:"success"},n=e.map(y=>{const f=y.capacity>0?Math.round(y.currentVolume/y.capacity*100):0;return`
        <tr>
  ...
  `}function Ht(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function nd(e,t,s){const n=e.rows.map((y,f)=>`
      <tr>
...
</svg>`,ud=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
  <circle cx="14" cy="14" r="13" stroke="currentColor" stroke-width="1.5"/>
...
`)}`,c=new Blob([r],{type:"text/csv;charset=utf-8;"}),p=URL.createObjectURL(c),u=document.createElement("a");u.href=p,u.download=e,document.body.append(u),u.click(),u.remove(),window.setTimeout(()=>URL.revokeObjectURL(p),0)}const pd=Object.fromEntries(Tt.map(e=>[e.value,e.label])),md=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/invoice-entry","/quote","/quote-settings","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser","/demand-forecast","/churn-alert","/seasonal-calendar","/visit-planner","/demand","/shipment-calendar","/brewing-plan"];let Be=[];async function yd(){const{supabaseQueryAll:e}=await E(async()=>{const{supabaseQueryAll:s}=await Promise.resolve().then(()=>B);return{supabaseQueryAll:s}},void 0);Be=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(s=>typeof s.email=="string"&&s.email.length>0).map(s=>({name:String(s.name??""),email:String(s.email??""),area:String(s.delivery_area_code??""),historySegment:"seasonal"}))}const vs=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"},{path:"/churn-alert",title:"離反アラート・休眠顧客"},{path:"/seasonal-calendar",title:"季節提案カレンダー"},{path:"/visit-planner",title:"訪問計画・ルート最適化"},{path:"/demand",title:"需要分析・安全在庫・生産計画"},{path:"/shipment-calendar",title:"出荷カレンダー"},{path:"/brewing-plan",title:"醸造計画"}];function Nn(e){const t=va[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function Ta(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function hd(){const e=Nn("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const Mt=new Date,fd=Mt.toISOString().slice(0,7),vd=Mt.getFullYear(),gd=Mt.getMonth()+1,bd=Mt.toISOString().slice(0,10),$d="C0011",Ee=hd();function Mn(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",s=e.startsWith(t)?e.slice(t.length)||"/":e;return md.includes(s)?s:"/"}function Na(e){switch(e){case"/invoice-entry":case"/quote":case"/quote-settings":case"/delivery":case"/billing":case"/invoice":case"/ledger":case"/shipment-calendar":return"sales";case"/analytics":case"/customer-analysis":case"/product-power":case"/customer-efficiency":case"/report":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":case"/churn-alert":case"/seasonal-calendar":case"/visit-planner":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":case"/demand":case"/brewing-plan":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const gs=Mn(location.pathname),a={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:Ta(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:fd,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:vd,taxMonth:gd,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],mapCustomers:[],callLogs:[],mapFilters:{filterStatus:"all",filterArea:"",filterBiz:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...nc,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...oc},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:bd,route:gs,currentCategory:Na(gs),sidebarOpen:!1,announcements:[],dismissedAnnouncements:new Set,updateAvailable:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:$d,salesPeriod:"month",customRange:{start:"",end:""},quoteState:La(ta()),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,quoteList:[],quoteListLoading:!1,quoteEditId:null,quoteCompanySettings:ta(),productPower:[],productFilter:"all",productPeriod:"year",productDaily:[],productCustomStart:"",productCustomEnd:"",productSortState:[],customerSortState:[],dashboardSortState:[],masterSortState:[],analyticsSortState:[],customerEfficiency:[],masterTab:"customers",masterFilter:{...Da},analyticsTab:"products",analyticsPeriod:"all",analyticsPeriodFilter:"",analyticsPeriodRows:[],analyticsPeriodChartData:[],analyticsPrevYearChartData:[],analyticsChartMetric:"amount",analyticsFiscalMode:"calendar",analyticsPeriodOptions:[],analyticsStaffFilter:"",analyticsTagFilter:"",analyticsStaffPeriod:"all",analyticsStaffPeriodFilter:"",analyticsStaffPeriodOptions:[],analyticsStaffTotals:[],analyticsStaffDrilldown:null,analyticsDrilldown:null,emailAudienceMode:Ee.mode,emailRegion:Ee.region,emailHistorySegment:Ee.historySegment,emailTemplateId:Ee.templateId,emailSubject:Ee.subject,emailBody:Ee.body,emailSaveMessage:Ee.saveMessage,emailSending:!1,demandForecast:{...Zi},shipmentCalendarData:null,shipmentCalendarYearMonth:new Date().toISOString().slice(0,7),shipmentCalendarSelectedDate:null,churnAlert:null,churnNotes:[],seasonalCalendar:null,visitPlanner:null,demandAnalysis:null,safetyStockParams:[],productionPlan:[],demandTab:"demand",demandPlanYearMonth:new Date().toISOString().slice(0,7),demandYearsBack:3,demandPlanTypeFilter:"monthly",brewingPlanData:[],brewingMonthlyTrend:[],brewingPlanFY:(()=>{const e=new Date;return e.getMonth()>=9?e.getFullYear():e.getFullYear()-1})(),demandSort:null,calendarShifts:St(new Date().toISOString().slice(0,7),1,1),calendarDefaultPart:1,calendarDefaultEmp:1,calendarSelectedDate:null,brewingSchedule:[],brewingProductDetail:[],brewingExcludedProducts:new Set,globalSearchOpen:!1,globalQuery:"",orderHeaders:[],authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function bs(e){return e.slice(0,10)}function _d(e){return{...e}}function Et(){a.pickerMode=null,a.pickerQuery="",a.pickerTargetLine=null}function Rn(){a.invoiceForm=Ta(),a.invoiceSavedDocNo=null,a.invoicePriceGroup="",a.invoiceErrors={},Et()}function On(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((s,n)=>{s.productCode.trim()||(t[`lines.${n}.productCode`]="商品コードは必須です。"),s.productName.trim()||(t[`lines.${n}.productName`]="商品名は必須です。"),s.quantity<=0&&(t[`lines.${n}.quantity`]="数量は1以上を入力してください。"),s.unitPrice<0&&(t[`lines.${n}.unitPrice`]="単価は0円以上で入力してください。")}),t}function wd(e){const t=a.invoiceForm.lines[e];t&&a.invoiceForm.lines.splice(e+1,0,_d(t))}function xd(){const e=a.invoiceRecords[0],t=a.masterStats?.customers[0],s=a.masterStats?.products.slice(0,2)??[];a.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:a.invoiceForm.staffCode||"S001",lines:s.map((n,i)=>{const r=i===0?1:2,c=1200*(i+1);return{productCode:n.code,productName:n.name,quantity:r,unitPrice:c,unit:"本",amount:r*c}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},a.invoiceSavedDocNo=null,a.invoiceErrors={}}function Sd(e){const t=a.masterStats?.customers.find(s=>s.code.toLowerCase()===e.trim().toLowerCase());return t?(a.invoiceForm.customerCode=t.code,a.invoiceForm.customerName=t.name,a.invoicePriceGroup=t.priceGroup||"",!0):!1}function kd(e){const t=a.masterStats?.customers.find(s=>s.name===e.trim());return t?(a.invoiceForm.customerCode=t.code,a.invoiceForm.customerName=t.name,a.invoicePriceGroup=t.priceGroup||"",!0):!1}function jn(e){if(be(e),a.invoiceErrors=On(a.invoiceForm),Object.keys(a.invoiceErrors).length>0){_();return}a.invoiceSaving=!0,_(),Ts(a.invoiceForm).then(t=>{a.invoiceSavedDocNo=t.documentNo,a.invoiceSaving=!1,a.invoiceErrors={},a.invoiceForm=Ta(),_()}).catch(()=>{a.invoiceSaving=!1,_()})}function Fn(e){const t=a.salesFilter.startDate?new Date(a.salesFilter.startDate):null,s=a.salesFilter.endDate?new Date(`${a.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((n,i)=>new Date(i.date).getTime()-new Date(n.date).getTime()).filter(n=>{const i=new Date(n.date);return!(t&&i<t||s&&i>s)})}function zn(){switch(a.emailAudienceMode){case"area":return a.emailRegion==="all"?Be:Be.filter(e=>e.area===a.emailRegion);case"history":return Be.filter(e=>e.historySegment===a.emailHistorySegment);default:return Be}}function Pd(){const e=zn();return{audienceMode:a.emailAudienceMode,region:a.emailRegion,historySegment:a.emailHistorySegment,selectedTemplateId:a.emailTemplateId,subject:a.emailSubject,body:a.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:a.emailSaveMessage,sending:a.emailSending,senderId:a.emailSenderId,senders:a.mailSenders}}function Gt(e){const t=zn(),s=a.emailAudienceMode==="area"?a.emailRegion:a.emailAudienceMode==="history"?a.emailHistorySegment:"all";return{subject:a.emailSubject.trim(),body:a.emailBody.trim(),templateId:a.emailTemplateId,audienceMode:a.emailAudienceMode,audienceFilter:s,recipientCount:t.length,recipients:t.map(n=>n.email),status:e}}function Ma(){return a.user,!1}function it(){a.globalSearchOpen=!1,a.globalQuery=""}function Ad(){const e=a.globalQuery.trim().toLowerCase();return e?{customers:a.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:a.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:a.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:vs.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:vs}}function Cd(){let e=[],t,s="export.csv";switch(a.route){case"/sales":e=(a.salesSummary?Fn(a.salesSummary):[]).map(n=>({documentNo:n.documentNo,date:n.date,customerCode:n.customerCode,customerName:n.customerName,amount:n.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],s="sales.csv";break;case"/payment":e=[...a.paymentStatus?.records??[]].sort((n,i)=>i.balanceAmount-n.balanceAmount).map(n=>({...n})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],s="payment-status.csv";break;case"/invoice":e=a.invoiceRecords.map(n=>({...n})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],s="invoices.csv";break;case"/purchase":e=a.purchaseList.map(n=>({...n})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],s="purchase.csv";break;case"/jikomi":e=a.jikomiList.map(n=>({...n})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],s="jikomi.csv";break;case"/tanks":e=a.tankList.map(n=>({...n})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],s="tanks.csv";break;case"/kentei":e=a.kenteiList.map(n=>({...n})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],s="kentei.csv";break;case"/materials":e=a.materialList.map(n=>({...n})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],s="materials.csv";break;case"/master":a.masterTab==="customers"?(e=a.masterStats?.customers.map(n=>({...n}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],s="master-customers.csv"):(e=a.masterStats?.products.map(n=>({...n}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],s="master-products.csv");break;default:return}ua(s,e,t)}function $s(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),a.route=e,a.currentCategory=Na(e),a.sidebarOpen=!1,it(),Ra(e)}async function Ra(e){a.actionLoading=!0,_();try{switch(e){case"/quote":a.quoteEditId===null&&a.quoteList.length===0&&(a.quoteListLoading=!0,_(),a.quoteList=await Ea(),a.quoteListLoading=!1);break;case"/invoice":a.invoiceRecords.length===0&&(a.invoiceRecords=await ot(a.invoiceFilter));break;case"/analytics":(!a.salesAnalytics||a.salesAnalytics.monthlySales.length===0)&&(a.salesAnalytics=await $a());break;case"/delivery":a.deliveryNote||(a.deliveryNote=await _a(a.deliverySearchDocNo));break;case"/shipment-calendar":{const{fetchShipmentCalendar:t}=await E(async()=>{const{fetchShipmentCalendar:s}=await Promise.resolve().then(()=>q);return{fetchShipmentCalendar:s}},void 0);a.shipmentCalendarData=await t(a.shipmentCalendarYearMonth);break}case"/billing":a.billingSummary||(a.billingSummary=await wa(a.billingYearMonth));break;case"/report":a.salesReport||(a.salesReport=await qt());break;case"/product-power":a.productPower.length===0&&(a.productPower=await js());break;case"/customer-efficiency":a.customerEfficiency.length===0&&(a.customerEfficiency=await Fs());break;case"/customer-analysis":a.customerAnalysis||(a.customerAnalysis=await zs());break;case"/demand-forecast":if(a.demandForecast.forecasts.length===0){const{fetchDemandForecasts:t,fetchDeliverySchedule:s}=await E(async()=>{const{fetchDemandForecasts:r,fetchDeliverySchedule:c}=await Promise.resolve().then(()=>q);return{fetchDemandForecasts:r,fetchDeliverySchedule:c}},void 0),[n,i]=await Promise.all([t(),s()]);a.demandForecast.forecasts=n.map(r=>({code:r.productCode,name:r.productName,segment:r.segment,monthlyQuantity:new Array(12).fill(0),avgMonthly:Math.round(r.avgMonthly),adjustedAvg:Math.round(r.avgMonthly),nextMonthForecast:Math.round(r.forecastQuantity),annualForecast:Math.round(r.avgMonthly*12),safetyStock:Math.round(r.safetyStock)})),a.demandForecast.deliveries=er(i)}break;case"/churn-alert":{const{fetchChurnAlerts:t,fetchChurnNotes:s}=await E(async()=>{const{fetchChurnAlerts:n,fetchChurnNotes:i}=await Promise.resolve().then(()=>q);return{fetchChurnAlerts:n,fetchChurnNotes:i}},void 0);if(!a.churnAlert){const n=await t();a.churnAlert=Tc(n)}a.churnNotes=await s();break}case"/seasonal-calendar":if(!a.seasonalCalendar){const{fetchProductShipmentsFromTable:t}=await E(async()=>{const{fetchProductShipmentsFromTable:n}=await Promise.resolve().then(()=>q);return{fetchProductShipmentsFromTable:n}},void 0),s=await t();if(s.length>0)a.seasonalCalendar=ms(s.map(n=>({code:n.code,name:n.name,category:"",monthlyQuantity:n.monthlyQuantity})));else{const{fetchProductMonthlyShipments:n}=await E(async()=>{const{fetchProductMonthlyShipments:r}=await Promise.resolve().then(()=>q);return{fetchProductMonthlyShipments:r}},void 0),i=await n();a.seasonalCalendar=ms(i.map(r=>({code:r.code,name:r.name,category:"",monthlyQuantity:r.monthlyQuantity})))}}break;case"/visit-planner":if(!a.visitPlanner){const{fetchVisitPriorities:t}=await E(async()=>{const{fetchVisitPriorities:n}=await Promise.resolve().then(()=>q);return{fetchVisitPriorities:n}},void 0),s=await t();if(s.length>0)a.visitPlanner={candidates:s.map(n=>({code:n.customer_code,name:n.customer_name,phone:n.phone,address:n.address,areaCode:n.area_code,businessType:n.business_type,priorityScore:n.priority_score,reasons:n.reasons,lastOrderDate:n.last_order_date,daysSinceOrder:n.days_since_order,annualRevenue:n.annual_revenue,recommendedAction:n.recommended_action})),weekPlan:[],filterArea:"",filterMinScore:0},a.visitPlanner=hs(s.map(n=>({code:n.customer_code,name:n.customer_name,phone:n.phone,address1:n.address,areaCode:n.area_code,businessType:n.business_type,annualRevenue:n.annual_revenue,lastOrderDate:n.last_order_date,hasSeasonalProposal:n.reasons.some(i=>i.includes("季節"))})));else{const{supabaseQueryAll:n}=await E(async()=>{const{supabaseQueryAll:u}=await Promise.resolve().then(()=>B);return{supabaseQueryAll:u}},void 0),[i,r]=await Promise.all([n("sales_document_headers",{select:"sales_date,legacy_customer_code,total_amount"}),a.masterStats?Promise.resolve(a.masterStats.customers):ga().then(u=>u.customers)]),c=a.masterStats?.customers??r,p=new Map;i.forEach(u=>{const y=u.legacy_customer_code||"",f=u.sales_date||"",v=Number(u.total_amount)||0,b=p.get(y);!b||f>b.lastDate?p.set(y,{lastDate:f,total:(b?.total??0)+v}):b.total+=v}),a.visitPlanner=hs(c.filter(u=>u.isActive).map(u=>({code:u.code,name:u.name,phone:u.phone,address1:u.address1,areaCode:u.areaCode,businessType:u.businessType,annualRevenue:p.get(u.code)?.total??0,lastOrderDate:p.get(u.code)?.lastDate??"",hasSeasonalProposal:!1})))}}break;case"/demand":{const{fetchDemandAnalysis:t,fetchSafetyStockParams:s,fetchProductionPlan:n}=await E(async()=>{const{fetchDemandAnalysis:i,fetchSafetyStockParams:r,fetchProductionPlan:c}=await Promise.resolve().then(()=>q);return{fetchDemandAnalysis:i,fetchSafetyStockParams:r,fetchProductionPlan:c}},void 0);if(!a.demandAnalysis){const[i,r]=await Promise.all([t(a.demandYearsBack*12),s()]);a.demandAnalysis=i,a.safetyStockParams=r}if(a.productionPlan.length===0){const i=await n(a.demandPlanYearMonth);if(i.length>0)a.productionPlan=i;else if(a.demandAnalysis&&a.safetyStockParams.length>0){const r=a.demandPlanYearMonth,c=a.demandAnalysis.months.filter(p=>p<r).slice(-3);a.productionPlan=a.safetyStockParams.map(p=>{const u=p.productionType==="make_to_order",y=c.map(x=>a.demandAnalysis.matrix[p.productCode]?.[x]??0),f=u?0:y.length>0?Math.ceil(y.reduce((x,k)=>x+k,0)/y.length):Math.ceil(p.avgMonthlyDemand),v=u?0:Math.ceil(p.safetyStockQty),b=Math.max(0,f+v);return{id:"",yearMonth:r,productCode:p.productCode,productName:p.productName,demandForecast:f,safetyStockTarget:v,openingStock:0,requiredProduction:b,plannedQty:u?0:b,actualQty:0,status:"draft",productionType:p.productionType??"monthly",notes:""}})}}break}case"/brewing-plan":{const{fetchBrewingPlanSummary:t,fetchBrewingMonthlyTrend:s,fetchBrewingSchedule:n,fetchBrewingProductDetail:i}=await E(async()=>{const{fetchBrewingPlanSummary:b,fetchBrewingMonthlyTrend:x,fetchBrewingSchedule:k,fetchBrewingProductDetail:o}=await Promise.resolve().then(()=>q);return{fetchBrewingPlanSummary:b,fetchBrewingMonthlyTrend:x,fetchBrewingSchedule:k,fetchBrewingProductDetail:o}},void 0),r=a.brewingPlanFY,c=`${r}-10-01`,p=`${r+1}-09-30`,[u,y,f,v]=await Promise.all([t(c,p),s(c,p),n(r),i(c,p)]);a.brewingPlanData=u,a.brewingMonthlyTrend=y,a.brewingSchedule=f,a.brewingProductDetail=v;break}case"/jikomi":a.jikomiList.length===0&&(a.jikomiList=await Vs());break;case"/tanks":a.tankList.length===0&&(a.tankList=await Js());break;case"/kentei":a.kenteiList.length===0&&(a.kenteiList=await Ys());break;case"/materials":a.materialList.length===0&&(a.materialList=await Wt());break;case"/purchase":(a.purchaseList.length===0||a.payableList.length===0)&&([a.purchaseList,a.payableList]=await Promise.all([Us(),Qs()]));break;case"/raw-material":(a.billList.length===0||a.rawStockList.length===0)&&([a.billList,a.rawStockList]=await Promise.all([Hs(),Gs()]));break;case"/tax":a.taxDeclaration||(a.taxDeclaration=await Sa(a.taxYear,a.taxMonth));break;case"/store":(a.storeSales.length===0||a.storeOrders.length===0)&&([a.storeSales,a.storeOrders]=await Promise.all([ka(a.storeSalesDate),Ws()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await E(async()=>{const{fetchMailSenders:s}=await Promise.resolve().then(()=>q);return{fetchMailSenders:s}},void 0);if(a.mailSenders=await t(),!a.emailSenderId||!a.mailSenders.find(s=>s.id===a.emailSenderId)){const s=a.mailSenders.find(n=>n.isDefault)??a.mailSenders[0];s&&(a.emailSenderId=s.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await E(async()=>{const{fetchCalendarEvents:s}=await Promise.resolve().then(()=>q);return{fetchCalendarEvents:s}},void 0);a.calendarEvents=await t(a.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await E(async()=>{const{fetchIntegrationSettings:s}=await Promise.resolve().then(()=>q);return{fetchIntegrationSettings:s}},void 0);a.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:s}=await E(async()=>{const{fetchShopifyOrders:n,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>q);return{fetchShopifyOrders:n,fetchIntegrationSettings:i}},void 0);a.shopifyOrders=await t(),a.integrations.length===0&&(a.integrations=await s())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:s}=await E(async()=>{const{fetchFaxInbox:n,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>q);return{fetchFaxInbox:n,fetchIntegrationSettings:i}},void 0);a.faxRecords=await t(),a.integrations.length===0&&(a.integrations=await s())}break;case"/users":{const{fetchUserProfiles:t}=await E(async()=>{const{fetchUserProfiles:s}=await Promise.resolve().then(()=>q);return{fetchUserProfiles:s}},void 0);a.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:s,fetchMailSenders:n}=await E(async()=>{const{fetchMyProfile:r,fetchAuditLogs:c,fetchMailSenders:p}=await Promise.resolve().then(()=>q);return{fetchMyProfile:r,fetchAuditLogs:c,fetchMailSenders:p}},void 0),i=a.user?.email??a.myProfile?.email??"";i&&(a.myProfile=await t(i)),a.mailSenders.length===0&&(a.mailSenders=await n()),a.auditLogs=await s(50)}break;case"/audit":{const{fetchAuditLogs:t}=await E(async()=>{const{fetchAuditLogs:s}=await Promise.resolve().then(()=>q);return{fetchAuditLogs:s}},void 0);a.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await E(async()=>{const{fetchProspects:s}=await Promise.resolve().then(()=>q);return{fetchProspects:s}},void 0);a.prospects=await t()}break;case"/map":{const{fetchMapCustomers:t,fetchDeliveryLocations:s}=await E(async()=>{const{fetchMapCustomers:r,fetchDeliveryLocations:c}=await Promise.resolve().then(()=>q);return{fetchMapCustomers:r,fetchDeliveryLocations:c}},void 0),[n,i]=await Promise.all([t(),s()]);a.mapCustomers=n,a.deliveryLocations=i}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:s}=await E(async()=>{const{fetchCallLogs:n,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>q);return{fetchCallLogs:n,fetchIntegrationSettings:i}},void 0);a.callLogs=await t(100),a.integrations.length===0&&(a.integrations=await s())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:s}=await E(async()=>{const{fetchLeadLists:n,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>q);return{fetchLeadLists:n,fetchIntegrationSettings:i}},void 0);a.leadLists=await t(),a.integrations.length===0&&(a.integrations=await s())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await E(async()=>{const{fetchWorkflowOrdersFromDb:s}=await Promise.resolve().then(()=>q);return{fetchWorkflowOrdersFromDb:s}},void 0);a.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await E(async()=>{const{fetchTourInquiriesFromDb:s}=await Promise.resolve().then(()=>q);return{fetchTourInquiriesFromDb:s}},void 0);a.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:s,fetchIntegrationSettings:n}=await E(async()=>{const{fetchSlackRules:i,fetchSlackLogs:r,fetchIntegrationSettings:c}=await Promise.resolve().then(()=>q);return{fetchSlackRules:i,fetchSlackLogs:r,fetchIntegrationSettings:c}},void 0);a.slackRules=await t(),a.slackLogs=await s(50),a.integrations.length===0&&(a.integrations=await n())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:s,fetchWorkflowOrdersFromDb:n,fetchTourInquiriesFromDb:i,fetchOrderHeaders:r}=await E(async()=>{const{fetchProspects:c,fetchCalendarEvents:p,fetchWorkflowOrdersFromDb:u,fetchTourInquiriesFromDb:y,fetchOrderHeaders:f}=await Promise.resolve().then(()=>q);return{fetchProspects:c,fetchCalendarEvents:p,fetchWorkflowOrdersFromDb:u,fetchTourInquiriesFromDb:y,fetchOrderHeaders:f}},void 0);a.prospects.length===0&&(a.prospects=await t()),a.calendarEvents.length===0&&(a.calendarEvents=await s(a.calendarYearMonth)),a.materialList.length===0&&(a.materialList=await Wt()),a.workflowOrders.length===0&&(a.workflowOrders=await n()),a.tourInquiries.length===0&&(a.tourInquiries=await i()),a.orderHeaders.length===0&&(a.orderHeaders=await r())}break;default:break}}catch(t){console.error("Route data load error:",e,t),D(`データ読み込みエラー: ${t.message??"不明"}`,"error")}finally{a.actionLoading=!1,_()}}function _s(){if(Ma())return Yr(a.authError,a.authSubmitting);if(a.loading)return`
    ...
    `;switch(a.route){case"/cat/sales":return dt("sales");case"/cat/brewery":return dt("brewery");case"/cat/purchase":return dt("purchase");case"/cat/more":return dt("more");case"/invoice-entry":return vr(a.invoiceForm,a.invoiceSavedDocNo,a.invoiceSaving,a.invoiceErrors);case"/quote":return a.quoteEditId===null?xr(a.quoteList,a.quoteListLoading):bn(a.quoteState,a.masterStats?.customers??[],a.masterStats?.products??[],a.quoteCustomerQuery,a.quoteProductQuery,a.quotePricing,a.quoteCompanySettings);case"/quote-settings":return kr(a.quoteCompanySettings);case"/email":return mr(Pd());case"/delivery":return a.deliveryNote?ur(a.deliveryNote,a.deliverySearchDocNo):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/shipment-calendar":return Hc(a.shipmentCalendarData,a.shipmentCalendarYearMonth,a.shipmentCalendarSelectedDate);case"/billing":return a.billingSummary?Ui(a.billingSummary,a.billingYearMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/report":return a.salesReport?xl(a.salesReport):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":return Ir(a.productPower,a.productFilter,a.productDaily,a.productPeriod,a.productCustomStart,a.productCustomEnd,a.productSortState);case"/customer-efficiency":return Tr(a.customerEfficiency,a.customerSortState);case"/customer-analysis":return a.customerAnalysis?yl(a.customerAnalysis):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/demand-forecast":return nr(a.demandForecast);case"/demand":return kc(a.demandAnalysis,a.safetyStockParams,a.productionPlan,a.demandTab,a.demandPlanYearMonth,a.demandYearsBack,a.demandPlanTypeFilter,a.demandSort,a.calendarShifts,a.calendarSelectedDate);case"/brewing-plan":return qc(a.brewingPlanData,a.brewingMonthlyTrend,a.brewingPlanFY,a.brewingProductDetail,a.brewingExcludedProducts);case"/churn-alert":return a.churnAlert?Rc(a.churnAlert,a.churnNotes):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">離反データを分析中…</p></div></section>';case"/seasonal-calendar":return a.seasonalCalendar?Bc(a.seasonalCalendar):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">季節データを分析中…</p></div></section>';case"/visit-planner":return a.visitPlanner?ed(a.visitPlanner):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">訪問計画を生成中…</p></div></section>';case"/jikomi":return a.jikomiView==="calendar"?`${Ka(a.jikomiList,a.jikomiView)}${Br(a.jikomiList)}`:Ka(a.jikomiList,a.jikomiView);case"/tanks":return sd(a.tankList);case"/kentei":return Vr(a.kenteiList);case"/materials":return tl(a.materialList)+el(a.materialEditing,a.materialEditingIsNew);case"/purchase":return il(a.purchaseList,a.payableList);case"/raw-material":return rl(a.billList,a.rawStockList);case"/tax":return a.taxDeclaration?nd(a.taxDeclaration,a.taxYear,a.taxMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/store":return Al(a.storeSales,a.storeOrders,a.storeTab,a.storeSalesDate);case"/setup":return a.pipelineMeta?dl(a.pipelineMeta,se,J,a.syncDashboard):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/raw-browser":return yc(a.rawSelectedTable,a.rawRecords,a.rawTableList,a.rawPage,a.rawTotalCount);case"/import":return El(a.importEntity,a.importPreview,a.importing,a.importResult);case"/print":return cc(a.printTemplate,a.printOptions,a.printCompany,a.printData);case"/form-designer":return Dl(a.printData,a.printCompany,a.printOptions,a.fdSavedPositions,a.fdDesignMode);case"/map":return a.mapCustomers.length===0?'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">マップデータを読み込み中…</p></div></section>':ql(a.mapCustomers,a.deliveryLocations,a.mapFilters);case"/workflow":return Nl(a.workflowOrders);case"/mobile-order":return Ml(a.mobileOrder,a.masterStats?.customers??[],a.masterStats?.products??[]);case"/tour":return Ol(a.tourInquiries,a.tourActiveId);case"/mail-senders":return zl(a.mailSenders,a.mailSenderEditingId);case"/calendar":return Bl(a.calendarEvents,a.calendarYearMonth,a.calendarFilterCategory,a.calendarEdit);case"/integrations":return Jl(a.integrations,a.integrationEditingId);case"/shopify":{const e=a.integrations.find(t=>t.id==="shopify");return Yl(a.shopifyOrders,e?.lastSyncAt??null)}case"/fax":return Ul(a.faxRecords,a.faxProcessing,a.faxOcrText);case"/users":return Ql(a.userProfiles,a.userEditingId,a.myProfile);case"/profile":return Hl(a.myProfile,a.auditLogs.filter(e=>e.userEmail===a.myProfile?.email),a.mailSenders);case"/audit":return Gl(a.auditLogs);case"/prospects":{const e={prospects:a.prospects,activities:a.prospectActivities,editingId:a.prospectEditingId,viewMode:a.prospectViewMode};return Xl(e)}case"/slack":{const e=a.integrations.find(t=>t.provider==="slack")??null;return ec(e,a.slackRules,a.slackLogs)}case"/calls":{const e=a.integrations.find(t=>t.provider==="ivry");return tc(a.callLogs,a.masterStats?.customers??[],e?.lastSyncAt??null,e?.isEnabled??!1)}case"/list-builder":{const e={lists:a.leadLists,activeListId:a.leadActiveListId,items:a.leadItems,searchQuery:a.leadSearchQuery,searchArea:a.leadSearchArea,searchBusinessType:a.leadSearchType,searching:a.leadSearching,searchResults:a.leadSearchResults};return sc(e)}}if(!a.salesSummary||!a.paymentStatus||!a.masterStats||!a.pipelineMeta||!a.customerLedger||!a.salesAnalytics)return"";switch(a.route){case"/sales":return Pl(Fn(a.salesSummary),a.salesFilter.startDate,a.salesFilter.endDate);case"/payment":return nl([...a.paymentStatus.records].sort((e,t)=>t.balanceAmount-e.balanceAmount));case"/master":return Zr(a.masterStats,a.masterTab,a.masterFilter,a.masterSortState);case"/invoice":return Rr(a.invoiceRecords,a.invoiceFilter);case"/ledger":return Ki(a.customerLedger,a.ledgerCustomerCode);case"/analytics":return kn(a.salesAnalytics,a.analyticsTab,a.analyticsPeriod,a.analyticsPeriodFilter,a.analyticsPeriodRows,a.analyticsPeriodOptions,a.analyticsStaffFilter,a.analyticsTagFilter,a.analyticsStaffDrilldown,a.analyticsStaffPeriod,a.analyticsStaffPeriodFilter,a.analyticsStaffPeriodOptions,a.analyticsStaffTotals,a.analyticsSortState,a.analyticsDrilldown,a.analyticsPeriodChartData,a.analyticsPrevYearChartData,a.analyticsChartMetric,a.analyticsFiscalMode);case"/":return Ld();default:return rr(a.salesSummary,a.pipelineMeta,a.salesAnalytics,{upcomingEvents:a.calendarEvents,tourInquiries:a.tourInquiries,workflowOrdersCount:{new:a.workflowOrders.filter(e=>e.stage==="new").length,picking:a.workflowOrders.filter(e=>e.stage==="picking").length,packed:a.workflowOrders.filter(e=>e.stage==="packed").length,shipped:a.workflowOrders.filter(e=>e.stage==="shipped").length,total:a.workflowOrders.length},lowStockCount:a.materialList.filter(e=>e.currentStock<e.minimumStock*1.5).length,masterCounts:a.masterStats?{customers:a.masterStats.summary.customerCount,products:a.masterStats.summary.productCount,suppliers:a.syncDashboard?.tables.find(e=>e.tableName==="suppliers")?.rowCount??0,specialPrices:a.syncDashboard?.tables.find(e=>e.tableName==="customer_product_prices")?.rowCount??0}:void 0,churnSummary:a.churnAlert?{atRiskCount:a.churnAlert.atRiskCustomers.length,dormantCount:a.churnAlert.dormantCustomers.length,decliningCount:a.churnAlert.decliningCustomers.length,totalImpact:[...a.churnAlert.atRiskCustomers,...a.churnAlert.dormantCustomers,...a.churnAlert.decliningCustomers].reduce((e,t)=>e+t.totalAmountLast12m,0)}:void 0,orderHeaders:a.orderHeaders},a.salesPeriod,a.customRange,a.dashboardSortState)}}function Ed(){const e={info:{bg:"#edf6ff",border:"#b8d4e8",icon:"ℹ️"},warning:{bg:"#fff8e6",border:"#e6c54d",icon:"⚠️"},maintenance:{bg:"#fff3e0",border:"#f5a623",icon:"🔧"},update:{bg:"#e8f5e9",border:"#66bb6a",icon:"🆕"}},s=a.announcements.filter(i=>!a.dismissedAnnouncements.has(i.id)).map(i=>{const r=e[i.level]??e.info;return`
      ...
      </div>`:"";return s+n}function Ld(){function e(s,n,i,r){return`<a href="${`${"/".replace(/\/$/,"")||"/"}${s}`}" data-link="${s}" class="home-card">
