(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const c of r)if(c.type==="childList")for(const a of c.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const c={};return r.integrity&&(c.integrity=r.integrity),r.referrerPolicy&&(c.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?c.credentials="include":r.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(r){if(r.ep)return;r.ep=!0;const c=n(r);fetch(r.href,c)}})();const ms="modulepreload",hs=function(e){return"/"+e},Dt={},f=function(t,n,i){let r=Promise.resolve();if(n&&n.length>0){let d=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};var a=d;document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),o=l?.nonce||l?.getAttribute("nonce");r=d(n.map(u=>{if(u=hs(u),u in Dt)return;Dt[u]=!0;const p=u.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${h}`))return;const v=document.createElement("link");if(v.rel=p?"stylesheet":ms,p||(v.as="script"),v.crossOrigin="",v.href=u,o&&v.setAttribute("nonce",o),document.head.appendChild(v),p)return new Promise((_,A)=>{v.addEventListener("load",_),v.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${u}`)))})}))}function c(l){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=l,window.dispatchEvent(o),!o.defaultPrevented)throw l}return r.then(l=>{for(const o of l||[])o.status==="rejected"&&c(o.reason);return t().catch(c)})},z="https://loarwnuyvfxiscjjsmiz.supabase.co",j="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";async function Ye(e,t){try{const n=new URL(`/rest/v1/${e}`,z),i=await fetch(n.toString(),{method:"POST",headers:{apikey:j,Authorization:`Bearer ${j}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(t)});if(!i.ok)throw new Error(`HTTP ${i.status}`);return(await i.json())[0]??null}catch(n){return console.warn(`Failed to insert into Supabase table ${e}`,n),null}}async function yt(e,t,n){try{const i=new URL(`/rest/v1/${e}?id=eq.${t}`,z);return(await fetch(i.toString(),{method:"PATCH",headers:{apikey:j,Authorization:`Bearer ${j}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(n)})).ok}catch{return!1}}async function ia(e,t={}){try{const n=new URL(`/rest/v1/rpc/${e}`,z),i=await fetch(n.toString(),{method:"POST",headers:{apikey:j,Authorization:`Bearer ${j}`,"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()}catch(n){return console.warn(`Failed to call Supabase RPC ${e}`,n),null}}async function vt(e){try{const t=new URL(`/rest/v1/${e}`,z);t.searchParams.set("select","*"),t.searchParams.set("limit","0");const n=await fetch(t.toString(),{method:"GET",headers:{apikey:j,Authorization:`Bearer ${j}`,Accept:"application/json",Prefer:"count=exact"}});if(!n.ok)return 0;const i=n.headers.get("Content-Range");if(i){const r=i.match(/\/(\d+)/);if(r)return parseInt(r[1],10)}return 0}catch{return 0}}async function w(e,t={}){try{const n=new URL(`/rest/v1/${e}`,z);Object.entries(t).forEach(([r,c])=>{n.searchParams.set(r,c)});const i=await fetch(n.toString(),{method:"GET",headers:{apikey:j,Authorization:`Bearer ${j}`,Accept:"application/json",Prefer:"return=representation"}});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()}catch(n){return console.warn(`Failed to query Supabase table ${e}`,n),[]}}async function K(e,t={},n=1e3){const i=[];let r=0;try{for(;;){const c=new URL(`/rest/v1/${e}`,z);Object.entries(t).forEach(([o,d])=>{c.searchParams.set(o,d)}),c.searchParams.set("limit",String(n)),c.searchParams.set("offset",String(r));const a=await fetch(c.toString(),{method:"GET",headers:{apikey:j,Authorization:`Bearer ${j}`,Accept:"application/json",Prefer:"return=representation"}});if(!a.ok)throw new Error(`HTTP ${a.status}`);const l=await a.json();if(i.push(...l),l.length<n)break;r+=n}return i}catch(c){return console.warn(`Failed to query all rows from Supabase table ${e}`,c),i.length>0?i:[]}}const N=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:j,SUPABASE_URL:z,supabaseCount:vt,supabaseInsert:Ye,supabaseQuery:w,supabaseQueryAll:K,supabaseRpc:ia,supabaseUpdate:yt},Symbol.toStringTag,{value:"Module"})),ft="sake_auth";function la(e){localStorage.setItem(ft,JSON.stringify(e))}function oa(){return{apikey:j,"Content-Type":"application/json"}}function ys(e){try{const[,t]=e.split(".");if(!t)return null;const n=t.replaceAll("-","+").replaceAll("_","/"),i=n.padEnd(Math.ceil(n.length/4)*4,"=");return JSON.parse(atob(i))}catch{return null}}async function ra(e,t){const n=await fetch(`${z}/auth/v1/${e}`,{method:"POST",headers:oa(),body:JSON.stringify(t)}),i=await n.json().catch(()=>({}));if(!n.ok)throw new Error(i.error_description??i.msg??`HTTP ${n.status}`);return i}async function vs(e,t){const n=await ra("token?grant_type=password",{email:e,password:t});return la({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??e}}async function Pt(e,t){const n=await ra("signup",{email:e,password:t});return n.access_token&&n.refresh_token&&la({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??e}}async function fs(){const e=He();if(localStorage.removeItem(ft),!!e?.access_token)try{await fetch(`${z}/auth/v1/logout`,{method:"POST",headers:{...oa(),Authorization:`Bearer ${e.access_token}`}})}catch(t){console.warn("Supabase sign out failed",t)}}function He(){const e=localStorage.getItem(ft);if(!e)return null;try{const t=JSON.parse(e);return!t.access_token||!t.refresh_token?null:{access_token:t.access_token,refresh_token:t.refresh_token}}catch{return null}}function bs(){const e=He();if(!e)return null;const t=ys(e.access_token),n=typeof t?.email=="string"?t.email:null;return n?{email:n}:null}async function gs(e){const t=He();if(!t)throw new Error("not signed in");const n=await fetch(`${z}/auth/v1/user`,{method:"PUT",headers:{apikey:j,Authorization:`Bearer ${t.access_token}`,"Content-Type":"application/json"},body:JSON.stringify({password:e})});if(!n.ok){const i=await n.json().catch(()=>({}));throw new Error(i.msg??`HTTP ${n.status}`)}}const bt={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
ご注文締切や納品希望日がございましたら、あわせてお知らせください。`}},ca={generatedAt:new Date().toISOString(),kpis:{todaySales:0,todayDelta:0,monthSales:0,monthDelta:0,unpaidCount:0,unpaidAmount:0},dailySales:[],allDailySales:[],salesRecords:[]},$s={generatedAt:new Date().toISOString(),records:[]},ee={generatedAt:new Date().toISOString(),summary:{customerCount:0,activeCustomerCount:0,productCount:0,activeProductCount:0},customers:[],products:[]},_s={generatedAt:new Date().toISOString(),lastSyncAt:new Date().toISOString(),status:"success",jobName:"sake-relay",message:"データ未取得"},ws={},ks={generatedAt:new Date().toISOString(),monthlySales:[],productTotals:[],customerTotals:[]};function C(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e=="string"){const t=Number(e);return Number.isFinite(t)?t:0}return 0}function Ss(e){switch((e??"").toLowerCase()){case"paid":case"complete":case"completed":return"paid";case"partial":case"partially_paid":case"partially paid":return"partial";default:return"unpaid"}}function xs(e){return typeof e=="boolean"?e:typeof e=="number"?e!==0:typeof e=="string"?["true","1","active","enabled","yes","y"].includes(e.toLowerCase()):!1}function m(e,t,n=""){for(const i of t){const r=e[i];if(typeof r=="string"&&r.length>0)return r}return n}function g(e,t,n=0){for(const i of t)if(i in e)return C(e[i]);return n}function F(e,t,n=!0){for(const i of t)if(i in e)return xs(e[i]);return n}function O(e,t,n){for(const i of t){const r=e[i];if(typeof r!="string"||r.length===0)continue;if(/^\d{4}-\d{2}-\d{2}$/.test(r))return new Date(`${r}T00:00:00Z`).toISOString();const c=new Date(r);if(!Number.isNaN(c.getTime()))return c.toISOString()}return n}function As(e,t){return{id:String(e.id??`invoice-${t+1}`),documentNo:e.document_no??e.legacy_document_no??`D${String(240100+t).padStart(6,"0")}`,date:O(e,["sales_date","document_date"],new Date().toISOString()),customerCode:e.customer_code??e.legacy_customer_code??`C${String(t+1).padStart(4,"0")}`,customerName:e.customer_name??e.customer_code??e.legacy_customer_code??"不明",itemCount:0,amount:C(e.total_amount??e.billed_amount)}}function Nt(e){const t=e.trim().toUpperCase(),n=ws[t];if(n)return n;const i=ca.salesRecords.find(r=>r.customerCode.toUpperCase()===t);return{customerCode:t||"未指定",customerName:i?.customerName??"該当得意先なし",balanceAmount:0,salesTotal:0,paymentTotal:0,salesHistory:[],paymentHistory:[]}}async function da(){const e=await K("daily_sales_detail",{select:"sales_date,amount,document_count,bottles,volume_ml,price_per_bottle,price_per_liter",order:"sales_date.desc"});if(e.length>0){const[t,n]=await Promise.all([w("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"}),w("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,legacy_customer_code,customer_name,total_amount",order:"sales_date.desc",limit:"20"})]),r=new Date().toISOString().slice(0,10),c=r.slice(0,7),a=[...e].sort((v,_)=>v.sales_date.localeCompare(_.sales_date)).map(v=>({date:new Date(`${v.sales_date}T00:00:00Z`).toISOString(),amount:C(v.amount??v.sales_amount),bottles:C(v.bottles),volumeMl:C(v.volume_ml),pricePerBottle:C(v.price_per_bottle),pricePerLiter:C(v.price_per_liter)})),l=a.slice(-30),o=v=>C(v.amount??v.sales_amount),d=e.reduce((v,_)=>_.sales_date===r?v+o(_):v,0),u=e.reduce((v,_)=>_.sales_date.startsWith(c)?v+o(_):v,0),p=t.filter(v=>C(v.balance_amount)>0),h=n.map((v,_)=>({id:String(v.id??`sale-${_+1}`),documentNo:v.document_no??v.legacy_document_no??"",date:v.sales_date??"",customerCode:v.legacy_customer_code??"",customerName:v.customer_name??v.legacy_customer_code??"",amount:C(v.total_amount)}));return{generatedAt:new Date().toISOString(),kpis:{todaySales:d,todayDelta:0,monthSales:u,monthDelta:0,unpaidCount:p.length,unpaidAmount:p.reduce((v,_)=>v+C(_.balance_amount),0)},dailySales:l,allDailySales:a,salesRecords:h}}return ca}async function ua(){const e=await K("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"});return e.length>0?{generatedAt:new Date().toISOString(),records:e.map((t,n)=>{const i=t.legacy_customer_code??`UNKNOWN-${n+1}`;return{id:`payment-${i}-${n+1}`,customerCode:i,customerName:i,billedAmount:C(t.billed_amount),paymentAmount:C(t.paid_amount),balanceAmount:C(t.balance_amount),lastPaymentDate:null,status:Ss(t.payment_status)}})}:$s}async function pa(){const[e,t]=await Promise.all([K("customers"),K("products")]);if(e.length>0||t.length>0){const n=e.length?e.map((r,c)=>{const a=typeof r.memo=="string"?JSON.parse(r.memo||"{}"):r.memo??{};return{id:m(r,["id","customer_id","code"],`customer-${c+1}`),code:m(r,["code","customer_code","legacy_customer_code"],`C${String(c+1).padStart(4,"0")}`),name:m(r,["name","customer_name","display_name"],`Customer ${c+1}`),kanaName:m(r,["kana_name"],""),shortName:m(r,["short_name"],""),postalCode:m(r,["postal_code"],""),address1:m(r,["address1"],""),address2:m(r,["address2"],""),phone:m(r,["phone"],""),fax:m(r,["fax"],""),email:m(r,["email"],""),staffCode:m(r,["staff_code"],""),businessType:m(r,["business_type"],""),areaCode:m(r,["delivery_area_code"],""),salesCategory:String(a.sales_category??""),closingDay:g(r,["closing_day","close_day"],31),paymentDay:g(r,["payment_day","due_day"],15),paymentMonth:Number(a.payment_month??0),paymentCycle:m(r,["payment_cycle"],""),billingCycleType:m(r,["billing_cycle_type"],""),billingCode:String(a.billing_code??""),creditLimit:g(r,["credit_limit"],0),taxMode:m(r,["tax_mode"],""),taxRound:String(a.tax_round??""),invoiceIssue:String(a.invoice_issue??""),invoiceType:m(r,["invoice_type"],""),priceGroup:String(a.price_group??""),priceType:String(a.price_type??""),customerGroup1:String(a.customer_group1??""),customerGroup2:String(a.customer_group2??""),bankName:m(r,["bank_name"],""),bankBranch:m(r,["bank_branch"],""),bankAccount:m(r,["bank_account"],""),isActive:F(r,["is_active","active","enabled"],!0),lat:r.lat?Number(r.lat):void 0,lng:r.lng?Number(r.lng):void 0}}):ee.customers,i=t.length?t.map((r,c)=>({id:m(r,["id","product_id","code"],`product-${c+1}`),code:m(r,["code","product_code","legacy_product_code"],`P${String(c+1).padStart(5,"0")}`),janCode:m(r,["jan_code","jan","barcode"],""),name:m(r,["name","product_name","display_name"],`Product ${c+1}`),kanaName:m(r,["kana_name"],""),shortName:m(r,["short_name"],""),category:m(r,["category","category_name","category_code"],"未分類"),taxCategoryCode:m(r,["tax_category_code"],""),isActive:F(r,["is_active","active","enabled"],!0),listPrice:g(r,["list_price"],0),purchasePrice:g(r,["purchase_price"],0),salePrice:g(r,["default_sale_price","sale_price"],0),costPrice:g(r,["default_cost_price"],0),alcoholDegree:r.alcohol_degree!=null?Number(r.alcohol_degree):null,volumeMl:r.volume_ml!=null?Number(r.volume_ml):null,unit:m(r,["unit"],"本"),bottleType:m(r,["bottle_type"],""),containerCode:m(r,["container_code"],""),polishRate:r.polish_rate!=null?Number(r.polish_rate):null,riceType:m(r,["rice_type"],""),season:m(r,["season"],""),agingYears:g(r,["aging_years"],0)})):ee.products;return{generatedAt:new Date().toISOString(),summary:{customerCount:e.length||ee.summary.customerCount,activeCustomerCount:e.length?n.filter(r=>r.isActive).length:ee.summary.activeCustomerCount,productCount:t.length||ee.summary.productCount,activeProductCount:t.length?i.filter(r=>r.isActive).length:ee.summary.activeProductCount},customers:n,products:i}}return ee}async function ma(){const e=await w("relay_sync_log",{order:"sync_ended_at.desc.nullslast",limit:"1"});if(e.length>0){const t=e[0],n=m(t,["status"],"success"),i=t.errors,r=Array.isArray(i)?i.length>0:!!i;return{generatedAt:new Date().toISOString(),lastSyncAt:O(t,["sync_ended_at","sync_started_at"],new Date().toISOString()),status:r?"warning":n==="error"?"error":"success",jobName:m(t,["agent_hostname"],"sake-relay"),message:`${g(t,["rows_upserted"],0)}行同期 / ${g(t,["files_updated"],0)}ファイル更新`}}return _s}async function ha(){const e=await ia("get_sync_summary");return e&&e.tables?{tables:e.tables.map(t=>({tableName:t.name,displayName:t.display_name,rowCount:t.count,lastSyncAt:t.last_sync,tableType:t.type})),totalRawRecords:e.total_raw_records,totalNormalizedRecords:e.total_normalized_records,lastOverallSync:e.overall_freshness}:{tables:[],totalRawRecords:0,totalNormalizedRecords:0,lastOverallSync:null}}async function Be(e){const t={select:"id,document_no,legacy_document_no,sales_date,customer_code,legacy_customer_code,customer_name,total_amount,billed_amount,line_count",order:"sales_date.desc",limit:"500"};e.startDate&&e.endDate?t.and=`(sales_date.gte.${e.startDate},sales_date.lte.${e.endDate})`:e.startDate?t.sales_date=`gte.${e.startDate}`:e.endDate&&(t.sales_date=`lte.${e.endDate}`);const n=[];e.customerCode.trim()&&n.push(`customer_code.ilike.*${e.customerCode.trim()}*`,`legacy_customer_code.ilike.*${e.customerCode.trim()}*`),e.documentNo.trim()&&n.push(`document_no.ilike.*${e.documentNo.trim()}*`,`legacy_document_no.ilike.*${e.documentNo.trim()}*`),n.length>0&&(t.or=`(${n.join(",")})`);const i=await w("mv_invoice_with_line_count",t);return i.length>0?i.map((r,c)=>({id:m(r,["id"],`invoice-${c}`),documentNo:m(r,["document_no","legacy_document_no"],""),date:O(r,["sales_date"],""),customerCode:m(r,["legacy_customer_code","customer_code"],""),customerName:m(r,["customer_name","legacy_customer_code"],""),itemCount:g(r,["line_count"],0),amount:g(r,["total_amount","billed_amount"],0)})):[]}async function gt(e){const t=e.trim().toUpperCase();if(!t)return Nt("");const[n,i,r]=await Promise.all([w("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,document_date,customer_code,legacy_customer_code,customer_name,total_amount,billed_amount",or:`customer_code.eq.${t},legacy_customer_code.eq.${t}`,order:"sales_date.desc",limit:"50"}),w("customer_payments",{select:"id,customer_code,legacy_customer_code,payment_date,received_date,amount,payment_amount,method,payment_method",or:`customer_code.eq.${t},legacy_customer_code.eq.${t}`,order:"payment_date.desc",limit:"50"}),w("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"})]);if(n.length>0||i.length>0){const c=n.map((o,d)=>{const u=As(o,d);return{id:u.id,date:u.date,documentNo:u.documentNo,amount:u.amount}}),a=i.map((o,d)=>({id:String(o.id??`payment-${d+1}`),date:O(o,["payment_date","received_date"],new Date().toISOString()),amount:C(o.payment_amount??o.amount),method:o.payment_method??o.method??"入金"})),l=r.find(o=>(o.legacy_customer_code??"").toUpperCase()===t);return{customerCode:t,customerName:n[0]?.customer_name??n[0]?.customer_code??n[0]?.legacy_customer_code??t,balanceAmount:C(l?.balance_amount),salesTotal:c.reduce((o,d)=>o+d.amount,0),paymentTotal:a.reduce((o,d)=>o+d.amount,0),salesHistory:c,paymentHistory:a}}return Nt(t)}async function ya(){const[e,t,n]=await Promise.all([w("mv_monthly_sales",{order:"month.asc"}),w("mv_customer_sales_totals",{order:"amount.desc",limit:"100"}),w("mv_product_sales_totals",{order:"amount.desc",limit:"100"})]);return e.length>0?{generatedAt:new Date().toISOString(),monthlySales:e.slice(-12).map(i=>({month:m(i,["month"],""),amount:g(i,["amount"],0)})),productTotals:n.map(i=>({code:m(i,["code"],""),name:m(i,["name"],""),amount:g(i,["amount"],0),quantity:g(i,["quantity"],0),documents:g(i,["documents"],0)})),customerTotals:t.map(i=>({code:m(i,["code"],""),name:m(i,["name"],""),amount:g(i,["amount"],0),quantity:g(i,["quantity"],0),documents:g(i,["documents"],0)}))}:ks}const lt={sales:"売上",return:"返品",export_return:"輸出戻入"};async function va(e){const t=e.lines.reduce((r,c)=>r+c.amount,0),n=`D${Date.now().toString().slice(-6)}`;return{id:(await Ye("sales_document_headers",{legacy_document_no:n,legacy_customer_code:e.customerCode,sales_date:e.invoiceDate,document_type:e.invoiceType,staff_code:e.staffCode,total_amount:t,status:"confirmed"}))?.id??`local-${n}`,documentNo:n,totalAmount:t,status:"confirmed",createdAt:new Date().toISOString()}}const qt={documentNo:"",invoiceDate:"",customerCode:"",customerName:"",customerAddress:"",lines:[],totalAmount:0,taxAmount:0,note:""};async function $t(e){const t=await w("sales_document_headers",{select:"*",legacy_document_no:`eq.${e}`});if(t.length>0){const n=t[0],i=C(n.total_amount);return{documentNo:e,invoiceDate:m(n,["sales_date","document_date"],""),customerCode:m(n,["legacy_customer_code","customer_code"],""),customerName:m(n,["customer_name","legacy_customer_code"],""),customerAddress:"",lines:[],totalAmount:i,taxAmount:Math.floor(i*10/110),note:""}}return{...qt,documentNo:e||qt.documentNo}}const Es={targetYearMonth:"",closingDay:31,totalBilling:0,customers:[]};async function _t(e){const t=await w("mv_billing_summary",{year_month:`eq.${e}`,order:"sales_amount.desc"});if(t.length>0){const n=t.map(r=>{const c=g(r,["sales_amount"],0),a=g(r,["tax_amount"],0);return{customerCode:m(r,["customer_code"],""),customerName:m(r,["customer_name"],""),closingDay:31,salesAmount:c,taxAmount:a,prevBalance:0,paymentAmount:0,billingAmount:c,status:"open"}}),i=n.reduce((r,c)=>r+c.billingAmount,0);return{targetYearMonth:e,closingDay:31,totalBilling:i,customers:n}}return{...Es,targetYearMonth:e}}const Cs={generatedAt:new Date().toISOString(),months:[],salesByProduct:[],salesByCustomer:[],costSimulation:[]};async function Ge(){const[e,t,n]=await Promise.all([w("mv_monthly_sales",{order:"month.asc"}),w("mv_product_monthly_shipments",{order:"code.asc,month.asc"}),w("mv_customer_sales_totals",{order:"amount.desc",limit:"10"})]);if(e.length===0)return Cs;const i=e.slice(-12).map(o=>m(o,["month"],"")),r=new Map;t.forEach(o=>{const d=m(o,["code"],"");r.has(d)||r.set(d,{name:m(o,["name"],d),monthValues:new Map}),r.get(d).monthValues.set(m(o,["month"],""),g(o,["amount"],0))});const a=Array.from(r.entries()).map(([o,d])=>({code:o,name:d.name,total:i.reduce((u,p)=>u+(d.monthValues.get(p)??0),0),monthValues:d.monthValues})).sort((o,d)=>d.total-o.total).slice(0,10).map(o=>({label:o.name,values:i.map(d=>o.monthValues.get(d)??0)})),l=n.map(o=>({label:m(o,["name"],""),values:i.map(()=>Math.round(g(o,["amount"],0)/i.length))}));return{generatedAt:new Date().toISOString(),months:i,salesByProduct:a,salesByCustomer:l,costSimulation:[]}}async function Ls(){const e=await K("mv_product_monthly_shipments",{order:"code.asc,month.asc"});if(e.length===0)return[];const t=new Map;return e.forEach(n=>{const i=m(n,["code"],"");if(!i)return;const r=m(n,["month"],""),c=parseInt(r.slice(5,7))-1;if(c<0||c>11)return;let a=t.get(i);a||(a={name:m(n,["name"],i),qty:new Array(12).fill(0),amt:new Array(12).fill(0)},t.set(i,a)),a.qty[c]+=g(n,["quantity"],0),a.amt[c]+=g(n,["amount"],0)}),Array.from(t.entries()).map(([n,i])=>({code:n,name:i.name,monthlyQuantity:i.qty,monthlyAmount:i.amt,totalQuantity:i.qty.reduce((r,c)=>r+c,0),totalAmount:i.amt.reduce((r,c)=>r+c,0)})).filter(n=>n.totalQuantity>0).sort((n,i)=>i.totalAmount-n.totalAmount)}async function Is(){const e=new Date;e.setMonth(e.getMonth()-1);const t=e.toISOString().slice(0,10),n=await K("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,document_date,customer_name",order:"sales_date.desc",sales_date:`gte.${t}`});if(n.length===0)return[];n.map(a=>String(a.id)).filter(Boolean);const i=await K("sales_document_lines",{select:"header_id,document_header_id,product_name,quantity"}),r=new Map;n.forEach(a=>{a.id&&r.set(String(a.id),a)});const c=[];return i.forEach(a=>{const l=String(a.header_id??a.document_header_id??""),o=r.get(l);if(!o)return;const d=o.sales_date??o.document_date??"";!d||d<t||c.push({date:d.slice(0,10),customerName:o.customer_name??"不明",productName:a.product_name??"不明",quantity:C(a.quantity),documentNo:o.document_no??o.legacy_document_no??""})}),c.sort((a,l)=>a.date.localeCompare(l.date))}async function fa(){const e=new Date().toISOString();return(await w("system_announcements",{is_active:"eq.true",starts_at:`lte.${e}`,or:`(ends_at.is.null,ends_at.gte.${e})`,order:"created_at.desc"})).map(n=>({id:m(n,["id"],""),message:m(n,["message"],""),level:m(n,["level"],"info"),startsAt:O(n,["starts_at"],""),endsAt:n.ends_at?O(n,["ends_at"],""):null,dismissible:F(n,["dismissible"],!0)}))}async function ba(e,t,n){try{return await Ye("feature_requests",{title:e,category:t,description:n}),!0}catch{return!1}}async function ga(e,t){return yt("customers",e,t)}async function $a(e,t){return yt("products",e,t)}async function _a(e,t){const n=e.find(a=>a.code===t);n?.priceGroup;const i=n?.priceGroup||t;let r="";try{const a=await w("customers",{select:"memo",legacy_customer_code:`eq.${t}`,limit:"1"});a[0]?.memo&&(r=(typeof a[0].memo=="string"?JSON.parse(a[0].memo):a[0].memo)?.price_type??"")}catch{}const c=new Map;if(i){const a=await w("customer_product_prices",{price_group:`eq.${i}`,select:"legacy_product_code,special_price"});for(const l of a)c.set(l.legacy_product_code,l.special_price)}return{priceType:r,priceGroup:i,individualPrices:c}}function wa(e,t){const n=t.individualPrices.get(e.code);if(n!=null&&n>0)return{price:n,label:"個別単価"};switch(t.priceType){case"000":if(e.purchasePrice>0)return{price:e.purchasePrice,label:"生産者価格"};break;case"001":if(e.listPrice>0)return{price:e.listPrice,label:"小売価格"};break;case"002":if(e.salePrice>0)return{price:e.salePrice,label:"卸価格"};break}return{price:e.salePrice||0,label:"標準価格"}}async function ka(){return(await w("product_power",{select:"legacy_product_code,product_name,volume_ml,category_code,year_amount,year_qty,recent_amount,recent_qty,prev_amount,share_pct,growth_rate,rank",order:"year_amount.desc",limit:"100"})).map(t=>({code:String(t.legacy_product_code??""),name:String(t.product_name??""),volumeMl:t.volume_ml?Number(t.volume_ml):null,category:String(t.category_code??""),yearAmount:Number(t.year_amount??0),yearQty:Number(t.year_qty??0),recentAmount:Number(t.recent_amount??0),recentQty:Number(t.recent_qty??0),prevAmount:Number(t.prev_amount??0),sharePct:Number(t.share_pct??0),growthRate:t.growth_rate!=null?Number(t.growth_rate):null,rank:String(t.rank??"C")}))}async function Sa(){return(await w("customer_efficiency",{select:"legacy_customer_code,customer_name,address1,year_amount,share_pct,recent_amount,recent_qty,order_days,prev_amount,growth_rate,current_rank,prev_rank",order:"year_amount.desc",limit:"100"})).map(t=>({code:String(t.legacy_customer_code??""),name:String(t.customer_name??""),address:String(t.address1??""),yearAmount:Number(t.year_amount??0),sharePct:Number(t.share_pct??0),recentAmount:Number(t.recent_amount??0),recentQty:Number(t.recent_qty??0),orderDays:Number(t.order_days??0),prevAmount:Number(t.prev_amount??0),growthRate:t.growth_rate!=null?Number(t.growth_rate):null,currentRank:String(t.current_rank??"C"),prevRank:String(t.prev_rank??"")}))}async function xa(){const[e,t]=await Promise.all([w("mv_customer_abc",{order:"amount.desc"}),Ge()]),n=e.map(i=>({code:m(i,["code"],""),name:m(i,["name"],""),amount:g(i,["amount"],0),documents:g(i,["documents"],0),ratio:g(i,["ratio"],0),cumRatio:g(i,["cum_ratio"],0),abcRank:m(i,["abc_rank"],"C")}));return{generatedAt:new Date().toISOString(),ranking:n,months:t.months,monthlyByCustomer:t.salesByCustomer}}async function Ds(){const[e,t]=await Promise.all([w("mv_product_abc",{order:"amount.desc"}),Ge()]),n=e.map(a=>({code:m(a,["code"],""),name:m(a,["name"],""),amount:g(a,["amount"],0),quantity:g(a,["quantity"],0),ratio:g(a,["ratio"],0),cumRatio:g(a,["cum_ratio"],0),abcRank:m(a,["abc_rank"],"C")})),i=n.reduce((a,l)=>a+l.amount,0),r=new Set(n.filter(a=>a.abcRank==="A").map(a=>a.name)),c=t.salesByProduct.filter(a=>r.has(a.label));return{generatedAt:new Date().toISOString(),totalAmount:i,ranking:n,months:t.months,monthlyByProduct:c.length>0?c:t.salesByProduct}}const Aa={planned:"計画中",active:"仕込中",done:"完了"};async function Ea(){const e=await w("brewing_batches",{order:"start_date.desc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),jikomiNo:m(t,["batch_no","legacy_batch_no"],""),productName:m(t,["brand_name"],""),riceType:m(t,["rice_type"],""),plannedKg:g(t,["planned_rice_kg"],0),actualKg:g(t,["actual_rice_kg"],0),startDate:O(t,["start_date"],""),expectedDoneDate:O(t,["expected_done_date"],""),status:m(t,["status"],"planned"),tankNo:m(t,["tank_no"],""),note:m(t,["remarks"],"")})):[]}async function Ca(){const e=await w("tanks",{order:"tank_no.asc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),tankNo:m(t,["tank_no"],""),capacity:g(t,["capacity_l"],0),currentVolume:g(t,["current_volume_l"],0),productName:m(t,["current_product_code"],""),jikomiNo:m(t,["current_batch_id"],""),status:m(t,["status"],"empty"),lastUpdated:O(t,["last_updated_at"],"")})):[]}async function La(){const e=await w("kentei_records",{order:"kentei_date.desc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),kenteiNo:m(t,["kentei_no"],""),jikomiNo:m(t,["batch_id"],""),productName:m(t,["product_code"],""),kenteiDate:O(t,["kentei_date"],""),alcoholDegree:g(t,["alcohol_degree"],0),extractDegree:g(t,["extract_degree"],0),sakaMeterValue:g(t,["sakemeter_value"],0),volume:g(t,["volume_l"],0),taxCategory:m(t,["tax_category_code"],""),status:m(t,["status"],"pending")})):[]}async function ot(){const e=await w("materials",{order:"name.asc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),code:m(t,["material_code","legacy_material_code"],""),name:m(t,["name"],""),unit:m(t,["unit"],""),currentStock:g(t,["current_stock"],0),minimumStock:g(t,["minimum_stock"],0),unitCost:g(t,["unit_cost"],0),lastUpdated:O(t,["updated_at"],"")})):[]}async function Ia(){const e=await w("purchase_document_headers",{order:"purchase_date.desc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),documentNo:m(t,["document_no","legacy_document_no"],""),purchaseDate:O(t,["purchase_date"],""),supplierCode:m(t,["supplier_code","legacy_supplier_code"],""),supplierName:m(t,["supplier_name"],""),itemName:"",quantity:0,unitPrice:0,amount:g(t,["total_amount"],0),status:m(t,["payment_status"],"pending")})):[]}async function Da(){const e=await w("supplier_payment_status",{order:"legacy_supplier_code.asc"});return e.length>0?e.map(t=>({supplierCode:m(t,["supplier_code","legacy_supplier_code"],""),supplierName:m(t,["legacy_supplier_code"],""),totalPurchase:g(t,["total_purchase"],0),paidAmount:g(t,["paid_amount"],0),balance:g(t,["balance"],0),nextPaymentDate:O(t,["next_payment_date"],""),status:m(t,["status"],"unpaid")})):[]}async function Pa(){const e=await w("bills_of_exchange",{order:"due_date.desc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),billNo:m(t,["bill_no"],""),supplierName:m(t,["counterparty_name"],""),amount:g(t,["amount"],0),issueDate:O(t,["issue_date"],""),dueDate:O(t,["due_date"],""),status:m(t,["status"],"holding")})):[]}async function Na(){const e=await w("raw_materials",{order:"name.asc"});return e.length>0?e.map(t=>({code:m(t,["material_code","legacy_material_code"],""),name:m(t,["name"],""),unit:m(t,["unit"],""),currentStock:g(t,["current_stock"],0),minimumStock:g(t,["minimum_stock"],0),lastPurchaseDate:O(t,["last_purchase_date"],""),unitCost:g(t,["unit_cost"],0)})):[]}const qa=[{code:"01",name:"清酒（普通酒）",taxRatePerLiter:100},{code:"02",name:"清酒（純米酒）",taxRatePerLiter:100},{code:"03",name:"清酒（吟醸酒）",taxRatePerLiter:100},{code:"04",name:"清酒（大吟醸酒）",taxRatePerLiter:100},{code:"05",name:"本格焼酎",taxRatePerLiter:250},{code:"06",name:"リキュール",taxRatePerLiter:200},{code:"07",name:"果実酒",taxRatePerLiter:100},{code:"08",name:"その他醸造酒",taxRatePerLiter:100}],rt={export:"輸出",sample:"見本",research:"試験醸造",loss:"欠減"},Ps={targetYear:0,targetMonth:0,companyName:"",companyNo:"",companyAddress:"",companyRepresentative:"",taxOffice:"",rows:[],deductions:[],totalVolume:0,totalTax:0,status:"draft",submittedAt:null};async function wt(e,t){const n=await w("tax_declarations",{target_year:`eq.${e}`,target_month:`eq.${t}`,limit:"1"});if(n.length>0){const i=n[0],r=m(i,["id"],""),[c,a]=await Promise.all([w("tax_declaration_rows",{declaration_id:`eq.${r}`,order:"tax_category_code.asc"}),w("tax_deductions",{declaration_id:`eq.${r}`})]),l=c.map(d=>({taxCategory:m(d,["tax_category_code"],""),taxCategoryName:m(d,["tax_category_name"],""),alcoholDegree:g(d,["alcohol_degree"],0),volume:g(d,["taxable_volume"],0),taxRate:g(d,["tax_rate"],0),taxAmount:g(d,["tax_amount"],0),productionVolume:g(d,["production_volume"],0),previousBalance:g(d,["previous_balance"],0),currentAdjustment:g(d,["current_adjustment"],0),exportDeduction:g(d,["export_deduction"],0),sampleDeduction:g(d,["sample_deduction"],0),taxableVolume:g(d,["taxable_volume"],0)})),o=a.map(d=>({type:m(d,["deduction_type"],"sample"),categoryCode:m(d,["tax_category_code"],""),volume:g(d,["volume"],0),reason:m(d,["reason"],""),documentNo:m(d,["reference_document_no"],"")||void 0}));return{targetYear:e,targetMonth:t,companyName:m(i,["company_name"],""),companyNo:m(i,["company_no"],""),companyAddress:m(i,["company_address"],""),companyRepresentative:m(i,["company_representative"],""),taxOffice:m(i,["tax_office"],""),rows:l,deductions:o,totalVolume:g(i,["total_taxable_volume"],0),totalTax:g(i,["total_tax_amount"],0),status:m(i,["status"],"draft"),submittedAt:m(i,["submitted_at"],"")||null}}return{...Ps,targetYear:e,targetMonth:t}}function J(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;")}function Ta(e){const t=e.rows.map(i=>`    <Category>
      <Code>${J(i.taxCategory)}</Code>
      <Name>${J(i.taxCategoryName)}</Name>
...
`),n=e.deductions.map(i=>`    <Deduction type="${J(i.type)}">
      <CategoryCode>${J(i.categoryCode)}</CategoryCode>
      <Volume>${i.volume}</Volume>
      <Reason>${J(i.reason)}</Reason>${i.documentNo?`
      <DocumentNo>${J(i.documentNo)}</DocumentNo>`:""}
    </Deduction>`).join(`
...
`}function Ns(e){const t=String(e);return/[,"\n]/.test(t)?`"${t.replaceAll('"','""')}"`:t}function qs(e){const n=["酒類コード","区分名","アルコール度数","製造数量","前月繰越","当月調整","輸出控除","見本等控除","課税数量","税率(円/L)","税額(円)"].join(","),i=e.rows.map(c=>[c.taxCategory,c.taxCategoryName,c.alcoholDegree,c.productionVolume,c.previousBalance,c.currentAdjustment,c.exportDeduction,c.sampleDeduction,c.taxableVolume,c.taxRate,c.taxAmount].map(Ns).join(",")),r=`,合計,,${e.rows.reduce((c,a)=>c+a.productionVolume,0)},,,${e.rows.reduce((c,a)=>c+a.exportDeduction,0)},${e.rows.reduce((c,a)=>c+a.sampleDeduction,0)},${e.totalVolume},,${e.totalTax}`;return"\uFEFF"+[n,...i,r].join(`
`)+`
`}function Ts(e){const t=e.rows.map(r=>{const c=Math.max(0,r.productionVolume+r.previousBalance+r.currentAdjustment-r.exportDeduction-r.sampleDeduction),a=Math.round(c*r.taxRate);return{...r,taxableVolume:c,volume:c,taxAmount:a}}),n=t.reduce((r,c)=>r+c.taxableVolume,0),i=t.reduce((r,c)=>r+c.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:i}}async function Rs(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>N);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:Ta(e),submitted_at:e.submittedAt})}async function kt(e){const t=await w("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(n=>({id:m(n,["id"],""),saleDate:m(n,["sale_date"],e),saleTime:m(n,["sale_time"],""),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),quantity:g(n,["quantity"],0),unitPrice:g(n,["unit_price"],0),amount:g(n,["amount"],0),paymentMethod:m(n,["payment_method"],"cash")})):[]}async function Ra(){const e=await w("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),orderDate:O(t,["order_date"],""),customerName:m(t,["customer_name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["shipping_address"],""),items:[],totalAmount:g(t,["total_amount"],0),status:m(t,["status"],"new"),shippingDate:O(t,["shipping_date"],"")})):[]}async function Me(e){const t=await Ye("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function Oa(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function Os(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await w("print_layouts",t)).map(i=>({id:m(i,["id"],""),name:m(i,["name"],""),templateKey:m(i,["template_key"],""),positions:i.positions??{},isDefault:F(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}))}async function js(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:r}=await Promise.resolve().then(()=>N);return{supabaseInsert:r}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},i=await t("print_layouts",n);return i?{id:m(i,["id"],e.id),name:m(i,["name"],e.name),templateKey:m(i,["template_key"],e.templateKey),positions:i.positions??e.positions,isDefault:F(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}:null}async function Ms(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function Fs(){return(await w("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),signature:m(t,["signature"],""),replyTo:m(t,["reply_to"],""),isDefault:F(t,["is_default"],!1),isVerified:F(t,["is_verified"],!1),note:m(t,["note"],"")}))}async function Bs(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:m(n,["id"],e.id),name:m(n,["name"],e.name),email:m(n,["email"],e.email),displayName:m(n,["display_name"],""),signature:m(n,["signature"],""),replyTo:m(n,["reply_to"],""),isDefault:F(n,["is_default"],!1),isVerified:F(n,["is_verified"],!1)}:null}async function zs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const St={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},xt={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Vs(e){const t=`${e}-01T00:00:00Z`,[n,i]=e.split("-").map(l=>parseInt(l,10)),r=new Date(n,i,0).getDate(),c=`${e}-${String(r).padStart(2,"0")}T23:59:59Z`;return(await w("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${c})`,order:"starts_at.asc"})).map(l=>({id:m(l,["id"],""),title:m(l,["title"],""),description:m(l,["description"],""),category:m(l,["category"],"general")||"general",startsAt:m(l,["starts_at"],new Date().toISOString()),endsAt:m(l,["ends_at"],""),isAllDay:F(l,["is_all_day"],!1),location:m(l,["location"],""),attendees:l.attendees??[],relatedCustomerCode:m(l,["related_customer_code"],""),relatedOrderId:m(l,["related_order_id"],""),color:m(l,["color"],""),googleEventId:m(l,["google_event_id"],"")}))}async function Js(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??xt[e.category],updated_at:new Date().toISOString()})?e:null}async function Us(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ja(){return(await w("integration_settings",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),provider:m(t,["provider"],""),config:t.config??{},isEnabled:F(t,["is_enabled"],!1),lastSyncAt:m(t,["last_sync_at"],""),lastStatus:m(t,["last_status"],"")}))}async function xe(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function Ys(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const i=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,r=await fetch(i,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const c=await r.json(),{supabaseInsert:a}=await f(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>N);return{supabaseInsert:o}},void 0);let l=0;for(const o of c.orders){const d=`shopify_${o.id}`;await a("shopify_orders",{id:d,shopify_order_id:String(o.id),order_number:String(o.order_number??""),order_date:String(o.created_at??new Date().toISOString()),customer_name:String(o.customer?.first_name??"")+" "+String(o.customer?.last_name??""),customer_email:String(o.customer?.email??""),total_amount:Math.round(parseFloat(String(o.total_price??"0"))),financial_status:String(o.financial_status??""),fulfillment_status:String(o.fulfillment_status??"unfulfilled"),line_items:o.line_items??[],shipping_address:o.shipping_address??null,raw_payload:o}),l++}return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${l}件取得成功`}),{count:l}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Hs(){return(await w("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),shopifyOrderId:m(t,["shopify_order_id"],""),orderNumber:m(t,["order_number"],""),orderDate:m(t,["order_date"],""),customerName:m(t,["customer_name"],""),customerEmail:m(t,["customer_email"],""),totalAmount:C(t.total_amount),financialStatus:m(t,["financial_status"],""),fulfillmentStatus:m(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function Gs(e){const t=e.config.refresh_token,n=e.config.client_id,i=e.config.client_secret;if(!t||!n||!i)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const r=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:n,client_secret:i})});if(!r.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${r.status}`};const a=(await r.json()).access_token;return await xe({...e,config:{...e.config,oauth_token:a}}),e.config.oauth_token=a,{token:a}}async function Xs(e){let t=e.config.oauth_token;const n=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const i=new Date().toISOString(),r=new Date(Date.now()+30*86400*1e3).toISOString(),c=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${i}&timeMax=${r}&singleEvents=true&orderBy=startTime`;let a=await fetch(c,{headers:{Authorization:`Bearer ${t}`}});if(a.status===401){const u=await Gs(e);if(u.error)return{count:0,error:u.error};t=u.token,a=await fetch(c,{headers:{Authorization:`Bearer ${t}`}})}if(!a.ok)return{count:0,error:`HTTP ${a.status}`};const l=await a.json(),{supabaseInsert:o}=await f(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>N);return{supabaseInsert:u}},void 0);let d=0;for(const u of l.items){const p=`gcal_${u.id}`,h=u.start?.dateTime??u.start?.date??"",v=u.end?.dateTime??u.end?.date??"";await o("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(h),ends_at:String(v),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),d++}return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${d}件取得`}),{count:d}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Qs(){return(await w("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),receivedAt:m(t,["received_at"],""),senderPhone:m(t,["sender_phone"],""),senderName:m(t,["sender_name"],""),imageUrl:m(t,["image_url"],""),ocrStatus:m(t,["ocr_status"],"pending")||"pending",ocrText:m(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:m(t,["linked_invoice_id"],"")}))}async function Ws(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const i=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,r=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return r.ok?{text:(await r.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${r.status}`}}catch(i){return{text:"",error:i instanceof Error?i.message:String(i)}}}async function Ks(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const ze={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Ve={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function Zs(){return(await w("user_profiles",{order:"display_name.asc"})).map(t=>({id:m(t,["id"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),staffCode:m(t,["staff_code"],""),department:m(t,["department"],"all")||"all",role:m(t,["role"],"staff")||"staff",defaultMailSenderId:m(t,["default_mail_sender_id"],""),phone:m(t,["phone"],""),avatarUrl:m(t,["avatar_url"],""),isActive:F(t,["is_active"],!0),lastSignInAt:m(t,["last_sign_in_at"],""),createdAt:m(t,["created_at"],"")}))}async function en(e){if(!e)return null;const t=await w("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:m(n,["id"],""),email:m(n,["email"],""),displayName:m(n,["display_name"],""),staffCode:m(n,["staff_code"],""),department:m(n,["department"],"all")||"all",role:m(n,["role"],"staff")||"staff",defaultMailSenderId:m(n,["default_mail_sender_id"],""),phone:m(n,["phone"],""),avatarUrl:m(n,["avatar_url"],""),isActive:F(n,["is_active"],!0),lastSignInAt:m(n,["last_sign_in_at"],"")}}async function tn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function an(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function sn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>N);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function nn(e=100){return(await w("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),action:m(n,["action"],""),entityType:m(n,["entity_type"],""),entityId:m(n,["entity_id"],""),userEmail:m(n,["user_email"],""),changes:n.changes??{},createdAt:m(n,["created_at"],"")}))}const Je={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function Ma(){return(await w("slack_notifications",{order:"event_type.asc"})).map(t=>({id:m(t,["id"],""),eventType:m(t,["event_type"],"new_order"),enabled:F(t,["enabled"],!0),channel:m(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:m(t,["last_triggered_at"],"")}))}async function ln(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function on(e=50){return(await w("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),eventType:m(n,["event_type"],""),channel:m(n,["channel"],""),message:m(n,["message"],""),status:m(n,["status"],"sent"),error:m(n,["error"],""),sentAt:m(n,["sent_at"],"")}))}async function rn(e,t,n){const r=(await ja()).find(d=>d.provider==="slack");if(!r||!r.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const c=r.config.webhook_url;if(!c)return{ok:!1,error:"Webhook URL未設定"};const l=(await Ma()).find(d=>d.eventType===e&&d.enabled);if(!l)return{ok:!1,error:"通知ルールが無効"};const o=n??l.channel??r.config.default_channel??"#general";try{const d=await fetch(c,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${Je[e]} ${t}`,channel:o})}),u=d.ok,{supabaseInsert:p}=await f(async()=>{const{supabaseInsert:h}=await Promise.resolve().then(()=>N);return{supabaseInsert:h}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:o,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${d.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${d.status}`}}catch(d){return{ok:!1,error:d instanceof Error?d.message:String(d)}}}const Ae={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Xe={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function cn(){return(await w("prospects",{order:"updated_at.desc"})).map(t=>({id:m(t,["id"],""),companyName:m(t,["company_name"],""),contactName:m(t,["contact_name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),address:m(t,["address"],""),website:m(t,["website"],""),businessType:m(t,["business_type"],""),stage:m(t,["stage"],"cold"),source:m(t,["source"],""),expectedAmount:C(t.expected_amount),probability:C(t.probability),assignedStaffCode:m(t,["assigned_staff_code"],""),nextActionDate:m(t,["next_action_date"],""),nextAction:m(t,["next_action"],""),note:m(t,["note"],""),lastContactAt:m(t,["last_contact_at"],""),wonAt:m(t,["won_at"],""),lostAt:m(t,["lost_at"],""),lostReason:m(t,["lost_reason"],""),convertedCustomerCode:m(t,["converted_customer_code"],""),createdAt:m(t,["created_at"],"")}))}async function Fa(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function dn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function un(e){return(await w("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:m(n,["id"],""),prospectId:m(n,["prospect_id"],""),activityType:m(n,["activity_type"],"call"),title:m(n,["title"],""),description:m(n,["description"],""),activityDate:m(n,["activity_date"],""),result:m(n,["result"],""),staffCode:m(n,["staff_code"],"")}))}async function pn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const Ba=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function mn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function hn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function yn(){return(await w("delivery_locations",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),customerCode:m(t,["customer_code"],""),name:m(t,["name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:m(t,["contact_name"],""),phone:m(t,["phone"],""),deliveryNote:m(t,["delivery_note"],""),isActive:F(t,["is_active"],!0)}))}async function vn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function fn(e=50){return(await w("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),callDirection:m(n,["call_direction"],"inbound"),fromNumber:m(n,["from_number"],""),toNumber:m(n,["to_number"],""),matchedCustomerCode:m(n,["matched_customer_code"],""),matchedProspectId:m(n,["matched_prospect_id"],""),durationSeconds:C(n.duration_seconds),callStatus:m(n,["call_status"],"answered"),recordingUrl:m(n,["recording_url"],""),transcript:m(n,["transcript"],""),ivryCallId:m(n,["ivry_call_id"],""),startedAt:m(n,["started_at"],""),endedAt:m(n,["ended_at"],""),notes:m(n,["notes"],"")}))}async function za(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function bn(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const i=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,r=await fetch(i,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const a=(await r.json()).calls??[];let l=0;for(const o of a)await za({id:`ivry_${o.id}`,callDirection:String(o.direction??"inbound"),fromNumber:String(o.from??""),toNumber:String(o.to??""),durationSeconds:Number(o.duration??0),callStatus:String(o.status??"answered"),recordingUrl:String(o.recording_url??""),startedAt:String(o.started_at??""),endedAt:String(o.ended_at??""),ivryCallId:String(o.id??"")}),l++;return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${l}件取得`}),{count:l}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function gn(e,t){const n=e.config.api_key,i=e.config.team_id;if(!n||!i)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let r=0;for(const c of t){if(!c.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${i}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:c.name,phone_number:c.phone,external_id:c.customerCode??"",note:c.note??""})})).ok&&r++}return{synced:r}}catch(r){return{synced:0,error:r instanceof Error?r.message:String(r)}}}async function $n(){return(await w("lead_lists",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),query:m(t,["query"],""),area:m(t,["area"],""),businessType:m(t,["business_type"],""),totalCount:C(t.total_count),source:m(t,["source"],"manual"),createdAt:m(t,["created_at"],"")}))}async function _n(e){return(await w("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:m(n,["id"],""),listId:m(n,["list_id"],""),companyName:m(n,["company_name"],""),address:m(n,["address"],""),phone:m(n,["phone"],""),website:m(n,["website"],""),email:m(n,["email"],""),businessType:m(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:C(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:m(n,["place_id"],""),status:m(n,["status"],"new"),convertedProspectId:m(n,["converted_prospect_id"],""),note:m(n,["note"],"")}))}async function wn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function Va(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function kn(e,t,n){const i=e.config.api_key;if(!i)return{results:[],error:"Google Maps API key 未設定"};const r=`${t} ${n}`.trim(),c=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(r)}&language=ja&key=${i}`;try{const a=await fetch(c);if(!a.ok)return{results:[],error:`HTTP ${a.status}`};const l=await a.json();return l.status!=="OK"&&l.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${l.status}`}:{results:l.results.map(d=>{const u=d.geometry?.location;return{id:`place_${d.place_id}`,listId:"",companyName:String(d.name??""),address:String(d.formatted_address??""),rating:d.rating?Number(d.rating):void 0,reviewCount:d.user_ratings_total?Number(d.user_ratings_total):void 0,lat:u?.lat,lng:u?.lng,placeId:String(d.place_id??""),status:"new"}})}}catch(a){return{results:[],error:a instanceof Error?a.message:String(a)}}}async function Sn(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await Fa(t);return n&&await Va({...e,status:"imported",convertedProspectId:t.id}),n}async function xn(){return(await w("workflow_orders",{order:"order_date.desc"})).map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),customerName:m(t,["customer_name"],""),customerCode:m(t,["customer_code"],""),orderDate:m(t,["order_date"],""),deliveryDate:m(t,["delivery_date"],""),stage:m(t,["stage"],"new"),totalAmount:C(t.total_amount),itemCount:C(t.item_count),priority:m(t,["priority"],"normal"),staffName:m(t,["staff_name"],""),notes:m(t,["notes"],"")}))}async function An(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function En(){return(await w("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),visitDate:m(t,["visit_date"],""),partySize:C(t.party_size)||1,language:m(t,["language"],"ja"),purpose:m(t,["purpose"],""),message:m(t,["message"],""),status:m(t,["status"],"new"),repliedAt:m(t,["replied_at"],""),confirmedTime:m(t,["confirmed_time"],""),createdAt:m(t,["created_at"],new Date().toISOString())}))}async function Cn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>N);return{supabaseInsert:i}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const Ln=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function Ja(){return(await Promise.all(Ln.map(async t=>{const[n,i]=await Promise.all([vt(t.table),w(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:i[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function Fe(e,t,n=100){const i=(t-1)*n,[r,c]=await Promise.all([w(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(i)}),vt(e)]);return{records:r,total:c}}async function ct(e){const t=await w("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const i=JSON.parse(n);return String(i.price_group??"")}catch{return""}return""}async function Ua(e,t){if(e){const i=await w("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(i.length>0&&i[0].special_price)return C(i[0].special_price)}const n=await w("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?C(n[0].default_sale_price):0}const $=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:xt,CALENDAR_CATEGORY_LABELS:St,DEPT_LABELS:Ve,INVOICE_TYPE_LABELS:lt,JIKOMI_STATUS_LABELS:Aa,MATERIAL_CATEGORIES:Ba,PROSPECT_STAGE_COLORS:Xe,PROSPECT_STAGE_LABELS:Ae,ROLE_LABELS:ze,SEASONAL_TEMPLATES:bt,SLACK_EVENT_LABELS:Je,TAX_DEDUCTION_LABELS:rt,TAX_RATE_CATEGORIES:qa,convertLeadToProspect:Sn,deleteCalendarEvent:Us,deleteMailSender:zs,deleteMaterial:hn,deletePrintLayout:Ms,deleteProspect:dn,deleteUserProfile:an,fetchAnnouncements:fa,fetchAuditLogs:nn,fetchBillList:Pa,fetchBillingSummary:_t,fetchCalendarEvents:Vs,fetchCallLogs:fn,fetchCustomerAnalysis:xa,fetchCustomerEfficiency:Sa,fetchCustomerLedger:gt,fetchCustomerPriceGroup:ct,fetchCustomerPricing:_a,fetchDeliveryLocations:yn,fetchDeliveryNote:$t,fetchDeliverySchedule:Is,fetchFaxInbox:Qs,fetchIntegrationSettings:ja,fetchInvoices:Be,fetchJikomiList:Ea,fetchKenteiList:La,fetchLeadItems:_n,fetchLeadLists:$n,fetchMailSenders:Fs,fetchMasterStats:pa,fetchMaterialList:ot,fetchMyProfile:en,fetchPayableList:Da,fetchPaymentStatus:ua,fetchPipelineMeta:ma,fetchPrintLayouts:Os,fetchProductABC:Ds,fetchProductMonthlyShipments:Ls,fetchProductPower:ka,fetchProductPrice:Ua,fetchProspectActivities:un,fetchProspects:cn,fetchPurchaseList:Ia,fetchRawMaterialStock:Na,fetchRawRecords:Fe,fetchRawTableList:Ja,fetchSalesAnalytics:ya,fetchSalesReport:Ge,fetchSalesSummary:da,fetchShopifyOrders:Hs,fetchSlackLogs:on,fetchSlackRules:Ma,fetchStoreOrders:Ra,fetchStoreSales:kt,fetchSyncDashboard:ha,fetchTankList:Ca,fetchTaxDeclaration:wt,fetchTourInquiriesFromDb:En,fetchUserProfiles:Zs,fetchWorkflowOrdersFromDb:xn,generateTaxCSV:qs,generateTaxXML:Ta,ocrFaxImage:Ws,recalculateTaxDeclaration:Ts,recordAudit:sn,resolveProductPrice:wa,saveCalendarEvent:Js,saveCallLog:za,saveDeliveryLocation:vn,saveEmailCampaign:Me,saveFaxRecord:Ks,saveIntegrationSetting:xe,saveInvoice:va,saveLeadItem:Va,saveLeadList:wn,saveMailSender:Bs,saveMaterial:mn,savePrintLayout:js,saveProspect:Fa,saveProspectActivity:pn,saveSlackRule:ln,saveTaxDeclaration:Rs,saveTourInquiry:Cn,saveUserProfile:tn,saveWorkflowOrder:An,searchPlaces:kn,sendEmailCampaign:Oa,sendSlackNotification:rn,submitFeatureRequest:ba,syncGoogleCalendar:Xs,syncIvryCallLogs:bn,syncPhoneBookToIvry:gn,syncShopifyOrders:Ys,updateCustomer:ga,updateProduct:$a},Symbol.toStringTag,{value:"Module"}));function oe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const In={open:"未締め",closed:"締め済"};function Dn(e,t){const n=e.customers.map(i=>`
      <tr>
        <td>
        ...
        <td class="numeric">${oe(i.salesAmount)}</td>
        <td class="numeric">${oe(i.taxAmount)}</td>
        <td class="numeric">${oe(i.prevBalance)}</td>
        <td class="numeric">${oe(i.paymentAmount)}</td>
        <td class="numeric"><strong>${oe(i.billingAmount)}</strong></td>
        <td>
          <span class="status-pill ${i.status==="closed"?"success":"warning"}">${In[i.status]}</span>
        </td>
        <td>
  ...
  `}function Ya(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function $e(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function qn(e){return e.salesHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':e.salesHistory.map(t=>`
        <tr>
          <td>${Ya(t.date)}</td>
          <td class="mono">${t.documentNo}</td>
          <td class="numeric">${$e(t.amount)}</td>
        </tr>
      `).join("")}function Tn(e){return e.paymentHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':e.paymentHistory.map(t=>`
        <tr>
          <td>${Ya(t.date)}</td>
          <td>${t.method}</td>
          <td class="numeric">${$e(t.amount)}</td>
  ...
  `}const On={forecasts:[],deliveries:[],calendarMonth:new Date().toISOString().slice(0,7),selectedSegment:"all"},Rt={monthly:"月次生産","made-to-order":"受注生産","november-only":"11月限定","annual-batch":"年間一括"},me={monthly:"#0F5B8D","made-to-order":"#6b46c1","november-only":"#c05621","annual-batch":"#2f855a"};function jn(e){const t=e.filter(r=>r>0).length,n=e.reduce((r,c)=>r+c,0);if(n===0)return"made-to-order";const i=e[10]/n;return e[11]/n,i>.5?"november-only":t<=3?"made-to-order":t<=4&&i<.3?"annual-batch":"monthly"}function Ha(e,t){if(t==="monthly"){const r=e.filter((a,l)=>l!==11).filter(a=>a>0);if(r.length===0)return 0;const c=[...r].sort((a,l)=>a-l);if(c.length>2){const a=c.slice(0,-1);return Math.round(a.reduce((l,o)=>l+o,0)/a.length)}return Math.round(r.reduce((a,l)=>a+l,0)/r.length)}if(t==="november-only")return e[10];if(t==="annual-batch")return e.reduce((i,r)=>i+r,0);const n=e.filter(i=>i>0);return n.length>0?Math.round(n.reduce((i,r)=>i+r,0)/n.length):0}function Mn(e,t){const n=(new Date().getMonth()+1)%12;if(t==="november-only")return n===10?e[10]:0;if(t==="annual-batch"){const i=e.indexOf(Math.max(...e));return n===i?e.reduce((r,c)=>r+c,0):0}return t==="made-to-order"?0:e[n]>0?e[n]:Ha(e,t)}function Fn(e){return e.slice(0,50).map(t=>{const n=t.monthlyQuantity,i=jn(n),r=Math.round(t.totalQuantity/12),c=Ha(n,i),a=Mn(n,i),l=i==="monthly"?c*11+n[11]:t.totalQuantity,o=i==="monthly"?Math.round(c*1.5):i==="november-only"?Math.round(n[10]*.1):0;return{code:t.code,name:t.name,segment:i,monthlyQuantity:n,avgMonthly:r,adjustedAvg:c,nextMonthForecast:a,annualForecast:l,safetyStock:o}})}function Bn(e){const t=new Date().toISOString().slice(0,10);return e.map(n=>({date:n.date,customerName:n.customerName,productName:n.productName,quantity:n.quantity,status:n.date>t?"scheduled":"delivered"}))}function zn(e){const[t,n]=e.split("-").map(Number);return new Date(t,n,0).getDate()}function Vn(e){const[t,n]=e.split("-").map(Number);return new Date(t,n-1,1).getDay()}function Ga(e,t){const n=zn(t),i=Vn(t),[r,c]=t.split("-").map(Number),a=new Map;e.forEach(x=>{if(x.date.slice(0,7)===t){const S=x.date.slice(0,10);a.has(S)||a.set(S,[]),a.get(S).push(x)}});const l=e.filter(x=>x.date.slice(0,7)===t),o=l.reduce((x,S)=>x+S.quantity,0),d=new Set(l.map(x=>x.date)).size,u=new Date().toISOString().slice(0,10),p=["日","月","火","水","木","金","土"].map(x=>`<th class="dcal-header">${x}</th>`).join("");let h="",v=1;for(let x=0;x<6&&!(v>n&&x>0);x++){h+="<tr>";for(let S=0;S<7;S++)if(x===0&&S<i||v>n)h+='<td class="dcal-cell dcal-empty"></td>';else{const T=`${r}-${String(c).padStart(2,"0")}-${String(v).padStart(2,"0")}`,B=a.get(T)||[],Z=T===u,We=B.reduce((Ee,Q)=>Ee+Q.quantity,0);h+=`
          <td class="dcal-cell ${Z?"dcal-today":""}">
            <div class="dcal-day">${v}</div>
            ${B.length>0?`
              <div class="dcal-entries">
                <div class="dcal-entry dcal-${B[0].status}">${B.length}件 ${We}本</div>
              </div>
            `:""}
          </td>`,v++}h+="</tr>"}const[_,A]=c===1?[r-1,12]:[r,c-1],[k,L]=c===12?[r+1,1]:[r,c+1],V=`${_}-${String(A).padStart(2,"0")}`,q=`${k}-${String(L).padStart(2,"0")}`;return`
    <section class="panel">
      <div class="panel-header">
        <div>
          <h2>納品カレンダー</h2>
          <p class="panel-caption">${r}年${c}月: ${d}日稼働 / ${l.length}件 / 合計${o.toLocaleString()}本</p>
        </div>
        <div style="display:flex;align-items:center;gap:8px;">
          <button class="button secondary small" type="button" data-action="dcal-prev" data-month="${V}">◀</button>
  ...
  `}const Ot=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"];function Jn(e,t){const n=t==="all"?e:e.filter(l=>l.segment===t),i={all:e.length,monthly:e.filter(l=>l.segment==="monthly").length,"made-to-order":e.filter(l=>l.segment==="made-to-order").length,"november-only":e.filter(l=>l.segment==="november-only").length,"annual-batch":e.filter(l=>l.segment==="annual-batch").length},r=["all","monthly","made-to-order","november-only","annual-batch"].map(l=>`
      <button class="button ${t===l?"primary":"secondary"} small" type="button" data-action="forecast-segment" data-segment="${l}">
        ${l==="all"?"全て":Rt[l]} (${i[l]})
      </button>
    `).join(""),c=new Date().getMonth(),a=n.map(l=>{const o=Math.max(...l.monthlyQuantity,1),d=l.monthlyQuantity.map((u,p)=>{const h=u/o;return`<td class="forecast-heat" style="background:${p===c?`rgba(15,91,141,${.15+h*.55})`:p===11?`rgba(200,50,50,${h*.4})`:`rgba(100,100,100,${h*.35})`};" title="${Ot[p]}: ${u.toLocaleString()}本">${u>0?u.toLocaleString():"—"}</td>`}).join("");return`
      <tr>
        <td class="mono">${l.code}</td>
        <td>${l.name}</td>
        <td><span class="segment-badge" style="background:${me[l.segment]};">${Rt[l.segment]}</span></td>
        ${d}
        ...
        <table class="forecast-table">
          <thead>
            <tr>
              ...
              <th>商品名</th>
              <th>区分</th>
              ${Ot.map((l,o)=>`<th class="forecast-month-th ${o===c?"current-month":""}">${l}</th>`).join("")}
  ...
  `}function Un(e){return`
    ...
    ${Ga(e.deliveries,e.calendarMonth)}
    ${Jn(e.forecasts,e.selectedSegment)}
  `}function Yn(e,t){return Ga(e,t)}const Le={today:"当日",month:"当月","90days":"90日",year:"1年",all:"全期間",custom:"指定期間"};function jt(e,t){const n=new Date(e);return n.setFullYear(n.getFullYear()+t),n.toISOString()}function Hn(e,t,n){if(t==="all")return e;const i=new Date,r=i.toISOString().slice(0,10),c=new Date(i);switch(t){case"today":return e.filter(a=>a.date.slice(0,10)===r);case"month":return e.filter(a=>a.date.slice(0,7)===r.slice(0,7));case"90days":return c.setDate(c.getDate()-90),e.filter(a=>a.date>=c.toISOString());case"year":return c.setFullYear(c.getFullYear()-1),e.filter(a=>a.date>=c.toISOString());case"custom":return!n?.start||!n?.end?e:e.filter(a=>{const l=a.date.slice(0,10);return l>=n.start&&l<=n.end})}}function U(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ie(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function he(e,t){for(const n of t){const i=e[n];if(typeof i=="number"&&Number.isFinite(i))return i;if(typeof i=="string"){const r=Number(i);if(Number.isFinite(r))return r}}return null}function Gn(e){const t=e?.productTotals;if(!t||t.length===0)return"―";const n=t.reduce((r,c)=>{const a=he(c,["amount","salesAmount"]),l=he(c,["marginRate","grossMarginRate"]);return a===null||a<=0||l===null?r:{weightedAmount:r.weightedAmount+a,weightedRate:r.weightedRate+a*l}},{weightedAmount:0,weightedRate:0});if(n.weightedAmount>0)return`${(n.weightedRate/n.weightedAmount).toFixed(1)}%`;const i=t.reduce((r,c)=>{const a=c,l=he(a,["amount","salesAmount"]),o=he(a,["grossProfit","grossAmount","margin"]),d=he(a,["costAmount","cost","costPrice"]);if(l===null||l<=0)return r;const u=o??(d!==null?l-d:null);return u===null?r:{sales:r.sales+l,gross:r.gross+u}},{sales:0,gross:0});return i.sales>0?`${(i.gross/i.sales*100).toFixed(1)}%`:"―"}function Xn(e){const i={top:20,right:20,bottom:30,left:50},r=760-i.left-i.right,c=260-i.top-i.bottom,a=Math.max(...e.map(u=>u.amount),1),l=r/e.length,o=e.map((u,p)=>{const h=u.amount/a*c,v=i.left+p*l+4,_=i.top+c-h,A=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(u.date));return`
        <g>
          <rect x="${v}" y="${_}" width="${Math.max(l-8,8)}" height="${h}" rx="4" fill="#0F5B8D" opacity="${.58+p/e.length*.34}" />
          ${p%5===0?`<text x="${v+6}" y="252" class="chart-axis">${A}</text>`:""}
        </g>
      `}).join("");return`
    <svg viewBox="0 0 760 260" class="sales-chart" role="img" aria-label="直近30日の日次売上">
      ${[0,.25,.5,.75,1].map(u=>{const p=i.top+c-c*u,h=Math.round(a*u/1e3);return`
        <g>
  ...
  `}function Qn(e,t,n,i,r="month",c){const a={success:"正常",warning:"注意",error:"異常",running:"実行中"},l=Hn(e.allDailySales,r,c),o=l.reduce((x,S)=>x+S.amount,0),d=l.reduce((x,S)=>x+S.bottles,0),u=l.reduce((x,S)=>x+S.volumeMl,0),p=l.length,h=d>0?Math.round(o/d):0,v=u>0?Math.round(o/(u/1e3)):0,A=(l.length>0?e.allDailySales.filter(x=>{const S=l[0]?.date??"",T=l[l.length-1]?.date??"",B=jt(S,-1),Z=jt(T,-1);return x.date>=B&&x.date<=Z}):[]).reduce((x,S)=>x+S.amount,0),k=A>0?(o-A)/A*100:0,L=k>0?"+":"",V=e.salesRecords.slice(0,10).map(x=>`
            <tr>
              <td class="mono">${x.documentNo}</td>
              <td>${Ie(x.date)}</td>
              <td>${x.customerName}</td>
              <td class="numeric">${U(x.amount)}</td>
            </tr>
          `).join(""),q=["today","month","90days","year","all"].map(x=>`<button class="button ${x===r?"primary":"secondary"} small" type="button" data-period="${x}">${Le[x]}</button>`).join("");return`
    <section class="page-head">
      <div>
      ...
      <div class="meta-stack">
        ...
        <span class="meta-note">最終同期 ${Ie(t.lastSyncAt)}</span>
    ...
    <section class="kpi-grid">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${U(e.kpis.todaySales)}</p>
        <p class="kpi-sub">前日比 ${e.kpis.todayDelta>0?"+":""}${e.kpis.todayDelta.toFixed(1)}%</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">${Le[r]}売上</p>
        <p class="kpi-value">${U(o)}</p>
        <p class="kpi-sub">${p}日間${p>0?` / 日平均 ${U(Math.round(o/p))}`:""}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">昨対比</p>
        <p class="kpi-value" style="color:${k>=0?"#2f855a":"#c53d3d"}">${A>0?`${L}${k.toFixed(1)}%`:"―"}</p>
        <p class="kpi-sub">前年同期 ${A>0?U(A):"データなし"}</p>
      </article>
      <article class="panel kpi-card kpi-alert">
        ...
        <p class="kpi-sub">残高 ${U(e.kpis.unpaidAmount)}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">月次粗利率</p>
        <p class="kpi-value">${Gn(n)}</p>
    ...
    <section class="content-grid">
      <article class="panel">
        <div class="panel-header">
          <div>
            <h2>日次売上</h2>
            <p class="panel-caption">${Le[r]} (${l.length}日分)</p>
          </div>
        </div>
        <div class="chart-scroll">
          ${Xn(l.length>0?l:e.dailySales)}
        </div>
      </article>
      ...
      <aside class="panel sync-panel">
        <div>
          ...
          <dl class="meta-list">
            ...
            <div>
              <dt>最終同期</dt>
              <dd>${Ie(t.lastSyncAt)}</dd>
            </div>
            <div>
              <dt>更新時刻</dt>
              <dd>${Ie(t.generatedAt)}</dd>
            </div>
          </dl>
        </div>
    ...
    <details class="panel collapsible-panel">
      <summary class="panel-header clickable">
        <div>
          <h2>日次推移</h2>
          <p class="panel-caption">${Le[r]} — 売上・本数・液体量・単価（${l.length}日分）</p>
        </div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>${l.slice().reverse().slice(0,31).map(x=>`
            <tr>
              ...
              <td class="numeric">${U(x.pricePerBottle)}</td>
              <td class="numeric">${U(x.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
  ...
  `}function Wn(e){const t=e.prospects.reduce((a,l)=>a+l.expectedAmount*l.probability/100,0),n=e.prospects.filter(a=>a.stage==="hot"||a.stage==="negotiating").length,i=new Date().toISOString().slice(0,10),r=e.upcomingEvents.filter(a=>a.startsAt.slice(0,10)>=i).slice(0,5),c=e.tourInquiries.filter(a=>a.status==="new").length;return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
    ...
    <section class="content-grid">
      <article class="panel">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(100px, 1fr));gap:8px;">
          ${["cold","warm","hot","contacted","negotiating","won"].map(a=>{const l=e.prospects.filter(d=>d.stage===a).length,o=e.prospects.filter(d=>d.stage===a).reduce((d,u)=>d+u.expectedAmount,0);return`
              <div style="background:${Xe[a]};color:white;padding:12px;border-radius:6px;text-align:center;">
      ...
      <aside class="panel">
        ...
        ${r.length===0?'<p class="empty-note">予定なし</p>':`<div style="display:grid;gap:8px;">${r.map(a=>{const l=new Date(a.startsAt);return`
    ...
    ${e.deliveries&&e.deliveries.length>0?Yn(e.deliveries,e.deliveryCalendarMonth||new Date().toISOString().slice(0,7)):""}
  `}function Kn(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function re(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Zn(e,t){const n=e.lines.length?e.lines.map((r,c)=>`
          <tr>
    ...
    <article class="panel delivery-note-body" id="delivery-print-area">
      <div class="delivery-header">
        ...
        <div class="delivery-meta">
          <table class="delivery-meta-table">
            ...
            <tr><th>納品日</th><td>${Kn(e.invoiceDate)}</td></tr>
      ...
      <div class="delivery-footer">
        <div class="delivery-totals">
          <div class="total-stack"><span class="total-label">小計</span><span class="total-value">${re(i)}</span></div>
  ...
  `}function H(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ei(e){return H(e).replaceAll(`
`,"<br />")}function ti(e){const n=[...Object.values(bt),{id:"custom",season:"カスタム",subject:"",body:""}].map(r=>`
        <button
        ...
        >
          ...
          <strong>${H(r.subject||"空テンプレート")}</strong>
        </button>
      `).join(""),i=e.previewRecipients.length?e.previewRecipients.map(r=>`
            <li>
              <span>${H(r.name)}</span>
              <span class="table-sub">${H(r.email)} / ${H(r.area)}</span>
            </li>
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="field">
          <span>件名</span>
          <input id="email-subject" type="text" value="${H(e.subject)}" />
        </div>
        <div class="field">
          <span>本文</span>
          <textarea id="email-body" rows="12">${H(e.body)}</textarea>
        </div>
      ...
      <article class="panel">
        ...
        <label class="field" style="margin-bottom:12px;">
          ...
          <select id="email-sender">
            ${e.senders.map(r=>`<option value="${r.id}" ${r.id===e.senderId?"selected":""}>${H(r.name)} &lt;${H(r.email)}&gt;${r.isVerified?"":" ⚠️未認証"}</option>`).join("")}
        ...
        <div class="email-preview">
          <p class="panel-title">${H(e.subject||"件名未入力")}</p>
          <div class="preview-box">${e.body?ei(e.body):"本文未入力"}</div>
        </div>
        ${e.saveMessage?`<p class="meta-note">${H(e.saveMessage)}</p>`:""}
        <div class="action-bar">
  ...
  `}function Y(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function De(e,t){return t.length===0?"":`
  ...
  `}function ai(e,t){const n=[De("得意先",t.customers.map(r=>`
          <button
            ...
            data-path="/master"
          >
            <strong>${Y(r.name)}</strong>
            <span class="table-sub mono">${Y(r.code)}</span>
          </button>
        ...
        `)),De("伝票",t.documents.map(r=>`
          <button
            ...
            data-path="/invoice"
          >
            <strong>${Y(r.documentNo)}</strong>
            <span class="table-sub">${Y(r.customerName)} / ${Y(r.date)}</span>
          </button>
        `)),De("ページ",t.pages.map(r=>`
          <button
            ...
            data-path="${Y(r.path)}"
          >
            <strong>${Y(r.title)}</strong>
            <span class="table-sub mono">${Y(r.path)}</span>
          </button>
  ...
  `}function ye(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Xa(e){const t=e.resultsHtml.trim()?e.resultsHtml:`<p class="empty-note">${ye(e.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function Pe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Mt(e){return e.trim().toLowerCase()}function si(e,t){const n=Mt(t),i=e.filter(c=>n?[c.code,c.name,c.name].map(Mt).some(a=>a.includes(n)):!0).slice(0,50),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Xa({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:r,emptyMessage:"該当する得意先が見つかりません。"})}function ni(e){return e.toISOString().slice(0,10)}function le(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function te(e,t){return e[t]?`<div class="field-error">${le(e[t])}</div>`:""}function ce(e,t,n=""){return[n,e[t]?"has-error":""].filter(Boolean).join(" ")}function ii(e,t,n,i){const r=Object.keys(lt).map(o=>`<option value="${o}" ${e.invoiceType===o?"selected":""}>${lt[o]}</option>`).join(""),c=e.lines.map((o,d)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${ce(i,`lines.${d}.productCode`,"input-cell")}" type="text" data-line="${d}" data-field="productCode" value="${le(o.productCode)}" placeholder="P00001" />
            <button class="picker-btn" type="button" data-action="open-product-picker" data-line="${d}" aria-label="商品検索">🔍</button>
          </div>
          ${te(i,`lines.${d}.productCode`)}
        </td>
        <td>
          <input class="${ce(i,`lines.${d}.productName`,"input-cell")}" type="text" data-line="${d}" data-field="productName" value="${le(o.productName)}" placeholder="商品名" />
          ${te(i,`lines.${d}.productName`)}
        </td>
        <td>
          <input class="${ce(i,`lines.${d}.quantity`,"input-cell numeric")}" type="number" data-line="${d}" data-field="quantity" value="${o.quantity}" min="0" />
          ${te(i,`lines.${d}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${d}" data-field="unit" value="${o.unit}" placeholder="本" /></td>
        <td>
          <input class="${ce(i,`lines.${d}.unitPrice`,"input-cell numeric")}" type="number" data-line="${d}" data-field="unitPrice" value="${o.unitPrice}" min="0" />
          ${te(i,`lines.${d}.unitPrice`)}
        </td>
    ...
    `).join(""),a=e.lines.reduce((o,d)=>o+d.amount,0),l=Math.floor(a*10/110);return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${ce(i,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||ni(new Date)}" />
          ${te(i,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
  ...
  `}const li={showQuoteNo:!0,showValidUntil:!0,showSubject:!0,showDeliveryDate:!1,showPaymentTerms:!0,showDeliveryPlace:!1,showRemarks:!0,showSeal:!0,headerNote:"",footerNote:""},Qa={quoteNo:"",quoteDate:new Date().toISOString().slice(0,10),validUntil:"",customerCode:"",customerName:"",customerAddress:"",subject:"",lines:[],remarks:"",taxRate:10,deliveryDate:"",paymentTerms:"月末締め翌月末払い",deliveryPlace:"",previewMode:!1,sealSettings:null,fieldConfig:{...li}};function G(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function E(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Wa(e){const t=e.lines.reduce((a,l)=>a+l.amount,0),n=Math.round(t*e.taxRate/100),i=t+n,r=e.fieldConfig,c=[];return r.showValidUntil&&e.validUntil&&c.push(`<tr><th>有効期限</th><td>${e.validUntil}</td></tr>`),r.showDeliveryDate&&e.deliveryDate&&c.push(`<tr><th>納期</th><td>${E(e.deliveryDate)}</td></tr>`),r.showPaymentTerms&&e.paymentTerms&&c.push(`<tr><th>支払条件</th><td>${E(e.paymentTerms)}</td></tr>`),r.showDeliveryPlace&&e.deliveryPlace&&c.push(`<tr><th>納品場所</th><td>${E(e.deliveryPlace)}</td></tr>`),`
      ...
      <div class="quote-preview-inner">
        ...
        <div class="quote-preview-meta">
          <div class="quote-preview-customer">
            <p class="quote-preview-customer-name">${E(e.customerName||"（得意先未選択）")} 御中</p>
            ${e.customerAddress?`<p class="quote-preview-addr">${E(e.customerAddress)}</p>`:""}
          </div>
          <div class="quote-preview-info">
            ${r.showQuoteNo&&e.quoteNo?`<p>No. ${E(e.quoteNo)}</p>`:""}
            <p>${e.quoteDate}</p>
        ...
        ${r.headerNote?`<p class="quote-preview-note">${E(r.headerNote)}</p>`:""}

        ${r.showSubject&&e.subject?`<p class="quote-preview-subject">件名: ${E(e.subject)}</p>`:""}

        <div class="quote-preview-total-banner">
          <span>合計金額</span>
          <span class="quote-preview-total-value">${G(i)}（税込）</span>
        </div>
        ...
        <table class="quote-preview-table">
          ...
          <tbody>
            ${e.lines.map((a,l)=>`
              <tr>
                ...
                <td>${E(a.productName)}</td>
                <td style="text-align:right;">${a.quantity.toLocaleString()}</td>
                <td style="text-align:center;">${E(a.unit)}</td>
          ...
          <tfoot>
            ...
            <tr class="quote-preview-total-row"><td colspan="5" style="text-align:right;font-weight:700;">合計</td><td style="text-align:right;font-weight:700;">${G(i)}</td></tr>
          </tfoot>
        </table>
        ...
        ${r.showRemarks&&e.remarks?`
          <div class="quote-preview-remarks">
            ...
            <p>${E(e.remarks).replace(/\n/g,"<br/>")}</p>
          </div>
        `:""}

        ${r.footerNote?`<p class="quote-preview-footer-note">${E(r.footerNote)}</p>`:""}
      </div>
    </div>
  `}function oi(e){const t=(n,i,r)=>`
    ...
    <section class="panel">
      ...
      <div class="quote-notes-grid" style="margin-top:12px;">
        <div class="form-row">
          ...
          <input type="text" id="q-header-note" value="${E(e.headerNote)}" placeholder="例: 下記のとおりお見積り申し上げます" />
        </div>
        <div class="form-row">
          <label>フッターメモ（見積書���部に表示）</label>
          <input type="text" id="q-footer-note" value="${E(e.footerNote)}" placeholder="例: 本見積書に関するご不明点はお気軽にお問合せください" />
        </div>
      </div>
    </section>
  ...
  `}function ci(e,t,n,i,r,c){const a=e.lines.reduce((h,v)=>h+v.amount,0),l=Math.round(a*e.taxRate/100),o=a+l,d=i.length>=1?t.filter(h=>h.name.includes(i)||h.code.includes(i)).slice(0,8):[],u=r.length>=1?n.filter(h=>h.name.includes(r)||h.code.includes(r)).slice(0,8):[],p=e.fieldConfig;return e.previewMode?`
      <section class="page-head">
        <div>
    ...
    <section class="panel">
      <div class="quote-header-grid">
        ...
        <div class="form-row">
          <label>見積番号</label>
          <input type="text" id="q-no" value="${E(e.quoteNo)}" placeholder="自動採番" />
        </div>`:""}
        <div class="form-row">
          <label>見積日</label>
        ...
        <div class="form-row">
          <label>納期</label>
          <input type="text" id="q-delivery-date" value="${E(e.deliveryDate)}" placeholder="例: 受注後2週間" />
        </div>`:""}
        ${p.showPaymentTerms?`
        <div class="form-row">
          <label>支払条件</label>
          <input type="text" id="q-payment-terms" value="${E(e.paymentTerms)}" placeholder="月末締め翌月末���い" />
        </div>`:""}
        ${p.showDeliveryPlace?`
        <div class="form-row">
          <label>納品場所</label>
          <input type="text" id="q-delivery-place" value="${E(e.deliveryPlace)}" placeholder="例: 貴社指定場所" />
        </div>`:""}
      </div>
    </section>
    ...
    <section class="panel">
      ...
      ${d.length>0?`
        <div class="search-results">
          ${d.map(h=>`
            <button class="search-item" type="button" data-select-customer="${h.code}" data-cust-name="${E(h.name)}" data-cust-addr="${E(h.address1||"")}">
              <span class="mono">${h.code}</span> ${E(h.name)}
            </button>
          `).join("")}
        </div>
      `:""}
      ${e.customerName?`
        <div class="selected-item">
          <span class="mono">${e.customerCode}</span> <strong>${E(e.customerName)}</strong>
          ${e.customerAddress?`<br/><span style="color:var(--text-secondary);font-size:13px;">${E(e.customerAddress)}</span>`:""}
        </div>
      `:""}
    </section>
    ...
    <section class="panel">
      ...
      ${u.length>0?`
        <div class="search-results">
          ${u.map(h=>{const v=c?wa(h,c):{price:h.salePrice||0,label:"標準価格"},_=v.label!=="標準価格";return`
            <button class="search-item" type="button" data-add-product="${h.code}" data-prod-name="${E(h.name)}" data-prod-price="${v.price}">
              <span class="mono">${h.code}</span> ${E(h.name)}
              <span class="numeric" ${_?'style="color:#2f855a;font-weight:700;"':""}>${v.price?G(v.price):""} <small>(${v.label})</small></span>
            </button>`}).join("")}
        </div>
      `:""}
          ...
          <tbody>
            ${e.lines.map((h,v)=>`
              <tr>
                ...
                <td>${E(h.productName)}</td>
                <td class="numeric"><input type="number" class="qty-input" data-line-idx="${v}" value="${h.quantity}" min="0" style="width:60px;text-align:right;" /></td>
                <td>${E(h.unit)}</td>
                <td class="numeric"><input type="number" class="price-input" data-line-idx="${v}" value="${h.unitPrice}" min="0" style="width:80px;text-align:right;" /></td>
                <td class="numeric">${G(h.amount)}</td>
    ...
    <section class="panel">
      <div class="quote-summary">
        ...
        <div class="form-row">
          <label>備考</label>
          <textarea id="q-remarks" rows="2">${E(e.remarks)}</textarea>
        </div>`:""}
        <div class="quote-totals">
          <div><span>小計</span><span class="numeric">${G(a)}</span></div>
          <div><span>消費税(${e.taxRate}%)</span><span class="numeric">${G(l)}</span></div>
    ...
    ${oi(p)}
    ${ri(e.sealSettings)}
  `}function di(e){const t=Wa(e),n=window.open("","_blank","width=800,height=1100");if(!n){alert("ポップアップがブロックされました。許可してください。");return}n.document.write(`<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8" />
...
<\/script>
...
</html>`),n.document.close()}function Ka(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Za(e){return`<span style="display:inline-block;width:24px;height:24px;border-radius:50%;background:${{A:"#2f855a",B:"#2b6cb0",C:"#b7791f"}[e]||"#9aa5b1"};color:white;text-align:center;line-height:24px;font-weight:700;font-size:12px;">${e}</span>`}function es(e){return e==null?'<span style="color:#9aa5b1;">新規</span>':`<span style="color:${e>=0?"#2f855a":"#c53d3d"};font-weight:700;">${e>=0?"+":""}${e.toFixed(1)}%</span>`}function ui(e,t){return!t||e===t?"":e<t?`<span style="color:#2f855a;font-size:11px;">&#x2191;${t}&#x2192;${e}</span>`:`<span style="color:#c53d3d;font-size:11px;">&#x2193;${t}&#x2192;${e}</span>`}function pi(e,t="all"){const n=e.filter(u=>u.rank==="A").length,i=e.filter(u=>u.rank==="B").length,r=e.filter(u=>u.rank==="C").length,c=e.filter(u=>u.growthRate!=null&&u.growthRate>10),a=e.filter(u=>u.growthRate!=null&&u.growthRate<-10);let l=e,o="全商品";switch(t){case"A":l=e.filter(u=>u.rank==="A"),o="Aランク";break;case"B":l=e.filter(u=>u.rank==="B"),o="Bランク";break;case"C":l=e.filter(u=>u.rank==="C"),o="Cランク";break;case"growing":l=c,o="成長商品(+10%以上)";break;case"declining":l=a,o="衰退商品(-10%以下)";break}const d=(u,p,h)=>`<button class="button ${t===u?"primary":"secondary"} small" data-product-filter="${u}">${p} (${h})</button>`;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>商品力分析</h1>
    ...
    <section class="panel">
      ...
      <div class="button-group" style="margin-bottom:12px;">
        ...
        ${d("B","B",i)}
        ${d("C","C",r)}
        ${d("growing","成長",c.length)}
        ${d("declining","衰退",a.length)}
      </div>
      <div class="table-wrap">
        <table>
          <thead>
          ...
          <tbody>
            ${l.slice(0,100).map(u=>`
              <tr>
                <td>${Za(u.rank)}</td>
                <td>${u.name?u.name.slice(0,25):u.code}${u.volumeMl?` <small>${u.volumeMl}ml</small>`:""}</td>
                <td class="numeric">${Ka(u.yearAmount)}</td>
                <td class="numeric">${u.sharePct}%</td>
                <td class="numeric">${u.yearQty.toLocaleString()}</td>
                <td class="numeric">${es(u.growthRate)}</td>
              </tr>
            `).join("")}
  ...
  `}function mi(e){const t=e.filter(r=>r.currentRank==="A").length,n=e.filter(r=>r.prevRank&&r.currentRank<r.prevRank).length,i=e.filter(r=>r.prevRank&&r.currentRank>r.prevRank).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>営業効率分析</h1>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${e.slice(0,50).map(r=>`
              <tr>
                <td>${Za(r.currentRank)}</td>
                <td>${r.name||r.code}</td>
                <td class="numeric">${Ka(r.yearAmount)}</td>
                <td class="numeric">${r.sharePct}%</td>
                <td class="numeric">${r.orderDays}日</td>
                <td class="numeric">${es(r.growthRate)}</td>
                <td>${ui(r.currentRank,r.prevRank)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function hi(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function yi(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function vi(e,t){const n=e.length?e.map(i=>`
            <tr>
              ...
              <td class="numeric">${yi(i.amount)}</td>
            </tr>
  ...
  `}function fi(e){return new Date(e.getFullYear(),e.getMonth(),1)}function bi(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function ts(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function as(e){const t=new Date(e),n=t.getDay();return t.setDate(t.getDate()-n),t.setHours(0,0,0,0),t}function Ft(e){const t=ts(as(e),6);return t.setHours(23,59,59,999),t}function Bt(e){return new Date(`${e}T00:00:00`)}function zt(e){return`${e.getMonth()+1}/${e.getDate()}`}function gi(e){return e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function $i(){const e=new Date,t=as(bi(fi(e),-3)),n=Ft(new Date(e.getFullYear(),e.getMonth()+4,0)),i=[];let r=new Date(t);for(;r<=n;){const c=Ft(r);i.push({start:new Date(r),end:c,label:`${zt(r)} - ${zt(c)}`}),r=ts(r,7)}return i}function _i(e){const t=$i(),n=`160px repeat(${t.length}, minmax(56px, 1fr))`,i=t.map(c=>`
        <div class="gantt-week">
          <span>${c.label}</span>
        </div>
      `).join(""),r=e.length?e.map(c=>{const a=Bt(c.startDate),l=Bt(c.expectedDoneDate),o=Math.max(0,t.findIndex(p=>p.end>=a)),d=Math.max(o,t.reduce((p,h,v)=>h.start<=l?v:p,o)),u=[`仕込番号: ${c.jikomiNo}`,`銘柄: ${c.productName}`,`期間: ${c.startDate} - ${c.expectedDoneDate}`,`タンク: ${c.tankNo}`,`備考: ${c.note||"なし"}`].join(`
`);return`
  ...
  `}function Vt(e,t){const n={planned:"neutral",active:"warning",done:"success"},i=e.map(l=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${n[l.status]}">${Aa[l.status]}</span>
        </td>
        <td>${l.note||"―"}</td>
      </tr>
    `).join(""),r=e.filter(l=>l.status==="active").length,c=e.filter(l=>l.status==="done").length,a=e.filter(l=>l.status==="planned").length;return`
    <section class="page-head">
      <div>
  ...
  `}function wi(e){const t={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},i=e.map(o=>`
      <tr>
  ...
  `}function ki(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Si(e,t){return`
  ...
  `}const At={query:"",businessType:"",areaCode:"",activeOnly:"",page:1},_e=50;function Ei(e,t){let n=e;if(t.query){const l=t.query.toLowerCase();n=n.filter(o=>o.code.toLowerCase().includes(l)||o.name.toLowerCase().includes(l)||o.kanaName&&o.kanaName.toLowerCase().includes(l)||o.address1&&o.address1.toLowerCase().includes(l)||o.phone&&o.phone.toLowerCase().includes(l))}t.businessType&&(n=n.filter(l=>l.businessType===t.businessType)),t.areaCode&&(n=n.filter(l=>l.areaCode===t.areaCode)),t.activeOnly==="active"?n=n.filter(l=>l.isActive):t.activeOnly==="inactive"&&(n=n.filter(l=>!l.isActive));const i=Math.max(1,Math.ceil(n.length/_e)),c=(Math.min(t.page,i)-1)*_e,a=n.slice(c,c+_e);return{filtered:n,paged:a,totalPages:i}}function Jt(e,t,n){if(n<=1)return`<div class="master-pagination"><span>${e}件</span></div>`;const i=(t-1)*_e+1,r=Math.min(t*_e,e),c=[];for(let a=1;a<=n;a++)a===1||a===n||a>=t-2&&a<=t+2?c.push(`<button class="button ${a===t?"primary":"secondary"}" type="button" data-action="master-page" data-page="${a}" style="min-width:36px;padding:4px 8px;">${a}</button>`):(a===t-3||a===t+3)&&c.push('<span style="padding:0 4px;color:var(--text-secondary);">…</span>');return`
  ...
  `}function Ci(e,t){const n=[...new Set(e.map(r=>r.businessType).filter(Boolean))].sort(),i=[...new Set(e.map(r=>r.areaCode).filter(Boolean))].sort();return`
  ...
  `}function dt(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Li(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function Ii(e){return e.map(t=>`
        <tr>
      ...
      `).join("")}function Ne(e){return e?`¥${e.toLocaleString("ja-JP")}`:"―"}function Di(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${dt(t.name,20)}</td>
          <td>${t.kanaName||""}</td>
          ...
          <td>${t.unit||""}</td>
          <td>${t.bottleType||""}</td>
          <td class="numeric">${Ne(t.purchasePrice)}</td>
          <td class="numeric">${Ne(t.salePrice)}</td>
          <td class="numeric">${Ne(t.listPrice)}</td>
          <td class="numeric">${Ne(t.costPrice)}</td>
          <td>${t.riceType||""}</td>
      ...
      `).join("")}function Pi(e,t,n=At){const{filtered:i,paged:r,totalPages:c}=Ei(e.customers,n);return`
    <section class="page-head">
      <div>
      ...
      `:`
        <div class="table-wrap">
          <table>
            ...
            <tbody>${Di(e.products)}</tbody>
          </table>
        </div>
      `}
    </section>
  `}function Ke(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ni(e,t){if(!e&&!t)return"";const n=e;return`
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 160px;">
              ...
              <select id="mat-type">
                ...
                ${Ba.map(i=>`<option ${n?.materialType===i?"selected":""}>${i}</option>`).join("")}
              </select>
            </label>
  ...
  `}function qi(e){const t=e.map(r=>{const a=(r.minimumStock>0?r.currentStock/r.minimumStock:1/0)<1.5;return`
        <tr>
          ...
          <td class="numeric">${Ke(r.unitCost)}</td>
          <td class="numeric">${Ke(r.currentStock*r.unitCost)}</td>
          <td>${r.lastUpdated}</td>
          <td>
  ...
  `}function Ti(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function Ze(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Ri={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Oi(e){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td class="numeric">${Ze(n.billedAmount)}</td>
          <td class="numeric">${Ze(n.paymentAmount)}</td>
          <td class="numeric">${Ze(n.balanceAmount)}</td>
          <td>${Ti(n.lastPaymentDate)}</td>
          <td><span class="status-pill ${n.status==="paid"?"success":n.status==="partial"?"warning":"danger"}">${Ri[n.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function de(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ut(e){return e.trim().toLowerCase()}function ji(e,t){const n=Ut(t),i=e.filter(c=>n?[c.code,c.name,c.janCode].map(Ut).some(a=>a.includes(n)):!0),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Xa({title:"商品検索",searchQuery:t,placeholder:"コード・名前・JANで検索",resultsHtml:r,emptyMessage:"該当する商品が見つかりません。"})}function ae(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Mi(e,t){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},i={pending:"warning",confirmed:"neutral",paid:"success"},r={unpaid:"未払い",partial:"一部支払",paid:"支払済"},c={unpaid:"warning",partial:"neutral",paid:"success"},a=e.map(p=>`
      <tr>
    ...
    `).join(""),o=e.reduce((p,h)=>p+h.amount,0),d=t.reduce((p,h)=>p+h.balance,0),u=t.filter(p=>p.status!=="paid").length;return`
    <section class="page-head">
      <div>
  ...
  `}function ve(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Fi(e,t){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},i={holding:"neutral",due:"warning",cleared:"success"},r=e.map(u=>`
      <tr>
    ...
    `).join(""),c=t.map(u=>{const p=u.minimumStock>0&&u.currentStock<u.minimumStock*1.2;return`
      ...
      `}).join(""),a=e.filter(u=>u.status==="holding"),l=a.reduce((u,p)=>u+p.amount,0),o=t.reduce((u,p)=>u+p.currentStock*p.unitCost,0),d=t.filter(u=>u.minimumStock>0&&u.currentStock<u.minimumStock*1.2).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">仕入管理</p>
        <h1>手形管理・原料在庫</h1>
  ...
  `}function ut(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function M(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function pt(e){return`
  ...
  `}function qe(e){return`
    <div class="setup-command-row">
      <code class="inline-code">${M(e)}</code>
      ${Bi(e)}
    </div>
  `}function ue(e){return`
    <div class="setup-step" data-step="${e.step}">
      ...
      <div class="setup-step-section">
        ...
        <ol class="setup-list">
          ${e.instructions.map(t=>`<li>${M(t)}</li>`).join("")}
        </ol>
      </div>
      ${e.code?pt(e.code):""}
      <div class="setup-step-section">
        ...
        <ul class="setup-list">
          ${e.success.map(t=>`<li>${M(t)}</li>`).join("")}
        </ul>
      </div>
      <div class="setup-step-section">
        <p class="panel-title">よくあるエラー</p>
        <ul class="setup-list">
          ${e.errors.map(t=>`<li>${M(t)}</li>`).join("")}
        </ul>
      </div>
    </div>
  `}function Te(e){return`
    <div class="setup-step setup-step-compact" data-step="${M(e.stepLabel)}">
      <h3>${M(e.title)}</h3>
      <div class="setup-step-section">
        <p class="panel-title">目的</p>
        <p>${M(e.purpose)}</p>
  ...
  `}function Re(e){if(!e)return"error";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"success":n<24?"warning":"error"}function Yt(e){if(!e)return"未同期";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"正常":n<24?"注意":"要確認"}function zi(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">
          <span class="status-pill ${Re(e.lastOverallSync)}">${Yt(e.lastOverallSync)}</span>
        </p>
        <p class="kpi-sub">${Re(e.lastOverallSync)==="success"?"1時間以内":Re(e.lastOverallSync)==="warning"?"24時間以内":"24時間超"}</p>
      </article>
    </section>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="status-pill ${Re(t.lastSyncAt)}">${Yt(t.lastSyncAt)}</span></td>
            </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function Vi(e,t,n,i){const r={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
      ...
      <div class="relay-config-list">
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${M(t)}</span>
          </div>
          <button
            class="button secondary"
            type="button"
            data-action="copy-config"
            data-config-value="${M(t)}"
          >
            コピー
          </button>
        </div>
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${M(n)}</span>
          </div>
          <button
            class="button secondary"
            type="button"
            data-action="copy-config"
            data-config-value="${M(n)}"
          >
            コピー
          </button>
        </div>
  ...
  `}function ge(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ji(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function Ui(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),n=Math.max(...t.map(p=>p.amount),1),i=28,r=6,c=140,a=100,l=760,o=l-c-a,d=t.length*(i+r)+16,u=t.map((p,h)=>{const v=p.amount/n*o,_=h*(i+r)+8,A=p.abcRank==="A"?"#2F855A":p.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
          <text x="${c-8}" y="${_+i/2+5}" class="chart-axis" text-anchor="end">${p.name.length>10?p.name.slice(0,10)+"…":p.name}</text>
          <rect x="${c}" y="${_}" width="${v}" height="${i}" rx="4" fill="${A}" opacity="0.85" />
          <text x="${c+v+8}" y="${_+i/2+5}" class="chart-axis">${(p.amount/1e4).toFixed(0)}万円</text>
        </g>
      `}).join("");return`
    <svg viewBox="0 0 ${l} ${d}" class="sales-chart ranking-chart" role="img" aria-label="得意先別売上ランキング">
      ${u}
    </svg>
  `}function Yi(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(i=>`<th class="numeric">${i}</th>`).join(""),n=e.monthlyByCustomer.map(i=>{const r=i.values.reduce((a,l)=>a+l,0),c=i.values.map(a=>`<td class="numeric">${a>0?(a/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${i.label}</td>
          ${c}
  ...
  `}function Hi(e){e.ranking.reduce((o,d)=>o+d.amount,0);const t=e.ranking.filter(o=>o.abcRank==="A").length,n=e.ranking.filter(o=>o.abcRank==="B").length,i=e.ranking.filter(o=>o.abcRank==="C").length,r=e.ranking.filter(o=>o.abcRank==="A").reduce((o,d)=>o+d.amount,0),c=e.ranking.filter(o=>o.abcRank==="B").reduce((o,d)=>o+d.amount,0),a=e.ranking.filter(o=>o.abcRank==="C").reduce((o,d)=>o+d.amount,0),l=e.ranking.map(o=>`
        <tr>
          ...
          <td><span class="status-pill ${Ji(o.abcRank)}">${o.abcRank}</span></td>
        </tr>
      `).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-row">
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value">${i}社 <span class="kpi-sub">${ge(a)}</span></div>
      </div>
    </section>
  ...
  `}function Gi(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Xi(e){return e.replace("-","/")}function Qi(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,i={top:16,right:24,bottom:36,left:64},r=t-i.left-i.right,c=n-i.top-i.bottom,a=Math.max(...e.map(u=>u.amount),1),l=r/e.length,o=[0,.25,.5,.75,1].map(u=>{const p=i.top+c-c*u,h=`${Math.round(a*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${i.left}" y1="${p}" x2="${t-i.right}" y2="${p}" class="chart-grid" />
          <text x="8" y="${p+4}" class="chart-axis">${h}</text>
        </g>
      `}).join(""),d=e.map((u,p)=>{const h=u.amount/a*c,v=Math.max(l-18,24),_=i.left+p*l+(l-v)/2,A=i.top+c-h;return`
        <g>
          <rect x="${_}" y="${A}" width="${v}" height="${h}" rx="6" class="analytics-bar" />
          <text x="${_+v/2}" y="${n-10}" class="chart-axis centered-axis">${Xi(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function Wi(e){return e.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
          <td class="numeric">${Gi(t.amount)}</td>
          <td class="numeric">${t.quantity.toLocaleString("ja-JP")}</td>
          <td class="numeric">${t.documents.toLocaleString("ja-JP")}</td>
        </tr>
      `).join("")}function Ki(e,t){const n=t==="products"?"商品別集計":"得意先別集計",i=t==="products"?e.productTotals:e.customerTotals;return`
    <section class="page-head">
      <div>
  ...
  `}function fe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Zi(e){const t=Math.max(...e.salesByProduct.flatMap(c=>c.values),1),n=e.salesByProduct.map(c=>{const a=c.values.map((l,o)=>`
          <div class="bar-col">
            <div class="bar" style="height:${Math.round(l/t*120)}px" title="${e.months[o]}: ${fe(l)}"></div>
    ...
    `).join(""),r=e.salesByCustomer.map(c=>{const a=c.values.reduce((l,o)=>l+o,0);return`
        <tr>
          <td>${c.label}</td>
  ...
  `}function el(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function tl(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ht(e){return e.toISOString().slice(0,10)}function al(e,t,n){const i=e.length?e.map(r=>`
            <tr>
              ...
              <td class="numeric">${tl(r.amount)}</td>
            </tr>
    ...
    <section class="panel filter-panel">
      <div class="filter-grid">
        <label class="field">
          <span>開始日</span>
          <input id="sales-start" type="date" value="${t||Ht(new Date(Date.now()-1e3*60*60*24*30))}" />
        </label>
        <label class="field">
          <span>終了日</span>
          <input id="sales-end" type="date" value="${n||Ht(new Date)}" />
        </label>
        <div class="filter-actions">
  ...
  `}function Oe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function sl(e,t,n,i){const r={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},c={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},a={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},l=e.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
    ...
    `).join(""),o=t.map(p=>`
      <tr>
        ...
        <td class="numeric"><strong>${Oe(p.totalAmount)}</strong></td>
        <td>
  ...
  `:"";return`
    ...
    <section class="panel">
      ...
      <div class="summary-list">
        <div>
          <dt>必須列</dt>
          <dd>${r.required.map(l=>`<code class="config-value">${l}</code>`).join(" / ")}</dd>
        </div>
        <div>
          <dt>任意列</dt>
          <dd>${r.optional.map(l=>`<code class="config-value">${l}</code>`).join(" / ")}</dd>
        </div>
      </div>
      <div class="action-bar">
  ...
  `}const P={header:"#2196F3",code:"#4CAF50",date:"#FF9800",detail:"#9C27B0",total:"#F44336"};function ll(e,t,n){const i=[{id:"documentNo",label:"伝票番号",x:155,y:4,fontSize:9,value:e.documentNo,color:P.header},{id:"vendorName",label:"社名",x:4,y:12,fontSize:10,value:t.name,color:P.header},{id:"vendorAddress",label:"住所",x:4,y:17,fontSize:7,value:t.address1,color:P.header},{id:"customerName",label:"取引先名",x:4,y:20,fontSize:10,value:`${e.customerName} ${e.customerHonorific}`,color:P.header},{id:"chainStoreCode",label:"柱店CD",x:63,y:13,fontSize:9,value:e.chainStoreCode??"",color:P.code},{id:"categoryCode",label:"分類CD",x:87,y:13,fontSize:9,value:e.categoryCode??"",color:P.code},{id:"slipNumber",label:"伝票No.",x:117,y:13,fontSize:9,value:e.documentNo,color:P.code},{id:"vendorCode",label:"取引CD",x:151,y:13,fontSize:9,value:e.slipTypeCode??"",color:P.code},{id:"partnerCode",label:"取引先CD",x:94,y:20,fontSize:10,value:e.vendorCode??"",color:P.code},{id:"orderNo",label:"受注No.",x:143,y:20,fontSize:9,value:e.orderNo??"",color:P.code},{id:"currentDate",label:"当日日付",x:10,y:3.5,fontSize:8,value:e.documentDate.replace(/-/g,"/"),color:P.date},{id:"orderDate",label:"発注日",x:180,y:13,fontSize:7.5,value:(e.orderDate??"").replace(/-/g,"/"),color:P.date},{id:"deliveryDate",label:"納品日",x:204,y:13,fontSize:7.5,value:(e.deliveryDate??"").replace(/-/g,"/"),color:P.date}];e.lines.slice(0,6).forEach((a,l)=>{const o=33+l*8.5;i.push({id:`line${l}_name`,label:`明細${l+1} 品名`,x:5,y:o,fontSize:7.5,value:a.productName+(a.spec?` ${a.spec}`:""),color:P.detail},{id:`line${l}_code`,label:`明細${l+1} CD`,x:64,y:o,fontSize:7.5,value:a.productCode,color:P.detail},{id:`line${l}_qty`,label:`明細${l+1} 数量`,x:124,y:o,fontSize:8,value:a.quantity>0?String(a.quantity):"",color:P.detail},{id:`line${l}_price`,label:`明細${l+1} 原単価`,x:163,y:o,fontSize:8,value:a.unitPrice>0?a.unitPrice.toLocaleString("ja-JP"):"",color:P.detail},{id:`line${l}_amount`,label:`明細${l+1} 原価金額`,x:176,y:o,fontSize:8,value:a.amount>0?a.amount.toLocaleString("ja-JP"):"",color:P.detail},{id:`line${l}_retail`,label:`明細${l+1} 売単価`,x:193,y:o,fontSize:8,value:a.retailPrice?a.retailPrice.toLocaleString("ja-JP"):"",color:P.detail})});const r=e.lines.reduce((a,l)=>a+(l.amount||0),0),c=e.lines.reduce((a,l)=>a+l.quantity,0);return i.push({id:"totalQty",label:"合計数量",x:125,y:89,fontSize:9,value:String(c),color:P.total},{id:"costTotal",label:"原価金額合計",x:179,y:89,fontSize:10,value:r.toLocaleString("ja-JP"),color:P.total}),n&&i.forEach(a=>{const l=n[a.id];l&&(a.x=l.x,a.y=l.y)}),i}function ol(e,t,n,i,r){const a=ll(e,t,i).map(o=>`
  ...
  `}function tt(e){const t={};return e.querySelectorAll("[data-fd-id]").forEach(n=>{const i=n.dataset.fdId??"",r=parseFloat(n.style.left)||0,c=parseFloat(n.style.top)||0;t[i]={x:r,y:c}}),t}function rl(e,t,n,i,r){const c=Array.from(new Set([...e.map(d=>d.businessType??""),...t.map(d=>d.businessType??"")].filter(Boolean))),a=e.filter(d=>d.lat&&d.lng).length,l=t.filter(d=>d.lat&&d.lng).length,o=n.filter(d=>d.lat&&d.lng).length;return`
    <section class="page-head">
      <div>
  ...
  `}const cl={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},dl=["new","picking","packed","shipped","delivered"];function ul(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(c=>t[c.stage].push(c));const n=dl.map(c=>{const a=cl[c],l=t[c];return`
      <div class="wf-col" data-wf-stage="${c}">
        ...
        <div class="wf-col-body">
          ${l.length===0?'<div class="wf-empty">―</div>':l.map(o=>`
  ...
  `}function pl(e,t,n){const i=e.cart.reduce((c,a)=>c+a.amount,0);return`
  ...
  `}function ml(e,t,n){if(e.step==="customer"){const i=e.customerQuery.toLowerCase(),r=i?t.filter(c=>c.name.toLowerCase().includes(i)||c.code.toLowerCase().includes(i)):t.slice(0,20);return`
      <section class="panel">
    ...
    `}if(e.step==="products"){const i=e.productQuery.toLowerCase(),r=i?n.filter(c=>c.name.toLowerCase().includes(i)||c.code.toLowerCase().includes(i)):n.slice(0,30);return`
      <section class="panel">
        ...
        <div class="mo-list">
          ${r.slice(0,50).map(c=>{const a=e.cart.find(l=>l.productCode===c.code);return`
  ...
  `}const Gt={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},Xt={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},Qt={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function hl(e,t){const n=e.find(c=>c.id===t)??e[0],i=e.filter(c=>c.status==="new").length,r=e.filter(c=>c.status==="confirmed").length;return`
    <section class="page-head">
      <div>
          ...
          ${e.map(c=>`
            <button class="tour-item ${n?.id===c.id?"active":""}" data-tour-id="${c.id}">
              <div class="tour-item-head">
                ...
                <span class="status-pill ${Xt[c.status]}">${Gt[c.status]}</span>
              </div>
              <div class="tour-item-sub">
                ${Qt[c.language]} · 👥 ${c.partySize}名
              </div>
...
金井酒造店`;function fl(e,t){const n=t?e.find(r=>r.id===t):null,i=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${n||i?`
      ...
      `:""}
  `}function bl(e,t,n,i){const[r,c]=t.split("-").map(S=>parseInt(S,10)),a=new Date(r,c-1,1),l=new Date(r,c,0),o=a.getDay(),d=l.getDate(),u=[];for(let S=0;S<o;S++)u.push({isOutside:!0});for(let S=1;S<=d;S++)u.push({date:new Date(r,c-1,S)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter(S=>S.category===n):e,h={};p.forEach(S=>{const T=S.startsAt.slice(0,10);h[T]??=[],h[T].push(S)});const v=new Date().toISOString().slice(0,10),_=u.map(S=>{if(S.isOutside)return'<div class="cal-cell cal-outside"></div>';const T=S.date,B=`${T.getFullYear()}-${String(T.getMonth()+1).padStart(2,"0")}-${String(T.getDate()).padStart(2,"0")}`,Z=h[B]??[],We=B===v,Ee=T.getDay();return`
        <div class="cal-cell ${We?"cal-today":""} ${Ee===0?"cal-sun":Ee===6?"cal-sat":""}"
             data-cal-date="${B}">
          <div class="cal-day-num">${T.getDate()}</div>
          <div class="cal-events">
            ${Z.slice(0,3).map(Q=>`
              <button class="cal-event" data-cal-event-id="${Q.id}"
                      style="background:${Q.color||xt[Q.category]||"#0F5B8D"};"
                      title="${Q.title}">
            ...
            `).join("")}
            ${Z.length>3?`<button class="cal-event-more" data-cal-date="${B}">+${Z.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),A=i?.isOpen?gl(i):"",k=new Date(r,c-2,1),L=new Date(r,c,1),V=`${k.getFullYear()}-${String(k.getMonth()+1).padStart(2,"0")}`,q=`${L.getFullYear()}-${String(L.getMonth()+1).padStart(2,"0")}`,x=(()=>{const S=new Date;return`${S.getFullYear()}-${String(S.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      <div class="cal-toolbar">
        <div class="cal-nav">
          <button class="button secondary" data-action="cal-prev" data-ym="${V}">◀ 前月</button>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(St).map(([S,T])=>`<option value="${S}" ${n===S?"selected":""}>${T}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
      ...
      <div class="modal-panel" onclick="event.stopPropagation()">
        ...
        <div class="modal-body">
          ...
          <div style="display:flex;gap:8px;">
            <label class="field" style="flex:1;">
              ...
              <select id="cal-category">
                ${Object.entries(St).map(([n,i])=>`<option value="${n}" ${t.category===n?"selected":""}>${i}</option>`).join("")}
              </select>
            </label>
          ...
          <div style="display:flex;gap:8px;">
            <label class="field" style="flex:1;">
              <span>開始</span>
              <input id="cal-starts" type="datetime-local" value="${t.startsAt?Wt(t.startsAt):""}" />
            </label>
            <label class="field" style="flex:1;">
              <span>終了 (任意)</span>
              <input id="cal-ends" type="datetime-local" value="${t.endsAt?Wt(t.endsAt):""}" />
            </label>
          </div>
          <label class="field">
            <span>場所</span>
  ...
  `}function _l(e,t){const n=e.reduce((c,a)=>c+a.totalAmount,0),i=e.filter(c=>c.financialStatus==="paid").length,r=e.filter(c=>c.fulfillmentStatus!=="fulfilled"&&c.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function kl(e,t,n){const i=t==="__new__"?null:e.find(a=>a.id===t),r=t==="__new__";return n?.role==="admin"?`
    <section class="page-head">
      <div>
      ...
      <section class="panel">
        ...
        <div class="filter-grid filter-grid--wide">
          ...
          <label class="field" style="flex:1 1 140px;">
            <span>部署</span>
            <select id="user-dept">
              ${Object.entries(Ve).map(([a,l])=>`<option value="${a}" ${i?.department===a?"selected":""}>${l}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 140px;">
            <span>権限</span>
            <select id="user-role">
              ${Object.entries(ze).map(([a,l])=>`<option value="${a}" ${i?.role===a?"selected":""}>${l}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 160px;">
            <span>電話</span>
  ...
  `:`
    ...
    <section class="panel">
      ...
      <dl class="summary-list">
        ...
        <div><dt>部署</dt><dd>${Ve[e.department]}</dd></div>
  ...
  `:`
    ...
    `}function xl(e){const t={};return e.forEach(n=>{const i=n.userEmail??"(anonymous)";t[i]=(t[i]??0)+1}),`
    <section class="page-head">
      <div>
  ...
  `}function Al(e){const t=e.prospects.reduce((c,a)=>c+a.expectedAmount,0),n=e.prospects.reduce((c,a)=>c+a.expectedAmount*a.probability/100,0),i=e.prospects.filter(c=>c.stage==="won").length,r=e.prospects.filter(c=>c.stage==="hot"||c.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    ${e.viewMode==="kanban"?El(e.prospects):Cl(e.prospects)}

    ${Ll(e)}
  `}function El(e){return`
    <section class="panel" style="padding:12px;">
      <p class="form-hint" style="margin:0 0 12px;">カードをドラッグしてステージ変更。クリックで詳細編集。</p>
      <div class="pk-board">${["cold","warm","hot","contacted","negotiating","won","lost"].map(i=>{const r=e.filter(a=>a.stage===i),c=r.reduce((a,l)=>a+l.expectedAmount,0);return`
        <div class="pk-col" data-prospect-stage="${i}">
          <div class="pk-col-header" style="--pk-color:${Xe[i]};">
            <span class="pk-col-label">${Ae[i]}</span>
          ...
          <tbody>
            ${e.map(t=>`
              <tr>
                ...
                <td>${t.businessType??"―"}</td>
                <td><span class="status-pill" style="background:${Xe[t.stage]};color:white;">${Ae[t.stage]}</span></td>
  ...
  `}function Ll(e){if(!e.editingId)return"";const t=e.editingId==="__new__",n=t?null:e.prospects.find(i=>i.id===e.editingId);return!t&&!n?"":`
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 140px;">
              ...
              <select id="prospect-stage">
                ${Object.entries(Ae).map(([i,r])=>`<option value="${i}" ${n?.stage===i?"selected":""}>${r}</option>`).join("")}
              </select>
            </label>
            <label class="field" style="flex:1 1 120px;">
              <span>流入元</span>
  ...
  `}function Il(e,t,n){const i=e?.config.webhook_url??"",r=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${t.map(c=>`
              <tr>
                <td>${Je[c.eventType]||c.eventType}</td>
                <td>
  ...
  `}function Dl(e,t,n,i){const r=new Map(t.map(p=>[p.code,p])),c=e.filter(p=>p.callDirection==="inbound").length,a=e.filter(p=>p.callDirection==="outbound").length,l=e.filter(p=>p.callStatus==="missed").length,o=e.reduce((p,h)=>p+(h.durationSeconds??0),0),d=p=>{if(p===0)return"―";const h=Math.floor(p/60),v=p%60;return h>0?`${h}分${v}秒`:`${v}秒`},u=p=>{if(p.matchedCustomerCode){const h=r.get(p.matchedCustomerCode);if(h)return`${h.name} (既存)`}return"未登録番号"};return`
    <section class="page-head">
      <div>
  ...
  `}const Pl=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function Nl(e){const t=e.activeListId?e.lists.find(c=>c.id===e.activeListId):null,n=e.items.filter(c=>c.status==="new").length,i=e.items.filter(c=>c.status==="imported").length,r=e.items.filter(c=>c.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
    ...
    <section class="panel">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:flex-end;">
        <label class="field" style="flex:1 1 180px;">
          ...
          <select id="lb-type">
            <option value="">選択</option>
            ${Pl.map(c=>`<option value="${c}" ${e.searchBusinessType===c?"selected":""}>${c}</option>`).join("")}
          </select>
        </label>
        <label class="field" style="flex:1 1 180px;">
          <span>エリア</span>
  ...
  `}const Kt={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},ql={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},Tl={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function R(e){return"¥"+e.toLocaleString("ja-JP")}function we(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function ss(e,t){const n=e.reduce((c,a)=>c+a.amount,0),i=Math.floor(n*t),r=n+i;return{subtotal:n,taxAmount:i,total:r}}const I={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function D(e,t){const n=e.align??"left",i=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${i}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function at(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),i=n-2018;return{y:i>0?String(i).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function Rl(e,t,n){const i=at(e.documentDate),r=at(e.orderDate??e.documentDate),c=at(e.deliveryDate??e.documentDate),a=e.lines.slice(0,6).map((k,L)=>{const V=I.detailStartY+L*I.detailRowH,q=I.detailCols,x=[],S=(T,B)=>{B&&x.push(D({...T,y:V,x:T.x+0},B))};return S(q.productName,k.productName+(k.spec?` ${k.spec}`:"")),S(q.productCode,k.productCode),S(q.color,k.color??""),S(q.size,[k.size,k.caseQty?`×${k.caseQty}`:""].filter(Boolean).join(" ")),S(q.unit,k.unit),S(q.quantity,k.quantity>0?k.quantity.toLocaleString("ja-JP"):""),S(q.correctedQty,k.correctedQuantity?k.correctedQuantity.toLocaleString("ja-JP"):""),S(q.discount,k.discount?k.discount.toLocaleString("ja-JP"):""),S(q.unitPrice,k.unitPrice>0?k.unitPrice.toLocaleString("ja-JP"):""),S(q.costAmount,k.amount>0?k.amount.toLocaleString("ja-JP"):""),S(q.retailPrice,k.retailPrice?k.retailPrice.toLocaleString("ja-JP"):""),S(q.note,k.receivedAmount?k.receivedAmount.toLocaleString("ja-JP"):""),x.join("")}).join(""),l=e.lines.reduce((k,L)=>k+(L.amount||0),0),o=e.lines.reduce((k,L)=>k+(L.retailPrice||0)*(L.correctedQuantity??L.quantity),0),d=e.lines.reduce((k,L)=>k+(L.receivedAmount||0),0),u=e.lines.reduce((k,L)=>k+(L.returnAmount||0),0),p=e.lines.reduce((k,L)=>k+L.quantity,0),h=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",v=n.calibrationOffsetX||0,_=n.calibrationOffsetY||0,A=`transform: translate(${v}mm, ${_}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${h}">
        ...
        ${D(I.currentDateY,i.y)}
        ${D(I.currentDateM,i.m)}
        ${D(I.currentDateD,i.d)}
        ${D(I.documentNo,e.documentNo)}
        ${e.settlementPrint?D(I.settlementCheck,"✓"):""}

        ${D(I.vendorName,t.name)}
        ${D(I.vendorAddress,t.address1)}
        ${D(I.chainStoreCode,e.chainStoreCode??"")}
        ${D(I.categoryCode,e.categoryCode??"")}
        ${D(I.slipNumber,e.documentNo)}
        ${D(I.vendorCode,e.slipTypeCode??"")}

        ${D(I.customerName,`${e.customerName} ${e.customerHonorific}`)}
        ${D(I.orderDateY,r.y)}
        ${D(I.orderDateM,r.m)}
        ${D(I.orderDateD,r.d)}
        ${D(I.deliveryDateY,c.y)}
        ${D(I.deliveryDateM,c.m)}
        ${D(I.deliveryDateD,c.d)}
        ${D(I.orderNo,e.orderNo??"")}
        ${D(I.partnerCode,e.vendorCode??"")}

        ${a}

        ${D(I.totalQty,p.toLocaleString("ja-JP"))}
        ${D(I.receivedTotal,d.toLocaleString("ja-JP"))}
        ${D(I.returnTotal,u.toLocaleString("ja-JP"))}
        ${D(I.correctedCostTotal,l.toLocaleString("ja-JP"))}
        ${D(I.correctedRetailTotal,o.toLocaleString("ja-JP"))}
        </div>
      </div>
    </div>
  `}function Ol(e,t,n){const{subtotal:i,taxAmount:r,total:c}=ss(e.lines,e.taxRate),a=e.previousBalance??0,l=e.paymentAmount??0,o=a-l+c,d=e.lines.map(p=>`
      <tr>
        ...
        <div>
          ${n.showRegistrationNo?`
            <div class="freee-tax-breakdown">
              <p>＜税率内訳＞</p>
              <p>${Math.round(e.taxRate*100)}%対象: ${R(i)} / 消費税: ${R(r)}</p>
            </div>`:""}
        </div>
        <table class="freee-summary-table">
          ${a?`<tr><th>前回御請求額</th><td>${R(a)}</td></tr>`:""}
          ${l?`<tr><th>ご入金額</th><td>▲ ${R(l)}</td></tr>`:""}
          <tr><th>今回御請求 小計</th><td>${R(i)}</td></tr>
  ...
  `}function jl(e,t,n){const{subtotal:i,taxAmount:r,total:c}=ss(e.lines,e.taxRate),a=e.lines.map(o=>`
      <tr>
  ...
  `}function Ml(e,t,n,i){let r="";switch(e){case"chain_store":r=Rl(i,n,t);break;case"quotation":r=jl(i,n,t);break;case"invoice_monthly":r=Ol(i,n,t);break}const c=Object.keys(Kt).map(o=>`<button class="tab-button ${e===o?"active":""}" data-print-template="${o}">${Kt[o]}</button>`).join(""),a=i.lines.map((o,d)=>`
      <tr>
      ...
      </tr>`).join(""),l=[{key:"showSeal",label:"印影"},{key:"showRegistrationNo",label:"登録番号"},{key:"showBankInfo",label:"振込先"},{key:"showJanCode",label:"JAN"},{key:"showRemarks",label:"備考"}].map(o=>`<label style="font-size:12px;"><input type="checkbox" data-print-opt="${o.key}" ${t[o.key]?"checked":""} /> ${o.label}</label>`).join(" ");return`
    <section class="page-head no-print">
      <div>
  ...
  `}const Fl={customers:["legacy_customer_code","name"],products:["legacy_product_code","name"],suppliers:["legacy_supplier_code","name"],staff:["legacy_staff_code","name"]},Bl={customers:["legacy_customer_code","name","kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"],products:["legacy_product_code","name","kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"],suppliers:["legacy_supplier_code","name","kana_name","phone","postal_code","address1","closing_day","payment_day","email"],staff:["legacy_staff_code","name","kana_name","department"]};function zl(e){e.charCodeAt(0)===65279&&(e=e.slice(1));const t=[];let n=[],i="",r=!1;for(let l=0;l<e.length;l++){const o=e[l];r?o==='"'?e[l+1]==='"'?(i+='"',l++):r=!1:i+=o:o==='"'?r=!0:o===","?(n.push(i),i=""):o===`
`||o==="\r"?(o==="\r"&&e[l+1]===`
`&&l++,n.push(i),n.some(d=>d!=="")&&t.push(n),n=[],i=""):i+=o}if((i!==""||n.length>0)&&(n.push(i),n.some(l=>l!=="")&&t.push(n)),t.length===0)return{columns:[],rows:[]};const c=t[0].map(l=>l.trim()),a=[];for(let l=1;l<t.length;l++){const o={};c.forEach((d,u)=>{o[d]=(t[l][u]??"").trim()}),a.push(o)}return{columns:c,rows:a}}function Vl(e,t,n){const i=Fl[e],r=i.filter(l=>!t.includes(l)),c=n.map(l=>{const o=[];r.length>0&&o.push(`必須列欠損: ${r.join(",")}`);for(const d of i)t.includes(d)&&!l[d]&&o.push(`${d}が空`);return{...l,_valid:o.length===0,_error:o[0]}}),a=c.filter(l=>l._valid).length;return{entity:e,columns:t,rows:c,totalRows:n.length,validRows:a,invalidRows:c.length-a}}function Jl(e){const n=Bl[e],r={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[e];return"\uFEFF"+n.join(",")+`
`+r.join(",")+`
`}async function Ul(e,t){const{supabaseInsert:n}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>N);return{supabaseInsert:l}},void 0);let i=0,r=0;const a={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const l of t){if(!l._valid)continue;const{_valid:o,_error:d,...u}=l,p={...u};if(!p.id){const h=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[h]??`${e}-${Date.now()}-${i+r}`)}for(const h of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[h]=="string"&&p[h]!==""){const v=Number(p[h]);Number.isFinite(v)&&(p[h]=v)}try{await n(a,p)!==null?i++:r++}catch{r++}}return{inserted:i,failed:r}}function st(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function Yl(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Hl(e,t,n,i,r){const c=n.reduce((d,u)=>d+u.rowCount,0),a=n.map(d=>d.lastSyncAt).filter(d=>d!==null).sort().reverse()[0]??null,l=100,o=Math.max(1,Math.ceil(r/l));return`
    <section class="page-head">
      <div>
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:8px;padding:0 0 16px;">
        ${n.map(d=>`
          ...
          >
            ...
            <p class="kpi-sub" style="font-size:11px;">${d.lastSyncAt?st(d.lastSyncAt):"未同期"}</p>
          </button>
        `).join("")}
      </div>
    </section>
    ...
    <section class="panel">
      <div class="panel-header">
        <div>
          ...
          <p class="panel-caption">${r.toLocaleString("ja-JP")}件中 ${((i-1)*l+1).toLocaleString("ja-JP")}-${Math.min(i*l,r).toLocaleString("ja-JP")} を表示</p>
        </div>
        <div class="panel-header-actions">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>${d._synced_at?st(d._synced_at):"---"}</td>
              <td class="mono" style="font-size:11px;max-width:300px;overflow:hidden;text-overflow:ellipsis;" title="${d._raw_b64?d._raw_b64.slice(0,200):""}">${Yl(d._raw_b64)}</td>
            </tr>
            `).join("")}
          </tbody>
        </table>
    ...
    `}
  `}function Gl(e){const t={empty:"空",in_use:"使用中",aging:"熟成中"},n={empty:"neutral",in_use:"warning",aging:"success"},i=e.map(d=>{const u=d.capacity>0?Math.round(d.currentVolume/d.capacity*100):0;return`
        <tr>
      ...
      `}).join(""),r=e.filter(d=>d.status==="in_use").length,c=e.filter(d=>d.status==="aging").length,a=e.filter(d=>d.status==="empty").length,l=e.reduce((d,u)=>d+u.capacity,0),o=e.reduce((d,u)=>d+u.currentVolume,0);return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>タンク管理</h1>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-sub">使用率 ${l>0?Math.round(o/l*100):0}%</p>
      </article>
      <article class="panel kpi-card">
  ...
  `}function nt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Xl(e,t,n){const i=e.rows.map((d,u)=>`
      <tr>
        ...
        <td class="numeric"><strong>${nt(d.taxAmount)}</strong></td>
        <td>
    ...
    `).join(""),c=Array.from({length:12},(d,u)=>u+1),a=e.rows.reduce((d,u)=>d+u.exportDeduction+u.sampleDeduction,0),l=e.rows.reduce((d,u)=>d+u.productionVolume,0),o=l>0?a/l*100:0;return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${nt(e.totalTax)}</p>
        ...
        <table class="entry-table">
          ...
          <tfoot>
            <tr>
              ...
              <th></th>
              <th class="numeric">${nt(e.totalTax)}</th>
              <th></th>
            </tr>
          </tfoot>
        </table>
  ...
  `}const Ql={success:'<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="8.5" stroke="currentColor"/><path d="M5.5 9.5L7.5 11.5L12.5 6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',error:'<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="8.5" stroke="currentColor"/><path d="M6.5 6.5L11.5 11.5M11.5 6.5L6.5 11.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',warning:'<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M9 2L16.5 15H1.5L9 2Z" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"/><path d="M9 7V10.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="9" cy="13" r="0.8" fill="currentColor"/></svg>',info:'<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="8.5" stroke="currentColor"/><path d="M9 8V13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="9" cy="5.5" r="0.8" fill="currentColor"/></svg>'};let se=null,Wl=0;const mt=[];function Kl(){return se&&document.body.contains(se)||(se=document.createElement("div"),se.className="toast-container",document.body.appendChild(se)),se}function b(e,t="success",n){const i=Kl(),r=++Wl,c=t==="error"?5e3:t==="warning"?4e3:3e3,a=document.createElement("div");a.className=`toast toast-${t}`,a.setAttribute("role","status"),a.setAttribute("aria-live","polite"),a.innerHTML=`
    <span class="toast-icon">${Ql[t]}</span>
    <span class="toast-msg">${eo(e)}</span>
    <button class="toast-dismiss" aria-label="閉じる">✕</button>
  `;const l={id:r,message:e,type:t,el:a};mt.push(l),i.appendChild(a),requestAnimationFrame(()=>{a.classList.add("toast-enter")});const o=()=>Zl(l);a.querySelector(".toast-dismiss").addEventListener("click",o),setTimeout(()=>{a.classList.add("toast-exit"),a.addEventListener("animationend",o,{once:!0})},c)}function Zl(e){const t=mt.indexOf(e);t!==-1&&(mt.splice(t,1),e.el.remove())}function eo(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function W(e,t={}){const{title:n="確認",confirmLabel:i="OK",cancelLabel:r="キャンセル",variant:c="primary"}=t;return new Promise(a=>{const l=document.createElement("div");l.className="modal-backdrop confirm-backdrop",l.setAttribute("role","dialog"),l.setAttribute("aria-modal","true"),l.innerHTML=`
      <div class="modal-panel confirm-panel">
        ...
        <div class="confirm-actions">
          ...
          <button class="button ${c} confirm-ok">${je(i)}</button>
        </div>
      </div>
    `;const o=u=>{l.classList.add("confirm-exit"),l.addEventListener("animationend",()=>{l.remove()},{once:!0}),a(u)};l.querySelector(".confirm-cancel").addEventListener("click",()=>o(!1)),l.querySelector(".confirm-ok").addEventListener("click",()=>o(!0)),l.addEventListener("click",u=>{u.target===l&&o(!1)});const d=u=>{u.key==="Escape"&&(document.removeEventListener("keydown",d),o(!1))};document.addEventListener("keydown",d),document.body.appendChild(l),requestAnimationFrame(()=>{l.querySelector(".confirm-ok")?.focus()})})}const to=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
...
</svg>`,ao=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
  <circle cx="14" cy="14" r="13" stroke="currentColor" stroke-width="1.5"/>
...
</svg>`;function je(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Zt(e){const n=(e==null?"":e instanceof Date?e.toISOString():String(e)).replaceAll('"','""');return/[",\n\r]/.test(n)?`"${n}"`:n}function so(e,t,n){if(t.length===0&&(!n||n.length===0))return;const i=n&&n.length>0?n:Object.keys(t[0]??{}).map(d=>({key:d,label:d})),c=`\uFEFF${[i.map(d=>Zt(d.label)).join(","),...t.map(d=>i.map(u=>Zt(d[u.key])).join(","))].join(`\r
`)}`,a=new Blob([c],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(a),o=document.createElement("a");o.href=l,o.download=e,document.body.append(o),o.click(),o.remove(),window.setTimeout(()=>URL.revokeObjectURL(l),0)}const no=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser","/demand-forecast"];let pe=[];async function io(){const{supabaseQueryAll:e}=await f(async()=>{const{supabaseQueryAll:n}=await Promise.resolve().then(()=>N);return{supabaseQueryAll:n}},void 0);pe=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(n=>typeof n.email=="string"&&n.email.length>0).map(n=>({name:String(n.name??""),email:String(n.email??""),area:String(n.delivery_area_code??""),historySegment:"seasonal"}))}const ea=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"},{path:"/demand-forecast",title:"需要予測・納品カレンダー"}];function ns(e){const t=bt[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function Et(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function lo(){const e=ns("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const Qe=new Date,oo=Qe.toISOString().slice(0,7),ro=Qe.getFullYear(),co=Qe.getMonth()+1,uo=Qe.toISOString().slice(0,10),po="C0011",ne=lo();function is(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return no.includes(n)?n:"/"}function Ct(e){switch(e){case"/invoice-entry":case"/quote":case"/delivery":case"/billing":case"/invoice":case"/ledger":return"sales";case"/analytics":case"/customer-analysis":case"/product-power":case"/customer-efficiency":case"/report":case"/demand-forecast":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const ta=is(location.pathname),s={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:Et(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:oo,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:ro,taxMonth:co,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],callLogs:[],mapFilters:{showCustomers:!0,showProspects:!0,showDelivery:!0,filterRegion:"",filterBusinessType:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...ql,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...Tl},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:uo,route:ta,currentCategory:Ct(ta),sidebarOpen:!1,announcements:[],dismissedAnnouncements:new Set,updateAvailable:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:po,salesPeriod:"month",customRange:{start:"",end:""},quoteState:(()=>{const e={...Qa};try{const t=localStorage.getItem("quote-seal");t&&(e.sealSettings=JSON.parse(t))}catch{}return e})(),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,productPower:[],productFilter:"all",customerEfficiency:[],masterTab:"customers",masterFilter:{...At},analyticsTab:"products",emailAudienceMode:ne.mode,emailRegion:ne.region,emailHistorySegment:ne.historySegment,emailTemplateId:ne.templateId,emailSubject:ne.subject,emailBody:ne.body,emailSaveMessage:ne.saveMessage,emailSending:!1,demandForecast:{...On},globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function aa(e){return e.slice(0,10)}function mo(e){return{...e}}function Ue(){s.pickerMode=null,s.pickerQuery="",s.pickerTargetLine=null}function ls(){s.invoiceForm=Et(),s.invoiceSavedDocNo=null,s.invoicePriceGroup="",s.invoiceErrors={},Ue()}function os(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,i)=>{n.productCode.trim()||(t[`lines.${i}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${i}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${i}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${i}.unitPrice`]="単価は0円以上で入力してください。")}),t}function ho(e){const t=s.invoiceForm.lines[e];t&&s.invoiceForm.lines.splice(e+1,0,mo(t))}function yo(){const e=s.invoiceRecords[0],t=s.masterStats?.customers[0],n=s.masterStats?.products.slice(0,2)??[];s.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:s.invoiceForm.staffCode||"S001",lines:n.map((i,r)=>{const c=r===0?1:2,a=1200*(r+1);return{productCode:i.code,productName:i.name,quantity:c,unitPrice:a,unit:"本",amount:c*a}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},s.invoiceSavedDocNo=null,s.invoiceErrors={}}function vo(e){const t=s.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function fo(e){const t=s.masterStats?.customers.find(n=>n.name===e.trim());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function rs(e){if(X(e),s.invoiceErrors=os(s.invoiceForm),Object.keys(s.invoiceErrors).length>0){y();return}s.invoiceSaving=!0,y(),va(s.invoiceForm).then(t=>{s.invoiceSavedDocNo=t.documentNo,s.invoiceSaving=!1,s.invoiceErrors={},s.invoiceForm=Et(),y()}).catch(()=>{s.invoiceSaving=!1,y()})}function cs(e){const t=s.salesFilter.startDate?new Date(s.salesFilter.startDate):null,n=s.salesFilter.endDate?new Date(`${s.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((i,r)=>new Date(r.date).getTime()-new Date(i.date).getTime()).filter(i=>{const r=new Date(i.date);return!(t&&r<t||n&&r>n)})}function ds(){switch(s.emailAudienceMode){case"area":return s.emailRegion==="all"?pe:pe.filter(e=>e.area===s.emailRegion);case"history":return pe.filter(e=>e.historySegment===s.emailHistorySegment);default:return pe}}function bo(){const e=ds();return{audienceMode:s.emailAudienceMode,region:s.emailRegion,historySegment:s.emailHistorySegment,selectedTemplateId:s.emailTemplateId,subject:s.emailSubject,body:s.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:s.emailSaveMessage,sending:s.emailSending,senderId:s.emailSenderId,senders:s.mailSenders}}function it(e){const t=ds(),n=s.emailAudienceMode==="area"?s.emailRegion:s.emailAudienceMode==="history"?s.emailHistorySegment:"all";return{subject:s.emailSubject.trim(),body:s.emailBody.trim(),templateId:s.emailTemplateId,audienceMode:s.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(i=>i.email),status:e}}function Lt(){return s.user,!1}function Se(){s.globalSearchOpen=!1,s.globalQuery=""}function go(){const e=s.globalQuery.trim().toLowerCase();return e?{customers:s.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:s.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:s.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:ea.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:ea}}function $o(){let e=[],t,n="export.csv";switch(s.route){case"/sales":e=(s.salesSummary?cs(s.salesSummary):[]).map(i=>({documentNo:i.documentNo,date:i.date,customerCode:i.customerCode,customerName:i.customerName,amount:i.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...s.paymentStatus?.records??[]].sort((i,r)=>r.balanceAmount-i.balanceAmount).map(i=>({...i})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=s.invoiceRecords.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=s.purchaseList.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=s.jikomiList.map(i=>({...i})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=s.tankList.map(i=>({...i})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=s.kenteiList.map(i=>({...i})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=s.materialList.map(i=>({...i})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":s.masterTab==="customers"?(e=s.masterStats?.customers.map(i=>({...i}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=s.masterStats?.products.map(i=>({...i}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}so(n,e,t)}function sa(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),s.route=e,s.currentCategory=Ct(e),s.sidebarOpen=!1,Se(),It(e)}async function It(e){s.actionLoading=!0,y();try{switch(e){case"/delivery":s.deliveryNote||(s.deliveryNote=await $t(s.deliverySearchDocNo||"D240122"));break;case"/billing":s.billingSummary||(s.billingSummary=await _t(s.billingYearMonth));break;case"/report":s.salesReport||(s.salesReport=await Ge());break;case"/product-power":s.productPower.length===0&&(s.productPower=await ka());break;case"/customer-efficiency":s.customerEfficiency.length===0&&(s.customerEfficiency=await Sa());break;case"/customer-analysis":s.customerAnalysis||(s.customerAnalysis=await xa());break;case"/demand-forecast":if(s.demandForecast.forecasts.length===0){const{fetchProductMonthlyShipments:t,fetchDeliverySchedule:n}=await f(async()=>{const{fetchProductMonthlyShipments:c,fetchDeliverySchedule:a}=await Promise.resolve().then(()=>$);return{fetchProductMonthlyShipments:c,fetchDeliverySchedule:a}},void 0),[i,r]=await Promise.all([t(),n()]);s.demandForecast.forecasts=Fn(i),s.demandForecast.deliveries=Bn(r)}break;case"/jikomi":s.jikomiList.length===0&&(s.jikomiList=await Ea());break;case"/tanks":s.tankList.length===0&&(s.tankList=await Ca());break;case"/kentei":s.kenteiList.length===0&&(s.kenteiList=await La());break;case"/materials":s.materialList.length===0&&(s.materialList=await ot());break;case"/purchase":(s.purchaseList.length===0||s.payableList.length===0)&&([s.purchaseList,s.payableList]=await Promise.all([Ia(),Da()]));break;case"/raw-material":(s.billList.length===0||s.rawStockList.length===0)&&([s.billList,s.rawStockList]=await Promise.all([Pa(),Na()]));break;case"/tax":s.taxDeclaration||(s.taxDeclaration=await wt(s.taxYear,s.taxMonth));break;case"/store":(s.storeSales.length===0||s.storeOrders.length===0)&&([s.storeSales,s.storeOrders]=await Promise.all([kt(s.storeSalesDate),Ra()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await f(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>$);return{fetchMailSenders:n}},void 0);if(s.mailSenders=await t(),!s.emailSenderId||!s.mailSenders.find(n=>n.id===s.emailSenderId)){const n=s.mailSenders.find(i=>i.isDefault)??s.mailSenders[0];n&&(s.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await f(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>$);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await f(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>$);return{fetchIntegrationSettings:n}},void 0);s.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchShopifyOrders:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>$);return{fetchShopifyOrders:i,fetchIntegrationSettings:r}},void 0);s.shopifyOrders=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchFaxInbox:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>$);return{fetchFaxInbox:i,fetchIntegrationSettings:r}},void 0);s.faxRecords=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await f(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>$);return{fetchUserProfiles:n}},void 0);s.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:i}=await f(async()=>{const{fetchMyProfile:c,fetchAuditLogs:a,fetchMailSenders:l}=await Promise.resolve().then(()=>$);return{fetchMyProfile:c,fetchAuditLogs:a,fetchMailSenders:l}},void 0),r=s.user?.email??s.myProfile?.email??"";r&&(s.myProfile=await t(r)),s.mailSenders.length===0&&(s.mailSenders=await i()),s.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await f(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>$);return{fetchAuditLogs:n}},void 0);s.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await f(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>$);return{fetchProspects:n}},void 0);s.prospects=await t()}break;case"/map":{const{fetchProspects:t,fetchDeliveryLocations:n,fetchIntegrationSettings:i}=await f(async()=>{const{fetchProspects:r,fetchDeliveryLocations:c,fetchIntegrationSettings:a}=await Promise.resolve().then(()=>$);return{fetchProspects:r,fetchDeliveryLocations:c,fetchIntegrationSettings:a}},void 0);s.prospects=await t(),s.deliveryLocations=await n(),s.integrations.length===0&&(s.integrations=await i())}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchCallLogs:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>$);return{fetchCallLogs:i,fetchIntegrationSettings:r}},void 0);s.callLogs=await t(100),s.integrations.length===0&&(s.integrations=await n())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchLeadLists:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>$);return{fetchLeadLists:i,fetchIntegrationSettings:r}},void 0);s.leadLists=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await f(async()=>{const{fetchWorkflowOrdersFromDb:n}=await Promise.resolve().then(()=>$);return{fetchWorkflowOrdersFromDb:n}},void 0);s.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await f(async()=>{const{fetchTourInquiriesFromDb:n}=await Promise.resolve().then(()=>$);return{fetchTourInquiriesFromDb:n}},void 0);s.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:i}=await f(async()=>{const{fetchSlackRules:r,fetchSlackLogs:c,fetchIntegrationSettings:a}=await Promise.resolve().then(()=>$);return{fetchSlackRules:r,fetchSlackLogs:c,fetchIntegrationSettings:a}},void 0);s.slackRules=await t(),s.slackLogs=await n(50),s.integrations.length===0&&(s.integrations=await i())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:n,fetchWorkflowOrdersFromDb:i,fetchTourInquiriesFromDb:r}=await f(async()=>{const{fetchProspects:c,fetchCalendarEvents:a,fetchWorkflowOrdersFromDb:l,fetchTourInquiriesFromDb:o}=await Promise.resolve().then(()=>$);return{fetchProspects:c,fetchCalendarEvents:a,fetchWorkflowOrdersFromDb:l,fetchTourInquiriesFromDb:o}},void 0);s.prospects.length===0&&(s.prospects=await t()),s.calendarEvents.length===0&&(s.calendarEvents=await n(s.calendarYearMonth)),s.materialList.length===0&&(s.materialList=await ot()),s.workflowOrders.length===0&&(s.workflowOrders=await i()),s.tourInquiries.length===0&&(s.tourInquiries=await r())}break;default:break}}catch(t){console.warn("Route data load error",t)}finally{s.actionLoading=!1,y()}}function na(){if(Lt())return Si(s.authError,s.authSubmitting);if(s.loading)return`
      <section class="panel">
        <div class="loading-overlay">
          <div class="loading-spinner"></div>
    ...
    `;switch(s.route){case"/cat/sales":return Ce("sales");case"/cat/brewery":return Ce("brewery");case"/cat/purchase":return Ce("purchase");case"/cat/more":return Ce("more");case"/invoice-entry":return ii(s.invoiceForm,s.invoiceSavedDocNo,s.invoiceSaving,s.invoiceErrors);case"/quote":return ci(s.quoteState,s.masterStats?.customers??[],s.masterStats?.products??[],s.quoteCustomerQuery,s.quoteProductQuery,s.quotePricing);case"/email":return ti(bo());case"/delivery":return s.deliveryNote?Zn(s.deliveryNote,s.deliverySearchDocNo):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/billing":return s.billingSummary?Dn(s.billingSummary,s.billingYearMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/report":return s.salesReport?Zi(s.salesReport):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":return pi(s.productPower,s.productFilter);case"/customer-efficiency":return mi(s.customerEfficiency);case"/customer-analysis":return s.customerAnalysis?Hi(s.customerAnalysis):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":case"/customer-efficiency":return'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/demand-forecast":return Un(s.demandForecast);case"/jikomi":return s.jikomiView==="calendar"?`${Vt(s.jikomiList,s.jikomiView)}${_i(s.jikomiList)}`:Vt(s.jikomiList,s.jikomiView);case"/tanks":return Gl(s.tankList);case"/kentei":return wi(s.kenteiList);case"/materials":return qi(s.materialList)+Ni(s.materialEditing,s.materialEditingIsNew);case"/purchase":return Mi(s.purchaseList,s.payableList);case"/raw-material":return Fi(s.billList,s.rawStockList);case"/tax":return s.taxDeclaration?Xl(s.taxDeclaration,s.taxYear,s.taxMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/store":return sl(s.storeSales,s.storeOrders,s.storeTab,s.storeSalesDate);case"/setup":return s.pipelineMeta?Vi(s.pipelineMeta,z,j,s.syncDashboard):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/raw-browser":return Hl(s.rawSelectedTable,s.rawRecords,s.rawTableList,s.rawPage,s.rawTotalCount);case"/import":return il(s.importEntity,s.importPreview,s.importing,s.importResult);case"/print":return Ml(s.printTemplate,s.printOptions,s.printCompany,s.printData);case"/form-designer":return ol(s.printData,s.printCompany,s.printOptions,s.fdSavedPositions,s.fdDesignMode);case"/map":{const e=(s.masterStats?.customers??[]).slice(0,200).map((i,r)=>{const c=i;return{...i,lat:c.lat??35.37+r%12*.05+(Math.random()-.5)*.02,lng:c.lng??139.29+Math.floor(r/12)*.05+(Math.random()-.5)*.02,address1:c.address1??"",businessType:c.businessType??"",lastOrderAmount:0}}),n=!!s.integrations.find(i=>i.provider==="google_maps")?.config.api_key;return rl(e,s.prospects,s.deliveryLocations,s.mapFilters,n)}case"/workflow":return ul(s.workflowOrders);case"/mobile-order":return pl(s.mobileOrder,s.masterStats?.customers??[],s.masterStats?.products??[]);case"/tour":return hl(s.tourInquiries,s.tourActiveId);case"/mail-senders":return fl(s.mailSenders,s.mailSenderEditingId);case"/calendar":return bl(s.calendarEvents,s.calendarYearMonth,s.calendarFilterCategory,s.calendarEdit);case"/integrations":return $l(s.integrations,s.integrationEditingId);case"/shopify":{const e=s.integrations.find(t=>t.id==="shopify");return _l(s.shopifyOrders,e?.lastSyncAt??null)}case"/fax":return wl(s.faxRecords,s.faxProcessing,s.faxOcrText);case"/users":return kl(s.userProfiles,s.userEditingId,s.myProfile);case"/profile":return Sl(s.myProfile,s.auditLogs.filter(e=>e.userEmail===s.myProfile?.email),s.mailSenders);case"/audit":return xl(s.auditLogs);case"/prospects":{const e={prospects:s.prospects,activities:s.prospectActivities,editingId:s.prospectEditingId,viewMode:s.prospectViewMode};return Al(e)}case"/slack":{const e=s.integrations.find(t=>t.provider==="slack")??null;return Il(e,s.slackRules,s.slackLogs)}case"/calls":{const e=s.integrations.find(t=>t.provider==="ivry");return Dl(s.callLogs,s.masterStats?.customers??[],e?.lastSyncAt??null,e?.isEnabled??!1)}case"/list-builder":{const e={lists:s.leadLists,activeListId:s.leadActiveListId,items:s.leadItems,searchQuery:s.leadSearchQuery,searchArea:s.leadSearchArea,searchBusinessType:s.leadSearchType,searching:s.leadSearching,searchResults:s.leadSearchResults};return Nl(e)}}if(!s.salesSummary||!s.paymentStatus||!s.masterStats||!s.pipelineMeta||!s.customerLedger||!s.salesAnalytics)return"";switch(s.route){case"/sales":return al(cs(s.salesSummary),s.salesFilter.startDate,s.salesFilter.endDate);case"/payment":return Oi([...s.paymentStatus.records].sort((e,t)=>t.balanceAmount-e.balanceAmount));case"/master":return Pi(s.masterStats,s.masterTab,s.masterFilter);case"/invoice":return vi(s.invoiceRecords,s.invoiceFilter);case"/ledger":return Rn(s.customerLedger,s.ledgerCustomerCode);case"/analytics":return Ki(s.salesAnalytics,s.analyticsTab);default:return Qn(s.salesSummary,s.pipelineMeta,s.salesAnalytics,{prospects:s.prospects,upcomingEvents:s.calendarEvents,tourInquiries:s.tourInquiries,workflowOrdersCount:{new:s.workflowOrders.filter(e=>e.stage==="new").length,picking:s.workflowOrders.filter(e=>e.stage==="picking").length,packed:s.workflowOrders.filter(e=>e.stage==="packed").length,shipped:s.workflowOrders.filter(e=>e.stage==="shipped").length,total:s.workflowOrders.length},lowStockCount:s.materialList.filter(e=>e.currentStock<e.minimumStock*1.5).length,masterCounts:s.masterStats?{customers:s.masterStats.summary.customerCount,products:s.masterStats.summary.productCount,suppliers:s.syncDashboard?.tables.find(e=>e.tableName==="suppliers")?.rowCount??0,specialPrices:s.syncDashboard?.tables.find(e=>e.tableName==="customer_product_prices")?.rowCount??0}:void 0},s.salesPeriod,s.customRange)}}function _o(){const e={info:{bg:"#edf6ff",border:"#b8d4e8",icon:"ℹ️"},warning:{bg:"#fff8e6",border:"#e6c54d",icon:"⚠️"},maintenance:{bg:"#fff3e0",border:"#f5a623",icon:"🔧"},update:{bg:"#e8f5e9",border:"#66bb6a",icon:"🆕"}},n=s.announcements.filter(r=>!s.dismissedAnnouncements.has(r.id)).map(r=>{const c=e[r.level]??e.info;return`
      ...
      </div>`:"";return n+i}function wo(){if(Lt())return`
    ...
    `;const e={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売業務",items:[{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/quote",label:"見積作成",kicker:"Quote"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],analytics:[{label:"分析",items:[{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/customer-analysis",label:"得意先分析",kicker:"CustABC"},{path:"/product-power",label:"商品力分析",kicker:"Power"},{path:"/customer-efficiency",label:"営業効率",kicker:"Efficiency"},{path:"/demand-forecast",label:"需要予測",kicker:"Forecast"},{path:"/report",label:"集計帳票",kicker:"Report"}]}],crm:[{label:"営業・顧客",items:[{path:"/prospects",label:"新規営業",kicker:"Prospects"},{path:"/map",label:"取引先マップ",kicker:"Map"},{path:"/list-builder",label:"リスト取得",kicker:"ListBuild"},{path:"/calls",label:"通話履歴",kicker:"Calls"},{path:"/email",label:"メール配信",kicker:"Mail"}]},{label:"受注・出荷",items:[{path:"/workflow",label:"受注ワークフロー",kicker:"Workflow"},{path:"/mobile-order",label:"モバイル受注",kicker:"Mobile"},{path:"/shopify",label:"Shopify注文",kicker:"Shopify"},{path:"/fax",label:"FAX OCR",kicker:"FAX"}]}],orders:[{label:"仕入・調達",items:[{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],brewery:[{label:"製造管理",items:[{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"},{path:"/tax",label:"酒税申告",kicker:"Tax"}]}],master:[{label:"マスタ・ツール",items:[{path:"/master",label:"マスタ管理",kicker:"Master"},{path:"/calendar",label:"カレンダー",kicker:"Calendar"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/tour",label:"酒蔵見学",kicker:"Tour"},{path:"/print",label:"印刷",kicker:"Print"}]}],settings:[{label:"システム設定",items:[{path:"/setup",label:"連動設定",kicker:"Setup"},{path:"/integrations",label:"外部連携",kicker:"API"},{path:"/slack",label:"Slack通知",kicker:"Slack"},{path:"/import",label:"データ取込",kicker:"Import"},{path:"/raw-browser",label:"データブラウザ",kicker:"RawData"},{path:"/users",label:"ユーザー管理",kicker:"Users"},{path:"/profile",label:"プロフィール",kicker:"Profile"},{path:"/audit",label:"操作ログ",kicker:"Audit"}]}]},t=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/invoice-entry",label:"販売"},{category:"analytics",path:"/analytics",label:"分析"},{category:"crm",path:"/prospects",label:"営業"},{category:"orders",path:"/purchase",label:"仕入"},{category:"brewery",path:"/jikomi",label:"製造"},{category:"master",path:"/master",label:"マスタ"},{category:"settings",path:"/setup",label:"設定"}],n=e[s.currentCategory].map(l=>`
      ...
      `).join(""),r=s.pickerMode&&s.masterStats?s.pickerMode==="customer"?si(s.masterStats.customers,s.pickerQuery):ji(s.masterStats.products,s.pickerQuery):"",c=s.globalSearchOpen?ai(s.globalQuery,go()):"",a=s.user?`
  ...
  `}async function ko(e){s.actionLoading=!0,y();try{s.invoiceRecords=await Be(e)}finally{s.actionLoading=!1,y()}}async function So(e){s.actionLoading=!0,y();try{s.customerLedger=await gt(e)}finally{s.actionLoading=!1,y()}}function X(e){s.invoiceForm={invoiceType:e.querySelector("#inv-type")?.value??s.invoiceForm.invoiceType,invoiceDate:e.querySelector("#inv-date")?.value??s.invoiceForm.invoiceDate,customerCode:e.querySelector("#inv-customer-code")?.value??s.invoiceForm.customerCode,customerName:e.querySelector("#inv-customer-name")?.value??s.invoiceForm.customerName,staffCode:e.querySelector("#inv-staff")?.value??s.invoiceForm.staffCode,lines:s.invoiceForm.lines.map((t,n)=>{const i=parseFloat(e.querySelector(`[data-line="${n}"][data-field="quantity"]`)?.value??"")||0,r=parseFloat(e.querySelector(`[data-line="${n}"][data-field="unitPrice"]`)?.value??"")||0;return{...t,productCode:e.querySelector(`[data-line="${n}"][data-field="productCode"]`)?.value??t.productCode,productName:e.querySelector(`[data-line="${n}"][data-field="productName"]`)?.value??t.productName,unit:e.querySelector(`[data-line="${n}"][data-field="unit"]`)?.value??t.unit,quantity:i,unitPrice:r,amount:i*r}}),note:e.querySelector("#inv-note")?.value??s.invoiceForm.note},s.invoiceForm.customerCode=s.invoiceForm.customerCode.trim().toUpperCase(),s.invoiceForm.customerName=s.invoiceForm.customerName.trim()}function ie(e){const t=e.querySelector("input[name='email-audience-mode']:checked")?.value??s.emailAudienceMode;s.emailAudienceMode=t,s.emailRegion=e.querySelector("#email-region")?.value??s.emailRegion,s.emailHistorySegment=e.querySelector("#email-history-segment")?.value??s.emailHistorySegment,s.emailSubject=e.querySelector("#email-subject")?.value??s.emailSubject,s.emailBody=e.querySelector("#email-body")?.value??s.emailBody}function xo(e){e.querySelector("[data-action='global-search-open']")?.addEventListener("click",()=>{s.globalSearchOpen=!0,y()}),e.querySelectorAll("[data-action='global-search-close']").forEach(a=>{a.addEventListener("click",l=>{a.classList.contains("global-search")&&l.target instanceof HTMLElement&&!l.target.classList.contains("global-search")||(Se(),y())})}),e.querySelector("#global-search-input")?.addEventListener("input",a=>{s.globalQuery=a.target.value,y()}),e.querySelectorAll("[data-action='global-nav']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.path;l&&(Se(),sa(l))})}),e.querySelector("[data-action='csv-export']")?.addEventListener("click",()=>{$o()}),e.querySelectorAll("[data-jikomi-tab]").forEach(a=>{a.addEventListener("click",()=>{s.jikomiView=a.dataset.jikomiTab,y()})}),e.querySelector("[data-action='auth-login']")?.addEventListener("click",()=>{const a=e.querySelector("#auth-email")?.value.trim()??"",l=e.querySelector("#auth-password")?.value??"";s.authSubmitting=!0,s.authError=null,y(),vs(a,l).then(async o=>{s.user=o,s.authSkipped=!1,s.authSubmitting=!1,s.authError=null;const{fetchMyProfile:d,recordAudit:u}=await f(async()=>{const{fetchMyProfile:p,recordAudit:h}=await Promise.resolve().then(()=>$);return{fetchMyProfile:p,recordAudit:h}},void 0);s.myProfile=await d(o.email),await u({action:"sign_in",userEmail:o.email}),y()}).catch(async o=>{try{const d=await Pt(a,l);s.user=d,s.authSkipped=!1,s.authError=null;const{fetchMyProfile:u}=await f(async()=>{const{fetchMyProfile:p}=await Promise.resolve().then(()=>$);return{fetchMyProfile:p}},void 0);s.myProfile=await u(d.email)}catch{s.authError=o instanceof Error?o.message:"ログインに失敗しました。"}finally{s.authSubmitting=!1,y()}})}),e.querySelector("[data-action='auth-skip']")?.addEventListener("click",()=>{s.authSkipped=!0,s.authError=null,y()}),e.querySelector("[data-action='auth-logout']")?.addEventListener("click",()=>{fs().finally(()=>{location.reload()})}),e.querySelector("[data-action='sidebar-open']")?.addEventListener("click",()=>{s.sidebarOpen=!0,y()}),e.querySelectorAll("[data-action='sidebar-close']").forEach(a=>{a.addEventListener("click",()=>{s.sidebarOpen=!1,y()})});const t=e.querySelector(".sidebar");if(t&&s.sidebarOpen){let a=0;t.addEventListener("touchstart",l=>{a=l.touches[0].clientX},{passive:!0}),t.addEventListener("touchend",l=>{l.changedTouches[0].clientX-a<-60&&(s.sidebarOpen=!1,y())},{passive:!0})}e.querySelectorAll("[data-action='dismiss-announcement']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.id??"";s.dismissedAnnouncements.add(l),y()})}),e.querySelector("[data-action='reload-app']")?.addEventListener("click",()=>{location.reload()}),e.querySelectorAll("[data-link]").forEach(a=>{a.addEventListener("click",l=>{l.preventDefault(),sa(a.dataset.link)})}),e.querySelector("#feature-request-form")?.addEventListener("submit",async a=>{a.preventDefault();const l=e.querySelector("#fr-title")?.value??"",o=e.querySelector("#fr-category")?.value??"feature",d=e.querySelector("#fr-description")?.value??"",u=e.querySelector("#fr-result");if(!l.trim())return;const p=await ba(l,o,d);if(u&&(u.textContent=p?"送信しました":"送信に失敗しました",u.className=`fr-result ${p?"success":"error"}`),p){const h=e.querySelector("#feature-request-form");h&&h.reset()}}),e.querySelectorAll("[data-period]").forEach(a=>{a.addEventListener("click",()=>{s.salesPeriod=a.dataset.period,y()})}),e.querySelector("[data-action='apply-range']")?.addEventListener("click",()=>{const a=e.querySelector("#range-start")?.value??"",l=e.querySelector("#range-end")?.value??"";a&&l&&(s.customRange={start:a,end:l},s.salesPeriod="custom",y())}),e.querySelectorAll("[data-edit-customer]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.editCustomer??"",o=s.masterStats?.customers.find(u=>u.id===l);if(!o)return;const d=document.createElement("div");d.innerHTML=xi(o),document.body.appendChild(d.firstElementChild),document.querySelector("[data-action='close-modal']")?.addEventListener("click",()=>{document.getElementById("edit-modal")?.remove()}),document.getElementById("edit-customer-form")?.addEventListener("submit",async u=>{u.preventDefault();const p=document.getElementById("edit-result"),h=await ga(l,{name:document.getElementById("ec-name").value,kana_name:document.getElementById("ec-kana").value,phone:document.getElementById("ec-phone").value,fax:document.getElementById("ec-fax").value,postal_code:document.getElementById("ec-postal").value,address1:document.getElementById("ec-address").value,closing_day:parseInt(document.getElementById("ec-closing").value)||null,payment_day:parseInt(document.getElementById("ec-payment").value)||null,manual_override:!0});p&&(p.textContent=h?"保存しました":"保存に失敗",p.className=`fr-result ${h?"success":"error"}`),h&&(document.getElementById("edit-modal")?.remove(),ke())})})}),e.querySelectorAll("[data-edit-product]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.editProduct??"",o=s.masterStats?.products.find(u=>u.id===l);if(!o)return;const d=document.createElement("div");d.innerHTML=Ai(o),document.body.appendChild(d.firstElementChild),document.querySelector("[data-action='close-modal']")?.addEventListener("click",()=>{document.getElementById("edit-modal")?.remove()}),document.getElementById("edit-product-form")?.addEventListener("submit",async u=>{u.preventDefault();const p=document.getElementById("edit-result"),h=await $a(l,{name:document.getElementById("ep-name").value,category_code:document.getElementById("ep-category").value,alcohol_degree:parseFloat(document.getElementById("ep-alcohol").value)||null,volume_ml:parseInt(document.getElementById("ep-volume").value)||null,bottle_type:document.getElementById("ep-bottle").value,purchase_price:parseInt(document.getElementById("ep-purchase").value)||null,default_sale_price:parseInt(document.getElementById("ep-sale").value)||null,manual_override:!0});p&&(p.textContent=h?"保存しました":"保存に失敗",p.className=`fr-result ${h?"success":"error"}`),h&&(document.getElementById("edit-modal")?.remove(),ke())})})}),e.querySelector("#q-cust-search")?.addEventListener("input",a=>{s.quoteCustomerQuery=a.target.value,y()}),e.querySelector("#q-prod-search")?.addEventListener("input",a=>{s.quoteProductQuery=a.target.value,y()}),e.querySelectorAll("[data-select-customer]").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.selectCustomer??"";s.quoteState.customerCode=l,s.quoteState.customerName=a.dataset.custName??"",s.quoteState.customerAddress=a.dataset.custAddr??"",s.quoteCustomerQuery="",s.quotePricing=await _a(s.masterStats?.customers??[],l),y()})}),e.querySelectorAll("[data-add-product]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.addProduct??"",o=a.dataset.prodName??"",d=parseInt(a.dataset.prodPrice??"0");s.quoteState.lines.push({productCode:l,productName:o,quantity:1,unit:"本",unitPrice:d,amount:d}),s.quoteProductQuery="",y()})}),e.querySelectorAll(".qty-input").forEach(a=>{a.addEventListener("change",()=>{const l=parseInt(a.dataset.lineIdx??"0"),o=s.quoteState.lines[l];o&&(o.quantity=parseInt(a.value)||0,o.amount=o.quantity*o.unitPrice,y())})}),e.querySelectorAll(".price-input").forEach(a=>{a.addEventListener("change",()=>{const l=parseInt(a.dataset.lineIdx??"0"),o=s.quoteState.lines[l];o&&(o.unitPrice=parseInt(a.value)||0,o.amount=o.quantity*o.unitPrice,y())})}),e.querySelectorAll("[data-remove-line]").forEach(a=>{a.addEventListener("click",()=>{const l=parseInt(a.dataset.removeLine??"0");s.quoteState.lines.splice(l,1),y()})}),e.querySelector("[data-action='save-quote']")?.addEventListener("click",async()=>{const a=s.quoteState;a.quoteNo=a.quoteNo||`Q${Date.now().toString(36).toUpperCase()}`,a.quoteDate=document.getElementById("q-date")?.value??a.quoteDate,a.validUntil=document.getElementById("q-valid")?.value??"",a.subject=document.getElementById("q-subject")?.value??"",a.remarks=document.getElementById("q-remarks")?.value??"",a.deliveryDate=document.getElementById("q-delivery-date")?.value??a.deliveryDate,a.paymentTerms=document.getElementById("q-payment-terms")?.value??a.paymentTerms,a.deliveryPlace=document.getElementById("q-delivery-place")?.value??a.deliveryPlace,a.fieldConfig.headerNote=document.getElementById("q-header-note")?.value??a.fieldConfig.headerNote,a.fieldConfig.footerNote=document.getElementById("q-footer-note")?.value??a.fieldConfig.footerNote;const l=a.lines.reduce((p,h)=>p+h.amount,0),o=Math.round(l*a.taxRate/100),{supabaseInsert:d}=await f(async()=>{const{supabaseInsert:p}=await Promise.resolve().then(()=>N);return{supabaseInsert:p}},void 0),u=await d("quotes",{quote_no:a.quoteNo,quote_date:a.quoteDate,valid_until:a.validUntil||null,legacy_customer_code:a.customerCode,customer_name:a.customerName,customer_address:a.customerAddress,subject:a.subject,subtotal:l,tax_amount:o,total_amount:l+o,remarks:a.remarks});if(u?.id){for(let p=0;p<a.lines.length;p++){const h=a.lines[p];await d("quote_lines",{quote_id:u.id,line_no:p+1,legacy_product_code:h.productCode,product_name:h.productName,quantity:h.quantity,unit:h.unit,unit_price:h.unitPrice,amount:h.amount})}alert(`見積 ${a.quoteNo} を保存しました`),s.quoteState={...Qa},y()}}),e.querySelector("[data-action='quote-preview-mode']")?.addEventListener("click",()=>{const a=s.quoteState;a.quoteDate=document.getElementById("q-date")?.value??a.quoteDate,a.validUntil=document.getElementById("q-valid")?.value??a.validUntil,a.subject=document.getElementById("q-subject")?.value??a.subject,a.remarks=document.getElementById("q-remarks")?.value??a.remarks,a.quoteNo=document.getElementById("q-no")?.value??a.quoteNo,a.deliveryDate=document.getElementById("q-delivery-date")?.value??a.deliveryDate,a.paymentTerms=document.getElementById("q-payment-terms")?.value??a.paymentTerms,a.deliveryPlace=document.getElementById("q-delivery-place")?.value??a.deliveryPlace,a.fieldConfig.headerNote=document.getElementById("q-header-note")?.value??a.fieldConfig.headerNote,a.fieldConfig.footerNote=document.getElementById("q-footer-note")?.value??a.fieldConfig.footerNote,a.previewMode=!0,y()}),e.querySelector("[data-action='quote-edit-mode']")?.addEventListener("click",()=>{s.quoteState.previewMode=!1,y()}),e.querySelector("[data-action='quote-download-pdf']")?.addEventListener("click",()=>{const a=s.quoteState;a.previewMode||(a.quoteDate=document.getElementById("q-date")?.value??a.quoteDate,a.validUntil=document.getElementById("q-valid")?.value??a.validUntil,a.subject=document.getElementById("q-subject")?.value??a.subject,a.remarks=document.getElementById("q-remarks")?.value??a.remarks,a.quoteNo=document.getElementById("q-no")?.value??a.quoteNo,a.deliveryDate=document.getElementById("q-delivery-date")?.value??a.deliveryDate,a.paymentTerms=document.getElementById("q-payment-terms")?.value??a.paymentTerms,a.deliveryPlace=document.getElementById("q-delivery-place")?.value??a.deliveryPlace,a.fieldConfig.headerNote=document.getElementById("q-header-note")?.value??a.fieldConfig.headerNote,a.fieldConfig.footerNote=document.getElementById("q-footer-note")?.value??a.fieldConfig.footerNote),di(a)}),e.querySelectorAll("[data-field-toggle]").forEach(a=>{a.addEventListener("change",()=>{const l=a.dataset.fieldToggle;l&&typeof s.quoteState.fieldConfig[l]=="boolean"&&(s.quoteState.fieldConfig[l]=a.checked,y())})}),e.querySelector("#q-seal-file")?.addEventListener("change",a=>{const l=a.target.files?.[0];if(!l)return;const o=new FileReader;o.onload=()=>{s.quoteState.sealSettings={imageDataUrl:o.result,size:72},localStorage.setItem("quote-seal",JSON.stringify(s.quoteState.sealSettings)),y()},o.readAsDataURL(l)}),e.querySelector("#q-seal-size")?.addEventListener("input",a=>{const l=parseInt(a.target.value);s.quoteState.sealSettings&&(s.quoteState.sealSettings.size=l,localStorage.setItem("quote-seal",JSON.stringify(s.quoteState.sealSettings)),y())}),e.querySelector("[data-action='remove-seal']")?.addEventListener("click",()=>{s.quoteState.sealSettings=null,localStorage.removeItem("quote-seal"),y()}),e.querySelectorAll("[data-action='dcal-prev'],[data-action='dcal-next']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.month;l&&(s.demandForecast.calendarMonth=l,y())})}),e.querySelectorAll("[data-action='forecast-segment']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.segment;s.demandForecast.selectedSegment=l,y()})}),e.querySelectorAll("[data-product-filter]").forEach(a=>{a.addEventListener("click",()=>{s.productFilter=a.dataset.productFilter??"all",y()})}),e.querySelector("[data-action='dashboard-refresh']")?.addEventListener("click",async a=>{const l=a.currentTarget;l.disabled=!0,l.textContent="更新中…",await ke(),l.disabled=!1,l.textContent="↻ 更新",b("ダッシュボードを更新しました","success")}),e.querySelector("[data-action='sales-filter']")?.addEventListener("click",()=>{const a=e.querySelector("#sales-start")?.value??"",l=e.querySelector("#sales-end")?.value??"";s.salesFilter={startDate:a,endDate:l},y()}),e.querySelector("[data-action='invoice-filter']")?.addEventListener("click",()=>{const a={documentNo:e.querySelector("#invoice-document-no")?.value??"",startDate:e.querySelector("#invoice-start")?.value??"",endDate:e.querySelector("#invoice-end")?.value??"",customerCode:e.querySelector("#invoice-customer-code")?.value??""};s.invoiceFilter=a,ko(a)}),e.querySelector("[data-action='ledger-search']")?.addEventListener("click",()=>{const a=e.querySelector("#ledger-customer-code")?.value??"";s.ledgerCustomerCode=a.trim().toUpperCase(),So(s.ledgerCustomerCode)}),e.querySelectorAll("[data-tab]").forEach(a=>{a.addEventListener("click",()=>{s.masterTab=a.dataset.tab,s.masterFilter={...At},y()})}),e.querySelector("[data-action='master-filter']")?.addEventListener("click",()=>{s.masterFilter={query:e.querySelector("#master-search")?.value??"",businessType:e.querySelector("#master-business-type")?.value??"",areaCode:e.querySelector("#master-area-code")?.value??"",activeOnly:e.querySelector("#master-active-only")?.value??"",page:1},y()}),e.querySelector("#master-search")?.addEventListener("keydown",a=>{a.key==="Enter"&&e.querySelector("[data-action='master-filter']")?.click()}),e.querySelectorAll("[data-action='master-page']").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.page);l>=1&&(s.masterFilter={...s.masterFilter,page:l},y())})}),e.querySelectorAll("[data-action='raw-select-table']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.table;if(!l)return;s.rawSelectedTable=l,s.rawPage=1;const o=await Fe(l,1);s.rawRecords=o.records,s.rawTotalCount=o.total,y()})}),e.querySelector("[data-action='raw-page-prev']")?.addEventListener("click",async()=>{if(!s.rawSelectedTable||s.rawPage<=1)return;s.rawPage-=1;const a=await Fe(s.rawSelectedTable,s.rawPage);s.rawRecords=a.records,s.rawTotalCount=a.total,y()}),e.querySelector("[data-action='raw-page-next']")?.addEventListener("click",async()=>{if(!s.rawSelectedTable)return;s.rawPage+=1;const a=await Fe(s.rawSelectedTable,s.rawPage);s.rawRecords=a.records,s.rawTotalCount=a.total,y()}),e.querySelectorAll("[data-analytics-tab]").forEach(a=>{a.addEventListener("click",()=>{s.analyticsTab=a.dataset.analyticsTab,y()})}),e.querySelector("[data-action='add-line']")?.addEventListener("click",()=>{X(e),s.invoiceForm.lines.push({productCode:"",productName:"",quantity:0,unitPrice:0,unit:"本",amount:0}),s.invoiceErrors={},y()}),e.querySelectorAll("[data-action='remove-line']").forEach(a=>{a.addEventListener("click",()=>{X(e);const l=parseInt(a.dataset.line??"0",10);s.invoiceForm.lines.splice(l,1),s.invoiceErrors=os(s.invoiceForm),y()})}),e.querySelectorAll("[data-action='duplicate-line']").forEach(a=>{a.addEventListener("click",()=>{X(e),ho(parseInt(a.dataset.line??"0",10)),s.invoiceErrors={},y()})}),e.querySelector("[data-action='copy-past-invoice']")?.addEventListener("click",()=>{yo(),y()}),e.querySelector("[data-action='open-customer-picker']")?.addEventListener("click",()=>{X(e),s.pickerMode="customer",s.pickerTargetLine=null,s.pickerQuery=s.invoiceForm.customerCode||s.invoiceForm.customerName,y()}),e.querySelectorAll("[data-action='open-product-picker']").forEach(a=>{a.addEventListener("click",()=>{X(e);const l=parseInt(a.dataset.line??"0",10),o=s.invoiceForm.lines[l];s.pickerMode="product",s.pickerTargetLine=l,s.pickerQuery=o?o.productCode||o.productName:"",y()})}),e.querySelectorAll("[data-action='modal-close']").forEach(a=>{a.addEventListener("click",l=>{a.classList.contains("modal-backdrop")&&l.target instanceof HTMLElement&&!l.target.classList.contains("modal-backdrop")||(Ue(),y())})}),e.querySelectorAll("[data-action='picker-select']").forEach(a=>{const l=async()=>{const o=a.dataset.code??"",d=a.dataset.name??"";if(s.pickerMode==="customer"){s.invoiceForm.customerCode=o,s.invoiceForm.customerName=d,delete s.invoiceErrors.customerCode;const u=s.masterStats?.customers.find(p=>p.code===o);s.invoicePriceGroup=u?.priceGroup||"",!s.invoicePriceGroup&&o&&(s.invoicePriceGroup=await ct(o))}else if(s.pickerMode==="product"&&s.pickerTargetLine!==null){const u=s.invoiceForm.lines[s.pickerTargetLine];if(u){u.productCode=o,u.productName=d;const p=await Ua(s.invoicePriceGroup,o);p>0&&(u.unitPrice=p),u.amount=u.quantity*u.unitPrice,delete s.invoiceErrors[`lines.${s.pickerTargetLine}.productCode`],delete s.invoiceErrors[`lines.${s.pickerTargetLine}.productName`]}}Ue(),y()};a.addEventListener("click",l),a.addEventListener("keydown",o=>{o.key==="Enter"&&l()})}),e.querySelector("#modal-search")?.addEventListener("input",a=>{s.pickerQuery=a.target.value,y()}),e.querySelector("[data-action='invoice-clear']")?.addEventListener("click",()=>{ls(),y()}),e.querySelector("[data-action='invoice-save']")?.addEventListener("click",()=>{rs(e)}),e.querySelector("#inv-customer-code")?.addEventListener("blur",async()=>{X(e),vo(s.invoiceForm.customerCode)&&(delete s.invoiceErrors.customerCode,!s.invoicePriceGroup&&s.invoiceForm.customerCode&&(s.invoicePriceGroup=await ct(s.invoiceForm.customerCode)),y())}),e.querySelector("#inv-customer-name")?.addEventListener("blur",()=>{X(e),fo(s.invoiceForm.customerName)&&(delete s.invoiceErrors.customerCode,y())}),e.querySelectorAll("#inv-date, #inv-customer-code, #inv-customer-name, #inv-staff, #inv-note, [data-field], #inv-type").forEach(a=>{a.addEventListener("input",()=>{X(e),s.invoiceSavedDocNo=null;const l=a.dataset.field;(l==="quantity"||l==="unitPrice")&&y()})}),e.querySelector("#inv-type")?.addEventListener("change",()=>{X(e),s.invoiceSavedDocNo=null}),e.querySelector("[data-action='delivery-search']")?.addEventListener("click",()=>{const a=e.querySelector("#delivery-docno")?.value??"";s.deliverySearchDocNo=a.trim(),s.deliveryNote=null,s.actionLoading=!0,y(),$t(s.deliverySearchDocNo||"D240122").then(l=>{s.deliveryNote=l,s.actionLoading=!1,y()})}),e.querySelector("[data-action='billing-load']")?.addEventListener("click",()=>{const a=e.querySelector("#billing-month")?.value??s.billingYearMonth;s.billingYearMonth=a,s.billingSummary=null,s.actionLoading=!0,y(),_t(a).then(l=>{s.billingSummary=l,s.actionLoading=!1,y()})}),e.querySelector("[data-action='tax-load']")?.addEventListener("click",()=>{const a=parseInt(e.querySelector("#tax-year")?.value??String(s.taxYear),10),l=parseInt(e.querySelector("#tax-month")?.value??String(s.taxMonth),10);s.taxYear=a,s.taxMonth=l,s.taxDeclaration=null,s.actionLoading=!0,y(),wt(a,l).then(o=>{s.taxDeclaration=o,s.actionLoading=!1,y()})}),e.querySelector("[data-action='tax-export-xml']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{generateTaxXML:a}=await f(async()=>{const{generateTaxXML:p}=await Promise.resolve().then(()=>$);return{generateTaxXML:p}},void 0),l=a(s.taxDeclaration),o=new Blob([l],{type:"application/xml;charset=utf-8"}),d=URL.createObjectURL(o),u=document.createElement("a");u.href=d,u.download=`tax-${s.taxYear}-${String(s.taxMonth).padStart(2,"0")}.xml`,u.click(),URL.revokeObjectURL(d)}),e.querySelector("[data-action='tax-export-csv']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{generateTaxCSV:a}=await f(async()=>{const{generateTaxCSV:p}=await Promise.resolve().then(()=>$);return{generateTaxCSV:p}},void 0),l=a(s.taxDeclaration),o=new Blob([l],{type:"text/csv;charset=utf-8"}),d=URL.createObjectURL(o),u=document.createElement("a");u.href=d,u.download=`tax-${s.taxYear}-${String(s.taxMonth).padStart(2,"0")}.csv`,u.click(),URL.revokeObjectURL(d)}),e.querySelector("[data-action='tax-save-draft']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{saveTaxDeclaration:a}=await f(async()=>{const{saveTaxDeclaration:l}=await Promise.resolve().then(()=>$);return{saveTaxDeclaration:l}},void 0);try{await a(s.taxDeclaration),b("下書き保存しました")}catch(l){b("保存に失敗: "+(l instanceof Error?l.message:String(l)),"error")}}),e.querySelectorAll("[data-tax-row][data-tax-field]").forEach(a=>{a.addEventListener("change",async()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.taxRow),o=a.dataset.taxField,d=a.type==="number"?Number(a.value)||0:a.value,u=[...s.taxDeclaration.rows];u[l]={...u[l],[o]:d};const{recalculateTaxDeclaration:p}=await f(async()=>{const{recalculateTaxDeclaration:h}=await Promise.resolve().then(()=>$);return{recalculateTaxDeclaration:h}},void 0);s.taxDeclaration=p({...s.taxDeclaration,rows:u}),y()})}),e.querySelectorAll("[data-ded-row][data-ded-field]").forEach(a=>{a.addEventListener("change",()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.dedRow),o=a.dataset.dedField,d=a.type==="number"?Number(a.value)||0:a.value,u=[...s.taxDeclaration.deductions];u[l]={...u[l],[o]:d},s.taxDeclaration={...s.taxDeclaration,deductions:u},y()})}),e.querySelectorAll("input[data-tax-field]:not([data-tax-row])").forEach(a=>{a.addEventListener("change",()=>{if(!s.taxDeclaration)return;const l=a.dataset.taxField;s.taxDeclaration={...s.taxDeclaration,[l]:a.value}})}),e.querySelector("[data-action='tax-add-category']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{recalculateTaxDeclaration:a,TAX_RATE_CATEGORIES:l}=await f(async()=>{const{recalculateTaxDeclaration:u,TAX_RATE_CATEGORIES:p}=await Promise.resolve().then(()=>$);return{recalculateTaxDeclaration:u,TAX_RATE_CATEGORIES:p}},void 0),o=l[0],d={taxCategory:o.code,taxCategoryName:o.name,alcoholDegree:15,productionVolume:0,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:0,taxableVolume:0,volume:0,taxRate:o.taxRatePerLiter,taxAmount:0};s.taxDeclaration=a({...s.taxDeclaration,rows:[...s.taxDeclaration.rows,d]}),y()}),e.querySelectorAll("[data-action='tax-remove-category']").forEach(a=>{a.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.taxRow),{recalculateTaxDeclaration:o}=await f(async()=>{const{recalculateTaxDeclaration:u}=await Promise.resolve().then(()=>$);return{recalculateTaxDeclaration:u}},void 0),d=s.taxDeclaration.rows.filter((u,p)=>p!==l);s.taxDeclaration=o({...s.taxDeclaration,rows:d}),y()})}),e.querySelector("[data-action='tax-add-deduction']")?.addEventListener("click",()=>{if(!s.taxDeclaration)return;const a={type:"export",categoryCode:"01",volume:0,reason:"",documentNo:""};s.taxDeclaration={...s.taxDeclaration,deductions:[...s.taxDeclaration.deductions,a]},y()}),e.querySelectorAll("[data-action='tax-remove-deduction']").forEach(a=>{a.addEventListener("click",()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.dedRow),o=s.taxDeclaration.deductions.filter((d,u)=>u!==l);s.taxDeclaration={...s.taxDeclaration,deductions:o},y()})}),e.querySelectorAll("[data-store-tab]").forEach(a=>{a.addEventListener("click",()=>{s.storeTab=a.dataset.storeTab,y()})}),e.querySelectorAll("[data-import-entity]").forEach(a=>{a.addEventListener("click",()=>{s.importEntity=a.dataset.importEntity,s.importPreview=null,s.importResult=null,y()})}),e.querySelector("[data-action='download-template']")?.addEventListener("click",()=>{const a=Jl(s.importEntity),l=new Blob([a],{type:"text/csv;charset=utf-8"}),o=URL.createObjectURL(l),d=document.createElement("a");d.href=o,d.download=`template_${s.importEntity}.csv`,d.click(),URL.revokeObjectURL(o)}),e.querySelector("[data-action='import-parse']")?.addEventListener("click",()=>{const l=e.querySelector("#import-file")?.files?.[0];if(!l){b("CSVファイルを選択してください","warning");return}const o=new FileReader;o.onload=()=>{const d=String(o.result??""),{columns:u,rows:p}=zl(d);s.importPreview=Vl(s.importEntity,u,p),s.importResult=null,y()},o.readAsText(l,"utf-8")}),e.querySelector("[data-action='import-cancel']")?.addEventListener("click",()=>{s.importPreview=null,s.importResult=null,y()}),e.querySelectorAll("[data-print-template]").forEach(a=>{a.addEventListener("click",()=>{s.printTemplate=a.dataset.printTemplate,y()})}),e.querySelectorAll("[data-print-field]").forEach(a=>{a.addEventListener("change",()=>{const l=a.dataset.printField;let o=a.value;(l==="taxRate"||l==="previousBalance"||l==="paymentAmount")&&(o=Number(a.value)||0),s.printData={...s.printData,[l]:o},y()})}),e.querySelectorAll("[data-print-opt]").forEach(a=>{const l=()=>{const o=a.dataset.printOpt;let d;a.type==="checkbox"?d=a.checked:o==="copies"?d=Number(a.value)||1:o==="overlayOpacity"||o==="calibrationOffsetX"||o==="calibrationOffsetY"?d=Number(a.value)||0:d=a.value,s.printOptions={...s.printOptions,[o]:d},y()};a.addEventListener("change",l),a.type==="range"&&a.addEventListener("input",l)}),e.querySelectorAll("[data-print-line][data-print-lfield]").forEach(a=>{a.addEventListener("change",()=>{const l=Number(a.dataset.printLine),o=a.dataset.printLfield,d=[...s.printData.lines];let u=a.value;(o==="quantity"||o==="unitPrice")&&(u=Number(a.value)||0),d[l]={...d[l],[o]:u},d[l].amount=(Number(d[l].quantity)||0)*(Number(d[l].unitPrice)||0),s.printData={...s.printData,lines:d},y()})}),e.querySelector("[data-action='print-add-line']")?.addEventListener("click",()=>{s.printData={...s.printData,lines:[...s.printData.lines,{productCode:"",productName:"",spec:"",quantity:0,unit:"本",unitPrice:0,amount:0}]},y()}),e.querySelectorAll("[data-action='print-remove-line']").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.printLine);s.printData={...s.printData,lines:s.printData.lines.filter((o,d)=>d!==l)},y()})}),e.querySelector("[data-action='print-save-settings']")?.addEventListener("click",()=>{try{localStorage.setItem("sake_print_options",JSON.stringify(s.printOptions)),localStorage.setItem("sake_print_company",JSON.stringify(s.printCompany)),b("印刷設定を保存しました")}catch(a){b("保存失敗: "+(a instanceof Error?a.message:String(a)),"error")}}),e.querySelector("[data-action='print-open-company']")?.addEventListener("click",()=>{const a=s.printCompany,l=prompt("会社名",a.name);if(l===null)return;const o=prompt("郵便番号",a.postalCode)??a.postalCode,d=prompt("住所",a.address1)??a.address1,u=prompt("TEL",a.tel)??a.tel,p=prompt("FAX",a.fax)??a.fax,h=prompt("適格請求書登録番号 (T+13桁)",a.registrationNo)??a.registrationNo,v=prompt("取引銀行名",a.bankName)??a.bankName,_=prompt("支店名",a.bankBranch)??a.bankBranch,A=prompt("口座番号",a.bankAccountNo)??a.bankAccountNo,k=prompt("口座名義",a.bankAccountHolder)??a.bankAccountHolder;s.printCompany={...a,name:l,postalCode:o,address1:d,tel:u,fax:p,registrationNo:h,bankName:v,bankBranch:_,bankAccountNo:A,bankAccountHolder:k},y()}),e.querySelector("[data-action='fd-toggle-design']")?.addEventListener("click",()=>{s.fdDesignMode=!s.fdDesignMode,y()}),e.querySelector("[data-action='fd-save-cloud']")?.addEventListener("click",async()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const o=(e.querySelector("#fd-layout-name")?.value??"").trim()||"デフォルト",d=tt(a),{savePrintLayout:u}=await f(async()=>{const{savePrintLayout:h}=await Promise.resolve().then(()=>$);return{savePrintLayout:h}},void 0),p={id:`bp1701_${o.replaceAll(/[^a-zA-Z0-9_-]/g,"_")}_${Date.now()}`,name:o,templateKey:"chain_store",positions:d};try{await u(p)?(b(`クラウド保存成功: ${o}`),s.fdSavedPositions=d,localStorage.setItem("sake_fd_positions",JSON.stringify(d)),y()):(b("クラウド保存に失敗しました。ローカルには保存されました","warning"),localStorage.setItem("sake_fd_positions",JSON.stringify(d)))}catch(h){b("保存エラー: "+(h instanceof Error?h.message:""),"error")}}),e.querySelector("[data-action='fd-save-local']")?.addEventListener("click",()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const l=tt(a);s.fdSavedPositions=l;try{localStorage.setItem("sake_fd_positions",JSON.stringify(l)),b(`ローカル保存完了: ${Object.keys(l).length}件`)}catch(o){b("保存失敗: "+(o instanceof Error?o.message:""),"error")}}),e.querySelector("[data-action='fd-export-json']")?.addEventListener("click",()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const o={templateKey:"chain_store",positions:tt(a),exportedAt:new Date().toISOString()},d=new Blob([JSON.stringify(o,null,2)],{type:"application/json"}),u=URL.createObjectURL(d),p=document.createElement("a");p.href=u,p.download=`bp1701_layout_${new Date().toISOString().slice(0,10)}.json`,p.click(),URL.revokeObjectURL(u)}),e.querySelector("[data-action='fd-import-json']")?.addEventListener("click",()=>{e.querySelector("#fd-import-file")?.click()}),e.querySelector("#fd-import-file")?.addEventListener("change",async a=>{const l=a.target.files?.[0];if(l)try{const o=await l.text(),u=JSON.parse(o).positions;if(!u)throw new Error("positions field not found");s.fdSavedPositions=u,localStorage.setItem("sake_fd_positions",JSON.stringify(u)),b(`インポート成功: ${Object.keys(u).length}件`),y()}catch(o){b("インポート失敗: "+(o instanceof Error?o.message:""),"error")}});const n=e.querySelector("#fd-saved-layouts");n&&s.route==="/form-designer"&&s.fdDesignMode&&(async()=>{const{fetchPrintLayouts:a}=await f(async()=>{const{fetchPrintLayouts:o}=await Promise.resolve().then(()=>$);return{fetchPrintLayouts:o}},void 0),l=await a("chain_store");l.length===0?n.innerHTML="☁️ クラウドに保存されたレイアウトはありません":(n.innerHTML=`☁️ クラウド保存済み (${l.length}件):<br/>`+l.map(o=>`<button class="button-sm secondary" data-action="fd-load-layout" data-layout-id="${o.id}" style="margin:4px 4px 0 0;">${o.name}</button>
                 <button class="button-sm secondary" data-action="fd-delete-layout" data-layout-id="${o.id}" title="削除" style="margin:4px 8px 0 0;color:var(--danger);">✕</button>`).join(""),n.querySelectorAll("[data-action='fd-load-layout']").forEach(o=>{o.addEventListener("click",()=>{const d=o.dataset.layoutId,u=l.find(p=>p.id===d);u&&(s.fdSavedPositions=u.positions,localStorage.setItem("sake_fd_positions",JSON.stringify(u.positions)),b(`読込完了: ${u.name}`),y())})}),n.querySelectorAll("[data-action='fd-delete-layout']").forEach(o=>{o.addEventListener("click",async()=>{const d=o.dataset.layoutId;if(!d||!await W("このレイアウトを削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deletePrintLayout:u}=await f(async()=>{const{deletePrintLayout:h}=await Promise.resolve().then(()=>$);return{deletePrintLayout:h}},void 0);await u(d)?(b("削除しました"),y()):b("削除失敗","error")})}))})(),e.querySelector("[data-action='fd-reset-positions']")?.addEventListener("click",async()=>{await W("フィールド位置を初期値に戻しますか？")&&(s.fdSavedPositions=null,localStorage.removeItem("sake_fd_positions"),y())});const i=e.querySelector("#fd-sel-x"),r=e.querySelector("#fd-sel-y");[i,r].forEach(a=>{a?.addEventListener("change",()=>{if(!s.fdActiveFieldId)return;const l=document.querySelector(`[data-fd-id="${s.fdActiveFieldId}"]`);l&&(i&&(l.style.left=i.value+"mm"),r&&(l.style.top=r.value+"mm"))})});const c=e.querySelector("#customer-map");c&&s.route==="/map"&&ps(c),e.querySelectorAll(".wf-card").forEach(a=>{a.addEventListener("dragstart",l=>{a.classList.add("wf-dragging"),l.dataTransfer?.setData("text/plain",a.dataset.wfOrder??"")}),a.addEventListener("dragend",()=>a.classList.remove("wf-dragging"))}),e.querySelectorAll(".wf-col").forEach(a=>{a.addEventListener("dragover",l=>l.preventDefault()),a.addEventListener("drop",l=>{l.preventDefault();const o=l.dataTransfer?.getData("text/plain"),d=a.dataset.wfStage;if(!o||!d)return;const u=s.workflowOrders.find(p=>p.id===o);u&&(u.stage=d,y())})}),e.querySelectorAll("[data-mo-step]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moStep;a.disabled||(s.mobileOrder.step=l,y())})}),e.querySelector("#mo-customer-q")?.addEventListener("input",a=>{s.mobileOrder.customerQuery=a.target.value,y()}),e.querySelector("#mo-product-q")?.addEventListener("input",a=>{s.mobileOrder.productQuery=a.target.value,y()}),e.querySelectorAll("[data-mo-select-customer]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moSelectCustomer,o=s.masterStats?.customers.find(d=>d.id===l);o&&(s.mobileOrder.selectedCustomer=o),y()})}),e.querySelectorAll("[data-mo-add-product]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moAddProduct,o=s.masterStats?.products.find(u=>u.code===l);if(!o)return;const d=1800;s.mobileOrder.cart.push({productCode:o.code,productName:o.name,quantity:1,unit:"本",unitPrice:d,amount:d}),y()})}),e.querySelectorAll("[data-mo-qty]").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.moQty),o=a.dataset.moProduct,d=s.mobileOrder.cart.find(u=>u.productCode===o);d&&(d.quantity=Math.max(0,d.quantity+l),d.amount=d.quantity*d.unitPrice,d.quantity===0&&(s.mobileOrder.cart=s.mobileOrder.cart.filter(u=>u.productCode!==o)),y())})}),e.querySelectorAll("[data-mo-remove]").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.moRemove);s.mobileOrder.cart.splice(l,1),y()})}),e.querySelector("[data-action='mo-submit']")?.addEventListener("click",async()=>{const a=e.querySelector("#mo-memo");s.mobileOrder.memo=a?.value??"";const l="MO"+Date.now().toString().slice(-8);s.mobileOrder.submittedDocNo=l,s.mobileOrder.step="done",y()}),e.querySelector("[data-action='mo-reset']")?.addEventListener("click",()=>{s.mobileOrder={step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},y()}),e.querySelectorAll("[data-tour-id]").forEach(a=>{a.addEventListener("click",()=>{s.tourActiveId=a.dataset.tourId??null,y()})}),e.querySelectorAll("[data-action='tour-insert-template']").forEach(a=>{a.addEventListener("click",()=>{const l=s.tourInquiries.find(h=>h.id===s.tourActiveId);if(!l)return;const o=a.dataset.template==="confirm"?yl:vl,d=e.querySelector("#tour-confirmed-time"),u=o.replaceAll("{name}",l.name).replaceAll("{partySize}",String(l.partySize)).replaceAll("{confirmedTime}",d?.value??l.visitDate),p=e.querySelector("#tour-reply-body");p&&(p.value=u)})}),e.querySelector("[data-action='tour-send-reply']")?.addEventListener("click",()=>{const a=document.querySelector("[data-action='tour-send-reply']")?.dataset.tourId??"",l=s.tourInquiries.find(d=>d.id===a);if(!l)return;const o=e.querySelector("#tour-confirmed-time");l.status="confirmed",l.repliedAt=new Date().toISOString(),l.confirmedTime=o?.value??"",b("返信メールを下書き保存し、ステータスを確定にしました"),y()}),e.querySelector("[data-action='lb-search']")?.addEventListener("click",async()=>{const a=e.querySelector("#lb-type")?.value??"",l=e.querySelector("#lb-area")?.value??"",o=e.querySelector("#lb-keyword")?.value??"";if(!a&&!o){b("業種かキーワードを入力してください","warning");return}s.leadSearchType=a,s.leadSearchArea=l,s.leadSearchQuery=o,s.leadSearching=!0,y();const d=s.integrations.find(v=>v.provider==="google_maps");if(!d||!d.config.api_key){b("Google Maps APIキーが /integrations で未設定です","warning"),s.leadSearching=!1,y();return}const{searchPlaces:u}=await f(async()=>{const{searchPlaces:v}=await Promise.resolve().then(()=>$);return{searchPlaces:v}},void 0),p=[a,o].filter(Boolean).join(" "),h=await u(d,p,l);s.leadSearching=!1,h.error?b("検索失敗: "+h.error,"error"):s.leadSearchResults=h.results,y()}),e.querySelector("[data-action='lb-clear-search']")?.addEventListener("click",()=>{s.leadSearchResults=[],y()}),e.querySelector("[data-action='lb-save-list']")?.addEventListener("click",async()=>{if(s.leadSearchResults.length===0)return;const a=prompt("リスト名を入力:",`${s.leadSearchType} ${s.leadSearchArea}`);if(!a)return;const l=`ll_${Date.now()}`,o={id:l,name:a,query:s.leadSearchQuery,area:s.leadSearchArea,businessType:s.leadSearchType,totalCount:s.leadSearchResults.length,source:"google_places"},{saveLeadList:d,saveLeadItem:u,fetchLeadLists:p,fetchLeadItems:h}=await f(async()=>{const{saveLeadList:A,saveLeadItem:k,fetchLeadLists:L,fetchLeadItems:V}=await Promise.resolve().then(()=>$);return{saveLeadList:A,saveLeadItem:k,fetchLeadLists:L,fetchLeadItems:V}},void 0);await d(o);const v=e.querySelectorAll(".lb-search-check:checked"),_=Array.from(v).map(A=>Number(A.dataset.idx));for(const A of _){const k=s.leadSearchResults[A];k&&await u({...k,id:`li_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,listId:l,businessType:s.leadSearchType})}s.leadLists=await p(),s.leadActiveListId=l,s.leadItems=await h(l),s.leadSearchResults=[],b(`${_.length}件を「${a}」として保存しました`),y()}),e.querySelectorAll("[data-action='lb-select-list']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??null;if(s.leadActiveListId=l,l){const{fetchLeadItems:o}=await f(async()=>{const{fetchLeadItems:d}=await Promise.resolve().then(()=>$);return{fetchLeadItems:d}},void 0);s.leadItems=await o(l)}y()})}),e.querySelectorAll("[data-action='lb-exclude']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??"",o=s.leadItems.find(p=>p.id===l);if(!o)return;const{saveLeadItem:d,fetchLeadItems:u}=await f(async()=>{const{saveLeadItem:p,fetchLeadItems:h}=await Promise.resolve().then(()=>$);return{saveLeadItem:p,fetchLeadItems:h}},void 0);await d({...o,status:"excluded"}),s.leadActiveListId&&(s.leadItems=await u(s.leadActiveListId)),y()})}),e.querySelectorAll("[data-action='lb-convert-one']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??"",o=s.leadItems.find(h=>h.id===l);if(!o)return;const{convertLeadToProspect:d,fetchLeadItems:u}=await f(async()=>{const{convertLeadToProspect:h,fetchLeadItems:v}=await Promise.resolve().then(()=>$);return{convertLeadToProspect:h,fetchLeadItems:v}},void 0);await d(o)&&(b("見込客に追加しました: "+o.companyName),s.leadActiveListId&&(s.leadItems=await u(s.leadActiveListId)),y())})}),e.querySelector("[data-action='lb-bulk-convert']")?.addEventListener("click",async()=>{const a=e.querySelectorAll(".lb-item-check:checked");if(a.length===0&&!await W("全ての新規アイテムを見込客に変換しますか？"))return;const l=a.length>0?Array.from(a).map(p=>p.dataset.id):s.leadItems.filter(p=>p.status==="new").map(p=>p.id),{convertLeadToProspect:o,fetchLeadItems:d}=await f(async()=>{const{convertLeadToProspect:p,fetchLeadItems:h}=await Promise.resolve().then(()=>$);return{convertLeadToProspect:p,fetchLeadItems:h}},void 0);let u=0;for(const p of l){const h=s.leadItems.find(v=>v.id===p);h&&h.status==="new"&&await o(h)&&u++}b(`${u}件を見込客に変換しました`),s.leadActiveListId&&(s.leadItems=await d(s.leadActiveListId)),y()}),e.querySelectorAll("[data-map-filter]").forEach(a=>{a.addEventListener("change",()=>{const l=a.dataset.mapFilter;let o;a.type==="checkbox"?o=a.checked:o=a.value,s.mapFilters={...s.mapFilters,[l]:o},y()})}),e.querySelector("[data-action='ivry-sync']")?.addEventListener("click",async()=>{const a=s.integrations.find(u=>u.provider==="ivry");if(!a||!a.isEnabled){b("IVRy連携が無効です。/integrations で有効化してください","warning");return}const{syncIvryCallLogs:l,fetchCallLogs:o}=await f(async()=>{const{syncIvryCallLogs:u,fetchCallLogs:p}=await Promise.resolve().then(()=>$);return{syncIvryCallLogs:u,fetchCallLogs:p}},void 0),d=await l(a);d.error?b("同期失敗: "+d.error,"error"):(b(`${d.count}件の通話履歴を同期しました`),s.callLogs=await o(100),y())}),e.querySelector("[data-action='ivry-push-phonebook']")?.addEventListener("click",async()=>{const a=s.integrations.find(u=>u.provider==="ivry");if(!a||!a.isEnabled){b("IVRy連携が無効です","warning");return}if(!await W("全ての取引先と見込客の電話帳をIVRyに送信しますか？"))return;const{syncPhoneBookToIvry:l}=await f(async()=>{const{syncPhoneBookToIvry:u}=await Promise.resolve().then(()=>$);return{syncPhoneBookToIvry:u}},void 0),o=[];s.masterStats?.customers.forEach(u=>{o.push({name:u.name,phone:"",customerCode:u.code,note:"既存取引先"})}),s.prospects.forEach(u=>{u.phone&&o.push({name:u.companyName,phone:u.phone,customerCode:u.id,note:`見込客 (${u.stage})`})});const d=await l(a,o);d.error?b("送信失敗: "+d.error,"error"):b(`${d.synced}件の連絡先を送信しました`)}),e.querySelectorAll("[data-action='call-link-customer']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??"",o=a.dataset.phone??"",d=prompt(`電話番号 ${o} を顧客コードに紐付け
顧客コードを入力:`);if(!d)return;const u=s.callLogs.find(v=>v.id===l);if(!u)return;const{saveCallLog:p,fetchCallLogs:h}=await f(async()=>{const{saveCallLog:v,fetchCallLogs:_}=await Promise.resolve().then(()=>$);return{saveCallLog:v,fetchCallLogs:_}},void 0);await p({...u,matchedCustomerCode:d}),s.callLogs=await h(100),y()})}),e.querySelectorAll("[data-action='call-memo']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??"",o=s.callLogs.find(h=>h.id===l);if(!o)return;const d=prompt("メモを入力:",o.notes??"");if(d===null)return;const{saveCallLog:u,fetchCallLogs:p}=await f(async()=>{const{saveCallLog:h,fetchCallLogs:v}=await Promise.resolve().then(()=>$);return{saveCallLog:h,fetchCallLogs:v}},void 0);await u({...o,notes:d}),s.callLogs=await p(100),y()})}),e.querySelectorAll("[data-prospect-view]").forEach(a=>{a.addEventListener("click",()=>{s.prospectViewMode=a.dataset.prospectView,y()})}),e.querySelector("[data-action='prospect-new']")?.addEventListener("click",()=>{s.prospectEditingId="__new__",y()}),e.querySelectorAll("[data-action='prospect-edit']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??null;if(s.prospectEditingId=l,l){const{fetchProspectActivities:o}=await f(async()=>{const{fetchProspectActivities:d}=await Promise.resolve().then(()=>$);return{fetchProspectActivities:d}},void 0);s.prospectActivities=await o(l)}y()})}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.prospectId??null;if(s.prospectEditingId=l,l){const{fetchProspectActivities:o}=await f(async()=>{const{fetchProspectActivities:d}=await Promise.resolve().then(()=>$);return{fetchProspectActivities:d}},void 0);s.prospectActivities=await o(l)}y()})}),e.querySelectorAll("[data-action='prospect-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.prospectEditingId=null,s.prospectActivities=[],y())})}),e.querySelector("[data-action='prospect-save']")?.addEventListener("click",async()=>{const a=s.prospectEditingId==="__new__",l=a?`p_${Date.now()}`:s.prospectEditingId??"",o={id:l,companyName:e.querySelector("#prospect-company")?.value??"",contactName:e.querySelector("#prospect-contact")?.value??"",email:e.querySelector("#prospect-email")?.value??"",phone:e.querySelector("#prospect-phone")?.value??"",businessType:e.querySelector("#prospect-business-type")?.value??"",stage:e.querySelector("#prospect-stage")?.value??"cold",source:e.querySelector("#prospect-source")?.value??"",expectedAmount:Number(e.querySelector("#prospect-amount")?.value)||0,probability:Number(e.querySelector("#prospect-probability")?.value)||0,assignedStaffCode:e.querySelector("#prospect-staff")?.value??"",nextActionDate:e.querySelector("#prospect-next-date")?.value??"",nextAction:e.querySelector("#prospect-next-action")?.value??"",note:e.querySelector("#prospect-note")?.value??""};if(!o.companyName){b("会社名は必須です","warning");return}const{saveProspect:d,fetchProspects:u,recordAudit:p,sendSlackNotification:h}=await f(async()=>{const{saveProspect:_,fetchProspects:A,recordAudit:k,sendSlackNotification:L}=await Promise.resolve().then(()=>$);return{saveProspect:_,fetchProspects:A,recordAudit:k,sendSlackNotification:L}},void 0);await d(o)?(a&&await h("new_prospect",`新規見込客: ${o.companyName} / 想定 ¥${o.expectedAmount.toLocaleString("ja-JP")}`).catch(()=>{}),await p({action:a?"prospect_create":"prospect_update",entityType:"prospect",entityId:l,userEmail:s.user?.email}),s.prospects=await u(),s.prospectEditingId=null,y()):b("保存失敗","error")}),e.querySelectorAll("[data-action='prospect-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=a.dataset.id??"",{deleteProspect:o,fetchProspects:d}=await f(async()=>{const{deleteProspect:u,fetchProspects:p}=await Promise.resolve().then(()=>$);return{deleteProspect:u,fetchProspects:p}},void 0);await o(l)&&(s.prospects=await d(),y())})}),e.querySelector("[data-action='prospect-add-activity']")?.addEventListener("click",async()=>{const a=e.querySelector("[data-action='prospect-add-activity']")?.dataset.id??"",l=e.querySelector("#prospect-activity-type")?.value??"call",o=e.querySelector("#prospect-activity-title")?.value??"";if(!o){b("内容を入力してください","warning");return}const{saveProspectActivity:d,fetchProspectActivities:u}=await f(async()=>{const{saveProspectActivity:p,fetchProspectActivities:h}=await Promise.resolve().then(()=>$);return{saveProspectActivity:p,fetchProspectActivities:h}},void 0);await d({id:`act_${Date.now()}`,prospectId:a,activityType:l,title:o,activityDate:new Date().toISOString(),staffCode:s.myProfile?.staffCode}),s.prospectActivities=await u(a),y()}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(a=>{a.addEventListener("dragstart",l=>{l.dataTransfer?.setData("text/plain",a.dataset.prospectId??"")})}),e.querySelectorAll(".pk-col[data-prospect-stage]").forEach(a=>{a.addEventListener("dragover",l=>l.preventDefault()),a.addEventListener("drop",async l=>{l.preventDefault();const o=l.dataTransfer?.getData("text/plain"),d=a.dataset.prospectStage;if(!o)return;const u=s.prospects.find(p=>p.id===o);if(u&&u.stage!==d){const p={...u,stage:d},{saveProspect:h}=await f(async()=>{const{saveProspect:v}=await Promise.resolve().then(()=>$);return{saveProspect:v}},void 0);await h(p),u.stage=d,y()}})}),e.querySelector("[data-action='slack-save']")?.addEventListener("click",async()=>{const{fetchIntegrationSettings:a,saveIntegrationSetting:l}=await f(async()=>{const{fetchIntegrationSettings:v,saveIntegrationSetting:_}=await Promise.resolve().then(()=>$);return{fetchIntegrationSettings:v,saveIntegrationSetting:_}},void 0),d=(s.integrations.length>0?s.integrations:await a()).find(v=>v.provider==="slack");if(!d)return;const u=e.querySelector("#slack-webhook")?.value??"",p=e.querySelector("#slack-default-channel")?.value??"",h=e.querySelector("#slack-enabled")?.checked??!1;await l({...d,config:{...d.config,webhook_url:u,default_channel:p},isEnabled:h}),s.integrations=await a(),b("保存しました"),y()}),e.querySelector("[data-action='slack-save-rules']")?.addEventListener("click",async()=>{const{saveSlackRule:a,fetchSlackRules:l}=await f(async()=>{const{saveSlackRule:o,fetchSlackRules:d}=await Promise.resolve().then(()=>$);return{saveSlackRule:o,fetchSlackRules:d}},void 0);for(const o of s.slackRules){const d=e.querySelector(`[data-slack-rule-id="${o.id}"][data-slack-field="enabled"]`)?.checked??o.enabled,u=e.querySelector(`[data-slack-rule-id="${o.id}"][data-slack-field="channel"]`)?.value??o.channel;await a({...o,enabled:d,channel:u})}s.slackRules=await l(),b("ルールを保存しました"),y()}),e.querySelector("[data-action='slack-test']")?.addEventListener("click",async()=>{const{sendSlackNotification:a}=await f(async()=>{const{sendSlackNotification:o}=await Promise.resolve().then(()=>$);return{sendSlackNotification:o}},void 0),l=await a("new_order","🧪 これはテスト通知です (syusen-cloud)");l.ok?b("テスト送信成功"):b("送信失敗: "+(l.error??""),"error")}),e.querySelector("[data-action='material-receive']")?.addEventListener("click",()=>{s.materialEditing=null,s.materialEditingIsNew=!0,y()}),e.querySelectorAll("[data-action='material-adjust']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.id??"",o=s.materialList.find(d=>d.id===l);o&&(s.materialEditing=o,s.materialEditingIsNew=!1,y())})}),e.querySelectorAll("[data-action='material-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.materialEditing=null,s.materialEditingIsNew=!1,y())})}),e.querySelector("[data-action='material-save']")?.addEventListener("click",async()=>{const l={id:s.materialEditingIsNew?`mat_${Date.now()}`:s.materialEditing?.id??"",code:e.querySelector("#mat-code")?.value??"",name:e.querySelector("#mat-name")?.value??"",unit:e.querySelector("#mat-unit")?.value??"個",currentStock:Number(e.querySelector("#mat-stock")?.value)||0,minimumStock:Number(e.querySelector("#mat-min")?.value)||0,unitCost:Number(e.querySelector("#mat-cost")?.value)||0,lastUpdated:e.querySelector("#mat-last-date")?.value??new Date().toISOString().slice(0,10)};if(l.materialType=e.querySelector("#mat-type")?.value??"",!l.code||!l.name){b("コードと品名は必須です","warning");return}const{saveMaterial:o,fetchMaterialList:d}=await f(async()=>{const{saveMaterial:p,fetchMaterialList:h}=await Promise.resolve().then(()=>$);return{saveMaterial:p,fetchMaterialList:h}},void 0);await o(l)?(s.materialList=await d(),s.materialEditing=null,s.materialEditingIsNew=!1,b("保存しました"),y()):b("保存失敗","error")}),e.querySelector("[data-action='material-delete']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='material-delete']")?.dataset.id??"";if(!a||!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deleteMaterial:l,fetchMaterialList:o}=await f(async()=>{const{deleteMaterial:d,fetchMaterialList:u}=await Promise.resolve().then(()=>$);return{deleteMaterial:d,fetchMaterialList:u}},void 0);await l(a)&&(s.materialList=await o(),s.materialEditing=null,y())}),e.querySelector("[data-action='user-new']")?.addEventListener("click",()=>{s.userEditingId="__new__",y()}),e.querySelectorAll("[data-action='user-edit']").forEach(a=>{a.addEventListener("click",()=>{s.userEditingId=a.dataset.id??null,y()})}),e.querySelector("[data-action='user-cancel']")?.addEventListener("click",()=>{s.userEditingId=null,y()}),e.querySelector("[data-action='user-save']")?.addEventListener("click",async()=>{const a=s.userEditingId==="__new__",l=a?crypto.randomUUID():s.userEditingId??"",o=e.querySelector("#user-email")?.value.trim()??"",d=e.querySelector("#user-name")?.value.trim()??"";if(!o||!d){b("名前とメールアドレスは必須です","warning");return}const u={id:l,email:o,displayName:d,staffCode:e.querySelector("#user-code")?.value??"",department:e.querySelector("#user-dept")?.value??"all",role:e.querySelector("#user-role")?.value??"staff",phone:e.querySelector("#user-phone")?.value??"",isActive:e.querySelector("#user-active")?.checked??!0};if(a){const A=e.querySelector("#user-password")?.value??"";if(A.length<8){b("パスワードは8文字以上必要です","warning");return}try{await Pt(o,A)}catch(k){b("Auth登録失敗: "+(k instanceof Error?k.message:""),"error");return}}const{saveUserProfile:p,fetchUserProfiles:h,recordAudit:v}=await f(async()=>{const{saveUserProfile:A,fetchUserProfiles:k,recordAudit:L}=await Promise.resolve().then(()=>$);return{saveUserProfile:A,fetchUserProfiles:k,recordAudit:L}},void 0);await p(u)?(await v({action:a?"user_create":"user_update",entityType:"user",entityId:l,userEmail:s.user?.email}),s.userProfiles=await h(),s.userEditingId=null,b("保存しました"),y()):b("保存失敗","error")}),e.querySelectorAll("[data-action='user-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=a.dataset.id??"",{deleteUserProfile:o,fetchUserProfiles:d,recordAudit:u}=await f(async()=>{const{deleteUserProfile:h,fetchUserProfiles:v,recordAudit:_}=await Promise.resolve().then(()=>$);return{deleteUserProfile:h,fetchUserProfiles:v,recordAudit:_}},void 0);await o(l)?(await u({action:"user_delete",entityType:"user",entityId:l,userEmail:s.user?.email}),s.userProfiles=await d(),y()):b("削除失敗","error")})}),e.querySelector("[data-action='profile-save-sender']")?.addEventListener("click",async()=>{if(!s.myProfile)return;const a=e.querySelector("#profile-sender")?.value??"",l={...s.myProfile,defaultMailSenderId:a},{saveUserProfile:o}=await f(async()=>{const{saveUserProfile:d}=await Promise.resolve().then(()=>$);return{saveUserProfile:d}},void 0);await o(l),s.myProfile=l,b("保存しました"),y()}),e.querySelector("[data-action='profile-change-password']")?.addEventListener("click",async()=>{const a=e.querySelector("#profile-new-password")?.value??"";if(a.length<8){b("8文字以上のパスワードを入力してください","warning");return}try{await gs(a),b("パスワードを変更しました")}catch(l){b("変更失敗: "+(l instanceof Error?l.message:""),"error")}}),e.querySelectorAll("[data-action='int-edit']").forEach(a=>{a.addEventListener("click",()=>{s.integrationEditingId=a.dataset.id??null,y()})}),e.querySelector("[data-action='int-cancel']")?.addEventListener("click",()=>{s.integrationEditingId=null,y()}),e.querySelector("[data-action='int-save']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='int-save']")?.dataset.id??"",l=s.integrations.find(v=>v.id===a);if(!l)return;const o={...l.config};Object.keys(o).forEach(v=>{const _=e.querySelector(`#int-${v}`);_&&(o[v]=_.value)});const d=e.querySelector("#int-enabled")?.checked??!1,{saveIntegrationSetting:u,fetchIntegrationSettings:p}=await f(async()=>{const{saveIntegrationSetting:v,fetchIntegrationSettings:_}=await Promise.resolve().then(()=>$);return{saveIntegrationSetting:v,fetchIntegrationSettings:_}},void 0);await u({...l,config:o,isEnabled:d})?(s.integrations=await p(),s.integrationEditingId=null,b("保存しました"),y()):b("保存失敗","error")}),e.querySelectorAll("[data-action='int-sync-shopify'], [data-action='shopify-sync']").forEach(a=>{a.addEventListener("click",async()=>{const l=s.integrations.find(p=>p.provider==="shopify");if(!l){b("Shopify連携が未設定です","warning");return}a.textContent="同期中…",a.disabled=!0;const{syncShopifyOrders:o,fetchShopifyOrders:d}=await f(async()=>{const{syncShopifyOrders:p,fetchShopifyOrders:h}=await Promise.resolve().then(()=>$);return{syncShopifyOrders:p,fetchShopifyOrders:h}},void 0),u=await o(l);u.error?b("同期失敗: "+u.error,"error"):(b(`${u.count}件を同期しました`),s.shopifyOrders=await d()),y()})}),e.querySelectorAll("[data-action='int-sync-gcal']").forEach(a=>{a.addEventListener("click",async()=>{const l=s.integrations.find(p=>p.provider==="google_calendar");if(!l)return;a.textContent="同期中…",a.disabled=!0;const{syncGoogleCalendar:o,fetchCalendarEvents:d}=await f(async()=>{const{syncGoogleCalendar:p,fetchCalendarEvents:h}=await Promise.resolve().then(()=>$);return{syncGoogleCalendar:p,fetchCalendarEvents:h}},void 0),u=await o(l);u.error?b("同期失敗: "+u.error,"error"):(b(`${u.count}件を同期しました`),s.calendarEvents=await d(s.calendarYearMonth)),y()})}),e.querySelector("[data-action='fax-upload']")?.addEventListener("click",async()=>{const l=e.querySelector("#fax-file")?.files?.[0];if(!l){b("FAX画像を選択してください","warning");return}const o=s.integrations.find(d=>d.provider==="cloud_vision");if(!o||!o.config.api_key){b("Cloud Vision API Key が設定されていません。/integrations で設定してください","warning");return}s.faxProcessing=!0,s.faxOcrText=null,y();try{const d=new FileReader;d.onload=async()=>{const u=String(d.result??""),{ocrFaxImage:p,saveFaxRecord:h,fetchFaxInbox:v}=await f(async()=>{const{ocrFaxImage:L,saveFaxRecord:V,fetchFaxInbox:q}=await Promise.resolve().then(()=>$);return{ocrFaxImage:L,saveFaxRecord:V,fetchFaxInbox:q}},void 0),_=await p(o,u),A=e.querySelector("#fax-sender-name")?.value??"",k=e.querySelector("#fax-sender-phone")?.value??"";await h({id:`fax_${Date.now()}`,receivedAt:new Date().toISOString(),senderName:A,senderPhone:k,ocrStatus:_.error?"failed":"done",ocrText:_.text}),s.faxOcrText=_.error?`エラー: ${_.error}`:_.text,s.faxRecords=await v(),s.faxProcessing=!1,y()},d.readAsDataURL(l)}catch(d){b("OCR失敗: "+(d instanceof Error?d.message:""),"error"),s.faxProcessing=!1,y()}}),e.querySelector("[data-action='ms-new']")?.addEventListener("click",()=>{s.mailSenderEditingId="__new__",y()}),e.querySelectorAll("[data-action='ms-edit']").forEach(a=>{a.addEventListener("click",()=>{s.mailSenderEditingId=a.dataset.id??null,y()})}),e.querySelector("[data-action='ms-cancel']")?.addEventListener("click",()=>{s.mailSenderEditingId=null,y()}),e.querySelector("[data-action='ms-save']")?.addEventListener("click",async()=>{const a=e.querySelector("[data-action='ms-save']")?.dataset.id||`sender_${Date.now()}`,l={id:a,name:e.querySelector("#ms-name")?.value||"",email:e.querySelector("#ms-email")?.value||"",displayName:e.querySelector("#ms-display-name")?.value||"",replyTo:e.querySelector("#ms-reply-to")?.value||"",signature:e.querySelector("#ms-signature")?.value||"",isDefault:e.querySelector("#ms-default")?.checked??!1,isVerified:s.mailSenders.find(p=>p.id===a)?.isVerified??!1};if(!l.name||!l.email){b("名前とメールアドレスは必須です","warning");return}const{saveMailSender:o,fetchMailSenders:d}=await f(async()=>{const{saveMailSender:p,fetchMailSenders:h}=await Promise.resolve().then(()=>$);return{saveMailSender:p,fetchMailSenders:h}},void 0);await o(l)?(s.mailSenders=await d(),s.mailSenderEditingId=null,b("保存しました"),y()):b("保存に失敗しました","error")}),e.querySelectorAll("[data-action='ms-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=a.dataset.id??"",{deleteMailSender:o,fetchMailSenders:d}=await f(async()=>{const{deleteMailSender:p,fetchMailSenders:h}=await Promise.resolve().then(()=>$);return{deleteMailSender:p,fetchMailSenders:h}},void 0);await o(l)?(s.mailSenders=await d(),y()):b("削除失敗","error")})}),e.querySelectorAll("[data-action='cal-prev'], [data-action='cal-next'], [data-action='cal-today']").forEach(a=>{a.addEventListener("click",async()=>{s.calendarYearMonth=a.dataset.ym??s.calendarYearMonth;const{fetchCalendarEvents:l}=await f(async()=>{const{fetchCalendarEvents:o}=await Promise.resolve().then(()=>$);return{fetchCalendarEvents:o}},void 0);s.calendarEvents=await l(s.calendarYearMonth),y()})}),e.querySelector("#cal-month-input")?.addEventListener("change",async a=>{s.calendarYearMonth=a.target.value;const{fetchCalendarEvents:l}=await f(async()=>{const{fetchCalendarEvents:o}=await Promise.resolve().then(()=>$);return{fetchCalendarEvents:o}},void 0);s.calendarEvents=await l(s.calendarYearMonth),y()}),e.querySelector("#cal-filter-category")?.addEventListener("change",a=>{s.calendarFilterCategory=a.target.value,y()}),e.querySelector("[data-action='cal-new']")?.addEventListener("click",()=>{const a=new Date;s.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:new Date(a.getTime()+3600*1e3).toISOString(),isAllDay:!1}},y()}),e.querySelectorAll("[data-cal-date]").forEach(a=>{a.tagName!=="BUTTON"&&a.addEventListener("click",l=>{if(l.target.closest(".cal-event"))return;const o=a.dataset.calDate??"";s.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:`${o}T10:00:00`,isAllDay:!1}},y()})}),e.querySelectorAll("[data-cal-event-id]").forEach(a=>{a.addEventListener("click",l=>{l.stopPropagation();const o=a.dataset.calEventId,d=s.calendarEvents.find(u=>u.id===o);d&&(s.calendarEdit={isOpen:!0,isNew:!1,event:{...d}},y())})}),e.querySelectorAll("[data-action='cal-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.calendarEdit=null,y())})}),e.querySelector("[data-action='cal-save']")?.addEventListener("click",async()=>{if(!s.calendarEdit)return;const{saveCalendarEvent:a,fetchCalendarEvents:l,CALENDAR_CATEGORY_COLORS:o}=await f(async()=>{const{saveCalendarEvent:v,fetchCalendarEvents:_,CALENDAR_CATEGORY_COLORS:A}=await Promise.resolve().then(()=>$);return{saveCalendarEvent:v,fetchCalendarEvents:_,CALENDAR_CATEGORY_COLORS:A}},void 0),d=document.querySelector("[data-action='cal-save']")?.dataset.id||s.calendarEdit.event.id||`evt_${Date.now()}`,u=e.querySelector("#cal-category")?.value??"general",p={id:d,title:e.querySelector("#cal-title")?.value??"",category:u,startsAt:new Date(e.querySelector("#cal-starts")?.value??new Date().toISOString()).toISOString(),endsAt:e.querySelector("#cal-ends")?.value?new Date(e.querySelector("#cal-ends").value).toISOString():void 0,isAllDay:e.querySelector("#cal-allday")?.checked??!1,location:e.querySelector("#cal-location")?.value??"",relatedCustomerCode:e.querySelector("#cal-customer")?.value??"",description:e.querySelector("#cal-description")?.value??"",color:o[u]};if(!p.title){b("タイトルは必須です","warning");return}await a(p)?(s.calendarEvents=await l(s.calendarYearMonth),s.calendarEdit=null,b("保存しました"),y()):b("保存失敗","error")}),e.querySelector("[data-action='cal-delete']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='cal-delete']")?.dataset.id??"";if(!a||!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deleteCalendarEvent:l,fetchCalendarEvents:o}=await f(async()=>{const{deleteCalendarEvent:u,fetchCalendarEvents:p}=await Promise.resolve().then(()=>$);return{deleteCalendarEvent:u,fetchCalendarEvents:p}},void 0);await l(a)?(s.calendarEvents=await o(s.calendarYearMonth),s.calendarEdit=null,b("削除しました"),y()):b("削除失敗","error")}),e.querySelector("[data-action='import-execute']")?.addEventListener("click",async()=>{if(s.importPreview){s.importing=!0,y();try{const a=s.importPreview.rows.filter(o=>o._valid),l=await Ul(s.importEntity,a);s.importResult=`取り込み完了: ${l.inserted}件成功 / ${l.failed}件失敗`,s.importPreview=null}catch(a){s.importResult=`エラー: ${a instanceof Error?a.message:String(a)}`}finally{s.importing=!1,y()}}}),e.querySelector("[data-action='store-load']")?.addEventListener("click",()=>{const a=e.querySelector("#store-date")?.value??s.storeSalesDate;s.storeSalesDate=a,s.storeSales=[],s.actionLoading=!0,y(),kt(a).then(l=>{s.storeSales=l,s.actionLoading=!1,y()})}),e.querySelectorAll("[data-action='copy-config']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.configValue??"";if(l)try{await navigator.clipboard.writeText(l),a.textContent="コピー済み",window.setTimeout(()=>{a.textContent="コピー"},1600)}catch(o){console.warn("Clipboard copy failed",o)}})}),e.querySelector("[data-action='download-relay-config']")?.addEventListener("click",()=>{const l=JSON.stringify({supabase_url:z,supabase_anon_key:j,z_drive_path:"Z:\\",sync_modules:["sk","sh","k5","h5"],interval_minutes:5,use_odbc:!1,odbc_dsn:"MagicSake",log_level:"INFO"},null,2),o=new Blob([l],{type:"application/json;charset=utf-8"}),d=URL.createObjectURL(o),u=document.createElement("a");u.href=d,u.download="relay_config.json",u.click(),URL.revokeObjectURL(d)}),e.querySelectorAll("[data-action='copy-code']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.code??"";if(l)try{await navigator.clipboard.writeText(decodeURIComponent(l)),a.textContent="コピー済み",window.setTimeout(()=>{a.textContent="コピー"},1600)}catch(o){console.warn("Clipboard code copy failed",o)}})}),e.querySelectorAll("input[name='email-audience-mode']").forEach(a=>{a.addEventListener("change",()=>{ie(e),s.emailSaveMessage=null,y()})}),e.querySelectorAll("#email-region, #email-history-segment").forEach(a=>{a.addEventListener("change",()=>{ie(e),s.emailSaveMessage=null,y()})}),e.querySelector("#email-subject")?.addEventListener("input",()=>{ie(e),s.emailSaveMessage=null}),e.querySelector("#email-body")?.addEventListener("input",()=>{ie(e),s.emailSaveMessage=null}),e.querySelectorAll("[data-action='template-select']").forEach(a=>{a.addEventListener("click",()=>{s.emailTemplateId=a.dataset.templateId??"custom";const l=ns(s.emailTemplateId);s.emailSubject=l.subject,s.emailBody=l.body,s.emailSaveMessage=null,y()})}),e.querySelector("[data-action='email-insert-link']")?.addEventListener("click",()=>{ie(e);const a=`

商品詳細はこちら: https://kaneishuzo.co.jp/products`;s.emailBody.includes("https://kaneishuzo.co.jp/products")||(s.emailBody=`${s.emailBody.trimEnd()}${a}`),s.emailSaveMessage=null,y()}),e.querySelector("[data-action='email-save']")?.addEventListener("click",()=>{ie(e),s.actionLoading=!0,y(),Me(it("draft")).then(a=>{s.emailSaveMessage=`下書きを保存しました。${new Intl.DateTimeFormat("ja-JP",{month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(a.updatedAt??new Date().toISOString()))}`,s.actionLoading=!1,y()})}),e.querySelector("#email-sender")?.addEventListener("change",a=>{s.emailSenderId=a.target.value}),e.querySelector("[data-action='email-send']")?.addEventListener("click",()=>{ie(e),s.actionLoading=!0,s.emailSending=!0,y();const a=it("sent");s.mailSenders.find(l=>l.id===s.emailSenderId),Oa().then(async l=>{await Me({...a,recipientCount:l.sent}),s.emailSaveMessage=`${l.sent.toLocaleString("ja-JP")} 件送信しました。`,s.actionLoading=!1,s.emailSending=!1,y(),b(`${l.sent}件送信完了`)}).catch(async()=>{await Me(it("draft")),s.emailSaveMessage="APIキー未設定のため下書きを保存しました。",s.actionLoading=!1,s.emailSending=!1,y(),b("APIキー未設定のため下書き保存しました","warning")})})}function y(){const e=document.querySelector("#app");if(!e)return;e.innerHTML=wo(),xo(e),s.pickerMode&&e.querySelector("#modal-search")?.focus(),s.globalSearchOpen&&e.querySelector("#global-search-input")?.focus(),Lt()&&e.querySelector("#auth-email")?.focus(),requestAnimationFrame(()=>{for(const n of["fd-scaler","print-scaler"]){const i=e.querySelector(`#${n}`),r=i?.querySelector(".fd-canvas, .print-preview"),c=r?.querySelector(".print-page")??r;if(!i||!c)continue;const a=i.parentElement?.clientWidth??0,l=c.offsetWidth;if(a>0&&l>0&&l>a-24){const o=(a-24)/l;i.style.transform=`scale(${o})`,i.style.transformOrigin="top left",i.style.height=`${(c.offsetHeight+48)*o}px`}else i.style.transform="",i.style.height=""}});const t=s.sidebarOpen||s.pickerMode!==null||s.globalSearchOpen;document.body.style.overflow=t?"hidden":"",document.body.style.touchAction=t?"none":""}const us="sake-cloud-cache",Ao=1800*1e3;function Eo(){try{const e={ts:Date.now(),salesSummary:s.salesSummary,paymentStatus:s.paymentStatus,masterStats:s.masterStats,pipelineMeta:s.pipelineMeta,salesAnalytics:s.salesAnalytics};localStorage.setItem(us,JSON.stringify(e))}catch{}}function Co(){try{const e=localStorage.getItem(us);if(!e)return!1;const t=JSON.parse(e);return Date.now()-t.ts>Ao?!1:(t.salesSummary&&(s.salesSummary=t.salesSummary),t.paymentStatus&&(s.paymentStatus=t.paymentStatus),t.masterStats&&(s.masterStats=t.masterStats),t.pipelineMeta&&(s.pipelineMeta=t.pipelineMeta),t.salesAnalytics&&(s.salesAnalytics=t.salesAnalytics),!0)}catch{return!1}}async function ke(){const e=Co();e&&(s.loading=!1,y()),s.loading=!e,e||y();try{const[t,n,i,r,c,a,l,o]=await Promise.all([da(),ua(),pa(),ma(),Be(s.invoiceFilter),gt(s.ledgerCustomerCode),ya(),ha()]);if(s.salesSummary=t,s.paymentStatus=n,s.masterStats=i,s.pipelineMeta=r,s.invoiceRecords=c,s.customerLedger=a,s.salesAnalytics=l,s.syncDashboard=o,fa().then(d=>{s.announcements=d,y()}),pe.length===0&&io(),s.rawTableList.length===0&&Ja().then(d=>{s.rawTableList=d,s.route==="/raw-browser"&&y()}),!s.salesFilter.startDate||!s.salesFilter.endDate){const u=[...t.salesRecords].sort((v,_)=>new Date(_.date).getTime()-new Date(v.date).getTime())[0]?.date??new Date().toISOString(),p=new Date(u),h=new Date(p);h.setDate(p.getDate()-30),s.salesFilter={startDate:aa(h.toISOString()),endDate:aa(p.toISOString())}}(!s.invoiceFilter.startDate||!s.invoiceFilter.endDate)&&(s.invoiceFilter={...s.invoiceFilter,startDate:s.salesFilter.startDate,endDate:s.salesFilter.endDate},s.invoiceRecords=await Be(s.invoiceFilter)),s.error=null,Eo()}catch(t){e||(s.error=t instanceof Error?t.message:"データの取得に失敗しました。")}finally{s.loading=!1,y(),It(s.route)}}window.addEventListener("popstate",()=>{s.route=is(location.pathname),s.currentCategory=Ct(s.route),s.sidebarOpen=!1,Se(),It(s.route)});window.addEventListener("keydown",e=>{if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="k"){e.preventDefault(),s.globalSearchOpen=!0,y();return}if(e.key==="Escape"){if(s.globalSearchOpen){Se(),y();return}if(s.pickerMode){Ue(),y();return}s.route==="/invoice-entry"&&!s.invoiceSaving&&(ls(),y());return}if(s.route==="/invoice-entry"&&!s.invoiceSaving&&(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault();const t=document.querySelector("#app");t&&rs(t)}});s.user=He()?bs():null;s.user?.email&&(async()=>{const{fetchMyProfile:e}=await f(async()=>{const{fetchMyProfile:t}=await Promise.resolve().then(()=>$);return{fetchMyProfile:t}},void 0);s.myProfile=await e(s.user.email),y()})();try{const e=localStorage.getItem("sake_print_options");e&&(s.printOptions={...s.printOptions,...JSON.parse(e)});const t=localStorage.getItem("sake_print_company");t&&(s.printCompany={...s.printCompany,...JSON.parse(t)});const n=localStorage.getItem("sake_fd_positions");n&&(s.fdSavedPositions=JSON.parse(n))}catch{}(function(){let t=null,n=0,i=0,r=0,c=0,a=1;document.addEventListener("mousedown",l=>{const o=l.target.closest(".fd-draggable");if(!o||!s.fdDesignMode)return;l.preventDefault();const d=o.closest(".fd-canvas");if(!d)return;const u=d.getBoundingClientRect();if(u.width===0)return;a=228.6/u.width,t=o,n=l.clientX,i=l.clientY,r=parseFloat(o.style.left)||0,c=parseFloat(o.style.top)||0,document.querySelectorAll(".fd-active").forEach(_=>_.classList.remove("fd-active")),o.classList.add("fd-active","fd-dragging"),s.fdActiveFieldId=o.dataset.fdId??null;const p=document.querySelector("#fd-selected-info");p&&(p.textContent=`選択中: ${o.title}`);const h=document.querySelector("#fd-sel-x"),v=document.querySelector("#fd-sel-y");h&&(h.value=String(r)),v&&(v.value=String(c))}),document.addEventListener("mousemove",l=>{if(!t)return;const o=(l.clientX-n)*a,d=(l.clientY-i)*a,u=Math.round((r+o)*2)/2,p=Math.round((c+d)*2)/2;t.style.left=u+"mm",t.style.top=p+"mm";const h=document.querySelector("#fd-sel-x"),v=document.querySelector("#fd-sel-y");h&&(h.value=String(u)),v&&(v.value=String(p))}),document.addEventListener("mouseup",()=>{t&&(t.classList.remove("fd-dragging"),t=null)}),document.addEventListener("keydown",l=>{if(!s.fdDesignMode||!s.fdActiveFieldId||l.key!=="ArrowLeft"&&l.key!=="ArrowRight"&&l.key!=="ArrowUp"&&l.key!=="ArrowDown"||l.target.tagName==="INPUT"||l.target.tagName==="TEXTAREA")return;const o=document.querySelector(`[data-fd-id="${s.fdActiveFieldId}"]`);if(!o)return;l.preventDefault();const d=.5;let u=parseFloat(o.style.left)||0,p=parseFloat(o.style.top)||0;l.key==="ArrowLeft"?u-=d:l.key==="ArrowRight"?u+=d:l.key==="ArrowUp"?p-=d:l.key==="ArrowDown"&&(p+=d),o.style.left=u+"mm",o.style.top=p+"mm";const h=document.querySelector("#fd-sel-x"),v=document.querySelector("#fd-sel-y");h&&(h.value=String(u)),v&&(v.value=String(p))})})();function ps(e){const t=window.google?.maps;if(!t){e.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-secondary);">Google Maps 読込中…</div>',setTimeout(()=>ps(e),500);return}e.innerHTML="";const n=new t.Map(e,{center:{lat:35.45,lng:139.4},zoom:10,mapId:"sake-system-map",gestureHandling:"greedy"}),i=new t.InfoWindow;function r(c,a,l,o,d){const u=new t.marker.AdvancedMarkerElement({map:n,position:{lat:c,lng:a},content:(()=>{const p=document.createElement("div");return p.style.cssText=`background:${l};color:white;border-radius:50%;width:28px;height:28px;display:flex;align-items:center;justify-content:center;border:2px solid white;box-shadow:0 2px 6px rgba(0,0,0,0.3);font-weight:700;font-size:11px;cursor:pointer;`,p.textContent=o,p})()});u.addListener("click",()=>{i.setContent(d),i.open({anchor:u,map:n})})}s.mapFilters.showCustomers&&(s.masterStats?.customers??[]).forEach(a=>{!a.lat||!a.lng||s.mapFilters.filterBusinessType&&a.businessType!==s.mapFilters.filterBusinessType||r(a.lat,a.lng,"#2196F3","既",`<div style="min-width:180px;"><strong>${a.name}</strong><br/><span style="color:#666;font-size:11px;">${a.code}</span><br/>既存取引先<br/>締日${a.closingDay}日 / 支払日${a.paymentDay}日${a.address1?`<br/>${a.address1}`:""}</div>`)}),s.mapFilters.showProspects&&s.prospects.forEach(c=>{if(!c.lat||!c.lng||s.mapFilters.filterBusinessType&&c.businessType!==s.mapFilters.filterBusinessType)return;const a=c.stage==="hot"||c.stage==="negotiating"?"#EF5350":c.stage==="won"?"#66BB6A":"#4CAF50";r(c.lat,c.lng,a,"新",`<div style="min-width:200px;"><strong>${c.companyName}</strong><br/><span style="color:#666;font-size:11px;">${c.contactName??""}</span><br/>新規見込客 (${c.stage})<br/>想定 ¥${c.expectedAmount.toLocaleString("ja-JP")} / 確度 ${c.probability}%${c.nextAction?`<br/>${c.nextAction}`:""}</div>`)}),s.mapFilters.showDelivery&&s.deliveryLocations.forEach(c=>{!c.lat||!c.lng||r(c.lat,c.lng,"#FF9800","納",`<div style="min-width:180px;"><strong>${c.name}</strong><br/>納品先${c.customerCode?` (${c.customerCode})`:""}<br/>${c.address??""}${c.contactName?`<br/>${c.contactName}`:""}${c.deliveryNote?`<br/>${c.deliveryNote}`:""}</div>`)})}ke();const Lo=300*1e3;setInterval(()=>{s.route==="/"&&!s.loading&&!document.hidden&&ke()},Lo);let ht="";fetch(`${location.origin}/index.html?_t=${Date.now()}`).then(e=>e.text()).then(e=>{ht=e}).catch(()=>{});setInterval(async()=>{if(!(!ht||document.hidden))try{await(await fetch(`${location.origin}/index.html?_t=${Date.now()}`)).text()!==ht&&!s.updateAvailable&&(s.updateAvailable=!0,y())}catch{}},120*1e3);
