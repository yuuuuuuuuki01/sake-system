(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const c of r)if(c.type==="childList")for(const a of c.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const c={};return r.integrity&&(c.integrity=r.integrity),r.referrerPolicy&&(c.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?c.credentials="include":r.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(r){if(r.ep)return;r.ep=!0;const c=n(r);fetch(r.href,c)}})();const hs="modulepreload",vs=function(e){return"/"+e},Lt={},f=function(t,n,i){let r=Promise.resolve();if(n&&n.length>0){let d=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};var a=d;document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),o=l?.nonce||l?.getAttribute("nonce");r=d(n.map(u=>{if(u=vs(u),u in Lt)return;Lt[u]=!0;const p=u.endsWith(".css"),y=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${y}`))return;const v=document.createElement("link");if(v.rel=p?"stylesheet":hs,p||(v.as="script"),v.crossOrigin="",v.href=u,o&&v.setAttribute("nonce",o),document.head.appendChild(v),p)return new Promise(($,E)=>{v.addEventListener("load",$),v.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${u}`)))})}))}function c(l){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=l,window.dispatchEvent(o),!o.defaultPrevented)throw l}return r.then(l=>{for(const o of l||[])o.status==="rejected"&&c(o.reason);return t().catch(c)})},V="https://loarwnuyvfxiscjjsmiz.supabase.co",j="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";async function Ye(e,t){try{const n=new URL(`/rest/v1/${e}`,V),i=await fetch(n.toString(),{method:"POST",headers:{apikey:j,Authorization:`Bearer ${j}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(t)});if(!i.ok)throw new Error(`HTTP ${i.status}`);return(await i.json())[0]??null}catch(n){return console.warn(`Failed to insert into Supabase table ${e}`,n),null}}async function ht(e,t,n){try{const i=new URL(`/rest/v1/${e}?id=eq.${t}`,V);return(await fetch(i.toString(),{method:"PATCH",headers:{apikey:j,Authorization:`Bearer ${j}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(n)})).ok}catch{return!1}}async function ia(e,t={}){try{const n=new URL(`/rest/v1/rpc/${e}`,V),i=await fetch(n.toString(),{method:"POST",headers:{apikey:j,Authorization:`Bearer ${j}`,"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()}catch(n){return console.warn(`Failed to call Supabase RPC ${e}`,n),null}}async function vt(e){try{const t=new URL(`/rest/v1/${e}`,V);t.searchParams.set("select","*"),t.searchParams.set("limit","0");const n=await fetch(t.toString(),{method:"GET",headers:{apikey:j,Authorization:`Bearer ${j}`,Accept:"application/json",Prefer:"count=exact"}});if(!n.ok)return 0;const i=n.headers.get("Content-Range");if(i){const r=i.match(/\/(\d+)/);if(r)return parseInt(r[1],10)}return 0}catch{return 0}}async function S(e,t={}){try{const n=new URL(`/rest/v1/${e}`,V);Object.entries(t).forEach(([r,c])=>{n.searchParams.set(r,c)});const i=await fetch(n.toString(),{method:"GET",headers:{apikey:j,Authorization:`Bearer ${j}`,Accept:"application/json",Prefer:"return=representation"}});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()}catch(n){return console.warn(`Failed to query Supabase table ${e}`,n),[]}}async function K(e,t={},n=1e3){const i=[];let r=0;try{for(;;){const c=new URL(`/rest/v1/${e}`,V);Object.entries(t).forEach(([o,d])=>{c.searchParams.set(o,d)}),c.searchParams.set("limit",String(n)),c.searchParams.set("offset",String(r));const a=await fetch(c.toString(),{method:"GET",headers:{apikey:j,Authorization:`Bearer ${j}`,Accept:"application/json",Prefer:"return=representation"}});if(!a.ok)throw new Error(`HTTP ${a.status}`);const l=await a.json();if(i.push(...l),l.length<n)break;r+=n}return i}catch(c){return console.warn(`Failed to query all rows from Supabase table ${e}`,c),i.length>0?i:[]}}const q=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:j,SUPABASE_URL:V,supabaseCount:vt,supabaseInsert:Ye,supabaseQuery:S,supabaseQueryAll:K,supabaseRpc:ia,supabaseUpdate:ht},Symbol.toStringTag,{value:"Module"})),ft="sake_auth";function la(e){localStorage.setItem(ft,JSON.stringify(e))}function oa(){return{apikey:j,"Content-Type":"application/json"}}function fs(e){try{const[,t]=e.split(".");if(!t)return null;const n=t.replaceAll("-","+").replaceAll("_","/"),i=n.padEnd(Math.ceil(n.length/4)*4,"=");return JSON.parse(atob(i))}catch{return null}}async function ra(e,t){const n=await fetch(`${V}/auth/v1/${e}`,{method:"POST",headers:oa(),body:JSON.stringify(t)}),i=await n.json().catch(()=>({}));if(!n.ok)throw new Error(i.error_description??i.msg??`HTTP ${n.status}`);return i}async function bs(e,t){const n=await ra("token?grant_type=password",{email:e,password:t});return la({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??e}}async function Dt(e,t){const n=await ra("signup",{email:e,password:t});return n.access_token&&n.refresh_token&&la({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??e}}async function gs(){const e=He();if(localStorage.removeItem(ft),!!e?.access_token)try{await fetch(`${V}/auth/v1/logout`,{method:"POST",headers:{...oa(),Authorization:`Bearer ${e.access_token}`}})}catch(t){console.warn("Supabase sign out failed",t)}}function He(){const e=localStorage.getItem(ft);if(!e)return null;try{const t=JSON.parse(e);return!t.access_token||!t.refresh_token?null:{access_token:t.access_token,refresh_token:t.refresh_token}}catch{return null}}function $s(){const e=He();if(!e)return null;const t=fs(e.access_token),n=typeof t?.email=="string"?t.email:null;return n?{email:n}:null}async function _s(e){const t=He();if(!t)throw new Error("not signed in");const n=await fetch(`${V}/auth/v1/user`,{method:"PUT",headers:{apikey:j,Authorization:`Bearer ${t.access_token}`,"Content-Type":"application/json"},body:JSON.stringify({password:e})});if(!n.ok){const i=await n.json().catch(()=>({}));throw new Error(i.msg??`HTTP ${n.status}`)}}const bt={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
`)+`
`}function Fs(e){const t=e.rows.map(r=>{const c=Math.max(0,r.productionVolume+r.previousBalance+r.currentAdjustment-r.exportDeduction-r.sampleDeduction),a=Math.round(c*r.taxRate);return{...r,taxableVolume:c,volume:c,taxAmount:a}}),n=t.reduce((r,c)=>r+c.taxableVolume,0),i=t.reduce((r,c)=>r+c.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:i}}async function Bs(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>q);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:Ra(e),submitted_at:e.submittedAt})}async function kt(e){const t=await S("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(n=>({id:m(n,["id"],""),saleDate:m(n,["sale_date"],e),saleTime:m(n,["sale_time"],""),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),quantity:g(n,["quantity"],0),unitPrice:g(n,["unit_price"],0),amount:g(n,["amount"],0),paymentMethod:m(n,["payment_method"],"cash")})):[]}async function Oa(){const e=await S("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),orderDate:O(t,["order_date"],""),customerName:m(t,["customer_name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["shipping_address"],""),items:[],totalAmount:g(t,["total_amount"],0),status:m(t,["status"],"new"),shippingDate:O(t,["shipping_date"],"")})):[]}async function Me(e){const t=await Ye("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function ja(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function zs(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await S("print_layouts",t)).map(i=>({id:m(i,["id"],""),name:m(i,["name"],""),templateKey:m(i,["template_key"],""),positions:i.positions??{},isDefault:B(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}))}async function Vs(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:r}=await Promise.resolve().then(()=>q);return{supabaseInsert:r}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},i=await t("print_layouts",n);return i?{id:m(i,["id"],e.id),name:m(i,["name"],e.name),templateKey:m(i,["template_key"],e.templateKey),positions:i.positions??e.positions,isDefault:B(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}:null}async function Js(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function Us(){return(await S("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),signature:m(t,["signature"],""),replyTo:m(t,["reply_to"],""),isDefault:B(t,["is_default"],!1),isVerified:B(t,["is_verified"],!1),note:m(t,["note"],"")}))}async function Ys(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:m(n,["id"],e.id),name:m(n,["name"],e.name),email:m(n,["email"],e.email),displayName:m(n,["display_name"],""),signature:m(n,["signature"],""),replyTo:m(n,["reply_to"],""),isDefault:B(n,["is_default"],!1),isVerified:B(n,["is_verified"],!1)}:null}async function Hs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const St={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},xt={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Gs(e){const t=`${e}-01T00:00:00Z`,[n,i]=e.split("-").map(l=>parseInt(l,10)),r=new Date(n,i,0).getDate(),c=`${e}-${String(r).padStart(2,"0")}T23:59:59Z`;return(await S("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${c})`,order:"starts_at.asc"})).map(l=>({id:m(l,["id"],""),title:m(l,["title"],""),description:m(l,["description"],""),category:m(l,["category"],"general")||"general",startsAt:m(l,["starts_at"],new Date().toISOString()),endsAt:m(l,["ends_at"],""),isAllDay:B(l,["is_all_day"],!1),location:m(l,["location"],""),attendees:l.attendees??[],relatedCustomerCode:m(l,["related_customer_code"],""),relatedOrderId:m(l,["related_order_id"],""),color:m(l,["color"],""),googleEventId:m(l,["google_event_id"],"")}))}async function Xs(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??xt[e.category],updated_at:new Date().toISOString()})?e:null}async function Qs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Ma(){return(await S("integration_settings",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),provider:m(t,["provider"],""),config:t.config??{},isEnabled:B(t,["is_enabled"],!1),lastSyncAt:m(t,["last_sync_at"],""),lastStatus:m(t,["last_status"],"")}))}async function xe(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function Ws(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const i=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,r=await fetch(i,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const c=await r.json(),{supabaseInsert:a}=await f(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>q);return{supabaseInsert:o}},void 0);let l=0;for(const o of c.orders){const d=`shopify_${o.id}`;await a("shopify_orders",{id:d,shopify_order_id:String(o.id),order_number:String(o.order_number??""),order_date:String(o.created_at??new Date().toISOString()),customer_name:String(o.customer?.first_name??"")+" "+String(o.customer?.last_name??""),customer_email:String(o.customer?.email??""),total_amount:Math.round(parseFloat(String(o.total_price??"0"))),financial_status:String(o.financial_status??""),fulfillment_status:String(o.fulfillment_status??"unfulfilled"),line_items:o.line_items??[],shipping_address:o.shipping_address??null,raw_payload:o}),l++}return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${l}件取得成功`}),{count:l}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Ks(){return(await S("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),shopifyOrderId:m(t,["shopify_order_id"],""),orderNumber:m(t,["order_number"],""),orderDate:m(t,["order_date"],""),customerName:m(t,["customer_name"],""),customerEmail:m(t,["customer_email"],""),totalAmount:C(t.total_amount),financialStatus:m(t,["financial_status"],""),fulfillmentStatus:m(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function Zs(e){const t=e.config.refresh_token,n=e.config.client_id,i=e.config.client_secret;if(!t||!n||!i)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const r=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:n,client_secret:i})});if(!r.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${r.status}`};const a=(await r.json()).access_token;return await xe({...e,config:{...e.config,oauth_token:a}}),e.config.oauth_token=a,{token:a}}async function en(e){let t=e.config.oauth_token;const n=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const i=new Date().toISOString(),r=new Date(Date.now()+30*86400*1e3).toISOString(),c=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${i}&timeMax=${r}&singleEvents=true&orderBy=startTime`;let a=await fetch(c,{headers:{Authorization:`Bearer ${t}`}});if(a.status===401){const u=await Zs(e);if(u.error)return{count:0,error:u.error};t=u.token,a=await fetch(c,{headers:{Authorization:`Bearer ${t}`}})}if(!a.ok)return{count:0,error:`HTTP ${a.status}`};const l=await a.json(),{supabaseInsert:o}=await f(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>q);return{supabaseInsert:u}},void 0);let d=0;for(const u of l.items){const p=`gcal_${u.id}`,y=u.start?.dateTime??u.start?.date??"",v=u.end?.dateTime??u.end?.date??"";await o("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(y),ends_at:String(v),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),d++}return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${d}件取得`}),{count:d}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function tn(){return(await S("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),receivedAt:m(t,["received_at"],""),senderPhone:m(t,["sender_phone"],""),senderName:m(t,["sender_name"],""),imageUrl:m(t,["image_url"],""),ocrStatus:m(t,["ocr_status"],"pending")||"pending",ocrText:m(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:m(t,["linked_invoice_id"],"")}))}async function an(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const i=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,r=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return r.ok?{text:(await r.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${r.status}`}}catch(i){return{text:"",error:i instanceof Error?i.message:String(i)}}}async function sn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const ze={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Ve={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function nn(){return(await S("user_profiles",{order:"display_name.asc"})).map(t=>({id:m(t,["id"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),staffCode:m(t,["staff_code"],""),department:m(t,["department"],"all")||"all",role:m(t,["role"],"staff")||"staff",defaultMailSenderId:m(t,["default_mail_sender_id"],""),phone:m(t,["phone"],""),avatarUrl:m(t,["avatar_url"],""),isActive:B(t,["is_active"],!0),lastSignInAt:m(t,["last_sign_in_at"],""),createdAt:m(t,["created_at"],"")}))}async function ln(e){if(!e)return null;const t=await S("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:m(n,["id"],""),email:m(n,["email"],""),displayName:m(n,["display_name"],""),staffCode:m(n,["staff_code"],""),department:m(n,["department"],"all")||"all",role:m(n,["role"],"staff")||"staff",defaultMailSenderId:m(n,["default_mail_sender_id"],""),phone:m(n,["phone"],""),avatarUrl:m(n,["avatar_url"],""),isActive:B(n,["is_active"],!0),lastSignInAt:m(n,["last_sign_in_at"],"")}}async function on(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function rn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function cn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>q);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function dn(e=100){return(await S("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),action:m(n,["action"],""),entityType:m(n,["entity_type"],""),entityId:m(n,["entity_id"],""),userEmail:m(n,["user_email"],""),changes:n.changes??{},createdAt:m(n,["created_at"],"")}))}const Je={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function Fa(){return(await S("slack_notifications",{order:"event_type.asc"})).map(t=>({id:m(t,["id"],""),eventType:m(t,["event_type"],"new_order"),enabled:B(t,["enabled"],!0),channel:m(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:m(t,["last_triggered_at"],"")}))}async function un(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function pn(e=50){return(await S("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),eventType:m(n,["event_type"],""),channel:m(n,["channel"],""),message:m(n,["message"],""),status:m(n,["status"],"sent"),error:m(n,["error"],""),sentAt:m(n,["sent_at"],"")}))}async function mn(e,t,n){const r=(await Ma()).find(d=>d.provider==="slack");if(!r||!r.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const c=r.config.webhook_url;if(!c)return{ok:!1,error:"Webhook URL未設定"};const l=(await Fa()).find(d=>d.eventType===e&&d.enabled);if(!l)return{ok:!1,error:"通知ルールが無効"};const o=n??l.channel??r.config.default_channel??"#general";try{const d=await fetch(c,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${Je[e]} ${t}`,channel:o})}),u=d.ok,{supabaseInsert:p}=await f(async()=>{const{supabaseInsert:y}=await Promise.resolve().then(()=>q);return{supabaseInsert:y}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:o,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${d.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${d.status}`}}catch(d){return{ok:!1,error:d instanceof Error?d.message:String(d)}}}const Ae={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Xe={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function yn(){return(await S("prospects",{order:"updated_at.desc"})).map(t=>({id:m(t,["id"],""),companyName:m(t,["company_name"],""),contactName:m(t,["contact_name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),address:m(t,["address"],""),website:m(t,["website"],""),businessType:m(t,["business_type"],""),stage:m(t,["stage"],"cold"),source:m(t,["source"],""),expectedAmount:C(t.expected_amount),probability:C(t.probability),assignedStaffCode:m(t,["assigned_staff_code"],""),nextActionDate:m(t,["next_action_date"],""),nextAction:m(t,["next_action"],""),note:m(t,["note"],""),lastContactAt:m(t,["last_contact_at"],""),wonAt:m(t,["won_at"],""),lostAt:m(t,["lost_at"],""),lostReason:m(t,["lost_reason"],""),convertedCustomerCode:m(t,["converted_customer_code"],""),createdAt:m(t,["created_at"],"")}))}async function Ba(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function hn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function vn(e){return(await S("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:m(n,["id"],""),prospectId:m(n,["prospect_id"],""),activityType:m(n,["activity_type"],"call"),title:m(n,["title"],""),description:m(n,["description"],""),activityDate:m(n,["activity_date"],""),result:m(n,["result"],""),staffCode:m(n,["staff_code"],"")}))}async function fn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const za=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function bn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function gn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function $n(){return(await S("delivery_locations",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),customerCode:m(t,["customer_code"],""),name:m(t,["name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:m(t,["contact_name"],""),phone:m(t,["phone"],""),deliveryNote:m(t,["delivery_note"],""),isActive:B(t,["is_active"],!0)}))}async function _n(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function wn(e=50){return(await S("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),callDirection:m(n,["call_direction"],"inbound"),fromNumber:m(n,["from_number"],""),toNumber:m(n,["to_number"],""),matchedCustomerCode:m(n,["matched_customer_code"],""),matchedProspectId:m(n,["matched_prospect_id"],""),durationSeconds:C(n.duration_seconds),callStatus:m(n,["call_status"],"answered"),recordingUrl:m(n,["recording_url"],""),transcript:m(n,["transcript"],""),ivryCallId:m(n,["ivry_call_id"],""),startedAt:m(n,["started_at"],""),endedAt:m(n,["ended_at"],""),notes:m(n,["notes"],"")}))}async function Va(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function kn(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const i=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,r=await fetch(i,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const a=(await r.json()).calls??[];let l=0;for(const o of a)await Va({id:`ivry_${o.id}`,callDirection:String(o.direction??"inbound"),fromNumber:String(o.from??""),toNumber:String(o.to??""),durationSeconds:Number(o.duration??0),callStatus:String(o.status??"answered"),recordingUrl:String(o.recording_url??""),startedAt:String(o.started_at??""),endedAt:String(o.ended_at??""),ivryCallId:String(o.id??"")}),l++;return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${l}件取得`}),{count:l}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Sn(e,t){const n=e.config.api_key,i=e.config.team_id;if(!n||!i)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let r=0;for(const c of t){if(!c.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${i}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:c.name,phone_number:c.phone,external_id:c.customerCode??"",note:c.note??""})})).ok&&r++}return{synced:r}}catch(r){return{synced:0,error:r instanceof Error?r.message:String(r)}}}async function xn(){return(await S("lead_lists",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),query:m(t,["query"],""),area:m(t,["area"],""),businessType:m(t,["business_type"],""),totalCount:C(t.total_count),source:m(t,["source"],"manual"),createdAt:m(t,["created_at"],"")}))}async function An(e){return(await S("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:m(n,["id"],""),listId:m(n,["list_id"],""),companyName:m(n,["company_name"],""),address:m(n,["address"],""),phone:m(n,["phone"],""),website:m(n,["website"],""),email:m(n,["email"],""),businessType:m(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:C(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:m(n,["place_id"],""),status:m(n,["status"],"new"),convertedProspectId:m(n,["converted_prospect_id"],""),note:m(n,["note"],"")}))}async function En(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function Ja(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function Pn(e,t,n){const i=e.config.api_key;if(!i)return{results:[],error:"Google Maps API key 未設定"};const r=`${t} ${n}`.trim(),c=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(r)}&language=ja&key=${i}`;try{const a=await fetch(c);if(!a.ok)return{results:[],error:`HTTP ${a.status}`};const l=await a.json();return l.status!=="OK"&&l.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${l.status}`}:{results:l.results.map(d=>{const u=d.geometry?.location;return{id:`place_${d.place_id}`,listId:"",companyName:String(d.name??""),address:String(d.formatted_address??""),rating:d.rating?Number(d.rating):void 0,reviewCount:d.user_ratings_total?Number(d.user_ratings_total):void 0,lat:u?.lat,lng:u?.lng,placeId:String(d.place_id??""),status:"new"}})}}catch(a){return{results:[],error:a instanceof Error?a.message:String(a)}}}async function Cn(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await Ba(t);return n&&await Ja({...e,status:"imported",convertedProspectId:t.id}),n}async function In(){return(await S("workflow_orders",{order:"order_date.desc"})).map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),customerName:m(t,["customer_name"],""),customerCode:m(t,["customer_code"],""),orderDate:m(t,["order_date"],""),deliveryDate:m(t,["delivery_date"],""),stage:m(t,["stage"],"new"),totalAmount:C(t.total_amount),itemCount:C(t.item_count),priority:m(t,["priority"],"normal"),staffName:m(t,["staff_name"],""),notes:m(t,["notes"],"")}))}async function Ln(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function Dn(){return(await S("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),visitDate:m(t,["visit_date"],""),partySize:C(t.party_size)||1,language:m(t,["language"],"ja"),purpose:m(t,["purpose"],""),message:m(t,["message"],""),status:m(t,["status"],"new"),repliedAt:m(t,["replied_at"],""),confirmedTime:m(t,["confirmed_time"],""),createdAt:m(t,["created_at"],new Date().toISOString())}))}async function qn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const Nn=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function Ua(){return(await Promise.all(Nn.map(async t=>{const[n,i]=await Promise.all([vt(t.table),S(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:i[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function Fe(e,t,n=100){const i=(t-1)*n,[r,c]=await Promise.all([S(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(i)}),vt(e)]);return{records:r,total:c}}async function ct(e){const t=await S("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const i=JSON.parse(n);return String(i.price_group??"")}catch{return""}return""}async function Ya(e,t){if(e){const i=await S("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(i.length>0&&i[0].special_price)return C(i[0].special_price)}const n=await S("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?C(n[0].default_sale_price):0}const w=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:xt,CALENDAR_CATEGORY_LABELS:St,DEPT_LABELS:Ve,INVOICE_TYPE_LABELS:lt,JIKOMI_STATUS_LABELS:Ea,MATERIAL_CATEGORIES:za,PROSPECT_STAGE_COLORS:Xe,PROSPECT_STAGE_LABELS:Ae,ROLE_LABELS:ze,SEASONAL_TEMPLATES:bt,SLACK_EVENT_LABELS:Je,TAX_DEDUCTION_LABELS:rt,TAX_RATE_CATEGORIES:Ta,convertLeadToProspect:Cn,deleteCalendarEvent:Qs,deleteMailSender:Hs,deleteMaterial:gn,deletePrintLayout:Js,deleteProspect:hn,deleteUserProfile:rn,fetchAnalyticsByPeriod:Cs,fetchAnnouncements:ba,fetchAuditLogs:dn,fetchAvailablePeriods:Is,fetchBillList:qa,fetchBillingSummary:_t,fetchCalendarEvents:Gs,fetchCallLogs:wn,fetchCustomerAnalysis:Aa,fetchCustomerEfficiency:xa,fetchCustomerLedger:gt,fetchCustomerPriceGroup:ct,fetchCustomerPricing:wa,fetchDeliveryLocations:$n,fetchDeliveryNote:$t,fetchDeliverySchedule:Ns,fetchFaxInbox:tn,fetchIntegrationSettings:Ma,fetchInvoices:Be,fetchJikomiList:Pa,fetchKenteiList:Ia,fetchLeadItems:An,fetchLeadLists:xn,fetchMailSenders:Us,fetchMasterStats:pa,fetchMaterialList:ot,fetchMyProfile:ln,fetchPayableList:Da,fetchPaymentStatus:ua,fetchPipelineMeta:ma,fetchPrintLayouts:zs,fetchProductABC:Rs,fetchProductDaily:Ts,fetchProductMonthlyShipments:qs,fetchProductPower:Sa,fetchProductPrice:Ya,fetchProspectActivities:vn,fetchProspects:yn,fetchPurchaseList:La,fetchRawMaterialStock:Na,fetchRawRecords:Fe,fetchRawTableList:Ua,fetchSalesAnalytics:ha,fetchSalesReport:Ge,fetchSalesSummary:da,fetchShopifyOrders:Ks,fetchSlackLogs:pn,fetchSlackRules:Fa,fetchStoreOrders:Oa,fetchStoreSales:kt,fetchSyncDashboard:ya,fetchTankList:Ca,fetchTaxDeclaration:wt,fetchTourInquiriesFromDb:Dn,fetchUserProfiles:nn,fetchWorkflowOrdersFromDb:In,generateTaxCSV:Ms,generateTaxXML:Ra,ocrFaxImage:an,recalculateTaxDeclaration:Fs,recordAudit:cn,resolveProductPrice:ka,saveCalendarEvent:Xs,saveCallLog:Va,saveDeliveryLocation:_n,saveEmailCampaign:Me,saveFaxRecord:sn,saveIntegrationSetting:xe,saveInvoice:fa,saveLeadItem:Ja,saveLeadList:En,saveMailSender:Ys,saveMaterial:bn,savePrintLayout:Vs,saveProspect:Ba,saveProspectActivity:fn,saveSlackRule:un,saveTaxDeclaration:Bs,saveTourInquiry:qn,saveUserProfile:on,saveWorkflowOrder:Ln,searchPlaces:Pn,sendEmailCampaign:ja,sendSlackNotification:mn,submitFeatureRequest:ga,syncGoogleCalendar:en,syncIvryCallLogs:kn,syncPhoneBookToIvry:Sn,syncShopifyOrders:Ws,updateCustomer:$a,updateProduct:_a},Symbol.toStringTag,{value:"Module"}));function oe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Tn={open:"未締め",closed:"締め済"};function Rn(e,t){const n=e.customers.map(i=>`
      <tr>
        <td>
        ...
        <td>
          <span class="status-pill ${i.status==="closed"?"success":"warning"}">${Tn[i.status]}</span>
        </td>
        <td>
  ...
  `}const zn={forecasts:[],deliveries:[],calendarMonth:new Date().toISOString().slice(0,7),selectedSegment:"all"},Rt={monthly:"月次生産","made-to-order":"受注生産","november-only":"11月限定","annual-batch":"年間一括"},me={monthly:"#0F5B8D","made-to-order":"#6b46c1","november-only":"#c05621","annual-batch":"#2f855a"};function Vn(e){const t=e.filter(r=>r>0).length,n=e.reduce((r,c)=>r+c,0);if(n===0)return"made-to-order";const i=e[10]/n;return e[11]/n,i>.5?"november-only":t<=3?"made-to-order":t<=4&&i<.3?"annual-batch":"monthly"}function Ga(e,t){if(t==="monthly"){const r=e.filter((a,l)=>l!==11).filter(a=>a>0);if(r.length===0)return 0;const c=[...r].sort((a,l)=>a-l);if(c.length>2){const a=c.slice(0,-1);return Math.round(a.reduce((l,o)=>l+o,0)/a.length)}return Math.round(r.reduce((a,l)=>a+l,0)/r.length)}if(t==="november-only")return e[10];if(t==="annual-batch")return e.reduce((i,r)=>i+r,0);const n=e.filter(i=>i>0);return n.length>0?Math.round(n.reduce((i,r)=>i+r,0)/n.length):0}function Jn(e,t){const n=(new Date().getMonth()+1)%12;if(t==="november-only")return n===10?e[10]:0;if(t==="annual-batch"){const i=e.indexOf(Math.max(...e));return n===i?e.reduce((r,c)=>r+c,0):0}return t==="made-to-order"?0:e[n]>0?e[n]:Ga(e,t)}function Un(e){return e.slice(0,50).map(t=>{const n=t.monthlyQuantity,i=Vn(n),r=Math.round(t.totalQuantity/12),c=Ga(n,i),a=Jn(n,i),l=i==="monthly"?c*11+n[11]:t.totalQuantity,o=i==="monthly"?Math.round(c*1.5):i==="november-only"?Math.round(n[10]*.1):0;return{code:t.code,name:t.name,segment:i,monthlyQuantity:n,avgMonthly:r,adjustedAvg:c,nextMonthForecast:a,annualForecast:l,safetyStock:o}})}function Yn(e){const t=new Date().toISOString().slice(0,10);return e.map(n=>({date:n.date,customerName:n.customerName,productName:n.productName,quantity:n.quantity,status:n.date>t?"scheduled":"delivered"}))}function Hn(e){const[t,n]=e.split("-").map(Number);return new Date(t,n,0).getDate()}function Gn(e){const[t,n]=e.split("-").map(Number);return new Date(t,n-1,1).getDay()}function Xa(e,t){const n=Hn(t),i=Gn(t),[r,c]=t.split("-").map(Number),a=new Map;e.forEach(A=>{if(A.date.slice(0,7)===t){const x=A.date.slice(0,10);a.has(x)||a.set(x,[]),a.get(x).push(A)}});const l=e.filter(A=>A.date.slice(0,7)===t),o=l.reduce((A,x)=>A+x.quantity,0),d=new Set(l.map(A=>A.date)).size,u=new Date().toISOString().slice(0,10),p=["日","月","火","水","木","金","土"].map(A=>`<th class="dcal-header">${A}</th>`).join("");let y="",v=1;for(let A=0;A<6&&!(v>n&&A>0);A++){y+="<tr>";for(let x=0;x<7;x++)if(A===0&&x<i||v>n)y+='<td class="dcal-cell dcal-empty"></td>';else{const T=`${r}-${String(c).padStart(2,"0")}-${String(v).padStart(2,"0")}`,z=a.get(T)||[],Z=T===u,We=z.reduce((Ee,Q)=>Ee+Q.quantity,0);y+=`
          <td class="dcal-cell ${Z?"dcal-today":""}">
            <div class="dcal-day">${v}</div>
            ${z.length>0?`
              <div class="dcal-entries">
                <div class="dcal-entry dcal-${z[0].status}">${z.length}件 ${We}本</div>
              </div>
            `:""}
          </td>`,v++}y+="</tr>"}const[$,E]=c===1?[r-1,12]:[r,c-1],[k,b]=c===12?[r+1,1]:[r,c+1],F=`${$}-${String(E).padStart(2,"0")}`,N=`${k}-${String(b).padStart(2,"0")}`;return`
    <section class="panel">
      <div class="panel-header">
        <div>
          <h2>納品カレンダー</h2>
  ...
  `}function Qn(e){return`
    ...
    ${Xa(e.deliveries,e.calendarMonth)}
    ${Xn(e.forecasts,e.selectedSegment)}
  `}function Wn(e,t){return Xa(e,t)}const Ce={today:"当日",month:"当月","90days":"90日",year:"1年",all:"全期間",custom:"指定期間"};function jt(e,t){const n=new Date(e);return n.setFullYear(n.getFullYear()+t),n.toISOString()}function Kn(e,t,n){if(t==="all")return e;const i=new Date,r=i.toISOString().slice(0,10),c=new Date(i);switch(t){case"today":return e.filter(a=>a.date.slice(0,10)===r);case"month":return e.filter(a=>a.date.slice(0,7)===r.slice(0,7));case"90days":return c.setDate(c.getDate()-90),e.filter(a=>a.date>=c.toISOString());case"year":return c.setFullYear(c.getFullYear()-1),e.filter(a=>a.date>=c.toISOString());case"custom":return!n?.start||!n?.end?e:e.filter(a=>{const l=a.date.slice(0,10);return l>=n.start&&l<=n.end})}}function U(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ie(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function ye(e,t){for(const n of t){const i=e[n];if(typeof i=="number"&&Number.isFinite(i))return i;if(typeof i=="string"){const r=Number(i);if(Number.isFinite(r))return r}}return null}function Zn(e){const t=e?.productTotals;if(!t||t.length===0)return"―";const n=t.reduce((r,c)=>{const a=ye(c,["amount","salesAmount"]),l=ye(c,["marginRate","grossMarginRate"]);return a===null||a<=0||l===null?r:{weightedAmount:r.weightedAmount+a,weightedRate:r.weightedRate+a*l}},{weightedAmount:0,weightedRate:0});if(n.weightedAmount>0)return`${(n.weightedRate/n.weightedAmount).toFixed(1)}%`;const i=t.reduce((r,c)=>{const a=c,l=ye(a,["amount","salesAmount"]),o=ye(a,["grossProfit","grossAmount","margin"]),d=ye(a,["costAmount","cost","costPrice"]);if(l===null||l<=0)return r;const u=o??(d!==null?l-d:null);return u===null?r:{sales:r.sales+l,gross:r.gross+u}},{sales:0,gross:0});return i.sales>0?`${(i.gross/i.sales*100).toFixed(1)}%`:"―"}function ei(e){const i={top:20,right:20,bottom:30,left:50},r=760-i.left-i.right,c=260-i.top-i.bottom,a=Math.max(...e.map(u=>u.amount),1),l=r/e.length,o=e.map((u,p)=>{const y=u.amount/a*c,v=i.left+p*l+4,$=i.top+c-y,E=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(u.date));return`
        <g>
          <rect x="${v}" y="${$}" width="${Math.max(l-8,8)}" height="${y}" rx="4" fill="#0F5B8D" opacity="${.58+p/e.length*.34}" />
          ${p%5===0?`<text x="${v+6}" y="252" class="chart-axis">${E}</text>`:""}
        </g>
      `}).join("");return`
  ...
  `}function ti(e,t,n,i,r="month",c){const a={success:"正常",warning:"注意",error:"異常",running:"実行中"},l=Kn(e.allDailySales,r,c),o=l.reduce((A,x)=>A+x.amount,0),d=l.reduce((A,x)=>A+x.bottles,0),u=l.reduce((A,x)=>A+x.volumeMl,0),p=l.length,y=d>0?Math.round(o/d):0,v=u>0?Math.round(o/(u/1e3)):0,E=(l.length>0?e.allDailySales.filter(A=>{const x=l[0]?.date??"",T=l[l.length-1]?.date??"",z=jt(x,-1),Z=jt(T,-1);return A.date>=z&&A.date<=Z}):[]).reduce((A,x)=>A+x.amount,0),k=E>0?(o-E)/E*100:0,b=k>0?"+":"",F=e.salesRecords.slice(0,10).map(A=>`
            <tr>
              <td class="mono">${A.documentNo}</td>
              <td>${Ie(A.date)}</td>
              <td>${A.customerName}</td>
              <td class="numeric">${U(A.amount)}</td>
            </tr>
          `).join(""),N=["today","month","90days","year","all"].map(A=>`<button class="button ${A===r?"primary":"secondary"} small" type="button" data-period="${A}">${Ce[A]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card">
        <p class="panel-title">${Ce[r]}売上</p>
        <p class="kpi-value">${U(o)}</p>
        <p class="kpi-sub">${p}日間${p>0?` / 日平均 ${U(Math.round(o/p))}`:""}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">昨対比</p>
        <p class="kpi-value" style="color:${k>=0?"#2f855a":"#c53d3d"}">${E>0?`${b}${k.toFixed(1)}%`:"―"}</p>
        <p class="kpi-sub">前年同期 ${E>0?U(E):"データなし"}</p>
      </article>
    ...
    <section class="content-grid">
      <article class="panel">
        <div class="panel-header">
          <div>
            <h2>日次売上</h2>
            <p class="panel-caption">${Ce[r]} (${l.length}日分)</p>
          </div>
        </div>
        <div class="chart-scroll">
          ${ei(l.length>0?l:e.dailySales)}
        </div>
      </article>
    ...
    <details class="panel collapsible-panel">
      <summary class="panel-header clickable">
        <div>
          <h2>日次推移</h2>
          <p class="panel-caption">${Ce[r]} — 売上・本数・液体量・単価（${l.length}日分）</p>
        </div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>${l.slice().reverse().slice(0,31).map(A=>`
            <tr>
              <td class="mono">${A.date.slice(0,10)}</td>
              <td class="numeric">${U(A.amount)}</td>
              <td class="numeric">${A.bottles.toLocaleString("ja-JP")}</td>
              <td class="numeric">${(A.volumeMl/1e3).toLocaleString("ja-JP",{maximumFractionDigits:0})}</td>
              <td class="numeric">${U(A.pricePerBottle)}</td>
              <td class="numeric">${U(A.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
  ...
  `}function ai(e){const t=e.prospects.reduce((a,l)=>a+l.expectedAmount*l.probability/100,0),n=e.prospects.filter(a=>a.stage==="hot"||a.stage==="negotiating").length,i=new Date().toISOString().slice(0,10),r=e.upcomingEvents.filter(a=>a.startsAt.slice(0,10)>=i).slice(0,5),c=e.tourInquiries.filter(a=>a.status==="new").length;return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
  ...
  `}function H(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ii(e){return H(e).replaceAll(`
`,"<br />")}function li(e){const n=[...Object.values(bt),{id:"custom",season:"カスタム",subject:"",body:""}].map(r=>`
  ...
  `}function Y(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Le(e,t){return t.length===0?"":`
  ...
  `}function oi(e,t){const n=[Le("得意先",t.customers.map(r=>`
          <button
  ...
  `}function he(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Qa(e){const t=e.resultsHtml.trim()?e.resultsHtml:`<p class="empty-note">${he(e.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function De(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Mt(e){return e.trim().toLowerCase()}function ri(e,t){const n=Mt(t),i=e.filter(c=>n?[c.code,c.name,c.name].map(Mt).some(a=>a.includes(n)):!0).slice(0,50),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${ce(i,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||ci(new Date)}" />
          ${te(i,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
      ...
      <div class="quote-preview-inner">
        ...
        <div class="quote-preview-meta">
          ...
          <div class="quote-preview-info">
            ${r.showQuoteNo&&e.quoteNo?`<p>No. ${P(e.quoteNo)}</p>`:""}
            <p>${e.quoteDate}</p>
        ...
        ${r.headerNote?`<p class="quote-preview-note">${P(r.headerNote)}</p>`:""}

        ${r.showSubject&&e.subject?`<p class="quote-preview-subject">件名: ${P(e.subject)}</p>`:""}
        ...
        ${r.footerNote?`<p class="quote-preview-footer-note">${P(r.footerNote)}</p>`:""}
      </div>
    </div>
  `}function pi(e){const t=(n,i,r)=>`
  ...
  `}function yi(e,t,n,i,r,c){const a=e.lines.reduce((y,v)=>y+v.amount,0),l=Math.round(a*e.taxRate/100),o=a+l,d=i.length>=1?t.filter(y=>y.name.includes(i)||y.code.includes(i)).slice(0,8):[],u=r.length>=1?n.filter(y=>y.name.includes(r)||y.code.includes(r)).slice(0,8):[],p=e.fieldConfig;return e.previewMode?`
      <section class="page-head">
        <div>
    ...
    <section class="panel">
      ...
      <div class="form-row">
        <input type="text" id="q-prod-search" value="${P(r)}" placeholder="商品名またはコードで検索して追加" />
      </div>
      ${u.length>0?`
        <div class="search-results">
          ${u.map(y=>{const v=c?ka(y,c):{price:y.salePrice||0,label:"標準価格"},$=v.label!=="標準価格";return`
            <button class="search-item" type="button" data-add-product="${y.code}" data-prod-name="${P(y.name)}" data-prod-price="${v.price}">
              <span class="mono">${y.code}</span> ${P(y.name)}
              <span class="numeric" ${$?'style="color:#2f855a;font-weight:700;"':""}>${v.price?G(v.price):""} <small>(${v.label})</small></span>
            </button>`}).join("")}
        </div>
      `:""}
    ...
    ${pi(p)}
    ${mi(e.sealSettings)}
  `}function hi(e){const t=Ka(e),n=window.open("","_blank","width=800,height=1100");if(!n){alert("ポップアップがブロックされました。許可してください。");return}n.document.write(`<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8" />
...
<\/script>
...
</html>`),n.document.close()}function Za(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function es(e){return`<span style="display:inline-block;width:24px;height:24px;border-radius:50%;background:${{A:"#2f855a",B:"#2b6cb0",C:"#b7791f"}[e]||"#9aa5b1"};color:white;text-align:center;line-height:24px;font-weight:700;font-size:12px;">${e}</span>`}function ts(e){return e==null?'<span style="color:#9aa5b1;">―</span>':`<span style="color:${e>=0?"#2f855a":"#c53d3d"};font-weight:700;">${e>=0?"+":""}${e.toFixed(1)}%</span>`}function vi(e,t){return!t||e===t?"":e<t?`<span style="color:#2f855a;font-size:11px;">&#x2191;${t}&#x2192;${e}</span>`:`<span style="color:#c53d3d;font-size:11px;">&#x2193;${t}&#x2192;${e}</span>`}function fi(e,t,n,i,r){const c=new Map,a=new Map;for(const u of e){if(u.date>=t&&u.date<=n){const p=c.get(u.productCode);p?(p.amt+=u.amount,p.qty+=u.qty):c.set(u.productCode,{name:u.productName,vol:u.volumeMl,amt:u.amount,qty:u.qty})}u.date>=i&&u.date<=r&&a.set(u.productCode,(a.get(u.productCode)??0)+u.amount)}const l=[...c.entries()].map(([u,p])=>({code:u,...p})).sort((u,p)=>p.amt-u.amt),o=l.reduce((u,p)=>u+p.amt,0);let d=0;return l.map(u=>{d+=u.amt;const p=o>0?Math.round(u.amt*1e4/o)/100:0,y=d<=o*.7?"A":d<=o*.9?"B":"C",v=a.get(u.code)??0,$=v>0?Math.round((u.amt-v)/v*1e3)/10:null;return{code:u.code,name:u.name,volumeMl:u.vol,amount:u.amt,qty:u.qty,sharePct:p,rank:y,prevAmount:v,growthRate:$}})}function bi(e,t,n){const i=new Date,r=i.toISOString().slice(0,10);let c=r,a=r,l="";switch(e){case"week":{const u=new Date(i);u.setDate(u.getDate()-7),c=u.toISOString().slice(0,10),a=r,l="直近7日間";break}case"month":{c=r.slice(0,7)+"-01",a=r,l="当月";break}case"90days":{const u=new Date(i);u.setDate(u.getDate()-90),c=u.toISOString().slice(0,10),a=r,l="直近90日間";break}case"year":{const u=new Date(i);u.setFullYear(u.getFullYear()-1),c=u.toISOString().slice(0,10),a=r,l="直近1年間";break}case"custom":{c=t||r,a=n||r,l=`${c} 〜 ${a}`;break}}const o=new Date(c);o.setFullYear(o.getFullYear()-1);const d=new Date(a);return d.setFullYear(d.getFullYear()-1),{start:c,end:a,prevStart:o.toISOString().slice(0,10),prevEnd:d.toISOString().slice(0,10),label:l}}function gi(e,t="all",n=[],i="year",r,c){const a=bi(i,r,c),l=n.length>0?fi(n,a.start,a.end,a.prevStart,a.prevEnd):e.map(b=>({code:b.code,name:b.name,volumeMl:b.volumeMl,amount:b.yearAmount,qty:b.yearQty,sharePct:b.sharePct,rank:b.rank,prevAmount:b.prevAmount,growthRate:b.growthRate})),o=l.filter(b=>b.rank==="A").length,d=l.filter(b=>b.rank==="B").length,u=l.filter(b=>b.rank==="C").length,p=l.filter(b=>b.growthRate!=null&&b.growthRate>10),y=l.filter(b=>b.growthRate!=null&&b.growthRate<-10);let v=l,$="全商品";switch(t){case"A":v=l.filter(b=>b.rank==="A"),$="Aランク";break;case"B":v=l.filter(b=>b.rank==="B"),$="Bランク";break;case"C":v=l.filter(b=>b.rank==="C"),$="Cランク";break;case"growing":v=p,$="成長商品(+10%以上)";break;case"declining":v=y,$="衰退商品(-10%以下)";break}const E=(b,F,N)=>`<button class="button ${t===b?"primary":"secondary"} small" data-product-filter="${b}">${F} (${N})</button>`,k=(b,F)=>`<button class="button ${i===b?"primary":"secondary"} small" data-product-period="${b}">${F}</button>`;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>商品力分析</h1>
    ...
    <section class="panel">
      ...
      <div class="button-group" style="margin-bottom:12px;">
        ...
        ${E("B","B",d)}
        ${E("C","C",u)}
        ${E("growing","成長",p.length)}
        ${E("declining","衰退",y.length)}
      </div>
      <div class="table-wrap">
        <table>
          <thead>
          ...
          <tbody>
            ${v.slice(0,100).map(b=>`
              <tr>
                <td>${es(b.rank)}</td>
                <td>${b.name?b.name.slice(0,25):b.code}${b.volumeMl?` <small>${b.volumeMl}ml</small>`:""}</td>
                <td class="numeric">${Za(b.amount)}</td>
                <td class="numeric">${b.sharePct}%</td>
                <td class="numeric">${b.qty.toLocaleString()}</td>
                <td class="numeric">${ts(b.growthRate)}</td>
              </tr>
            `).join("")}
  ...
  `}function $i(e){const t=e.filter(r=>r.currentRank==="A").length,n=e.filter(r=>r.prevRank&&r.currentRank<r.prevRank).length,i=e.filter(r=>r.prevRank&&r.currentRank>r.prevRank).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>営業効率分析</h1>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${e.slice(0,50).map(r=>`
              <tr>
                <td>${es(r.currentRank)}</td>
                <td>${r.name||r.code}</td>
                <td class="numeric">${Za(r.yearAmount)}</td>
                <td class="numeric">${r.sharePct}%</td>
                <td class="numeric">${r.orderDays}日</td>
                <td class="numeric">${ts(r.growthRate)}</td>
  ...
  `}function _i(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function wi(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ki(e,t){const n=e.length?e.map(i=>`
            <tr>
              ...
              <td class="numeric">${wi(i.amount)}</td>
            </tr>
  ...
  `}function Si(e){return new Date(e.getFullYear(),e.getMonth(),1)}function xi(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function as(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function ss(e){const t=new Date(e),n=t.getDay();return t.setDate(t.getDate()-n),t.setHours(0,0,0,0),t}function Ft(e){const t=as(ss(e),6);return t.setHours(23,59,59,999),t}function Bt(e){return new Date(`${e}T00:00:00`)}function zt(e){return`${e.getMonth()+1}/${e.getDate()}`}function Ai(e){return e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function Ei(){const e=new Date,t=ss(xi(Si(e),-3)),n=Ft(new Date(e.getFullYear(),e.getMonth()+4,0)),i=[];let r=new Date(t);for(;r<=n;){const c=Ft(r);i.push({start:new Date(r),end:c,label:`${zt(r)} - ${zt(c)}`}),r=as(r,7)}return i}function Pi(e){const t=Ei(),n=`160px repeat(${t.length}, minmax(56px, 1fr))`,i=t.map(c=>`
        <div class="gantt-week">
          <span>${c.label}</span>
        </div>
      `).join(""),r=e.length?e.map(c=>{const a=Bt(c.startDate),l=Bt(c.expectedDoneDate),o=Math.max(0,t.findIndex(p=>p.end>=a)),d=Math.max(o,t.reduce((p,y,v)=>y.start<=l?v:p,o)),u=[`仕込番号: ${c.jikomiNo}`,`銘柄: ${c.productName}`,`期間: ${c.startDate} - ${c.expectedDoneDate}`,`タンク: ${c.tankNo}`,`備考: ${c.note||"なし"}`].join(`
`);return`
  ...
  `}function Vt(e,t){const n={planned:"neutral",active:"warning",done:"success"},i=e.map(l=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${n[l.status]}">${Ea[l.status]}</span>
        </td>
        <td>${l.note||"―"}</td>
      </tr>
  ...
  `}function Ci(e){const t={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},i=e.map(o=>`
      <tr>
  ...
  `}function Ii(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Li(e,t){return`
  ...
  `}function Ti(e,t){const n=[...new Set(e.map(r=>r.businessType).filter(Boolean))].sort(),i=[...new Set(e.map(r=>r.areaCode).filter(Boolean))].sort();return`
  ...
  `}function dt(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Ri(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function Oi(e){return e.map(t=>`
        <tr>
      ...
      `).join("")}function qe(e){return e?`¥${e.toLocaleString("ja-JP")}`:"―"}function ji(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${dt(t.name,20)}</td>
          <td>${t.kanaName||""}</td>
      ...
      `).join("")}function Mi(e,t,n=At){const{filtered:i,paged:r,totalPages:c}=Ni(e.customers,n);return`
    <section class="page-head">
      <div>
      ...
      `:`
        <div class="table-wrap">
          <table>
            ...
            <tbody>${ji(e.products)}</tbody>
          </table>
        </div>
      `}
    </section>
  `}function Ke(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Fi(e,t){if(!e&&!t)return"";const n=e;return`
  ...
  `}function Bi(e){const t=e.map(r=>{const a=(r.minimumStock>0?r.currentStock/r.minimumStock:1/0)<1.5;return`
        <tr>
  ...
  `}function zi(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function Ze(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Vi={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Ji(e){return`
    <section class="page-head">
      <div>
  ...
  `}function de(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ut(e){return e.trim().toLowerCase()}function Ui(e,t){const n=Ut(t),i=e.filter(c=>n?[c.code,c.name,c.janCode].map(Ut).some(a=>a.includes(n)):!0),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Qa({title:"商品検索",searchQuery:t,placeholder:"コード・名前・JANで検索",resultsHtml:r,emptyMessage:"該当する商品が見つかりません。"})}function ae(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Yi(e,t){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},i={pending:"warning",confirmed:"neutral",paid:"success"},r={unpaid:"未払い",partial:"一部支払",paid:"支払済"},c={unpaid:"warning",partial:"neutral",paid:"success"},a=e.map(p=>`
      <tr>
  ...
  `}function ve(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Hi(e,t){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},i={holding:"neutral",due:"warning",cleared:"success"},r=e.map(u=>`
      <tr>
  ...
  `}function Re(e){if(!e)return"error";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"success":n<24?"warning":"error"}function Yt(e){if(!e)return"未同期";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"正常":n<24?"注意":"要確認"}function Xi(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
  ...
  `}function Qi(e,t,n,i){const r={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function ge(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Wi(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function Ki(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),n=Math.max(...t.map(p=>p.amount),1),i=28,r=6,c=140,a=100,l=760,o=l-c-a,d=t.length*(i+r)+16,u=t.map((p,y)=>{const v=p.amount/n*o,$=y*(i+r)+8,E=p.abcRank==="A"?"#2F855A":p.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
          <text x="${c-8}" y="${$+i/2+5}" class="chart-axis" text-anchor="end">${p.name.length>10?p.name.slice(0,10)+"…":p.name}</text>
          <rect x="${c}" y="${$}" width="${v}" height="${i}" rx="4" fill="${E}" opacity="0.85" />
          <text x="${c+v+8}" y="${$+i/2+5}" class="chart-axis">${(p.amount/1e4).toFixed(0)}万円</text>
        </g>
      `}).join("");return`
    <svg viewBox="0 0 ${l} ${d}" class="sales-chart ranking-chart" role="img" aria-label="得意先別売上ランキング">
      ${u}
    </svg>
  `}function Zi(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(i=>`<th class="numeric">${i}</th>`).join(""),n=e.monthlyByCustomer.map(i=>{const r=i.values.reduce((a,l)=>a+l,0),c=i.values.map(a=>`<td class="numeric">${a>0?(a/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${i.label}</td>
          ${c}
  ...
  `}function el(e){e.ranking.reduce((o,d)=>o+d.amount,0);const t=e.ranking.filter(o=>o.abcRank==="A").length,n=e.ranking.filter(o=>o.abcRank==="B").length,i=e.ranking.filter(o=>o.abcRank==="C").length,r=e.ranking.filter(o=>o.abcRank==="A").reduce((o,d)=>o+d.amount,0),c=e.ranking.filter(o=>o.abcRank==="B").reduce((o,d)=>o+d.amount,0),a=e.ranking.filter(o=>o.abcRank==="C").reduce((o,d)=>o+d.amount,0),l=e.ranking.map(o=>`
        <tr>
          ...
          <td><span class="status-pill ${Wi(o.abcRank)}">${o.abcRank}</span></td>
        </tr>
      `).join("");return`
    <section class="page-head">
      <div>
  ...
  `}function ns(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function tl(e){return e.replace("-","/")}const al={all:"全期間",yearly:"年次",monthly:"月次",weekly:"週次",daily:"日次"};function sl(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,i={top:16,right:24,bottom:36,left:64},r=t-i.left-i.right,c=n-i.top-i.bottom,a=Math.max(...e.map(u=>u.amount),1),l=r/e.length,o=[0,.25,.5,.75,1].map(u=>{const p=i.top+c-c*u,y=`${Math.round(a*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${i.left}" y1="${p}" x2="${t-i.right}" y2="${p}" class="chart-grid" />
          <text x="8" y="${p+4}" class="chart-axis">${y}</text>
        </g>
      `}).join(""),d=e.map((u,p)=>{const y=u.amount/a*c,v=Math.max(l-18,24),$=i.left+p*l+(l-v)/2,E=i.top+c-y;return`
        <g>
          <rect x="${$}" y="${E}" width="${v}" height="${y}" rx="6" class="analytics-bar" />
          <text x="${$+v/2}" y="${n-10}" class="chart-axis centered-axis">${tl(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function nl(e){return e.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
          <td class="numeric">${ns(t.amount)}</td>
          <td class="numeric">${t.quantity.toLocaleString("ja-JP")}</td>
          <td class="numeric">${t.documents.toLocaleString("ja-JP")}</td>
        </tr>
      `).join("")}function il(e){return e.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
      ...
      `).join("")}function ll(e,t,n="all",i="",r=[],c=[]){const a=t==="products"?"商品別集計":"得意先別集計",l=t==="products"?e.productTotals:e.customerTotals,o=n!=="all"&&r.length>0,d=["all","yearly","monthly","weekly","daily"].map(p=>`<button class="button ${p===n?"primary":"secondary"} small" type="button" data-analytics-period="${p}">${al[p]}</button>`).join(""),u=n!=="all"&&c.length>0?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
      ...
      <article class="panel">
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>${o?il(r):nl(l)}</tbody>
          </table>
        </div>
      </article>
    </section>
  `}function fe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ol(e){const t=Math.max(...e.salesByProduct.flatMap(c=>c.values),1),n=e.salesByProduct.map(c=>{const a=c.values.map((l,o)=>`
          <div class="bar-col">
  ...
  `}function rl(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function cl(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ht(e){return e.toISOString().slice(0,10)}function dl(e,t,n){const i=e.length?e.map(r=>`
            <tr>
              ...
              <td class="numeric">${cl(r.amount)}</td>
            </tr>
  ...
  `}function Oe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ul(e,t,n,i){const r={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},c={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},a={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},l=e.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
  ...
  `}const et={customers:"得意先マスタ",products:"商品マスタ",suppliers:"仕入先マスタ",staff:"担当者マスタ"},pl={customers:{required:["legacy_customer_code","name"],optional:["kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"]},products:{required:["legacy_product_code","name"],optional:["kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"]},suppliers:{required:["legacy_supplier_code","name"],optional:["kana_name","phone","postal_code","address1","closing_day","payment_day","email"]},staff:{required:["legacy_staff_code","name"],optional:["kana_name","department"]}};function ml(e,t,n,i){const r=pl[e],c=Object.keys(et).map(l=>`
  ...
  `}const fl={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},bl=["new","picking","packed","shipped","delivered"];function gl(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(c=>t[c.stage].push(c));const n=bl.map(c=>{const a=fl[c],l=t[c];return`
  ...
  `}function $l(e,t,n){const i=e.cart.reduce((c,a)=>c+a.amount,0);return`
  ...
  `}function _l(e,t,n){if(e.step==="customer"){const i=e.customerQuery.toLowerCase(),r=i?t.filter(c=>c.name.toLowerCase().includes(i)||c.code.toLowerCase().includes(i)):t.slice(0,20);return`
      <section class="panel">
  ...
  `}const Gt={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},Xt={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},Qt={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function wl(e,t){const n=e.find(c=>c.id===t)??e[0],i=e.filter(c=>c.status==="new").length,r=e.filter(c=>c.status==="confirmed").length;return`
    <section class="page-head">
      <div>
...
金井酒造店`;function xl(e,t){const n=t?e.find(r=>r.id===t):null,i=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${n||i?`
      ...
      `:""}
  `}function Al(e,t,n,i){const[r,c]=t.split("-").map(x=>parseInt(x,10)),a=new Date(r,c-1,1),l=new Date(r,c,0),o=a.getDay(),d=l.getDate(),u=[];for(let x=0;x<o;x++)u.push({isOutside:!0});for(let x=1;x<=d;x++)u.push({date:new Date(r,c-1,x)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter(x=>x.category===n):e,y={};p.forEach(x=>{const T=x.startsAt.slice(0,10);y[T]??=[],y[T].push(x)});const v=new Date().toISOString().slice(0,10),$=u.map(x=>{if(x.isOutside)return'<div class="cal-cell cal-outside"></div>';const T=x.date,z=`${T.getFullYear()}-${String(T.getMonth()+1).padStart(2,"0")}-${String(T.getDate()).padStart(2,"0")}`,Z=y[z]??[],We=z===v,Ee=T.getDay();return`
        <div class="cal-cell ${We?"cal-today":""} ${Ee===0?"cal-sun":Ee===6?"cal-sat":""}"
          ...
          <div class="cal-events">
            ...
            `).join("")}
            ${Z.length>3?`<button class="cal-event-more" data-cal-date="${z}">+${Z.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),E=i?.isOpen?El(i):"",k=new Date(r,c-2,1),b=new Date(r,c,1),F=`${k.getFullYear()}-${String(k.getMonth()+1).padStart(2,"0")}`,N=`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}`,A=(()=>{const x=new Date;return`${x.getFullYear()}-${String(x.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      <div class="cal-toolbar">
        <div class="cal-nav">
          ...
          <button class="button secondary" data-action="cal-today" data-ym="${A}">今日</button>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(St).map(([x,T])=>`<option value="${x}" ${n===x?"selected":""}>${T}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
    ...
    ${E}
  `}function El(e){const t=e.event;return`
  ...
  `}function Ll(e,t,n){const i=t==="__new__"?null:e.find(a=>a.id===t),r=t==="__new__";return n?.role==="admin"?`
    <section class="page-head">
      <div>
  ...
  `:`
    ...
    `}function ql(e){const t={};return e.forEach(n=>{const i=n.userEmail??"(anonymous)";t[i]=(t[i]??0)+1}),`
    <section class="page-head">
      <div>
  ...
  `}function Nl(e){const t=e.prospects.reduce((c,a)=>c+a.expectedAmount,0),n=e.prospects.reduce((c,a)=>c+a.expectedAmount*a.probability/100,0),i=e.prospects.filter(c=>c.stage==="won").length,r=e.prospects.filter(c=>c.stage==="hot"||c.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    ${e.viewMode==="kanban"?Tl(e.prospects):Rl(e.prospects)}
  ...
  `}function Ol(e){if(!e.editingId)return"";const t=e.editingId==="__new__",n=t?null:e.prospects.find(i=>i.id===e.editingId);return!t&&!n?"":`
  ...
  `}function jl(e,t,n){const i=e?.config.webhook_url??"",r=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
  ...
  `}const Fl=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function Bl(e){const t=e.activeListId?e.lists.find(c=>c.id===e.activeListId):null,n=e.items.filter(c=>c.status==="new").length,i=e.items.filter(c=>c.status==="imported").length,r=e.items.filter(c=>c.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
    ...
    <section class="panel">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:flex-end;">
        <label class="field" style="flex:1 1 180px;">
          ...
          <select id="lb-type">
            <option value="">選択</option>
            ${Fl.map(c=>`<option value="${c}" ${e.searchBusinessType===c?"selected":""}>${c}</option>`).join("")}
          </select>
        </label>
        <label class="field" style="flex:1 1 180px;">
          <span>エリア</span>
  ...
  `}const Kt={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},zl={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},Vl={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function R(e){return"¥"+e.toLocaleString("ja-JP")}function we(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function is(e,t){const n=e.reduce((c,a)=>c+a.amount,0),i=Math.floor(n*t),r=n+i;return{subtotal:n,taxAmount:i,total:r}}const I={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function L(e,t){const n=e.align??"left",i=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${i}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function at(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),i=n-2018;return{y:i>0?String(i).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function Jl(e,t,n){const i=at(e.documentDate),r=at(e.orderDate??e.documentDate),c=at(e.deliveryDate??e.documentDate),a=e.lines.slice(0,6).map((k,b)=>{const F=I.detailStartY+b*I.detailRowH,N=I.detailCols,A=[],x=(T,z)=>{z&&A.push(L({...T,y:F,x:T.x+0},z))};return x(N.productName,k.productName+(k.spec?` ${k.spec}`:"")),x(N.productCode,k.productCode),x(N.color,k.color??""),x(N.size,[k.size,k.caseQty?`×${k.caseQty}`:""].filter(Boolean).join(" ")),x(N.unit,k.unit),x(N.quantity,k.quantity>0?k.quantity.toLocaleString("ja-JP"):""),x(N.correctedQty,k.correctedQuantity?k.correctedQuantity.toLocaleString("ja-JP"):""),x(N.discount,k.discount?k.discount.toLocaleString("ja-JP"):""),x(N.unitPrice,k.unitPrice>0?k.unitPrice.toLocaleString("ja-JP"):""),x(N.costAmount,k.amount>0?k.amount.toLocaleString("ja-JP"):""),x(N.retailPrice,k.retailPrice?k.retailPrice.toLocaleString("ja-JP"):""),x(N.note,k.receivedAmount?k.receivedAmount.toLocaleString("ja-JP"):""),A.join("")}).join(""),l=e.lines.reduce((k,b)=>k+(b.amount||0),0),o=e.lines.reduce((k,b)=>k+(b.retailPrice||0)*(b.correctedQuantity??b.quantity),0),d=e.lines.reduce((k,b)=>k+(b.receivedAmount||0),0),u=e.lines.reduce((k,b)=>k+(b.returnAmount||0),0),p=e.lines.reduce((k,b)=>k+b.quantity,0),y=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",v=n.calibrationOffsetX||0,$=n.calibrationOffsetY||0,E=`transform: translate(${v}mm, ${$}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${y}">
        ...
        ${L(I.currentDateY,i.y)}
        ${L(I.currentDateM,i.m)}
        ${L(I.currentDateD,i.d)}
        ${L(I.documentNo,e.documentNo)}
        ${e.settlementPrint?L(I.settlementCheck,"✓"):""}

        ${L(I.vendorName,t.name)}
        ${L(I.vendorAddress,t.address1)}
        ${L(I.chainStoreCode,e.chainStoreCode??"")}
        ${L(I.categoryCode,e.categoryCode??"")}
        ${L(I.slipNumber,e.documentNo)}
        ${L(I.vendorCode,e.slipTypeCode??"")}

        ${L(I.customerName,`${e.customerName} ${e.customerHonorific}`)}
        ${L(I.orderDateY,r.y)}
        ${L(I.orderDateM,r.m)}
        ${L(I.orderDateD,r.d)}
        ${L(I.deliveryDateY,c.y)}
        ${L(I.deliveryDateM,c.m)}
        ${L(I.deliveryDateD,c.d)}
        ${L(I.orderNo,e.orderNo??"")}
        ${L(I.partnerCode,e.vendorCode??"")}

        ${a}

        ${L(I.totalQty,p.toLocaleString("ja-JP"))}
        ${L(I.receivedTotal,d.toLocaleString("ja-JP"))}
        ${L(I.returnTotal,u.toLocaleString("ja-JP"))}
        ${L(I.correctedCostTotal,l.toLocaleString("ja-JP"))}
        ${L(I.correctedRetailTotal,o.toLocaleString("ja-JP"))}
        </div>
      </div>
    </div>
  `}function Ul(e,t,n){const{subtotal:i,taxAmount:r,total:c}=is(e.lines,e.taxRate),a=e.previousBalance??0,l=e.paymentAmount??0,o=a-l+c,d=e.lines.map(p=>`
      <tr>
  ...
  `}function Yl(e,t,n){const{subtotal:i,taxAmount:r,total:c}=is(e.lines,e.taxRate),a=e.lines.map(o=>`
      <tr>
  ...
  `}function Hl(e,t,n,i){let r="";switch(e){case"chain_store":r=Jl(i,n,t);break;case"quotation":r=Yl(i,n,t);break;case"invoice_monthly":r=Ul(i,n,t);break}const c=Object.keys(Kt).map(o=>`<button class="tab-button ${e===o?"active":""}" data-print-template="${o}">${Kt[o]}</button>`).join(""),a=i.lines.map((o,d)=>`
      <tr>
  ...
  `}const Gl={customers:["legacy_customer_code","name"],products:["legacy_product_code","name"],suppliers:["legacy_supplier_code","name"],staff:["legacy_staff_code","name"]},Xl={customers:["legacy_customer_code","name","kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"],products:["legacy_product_code","name","kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"],suppliers:["legacy_supplier_code","name","kana_name","phone","postal_code","address1","closing_day","payment_day","email"],staff:["legacy_staff_code","name","kana_name","department"]};function Ql(e){e.charCodeAt(0)===65279&&(e=e.slice(1));const t=[];let n=[],i="",r=!1;for(let l=0;l<e.length;l++){const o=e[l];r?o==='"'?e[l+1]==='"'?(i+='"',l++):r=!1:i+=o:o==='"'?r=!0:o===","?(n.push(i),i=""):o===`
`||o==="\r"?(o==="\r"&&e[l+1]===`
`&&l++,n.push(i),n.some(d=>d!=="")&&t.push(n),n=[],i=""):i+=o}if((i!==""||n.length>0)&&(n.push(i),n.some(l=>l!=="")&&t.push(n)),t.length===0)return{columns:[],rows:[]};const c=t[0].map(l=>l.trim()),a=[];for(let l=1;l<t.length;l++){const o={};c.forEach((d,u)=>{o[d]=(t[l][u]??"").trim()}),a.push(o)}return{columns:c,rows:a}}function Wl(e,t,n){const i=Gl[e],r=i.filter(l=>!t.includes(l)),c=n.map(l=>{const o=[];r.length>0&&o.push(`必須列欠損: ${r.join(",")}`);for(const d of i)t.includes(d)&&!l[d]&&o.push(`${d}が空`);return{...l,_valid:o.length===0,_error:o[0]}}),a=c.filter(l=>l._valid).length;return{entity:e,columns:t,rows:c,totalRows:n.length,validRows:a,invalidRows:c.length-a}}function Kl(e){const n=Xl[e],r={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[e];return"\uFEFF"+n.join(",")+`
`+r.join(",")+`
`}async function Zl(e,t){const{supabaseInsert:n}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);let i=0,r=0;const a={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const l of t){if(!l._valid)continue;const{_valid:o,_error:d,...u}=l,p={...u};if(!p.id){const y=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[y]??`${e}-${Date.now()}-${i+r}`)}for(const y of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[y]=="string"&&p[y]!==""){const v=Number(p[y]);Number.isFinite(v)&&(p[y]=v)}try{await n(a,p)!==null?i++:r++}catch{r++}}return{inserted:i,failed:r}}function st(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function eo(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function to(e,t,n,i,r){const c=n.reduce((d,u)=>d+u.rowCount,0),a=n.map(d=>d.lastSyncAt).filter(d=>d!==null).sort().reverse()[0]??null,l=100,o=Math.max(1,Math.ceil(r/l));return`
    <section class="page-head">
      <div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="mono" style="font-size:11px;max-width:300px;overflow:hidden;text-overflow:ellipsis;" title="${d._raw_b64?d._raw_b64.slice(0,200):""}">${eo(d._raw_b64)}</td>
            </tr>
            `).join("")}
          </tbody>
        </table>
    ...
    `}
  `}function ao(e){const t={empty:"空",in_use:"使用中",aging:"熟成中"},n={empty:"neutral",in_use:"warning",aging:"success"},i=e.map(d=>{const u=d.capacity>0?Math.round(d.currentVolume/d.capacity*100):0;return`
        <tr>
  ...
  `}function nt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function so(e,t,n){const i=e.rows.map((d,u)=>`
      <tr>
      ...
      <tr>
        ...
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="categoryCode">
            ${Ta.map(p=>`<option value="${p.code}" ${p.code===d.categoryCode?"selected":""}>${p.code}:${p.name}</option>`).join("")}
          </select>
        </td>
        <td class="numeric">
  ...
  `;const l={id:r,message:e,type:t,el:a};mt.push(l),i.appendChild(a),requestAnimationFrame(()=>{a.classList.add("toast-enter")});const o=()=>oo(l);a.querySelector(".toast-dismiss").addEventListener("click",o),setTimeout(()=>{a.classList.add("toast-exit"),a.addEventListener("animationend",o,{once:!0})},c)}function oo(e){const t=mt.indexOf(e);t!==-1&&(mt.splice(t,1),e.el.remove())}function ro(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function W(e,t={}){const{title:n="確認",confirmLabel:i="OK",cancelLabel:r="キャンセル",variant:c="primary"}=t;return new Promise(a=>{const l=document.createElement("div");l.className="modal-backdrop confirm-backdrop",l.setAttribute("role","dialog"),l.setAttribute("aria-modal","true"),l.innerHTML=`
    ...
    `;const o=u=>{l.classList.add("confirm-exit"),l.addEventListener("animationend",()=>{l.remove()},{once:!0}),a(u)};l.querySelector(".confirm-cancel").addEventListener("click",()=>o(!1)),l.querySelector(".confirm-ok").addEventListener("click",()=>o(!0)),l.addEventListener("click",u=>{u.target===l&&o(!1)});const d=u=>{u.key==="Escape"&&(document.removeEventListener("keydown",d),o(!1))};document.addEventListener("keydown",d),document.body.appendChild(l),requestAnimationFrame(()=>{l.querySelector(".confirm-ok")?.focus()})})}const co=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
...
</svg>`,uo=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
  <circle cx="14" cy="14" r="13" stroke="currentColor" stroke-width="1.5"/>
...
</svg>`;function je(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Zt(e){const n=(e==null?"":e instanceof Date?e.toISOString():String(e)).replaceAll('"','""');return/[",\n\r]/.test(n)?`"${n}"`:n}function po(e,t,n){if(t.length===0&&(!n||n.length===0))return;const i=n&&n.length>0?n:Object.keys(t[0]??{}).map(d=>({key:d,label:d})),c=`\uFEFF${[i.map(d=>Zt(d.label)).join(","),...t.map(d=>i.map(u=>Zt(d[u.key])).join(","))].join(`\r
`)}`,a=new Blob([c],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(a),o=document.createElement("a");o.href=l,o.download=e,document.body.append(o),o.click(),o.remove(),window.setTimeout(()=>URL.revokeObjectURL(l),0)}const mo=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser","/demand-forecast"];let pe=[];async function yo(){const{supabaseQueryAll:e}=await f(async()=>{const{supabaseQueryAll:n}=await Promise.resolve().then(()=>q);return{supabaseQueryAll:n}},void 0);pe=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(n=>typeof n.email=="string"&&n.email.length>0).map(n=>({name:String(n.name??""),email:String(n.email??""),area:String(n.delivery_area_code??""),historySegment:"seasonal"}))}const ea=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"},{path:"/demand-forecast",title:"需要予測・納品カレンダー"}];function ls(e){const t=bt[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function Et(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function ho(){const e=ls("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const Qe=new Date,vo=Qe.toISOString().slice(0,7),fo=Qe.getFullYear(),bo=Qe.getMonth()+1,go=Qe.toISOString().slice(0,10),$o="C0011",ne=ho();function os(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return mo.includes(n)?n:"/"}function Pt(e){switch(e){case"/invoice-entry":case"/quote":case"/delivery":case"/billing":case"/invoice":case"/ledger":return"sales";case"/analytics":case"/customer-analysis":case"/product-power":case"/customer-efficiency":case"/report":case"/demand-forecast":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const ta=os(location.pathname),s={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:Et(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:vo,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:fo,taxMonth:bo,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],callLogs:[],mapFilters:{showCustomers:!0,showProspects:!0,showDelivery:!0,filterRegion:"",filterBusinessType:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...zl,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...Vl},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:go,route:ta,currentCategory:Pt(ta),sidebarOpen:!1,announcements:[],dismissedAnnouncements:new Set,updateAvailable:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:$o,salesPeriod:"month",customRange:{start:"",end:""},quoteState:(()=>{const e={...Wa};try{const t=localStorage.getItem("quote-seal");t&&(e.sealSettings=JSON.parse(t))}catch{}return e})(),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,productPower:[],productFilter:"all",productPeriod:"year",productDaily:[],productCustomStart:"",productCustomEnd:"",customerEfficiency:[],masterTab:"customers",masterFilter:{...At},analyticsTab:"products",analyticsPeriod:"all",analyticsPeriodFilter:"",analyticsPeriodRows:[],analyticsPeriodOptions:[],emailAudienceMode:ne.mode,emailRegion:ne.region,emailHistorySegment:ne.historySegment,emailTemplateId:ne.templateId,emailSubject:ne.subject,emailBody:ne.body,emailSaveMessage:ne.saveMessage,emailSending:!1,demandForecast:{...zn},globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function aa(e){return e.slice(0,10)}function _o(e){return{...e}}function Ue(){s.pickerMode=null,s.pickerQuery="",s.pickerTargetLine=null}function rs(){s.invoiceForm=Et(),s.invoiceSavedDocNo=null,s.invoicePriceGroup="",s.invoiceErrors={},Ue()}function cs(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,i)=>{n.productCode.trim()||(t[`lines.${i}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${i}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${i}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${i}.unitPrice`]="単価は0円以上で入力してください。")}),t}function wo(e){const t=s.invoiceForm.lines[e];t&&s.invoiceForm.lines.splice(e+1,0,_o(t))}function ko(){const e=s.invoiceRecords[0],t=s.masterStats?.customers[0],n=s.masterStats?.products.slice(0,2)??[];s.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:s.invoiceForm.staffCode||"S001",lines:n.map((i,r)=>{const c=r===0?1:2,a=1200*(r+1);return{productCode:i.code,productName:i.name,quantity:c,unitPrice:a,unit:"本",amount:c*a}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},s.invoiceSavedDocNo=null,s.invoiceErrors={}}function So(e){const t=s.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function xo(e){const t=s.masterStats?.customers.find(n=>n.name===e.trim());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function ds(e){if(X(e),s.invoiceErrors=cs(s.invoiceForm),Object.keys(s.invoiceErrors).length>0){h();return}s.invoiceSaving=!0,h(),fa(s.invoiceForm).then(t=>{s.invoiceSavedDocNo=t.documentNo,s.invoiceSaving=!1,s.invoiceErrors={},s.invoiceForm=Et(),h()}).catch(()=>{s.invoiceSaving=!1,h()})}function us(e){const t=s.salesFilter.startDate?new Date(s.salesFilter.startDate):null,n=s.salesFilter.endDate?new Date(`${s.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((i,r)=>new Date(r.date).getTime()-new Date(i.date).getTime()).filter(i=>{const r=new Date(i.date);return!(t&&r<t||n&&r>n)})}function ps(){switch(s.emailAudienceMode){case"area":return s.emailRegion==="all"?pe:pe.filter(e=>e.area===s.emailRegion);case"history":return pe.filter(e=>e.historySegment===s.emailHistorySegment);default:return pe}}function Ao(){const e=ps();return{audienceMode:s.emailAudienceMode,region:s.emailRegion,historySegment:s.emailHistorySegment,selectedTemplateId:s.emailTemplateId,subject:s.emailSubject,body:s.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:s.emailSaveMessage,sending:s.emailSending,senderId:s.emailSenderId,senders:s.mailSenders}}function it(e){const t=ps(),n=s.emailAudienceMode==="area"?s.emailRegion:s.emailAudienceMode==="history"?s.emailHistorySegment:"all";return{subject:s.emailSubject.trim(),body:s.emailBody.trim(),templateId:s.emailTemplateId,audienceMode:s.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(i=>i.email),status:e}}function Ct(){return s.user,!1}function Se(){s.globalSearchOpen=!1,s.globalQuery=""}function Eo(){const e=s.globalQuery.trim().toLowerCase();return e?{customers:s.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:s.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:s.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:ea.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:ea}}function Po(){let e=[],t,n="export.csv";switch(s.route){case"/sales":e=(s.salesSummary?us(s.salesSummary):[]).map(i=>({documentNo:i.documentNo,date:i.date,customerCode:i.customerCode,customerName:i.customerName,amount:i.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...s.paymentStatus?.records??[]].sort((i,r)=>r.balanceAmount-i.balanceAmount).map(i=>({...i})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=s.invoiceRecords.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=s.purchaseList.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=s.jikomiList.map(i=>({...i})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=s.tankList.map(i=>({...i})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=s.kenteiList.map(i=>({...i})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=s.materialList.map(i=>({...i})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":s.masterTab==="customers"?(e=s.masterStats?.customers.map(i=>({...i}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=s.masterStats?.products.map(i=>({...i}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}po(n,e,t)}function sa(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),s.route=e,s.currentCategory=Pt(e),s.sidebarOpen=!1,Se(),It(e)}async function It(e){s.actionLoading=!0,h();try{switch(e){case"/delivery":s.deliveryNote||(s.deliveryNote=await $t(s.deliverySearchDocNo||"D240122"));break;case"/billing":s.billingSummary||(s.billingSummary=await _t(s.billingYearMonth));break;case"/report":s.salesReport||(s.salesReport=await Ge());break;case"/product-power":s.productPower.length===0&&(s.productPower=await Sa());break;case"/customer-efficiency":s.customerEfficiency.length===0&&(s.customerEfficiency=await xa());break;case"/customer-analysis":s.customerAnalysis||(s.customerAnalysis=await Aa());break;case"/demand-forecast":if(s.demandForecast.forecasts.length===0){const{fetchProductMonthlyShipments:t,fetchDeliverySchedule:n}=await f(async()=>{const{fetchProductMonthlyShipments:c,fetchDeliverySchedule:a}=await Promise.resolve().then(()=>w);return{fetchProductMonthlyShipments:c,fetchDeliverySchedule:a}},void 0),[i,r]=await Promise.all([t(),n()]);s.demandForecast.forecasts=Un(i),s.demandForecast.deliveries=Yn(r)}break;case"/jikomi":s.jikomiList.length===0&&(s.jikomiList=await Pa());break;case"/tanks":s.tankList.length===0&&(s.tankList=await Ca());break;case"/kentei":s.kenteiList.length===0&&(s.kenteiList=await Ia());break;case"/materials":s.materialList.length===0&&(s.materialList=await ot());break;case"/purchase":(s.purchaseList.length===0||s.payableList.length===0)&&([s.purchaseList,s.payableList]=await Promise.all([La(),Da()]));break;case"/raw-material":(s.billList.length===0||s.rawStockList.length===0)&&([s.billList,s.rawStockList]=await Promise.all([qa(),Na()]));break;case"/tax":s.taxDeclaration||(s.taxDeclaration=await wt(s.taxYear,s.taxMonth));break;case"/store":(s.storeSales.length===0||s.storeOrders.length===0)&&([s.storeSales,s.storeOrders]=await Promise.all([kt(s.storeSalesDate),Oa()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await f(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>w);return{fetchMailSenders:n}},void 0);if(s.mailSenders=await t(),!s.emailSenderId||!s.mailSenders.find(n=>n.id===s.emailSenderId)){const n=s.mailSenders.find(i=>i.isDefault)??s.mailSenders[0];n&&(s.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await f(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>w);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await f(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>w);return{fetchIntegrationSettings:n}},void 0);s.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchShopifyOrders:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>w);return{fetchShopifyOrders:i,fetchIntegrationSettings:r}},void 0);s.shopifyOrders=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchFaxInbox:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>w);return{fetchFaxInbox:i,fetchIntegrationSettings:r}},void 0);s.faxRecords=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await f(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>w);return{fetchUserProfiles:n}},void 0);s.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:i}=await f(async()=>{const{fetchMyProfile:c,fetchAuditLogs:a,fetchMailSenders:l}=await Promise.resolve().then(()=>w);return{fetchMyProfile:c,fetchAuditLogs:a,fetchMailSenders:l}},void 0),r=s.user?.email??s.myProfile?.email??"";r&&(s.myProfile=await t(r)),s.mailSenders.length===0&&(s.mailSenders=await i()),s.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await f(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>w);return{fetchAuditLogs:n}},void 0);s.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await f(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>w);return{fetchProspects:n}},void 0);s.prospects=await t()}break;case"/map":{const{fetchProspects:t,fetchDeliveryLocations:n,fetchIntegrationSettings:i}=await f(async()=>{const{fetchProspects:r,fetchDeliveryLocations:c,fetchIntegrationSettings:a}=await Promise.resolve().then(()=>w);return{fetchProspects:r,fetchDeliveryLocations:c,fetchIntegrationSettings:a}},void 0);s.prospects=await t(),s.deliveryLocations=await n(),s.integrations.length===0&&(s.integrations=await i())}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchCallLogs:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>w);return{fetchCallLogs:i,fetchIntegrationSettings:r}},void 0);s.callLogs=await t(100),s.integrations.length===0&&(s.integrations=await n())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchLeadLists:i,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>w);return{fetchLeadLists:i,fetchIntegrationSettings:r}},void 0);s.leadLists=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await f(async()=>{const{fetchWorkflowOrdersFromDb:n}=await Promise.resolve().then(()=>w);return{fetchWorkflowOrdersFromDb:n}},void 0);s.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await f(async()=>{const{fetchTourInquiriesFromDb:n}=await Promise.resolve().then(()=>w);return{fetchTourInquiriesFromDb:n}},void 0);s.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:i}=await f(async()=>{const{fetchSlackRules:r,fetchSlackLogs:c,fetchIntegrationSettings:a}=await Promise.resolve().then(()=>w);return{fetchSlackRules:r,fetchSlackLogs:c,fetchIntegrationSettings:a}},void 0);s.slackRules=await t(),s.slackLogs=await n(50),s.integrations.length===0&&(s.integrations=await i())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:n,fetchWorkflowOrdersFromDb:i,fetchTourInquiriesFromDb:r}=await f(async()=>{const{fetchProspects:c,fetchCalendarEvents:a,fetchWorkflowOrdersFromDb:l,fetchTourInquiriesFromDb:o}=await Promise.resolve().then(()=>w);return{fetchProspects:c,fetchCalendarEvents:a,fetchWorkflowOrdersFromDb:l,fetchTourInquiriesFromDb:o}},void 0);s.prospects.length===0&&(s.prospects=await t()),s.calendarEvents.length===0&&(s.calendarEvents=await n(s.calendarYearMonth)),s.materialList.length===0&&(s.materialList=await ot()),s.workflowOrders.length===0&&(s.workflowOrders=await i()),s.tourInquiries.length===0&&(s.tourInquiries=await r())}break;default:break}}catch(t){console.warn("Route data load error",t)}finally{s.actionLoading=!1,h()}}function na(){if(Ct())return Li(s.authError,s.authSubmitting);if(s.loading)return`
      <section class="panel">
        <div class="loading-overlay">
          <div class="loading-spinner"></div>
    ...
    `;switch(s.route){case"/cat/sales":return Pe("sales");case"/cat/brewery":return Pe("brewery");case"/cat/purchase":return Pe("purchase");case"/cat/more":return Pe("more");case"/invoice-entry":return di(s.invoiceForm,s.invoiceSavedDocNo,s.invoiceSaving,s.invoiceErrors);case"/quote":return yi(s.quoteState,s.masterStats?.customers??[],s.masterStats?.products??[],s.quoteCustomerQuery,s.quoteProductQuery,s.quotePricing);case"/email":return li(Ao());case"/delivery":return s.deliveryNote?ni(s.deliveryNote,s.deliverySearchDocNo):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/billing":return s.billingSummary?Rn(s.billingSummary,s.billingYearMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/report":return s.salesReport?ol(s.salesReport):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":return gi(s.productPower,s.productFilter,s.productDaily,s.productPeriod,s.productCustomStart,s.productCustomEnd);case"/customer-efficiency":return $i(s.customerEfficiency);case"/customer-analysis":return s.customerAnalysis?el(s.customerAnalysis):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":case"/customer-efficiency":return'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/demand-forecast":return Qn(s.demandForecast);case"/jikomi":return s.jikomiView==="calendar"?`${Vt(s.jikomiList,s.jikomiView)}${Pi(s.jikomiList)}`:Vt(s.jikomiList,s.jikomiView);case"/tanks":return ao(s.tankList);case"/kentei":return Ci(s.kenteiList);case"/materials":return Bi(s.materialList)+Fi(s.materialEditing,s.materialEditingIsNew);case"/purchase":return Yi(s.purchaseList,s.payableList);case"/raw-material":return Hi(s.billList,s.rawStockList);case"/tax":return s.taxDeclaration?so(s.taxDeclaration,s.taxYear,s.taxMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/store":return ul(s.storeSales,s.storeOrders,s.storeTab,s.storeSalesDate);case"/setup":return s.pipelineMeta?Qi(s.pipelineMeta,V,j,s.syncDashboard):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/raw-browser":return to(s.rawSelectedTable,s.rawRecords,s.rawTableList,s.rawPage,s.rawTotalCount);case"/import":return ml(s.importEntity,s.importPreview,s.importing,s.importResult);case"/print":return Hl(s.printTemplate,s.printOptions,s.printCompany,s.printData);case"/form-designer":return hl(s.printData,s.printCompany,s.printOptions,s.fdSavedPositions,s.fdDesignMode);case"/map":{const e=(s.masterStats?.customers??[]).slice(0,200).map((i,r)=>{const c=i;return{...i,lat:c.lat??35.37+r%12*.05+(Math.random()-.5)*.02,lng:c.lng??139.29+Math.floor(r/12)*.05+(Math.random()-.5)*.02,address1:c.address1??"",businessType:c.businessType??"",lastOrderAmount:0}}),n=!!s.integrations.find(i=>i.provider==="google_maps")?.config.api_key;return vl(e,s.prospects,s.deliveryLocations,s.mapFilters,n)}case"/workflow":return gl(s.workflowOrders);case"/mobile-order":return $l(s.mobileOrder,s.masterStats?.customers??[],s.masterStats?.products??[]);case"/tour":return wl(s.tourInquiries,s.tourActiveId);case"/mail-senders":return xl(s.mailSenders,s.mailSenderEditingId);case"/calendar":return Al(s.calendarEvents,s.calendarYearMonth,s.calendarFilterCategory,s.calendarEdit);case"/integrations":return Pl(s.integrations,s.integrationEditingId);case"/shopify":{const e=s.integrations.find(t=>t.id==="shopify");return Cl(s.shopifyOrders,e?.lastSyncAt??null)}case"/fax":return Il(s.faxRecords,s.faxProcessing,s.faxOcrText);case"/users":return Ll(s.userProfiles,s.userEditingId,s.myProfile);case"/profile":return Dl(s.myProfile,s.auditLogs.filter(e=>e.userEmail===s.myProfile?.email),s.mailSenders);case"/audit":return ql(s.auditLogs);case"/prospects":{const e={prospects:s.prospects,activities:s.prospectActivities,editingId:s.prospectEditingId,viewMode:s.prospectViewMode};return Nl(e)}case"/slack":{const e=s.integrations.find(t=>t.provider==="slack")??null;return jl(e,s.slackRules,s.slackLogs)}case"/calls":{const e=s.integrations.find(t=>t.provider==="ivry");return Ml(s.callLogs,s.masterStats?.customers??[],e?.lastSyncAt??null,e?.isEnabled??!1)}case"/list-builder":{const e={lists:s.leadLists,activeListId:s.leadActiveListId,items:s.leadItems,searchQuery:s.leadSearchQuery,searchArea:s.leadSearchArea,searchBusinessType:s.leadSearchType,searching:s.leadSearching,searchResults:s.leadSearchResults};return Bl(e)}}if(!s.salesSummary||!s.paymentStatus||!s.masterStats||!s.pipelineMeta||!s.customerLedger||!s.salesAnalytics)return"";switch(s.route){case"/sales":return dl(us(s.salesSummary),s.salesFilter.startDate,s.salesFilter.endDate);case"/payment":return Ji([...s.paymentStatus.records].sort((e,t)=>t.balanceAmount-e.balanceAmount));case"/master":return Mi(s.masterStats,s.masterTab,s.masterFilter);case"/invoice":return ki(s.invoiceRecords,s.invoiceFilter);case"/ledger":return Bn(s.customerLedger,s.ledgerCustomerCode);case"/analytics":return ll(s.salesAnalytics,s.analyticsTab,s.analyticsPeriod,s.analyticsPeriodFilter,s.analyticsPeriodRows,s.analyticsPeriodOptions);default:return ti(s.salesSummary,s.pipelineMeta,s.salesAnalytics,{prospects:s.prospects,upcomingEvents:s.calendarEvents,tourInquiries:s.tourInquiries,workflowOrdersCount:{new:s.workflowOrders.filter(e=>e.stage==="new").length,picking:s.workflowOrders.filter(e=>e.stage==="picking").length,packed:s.workflowOrders.filter(e=>e.stage==="packed").length,shipped:s.workflowOrders.filter(e=>e.stage==="shipped").length,total:s.workflowOrders.length},lowStockCount:s.materialList.filter(e=>e.currentStock<e.minimumStock*1.5).length,masterCounts:s.masterStats?{customers:s.masterStats.summary.customerCount,products:s.masterStats.summary.productCount,suppliers:s.syncDashboard?.tables.find(e=>e.tableName==="suppliers")?.rowCount??0,specialPrices:s.syncDashboard?.tables.find(e=>e.tableName==="customer_product_prices")?.rowCount??0}:void 0},s.salesPeriod,s.customRange)}}function Co(){const e={info:{bg:"#edf6ff",border:"#b8d4e8",icon:"ℹ️"},warning:{bg:"#fff8e6",border:"#e6c54d",icon:"⚠️"},maintenance:{bg:"#fff3e0",border:"#f5a623",icon:"🔧"},update:{bg:"#e8f5e9",border:"#66bb6a",icon:"🆕"}},n=s.announcements.filter(r=>!s.dismissedAnnouncements.has(r.id)).map(r=>{const c=e[r.level]??e.info;return`
      ...
      </div>`:"";return n+i}function Io(){if(Ct())return`
    ...
    `;const e={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売業務",items:[{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/quote",label:"見積作成",kicker:"Quote"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],analytics:[{label:"分析",items:[{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/customer-analysis",label:"得意先分析",kicker:"CustABC"},{path:"/product-power",label:"商品力分析",kicker:"Power"},{path:"/customer-efficiency",label:"営業効率",kicker:"Efficiency"},{path:"/demand-forecast",label:"需要予測",kicker:"Forecast"},{path:"/report",label:"集計帳票",kicker:"Report"}]}],crm:[{label:"営業・顧客",items:[{path:"/prospects",label:"新規営業",kicker:"Prospects"},{path:"/map",label:"取引先マップ",kicker:"Map"},{path:"/list-builder",label:"リスト取得",kicker:"ListBuild"},{path:"/calls",label:"通話履歴",kicker:"Calls"},{path:"/email",label:"メール配信",kicker:"Mail"}]},{label:"受注・出荷",items:[{path:"/workflow",label:"受注ワークフロー",kicker:"Workflow"},{path:"/mobile-order",label:"モバイル受注",kicker:"Mobile"},{path:"/shopify",label:"Shopify注文",kicker:"Shopify"},{path:"/fax",label:"FAX OCR",kicker:"FAX"}]}],orders:[{label:"仕入・調達",items:[{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],brewery:[{label:"製造管理",items:[{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"},{path:"/tax",label:"酒税申告",kicker:"Tax"}]}],master:[{label:"マスタ・ツール",items:[{path:"/master",label:"マスタ管理",kicker:"Master"},{path:"/calendar",label:"カレンダー",kicker:"Calendar"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/tour",label:"酒蔵見学",kicker:"Tour"},{path:"/print",label:"印刷",kicker:"Print"}]}],settings:[{label:"システム設定",items:[{path:"/setup",label:"連動設定",kicker:"Setup"},{path:"/integrations",label:"外部連携",kicker:"API"},{path:"/slack",label:"Slack通知",kicker:"Slack"},{path:"/import",label:"データ取込",kicker:"Import"},{path:"/raw-browser",label:"データブラウザ",kicker:"RawData"},{path:"/users",label:"ユーザー管理",kicker:"Users"},{path:"/profile",label:"プロフィール",kicker:"Profile"},{path:"/audit",label:"操作ログ",kicker:"Audit"}]}]},t=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/invoice-entry",label:"販売"},{category:"analytics",path:"/analytics",label:"分析"},{category:"crm",path:"/prospects",label:"営業"},{category:"orders",path:"/purchase",label:"仕入"},{category:"brewery",path:"/jikomi",label:"製造"},{category:"master",path:"/master",label:"マスタ"},{category:"settings",path:"/setup",label:"設定"}],n=e[s.currentCategory].map(l=>`
      ...
      `).join(""),r=s.pickerMode&&s.masterStats?s.pickerMode==="customer"?ri(s.masterStats.customers,s.pickerQuery):Ui(s.masterStats.products,s.pickerQuery):"",c=s.globalSearchOpen?oi(s.globalQuery,Eo()):"",a=s.user?`
  ...
  `}async function Lo(e){s.actionLoading=!0,h();try{s.invoiceRecords=await Be(e)}finally{s.actionLoading=!1,h()}}async function Do(e){s.actionLoading=!0,h();try{s.customerLedger=await gt(e)}finally{s.actionLoading=!1,h()}}function X(e){s.invoiceForm={invoiceType:e.querySelector("#inv-type")?.value??s.invoiceForm.invoiceType,invoiceDate:e.querySelector("#inv-date")?.value??s.invoiceForm.invoiceDate,customerCode:e.querySelector("#inv-customer-code")?.value??s.invoiceForm.customerCode,customerName:e.querySelector("#inv-customer-name")?.value??s.invoiceForm.customerName,staffCode:e.querySelector("#inv-staff")?.value??s.invoiceForm.staffCode,lines:s.invoiceForm.lines.map((t,n)=>{const i=parseFloat(e.querySelector(`[data-line="${n}"][data-field="quantity"]`)?.value??"")||0,r=parseFloat(e.querySelector(`[data-line="${n}"][data-field="unitPrice"]`)?.value??"")||0;return{...t,productCode:e.querySelector(`[data-line="${n}"][data-field="productCode"]`)?.value??t.productCode,productName:e.querySelector(`[data-line="${n}"][data-field="productName"]`)?.value??t.productName,unit:e.querySelector(`[data-line="${n}"][data-field="unit"]`)?.value??t.unit,quantity:i,unitPrice:r,amount:i*r}}),note:e.querySelector("#inv-note")?.value??s.invoiceForm.note},s.invoiceForm.customerCode=s.invoiceForm.customerCode.trim().toUpperCase(),s.invoiceForm.customerName=s.invoiceForm.customerName.trim()}function ie(e){const t=e.querySelector("input[name='email-audience-mode']:checked")?.value??s.emailAudienceMode;s.emailAudienceMode=t,s.emailRegion=e.querySelector("#email-region")?.value??s.emailRegion,s.emailHistorySegment=e.querySelector("#email-history-segment")?.value??s.emailHistorySegment,s.emailSubject=e.querySelector("#email-subject")?.value??s.emailSubject,s.emailBody=e.querySelector("#email-body")?.value??s.emailBody}function qo(e){e.querySelector("[data-action='global-search-open']")?.addEventListener("click",()=>{s.globalSearchOpen=!0,h()}),e.querySelectorAll("[data-action='global-search-close']").forEach(a=>{a.addEventListener("click",l=>{a.classList.contains("global-search")&&l.target instanceof HTMLElement&&!l.target.classList.contains("global-search")||(Se(),h())})}),e.querySelector("#global-search-input")?.addEventListener("input",a=>{s.globalQuery=a.target.value,h()}),e.querySelectorAll("[data-action='global-nav']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.path;l&&(Se(),sa(l))})}),e.querySelector("[data-action='csv-export']")?.addEventListener("click",()=>{Po()}),e.querySelectorAll("[data-jikomi-tab]").forEach(a=>{a.addEventListener("click",()=>{s.jikomiView=a.dataset.jikomiTab,h()})}),e.querySelector("[data-action='auth-login']")?.addEventListener("click",()=>{const a=e.querySelector("#auth-email")?.value.trim()??"",l=e.querySelector("#auth-password")?.value??"";s.authSubmitting=!0,s.authError=null,h(),bs(a,l).then(async o=>{s.user=o,s.authSkipped=!1,s.authSubmitting=!1,s.authError=null;const{fetchMyProfile:d,recordAudit:u}=await f(async()=>{const{fetchMyProfile:p,recordAudit:y}=await Promise.resolve().then(()=>w);return{fetchMyProfile:p,recordAudit:y}},void 0);s.myProfile=await d(o.email),await u({action:"sign_in",userEmail:o.email}),h()}).catch(async o=>{try{const d=await Dt(a,l);s.user=d,s.authSkipped=!1,s.authError=null;const{fetchMyProfile:u}=await f(async()=>{const{fetchMyProfile:p}=await Promise.resolve().then(()=>w);return{fetchMyProfile:p}},void 0);s.myProfile=await u(d.email)}catch{s.authError=o instanceof Error?o.message:"ログインに失敗しました。"}finally{s.authSubmitting=!1,h()}})}),e.querySelector("[data-action='auth-skip']")?.addEventListener("click",()=>{s.authSkipped=!0,s.authError=null,h()}),e.querySelector("[data-action='auth-logout']")?.addEventListener("click",()=>{gs().finally(()=>{location.reload()})}),e.querySelector("[data-action='sidebar-open']")?.addEventListener("click",()=>{s.sidebarOpen=!0,h()}),e.querySelectorAll("[data-action='sidebar-close']").forEach(a=>{a.addEventListener("click",()=>{s.sidebarOpen=!1,h()})});const t=e.querySelector(".sidebar");if(t&&s.sidebarOpen){let a=0;t.addEventListener("touchstart",l=>{a=l.touches[0].clientX},{passive:!0}),t.addEventListener("touchend",l=>{l.changedTouches[0].clientX-a<-60&&(s.sidebarOpen=!1,h())},{passive:!0})}e.querySelectorAll("[data-action='dismiss-announcement']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.id??"";s.dismissedAnnouncements.add(l),h()})}),e.querySelector("[data-action='reload-app']")?.addEventListener("click",()=>{location.reload()}),e.querySelectorAll("[data-link]").forEach(a=>{a.addEventListener("click",l=>{l.preventDefault(),sa(a.dataset.link)})}),e.querySelector("#feature-request-form")?.addEventListener("submit",async a=>{a.preventDefault();const l=e.querySelector("#fr-title")?.value??"",o=e.querySelector("#fr-category")?.value??"feature",d=e.querySelector("#fr-description")?.value??"",u=e.querySelector("#fr-result");if(!l.trim())return;const p=await ga(l,o,d);if(u&&(u.textContent=p?"送信しました":"送信に失敗しました",u.className=`fr-result ${p?"success":"error"}`),p){const y=e.querySelector("#feature-request-form");y&&y.reset()}}),e.querySelectorAll("[data-period]").forEach(a=>{a.addEventListener("click",()=>{s.salesPeriod=a.dataset.period,h()})}),e.querySelector("[data-action='apply-range']")?.addEventListener("click",()=>{const a=e.querySelector("#range-start")?.value??"",l=e.querySelector("#range-end")?.value??"";a&&l&&(s.customRange={start:a,end:l},s.salesPeriod="custom",h())}),e.querySelectorAll("[data-edit-customer]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.editCustomer??"",o=s.masterStats?.customers.find(u=>u.id===l);if(!o)return;const d=document.createElement("div");d.innerHTML=Di(o),document.body.appendChild(d.firstElementChild),document.querySelector("[data-action='close-modal']")?.addEventListener("click",()=>{document.getElementById("edit-modal")?.remove()}),document.getElementById("edit-customer-form")?.addEventListener("submit",async u=>{u.preventDefault();const p=document.getElementById("edit-result"),y=await $a(l,{name:document.getElementById("ec-name").value,kana_name:document.getElementById("ec-kana").value,phone:document.getElementById("ec-phone").value,fax:document.getElementById("ec-fax").value,postal_code:document.getElementById("ec-postal").value,address1:document.getElementById("ec-address").value,closing_day:parseInt(document.getElementById("ec-closing").value)||null,payment_day:parseInt(document.getElementById("ec-payment").value)||null,manual_override:!0});p&&(p.textContent=y?"保存しました":"保存に失敗",p.className=`fr-result ${y?"success":"error"}`),y&&(document.getElementById("edit-modal")?.remove(),ke())})})}),e.querySelectorAll("[data-edit-product]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.editProduct??"",o=s.masterStats?.products.find(u=>u.id===l);if(!o)return;const d=document.createElement("div");d.innerHTML=qi(o),document.body.appendChild(d.firstElementChild),document.querySelector("[data-action='close-modal']")?.addEventListener("click",()=>{document.getElementById("edit-modal")?.remove()}),document.getElementById("edit-product-form")?.addEventListener("submit",async u=>{u.preventDefault();const p=document.getElementById("edit-result"),y=await _a(l,{name:document.getElementById("ep-name").value,category_code:document.getElementById("ep-category").value,alcohol_degree:parseFloat(document.getElementById("ep-alcohol").value)||null,volume_ml:parseInt(document.getElementById("ep-volume").value)||null,bottle_type:document.getElementById("ep-bottle").value,purchase_price:parseInt(document.getElementById("ep-purchase").value)||null,default_sale_price:parseInt(document.getElementById("ep-sale").value)||null,manual_override:!0});p&&(p.textContent=y?"保存しました":"保存に失敗",p.className=`fr-result ${y?"success":"error"}`),y&&(document.getElementById("edit-modal")?.remove(),ke())})})}),e.querySelector("#q-cust-search")?.addEventListener("input",a=>{s.quoteCustomerQuery=a.target.value,h()}),e.querySelector("#q-prod-search")?.addEventListener("input",a=>{s.quoteProductQuery=a.target.value,h()}),e.querySelectorAll("[data-select-customer]").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.selectCustomer??"";s.quoteState.customerCode=l,s.quoteState.customerName=a.dataset.custName??"",s.quoteState.customerAddress=a.dataset.custAddr??"",s.quoteCustomerQuery="",s.quotePricing=await wa(s.masterStats?.customers??[],l),h()})}),e.querySelectorAll("[data-add-product]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.addProduct??"",o=a.dataset.prodName??"",d=parseInt(a.dataset.prodPrice??"0");s.quoteState.lines.push({productCode:l,productName:o,quantity:1,unit:"本",unitPrice:d,amount:d}),s.quoteProductQuery="",h()})}),e.querySelectorAll(".qty-input").forEach(a=>{a.addEventListener("change",()=>{const l=parseInt(a.dataset.lineIdx??"0"),o=s.quoteState.lines[l];o&&(o.quantity=parseInt(a.value)||0,o.amount=o.quantity*o.unitPrice,h())})}),e.querySelectorAll(".price-input").forEach(a=>{a.addEventListener("change",()=>{const l=parseInt(a.dataset.lineIdx??"0"),o=s.quoteState.lines[l];o&&(o.unitPrice=parseInt(a.value)||0,o.amount=o.quantity*o.unitPrice,h())})}),e.querySelectorAll("[data-remove-line]").forEach(a=>{a.addEventListener("click",()=>{const l=parseInt(a.dataset.removeLine??"0");s.quoteState.lines.splice(l,1),h()})}),e.querySelector("[data-action='save-quote']")?.addEventListener("click",async()=>{const a=s.quoteState;a.quoteNo=a.quoteNo||`Q${Date.now().toString(36).toUpperCase()}`,a.quoteDate=document.getElementById("q-date")?.value??a.quoteDate,a.validUntil=document.getElementById("q-valid")?.value??"",a.subject=document.getElementById("q-subject")?.value??"",a.remarks=document.getElementById("q-remarks")?.value??"",a.deliveryDate=document.getElementById("q-delivery-date")?.value??a.deliveryDate,a.paymentTerms=document.getElementById("q-payment-terms")?.value??a.paymentTerms,a.deliveryPlace=document.getElementById("q-delivery-place")?.value??a.deliveryPlace,a.fieldConfig.headerNote=document.getElementById("q-header-note")?.value??a.fieldConfig.headerNote,a.fieldConfig.footerNote=document.getElementById("q-footer-note")?.value??a.fieldConfig.footerNote;const l=a.lines.reduce((p,y)=>p+y.amount,0),o=Math.round(l*a.taxRate/100),{supabaseInsert:d}=await f(async()=>{const{supabaseInsert:p}=await Promise.resolve().then(()=>q);return{supabaseInsert:p}},void 0),u=await d("quotes",{quote_no:a.quoteNo,quote_date:a.quoteDate,valid_until:a.validUntil||null,legacy_customer_code:a.customerCode,customer_name:a.customerName,customer_address:a.customerAddress,subject:a.subject,subtotal:l,tax_amount:o,total_amount:l+o,remarks:a.remarks});if(u?.id){for(let p=0;p<a.lines.length;p++){const y=a.lines[p];await d("quote_lines",{quote_id:u.id,line_no:p+1,legacy_product_code:y.productCode,product_name:y.productName,quantity:y.quantity,unit:y.unit,unit_price:y.unitPrice,amount:y.amount})}alert(`見積 ${a.quoteNo} を保存しました`),s.quoteState={...Wa},h()}}),e.querySelector("[data-action='quote-preview-mode']")?.addEventListener("click",()=>{const a=s.quoteState;a.quoteDate=document.getElementById("q-date")?.value??a.quoteDate,a.validUntil=document.getElementById("q-valid")?.value??a.validUntil,a.subject=document.getElementById("q-subject")?.value??a.subject,a.remarks=document.getElementById("q-remarks")?.value??a.remarks,a.quoteNo=document.getElementById("q-no")?.value??a.quoteNo,a.deliveryDate=document.getElementById("q-delivery-date")?.value??a.deliveryDate,a.paymentTerms=document.getElementById("q-payment-terms")?.value??a.paymentTerms,a.deliveryPlace=document.getElementById("q-delivery-place")?.value??a.deliveryPlace,a.fieldConfig.headerNote=document.getElementById("q-header-note")?.value??a.fieldConfig.headerNote,a.fieldConfig.footerNote=document.getElementById("q-footer-note")?.value??a.fieldConfig.footerNote,a.previewMode=!0,h()}),e.querySelector("[data-action='quote-edit-mode']")?.addEventListener("click",()=>{s.quoteState.previewMode=!1,h()}),e.querySelector("[data-action='quote-download-pdf']")?.addEventListener("click",()=>{const a=s.quoteState;a.previewMode||(a.quoteDate=document.getElementById("q-date")?.value??a.quoteDate,a.validUntil=document.getElementById("q-valid")?.value??a.validUntil,a.subject=document.getElementById("q-subject")?.value??a.subject,a.remarks=document.getElementById("q-remarks")?.value??a.remarks,a.quoteNo=document.getElementById("q-no")?.value??a.quoteNo,a.deliveryDate=document.getElementById("q-delivery-date")?.value??a.deliveryDate,a.paymentTerms=document.getElementById("q-payment-terms")?.value??a.paymentTerms,a.deliveryPlace=document.getElementById("q-delivery-place")?.value??a.deliveryPlace,a.fieldConfig.headerNote=document.getElementById("q-header-note")?.value??a.fieldConfig.headerNote,a.fieldConfig.footerNote=document.getElementById("q-footer-note")?.value??a.fieldConfig.footerNote),hi(a)}),e.querySelectorAll("[data-field-toggle]").forEach(a=>{a.addEventListener("change",()=>{const l=a.dataset.fieldToggle;l&&typeof s.quoteState.fieldConfig[l]=="boolean"&&(s.quoteState.fieldConfig[l]=a.checked,h())})}),e.querySelector("#q-seal-file")?.addEventListener("change",a=>{const l=a.target.files?.[0];if(!l)return;const o=new FileReader;o.onload=()=>{s.quoteState.sealSettings={imageDataUrl:o.result,size:72},localStorage.setItem("quote-seal",JSON.stringify(s.quoteState.sealSettings)),h()},o.readAsDataURL(l)}),e.querySelector("#q-seal-size")?.addEventListener("input",a=>{const l=parseInt(a.target.value);s.quoteState.sealSettings&&(s.quoteState.sealSettings.size=l,localStorage.setItem("quote-seal",JSON.stringify(s.quoteState.sealSettings)),h())}),e.querySelector("[data-action='remove-seal']")?.addEventListener("click",()=>{s.quoteState.sealSettings=null,localStorage.removeItem("quote-seal"),h()}),e.querySelectorAll("[data-action='dcal-prev'],[data-action='dcal-next']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.month;l&&(s.demandForecast.calendarMonth=l,h())})}),e.querySelectorAll("[data-action='forecast-segment']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.segment;s.demandForecast.selectedSegment=l,h()})}),e.querySelectorAll("[data-product-period]").forEach(a=>{a.addEventListener("click",()=>{s.productPeriod=a.dataset.productPeriod??"year",h()})}),e.querySelector("[data-action='pp-apply-range']")?.addEventListener("click",()=>{const a=document.getElementById("pp-range-start")?.value??"",l=document.getElementById("pp-range-end")?.value??"";a&&l&&(s.productCustomStart=a,s.productCustomEnd=l,s.productPeriod="custom",h())}),e.querySelectorAll("[data-product-filter]").forEach(a=>{a.addEventListener("click",()=>{s.productFilter=a.dataset.productFilter??"all",h()})}),e.querySelector("[data-action='dashboard-refresh']")?.addEventListener("click",async a=>{const l=a.currentTarget;l.disabled=!0,l.textContent="更新中…",await ke(),l.disabled=!1,l.textContent="↻ 更新",_("ダッシュボードを更新しました","success")}),e.querySelector("[data-action='sales-filter']")?.addEventListener("click",()=>{const a=e.querySelector("#sales-start")?.value??"",l=e.querySelector("#sales-end")?.value??"";s.salesFilter={startDate:a,endDate:l},h()}),e.querySelector("[data-action='invoice-filter']")?.addEventListener("click",()=>{const a={documentNo:e.querySelector("#invoice-document-no")?.value??"",startDate:e.querySelector("#invoice-start")?.value??"",endDate:e.querySelector("#invoice-end")?.value??"",customerCode:e.querySelector("#invoice-customer-code")?.value??""};s.invoiceFilter=a,Lo(a)}),e.querySelector("[data-action='ledger-search']")?.addEventListener("click",()=>{const a=e.querySelector("#ledger-customer-code")?.value??"";s.ledgerCustomerCode=a.trim().toUpperCase(),Do(s.ledgerCustomerCode)}),e.querySelectorAll("[data-tab]").forEach(a=>{a.addEventListener("click",()=>{s.masterTab=a.dataset.tab,s.masterFilter={...At},h()})}),e.querySelector("[data-action='master-filter']")?.addEventListener("click",()=>{s.masterFilter={query:e.querySelector("#master-search")?.value??"",businessType:e.querySelector("#master-business-type")?.value??"",areaCode:e.querySelector("#master-area-code")?.value??"",activeOnly:e.querySelector("#master-active-only")?.value??"",page:1},h()}),e.querySelector("#master-search")?.addEventListener("keydown",a=>{a.key==="Enter"&&e.querySelector("[data-action='master-filter']")?.click()}),e.querySelectorAll("[data-action='master-page']").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.page);l>=1&&(s.masterFilter={...s.masterFilter,page:l},h())})}),e.querySelectorAll("[data-action='raw-select-table']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.table;if(!l)return;s.rawSelectedTable=l,s.rawPage=1;const o=await Fe(l,1);s.rawRecords=o.records,s.rawTotalCount=o.total,h()})}),e.querySelector("[data-action='raw-page-prev']")?.addEventListener("click",async()=>{if(!s.rawSelectedTable||s.rawPage<=1)return;s.rawPage-=1;const a=await Fe(s.rawSelectedTable,s.rawPage);s.rawRecords=a.records,s.rawTotalCount=a.total,h()}),e.querySelector("[data-action='raw-page-next']")?.addEventListener("click",async()=>{if(!s.rawSelectedTable)return;s.rawPage+=1;const a=await Fe(s.rawSelectedTable,s.rawPage);s.rawRecords=a.records,s.rawTotalCount=a.total,h()}),e.querySelectorAll("[data-analytics-tab]").forEach(a=>{a.addEventListener("click",async()=>{if(s.analyticsTab=a.dataset.analyticsTab,s.analyticsPeriod!=="all"){const{fetchAnalyticsByPeriod:l,fetchAvailablePeriods:o}=await f(async()=>{const{fetchAnalyticsByPeriod:d,fetchAvailablePeriods:u}=await Promise.resolve().then(()=>w);return{fetchAnalyticsByPeriod:d,fetchAvailablePeriods:u}},void 0);s.analyticsPeriodOptions=await o(s.analyticsTab,s.analyticsPeriod),s.analyticsPeriodFilter=s.analyticsPeriodOptions[0]??"",s.analyticsPeriodRows=await l(s.analyticsTab,s.analyticsPeriod,s.analyticsPeriodFilter)}h()})}),e.querySelectorAll("[data-analytics-period]").forEach(a=>{a.addEventListener("click",async()=>{const{fetchAnalyticsByPeriod:l,fetchAvailablePeriods:o}=await f(async()=>{const{fetchAnalyticsByPeriod:u,fetchAvailablePeriods:p}=await Promise.resolve().then(()=>w);return{fetchAnalyticsByPeriod:u,fetchAvailablePeriods:p}},void 0),d=a.dataset.analyticsPeriod;s.analyticsPeriod=d,d==="all"?(s.analyticsPeriodRows=[],s.analyticsPeriodOptions=[],s.analyticsPeriodFilter=""):(s.analyticsPeriodOptions=await o(s.analyticsTab,d),s.analyticsPeriodFilter=s.analyticsPeriodOptions[0]??"",s.analyticsPeriodRows=await l(s.analyticsTab,d,s.analyticsPeriodFilter)),h()})}),e.querySelector("#analytics-period-select")?.addEventListener("change",async a=>{const{fetchAnalyticsByPeriod:l}=await f(async()=>{const{fetchAnalyticsByPeriod:o}=await Promise.resolve().then(()=>w);return{fetchAnalyticsByPeriod:o}},void 0);s.analyticsPeriodFilter=a.target.value,s.analyticsPeriodRows=await l(s.analyticsTab,s.analyticsPeriod,s.analyticsPeriodFilter),h()}),e.querySelector("[data-action='add-line']")?.addEventListener("click",()=>{X(e),s.invoiceForm.lines.push({productCode:"",productName:"",quantity:0,unitPrice:0,unit:"本",amount:0}),s.invoiceErrors={},h()}),e.querySelectorAll("[data-action='remove-line']").forEach(a=>{a.addEventListener("click",()=>{X(e);const l=parseInt(a.dataset.line??"0",10);s.invoiceForm.lines.splice(l,1),s.invoiceErrors=cs(s.invoiceForm),h()})}),e.querySelectorAll("[data-action='duplicate-line']").forEach(a=>{a.addEventListener("click",()=>{X(e),wo(parseInt(a.dataset.line??"0",10)),s.invoiceErrors={},h()})}),e.querySelector("[data-action='copy-past-invoice']")?.addEventListener("click",()=>{ko(),h()}),e.querySelector("[data-action='open-customer-picker']")?.addEventListener("click",()=>{X(e),s.pickerMode="customer",s.pickerTargetLine=null,s.pickerQuery=s.invoiceForm.customerCode||s.invoiceForm.customerName,h()}),e.querySelectorAll("[data-action='open-product-picker']").forEach(a=>{a.addEventListener("click",()=>{X(e);const l=parseInt(a.dataset.line??"0",10),o=s.invoiceForm.lines[l];s.pickerMode="product",s.pickerTargetLine=l,s.pickerQuery=o?o.productCode||o.productName:"",h()})}),e.querySelectorAll("[data-action='modal-close']").forEach(a=>{a.addEventListener("click",l=>{a.classList.contains("modal-backdrop")&&l.target instanceof HTMLElement&&!l.target.classList.contains("modal-backdrop")||(Ue(),h())})}),e.querySelectorAll("[data-action='picker-select']").forEach(a=>{const l=async()=>{const o=a.dataset.code??"",d=a.dataset.name??"";if(s.pickerMode==="customer"){s.invoiceForm.customerCode=o,s.invoiceForm.customerName=d,delete s.invoiceErrors.customerCode;const u=s.masterStats?.customers.find(p=>p.code===o);s.invoicePriceGroup=u?.priceGroup||"",!s.invoicePriceGroup&&o&&(s.invoicePriceGroup=await ct(o))}else if(s.pickerMode==="product"&&s.pickerTargetLine!==null){const u=s.invoiceForm.lines[s.pickerTargetLine];if(u){u.productCode=o,u.productName=d;const p=await Ya(s.invoicePriceGroup,o);p>0&&(u.unitPrice=p),u.amount=u.quantity*u.unitPrice,delete s.invoiceErrors[`lines.${s.pickerTargetLine}.productCode`],delete s.invoiceErrors[`lines.${s.pickerTargetLine}.productName`]}}Ue(),h()};a.addEventListener("click",l),a.addEventListener("keydown",o=>{o.key==="Enter"&&l()})}),e.querySelector("#modal-search")?.addEventListener("input",a=>{s.pickerQuery=a.target.value,h()}),e.querySelector("[data-action='invoice-clear']")?.addEventListener("click",()=>{rs(),h()}),e.querySelector("[data-action='invoice-save']")?.addEventListener("click",()=>{ds(e)}),e.querySelector("#inv-customer-code")?.addEventListener("blur",async()=>{X(e),So(s.invoiceForm.customerCode)&&(delete s.invoiceErrors.customerCode,!s.invoicePriceGroup&&s.invoiceForm.customerCode&&(s.invoicePriceGroup=await ct(s.invoiceForm.customerCode)),h())}),e.querySelector("#inv-customer-name")?.addEventListener("blur",()=>{X(e),xo(s.invoiceForm.customerName)&&(delete s.invoiceErrors.customerCode,h())}),e.querySelectorAll("#inv-date, #inv-customer-code, #inv-customer-name, #inv-staff, #inv-note, [data-field], #inv-type").forEach(a=>{a.addEventListener("input",()=>{X(e),s.invoiceSavedDocNo=null;const l=a.dataset.field;(l==="quantity"||l==="unitPrice")&&h()})}),e.querySelector("#inv-type")?.addEventListener("change",()=>{X(e),s.invoiceSavedDocNo=null}),e.querySelector("[data-action='delivery-search']")?.addEventListener("click",()=>{const a=e.querySelector("#delivery-docno")?.value??"";s.deliverySearchDocNo=a.trim(),s.deliveryNote=null,s.actionLoading=!0,h(),$t(s.deliverySearchDocNo||"D240122").then(l=>{s.deliveryNote=l,s.actionLoading=!1,h()})}),e.querySelector("[data-action='billing-load']")?.addEventListener("click",()=>{const a=e.querySelector("#billing-month")?.value??s.billingYearMonth;s.billingYearMonth=a,s.billingSummary=null,s.actionLoading=!0,h(),_t(a).then(l=>{s.billingSummary=l,s.actionLoading=!1,h()})}),e.querySelector("[data-action='tax-load']")?.addEventListener("click",()=>{const a=parseInt(e.querySelector("#tax-year")?.value??String(s.taxYear),10),l=parseInt(e.querySelector("#tax-month")?.value??String(s.taxMonth),10);s.taxYear=a,s.taxMonth=l,s.taxDeclaration=null,s.actionLoading=!0,h(),wt(a,l).then(o=>{s.taxDeclaration=o,s.actionLoading=!1,h()})}),e.querySelector("[data-action='tax-export-xml']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{generateTaxXML:a}=await f(async()=>{const{generateTaxXML:p}=await Promise.resolve().then(()=>w);return{generateTaxXML:p}},void 0),l=a(s.taxDeclaration),o=new Blob([l],{type:"application/xml;charset=utf-8"}),d=URL.createObjectURL(o),u=document.createElement("a");u.href=d,u.download=`tax-${s.taxYear}-${String(s.taxMonth).padStart(2,"0")}.xml`,u.click(),URL.revokeObjectURL(d)}),e.querySelector("[data-action='tax-export-csv']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{generateTaxCSV:a}=await f(async()=>{const{generateTaxCSV:p}=await Promise.resolve().then(()=>w);return{generateTaxCSV:p}},void 0),l=a(s.taxDeclaration),o=new Blob([l],{type:"text/csv;charset=utf-8"}),d=URL.createObjectURL(o),u=document.createElement("a");u.href=d,u.download=`tax-${s.taxYear}-${String(s.taxMonth).padStart(2,"0")}.csv`,u.click(),URL.revokeObjectURL(d)}),e.querySelector("[data-action='tax-save-draft']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{saveTaxDeclaration:a}=await f(async()=>{const{saveTaxDeclaration:l}=await Promise.resolve().then(()=>w);return{saveTaxDeclaration:l}},void 0);try{await a(s.taxDeclaration),_("下書き保存しました")}catch(l){_("保存に失敗: "+(l instanceof Error?l.message:String(l)),"error")}}),e.querySelectorAll("[data-tax-row][data-tax-field]").forEach(a=>{a.addEventListener("change",async()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.taxRow),o=a.dataset.taxField,d=a.type==="number"?Number(a.value)||0:a.value,u=[...s.taxDeclaration.rows];u[l]={...u[l],[o]:d};const{recalculateTaxDeclaration:p}=await f(async()=>{const{recalculateTaxDeclaration:y}=await Promise.resolve().then(()=>w);return{recalculateTaxDeclaration:y}},void 0);s.taxDeclaration=p({...s.taxDeclaration,rows:u}),h()})}),e.querySelectorAll("[data-ded-row][data-ded-field]").forEach(a=>{a.addEventListener("change",()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.dedRow),o=a.dataset.dedField,d=a.type==="number"?Number(a.value)||0:a.value,u=[...s.taxDeclaration.deductions];u[l]={...u[l],[o]:d},s.taxDeclaration={...s.taxDeclaration,deductions:u},h()})}),e.querySelectorAll("input[data-tax-field]:not([data-tax-row])").forEach(a=>{a.addEventListener("change",()=>{if(!s.taxDeclaration)return;const l=a.dataset.taxField;s.taxDeclaration={...s.taxDeclaration,[l]:a.value}})}),e.querySelector("[data-action='tax-add-category']")?.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const{recalculateTaxDeclaration:a,TAX_RATE_CATEGORIES:l}=await f(async()=>{const{recalculateTaxDeclaration:u,TAX_RATE_CATEGORIES:p}=await Promise.resolve().then(()=>w);return{recalculateTaxDeclaration:u,TAX_RATE_CATEGORIES:p}},void 0),o=l[0],d={taxCategory:o.code,taxCategoryName:o.name,alcoholDegree:15,productionVolume:0,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:0,taxableVolume:0,volume:0,taxRate:o.taxRatePerLiter,taxAmount:0};s.taxDeclaration=a({...s.taxDeclaration,rows:[...s.taxDeclaration.rows,d]}),h()}),e.querySelectorAll("[data-action='tax-remove-category']").forEach(a=>{a.addEventListener("click",async()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.taxRow),{recalculateTaxDeclaration:o}=await f(async()=>{const{recalculateTaxDeclaration:u}=await Promise.resolve().then(()=>w);return{recalculateTaxDeclaration:u}},void 0),d=s.taxDeclaration.rows.filter((u,p)=>p!==l);s.taxDeclaration=o({...s.taxDeclaration,rows:d}),h()})}),e.querySelector("[data-action='tax-add-deduction']")?.addEventListener("click",()=>{if(!s.taxDeclaration)return;const a={type:"export",categoryCode:"01",volume:0,reason:"",documentNo:""};s.taxDeclaration={...s.taxDeclaration,deductions:[...s.taxDeclaration.deductions,a]},h()}),e.querySelectorAll("[data-action='tax-remove-deduction']").forEach(a=>{a.addEventListener("click",()=>{if(!s.taxDeclaration)return;const l=Number(a.dataset.dedRow),o=s.taxDeclaration.deductions.filter((d,u)=>u!==l);s.taxDeclaration={...s.taxDeclaration,deductions:o},h()})}),e.querySelectorAll("[data-store-tab]").forEach(a=>{a.addEventListener("click",()=>{s.storeTab=a.dataset.storeTab,h()})}),e.querySelectorAll("[data-import-entity]").forEach(a=>{a.addEventListener("click",()=>{s.importEntity=a.dataset.importEntity,s.importPreview=null,s.importResult=null,h()})}),e.querySelector("[data-action='download-template']")?.addEventListener("click",()=>{const a=Kl(s.importEntity),l=new Blob([a],{type:"text/csv;charset=utf-8"}),o=URL.createObjectURL(l),d=document.createElement("a");d.href=o,d.download=`template_${s.importEntity}.csv`,d.click(),URL.revokeObjectURL(o)}),e.querySelector("[data-action='import-parse']")?.addEventListener("click",()=>{const l=e.querySelector("#import-file")?.files?.[0];if(!l){_("CSVファイルを選択してください","warning");return}const o=new FileReader;o.onload=()=>{const d=String(o.result??""),{columns:u,rows:p}=Ql(d);s.importPreview=Wl(s.importEntity,u,p),s.importResult=null,h()},o.readAsText(l,"utf-8")}),e.querySelector("[data-action='import-cancel']")?.addEventListener("click",()=>{s.importPreview=null,s.importResult=null,h()}),e.querySelectorAll("[data-print-template]").forEach(a=>{a.addEventListener("click",()=>{s.printTemplate=a.dataset.printTemplate,h()})}),e.querySelectorAll("[data-print-field]").forEach(a=>{a.addEventListener("change",()=>{const l=a.dataset.printField;let o=a.value;(l==="taxRate"||l==="previousBalance"||l==="paymentAmount")&&(o=Number(a.value)||0),s.printData={...s.printData,[l]:o},h()})}),e.querySelectorAll("[data-print-opt]").forEach(a=>{const l=()=>{const o=a.dataset.printOpt;let d;a.type==="checkbox"?d=a.checked:o==="copies"?d=Number(a.value)||1:o==="overlayOpacity"||o==="calibrationOffsetX"||o==="calibrationOffsetY"?d=Number(a.value)||0:d=a.value,s.printOptions={...s.printOptions,[o]:d},h()};a.addEventListener("change",l),a.type==="range"&&a.addEventListener("input",l)}),e.querySelectorAll("[data-print-line][data-print-lfield]").forEach(a=>{a.addEventListener("change",()=>{const l=Number(a.dataset.printLine),o=a.dataset.printLfield,d=[...s.printData.lines];let u=a.value;(o==="quantity"||o==="unitPrice")&&(u=Number(a.value)||0),d[l]={...d[l],[o]:u},d[l].amount=(Number(d[l].quantity)||0)*(Number(d[l].unitPrice)||0),s.printData={...s.printData,lines:d},h()})}),e.querySelector("[data-action='print-add-line']")?.addEventListener("click",()=>{s.printData={...s.printData,lines:[...s.printData.lines,{productCode:"",productName:"",spec:"",quantity:0,unit:"本",unitPrice:0,amount:0}]},h()}),e.querySelectorAll("[data-action='print-remove-line']").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.printLine);s.printData={...s.printData,lines:s.printData.lines.filter((o,d)=>d!==l)},h()})}),e.querySelector("[data-action='print-save-settings']")?.addEventListener("click",()=>{try{localStorage.setItem("sake_print_options",JSON.stringify(s.printOptions)),localStorage.setItem("sake_print_company",JSON.stringify(s.printCompany)),_("印刷設定を保存しました")}catch(a){_("保存失敗: "+(a instanceof Error?a.message:String(a)),"error")}}),e.querySelector("[data-action='print-open-company']")?.addEventListener("click",()=>{const a=s.printCompany,l=prompt("会社名",a.name);if(l===null)return;const o=prompt("郵便番号",a.postalCode)??a.postalCode,d=prompt("住所",a.address1)??a.address1,u=prompt("TEL",a.tel)??a.tel,p=prompt("FAX",a.fax)??a.fax,y=prompt("適格請求書登録番号 (T+13桁)",a.registrationNo)??a.registrationNo,v=prompt("取引銀行名",a.bankName)??a.bankName,$=prompt("支店名",a.bankBranch)??a.bankBranch,E=prompt("口座番号",a.bankAccountNo)??a.bankAccountNo,k=prompt("口座名義",a.bankAccountHolder)??a.bankAccountHolder;s.printCompany={...a,name:l,postalCode:o,address1:d,tel:u,fax:p,registrationNo:y,bankName:v,bankBranch:$,bankAccountNo:E,bankAccountHolder:k},h()}),e.querySelector("[data-action='fd-toggle-design']")?.addEventListener("click",()=>{s.fdDesignMode=!s.fdDesignMode,h()}),e.querySelector("[data-action='fd-save-cloud']")?.addEventListener("click",async()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const o=(e.querySelector("#fd-layout-name")?.value??"").trim()||"デフォルト",d=tt(a),{savePrintLayout:u}=await f(async()=>{const{savePrintLayout:y}=await Promise.resolve().then(()=>w);return{savePrintLayout:y}},void 0),p={id:`bp1701_${o.replaceAll(/[^a-zA-Z0-9_-]/g,"_")}_${Date.now()}`,name:o,templateKey:"chain_store",positions:d};try{await u(p)?(_(`クラウド保存成功: ${o}`),s.fdSavedPositions=d,localStorage.setItem("sake_fd_positions",JSON.stringify(d)),h()):(_("クラウド保存に失敗しました。ローカルには保存されました","warning"),localStorage.setItem("sake_fd_positions",JSON.stringify(d)))}catch(y){_("保存エラー: "+(y instanceof Error?y.message:""),"error")}}),e.querySelector("[data-action='fd-save-local']")?.addEventListener("click",()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const l=tt(a);s.fdSavedPositions=l;try{localStorage.setItem("sake_fd_positions",JSON.stringify(l)),_(`ローカル保存完了: ${Object.keys(l).length}件`)}catch(o){_("保存失敗: "+(o instanceof Error?o.message:""),"error")}}),e.querySelector("[data-action='fd-export-json']")?.addEventListener("click",()=>{const a=e.querySelector(".fd-canvas");if(!a)return;const o={templateKey:"chain_store",positions:tt(a),exportedAt:new Date().toISOString()},d=new Blob([JSON.stringify(o,null,2)],{type:"application/json"}),u=URL.createObjectURL(d),p=document.createElement("a");p.href=u,p.download=`bp1701_layout_${new Date().toISOString().slice(0,10)}.json`,p.click(),URL.revokeObjectURL(u)}),e.querySelector("[data-action='fd-import-json']")?.addEventListener("click",()=>{e.querySelector("#fd-import-file")?.click()}),e.querySelector("#fd-import-file")?.addEventListener("change",async a=>{const l=a.target.files?.[0];if(l)try{const o=await l.text(),u=JSON.parse(o).positions;if(!u)throw new Error("positions field not found");s.fdSavedPositions=u,localStorage.setItem("sake_fd_positions",JSON.stringify(u)),_(`インポート成功: ${Object.keys(u).length}件`),h()}catch(o){_("インポート失敗: "+(o instanceof Error?o.message:""),"error")}});const n=e.querySelector("#fd-saved-layouts");n&&s.route==="/form-designer"&&s.fdDesignMode&&(async()=>{const{fetchPrintLayouts:a}=await f(async()=>{const{fetchPrintLayouts:o}=await Promise.resolve().then(()=>w);return{fetchPrintLayouts:o}},void 0),l=await a("chain_store");l.length===0?n.innerHTML="☁️ クラウドに保存されたレイアウトはありません":(n.innerHTML=`☁️ クラウド保存済み (${l.length}件):<br/>`+l.map(o=>`<button class="button-sm secondary" data-action="fd-load-layout" data-layout-id="${o.id}" style="margin:4px 4px 0 0;">${o.name}</button>
                 <button class="button-sm secondary" data-action="fd-delete-layout" data-layout-id="${o.id}" title="削除" style="margin:4px 8px 0 0;color:var(--danger);">✕</button>`).join(""),n.querySelectorAll("[data-action='fd-load-layout']").forEach(o=>{o.addEventListener("click",()=>{const d=o.dataset.layoutId,u=l.find(p=>p.id===d);u&&(s.fdSavedPositions=u.positions,localStorage.setItem("sake_fd_positions",JSON.stringify(u.positions)),_(`読込完了: ${u.name}`),h())})}),n.querySelectorAll("[data-action='fd-delete-layout']").forEach(o=>{o.addEventListener("click",async()=>{const d=o.dataset.layoutId;if(!d||!await W("このレイアウトを削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deletePrintLayout:u}=await f(async()=>{const{deletePrintLayout:y}=await Promise.resolve().then(()=>w);return{deletePrintLayout:y}},void 0);await u(d)?(_("削除しました"),h()):_("削除失敗","error")})}))})(),e.querySelector("[data-action='fd-reset-positions']")?.addEventListener("click",async()=>{await W("フィールド位置を初期値に戻しますか？")&&(s.fdSavedPositions=null,localStorage.removeItem("sake_fd_positions"),h())});const i=e.querySelector("#fd-sel-x"),r=e.querySelector("#fd-sel-y");[i,r].forEach(a=>{a?.addEventListener("change",()=>{if(!s.fdActiveFieldId)return;const l=document.querySelector(`[data-fd-id="${s.fdActiveFieldId}"]`);l&&(i&&(l.style.left=i.value+"mm"),r&&(l.style.top=r.value+"mm"))})});const c=e.querySelector("#customer-map");c&&s.route==="/map"&&ys(c),e.querySelectorAll(".wf-card").forEach(a=>{a.addEventListener("dragstart",l=>{a.classList.add("wf-dragging"),l.dataTransfer?.setData("text/plain",a.dataset.wfOrder??"")}),a.addEventListener("dragend",()=>a.classList.remove("wf-dragging"))}),e.querySelectorAll(".wf-col").forEach(a=>{a.addEventListener("dragover",l=>l.preventDefault()),a.addEventListener("drop",l=>{l.preventDefault();const o=l.dataTransfer?.getData("text/plain"),d=a.dataset.wfStage;if(!o||!d)return;const u=s.workflowOrders.find(p=>p.id===o);u&&(u.stage=d,h())})}),e.querySelectorAll("[data-mo-step]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moStep;a.disabled||(s.mobileOrder.step=l,h())})}),e.querySelector("#mo-customer-q")?.addEventListener("input",a=>{s.mobileOrder.customerQuery=a.target.value,h()}),e.querySelector("#mo-product-q")?.addEventListener("input",a=>{s.mobileOrder.productQuery=a.target.value,h()}),e.querySelectorAll("[data-mo-select-customer]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moSelectCustomer,o=s.masterStats?.customers.find(d=>d.id===l);o&&(s.mobileOrder.selectedCustomer=o),h()})}),e.querySelectorAll("[data-mo-add-product]").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.moAddProduct,o=s.masterStats?.products.find(u=>u.code===l);if(!o)return;const d=1800;s.mobileOrder.cart.push({productCode:o.code,productName:o.name,quantity:1,unit:"本",unitPrice:d,amount:d}),h()})}),e.querySelectorAll("[data-mo-qty]").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.moQty),o=a.dataset.moProduct,d=s.mobileOrder.cart.find(u=>u.productCode===o);d&&(d.quantity=Math.max(0,d.quantity+l),d.amount=d.quantity*d.unitPrice,d.quantity===0&&(s.mobileOrder.cart=s.mobileOrder.cart.filter(u=>u.productCode!==o)),h())})}),e.querySelectorAll("[data-mo-remove]").forEach(a=>{a.addEventListener("click",()=>{const l=Number(a.dataset.moRemove);s.mobileOrder.cart.splice(l,1),h()})}),e.querySelector("[data-action='mo-submit']")?.addEventListener("click",async()=>{const a=e.querySelector("#mo-memo");s.mobileOrder.memo=a?.value??"";const l="MO"+Date.now().toString().slice(-8);s.mobileOrder.submittedDocNo=l,s.mobileOrder.step="done",h()}),e.querySelector("[data-action='mo-reset']")?.addEventListener("click",()=>{s.mobileOrder={step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},h()}),e.querySelectorAll("[data-tour-id]").forEach(a=>{a.addEventListener("click",()=>{s.tourActiveId=a.dataset.tourId??null,h()})}),e.querySelectorAll("[data-action='tour-insert-template']").forEach(a=>{a.addEventListener("click",()=>{const l=s.tourInquiries.find(y=>y.id===s.tourActiveId);if(!l)return;const o=a.dataset.template==="confirm"?kl:Sl,d=e.querySelector("#tour-confirmed-time"),u=o.replaceAll("{name}",l.name).replaceAll("{partySize}",String(l.partySize)).replaceAll("{confirmedTime}",d?.value??l.visitDate),p=e.querySelector("#tour-reply-body");p&&(p.value=u)})}),e.querySelector("[data-action='tour-send-reply']")?.addEventListener("click",()=>{const a=document.querySelector("[data-action='tour-send-reply']")?.dataset.tourId??"",l=s.tourInquiries.find(d=>d.id===a);if(!l)return;const o=e.querySelector("#tour-confirmed-time");l.status="confirmed",l.repliedAt=new Date().toISOString(),l.confirmedTime=o?.value??"",_("返信メールを下書き保存し、ステータスを確定にしました"),h()}),e.querySelector("[data-action='lb-search']")?.addEventListener("click",async()=>{const a=e.querySelector("#lb-type")?.value??"",l=e.querySelector("#lb-area")?.value??"",o=e.querySelector("#lb-keyword")?.value??"";if(!a&&!o){_("業種かキーワードを入力してください","warning");return}s.leadSearchType=a,s.leadSearchArea=l,s.leadSearchQuery=o,s.leadSearching=!0,h();const d=s.integrations.find(v=>v.provider==="google_maps");if(!d||!d.config.api_key){_("Google Maps APIキーが /integrations で未設定です","warning"),s.leadSearching=!1,h();return}const{searchPlaces:u}=await f(async()=>{const{searchPlaces:v}=await Promise.resolve().then(()=>w);return{searchPlaces:v}},void 0),p=[a,o].filter(Boolean).join(" "),y=await u(d,p,l);s.leadSearching=!1,y.error?_("検索失敗: "+y.error,"error"):s.leadSearchResults=y.results,h()}),e.querySelector("[data-action='lb-clear-search']")?.addEventListener("click",()=>{s.leadSearchResults=[],h()}),e.querySelector("[data-action='lb-save-list']")?.addEventListener("click",async()=>{if(s.leadSearchResults.length===0)return;const a=prompt("リスト名を入力:",`${s.leadSearchType} ${s.leadSearchArea}`);if(!a)return;const l=`ll_${Date.now()}`,o={id:l,name:a,query:s.leadSearchQuery,area:s.leadSearchArea,businessType:s.leadSearchType,totalCount:s.leadSearchResults.length,source:"google_places"},{saveLeadList:d,saveLeadItem:u,fetchLeadLists:p,fetchLeadItems:y}=await f(async()=>{const{saveLeadList:E,saveLeadItem:k,fetchLeadLists:b,fetchLeadItems:F}=await Promise.resolve().then(()=>w);return{saveLeadList:E,saveLeadItem:k,fetchLeadLists:b,fetchLeadItems:F}},void 0);await d(o);const v=e.querySelectorAll(".lb-search-check:checked"),$=Array.from(v).map(E=>Number(E.dataset.idx));for(const E of $){const k=s.leadSearchResults[E];k&&await u({...k,id:`li_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,listId:l,businessType:s.leadSearchType})}s.leadLists=await p(),s.leadActiveListId=l,s.leadItems=await y(l),s.leadSearchResults=[],_(`${$.length}件を「${a}」として保存しました`),h()}),e.querySelectorAll("[data-action='lb-select-list']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??null;if(s.leadActiveListId=l,l){const{fetchLeadItems:o}=await f(async()=>{const{fetchLeadItems:d}=await Promise.resolve().then(()=>w);return{fetchLeadItems:d}},void 0);s.leadItems=await o(l)}h()})}),e.querySelectorAll("[data-action='lb-exclude']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??"",o=s.leadItems.find(p=>p.id===l);if(!o)return;const{saveLeadItem:d,fetchLeadItems:u}=await f(async()=>{const{saveLeadItem:p,fetchLeadItems:y}=await Promise.resolve().then(()=>w);return{saveLeadItem:p,fetchLeadItems:y}},void 0);await d({...o,status:"excluded"}),s.leadActiveListId&&(s.leadItems=await u(s.leadActiveListId)),h()})}),e.querySelectorAll("[data-action='lb-convert-one']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??"",o=s.leadItems.find(y=>y.id===l);if(!o)return;const{convertLeadToProspect:d,fetchLeadItems:u}=await f(async()=>{const{convertLeadToProspect:y,fetchLeadItems:v}=await Promise.resolve().then(()=>w);return{convertLeadToProspect:y,fetchLeadItems:v}},void 0);await d(o)&&(_("見込客に追加しました: "+o.companyName),s.leadActiveListId&&(s.leadItems=await u(s.leadActiveListId)),h())})}),e.querySelector("[data-action='lb-bulk-convert']")?.addEventListener("click",async()=>{const a=e.querySelectorAll(".lb-item-check:checked");if(a.length===0&&!await W("全ての新規アイテムを見込客に変換しますか？"))return;const l=a.length>0?Array.from(a).map(p=>p.dataset.id):s.leadItems.filter(p=>p.status==="new").map(p=>p.id),{convertLeadToProspect:o,fetchLeadItems:d}=await f(async()=>{const{convertLeadToProspect:p,fetchLeadItems:y}=await Promise.resolve().then(()=>w);return{convertLeadToProspect:p,fetchLeadItems:y}},void 0);let u=0;for(const p of l){const y=s.leadItems.find(v=>v.id===p);y&&y.status==="new"&&await o(y)&&u++}_(`${u}件を見込客に変換しました`),s.leadActiveListId&&(s.leadItems=await d(s.leadActiveListId)),h()}),e.querySelectorAll("[data-map-filter]").forEach(a=>{a.addEventListener("change",()=>{const l=a.dataset.mapFilter;let o;a.type==="checkbox"?o=a.checked:o=a.value,s.mapFilters={...s.mapFilters,[l]:o},h()})}),e.querySelector("[data-action='ivry-sync']")?.addEventListener("click",async()=>{const a=s.integrations.find(u=>u.provider==="ivry");if(!a||!a.isEnabled){_("IVRy連携が無効です。/integrations で有効化してください","warning");return}const{syncIvryCallLogs:l,fetchCallLogs:o}=await f(async()=>{const{syncIvryCallLogs:u,fetchCallLogs:p}=await Promise.resolve().then(()=>w);return{syncIvryCallLogs:u,fetchCallLogs:p}},void 0),d=await l(a);d.error?_("同期失敗: "+d.error,"error"):(_(`${d.count}件の通話履歴を同期しました`),s.callLogs=await o(100),h())}),e.querySelector("[data-action='ivry-push-phonebook']")?.addEventListener("click",async()=>{const a=s.integrations.find(u=>u.provider==="ivry");if(!a||!a.isEnabled){_("IVRy連携が無効です","warning");return}if(!await W("全ての取引先と見込客の電話帳をIVRyに送信しますか？"))return;const{syncPhoneBookToIvry:l}=await f(async()=>{const{syncPhoneBookToIvry:u}=await Promise.resolve().then(()=>w);return{syncPhoneBookToIvry:u}},void 0),o=[];s.masterStats?.customers.forEach(u=>{o.push({name:u.name,phone:"",customerCode:u.code,note:"既存取引先"})}),s.prospects.forEach(u=>{u.phone&&o.push({name:u.companyName,phone:u.phone,customerCode:u.id,note:`見込客 (${u.stage})`})});const d=await l(a,o);d.error?_("送信失敗: "+d.error,"error"):_(`${d.synced}件の連絡先を送信しました`)}),e.querySelectorAll("[data-action='call-link-customer']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??"",o=a.dataset.phone??"",d=prompt(`電話番号 ${o} を顧客コードに紐付け
顧客コードを入力:`);if(!d)return;const u=s.callLogs.find(v=>v.id===l);if(!u)return;const{saveCallLog:p,fetchCallLogs:y}=await f(async()=>{const{saveCallLog:v,fetchCallLogs:$}=await Promise.resolve().then(()=>w);return{saveCallLog:v,fetchCallLogs:$}},void 0);await p({...u,matchedCustomerCode:d}),s.callLogs=await y(100),h()})}),e.querySelectorAll("[data-action='call-memo']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??"",o=s.callLogs.find(y=>y.id===l);if(!o)return;const d=prompt("メモを入力:",o.notes??"");if(d===null)return;const{saveCallLog:u,fetchCallLogs:p}=await f(async()=>{const{saveCallLog:y,fetchCallLogs:v}=await Promise.resolve().then(()=>w);return{saveCallLog:y,fetchCallLogs:v}},void 0);await u({...o,notes:d}),s.callLogs=await p(100),h()})}),e.querySelectorAll("[data-prospect-view]").forEach(a=>{a.addEventListener("click",()=>{s.prospectViewMode=a.dataset.prospectView,h()})}),e.querySelector("[data-action='prospect-new']")?.addEventListener("click",()=>{s.prospectEditingId="__new__",h()}),e.querySelectorAll("[data-action='prospect-edit']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.id??null;if(s.prospectEditingId=l,l){const{fetchProspectActivities:o}=await f(async()=>{const{fetchProspectActivities:d}=await Promise.resolve().then(()=>w);return{fetchProspectActivities:d}},void 0);s.prospectActivities=await o(l)}h()})}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.prospectId??null;if(s.prospectEditingId=l,l){const{fetchProspectActivities:o}=await f(async()=>{const{fetchProspectActivities:d}=await Promise.resolve().then(()=>w);return{fetchProspectActivities:d}},void 0);s.prospectActivities=await o(l)}h()})}),e.querySelectorAll("[data-action='prospect-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.prospectEditingId=null,s.prospectActivities=[],h())})}),e.querySelector("[data-action='prospect-save']")?.addEventListener("click",async()=>{const a=s.prospectEditingId==="__new__",l=a?`p_${Date.now()}`:s.prospectEditingId??"",o={id:l,companyName:e.querySelector("#prospect-company")?.value??"",contactName:e.querySelector("#prospect-contact")?.value??"",email:e.querySelector("#prospect-email")?.value??"",phone:e.querySelector("#prospect-phone")?.value??"",businessType:e.querySelector("#prospect-business-type")?.value??"",stage:e.querySelector("#prospect-stage")?.value??"cold",source:e.querySelector("#prospect-source")?.value??"",expectedAmount:Number(e.querySelector("#prospect-amount")?.value)||0,probability:Number(e.querySelector("#prospect-probability")?.value)||0,assignedStaffCode:e.querySelector("#prospect-staff")?.value??"",nextActionDate:e.querySelector("#prospect-next-date")?.value??"",nextAction:e.querySelector("#prospect-next-action")?.value??"",note:e.querySelector("#prospect-note")?.value??""};if(!o.companyName){_("会社名は必須です","warning");return}const{saveProspect:d,fetchProspects:u,recordAudit:p,sendSlackNotification:y}=await f(async()=>{const{saveProspect:$,fetchProspects:E,recordAudit:k,sendSlackNotification:b}=await Promise.resolve().then(()=>w);return{saveProspect:$,fetchProspects:E,recordAudit:k,sendSlackNotification:b}},void 0);await d(o)?(a&&await y("new_prospect",`新規見込客: ${o.companyName} / 想定 ¥${o.expectedAmount.toLocaleString("ja-JP")}`).catch(()=>{}),await p({action:a?"prospect_create":"prospect_update",entityType:"prospect",entityId:l,userEmail:s.user?.email}),s.prospects=await u(),s.prospectEditingId=null,h()):_("保存失敗","error")}),e.querySelectorAll("[data-action='prospect-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=a.dataset.id??"",{deleteProspect:o,fetchProspects:d}=await f(async()=>{const{deleteProspect:u,fetchProspects:p}=await Promise.resolve().then(()=>w);return{deleteProspect:u,fetchProspects:p}},void 0);await o(l)&&(s.prospects=await d(),h())})}),e.querySelector("[data-action='prospect-add-activity']")?.addEventListener("click",async()=>{const a=e.querySelector("[data-action='prospect-add-activity']")?.dataset.id??"",l=e.querySelector("#prospect-activity-type")?.value??"call",o=e.querySelector("#prospect-activity-title")?.value??"";if(!o){_("内容を入力してください","warning");return}const{saveProspectActivity:d,fetchProspectActivities:u}=await f(async()=>{const{saveProspectActivity:p,fetchProspectActivities:y}=await Promise.resolve().then(()=>w);return{saveProspectActivity:p,fetchProspectActivities:y}},void 0);await d({id:`act_${Date.now()}`,prospectId:a,activityType:l,title:o,activityDate:new Date().toISOString(),staffCode:s.myProfile?.staffCode}),s.prospectActivities=await u(a),h()}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(a=>{a.addEventListener("dragstart",l=>{l.dataTransfer?.setData("text/plain",a.dataset.prospectId??"")})}),e.querySelectorAll(".pk-col[data-prospect-stage]").forEach(a=>{a.addEventListener("dragover",l=>l.preventDefault()),a.addEventListener("drop",async l=>{l.preventDefault();const o=l.dataTransfer?.getData("text/plain"),d=a.dataset.prospectStage;if(!o)return;const u=s.prospects.find(p=>p.id===o);if(u&&u.stage!==d){const p={...u,stage:d},{saveProspect:y}=await f(async()=>{const{saveProspect:v}=await Promise.resolve().then(()=>w);return{saveProspect:v}},void 0);await y(p),u.stage=d,h()}})}),e.querySelector("[data-action='slack-save']")?.addEventListener("click",async()=>{const{fetchIntegrationSettings:a,saveIntegrationSetting:l}=await f(async()=>{const{fetchIntegrationSettings:v,saveIntegrationSetting:$}=await Promise.resolve().then(()=>w);return{fetchIntegrationSettings:v,saveIntegrationSetting:$}},void 0),d=(s.integrations.length>0?s.integrations:await a()).find(v=>v.provider==="slack");if(!d)return;const u=e.querySelector("#slack-webhook")?.value??"",p=e.querySelector("#slack-default-channel")?.value??"",y=e.querySelector("#slack-enabled")?.checked??!1;await l({...d,config:{...d.config,webhook_url:u,default_channel:p},isEnabled:y}),s.integrations=await a(),_("保存しました"),h()}),e.querySelector("[data-action='slack-save-rules']")?.addEventListener("click",async()=>{const{saveSlackRule:a,fetchSlackRules:l}=await f(async()=>{const{saveSlackRule:o,fetchSlackRules:d}=await Promise.resolve().then(()=>w);return{saveSlackRule:o,fetchSlackRules:d}},void 0);for(const o of s.slackRules){const d=e.querySelector(`[data-slack-rule-id="${o.id}"][data-slack-field="enabled"]`)?.checked??o.enabled,u=e.querySelector(`[data-slack-rule-id="${o.id}"][data-slack-field="channel"]`)?.value??o.channel;await a({...o,enabled:d,channel:u})}s.slackRules=await l(),_("ルールを保存しました"),h()}),e.querySelector("[data-action='slack-test']")?.addEventListener("click",async()=>{const{sendSlackNotification:a}=await f(async()=>{const{sendSlackNotification:o}=await Promise.resolve().then(()=>w);return{sendSlackNotification:o}},void 0),l=await a("new_order","🧪 これはテスト通知です (syusen-cloud)");l.ok?_("テスト送信成功"):_("送信失敗: "+(l.error??""),"error")}),e.querySelector("[data-action='material-receive']")?.addEventListener("click",()=>{s.materialEditing=null,s.materialEditingIsNew=!0,h()}),e.querySelectorAll("[data-action='material-adjust']").forEach(a=>{a.addEventListener("click",()=>{const l=a.dataset.id??"",o=s.materialList.find(d=>d.id===l);o&&(s.materialEditing=o,s.materialEditingIsNew=!1,h())})}),e.querySelectorAll("[data-action='material-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.materialEditing=null,s.materialEditingIsNew=!1,h())})}),e.querySelector("[data-action='material-save']")?.addEventListener("click",async()=>{const l={id:s.materialEditingIsNew?`mat_${Date.now()}`:s.materialEditing?.id??"",code:e.querySelector("#mat-code")?.value??"",name:e.querySelector("#mat-name")?.value??"",unit:e.querySelector("#mat-unit")?.value??"個",currentStock:Number(e.querySelector("#mat-stock")?.value)||0,minimumStock:Number(e.querySelector("#mat-min")?.value)||0,unitCost:Number(e.querySelector("#mat-cost")?.value)||0,lastUpdated:e.querySelector("#mat-last-date")?.value??new Date().toISOString().slice(0,10)};if(l.materialType=e.querySelector("#mat-type")?.value??"",!l.code||!l.name){_("コードと品名は必須です","warning");return}const{saveMaterial:o,fetchMaterialList:d}=await f(async()=>{const{saveMaterial:p,fetchMaterialList:y}=await Promise.resolve().then(()=>w);return{saveMaterial:p,fetchMaterialList:y}},void 0);await o(l)?(s.materialList=await d(),s.materialEditing=null,s.materialEditingIsNew=!1,_("保存しました"),h()):_("保存失敗","error")}),e.querySelector("[data-action='material-delete']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='material-delete']")?.dataset.id??"";if(!a||!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deleteMaterial:l,fetchMaterialList:o}=await f(async()=>{const{deleteMaterial:d,fetchMaterialList:u}=await Promise.resolve().then(()=>w);return{deleteMaterial:d,fetchMaterialList:u}},void 0);await l(a)&&(s.materialList=await o(),s.materialEditing=null,h())}),e.querySelector("[data-action='user-new']")?.addEventListener("click",()=>{s.userEditingId="__new__",h()}),e.querySelectorAll("[data-action='user-edit']").forEach(a=>{a.addEventListener("click",()=>{s.userEditingId=a.dataset.id??null,h()})}),e.querySelector("[data-action='user-cancel']")?.addEventListener("click",()=>{s.userEditingId=null,h()}),e.querySelector("[data-action='user-save']")?.addEventListener("click",async()=>{const a=s.userEditingId==="__new__",l=a?crypto.randomUUID():s.userEditingId??"",o=e.querySelector("#user-email")?.value.trim()??"",d=e.querySelector("#user-name")?.value.trim()??"";if(!o||!d){_("名前とメールアドレスは必須です","warning");return}const u={id:l,email:o,displayName:d,staffCode:e.querySelector("#user-code")?.value??"",department:e.querySelector("#user-dept")?.value??"all",role:e.querySelector("#user-role")?.value??"staff",phone:e.querySelector("#user-phone")?.value??"",isActive:e.querySelector("#user-active")?.checked??!0};if(a){const E=e.querySelector("#user-password")?.value??"";if(E.length<8){_("パスワードは8文字以上必要です","warning");return}try{await Dt(o,E)}catch(k){_("Auth登録失敗: "+(k instanceof Error?k.message:""),"error");return}}const{saveUserProfile:p,fetchUserProfiles:y,recordAudit:v}=await f(async()=>{const{saveUserProfile:E,fetchUserProfiles:k,recordAudit:b}=await Promise.resolve().then(()=>w);return{saveUserProfile:E,fetchUserProfiles:k,recordAudit:b}},void 0);await p(u)?(await v({action:a?"user_create":"user_update",entityType:"user",entityId:l,userEmail:s.user?.email}),s.userProfiles=await y(),s.userEditingId=null,_("保存しました"),h()):_("保存失敗","error")}),e.querySelectorAll("[data-action='user-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=a.dataset.id??"",{deleteUserProfile:o,fetchUserProfiles:d,recordAudit:u}=await f(async()=>{const{deleteUserProfile:y,fetchUserProfiles:v,recordAudit:$}=await Promise.resolve().then(()=>w);return{deleteUserProfile:y,fetchUserProfiles:v,recordAudit:$}},void 0);await o(l)?(await u({action:"user_delete",entityType:"user",entityId:l,userEmail:s.user?.email}),s.userProfiles=await d(),h()):_("削除失敗","error")})}),e.querySelector("[data-action='profile-save-sender']")?.addEventListener("click",async()=>{if(!s.myProfile)return;const a=e.querySelector("#profile-sender")?.value??"",l={...s.myProfile,defaultMailSenderId:a},{saveUserProfile:o}=await f(async()=>{const{saveUserProfile:d}=await Promise.resolve().then(()=>w);return{saveUserProfile:d}},void 0);await o(l),s.myProfile=l,_("保存しました"),h()}),e.querySelector("[data-action='profile-change-password']")?.addEventListener("click",async()=>{const a=e.querySelector("#profile-new-password")?.value??"";if(a.length<8){_("8文字以上のパスワードを入力してください","warning");return}try{await _s(a),_("パスワードを変更しました")}catch(l){_("変更失敗: "+(l instanceof Error?l.message:""),"error")}}),e.querySelectorAll("[data-action='int-edit']").forEach(a=>{a.addEventListener("click",()=>{s.integrationEditingId=a.dataset.id??null,h()})}),e.querySelector("[data-action='int-cancel']")?.addEventListener("click",()=>{s.integrationEditingId=null,h()}),e.querySelector("[data-action='int-save']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='int-save']")?.dataset.id??"",l=s.integrations.find(v=>v.id===a);if(!l)return;const o={...l.config};Object.keys(o).forEach(v=>{const $=e.querySelector(`#int-${v}`);$&&(o[v]=$.value)});const d=e.querySelector("#int-enabled")?.checked??!1,{saveIntegrationSetting:u,fetchIntegrationSettings:p}=await f(async()=>{const{saveIntegrationSetting:v,fetchIntegrationSettings:$}=await Promise.resolve().then(()=>w);return{saveIntegrationSetting:v,fetchIntegrationSettings:$}},void 0);await u({...l,config:o,isEnabled:d})?(s.integrations=await p(),s.integrationEditingId=null,_("保存しました"),h()):_("保存失敗","error")}),e.querySelectorAll("[data-action='int-sync-shopify'], [data-action='shopify-sync']").forEach(a=>{a.addEventListener("click",async()=>{const l=s.integrations.find(p=>p.provider==="shopify");if(!l){_("Shopify連携が未設定です","warning");return}a.textContent="同期中…",a.disabled=!0;const{syncShopifyOrders:o,fetchShopifyOrders:d}=await f(async()=>{const{syncShopifyOrders:p,fetchShopifyOrders:y}=await Promise.resolve().then(()=>w);return{syncShopifyOrders:p,fetchShopifyOrders:y}},void 0),u=await o(l);u.error?_("同期失敗: "+u.error,"error"):(_(`${u.count}件を同期しました`),s.shopifyOrders=await d()),h()})}),e.querySelectorAll("[data-action='int-sync-gcal']").forEach(a=>{a.addEventListener("click",async()=>{const l=s.integrations.find(p=>p.provider==="google_calendar");if(!l)return;a.textContent="同期中…",a.disabled=!0;const{syncGoogleCalendar:o,fetchCalendarEvents:d}=await f(async()=>{const{syncGoogleCalendar:p,fetchCalendarEvents:y}=await Promise.resolve().then(()=>w);return{syncGoogleCalendar:p,fetchCalendarEvents:y}},void 0),u=await o(l);u.error?_("同期失敗: "+u.error,"error"):(_(`${u.count}件を同期しました`),s.calendarEvents=await d(s.calendarYearMonth)),h()})}),e.querySelector("[data-action='fax-upload']")?.addEventListener("click",async()=>{const l=e.querySelector("#fax-file")?.files?.[0];if(!l){_("FAX画像を選択してください","warning");return}const o=s.integrations.find(d=>d.provider==="cloud_vision");if(!o||!o.config.api_key){_("Cloud Vision API Key が設定されていません。/integrations で設定してください","warning");return}s.faxProcessing=!0,s.faxOcrText=null,h();try{const d=new FileReader;d.onload=async()=>{const u=String(d.result??""),{ocrFaxImage:p,saveFaxRecord:y,fetchFaxInbox:v}=await f(async()=>{const{ocrFaxImage:b,saveFaxRecord:F,fetchFaxInbox:N}=await Promise.resolve().then(()=>w);return{ocrFaxImage:b,saveFaxRecord:F,fetchFaxInbox:N}},void 0),$=await p(o,u),E=e.querySelector("#fax-sender-name")?.value??"",k=e.querySelector("#fax-sender-phone")?.value??"";await y({id:`fax_${Date.now()}`,receivedAt:new Date().toISOString(),senderName:E,senderPhone:k,ocrStatus:$.error?"failed":"done",ocrText:$.text}),s.faxOcrText=$.error?`エラー: ${$.error}`:$.text,s.faxRecords=await v(),s.faxProcessing=!1,h()},d.readAsDataURL(l)}catch(d){_("OCR失敗: "+(d instanceof Error?d.message:""),"error"),s.faxProcessing=!1,h()}}),e.querySelector("[data-action='ms-new']")?.addEventListener("click",()=>{s.mailSenderEditingId="__new__",h()}),e.querySelectorAll("[data-action='ms-edit']").forEach(a=>{a.addEventListener("click",()=>{s.mailSenderEditingId=a.dataset.id??null,h()})}),e.querySelector("[data-action='ms-cancel']")?.addEventListener("click",()=>{s.mailSenderEditingId=null,h()}),e.querySelector("[data-action='ms-save']")?.addEventListener("click",async()=>{const a=e.querySelector("[data-action='ms-save']")?.dataset.id||`sender_${Date.now()}`,l={id:a,name:e.querySelector("#ms-name")?.value||"",email:e.querySelector("#ms-email")?.value||"",displayName:e.querySelector("#ms-display-name")?.value||"",replyTo:e.querySelector("#ms-reply-to")?.value||"",signature:e.querySelector("#ms-signature")?.value||"",isDefault:e.querySelector("#ms-default")?.checked??!1,isVerified:s.mailSenders.find(p=>p.id===a)?.isVerified??!1};if(!l.name||!l.email){_("名前とメールアドレスは必須です","warning");return}const{saveMailSender:o,fetchMailSenders:d}=await f(async()=>{const{saveMailSender:p,fetchMailSenders:y}=await Promise.resolve().then(()=>w);return{saveMailSender:p,fetchMailSenders:y}},void 0);await o(l)?(s.mailSenders=await d(),s.mailSenderEditingId=null,_("保存しました"),h()):_("保存に失敗しました","error")}),e.querySelectorAll("[data-action='ms-delete']").forEach(a=>{a.addEventListener("click",async()=>{if(!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=a.dataset.id??"",{deleteMailSender:o,fetchMailSenders:d}=await f(async()=>{const{deleteMailSender:p,fetchMailSenders:y}=await Promise.resolve().then(()=>w);return{deleteMailSender:p,fetchMailSenders:y}},void 0);await o(l)?(s.mailSenders=await d(),h()):_("削除失敗","error")})}),e.querySelectorAll("[data-action='cal-prev'], [data-action='cal-next'], [data-action='cal-today']").forEach(a=>{a.addEventListener("click",async()=>{s.calendarYearMonth=a.dataset.ym??s.calendarYearMonth;const{fetchCalendarEvents:l}=await f(async()=>{const{fetchCalendarEvents:o}=await Promise.resolve().then(()=>w);return{fetchCalendarEvents:o}},void 0);s.calendarEvents=await l(s.calendarYearMonth),h()})}),e.querySelector("#cal-month-input")?.addEventListener("change",async a=>{s.calendarYearMonth=a.target.value;const{fetchCalendarEvents:l}=await f(async()=>{const{fetchCalendarEvents:o}=await Promise.resolve().then(()=>w);return{fetchCalendarEvents:o}},void 0);s.calendarEvents=await l(s.calendarYearMonth),h()}),e.querySelector("#cal-filter-category")?.addEventListener("change",a=>{s.calendarFilterCategory=a.target.value,h()}),e.querySelector("[data-action='cal-new']")?.addEventListener("click",()=>{const a=new Date;s.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:new Date(a.getTime()+3600*1e3).toISOString(),isAllDay:!1}},h()}),e.querySelectorAll("[data-cal-date]").forEach(a=>{a.tagName!=="BUTTON"&&a.addEventListener("click",l=>{if(l.target.closest(".cal-event"))return;const o=a.dataset.calDate??"";s.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:`${o}T10:00:00`,isAllDay:!1}},h()})}),e.querySelectorAll("[data-cal-event-id]").forEach(a=>{a.addEventListener("click",l=>{l.stopPropagation();const o=a.dataset.calEventId,d=s.calendarEvents.find(u=>u.id===o);d&&(s.calendarEdit={isOpen:!0,isNew:!1,event:{...d}},h())})}),e.querySelectorAll("[data-action='cal-close']").forEach(a=>{a.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(s.calendarEdit=null,h())})}),e.querySelector("[data-action='cal-save']")?.addEventListener("click",async()=>{if(!s.calendarEdit)return;const{saveCalendarEvent:a,fetchCalendarEvents:l,CALENDAR_CATEGORY_COLORS:o}=await f(async()=>{const{saveCalendarEvent:v,fetchCalendarEvents:$,CALENDAR_CATEGORY_COLORS:E}=await Promise.resolve().then(()=>w);return{saveCalendarEvent:v,fetchCalendarEvents:$,CALENDAR_CATEGORY_COLORS:E}},void 0),d=document.querySelector("[data-action='cal-save']")?.dataset.id||s.calendarEdit.event.id||`evt_${Date.now()}`,u=e.querySelector("#cal-category")?.value??"general",p={id:d,title:e.querySelector("#cal-title")?.value??"",category:u,startsAt:new Date(e.querySelector("#cal-starts")?.value??new Date().toISOString()).toISOString(),endsAt:e.querySelector("#cal-ends")?.value?new Date(e.querySelector("#cal-ends").value).toISOString():void 0,isAllDay:e.querySelector("#cal-allday")?.checked??!1,location:e.querySelector("#cal-location")?.value??"",relatedCustomerCode:e.querySelector("#cal-customer")?.value??"",description:e.querySelector("#cal-description")?.value??"",color:o[u]};if(!p.title){_("タイトルは必須です","warning");return}await a(p)?(s.calendarEvents=await l(s.calendarYearMonth),s.calendarEdit=null,_("保存しました"),h()):_("保存失敗","error")}),e.querySelector("[data-action='cal-delete']")?.addEventListener("click",async()=>{const a=document.querySelector("[data-action='cal-delete']")?.dataset.id??"";if(!a||!await W("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deleteCalendarEvent:l,fetchCalendarEvents:o}=await f(async()=>{const{deleteCalendarEvent:u,fetchCalendarEvents:p}=await Promise.resolve().then(()=>w);return{deleteCalendarEvent:u,fetchCalendarEvents:p}},void 0);await l(a)?(s.calendarEvents=await o(s.calendarYearMonth),s.calendarEdit=null,_("削除しました"),h()):_("削除失敗","error")}),e.querySelector("[data-action='import-execute']")?.addEventListener("click",async()=>{if(s.importPreview){s.importing=!0,h();try{const a=s.importPreview.rows.filter(o=>o._valid),l=await Zl(s.importEntity,a);s.importResult=`取り込み完了: ${l.inserted}件成功 / ${l.failed}件失敗`,s.importPreview=null}catch(a){s.importResult=`エラー: ${a instanceof Error?a.message:String(a)}`}finally{s.importing=!1,h()}}}),e.querySelector("[data-action='store-load']")?.addEventListener("click",()=>{const a=e.querySelector("#store-date")?.value??s.storeSalesDate;s.storeSalesDate=a,s.storeSales=[],s.actionLoading=!0,h(),kt(a).then(l=>{s.storeSales=l,s.actionLoading=!1,h()})}),e.querySelectorAll("[data-action='copy-config']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.configValue??"";if(l)try{await navigator.clipboard.writeText(l),a.textContent="コピー済み",window.setTimeout(()=>{a.textContent="コピー"},1600)}catch(o){console.warn("Clipboard copy failed",o)}})}),e.querySelector("[data-action='download-relay-config']")?.addEventListener("click",()=>{const l=JSON.stringify({supabase_url:V,supabase_anon_key:j,z_drive_path:"Z:\\",sync_modules:["sk","sh","k5","h5"],interval_minutes:5,use_odbc:!1,odbc_dsn:"MagicSake",log_level:"INFO"},null,2),o=new Blob([l],{type:"application/json;charset=utf-8"}),d=URL.createObjectURL(o),u=document.createElement("a");u.href=d,u.download="relay_config.json",u.click(),URL.revokeObjectURL(d)}),e.querySelectorAll("[data-action='copy-code']").forEach(a=>{a.addEventListener("click",async()=>{const l=a.dataset.code??"";if(l)try{await navigator.clipboard.writeText(decodeURIComponent(l)),a.textContent="コピー済み",window.setTimeout(()=>{a.textContent="コピー"},1600)}catch(o){console.warn("Clipboard code copy failed",o)}})}),e.querySelectorAll("input[name='email-audience-mode']").forEach(a=>{a.addEventListener("change",()=>{ie(e),s.emailSaveMessage=null,h()})}),e.querySelectorAll("#email-region, #email-history-segment").forEach(a=>{a.addEventListener("change",()=>{ie(e),s.emailSaveMessage=null,h()})}),e.querySelector("#email-subject")?.addEventListener("input",()=>{ie(e),s.emailSaveMessage=null}),e.querySelector("#email-body")?.addEventListener("input",()=>{ie(e),s.emailSaveMessage=null}),e.querySelectorAll("[data-action='template-select']").forEach(a=>{a.addEventListener("click",()=>{s.emailTemplateId=a.dataset.templateId??"custom";const l=ls(s.emailTemplateId);s.emailSubject=l.subject,s.emailBody=l.body,s.emailSaveMessage=null,h()})}),e.querySelector("[data-action='email-insert-link']")?.addEventListener("click",()=>{ie(e);const a=`

商品詳細はこちら: https://kaneishuzo.co.jp/products`;s.emailBody.includes("https://kaneishuzo.co.jp/products")||(s.emailBody=`${s.emailBody.trimEnd()}${a}`),s.emailSaveMessage=null,h()}),e.querySelector("[data-action='email-save']")?.addEventListener("click",()=>{ie(e),s.actionLoading=!0,h(),Me(it("draft")).then(a=>{s.emailSaveMessage=`下書きを保存しました。${new Intl.DateTimeFormat("ja-JP",{month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(a.updatedAt??new Date().toISOString()))}`,s.actionLoading=!1,h()})}),e.querySelector("#email-sender")?.addEventListener("change",a=>{s.emailSenderId=a.target.value}),e.querySelector("[data-action='email-send']")?.addEventListener("click",()=>{ie(e),s.actionLoading=!0,s.emailSending=!0,h();const a=it("sent");s.mailSenders.find(l=>l.id===s.emailSenderId),ja().then(async l=>{await Me({...a,recipientCount:l.sent}),s.emailSaveMessage=`${l.sent.toLocaleString("ja-JP")} 件送信しました。`,s.actionLoading=!1,s.emailSending=!1,h(),_(`${l.sent}件送信完了`)}).catch(async()=>{await Me(it("draft")),s.emailSaveMessage="APIキー未設定のため下書きを保存しました。",s.actionLoading=!1,s.emailSending=!1,h(),_("APIキー未設定のため下書き保存しました","warning")})})}function h(){const e=document.querySelector("#app");if(!e)return;e.innerHTML=Io(),qo(e),s.pickerMode&&e.querySelector("#modal-search")?.focus(),s.globalSearchOpen&&e.querySelector("#global-search-input")?.focus(),Ct()&&e.querySelector("#auth-email")?.focus(),requestAnimationFrame(()=>{for(const n of["fd-scaler","print-scaler"]){const i=e.querySelector(`#${n}`),r=i?.querySelector(".fd-canvas, .print-preview"),c=r?.querySelector(".print-page")??r;if(!i||!c)continue;const a=i.parentElement?.clientWidth??0,l=c.offsetWidth;if(a>0&&l>0&&l>a-24){const o=(a-24)/l;i.style.transform=`scale(${o})`,i.style.transformOrigin="top left",i.style.height=`${(c.offsetHeight+48)*o}px`}else i.style.transform="",i.style.height=""}});const t=s.sidebarOpen||s.pickerMode!==null||s.globalSearchOpen;document.body.style.overflow=t?"hidden":"",document.body.style.touchAction=t?"none":""}const ms="sake-cloud-cache",No=1800*1e3;function To(){try{const e={ts:Date.now(),salesSummary:s.salesSummary,paymentStatus:s.paymentStatus,masterStats:s.masterStats,pipelineMeta:s.pipelineMeta,salesAnalytics:s.salesAnalytics};localStorage.setItem(ms,JSON.stringify(e))}catch{}}function Ro(){try{const e=localStorage.getItem(ms);if(!e)return!1;const t=JSON.parse(e);return Date.now()-t.ts>No?!1:(t.salesSummary&&(s.salesSummary=t.salesSummary),t.paymentStatus&&(s.paymentStatus=t.paymentStatus),t.masterStats&&(s.masterStats=t.masterStats),t.pipelineMeta&&(s.pipelineMeta=t.pipelineMeta),t.salesAnalytics&&(s.salesAnalytics=t.salesAnalytics),!0)}catch{return!1}}async function ke(){const e=Ro();e&&(s.loading=!1,h()),s.loading=!e,e||h();try{const[t,n,i,r,c,a,l,o]=await Promise.all([da(),ua(),pa(),ma(),Be(s.invoiceFilter),gt(s.ledgerCustomerCode),ha(),ya()]);if(s.salesSummary=t,s.paymentStatus=n,s.masterStats=i,s.pipelineMeta=r,s.invoiceRecords=c,s.customerLedger=a,s.salesAnalytics=l,s.syncDashboard=o,ba().then(d=>{s.announcements=d,h()}),pe.length===0&&yo(),s.rawTableList.length===0&&Ua().then(d=>{s.rawTableList=d,s.route==="/raw-browser"&&h()}),!s.salesFilter.startDate||!s.salesFilter.endDate){const u=[...t.salesRecords].sort((v,$)=>new Date($.date).getTime()-new Date(v.date).getTime())[0]?.date??new Date().toISOString(),p=new Date(u),y=new Date(p);y.setDate(p.getDate()-30),s.salesFilter={startDate:aa(y.toISOString()),endDate:aa(p.toISOString())}}(!s.invoiceFilter.startDate||!s.invoiceFilter.endDate)&&(s.invoiceFilter={...s.invoiceFilter,startDate:s.salesFilter.startDate,endDate:s.salesFilter.endDate},s.invoiceRecords=await Be(s.invoiceFilter)),s.error=null,To()}catch(t){e||(s.error=t instanceof Error?t.message:"データの取得に失敗しました。")}finally{s.loading=!1,h(),It(s.route)}}window.addEventListener("popstate",()=>{s.route=os(location.pathname),s.currentCategory=Pt(s.route),s.sidebarOpen=!1,Se(),It(s.route)});window.addEventListener("keydown",e=>{if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="k"){e.preventDefault(),s.globalSearchOpen=!0,h();return}if(e.key==="Escape"){if(s.globalSearchOpen){Se(),h();return}if(s.pickerMode){Ue(),h();return}s.route==="/invoice-entry"&&!s.invoiceSaving&&(rs(),h());return}if(s.route==="/invoice-entry"&&!s.invoiceSaving&&(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault();const t=document.querySelector("#app");t&&ds(t)}});s.user=He()?$s():null;s.user?.email&&(async()=>{const{fetchMyProfile:e}=await f(async()=>{const{fetchMyProfile:t}=await Promise.resolve().then(()=>w);return{fetchMyProfile:t}},void 0);s.myProfile=await e(s.user.email),h()})();try{const e=localStorage.getItem("sake_print_options");e&&(s.printOptions={...s.printOptions,...JSON.parse(e)});const t=localStorage.getItem("sake_print_company");t&&(s.printCompany={...s.printCompany,...JSON.parse(t)});const n=localStorage.getItem("sake_fd_positions");n&&(s.fdSavedPositions=JSON.parse(n))}catch{}(function(){let t=null,n=0,i=0,r=0,c=0,a=1;document.addEventListener("mousedown",l=>{const o=l.target.closest(".fd-draggable");if(!o||!s.fdDesignMode)return;l.preventDefault();const d=o.closest(".fd-canvas");if(!d)return;const u=d.getBoundingClientRect();if(u.width===0)return;a=228.6/u.width,t=o,n=l.clientX,i=l.clientY,r=parseFloat(o.style.left)||0,c=parseFloat(o.style.top)||0,document.querySelectorAll(".fd-active").forEach($=>$.classList.remove("fd-active")),o.classList.add("fd-active","fd-dragging"),s.fdActiveFieldId=o.dataset.fdId??null;const p=document.querySelector("#fd-selected-info");p&&(p.textContent=`選択中: ${o.title}`);const y=document.querySelector("#fd-sel-x"),v=document.querySelector("#fd-sel-y");y&&(y.value=String(r)),v&&(v.value=String(c))}),document.addEventListener("mousemove",l=>{if(!t)return;const o=(l.clientX-n)*a,d=(l.clientY-i)*a,u=Math.round((r+o)*2)/2,p=Math.round((c+d)*2)/2;t.style.left=u+"mm",t.style.top=p+"mm";const y=document.querySelector("#fd-sel-x"),v=document.querySelector("#fd-sel-y");y&&(y.value=String(u)),v&&(v.value=String(p))}),document.addEventListener("mouseup",()=>{t&&(t.classList.remove("fd-dragging"),t=null)}),document.addEventListener("keydown",l=>{if(!s.fdDesignMode||!s.fdActiveFieldId||l.key!=="ArrowLeft"&&l.key!=="ArrowRight"&&l.key!=="ArrowUp"&&l.key!=="ArrowDown"||l.target.tagName==="INPUT"||l.target.tagName==="TEXTAREA")return;const o=document.querySelector(`[data-fd-id="${s.fdActiveFieldId}"]`);if(!o)return;l.preventDefault();const d=.5;let u=parseFloat(o.style.left)||0,p=parseFloat(o.style.top)||0;l.key==="ArrowLeft"?u-=d:l.key==="ArrowRight"?u+=d:l.key==="ArrowUp"?p-=d:l.key==="ArrowDown"&&(p+=d),o.style.left=u+"mm",o.style.top=p+"mm";const y=document.querySelector("#fd-sel-x"),v=document.querySelector("#fd-sel-y");y&&(y.value=String(u)),v&&(v.value=String(p))})})();function ys(e){const t=window.google?.maps;if(!t){e.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-secondary);">Google Maps 読込中…</div>',setTimeout(()=>ys(e),500);return}e.innerHTML="";const n=new t.Map(e,{center:{lat:35.45,lng:139.4},zoom:10,mapId:"sake-system-map",gestureHandling:"greedy"}),i=new t.InfoWindow;function r(c,a,l,o,d){const u=new t.marker.AdvancedMarkerElement({map:n,position:{lat:c,lng:a},content:(()=>{const p=document.createElement("div");return p.style.cssText=`background:${l};color:white;border-radius:50%;width:28px;height:28px;display:flex;align-items:center;justify-content:center;border:2px solid white;box-shadow:0 2px 6px rgba(0,0,0,0.3);font-weight:700;font-size:11px;cursor:pointer;`,p.textContent=o,p})()});u.addListener("click",()=>{i.setContent(d),i.open({anchor:u,map:n})})}s.mapFilters.showCustomers&&(s.masterStats?.customers??[]).forEach(a=>{!a.lat||!a.lng||s.mapFilters.filterBusinessType&&a.businessType!==s.mapFilters.filterBusinessType||r(a.lat,a.lng,"#2196F3","既",`<div style="min-width:180px;"><strong>${a.name}</strong><br/><span style="color:#666;font-size:11px;">${a.code}</span><br/>既存取引先<br/>締日${a.closingDay}日 / 支払日${a.paymentDay}日${a.address1?`<br/>${a.address1}`:""}</div>`)}),s.mapFilters.showProspects&&s.prospects.forEach(c=>{if(!c.lat||!c.lng||s.mapFilters.filterBusinessType&&c.businessType!==s.mapFilters.filterBusinessType)return;const a=c.stage==="hot"||c.stage==="negotiating"?"#EF5350":c.stage==="won"?"#66BB6A":"#4CAF50";r(c.lat,c.lng,a,"新",`<div style="min-width:200px;"><strong>${c.companyName}</strong><br/><span style="color:#666;font-size:11px;">${c.contactName??""}</span><br/>新規見込客 (${c.stage})<br/>想定 ¥${c.expectedAmount.toLocaleString("ja-JP")} / 確度 ${c.probability}%${c.nextAction?`<br/>${c.nextAction}`:""}</div>`)}),s.mapFilters.showDelivery&&s.deliveryLocations.forEach(c=>{!c.lat||!c.lng||r(c.lat,c.lng,"#FF9800","納",`<div style="min-width:180px;"><strong>${c.name}</strong><br/>納品先${c.customerCode?` (${c.customerCode})`:""}<br/>${c.address??""}${c.contactName?`<br/>${c.contactName}`:""}${c.deliveryNote?`<br/>${c.deliveryNote}`:""}</div>`)})}ke();const Oo=300*1e3;setInterval(()=>{s.route==="/"&&!s.loading&&!document.hidden&&ke()},Oo);let yt="";fetch(`${location.origin}/index.html?_t=${Date.now()}`).then(e=>e.text()).then(e=>{yt=e}).catch(()=>{});setInterval(async()=>{if(!(!yt||document.hidden))try{await(await fetch(`${location.origin}/index.html?_t=${Date.now()}`)).text()!==yt&&!s.updateAvailable&&(s.updateAvailable=!0,h())}catch{}},120*1e3);
