(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function n(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=n(o);fetch(o.href,i)}})();const Re="modulepreload",Me=function(t){return"/sake-system/"+t},jt={},C=function(e,n,s){let o=Promise.resolve();if(n&&n.length>0){let c=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};var d=c;document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),r=l?.nonce||l?.getAttribute("nonce");o=c(n.map(u=>{if(u=Me(u),u in jt)return;jt[u]=!0;const p=u.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${h}`))return;const y=document.createElement("link");if(y.rel=p?"stylesheet":Re,p||(y.as="script"),y.crossOrigin="",y.href=u,r&&y.setAttribute("nonce",r),document.head.appendChild(y),p)return new Promise((P,F)=>{y.addEventListener("load",P),y.addEventListener("error",()=>F(new Error(`Unable to preload CSS for ${u}`)))})}))}function i(l){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=l,window.dispatchEvent(r),!r.defaultPrevented)throw l}return o.then(l=>{for(const r of l||[])r.status==="rejected"&&i(r.reason);return e().catch(i)})},K="https://loarwnuyvfxiscjjsmiz.supabase.co",vt="";async function bt(t,e){return null}async function f(t,e={}){return[]}const zt=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:vt,SUPABASE_URL:K,supabaseInsert:bt,supabaseQuery:f},Symbol.toStringTag,{value:"Module"})),gt="sake_auth";function Xt(t){localStorage.setItem(gt,JSON.stringify(t))}function Zt(){return{apikey:vt,"Content-Type":"application/json"}}function qe(t){try{const[,e]=t.split(".");if(!e)return null;const n=e.replaceAll("-","+").replaceAll("_","/"),s=n.padEnd(Math.ceil(n.length/4)*4,"=");return JSON.parse(atob(s))}catch{return null}}async function te(t,e){const n=await fetch(`${K}/auth/v1/${t}`,{method:"POST",headers:Zt(),body:JSON.stringify(e)}),s=await n.json().catch(()=>({}));if(!n.ok)throw new Error(s.error_description??s.msg??`HTTP ${n.status}`);return s}async function Ie(t,e){const n=await te("token?grant_type=password",{email:t,password:e});return Xt({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??t}}async function Fe(t,e){const n=await te("signup",{email:t,password:e});return n.access_token&&n.refresh_token&&Xt({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??t}}async function Oe(){const t=ft();if(localStorage.removeItem(gt),!!t?.access_token)try{await fetch(`${K}/auth/v1/logout`,{method:"POST",headers:{...Zt(),Authorization:`Bearer ${t.access_token}`}})}catch(e){console.warn("Supabase sign out failed",e)}}function ft(){const t=localStorage.getItem(gt);if(!t)return null;try{const e=JSON.parse(t);return!e.access_token||!e.refresh_token?null:{access_token:e.access_token,refresh_token:e.refresh_token}}catch{return null}}function Ve(){const t=ft();if(!t)return null;const e=qe(t.access_token),n=typeof e?.email=="string"?e.email:null;return n?{email:n}:null}const $t={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
ご注文締切や納品希望日がございましたら、あわせてお知らせください。`}},st={generatedAt:"2026-04-15T09:15:00+09:00",kpis:{todaySales:1248e3,todayDelta:8.2,monthSales:18245e3,monthDelta:5.6,unpaidCount:7,unpaidAmount:264e4},dailySales:Array.from({length:30},(t,e)=>{const n=new Date("2026-03-17T00:00:00+09:00");return n.setDate(n.getDate()+e),{date:n.toISOString(),amount:42e4+e*73123%62e4}}),salesRecords:Array.from({length:20},(t,e)=>{const n=new Date("2026-04-15T00:00:00+09:00");return n.setDate(n.getDate()-e),{id:`sale-${e+1}`,documentNo:`D${String(240100+e).padStart(6,"0")}`,date:n.toISOString(),customerCode:`C${String(e+11).padStart(4,"0")}`,customerName:["青葉商事","北斗酒販","中央フーズ","東海酒店"][e%4],amount:68e3+e%6*24500}})},Je={generatedAt:"2026-04-15T09:15:00+09:00",records:[{id:"pay-1",customerCode:"C0011",customerName:"青葉商事",billedAmount:54e4,paymentAmount:0,balanceAmount:54e4,lastPaymentDate:null,status:"unpaid"},{id:"pay-2",customerCode:"C0012",customerName:"北斗酒販",billedAmount:72e4,paymentAmount:3e5,balanceAmount:42e4,lastPaymentDate:"2026-04-11T14:30:00+09:00",status:"partial"},{id:"pay-3",customerCode:"C0013",customerName:"中央フーズ",billedAmount:68e4,paymentAmount:68e4,balanceAmount:0,lastPaymentDate:"2026-04-14T10:00:00+09:00",status:"paid"},{id:"pay-4",customerCode:"C0014",customerName:"東海酒店",billedAmount:41e4,paymentAmount:18e4,balanceAmount:23e4,lastPaymentDate:"2026-04-10T09:10:00+09:00",status:"partial"}]},x={generatedAt:"2026-04-15T09:15:00+09:00",summary:{customerCount:164,activeCustomerCount:152,productCount:486,activeProductCount:461},customers:Array.from({length:12},(t,e)=>({id:`customer-${e+1}`,code:`C${String(e+1).padStart(4,"0")}`,name:["青葉商事","北斗酒販","中央フーズ","東海酒店","三和物産","南星リカー"][e%6],closingDay:[15,20,25,31][e%4],paymentDay:[5,10,15,20][e%4],isActive:e%5!==0})),products:Array.from({length:12},(t,e)=>({id:`product-${e+1}`,code:`P${String(e+1).padStart(5,"0")}`,janCode:`4901234567${String(e).padStart(3,"0")}`,name:["純米吟醸 720ml","本醸造 1.8L","特別純米 300ml","梅酒 500ml"][e%4],category:["清酒","焼酎","リキュール"][e%3],isActive:e%6!==0}))},Be={generatedAt:"2026-04-15T09:15:00+09:00",lastSyncAt:"2026-04-15T09:12:21+09:00",status:"success",jobName:"daily-sync",message:"同期完了。売上・入金・マスタを最新化しました。"},ee=st.salesRecords.map((t,e)=>({...t,itemCount:e%4+1})),Ue={C0011:{customerCode:"C0011",customerName:"青葉商事",balanceAmount:54e4,salesTotal:114e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-1",date:"2026-04-15T00:00:00+09:00",documentNo:"D240100",amount:42e4},{id:"ledger-sale-2",date:"2026-04-08T00:00:00+09:00",documentNo:"D240087",amount:39e4},{id:"ledger-sale-3",date:"2026-03-28T00:00:00+09:00",documentNo:"D240059",amount:33e4}],paymentHistory:[{id:"ledger-payment-1",date:"2026-04-10T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-2",date:"2026-03-31T00:00:00+09:00",amount:3e5,method:"振込"}]},C0012:{customerCode:"C0012",customerName:"北斗酒販",balanceAmount:42e4,salesTotal:102e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-4",date:"2026-04-14T00:00:00+09:00",documentNo:"D240101",amount:36e4},{id:"ledger-sale-5",date:"2026-04-05T00:00:00+09:00",documentNo:"D240082",amount:32e4},{id:"ledger-sale-6",date:"2026-03-25T00:00:00+09:00",documentNo:"D240054",amount:34e4}],paymentHistory:[{id:"ledger-payment-3",date:"2026-04-11T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-4",date:"2026-03-30T00:00:00+09:00",amount:3e5,method:"現金"}]}},nt={productTotals:[{code:"P00001",name:"純米吟醸 720ml",amount:584e4,quantity:820,documents:148},{code:"P00002",name:"本醸造 1.8L",amount:498e4,quantity:610,documents:131},{code:"P00003",name:"特別純米 300ml",amount:356e4,quantity:1240,documents:112},{code:"P00004",name:"梅酒 500ml",amount:287e4,quantity:540,documents:89}],customerTotals:[{code:"C0011",name:"青葉商事",amount:462e4,quantity:320,documents:54},{code:"C0012",name:"北斗酒販",amount:438e4,quantity:294,documents:49},{code:"C0013",name:"中央フーズ",amount:391e4,quantity:276,documents:45},{code:"C0014",name:"東海酒店",amount:324e4,quantity:221,documents:37}]};function b(t){if(typeof t=="number"&&Number.isFinite(t))return t;if(typeof t=="string"){const e=Number(t);return Number.isFinite(e)?e:0}return 0}function He(t){switch((t??"").toLowerCase()){case"paid":case"complete":case"completed":return"paid";case"partial":case"partially_paid":case"partially paid":return"partial";default:return"unpaid"}}function Ke(t){return typeof t=="boolean"?t:typeof t=="number"?t!==0:typeof t=="string"?["true","1","active","enabled","yes","y"].includes(t.toLowerCase()):!1}function S(t,e,n=""){for(const s of e){const o=t[s];if(typeof o=="string"&&o.length>0)return o}return n}function Pt(t,e,n=0){for(const s of e)if(s in t)return b(t[s]);return n}function Tt(t,e,n=!0){for(const s of e)if(s in t)return Ke(t[s]);return n}function ae(t,e,n){for(const s of e){const o=t[s];if(typeof o!="string"||o.length===0)continue;if(/^\d{4}-\d{2}-\d{2}$/.test(o))return new Date(`${o}T00:00:00Z`).toISOString();const i=new Date(o);if(!Number.isNaN(i.getTime()))return i.toISOString()}return n}function se(t){return t.slice(0,7)}function kt(t,e){return{id:String(t.id??`invoice-${e+1}`),documentNo:t.document_no??t.legacy_document_no??`D${String(240100+e).padStart(6,"0")}`,date:ae(t,["sales_date","document_date"],new Date().toISOString()),customerCode:t.customer_code??t.legacy_customer_code??`C${String(e+1).padStart(4,"0")}`,customerName:t.customer_name??t.customer_code??t.legacy_customer_code??"不明",itemCount:0,amount:b(t.total_amount??t.billed_amount)}}function Et(t,e){const n=e.startDate?new Date(`${e.startDate}T00:00:00`):null,s=e.endDate?new Date(`${e.endDate}T23:59:59`):null,o=e.documentNo.trim().toLowerCase(),i=e.customerCode.trim().toLowerCase();return t.filter(d=>{const l=new Date(d.date);return!(n&&l<n||s&&l>s||o&&!d.documentNo.toLowerCase().includes(o)||i&&!d.customerCode.toLowerCase().includes(i))}).sort((d,l)=>new Date(l.date).getTime()-new Date(d.date).getTime())}function Rt(t){const e=t.trim().toUpperCase(),n=Ue[e];if(n)return n;const s=st.salesRecords.find(o=>o.customerCode.toUpperCase()===e);return{customerCode:e||"未指定",customerName:s?.customerName??"該当得意先なし",balanceAmount:0,salesTotal:0,paymentTotal:0,salesHistory:[],paymentHistory:[]}}function Ye(){const t=new Map,e=new Map,n=new Map;return ee.forEach((s,o)=>{const i=se(s.date);t.set(i,(t.get(i)??0)+s.amount);const d=e.get(s.customerCode)??{code:s.customerCode,name:s.customerName,amount:0,quantity:0,documents:0};d.amount+=s.amount,d.quantity+=s.itemCount,d.documents+=1,e.set(s.customerCode,d);const l=`P${String(o%4+1).padStart(5,"0")}`,r=nt.productTotals[o%nt.productTotals.length],c=n.get(l)??{code:l,name:r?.name??`商品${o+1}`,amount:0,quantity:0,documents:0};c.amount+=s.amount,c.quantity+=s.itemCount*12,c.documents+=1,n.set(l,c)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(t.entries()).sort(([s],[o])=>s.localeCompare(o)).map(([s,o])=>({month:s,amount:o})),productTotals:Array.from(n.values()).sort((s,o)=>o.amount-s.amount),customerTotals:Array.from(e.values()).sort((s,o)=>o.amount-s.amount)}}async function v(t,e){try{const n=await fetch(`/sake-system/${t}`,{headers:{Accept:"application/json"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(n){return console.warn(`Failed to fetch ${t}, using fallback data`,n),e}}async function ne(){const t=await f("daily_sales_fact",{});if(t.length>0){const e=await f("customer_payment_status",{}),s=new Date().toISOString().slice(0,10),o=s.slice(0,7),i=[...t].sort((c,u)=>c.sales_date.localeCompare(u.sales_date)).slice(-30).map(c=>({date:new Date(`${c.sales_date}T00:00:00Z`).toISOString(),amount:b(c.sales_amount)})),d=t.reduce((c,u)=>u.sales_date===s?c+b(u.sales_amount):c,0),l=t.reduce((c,u)=>u.sales_date.startsWith(o)?c+b(u.sales_amount):c,0),r=e.filter(c=>b(c.balance_amount)>0);return{generatedAt:new Date().toISOString(),kpis:{todaySales:d,todayDelta:0,monthSales:l,monthDelta:0,unpaidCount:r.length,unpaidAmount:r.reduce((c,u)=>c+b(u.balance_amount),0)},dailySales:i,salesRecords:st.salesRecords}}return v("data/api/latest/sales-summary.json",st)}async function oe(){const t=await f("customer_payment_status",{});return t.length>0?{generatedAt:new Date().toISOString(),records:t.map((e,n)=>{const s=e.legacy_customer_code??`UNKNOWN-${n+1}`;return{id:`payment-${s}-${n+1}`,customerCode:s,customerName:s,billedAmount:b(e.billed_amount),paymentAmount:b(e.paid_amount),balanceAmount:b(e.balance_amount),lastPaymentDate:null,status:He(e.payment_status)}})}:v("data/api/latest/payment-status.json",Je)}async function ie(){const[t,e]=await Promise.all([f(),f()]);if(t.length>0||e.length>0){const n=t.length?t.map((o,i)=>({id:S(o,["id","customer_id","code"],`customer-${i+1}`),code:S(o,["code","customer_code","legacy_customer_code"],`C${String(i+1).padStart(4,"0")}`),name:S(o,["name","customer_name","display_name"],`Customer ${i+1}`),closingDay:Pt(o,["closing_day","close_day"],31),paymentDay:Pt(o,["payment_day","due_day"],15),isActive:Tt(o,["is_active","active","enabled"],!0)})):x.customers,s=e.length?e.map((o,i)=>({id:S(o,["id","product_id","code"],`product-${i+1}`),code:S(o,["code","product_code"],`P${String(i+1).padStart(5,"0")}`),janCode:S(o,["jan_code","jan","barcode"],""),name:S(o,["name","product_name","display_name"],`Product ${i+1}`),category:S(o,["category","category_name"],"未分類"),isActive:Tt(o,["is_active","active","enabled"],!0)})):x.products;return{generatedAt:new Date().toISOString(),summary:{customerCount:t.length||x.summary.customerCount,activeCustomerCount:t.length?n.filter(o=>o.isActive).length:x.summary.activeCustomerCount,productCount:e.length||x.summary.productCount,activeProductCount:e.length?s.filter(o=>o.isActive).length:x.summary.activeProductCount},customers:n,products:s}}return v("data/api/latest/master-stats.json",x)}function le(){return v("data/api/latest/pipeline-meta.json",Be)}async function ot(t){const[e,n]=await Promise.all([f("sales_document_headers",{}),f("sales_document_lines",{})]);if(e.length>0){const s=new Map;n.forEach(i=>{const d=String(i.header_id??i.document_header_id??i.document_no??i.id??"");d&&s.set(d,(s.get(d)??0)+1)});const o=e.map((i,d)=>{const l=kt(i,d),r=String(i.id??i.document_no??i.legacy_document_no??"");return{...l,itemCount:s.get(r)??l.itemCount}});return Et(o,t)}return Et(ee,t)}async function St(t){const e=t.trim().toUpperCase();if(!e)return Rt("");const[n,s,o]=await Promise.all([f("sales_document_headers",{}),f("customer_payments",{}),f("customer_payment_status",{})]);if(n.length>0||s.length>0){const i=n.map((r,c)=>{const u=kt(r,c);return{id:u.id,date:u.date,documentNo:u.documentNo,amount:u.amount}}),d=s.map((r,c)=>({id:String(r.id??`payment-${c+1}`),date:ae(r,["payment_date","received_date"],new Date().toISOString()),amount:b(r.payment_amount??r.amount),method:r.payment_method??r.method??"入金"})),l=o.find(r=>(r.legacy_customer_code??"").toUpperCase()===e);return{customerCode:e,customerName:n[0]?.customer_name??n[0]?.customer_code??n[0]?.legacy_customer_code??e,balanceAmount:b(l?.balance_amount),salesTotal:i.reduce((r,c)=>r+c.amount,0),paymentTotal:d.reduce((r,c)=>r+c.amount,0),salesHistory:i,paymentHistory:d}}return Rt(e)}async function ce(){const[t,e,n]=await Promise.all([f("daily_sales_fact",{}),f("sales_document_headers",{}),f("sales_document_lines",{})]);if(t.length>0){const s=new Map;t.forEach(d=>{const l=se(d.sales_date);s.set(l,(s.get(l)??0)+b(d.sales_amount))});const o=new Map;e.forEach((d,l)=>{const r=kt(d,l),c=o.get(r.customerCode)??{code:r.customerCode,name:r.customerName,amount:0,quantity:0,documents:0};c.amount+=r.amount,c.documents+=1,o.set(r.customerCode,c)});const i=new Map;return n.forEach((d,l)=>{const r=d.product_code??d.legacy_product_code??`P${String(l+1).padStart(5,"0")}`,c=i.get(r)??{code:r,name:d.product_name??r,amount:0,quantity:0,documents:0};c.amount+=b(d.line_amount??d.amount),c.quantity+=b(d.quantity),c.documents+=1,i.set(r,c)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(s.entries()).sort(([d],[l])=>d.localeCompare(l)).map(([d,l])=>({month:d,amount:l})).slice(-12),productTotals:i.size>0?Array.from(i.values()).sort((d,l)=>l.amount-d.amount):nt.productTotals,customerTotals:o.size>0?Array.from(o.values()).sort((d,l)=>l.amount-d.amount):nt.customerTotals}}return Ye()}const mt={sales:"売上",return:"返品",export_return:"輸出戻入"};async function re(t){const e=t.lines.reduce((o,i)=>o+i.amount,0),n=`D${Date.now().toString().slice(-6)}`;return{id:(await bt("sales_document_headers",{legacy_customer_code:t.customerCode,sales_date:t.invoiceDate,document_type:t.invoiceType,staff_code:t.staffCode}))?.id??`local-${n}`,documentNo:n,totalAmount:e,status:"confirmed",createdAt:new Date().toISOString()}}const Mt={documentNo:"D240122",invoiceDate:"2026-04-14",customerCode:"C0011",customerName:"青葉商事 株式会社",customerAddress:"〒123-4567 東京都千代田区〇〇 1-2-3",lines:[{productCode:"P00012",productName:"純米吟醸 720ml",quantity:6,unitPrice:12e3,unit:"本",amount:72e3},{productCode:"P00008",productName:"本醸造 1.8L",quantity:4,unitPrice:8500,unit:"本",amount:34e3},{productCode:"P00021",productName:"梅酒 500ml",quantity:12,unitPrice:5800,unit:"本",amount:69600}],totalAmount:175600,taxAmount:15960,note:""};async function wt(t){const e=await f("sales_document_headers",{});if(e.length>0){const n=e[0],s=b(n.total_amount);return{documentNo:t,invoiceDate:S(n,["sales_date","document_date"],""),customerCode:S(n,["legacy_customer_code","customer_code"],""),customerName:S(n,["customer_name","legacy_customer_code"],""),customerAddress:"",lines:[],totalAmount:s,taxAmount:Math.floor(s*10/110),note:""}}return{...Mt,documentNo:t||Mt.documentNo}}const We={targetYearMonth:"2026-04",closingDay:15,totalBilling:482e4,customers:[{customerCode:"C0011",customerName:"青葉商事",closingDay:15,salesAmount:54e4,taxAmount:54e3,prevBalance:28e4,paymentAmount:28e4,billingAmount:594e3,status:"open"},{customerCode:"C0012",customerName:"北斗酒販",closingDay:15,salesAmount:72e4,taxAmount:72e3,prevBalance:14e4,paymentAmount:14e4,billingAmount:792e3,status:"closed"},{customerCode:"C0013",customerName:"中央フーズ",closingDay:15,salesAmount:38e4,taxAmount:38e3,prevBalance:0,paymentAmount:0,billingAmount:418e3,status:"open"},{customerCode:"C0014",customerName:"東海酒店",closingDay:15,salesAmount:61e4,taxAmount:61e3,prevBalance:23e4,paymentAmount:15e4,billingAmount:751e3,status:"open"}]};async function Dt(t){return v(`data/api/latest/billing-${t}.json`,{...We,targetYearMonth:t})}const Qe=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],Ge={generatedAt:new Date().toISOString(),months:Qe,salesByProduct:[{label:"純米吟醸 720ml",values:[380,410,520,480,390,320,450,480,510,420,380,350].map(t=>t*1e4)},{label:"本醸造 1.8L",values:[290,310,380,340,280,250,320,360,390,310,280,260].map(t=>t*1e4)},{label:"梅酒 500ml",values:[210,240,310,290,230,180,260,300,320,250,200,190].map(t=>t*1e4)}],salesByCustomer:[{label:"青葉商事",values:[480,510,620,590,480,390,540,580,610,510,460,430].map(t=>t*1e4)},{label:"北斗酒販",values:[390,420,520,490,400,330,460,500,530,430,380,360].map(t=>t*1e4)}],costSimulation:[{productCode:"P00012",productName:"純米吟醸 720ml",costPrice:7200,sellPrice:12e3,margin:4800,marginRate:40},{productCode:"P00008",productName:"本醸造 1.8L",costPrice:4800,sellPrice:8500,margin:3700,marginRate:43.5},{productCode:"P00021",productName:"梅酒 500ml",costPrice:3200,sellPrice:5800,margin:2600,marginRate:44.8}]};async function de(){return v("data/api/latest/sales-report.json",Ge)}const ue={planned:"計画中",active:"仕込中",done:"完了"},ze=[{id:"j1",jikomiNo:"J2026-01",productName:"純米吟醸",riceType:"山田錦",plannedKg:400,actualKg:400,startDate:"2026-01-10",expectedDoneDate:"2026-02-20",status:"done",tankNo:"T01",note:""},{id:"j2",jikomiNo:"J2026-02",productName:"本醸造",riceType:"日本晴",plannedKg:600,actualKg:600,startDate:"2026-02-01",expectedDoneDate:"2026-03-15",status:"done",tankNo:"T02",note:""},{id:"j3",jikomiNo:"J2026-03",productName:"特別純米",riceType:"五百万石",plannedKg:500,actualKg:480,startDate:"2026-03-05",expectedDoneDate:"2026-04-20",status:"active",tankNo:"T03",note:"経過良好"},{id:"j4",jikomiNo:"J2026-04",productName:"純米大吟醸",riceType:"山田錦",plannedKg:300,actualKg:0,startDate:"2026-04-15",expectedDoneDate:"2026-06-01",status:"planned",tankNo:"T04",note:""}];async function pe(){return v("data/api/latest/jikomi.json",ze)}const Xe=[{id:"t1",tankNo:"T01",capacity:3e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-01"},{id:"t2",tankNo:"T02",capacity:4e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-20"},{id:"t3",tankNo:"T03",capacity:3500,currentVolume:2800,productName:"特別純米",jikomiNo:"J2026-03",status:"in_use",lastUpdated:"2026-04-10"},{id:"t4",tankNo:"T04",capacity:2e3,currentVolume:0,productName:"純米大吟醸",jikomiNo:"J2026-04",status:"in_use",lastUpdated:"2026-04-15"},{id:"t5",tankNo:"T05",capacity:5e3,currentVolume:3200,productName:"本醸造（貯蔵）",jikomiNo:"J2026-02",status:"aging",lastUpdated:"2026-03-20"}];async function me(){return v("data/api/latest/tanks.json",Xe)}const Ze=[{id:"k1",kenteiNo:"K2026-001",jikomiNo:"J2026-01",productName:"純米吟醸",kenteiDate:"2026-02-25",alcoholDegree:16.2,extractDegree:3.8,sakaMeterValue:2.5,volume:2850,taxCategory:"清酒",status:"approved"},{id:"k2",kenteiNo:"K2026-002",jikomiNo:"J2026-02",productName:"本醸造",kenteiDate:"2026-03-18",alcoholDegree:15.5,extractDegree:4.1,sakaMeterValue:1.8,volume:3600,taxCategory:"清酒",status:"submitted"},{id:"k3",kenteiNo:"K2026-003",jikomiNo:"J2026-03",productName:"特別純米",kenteiDate:"2026-04-18",alcoholDegree:0,extractDegree:0,sakaMeterValue:0,volume:0,taxCategory:"清酒",status:"pending"}];async function he(){return v("data/api/latest/kentei.json",Ze)}const ta=[{id:"m1",code:"M001",name:"720ml瓶",unit:"本",currentStock:2400,minimumStock:500,unitCost:85,lastUpdated:"2026-04-10"},{id:"m2",code:"M002",name:"1.8L瓶",unit:"本",currentStock:1800,minimumStock:300,unitCost:140,lastUpdated:"2026-04-10"},{id:"m3",code:"M003",name:"300ml瓶",unit:"本",currentStock:3600,minimumStock:600,unitCost:55,lastUpdated:"2026-04-08"},{id:"m4",code:"M004",name:"キャップ（金）",unit:"個",currentStock:8e3,minimumStock:1e3,unitCost:12,lastUpdated:"2026-04-05"},{id:"m5",code:"M005",name:"ラベル（純米吟醸）",unit:"枚",currentStock:1200,minimumStock:300,unitCost:28,lastUpdated:"2026-04-01"},{id:"m6",code:"M006",name:"化粧箱（720ml）",unit:"個",currentStock:180,minimumStock:100,unitCost:320,lastUpdated:"2026-04-01"}];async function ye(){return v("data/api/latest/materials.json",ta)}const ea=[{id:"p1",documentNo:"K240050",purchaseDate:"2026-04-05",supplierCode:"S001",supplierName:"山田農場",itemName:"山田錦（精米65%）",quantity:500,unitPrice:480,amount:24e4,status:"confirmed"},{id:"p2",documentNo:"K240051",purchaseDate:"2026-04-06",supplierCode:"S002",supplierName:"日本瓶工業",itemName:"720ml瓶",quantity:1200,unitPrice:85,amount:102e3,status:"confirmed"},{id:"p3",documentNo:"K240052",purchaseDate:"2026-04-10",supplierCode:"S003",supplierName:"山本麹店",itemName:"米麹",quantity:80,unitPrice:1200,amount:96e3,status:"pending"},{id:"p4",documentNo:"K240053",purchaseDate:"2026-04-12",supplierCode:"S001",supplierName:"山田農場",itemName:"五百万石（精米60%）",quantity:300,unitPrice:420,amount:126e3,status:"pending"}],aa=[{supplierCode:"S001",supplierName:"山田農場",totalPurchase:366e3,paidAmount:24e4,balance:126e3,nextPaymentDate:"2026-04-30",status:"partial"},{supplierCode:"S002",supplierName:"日本瓶工業",totalPurchase:102e3,paidAmount:102e3,balance:0,nextPaymentDate:"",status:"paid"},{supplierCode:"S003",supplierName:"山本麹店",totalPurchase:96e3,paidAmount:0,balance:96e3,nextPaymentDate:"2026-04-30",status:"unpaid"}],sa=[{id:"b1",billNo:"H240001",supplierName:"山田農場",amount:24e4,issueDate:"2026-03-31",dueDate:"2026-04-30",status:"holding"},{id:"b2",billNo:"H240002",supplierName:"大阪資材",amount:185e3,issueDate:"2026-03-31",dueDate:"2026-05-31",status:"holding"},{id:"b3",billNo:"H230045",supplierName:"中部農業",amount:32e4,issueDate:"2026-02-28",dueDate:"2026-03-31",status:"cleared"}],na=[{code:"R001",name:"山田錦（精米65%）",unit:"kg",currentStock:380,minimumStock:100,lastPurchaseDate:"2026-04-05",unitCost:480},{code:"R002",name:"五百万石（精米60%）",unit:"kg",currentStock:290,minimumStock:100,lastPurchaseDate:"2026-04-12",unitCost:420},{code:"R003",name:"米麹",unit:"kg",currentStock:62,minimumStock:20,lastPurchaseDate:"2026-04-10",unitCost:1200},{code:"R004",name:"醸造用アルコール",unit:"L",currentStock:240,minimumStock:50,lastPurchaseDate:"2026-03-20",unitCost:180},{code:"R005",name:"清酒用酵母",unit:"g",currentStock:500,minimumStock:100,lastPurchaseDate:"2026-02-15",unitCost:3200}];async function ve(){return v("data/api/latest/purchases.json",ea)}async function be(){return v("data/api/latest/payables.json",aa)}async function ge(){return v("data/api/latest/bills.json",sa)}async function fe(){return v("data/api/latest/raw-stock.json",na)}const $e=[{code:"01",name:"清酒（普通酒）",taxRatePerLiter:100},{code:"02",name:"清酒（純米酒）",taxRatePerLiter:100},{code:"03",name:"清酒（吟醸酒）",taxRatePerLiter:100},{code:"04",name:"清酒（大吟醸酒）",taxRatePerLiter:100},{code:"05",name:"本格焼酎",taxRatePerLiter:250},{code:"06",name:"リキュール",taxRatePerLiter:200},{code:"07",name:"果実酒",taxRatePerLiter:100},{code:"08",name:"その他醸造酒",taxRatePerLiter:100}],ht={export:"輸出",sample:"見本",research:"試験醸造",loss:"欠減"},oa={targetYear:2026,targetMonth:3,companyName:"金井酒造店",companyNo:"1234567890123",companyAddress:"神奈川県秦野市堀山下182",companyRepresentative:"金井 和雄",taxOffice:"小田原税務署",rows:[{taxCategory:"01",taxCategoryName:"清酒（普通酒）",alcoholDegree:15.5,productionVolume:3800,previousBalance:0,currentAdjustment:0,exportDeduction:100,sampleDeduction:100,taxableVolume:3600,volume:3600,taxRate:100,taxAmount:36e4},{taxCategory:"02",taxCategoryName:"清酒（純米酒）",alcoholDegree:16.2,productionVolume:2900,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:50,taxableVolume:2850,volume:2850,taxRate:100,taxAmount:285e3},{taxCategory:"03",taxCategoryName:"清酒（吟醸酒）",alcoholDegree:16.5,productionVolume:1250,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:50,taxableVolume:1200,volume:1200,taxRate:100,taxAmount:12e4}],deductions:[{type:"export",categoryCode:"01",volume:100,reason:"シンガポール向け輸出",documentNo:"EX2026-003"},{type:"sample",categoryCode:"01",volume:100,reason:"展示会サンプル出荷"},{type:"sample",categoryCode:"02",volume:50,reason:"品評会出品"},{type:"sample",categoryCode:"03",volume:50,reason:"全国新酒鑑評会出品"}],totalVolume:7650,totalTax:765e3,status:"draft",submittedAt:null};async function Ct(t,e){return v(`data/api/latest/tax-${t}-${String(e).padStart(2,"0")}.json`,{...oa,targetYear:t,targetMonth:e})}function $(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;")}function ke(t){const e=t.rows.map(s=>`    <Category>
...
`}function ia(t){const e=String(t);return/[,"\n]/.test(e)?`"${e.replaceAll('"','""')}"`:e}function la(t){const n=["酒類コード","区分名","アルコール度数","製造数量","前月繰越","当月調整","輸出控除","見本等控除","課税数量","税率(円/L)","税額(円)"].join(","),s=t.rows.map(i=>[i.taxCategory,i.taxCategoryName,i.alcoholDegree,i.productionVolume,i.previousBalance,i.currentAdjustment,i.exportDeduction,i.sampleDeduction,i.taxableVolume,i.taxRate,i.taxAmount].map(ia).join(",")),o=`,合計,,${t.rows.reduce((i,d)=>i+d.productionVolume,0)},,,${t.rows.reduce((i,d)=>i+d.exportDeduction,0)},${t.rows.reduce((i,d)=>i+d.sampleDeduction,0)},${t.totalVolume},,${t.totalTax}`;return"\uFEFF"+[n,...s,o].join(`
`)+`
`}function ca(t){const e=t.rows.map(o=>{const i=Math.max(0,o.productionVolume+o.previousBalance+o.currentAdjustment-o.exportDeduction-o.sampleDeduction),d=Math.round(i*o.taxRate);return{...o,taxableVolume:i,volume:i,taxAmount:d}}),n=e.reduce((o,i)=>o+i.taxableVolume,0),s=e.reduce((o,i)=>o+i.taxAmount,0);return{...t,rows:e,totalVolume:n,totalTax:s}}async function ra(t){const{supabaseInsert:e}=await C(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>zt);return{supabaseInsert:n}},void 0);await e("tax_declarations",{target_year:t.targetYear,target_month:t.targetMonth,company_name:t.companyName,company_no:t.companyNo,company_address:t.companyAddress,company_representative:t.companyRepresentative,tax_office:t.taxOffice,total_taxable_volume:t.totalVolume,total_tax_amount:t.totalTax,status:t.status,xml_data:ke(t),submitted_at:t.submittedAt})}const da=Array.from({length:10},(t,e)=>({id:`ss${e+1}`,saleDate:"2026-04-15",saleTime:`${9+e}:${String(e*7%60).padStart(2,"0")}`,productCode:`P${String(e%4+1).padStart(5,"0")}`,productName:["純米吟醸 720ml","本醸造 1.8L","梅酒 500ml","特別純米 300ml"][e%4],quantity:1+e%3,unitPrice:[2200,1800,980,680][e%4],amount:(1+e%3)*[2200,1800,980,680][e%4],paymentMethod:["cash","card","paypay","cash"][e%4]})),ua=[{id:"o1",orderNo:"ORD-2604001",orderDate:"2026-04-13",customerName:"鈴木 太郎",postalCode:"150-0001",address:"東京都渋谷区〇〇1-1",items:[{productName:"純米吟醸 720ml",quantity:2,amount:4400}],totalAmount:4400,status:"shipped",shippingDate:"2026-04-14"},{id:"o2",orderNo:"ORD-2604002",orderDate:"2026-04-14",customerName:"田中 花子",postalCode:"530-0001",address:"大阪府大阪市北区〇〇2-3",items:[{productName:"梅酒 500ml",quantity:3,amount:2940},{productName:"本醸造 1.8L",quantity:1,amount:1800}],totalAmount:4740,status:"processing",shippingDate:""},{id:"o3",orderNo:"ORD-2604003",orderDate:"2026-04-15",customerName:"佐藤 一郎",postalCode:"460-0001",address:"愛知県名古屋市中区〇〇3-5",items:[{productName:"特別純米 300ml ×6本セット",quantity:1,amount:3980}],totalAmount:3980,status:"new",shippingDate:""}];async function xt(t){return v(`data/api/latest/store-sales-${t}.json`,da)}async function Se(){return v("data/api/latest/store-orders.json",ua)}async function at(t){const e=await bt("email_campaigns",{subject:t.subject,body:t.body,template_id:t.templateId,audience_mode:t.audienceMode,audience_filter:t.audienceFilter,recipient_count:t.recipientCount,sent_count:t.status==="sent"?t.recipientCount:0,status:t.status,sent_at:t.status==="sent"?new Date().toISOString():null});return{id:e?.id??`local-email-${Date.now()}`,subject:e?.subject??t.subject,body:e?.body??t.body,templateId:e?.template_id??t.templateId,audienceMode:e?.audience_mode??t.audienceMode,audienceFilter:e?.audience_filter??t.audienceFilter,recipientCount:e?.recipient_count??t.recipientCount,status:e?.status??t.status,createdAt:e?.created_at??new Date().toISOString(),updatedAt:e?.updated_at??new Date().toISOString()}}async function we(t){throw new Error("VITE_RESEND_API_KEY is not configured")}const T=Object.freeze(Object.defineProperty({__proto__:null,INVOICE_TYPE_LABELS:mt,JIKOMI_STATUS_LABELS:ue,SEASONAL_TEMPLATES:$t,TAX_DEDUCTION_LABELS:ht,TAX_RATE_CATEGORIES:$e,fetchBillList:ge,fetchBillingSummary:Dt,fetchCustomerLedger:St,fetchDeliveryNote:wt,fetchInvoices:ot,fetchJikomiList:pe,fetchKenteiList:he,fetchMasterStats:ie,fetchMaterialList:ye,fetchPayableList:be,fetchPaymentStatus:oe,fetchPipelineMeta:le,fetchPurchaseList:ve,fetchRawMaterialStock:fe,fetchSalesAnalytics:ce,fetchSalesReport:de,fetchSalesSummary:ne,fetchStoreOrders:Se,fetchStoreSales:xt,fetchTankList:me,fetchTaxDeclaration:Ct,generateTaxCSV:la,generateTaxXML:ke,recalculateTaxDeclaration:ca,saveEmailCampaign:at,saveInvoice:re,saveTaxDeclaration:ra,sendEmailCampaign:we},Symbol.toStringTag,{value:"Module"}));function E(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}const pa={open:"未締め",closed:"締め済"};function ma(t,e){const n=t.customers.map(s=>`
      <tr>
        <td>
        ...
        <td class="numeric">${E(s.salesAmount)}</td>
        <td class="numeric">${E(s.taxAmount)}</td>
        <td class="numeric">${E(s.prevBalance)}</td>
        <td class="numeric">${E(s.paymentAmount)}</td>
        <td class="numeric"><strong>${E(s.billingAmount)}</strong></td>
        <td>
          <span class="status-pill ${s.status==="closed"?"success":"warning"}">${pa[s.status]}</span>
        </td>
        <td>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${E(t.totalBilling)}</p>
  ...
  `}function De(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function U(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function va(t){return t.salesHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':t.salesHistory.map(e=>`
        <tr>
          <td>${De(e.date)}</td>
          <td class="mono">${e.documentNo}</td>
          <td class="numeric">${U(e.amount)}</td>
        </tr>
      `).join("")}function ba(t){return t.paymentHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':t.paymentHistory.map(e=>`
        <tr>
          <td>${De(e.date)}</td>
          <td>${e.method}</td>
          <td class="numeric">${U(e.amount)}</td>
        </tr>
      `).join("")}function ga(t,e){return`
    <section class="page-head">
      <div>
    ...
    <section class="ledger-grid">
      <article class="panel ledger-summary">
        ...
        <dl class="summary-list">
          <div>
            <dt>売上累計</dt>
            <dd>${U(t.salesTotal)}</dd>
          </div>
          <div>
            <dt>入金累計</dt>
            <dd>${U(t.paymentTotal)}</dd>
          </div>
          <div>
            <dt>残高</dt>
            <dd class="${t.balanceAmount>0?"balance-warning":""}">${U(t.balanceAmount)}</dd>
          </div>
        </dl>
      </article>
  ...
  `}function W(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Q(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function O(t,e){for(const n of e){const s=t[n];if(typeof s=="number"&&Number.isFinite(s))return s;if(typeof s=="string"){const o=Number(s);if(Number.isFinite(o))return o}}return null}function fa(t){const e=t?.productTotals;if(!e||e.length===0)return"―";const n=e.reduce((o,i)=>{const d=O(i,["amount","salesAmount"]),l=O(i,["marginRate","grossMarginRate"]);return d===null||d<=0||l===null?o:{weightedAmount:o.weightedAmount+d,weightedRate:o.weightedRate+d*l}},{weightedAmount:0,weightedRate:0});if(n.weightedAmount>0)return`${(n.weightedRate/n.weightedAmount).toFixed(1)}%`;const s=e.reduce((o,i)=>{const d=i,l=O(d,["amount","salesAmount"]),r=O(d,["grossProfit","grossAmount","margin"]),c=O(d,["costAmount","cost","costPrice"]);if(l===null||l<=0)return o;const u=r??(c!==null?l-c:null);return u===null?o:{sales:o.sales+l,gross:o.gross+u}},{sales:0,gross:0});return s.sales>0?`${(s.gross/s.sales*100).toFixed(1)}%`:"―"}function $a(t){const s={top:20,right:20,bottom:30,left:50},o=760-s.left-s.right,i=260-s.top-s.bottom,d=Math.max(...t.map(u=>u.amount),1),l=o/t.length,r=t.map((u,p)=>{const h=u.amount/d*i,y=s.left+p*l+4,P=s.top+i-h,F=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(u.date));return`
        <g>
          <rect x="${y}" y="${P}" width="${Math.max(l-8,8)}" height="${h}" rx="4" fill="#0F5B8D" opacity="${.58+p/t.length*.34}" />
          ${p%5===0?`<text x="${y+6}" y="252" class="chart-axis">${F}</text>`:""}
        </g>
      `}).join("");return`
  ...
  `}function ka(t,e,n){const s={success:"正常",warning:"注意",error:"異常",running:"実行中"},o=t.salesRecords.slice(0,10).map(i=>`
            <tr>
    ...
    <section class="page-head">
      ...
      <div class="meta-stack">
        ...
        <span class="meta-note">最終同期 ${Q(e.lastSyncAt)}</span>
      </div>
    </section>
      ...
      <aside class="panel sync-panel">
        <div>
          ...
          <dl class="meta-list">
            ...
            <div>
              <dt>最終同期</dt>
              <dd>${Q(e.lastSyncAt)}</dd>
            </div>
            <div>
              <dt>更新時刻</dt>
              <dd>${Q(e.generatedAt)}</dd>
            </div>
          </dl>
        </div>
  ...
  `}function Sa(t){return t?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(t)):""}function R(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function wa(t,e){const n=t.lines.length?t.lines.map((o,i)=>`
          <tr>
    ...
    <article class="panel delivery-note-body" id="delivery-print-area">
      <div class="delivery-header">
        ...
        <div class="delivery-meta">
          <table class="delivery-meta-table">
            ...
            <tr><th>納品日</th><td>${Sa(t.invoiceDate)}</td></tr>
            <tr><th>合計金額</th><td class="numeric">${R(t.totalAmount)}（税込）</td></tr>
          </table>
      ...
      <div class="delivery-footer">
        <div class="delivery-totals">
          <div class="total-stack"><span class="total-label">小計</span><span class="total-value">${R(s)}</span></div>
          <div class="total-stack"><span class="total-label">消費税（10%）</span><span class="total-value">${R(t.taxAmount)}</span></div>
          <div class="total-stack total-grand"><span class="total-label">合計（税込）</span><span class="total-value">${R(t.totalAmount)}</span></div>
        </div>
        ${t.note?`<p class="delivery-note-text">備考：${t.note}</p>`:""}
      </div>
    </article>
  `}function D(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Da(t){return D(t).replaceAll(`
`,"<br />")}function Ca(t){const n=[...Object.values($t),{id:"custom",season:"カスタム",subject:"",body:""}].map(o=>`
        <button
        ...
        >
          ...
          <strong>${D(o.subject||"空テンプレート")}</strong>
        </button>
      `).join(""),s=t.previewRecipients.length?t.previewRecipients.map(o=>`
            <li>
              <span>${D(o.name)}</span>
              <span class="table-sub">${D(o.email)} / ${D(o.area)}</span>
            </li>
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="email-preview">
          ...
          <div class="preview-box">${t.body?Da(t.body):"本文未入力"}</div>
        </div>
  ...
  `}function k(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function G(t,e){return e.length===0?"":`
  ...
  `}function xa(t,e){const n=[G("得意先",e.customers.map(o=>`
          <button
  ...
  `}function V(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ce(t){const e=t.resultsHtml.trim()?t.resultsHtml:`<p class="empty-note">${V(t.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function z(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function It(t){return t.trim().toLowerCase()}function _a(t,e){const n=It(e),s=t.filter(i=>n?[i.code,i.name,i.name].map(It).some(d=>d.includes(n)):!0).slice(0,50),o=s.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Ce({title:"得意先検索",searchQuery:e,placeholder:"コード・名前で検索",resultsHtml:o,emptyMessage:"該当する得意先が見つかりません。"})}function Aa(t){return t.toISOString().slice(0,10)}function j(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function _(t,e){return t[e]?`<div class="field-error">${j(t[e])}</div>`:""}function M(t,e,n=""){return[n,t[e]?"has-error":""].filter(Boolean).join(" ")}function La(t,e,n,s){const o=Object.keys(mt).map(r=>`<option value="${r}" ${t.invoiceType===r?"selected":""}>${mt[r]}</option>`).join(""),i=t.lines.map((r,c)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${M(s,`lines.${c}.productCode`,"input-cell")}" type="text" data-line="${c}" data-field="productCode" value="${j(r.productCode)}" placeholder="P00001" />
            <button class="picker-btn" type="button" data-action="open-product-picker" data-line="${c}" aria-label="商品検索">🔍</button>
          </div>
          ${_(s,`lines.${c}.productCode`)}
        </td>
        <td>
          <input class="${M(s,`lines.${c}.productName`,"input-cell")}" type="text" data-line="${c}" data-field="productName" value="${j(r.productName)}" placeholder="商品名" />
          ${_(s,`lines.${c}.productName`)}
        </td>
        <td>
          <input class="${M(s,`lines.${c}.quantity`,"input-cell numeric")}" type="number" data-line="${c}" data-field="quantity" value="${r.quantity}" min="0" />
          ${_(s,`lines.${c}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${c}" data-field="unit" value="${r.unit}" placeholder="本" /></td>
        <td>
          <input class="${M(s,`lines.${c}.unitPrice`,"input-cell numeric")}" type="number" data-line="${c}" data-field="unitPrice" value="${r.unitPrice}" min="0" />
          ${_(s,`lines.${c}.unitPrice`)}
        </td>
    ...
    `).join(""),d=t.lines.reduce((r,c)=>r+c.amount,0),l=Math.floor(d*10/110);return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${M(s,"invoiceDate")}" id="inv-date" type="date" value="${t.invoiceDate||Aa(new Date)}" />
          ${_(s,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
  ...
  `}function Na(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function ja(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Pa(t,e){const n=t.length?t.map(s=>`
            <tr>
              ...
              <td class="numeric">${ja(s.amount)}</td>
            </tr>
  ...
  `}function Ta(t){return new Date(t.getFullYear(),t.getMonth(),1)}function Ea(t,e){return new Date(t.getFullYear(),t.getMonth()+e,1)}function xe(t,e){const n=new Date(t);return n.setDate(n.getDate()+e),n}function _e(t){const e=new Date(t),n=e.getDay();return e.setDate(e.getDate()-n),e.setHours(0,0,0,0),e}function Ft(t){const e=xe(_e(t),6);return e.setHours(23,59,59,999),e}function Ot(t){return new Date(`${t}T00:00:00`)}function Vt(t){return`${t.getMonth()+1}/${t.getDate()}`}function Ra(t){return t.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function Ma(){const t=new Date,e=_e(Ea(Ta(t),-3)),n=Ft(new Date(t.getFullYear(),t.getMonth()+4,0)),s=[];let o=new Date(e);for(;o<=n;){const i=Ft(o);s.push({start:new Date(o),end:i,label:`${Vt(o)} - ${Vt(i)}`}),o=xe(o,7)}return s}function qa(t){const e=Ma(),n=`160px repeat(${e.length}, minmax(56px, 1fr))`,s=e.map(i=>`
        <div class="gantt-week">
          <span>${i.label}</span>
        </div>
      `).join(""),o=t.length?t.map(i=>{const d=Ot(i.startDate),l=Ot(i.expectedDoneDate),r=Math.max(0,e.findIndex(p=>p.end>=d)),c=Math.max(r,e.reduce((p,h,y)=>h.start<=l?y:p,r)),u=[`仕込番号: ${i.jikomiNo}`,`銘柄: ${i.productName}`,`期間: ${i.startDate} - ${i.expectedDoneDate}`,`タンク: ${i.tankNo}`,`備考: ${i.note||"なし"}`].join(`
`);return`
  ...
  `}function Jt(t,e){const n={planned:"neutral",active:"warning",done:"success"},s=t.map(l=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${n[l.status]}">${ue[l.status]}</span>
        </td>
        <td>${l.note||"―"}</td>
      </tr>
  ...
  `}function Ia(t){const e={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},s=t.map(r=>`
      <tr>
    ...
    `).join(""),o=t.filter(r=>r.status==="approved").length,i=t.filter(r=>r.status==="submitted").length,d=t.filter(r=>r.status==="pending").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>検定管理</h1>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${t.filter(r=>r.status==="approved").reduce((r,c)=>r+c.volume,0).toLocaleString("ja-JP")} L</p>
  ...
  `}function Fa(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Oa(t,e){return`
  ...
  `}function Va(t){return t.map(e=>`
      ...
      `).join("")}function Ja(t){return t.map(e=>`
        <tr>
          <td class="mono">${e.code}</td>
      ...
      <div class="table-wrap">
        ...
        `:`
          <table>
            ...
            <tbody>${Ja(t.products)}</tbody>
          </table>
        `}
      </div>
    </section>
  `}function ct(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Ua(t){const e=t.map(o=>{const d=(o.minimumStock>0?o.currentStock/o.minimumStock:1/0)<1.5;return`
        <tr>
  ...
  `}function Ha(t){return t?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t)):"-"}function rt(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}const Ka={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Ya(t){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td>${Ha(n.lastPaymentDate)}</td>
          <td><span class="status-pill ${n.status==="paid"?"success":n.status==="partial"?"warning":"danger"}">${Ka[n.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function q(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Bt(t){return t.trim().toLowerCase()}function Wa(t,e){const n=Bt(e),s=t.filter(i=>n?[i.code,i.name,i.janCode].map(Bt).some(d=>d.includes(n)):!0),o=s.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Ce({title:"商品検索",searchQuery:e,placeholder:"コード・名前・JANで検索",resultsHtml:o,emptyMessage:"該当する商品が見つかりません。"})}function A(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Qa(t,e){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},s={pending:"warning",confirmed:"neutral",paid:"success"},o={unpaid:"未払い",partial:"一部支払",paid:"支払済"},i={unpaid:"warning",partial:"neutral",paid:"success"},d=t.map(p=>`
      <tr>
    ...
    `).join(""),r=t.reduce((p,h)=>p+h.amount,0),c=e.reduce((p,h)=>p+h.balance,0),u=e.filter(p=>p.status!=="paid").length;return`
    <section class="page-head">
      <div>
  ...
  `}function J(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Ga(t,e){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},s={holding:"neutral",due:"warning",cleared:"success"},o=t.map(u=>`
      <tr>
        <td class="mono">${u.billNo}</td>
        <td>${u.supplierName}</td>
        <td class="numeric">${J(u.amount)}</td>
        <td>${u.issueDate}</td>
        <td>${u.dueDate}</td>
        <td>
    ...
    `).join(""),i=e.map(u=>{const p=u.minimumStock>0&&u.currentStock<u.minimumStock*1.2;return`
        <tr>
          ...
          <td class="numeric">${J(u.unitCost)}</td>
          <td class="numeric">${J(u.currentStock*u.unitCost)}</td>
          <td>${u.lastPurchaseDate}</td>
        </tr>
      `}).join(""),d=t.filter(u=>u.status==="holding"),l=d.reduce((u,p)=>u+p.amount,0),r=e.reduce((u,p)=>u+p.currentStock*p.unitCost,0),c=e.filter(u=>u.minimumStock>0&&u.currentStock<u.minimumStock*1.2).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">仕入管理</p>
        <h1>手形管理・原料在庫</h1>
  ...
  `}function za(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function g(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function yt(t){return`
  ...
  `}function Za(t,e,n){const s={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${za(t.lastSyncAt)}</p>
    ...
    <section class="panel">
      ...
      ${Z({stepLabel:"準備1",title:"Git（ソースコード取得に使用）",purpose:"GitHubからファイルをダウンロードするためのツール",body:`
        ...
        `})}
      ${Z({stepLabel:"準備2",title:"Python（同期スクリプトの実行環境）",purpose:"リレースクリプトを動かす",body:`
          <p class="panel-title">確認方法</p>
        ...
        `})}
      ${Z({stepLabel:"準備3",title:"pip（Pythonのパッケージ管理ツール）",purpose:"requests, pyodbc などのライブラリを入れる",body:`
          <p class="panel-title">確認方法</p>
          ...
          ${X("python get-pip.py")}
        `})}
      ${Z({stepLabel:"準備4",title:"テキストエディタ（設定ファイル編集用）",purpose:"relay_config.json を編集するため",body:`
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function ts(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function es(t){return t.replace("-","/")}function as(t){if(t.length===0)return'<div class="chart-empty">データなし</div>';const e=760,n=280,s={top:16,right:24,bottom:36,left:64},o=e-s.left-s.right,i=n-s.top-s.bottom,d=Math.max(...t.map(u=>u.amount),1),l=o/t.length,r=[0,.25,.5,.75,1].map(u=>{const p=s.top+i-i*u,h=`${Math.round(d*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${s.left}" y1="${p}" x2="${e-s.right}" y2="${p}" class="chart-grid" />
          <text x="8" y="${p+4}" class="chart-axis">${h}</text>
        </g>
      `}).join(""),c=t.map((u,p)=>{const h=u.amount/d*i,y=Math.max(l-18,24),P=s.left+p*l+(l-y)/2,F=s.top+i-h;return`
        <g>
          <rect x="${P}" y="${F}" width="${y}" height="${h}" rx="6" class="analytics-bar" />
          <text x="${P+y/2}" y="${n-10}" class="chart-axis centered-axis">${es(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function ss(t){return t.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':t.map(e=>`
        <tr>
          <td class="mono">${e.code}</td>
          <td>${e.name}</td>
          <td class="numeric">${ts(e.amount)}</td>
          <td class="numeric">${e.quantity.toLocaleString("ja-JP")}</td>
          <td class="numeric">${e.documents.toLocaleString("ja-JP")}</td>
        </tr>
      `).join("")}function ns(t,e){const n=e==="products"?"商品別集計":"得意先別集計",s=e==="products"?t.productTotals:t.customerTotals;return`
    <section class="page-head">
      <div>
  ...
  `}function B(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function os(t){const e=Math.max(...t.salesByProduct.flatMap(i=>i.values),1),n=t.salesByProduct.map(i=>{const d=i.values.map((l,r)=>`
          <div class="bar-col">
            <div class="bar" style="height:${Math.round(l/e*120)}px" title="${t.months[r]}: ${B(l)}"></div>
      ...
      <tr>
        ...
        <td>${i.productName}</td>
        <td class="numeric">${B(i.costPrice)}</td>
        <td class="numeric">${B(i.sellPrice)}</td>
        <td class="numeric">${B(i.margin)}</td>
        <td class="numeric">
          <span class="status-pill ${i.marginRate>=40?"success":"warning"}">${i.marginRate.toFixed(1)}%</span>
        </td>
      </tr>
    `).join(""),o=t.salesByCustomer.map(i=>{const d=i.values.reduce((l,r)=>l+r,0);return`
        <tr>
          <td>${i.label}</td>
  ...
  `}function is(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function ls(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Ut(t){return t.toISOString().slice(0,10)}function cs(t,e,n){const s=t.length?t.map(o=>`
            <tr>
              ...
              <td class="numeric">${ls(o.amount)}</td>
            </tr>
    ...
    <section class="panel filter-panel">
      <div class="filter-grid">
        <label class="field">
          <span>開始日</span>
          <input id="sales-start" type="date" value="${e||Ut(new Date(Date.now()-1e3*60*60*24*30))}" />
        </label>
        <label class="field">
          <span>終了日</span>
          <input id="sales-end" type="date" value="${n||Ut(new Date)}" />
        </label>
        <div class="filter-actions">
  ...
  `}function tt(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function rs(t,e,n,s){const o={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},i={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},d={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},l=t.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
        <td class="mono">${p.productCode}</td>
        <td>${p.productName}</td>
        <td class="numeric">${p.quantity}</td>
        <td class="numeric">${tt(p.unitPrice)}</td>
        <td class="numeric"><strong>${tt(p.amount)}</strong></td>
    ...
    `).join(""),r=e.map(p=>`
      <tr>
        ...
        <td class="numeric"><strong>${tt(p.totalAmount)}</strong></td>
        <td>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${e.rows.slice(0,10).map((l,r)=>`
              <tr class="${l._valid?"":"has-error"}">
                <td>${r+1}</td>
                ${e.columns.map(c=>`<td>${String(l[c]??"")}</td>`).join("")}
  ...
  `}const ps={customers:["legacy_customer_code","name"],products:["legacy_product_code","name"],suppliers:["legacy_supplier_code","name"],staff:["legacy_staff_code","name"]},ms={customers:["legacy_customer_code","name","kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"],products:["legacy_product_code","name","kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"],suppliers:["legacy_supplier_code","name","kana_name","phone","postal_code","address1","closing_day","payment_day","email"],staff:["legacy_staff_code","name","kana_name","department"]};function hs(t){t.charCodeAt(0)===65279&&(t=t.slice(1));const e=[];let n=[],s="",o=!1;for(let l=0;l<t.length;l++){const r=t[l];o?r==='"'?t[l+1]==='"'?(s+='"',l++):o=!1:s+=r:r==='"'?o=!0:r===","?(n.push(s),s=""):r===`
`||r==="\r"?(r==="\r"&&t[l+1]===`
`&&l++,n.push(s),n.some(c=>c!=="")&&e.push(n),n=[],s=""):s+=r}if((s!==""||n.length>0)&&(n.push(s),n.some(l=>l!=="")&&e.push(n)),e.length===0)return{columns:[],rows:[]};const i=e[0].map(l=>l.trim()),d=[];for(let l=1;l<e.length;l++){const r={};i.forEach((c,u)=>{r[c]=(e[l][u]??"").trim()}),d.push(r)}return{columns:i,rows:d}}function ys(t,e,n){const s=ps[t],o=s.filter(l=>!e.includes(l)),i=n.map(l=>{const r=[];o.length>0&&r.push(`必須列欠損: ${o.join(",")}`);for(const c of s)e.includes(c)&&!l[c]&&r.push(`${c}が空`);return{...l,_valid:r.length===0,_error:r[0]}}),d=i.filter(l=>l._valid).length;return{entity:t,columns:e,rows:i,totalRows:n.length,validRows:d,invalidRows:i.length-d}}function vs(t){const n=ms[t],o={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[t];return"\uFEFF"+n.join(",")+`
`+o.join(",")+`
`}async function bs(t,e){const{supabaseInsert:n}=await C(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>zt);return{supabaseInsert:l}},void 0);let s=0,o=0;const d={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[t];for(const l of e){if(!l._valid)continue;const{_valid:r,_error:c,...u}=l,p={...u};if(!p.id){const h=t==="customers"?"legacy_customer_code":t==="products"?"legacy_product_code":t==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[h]??`${t}-${Date.now()}-${s+o}`)}for(const h of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[h]=="string"&&p[h]!==""){const y=Number(p[h]);Number.isFinite(y)&&(p[h]=y)}try{await n(d,p)!==null?s++:o++}catch{o++}}return{inserted:s,failed:o}}function gs(t){const e={empty:"空",in_use:"使用中",aging:"熟成中"},n={empty:"neutral",in_use:"warning",aging:"success"},s=t.map(c=>{const u=c.capacity>0?Math.round(c.currentVolume/c.capacity*100):0;return`
        <tr>
      ...
      `}).join(""),o=t.filter(c=>c.status==="in_use").length,i=t.filter(c=>c.status==="aging").length,d=t.filter(c=>c.status==="empty").length,l=t.reduce((c,u)=>c+u.capacity,0),r=t.reduce((c,u)=>c+u.currentVolume,0);return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>タンク管理</h1>
  ...
  `}function ut(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function fs(t,e,n){const s=t.rows.map((c,u)=>`
      <tr>
        ...
        <td class="numeric"><strong>${ut(c.taxAmount)}</strong></td>
        <td>
          <button class="button-icon" data-action="tax-remove-category" data-tax-row="${u}" title="削除">✕</button>
        </td>
      </tr>
    `).join(""),o=t.deductions.map((c,u)=>`
      <tr>
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="type">
            ${Object.keys(ht).map(p=>`<option value="${p}" ${p===c.type?"selected":""}>${ht[p]}</option>`).join("")}
          </select>
        </td>
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="categoryCode">
            ${$e.map(p=>`<option value="${p.code}" ${p.code===c.categoryCode?"selected":""}>${p.code}:${p.name}</option>`).join("")}
          </select>
        </td>
        <td class="numeric">
    ...
    `).join(""),i=Array.from({length:12},(c,u)=>u+1),d=t.rows.reduce((c,u)=>c+u.exportDeduction+u.sampleDeduction,0),l=t.rows.reduce((c,u)=>c+u.productionVolume,0),r=l>0?d/l*100:0;return`
    <section class="page-head">
      <div>
    ...
    <section class="panel filter-panel">
      <div class="filter-grid">
        <label class="field">
          <span>対象年</span>
          <select id="tax-year">
            ${[2025,2026,2027].map(c=>`<option value="${c}" ${e===c?"selected":""}>${c}年</option>`).join("")}
          </select>
        </label>
        <label class="field">
          <span>対象月</span>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${ut(t.totalTax)}</p>
        ...
        <table class="entry-table">
          ...
          <tfoot>
            <tr>
              ...
              <th></th>
              <th class="numeric">${ut(t.totalTax)}</th>
              <th></th>
            </tr>
          </tfoot>
        </table>
  ...
  `}function Ht(t){const n=(t==null?"":t instanceof Date?t.toISOString():String(t)).replaceAll('"','""');return/[",\n\r]/.test(n)?`"${n}"`:n}function $s(t,e,n){if(e.length===0&&(!n||n.length===0))return;const s=n&&n.length>0?n:Object.keys(e[0]??{}).map(c=>({key:c,label:c})),i=`\uFEFF${[s.map(c=>Ht(c.label)).join(","),...e.map(c=>s.map(u=>Ht(c[u.key])).join(","))].join(`\r
`)}`,d=new Blob([i],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(d),r=document.createElement("a");r.href=l,r.download=t,document.body.append(r),r.click(),r.remove(),window.setTimeout(()=>URL.revokeObjectURL(l),0)}const ks=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import"],et=[{name:"青葉商事",email:"aoba@example.jp",area:"関東",historySegment:"seasonal"},{name:"北斗酒販",email:"hokuto@example.jp",area:"北海道",historySegment:"premium"},{name:"中央フーズ",email:"chuo@example.jp",area:"関東",historySegment:"seasonal"},{name:"東海酒店",email:"tokai@example.jp",area:"中部",historySegment:"premium"},{name:"三和物産",email:"sanwa@example.jp",area:"関西",historySegment:"liqueur"},{name:"南星リカー",email:"nansei@example.jp",area:"九州",historySegment:"seasonal"},{name:"山川酒店",email:"yamakawa@example.jp",area:"関西",historySegment:"premium"},{name:"瑞穂商店",email:"mizuho@example.jp",area:"中部",historySegment:"seasonal"}],Kt=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"}];function Ae(t){const e=$t[t];return e?{subject:e.subject,body:e.body}:{subject:"",body:""}}function _t(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function Ss(){const t=Ae("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:t.subject,body:t.body,saveMessage:null}}const lt=new Date,ws=lt.toISOString().slice(0,7),Ds=lt.getFullYear(),Cs=lt.getMonth()+1,xs=lt.toISOString().slice(0,10),_s="C0011",L=Ss();function Le(t){const e="/sake-system/".endsWith("/")?"/sake-system/".slice(0,-1):"/sake-system/",n=t.startsWith(e)?t.slice(e.length)||"/":t;return ks.includes(n)?n:"/"}function At(t){switch(t){case"/cat/sales":case"/invoice":case"/ledger":case"/invoice-entry":case"/delivery":case"/billing":case"/report":return"sales";case"/cat/brewery":case"/jikomi":case"/tanks":case"/kentei":case"/materials":return"brewery";case"/cat/purchase":case"/purchase":case"/raw-material":return"purchase";case"/cat/more":case"/master":case"/analytics":case"/tax":case"/store":case"/setup":return"more";case"/email":return"email";default:return"dashboard"}}const Yt=Le(location.pathname),a={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,invoiceRecords:[],customerLedger:null,salesAnalytics:null,invoiceForm:_t(),invoiceSaving:!1,invoiceSavedDocNo:null,pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:ws,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:Ds,taxMonth:Cs,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,storeSalesDate:xs,route:Yt,currentCategory:At(Yt),sidebarOpen:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:_s,masterTab:"customers",analyticsTab:"products",emailAudienceMode:L.mode,emailRegion:L.region,emailHistorySegment:L.historySegment,emailTemplateId:L.templateId,emailSubject:L.subject,emailBody:L.body,emailSaveMessage:L.saveMessage,emailSending:!1,globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function Wt(t){return t.slice(0,10)}function As(t){return{...t}}function it(){a.pickerMode=null,a.pickerQuery="",a.pickerTargetLine=null}function Ne(){a.invoiceForm=_t(),a.invoiceSavedDocNo=null,a.invoiceErrors={},it()}function je(t){const e={};return t.invoiceDate.trim()||(e.invoiceDate="伝票日付は必須です。"),t.customerCode.trim()||(e.customerCode="得意先コードは必須です。"),t.lines.length===0&&(e.lines="明細を1行以上入力してください。"),t.lines.forEach((n,s)=>{n.productCode.trim()||(e[`lines.${s}.productCode`]="商品コードは必須です。"),n.productName.trim()||(e[`lines.${s}.productName`]="商品名は必須です。"),n.quantity<=0&&(e[`lines.${s}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(e[`lines.${s}.unitPrice`]="単価は0円以上で入力してください。")}),e}function Ls(t){const e=a.invoiceForm.lines[t];e&&a.invoiceForm.lines.splice(t+1,0,As(e))}function Ns(){const t=a.invoiceRecords[0],e=a.masterStats?.customers[0],n=a.masterStats?.products.slice(0,2)??[];a.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:t?.customerCode??e?.code??"",customerName:t?.customerName??e?.name??"",staffCode:a.invoiceForm.staffCode||"S001",lines:n.map((s,o)=>{const i=o===0?1:2,d=1200*(o+1);return{productCode:s.code,productName:s.name,quantity:i,unitPrice:d,unit:"本",amount:i*d}}),note:t?`過去伝票 ${t.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},a.invoiceSavedDocNo=null,a.invoiceErrors={}}function js(t){const e=a.masterStats?.customers.find(n=>n.code.toLowerCase()===t.trim().toLowerCase());return e?(a.invoiceForm.customerCode=e.code,a.invoiceForm.customerName=e.name,!0):!1}function Ps(t){const e=a.masterStats?.customers.find(n=>n.name===t.trim());return e?(a.invoiceForm.customerCode=e.code,a.invoiceForm.customerName=e.name,!0):!1}function Pe(t){if(w(t),a.invoiceErrors=je(a.invoiceForm),Object.keys(a.invoiceErrors).length>0){m();return}a.invoiceSaving=!0,m(),re(a.invoiceForm).then(e=>{a.invoiceSavedDocNo=e.documentNo,a.invoiceSaving=!1,a.invoiceErrors={},a.invoiceForm=_t(),m()}).catch(()=>{a.invoiceSaving=!1,m()})}function Te(t){const e=a.salesFilter.startDate?new Date(a.salesFilter.startDate):null,n=a.salesFilter.endDate?new Date(`${a.salesFilter.endDate}T23:59:59`):null;return[...t.salesRecords].sort((s,o)=>new Date(o.date).getTime()-new Date(s.date).getTime()).filter(s=>{const o=new Date(s.date);return!(e&&o<e||n&&o>n)})}function Ee(){switch(a.emailAudienceMode){case"area":return a.emailRegion==="all"?et:et.filter(t=>t.area===a.emailRegion);case"history":return et.filter(t=>t.historySegment===a.emailHistorySegment);default:return et}}function Ts(){const t=Ee();return{audienceMode:a.emailAudienceMode,region:a.emailRegion,historySegment:a.emailHistorySegment,selectedTemplateId:a.emailTemplateId,subject:a.emailSubject,body:a.emailBody,recipientCount:t.length,previewRecipients:t.slice(0,5),saveMessage:a.emailSaveMessage,sending:a.emailSending}}function pt(t){const e=Ee(),n=a.emailAudienceMode==="area"?a.emailRegion:a.emailAudienceMode==="history"?a.emailHistorySegment:"all";return{subject:a.emailSubject.trim(),body:a.emailBody.trim(),templateId:a.emailTemplateId,audienceMode:a.emailAudienceMode,audienceFilter:n,recipientCount:e.length,recipients:e.map(s=>s.email),status:t}}function Lt(){return a.user,!1}function H(){a.globalSearchOpen=!1,a.globalQuery=""}function Es(){const t=a.globalQuery.trim().toLowerCase();return t?{customers:a.masterStats?.customers.filter(e=>e.code.toLowerCase().includes(t)||e.name.toLowerCase().includes(t))??[],products:a.masterStats?.products.filter(e=>e.code.toLowerCase().includes(t)||e.name.toLowerCase().includes(t))??[],documents:a.invoiceRecords.filter(e=>e.documentNo.toLowerCase().includes(t)||e.customerName.toLowerCase().includes(t)||e.date.toLowerCase().includes(t)),pages:Kt.filter(e=>e.path.toLowerCase().includes(t)||e.title.toLowerCase().includes(t))}:{customers:[],products:[],documents:[],pages:Kt}}function Rs(){let t=[],e,n="export.csv";switch(a.route){case"/sales":t=(a.salesSummary?Te(a.salesSummary):[]).map(s=>({documentNo:s.documentNo,date:s.date,customerCode:s.customerCode,customerName:s.customerName,amount:s.amount})),e=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":t=[...a.paymentStatus?.records??[]].sort((s,o)=>o.balanceAmount-s.balanceAmount).map(s=>({...s})),e=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":t=a.invoiceRecords.map(s=>({...s})),e=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":t=a.purchaseList.map(s=>({...s})),e=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":t=a.jikomiList.map(s=>({...s})),e=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":t=a.tankList.map(s=>({...s})),e=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":t=a.kenteiList.map(s=>({...s})),e=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":t=a.materialList.map(s=>({...s})),e=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":a.masterTab==="customers"?(t=a.masterStats?.customers.map(s=>({...s}))??[],e=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(t=a.masterStats?.products.map(s=>({...s}))??[],e=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}$s(n,t,e)}function Qt(t){const e=`${"/sake-system/".replace(/\/$/,"")}${t==="/"?"/":t}`;history.pushState(null,"",e),a.route=t,a.currentCategory=At(t),a.sidebarOpen=!1,H(),Nt(t)}async function Nt(t){a.actionLoading=!0,m();try{switch(t){case"/delivery":a.deliveryNote||(a.deliveryNote=await wt(a.deliverySearchDocNo||"D240122"));break;case"/billing":a.billingSummary||(a.billingSummary=await Dt(a.billingYearMonth));break;case"/report":a.salesReport||(a.salesReport=await de());break;case"/jikomi":a.jikomiList.length===0&&(a.jikomiList=await pe());break;case"/tanks":a.tankList.length===0&&(a.tankList=await me());break;case"/kentei":a.kenteiList.length===0&&(a.kenteiList=await he());break;case"/materials":a.materialList.length===0&&(a.materialList=await ye());break;case"/purchase":(a.purchaseList.length===0||a.payableList.length===0)&&([a.purchaseList,a.payableList]=await Promise.all([ve(),be()]));break;case"/raw-material":(a.billList.length===0||a.rawStockList.length===0)&&([a.billList,a.rawStockList]=await Promise.all([ge(),fe()]));break;case"/tax":a.taxDeclaration||(a.taxDeclaration=await Ct(a.taxYear,a.taxMonth));break;case"/store":(a.storeSales.length===0||a.storeOrders.length===0)&&([a.storeSales,a.storeOrders]=await Promise.all([xt(a.storeSalesDate),Se()]));break;default:break}}catch(e){console.warn("Route data load error",e)}finally{a.actionLoading=!1,m()}}function Gt(){if(Lt())return Oa(a.authError,a.authSubmitting);if(a.loading)return'<section class="panel"><p>データを読み込んでいます。</p></section>';if(a.error)return`
      <section class="panel error-card">
        <p class="eyebrow">読込失敗</p>
        <h1>画面の初期化に失敗しました</h1>
        <p>${a.error}</p>
      </section>
    `;switch(a.route){case"/cat/sales":return Y("sales");case"/cat/brewery":return Y("brewery");case"/cat/purchase":return Y("purchase");case"/cat/more":return Y("more");case"/invoice-entry":return La(a.invoiceForm,a.invoiceSavedDocNo,a.invoiceSaving,a.invoiceErrors);case"/email":return Ca(Ts());case"/delivery":return a.deliveryNote?wa(a.deliveryNote,a.deliverySearchDocNo):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/billing":return a.billingSummary?ma(a.billingSummary,a.billingYearMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/report":return a.salesReport?os(a.salesReport):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/jikomi":return a.jikomiView==="calendar"?`${Jt(a.jikomiList,a.jikomiView)}${qa(a.jikomiList)}`:Jt(a.jikomiList,a.jikomiView);case"/tanks":return gs(a.tankList);case"/kentei":return Ia(a.kenteiList);case"/materials":return Ua(a.materialList);case"/purchase":return Qa(a.purchaseList,a.payableList);case"/raw-material":return Ga(a.billList,a.rawStockList);case"/tax":return a.taxDeclaration?fs(a.taxDeclaration,a.taxYear,a.taxMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/store":return rs(a.storeSales,a.storeOrders,a.storeTab,a.storeSalesDate);case"/setup":return a.pipelineMeta?Za(a.pipelineMeta,K,vt):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/import":return us(a.importEntity,a.importPreview,a.importing,a.importResult)}if(!a.salesSummary||!a.paymentStatus||!a.masterStats||!a.pipelineMeta||!a.customerLedger||!a.salesAnalytics)return"";switch(a.route){case"/sales":return cs(Te(a.salesSummary),a.salesFilter.startDate,a.salesFilter.endDate);case"/payment":return Ya([...a.paymentStatus.records].sort((t,e)=>e.balanceAmount-t.balanceAmount));case"/master":return Ba(a.masterStats,a.masterTab);case"/invoice":return Pa(a.invoiceRecords,a.invoiceFilter);case"/ledger":return ga(a.customerLedger,a.ledgerCustomerCode);case"/analytics":return ns(a.salesAnalytics,a.analyticsTab);default:return ka(a.salesSummary,a.pipelineMeta,a.salesAnalytics)}}function Ms(){if(Lt())return`
      <div class="shell auth-shell">
        <main class="main auth-main">
          <div class="view">${Gt()}</div>
        </main>
      </div>
    `;const t={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売管理",items:[{path:"/cat/sales",label:"販売管理トップ",kicker:"Category"},{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/report",label:"集計帳票",kicker:"Report"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],brewery:[{label:"蔵内管理",items:[{path:"/cat/brewery",label:"蔵内管理トップ",kicker:"Category"},{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"}]}],purchase:[{label:"仕入管理",items:[{path:"/cat/purchase",label:"仕入管理トップ",kicker:"Category"},{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],more:[{label:"その他",items:[{path:"/cat/more",label:"その他トップ",kicker:"Category"},{path:"/tax",label:"酒税申告",kicker:"Tax"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/master",label:"マスタ",kicker:"Master"},{path:"/email",label:"メール配信",kicker:"Mail"},{path:"/setup",label:"連動設定",kicker:"Setup"}]}],email:[{label:"メール配信",items:[{path:"/email",label:"季節商品案内",kicker:"Mail"}]}]},e=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/cat/sales",label:"販売管理"},{category:"brewery",path:"/cat/brewery",label:"蔵内管理"},{category:"purchase",path:"/cat/purchase",label:"仕入管理"},{category:"more",path:"/cat/more",label:"その他"},{category:"email",path:"/email",label:"メール配信"}],n=t[a.currentCategory].map(l=>`
      ...
      `).join(""),o=a.pickerMode&&a.masterStats?a.pickerMode==="customer"?_a(a.masterStats.customers,a.pickerQuery):Wa(a.masterStats.products,a.pickerQuery):"",i=a.globalSearchOpen?xa(a.globalQuery,Es()):"",d=a.user?`
