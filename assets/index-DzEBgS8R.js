...
`,"<br />")}function Si(e){const n=[...Object.values(Et),{id:"custom",season:"カスタム",subject:"",body:""}].map(r=>`
  ...
  `}function xi(e,t){const n=[Oe("得意先",t.customers.map(r=>`
          <button
  ...
  `}function je(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Gt(e){return e.trim().toLowerCase()}function Ai(e,t){const n=Gt(t),i=e.filter(c=>n?[c.code,c.name,c.name].map(Gt).some(a=>a.includes(n)):!0).slice(0,50),r=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
...
`);return`
  ...
  `}function bt(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function eo(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function to(e){return e.map(t=>`
      ...
      `).join("")}function Me(e){return e?`¥${e.toLocaleString("ja-JP")}`:"―"}function ao(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${bt(t.name,20)}</td>
          <td>${t.kanaName||""}</td>
  ...
  `}function ze(e){if(!e)return"error";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"success":n<24?"warning":"error"}function aa(e){if(!e)return"未同期";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"正常":n<24?"注意":"要確認"}function yo(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
          ...
          <tbody>
            ${$.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':$.map(P=>`
                <tr>
                  ...
                  <td>${P.name||"未設定"}</td>
                  <td class="numeric">${st(P.amount)}</td>
                  <td class="numeric">${P.quantity.toLocaleString("ja-JP")}</td>
