...
/* タイトル行（1カラム全幅） */
.q-title-row { border-bottom:3px solid ${e}; padding-bottom:8px; margin-bottom:12px; }
...
/* タイトル行（1カラム全幅） */
.q-doc .q-title-row { border-bottom:3px solid ${e}; padding-bottom:10px; margin-bottom:14px; }
