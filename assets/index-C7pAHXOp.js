...
`}function vn(e){const t=e.rows.map(l=>{const r=Math.max(0,l.productionVolume+l.previousBalance+l.currentAdjustment-l.exportDeduction-l.sampleDeduction),d=Math.round(r*l.taxRate);return{...l,taxableVolume:r,volume:r,taxAmount:d}}),n=t.reduce((l,r)=>l+r.taxableVolume,0),i=t.reduce((l,r)=>l+r.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:i}}async function fn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>R);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:ts(e),submitted_at:e.submittedAt})}async function Nt(e){const t=await P("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(n=>({id:m(n,["id"],""),saleDate:m(n,["sale_date"],e),saleTime:m(n,["sale_time"],""),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),quantity:b(n,["quantity"],0),unitPrice:b(n,["unit_price"],0),amount:b(n,["amount"],0),paymentMethod:m(n,["payment_method"],"cash")})):[]}async function as(){const e=await P("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),orderDate:B(t,["order_date"],""),customerName:m(t,["customer_name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["shipping_address"],""),items:[],totalAmount:b(t,["total_amount"],0),status:m(t,["status"],"new"),shippingDate:B(t,["shipping_date"],"")})):[]}async function Ye(e){const t=await et("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function ss(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function bn(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await P("print_layouts",t)).map(i=>({id:m(i,["id"],""),name:m(i,["name"],""),templateKey:m(i,["template_key"],""),positions:i.positions??{},isDefault:U(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}))}async function gn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>R);return{supabaseInsert:l}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},i=await t("print_layouts",n);return i?{id:m(i,["id"],e.id),name:m(i,["name"],e.name),templateKey:m(i,["template_key"],e.templateKey),positions:i.positions??e.positions,isDefault:U(i,["is_default"],!1),note:m(i,["note"],""),updatedAt:m(i,["updated_at"],"")}:null}async function $n(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function _n(){return(await P("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),signature:m(t,["signature"],""),replyTo:m(t,["reply_to"],""),isDefault:U(t,["is_default"],!1),isVerified:U(t,["is_verified"],!1),note:m(t,["note"],"")}))}async function wn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:m(n,["id"],e.id),name:m(n,["name"],e.name),email:m(n,["email"],e.email),displayName:m(n,["display_name"],""),signature:m(n,["signature"],""),replyTo:m(n,["reply_to"],""),isDefault:U(n,["is_default"],!1),isVerified:U(n,["is_verified"],!1)}:null}async function kn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const Rt={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},Ot={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Sn(e){const t=`${e}-01T00:00:00Z`,[n,i]=e.split("-").map(a=>parseInt(a,10)),l=new Date(n,i,0).getDate(),r=`${e}-${String(l).padStart(2,"0")}T23:59:59Z`;return(await P("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${r})`,order:"starts_at.asc"})).map(a=>({id:m(a,["id"],""),title:m(a,["title"],""),description:m(a,["description"],""),category:m(a,["category"],"general")||"general",startsAt:m(a,["starts_at"],new Date().toISOString()),endsAt:m(a,["ends_at"],""),isAllDay:U(a,["is_all_day"],!1),location:m(a,["location"],""),attendees:a.attendees??[],relatedCustomerCode:m(a,["related_customer_code"],""),relatedOrderId:m(a,["related_order_id"],""),color:m(a,["color"],""),googleEventId:m(a,["google_event_id"],"")}))}async function xn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??Ot[e.category],updated_at:new Date().toISOString()})?e:null}async function Pn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ns(){return(await P("integration_settings",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),provider:m(t,["provider"],""),config:t.config??{},isEnabled:U(t,["is_enabled"],!1),lastSyncAt:m(t,["last_sync_at"],""),lastStatus:m(t,["last_status"],"")}))}async function Te(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function An(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const i=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,l=await fetch(i,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!l.ok)return{count:0,error:`HTTP ${l.status}`};const r=await l.json(),{supabaseInsert:d}=await g(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>R);return{supabaseInsert:o}},void 0);let a=0;for(const o of r.orders){const c=`shopify_${o.id}`;await d("shopify_orders",{id:c,shopify_order_id:String(o.id),order_number:String(o.order_number??""),order_date:String(o.created_at??new Date().toISOString()),customer_name:String(o.customer?.first_name??"")+" "+String(o.customer?.last_name??""),customer_email:String(o.customer?.email??""),total_amount:Math.round(parseFloat(String(o.total_price??"0"))),financial_status:String(o.financial_status??""),fulfillment_status:String(o.fulfillment_status??"unfulfilled"),line_items:o.line_items??[],shipping_address:o.shipping_address??null,raw_payload:o}),a++}return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${a}件取得成功`}),{count:a}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function En(){return(await P("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),shopifyOrderId:m(t,["shopify_order_id"],""),orderNumber:m(t,["order_number"],""),orderDate:m(t,["order_date"],""),customerName:m(t,["customer_name"],""),customerEmail:m(t,["customer_email"],""),totalAmount:q(t.total_amount),financialStatus:m(t,["financial_status"],""),fulfillmentStatus:m(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function Dn(e){const t=e.config.refresh_token,n=e.config.client_id,i=e.config.client_secret;if(!t||!n||!i)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const l=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:n,client_secret:i})});if(!l.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${l.status}`};const d=(await l.json()).access_token;return await Te({...e,config:{...e.config,oauth_token:d}}),e.config.oauth_token=d,{token:d}}async function Cn(e){let t=e.config.oauth_token;const n=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const i=new Date().toISOString(),l=new Date(Date.now()+30*86400*1e3).toISOString(),r=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${i}&timeMax=${l}&singleEvents=true&orderBy=startTime`;let d=await fetch(r,{headers:{Authorization:`Bearer ${t}`}});if(d.status===401){const u=await Dn(e);if(u.error)return{count:0,error:u.error};t=u.token,d=await fetch(r,{headers:{Authorization:`Bearer ${t}`}})}if(!d.ok)return{count:0,error:`HTTP ${d.status}`};const a=await d.json(),{supabaseInsert:o}=await g(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>R);return{supabaseInsert:u}},void 0);let c=0;for(const u of a.items){const p=`gcal_${u.id}`,y=u.start?.dateTime??u.start?.date??"",h=u.end?.dateTime??u.end?.date??"";await o("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(y),ends_at:String(h),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),c++}return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${c}件取得`}),{count:c}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Ln(){return(await P("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),receivedAt:m(t,["received_at"],""),senderPhone:m(t,["sender_phone"],""),senderName:m(t,["sender_name"],""),imageUrl:m(t,["image_url"],""),ocrStatus:m(t,["ocr_status"],"pending")||"pending",ocrText:m(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:m(t,["linked_invoice_id"],"")}))}async function In(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const i=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,l=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return l.ok?{text:(await l.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${l.status}`}}catch(i){return{text:"",error:i instanceof Error?i.message:String(i)}}}async function Tn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Xe={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Ke={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function qn(){return(await P("user_profiles",{order:"display_name.asc"})).map(t=>({id:m(t,["id"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),staffCode:m(t,["staff_code"],""),department:m(t,["department"],"all")||"all",role:m(t,["role"],"staff")||"staff",defaultMailSenderId:m(t,["default_mail_sender_id"],""),phone:m(t,["phone"],""),avatarUrl:m(t,["avatar_url"],""),isActive:U(t,["is_active"],!0),lastSignInAt:m(t,["last_sign_in_at"],""),createdAt:m(t,["created_at"],"")}))}async function Nn(e){if(!e)return null;const t=await P("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:m(n,["id"],""),email:m(n,["email"],""),displayName:m(n,["display_name"],""),staffCode:m(n,["staff_code"],""),department:m(n,["department"],"all")||"all",role:m(n,["role"],"staff")||"staff",defaultMailSenderId:m(n,["default_mail_sender_id"],""),phone:m(n,["phone"],""),avatarUrl:m(n,["avatar_url"],""),isActive:U(n,["is_active"],!0),lastSignInAt:m(n,["last_sign_in_at"],"")}}async function Rn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function On(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Mn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>R);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function jn(e=100){return(await P("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),action:m(n,["action"],""),entityType:m(n,["entity_type"],""),entityId:m(n,["entity_id"],""),userEmail:m(n,["user_email"],""),changes:n.changes??{},createdAt:m(n,["created_at"],"")}))}const We={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function is(){return(await P("slack_notifications",{order:"event_type.asc"})).map(t=>({id:m(t,["id"],""),eventType:m(t,["event_type"],"new_order"),enabled:U(t,["enabled"],!0),channel:m(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:m(t,["last_triggered_at"],"")}))}async function Fn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function Bn(e=50){return(await P("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),eventType:m(n,["event_type"],""),channel:m(n,["channel"],""),message:m(n,["message"],""),status:m(n,["status"],"sent"),error:m(n,["error"],""),sentAt:m(n,["sent_at"],"")}))}async function zn(e,t,n){const l=(await ns()).find(c=>c.provider==="slack");if(!l||!l.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const r=l.config.webhook_url;if(!r)return{ok:!1,error:"Webhook URL未設定"};const a=(await is()).find(c=>c.eventType===e&&c.enabled);if(!a)return{ok:!1,error:"通知ルールが無効"};const o=n??a.channel??l.config.default_channel??"#general";try{const c=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${We[e]} ${t}`,channel:o})}),u=c.ok,{supabaseInsert:p}=await g(async()=>{const{supabaseInsert:y}=await Promise.resolve().then(()=>R);return{supabaseInsert:y}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:o,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${c.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${c.status}`}}catch(c){return{ok:!1,error:c instanceof Error?c.message:String(c)}}}const qe={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},st={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function Vn(){return(await P("prospects",{order:"updated_at.desc"})).map(t=>({id:m(t,["id"],""),companyName:m(t,["company_name"],""),contactName:m(t,["contact_name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),address:m(t,["address"],""),website:m(t,["website"],""),businessType:m(t,["business_type"],""),stage:m(t,["stage"],"cold"),source:m(t,["source"],""),expectedAmount:q(t.expected_amount),probability:q(t.probability),assignedStaffCode:m(t,["assigned_staff_code"],""),nextActionDate:m(t,["next_action_date"],""),nextAction:m(t,["next_action"],""),note:m(t,["note"],""),lastContactAt:m(t,["last_contact_at"],""),wonAt:m(t,["won_at"],""),lostAt:m(t,["lost_at"],""),lostReason:m(t,["lost_reason"],""),convertedCustomerCode:m(t,["converted_customer_code"],""),createdAt:m(t,["created_at"],"")}))}async function os(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function Jn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Un(e){return(await P("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:m(n,["id"],""),prospectId:m(n,["prospect_id"],""),activityType:m(n,["activity_type"],"call"),title:m(n,["title"],""),description:m(n,["description"],""),activityDate:m(n,["activity_date"],""),result:m(n,["result"],""),staffCode:m(n,["staff_code"],"")}))}async function Yn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const ls=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function Qn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function Hn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Gn(){return(await P("delivery_locations",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),customerCode:m(t,["customer_code"],""),name:m(t,["name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:m(t,["contact_name"],""),phone:m(t,["phone"],""),deliveryNote:m(t,["delivery_note"],""),isActive:U(t,["is_active"],!0)}))}async function Xn(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function Kn(e=50){return(await P("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),callDirection:m(n,["call_direction"],"inbound"),fromNumber:m(n,["from_number"],""),toNumber:m(n,["to_number"],""),matchedCustomerCode:m(n,["matched_customer_code"],""),matchedProspectId:m(n,["matched_prospect_id"],""),durationSeconds:q(n.duration_seconds),callStatus:m(n,["call_status"],"answered"),recordingUrl:m(n,["recording_url"],""),transcript:m(n,["transcript"],""),ivryCallId:m(n,["ivry_call_id"],""),startedAt:m(n,["started_at"],""),endedAt:m(n,["ended_at"],""),notes:m(n,["notes"],"")}))}async function rs(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function Wn(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const i=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,l=await fetch(i,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!l.ok)return{count:0,error:`HTTP ${l.status}`};const d=(await l.json()).calls??[];let a=0;for(const o of d)await rs({id:`ivry_${o.id}`,callDirection:String(o.direction??"inbound"),fromNumber:String(o.from??""),toNumber:String(o.to??""),durationSeconds:Number(o.duration??0),callStatus:String(o.status??"answered"),recordingUrl:String(o.recording_url??""),startedAt:String(o.started_at??""),endedAt:String(o.ended_at??""),ivryCallId:String(o.id??"")}),a++;return await Te({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${a}件取得`}),{count:a}}catch(i){return{count:0,error:i instanceof Error?i.message:String(i)}}}async function Zn(e,t){const n=e.config.api_key,i=e.config.team_id;if(!n||!i)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let l=0;for(const r of t){if(!r.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${i}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:r.name,phone_number:r.phone,external_id:r.customerCode??"",note:r.note??""})})).ok&&l++}return{synced:l}}catch(l){return{synced:0,error:l instanceof Error?l.message:String(l)}}}async function ei(){return(await P("lead_lists",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),query:m(t,["query"],""),area:m(t,["area"],""),businessType:m(t,["business_type"],""),totalCount:q(t.total_count),source:m(t,["source"],"manual"),createdAt:m(t,["created_at"],"")}))}async function ti(e){return(await P("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:m(n,["id"],""),listId:m(n,["list_id"],""),companyName:m(n,["company_name"],""),address:m(n,["address"],""),phone:m(n,["phone"],""),website:m(n,["website"],""),email:m(n,["email"],""),businessType:m(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:q(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:m(n,["place_id"],""),status:m(n,["status"],"new"),convertedProspectId:m(n,["converted_prospect_id"],""),note:m(n,["note"],"")}))}async function ai(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function cs(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function si(e,t,n){const i=e.config.api_key;if(!i)return{results:[],error:"Google Maps API key 未設定"};const l=`${t} ${n}`.trim(),r=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(l)}&language=ja&key=${i}`;try{const d=await fetch(r);if(!d.ok)return{results:[],error:`HTTP ${d.status}`};const a=await d.json();return a.status!=="OK"&&a.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${a.status}`}:{results:a.results.map(c=>{const u=c.geometry?.location;return{id:`place_${c.place_id}`,listId:"",companyName:String(c.name??""),address:String(c.formatted_address??""),rating:c.rating?Number(c.rating):void 0,reviewCount:c.user_ratings_total?Number(c.user_ratings_total):void 0,lat:u?.lat,lng:u?.lng,placeId:String(c.place_id??""),status:"new"}})}}catch(d){return{results:[],error:d instanceof Error?d.message:String(d)}}}async function ni(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await os(t);return n&&await cs({...e,status:"imported",convertedProspectId:t.id}),n}async function ii(){return(await P("workflow_orders",{order:"order_date.desc"})).map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),customerName:m(t,["customer_name"],""),customerCode:m(t,["customer_code"],""),orderDate:m(t,["order_date"],""),deliveryDate:m(t,["delivery_date"],""),stage:m(t,["stage"],"new"),totalAmount:q(t.total_amount),itemCount:q(t.item_count),priority:m(t,["priority"],"normal"),staffName:m(t,["staff_name"],""),notes:m(t,["notes"],"")}))}async function oi(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function li(){return(await P("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),visitDate:m(t,["visit_date"],""),partySize:q(t.party_size)||1,language:m(t,["language"],"ja"),purpose:m(t,["purpose"],""),message:m(t,["message"],""),status:m(t,["status"],"new"),repliedAt:m(t,["replied_at"],""),confirmedTime:m(t,["confirmed_time"],""),createdAt:m(t,["created_at"],new Date().toISOString())}))}async function ri(e){const{supabaseInsert:t}=await g(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>R);return{supabaseInsert:i}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const ci=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function ds(){return(await Promise.all(ci.map(async t=>{const[n,i]=await Promise.all([Et(t.table),P(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:i[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function Qe(e,t,n=100){const i=(t-1)*n,[l,r]=await Promise.all([P(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(i)}),Et(e)]);return{records:l,total:r}}async function $t(e){const t=await P("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const i=JSON.parse(n);return String(i.price_group??"")}catch{return""}return""}async function us(e,t){if(e){const i=await P("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(i.length>0&&i[0].special_price)return q(i[0].special_price)}const n=await P("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?q(n[0].default_sale_price):0}const di=[{code:"SAK001",name:"純米大吟醸　金井"},{code:"SAK002",name:"純米吟醸　金井"},{code:"SAK003",name:"本醸造　金井"},{code:"SAK004",name:"純米酒　金井"}],ui=[1.6,.7,1.3,1.2,.9,.7,.6,.7,.9,1,1.1,1.5],pi={SAK001:80,SAK002:150,SAK003:220,SAK004:180};function mi(){const e=new Date,t=[];for(let o=11;o>=0;o--){const c=new Date(e.getFullYear(),e.getMonth()-o,1);t.push(`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`)}const n=di,i={},l={};for(const o of n){i[o.code]={};for(const c of t){const u=parseInt(c.split("-")[1])-1,p=pi[o.code]??100,y=Math.round(p*ui[u]*(.85+Math.random()*.3));i[o.code][c]=y,l[c]=(l[c]??0)+y}}const r={},d={},a={};for(const o of n){const c=t.map(y=>i[o.code][y]??0),u=c.reduce((y,h)=>y+h,0)/c.length,p=c.reduce((y,h)=>y+(h-u)**2,0)/c.length;r[o.code]=c.reduce((y,h)=>y+h,0),d[o.code]=u,a[o.code]=Math.sqrt(p)}return{months:t,products:n,matrix:i,totals:l,productTotals:r,productAvg:d,productStdDev:a}}async function yi(){const e=await H("product_monthly_sales",{select:"year_month,product_code,product_name,quantity",order:"year_month.asc"});if(e.length===0)return mi();const t=new Set,n=new Map,i={},l={};for(const u of e){const p=m(u,["year_month"],""),y=m(u,["product_code"],""),h=m(u,["product_name"],y),f=b(u,["quantity"],0);!p||!y||(t.add(p),n.set(y,h),i[y]||(i[y]={}),i[y][p]=f,l[p]=(l[p]??0)+f)}const r=[...t].sort(),d=[...n.entries()].map(([u,p])=>({code:u,name:p})),a={},o={},c={};for(const u of d){const p=r.map(f=>i[u.code]?.[f]??0),y=p.reduce((f,S)=>f+S,0)/(p.length||1),h=p.reduce((f,S)=>f+(S-y)**2,0)/(p.length||1);a[u.code]=p.reduce((f,S)=>f+S,0),o[u.code]=y,c[u.code]=Math.sqrt(h)}return{months:r,products:d,matrix:i,totals:l,productTotals:a,productAvg:o,productStdDev:c}}async function hi(){return(await P("product_safety_stock_params",{order:"product_code.asc"})).map(t=>({productCode:m(t,["product_code"],""),productName:m(t,["product_name"],""),unit:m(t,["unit"],"本"),avgMonthlyDemand:b(t,["avg_monthly_demand"],0),demandStdDev:b(t,["demand_std_dev"],0),leadTimeDays:b(t,["lead_time_days"],30),serviceLevel:b(t,["service_level"],.95),safetyStockQty:b(t,["safety_stock_qty"],0),reorderPoint:b(t,["reorder_point"],0),memo:m(t,["memo"],"")}))}async function vi(e){return(await P("production_plan",{year_month:`eq.${e}`,order:"product_code.asc"})).map(n=>({id:m(n,["id"],""),yearMonth:m(n,["year_month"],e),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),demandForecast:b(n,["demand_forecast"],0),safetyStockTarget:b(n,["safety_stock_target"],0),openingStock:b(n,["opening_stock"],0),requiredProduction:b(n,["required_production"],0),plannedQty:b(n,["planned_qty"],0),actualQty:b(n,["actual_qty"],0),status:m(n,["status"],"draft"),notes:m(n,["notes"],"")}))}async function fi(e){const{supabaseUpsert:t}=await g(async()=>{const{supabaseUpsert:i}=await Promise.resolve().then(()=>R);return{supabaseUpsert:i}},void 0);return await t("product_safety_stock_params",{product_code:e.productCode,product_name:e.productName,unit:e.unit,avg_monthly_demand:e.avgMonthlyDemand,demand_std_dev:e.demandStdDev,lead_time_days:e.leadTimeDays,service_level:e.serviceLevel,safety_stock_qty:e.safetyStockQty,reorder_point:e.reorderPoint,memo:e.memo,last_calc_at:new Date().toISOString(),updated_at:new Date().toISOString()})!==null}async function bi(e){const{supabaseUpsert:t}=await g(async()=>{const{supabaseUpsert:i}=await Promise.resolve().then(()=>R);return{supabaseUpsert:i}},void 0);return await t("production_plan",{...e.id?{id:e.id}:{},year_month:e.yearMonth,product_code:e.productCode,product_name:e.productName,demand_forecast:e.demandForecast,safety_stock_target:e.safetyStockTarget,opening_stock:e.openingStock,required_production:e.requiredProduction,planned_qty:e.plannedQty,actual_qty:e.actualQty,status:e.status,notes:e.notes,updated_at:new Date().toISOString()})!==null}const k=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:Ot,CALENDAR_CATEGORY_LABELS:Rt,DEPT_LABELS:Ke,INVOICE_TYPE_LABELS:ft,JIKOMI_STATUS_LABELS:Ya,MATERIAL_CATEGORIES:ls,PROSPECT_STAGE_COLORS:st,PROSPECT_STAGE_LABELS:qe,ROLE_LABELS:Xe,SEASONAL_TEMPLATES:Ct,SLACK_EVENT_LABELS:We,TAX_DEDUCTION_LABELS:gt,TAX_RATE_CATEGORIES:es,convertLeadToProspect:ni,deleteCalendarEvent:Pn,deleteMailSender:kn,deleteMaterial:Hn,deletePrintLayout:$n,deleteProspect:Jn,deleteUserProfile:On,fetchAnalyticsByPeriod:Gs,fetchAnnouncements:Oa,fetchAuditLogs:jn,fetchAvailablePeriods:Xs,fetchBillList:Wa,fetchBillingSummary:Tt,fetchCalendarEvents:Sn,fetchCallLogs:Kn,fetchChurnAlerts:ln,fetchCustomerAnalysis:Ua,fetchCustomerEfficiency:Ja,fetchCustomerLedger:Lt,fetchCustomerPriceGroup:$t,fetchCustomerPricing:Ba,fetchDeliveryLocations:Gn,fetchDeliveryNote:It,fetchDeliverySchedule:on,fetchDemandAnalysis:yi,fetchDemandForecasts:nn,fetchFaxInbox:Ln,fetchIntegrationSettings:ns,fetchInvoices:Ge,fetchJikomiList:Qa,fetchKenteiList:Ga,fetchLeadItems:ti,fetchLeadLists:ei,fetchMailSenders:_n,fetchMasterStats:He,fetchMaterialList:bt,fetchMyProfile:Nn,fetchPayableList:Ka,fetchPaymentStatus:Ca,fetchPipelineMeta:La,fetchPrintLayouts:bn,fetchProductABC:pn,fetchProductDaily:un,fetchProductMonthlyShipments:sn,fetchProductPower:Va,fetchProductPrice:us,fetchProductShipmentsFromTable:dn,fetchProductionPlan:vi,fetchProspectActivities:Un,fetchProspects:Vn,fetchPurchaseList:Xa,fetchRawMaterialStock:Za,fetchRawRecords:Qe,fetchRawTableList:ds,fetchSafetyStockParams:hi,fetchSalesAnalytics:Ta,fetchSalesReport:at,fetchSalesSummary:Da,fetchSeasonalProfiles:cn,fetchShopifyOrders:En,fetchSlackLogs:Bn,fetchSlackRules:is,fetchStaffCustomerBreakdown:Zs,fetchStaffProductBreakdown:en,fetchStaffTotalsByPeriod:Ws,fetchStoreOrders:as,fetchStoreSales:Nt,fetchSyncDashboard:Ia,fetchTankList:Ha,fetchTaxDeclaration:qt,fetchTourInquiriesFromDb:li,fetchUserProfiles:qn,fetchVisitPriorities:rn,fetchWorkflowOrdersFromDb:ii,generateTaxCSV:hn,generateTaxXML:ts,ocrFaxImage:In,periodToDateRange:Ks,recalculateTaxDeclaration:vn,recordAudit:Mn,resolveProductPrice:za,saveCalendarEvent:xn,saveCallLog:rs,saveDeliveryLocation:Xn,saveEmailCampaign:Ye,saveFaxRecord:Tn,saveIntegrationSetting:Te,saveInvoice:Ra,saveLeadItem:cs,saveLeadList:ai,saveMailSender:wn,saveMaterial:Qn,savePrintLayout:gn,saveProductionPlan:bi,saveProspect:os,saveProspectActivity:Yn,saveSafetyStockParams:fi,saveSlackRule:Fn,saveTaxDeclaration:fn,saveTourInquiry:ri,saveUserProfile:Rn,saveWorkflowOrder:oi,searchPlaces:si,sendEmailCampaign:ss,sendSlackNotification:zn,submitFeatureRequest:Ma,syncGoogleCalendar:Cn,syncIvryCallLogs:Wn,syncPhoneBookToIvry:Zn,syncShopifyOrders:An,updateCustomer:ja,updateProduct:Fa},Symbol.toStringTag,{value:"Module"}));function me(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const gi={open:"未締め",closed:"締め済"};function $i(e,t){const n=e.customers.map(i=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${i.status==="closed"?"success":"warning"}">${gi[i.status]}</span>
        </td>
        <td>
  ...
  `}function Re(e,t,n){const i=e.findIndex(r=>r.column===t);if(i>=0){if(e[i].direction==="asc"){const d=[...e];return d[i]={column:t,direction:"desc"},d}return e.filter((d,a)=>a!==i)}const l={column:t,direction:"asc"};return n?[...e,l]:[l]}function Pi(e,t){const n=e.findIndex(r=>r.column===t);if(n<0)return'<span class="sort-icon">⇅</span>';const i=e[n].direction==="asc"?"↑":"↓",l=e.length>1?`<small class="sort-badge">${n+1}</small>`:"";return`<span class="sort-icon active">${i}${l}</span>`}function L(e,t,n,i=""){return`<th class="sortable ${i}" data-sort-col="${e}">${t} ${Pi(n,e)}</th>`}function Xt(e){if(e==null)return"";const t=String(e).replace(/[¥,円%本日L]/g,"").trim(),n=Number(t);return Number.isFinite(n)?n:t.toLowerCase()}function Le(e,t,n){return t.length===0?e:[...e].sort((i,l)=>{for(const{column:r,direction:d}of t){const a=n[r];if(!a)continue;const o=Xt(i[a]),c=Xt(l[a]);let u=0;if(typeof o=="number"&&typeof c=="number"?u=o-c:u=String(o).localeCompare(String(c),"ja"),u!==0)return d==="asc"?u:-u}return 0})}const Ai={forecasts:[],deliveries:[],calendarMonth:new Date().toISOString().slice(0,7),selectedSegment:"all"},Kt={monthly:"通年出荷","made-to-order":"受注生産","november-only":"歳暮（11月生産）","annual-batch":"季節集中","december-settlement":"歳暮（11月生産）","seasonal-batch":"季節集中"},_e={monthly:"#0F5B8D","made-to-order":"#6b46c1","november-only":"#c05621","annual-batch":"#2f855a","december-settlement":"#c05621","seasonal-batch":"#2f855a"};function Ei(e){const t=new Date().toISOString().slice(0,10);return e.map(n=>({date:n.date,customerName:n.customerName,productName:n.productName,quantity:n.quantity,status:n.date>t?"scheduled":"delivered"}))}function Di(e){const[t,n]=e.split("-").map(Number);return new Date(t,n,0).getDate()}function Ci(e){const[t,n]=e.split("-").map(Number);return new Date(t,n-1,1).getDay()}function ms(e,t){const n=Di(t),i=Ci(t),[l,r]=t.split("-").map(Number),d=new Map;e.forEach(E=>{if(E.date.slice(0,7)===t){const w=E.date.slice(0,10);d.has(w)||d.set(w,[]),d.get(w).push(E)}});const a=e.filter(E=>E.date.slice(0,7)===t),o=a.reduce((E,w)=>E+w.quantity,0),c=new Set(a.map(E=>E.date)).size,u=new Date().toISOString().slice(0,10),p=["日","月","火","水","木","金","土"].map(E=>`<th class="dcal-header">${E}</th>`).join("");let y="",h=1;for(let E=0;E<6&&!(h>n&&E>0);E++){y+="<tr>";for(let w=0;w<7;w++)if(E===0&&w<i||h>n)y+='<td class="dcal-cell dcal-empty"></td>';else{const I=`${l}-${String(r).padStart(2,"0")}-${String(h).padStart(2,"0")}`,j=d.get(I)||[],J=I===u,C=j.reduce((Y,X)=>Y+X.quantity,0);y+=`
          <td class="dcal-cell ${J?"dcal-today":""}">
            <div class="dcal-day">${h}</div>
            ${j.length>0?`
              <div class="dcal-entries">
                <div class="dcal-entry dcal-${j[0].status}">${j.length}件 ${C}本</div>
              </div>
            `:""}
          </td>`,h++}y+="</tr>"}const[f,S]=r===1?[l-1,12]:[l,r-1],[$,A]=r===12?[l+1,1]:[l,r+1],_=`${f}-${String(S).padStart(2,"0")}`,D=`${$}-${String(A).padStart(2,"0")}`;return`
    <section class="panel">
      <div class="panel-header">
        <div>
          <h2>納品カレンダー</h2>
  ...
  `}function Li(e,t){const n=t==="all"?e:e.filter(a=>a.segment===t),i={all:e.length};e.forEach(a=>{i[a.segment]=(i[a.segment]??0)+1});const r=["all",...[...new Set(e.map(a=>a.segment))]].map(a=>`
  ...
  `}function Oi(e,t,n,i,l="month",r,d=[]){const a={success:"正常",warning:"注意",error:"異常",running:"実行中"},o=qi(e.allDailySales,l,r),c=o.reduce((w,I)=>w+I.amount,0),u=o.reduce((w,I)=>w+I.bottles,0),p=o.reduce((w,I)=>w+I.volumeMl,0),y=o.length,h=u>0?Math.round(c/u):0,f=p>0?Math.round(c/(p/1e3)):0,$=(o.length>0?e.allDailySales.filter(w=>{const I=o[0]?.date??"",j=o[o.length-1]?.date??"",J=Wt(I,-1),C=Wt(j,-1);return w.date>=J&&w.date<=C}):[]).reduce((w,I)=>w+I.amount,0),A=$>0?(c-$)/$*100:0,_=A>0?"+":"",D=e.salesRecords.slice(0,10).map(w=>`
            <tr>
              <td class="mono">${w.documentNo}</td>
              <td>${ot(w.date)}</td>
              <td>${w.customerName}</td>
              <td class="numeric">${W(w.amount)}</td>
            </tr>
          `).join(""),E=["today","month","90days","year","all"].map(w=>`<button class="button ${w===l?"primary":"secondary"} small" type="button" data-period="${w}">${Oe[w]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-sub">前年同期 ${$>0?W($):"データなし"}</p>
      </article>
    ...
    <section class="content-grid">
      <article class="panel">
        <div class="panel-header">
          <div>
            <h2>日次売上</h2>
            <p class="panel-caption">${Oe[l]} (${o.length}日分)</p>
          </div>
        </div>
        <div class="chart-scroll">
          ${Ri(o.length>0?o:e.dailySales)}
        </div>
      </article>
    ...
    <details class="panel collapsible-panel">
      <summary class="panel-header clickable">
        <div>
          <h2>日次推移</h2>
          <p class="panel-caption">${Oe[l]} — 売上・本数・液体量・単価（${o.length}日分）</p>
        </div>
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
              ${L("date","日付",d)}
              ${L("amount","売上",d,"numeric")}
              ${L("bottles","本数",d,"numeric")}
              ${L("volumeMl","液体量(L)",d,"numeric")}
              ${L("pricePerBottle","本単価",d,"numeric")}
              ${L("pricePerLiter","L単価",d,"numeric")}
            </tr>
          </thead>
          <tbody>${Le(d.length>0?o:o.slice().reverse(),d,{date:"date",amount:"amount",bottles:"bottles",volumeMl:"volumeMl",pricePerBottle:"pricePerBottle",pricePerLiter:"pricePerLiter"}).slice(0,31).map(w=>`
            <tr>
              ...
              <td class="numeric">${W(w.pricePerBottle)}</td>
              <td class="numeric">${W(w.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
  ...
  `}function Mi(e){const t=e.prospects.reduce((d,a)=>d+a.expectedAmount*a.probability/100,0),n=e.prospects.filter(d=>d.stage==="hot"||d.stage==="negotiating").length,i=new Date().toISOString().slice(0,10),l=e.upcomingEvents.filter(d=>d.startsAt.slice(0,10)>=i).slice(0,5),r=e.tourInquiries.filter(d=>d.status==="new").length;return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
    ...
    <section class="content-grid">
      ...
      <aside class="panel">
        ...
        ${l.length===0?'<p class="empty-note">予定なし</p>':`<div style="display:grid;gap:8px;">${l.map(d=>{const a=new Date(d.startsAt);return`
  ...
  `}function ji(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function ye(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Fi(e,t){const n=e.lines.length?e.lines.map((l,r)=>`
          <tr>
  ...
  `}function ee(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Bi(e){return ee(e).replaceAll(`
`,"<br />")}function zi(e){const n=[...Object.values(Ct),{id:"custom",season:"カスタム",subject:"",body:""}].map(l=>`
        <button
  ...
  `}function Vi(e,t){const n=[Me("得意先",t.customers.map(l=>`
          <button
  ...
  `}function je(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Zt(e){return e.trim().toLowerCase()}function Ji(e,t){const n=Zt(t),i=e.filter(r=>n?[r.code,r.name,r.name].map(Zt).some(d=>d.includes(n)):!0).slice(0,50),l=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return ys({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:l,emptyMessage:"該当する得意先が見つかりません。"})}function Ui(e){return e.toISOString().slice(0,10)}function pe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function le(e,t){return e[t]?`<div class="field-error">${pe(e[t])}</div>`:""}function he(e,t,n=""){return[n,e[t]?"has-error":""].filter(Boolean).join(" ")}function Yi(e,t,n,i){const l=Object.keys(ft).map(o=>`<option value="${o}" ${e.invoiceType===o?"selected":""}>${ft[o]}</option>`).join(""),r=e.lines.map((o,c)=>`
      <tr>
        <td>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${he(i,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||Ui(new Date)}" />
          ${le(i,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
      ...
      <div class="quote-preview-inner">
        ...
        <div class="quote-preview-meta">
          ...
          <div class="quote-preview-info">
            ${l.showQuoteNo&&e.quoteNo?`<p>No. ${T(e.quoteNo)}</p>`:""}
            <p>${e.quoteDate}</p>
        ...
        ${l.headerNote?`<p class="quote-preview-note">${T(l.headerNote)}</p>`:""}

        ${l.showSubject&&e.subject?`<p class="quote-preview-subject">件名: ${T(e.subject)}</p>`:""}
        ...
        ${l.footerNote?`<p class="quote-preview-footer-note">${T(l.footerNote)}</p>`:""}
      </div>
    </div>
  `}function Hi(e){const t=(n,i,l)=>`
  ...
  `}function Xi(e,t,n,i,l,r){const d=e.lines.reduce((y,h)=>y+h.amount,0),a=Math.round(d*e.taxRate/100),o=d+a,c=i.length>=1?t.filter(y=>y.name.includes(i)||y.code.includes(i)).slice(0,8):[],u=l.length>=1?n.filter(y=>y.name.includes(l)||y.code.includes(l)).slice(0,8):[],p=e.fieldConfig;return e.previewMode?`
      <section class="page-head">
        <div>
    ...
    <section class="panel">
      ...
      <div class="form-row">
        <input type="text" id="q-prod-search" value="${T(l)}" placeholder="商品名またはコードで検索して追加" />
      </div>
      ${u.length>0?`
        <div class="search-results">
          ${u.map(y=>{const h=r?za(y,r):{price:y.salePrice||0,label:"標準価格"},f=h.label!=="標準価格";return`
    ...
    ${Hi(p)}
    ${Gi(e.sealSettings)}
  `}function Ki(e){const t=vs(e),n=window.open("","_blank","width=800,height=1100");if(!n){alert("ポップアップがブロックされました。許可してください。");return}n.document.write(`<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8" />
...
<\/script>
        ...
        <table>
          <thead>
            <tr>
              ...
              ${L("name","商品名",d)}
              ${L("amount","売上",d,"numeric")}
              ${L("sharePct","構成比",d,"numeric")}
              ${L("qty","本数",d,"numeric")}
              ${L("growthRate","前年同期比",d,"numeric")}
            </tr>
          </thead>
          <tbody>
            ${Le(f,d,{rank:"rank",name:"name",amount:"amount",sharePct:"sharePct",qty:"qty",growthRate:"growthRate"}).slice(0,100).map(_=>`
              <tr>
                <td>${bs(_.rank)}</td>
                <td>${_.name?_.name.slice(0,25):_.code}${_.volumeMl?` <small>${_.volumeMl}ml</small>`:""}</td>
                <td class="numeric">${fs(_.amount)}</td>
                <td class="numeric">${_.sharePct}%</td>
                <td class="numeric">${_.qty.toLocaleString()}</td>
                <td class="numeric">${gs(_.growthRate)}</td>
              </tr>
            `).join("")}
  ...
  `}function ao(e,t=[]){const n=e.filter(r=>r.currentRank==="A").length,i=e.filter(r=>r.prevRank&&r.currentRank<r.prevRank).length,l=e.filter(r=>r.prevRank&&r.currentRank>r.prevRank).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>営業効率分析</h1>
        ...
        <table>
          <thead>
            <tr>
              ${L("currentRank","ABC",t)}
              ${L("name","得意先名",t)}
              ${L("yearAmount","年間売上",t,"numeric")}
              ${L("sharePct","構成比",t,"numeric")}
              ${L("orderDays","受注日数",t,"numeric")}
              ${L("growthRate","前年比",t,"numeric")}
              <th>変動</th>
            </tr>
          </thead>
          <tbody>
  ...
  `}function so(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function no(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function io(e,t){const n=e.length?e.map(i=>`
            <tr>
              ...
              <td class="numeric">${no(i.amount)}</td>
            </tr>
  ...
  `}function oo(e){return new Date(e.getFullYear(),e.getMonth(),1)}function lo(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function $s(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function _s(e){const t=new Date(e),n=t.getDay();return t.setDate(t.getDate()-n),t.setHours(0,0,0,0),t}function ea(e){const t=$s(_s(e),6);return t.setHours(23,59,59,999),t}function ta(e){return new Date(`${e}T00:00:00`)}function aa(e){return`${e.getMonth()+1}/${e.getDate()}`}function ro(e){return e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function co(){const e=new Date,t=_s(lo(oo(e),-3)),n=ea(new Date(e.getFullYear(),e.getMonth()+4,0)),i=[];let l=new Date(t);for(;l<=n;){const r=ea(l);i.push({start:new Date(l),end:r,label:`${aa(l)} - ${aa(r)}`}),l=$s(l,7)}return i}function uo(e){const t=co(),n=`160px repeat(${t.length}, minmax(56px, 1fr))`,i=t.map(r=>`
        <div class="gantt-week">
          <span>${r.label}</span>
        </div>
      `).join(""),l=e.length?e.map(r=>{const d=ta(r.startDate),a=ta(r.expectedDoneDate),o=Math.max(0,t.findIndex(p=>p.end>=d)),c=Math.max(o,t.reduce((p,y,h)=>y.start<=a?h:p,o)),u=[`仕込番号: ${r.jikomiNo}`,`銘柄: ${r.productName}`,`期間: ${r.startDate} - ${r.expectedDoneDate}`,`タンク: ${r.tankNo}`,`備考: ${r.note||"なし"}`].join(`
`);return`
  ...
  `}function sa(e,t){const n={planned:"neutral",active:"warning",done:"success"},i=e.map(a=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${n[a.status]}">${Ya[a.status]}</span>
        </td>
        <td>${a.note||"―"}</td>
      </tr>
  ...
  `}function po(e){const t={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},i=e.map(o=>`
      <tr>
  ...
  `}function mo(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function yo(e,t){return`
  ...
  `}const Mt={query:"",businessType:"",areaCode:"",activeOnly:"",page:1},De=50;function fo(e,t){let n=e;if(t.query){const a=t.query.toLowerCase();n=n.filter(o=>o.code.toLowerCase().includes(a)||o.name.toLowerCase().includes(a)||o.kanaName&&o.kanaName.toLowerCase().includes(a)||o.address1&&o.address1.toLowerCase().includes(a)||o.phone&&o.phone.toLowerCase().includes(a))}t.businessType&&(n=n.filter(a=>a.businessType===t.businessType)),t.areaCode&&(n=n.filter(a=>a.areaCode===t.areaCode)),t.activeOnly==="active"?n=n.filter(a=>a.isActive):t.activeOnly==="inactive"&&(n=n.filter(a=>!a.isActive));const i=Math.max(1,Math.ceil(n.length/De)),r=(Math.min(t.page,i)-1)*De,d=n.slice(r,r+De);return{filtered:n,paged:d,totalPages:i}}function na(e,t,n){if(n<=1)return`<div class="master-pagination"><span>${e}件</span></div>`;const i=(t-1)*De+1,l=Math.min(t*De,e),r=[];for(let d=1;d<=n;d++)d===1||d===n||d>=t-2&&d<=t+2?r.push(`<button class="button ${d===t?"primary":"secondary"}" type="button" data-action="master-page" data-page="${d}" style="min-width:36px;padding:4px 8px;">${d}</button>`):(d===t-3||d===t+3)&&r.push('<span style="padding:0 4px;color:var(--text-secondary);">…</span>');return`
  ...
  `}function bo(e,t){const n=[...new Set(e.map(l=>l.businessType).filter(Boolean))].sort(),i=[...new Set(e.map(l=>l.areaCode).filter(Boolean))].sort();return`
  ...
  `}function _t(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function go(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function $o(e){return e.map(t=>`
        <tr>
      ...
      `).join("")}function Fe(e){return e?`¥${e.toLocaleString("ja-JP")}`:"―"}function _o(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${_t(t.name,20)}</td>
          <td>${t.kanaName||""}</td>
      ...
      `).join("")}function wo(e,t,n=Mt,i=[]){const{filtered:l,paged:r,totalPages:d}=fo(e.customers,n);return`
    <section class="page-head">
      <div>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>担当</th>
                ${L("areaName","地区",i)}
                ${L("closingDay","締日",i,"numeric")}
                ${L("paymentDay","支払日",i,"numeric")}
                <th>入金種</th>
                <th>請求先</th>
                <th>G1</th>
                <th>G2</th>
            ...
            <tbody>${$o(Le(r,i,{code:"code",name:"name",kanaName:"kanaName",businessType:"businessType",areaName:"areaName",closingDay:"closingDay",paymentDay:"paymentDay"}))}</tbody>
          </table>
        </div>
        ${na(l.length,n.page,d)}
      `:`
          ...
          <table>
            <thead>
              <tr>
                ...
                ${L("category","分類",i)}
                <th>酒税区分</th>
                ${L("alcoholDegree","度数",i,"numeric")}
                ${L("volumeMl","容量ml",i,"numeric")}
                <th>単位</th>
                <th>容器</th>
                ${L("purchasePrice","生産者価格",i,"numeric")}
                ${L("salePrice","卸価格",i,"numeric")}
                ${L("listPrice","定価(小売)",i,"numeric")}
            ...
            <tbody>${_o(Le(e.products,i,{code:"code",name:"name",category:"category",alcoholDegree:"alcoholDegree",volumeMl:"volumeMl",purchasePrice:"purchasePrice",salePrice:"salePrice",listPrice:"listPrice"}))}</tbody>
          </table>
        </div>
      `}
    </section>
  `}function lt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ko(e,t){if(!e&&!t)return"";const n=e;return`
  ...
  `}function So(e){const t=e.map(l=>{const d=(l.minimumStock>0?l.currentStock/l.minimumStock:1/0)<1.5;return`
        <tr>
          ...
          <td class="numeric">${lt(l.unitCost)}</td>
          <td class="numeric">${lt(l.currentStock*l.unitCost)}</td>
          <td>${l.lastUpdated}</td>
          <td>
  ...
  `}function xo(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function rt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Po={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Ao(e){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td>${xo(n.lastPaymentDate)}</td>
          <td><span class="status-pill ${n.status==="paid"?"success":n.status==="partial"?"warning":"danger"}">${Po[n.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function ve(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ia(e){return e.trim().toLowerCase()}function Eo(e,t){const n=ia(t),i=e.filter(r=>n?[r.code,r.name,r.janCode].map(ia).some(d=>d.includes(n)):!0),l=i.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return ys({title:"商品検索",searchQuery:t,placeholder:"コード・名前・JANで検索",resultsHtml:l,emptyMessage:"該当する商品が見つかりません。"})}function re(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Do(e,t){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},i={pending:"warning",confirmed:"neutral",paid:"success"},l={unpaid:"未払い",partial:"一部支払",paid:"支払済"},r={unpaid:"warning",partial:"neutral",paid:"success"},d=e.map(p=>`
      <tr>
  ...
  `}function Se(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Co(e,t){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},i={holding:"neutral",due:"warning",cleared:"success"},l=e.map(u=>`
      <tr>
  ...
  `}function Ve(e){if(!e)return"error";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"success":n<24?"warning":"error"}function oa(e){if(!e)return"未同期";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"正常":n<24?"注意":"要確認"}function Io(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
  ...
  `}function To(e,t,n,i){const l={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function Ae(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function qo(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function No(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),n=Math.max(...t.map(p=>p.amount),1),i=28,l=6,r=140,d=100,a=760,o=a-r-d,c=t.length*(i+l)+16,u=t.map((p,y)=>{const h=p.amount/n*o,f=y*(i+l)+8,S=p.abcRank==="A"?"#2F855A":p.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
          <text x="${r-8}" y="${f+i/2+5}" class="chart-axis" text-anchor="end">${p.name.length>10?p.name.slice(0,10)+"…":p.name}</text>
          <rect x="${r}" y="${f}" width="${h}" height="${i}" rx="4" fill="${S}" opacity="0.85" />
  ...
  `}function Ro(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(i=>`<th class="numeric">${i}</th>`).join(""),n=e.monthlyByCustomer.map(i=>{const l=i.values.reduce((d,a)=>d+a,0),r=i.values.map(d=>`<td class="numeric">${d>0?(d/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${i.label}</td>
          ${r}
  ...
  `}function Oo(e){e.ranking.reduce((o,c)=>o+c.amount,0);const t=e.ranking.filter(o=>o.abcRank==="A").length,n=e.ranking.filter(o=>o.abcRank==="B").length,i=e.ranking.filter(o=>o.abcRank==="C").length,l=e.ranking.filter(o=>o.abcRank==="A").reduce((o,c)=>o+c.amount,0),r=e.ranking.filter(o=>o.abcRank==="B").reduce((o,c)=>o+c.amount,0),d=e.ranking.filter(o=>o.abcRank==="C").reduce((o,c)=>o+c.amount,0),a=e.ranking.map(o=>`
        <tr>
          ...
          <td><span class="status-pill ${qo(o.abcRank)}">${o.abcRank}</span></td>
        </tr>
      `).join("");return`
    <section class="page-head">
      <div>
  ...
  `}function nt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Mo(e){return e.replace("-","/")}const la={all:"全期間",yearly:"年次",monthly:"月次",weekly:"週次",daily:"日次"};function jo(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,i={top:16,right:24,bottom:36,left:64},l=t-i.left-i.right,r=n-i.top-i.bottom,d=Math.max(...e.map(u=>u.amount),1),a=l/e.length,o=[0,.25,.5,.75,1].map(u=>{const p=i.top+r-r*u,y=`${Math.round(d*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${i.left}" y1="${p}" x2="${t-i.right}" y2="${p}" class="chart-grid" />
          <text x="8" y="${p+4}" class="chart-axis">${y}</text>
        </g>
      `}).join(""),c=e.map((u,p)=>{const y=u.amount/d*r,h=Math.max(a-18,24),f=i.left+p*a+(a-h)/2,S=i.top+r-y;return`
        <g>
          <rect x="${f}" y="${S}" width="${h}" height="${y}" rx="6" class="analytics-bar" />
          <text x="${f+h/2}" y="${n-10}" class="chart-axis centered-axis">${Mo(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function Fo(e){return e.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
      ...
      `).join("")}function Bo(e){return e.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
      ...
      `).join("")}function ra(e,t,n){const i=t?e.filter(r=>r.tag.includes(t)||r.name.includes(t)):e,l=i.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':i.map(r=>`
        <tr>
          <td class="mono">${r.code||"―"}</td>
          <td>${r.name||"未設定"}</td>
          <td class="mono">${r.tag||"―"}</td>
          <td class="numeric">${nt(r.amount)}</td>
  ...
  `}function zo(e,t,n="all",i="",l=[],r=[],d="",a="",o=null,c="all",u="",p=[],y=[]){const h=t==="products"?"商品別集計":t==="customers"?"得意先別集計":"担当別集計",f=t==="products"?e.productTotals:t==="customers"?e.customerTotals:e.staffTotals,S=n!=="all"&&l.length>0&&t!=="staff",$=["all","yearly","monthly","weekly","daily"].map(E=>`<button class="button ${E===n?"primary":"secondary"} small" type="button" data-analytics-period="${E}">${la[E]}</button>`).join(""),A=n!=="all"&&r.length>0&&t!=="staff"?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
        ${r.map(E=>`<option value="${E}" ${E===i?"selected":""}>${E}</option>`).join("")}
      </select>`:"";let _="",D="";if(t==="staff"){const E=["all","yearly","monthly","weekly","daily"].map(C=>`<button class="button ${C===c?"primary":"secondary"} small" type="button" data-staff-period="${C}">${la[C]}</button>`).join(""),w=c!=="all"&&p.length>0?`<select id="staff-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
          ${p.map(C=>`<option value="${C}" ${C===u?"selected":""}>${C}</option>`).join("")}
        </select>`:"",j=(y.length>0?y:e.staffTotals).filter(C=>!d||C.name.includes(d)||C.code.includes(d)),J=c!=="all"&&u?` (${u})`:"";if(_=`
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${j.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':j.map(C=>`
                <tr>
                  <td class="mono">${C.code||"―"}</td>
                  <td>${C.name||"未設定"}</td>
                  <td class="numeric">${nt(C.amount)}</td>
                  <td class="numeric">${C.quantity.toLocaleString("ja-JP")}</td>
                  <td class="numeric">${C.documents.toLocaleString("ja-JP")}</td>
                  <td><button class="button secondary small" data-staff-drilldown="${C.code}" data-staff-name="${C.name}">詳細</button></td>
                </tr>
              `).join("")}
          </tbody>
        </table>
      </div>
    `,o){const C=o.breakdownTab,Y=c!=="all"&&u?`<span style="font-size:12px;color:var(--text-secondary);margin-left:8px;">${u}</span>`:"";D=`
        <article class="panel" style="margin-top:16px;">
          ...
          <div style="display:flex;gap:8px;align-items:center;margin-bottom:12px;flex-wrap:wrap;">
            <div class="tab-group">
              <button class="tab-button ${C==="customers"?"active":""}" data-staff-breakdown-tab="customers">得意先別</button>
              <button class="tab-button ${C==="products"?"active":""}" data-staff-breakdown-tab="products">商品別</button>
            </div>
          ...
          ${C==="customers"?ra(o.customerRows,a,"得意先名"):ra(o.productRows,a,"商品名")}
        </article>
      `}}return`
    <section class="page-head">
      <div>
    ...
    ${D}
  `}function xe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Vo(e){const t=Math.max(...e.salesByProduct.flatMap(r=>r.values),1),n=e.salesByProduct.map(r=>{const d=r.values.map((a,o)=>`
          <div class="bar-col">
  ...
  `}function Jo(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function Uo(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ca(e){return e.toISOString().slice(0,10)}function Yo(e,t,n){const i=e.length?e.map(l=>`
            <tr>
              ...
              <td class="numeric">${Uo(l.amount)}</td>
            </tr>
  ...
  `}function Je(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Qo(e,t,n,i){const l={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},r={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},d={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},a=e.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
  ...
  `}const ct={customers:"得意先マスタ",products:"商品マスタ",suppliers:"仕入先マスタ",staff:"担当者マスタ"},Ho={customers:{required:["legacy_customer_code","name"],optional:["kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"]},products:{required:["legacy_product_code","name"],optional:["kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"]},suppliers:{required:["legacy_supplier_code","name"],optional:["kana_name","phone","postal_code","address1","closing_day","payment_day","email"]},staff:{required:["legacy_staff_code","name"],optional:["kana_name","department"]}};function Go(e,t,n,i){const l=Ho[e],r=Object.keys(ct).map(a=>`
  ...
  `}function dt(e){const t={};return e.querySelectorAll("[data-fd-id]").forEach(n=>{const i=n.dataset.fdId??"",l=parseFloat(n.style.left)||0,r=parseFloat(n.style.top)||0;t[i]={x:l,y:r}}),t}function Wo(e,t,n,i,l){const r=Array.from(new Set([...e.map(c=>c.businessType??""),...t.map(c=>c.businessType??"")].filter(Boolean))),d=e.filter(c=>c.lat&&c.lng).length,a=t.filter(c=>c.lat&&c.lng).length,o=n.filter(c=>c.lat&&c.lng).length;return`
    <section class="page-head">
      <div>
  ...
  `}const Zo={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},el=["new","picking","packed","shipped","delivered"];function tl(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(r=>t[r.stage].push(r));const n=el.map(r=>{const d=Zo[r],a=t[r];return`
  ...
  `}function al(e,t,n){const i=e.cart.reduce((r,d)=>r+d.amount,0);return`
  ...
  `}function sl(e,t,n){if(e.step==="customer"){const i=e.customerQuery.toLowerCase(),l=i?t.filter(r=>r.name.toLowerCase().includes(i)||r.code.toLowerCase().includes(i)):t.slice(0,20);return`
      <section class="panel">
  ...
  `}const da={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},ua={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},pa={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function nl(e,t){const n=e.find(r=>r.id===t)??e[0],i=e.filter(r=>r.status==="new").length,l=e.filter(r=>r.status==="confirmed").length;return`
    <section class="page-head">
      <div>
          ...
          ${e.map(r=>`
            <button class="tour-item ${n?.id===r.id?"active":""}" data-tour-id="${r.id}">
              <div class="tour-item-head">
                ...
                <span class="status-pill ${ua[r.status]}">${da[r.status]}</span>
              </div>
              <div class="tour-item-sub">
                ${pa[r.language]} · 👥 ${r.partySize}名
              </div>
...
金井酒造店`;function ll(e,t){const n=t?e.find(l=>l.id===t):null,i=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${n||i?`
      ...
      `:""}
  `}function rl(e,t,n,i){const[l,r]=t.split("-").map(w=>parseInt(w,10)),d=new Date(l,r-1,1),a=new Date(l,r,0),o=d.getDay(),c=a.getDate(),u=[];for(let w=0;w<o;w++)u.push({isOutside:!0});for(let w=1;w<=c;w++)u.push({date:new Date(l,r-1,w)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter(w=>w.category===n):e,y={};p.forEach(w=>{const I=w.startsAt.slice(0,10);y[I]??=[],y[I].push(w)});const h=new Date().toISOString().slice(0,10),f=u.map(w=>{if(w.isOutside)return'<div class="cal-cell cal-outside"></div>';const I=w.date,j=`${I.getFullYear()}-${String(I.getMonth()+1).padStart(2,"0")}-${String(I.getDate()).padStart(2,"0")}`,J=y[j]??[],C=j===h,Y=I.getDay();return`
        <div class="cal-cell ${C?"cal-today":""} ${Y===0?"cal-sun":Y===6?"cal-sat":""}"
             data-cal-date="${j}">
          ...
          <div class="cal-events">
            ...
            `).join("")}
            ${J.length>3?`<button class="cal-event-more" data-cal-date="${j}">+${J.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),S=i?.isOpen?cl(i):"",$=new Date(l,r-2,1),A=new Date(l,r,1),_=`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`,D=`${A.getFullYear()}-${String(A.getMonth()+1).padStart(2,"0")}`,E=(()=>{const w=new Date;return`${w.getFullYear()}-${String(w.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(Rt).map(([w,I])=>`<option value="${w}" ${n===w?"selected":""}>${I}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
  ...
  `}function ul(e,t){const n=e.reduce((r,d)=>r+d.totalAmount,0),i=e.filter(r=>r.financialStatus==="paid").length,l=e.filter(r=>r.fulfillmentStatus!=="fulfilled"&&r.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function ml(e,t,n){const i=t==="__new__"?null:e.find(d=>d.id===t),l=t==="__new__";return n?.role==="admin"?`
    <section class="page-head">
      <div>
  ...
  `:`
    ...
    `}function hl(e){const t={};return e.forEach(n=>{const i=n.userEmail??"(anonymous)";t[i]=(t[i]??0)+1}),`
    <section class="page-head">
      <div>
  ...
  `}function vl(e){const t=e.prospects.reduce((r,d)=>r+d.expectedAmount,0),n=e.prospects.reduce((r,d)=>r+d.expectedAmount*d.probability/100,0),i=e.prospects.filter(r=>r.stage==="won").length,l=e.prospects.filter(r=>r.stage==="hot"||r.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    ${e.viewMode==="kanban"?fl(e.prospects):bl(e.prospects)}
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 140px;">
              ...
              <select id="prospect-stage">
                ${Object.entries(qe).map(([i,l])=>`<option value="${i}" ${n?.stage===i?"selected":""}>${l}</option>`).join("")}
              </select>
            </label>
            <label class="field" style="flex:1 1 120px;">
              <span>流入元</span>
  ...
  `}function $l(e,t,n){const i=e?.config.webhook_url??"",l=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${t.map(r=>`
              <tr>
                <td>${We[r.eventType]||r.eventType}</td>
                <td>
  ...
  `}const wl=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function kl(e){const t=e.activeListId?e.lists.find(r=>r.id===e.activeListId):null,n=e.items.filter(r=>r.status==="new").length,i=e.items.filter(r=>r.status==="imported").length,l=e.items.filter(r=>r.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
    ...
    <section class="panel">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:flex-end;">
        <label class="field" style="flex:1 1 180px;">
          ...
          <select id="lb-type">
            <option value="">選択</option>
            ${wl.map(r=>`<option value="${r}" ${e.searchBusinessType===r?"selected":""}>${r}</option>`).join("")}
          </select>
        </label>
        <label class="field" style="flex:1 1 180px;">
          <span>エリア</span>
  ...
  `}const ya={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},Sl={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},xl={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function V(e){return"¥"+e.toLocaleString("ja-JP")}function Ce(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function ws(e,t){const n=e.reduce((r,d)=>r+d.amount,0),i=Math.floor(n*t),l=n+i;return{subtotal:n,taxAmount:i,total:l}}const N={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function O(e,t){const n=e.align??"left",i=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${i}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function ut(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),i=n-2018;return{y:i>0?String(i).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function Pl(e,t,n){const i=ut(e.documentDate),l=ut(e.orderDate??e.documentDate),r=ut(e.deliveryDate??e.documentDate),d=e.lines.slice(0,6).map(($,A)=>{const _=N.detailStartY+A*N.detailRowH,D=N.detailCols,E=[],w=(I,j)=>{j&&E.push(O({...I,y:_,x:I.x+0},j))};return w(D.productName,$.productName+($.spec?` ${$.spec}`:"")),w(D.productCode,$.productCode),w(D.color,$.color??""),w(D.size,[$.size,$.caseQty?`×${$.caseQty}`:""].filter(Boolean).join(" ")),w(D.unit,$.unit),w(D.quantity,$.quantity>0?$.quantity.toLocaleString("ja-JP"):""),w(D.correctedQty,$.correctedQuantity?$.correctedQuantity.toLocaleString("ja-JP"):""),w(D.discount,$.discount?$.discount.toLocaleString("ja-JP"):""),w(D.unitPrice,$.unitPrice>0?$.unitPrice.toLocaleString("ja-JP"):""),w(D.costAmount,$.amount>0?$.amount.toLocaleString("ja-JP"):""),w(D.retailPrice,$.retailPrice?$.retailPrice.toLocaleString("ja-JP"):""),w(D.note,$.receivedAmount?$.receivedAmount.toLocaleString("ja-JP"):""),E.join("")}).join(""),a=e.lines.reduce(($,A)=>$+(A.amount||0),0),o=e.lines.reduce(($,A)=>$+(A.retailPrice||0)*(A.correctedQuantity??A.quantity),0),c=e.lines.reduce(($,A)=>$+(A.receivedAmount||0),0),u=e.lines.reduce(($,A)=>$+(A.returnAmount||0),0),p=e.lines.reduce(($,A)=>$+A.quantity,0),y=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",h=n.calibrationOffsetX||0,f=n.calibrationOffsetY||0,S=`transform: translate(${h}mm, ${f}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${y}">
        ...
        ${O(N.orderDateM,l.m)}
        ${O(N.orderDateD,l.d)}
        ${O(N.deliveryDateY,r.y)}
        ${O(N.deliveryDateM,r.m)}
        ${O(N.deliveryDateD,r.d)}
        ...
        ${O(N.receivedTotal,c.toLocaleString("ja-JP"))}
        ${O(N.returnTotal,u.toLocaleString("ja-JP"))}
        ${O(N.correctedCostTotal,a.toLocaleString("ja-JP"))}
        ${O(N.correctedRetailTotal,o.toLocaleString("ja-JP"))}
        </div>
      </div>
    </div>
  `}function Al(e,t,n){const{subtotal:i,taxAmount:l,total:r}=ws(e.lines,e.taxRate),d=e.previousBalance??0,a=e.paymentAmount??0,o=d-a+r,c=e.lines.map(p=>`
      <tr>
    ...
    <div class="print-page invoice-freee ${n.fontSize}">
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${V(o)}</span>
        ...
        <div>
          ${n.showRegistrationNo?`
            <div class="freee-tax-breakdown">
              <p>＜税率内訳＞</p>
              <p>${Math.round(e.taxRate*100)}%対象: ${V(i)} / 消費税: ${V(l)}</p>
            </div>`:""}
        </div>
        <table class="freee-summary-table">
          ${d?`<tr><th>前回御請求額</th><td>${V(d)}</td></tr>`:""}
          ${a?`<tr><th>ご入金額</th><td>▲ ${V(a)}</td></tr>`:""}
          <tr><th>今回御請求 小計</th><td>${V(i)}</td></tr>
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${V(l)}</td></tr>
          <tr class="freee-sum-grand"><th>合計請求額</th><td>${V(o)}</td></tr>
        </table>
      </div>
  ...
  `}function El(e,t,n){const{subtotal:i,taxAmount:l,total:r}=ws(e.lines,e.taxRate),d=e.lines.map(o=>`
      <tr>
    ...
    <div class="print-page quotation-freee ${n.fontSize}">
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${V(r)}</span>
          <span class="freee-total-tax">（税込）</span>
        </div>
      </div>
      ...
      <div class="freee-summary">
        ...
        <table class="freee-summary-table">
          ...
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${V(l)}</td></tr>
          <tr class="freee-sum-grand"><th>合計</th><td>${V(r)}</td></tr>
        </table>
      </div>
  ...
  `}function Dl(e,t,n,i){let l="";switch(e){case"chain_store":l=Pl(i,n,t);break;case"quotation":l=El(i,n,t);break;case"invoice_monthly":l=Al(i,n,t);break}const r=Object.keys(ya).map(o=>`<button class="tab-button ${e===o?"active":""}" data-print-template="${o}">${ya[o]}</button>`).join(""),d=i.lines.map((o,c)=>`
      <tr>
  ...
  `}const Cl={customers:["legacy_customer_code","name"],products:["legacy_product_code","name"],suppliers:["legacy_supplier_code","name"],staff:["legacy_staff_code","name"]},Ll={customers:["legacy_customer_code","name","kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"],products:["legacy_product_code","name","kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"],suppliers:["legacy_supplier_code","name","kana_name","phone","postal_code","address1","closing_day","payment_day","email"],staff:["legacy_staff_code","name","kana_name","department"]};function Il(e){e.charCodeAt(0)===65279&&(e=e.slice(1));const t=[];let n=[],i="",l=!1;for(let a=0;a<e.length;a++){const o=e[a];l?o==='"'?e[a+1]==='"'?(i+='"',a++):l=!1:i+=o:o==='"'?l=!0:o===","?(n.push(i),i=""):o===`
`||o==="\r"?(o==="\r"&&e[a+1]===`
`&&a++,n.push(i),n.some(c=>c!=="")&&t.push(n),n=[],i=""):i+=o}if((i!==""||n.length>0)&&(n.push(i),n.some(a=>a!=="")&&t.push(n)),t.length===0)return{columns:[],rows:[]};const r=t[0].map(a=>a.trim()),d=[];for(let a=1;a<t.length;a++){const o={};r.forEach((c,u)=>{o[c]=(t[a][u]??"").trim()}),d.push(o)}return{columns:r,rows:d}}function Tl(e,t,n){const i=Cl[e],l=i.filter(a=>!t.includes(a)),r=n.map(a=>{const o=[];l.length>0&&o.push(`必須列欠損: ${l.join(",")}`);for(const c of i)t.includes(c)&&!a[c]&&o.push(`${c}が空`);return{...a,_valid:o.length===0,_error:o[0]}}),d=r.filter(a=>a._valid).length;return{entity:e,columns:t,rows:r,totalRows:n.length,validRows:d,invalidRows:r.length-d}}function ql(e){const n=Ll[e],l={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[e];return"\uFEFF"+n.join(",")+`
`+l.join(",")+`
`}async function Nl(e,t){const{supabaseInsert:n}=await g(async()=>{const{supabaseInsert:a}=await Promise.resolve().then(()=>R);return{supabaseInsert:a}},void 0);let i=0,l=0;const d={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const a of t){if(!a._valid)continue;const{_valid:o,_error:c,...u}=a,p={...u};if(!p.id){const y=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[y]??`${e}-${Date.now()}-${i+l}`)}for(const y of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[y]=="string"&&p[y]!==""){const h=Number(p[y]);Number.isFinite(h)&&(p[y]=h)}try{await n(d,p)!==null?i++:l++}catch{l++}}return{inserted:i,failed:l}}function pt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function Rl(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Ol(e,t,n,i,l){const r=n.reduce((c,u)=>c+u.rowCount,0),d=n.map(c=>c.lastSyncAt).filter(c=>c!==null).sort().reverse()[0]??null,a=100,o=Math.max(1,Math.ceil(l/a));return`
    <section class="page-head">
      <div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="mono" style="font-size:11px;max-width:300px;overflow:hidden;text-overflow:ellipsis;" title="${c._raw_b64?c._raw_b64.slice(0,200):""}">${Rl(c._raw_b64)}</td>
            </tr>
            `).join("")}
          </tbody>
        </table>
    ...
    `}
  `}function F(e){return e.toLocaleString("ja-JP")}function mt(e){const[t,n]=e.split("-");return`${t.slice(2)}/${n}`}function Ml(e){return e>=.99?2.33:e>=.97?1.88:e>=.95?1.65:e>=.9?1.28:1.04}function jl(e){const{months:t,matrix:n}=e;if(t.length===0||e.products.length===0)return'<div class="chart-empty">データなし</div>';const i=e.products.slice().sort((A,_)=>(e.productTotals[_.code]??0)-(e.productTotals[A.code]??0)).slice(0,6),l=["#0F5B8D","#2F855A","#B7791F","#C53D3D","#6B46C1","#2B6CB0"],r=820,d=280,a={top:20,right:20,bottom:40,left:60},o=r-a.left-a.right,c=d-a.top-a.bottom,u=t.map(A=>i.reduce((_,D)=>_+(n[D.code]?.[A]??0),0)),p=Math.max(...u,1),y=o/t.length,h=Math.max(y-10,14),f=[0,.25,.5,.75,1].map(A=>{const _=a.top+c-c*A,D=`${Math.round(p*A/100)*100}`;return`
      <line x1="${a.left}" y1="${_}" x2="${r-a.right}" y2="${_}" class="chart-grid" />
      <text x="6" y="${_+4}" class="chart-axis">${Number(D).toLocaleString("ja-JP")}</text>
    `}).join(""),S=t.map((A,_)=>{let D=a.top+c;const E=a.left+_*y+(y-h)/2,w=i.map((X,Vt)=>{const Jt=(n[X.code]?.[A]??0)/p*c;return D-=Jt,`<rect x="${E}" y="${D}" width="${h}" height="${Jt}" fill="${l[Vt%l.length]}" opacity="0.85" rx="${Vt===i.length-1?3:0}" />`}).join(""),[I,j]=A.split("-"),J=parseInt(j),C=J===1||_%3===0,Y=J===1?`${I.slice(2)}年`:`${J}月`;return`<g>${w}${C?`<text x="${E+h/2}" y="${d-10}" class="chart-axis centered-axis">${Y}</text>`:""}</g>`}).join(""),$=i.map((A,_)=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
    ...
    <div style="padding:4px 0 8px ${a.left}px;display:flex;flex-wrap:wrap;">${$}</div>
  `}function Fl(e){const{months:t,products:n}=e,i=n.slice().sort((d,a)=>(e.productTotals[a.code]??0)-(e.productTotals[d.code]??0)).slice(0,50),l=t.map(d=>{const[a,o]=d.split("-"),c=parseInt(o);return`<th class="numeric" style="min-width:52px;white-space:nowrap;">${c===1?`${a.slice(2)}年1月`:`${c}月`}</th>`}).join(""),r=i.map(d=>{const a=t.map(o=>{const c=e.matrix[d.code]?.[o]??0;return`<td class="numeric">${c>0?F(c):"—"}</td>`}).join("");return`
      <tr>
        <td class="mono">${d.code}</td>
        <td style="white-space:nowrap;">${d.name}</td>
        ${a}
        <td class="numeric"><strong>${F(e.productTotals[d.code]??0)}</strong></td>
        <td class="numeric">${F(Math.round(e.productAvg[d.code]??0))}</td>
        <td class="numeric">${F(Math.round(e.productStdDev[d.code]??0))}</td>
      </tr>
    `}).join("");return`
  ...
  `}function Bl(e){const t=e.months[e.months.length-1]??"",n=e.months[e.months.length-2]??"",i=e.months.length-13,l=i>=0?e.months[i]:"",r=e.products.reduce((p,y)=>p+(e.matrix[y.code]?.[t]??0),0),d=e.products.reduce((p,y)=>p+(e.matrix[y.code]?.[n]??0),0),a=l?e.products.reduce((p,y)=>p+(e.matrix[y.code]?.[l]??0),0):0,o=d>0?(r-d)/d*100:0,c=a>0?(r-a)/a*100:0,u=p=>p>=0?"+":"";return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        <p class="panel-title">直近月 出荷合計</p>
        <p class="kpi-value">${F(r)} 本</p>
        <p class="kpi-sub">${mt(t)}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">前月比</p>
        <p class="kpi-value ${o>=0?"":"text-danger"}">${u(o)}${o.toFixed(1)}%</p>
        <p class="kpi-sub">${mt(n)} 比</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">前年同月比</p>
        <p class="kpi-value ${c>=0?"":"text-danger"}">${a>0?`${u(c)}${c.toFixed(1)}%`:"—"}</p>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>${e.map(n=>{const i=Ml(n.serviceLevel),l=n.leadTimeDays/30,r=Math.ceil(i*n.demandStdDev*Math.sqrt(l)),d=Math.ceil(n.avgMonthlyDemand*l+r),a=r-n.safetyStockQty,o=a>0?"text-danger":a<-r*.3?"text-warning":"",c=[.9,.95,.99].map(u=>`<option value="${u}" ${Math.abs(n.serviceLevel-u)<.01?"selected":""}>${(u*100).toFixed(0)}%</option>`).join("");return`
      <tr>
        ...
        <td class="numeric">${F(d)}</td>
        <td class="numeric ${o}">
          ${a>0?`+${F(a)}`:F(a)}
          ${a>0?'<span class="status-pill warning" style="margin-left:4px">不足</span>':""}
        </td>
      </tr>
  ...
  `}function Vl(e,t){const n={draft:"下書き",confirmed:"確定",actual:"実績入力済"},i={draft:"neutral",confirmed:"info",actual:"success"},l=e.map(p=>{const y=Math.max(0,p.demandForecast+p.safetyStockTarget-p.openingStock),h=p.plannedQty>0?(p.actualQty-p.plannedQty)/p.plannedQty*100:null,f=h!==null?h>=0?"text-success":"text-danger":"";return`
      <tr>
    ...
    `}).join(""),r=e.reduce((p,y)=>p+y.demandForecast,0),d=e.reduce((p,y)=>p+Math.max(0,y.demandForecast+y.safetyStockTarget-y.openingStock),0),a=e.reduce((p,y)=>p+y.plannedQty,0),o=e.reduce((p,y)=>p+y.actualQty,0),c=new Date;return`
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;">
      <label class="field" style="margin:0;flex-shrink:0;">
        <span>対象年月</span>
        <select data-action="plan-year-month" style="width:140px;">${Array.from({length:24},(p,y)=>{const h=new Date(c.getFullYear(),c.getMonth()-6+y,1),f=`${h.getFullYear()}-${String(h.getMonth()+1).padStart(2,"0")}`;return`<option value="${f}" ${f===t?"selected":""}>${f.replace("-","年")}月</option>`}).join("")}</select>
      </label>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${l||'<tr><td colspan="9" class="empty-row">データなし</td></tr>'}
            ${e.length>0?`
              <tr style="background:var(--surface-alt);font-weight:700;">
                <td>合計</td>
                <td class="numeric">${F(Math.round(r))}</td>
                <td class="numeric">—</td>
                <td class="numeric">—</td>
                <td class="numeric">${F(Math.round(d))}</td>
                <td class="numeric">${F(a)}</td>
                <td class="numeric">${o>0?F(o):"—"}</td>
                <td class="numeric">—</td>
                <td>—</td>
              </tr>`:""}
          </tbody>
  ...
  `}function Jl(e,t,n,i,l){const d=[{key:"demand",label:"需要実績"},{key:"safety",label:"安全在庫"},{key:"plan",label:"生産計画"}].map(o=>`<button class="tab-button ${i===o.key?"active":""}"
       data-demand-tab="${o.key}">${o.label}</button>`).join("");let a="";return i==="demand"?a=e?Bl(e):'<section class="panel"><p>データを読み込んでいます…</p></section>':i==="safety"?a=zl(t):a=Vl(n,l),`
    <section class="page-head">
      <div>
    ...
    ${a}
  `}function ha(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ul(e,t){return Math.floor(Math.abs(t.getTime()-e.getTime())/(1e3*60*60*24))}function Yl(e){return e==="dormant"?"休眠":"離反リスク"}function Ql(e){return e==="dormant"?"warning":"danger"}function Hl(e,t){const n=new Date,i=new Date(n);i.setMonth(i.getMonth()-3);const l=new Date(n);l.setMonth(l.getMonth()-12);const r=new Date(n);r.setFullYear(r.getFullYear()-1);const d=new Date(r.getFullYear(),r.getMonth(),1),a=new Date(r.getFullYear(),r.getMonth()+1,0),o=new Date(n.getFullYear(),n.getMonth(),1),c=new Map(t.map(f=>[f.code,f])),u=new Map;for(const f of e){if(!f.legacy_customer_code)continue;const S=u.get(f.legacy_customer_code)||[];S.push(f),u.set(f.legacy_customer_code,S)}const p=[],y=[],h=new Set;for(const[f,S]of u.entries()){const $=c.get(f),A=$?.name||(S[0]?.customer_name??f);let _=null,D=0,E=!1,w=!1,I=!1,j=!1;for(const C of S){const Y=new Date(C.sales_date);(!_||Y>_)&&(_=Y),Y>=l&&(w=!0,D+=C.total_amount),Y>=i&&(E=!0),Y>=d&&Y<=a&&(I=!0),Y>=o&&(j=!0)}if(!_)continue;const J={code:f,name:A,businessType:$?.businessType??"",areaCode:$?.areaCode??"",phone:$?.phone??"",lastOrderDate:_.toISOString().slice(0,10),daysSinceLastOrder:Ul(_,n),totalAmountLast12m:D,status:"dormant"};w&&!E&&(p.push({...J,status:"dormant"}),h.add(f)),I&&!j&&!h.has(f)&&y.push({...J,status:"at-risk"})}return p.sort((f,S)=>S.daysSinceLastOrder-f.daysSinceLastOrder),y.sort((f,S)=>S.totalAmountLast12m-f.totalAmountLast12m),{dormantCustomers:p,atRiskCustomers:y}}function Gl(e){const t=[...e.dormantCustomers,...e.atRiskCustomers],n=e.dormantCustomers.length,i=e.atRiskCustomers.length,l=e.dormantCustomers.reduce((u,p)=>u+p.totalAmountLast12m,0),r=t.map(u=>`
        <tr data-status="${u.status}" data-area="${u.areaCode}" data-biz="${u.businessType}">
          ...
          <td><span class="status-pill ${Ql(u.status)}">${Yl(u.status)}</span></td>
        </tr>
    ...
    <\/script>
  `}const ie=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],St={"year-round":"通年品",seasonal:"季節品","year-end":"歳暮品"},ne={"year-round":"#0F5B8D",seasonal:"#2f855a","year-end":"#c05621"};function Xl(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Kl(e){const t=e.reduce((r,d)=>r+d,0);if(t===0)return"year-round";if((e[10]+e[11])/t>.5)return"year-end";const i=Math.max(...e);return e.filter(r=>r>i*.1).length<=6?"seasonal":"year-round"}function Wl(e){const t=e.reduce((r,d)=>r+d,0);if(t===0)return[];const i=t/12*1.5,l=[];for(let r=0;r<12;r++)e[r]>i&&l.push(r);if(l.length===0){const r=Math.max(...e);r>0&&l.push(e.indexOf(r))}return l.sort((r,d)=>r-d)}function Zl(e){return e.length===0?0:(e[0]-2+12)%12}function va(e){const t=new Date().getMonth(),n=e.map(l=>{const r=Kl(l.monthlyQuantity),d=Wl(l.monthlyQuantity),a=Zl(d);return{code:l.code,name:l.name,category:l.category,peakMonths:d,proposalStartMonth:a,seasonType:r,monthlyQuantity:l.monthlyQuantity}}),i=[];for(let l=0;l<12;l++){const r=n.filter(d=>{if(d.peakMonths.length===0)return!1;const a=d.proposalStartMonth,o=d.peakMonths[0];return a<=o?l>=a&&l<=o:l>=a||l<=o});i.push({month:l,products:r,targetCustomers:[]})}return{products:n,proposals:i,selectedMonth:t}}function er(e){const{products:t,proposals:n,selectedMonth:i}=e,l=new Date().getMonth(),r={"year-round":[],seasonal:[],"year-end":[]};t.forEach(p=>r[p.seasonType].push(p));const d=n[i],a=t.length,o=d?.products.length??0,c=t.filter(p=>p.peakMonths.includes(i)).length,u=d?.targetCustomers.length??0;return`
<div class="panel">
  <div class="page-head">
    <div>
  ...
  ${sr(d)}
</div>`}function tr(e,t){const n=[],i=["year-round","seasonal","year-end"];for(const l of i){const r=e[l];if(r.length!==0){n.push(`<tr><td colspan="14" style="padding:8px 8px 4px;font-weight:600;background:#f7fafc;border-bottom:1px solid #e2e8f0">
      <span class="status-pill" style="background:${ne[l]}15;color:${ne[l]};padding:2px 8px;border-radius:9px;font-size:0.75rem">${St[l]}</span>
    </td></tr>`);for(const d of r){const a=ie.map((o,c)=>{const u=d.peakMonths.includes(c),p=ks(d,c),y=c===t?"outline:2px solid #0F5B8D;outline-offset:-1px;":"";let h="transparent";u?h=ne[d.seasonType]:p&&(h=ne[d.seasonType]+"40");const f=u||p?`background:${h};border-radius:3px;height:18px;width:100%;`:"";return`<td style="padding:2px;text-align:center;${y}"><div style="${f}" title="${u?"ピーク":p?"提案期間":""}"></div></td>`}).join("");n.push(`<tr style="border-bottom:1px solid #f0f0f0">
    ...
    </div>`}).filter(Boolean);return i.length===0?`<div style="padding:1rem;color:#666;text-align:center">${ie[t]}に提案対象の商品はありません</div>`:i.join("")}function sr(e){return!e||e.targetCustomers.length===0?`
  ...
  <div class="table-wrap" style="margin-top:1rem">
    ...
    <tr style="border-bottom:1px solid #f0f0f0">
      ...
      <td class="mono numeric" style="padding:6px 8px">${Xl(n.lastYearAmount)}</td>
  ...
  `).join("")}</tbody>
  ...
  </div>`}const nr=new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}),yt=["月","火","水","木","金"],fa=6;function ir(e,t){if(!e)return 9999;const n=new Date(e);return isNaN(n.getTime())?9999:Math.floor((t.getTime()-n.getTime())/(1e3*60*60*24))}function or(e,t){if(t.length===0)return 0;const n=[...t].sort((l,r)=>l-r);return n.filter(l=>l<=e).length/n.length}function lr(e,t){return e.includes("離反リスク")?"緊急訪問 - 離反防止ヒアリング":e.includes("季節提案タイミング")?"季節商品の提案・試飲サンプル持参":t>30?"定期巡回 - 状況確認・追加注文確認":"関係維持 - ご挨拶"}function ba(e){const t=new Date,n=e.map(o=>o.annualRevenue),i=e.map(o=>{const c=ir(o.lastOrderDate,t);let u=0;const p=[];c>=60&&(u+=50,p.push("離反リスク")),o.hasSeasonalProposal&&(u+=30,p.push("季節提案タイミング")),c>=30&&c<60&&(u+=20,p.push("定期巡回"));const y=or(o.annualRevenue,n),h=Math.round(y*20);h>0&&(u+=h,p.push("金額ウェイト"));const f=lr(p,c);return{code:o.code,name:o.name,phone:o.phone,address:o.address1,areaCode:o.areaCode,businessType:o.businessType,priorityScore:u,reasons:p,lastOrderDate:o.lastOrderDate,daysSinceOrder:c,annualRevenue:o.annualRevenue,recommendedAction:f}}).filter(o=>o.priorityScore>0).sort((o,c)=>c.priorityScore-o.priorityScore),l=new Map;for(const o of i){const c=o.areaCode||"その他";l.has(c)||l.set(c,[]),l.get(c).push(o)}const r=[...l.entries()].sort((o,c)=>c[1].reduce((u,p)=>u+p.priorityScore,0)-o[1].reduce((u,p)=>u+p.priorityScore,0)),d=[];let a=0;for(const[o,c]of r){const u=c.sort((p,y)=>y.priorityScore-p.priorityScore);for(let p=0;p<u.length&&!(a>=yt.length);p+=fa){const y=u.slice(p,p+fa);d.push({dayLabel:yt[a],area:o,visits:y}),a++}if(a>=yt.length)break}return{candidates:i,weekPlan:d,filterArea:"",filterMinScore:0}}function rr(e){const{candidates:t,weekPlan:n,filterArea:i,filterMinScore:l}=e,r=t.filter(p=>!(i&&p.areaCode!==i||l>0&&p.priorityScore<l)),d=Array.from(new Set(t.map(p=>p.areaCode))).sort(),a=r.length,o=r.filter(p=>p.priorityScore>=50).length,c=r.filter(p=>p.reasons.includes("離反リスク")).length,u=n.reduce((p,y)=>p+y.visits.length,0);return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      ${n.length===0?"<p>訪問候補がありません。</p>":cr(n)}
    </section>
  ...
  `}function ur(e){const t={empty:"空",in_use:"使用中",aging:"熟成中"},n={empty:"neutral",in_use:"warning",aging:"success"},i=e.map(c=>{const u=c.capacity>0?Math.round(c.currentVolume/c.capacity*100):0;return`
        <tr>
  ...
  `}function ht(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function pr(e,t,n){const i=e.rows.map((c,u)=>`
      <tr>
...
</svg>`,gr=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
  <circle cx="14" cy="14" r="13" stroke="currentColor" stroke-width="1.5"/>
...
`)}`,d=new Blob([r],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(d),o=document.createElement("a");o.href=a,o.download=e,document.body.append(o),o.click(),o.remove(),window.setTimeout(()=>URL.revokeObjectURL(a),0)}const _r=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser","/demand-forecast","/churn-alert","/seasonal-calendar","/visit-planner","/demand"];let be=[];async function wr(){const{supabaseQueryAll:e}=await g(async()=>{const{supabaseQueryAll:n}=await Promise.resolve().then(()=>R);return{supabaseQueryAll:n}},void 0);be=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(n=>typeof n.email=="string"&&n.email.length>0).map(n=>({name:String(n.name??""),email:String(n.email??""),area:String(n.delivery_area_code??""),historySegment:"seasonal"}))}const $a=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"},{path:"/churn-alert",title:"離反アラート・休眠顧客"},{path:"/seasonal-calendar",title:"季節提案カレンダー"},{path:"/visit-planner",title:"訪問計画・ルート最適化"},{path:"/demand",title:"需要分析・安全在庫・生産計画"}];function Ss(e){const t=Ct[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function jt(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function kr(){const e=Ss("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const it=new Date,Sr=it.toISOString().slice(0,7),xr=it.getFullYear(),Pr=it.getMonth()+1,Ar=it.toISOString().slice(0,10),Er="C0011",de=kr();function xs(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return _r.includes(n)?n:"/"}function Ft(e){switch(e){case"/invoice-entry":case"/quote":case"/delivery":case"/billing":case"/invoice":case"/ledger":return"sales";case"/analytics":case"/customer-analysis":case"/product-power":case"/customer-efficiency":case"/report":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":case"/churn-alert":case"/seasonal-calendar":case"/visit-planner":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":case"/demand":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const _a=xs(location.pathname),s={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:jt(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:Sr,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:xr,taxMonth:Pr,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],callLogs:[],mapFilters:{showCustomers:!0,showProspects:!0,showDelivery:!0,filterRegion:"",filterBusinessType:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...Sl,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...xl},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:Ar,route:_a,currentCategory:Ft(_a),sidebarOpen:!1,announcements:[],dismissedAnnouncements:new Set,updateAvailable:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:Er,salesPeriod:"month",customRange:{start:"",end:""},quoteState:(()=>{const e={...hs};try{const t=localStorage.getItem("quote-seal");t&&(e.sealSettings=JSON.parse(t))}catch{}return e})(),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,productPower:[],productFilter:"all",productPeriod:"year",productDaily:[],productCustomStart:"",productCustomEnd:"",productSortState:[],customerSortState:[],dashboardSortState:[],masterSortState:[],customerEfficiency:[],masterTab:"customers",masterFilter:{...Mt},analyticsTab:"products",analyticsPeriod:"all",analyticsPeriodFilter:"",analyticsPeriodRows:[],analyticsPeriodOptions:[],analyticsStaffFilter:"",analyticsTagFilter:"",analyticsStaffPeriod:"all",analyticsStaffPeriodFilter:"",analyticsStaffPeriodOptions:[],analyticsStaffTotals:[],analyticsStaffDrilldown:null,emailAudienceMode:de.mode,emailRegion:de.region,emailHistorySegment:de.historySegment,emailTemplateId:de.templateId,emailSubject:de.subject,emailBody:de.body,emailSaveMessage:de.saveMessage,emailSending:!1,demandForecast:{...Ai},churnAlert:null,seasonalCalendar:null,visitPlanner:null,demandAnalysis:null,safetyStockParams:[],productionPlan:[],demandTab:"demand",demandPlanYearMonth:new Date().toISOString().slice(0,7),globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function wa(e){return e.slice(0,10)}function Dr(e){return{...e}}function Ze(){s.pickerMode=null,s.pickerQuery="",s.pickerTargetLine=null}function Ps(){s.invoiceForm=jt(),s.invoiceSavedDocNo=null,s.invoicePriceGroup="",s.invoiceErrors={},Ze()}function As(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,i)=>{n.productCode.trim()||(t[`lines.${i}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${i}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${i}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${i}.unitPrice`]="単価は0円以上で入力してください。")}),t}function Cr(e){const t=s.invoiceForm.lines[e];t&&s.invoiceForm.lines.splice(e+1,0,Dr(t))}function Lr(){const e=s.invoiceRecords[0],t=s.masterStats?.customers[0],n=s.masterStats?.products.slice(0,2)??[];s.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:s.invoiceForm.staffCode||"S001",lines:n.map((i,l)=>{const r=l===0?1:2,d=1200*(l+1);return{productCode:i.code,productName:i.name,quantity:r,unitPrice:d,unit:"本",amount:r*d}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},s.invoiceSavedDocNo=null,s.invoiceErrors={}}function Ir(e){const t=s.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function Tr(e){const t=s.masterStats?.customers.find(n=>n.name===e.trim());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function Es(e){if(ae(e),s.invoiceErrors=As(s.invoiceForm),Object.keys(s.invoiceErrors).length>0){v();return}s.invoiceSaving=!0,v(),Ra(s.invoiceForm).then(t=>{s.invoiceSavedDocNo=t.documentNo,s.invoiceSaving=!1,s.invoiceErrors={},s.invoiceForm=jt(),v()}).catch(()=>{s.invoiceSaving=!1,v()})}function Ds(e){const t=s.salesFilter.startDate?new Date(s.salesFilter.startDate):null,n=s.salesFilter.endDate?new Date(`${s.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((i,l)=>new Date(l.date).getTime()-new Date(i.date).getTime()).filter(i=>{const l=new Date(i.date);return!(t&&l<t||n&&l>n)})}function Cs(){switch(s.emailAudienceMode){case"area":return s.emailRegion==="all"?be:be.filter(e=>e.area===s.emailRegion);case"history":return be.filter(e=>e.historySegment===s.emailHistorySegment);default:return be}}function qr(){const e=Cs();return{audienceMode:s.emailAudienceMode,region:s.emailRegion,historySegment:s.emailHistorySegment,selectedTemplateId:s.emailTemplateId,subject:s.emailSubject,body:s.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:s.emailSaveMessage,sending:s.emailSending,senderId:s.emailSenderId,senders:s.mailSenders}}function vt(e){const t=Cs(),n=s.emailAudienceMode==="area"?s.emailRegion:s.emailAudienceMode==="history"?s.emailHistorySegment:"all";return{subject:s.emailSubject.trim(),body:s.emailBody.trim(),templateId:s.emailTemplateId,audienceMode:s.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(i=>i.email),status:e}}function Bt(){return s.user,!1}function Ie(){s.globalSearchOpen=!1,s.globalQuery=""}function Nr(){const e=s.globalQuery.trim().toLowerCase();return e?{customers:s.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:s.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:s.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:$a.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:$a}}function Rr(){let e=[],t,n="export.csv";switch(s.route){case"/sales":e=(s.salesSummary?Ds(s.salesSummary):[]).map(i=>({documentNo:i.documentNo,date:i.date,customerCode:i.customerCode,customerName:i.customerName,amount:i.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...s.paymentStatus?.records??[]].sort((i,l)=>l.balanceAmount-i.balanceAmount).map(i=>({...i})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=s.invoiceRecords.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=s.purchaseList.map(i=>({...i})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=s.jikomiList.map(i=>({...i})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=s.tankList.map(i=>({...i})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=s.kenteiList.map(i=>({...i})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=s.materialList.map(i=>({...i})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":s.masterTab==="customers"?(e=s.masterStats?.customers.map(i=>({...i}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=s.masterStats?.products.map(i=>({...i}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}$r(n,e,t)}function ka(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),s.route=e,s.currentCategory=Ft(e),s.sidebarOpen=!1,Ie(),zt(e)}async function zt(e){s.actionLoading=!0,v();try{switch(e){case"/delivery":s.deliveryNote||(s.deliveryNote=await It(s.deliverySearchDocNo||"D240122"));break;case"/billing":s.billingSummary||(s.billingSummary=await Tt(s.billingYearMonth));break;case"/report":s.salesReport||(s.salesReport=await at());break;case"/product-power":s.productPower.length===0&&(s.productPower=await Va());break;case"/customer-efficiency":s.customerEfficiency.length===0&&(s.customerEfficiency=await Ja());break;case"/customer-analysis":s.customerAnalysis||(s.customerAnalysis=await Ua());break;case"/demand-forecast":if(s.demandForecast.forecasts.length===0){const{fetchDemandForecasts:t,fetchDeliverySchedule:n}=await g(async()=>{const{fetchDemandForecasts:r,fetchDeliverySchedule:d}=await Promise.resolve().then(()=>k);return{fetchDemandForecasts:r,fetchDeliverySchedule:d}},void 0),[i,l]=await Promise.all([t(),n()]);s.demandForecast.forecasts=i.map(r=>({code:r.productCode,name:r.productName,segment:r.segment,monthlyQuantity:new Array(12).fill(0),avgMonthly:Math.round(r.avgMonthly),adjustedAvg:Math.round(r.avgMonthly),nextMonthForecast:Math.round(r.forecastQuantity),annualForecast:Math.round(r.avgMonthly*12),safetyStock:Math.round(r.safetyStock)})),s.demandForecast.deliveries=Ei(l)}break;case"/churn-alert":if(!s.churnAlert){const{fetchChurnAlerts:t}=await g(async()=>{const{fetchChurnAlerts:i}=await Promise.resolve().then(()=>k);return{fetchChurnAlerts:i}},void 0),n=await t();if(n.length>0){const i=n.filter(r=>r.is_dormant).map(r=>({code:r.customer_code,name:r.customer_name,businessType:r.business_type,areaCode:r.area_code,phone:r.phone,lastOrderDate:r.last_order_date,daysSinceLastOrder:r.days_since_order,totalAmountLast12m:r.amount_12m,status:"dormant"})),l=n.filter(r=>r.is_at_risk).map(r=>({code:r.customer_code,name:r.customer_name,businessType:r.business_type,areaCode:r.area_code,phone:r.phone,lastOrderDate:r.last_order_date,daysSinceLastOrder:r.days_since_order,totalAmountLast12m:r.amount_12m,status:"at-risk"}));s.churnAlert={dormantCustomers:i,atRiskCustomers:l}}else{const{supabaseQueryAll:i}=await g(async()=>{const{supabaseQueryAll:d}=await Promise.resolve().then(()=>R);return{supabaseQueryAll:d}},void 0),[l,r]=await Promise.all([i("sales_document_headers",{select:"sales_date,legacy_customer_code,customer_name,total_amount"}),s.masterStats?Promise.resolve(s.masterStats.customers):He().then(d=>d.customers)]);s.churnAlert=Hl(l.map(d=>({sales_date:d.sales_date||"",legacy_customer_code:d.legacy_customer_code||"",customer_name:d.customer_name||"",total_amount:Number(d.total_amount)||0})),(s.masterStats?.customers??r).map(d=>({code:d.code,name:d.name,businessType:d.businessType,areaCode:d.areaCode,phone:d.phone})))}}break;case"/seasonal-calendar":if(!s.seasonalCalendar){const{fetchProductShipmentsFromTable:t}=await g(async()=>{const{fetchProductShipmentsFromTable:i}=await Promise.resolve().then(()=>k);return{fetchProductShipmentsFromTable:i}},void 0),n=await t();if(n.length>0)s.seasonalCalendar=va(n.map(i=>({code:i.code,name:i.name,category:"",monthlyQuantity:i.monthlyQuantity})));else{const{fetchProductMonthlyShipments:i}=await g(async()=>{const{fetchProductMonthlyShipments:r}=await Promise.resolve().then(()=>k);return{fetchProductMonthlyShipments:r}},void 0),l=await i();s.seasonalCalendar=va(l.map(r=>({code:r.code,name:r.name,category:"",monthlyQuantity:r.monthlyQuantity})))}}break;case"/visit-planner":if(!s.visitPlanner){const{fetchVisitPriorities:t}=await g(async()=>{const{fetchVisitPriorities:i}=await Promise.resolve().then(()=>k);return{fetchVisitPriorities:i}},void 0),n=await t();if(n.length>0)s.visitPlanner={candidates:n.map(i=>({code:i.customer_code,name:i.customer_name,phone:i.phone,address:i.address,areaCode:i.area_code,businessType:i.business_type,priorityScore:i.priority_score,reasons:i.reasons,lastOrderDate:i.last_order_date,daysSinceOrder:i.days_since_order,annualRevenue:i.annual_revenue,recommendedAction:i.recommended_action})),weekPlan:[],filterArea:"",filterMinScore:0},s.visitPlanner=ba(n.map(i=>({code:i.customer_code,name:i.customer_name,phone:i.phone,address1:i.address,areaCode:i.area_code,businessType:i.business_type,annualRevenue:i.annual_revenue,lastOrderDate:i.last_order_date,hasSeasonalProposal:i.reasons.some(l=>l.includes("季節"))})));else{const{supabaseQueryAll:i}=await g(async()=>{const{supabaseQueryAll:o}=await Promise.resolve().then(()=>R);return{supabaseQueryAll:o}},void 0),[l,r]=await Promise.all([i("sales_document_headers",{select:"sales_date,legacy_customer_code,total_amount"}),s.masterStats?Promise.resolve(s.masterStats.customers):He().then(o=>o.customers)]),d=s.masterStats?.customers??r,a=new Map;l.forEach(o=>{const c=o.legacy_customer_code||"",u=o.sales_date||"",p=Number(o.total_amount)||0,y=a.get(c);!y||u>y.lastDate?a.set(c,{lastDate:u,total:(y?.total??0)+p}):y.total+=p}),s.visitPlanner=ba(d.filter(o=>o.isActive).map(o=>({code:o.code,name:o.name,phone:o.phone,address1:o.address1,areaCode:o.areaCode,businessType:o.businessType,annualRevenue:a.get(o.code)?.total??0,lastOrderDate:a.get(o.code)?.lastDate??"",hasSeasonalProposal:!1})))}}break;case"/demand":{const{fetchDemandAnalysis:t,fetchSafetyStockParams:n,fetchProductionPlan:i}=await g(async()=>{const{fetchDemandAnalysis:l,fetchSafetyStockParams:r,fetchProductionPlan:d}=await Promise.resolve().then(()=>k);return{fetchDemandAnalysis:l,fetchSafetyStockParams:r,fetchProductionPlan:d}},void 0);if(!s.demandAnalysis){const[l,r]=await Promise.all([t(),n()]);s.demandAnalysis=l,s.safetyStockParams=r}if(s.productionPlan.length===0){const l=await i(s.demandPlanYearMonth);if(l.length>0)s.productionPlan=l;else if(s.demandAnalysis&&s.safetyStockParams.length>0){const r=s.demandPlanYearMonth,d=s.demandAnalysis.months.filter(a=>a<r).slice(-3);s.productionPlan=s.safetyStockParams.filter(a=>(s.demandAnalysis.productAvg[a.productCode]??0)>=10).map(a=>{const o=d.map(p=>s.demandAnalysis.matrix[a.productCode]?.[p]??0),c=o.length>0?Math.ceil(o.reduce((p,y)=>p+y,0)/o.length):Math.ceil(a.avgMonthlyDemand),u=Math.ceil(a.safetyStockQty);return{id:"",yearMonth:r,productCode:a.productCode,productName:a.productName,demandForecast:c,safetyStockTarget:u,openingStock:0,requiredProduction:Math.max(0,c+u),plannedQty:Math.max(0,c+u),actualQty:0,status:"draft",notes:""}})}}break}case"/jikomi":s.jikomiList.length===0&&(s.jikomiList=await Qa());break;case"/tanks":s.tankList.length===0&&(s.tankList=await Ha());break;case"/kentei":s.kenteiList.length===0&&(s.kenteiList=await Ga());break;case"/materials":s.materialList.length===0&&(s.materialList=await bt());break;case"/purchase":(s.purchaseList.length===0||s.payableList.length===0)&&([s.purchaseList,s.payableList]=await Promise.all([Xa(),Ka()]));break;case"/raw-material":(s.billList.length===0||s.rawStockList.length===0)&&([s.billList,s.rawStockList]=await Promise.all([Wa(),Za()]));break;case"/tax":s.taxDeclaration||(s.taxDeclaration=await qt(s.taxYear,s.taxMonth));break;case"/store":(s.storeSales.length===0||s.storeOrders.length===0)&&([s.storeSales,s.storeOrders]=await Promise.all([Nt(s.storeSalesDate),as()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await g(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>k);return{fetchMailSenders:n}},void 0);if(s.mailSenders=await t(),!s.emailSenderId||!s.mailSenders.find(n=>n.id===s.emailSenderId)){const n=s.mailSenders.find(i=>i.isDefault)??s.mailSenders[0];n&&(s.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await g(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>k);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await g(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>k);return{fetchIntegrationSettings:n}},void 0);s.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await g(async()=>{const{fetchShopifyOrders:i,fetchIntegrationSettings:l}=await Promise.resolve().then(()=>k);return{fetchShopifyOrders:i,fetchIntegrationSettings:l}},void 0);s.shopifyOrders=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await g(async()=>{const{fetchFaxInbox:i,fetchIntegrationSettings:l}=await Promise.resolve().then(()=>k);return{fetchFaxInbox:i,fetchIntegrationSettings:l}},void 0);s.faxRecords=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await g(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>k);return{fetchUserProfiles:n}},void 0);s.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:i}=await g(async()=>{const{fetchMyProfile:r,fetchAuditLogs:d,fetchMailSenders:a}=await Promise.resolve().then(()=>k);return{fetchMyProfile:r,fetchAuditLogs:d,fetchMailSenders:a}},void 0),l=s.user?.email??s.myProfile?.email??"";l&&(s.myProfile=await t(l)),s.mailSenders.length===0&&(s.mailSenders=await i()),s.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await g(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>k);return{fetchAuditLogs:n}},void 0);s.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await g(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>k);return{fetchProspects:n}},void 0);s.prospects=await t()}break;case"/map":{const{fetchProspects:t,fetchDeliveryLocations:n,fetchIntegrationSettings:i}=await g(async()=>{const{fetchProspects:l,fetchDeliveryLocations:r,fetchIntegrationSettings:d}=await Promise.resolve().then(()=>k);return{fetchProspects:l,fetchDeliveryLocations:r,fetchIntegrationSettings:d}},void 0);s.prospects=await t(),s.deliveryLocations=await n(),s.integrations.length===0&&(s.integrations=await i())}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:n}=await g(async()=>{const{fetchCallLogs:i,fetchIntegrationSettings:l}=await Promise.resolve().then(()=>k);return{fetchCallLogs:i,fetchIntegrationSettings:l}},void 0);s.callLogs=await t(100),s.integrations.length===0&&(s.integrations=await n())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:n}=await g(async()=>{const{fetchLeadLists:i,fetchIntegrationSettings:l}=await Promise.resolve().then(()=>k);return{fetchLeadLists:i,fetchIntegrationSettings:l}},void 0);s.leadLists=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await g(async()=>{const{fetchWorkflowOrdersFromDb:n}=await Promise.resolve().then(()=>k);return{fetchWorkflowOrdersFromDb:n}},void 0);s.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await g(async()=>{const{fetchTourInquiriesFromDb:n}=await Promise.resolve().then(()=>k);return{fetchTourInquiriesFromDb:n}},void 0);s.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:i}=await g(async()=>{const{fetchSlackRules:l,fetchSlackLogs:r,fetchIntegrationSettings:d}=await Promise.resolve().then(()=>k);return{fetchSlackRules:l,fetchSlackLogs:r,fetchIntegrationSettings:d}},void 0);s.slackRules=await t(),s.slackLogs=await n(50),s.integrations.length===0&&(s.integrations=await i())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:n,fetchWorkflowOrdersFromDb:i,fetchTourInquiriesFromDb:l}=await g(async()=>{const{fetchProspects:r,fetchCalendarEvents:d,fetchWorkflowOrdersFromDb:a,fetchTourInquiriesFromDb:o}=await Promise.resolve().then(()=>k);return{fetchProspects:r,fetchCalendarEvents:d,fetchWorkflowOrdersFromDb:a,fetchTourInquiriesFromDb:o}},void 0);s.prospects.length===0&&(s.prospects=await t()),s.calendarEvents.length===0&&(s.calendarEvents=await n(s.calendarYearMonth)),s.materialList.length===0&&(s.materialList=await bt()),s.workflowOrders.length===0&&(s.workflowOrders=await i()),s.tourInquiries.length===0&&(s.tourInquiries=await l())}break;default:break}}catch(t){console.warn("Route data load error",t)}finally{s.actionLoading=!1,v()}}function Sa(){if(Bt())return yo(s.authError,s.authSubmitting);if(s.loading)return`
    ...
    `;switch(s.route){case"/cat/sales":return Ne("sales");case"/cat/brewery":return Ne("brewery");case"/cat/purchase":return Ne("purchase");case"/cat/more":return Ne("more");case"/invoice-entry":return Yi(s.invoiceForm,s.invoiceSavedDocNo,s.invoiceSaving,s.invoiceErrors);case"/quote":return Xi(s.quoteState,s.masterStats?.customers??[],s.masterStats?.products??[],s.quoteCustomerQuery,s.quoteProductQuery,s.quotePricing);case"/email":return zi(qr());case"/delivery":return s.deliveryNote?Fi(s.deliveryNote,s.deliverySearchDocNo):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/billing":return s.billingSummary?$i(s.billingSummary,s.billingYearMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/report":return s.salesReport?Vo(s.salesReport):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":return to(s.productPower,s.productFilter,s.productDaily,s.productPeriod,s.productCustomStart,s.productCustomEnd,s.productSortState);case"/customer-efficiency":return ao(s.customerEfficiency,s.customerSortState);case"/customer-analysis":return s.customerAnalysis?Oo(s.customerAnalysis):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":case"/customer-efficiency":return'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/demand-forecast":return Ii(s.demandForecast);case"/demand":return Jl(s.demandAnalysis,s.safetyStockParams,s.productionPlan,s.demandTab,s.demandPlanYearMonth);case"/churn-alert":return s.churnAlert?Gl(s.churnAlert):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">離反データを分析中…</p></div></section>';case"/seasonal-calendar":return s.seasonalCalendar?er(s.seasonalCalendar):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">季節データを分析中…</p></div></section>';case"/visit-planner":return s.visitPlanner?rr(s.visitPlanner):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">訪問計画を生成中…</p></div></section>';case"/jikomi":return s.jikomiView==="calendar"?`${sa(s.jikomiList,s.jikomiView)}${uo(s.jikomiList)}`:sa(s.jikomiList,s.jikomiView);case"/tanks":return ur(s.tankList);case"/kentei":return po(s.kenteiList);case"/materials":return So(s.materialList)+ko(s.materialEditing,s.materialEditingIsNew);case"/purchase":return Do(s.purchaseList,s.payableList);case"/raw-material":return Co(s.billList,s.rawStockList);case"/tax":return s.taxDeclaration?pr(s.taxDeclaration,s.taxYear,s.taxMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/store":return Qo(s.storeSales,s.storeOrders,s.storeTab,s.storeSalesDate);case"/setup":return s.pipelineMeta?To(s.pipelineMeta,G,z,s.syncDashboard):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/raw-browser":return Ol(s.rawSelectedTable,s.rawRecords,s.rawTableList,s.rawPage,s.rawTotalCount);case"/import":return Go(s.importEntity,s.importPreview,s.importing,s.importResult);case"/print":return Dl(s.printTemplate,s.printOptions,s.printCompany,s.printData);case"/form-designer":return Ko(s.printData,s.printCompany,s.printOptions,s.fdSavedPositions,s.fdDesignMode);case"/map":{const e=(s.masterStats?.customers??[]).slice(0,200).map((i,l)=>{const r=i;return{...i,lat:r.lat??35.37+l%12*.05+(Math.random()-.5)*.02,lng:r.lng??139.29+Math.floor(l/12)*.05+(Math.random()-.5)*.02,address1:r.address1??"",businessType:r.businessType??"",lastOrderAmount:0}}),n=!!s.integrations.find(i=>i.provider==="google_maps")?.config.api_key;return Wo(e,s.prospects,s.deliveryLocations,s.mapFilters,n)}case"/workflow":return tl(s.workflowOrders);case"/mobile-order":return al(s.mobileOrder,s.masterStats?.customers??[],s.masterStats?.products??[]);case"/tour":return nl(s.tourInquiries,s.tourActiveId);case"/mail-senders":return ll(s.mailSenders,s.mailSenderEditingId);case"/calendar":return rl(s.calendarEvents,s.calendarYearMonth,s.calendarFilterCategory,s.calendarEdit);case"/integrations":return dl(s.integrations,s.integrationEditingId);case"/shopify":{const e=s.integrations.find(t=>t.id==="shopify");return ul(s.shopifyOrders,e?.lastSyncAt??null)}case"/fax":return pl(s.faxRecords,s.faxProcessing,s.faxOcrText);case"/users":return ml(s.userProfiles,s.userEditingId,s.myProfile);case"/profile":return yl(s.myProfile,s.auditLogs.filter(e=>e.userEmail===s.myProfile?.email),s.mailSenders);case"/audit":return hl(s.auditLogs);case"/prospects":{const e={prospects:s.prospects,activities:s.prospectActivities,editingId:s.prospectEditingId,viewMode:s.prospectViewMode};return vl(e)}case"/slack":{const e=s.integrations.find(t=>t.provider==="slack")??null;return $l(e,s.slackRules,s.slackLogs)}case"/calls":{const e=s.integrations.find(t=>t.provider==="ivry");return _l(s.callLogs,s.masterStats?.customers??[],e?.lastSyncAt??null,e?.isEnabled??!1)}case"/list-builder":{const e={lists:s.leadLists,activeListId:s.leadActiveListId,items:s.leadItems,searchQuery:s.leadSearchQuery,searchArea:s.leadSearchArea,searchBusinessType:s.leadSearchType,searching:s.leadSearching,searchResults:s.leadSearchResults};return kl(e)}}if(!s.salesSummary||!s.paymentStatus||!s.masterStats||!s.pipelineMeta||!s.customerLedger||!s.salesAnalytics)return"";switch(s.route){case"/sales":return Yo(Ds(s.salesSummary),s.salesFilter.startDate,s.salesFilter.endDate);case"/payment":return Ao([...s.paymentStatus.records].sort((e,t)=>t.balanceAmount-e.balanceAmount));case"/master":return wo(s.masterStats,s.masterTab,s.masterFilter,s.masterSortState);case"/invoice":return io(s.invoiceRecords,s.invoiceFilter);case"/ledger":return xi(s.customerLedger,s.ledgerCustomerCode);case"/analytics":return zo(s.salesAnalytics,s.analyticsTab,s.analyticsPeriod,s.analyticsPeriodFilter,s.analyticsPeriodRows,s.analyticsPeriodOptions,s.analyticsStaffFilter,s.analyticsTagFilter,s.analyticsStaffDrilldown,s.analyticsStaffPeriod,s.analyticsStaffPeriodFilter,s.analyticsStaffPeriodOptions,s.analyticsStaffTotals);default:return Oi(s.salesSummary,s.pipelineMeta,s.salesAnalytics,{prospects:s.prospects,upcomingEvents:s.calendarEvents,tourInquiries:s.tourInquiries,workflowOrdersCount:{new:s.workflowOrders.filter(e=>e.stage==="new").length,picking:s.workflowOrders.filter(e=>e.stage==="picking").length,packed:s.workflowOrders.filter(e=>e.stage==="packed").length,shipped:s.workflowOrders.filter(e=>e.stage==="shipped").length,total:s.workflowOrders.length},lowStockCount:s.materialList.filter(e=>e.currentStock<e.minimumStock*1.5).length,masterCounts:s.masterStats?{customers:s.masterStats.summary.customerCount,products:s.masterStats.summary.productCount,suppliers:s.syncDashboard?.tables.find(e=>e.tableName==="suppliers")?.rowCount??0,specialPrices:s.syncDashboard?.tables.find(e=>e.tableName==="customer_product_prices")?.rowCount??0}:void 0},s.salesPeriod,s.customRange,s.dashboardSortState)}}function Or(){const e={info:{bg:"#edf6ff",border:"#b8d4e8",icon:"ℹ️"},warning:{bg:"#fff8e6",border:"#e6c54d",icon:"⚠️"},maintenance:{bg:"#fff3e0",border:"#f5a623",icon:"🔧"},update:{bg:"#e8f5e9",border:"#66bb6a",icon:"🆕"}},n=s.announcements.filter(l=>!s.dismissedAnnouncements.has(l.id)).map(l=>{const r=e[l.level]??e.info;return`
      ...
      </div>`:"";return n+i}function Mr(){if(Bt())return`
    ...
    `;const e={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売業務",items:[{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/quote",label:"見積作成",kicker:"Quote"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],analytics:[{label:"分析",items:[{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/customer-analysis",label:"得意先分析",kicker:"CustABC"},{path:"/product-power",label:"商品力分析",kicker:"Power"},{path:"/customer-efficiency",label:"営業効率",kicker:"Efficiency"},{path:"/report",label:"集計帳票",kicker:"Report"}]}],crm:[{label:"営業ツール",items:[{path:"/churn-alert",label:"離反アラート",kicker:"Churn"},{path:"/seasonal-calendar",label:"季節提案",kicker:"Season"},{path:"/visit-planner",label:"訪問計画",kicker:"Visit"},{path:"/prospects",label:"新規営業",kicker:"Prospects"},{path:"/map",label:"取引先マップ",kicker:"Map"},{path:"/list-builder",label:"リスト取得",kicker:"ListBuild"},{path:"/calls",label:"通話履歴",kicker:"Calls"},{path:"/email",label:"メール配信",kicker:"Mail"}]},{label:"受注・出荷",items:[{path:"/workflow",label:"受注ワークフロー",kicker:"Workflow"},{path:"/mobile-order",label:"モバイル受注",kicker:"Mobile"},{path:"/shopify",label:"Shopify注文",kicker:"Shopify"},{path:"/fax",label:"FAX OCR",kicker:"FAX"}]}],orders:[{label:"仕入・調達",items:[{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],brewery:[{label:"製造管理",items:[{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"},{path:"/tax",label:"酒税申告",kicker:"Tax"},{path:"/demand",label:"需要・生産計画",kicker:"Demand"}]}],master:[{label:"マスタ・ツール",items:[{path:"/master",label:"マスタ管理",kicker:"Master"},{path:"/calendar",label:"カレンダー",kicker:"Calendar"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/tour",label:"酒蔵見学",kicker:"Tour"},{path:"/print",label:"印刷",kicker:"Print"}]}],settings:[{label:"システム設定",items:[{path:"/setup",label:"連動設定",kicker:"Setup"},{path:"/integrations",label:"外部連携",kicker:"API"},{path:"/slack",label:"Slack通知",kicker:"Slack"},{path:"/import",label:"データ取込",kicker:"Import"},{path:"/raw-browser",label:"データブラウザ",kicker:"RawData"},{path:"/users",label:"ユーザー管理",kicker:"Users"},{path:"/profile",label:"プロフィール",kicker:"Profile"},{path:"/audit",label:"操作ログ",kicker:"Audit"}]}]},t=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/invoice-entry",label:"販売"},{category:"analytics",path:"/analytics",label:"分析"},{category:"crm",path:"/prospects",label:"営業"},{category:"orders",path:"/purchase",label:"仕入"},{category:"brewery",path:"/jikomi",label:"製造"},{category:"master",path:"/master",label:"マスタ"},{category:"settings",path:"/setup",label:"設定"}],n=e[s.currentCategory].map(a=>`
      ...
      `).join(""),l=s.pickerMode&&s.masterStats?s.pickerMode==="customer"?Ji(s.masterStats.customers,s.pickerQuery):Eo(s.masterStats.products,s.pickerQuery):"",r=s.globalSearchOpen?Vi(s.globalQuery,Nr()):"",d=s.user?`
