(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();const Oe="modulepreload",Fe=function(t){return"/sake-system/"+t},Tt={},D=function(e,s,n){let o=Promise.resolve();if(s&&s.length>0){let r=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};var d=r;document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),c=l?.nonce||l?.getAttribute("nonce");o=r(s.map(u=>{if(u=Fe(u),u in Tt)return;Tt[u]=!0;const p=u.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${h}`))return;const v=document.createElement("link");if(v.rel=p?"stylesheet":Oe,p||(v.as="script"),v.crossOrigin="",v.href=u,c&&v.setAttribute("nonce",c),document.head.appendChild(v),p)return new Promise((E,F)=>{v.addEventListener("load",E),v.addEventListener("error",()=>F(new Error(`Unable to preload CSS for ${u}`)))})}))}function i(l){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=l,window.dispatchEvent(c),!c.defaultPrevented)throw l}return o.then(l=>{for(const c of l||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})},z="https://loarwnuyvfxiscjjsmiz.supabase.co",gt="";async function $t(t,e){return null}async function f(t,e={}){return[]}const ee=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:gt,SUPABASE_URL:z,supabaseInsert:$t,supabaseQuery:f},Symbol.toStringTag,{value:"Module"})),ft="sake_auth";function ae(t){localStorage.setItem(ft,JSON.stringify(t))}function se(){return{apikey:gt,"Content-Type":"application/json"}}function Je(t){try{const[,e]=t.split(".");if(!e)return null;const s=e.replaceAll("-","+").replaceAll("_","/"),n=s.padEnd(Math.ceil(s.length/4)*4,"=");return JSON.parse(atob(n))}catch{return null}}async function ne(t,e){const s=await fetch(`${z}/auth/v1/${t}`,{method:"POST",headers:se(),body:JSON.stringify(e)}),n=await s.json().catch(()=>({}));if(!s.ok)throw new Error(n.error_description??n.msg??`HTTP ${s.status}`);return n}async function Ve(t,e){const s=await ne("token?grant_type=password",{email:t,password:e});return ae({access_token:s.access_token,refresh_token:s.refresh_token}),{email:s.user?.email??t}}async function Be(t,e){const s=await ne("signup",{email:t,password:e});return s.access_token&&s.refresh_token&&ae({access_token:s.access_token,refresh_token:s.refresh_token}),{email:s.user?.email??t}}async function Ue(){const t=kt();if(localStorage.removeItem(ft),!!t?.access_token)try{await fetch(`${z}/auth/v1/logout`,{method:"POST",headers:{...se(),Authorization:`Bearer ${t.access_token}`}})}catch(e){console.warn("Supabase sign out failed",e)}}function kt(){const t=localStorage.getItem(ft);if(!t)return null;try{const e=JSON.parse(t);return!e.access_token||!e.refresh_token?null:{access_token:e.access_token,refresh_token:e.refresh_token}}catch{return null}}function He(){const t=kt();if(!t)return null;const e=Je(t.access_token),s=typeof e?.email=="string"?e.email:null;return s?{email:s}:null}const St={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
ご注文締切や納品希望日がございましたら、あわせてお知らせください。`}},ot={generatedAt:"2026-04-15T09:15:00+09:00",kpis:{todaySales:1248e3,todayDelta:8.2,monthSales:18245e3,monthDelta:5.6,unpaidCount:7,unpaidAmount:264e4},dailySales:Array.from({length:30},(t,e)=>{const s=new Date("2026-03-17T00:00:00+09:00");return s.setDate(s.getDate()+e),{date:s.toISOString(),amount:42e4+e*73123%62e4}}),salesRecords:Array.from({length:20},(t,e)=>{const s=new Date("2026-04-15T00:00:00+09:00");return s.setDate(s.getDate()-e),{id:`sale-${e+1}`,documentNo:`D${String(240100+e).padStart(6,"0")}`,date:s.toISOString(),customerCode:`C${String(e+11).padStart(4,"0")}`,customerName:["青葉商事","北斗酒販","中央フーズ","東海酒店"][e%4],amount:68e3+e%6*24500}})},Ye={generatedAt:"2026-04-15T09:15:00+09:00",records:[{id:"pay-1",customerCode:"C0011",customerName:"青葉商事",billedAmount:54e4,paymentAmount:0,balanceAmount:54e4,lastPaymentDate:null,status:"unpaid"},{id:"pay-2",customerCode:"C0012",customerName:"北斗酒販",billedAmount:72e4,paymentAmount:3e5,balanceAmount:42e4,lastPaymentDate:"2026-04-11T14:30:00+09:00",status:"partial"},{id:"pay-3",customerCode:"C0013",customerName:"中央フーズ",billedAmount:68e4,paymentAmount:68e4,balanceAmount:0,lastPaymentDate:"2026-04-14T10:00:00+09:00",status:"paid"},{id:"pay-4",customerCode:"C0014",customerName:"東海酒店",billedAmount:41e4,paymentAmount:18e4,balanceAmount:23e4,lastPaymentDate:"2026-04-10T09:10:00+09:00",status:"partial"}]},_={generatedAt:"2026-04-15T09:15:00+09:00",summary:{customerCount:164,activeCustomerCount:152,productCount:486,activeProductCount:461},customers:Array.from({length:12},(t,e)=>({id:`customer-${e+1}`,code:`C${String(e+1).padStart(4,"0")}`,name:["青葉商事","北斗酒販","中央フーズ","東海酒店","三和物産","南星リカー"][e%6],closingDay:[15,20,25,31][e%4],paymentDay:[5,10,15,20][e%4],isActive:e%5!==0})),products:Array.from({length:12},(t,e)=>({id:`product-${e+1}`,code:`P${String(e+1).padStart(5,"0")}`,janCode:`4901234567${String(e).padStart(3,"0")}`,name:["純米吟醸 720ml","本醸造 1.8L","特別純米 300ml","梅酒 500ml"][e%4],category:["清酒","焼酎","リキュール"][e%3],isActive:e%6!==0}))},Ke={generatedAt:"2026-04-15T09:15:00+09:00",lastSyncAt:"2026-04-15T09:12:21+09:00",status:"success",jobName:"daily-sync",message:"同期完了。売上・入金・マスタを最新化しました。"},oe=ot.salesRecords.map((t,e)=>({...t,itemCount:e%4+1})),ze={C0011:{customerCode:"C0011",customerName:"青葉商事",balanceAmount:54e4,salesTotal:114e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-1",date:"2026-04-15T00:00:00+09:00",documentNo:"D240100",amount:42e4},{id:"ledger-sale-2",date:"2026-04-08T00:00:00+09:00",documentNo:"D240087",amount:39e4},{id:"ledger-sale-3",date:"2026-03-28T00:00:00+09:00",documentNo:"D240059",amount:33e4}],paymentHistory:[{id:"ledger-payment-1",date:"2026-04-10T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-2",date:"2026-03-31T00:00:00+09:00",amount:3e5,method:"振込"}]},C0012:{customerCode:"C0012",customerName:"北斗酒販",balanceAmount:42e4,salesTotal:102e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-4",date:"2026-04-14T00:00:00+09:00",documentNo:"D240101",amount:36e4},{id:"ledger-sale-5",date:"2026-04-05T00:00:00+09:00",documentNo:"D240082",amount:32e4},{id:"ledger-sale-6",date:"2026-03-25T00:00:00+09:00",documentNo:"D240054",amount:34e4}],paymentHistory:[{id:"ledger-payment-3",date:"2026-04-11T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-4",date:"2026-03-30T00:00:00+09:00",amount:3e5,method:"現金"}]}},it={productTotals:[{code:"P00001",name:"純米吟醸 720ml",amount:584e4,quantity:820,documents:148},{code:"P00002",name:"本醸造 1.8L",amount:498e4,quantity:610,documents:131},{code:"P00003",name:"特別純米 300ml",amount:356e4,quantity:1240,documents:112},{code:"P00004",name:"梅酒 500ml",amount:287e4,quantity:540,documents:89}],customerTotals:[{code:"C0011",name:"青葉商事",amount:462e4,quantity:320,documents:54},{code:"C0012",name:"北斗酒販",amount:438e4,quantity:294,documents:49},{code:"C0013",name:"中央フーズ",amount:391e4,quantity:276,documents:45},{code:"C0014",name:"東海酒店",amount:324e4,quantity:221,documents:37}]};function g(t){if(typeof t=="number"&&Number.isFinite(t))return t;if(typeof t=="string"){const e=Number(t);return Number.isFinite(e)?e:0}return 0}function We(t){switch((t??"").toLowerCase()){case"paid":case"complete":case"completed":return"paid";case"partial":case"partially_paid":case"partially paid":return"partial";default:return"unpaid"}}function Qe(t){return typeof t=="boolean"?t:typeof t=="number"?t!==0:typeof t=="string"?["true","1","active","enabled","yes","y"].includes(t.toLowerCase()):!1}function w(t,e,s=""){for(const n of e){const o=t[n];if(typeof o=="string"&&o.length>0)return o}return s}function Rt(t,e,s=0){for(const n of e)if(n in t)return g(t[n]);return s}function qt(t,e,s=!0){for(const n of e)if(n in t)return Qe(t[n]);return s}function ie(t,e,s){for(const n of e){const o=t[n];if(typeof o!="string"||o.length===0)continue;if(/^\d{4}-\d{2}-\d{2}$/.test(o))return new Date(`${o}T00:00:00Z`).toISOString();const i=new Date(o);if(!Number.isNaN(i.getTime()))return i.toISOString()}return s}function le(t){return t.slice(0,7)}function wt(t,e){return{id:String(t.id??`invoice-${e+1}`),documentNo:t.document_no??t.legacy_document_no??`D${String(240100+e).padStart(6,"0")}`,date:ie(t,["sales_date","document_date"],new Date().toISOString()),customerCode:t.customer_code??t.legacy_customer_code??`C${String(e+1).padStart(4,"0")}`,customerName:t.customer_name??t.customer_code??t.legacy_customer_code??"不明",itemCount:0,amount:g(t.total_amount??t.billed_amount)}}function Mt(t,e){const s=e.startDate?new Date(`${e.startDate}T00:00:00`):null,n=e.endDate?new Date(`${e.endDate}T23:59:59`):null,o=e.documentNo.trim().toLowerCase(),i=e.customerCode.trim().toLowerCase();return t.filter(d=>{const l=new Date(d.date);return!(s&&l<s||n&&l>n||o&&!d.documentNo.toLowerCase().includes(o)||i&&!d.customerCode.toLowerCase().includes(i))}).sort((d,l)=>new Date(l.date).getTime()-new Date(d.date).getTime())}function It(t){const e=t.trim().toUpperCase(),s=ze[e];if(s)return s;const n=ot.salesRecords.find(o=>o.customerCode.toUpperCase()===e);return{customerCode:e||"未指定",customerName:n?.customerName??"該当得意先なし",balanceAmount:0,salesTotal:0,paymentTotal:0,salesHistory:[],paymentHistory:[]}}function Ge(){const t=new Map,e=new Map,s=new Map;return oe.forEach((n,o)=>{const i=le(n.date);t.set(i,(t.get(i)??0)+n.amount);const d=e.get(n.customerCode)??{code:n.customerCode,name:n.customerName,amount:0,quantity:0,documents:0};d.amount+=n.amount,d.quantity+=n.itemCount,d.documents+=1,e.set(n.customerCode,d);const l=`P${String(o%4+1).padStart(5,"0")}`,c=it.productTotals[o%it.productTotals.length],r=s.get(l)??{code:l,name:c?.name??`商品${o+1}`,amount:0,quantity:0,documents:0};r.amount+=n.amount,r.quantity+=n.itemCount*12,r.documents+=1,s.set(l,r)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(t.entries()).sort(([n],[o])=>n.localeCompare(o)).map(([n,o])=>({month:n,amount:o})),productTotals:Array.from(s.values()).sort((n,o)=>o.amount-n.amount),customerTotals:Array.from(e.values()).sort((n,o)=>o.amount-n.amount)}}async function b(t,e){try{const s=await fetch(`/sake-system/${t}`,{headers:{Accept:"application/json"}});if(!s.ok)throw new Error(`HTTP ${s.status}`);return await s.json()}catch(s){return console.warn(`Failed to fetch ${t}, using fallback data`,s),e}}async function ce(){const t=await f("daily_sales_fact",{});if(t.length>0){const e=await f("customer_payment_status",{}),n=new Date().toISOString().slice(0,10),o=n.slice(0,7),i=[...t].sort((r,u)=>r.sales_date.localeCompare(u.sales_date)).slice(-30).map(r=>({date:new Date(`${r.sales_date}T00:00:00Z`).toISOString(),amount:g(r.sales_amount)})),d=t.reduce((r,u)=>u.sales_date===n?r+g(u.sales_amount):r,0),l=t.reduce((r,u)=>u.sales_date.startsWith(o)?r+g(u.sales_amount):r,0),c=e.filter(r=>g(r.balance_amount)>0);return{generatedAt:new Date().toISOString(),kpis:{todaySales:d,todayDelta:0,monthSales:l,monthDelta:0,unpaidCount:c.length,unpaidAmount:c.reduce((r,u)=>r+g(u.balance_amount),0)},dailySales:i,salesRecords:ot.salesRecords}}return b("data/api/latest/sales-summary.json",ot)}async function re(){const t=await f("customer_payment_status",{});return t.length>0?{generatedAt:new Date().toISOString(),records:t.map((e,s)=>{const n=e.legacy_customer_code??`UNKNOWN-${s+1}`;return{id:`payment-${n}-${s+1}`,customerCode:n,customerName:n,billedAmount:g(e.billed_amount),paymentAmount:g(e.paid_amount),balanceAmount:g(e.balance_amount),lastPaymentDate:null,status:We(e.payment_status)}})}:b("data/api/latest/payment-status.json",Ye)}async function de(){const[t,e]=await Promise.all([f(),f()]);if(t.length>0||e.length>0){const s=t.length?t.map((o,i)=>({id:w(o,["id","customer_id","code"],`customer-${i+1}`),code:w(o,["code","customer_code","legacy_customer_code"],`C${String(i+1).padStart(4,"0")}`),name:w(o,["name","customer_name","display_name"],`Customer ${i+1}`),closingDay:Rt(o,["closing_day","close_day"],31),paymentDay:Rt(o,["payment_day","due_day"],15),isActive:qt(o,["is_active","active","enabled"],!0)})):_.customers,n=e.length?e.map((o,i)=>({id:w(o,["id","product_id","code"],`product-${i+1}`),code:w(o,["code","product_code"],`P${String(i+1).padStart(5,"0")}`),janCode:w(o,["jan_code","jan","barcode"],""),name:w(o,["name","product_name","display_name"],`Product ${i+1}`),category:w(o,["category","category_name"],"未分類"),isActive:qt(o,["is_active","active","enabled"],!0)})):_.products;return{generatedAt:new Date().toISOString(),summary:{customerCount:t.length||_.summary.customerCount,activeCustomerCount:t.length?s.filter(o=>o.isActive).length:_.summary.activeCustomerCount,productCount:e.length||_.summary.productCount,activeProductCount:e.length?n.filter(o=>o.isActive).length:_.summary.activeProductCount},customers:s,products:n}}return b("data/api/latest/master-stats.json",_)}function ue(){return b("data/api/latest/pipeline-meta.json",Ke)}async function lt(t){const[e,s]=await Promise.all([f("sales_document_headers",{}),f("sales_document_lines",{})]);if(e.length>0){const n=new Map;s.forEach(i=>{const d=String(i.header_id??i.document_header_id??i.document_no??i.id??"");d&&n.set(d,(n.get(d)??0)+1)});const o=e.map((i,d)=>{const l=wt(i,d),c=String(i.id??i.document_no??i.legacy_document_no??"");return{...l,itemCount:n.get(c)??l.itemCount}});return Mt(o,t)}return Mt(oe,t)}async function Ct(t){const e=t.trim().toUpperCase();if(!e)return It("");const[s,n,o]=await Promise.all([f("sales_document_headers",{}),f("customer_payments",{}),f("customer_payment_status",{})]);if(s.length>0||n.length>0){const i=s.map((c,r)=>{const u=wt(c,r);return{id:u.id,date:u.date,documentNo:u.documentNo,amount:u.amount}}),d=n.map((c,r)=>({id:String(c.id??`payment-${r+1}`),date:ie(c,["payment_date","received_date"],new Date().toISOString()),amount:g(c.payment_amount??c.amount),method:c.payment_method??c.method??"入金"})),l=o.find(c=>(c.legacy_customer_code??"").toUpperCase()===e);return{customerCode:e,customerName:s[0]?.customer_name??s[0]?.customer_code??s[0]?.legacy_customer_code??e,balanceAmount:g(l?.balance_amount),salesTotal:i.reduce((c,r)=>c+r.amount,0),paymentTotal:d.reduce((c,r)=>c+r.amount,0),salesHistory:i,paymentHistory:d}}return It(e)}async function pe(){const[t,e,s]=await Promise.all([f("daily_sales_fact",{}),f("sales_document_headers",{}),f("sales_document_lines",{})]);if(t.length>0){const n=new Map;t.forEach(d=>{const l=le(d.sales_date);n.set(l,(n.get(l)??0)+g(d.sales_amount))});const o=new Map;e.forEach((d,l)=>{const c=wt(d,l),r=o.get(c.customerCode)??{code:c.customerCode,name:c.customerName,amount:0,quantity:0,documents:0};r.amount+=c.amount,r.documents+=1,o.set(c.customerCode,r)});const i=new Map;return s.forEach((d,l)=>{const c=d.product_code??d.legacy_product_code??`P${String(l+1).padStart(5,"0")}`,r=i.get(c)??{code:c,name:d.product_name??c,amount:0,quantity:0,documents:0};r.amount+=g(d.line_amount??d.amount),r.quantity+=g(d.quantity),r.documents+=1,i.set(c,r)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(n.entries()).sort(([d],[l])=>d.localeCompare(l)).map(([d,l])=>({month:d,amount:l})).slice(-12),productTotals:i.size>0?Array.from(i.values()).sort((d,l)=>l.amount-d.amount):it.productTotals,customerTotals:o.size>0?Array.from(o.values()).sort((d,l)=>l.amount-d.amount):it.customerTotals}}return Ge()}const vt={sales:"売上",return:"返品",export_return:"輸出戻入"};async function me(t){const e=t.lines.reduce((o,i)=>o+i.amount,0),s=`D${Date.now().toString().slice(-6)}`;return{id:(await $t("sales_document_headers",{legacy_customer_code:t.customerCode,sales_date:t.invoiceDate,document_type:t.invoiceType,staff_code:t.staffCode}))?.id??`local-${s}`,documentNo:s,totalAmount:e,status:"confirmed",createdAt:new Date().toISOString()}}const Ot={documentNo:"D240122",invoiceDate:"2026-04-14",customerCode:"C0011",customerName:"青葉商事 株式会社",customerAddress:"〒123-4567 東京都千代田区〇〇 1-2-3",lines:[{productCode:"P00012",productName:"純米吟醸 720ml",quantity:6,unitPrice:12e3,unit:"本",amount:72e3},{productCode:"P00008",productName:"本醸造 1.8L",quantity:4,unitPrice:8500,unit:"本",amount:34e3},{productCode:"P00021",productName:"梅酒 500ml",quantity:12,unitPrice:5800,unit:"本",amount:69600}],totalAmount:175600,taxAmount:15960,note:""};async function xt(t){const e=await f("sales_document_headers",{});if(e.length>0){const s=e[0],n=g(s.total_amount);return{documentNo:t,invoiceDate:w(s,["sales_date","document_date"],""),customerCode:w(s,["legacy_customer_code","customer_code"],""),customerName:w(s,["customer_name","legacy_customer_code"],""),customerAddress:"",lines:[],totalAmount:n,taxAmount:Math.floor(n*10/110),note:""}}return{...Ot,documentNo:t||Ot.documentNo}}const Xe={targetYearMonth:"2026-04",closingDay:15,totalBilling:482e4,customers:[{customerCode:"C0011",customerName:"青葉商事",closingDay:15,salesAmount:54e4,taxAmount:54e3,prevBalance:28e4,paymentAmount:28e4,billingAmount:594e3,status:"open"},{customerCode:"C0012",customerName:"北斗酒販",closingDay:15,salesAmount:72e4,taxAmount:72e3,prevBalance:14e4,paymentAmount:14e4,billingAmount:792e3,status:"closed"},{customerCode:"C0013",customerName:"中央フーズ",closingDay:15,salesAmount:38e4,taxAmount:38e3,prevBalance:0,paymentAmount:0,billingAmount:418e3,status:"open"},{customerCode:"C0014",customerName:"東海酒店",closingDay:15,salesAmount:61e4,taxAmount:61e3,prevBalance:23e4,paymentAmount:15e4,billingAmount:751e3,status:"open"}]};async function Dt(t){return b(`data/api/latest/billing-${t}.json`,{...Xe,targetYearMonth:t})}const Ze=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],ta={generatedAt:new Date().toISOString(),months:Ze,salesByProduct:[{label:"純米吟醸 720ml",values:[380,410,520,480,390,320,450,480,510,420,380,350].map(t=>t*1e4)},{label:"本醸造 1.8L",values:[290,310,380,340,280,250,320,360,390,310,280,260].map(t=>t*1e4)},{label:"梅酒 500ml",values:[210,240,310,290,230,180,260,300,320,250,200,190].map(t=>t*1e4)}],salesByCustomer:[{label:"青葉商事",values:[480,510,620,590,480,390,540,580,610,510,460,430].map(t=>t*1e4)},{label:"北斗酒販",values:[390,420,520,490,400,330,460,500,530,430,380,360].map(t=>t*1e4)}],costSimulation:[{productCode:"P00012",productName:"純米吟醸 720ml",costPrice:7200,sellPrice:12e3,margin:4800,marginRate:40},{productCode:"P00008",productName:"本醸造 1.8L",costPrice:4800,sellPrice:8500,margin:3700,marginRate:43.5},{productCode:"P00021",productName:"梅酒 500ml",costPrice:3200,sellPrice:5800,margin:2600,marginRate:44.8}]};async function he(){return b("data/api/latest/sales-report.json",ta)}const ve={planned:"計画中",active:"仕込中",done:"完了"},ea=[{id:"j1",jikomiNo:"J2026-01",productName:"純米吟醸",riceType:"山田錦",plannedKg:400,actualKg:400,startDate:"2026-01-10",expectedDoneDate:"2026-02-20",status:"done",tankNo:"T01",note:""},{id:"j2",jikomiNo:"J2026-02",productName:"本醸造",riceType:"日本晴",plannedKg:600,actualKg:600,startDate:"2026-02-01",expectedDoneDate:"2026-03-15",status:"done",tankNo:"T02",note:""},{id:"j3",jikomiNo:"J2026-03",productName:"特別純米",riceType:"五百万石",plannedKg:500,actualKg:480,startDate:"2026-03-05",expectedDoneDate:"2026-04-20",status:"active",tankNo:"T03",note:"経過良好"},{id:"j4",jikomiNo:"J2026-04",productName:"純米大吟醸",riceType:"山田錦",plannedKg:300,actualKg:0,startDate:"2026-04-15",expectedDoneDate:"2026-06-01",status:"planned",tankNo:"T04",note:""}];async function ye(){return b("data/api/latest/jikomi.json",ea)}const aa=[{id:"t1",tankNo:"T01",capacity:3e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-01"},{id:"t2",tankNo:"T02",capacity:4e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-20"},{id:"t3",tankNo:"T03",capacity:3500,currentVolume:2800,productName:"特別純米",jikomiNo:"J2026-03",status:"in_use",lastUpdated:"2026-04-10"},{id:"t4",tankNo:"T04",capacity:2e3,currentVolume:0,productName:"純米大吟醸",jikomiNo:"J2026-04",status:"in_use",lastUpdated:"2026-04-15"},{id:"t5",tankNo:"T05",capacity:5e3,currentVolume:3200,productName:"本醸造（貯蔵）",jikomiNo:"J2026-02",status:"aging",lastUpdated:"2026-03-20"}];async function be(){return b("data/api/latest/tanks.json",aa)}const sa=[{id:"k1",kenteiNo:"K2026-001",jikomiNo:"J2026-01",productName:"純米吟醸",kenteiDate:"2026-02-25",alcoholDegree:16.2,extractDegree:3.8,sakaMeterValue:2.5,volume:2850,taxCategory:"清酒",status:"approved"},{id:"k2",kenteiNo:"K2026-002",jikomiNo:"J2026-02",productName:"本醸造",kenteiDate:"2026-03-18",alcoholDegree:15.5,extractDegree:4.1,sakaMeterValue:1.8,volume:3600,taxCategory:"清酒",status:"submitted"},{id:"k3",kenteiNo:"K2026-003",jikomiNo:"J2026-03",productName:"特別純米",kenteiDate:"2026-04-18",alcoholDegree:0,extractDegree:0,sakaMeterValue:0,volume:0,taxCategory:"清酒",status:"pending"}];async function ge(){return b("data/api/latest/kentei.json",sa)}const na=[{id:"m1",code:"M001",name:"720ml瓶",unit:"本",currentStock:2400,minimumStock:500,unitCost:85,lastUpdated:"2026-04-10"},{id:"m2",code:"M002",name:"1.8L瓶",unit:"本",currentStock:1800,minimumStock:300,unitCost:140,lastUpdated:"2026-04-10"},{id:"m3",code:"M003",name:"300ml瓶",unit:"本",currentStock:3600,minimumStock:600,unitCost:55,lastUpdated:"2026-04-08"},{id:"m4",code:"M004",name:"キャップ（金）",unit:"個",currentStock:8e3,minimumStock:1e3,unitCost:12,lastUpdated:"2026-04-05"},{id:"m5",code:"M005",name:"ラベル（純米吟醸）",unit:"枚",currentStock:1200,minimumStock:300,unitCost:28,lastUpdated:"2026-04-01"},{id:"m6",code:"M006",name:"化粧箱（720ml）",unit:"個",currentStock:180,minimumStock:100,unitCost:320,lastUpdated:"2026-04-01"}];async function $e(){return b("data/api/latest/materials.json",na)}const oa=[{id:"p1",documentNo:"K240050",purchaseDate:"2026-04-05",supplierCode:"S001",supplierName:"山田農場",itemName:"山田錦（精米65%）",quantity:500,unitPrice:480,amount:24e4,status:"confirmed"},{id:"p2",documentNo:"K240051",purchaseDate:"2026-04-06",supplierCode:"S002",supplierName:"日本瓶工業",itemName:"720ml瓶",quantity:1200,unitPrice:85,amount:102e3,status:"confirmed"},{id:"p3",documentNo:"K240052",purchaseDate:"2026-04-10",supplierCode:"S003",supplierName:"山本麹店",itemName:"米麹",quantity:80,unitPrice:1200,amount:96e3,status:"pending"},{id:"p4",documentNo:"K240053",purchaseDate:"2026-04-12",supplierCode:"S001",supplierName:"山田農場",itemName:"五百万石（精米60%）",quantity:300,unitPrice:420,amount:126e3,status:"pending"}],ia=[{supplierCode:"S001",supplierName:"山田農場",totalPurchase:366e3,paidAmount:24e4,balance:126e3,nextPaymentDate:"2026-04-30",status:"partial"},{supplierCode:"S002",supplierName:"日本瓶工業",totalPurchase:102e3,paidAmount:102e3,balance:0,nextPaymentDate:"",status:"paid"},{supplierCode:"S003",supplierName:"山本麹店",totalPurchase:96e3,paidAmount:0,balance:96e3,nextPaymentDate:"2026-04-30",status:"unpaid"}],la=[{id:"b1",billNo:"H240001",supplierName:"山田農場",amount:24e4,issueDate:"2026-03-31",dueDate:"2026-04-30",status:"holding"},{id:"b2",billNo:"H240002",supplierName:"大阪資材",amount:185e3,issueDate:"2026-03-31",dueDate:"2026-05-31",status:"holding"},{id:"b3",billNo:"H230045",supplierName:"中部農業",amount:32e4,issueDate:"2026-02-28",dueDate:"2026-03-31",status:"cleared"}],ca=[{code:"R001",name:"山田錦（精米65%）",unit:"kg",currentStock:380,minimumStock:100,lastPurchaseDate:"2026-04-05",unitCost:480},{code:"R002",name:"五百万石（精米60%）",unit:"kg",currentStock:290,minimumStock:100,lastPurchaseDate:"2026-04-12",unitCost:420},{code:"R003",name:"米麹",unit:"kg",currentStock:62,minimumStock:20,lastPurchaseDate:"2026-04-10",unitCost:1200},{code:"R004",name:"醸造用アルコール",unit:"L",currentStock:240,minimumStock:50,lastPurchaseDate:"2026-03-20",unitCost:180},{code:"R005",name:"清酒用酵母",unit:"g",currentStock:500,minimumStock:100,lastPurchaseDate:"2026-02-15",unitCost:3200}];async function fe(){return b("data/api/latest/purchases.json",oa)}async function ke(){return b("data/api/latest/payables.json",ia)}async function Se(){return b("data/api/latest/bills.json",la)}async function we(){return b("data/api/latest/raw-stock.json",ca)}const Ce=[{code:"01",name:"清酒（普通酒）",taxRatePerLiter:100},{code:"02",name:"清酒（純米酒）",taxRatePerLiter:100},{code:"03",name:"清酒（吟醸酒）",taxRatePerLiter:100},{code:"04",name:"清酒（大吟醸酒）",taxRatePerLiter:100},{code:"05",name:"本格焼酎",taxRatePerLiter:250},{code:"06",name:"リキュール",taxRatePerLiter:200},{code:"07",name:"果実酒",taxRatePerLiter:100},{code:"08",name:"その他醸造酒",taxRatePerLiter:100}],yt={export:"輸出",sample:"見本",research:"試験醸造",loss:"欠減"},ra={targetYear:2026,targetMonth:3,companyName:"金井酒造店",companyNo:"1234567890123",companyAddress:"神奈川県秦野市堀山下182",companyRepresentative:"金井 和雄",taxOffice:"小田原税務署",rows:[{taxCategory:"01",taxCategoryName:"清酒（普通酒）",alcoholDegree:15.5,productionVolume:3800,previousBalance:0,currentAdjustment:0,exportDeduction:100,sampleDeduction:100,taxableVolume:3600,volume:3600,taxRate:100,taxAmount:36e4},{taxCategory:"02",taxCategoryName:"清酒（純米酒）",alcoholDegree:16.2,productionVolume:2900,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:50,taxableVolume:2850,volume:2850,taxRate:100,taxAmount:285e3},{taxCategory:"03",taxCategoryName:"清酒（吟醸酒）",alcoholDegree:16.5,productionVolume:1250,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:50,taxableVolume:1200,volume:1200,taxRate:100,taxAmount:12e4}],deductions:[{type:"export",categoryCode:"01",volume:100,reason:"シンガポール向け輸出",documentNo:"EX2026-003"},{type:"sample",categoryCode:"01",volume:100,reason:"展示会サンプル出荷"},{type:"sample",categoryCode:"02",volume:50,reason:"品評会出品"},{type:"sample",categoryCode:"03",volume:50,reason:"全国新酒鑑評会出品"}],totalVolume:7650,totalTax:765e3,status:"draft",submittedAt:null};async function _t(t,e){return b(`data/api/latest/tax-${t}-${String(e).padStart(2,"0")}.json`,{...ra,targetYear:t,targetMonth:e})}function k(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;")}function xe(t){const e=t.rows.map(n=>`    <Category>
      <Code>${k(n.taxCategory)}</Code>
      <Name>${k(n.taxCategoryName)}</Name>
...
`),s=t.deductions.map(n=>`    <Deduction type="${k(n.type)}">
      <CategoryCode>${k(n.categoryCode)}</CategoryCode>
      <Volume>${n.volume}</Volume>
      <Reason>${k(n.reason)}</Reason>${n.documentNo?`
      <DocumentNo>${k(n.documentNo)}</DocumentNo>`:""}
    </Deduction>`).join(`
...
<TaxDeclaration>
  <Header>
    ...
    <TaxpayerId>${k(t.companyNo)}</TaxpayerId>
    <TaxpayerName>${k(t.companyName)}</TaxpayerName>
    <TaxpayerAddress>${k(t.companyAddress)}</TaxpayerAddress>
    <TaxpayerRepresentative>${k(t.companyRepresentative)}</TaxpayerRepresentative>
    <TaxOffice>${k(t.taxOffice)}</TaxOffice>
...
`}function da(t){const e=String(t);return/[,"\n]/.test(e)?`"${e.replaceAll('"','""')}"`:e}function ua(t){const s=["酒類コード","区分名","アルコール度数","製造数量","前月繰越","当月調整","輸出控除","見本等控除","課税数量","税率(円/L)","税額(円)"].join(","),n=t.rows.map(i=>[i.taxCategory,i.taxCategoryName,i.alcoholDegree,i.productionVolume,i.previousBalance,i.currentAdjustment,i.exportDeduction,i.sampleDeduction,i.taxableVolume,i.taxRate,i.taxAmount].map(da).join(",")),o=`,合計,,${t.rows.reduce((i,d)=>i+d.productionVolume,0)},,,${t.rows.reduce((i,d)=>i+d.exportDeduction,0)},${t.rows.reduce((i,d)=>i+d.sampleDeduction,0)},${t.totalVolume},,${t.totalTax}`;return"\uFEFF"+[s,...n,o].join(`
`)+`
`}function pa(t){const e=t.rows.map(o=>{const i=Math.max(0,o.productionVolume+o.previousBalance+o.currentAdjustment-o.exportDeduction-o.sampleDeduction),d=Math.round(i*o.taxRate);return{...o,taxableVolume:i,volume:i,taxAmount:d}}),s=e.reduce((o,i)=>o+i.taxableVolume,0),n=e.reduce((o,i)=>o+i.taxAmount,0);return{...t,rows:e,totalVolume:s,totalTax:n}}async function ma(t){const{supabaseInsert:e}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>ee);return{supabaseInsert:s}},void 0);await e("tax_declarations",{target_year:t.targetYear,target_month:t.targetMonth,company_name:t.companyName,company_no:t.companyNo,company_address:t.companyAddress,company_representative:t.companyRepresentative,tax_office:t.taxOffice,total_taxable_volume:t.totalVolume,total_tax_amount:t.totalTax,status:t.status,xml_data:xe(t),submitted_at:t.submittedAt})}const ha=Array.from({length:10},(t,e)=>({id:`ss${e+1}`,saleDate:"2026-04-15",saleTime:`${9+e}:${String(e*7%60).padStart(2,"0")}`,productCode:`P${String(e%4+1).padStart(5,"0")}`,productName:["純米吟醸 720ml","本醸造 1.8L","梅酒 500ml","特別純米 300ml"][e%4],quantity:1+e%3,unitPrice:[2200,1800,980,680][e%4],amount:(1+e%3)*[2200,1800,980,680][e%4],paymentMethod:["cash","card","paypay","cash"][e%4]})),va=[{id:"o1",orderNo:"ORD-2604001",orderDate:"2026-04-13",customerName:"鈴木 太郎",postalCode:"150-0001",address:"東京都渋谷区〇〇1-1",items:[{productName:"純米吟醸 720ml",quantity:2,amount:4400}],totalAmount:4400,status:"shipped",shippingDate:"2026-04-14"},{id:"o2",orderNo:"ORD-2604002",orderDate:"2026-04-14",customerName:"田中 花子",postalCode:"530-0001",address:"大阪府大阪市北区〇〇2-3",items:[{productName:"梅酒 500ml",quantity:3,amount:2940},{productName:"本醸造 1.8L",quantity:1,amount:1800}],totalAmount:4740,status:"processing",shippingDate:""},{id:"o3",orderNo:"ORD-2604003",orderDate:"2026-04-15",customerName:"佐藤 一郎",postalCode:"460-0001",address:"愛知県名古屋市中区〇〇3-5",items:[{productName:"特別純米 300ml ×6本セット",quantity:1,amount:3980}],totalAmount:3980,status:"new",shippingDate:""}];async function At(t){return b(`data/api/latest/store-sales-${t}.json`,ha)}async function De(){return b("data/api/latest/store-orders.json",va)}async function nt(t){const e=await $t("email_campaigns",{subject:t.subject,body:t.body,template_id:t.templateId,audience_mode:t.audienceMode,audience_filter:t.audienceFilter,recipient_count:t.recipientCount,sent_count:t.status==="sent"?t.recipientCount:0,status:t.status,sent_at:t.status==="sent"?new Date().toISOString():null});return{id:e?.id??`local-email-${Date.now()}`,subject:e?.subject??t.subject,body:e?.body??t.body,templateId:e?.template_id??t.templateId,audienceMode:e?.audience_mode??t.audienceMode,audienceFilter:e?.audience_filter??t.audienceFilter,recipientCount:e?.recipient_count??t.recipientCount,status:e?.status??t.status,createdAt:e?.created_at??new Date().toISOString(),updatedAt:e?.updated_at??new Date().toISOString()}}async function _e(t){throw new Error("VITE_RESEND_API_KEY is not configured")}const T=Object.freeze(Object.defineProperty({__proto__:null,INVOICE_TYPE_LABELS:vt,JIKOMI_STATUS_LABELS:ve,SEASONAL_TEMPLATES:St,TAX_DEDUCTION_LABELS:yt,TAX_RATE_CATEGORIES:Ce,fetchBillList:Se,fetchBillingSummary:Dt,fetchCustomerLedger:Ct,fetchDeliveryNote:xt,fetchInvoices:lt,fetchJikomiList:ye,fetchKenteiList:ge,fetchMasterStats:de,fetchMaterialList:$e,fetchPayableList:ke,fetchPaymentStatus:re,fetchPipelineMeta:ue,fetchPurchaseList:fe,fetchRawMaterialStock:we,fetchSalesAnalytics:pe,fetchSalesReport:he,fetchSalesSummary:ce,fetchStoreOrders:De,fetchStoreSales:At,fetchTankList:be,fetchTaxDeclaration:_t,generateTaxCSV:ua,generateTaxXML:xe,recalculateTaxDeclaration:pa,saveEmailCampaign:nt,saveInvoice:me,saveTaxDeclaration:ma,sendEmailCampaign:_e},Symbol.toStringTag,{value:"Module"}));function R(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}const ya={open:"未締め",closed:"締め済"};function ba(t,e){const s=t.customers.map(n=>`
      <tr>
        <td>
        ...
        <td class="numeric">${R(n.salesAmount)}</td>
        <td class="numeric">${R(n.taxAmount)}</td>
        <td class="numeric">${R(n.prevBalance)}</td>
        <td class="numeric">${R(n.paymentAmount)}</td>
        <td class="numeric"><strong>${R(n.billingAmount)}</strong></td>
        <td>
          <span class="status-pill ${n.status==="closed"?"success":"warning"}">${ya[n.status]}</span>
        </td>
        <td>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${R(t.totalBilling)}</p>
  ...
  `}function Q(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function G(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function J(t,e){for(const s of e){const n=t[s];if(typeof n=="number"&&Number.isFinite(n))return n;if(typeof n=="string"){const o=Number(n);if(Number.isFinite(o))return o}}return null}function wa(t){const e=t?.productTotals;if(!e||e.length===0)return"―";const s=e.reduce((o,i)=>{const d=J(i,["amount","salesAmount"]),l=J(i,["marginRate","grossMarginRate"]);return d===null||d<=0||l===null?o:{weightedAmount:o.weightedAmount+d,weightedRate:o.weightedRate+d*l}},{weightedAmount:0,weightedRate:0});if(s.weightedAmount>0)return`${(s.weightedRate/s.weightedAmount).toFixed(1)}%`;const n=e.reduce((o,i)=>{const d=i,l=J(d,["amount","salesAmount"]),c=J(d,["grossProfit","grossAmount","margin"]),r=J(d,["costAmount","cost","costPrice"]);if(l===null||l<=0)return o;const u=c??(r!==null?l-r:null);return u===null?o:{sales:o.sales+l,gross:o.gross+u}},{sales:0,gross:0});return n.sales>0?`${(n.gross/n.sales*100).toFixed(1)}%`:"―"}function Ca(t){const n={top:20,right:20,bottom:30,left:50},o=760-n.left-n.right,i=260-n.top-n.bottom,d=Math.max(...t.map(u=>u.amount),1),l=o/t.length,c=t.map((u,p)=>{const h=u.amount/d*i,v=n.left+p*l+4,E=n.top+i-h,F=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(u.date));return`
        <g>
          <rect x="${v}" y="${E}" width="${Math.max(l-8,8)}" height="${h}" rx="4" fill="#0F5B8D" opacity="${.58+p/t.length*.34}" />
          ${p%5===0?`<text x="${v+6}" y="252" class="chart-axis">${F}</text>`:""}
        </g>
      `}).join("");return`
    <svg viewBox="0 0 760 260" class="sales-chart" role="img" aria-label="直近30日の日次売上">
      ${[0,.25,.5,.75,1].map(u=>{const p=n.top+i-i*u,h=Math.round(d*u/1e3);return`
        <g>
  ...
  `}function xa(t,e,s){const n={success:"正常",warning:"注意",error:"異常",running:"実行中"},o=t.salesRecords.slice(0,10).map(i=>`
            <tr>
              <td class="mono">${i.documentNo}</td>
              <td>${G(i.date)}</td>
              <td>${i.customerName}</td>
              <td class="numeric">${Q(i.amount)}</td>
            </tr>
          `).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card kpi-alert">
        ...
        <p class="kpi-sub">残高 ${Q(t.kpis.unpaidAmount)}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">月次粗利率</p>
        <p class="kpi-value">${wa(s)}</p>
  ...
  `}function Da(t){return t?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(t)):""}function q(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function _a(t,e){const s=t.lines.length?t.lines.map((o,i)=>`
          <tr>
            ...
            <td>${o.unit}</td>
            <td class="numeric">${q(o.unitPrice)}</td>
            <td class="numeric">${q(o.amount)}</td>
          </tr>
      ...
      <div class="delivery-header">
        ...
        <div class="delivery-meta">
          <table class="delivery-meta-table">
            ...
            <tr><th>納品日</th><td>${Da(t.invoiceDate)}</td></tr>
  ...
  `}function x(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Aa(t){return x(t).replaceAll(`
`,"<br />")}function Na(t){const s=[...Object.values(St),{id:"custom",season:"カスタム",subject:"",body:""}].map(o=>`
        <button
        ...
        >
          ...
          <strong>${x(o.subject||"空テンプレート")}</strong>
        </button>
      `).join(""),n=t.previewRecipients.length?t.previewRecipients.map(o=>`
            <li>
              <span>${x(o.name)}</span>
              <span class="table-sub">${x(o.email)} / ${x(o.area)}</span>
            </li>
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="field">
          <span>件名</span>
          <input id="email-subject" type="text" value="${x(t.subject)}" />
        </div>
        <div class="field">
          <span>本文</span>
          <textarea id="email-body" rows="12">${x(t.body)}</textarea>
        </div>
      ...
      <article class="panel">
        ...
        <div class="email-preview">
          <p class="panel-title">${x(t.subject||"件名未入力")}</p>
          <div class="preview-box">${t.body?Aa(t.body):"本文未入力"}</div>
        </div>
        ${t.saveMessage?`<p class="meta-note">${x(t.saveMessage)}</p>`:""}
        <div class="action-bar">
  ...
  `}function S(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function X(t,e){return e.length===0?"":`
  ...
  `}function La(t,e){const s=[X("得意先",e.customers.map(o=>`
          <button
          ...
          >
            ...
            <span class="table-sub mono">${S(o.code)}</span>
          </button>
        `)),X("商品",e.products.map(o=>`
          <button
            class="search-result-item"
            type="button"
            data-action="global-nav"
        ...
        `)),X("伝票",e.documents.map(o=>`
          <button
            ...
            data-path="/invoice"
          >
            <strong>${S(o.documentNo)}</strong>
            <span class="table-sub">${S(o.customerName)} / ${S(o.date)}</span>
          </button>
        `)),X("ページ",e.pages.map(o=>`
          <button
            class="search-result-item"
          ...
          >
            ...
            <span class="table-sub mono">${S(o.path)}</span>
          </button>
  ...
  `}function V(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ne(t){const e=t.resultsHtml.trim()?t.resultsHtml:`<p class="empty-note">${V(t.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function Z(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Jt(t){return t.trim().toLowerCase()}function ja(t,e){const s=Jt(e),n=t.filter(i=>s?[i.code,i.name,i.name].map(Jt).some(d=>d.includes(s)):!0).slice(0,50),o=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Ne({title:"得意先検索",searchQuery:e,placeholder:"コード・名前で検索",resultsHtml:o,emptyMessage:"該当する得意先が見つかりません。"})}function Pa(t){return t.toISOString().slice(0,10)}function P(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function A(t,e){return t[e]?`<div class="field-error">${P(t[e])}</div>`:""}function M(t,e,s=""){return[s,t[e]?"has-error":""].filter(Boolean).join(" ")}function Ea(t,e,s,n){const o=Object.keys(vt).map(c=>`<option value="${c}" ${t.invoiceType===c?"selected":""}>${vt[c]}</option>`).join(""),i=t.lines.map((c,r)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${M(n,`lines.${r}.productCode`,"input-cell")}" type="text" data-line="${r}" data-field="productCode" value="${P(c.productCode)}" placeholder="P00001" />
            <button class="picker-btn" type="button" data-action="open-product-picker" data-line="${r}" aria-label="商品検索">🔍</button>
          </div>
          ${A(n,`lines.${r}.productCode`)}
        </td>
        <td>
          <input class="${M(n,`lines.${r}.productName`,"input-cell")}" type="text" data-line="${r}" data-field="productName" value="${P(c.productName)}" placeholder="商品名" />
          ${A(n,`lines.${r}.productName`)}
        </td>
        <td>
          <input class="${M(n,`lines.${r}.quantity`,"input-cell numeric")}" type="number" data-line="${r}" data-field="quantity" value="${c.quantity}" min="0" />
          ${A(n,`lines.${r}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${r}" data-field="unit" value="${c.unit}" placeholder="本" /></td>
        <td>
          <input class="${M(n,`lines.${r}.unitPrice`,"input-cell numeric")}" type="number" data-line="${r}" data-field="unitPrice" value="${c.unitPrice}" min="0" />
          ${A(n,`lines.${r}.unitPrice`)}
        </td>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${M(n,"invoiceDate")}" id="inv-date" type="date" value="${t.invoiceDate||Pa(new Date)}" />
          ${A(n,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
          <div class="input-group">
            <input
              class="${M(n,"customerCode")}"
              id="inv-customer-code"
              data-autofill="customer"
              type="text"
              placeholder="C0011"
              value="${P(t.customerCode)}"
            />
        ...
        <label class="field">
          ...
          <input
            ...
            type="text"
            placeholder="青葉商事"
            value="${P(t.customerName)}"
          />
        </label>
        <label class="field">
          <span>担当者コード</span>
          <input id="inv-staff" type="text" placeholder="S001" value="${P(t.staffCode)}" />
        </label>
      </div>
      ${A(n,"lines")}
    </section>
    ...
    <section class="panel">
      <label class="field">
        <span>備考</span>
        <textarea id="inv-note" rows="2" placeholder="備考・特記事項">${P(t.note)}</textarea>
      </label>
    </section>
  ...
  `}function Ta(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function Ra(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function qa(t,e){const s=t.length?t.map(n=>`
            <tr>
              ...
              <td class="numeric">${Ra(n.amount)}</td>
            </tr>
  ...
  `}function Ma(t){return new Date(t.getFullYear(),t.getMonth(),1)}function Ia(t,e){return new Date(t.getFullYear(),t.getMonth()+e,1)}function Le(t,e){const s=new Date(t);return s.setDate(s.getDate()+e),s}function je(t){const e=new Date(t),s=e.getDay();return e.setDate(e.getDate()-s),e.setHours(0,0,0,0),e}function Vt(t){const e=Le(je(t),6);return e.setHours(23,59,59,999),e}function Bt(t){return new Date(`${t}T00:00:00`)}function Ut(t){return`${t.getMonth()+1}/${t.getDate()}`}function Oa(t){return t.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function Fa(){const t=new Date,e=je(Ia(Ma(t),-3)),s=Vt(new Date(t.getFullYear(),t.getMonth()+4,0)),n=[];let o=new Date(e);for(;o<=s;){const i=Vt(o);n.push({start:new Date(o),end:i,label:`${Ut(o)} - ${Ut(i)}`}),o=Le(o,7)}return n}function Ja(t){const e=Fa(),s=`160px repeat(${e.length}, minmax(56px, 1fr))`,n=e.map(i=>`
        <div class="gantt-week">
          <span>${i.label}</span>
        </div>
      `).join(""),o=t.length?t.map(i=>{const d=Bt(i.startDate),l=Bt(i.expectedDoneDate),c=Math.max(0,e.findIndex(p=>p.end>=d)),r=Math.max(c,e.reduce((p,h,v)=>h.start<=l?v:p,c)),u=[`仕込番号: ${i.jikomiNo}`,`銘柄: ${i.productName}`,`期間: ${i.startDate} - ${i.expectedDoneDate}`,`タンク: ${i.tankNo}`,`備考: ${i.note||"なし"}`].join(`
`);return`
  ...
  `}function Ht(t,e){const s={planned:"neutral",active:"warning",done:"success"},n=t.map(l=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${s[l.status]}">${ve[l.status]}</span>
        </td>
        <td>${l.note||"―"}</td>
      </tr>
  ...
  `}function Va(t){const e={pending:"未実施",submitted:"申請中",approved:"承認済"},s={pending:"neutral",submitted:"warning",approved:"success"},n=t.map(c=>`
      <tr>
  ...
  `}function Ba(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ua(t,e){return`
  ...
  `}function Ha(t){return t.map(e=>`
      ...
      `).join("")}function Ya(t){return t.map(e=>`
        <tr>
          <td class="mono">${e.code}</td>
      ...
      <div class="table-wrap">
        ...
        `:`
          <table>
            ...
            <tbody>${Ya(t.products)}</tbody>
          </table>
        `}
      </div>
    </section>
  `}function dt(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function za(t){const e=t.map(o=>{const d=(o.minimumStock>0?o.currentStock/o.minimumStock:1/0)<1.5;return`
        <tr>
          ...
          <td class="numeric">${dt(o.unitCost)}</td>
          <td class="numeric">${dt(o.currentStock*o.unitCost)}</td>
          <td>${o.lastUpdated}</td>
          <td>
            <button class="button-sm secondary" data-action="material-adjust" data-id="${o.id}">調整</button>
          </td>
        </tr>
      `}).join(""),s=t.filter(o=>o.minimumStock>0&&o.currentStock/o.minimumStock<1.5).length,n=t.reduce((o,i)=>o+i.currentStock*i.unitCost,0);return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>資材在庫管理</h1>
  ...
  `}function Wa(t){return t?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t)):"-"}function ut(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}const Qa={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Ga(t){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td>${Wa(s.lastPaymentDate)}</td>
          <td><span class="status-pill ${s.status==="paid"?"success":s.status==="partial"?"warning":"danger"}">${Qa[s.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function I(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Yt(t){return t.trim().toLowerCase()}function Xa(t,e){const s=Yt(e),n=t.filter(i=>s?[i.code,i.name,i.janCode].map(Yt).some(d=>d.includes(s)):!0),o=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              ${n.map(i=>`
                    <tr
                      ...
                      data-name="${I(i.name)}"
                    >
                      <td class="mono">${I(i.code)}</td>
                      <td>${I(i.name)}</td>
                      <td class="mono">${I(i.janCode)}</td>
                      <td>${I(i.category)}</td>
                    </tr>
                  `).join("")}
            </tbody>
      ...
      `:"";return Ne({title:"商品検索",searchQuery:e,placeholder:"コード・名前・JANで検索",resultsHtml:o,emptyMessage:"該当する商品が見つかりません。"})}function N(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Za(t,e){const s={pending:"未確定",confirmed:"確定",paid:"支払済"},n={pending:"warning",confirmed:"neutral",paid:"success"},o={unpaid:"未払い",partial:"一部支払",paid:"支払済"},i={unpaid:"warning",partial:"neutral",paid:"success"},d=t.map(p=>`
      <tr>
  ...
  `}function B(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function ts(t,e){const s={holding:"保有中",due:"期日到来",cleared:"決済済"},n={holding:"neutral",due:"warning",cleared:"success"},o=t.map(u=>`
      <tr>
  ...
  `}function es(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function $(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function bt(t){return`
  ...
  `}function ss(t,e,s){const n={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${es(t.lastSyncAt)}</p>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function ns(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function os(t){return t.replace("-","/")}function is(t){if(t.length===0)return'<div class="chart-empty">データなし</div>';const e=760,s=280,n={top:16,right:24,bottom:36,left:64},o=e-n.left-n.right,i=s-n.top-n.bottom,d=Math.max(...t.map(u=>u.amount),1),l=o/t.length,c=[0,.25,.5,.75,1].map(u=>{const p=n.top+i-i*u,h=`${Math.round(d*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${n.left}" y1="${p}" x2="${e-n.right}" y2="${p}" class="chart-grid" />
          <text x="8" y="${p+4}" class="chart-axis">${h}</text>
        </g>
      `}).join(""),r=t.map((u,p)=>{const h=u.amount/d*i,v=Math.max(l-18,24),E=n.left+p*l+(l-v)/2,F=n.top+i-h;return`
        <g>
          <rect x="${E}" y="${F}" width="${v}" height="${h}" rx="6" class="analytics-bar" />
          <text x="${E+v/2}" y="${s-10}" class="chart-axis centered-axis">${os(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function ls(t){return t.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':t.map(e=>`
        <tr>
          <td class="mono">${e.code}</td>
          <td>${e.name}</td>
          <td class="numeric">${ns(e.amount)}</td>
          <td class="numeric">${e.quantity.toLocaleString("ja-JP")}</td>
          <td class="numeric">${e.documents.toLocaleString("ja-JP")}</td>
        </tr>
      `).join("")}function cs(t,e){const s=e==="products"?"商品別集計":"得意先別集計",n=e==="products"?t.productTotals:t.customerTotals;return`
    <section class="page-head">
      <div>
  ...
  `}function U(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function rs(t){const e=Math.max(...t.salesByProduct.flatMap(i=>i.values),1),s=t.salesByProduct.map(i=>{const d=i.values.map((l,c)=>`
          <div class="bar-col">
            <div class="bar" style="height:${Math.round(l/e*120)}px" title="${t.months[c]}: ${U(l)}"></div>
  ...
  `}function ds(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function us(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Kt(t){return t.toISOString().slice(0,10)}function ps(t,e,s){const n=t.length?t.map(o=>`
            <tr>
              ...
              <td class="numeric">${us(o.amount)}</td>
            </tr>
    ...
    <section class="panel filter-panel">
      <div class="filter-grid">
        ...
        <label class="field">
          <span>終了日</span>
          <input id="sales-end" type="date" value="${s||Kt(new Date)}" />
        </label>
        <div class="filter-actions">
  ...
  `}function at(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function ms(t,e,s,n){const o={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},i={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},d={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},l=t.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
  ...
  `}const pt={customers:"得意先マスタ",products:"商品マスタ",suppliers:"仕入先マスタ",staff:"担当者マスタ"},hs={customers:{required:["legacy_customer_code","name"],optional:["kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"]},products:{required:["legacy_product_code","name"],optional:["kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"]},suppliers:{required:["legacy_supplier_code","name"],optional:["kana_name","phone","postal_code","address1","closing_day","payment_day","email"]},staff:{required:["legacy_staff_code","name"],optional:["kana_name","department"]}};function vs(t,e,s,n){const o=hs[t],i=Object.keys(pt).map(l=>`
  ...
  `}const zt={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},ys={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1},bs={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function y(t){return"¥"+t.toLocaleString("ja-JP")}function Y(t){const e=new Date(t);return`${e.getFullYear()}年${e.getMonth()+1}月${e.getDate()}日`}function Nt(t,e){const s=t.reduce((i,d)=>i+d.amount,0),n=Math.floor(s*e),o=s+n;return{subtotal:s,taxAmount:n,total:o}}function gs(t,e,s){const{subtotal:n,taxAmount:o,total:i}=Nt(t.lines,t.taxRate),d=t.lines.map((c,r)=>`
      <tr>
        <td class="cs-num">${r+1}</td>
        <td class="cs-code mono">${c.productCode}</td>
        ${s.showJanCode?`<td class="mono">${c.janCode??""}</td>`:""}
        <td class="cs-name">${c.productName}${c.spec?` ${c.spec}`:""}</td>
        <td class="cs-qty numeric">${c.quantity.toLocaleString("ja-JP")}</td>
        ${s.showUnit?`<td class="cs-unit">${c.unit}</td>`:""}
        <td class="cs-price numeric">${y(c.unitPrice)}</td>
        <td class="cs-amount numeric">${y(c.amount)}</td>
      </tr>
    `).join(""),l=Array.from({length:Math.max(0,8-t.lines.length)}).map(()=>`
      <tr class="cs-filler">
        <td></td><td></td>
        ${s.showJanCode?"<td></td>":""}
        <td></td><td></td>
    ...
    <div class="print-page chain-store ${s.fontSize}">
      <div class="cs-header">
        <div class="cs-title">
          <h1>チェーンストア伝票</h1>
          <p class="cs-sub">伝票番号: <span class="mono">${t.documentNo}</span></p>
        </div>
        <div class="cs-date">
          <div><label>納品日</label><span>${Y(t.documentDate)}</span></div>
        </div>
      </div>
      ...
      <div class="cs-parties">
        <div class="cs-to">
          ...
          ${t.customerPostalCode?`<p class="cs-postal">〒${t.customerPostalCode}</p>`:""}
          ${t.customerAddress?`<p>${t.customerAddress}</p>`:""}
          <p class="cs-to-name">${t.customerName} ${t.customerHonorific}</p>
          ${t.customerCode?`<p class="cs-code-line mono">取引先CD: ${t.customerCode}</p>`:""}
        </div>
        <div class="cs-from">
          <p class="cs-from-name">${e.name}</p>
          <p>〒${e.postalCode}</p>
          <p>${e.address1}${e.address2?` ${e.address2}`:""}</p>
          <p>TEL: ${e.tel}　FAX: ${e.fax}</p>
          ${s.showRegistrationNo?`<p class="mono">登録番号: ${e.registrationNo}</p>`:""}
          ${s.showSeal&&e.sealImageUrl?`<img class="cs-seal" src="${e.sealImageUrl}" alt="印" />`:s.showSeal?'<div class="cs-seal-placeholder">印</div>':""}
        </div>
      </div>
      ...
      <table class="cs-table">
        <thead>
          <tr>
            ...
            ${s.showUnit?"<th class='cs-unit'>単位</th>":""}
      ...
      <div class="cs-totals">
        <div class="cs-total-row"><span>小計</span><span class="numeric">${y(n)}</span></div>
        <div class="cs-total-row"><span>消費税（${Math.round(t.taxRate*100)}%）</span><span class="numeric">${y(o)}</span></div>
        <div class="cs-total-row cs-total-main"><span>合計</span><span class="numeric">${y(i)}</span></div>
      </div>

      ${s.showRemarks&&t.remarks?`<div class="cs-remarks"><p class="cs-label">備考</p><p>${t.remarks}</p></div>`:""}
  ...
  `}function $s(t,e,s){const{subtotal:n,taxAmount:o,total:i}=Nt(t.lines,t.taxRate),d=t.previousBalance??0,l=t.paymentAmount??0,c=d-l+i,r=t.lines.map(p=>`
      <tr>
        <td>${p.note??""}</td>
        <td class="inv-name">${p.productName}${p.spec?` <span class="inv-spec">${p.spec}</span>`:""}</td>
        <td class="inv-qty numeric">${p.quantity.toLocaleString("ja-JP")}</td>
        ${s.showUnit?`<td class="inv-unit">${p.unit}</td>`:""}
        <td class="inv-price numeric">${y(p.unitPrice)}</td>
        <td class="inv-amount numeric">${y(p.amount)}</td>
      </tr>
    `).join(""),u=Array.from({length:Math.max(0,8-t.lines.length)}).map(()=>`
      <tr class="inv-filler">
        <td></td><td></td><td></td>
        ${s.showUnit?"<td></td>":""}
        <td></td><td></td>
    ...
    `).join("");return`
    <div class="print-page invoice-doc ${s.fontSize}">
      <div class="inv-masthead">
        <h1>請　求　書</h1>
        <p class="inv-sub mono">No. ${t.documentNo}</p>
      </div>

      <div class="inv-header">
        <div class="inv-to">
          ${t.customerPostalCode?`<p>〒${t.customerPostalCode}</p>`:""}
          ${t.customerAddress?`<p>${t.customerAddress}</p>`:""}
          <h2 class="inv-to-name">${t.customerName} ${t.customerHonorific}</h2>
        </div>
        <div class="inv-meta">
          <table class="inv-meta-table">
            <tr><th>請求日</th><td>${Y(t.documentDate)}</td></tr>
            ${t.dueDate?`<tr><th>お支払期限</th><td>${Y(t.dueDate)}</td></tr>`:""}
          </table>
        </div>
      </div>
      ...
      <div class="inv-amount-box">
        ...
        <div class="inv-amount-value">${y(c)}（税込）</div>
      </div>
      ...
      <table class="inv-table">
        <thead>
          <tr>
            ...
            ${s.showUnit?"<th class='inv-unit'>単位</th>":""}
      ...
      <div class="inv-summary">
        <table class="inv-summary-table">
          ${d?`<tr><th>前回御請求額</th><td class="numeric">${y(d)}</td></tr>`:""}
          ${l?`<tr><th>ご入金額</th><td class="numeric">▲ ${y(l)}</td></tr>`:""}
          <tr><th>今回ご請求額 (小計)</th><td class="numeric">${y(n)}</td></tr>
          <tr><th>消費税 (${Math.round(t.taxRate*100)}%)</th><td class="numeric">${y(o)}</td></tr>
          <tr class="inv-grand"><th>合計請求額</th><td class="numeric">${y(c)}</td></tr>
        </table>
      </div>
      ...
      <div class="inv-bank">
        <h3>お振込先</h3>
        <p>${e.bankName} ${e.bankBranch}　${e.bankAccountType} ${e.bankAccountNo}</p>
        <p>口座名義: ${e.bankAccountHolder}</p>
        <p class="inv-note">※ お振込手数料はお客様ご負担でお願いいたします。</p>
      </div>
      `:""}

      ${s.showRemarks&&t.remarks?`<div class="inv-remarks"><h3>備考</h3><p>${t.remarks}</p></div>`:""}

      <div class="inv-footer">
        <div class="inv-from">
          <p class="inv-from-name">${e.name}</p>
          <p>〒${e.postalCode}</p>
          <p>${e.address1}${e.address2?` ${e.address2}`:""}</p>
          <p>TEL: ${e.tel}　FAX: ${e.fax}</p>
          ${s.showRegistrationNo?`<p class="mono">登録番号: ${e.registrationNo}</p>`:""}
        </div>
        ${s.showSeal?e.sealImageUrl?`<img class="inv-seal" src="${e.sealImageUrl}" alt="印" />`:'<div class="inv-seal-placeholder">印</div>':""}
      </div>
    </div>
  `}function fs(t,e,s){const{subtotal:n,taxAmount:o,total:i}=Nt(t.lines,t.taxRate),d=t.lines.map((c,r)=>`
      <tr>
        <td class="q-num">${r+1}</td>
        <td class="q-name">${c.productName}${c.spec?` <span class="q-spec">${c.spec}</span>`:""}</td>
        <td class="q-qty numeric">${c.quantity.toLocaleString("ja-JP")}</td>
        ${s.showUnit?`<td class="q-unit">${c.unit}</td>`:""}
        <td class="q-price numeric">${y(c.unitPrice)}</td>
        <td class="q-amount numeric">${y(c.amount)}</td>
      </tr>
    `).join(""),l=Array.from({length:Math.max(0,6-t.lines.length)}).map(()=>`
      <tr class="q-filler">
        <td></td><td></td><td></td>
        ${s.showUnit?"<td></td>":""}
        <td></td><td></td>
    ...
    `).join("");return`
    <div class="print-page quotation ${s.fontSize}">
      ...
      <div class="q-header">
        <div class="q-to">
          ${t.customerPostalCode?`<p class="q-postal">〒${t.customerPostalCode}</p>`:""}
          ${t.customerAddress?`<p>${t.customerAddress}</p>`:""}
          <p class="q-to-name">${t.customerName} ${t.customerHonorific}</p>
          ${t.title?`<p class="q-title">件名: ${t.title}</p>`:""}
        </div>
        <div class="q-meta">
          <table class="q-meta-table">
            <tr><th>見積番号</th><td class="mono">${t.documentNo}</td></tr>
            <tr><th>見積日</th><td>${Y(t.documentDate)}</td></tr>
            ${t.expireDate?`<tr><th>有効期限</th><td>${Y(t.expireDate)}</td></tr>`:""}
          </table>
        </div>
      </div>
      ...
      <div class="q-total-box">
        ...
        <div class="q-total-value">${y(i)}（税込）</div>
      </div>
      ...
      <table class="q-table">
        <thead>
          <tr>
            ...
            ${s.showUnit?"<th class='q-unit'>単位</th>":""}
        ...
        <tfoot>
          <tr>
            <td colspan="${s.showUnit?4:3}"></td>
            <th class="q-right">小計</th>
            <td class="numeric">${y(n)}</td>
          </tr>
          <tr>
            <td colspan="${s.showUnit?4:3}"></td>
            <th class="q-right">消費税 (${Math.round(t.taxRate*100)}%)</th>
            <td class="numeric">${y(o)}</td>
          </tr>
          <tr class="q-grand">
            <td colspan="${s.showUnit?4:3}"></td>
            <th class="q-right">合計</th>
            <td class="numeric">${y(i)}</td>
          </tr>
        </tfoot>
      </table>

      ${s.showRemarks&&t.remarks?`<div class="q-remarks"><p class="q-label">備考</p><p>${t.remarks}</p></div>`:""}

      <div class="q-footer">
        <div class="q-from">
          <p class="q-from-name">${e.name}</p>
          <p>〒${e.postalCode}</p>
          <p>${e.address1}${e.address2?` ${e.address2}`:""}</p>
          <p>TEL: ${e.tel}　FAX: ${e.fax}</p>
          ${s.showRegistrationNo?`<p class="mono">登録番号: ${e.registrationNo}</p>`:""}
        </div>
        ${s.showSeal?e.sealImageUrl?`<img class="q-seal" src="${e.sealImageUrl}" alt="印" />`:'<div class="q-seal-placeholder">印</div>':""}
      </div>
    </div>
  `}function ks(t,e,s,n){const o=Object.keys(zt).map(l=>`
      <button class="tab-button ${t===l?"active":""}" data-print-template="${l}">
        ${zt[l]}
      </button>
    `).join("");let i="";switch(t){case"chain_store":i=gs(n,s,e);break;case"quotation":i=fs(n,s,e);break;case"invoice_monthly":i=$s(n,s,e);break}const d=n.lines.map((l,c)=>`
      <tr>
  ...
  `}const Ss={customers:["legacy_customer_code","name"],products:["legacy_product_code","name"],suppliers:["legacy_supplier_code","name"],staff:["legacy_staff_code","name"]},ws={customers:["legacy_customer_code","name","kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"],products:["legacy_product_code","name","kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"],suppliers:["legacy_supplier_code","name","kana_name","phone","postal_code","address1","closing_day","payment_day","email"],staff:["legacy_staff_code","name","kana_name","department"]};function Cs(t){t.charCodeAt(0)===65279&&(t=t.slice(1));const e=[];let s=[],n="",o=!1;for(let l=0;l<t.length;l++){const c=t[l];o?c==='"'?t[l+1]==='"'?(n+='"',l++):o=!1:n+=c:c==='"'?o=!0:c===","?(s.push(n),n=""):c===`
`||c==="\r"?(c==="\r"&&t[l+1]===`
`&&l++,s.push(n),s.some(r=>r!=="")&&e.push(s),s=[],n=""):n+=c}if((n!==""||s.length>0)&&(s.push(n),s.some(l=>l!=="")&&e.push(s)),e.length===0)return{columns:[],rows:[]};const i=e[0].map(l=>l.trim()),d=[];for(let l=1;l<e.length;l++){const c={};i.forEach((r,u)=>{c[r]=(e[l][u]??"").trim()}),d.push(c)}return{columns:i,rows:d}}function xs(t,e,s){const n=Ss[t],o=n.filter(l=>!e.includes(l)),i=s.map(l=>{const c=[];o.length>0&&c.push(`必須列欠損: ${o.join(",")}`);for(const r of n)e.includes(r)&&!l[r]&&c.push(`${r}が空`);return{...l,_valid:c.length===0,_error:c[0]}}),d=i.filter(l=>l._valid).length;return{entity:t,columns:e,rows:i,totalRows:s.length,validRows:d,invalidRows:i.length-d}}function Ds(t){const s=ws[t],o={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[t];return"\uFEFF"+s.join(",")+`
`+o.join(",")+`
`}async function _s(t,e){const{supabaseInsert:s}=await D(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>ee);return{supabaseInsert:l}},void 0);let n=0,o=0;const d={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[t];for(const l of e){if(!l._valid)continue;const{_valid:c,_error:r,...u}=l,p={...u};if(!p.id){const h=t==="customers"?"legacy_customer_code":t==="products"?"legacy_product_code":t==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[h]??`${t}-${Date.now()}-${n+o}`)}for(const h of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[h]=="string"&&p[h]!==""){const v=Number(p[h]);Number.isFinite(v)&&(p[h]=v)}try{await s(d,p)!==null?n++:o++}catch{o++}}return{inserted:n,failed:o}}function As(t){const e={empty:"空",in_use:"使用中",aging:"熟成中"},s={empty:"neutral",in_use:"warning",aging:"success"},n=t.map(r=>{const u=r.capacity>0?Math.round(r.currentVolume/r.capacity*100):0;return`
        <tr>
  ...
  `}function mt(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Ns(t,e,s){const n=t.rows.map((r,u)=>`
      <tr>
    ...
    <section class="panel filter-panel">
      <div class="filter-grid">
        ...
        <label class="field">
          <span>対象月</span>
          <select id="tax-month">
            ${i.map(r=>`<option value="${r}" ${s===r?"selected":""}>${r}月</option>`).join("")}
          </select>
        </label>
        <div class="filter-actions">
  ...
  `}function Wt(t){const s=(t==null?"":t instanceof Date?t.toISOString():String(t)).replaceAll('"','""');return/[",\n\r]/.test(s)?`"${s}"`:s}function Ls(t,e,s){if(e.length===0&&(!s||s.length===0))return;const n=s&&s.length>0?s:Object.keys(e[0]??{}).map(r=>({key:r,label:r})),i=`\uFEFF${[n.map(r=>Wt(r.label)).join(","),...e.map(r=>n.map(u=>Wt(r[u.key])).join(","))].join(`\r
`)}`,d=new Blob([i],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(d),c=document.createElement("a");c.href=l,c.download=t,document.body.append(c),c.click(),c.remove(),window.setTimeout(()=>URL.revokeObjectURL(l),0)}const js=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print"],st=[{name:"青葉商事",email:"aoba@example.jp",area:"関東",historySegment:"seasonal"},{name:"北斗酒販",email:"hokuto@example.jp",area:"北海道",historySegment:"premium"},{name:"中央フーズ",email:"chuo@example.jp",area:"関東",historySegment:"seasonal"},{name:"東海酒店",email:"tokai@example.jp",area:"中部",historySegment:"premium"},{name:"三和物産",email:"sanwa@example.jp",area:"関西",historySegment:"liqueur"},{name:"南星リカー",email:"nansei@example.jp",area:"九州",historySegment:"seasonal"},{name:"山川酒店",email:"yamakawa@example.jp",area:"関西",historySegment:"premium"},{name:"瑞穂商店",email:"mizuho@example.jp",area:"中部",historySegment:"seasonal"}],Qt=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"}];function Pe(t){const e=St[t];return e?{subject:e.subject,body:e.body}:{subject:"",body:""}}function Lt(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function Ps(){const t=Pe("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:t.subject,body:t.body,saveMessage:null}}const rt=new Date,Es=rt.toISOString().slice(0,7),Ts=rt.getFullYear(),Rs=rt.getMonth()+1,qs=rt.toISOString().slice(0,10),Ms="C0011",L=Ps();function Ee(t){const e="/sake-system/".endsWith("/")?"/sake-system/".slice(0,-1):"/sake-system/",s=t.startsWith(e)?t.slice(e.length)||"/":t;return js.includes(s)?s:"/"}function jt(t){switch(t){case"/cat/sales":case"/invoice":case"/ledger":case"/invoice-entry":case"/delivery":case"/billing":case"/report":return"sales";case"/cat/brewery":case"/jikomi":case"/tanks":case"/kentei":case"/materials":return"brewery";case"/cat/purchase":case"/purchase":case"/raw-material":return"purchase";case"/cat/more":case"/master":case"/analytics":case"/tax":case"/store":case"/setup":return"more";case"/email":return"email";default:return"dashboard"}}const Gt=Ee(location.pathname),a={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,invoiceRecords:[],customerLedger:null,salesAnalytics:null,invoiceForm:Lt(),invoiceSaving:!1,invoiceSavedDocNo:null,pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:Es,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:Ts,taxMonth:Rs,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,printTemplate:"chain_store",printOptions:{...ys},printCompany:{...bs},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸",spec:"720ml",quantity:12,unit:"本",unitPrice:1800,amount:21600,janCode:"4901234567891"},{productCode:"P00008",productName:"本醸造",spec:"1.8L",quantity:6,unit:"本",unitPrice:2400,amount:14400,janCode:"4901234567908"}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:qs,route:Gt,currentCategory:jt(Gt),sidebarOpen:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:Ms,masterTab:"customers",analyticsTab:"products",emailAudienceMode:L.mode,emailRegion:L.region,emailHistorySegment:L.historySegment,emailTemplateId:L.templateId,emailSubject:L.subject,emailBody:L.body,emailSaveMessage:L.saveMessage,emailSending:!1,globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function Xt(t){return t.slice(0,10)}function Is(t){return{...t}}function ct(){a.pickerMode=null,a.pickerQuery="",a.pickerTargetLine=null}function Te(){a.invoiceForm=Lt(),a.invoiceSavedDocNo=null,a.invoiceErrors={},ct()}function Re(t){const e={};return t.invoiceDate.trim()||(e.invoiceDate="伝票日付は必須です。"),t.customerCode.trim()||(e.customerCode="得意先コードは必須です。"),t.lines.length===0&&(e.lines="明細を1行以上入力してください。"),t.lines.forEach((s,n)=>{s.productCode.trim()||(e[`lines.${n}.productCode`]="商品コードは必須です。"),s.productName.trim()||(e[`lines.${n}.productName`]="商品名は必須です。"),s.quantity<=0&&(e[`lines.${n}.quantity`]="数量は1以上を入力してください。"),s.unitPrice<0&&(e[`lines.${n}.unitPrice`]="単価は0円以上で入力してください。")}),e}function Os(t){const e=a.invoiceForm.lines[t];e&&a.invoiceForm.lines.splice(t+1,0,Is(e))}function Fs(){const t=a.invoiceRecords[0],e=a.masterStats?.customers[0],s=a.masterStats?.products.slice(0,2)??[];a.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:t?.customerCode??e?.code??"",customerName:t?.customerName??e?.name??"",staffCode:a.invoiceForm.staffCode||"S001",lines:s.map((n,o)=>{const i=o===0?1:2,d=1200*(o+1);return{productCode:n.code,productName:n.name,quantity:i,unitPrice:d,unit:"本",amount:i*d}}),note:t?`過去伝票 ${t.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},a.invoiceSavedDocNo=null,a.invoiceErrors={}}function Js(t){const e=a.masterStats?.customers.find(s=>s.code.toLowerCase()===t.trim().toLowerCase());return e?(a.invoiceForm.customerCode=e.code,a.invoiceForm.customerName=e.name,!0):!1}function Vs(t){const e=a.masterStats?.customers.find(s=>s.name===t.trim());return e?(a.invoiceForm.customerCode=e.code,a.invoiceForm.customerName=e.name,!0):!1}function qe(t){if(C(t),a.invoiceErrors=Re(a.invoiceForm),Object.keys(a.invoiceErrors).length>0){m();return}a.invoiceSaving=!0,m(),me(a.invoiceForm).then(e=>{a.invoiceSavedDocNo=e.documentNo,a.invoiceSaving=!1,a.invoiceErrors={},a.invoiceForm=Lt(),m()}).catch(()=>{a.invoiceSaving=!1,m()})}function Me(t){const e=a.salesFilter.startDate?new Date(a.salesFilter.startDate):null,s=a.salesFilter.endDate?new Date(`${a.salesFilter.endDate}T23:59:59`):null;return[...t.salesRecords].sort((n,o)=>new Date(o.date).getTime()-new Date(n.date).getTime()).filter(n=>{const o=new Date(n.date);return!(e&&o<e||s&&o>s)})}function Ie(){switch(a.emailAudienceMode){case"area":return a.emailRegion==="all"?st:st.filter(t=>t.area===a.emailRegion);case"history":return st.filter(t=>t.historySegment===a.emailHistorySegment);default:return st}}function Bs(){const t=Ie();return{audienceMode:a.emailAudienceMode,region:a.emailRegion,historySegment:a.emailHistorySegment,selectedTemplateId:a.emailTemplateId,subject:a.emailSubject,body:a.emailBody,recipientCount:t.length,previewRecipients:t.slice(0,5),saveMessage:a.emailSaveMessage,sending:a.emailSending}}function ht(t){const e=Ie(),s=a.emailAudienceMode==="area"?a.emailRegion:a.emailAudienceMode==="history"?a.emailHistorySegment:"all";return{subject:a.emailSubject.trim(),body:a.emailBody.trim(),templateId:a.emailTemplateId,audienceMode:a.emailAudienceMode,audienceFilter:s,recipientCount:e.length,recipients:e.map(n=>n.email),status:t}}function Pt(){return a.user,!1}function K(){a.globalSearchOpen=!1,a.globalQuery=""}function Us(){const t=a.globalQuery.trim().toLowerCase();return t?{customers:a.masterStats?.customers.filter(e=>e.code.toLowerCase().includes(t)||e.name.toLowerCase().includes(t))??[],products:a.masterStats?.products.filter(e=>e.code.toLowerCase().includes(t)||e.name.toLowerCase().includes(t))??[],documents:a.invoiceRecords.filter(e=>e.documentNo.toLowerCase().includes(t)||e.customerName.toLowerCase().includes(t)||e.date.toLowerCase().includes(t)),pages:Qt.filter(e=>e.path.toLowerCase().includes(t)||e.title.toLowerCase().includes(t))}:{customers:[],products:[],documents:[],pages:Qt}}function Hs(){let t=[],e,s="export.csv";switch(a.route){case"/sales":t=(a.salesSummary?Me(a.salesSummary):[]).map(n=>({documentNo:n.documentNo,date:n.date,customerCode:n.customerCode,customerName:n.customerName,amount:n.amount})),e=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],s="sales.csv";break;case"/payment":t=[...a.paymentStatus?.records??[]].sort((n,o)=>o.balanceAmount-n.balanceAmount).map(n=>({...n})),e=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],s="payment-status.csv";break;case"/invoice":t=a.invoiceRecords.map(n=>({...n})),e=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],s="invoices.csv";break;case"/purchase":t=a.purchaseList.map(n=>({...n})),e=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],s="purchase.csv";break;case"/jikomi":t=a.jikomiList.map(n=>({...n})),e=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],s="jikomi.csv";break;case"/tanks":t=a.tankList.map(n=>({...n})),e=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],s="tanks.csv";break;case"/kentei":t=a.kenteiList.map(n=>({...n})),e=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],s="kentei.csv";break;case"/materials":t=a.materialList.map(n=>({...n})),e=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],s="materials.csv";break;case"/master":a.masterTab==="customers"?(t=a.masterStats?.customers.map(n=>({...n}))??[],e=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],s="master-customers.csv"):(t=a.masterStats?.products.map(n=>({...n}))??[],e=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],s="master-products.csv");break;default:return}Ls(s,t,e)}function Zt(t){const e=`${"/sake-system/".replace(/\/$/,"")}${t==="/"?"/":t}`;history.pushState(null,"",e),a.route=t,a.currentCategory=jt(t),a.sidebarOpen=!1,K(),Et(t)}async function Et(t){a.actionLoading=!0,m();try{switch(t){case"/delivery":a.deliveryNote||(a.deliveryNote=await xt(a.deliverySearchDocNo||"D240122"));break;case"/billing":a.billingSummary||(a.billingSummary=await Dt(a.billingYearMonth));break;case"/report":a.salesReport||(a.salesReport=await he());break;case"/jikomi":a.jikomiList.length===0&&(a.jikomiList=await ye());break;case"/tanks":a.tankList.length===0&&(a.tankList=await be());break;case"/kentei":a.kenteiList.length===0&&(a.kenteiList=await ge());break;case"/materials":a.materialList.length===0&&(a.materialList=await $e());break;case"/purchase":(a.purchaseList.length===0||a.payableList.length===0)&&([a.purchaseList,a.payableList]=await Promise.all([fe(),ke()]));break;case"/raw-material":(a.billList.length===0||a.rawStockList.length===0)&&([a.billList,a.rawStockList]=await Promise.all([Se(),we()]));break;case"/tax":a.taxDeclaration||(a.taxDeclaration=await _t(a.taxYear,a.taxMonth));break;case"/store":(a.storeSales.length===0||a.storeOrders.length===0)&&([a.storeSales,a.storeOrders]=await Promise.all([At(a.storeSalesDate),De()]));break;default:break}}catch(e){console.warn("Route data load error",e)}finally{a.actionLoading=!1,m()}}function te(){if(Pt())return Ua(a.authError,a.authSubmitting);if(a.loading)return'<section class="panel"><p>データを読み込んでいます。</p></section>';if(a.error)return`
      <section class="panel error-card">
        <p class="eyebrow">読込失敗</p>
        <h1>画面の初期化に失敗しました</h1>
        <p>${a.error}</p>
      </section>
    `;switch(a.route){case"/cat/sales":return W("sales");case"/cat/brewery":return W("brewery");case"/cat/purchase":return W("purchase");case"/cat/more":return W("more");case"/invoice-entry":return Ea(a.invoiceForm,a.invoiceSavedDocNo,a.invoiceSaving,a.invoiceErrors);case"/email":return Na(Bs());case"/delivery":return a.deliveryNote?_a(a.deliveryNote,a.deliverySearchDocNo):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/billing":return a.billingSummary?ba(a.billingSummary,a.billingYearMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/report":return a.salesReport?rs(a.salesReport):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/jikomi":return a.jikomiView==="calendar"?`${Ht(a.jikomiList,a.jikomiView)}${Ja(a.jikomiList)}`:Ht(a.jikomiList,a.jikomiView);case"/tanks":return As(a.tankList);case"/kentei":return Va(a.kenteiList);case"/materials":return za(a.materialList);case"/purchase":return Za(a.purchaseList,a.payableList);case"/raw-material":return ts(a.billList,a.rawStockList);case"/tax":return a.taxDeclaration?Ns(a.taxDeclaration,a.taxYear,a.taxMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/store":return ms(a.storeSales,a.storeOrders,a.storeTab,a.storeSalesDate);case"/setup":return a.pipelineMeta?ss(a.pipelineMeta,z,gt):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/import":return vs(a.importEntity,a.importPreview,a.importing,a.importResult);case"/print":return ks(a.printTemplate,a.printOptions,a.printCompany,a.printData)}if(!a.salesSummary||!a.paymentStatus||!a.masterStats||!a.pipelineMeta||!a.customerLedger||!a.salesAnalytics)return"";switch(a.route){case"/sales":return ps(Me(a.salesSummary),a.salesFilter.startDate,a.salesFilter.endDate);case"/payment":return Ga([...a.paymentStatus.records].sort((t,e)=>e.balanceAmount-t.balanceAmount));case"/master":return Ka(a.masterStats,a.masterTab);case"/invoice":return qa(a.invoiceRecords,a.invoiceFilter);case"/ledger":return Sa(a.customerLedger,a.ledgerCustomerCode);case"/analytics":return cs(a.salesAnalytics,a.analyticsTab);default:return xa(a.salesSummary,a.pipelineMeta,a.salesAnalytics)}}function Ys(){if(Pt())return`
      <div class="shell auth-shell">
        <main class="main auth-main">
          <div class="view">${te()}</div>
        </main>
      </div>
    `;const t={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売管理",items:[{path:"/cat/sales",label:"販売管理トップ",kicker:"Category"},{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/report",label:"集計帳票",kicker:"Report"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],brewery:[{label:"蔵内管理",items:[{path:"/cat/brewery",label:"蔵内管理トップ",kicker:"Category"},{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"}]}],purchase:[{label:"仕入管理",items:[{path:"/cat/purchase",label:"仕入管理トップ",kicker:"Category"},{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],more:[{label:"その他",items:[{path:"/cat/more",label:"その他トップ",kicker:"Category"},{path:"/tax",label:"酒税申告",kicker:"Tax"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/master",label:"マスタ",kicker:"Master"},{path:"/email",label:"メール配信",kicker:"Mail"},{path:"/setup",label:"連動設定",kicker:"Setup"}]}],email:[{label:"メール配信",items:[{path:"/email",label:"季節商品案内",kicker:"Mail"}]}]},e=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/cat/sales",label:"販売管理"},{category:"brewery",path:"/cat/brewery",label:"蔵内管理"},{category:"purchase",path:"/cat/purchase",label:"仕入管理"},{category:"more",path:"/cat/more",label:"その他"},{category:"email",path:"/email",label:"メール配信"}],s=t[a.currentCategory].map(l=>`
        <div class="nav-group">
      ...
      `).join(""),o=a.pickerMode&&a.masterStats?a.pickerMode==="customer"?ja(a.masterStats.customers,a.pickerQuery):Xa(a.masterStats.products,a.pickerQuery):"",i=a.globalSearchOpen?La(a.globalQuery,Us()):"",d=a.user?`
    ...
    <div class="shell">
      ...
      <main class="main">
        ...
        <div class="view ${a.actionLoading?"is-busy":""}">${te()}</div>
      </main>
      ${o}
      ${i}
    </div>
  `}async function Ks(t){a.actionLoading=!0,m();try{a.invoiceRecords=await lt(t)}finally{a.actionLoading=!1,m()}}async function zs(t){a.actionLoading=!0,m();try{a.customerLedger=await Ct(t)}finally{a.actionLoading=!1,m()}}function C(t){a.invoiceForm={invoiceType:t.querySelector("#inv-type")?.value??a.invoiceForm.invoiceType,invoiceDate:t.querySelector("#inv-date")?.value??a.invoiceForm.invoiceDate,customerCode:t.querySelector("#inv-customer-code")?.value??a.invoiceForm.customerCode,customerName:t.querySelector("#inv-customer-name")?.value??a.invoiceForm.customerName,staffCode:t.querySelector("#inv-staff")?.value??a.invoiceForm.staffCode,lines:a.invoiceForm.lines.map((e,s)=>{const n=parseFloat(t.querySelector(`[data-line="${s}"][data-field="quantity"]`)?.value??"")||0,o=parseFloat(t.querySelector(`[data-line="${s}"][data-field="unitPrice"]`)?.value??"")||0;return{...e,productCode:t.querySelector(`[data-line="${s}"][data-field="productCode"]`)?.value??e.productCode,productName:t.querySelector(`[data-line="${s}"][data-field="productName"]`)?.value??e.productName,unit:t.querySelector(`[data-line="${s}"][data-field="unit"]`)?.value??e.unit,quantity:n,unitPrice:o,amount:n*o}}),note:t.querySelector("#inv-note")?.value??a.invoiceForm.note},a.invoiceForm.customerCode=a.invoiceForm.customerCode.trim().toUpperCase(),a.invoiceForm.customerName=a.invoiceForm.customerName.trim()}function j(t){const e=t.querySelector("input[name='email-audience-mode']:checked")?.value??a.emailAudienceMode;a.emailAudienceMode=e,a.emailRegion=t.querySelector("#email-region")?.value??a.emailRegion,a.emailHistorySegment=t.querySelector("#email-history-segment")?.value??a.emailHistorySegment,a.emailSubject=t.querySelector("#email-subject")?.value??a.emailSubject,a.emailBody=t.querySelector("#email-body")?.value??a.emailBody}function Ws(t){t.querySelector("[data-action='global-search-open']")?.addEventListener("click",()=>{a.globalSearchOpen=!0,m()}),t.querySelectorAll("[data-action='global-search-close']").forEach(e=>{e.addEventListener("click",s=>{e.classList.contains("global-search")&&s.target instanceof HTMLElement&&!s.target.classList.contains("global-search")||(K(),m())})}),t.querySelector("#global-search-input")?.addEventListener("input",e=>{a.globalQuery=e.target.value,m()}),t.querySelectorAll("[data-action='global-nav']").forEach(e=>{e.addEventListener("click",()=>{const s=e.dataset.path;s&&(K(),Zt(s))})}),t.querySelector("[data-action='csv-export']")?.addEventListener("click",()=>{Hs()}),t.querySelectorAll("[data-jikomi-tab]").forEach(e=>{e.addEventListener("click",()=>{a.jikomiView=e.dataset.jikomiTab,m()})}),t.querySelector("[data-action='auth-login']")?.addEventListener("click",()=>{const e=t.querySelector("#auth-email")?.value.trim()??"",s=t.querySelector("#auth-password")?.value??"";a.authSubmitting=!0,a.authError=null,m(),Ve(e,s).then(n=>{a.user=n,a.authSkipped=!1,a.authSubmitting=!1,a.authError=null,m()}).catch(async n=>{try{const o=await Be(e,s);a.user=o,a.authSkipped=!1,a.authError=null}catch{a.authError=n instanceof Error?n.message:"ログインに失敗しました。"}finally{a.authSubmitting=!1,m()}})}),t.querySelector("[data-action='auth-skip']")?.addEventListener("click",()=>{a.authSkipped=!0,a.authError=null,m()}),t.querySelector("[data-action='auth-logout']")?.addEventListener("click",()=>{Ue().finally(()=>{location.reload()})}),t.querySelector("[data-action='sidebar-open']")?.addEventListener("click",()=>{a.sidebarOpen=!0,m()}),t.querySelectorAll("[data-action='sidebar-close']").forEach(e=>{e.addEventListener("click",()=>{a.sidebarOpen=!1,m()})}),t.querySelectorAll("[data-link]").forEach(e=>{e.addEventListener("click",s=>{s.preventDefault(),Zt(e.dataset.link)})}),t.querySelector("[data-action='sales-filter']")?.addEventListener("click",()=>{const e=t.querySelector("#sales-start")?.value??"",s=t.querySelector("#sales-end")?.value??"";a.salesFilter={startDate:e,endDate:s},m()}),t.querySelector("[data-action='invoice-filter']")?.addEventListener("click",()=>{const e={documentNo:t.querySelector("#invoice-document-no")?.value??"",startDate:t.querySelector("#invoice-start")?.value??"",endDate:t.querySelector("#invoice-end")?.value??"",customerCode:t.querySelector("#invoice-customer-code")?.value??""};a.invoiceFilter=e,Ks(e)}),t.querySelector("[data-action='ledger-search']")?.addEventListener("click",()=>{const e=t.querySelector("#ledger-customer-code")?.value??"";a.ledgerCustomerCode=e.trim().toUpperCase(),zs(a.ledgerCustomerCode)}),t.querySelectorAll("[data-tab]").forEach(e=>{e.addEventListener("click",()=>{a.masterTab=e.dataset.tab,m()})}),t.querySelectorAll("[data-analytics-tab]").forEach(e=>{e.addEventListener("click",()=>{a.analyticsTab=e.dataset.analyticsTab,m()})}),t.querySelector("[data-action='add-line']")?.addEventListener("click",()=>{C(t),a.invoiceForm.lines.push({productCode:"",productName:"",quantity:0,unitPrice:0,unit:"本",amount:0}),a.invoiceErrors={},m()}),t.querySelectorAll("[data-action='remove-line']").forEach(e=>{e.addEventListener("click",()=>{C(t);const s=parseInt(e.dataset.line??"0",10);a.invoiceForm.lines.splice(s,1),a.invoiceErrors=Re(a.invoiceForm),m()})}),t.querySelectorAll("[data-action='duplicate-line']").forEach(e=>{e.addEventListener("click",()=>{C(t),Os(parseInt(e.dataset.line??"0",10)),a.invoiceErrors={},m()})}),t.querySelector("[data-action='copy-past-invoice']")?.addEventListener("click",()=>{Fs(),m()}),t.querySelector("[data-action='open-customer-picker']")?.addEventListener("click",()=>{C(t),a.pickerMode="customer",a.pickerTargetLine=null,a.pickerQuery=a.invoiceForm.customerCode||a.invoiceForm.customerName,m()}),t.querySelectorAll("[data-action='open-product-picker']").forEach(e=>{e.addEventListener("click",()=>{C(t);const s=parseInt(e.dataset.line??"0",10),n=a.invoiceForm.lines[s];a.pickerMode="product",a.pickerTargetLine=s,a.pickerQuery=n?n.productCode||n.productName:"",m()})}),t.querySelectorAll("[data-action='modal-close']").forEach(e=>{e.addEventListener("click",s=>{e.classList.contains("modal-backdrop")&&s.target instanceof HTMLElement&&!s.target.classList.contains("modal-backdrop")||(ct(),m())})}),t.querySelectorAll("[data-action='picker-select']").forEach(e=>{const s=()=>{const n=e.dataset.code??"",o=e.dataset.name??"";if(a.pickerMode==="customer")a.invoiceForm.customerCode=n,a.invoiceForm.customerName=o,delete a.invoiceErrors.customerCode;else if(a.pickerMode==="product"&&a.pickerTargetLine!==null){const i=a.invoiceForm.lines[a.pickerTargetLine];i&&(i.productCode=n,i.productName=o,i.amount=i.quantity*i.unitPrice,delete a.invoiceErrors[`lines.${a.pickerTargetLine}.productCode`],delete a.invoiceErrors[`lines.${a.pickerTargetLine}.productName`])}ct(),m()};e.addEventListener("click",s),e.addEventListener("keydown",n=>{n.key==="Enter"&&s()})}),t.querySelector("#modal-search")?.addEventListener("input",e=>{a.pickerQuery=e.target.value,m()}),t.querySelector("[data-action='invoice-clear']")?.addEventListener("click",()=>{Te(),m()}),t.querySelector("[data-action='invoice-save']")?.addEventListener("click",()=>{qe(t)}),t.querySelector("#inv-customer-code")?.addEventListener("blur",()=>{C(t),Js(a.invoiceForm.customerCode)&&(delete a.invoiceErrors.customerCode,m())}),t.querySelector("#inv-customer-name")?.addEventListener("blur",()=>{C(t),Vs(a.invoiceForm.customerName)&&(delete a.invoiceErrors.customerCode,m())}),t.querySelectorAll("#inv-date, #inv-customer-code, #inv-customer-name, #inv-staff, #inv-note, [data-field], #inv-type").forEach(e=>{e.addEventListener("input",()=>{C(t),a.invoiceSavedDocNo=null})}),t.querySelector("#inv-type")?.addEventListener("change",()=>{C(t),a.invoiceSavedDocNo=null}),t.querySelector("[data-action='delivery-search']")?.addEventListener("click",()=>{const e=t.querySelector("#delivery-docno")?.value??"";a.deliverySearchDocNo=e.trim(),a.deliveryNote=null,a.actionLoading=!0,m(),xt(a.deliverySearchDocNo||"D240122").then(s=>{a.deliveryNote=s,a.actionLoading=!1,m()})}),t.querySelector("[data-action='billing-load']")?.addEventListener("click",()=>{const e=t.querySelector("#billing-month")?.value??a.billingYearMonth;a.billingYearMonth=e,a.billingSummary=null,a.actionLoading=!0,m(),Dt(e).then(s=>{a.billingSummary=s,a.actionLoading=!1,m()})}),t.querySelector("[data-action='tax-load']")?.addEventListener("click",()=>{const e=parseInt(t.querySelector("#tax-year")?.value??String(a.taxYear),10),s=parseInt(t.querySelector("#tax-month")?.value??String(a.taxMonth),10);a.taxYear=e,a.taxMonth=s,a.taxDeclaration=null,a.actionLoading=!0,m(),_t(e,s).then(n=>{a.taxDeclaration=n,a.actionLoading=!1,m()})}),t.querySelector("[data-action='tax-export-xml']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{generateTaxXML:e}=await D(async()=>{const{generateTaxXML:d}=await Promise.resolve().then(()=>T);return{generateTaxXML:d}},void 0),s=e(a.taxDeclaration),n=new Blob([s],{type:"application/xml;charset=utf-8"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download=`tax-${a.taxYear}-${String(a.taxMonth).padStart(2,"0")}.xml`,i.click(),URL.revokeObjectURL(o)}),t.querySelector("[data-action='tax-export-csv']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{generateTaxCSV:e}=await D(async()=>{const{generateTaxCSV:d}=await Promise.resolve().then(()=>T);return{generateTaxCSV:d}},void 0),s=e(a.taxDeclaration),n=new Blob([s],{type:"text/csv;charset=utf-8"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download=`tax-${a.taxYear}-${String(a.taxMonth).padStart(2,"0")}.csv`,i.click(),URL.revokeObjectURL(o)}),t.querySelector("[data-action='tax-save-draft']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{saveTaxDeclaration:e}=await D(async()=>{const{saveTaxDeclaration:s}=await Promise.resolve().then(()=>T);return{saveTaxDeclaration:s}},void 0);try{await e(a.taxDeclaration),alert("下書き保存しました（Supabase tax_declarationsに保存）")}catch(s){alert("保存に失敗: "+(s instanceof Error?s.message:String(s)))}}),t.querySelectorAll("[data-tax-row][data-tax-field]").forEach(e=>{e.addEventListener("change",async()=>{if(!a.taxDeclaration)return;const s=Number(e.dataset.taxRow),n=e.dataset.taxField,o=e.type==="number"?Number(e.value)||0:e.value,i=[...a.taxDeclaration.rows];i[s]={...i[s],[n]:o};const{recalculateTaxDeclaration:d}=await D(async()=>{const{recalculateTaxDeclaration:l}=await Promise.resolve().then(()=>T);return{recalculateTaxDeclaration:l}},void 0);a.taxDeclaration=d({...a.taxDeclaration,rows:i}),m()})}),t.querySelectorAll("[data-ded-row][data-ded-field]").forEach(e=>{e.addEventListener("change",()=>{if(!a.taxDeclaration)return;const s=Number(e.dataset.dedRow),n=e.dataset.dedField,o=e.type==="number"?Number(e.value)||0:e.value,i=[...a.taxDeclaration.deductions];i[s]={...i[s],[n]:o},a.taxDeclaration={...a.taxDeclaration,deductions:i},m()})}),t.querySelectorAll("input[data-tax-field]:not([data-tax-row])").forEach(e=>{e.addEventListener("change",()=>{if(!a.taxDeclaration)return;const s=e.dataset.taxField;a.taxDeclaration={...a.taxDeclaration,[s]:e.value}})}),t.querySelector("[data-action='tax-add-category']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{recalculateTaxDeclaration:e,TAX_RATE_CATEGORIES:s}=await D(async()=>{const{recalculateTaxDeclaration:i,TAX_RATE_CATEGORIES:d}=await Promise.resolve().then(()=>T);return{recalculateTaxDeclaration:i,TAX_RATE_CATEGORIES:d}},void 0),n=s[0],o={taxCategory:n.code,taxCategoryName:n.name,alcoholDegree:15,productionVolume:0,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:0,taxableVolume:0,volume:0,taxRate:n.taxRatePerLiter,taxAmount:0};a.taxDeclaration=e({...a.taxDeclaration,rows:[...a.taxDeclaration.rows,o]}),m()}),t.querySelectorAll("[data-action='tax-remove-category']").forEach(e=>{e.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const s=Number(e.dataset.taxRow),{recalculateTaxDeclaration:n}=await D(async()=>{const{recalculateTaxDeclaration:i}=await Promise.resolve().then(()=>T);return{recalculateTaxDeclaration:i}},void 0),o=a.taxDeclaration.rows.filter((i,d)=>d!==s);a.taxDeclaration=n({...a.taxDeclaration,rows:o}),m()})}),t.querySelector("[data-action='tax-add-deduction']")?.addEventListener("click",()=>{if(!a.taxDeclaration)return;const e={type:"export",categoryCode:"01",volume:0,reason:"",documentNo:""};a.taxDeclaration={...a.taxDeclaration,deductions:[...a.taxDeclaration.deductions,e]},m()}),t.querySelectorAll("[data-action='tax-remove-deduction']").forEach(e=>{e.addEventListener("click",()=>{if(!a.taxDeclaration)return;const s=Number(e.dataset.dedRow),n=a.taxDeclaration.deductions.filter((o,i)=>i!==s);a.taxDeclaration={...a.taxDeclaration,deductions:n},m()})}),t.querySelectorAll("[data-store-tab]").forEach(e=>{e.addEventListener("click",()=>{a.storeTab=e.dataset.storeTab,m()})}),t.querySelectorAll("[data-import-entity]").forEach(e=>{e.addEventListener("click",()=>{a.importEntity=e.dataset.importEntity,a.importPreview=null,a.importResult=null,m()})}),t.querySelector("[data-action='download-template']")?.addEventListener("click",()=>{const e=Ds(a.importEntity),s=new Blob([e],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(s),o=document.createElement("a");o.href=n,o.download=`template_${a.importEntity}.csv`,o.click(),URL.revokeObjectURL(n)}),t.querySelector("[data-action='import-parse']")?.addEventListener("click",()=>{const s=t.querySelector("#import-file")?.files?.[0];if(!s){alert("CSVファイルを選択してください");return}const n=new FileReader;n.onload=()=>{const o=String(n.result??""),{columns:i,rows:d}=Cs(o);a.importPreview=xs(a.importEntity,i,d),a.importResult=null,m()},n.readAsText(s,"utf-8")}),t.querySelector("[data-action='import-cancel']")?.addEventListener("click",()=>{a.importPreview=null,a.importResult=null,m()}),t.querySelectorAll("[data-print-template]").forEach(e=>{e.addEventListener("click",()=>{a.printTemplate=e.dataset.printTemplate,m()})}),t.querySelectorAll("[data-print-field]").forEach(e=>{e.addEventListener("change",()=>{const s=e.dataset.printField;let n=e.value;(s==="taxRate"||s==="previousBalance"||s==="paymentAmount")&&(n=Number(e.value)||0),a.printData={...a.printData,[s]:n},m()})}),t.querySelectorAll("[data-print-opt]").forEach(e=>{e.addEventListener("change",()=>{const s=e.dataset.printOpt;let n;e.type==="checkbox"?n=e.checked:s==="copies"?n=Number(e.value)||1:n=e.value,a.printOptions={...a.printOptions,[s]:n},m()})}),t.querySelectorAll("[data-print-line][data-print-lfield]").forEach(e=>{e.addEventListener("change",()=>{const s=Number(e.dataset.printLine),n=e.dataset.printLfield,o=[...a.printData.lines];let i=e.value;(n==="quantity"||n==="unitPrice")&&(i=Number(e.value)||0),o[s]={...o[s],[n]:i},o[s].amount=(Number(o[s].quantity)||0)*(Number(o[s].unitPrice)||0),a.printData={...a.printData,lines:o},m()})}),t.querySelector("[data-action='print-add-line']")?.addEventListener("click",()=>{a.printData={...a.printData,lines:[...a.printData.lines,{productCode:"",productName:"",spec:"",quantity:0,unit:"本",unitPrice:0,amount:0}]},m()}),t.querySelectorAll("[data-action='print-remove-line']").forEach(e=>{e.addEventListener("click",()=>{const s=Number(e.dataset.printLine);a.printData={...a.printData,lines:a.printData.lines.filter((n,o)=>o!==s)},m()})}),t.querySelector("[data-action='print-save-settings']")?.addEventListener("click",()=>{try{localStorage.setItem("sake_print_options",JSON.stringify(a.printOptions)),localStorage.setItem("sake_print_company",JSON.stringify(a.printCompany)),alert("印刷設定を保存しました（次回以降も使えます）")}catch(e){alert("保存失敗: "+(e instanceof Error?e.message:String(e)))}}),t.querySelector("[data-action='print-open-company']")?.addEventListener("click",()=>{const e=a.printCompany,s=prompt("会社名",e.name);if(s===null)return;const n=prompt("郵便番号",e.postalCode)??e.postalCode,o=prompt("住所",e.address1)??e.address1,i=prompt("TEL",e.tel)??e.tel,d=prompt("FAX",e.fax)??e.fax,l=prompt("適格請求書登録番号 (T+13桁)",e.registrationNo)??e.registrationNo,c=prompt("取引銀行名",e.bankName)??e.bankName,r=prompt("支店名",e.bankBranch)??e.bankBranch,u=prompt("口座番号",e.bankAccountNo)??e.bankAccountNo,p=prompt("口座名義",e.bankAccountHolder)??e.bankAccountHolder;a.printCompany={...e,name:s,postalCode:n,address1:o,tel:i,fax:d,registrationNo:l,bankName:c,bankBranch:r,bankAccountNo:u,bankAccountHolder:p},m()}),t.querySelector("[data-action='import-execute']")?.addEventListener("click",async()=>{if(a.importPreview){a.importing=!0,m();try{const e=a.importPreview.rows.filter(n=>n._valid),s=await _s(a.importEntity,e);a.importResult=`取り込み完了: ${s.inserted}件成功 / ${s.failed}件失敗`,a.importPreview=null}catch(e){a.importResult=`エラー: ${e instanceof Error?e.message:String(e)}`}finally{a.importing=!1,m()}}}),t.querySelector("[data-action='store-load']")?.addEventListener("click",()=>{const e=t.querySelector("#store-date")?.value??a.storeSalesDate;a.storeSalesDate=e,a.storeSales=[],a.actionLoading=!0,m(),At(e).then(s=>{a.storeSales=s,a.actionLoading=!1,m()})}),t.querySelectorAll("[data-action='copy-config']").forEach(e=>{e.addEventListener("click",async()=>{const s=e.dataset.configValue??"";if(s)try{await navigator.clipboard.writeText(s),e.textContent="コピー済み",window.setTimeout(()=>{e.textContent="コピー"},1600)}catch(n){console.warn("Clipboard copy failed",n)}})}),t.querySelector("[data-action='download-relay-config']")?.addEventListener("click",()=>{const s=JSON.stringify({supabase_url:z,supabase_anon_key:"（Supabaseダッシュボードから取得して貼り付け）",z_drive_path:"Z:\\",sync_modules:["sk","sh","k5","h5"],interval_minutes:5,use_odbc:!1,odbc_dsn:"MagicSake",log_level:"INFO"},null,2),n=new Blob([s],{type:"application/json;charset=utf-8"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download="relay_config.json",i.click(),URL.revokeObjectURL(o)}),t.querySelectorAll("[data-action='copy-code']").forEach(e=>{e.addEventListener("click",async()=>{const s=e.dataset.code??"";if(s)try{await navigator.clipboard.writeText(decodeURIComponent(s)),e.textContent="コピー済み",window.setTimeout(()=>{e.textContent="コピー"},1600)}catch(n){console.warn("Clipboard code copy failed",n)}})}),t.querySelectorAll("input[name='email-audience-mode']").forEach(e=>{e.addEventListener("change",()=>{j(t),a.emailSaveMessage=null,m()})}),t.querySelectorAll("#email-region, #email-history-segment").forEach(e=>{e.addEventListener("change",()=>{j(t),a.emailSaveMessage=null,m()})}),t.querySelector("#email-subject")?.addEventListener("input",()=>{j(t),a.emailSaveMessage=null}),t.querySelector("#email-body")?.addEventListener("input",()=>{j(t),a.emailSaveMessage=null}),t.querySelectorAll("[data-action='template-select']").forEach(e=>{e.addEventListener("click",()=>{a.emailTemplateId=e.dataset.templateId??"custom";const s=Pe(a.emailTemplateId);a.emailSubject=s.subject,a.emailBody=s.body,a.emailSaveMessage=null,m()})}),t.querySelector("[data-action='email-insert-link']")?.addEventListener("click",()=>{j(t);const e=`

商品詳細はこちら: https://example.jp/products/seasonal`;a.emailBody.includes("https://example.jp/products/seasonal")||(a.emailBody=`${a.emailBody.trimEnd()}${e}`),a.emailSaveMessage=null,m()}),t.querySelector("[data-action='email-save']")?.addEventListener("click",()=>{j(t),a.actionLoading=!0,m(),nt(ht("draft")).then(e=>{a.emailSaveMessage=`下書きを保存しました。${new Intl.DateTimeFormat("ja-JP",{month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e.updatedAt??new Date().toISOString()))}`,a.actionLoading=!1,m()})}),t.querySelector("[data-action='email-send']")?.addEventListener("click",()=>{j(t),a.actionLoading=!0,a.emailSending=!0,m();const e=ht("sent");_e().then(async s=>{await nt({...e,recipientCount:s.sent}),a.emailSaveMessage=`${s.sent.toLocaleString("ja-JP")} 件送信しました。`,a.actionLoading=!1,a.emailSending=!1,m(),window.alert(`${s.sent}件送信完了`)}).catch(async()=>{await nt(ht("draft")),a.emailSaveMessage="APIキー未設定のため下書きを保存しました。",a.actionLoading=!1,a.emailSending=!1,m(),window.alert("APIキー未設定のため下書き保存しました")})})}function m(){const t=document.querySelector("#app");t&&(t.innerHTML=Ys(),Ws(t),a.pickerMode&&t.querySelector("#modal-search")?.focus(),a.globalSearchOpen&&t.querySelector("#global-search-input")?.focus(),Pt()&&t.querySelector("#auth-email")?.focus())}async function Qs(){a.loading=!0,m();try{const[t,e,s,n,o,i,d]=await Promise.all([ce(),re(),de(),ue(),lt(a.invoiceFilter),Ct(a.ledgerCustomerCode),pe()]);if(a.salesSummary=t,a.paymentStatus=e,a.masterStats=s,a.pipelineMeta=n,a.invoiceRecords=o,a.customerLedger=i,a.salesAnalytics=d,!a.salesFilter.startDate||!a.salesFilter.endDate){const c=[...t.salesRecords].sort((p,h)=>new Date(h.date).getTime()-new Date(p.date).getTime())[0]?.date??new Date().toISOString(),r=new Date(c),u=new Date(r);u.setDate(r.getDate()-30),a.salesFilter={startDate:Xt(u.toISOString()),endDate:Xt(r.toISOString())}}(!a.invoiceFilter.startDate||!a.invoiceFilter.endDate)&&(a.invoiceFilter={...a.invoiceFilter,startDate:a.salesFilter.startDate,endDate:a.salesFilter.endDate},a.invoiceRecords=await lt(a.invoiceFilter)),a.error=null}catch(t){a.error=t instanceof Error?t.message:"データの取得に失敗しました。"}finally{a.loading=!1,m(),Et(a.route)}}window.addEventListener("popstate",()=>{a.route=Ee(location.pathname),a.currentCategory=jt(a.route),a.sidebarOpen=!1,K(),Et(a.route)});window.addEventListener("keydown",t=>{if((t.ctrlKey||t.metaKey)&&t.key.toLowerCase()==="k"){t.preventDefault(),a.globalSearchOpen=!0,m();return}if(t.key==="Escape"){if(a.globalSearchOpen){K(),m();return}if(a.pickerMode){ct(),m();return}a.route==="/invoice-entry"&&!a.invoiceSaving&&(Te(),m());return}if(a.route==="/invoice-entry"&&!a.invoiceSaving&&(t.ctrlKey||t.metaKey)&&t.key.toLowerCase()==="s"){t.preventDefault();const e=document.querySelector("#app");e&&qe(e)}});a.user=kt()?He():null;try{const t=localStorage.getItem("sake_print_options");t&&(a.printOptions={...a.printOptions,...JSON.parse(t)});const e=localStorage.getItem("sake_print_company");e&&(a.printCompany={...a.printCompany,...JSON.parse(e)})}catch{}Qs();
