(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const c of i)if(c.type==="childList")for(const o of c.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const c={};return i.integrity&&(c.integrity=i.integrity),i.referrerPolicy&&(c.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?c.credentials="include":i.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(i){if(i.ep)return;i.ep=!0;const c=n(i);fetch(i.href,c)}})();const Et="https://loarwnuyvfxiscjjsmiz.supabase.co",It="";async function ft(t,e){return null}async function b(t,e={}){return[]}const kt={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
ご注文締切や納品希望日がございましたら、あわせてお知らせください。`}},U={generatedAt:"2026-04-15T09:15:00+09:00",kpis:{todaySales:1248e3,todayDelta:8.2,monthSales:18245e3,monthDelta:5.6,unpaidCount:7,unpaidAmount:264e4},dailySales:Array.from({length:30},(t,e)=>{const n=new Date("2026-03-17T00:00:00+09:00");return n.setDate(n.getDate()+e),{date:n.toISOString(),amount:42e4+e*73123%62e4}}),salesRecords:Array.from({length:20},(t,e)=>{const n=new Date("2026-04-15T00:00:00+09:00");return n.setDate(n.getDate()-e),{id:`sale-${e+1}`,documentNo:`D${String(240100+e).padStart(6,"0")}`,date:n.toISOString(),customerCode:`C${String(e+11).padStart(4,"0")}`,customerName:["青葉商事","北斗酒販","中央フーズ","東海酒店"][e%4],amount:68e3+e%6*24500}})},Jt={generatedAt:"2026-04-15T09:15:00+09:00",records:[{id:"pay-1",customerCode:"C0011",customerName:"青葉商事",billedAmount:54e4,paymentAmount:0,balanceAmount:54e4,lastPaymentDate:null,status:"unpaid"},{id:"pay-2",customerCode:"C0012",customerName:"北斗酒販",billedAmount:72e4,paymentAmount:3e5,balanceAmount:42e4,lastPaymentDate:"2026-04-11T14:30:00+09:00",status:"partial"},{id:"pay-3",customerCode:"C0013",customerName:"中央フーズ",billedAmount:68e4,paymentAmount:68e4,balanceAmount:0,lastPaymentDate:"2026-04-14T10:00:00+09:00",status:"paid"},{id:"pay-4",customerCode:"C0014",customerName:"東海酒店",billedAmount:41e4,paymentAmount:18e4,balanceAmount:23e4,lastPaymentDate:"2026-04-10T09:10:00+09:00",status:"partial"}]},S={generatedAt:"2026-04-15T09:15:00+09:00",summary:{customerCount:164,activeCustomerCount:152,productCount:486,activeProductCount:461},customers:Array.from({length:12},(t,e)=>({id:`customer-${e+1}`,code:`C${String(e+1).padStart(4,"0")}`,name:["青葉商事","北斗酒販","中央フーズ","東海酒店","三和物産","南星リカー"][e%6],closingDay:[15,20,25,31][e%4],paymentDay:[5,10,15,20][e%4],isActive:e%5!==0})),products:Array.from({length:12},(t,e)=>({id:`product-${e+1}`,code:`P${String(e+1).padStart(5,"0")}`,janCode:`4901234567${String(e).padStart(3,"0")}`,name:["純米吟醸 720ml","本醸造 1.8L","特別純米 300ml","梅酒 500ml"][e%4],category:["清酒","焼酎","リキュール"][e%3],isActive:e%6!==0}))},Ot={generatedAt:"2026-04-15T09:15:00+09:00",lastSyncAt:"2026-04-15T09:12:21+09:00",status:"success",jobName:"daily-sync",message:"同期完了。売上・入金・マスタを最新化しました。"},St=U.salesRecords.map((t,e)=>({...t,itemCount:e%4+1})),Bt={C0011:{customerCode:"C0011",customerName:"青葉商事",balanceAmount:54e4,salesTotal:114e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-1",date:"2026-04-15T00:00:00+09:00",documentNo:"D240100",amount:42e4},{id:"ledger-sale-2",date:"2026-04-08T00:00:00+09:00",documentNo:"D240087",amount:39e4},{id:"ledger-sale-3",date:"2026-03-28T00:00:00+09:00",documentNo:"D240059",amount:33e4}],paymentHistory:[{id:"ledger-payment-1",date:"2026-04-10T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-2",date:"2026-03-31T00:00:00+09:00",amount:3e5,method:"振込"}]},C0012:{customerCode:"C0012",customerName:"北斗酒販",balanceAmount:42e4,salesTotal:102e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-4",date:"2026-04-14T00:00:00+09:00",documentNo:"D240101",amount:36e4},{id:"ledger-sale-5",date:"2026-04-05T00:00:00+09:00",documentNo:"D240082",amount:32e4},{id:"ledger-sale-6",date:"2026-03-25T00:00:00+09:00",documentNo:"D240054",amount:34e4}],paymentHistory:[{id:"ledger-payment-3",date:"2026-04-11T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-4",date:"2026-03-30T00:00:00+09:00",amount:3e5,method:"現金"}]}},V={productTotals:[{code:"P00001",name:"純米吟醸 720ml",amount:584e4,quantity:820,documents:148},{code:"P00002",name:"本醸造 1.8L",amount:498e4,quantity:610,documents:131},{code:"P00003",name:"特別純米 300ml",amount:356e4,quantity:1240,documents:112},{code:"P00004",name:"梅酒 500ml",amount:287e4,quantity:540,documents:89}],customerTotals:[{code:"C0011",name:"青葉商事",amount:462e4,quantity:320,documents:54},{code:"C0012",name:"北斗酒販",amount:438e4,quantity:294,documents:49},{code:"C0013",name:"中央フーズ",amount:391e4,quantity:276,documents:45},{code:"C0014",name:"東海酒店",amount:324e4,quantity:221,documents:37}]};function v(t){if(typeof t=="number"&&Number.isFinite(t))return t;if(typeof t=="string"){const e=Number(t);return Number.isFinite(e)?e:0}return 0}function Ht(t){switch((t??"").toLowerCase()){case"paid":case"complete":case"completed":return"paid";case"partial":case"partially_paid":case"partially paid":return"partial";default:return"unpaid"}}function Yt(t){return typeof t=="boolean"?t:typeof t=="number"?t!==0:typeof t=="string"?["true","1","active","enabled","yes","y"].includes(t.toLowerCase()):!1}function g(t,e,n=""){for(const s of e){const i=t[s];if(typeof i=="string"&&i.length>0)return i}return n}function ct(t,e,n=0){for(const s of e)if(s in t)return v(t[s]);return n}function ot(t,e,n=!0){for(const s of e)if(s in t)return Yt(t[s]);return n}function Ct(t,e,n){for(const s of e){const i=t[s];if(typeof i!="string"||i.length===0)continue;if(/^\d{4}-\d{2}-\d{2}$/.test(i))return new Date(`${i}T00:00:00Z`).toISOString();const c=new Date(i);if(!Number.isNaN(c.getTime()))return c.toISOString()}return n}function wt(t){return t.slice(0,7)}function at(t,e){return{id:String(t.id??`invoice-${e+1}`),documentNo:t.document_no??t.legacy_document_no??`D${String(240100+e).padStart(6,"0")}`,date:Ct(t,["sales_date","document_date"],new Date().toISOString()),customerCode:t.customer_code??t.legacy_customer_code??`C${String(e+1).padStart(4,"0")}`,customerName:t.customer_name??t.customer_code??t.legacy_customer_code??"不明",itemCount:0,amount:v(t.total_amount??t.billed_amount)}}function lt(t,e){const n=e.startDate?new Date(`${e.startDate}T00:00:00`):null,s=e.endDate?new Date(`${e.endDate}T23:59:59`):null,i=e.documentNo.trim().toLowerCase(),c=e.customerCode.trim().toLowerCase();return t.filter(o=>{const p=new Date(o.date);return!(n&&p<n||s&&p>s||i&&!o.documentNo.toLowerCase().includes(i)||c&&!o.customerCode.toLowerCase().includes(c))}).sort((o,p)=>new Date(p.date).getTime()-new Date(o.date).getTime())}function rt(t){const e=t.trim().toUpperCase(),n=Bt[e];if(n)return n;const s=U.salesRecords.find(i=>i.customerCode.toUpperCase()===e);return{customerCode:e||"未指定",customerName:s?.customerName??"該当得意先なし",balanceAmount:0,salesTotal:0,paymentTotal:0,salesHistory:[],paymentHistory:[]}}function Kt(){const t=new Map,e=new Map,n=new Map;return St.forEach((s,i)=>{const c=wt(s.date);t.set(c,(t.get(c)??0)+s.amount);const o=e.get(s.customerCode)??{code:s.customerCode,name:s.customerName,amount:0,quantity:0,documents:0};o.amount+=s.amount,o.quantity+=s.itemCount,o.documents+=1,e.set(s.customerCode,o);const p=`P${String(i%4+1).padStart(5,"0")}`,r=V.productTotals[i%V.productTotals.length],l=n.get(p)??{code:p,name:r?.name??`商品${i+1}`,amount:0,quantity:0,documents:0};l.amount+=s.amount,l.quantity+=s.itemCount*12,l.documents+=1,n.set(p,l)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(t.entries()).sort(([s],[i])=>s.localeCompare(i)).map(([s,i])=>({month:s,amount:i})),productTotals:Array.from(n.values()).sort((s,i)=>i.amount-s.amount),customerTotals:Array.from(e.values()).sort((s,i)=>i.amount-s.amount)}}async function y(t,e){try{const n=await fetch(`/sake-system/${t}`,{headers:{Accept:"application/json"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(n){return console.warn(`Failed to fetch ${t}, using fallback data`,n),e}}async function Ut(){const t=await b("daily_sales_fact",{});if(t.length>0){const e=await b("customer_payment_status",{}),s=new Date().toISOString().slice(0,10),i=s.slice(0,7),c=[...t].sort((l,d)=>l.sales_date.localeCompare(d.sales_date)).slice(-30).map(l=>({date:new Date(`${l.sales_date}T00:00:00Z`).toISOString(),amount:v(l.sales_amount)})),o=t.reduce((l,d)=>d.sales_date===s?l+v(d.sales_amount):l,0),p=t.reduce((l,d)=>d.sales_date.startsWith(i)?l+v(d.sales_amount):l,0),r=e.filter(l=>v(l.balance_amount)>0);return{generatedAt:new Date().toISOString(),kpis:{todaySales:o,todayDelta:0,monthSales:p,monthDelta:0,unpaidCount:r.length,unpaidAmount:r.reduce((l,d)=>l+v(d.balance_amount),0)},dailySales:c,salesRecords:U.salesRecords}}return y("data/api/latest/sales-summary.json",U)}async function Vt(){const t=await b("customer_payment_status",{});return t.length>0?{generatedAt:new Date().toISOString(),records:t.map((e,n)=>{const s=e.legacy_customer_code??`UNKNOWN-${n+1}`;return{id:`payment-${s}-${n+1}`,customerCode:s,customerName:s,billedAmount:v(e.billed_amount),paymentAmount:v(e.paid_amount),balanceAmount:v(e.balance_amount),lastPaymentDate:null,status:Ht(e.payment_status)}})}:y("data/api/latest/payment-status.json",Jt)}async function Wt(){const[t,e]=await Promise.all([b(),b()]);if(t.length>0||e.length>0){const n=t.length?t.map((i,c)=>({id:g(i,["id","customer_id","code"],`customer-${c+1}`),code:g(i,["code","customer_code","legacy_customer_code"],`C${String(c+1).padStart(4,"0")}`),name:g(i,["name","customer_name","display_name"],`Customer ${c+1}`),closingDay:ct(i,["closing_day","close_day"],31),paymentDay:ct(i,["payment_day","due_day"],15),isActive:ot(i,["is_active","active","enabled"],!0)})):S.customers,s=e.length?e.map((i,c)=>({id:g(i,["id","product_id","code"],`product-${c+1}`),code:g(i,["code","product_code"],`P${String(c+1).padStart(5,"0")}`),janCode:g(i,["jan_code","jan","barcode"],""),name:g(i,["name","product_name","display_name"],`Product ${c+1}`),category:g(i,["category","category_name"],"未分類"),isActive:ot(i,["is_active","active","enabled"],!0)})):S.products;return{generatedAt:new Date().toISOString(),summary:{customerCount:t.length||S.summary.customerCount,activeCustomerCount:t.length?n.filter(i=>i.isActive).length:S.summary.activeCustomerCount,productCount:e.length||S.summary.productCount,activeProductCount:e.length?s.filter(i=>i.isActive).length:S.summary.activeProductCount},customers:n,products:s}}return y("data/api/latest/master-stats.json",S)}function Qt(){return y("data/api/latest/pipeline-meta.json",Ot)}async function tt(t){const[e,n]=await Promise.all([b("sales_document_headers",{}),b("sales_document_lines",{})]);if(e.length>0){const s=new Map;n.forEach(c=>{const o=String(c.header_id??c.document_header_id??c.document_no??c.id??"");o&&s.set(o,(s.get(o)??0)+1)});const i=e.map((c,o)=>{const p=at(c,o),r=String(c.id??c.document_no??c.legacy_document_no??"");return{...p,itemCount:s.get(r)??p.itemCount}});return lt(i,t)}return lt(St,t)}async function Dt(t){const e=t.trim().toUpperCase();if(!e)return rt("");const[n,s,i]=await Promise.all([b("sales_document_headers",{}),b("customer_payments",{}),b("customer_payment_status",{})]);if(n.length>0||s.length>0){const c=n.map((r,l)=>{const d=at(r,l);return{id:d.id,date:d.date,documentNo:d.documentNo,amount:d.amount}}),o=s.map((r,l)=>({id:String(r.id??`payment-${l+1}`),date:Ct(r,["payment_date","received_date"],new Date().toISOString()),amount:v(r.payment_amount??r.amount),method:r.payment_method??r.method??"入金"})),p=i.find(r=>(r.legacy_customer_code??"").toUpperCase()===e);return{customerCode:e,customerName:n[0]?.customer_name??n[0]?.customer_code??n[0]?.legacy_customer_code??e,balanceAmount:v(p?.balance_amount),salesTotal:c.reduce((r,l)=>r+l.amount,0),paymentTotal:o.reduce((r,l)=>r+l.amount,0),salesHistory:c,paymentHistory:o}}return rt(e)}async function zt(){const[t,e,n]=await Promise.all([b("daily_sales_fact",{}),b("sales_document_headers",{}),b("sales_document_lines",{})]);if(t.length>0){const s=new Map;t.forEach(o=>{const p=wt(o.sales_date);s.set(p,(s.get(p)??0)+v(o.sales_amount))});const i=new Map;e.forEach((o,p)=>{const r=at(o,p),l=i.get(r.customerCode)??{code:r.customerCode,name:r.customerName,amount:0,quantity:0,documents:0};l.amount+=r.amount,l.documents+=1,i.set(r.customerCode,l)});const c=new Map;return n.forEach((o,p)=>{const r=o.product_code??o.legacy_product_code??`P${String(p+1).padStart(5,"0")}`,l=c.get(r)??{code:r,name:o.product_name??r,amount:0,quantity:0,documents:0};l.amount+=v(o.line_amount??o.amount),l.quantity+=v(o.quantity),l.documents+=1,c.set(r,l)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(s.entries()).sort(([o],[p])=>o.localeCompare(p)).map(([o,p])=>({month:o,amount:p})).slice(-12),productTotals:c.size>0?Array.from(c.values()).sort((o,p)=>p.amount-o.amount):V.productTotals,customerTotals:i.size>0?Array.from(i.values()).sort((o,p)=>p.amount-o.amount):V.customerTotals}}return Kt()}const dt={sales:"売上",return:"返品",export_return:"輸出戻入"};async function Gt(t){const e=t.lines.reduce((i,c)=>i+c.amount,0),n=`D${Date.now().toString().slice(-6)}`;return{id:(await ft("sales_document_headers",{legacy_customer_code:t.customerCode,sales_date:t.invoiceDate,document_type:t.invoiceType,staff_code:t.staffCode}))?.id??`local-${n}`,documentNo:n,totalAmount:e,status:"confirmed",createdAt:new Date().toISOString()}}const ut={documentNo:"D240122",invoiceDate:"2026-04-14",customerCode:"C0011",customerName:"青葉商事 株式会社",customerAddress:"〒123-4567 東京都千代田区〇〇 1-2-3",lines:[{productCode:"P00012",productName:"純米吟醸 720ml",quantity:6,unitPrice:12e3,unit:"本",amount:72e3},{productCode:"P00008",productName:"本醸造 1.8L",quantity:4,unitPrice:8500,unit:"本",amount:34e3},{productCode:"P00021",productName:"梅酒 500ml",quantity:12,unitPrice:5800,unit:"本",amount:69600}],totalAmount:175600,taxAmount:15960,note:""};async function Nt(t){const e=await b("sales_document_headers",{});if(e.length>0){const n=e[0],s=v(n.total_amount);return{documentNo:t,invoiceDate:g(n,["sales_date","document_date"],""),customerCode:g(n,["legacy_customer_code","customer_code"],""),customerName:g(n,["customer_name","legacy_customer_code"],""),customerAddress:"",lines:[],totalAmount:s,taxAmount:Math.floor(s*10/110),note:""}}return{...ut,documentNo:t||ut.documentNo}}const Zt={targetYearMonth:"2026-04",closingDay:15,totalBilling:482e4,customers:[{customerCode:"C0011",customerName:"青葉商事",closingDay:15,salesAmount:54e4,taxAmount:54e3,prevBalance:28e4,paymentAmount:28e4,billingAmount:594e3,status:"open"},{customerCode:"C0012",customerName:"北斗酒販",closingDay:15,salesAmount:72e4,taxAmount:72e3,prevBalance:14e4,paymentAmount:14e4,billingAmount:792e3,status:"closed"},{customerCode:"C0013",customerName:"中央フーズ",closingDay:15,salesAmount:38e4,taxAmount:38e3,prevBalance:0,paymentAmount:0,billingAmount:418e3,status:"open"},{customerCode:"C0014",customerName:"東海酒店",closingDay:15,salesAmount:61e4,taxAmount:61e3,prevBalance:23e4,paymentAmount:15e4,billingAmount:751e3,status:"open"}]};async function At(t){return y(`data/api/latest/billing-${t}.json`,{...Zt,targetYearMonth:t})}const Xt=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],te={generatedAt:new Date().toISOString(),months:Xt,salesByProduct:[{label:"純米吟醸 720ml",values:[380,410,520,480,390,320,450,480,510,420,380,350].map(t=>t*1e4)},{label:"本醸造 1.8L",values:[290,310,380,340,280,250,320,360,390,310,280,260].map(t=>t*1e4)},{label:"梅酒 500ml",values:[210,240,310,290,230,180,260,300,320,250,200,190].map(t=>t*1e4)}],salesByCustomer:[{label:"青葉商事",values:[480,510,620,590,480,390,540,580,610,510,460,430].map(t=>t*1e4)},{label:"北斗酒販",values:[390,420,520,490,400,330,460,500,530,430,380,360].map(t=>t*1e4)}],costSimulation:[{productCode:"P00012",productName:"純米吟醸 720ml",costPrice:7200,sellPrice:12e3,margin:4800,marginRate:40},{productCode:"P00008",productName:"本醸造 1.8L",costPrice:4800,sellPrice:8500,margin:3700,marginRate:43.5},{productCode:"P00021",productName:"梅酒 500ml",costPrice:3200,sellPrice:5800,margin:2600,marginRate:44.8}]};async function ee(){return y("data/api/latest/sales-report.json",te)}const ae={planned:"計画中",active:"仕込中",done:"完了"},se=[{id:"j1",jikomiNo:"J2026-01",productName:"純米吟醸",riceType:"山田錦",plannedKg:400,actualKg:400,startDate:"2026-01-10",expectedDoneDate:"2026-02-20",status:"done",tankNo:"T01",note:""},{id:"j2",jikomiNo:"J2026-02",productName:"本醸造",riceType:"日本晴",plannedKg:600,actualKg:600,startDate:"2026-02-01",expectedDoneDate:"2026-03-15",status:"done",tankNo:"T02",note:""},{id:"j3",jikomiNo:"J2026-03",productName:"特別純米",riceType:"五百万石",plannedKg:500,actualKg:480,startDate:"2026-03-05",expectedDoneDate:"2026-04-20",status:"active",tankNo:"T03",note:"経過良好"},{id:"j4",jikomiNo:"J2026-04",productName:"純米大吟醸",riceType:"山田錦",plannedKg:300,actualKg:0,startDate:"2026-04-15",expectedDoneDate:"2026-06-01",status:"planned",tankNo:"T04",note:""}];async function ne(){return y("data/api/latest/jikomi.json",se)}const ie=[{id:"t1",tankNo:"T01",capacity:3e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-01"},{id:"t2",tankNo:"T02",capacity:4e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-20"},{id:"t3",tankNo:"T03",capacity:3500,currentVolume:2800,productName:"特別純米",jikomiNo:"J2026-03",status:"in_use",lastUpdated:"2026-04-10"},{id:"t4",tankNo:"T04",capacity:2e3,currentVolume:0,productName:"純米大吟醸",jikomiNo:"J2026-04",status:"in_use",lastUpdated:"2026-04-15"},{id:"t5",tankNo:"T05",capacity:5e3,currentVolume:3200,productName:"本醸造（貯蔵）",jikomiNo:"J2026-02",status:"aging",lastUpdated:"2026-03-20"}];async function ce(){return y("data/api/latest/tanks.json",ie)}const oe=[{id:"k1",kenteiNo:"K2026-001",jikomiNo:"J2026-01",productName:"純米吟醸",kenteiDate:"2026-02-25",alcoholDegree:16.2,extractDegree:3.8,sakaMeterValue:2.5,volume:2850,taxCategory:"清酒",status:"approved"},{id:"k2",kenteiNo:"K2026-002",jikomiNo:"J2026-02",productName:"本醸造",kenteiDate:"2026-03-18",alcoholDegree:15.5,extractDegree:4.1,sakaMeterValue:1.8,volume:3600,taxCategory:"清酒",status:"submitted"},{id:"k3",kenteiNo:"K2026-003",jikomiNo:"J2026-03",productName:"特別純米",kenteiDate:"2026-04-18",alcoholDegree:0,extractDegree:0,sakaMeterValue:0,volume:0,taxCategory:"清酒",status:"pending"}];async function le(){return y("data/api/latest/kentei.json",oe)}const re=[{id:"m1",code:"M001",name:"720ml瓶",unit:"本",currentStock:2400,minimumStock:500,unitCost:85,lastUpdated:"2026-04-10"},{id:"m2",code:"M002",name:"1.8L瓶",unit:"本",currentStock:1800,minimumStock:300,unitCost:140,lastUpdated:"2026-04-10"},{id:"m3",code:"M003",name:"300ml瓶",unit:"本",currentStock:3600,minimumStock:600,unitCost:55,lastUpdated:"2026-04-08"},{id:"m4",code:"M004",name:"キャップ（金）",unit:"個",currentStock:8e3,minimumStock:1e3,unitCost:12,lastUpdated:"2026-04-05"},{id:"m5",code:"M005",name:"ラベル（純米吟醸）",unit:"枚",currentStock:1200,minimumStock:300,unitCost:28,lastUpdated:"2026-04-01"},{id:"m6",code:"M006",name:"化粧箱（720ml）",unit:"個",currentStock:180,minimumStock:100,unitCost:320,lastUpdated:"2026-04-01"}];async function de(){return y("data/api/latest/materials.json",re)}const ue=[{id:"p1",documentNo:"K240050",purchaseDate:"2026-04-05",supplierCode:"S001",supplierName:"山田農場",itemName:"山田錦（精米65%）",quantity:500,unitPrice:480,amount:24e4,status:"confirmed"},{id:"p2",documentNo:"K240051",purchaseDate:"2026-04-06",supplierCode:"S002",supplierName:"日本瓶工業",itemName:"720ml瓶",quantity:1200,unitPrice:85,amount:102e3,status:"confirmed"},{id:"p3",documentNo:"K240052",purchaseDate:"2026-04-10",supplierCode:"S003",supplierName:"山本麹店",itemName:"米麹",quantity:80,unitPrice:1200,amount:96e3,status:"pending"},{id:"p4",documentNo:"K240053",purchaseDate:"2026-04-12",supplierCode:"S001",supplierName:"山田農場",itemName:"五百万石（精米60%）",quantity:300,unitPrice:420,amount:126e3,status:"pending"}],pe=[{supplierCode:"S001",supplierName:"山田農場",totalPurchase:366e3,paidAmount:24e4,balance:126e3,nextPaymentDate:"2026-04-30",status:"partial"},{supplierCode:"S002",supplierName:"日本瓶工業",totalPurchase:102e3,paidAmount:102e3,balance:0,nextPaymentDate:"",status:"paid"},{supplierCode:"S003",supplierName:"山本麹店",totalPurchase:96e3,paidAmount:0,balance:96e3,nextPaymentDate:"2026-04-30",status:"unpaid"}],me=[{id:"b1",billNo:"H240001",supplierName:"山田農場",amount:24e4,issueDate:"2026-03-31",dueDate:"2026-04-30",status:"holding"},{id:"b2",billNo:"H240002",supplierName:"大阪資材",amount:185e3,issueDate:"2026-03-31",dueDate:"2026-05-31",status:"holding"},{id:"b3",billNo:"H230045",supplierName:"中部農業",amount:32e4,issueDate:"2026-02-28",dueDate:"2026-03-31",status:"cleared"}],he=[{code:"R001",name:"山田錦（精米65%）",unit:"kg",currentStock:380,minimumStock:100,lastPurchaseDate:"2026-04-05",unitCost:480},{code:"R002",name:"五百万石（精米60%）",unit:"kg",currentStock:290,minimumStock:100,lastPurchaseDate:"2026-04-12",unitCost:420},{code:"R003",name:"米麹",unit:"kg",currentStock:62,minimumStock:20,lastPurchaseDate:"2026-04-10",unitCost:1200},{code:"R004",name:"醸造用アルコール",unit:"L",currentStock:240,minimumStock:50,lastPurchaseDate:"2026-03-20",unitCost:180},{code:"R005",name:"清酒用酵母",unit:"g",currentStock:500,minimumStock:100,lastPurchaseDate:"2026-02-15",unitCost:3200}];async function ye(){return y("data/api/latest/purchases.json",ue)}async function ve(){return y("data/api/latest/payables.json",pe)}async function be(){return y("data/api/latest/bills.json",me)}async function ge(){return y("data/api/latest/raw-stock.json",he)}const $e={targetYear:2026,targetMonth:3,companyName:"金井酒造店",companyNo:"1234567890123",rows:[{taxCategory:"01",taxCategoryName:"清酒（普通酒）",alcoholDegree:15.5,volume:3600,taxRate:88,taxAmount:316800},{taxCategory:"02",taxCategoryName:"清酒（純米酒）",alcoholDegree:16.2,volume:2850,taxRate:88,taxAmount:250800},{taxCategory:"03",taxCategoryName:"清酒（吟醸酒）",alcoholDegree:16.5,volume:1200,taxRate:88,taxAmount:105600}],totalVolume:7650,totalTax:673200,status:"draft"};async function Lt(t,e){return y(`data/api/latest/tax-${t}-${String(e).padStart(2,"0")}.json`,{...$e,targetYear:t,targetMonth:e})}const fe=Array.from({length:10},(t,e)=>({id:`ss${e+1}`,saleDate:"2026-04-15",saleTime:`${9+e}:${String(e*7%60).padStart(2,"0")}`,productCode:`P${String(e%4+1).padStart(5,"0")}`,productName:["純米吟醸 720ml","本醸造 1.8L","梅酒 500ml","特別純米 300ml"][e%4],quantity:1+e%3,unitPrice:[2200,1800,980,680][e%4],amount:(1+e%3)*[2200,1800,980,680][e%4],paymentMethod:["cash","card","paypay","cash"][e%4]})),ke=[{id:"o1",orderNo:"ORD-2604001",orderDate:"2026-04-13",customerName:"鈴木 太郎",postalCode:"150-0001",address:"東京都渋谷区〇〇1-1",items:[{productName:"純米吟醸 720ml",quantity:2,amount:4400}],totalAmount:4400,status:"shipped",shippingDate:"2026-04-14"},{id:"o2",orderNo:"ORD-2604002",orderDate:"2026-04-14",customerName:"田中 花子",postalCode:"530-0001",address:"大阪府大阪市北区〇〇2-3",items:[{productName:"梅酒 500ml",quantity:3,amount:2940},{productName:"本醸造 1.8L",quantity:1,amount:1800}],totalAmount:4740,status:"processing",shippingDate:""},{id:"o3",orderNo:"ORD-2604003",orderDate:"2026-04-15",customerName:"佐藤 一郎",postalCode:"460-0001",address:"愛知県名古屋市中区〇〇3-5",items:[{productName:"特別純米 300ml ×6本セット",quantity:1,amount:3980}],totalAmount:3980,status:"new",shippingDate:""}];async function jt(t){return y(`data/api/latest/store-sales-${t}.json`,fe)}async function Se(){return y("data/api/latest/store-orders.json",ke)}async function pt(t){const e=await ft("email_campaigns",{subject:t.subject,body:t.body,template_id:t.templateId,audience_mode:t.audienceMode,audience_filter:t.audienceFilter,recipient_count:t.recipientCount,status:t.status});return{id:e?.id??`local-email-${Date.now()}`,subject:e?.subject??t.subject,body:e?.body??t.body,templateId:e?.template_id??t.templateId,audienceMode:e?.audience_mode??t.audienceMode,audienceFilter:e?.audience_filter??t.audienceFilter,recipientCount:e?.recipient_count??t.recipientCount,status:e?.status??t.status,createdAt:e?.created_at??new Date().toISOString(),updatedAt:e?.updated_at??new Date().toISOString()}}function j(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}const Ce={open:"未締め",closed:"締め済"};function we(t,e){const n=t.customers.map(s=>`
      <tr>
        <td>
        ...
        <td class="numeric">${j(s.salesAmount)}</td>
        <td class="numeric">${j(s.taxAmount)}</td>
        <td class="numeric">${j(s.prevBalance)}</td>
        <td class="numeric">${j(s.paymentAmount)}</td>
        <td class="numeric"><strong>${j(s.billingAmount)}</strong></td>
        <td>
          <span class="status-pill ${s.status==="closed"?"success":"warning"}">${Ce[s.status]}</span>
        </td>
        <td>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${j(t.totalBilling)}</p>
  ...
  `}function Pt(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function E(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Ae(t){return t.salesHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':t.salesHistory.map(e=>`
        <tr>
          <td>${Pt(e.date)}</td>
          <td class="mono">${e.documentNo}</td>
          <td class="numeric">${E(e.amount)}</td>
        </tr>
      `).join("")}function Le(t){return t.paymentHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':t.paymentHistory.map(e=>`
        <tr>
          <td>${Pt(e.date)}</td>
          <td>${e.method}</td>
          <td class="numeric">${E(e.amount)}</td>
        </tr>
      `).join("")}function je(t,e){return`
    <section class="page-head">
      <div>
  ...
  `}function O(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function B(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function M(t,e){for(const n of e){const s=t[n];if(typeof s=="number"&&Number.isFinite(s))return s;if(typeof s=="string"){const i=Number(s);if(Number.isFinite(i))return i}}return null}function Pe(t){const e=t?.productTotals;if(!e||e.length===0)return"―";const n=e.reduce((i,c)=>{const o=M(c,["amount","salesAmount"]),p=M(c,["marginRate","grossMarginRate"]);return o===null||o<=0||p===null?i:{weightedAmount:i.weightedAmount+o,weightedRate:i.weightedRate+o*p}},{weightedAmount:0,weightedRate:0});if(n.weightedAmount>0)return`${(n.weightedRate/n.weightedAmount).toFixed(1)}%`;const s=e.reduce((i,c)=>{const o=c,p=M(o,["amount","salesAmount"]),r=M(o,["grossProfit","grossAmount","margin"]),l=M(o,["costAmount","cost","costPrice"]);if(p===null||p<=0)return i;const d=r??(l!==null?p-l:null);return d===null?i:{sales:i.sales+p,gross:i.gross+d}},{sales:0,gross:0});return s.sales>0?`${(s.gross/s.sales*100).toFixed(1)}%`:"―"}function _e(t){const s={top:20,right:20,bottom:30,left:50},i=760-s.left-s.right,c=260-s.top-s.bottom,o=Math.max(...t.map(d=>d.amount),1),p=i/t.length,r=t.map((d,u)=>{const h=d.amount/o*c,L=s.left+u*p+4,I=s.top+c-h,z=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(d.date));return`
        <g>
    ...
    <svg viewBox="0 0 760 260" class="sales-chart" role="img" aria-label="直近30日の日次売上">
      ${[0,.25,.5,.75,1].map(d=>{const u=s.top+c-c*d,h=Math.round(o*d/1e3);return`
        <g>
  ...
  `}function xe(t,e,n){const s={success:"正常",warning:"注意",error:"異常",running:"実行中"},i=t.salesRecords.slice(0,10).map(c=>`
            <tr>
  ...
  `}function Te(t){return t?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(t)):""}function P(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Me(t,e){const n=t.lines.length?t.lines.map((i,c)=>`
          <tr>
            ...
            <td>${i.unit}</td>
            <td class="numeric">${P(i.unitPrice)}</td>
            <td class="numeric">${P(i.amount)}</td>
          </tr>
    ...
    <article class="panel delivery-note-body" id="delivery-print-area">
      <div class="delivery-header">
        ...
        <div class="delivery-meta">
          <table class="delivery-meta-table">
            ...
            <tr><th>納品日</th><td>${Te(t.invoiceDate)}</td></tr>
            <tr><th>合計金額</th><td class="numeric">${P(t.totalAmount)}（税込）</td></tr>
          </table>
      ...
      <div class="delivery-footer">
        <div class="delivery-totals">
          <div class="total-stack"><span class="total-label">小計</span><span class="total-value">${P(s)}</span></div>
          <div class="total-stack"><span class="total-label">消費税（10%）</span><span class="total-value">${P(t.taxAmount)}</span></div>
          <div class="total-stack total-grand"><span class="total-label">合計（税込）</span><span class="total-value">${P(t.totalAmount)}</span></div>
        </div>
        ${t.note?`<p class="delivery-note-text">備考：${t.note}</p>`:""}
      </div>
    </article>
  `}function k(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Fe(t){return k(t).replaceAll(`
`,"<br />")}function qe(t){const n=[...Object.values(kt),{id:"custom",season:"カスタム",subject:"",body:""}].map(i=>`
        <button
  ...
  `}function F(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function _t(t){const e=t.resultsHtml.trim()?t.resultsHtml:`<p class="empty-note">${F(t.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function H(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ht(t){return t.trim().toLowerCase()}function Re(t,e){const n=ht(e),s=t.filter(c=>n?[c.code,c.name,c.name].map(ht).some(o=>o.includes(n)):!0).slice(0,50),i=s.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return _t({title:"得意先検索",searchQuery:e,placeholder:"コード・名前で検索",resultsHtml:i,emptyMessage:"該当する得意先が見つかりません。"})}function Ee(t){return t.toISOString().slice(0,10)}function A(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function C(t,e){return t[e]?`<div class="field-error">${A(t[e])}</div>`:""}function _(t,e,n=""){return[n,t[e]?"has-error":""].filter(Boolean).join(" ")}function Ie(t,e,n,s){const i=Object.keys(dt).map(r=>`<option value="${r}" ${t.invoiceType===r?"selected":""}>${dt[r]}</option>`).join(""),c=t.lines.map((r,l)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${_(s,`lines.${l}.productCode`,"input-cell")}" type="text" data-line="${l}" data-field="productCode" value="${A(r.productCode)}" placeholder="P00001" />
            <button class="picker-btn" type="button" data-action="open-product-picker" data-line="${l}" aria-label="商品検索">🔍</button>
          </div>
          ${C(s,`lines.${l}.productCode`)}
        </td>
        <td>
          <input class="${_(s,`lines.${l}.productName`,"input-cell")}" type="text" data-line="${l}" data-field="productName" value="${A(r.productName)}" placeholder="商品名" />
          ${C(s,`lines.${l}.productName`)}
        </td>
        <td>
          <input class="${_(s,`lines.${l}.quantity`,"input-cell numeric")}" type="number" data-line="${l}" data-field="quantity" value="${r.quantity}" min="0" />
          ${C(s,`lines.${l}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${l}" data-field="unit" value="${r.unit}" placeholder="本" /></td>
        <td>
          <input class="${_(s,`lines.${l}.unitPrice`,"input-cell numeric")}" type="number" data-line="${l}" data-field="unitPrice" value="${r.unitPrice}" min="0" />
          ${C(s,`lines.${l}.unitPrice`)}
        </td>
        <td class="numeric">${r.amount>0?r.amount.toLocaleString("ja-JP"):"―"}</td>
        <td>
          <div class="line-actions">
            <button class="button secondary" type="button" data-action="duplicate-line" data-line="${l}">コピー</button>
            <button class="button-icon" type="button" data-action="remove-line" data-line="${l}" title="削除">✕</button>
          </div>
        </td>
      </tr>
    `).join(""),o=t.lines.reduce((r,l)=>r+l.amount,0),p=Math.floor(o*10/110);return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${_(s,"invoiceDate")}" id="inv-date" type="date" value="${t.invoiceDate||Ee(new Date)}" />
          ${C(s,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
    ...
    <section class="panel">
      ...
      <div class="invoice-total-row">
        <div class="total-stack">
          ...
          <span class="total-value">${(o-p).toLocaleString("ja-JP")} 円</span>
        </div>
        <div class="total-stack">
  ...
  `}function Je(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function Oe(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Be(t,e){const n=t.length?t.map(s=>`
            <tr>
              ...
              <td class="numeric">${Oe(s.amount)}</td>
            </tr>
  ...
  `}function He(t){const e={planned:"neutral",active:"warning",done:"success"},n=t.map(o=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${e[o.status]}">${ae[o.status]}</span>
        </td>
        <td>${o.note||"―"}</td>
      </tr>
    `).join(""),s=t.filter(o=>o.status==="active").length,i=t.filter(o=>o.status==="done").length,c=t.filter(o=>o.status==="planned").length;return`
    <section class="page-head">
      <div>
  ...
  `}function Ye(t){const e={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},s=t.map(r=>`
    ...
    `).join(""),i=t.filter(r=>r.status==="approved").length,c=t.filter(r=>r.status==="submitted").length,o=t.filter(r=>r.status==="pending").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>検定管理</h1>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${t.filter(r=>r.status==="approved").reduce((r,l)=>r+l.volume,0).toLocaleString("ja-JP")} L</p>
  ...
  `}function Ke(t){return t.map(e=>`
      ...
      `).join("")}function Ue(t){return t.map(e=>`
        <tr>
          <td class="mono">${e.code}</td>
      ...
      <div class="table-wrap">
        ...
        `:`
          <table>
            ...
            <tbody>${Ue(t.products)}</tbody>
          </table>
        `}
      </div>
    </section>
  `}function G(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function We(t){const e=t.map(i=>{const o=(i.minimumStock>0?i.currentStock/i.minimumStock:1/0)<1.5;return`
        <tr>
          ...
          <td class="numeric">${G(i.unitCost)}</td>
          <td class="numeric">${G(i.currentStock*i.unitCost)}</td>
          <td>${i.lastUpdated}</td>
          <td>
  ...
  `}function Qe(t){return t?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t)):"-"}function Z(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}const ze={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Ge(t){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td class="numeric">${Z(n.billedAmount)}</td>
          <td class="numeric">${Z(n.paymentAmount)}</td>
          <td class="numeric">${Z(n.balanceAmount)}</td>
          <td>${Qe(n.lastPaymentDate)}</td>
  ...
  `}function x(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function yt(t){return t.trim().toLowerCase()}function Ze(t,e){const n=yt(e),s=t.filter(c=>n?[c.code,c.name,c.janCode].map(yt).some(o=>o.includes(n)):!0),i=s.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return _t({title:"商品検索",searchQuery:e,placeholder:"コード・名前・JANで検索",resultsHtml:i,emptyMessage:"該当する商品が見つかりません。"})}function w(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Xe(t,e){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},s={pending:"warning",confirmed:"neutral",paid:"success"},i={unpaid:"未払い",partial:"一部支払",paid:"支払済"},c={unpaid:"warning",partial:"neutral",paid:"success"},o=t.map(u=>`
      <tr>
    ...
    `).join(""),r=t.reduce((u,h)=>u+h.amount,0),l=e.reduce((u,h)=>u+h.balance,0),d=e.filter(u=>u.status!=="paid").length;return`
    <section class="page-head">
      <div>
  ...
  `}function q(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function ta(t,e){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},s={holding:"neutral",due:"warning",cleared:"success"},i=t.map(d=>`
      <tr>
    ...
    `).join(""),c=e.map(d=>{const u=d.minimumStock>0&&d.currentStock<d.minimumStock*1.2;return`
      ...
      `}).join(""),o=t.filter(d=>d.status==="holding"),p=o.reduce((d,u)=>d+u.amount,0),r=e.reduce((d,u)=>d+u.currentStock*u.unitCost,0),l=e.filter(d=>d.minimumStock>0&&d.currentStock<d.minimumStock*1.2).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">仕入管理</p>
        <h1>手形管理・原料在庫</h1>
  ...
  `}function ea(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function $(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function et(t){return`
  ...
  `}function aa(t,e,n){const s={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${ea(t.lastSyncAt)}</p>
    ...
    <section class="panel">
      ...
      ${T({step:2,title:"GitHub から relay ファイルを取得",purpose:"自動同期に必要なスクリプト一式を Windows PC に配置します。",instructions:["作業用フォルダとして C:\\\\sake-relay\\\\ のような書き込み可能な場所を決めます。","コマンドプロンプトを開き、下のコマンドを1行ずつ実行します。","ダウンロード完了後、relay フォルダに移動できていることを確認します。"],code:`git clone https://github.com/yuuuuuuuuki01/sake-system.git
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
      ...
      <div class="relay-config-list">
        ...
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${$(n)}</span>
          </div>
          <button
            class="button secondary"
            type="button"
  ...
  `}function sa(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function na(t){return t.replace("-","/")}function ia(t){if(t.length===0)return'<div class="chart-empty">データなし</div>';const e=760,n=280,s={top:16,right:24,bottom:36,left:64},i=e-s.left-s.right,c=n-s.top-s.bottom,o=Math.max(...t.map(d=>d.amount),1),p=i/t.length,r=[0,.25,.5,.75,1].map(d=>{const u=s.top+c-c*d,h=`${Math.round(o*d/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${s.left}" y1="${u}" x2="${e-s.right}" y2="${u}" class="chart-grid" />
          <text x="8" y="${u+4}" class="chart-axis">${h}</text>
        </g>
      `}).join(""),l=t.map((d,u)=>{const h=d.amount/o*c,L=Math.max(p-18,24),I=s.left+u*p+(p-L)/2,z=s.top+c-h;return`
        <g>
          <rect x="${I}" y="${z}" width="${L}" height="${h}" rx="6" class="analytics-bar" />
          <text x="${I+L/2}" y="${n-10}" class="chart-axis centered-axis">${na(d.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function ca(t){return t.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':t.map(e=>`
        <tr>
          <td class="mono">${e.code}</td>
          <td>${e.name}</td>
          <td class="numeric">${sa(e.amount)}</td>
          <td class="numeric">${e.quantity.toLocaleString("ja-JP")}</td>
          <td class="numeric">${e.documents.toLocaleString("ja-JP")}</td>
        </tr>
      `).join("")}function oa(t,e){const n=e==="products"?"商品別集計":"得意先別集計",s=e==="products"?t.productTotals:t.customerTotals;return`
    <section class="page-head">
      <div>
  ...
  `}function R(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function la(t){const e=Math.max(...t.salesByProduct.flatMap(c=>c.values),1),n=t.salesByProduct.map(c=>{const o=c.values.map((p,r)=>`
          <div class="bar-col">
    ...
    `).join(""),i=t.salesByCustomer.map(c=>{const o=c.values.reduce((p,r)=>p+r,0);return`
        <tr>
          <td>${c.label}</td>
          ${c.values.map(p=>`<td class="numeric">${(p/1e4).toFixed(0)}万</td>`).join("")}
          <td class="numeric"><strong>${R(o)}</strong></td>
        </tr>
      `}).join("");return`
    <section class="page-head">
      <div>
  ...
  `}function ra(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function da(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function vt(t){return t.toISOString().slice(0,10)}function ua(t,e,n){const s=t.length?t.map(i=>`
            <tr>
  ...
  `}function Y(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function pa(t,e,n,s){const i={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},c={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},o={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},p=t.map(u=>`
      <tr>
        <td>${u.saleTime}</td>
    ...
    `).join(""),l=t.reduce((u,h)=>u+h.amount,0),d=e.filter(u=>u.status==="new").length;return`
    <section class="page-head">
      <div>
  ...
  `}function ma(t){const e={empty:"空",in_use:"使用中",aging:"熟成中"},n={empty:"neutral",in_use:"warning",aging:"success"},s=t.map(l=>{const d=l.capacity>0?Math.round(l.currentVolume/l.capacity*100):0;return`
        <tr>
          <td class="mono"><strong>${l.tankNo}</strong></td>
          <td class="numeric">${l.capacity.toLocaleString("ja-JP")} L</td>
          <td class="numeric">${l.currentVolume>0?l.currentVolume.toLocaleString("ja-JP")+" L":"―"}</td>
          <td>
          ...
          <td>${l.lastUpdated}</td>
          <td>
            <button class="button-sm secondary" data-action="tank-detail" data-id="${l.id}">詳細</button>
          </td>
        </tr>
      `}).join(""),i=t.filter(l=>l.status==="in_use").length,c=t.filter(l=>l.status==="aging").length,o=t.filter(l=>l.status==="empty").length,p=t.reduce((l,d)=>l+d.capacity,0),r=t.reduce((l,d)=>l+d.currentVolume,0);return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>タンク管理</h1>
  ...
  `}function X(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function ha(t,e,n){const s=t.rows.map(c=>`
      <tr>
        ...
        <td class="numeric"><strong>${X(c.taxAmount)}</strong></td>
      </tr>
    `).join(""),i=Array.from({length:12},(c,o)=>o+1);return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${X(t.totalTax)}</p>
        ...
        <table>
          ...
          <tfoot>
            <tr>
              ...
              <th></th>
              <th class="numeric">${X(t.totalTax)}</th>
            </tr>
          </tfoot>
        </table>
      </div>
  ...
  `}const ya=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email"],K=[{name:"青葉商事",email:"aoba@example.jp",area:"関東",historySegment:"seasonal"},{name:"北斗酒販",email:"hokuto@example.jp",area:"北海道",historySegment:"premium"},{name:"中央フーズ",email:"chuo@example.jp",area:"関東",historySegment:"seasonal"},{name:"東海酒店",email:"tokai@example.jp",area:"中部",historySegment:"premium"},{name:"三和物産",email:"sanwa@example.jp",area:"関西",historySegment:"liqueur"},{name:"南星リカー",email:"nansei@example.jp",area:"九州",historySegment:"seasonal"},{name:"山川酒店",email:"yamakawa@example.jp",area:"関西",historySegment:"premium"},{name:"瑞穂商店",email:"mizuho@example.jp",area:"中部",historySegment:"seasonal"}];function xt(t){const e=kt[t];return e?{subject:e.subject,body:e.body}:{subject:"",body:""}}function st(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function va(){const t=xt("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:t.subject,body:t.body,saveMessage:null}}const Q=new Date,ba=Q.toISOString().slice(0,7),ga=Q.getFullYear(),$a=Q.getMonth()+1,fa=Q.toISOString().slice(0,10),ka="C0011",D=va();function Tt(t){const e="/sake-system/".endsWith("/")?"/sake-system/".slice(0,-1):"/sake-system/",n=t.startsWith(e)?t.slice(e.length)||"/":t;return ya.includes(n)?n:"/"}function nt(t){switch(t){case"/cat/sales":case"/invoice":case"/ledger":case"/invoice-entry":case"/delivery":case"/billing":case"/report":return"sales";case"/cat/brewery":case"/jikomi":case"/tanks":case"/kentei":case"/materials":return"brewery";case"/cat/purchase":case"/purchase":case"/raw-material":return"purchase";case"/cat/more":case"/master":case"/analytics":case"/tax":case"/store":case"/setup":return"more";case"/email":return"email";default:return"dashboard"}}const bt=Tt(location.pathname),a={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,invoiceRecords:[],customerLedger:null,salesAnalytics:null,invoiceForm:st(),invoiceSaving:!1,invoiceSavedDocNo:null,pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:ba,salesReport:null,jikomiList:[],tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:ga,taxMonth:$a,storeSales:[],storeOrders:[],storeTab:"pos",storeSalesDate:fa,route:bt,currentCategory:nt(bt),sidebarOpen:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:ka,masterTab:"customers",analyticsTab:"products",emailAudienceMode:D.mode,emailRegion:D.region,emailHistorySegment:D.historySegment,emailTemplateId:D.templateId,emailSubject:D.subject,emailBody:D.body,emailSaveMessage:D.saveMessage,loading:!0,actionLoading:!1,error:null};function gt(t){return t.slice(0,10)}function Sa(t){return{...t}}function W(){a.pickerMode=null,a.pickerQuery="",a.pickerTargetLine=null}function Mt(){a.invoiceForm=st(),a.invoiceSavedDocNo=null,a.invoiceErrors={},W()}function Ft(t){const e={};return t.invoiceDate.trim()||(e.invoiceDate="伝票日付は必須です。"),t.customerCode.trim()||(e.customerCode="得意先コードは必須です。"),t.lines.length===0&&(e.lines="明細を1行以上入力してください。"),t.lines.forEach((n,s)=>{n.productCode.trim()||(e[`lines.${s}.productCode`]="商品コードは必須です。"),n.productName.trim()||(e[`lines.${s}.productName`]="商品名は必須です。"),n.quantity<=0&&(e[`lines.${s}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(e[`lines.${s}.unitPrice`]="単価は0円以上で入力してください。")}),e}function Ca(t){const e=a.invoiceForm.lines[t];e&&a.invoiceForm.lines.splice(t+1,0,Sa(e))}function wa(){const t=a.invoiceRecords[0],e=a.masterStats?.customers[0],n=a.masterStats?.products.slice(0,2)??[];a.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:t?.customerCode??e?.code??"",customerName:t?.customerName??e?.name??"",staffCode:a.invoiceForm.staffCode||"S001",lines:n.map((s,i)=>{const c=i===0?1:2,o=1200*(i+1);return{productCode:s.code,productName:s.name,quantity:c,unitPrice:o,unit:"本",amount:c*o}}),note:t?`過去伝票 ${t.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},a.invoiceSavedDocNo=null,a.invoiceErrors={}}function Da(t){const e=a.masterStats?.customers.find(n=>n.code.toLowerCase()===t.trim().toLowerCase());return e?(a.invoiceForm.customerCode=e.code,a.invoiceForm.customerName=e.name,!0):!1}function Na(t){const e=a.masterStats?.customers.find(n=>n.name===t.trim());return e?(a.invoiceForm.customerCode=e.code,a.invoiceForm.customerName=e.name,!0):!1}function qt(t){if(f(t),a.invoiceErrors=Ft(a.invoiceForm),Object.keys(a.invoiceErrors).length>0){m();return}a.invoiceSaving=!0,m(),Gt(a.invoiceForm).then(e=>{a.invoiceSavedDocNo=e.documentNo,a.invoiceSaving=!1,a.invoiceErrors={},a.invoiceForm=st(),m()}).catch(()=>{a.invoiceSaving=!1,m()})}function Aa(t){const e=a.salesFilter.startDate?new Date(a.salesFilter.startDate):null,n=a.salesFilter.endDate?new Date(`${a.salesFilter.endDate}T23:59:59`):null;return[...t.salesRecords].sort((s,i)=>new Date(i.date).getTime()-new Date(s.date).getTime()).filter(s=>{const i=new Date(s.date);return!(e&&i<e||n&&i>n)})}function Rt(){switch(a.emailAudienceMode){case"area":return a.emailRegion==="all"?K:K.filter(t=>t.area===a.emailRegion);case"history":return K.filter(t=>t.historySegment===a.emailHistorySegment);default:return K}}function La(){const t=Rt();return{audienceMode:a.emailAudienceMode,region:a.emailRegion,historySegment:a.emailHistorySegment,selectedTemplateId:a.emailTemplateId,subject:a.emailSubject,body:a.emailBody,recipientCount:t.length,previewRecipients:t.slice(0,5),saveMessage:a.emailSaveMessage}}function $t(t){const e=Rt(),n=a.emailAudienceMode==="area"?a.emailRegion:a.emailAudienceMode==="history"?a.emailHistorySegment:"all";return{subject:a.emailSubject.trim(),body:a.emailBody.trim(),templateId:a.emailTemplateId,audienceMode:a.emailAudienceMode,audienceFilter:n,recipientCount:e.length,status:t}}function ja(t){const e=`${"/sake-system/".replace(/\/$/,"")}${t==="/"?"/":t}`;history.pushState(null,"",e),a.route=t,a.currentCategory=nt(t),a.sidebarOpen=!1,it(t)}async function it(t){a.actionLoading=!0,m();try{switch(t){case"/delivery":a.deliveryNote||(a.deliveryNote=await Nt(a.deliverySearchDocNo||"D240122"));break;case"/billing":a.billingSummary||(a.billingSummary=await At(a.billingYearMonth));break;case"/report":a.salesReport||(a.salesReport=await ee());break;case"/jikomi":a.jikomiList.length===0&&(a.jikomiList=await ne());break;case"/tanks":a.tankList.length===0&&(a.tankList=await ce());break;case"/kentei":a.kenteiList.length===0&&(a.kenteiList=await le());break;case"/materials":a.materialList.length===0&&(a.materialList=await de());break;case"/purchase":(a.purchaseList.length===0||a.payableList.length===0)&&([a.purchaseList,a.payableList]=await Promise.all([ye(),ve()]));break;case"/raw-material":(a.billList.length===0||a.rawStockList.length===0)&&([a.billList,a.rawStockList]=await Promise.all([be(),ge()]));break;case"/tax":a.taxDeclaration||(a.taxDeclaration=await Lt(a.taxYear,a.taxMonth));break;case"/store":(a.storeSales.length===0||a.storeOrders.length===0)&&([a.storeSales,a.storeOrders]=await Promise.all([jt(a.storeSalesDate),Se()]));break;default:break}}catch(e){console.warn("Route data load error",e)}finally{a.actionLoading=!1,m()}}function Pa(){if(a.loading)return'<section class="panel"><p>データを読み込んでいます。</p></section>';if(a.error)return`
      <section class="panel error-card">
        <p class="eyebrow">読込失敗</p>
        <h1>画面の初期化に失敗しました</h1>
        <p>${a.error}</p>
      </section>
    `;switch(a.route){case"/cat/sales":return J("sales");case"/cat/brewery":return J("brewery");case"/cat/purchase":return J("purchase");case"/cat/more":return J("more");case"/invoice-entry":return Ie(a.invoiceForm,a.invoiceSavedDocNo,a.invoiceSaving,a.invoiceErrors);case"/email":return qe(La());case"/delivery":return a.deliveryNote?Me(a.deliveryNote,a.deliverySearchDocNo):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/billing":return a.billingSummary?we(a.billingSummary,a.billingYearMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/report":return a.salesReport?la(a.salesReport):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/jikomi":return He(a.jikomiList);case"/tanks":return ma(a.tankList);case"/kentei":return Ye(a.kenteiList);case"/materials":return We(a.materialList);case"/purchase":return Xe(a.purchaseList,a.payableList);case"/raw-material":return ta(a.billList,a.rawStockList);case"/tax":return a.taxDeclaration?ha(a.taxDeclaration,a.taxYear,a.taxMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/store":return pa(a.storeSales,a.storeOrders,a.storeTab,a.storeSalesDate);case"/setup":return a.pipelineMeta?aa(a.pipelineMeta,Et,It):'<section class="panel"><p>データを読み込んでいます…</p></section>'}if(!a.salesSummary||!a.paymentStatus||!a.masterStats||!a.pipelineMeta||!a.customerLedger||!a.salesAnalytics)return"";switch(a.route){case"/sales":return ua(Aa(a.salesSummary),a.salesFilter.startDate,a.salesFilter.endDate);case"/payment":return Ge([...a.paymentStatus.records].sort((t,e)=>e.balanceAmount-t.balanceAmount));case"/master":return Ve(a.masterStats,a.masterTab);case"/invoice":return Be(a.invoiceRecords,a.invoiceFilter);case"/ledger":return je(a.customerLedger,a.ledgerCustomerCode);case"/analytics":return oa(a.salesAnalytics,a.analyticsTab);default:return xe(a.salesSummary,a.pipelineMeta,a.salesAnalytics)}}function _a(){const t={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売管理",items:[{path:"/cat/sales",label:"販売管理トップ",kicker:"Category"},{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/report",label:"集計帳票",kicker:"Report"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],brewery:[{label:"蔵内管理",items:[{path:"/cat/brewery",label:"蔵内管理トップ",kicker:"Category"},{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"}]}],purchase:[{label:"仕入管理",items:[{path:"/cat/purchase",label:"仕入管理トップ",kicker:"Category"},{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],more:[{label:"その他",items:[{path:"/cat/more",label:"その他トップ",kicker:"Category"},{path:"/tax",label:"酒税申告",kicker:"Tax"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/master",label:"マスタ",kicker:"Master"},{path:"/email",label:"メール配信",kicker:"Mail"},{path:"/setup",label:"連動設定",kicker:"Setup"}]}],email:[{label:"メール配信",items:[{path:"/email",label:"季節商品案内",kicker:"Mail"}]}]},e=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/cat/sales",label:"販売管理"},{category:"brewery",path:"/cat/brewery",label:"蔵内管理"},{category:"purchase",path:"/cat/purchase",label:"仕入管理"},{category:"more",path:"/cat/more",label:"その他"},{category:"email",path:"/email",label:"メール配信"}],n=t[a.currentCategory].map(c=>`
        <div class="nav-group">
      ...
      `).join(""),i=a.pickerMode&&a.masterStats?a.pickerMode==="customer"?Re(a.masterStats.customers,a.pickerQuery):Ze(a.masterStats.products,a.pickerQuery):"";return`
    <div class="shell">
      <button
        class="menu-toggle"
        type="button"
