(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))l(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&l(i)}).observe(document,{childList:!0,subtree:!0});function n(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function l(r){if(r.ep)return;r.ep=!0;const a=n(r);fetch(r.href,a)}})();const rs="modulepreload",cs=function(e){return"/"+e},Lt={},b=function(t,n,l){let r=Promise.resolve();if(n&&n.length>0){let d=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};var i=d;document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),c=o?.nonce||o?.getAttribute("nonce");r=d(n.map(u=>{if(u=cs(u),u in Lt)return;Lt[u]=!0;const p=u.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${h}`))return;const v=document.createElement("link");if(v.rel=p?"stylesheet":rs,p||(v.as="script"),v.crossOrigin="",v.href=u,c&&v.setAttribute("nonce",c),document.head.appendChild(v),p)return new Promise((f,w)=>{v.addEventListener("load",f),v.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${u}`)))})}))}function a(o){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=o,window.dispatchEvent(c),!c.defaultPrevented)throw o}return r.then(o=>{for(const c of o||[])c.status==="rejected"&&a(c.reason);return t().catch(a)})},V="https://loarwnuyvfxiscjjsmiz.supabase.co",R="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";async function Ve(e,t){try{const n=new URL(`/rest/v1/${e}`,V),l=await fetch(n.toString(),{method:"POST",headers:{apikey:R,Authorization:`Bearer ${R}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(t)});if(!l.ok)throw new Error(`HTTP ${l.status}`);return(await l.json())[0]??null}catch(n){return console.warn(`Failed to insert into Supabase table ${e}`,n),null}}async function ut(e,t,n){try{const l=new URL(`/rest/v1/${e}?id=eq.${t}`,V);return(await fetch(l.toString(),{method:"PATCH",headers:{apikey:R,Authorization:`Bearer ${R}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(n)})).ok}catch{return!1}}async function ia(e,t={}){try{const n=new URL(`/rest/v1/rpc/${e}`,V),l=await fetch(n.toString(),{method:"POST",headers:{apikey:R,Authorization:`Bearer ${R}`,"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)});if(!l.ok)throw new Error(`HTTP ${l.status}`);return await l.json()}catch(n){return console.warn(`Failed to call Supabase RPC ${e}`,n),null}}async function pt(e){try{const t=new URL(`/rest/v1/${e}`,V);t.searchParams.set("select","*"),t.searchParams.set("limit","0");const n=await fetch(t.toString(),{method:"GET",headers:{apikey:R,Authorization:`Bearer ${R}`,Accept:"application/json",Prefer:"count=exact"}});if(!n.ok)return 0;const l=n.headers.get("Content-Range");if(l){const r=l.match(/\/(\d+)/);if(r)return parseInt(r[1],10)}return 0}catch{return 0}}async function S(e,t={}){try{const n=new URL(`/rest/v1/${e}`,V);Object.entries(t).forEach(([r,a])=>{n.searchParams.set(r,a)});const l=await fetch(n.toString(),{method:"GET",headers:{apikey:R,Authorization:`Bearer ${R}`,Accept:"application/json",Prefer:"return=representation"}});if(!l.ok)throw new Error(`HTTP ${l.status}`);return await l.json()}catch(n){return console.warn(`Failed to query Supabase table ${e}`,n),[]}}async function F(e,t={},n=1e3){const l=[];let r=0;try{for(;;){const a=new URL(`/rest/v1/${e}`,V);Object.entries(t).forEach(([c,d])=>{a.searchParams.set(c,d)}),a.searchParams.set("limit",String(n)),a.searchParams.set("offset",String(r));const i=await fetch(a.toString(),{method:"GET",headers:{apikey:R,Authorization:`Bearer ${R}`,Accept:"application/json",Prefer:"return=representation"}});if(!i.ok)throw new Error(`HTTP ${i.status}`);const o=await i.json();if(l.push(...o),o.length<n)break;r+=n}return l}catch(a){return console.warn(`Failed to query all rows from Supabase table ${e}`,a),l.length>0?l:[]}}const q=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:R,SUPABASE_URL:V,supabaseCount:pt,supabaseInsert:Ve,supabaseQuery:S,supabaseQueryAll:F,supabaseRpc:ia,supabaseUpdate:ut},Symbol.toStringTag,{value:"Module"})),mt="sake_auth";function la(e){localStorage.setItem(mt,JSON.stringify(e))}function oa(){return{apikey:R,"Content-Type":"application/json"}}function ds(e){try{const[,t]=e.split(".");if(!t)return null;const n=t.replaceAll("-","+").replaceAll("_","/"),l=n.padEnd(Math.ceil(n.length/4)*4,"=");return JSON.parse(atob(l))}catch{return null}}async function ra(e,t){const n=await fetch(`${V}/auth/v1/${e}`,{method:"POST",headers:oa(),body:JSON.stringify(t)}),l=await n.json().catch(()=>({}));if(!n.ok)throw new Error(l.error_description??l.msg??`HTTP ${n.status}`);return l}async function us(e,t){const n=await ra("token?grant_type=password",{email:e,password:t});return la({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??e}}async function Dt(e,t){const n=await ra("signup",{email:e,password:t});return n.access_token&&n.refresh_token&&la({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??e}}async function ps(){const e=Je();if(localStorage.removeItem(mt),!!e?.access_token)try{await fetch(`${V}/auth/v1/logout`,{method:"POST",headers:{...oa(),Authorization:`Bearer ${e.access_token}`}})}catch(t){console.warn("Supabase sign out failed",t)}}function Je(){const e=localStorage.getItem(mt);if(!e)return null;try{const t=JSON.parse(e);return!t.access_token||!t.refresh_token?null:{access_token:t.access_token,refresh_token:t.refresh_token}}catch{return null}}function ms(){const e=Je();if(!e)return null;const t=ds(e.access_token),n=typeof t?.email=="string"?t.email:null;return n?{email:n}:null}async function ys(e){const t=Je();if(!t)throw new Error("not signed in");const n=await fetch(`${V}/auth/v1/user`,{method:"PUT",headers:{apikey:R,Authorization:`Bearer ${t.access_token}`,"Content-Type":"application/json"},body:JSON.stringify({password:e})});if(!n.ok){const l=await n.json().catch(()=>({}));throw new Error(l.msg??`HTTP ${n.status}`)}}const yt={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
ご注文締切や納品希望日がございましたら、あわせてお知らせください。`}},ca={generatedAt:new Date().toISOString(),kpis:{todaySales:0,todayDelta:0,monthSales:0,monthDelta:0,unpaidCount:0,unpaidAmount:0},dailySales:[],allDailySales:[],salesRecords:[]},hs={generatedAt:new Date().toISOString(),records:[]},Z={generatedAt:new Date().toISOString(),summary:{customerCount:0,activeCustomerCount:0,productCount:0,activeProductCount:0},customers:[],products:[]},vs={generatedAt:new Date().toISOString(),lastSyncAt:new Date().toISOString(),status:"success",jobName:"sake-relay",message:"データ未取得"},da=[],fs={},Pt={generatedAt:new Date().toISOString(),productTotals:[]};function A(e){if(typeof e=="number"&&Number.isFinite(e))return e;if(typeof e=="string"){const t=Number(e);return Number.isFinite(t)?t:0}return 0}function bs(e){switch((e??"").toLowerCase()){case"paid":case"complete":case"completed":return"paid";case"partial":case"partially_paid":case"partially paid":return"partial";default:return"unpaid"}}function gs(e){return typeof e=="boolean"?e:typeof e=="number"?e!==0:typeof e=="string"?["true","1","active","enabled","yes","y"].includes(e.toLowerCase()):!1}function m(e,t,n=""){for(const l of t){const r=e[l];if(typeof r=="string"&&r.length>0)return r}return n}function x(e,t,n=0){for(const l of t)if(l in e)return A(e[l]);return n}function B(e,t,n=!0){for(const l of t)if(l in e)return gs(e[l]);return n}function z(e,t,n){for(const l of t){const r=e[l];if(typeof r!="string"||r.length===0)continue;if(/^\d{4}-\d{2}-\d{2}$/.test(r))return new Date(`${r}T00:00:00Z`).toISOString();const a=new Date(r);if(!Number.isNaN(a.getTime()))return a.toISOString()}return n}function ht(e){return e.slice(0,7)}function vt(e,t){return{id:String(e.id??`invoice-${t+1}`),documentNo:e.document_no??e.legacy_document_no??`D${String(240100+t).padStart(6,"0")}`,date:z(e,["sales_date","document_date"],new Date().toISOString()),customerCode:e.customer_code??e.legacy_customer_code??`C${String(t+1).padStart(4,"0")}`,customerName:e.customer_name??e.customer_code??e.legacy_customer_code??"不明",itemCount:0,amount:A(e.total_amount??e.billed_amount)}}function qt(e,t){const n=t.startDate?new Date(`${t.startDate}T00:00:00`):null,l=t.endDate?new Date(`${t.endDate}T23:59:59`):null,r=t.documentNo.trim().toLowerCase(),a=t.customerCode.trim().toLowerCase();return e.filter(i=>{const o=new Date(i.date);return!(n&&o<n||l&&o>l||r&&!i.documentNo.toLowerCase().includes(r)||a&&!i.customerCode.toLowerCase().includes(a))}).sort((i,o)=>new Date(o.date).getTime()-new Date(i.date).getTime())}function Tt(e){const t=e.trim().toUpperCase(),n=fs[t];if(n)return n;const l=ca.salesRecords.find(r=>r.customerCode.toUpperCase()===t);return{customerCode:t||"未指定",customerName:l?.customerName??"該当得意先なし",balanceAmount:0,salesTotal:0,paymentTotal:0,salesHistory:[],paymentHistory:[]}}function $s(){const e=new Map,t=new Map,n=new Map;return da.forEach((l,r)=>{const a=ht(l.date);e.set(a,(e.get(a)??0)+l.amount);const i=t.get(l.customerCode)??{code:l.customerCode,name:l.customerName,amount:0,quantity:0,documents:0};i.amount+=l.amount,i.quantity+=l.itemCount,i.documents+=1,t.set(l.customerCode,i);const o=`P${String(r%4+1).padStart(5,"0")}`,c=Pt.productTotals[r%Pt.productTotals.length],d=n.get(o)??{code:o,name:c?.name??`商品${r+1}`,amount:0,quantity:0,documents:0};d.amount+=l.amount,d.quantity+=l.itemCount*12,d.documents+=1,n.set(o,d)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(e.entries()).sort(([l],[r])=>l.localeCompare(r)).map(([l,r])=>({month:l,amount:r})),productTotals:Array.from(n.values()).sort((l,r)=>r.amount-l.amount),customerTotals:Array.from(t.values()).sort((l,r)=>r.amount-l.amount)}}async function Ue(e,t){try{const n=await fetch(`/${e}`,{headers:{Accept:"application/json"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(n){return console.warn(`Failed to fetch ${e}, using fallback data`,n),t}}async function ua(){const e=await F("daily_sales_detail",{select:"sales_date,amount,document_count,bottles,volume_ml,price_per_bottle,price_per_liter",order:"sales_date.desc"});if(e.length>0){const[t,n]=await Promise.all([S("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"}),S("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,legacy_customer_code,customer_name,total_amount",order:"sales_date.desc",limit:"20"})]),r=new Date().toISOString().slice(0,10),a=r.slice(0,7),i=[...e].sort((v,f)=>v.sales_date.localeCompare(f.sales_date)).map(v=>({date:new Date(`${v.sales_date}T00:00:00Z`).toISOString(),amount:A(v.amount??v.sales_amount),bottles:A(v.bottles),volumeMl:A(v.volume_ml),pricePerBottle:A(v.price_per_bottle),pricePerLiter:A(v.price_per_liter)})),o=i.slice(-30),c=v=>A(v.amount??v.sales_amount),d=e.reduce((v,f)=>f.sales_date===r?v+c(f):v,0),u=e.reduce((v,f)=>f.sales_date.startsWith(a)?v+c(f):v,0),p=t.filter(v=>A(v.balance_amount)>0),h=n.map((v,f)=>({id:String(v.id??`sale-${f+1}`),documentNo:v.document_no??v.legacy_document_no??"",date:v.sales_date??"",customerCode:v.legacy_customer_code??"",customerName:v.customer_name??v.legacy_customer_code??"",amount:A(v.total_amount)}));return{generatedAt:new Date().toISOString(),kpis:{todaySales:d,todayDelta:0,monthSales:u,monthDelta:0,unpaidCount:p.length,unpaidAmount:p.reduce((v,f)=>v+A(f.balance_amount),0)},dailySales:o,allDailySales:i,salesRecords:h}}return Ue("data/api/latest/sales-summary.json",ca)}async function pa(){const e=await F("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"});return e.length>0?{generatedAt:new Date().toISOString(),records:e.map((t,n)=>{const l=t.legacy_customer_code??`UNKNOWN-${n+1}`;return{id:`payment-${l}-${n+1}`,customerCode:l,customerName:l,billedAmount:A(t.billed_amount),paymentAmount:A(t.paid_amount),balanceAmount:A(t.balance_amount),lastPaymentDate:null,status:bs(t.payment_status)}})}:Ue("data/api/latest/payment-status.json",hs)}async function ma(){const[e,t]=await Promise.all([F("customers"),F("products")]);if(e.length>0||t.length>0){const n=e.length?e.map((r,a)=>{const i=typeof r.memo=="string"?JSON.parse(r.memo||"{}"):r.memo??{};return{id:m(r,["id","customer_id","code"],`customer-${a+1}`),code:m(r,["code","customer_code","legacy_customer_code"],`C${String(a+1).padStart(4,"0")}`),name:m(r,["name","customer_name","display_name"],`Customer ${a+1}`),kanaName:m(r,["kana_name"],""),shortName:m(r,["short_name"],""),postalCode:m(r,["postal_code"],""),address1:m(r,["address1"],""),address2:m(r,["address2"],""),phone:m(r,["phone"],""),fax:m(r,["fax"],""),staffCode:m(r,["staff_code"],""),businessType:m(r,["business_type"],""),areaCode:m(r,["delivery_area_code"],""),closingDay:x(r,["closing_day","close_day"],31),paymentDay:x(r,["payment_day","due_day"],15),billingCycleType:m(r,["billing_cycle_type"],""),priceGroup:String(i.price_group??""),isActive:B(r,["is_active","active","enabled"],!0),lat:r.lat?Number(r.lat):void 0,lng:r.lng?Number(r.lng):void 0}}):Z.customers,l=t.length?t.map((r,a)=>({id:m(r,["id","product_id","code"],`product-${a+1}`),code:m(r,["code","product_code","legacy_product_code"],`P${String(a+1).padStart(5,"0")}`),janCode:m(r,["jan_code","jan","barcode"],""),name:m(r,["name","product_name","display_name"],`Product ${a+1}`),category:m(r,["category","category_name","category_code"],"未分類"),isActive:B(r,["is_active","active","enabled"],!0),listPrice:x(r,["list_price"],0),purchasePrice:x(r,["purchase_price"],0),salePrice:x(r,["default_sale_price","sale_price"],0),alcoholDegree:r.alcohol_degree!=null?Number(r.alcohol_degree):null,volumeMl:r.volume_ml!=null?Number(r.volume_ml):null,bottleType:m(r,["bottle_type"],""),polishRate:r.polish_rate!=null?Number(r.polish_rate):null})):Z.products;return{generatedAt:new Date().toISOString(),summary:{customerCount:e.length||Z.summary.customerCount,activeCustomerCount:e.length?n.filter(r=>r.isActive).length:Z.summary.activeCustomerCount,productCount:t.length||Z.summary.productCount,activeProductCount:t.length?l.filter(r=>r.isActive).length:Z.summary.activeProductCount},customers:n,products:l}}return Ue("data/api/latest/master-stats.json",Z)}function ya(){return Ue("data/api/latest/pipeline-meta.json",vs)}async function ha(){const e=await ia("get_sync_summary");return e&&e.tables?{tables:e.tables.map(t=>({tableName:t.name,displayName:t.display_name,rowCount:t.count,lastSyncAt:t.last_sync,tableType:t.type})),totalRawRecords:e.total_raw_records,totalNormalizedRecords:e.total_normalized_records,lastOverallSync:e.overall_freshness}:{tables:[],totalRawRecords:0,totalNormalizedRecords:0,lastOverallSync:null}}async function Oe(e){const t={select:"id,document_no,legacy_document_no,sales_date,document_date,customer_code,legacy_customer_code,customer_name,total_amount,billed_amount",order:"sales_date.desc"};e.startDate&&(t.sales_date=`gte.${e.startDate}`),e.endDate&&(t.sales_date=e.startDate?`gte.${e.startDate}`:`lte.${e.endDate}`),e.startDate&&e.endDate&&(t.and=`(sales_date.gte.${e.startDate},sales_date.lte.${e.endDate})`,delete t.sales_date);const n=[];e.customerCode.trim()&&n.push(`customer_code.ilike.*${e.customerCode.trim()}*`,`legacy_customer_code.ilike.*${e.customerCode.trim()}*`),e.documentNo.trim()&&n.push(`document_no.ilike.*${e.documentNo.trim()}*`,`legacy_document_no.ilike.*${e.documentNo.trim()}*`),n.length>0&&(t.or=`(${n.join(",")})`);const l=await S("sales_document_headers",{...t,limit:"500"}),r=l.length>0?await F("sales_document_lines",{select:"id,header_id,document_header_id,document_no,amount,line_amount"}):[];if(l.length>0){const a=new Map;r.forEach(o=>{const c=String(o.header_id??o.document_header_id??o.document_no??o.id??"");c&&a.set(c,(a.get(c)??0)+1)});const i=l.map((o,c)=>{const d=vt(o,c),u=String(o.id??o.document_no??o.legacy_document_no??"");return{...d,itemCount:a.get(u)??d.itemCount}});return qt(i,e)}return qt(da,e)}async function ft(e){const t=e.trim().toUpperCase();if(!t)return Tt("");const[n,l,r]=await Promise.all([S("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,document_date,customer_code,legacy_customer_code,customer_name,total_amount,billed_amount",or:`customer_code.eq.${t},legacy_customer_code.eq.${t}`,order:"sales_date.desc",limit:"50"}),S("customer_payments",{select:"id,customer_code,legacy_customer_code,payment_date,received_date,amount,payment_amount,method,payment_method",or:`customer_code.eq.${t},legacy_customer_code.eq.${t}`,order:"payment_date.desc",limit:"50"}),S("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"})]);if(n.length>0||l.length>0){const a=n.map((c,d)=>{const u=vt(c,d);return{id:u.id,date:u.date,documentNo:u.documentNo,amount:u.amount}}),i=l.map((c,d)=>({id:String(c.id??`payment-${d+1}`),date:z(c,["payment_date","received_date"],new Date().toISOString()),amount:A(c.payment_amount??c.amount),method:c.payment_method??c.method??"入金"})),o=r.find(c=>(c.legacy_customer_code??"").toUpperCase()===t);return{customerCode:t,customerName:n[0]?.customer_name??n[0]?.customer_code??n[0]?.legacy_customer_code??t,balanceAmount:A(o?.balance_amount),salesTotal:a.reduce((c,d)=>c+d.amount,0),paymentTotal:i.reduce((c,d)=>c+d.amount,0),salesHistory:a,paymentHistory:i}}return Tt(t)}async function Ye(){const[e,t,n]=await Promise.all([F("daily_sales_detail",{select:"sales_date,amount,bottles,volume_ml,price_per_bottle,price_per_liter",order:"sales_date.asc"}),F("sales_document_headers",{select:"id,document_no,legacy_document_no,sales_date,document_date,customer_code,legacy_customer_code,customer_name,total_amount,billed_amount"}),F("sales_document_lines",{select:"id,header_id,document_header_id,document_no,product_code,legacy_product_code,product_name,quantity,amount,line_amount"})]);if(e.length>0){const l=new Map;e.forEach(i=>{const o=ht(i.sales_date);l.set(o,(l.get(o)??0)+A(i.sales_amount))});const r=new Map;t.forEach((i,o)=>{const c=vt(i,o),d=r.get(c.customerCode)??{code:c.customerCode,name:c.customerName,amount:0,quantity:0,documents:0};d.amount+=c.amount,d.documents+=1,r.set(c.customerCode,d)});const a=new Map;return n.forEach((i,o)=>{const c=i.product_code??i.legacy_product_code??`P${String(o+1).padStart(5,"0")}`,d=a.get(c)??{code:c,name:i.product_name??c,amount:0,quantity:0,documents:0};d.amount+=A(i.line_amount??i.amount),d.quantity+=A(i.quantity),d.documents+=1,a.set(c,d)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(l.entries()).sort(([i],[o])=>i.localeCompare(o)).map(([i,o])=>({month:i,amount:o})).slice(-12),productTotals:Array.from(a.values()).sort((i,o)=>o.amount-i.amount),customerTotals:Array.from(r.values()).sort((i,o)=>o.amount-i.amount)}}return $s()}const nt={sales:"売上",return:"返品",export_return:"輸出戻入"};async function va(e){const t=e.lines.reduce((r,a)=>r+a.amount,0),n=`D${Date.now().toString().slice(-6)}`;return{id:(await Ve("sales_document_headers",{legacy_document_no:n,legacy_customer_code:e.customerCode,sales_date:e.invoiceDate,document_type:e.invoiceType,staff_code:e.staffCode,total_amount:t,status:"confirmed"}))?.id??`local-${n}`,documentNo:n,totalAmount:t,status:"confirmed",createdAt:new Date().toISOString()}}const Nt={documentNo:"",invoiceDate:"",customerCode:"",customerName:"",customerAddress:"",lines:[],totalAmount:0,taxAmount:0,note:""};async function bt(e){const t=await S("sales_document_headers",{select:"*",legacy_document_no:`eq.${e}`});if(t.length>0){const n=t[0],l=A(n.total_amount);return{documentNo:e,invoiceDate:m(n,["sales_date","document_date"],""),customerCode:m(n,["legacy_customer_code","customer_code"],""),customerName:m(n,["customer_name","legacy_customer_code"],""),customerAddress:"",lines:[],totalAmount:l,taxAmount:Math.floor(l*10/110),note:""}}return{...Nt,documentNo:e||Nt.documentNo}}const _s={targetYearMonth:"",closingDay:31,totalBilling:0,customers:[]};async function gt(e){const[t,n]=e.split("-").map(Number),l=`${e}-01`,r=`${e}-31`,[a,i,o]=await Promise.all([F("sales_document_headers",{select:"legacy_customer_code,customer_name,total_amount,billed_amount,sales_date",and:`(sales_date.gte.${l},sales_date.lte.${r})`}),F("customers",{select:"code,legacy_customer_code,name,closing_day"}),F("customer_payment_status",{select:"legacy_customer_code,billed_amount,paid_amount,balance_amount,payment_status"})]);if(a.length>0){const c=new Map,d=new Map;i.forEach(v=>{const f=m(v,["code","legacy_customer_code"],"");f&&d.set(f,x(v,["closing_day"],31))});const u=new Map;o.forEach(v=>{const f=v.legacy_customer_code??"";u.set(f,A(v.balance_amount))}),a.forEach(v=>{const f=v.legacy_customer_code??v.customer_code??"",w=c.get(f),$=A(v.total_amount??v.billed_amount);if(w)w.salesAmount+=$,w.taxAmount=Math.floor(w.salesAmount*10/110),w.billingAmount=w.salesAmount+w.prevBalance-w.paymentAmount;else{const E=Math.floor($*10/110),M=u.get(f)??0;c.set(f,{customerCode:f,customerName:v.customer_name??f,closingDay:d.get(f)??31,salesAmount:$,taxAmount:E,prevBalance:M,paymentAmount:0,billingAmount:$+M,status:"open"})}});const p=Array.from(c.values()).sort((v,f)=>f.billingAmount-v.billingAmount),h=p.reduce((v,f)=>v+f.billingAmount,0);return{targetYearMonth:e,closingDay:31,totalBilling:h,customers:p}}return{..._s,targetYearMonth:e}}const ws={generatedAt:new Date().toISOString(),months:[],salesByProduct:[],salesByCustomer:[],costSimulation:[]};async function He(){const[e,t]=await Promise.all([F("daily_sales_detail",{select:"sales_date,amount",order:"sales_date.asc"}),F("sales_document_lines",{select:"document_no,product_code,legacy_product_code,product_name,quantity,amount,line_amount"})]);if(e.length===0)return ws;const n=new Map;t.forEach(u=>{const p=u.product_code??u.legacy_product_code??"";p&&u.product_name&&n.set(p,u.product_name)});const l=new Map;e.forEach(u=>{const p=ht(u.sales_date);l.set(p,(l.get(p)??0)+A(u.sales_amount??u.amount))});const r=Array.from(l.keys()).sort().slice(-12),a=new Map;t.forEach(u=>{const p=u.product_code??u.legacy_product_code??"";if(!p)return;const h=A(u.line_amount??u.amount);a.set(p,(a.get(p)??0)+h)});const o=Array.from(a.entries()).sort((u,p)=>p[1]-u[1]).slice(0,10).map(([u,p])=>({label:n.get(u)??u,values:r.map(()=>Math.round(p/r.length))})),c=[],d=[];return{generatedAt:new Date().toISOString(),months:r,salesByProduct:o,salesByCustomer:c,costSimulation:d}}async function fa(e,t,n){try{return await Ve("feature_requests",{title:e,category:t,description:n}),!0}catch{return!1}}async function ba(e,t){return ut("customers",e,t)}async function ga(e,t){return ut("products",e,t)}async function $a(e,t){const n=e.find(i=>i.code===t);n?.priceGroup;const l=n?.priceGroup||t;let r="";try{const i=await S("customers",{select:"memo",legacy_customer_code:`eq.${t}`,limit:"1"});i[0]?.memo&&(r=(typeof i[0].memo=="string"?JSON.parse(i[0].memo):i[0].memo)?.price_type??"")}catch{}const a=new Map;if(l){const i=await S("customer_product_prices",{price_group:`eq.${l}`,select:"legacy_product_code,special_price"});for(const o of i)a.set(o.legacy_product_code,o.special_price)}return{priceType:r,priceGroup:l,individualPrices:a}}function _a(e,t){const n=t.individualPrices.get(e.code);if(n!=null&&n>0)return{price:n,label:"個別単価"};switch(t.priceType){case"000":if(e.purchasePrice>0)return{price:e.purchasePrice,label:"生産者価格"};break;case"001":if(e.listPrice>0)return{price:e.listPrice,label:"小売価格"};break;case"002":if(e.salePrice>0)return{price:e.salePrice,label:"卸価格"};break}return{price:e.salePrice||0,label:"標準価格"}}function wa(e){const t=[...e].sort((r,a)=>a.amount-r.amount),n=t.reduce((r,a)=>r+a.amount,0);if(n===0)return[];let l=0;return t.map(r=>{const a=r.amount/n*100;l+=a;const i=l<=70?"A":l<=90?"B":"C";return{...r,ratio:a,cumRatio:l,abcRank:i}})}async function ka(){const[e,t]=await Promise.all([Ye(),He()]),n=wa(e.customerTotals.map(l=>({code:l.code,name:l.name,amount:l.amount,documents:l.documents})));return{generatedAt:new Date().toISOString(),ranking:n,months:t.months,monthlyByCustomer:t.salesByCustomer}}async function Sa(){const[e,t]=await Promise.all([Ye(),He()]),n=wa(e.productTotals.map(i=>({code:i.code,name:i.name,amount:i.amount,quantity:i.quantity}))),l=n.reduce((i,o)=>i+o.amount,0),r=new Set(n.filter(i=>i.abcRank==="A").map(i=>i.name)),a=t.salesByProduct.filter(i=>r.has(i.label));return{generatedAt:new Date().toISOString(),totalAmount:l,ranking:n,months:t.months,monthlyByProduct:a.length>0?a:t.salesByProduct}}const xa={planned:"計画中",active:"仕込中",done:"完了"};async function Aa(){const e=await S("brewing_batches",{order:"start_date.desc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),jikomiNo:m(t,["batch_no","legacy_batch_no"],""),productName:m(t,["brand_name"],""),riceType:m(t,["rice_type"],""),plannedKg:x(t,["planned_rice_kg"],0),actualKg:x(t,["actual_rice_kg"],0),startDate:z(t,["start_date"],""),expectedDoneDate:z(t,["expected_done_date"],""),status:m(t,["status"],"planned"),tankNo:m(t,["tank_no"],""),note:m(t,["remarks"],"")})):[]}async function Ea(){const e=await S("tanks",{order:"tank_no.asc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),tankNo:m(t,["tank_no"],""),capacity:x(t,["capacity_l"],0),currentVolume:x(t,["current_volume_l"],0),productName:m(t,["current_product_code"],""),jikomiNo:m(t,["current_batch_id"],""),status:m(t,["status"],"empty"),lastUpdated:z(t,["last_updated_at"],"")})):[]}async function Ca(){const e=await S("kentei_records",{order:"kentei_date.desc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),kenteiNo:m(t,["kentei_no"],""),jikomiNo:m(t,["batch_id"],""),productName:m(t,["product_code"],""),kenteiDate:z(t,["kentei_date"],""),alcoholDegree:x(t,["alcohol_degree"],0),extractDegree:x(t,["extract_degree"],0),sakaMeterValue:x(t,["sakemeter_value"],0),volume:x(t,["volume_l"],0),taxCategory:m(t,["tax_category_code"],""),status:m(t,["status"],"pending")})):[]}async function it(){const e=await S("materials",{order:"name.asc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),code:m(t,["material_code","legacy_material_code"],""),name:m(t,["name"],""),unit:m(t,["unit"],""),currentStock:x(t,["current_stock"],0),minimumStock:x(t,["minimum_stock"],0),unitCost:x(t,["unit_cost"],0),lastUpdated:z(t,["updated_at"],"")})):[]}async function Ia(){const e=await S("purchase_document_headers",{order:"purchase_date.desc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),documentNo:m(t,["document_no","legacy_document_no"],""),purchaseDate:z(t,["purchase_date"],""),supplierCode:m(t,["supplier_code","legacy_supplier_code"],""),supplierName:m(t,["supplier_name"],""),itemName:"",quantity:0,unitPrice:0,amount:x(t,["total_amount"],0),status:m(t,["payment_status"],"pending")})):[]}async function La(){const e=await S("supplier_payment_status",{order:"legacy_supplier_code.asc"});return e.length>0?e.map(t=>({supplierCode:m(t,["supplier_code","legacy_supplier_code"],""),supplierName:m(t,["legacy_supplier_code"],""),totalPurchase:x(t,["total_purchase"],0),paidAmount:x(t,["paid_amount"],0),balance:x(t,["balance"],0),nextPaymentDate:z(t,["next_payment_date"],""),status:m(t,["status"],"unpaid")})):[]}async function Da(){const e=await S("bills_of_exchange",{order:"due_date.desc"});return e.length>0?e.map(t=>({id:m(t,["id"],""),billNo:m(t,["bill_no"],""),supplierName:m(t,["counterparty_name"],""),amount:x(t,["amount"],0),issueDate:z(t,["issue_date"],""),dueDate:z(t,["due_date"],""),status:m(t,["status"],"holding")})):[]}async function Pa(){const e=await S("raw_materials",{order:"name.asc"});return e.length>0?e.map(t=>({code:m(t,["material_code","legacy_material_code"],""),name:m(t,["name"],""),unit:m(t,["unit"],""),currentStock:x(t,["current_stock"],0),minimumStock:x(t,["minimum_stock"],0),lastPurchaseDate:z(t,["last_purchase_date"],""),unitCost:x(t,["unit_cost"],0)})):[]}const qa=[{code:"01",name:"清酒（普通酒）",taxRatePerLiter:100},{code:"02",name:"清酒（純米酒）",taxRatePerLiter:100},{code:"03",name:"清酒（吟醸酒）",taxRatePerLiter:100},{code:"04",name:"清酒（大吟醸酒）",taxRatePerLiter:100},{code:"05",name:"本格焼酎",taxRatePerLiter:250},{code:"06",name:"リキュール",taxRatePerLiter:200},{code:"07",name:"果実酒",taxRatePerLiter:100},{code:"08",name:"その他醸造酒",taxRatePerLiter:100}],lt={export:"輸出",sample:"見本",research:"試験醸造",loss:"欠減"},ks={targetYear:0,targetMonth:0,companyName:"",companyNo:"",companyAddress:"",companyRepresentative:"",taxOffice:"",rows:[],deductions:[],totalVolume:0,totalTax:0,status:"draft",submittedAt:null};async function $t(e,t){const n=await S("tax_declarations",{target_year:`eq.${e}`,target_month:`eq.${t}`,limit:"1"});if(n.length>0){const l=n[0],r=m(l,["id"],""),[a,i]=await Promise.all([S("tax_declaration_rows",{declaration_id:`eq.${r}`,order:"tax_category_code.asc"}),S("tax_deductions",{declaration_id:`eq.${r}`})]),o=a.map(d=>({taxCategory:m(d,["tax_category_code"],""),taxCategoryName:m(d,["tax_category_name"],""),alcoholDegree:x(d,["alcohol_degree"],0),volume:x(d,["taxable_volume"],0),taxRate:x(d,["tax_rate"],0),taxAmount:x(d,["tax_amount"],0),productionVolume:x(d,["production_volume"],0),previousBalance:x(d,["previous_balance"],0),currentAdjustment:x(d,["current_adjustment"],0),exportDeduction:x(d,["export_deduction"],0),sampleDeduction:x(d,["sample_deduction"],0),taxableVolume:x(d,["taxable_volume"],0)})),c=i.map(d=>({type:m(d,["deduction_type"],"sample"),categoryCode:m(d,["tax_category_code"],""),volume:x(d,["volume"],0),reason:m(d,["reason"],""),documentNo:m(d,["reference_document_no"],"")||void 0}));return{targetYear:e,targetMonth:t,companyName:m(l,["company_name"],""),companyNo:m(l,["company_no"],""),companyAddress:m(l,["company_address"],""),companyRepresentative:m(l,["company_representative"],""),taxOffice:m(l,["tax_office"],""),rows:o,deductions:c,totalVolume:x(l,["total_taxable_volume"],0),totalTax:x(l,["total_tax_amount"],0),status:m(l,["status"],"draft"),submittedAt:m(l,["submitted_at"],"")||null}}return{...ks,targetYear:e,targetMonth:t}}function J(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;")}function Ta(e){const t=e.rows.map(l=>`    <Category>
      <Code>${J(l.taxCategory)}</Code>
      <Name>${J(l.taxCategoryName)}</Name>
...
`),n=e.deductions.map(l=>`    <Deduction type="${J(l.type)}">
      <CategoryCode>${J(l.categoryCode)}</CategoryCode>
      <Volume>${l.volume}</Volume>
      <Reason>${J(l.reason)}</Reason>${l.documentNo?`
      <DocumentNo>${J(l.documentNo)}</DocumentNo>`:""}
    </Deduction>`).join(`
...
`}function Ss(e){const t=String(e);return/[,"\n]/.test(t)?`"${t.replaceAll('"','""')}"`:t}function xs(e){const n=["酒類コード","区分名","アルコール度数","製造数量","前月繰越","当月調整","輸出控除","見本等控除","課税数量","税率(円/L)","税額(円)"].join(","),l=e.rows.map(a=>[a.taxCategory,a.taxCategoryName,a.alcoholDegree,a.productionVolume,a.previousBalance,a.currentAdjustment,a.exportDeduction,a.sampleDeduction,a.taxableVolume,a.taxRate,a.taxAmount].map(Ss).join(",")),r=`,合計,,${e.rows.reduce((a,i)=>a+i.productionVolume,0)},,,${e.rows.reduce((a,i)=>a+i.exportDeduction,0)},${e.rows.reduce((a,i)=>a+i.sampleDeduction,0)},${e.totalVolume},,${e.totalTax}`;return"\uFEFF"+[n,...l,r].join(`
`)+`
`}function As(e){const t=e.rows.map(r=>{const a=Math.max(0,r.productionVolume+r.previousBalance+r.currentAdjustment-r.exportDeduction-r.sampleDeduction),i=Math.round(a*r.taxRate);return{...r,taxableVolume:a,volume:a,taxAmount:i}}),n=t.reduce((r,a)=>r+a.taxableVolume,0),l=t.reduce((r,a)=>r+a.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:l}}async function Es(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>q);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:Ta(e),submitted_at:e.submittedAt})}async function _t(e){const t=await S("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(n=>({id:m(n,["id"],""),saleDate:m(n,["sale_date"],e),saleTime:m(n,["sale_time"],""),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),quantity:x(n,["quantity"],0),unitPrice:x(n,["unit_price"],0),amount:x(n,["amount"],0),paymentMethod:m(n,["payment_method"],"cash")})):[]}async function Na(){const e=await S("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),orderDate:z(t,["order_date"],""),customerName:m(t,["customer_name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["shipping_address"],""),items:[],totalAmount:x(t,["total_amount"],0),status:m(t,["status"],"new"),shippingDate:z(t,["shipping_date"],"")})):[]}async function Re(e){const t=await Ve("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function Ra(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function Cs(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await S("print_layouts",t)).map(l=>({id:m(l,["id"],""),name:m(l,["name"],""),templateKey:m(l,["template_key"],""),positions:l.positions??{},isDefault:B(l,["is_default"],!1),note:m(l,["note"],""),updatedAt:m(l,["updated_at"],"")}))}async function Is(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:r}=await Promise.resolve().then(()=>q);return{supabaseInsert:r}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},l=await t("print_layouts",n);return l?{id:m(l,["id"],e.id),name:m(l,["name"],e.name),templateKey:m(l,["template_key"],e.templateKey),positions:l.positions??e.positions,isDefault:B(l,["is_default"],!1),note:m(l,["note"],""),updatedAt:m(l,["updated_at"],"")}:null}async function Ls(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function Ds(){return(await S("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),signature:m(t,["signature"],""),replyTo:m(t,["reply_to"],""),isDefault:B(t,["is_default"],!1),isVerified:B(t,["is_verified"],!1),note:m(t,["note"],"")}))}async function Ps(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:m(n,["id"],e.id),name:m(n,["name"],e.name),email:m(n,["email"],e.email),displayName:m(n,["display_name"],""),signature:m(n,["signature"],""),replyTo:m(n,["reply_to"],""),isDefault:B(n,["is_default"],!1),isVerified:B(n,["is_verified"],!1)}:null}async function qs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const wt={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},kt={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Ts(e){const t=`${e}-01T00:00:00Z`,[n,l]=e.split("-").map(o=>parseInt(o,10)),r=new Date(n,l,0).getDate(),a=`${e}-${String(r).padStart(2,"0")}T23:59:59Z`;return(await S("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${a})`,order:"starts_at.asc"})).map(o=>({id:m(o,["id"],""),title:m(o,["title"],""),description:m(o,["description"],""),category:m(o,["category"],"general")||"general",startsAt:m(o,["starts_at"],new Date().toISOString()),endsAt:m(o,["ends_at"],""),isAllDay:B(o,["is_all_day"],!1),location:m(o,["location"],""),attendees:o.attendees??[],relatedCustomerCode:m(o,["related_customer_code"],""),relatedOrderId:m(o,["related_order_id"],""),color:m(o,["color"],""),googleEventId:m(o,["google_event_id"],"")}))}async function Ns(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??kt[e.category],updated_at:new Date().toISOString()})?e:null}async function Rs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ja(){return(await S("integration_settings",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),provider:m(t,["provider"],""),config:t.config??{},isEnabled:B(t,["is_enabled"],!1),lastSyncAt:m(t,["last_sync_at"],""),lastStatus:m(t,["last_status"],"")}))}async function Se(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function js(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const l=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,r=await fetch(l,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const a=await r.json(),{supabaseInsert:i}=await b(async()=>{const{supabaseInsert:c}=await Promise.resolve().then(()=>q);return{supabaseInsert:c}},void 0);let o=0;for(const c of a.orders){const d=`shopify_${c.id}`;await i("shopify_orders",{id:d,shopify_order_id:String(c.id),order_number:String(c.order_number??""),order_date:String(c.created_at??new Date().toISOString()),customer_name:String(c.customer?.first_name??"")+" "+String(c.customer?.last_name??""),customer_email:String(c.customer?.email??""),total_amount:Math.round(parseFloat(String(c.total_price??"0"))),financial_status:String(c.financial_status??""),fulfillment_status:String(c.fulfillment_status??"unfulfilled"),line_items:c.line_items??[],shipping_address:c.shipping_address??null,raw_payload:c}),o++}return await Se({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${o}件取得成功`}),{count:o}}catch(l){return{count:0,error:l instanceof Error?l.message:String(l)}}}async function Os(){return(await S("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),shopifyOrderId:m(t,["shopify_order_id"],""),orderNumber:m(t,["order_number"],""),orderDate:m(t,["order_date"],""),customerName:m(t,["customer_name"],""),customerEmail:m(t,["customer_email"],""),totalAmount:A(t.total_amount),financialStatus:m(t,["financial_status"],""),fulfillmentStatus:m(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function Ms(e){const t=e.config.refresh_token,n=e.config.client_id,l=e.config.client_secret;if(!t||!n||!l)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const r=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:n,client_secret:l})});if(!r.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${r.status}`};const i=(await r.json()).access_token;return await Se({...e,config:{...e.config,oauth_token:i}}),e.config.oauth_token=i,{token:i}}async function Fs(e){let t=e.config.oauth_token;const n=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const l=new Date().toISOString(),r=new Date(Date.now()+30*86400*1e3).toISOString(),a=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${l}&timeMax=${r}&singleEvents=true&orderBy=startTime`;let i=await fetch(a,{headers:{Authorization:`Bearer ${t}`}});if(i.status===401){const u=await Ms(e);if(u.error)return{count:0,error:u.error};t=u.token,i=await fetch(a,{headers:{Authorization:`Bearer ${t}`}})}if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const o=await i.json(),{supabaseInsert:c}=await b(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>q);return{supabaseInsert:u}},void 0);let d=0;for(const u of o.items){const p=`gcal_${u.id}`,h=u.start?.dateTime??u.start?.date??"",v=u.end?.dateTime??u.end?.date??"";await c("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(h),ends_at:String(v),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),d++}return await Se({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${d}件取得`}),{count:d}}catch(l){return{count:0,error:l instanceof Error?l.message:String(l)}}}async function Bs(){return(await S("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),receivedAt:m(t,["received_at"],""),senderPhone:m(t,["sender_phone"],""),senderName:m(t,["sender_name"],""),imageUrl:m(t,["image_url"],""),ocrStatus:m(t,["ocr_status"],"pending")||"pending",ocrText:m(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:m(t,["linked_invoice_id"],"")}))}async function zs(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const l=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,r=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return r.ok?{text:(await r.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${r.status}`}}catch(l){return{text:"",error:l instanceof Error?l.message:String(l)}}}async function Vs(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Me={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Fe={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function Js(){return(await S("user_profiles",{order:"display_name.asc"})).map(t=>({id:m(t,["id"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),staffCode:m(t,["staff_code"],""),department:m(t,["department"],"all")||"all",role:m(t,["role"],"staff")||"staff",defaultMailSenderId:m(t,["default_mail_sender_id"],""),phone:m(t,["phone"],""),avatarUrl:m(t,["avatar_url"],""),isActive:B(t,["is_active"],!0),lastSignInAt:m(t,["last_sign_in_at"],""),createdAt:m(t,["created_at"],"")}))}async function Us(e){if(!e)return null;const t=await S("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:m(n,["id"],""),email:m(n,["email"],""),displayName:m(n,["display_name"],""),staffCode:m(n,["staff_code"],""),department:m(n,["department"],"all")||"all",role:m(n,["role"],"staff")||"staff",defaultMailSenderId:m(n,["default_mail_sender_id"],""),phone:m(n,["phone"],""),avatarUrl:m(n,["avatar_url"],""),isActive:B(n,["is_active"],!0),lastSignInAt:m(n,["last_sign_in_at"],"")}}async function Ys(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function Hs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Xs(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>q);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function Gs(e=100){return(await S("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),action:m(n,["action"],""),entityType:m(n,["entity_type"],""),entityId:m(n,["entity_id"],""),userEmail:m(n,["user_email"],""),changes:n.changes??{},createdAt:m(n,["created_at"],"")}))}const Be={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function Oa(){return(await S("slack_notifications",{order:"event_type.asc"})).map(t=>({id:m(t,["id"],""),eventType:m(t,["event_type"],"new_order"),enabled:B(t,["enabled"],!0),channel:m(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:m(t,["last_triggered_at"],"")}))}async function Qs(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function Ws(e=50){return(await S("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),eventType:m(n,["event_type"],""),channel:m(n,["channel"],""),message:m(n,["message"],""),status:m(n,["status"],"sent"),error:m(n,["error"],""),sentAt:m(n,["sent_at"],"")}))}async function Ks(e,t,n){const r=(await ja()).find(d=>d.provider==="slack");if(!r||!r.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const a=r.config.webhook_url;if(!a)return{ok:!1,error:"Webhook URL未設定"};const o=(await Oa()).find(d=>d.eventType===e&&d.enabled);if(!o)return{ok:!1,error:"通知ルールが無効"};const c=n??o.channel??r.config.default_channel??"#general";try{const d=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${Be[e]} ${t}`,channel:c})}),u=d.ok,{supabaseInsert:p}=await b(async()=>{const{supabaseInsert:h}=await Promise.resolve().then(()=>q);return{supabaseInsert:h}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:c,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${d.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${d.status}`}}catch(d){return{ok:!1,error:d instanceof Error?d.message:String(d)}}}const xe={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Xe={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function Zs(){return(await S("prospects",{order:"updated_at.desc"})).map(t=>({id:m(t,["id"],""),companyName:m(t,["company_name"],""),contactName:m(t,["contact_name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),address:m(t,["address"],""),website:m(t,["website"],""),businessType:m(t,["business_type"],""),stage:m(t,["stage"],"cold"),source:m(t,["source"],""),expectedAmount:A(t.expected_amount),probability:A(t.probability),assignedStaffCode:m(t,["assigned_staff_code"],""),nextActionDate:m(t,["next_action_date"],""),nextAction:m(t,["next_action"],""),note:m(t,["note"],""),lastContactAt:m(t,["last_contact_at"],""),wonAt:m(t,["won_at"],""),lostAt:m(t,["lost_at"],""),lostReason:m(t,["lost_reason"],""),convertedCustomerCode:m(t,["converted_customer_code"],""),createdAt:m(t,["created_at"],"")}))}async function Ma(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function en(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function tn(e){return(await S("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:m(n,["id"],""),prospectId:m(n,["prospect_id"],""),activityType:m(n,["activity_type"],"call"),title:m(n,["title"],""),description:m(n,["description"],""),activityDate:m(n,["activity_date"],""),result:m(n,["result"],""),staffCode:m(n,["staff_code"],"")}))}async function an(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const Fa=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function sn(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function nn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ln(){return(await S("delivery_locations",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),customerCode:m(t,["customer_code"],""),name:m(t,["name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:m(t,["contact_name"],""),phone:m(t,["phone"],""),deliveryNote:m(t,["delivery_note"],""),isActive:B(t,["is_active"],!0)}))}async function on(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function rn(e=50){return(await S("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),callDirection:m(n,["call_direction"],"inbound"),fromNumber:m(n,["from_number"],""),toNumber:m(n,["to_number"],""),matchedCustomerCode:m(n,["matched_customer_code"],""),matchedProspectId:m(n,["matched_prospect_id"],""),durationSeconds:A(n.duration_seconds),callStatus:m(n,["call_status"],"answered"),recordingUrl:m(n,["recording_url"],""),transcript:m(n,["transcript"],""),ivryCallId:m(n,["ivry_call_id"],""),startedAt:m(n,["started_at"],""),endedAt:m(n,["ended_at"],""),notes:m(n,["notes"],"")}))}async function Ba(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function cn(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const l=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,r=await fetch(l,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const i=(await r.json()).calls??[];let o=0;for(const c of i)await Ba({id:`ivry_${c.id}`,callDirection:String(c.direction??"inbound"),fromNumber:String(c.from??""),toNumber:String(c.to??""),durationSeconds:Number(c.duration??0),callStatus:String(c.status??"answered"),recordingUrl:String(c.recording_url??""),startedAt:String(c.started_at??""),endedAt:String(c.ended_at??""),ivryCallId:String(c.id??"")}),o++;return await Se({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${o}件取得`}),{count:o}}catch(l){return{count:0,error:l instanceof Error?l.message:String(l)}}}async function dn(e,t){const n=e.config.api_key,l=e.config.team_id;if(!n||!l)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let r=0;for(const a of t){if(!a.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${l}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:a.name,phone_number:a.phone,external_id:a.customerCode??"",note:a.note??""})})).ok&&r++}return{synced:r}}catch(r){return{synced:0,error:r instanceof Error?r.message:String(r)}}}async function un(){return(await S("lead_lists",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),query:m(t,["query"],""),area:m(t,["area"],""),businessType:m(t,["business_type"],""),totalCount:A(t.total_count),source:m(t,["source"],"manual"),createdAt:m(t,["created_at"],"")}))}async function pn(e){return(await S("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:m(n,["id"],""),listId:m(n,["list_id"],""),companyName:m(n,["company_name"],""),address:m(n,["address"],""),phone:m(n,["phone"],""),website:m(n,["website"],""),email:m(n,["email"],""),businessType:m(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:A(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:m(n,["place_id"],""),status:m(n,["status"],"new"),convertedProspectId:m(n,["converted_prospect_id"],""),note:m(n,["note"],"")}))}async function mn(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function za(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function yn(e,t,n){const l=e.config.api_key;if(!l)return{results:[],error:"Google Maps API key 未設定"};const r=`${t} ${n}`.trim(),a=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(r)}&language=ja&key=${l}`;try{const i=await fetch(a);if(!i.ok)return{results:[],error:`HTTP ${i.status}`};const o=await i.json();return o.status!=="OK"&&o.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${o.status}`}:{results:o.results.map(d=>{const u=d.geometry?.location;return{id:`place_${d.place_id}`,listId:"",companyName:String(d.name??""),address:String(d.formatted_address??""),rating:d.rating?Number(d.rating):void 0,reviewCount:d.user_ratings_total?Number(d.user_ratings_total):void 0,lat:u?.lat,lng:u?.lng,placeId:String(d.place_id??""),status:"new"}})}}catch(i){return{results:[],error:i instanceof Error?i.message:String(i)}}}async function hn(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await Ma(t);return n&&await za({...e,status:"imported",convertedProspectId:t.id}),n}async function vn(){return(await S("workflow_orders",{order:"order_date.desc"})).map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),customerName:m(t,["customer_name"],""),customerCode:m(t,["customer_code"],""),orderDate:m(t,["order_date"],""),deliveryDate:m(t,["delivery_date"],""),stage:m(t,["stage"],"new"),totalAmount:A(t.total_amount),itemCount:A(t.item_count),priority:m(t,["priority"],"normal"),staffName:m(t,["staff_name"],""),notes:m(t,["notes"],"")}))}async function fn(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function bn(){return(await S("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),visitDate:m(t,["visit_date"],""),partySize:A(t.party_size)||1,language:m(t,["language"],"ja"),purpose:m(t,["purpose"],""),message:m(t,["message"],""),status:m(t,["status"],"new"),repliedAt:m(t,["replied_at"],""),confirmedTime:m(t,["confirmed_time"],""),createdAt:m(t,["created_at"],new Date().toISOString())}))}async function gn(e){const{supabaseInsert:t}=await b(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const $n=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function Va(){return(await Promise.all($n.map(async t=>{const[n,l]=await Promise.all([pt(t.table),S(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:l[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function je(e,t,n=100){const l=(t-1)*n,[r,a]=await Promise.all([S(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(l)}),pt(e)]);return{records:r,total:a}}async function ot(e){const t=await S("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const l=JSON.parse(n);return String(l.price_group??"")}catch{return""}return""}async function Ja(e,t){if(e){const l=await S("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(l.length>0&&l[0].special_price)return A(l[0].special_price)}const n=await S("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?A(n[0].default_sale_price):0}const _=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:kt,CALENDAR_CATEGORY_LABELS:wt,DEPT_LABELS:Fe,INVOICE_TYPE_LABELS:nt,JIKOMI_STATUS_LABELS:xa,MATERIAL_CATEGORIES:Fa,PROSPECT_STAGE_COLORS:Xe,PROSPECT_STAGE_LABELS:xe,ROLE_LABELS:Me,SEASONAL_TEMPLATES:yt,SLACK_EVENT_LABELS:Be,TAX_DEDUCTION_LABELS:lt,TAX_RATE_CATEGORIES:qa,convertLeadToProspect:hn,deleteCalendarEvent:Rs,deleteMailSender:qs,deleteMaterial:nn,deletePrintLayout:Ls,deleteProspect:en,deleteUserProfile:Hs,fetchAuditLogs:Gs,fetchBillList:Da,fetchBillingSummary:gt,fetchCalendarEvents:Ts,fetchCallLogs:rn,fetchCustomerAnalysis:ka,fetchCustomerLedger:ft,fetchCustomerPriceGroup:ot,fetchCustomerPricing:$a,fetchDeliveryLocations:ln,fetchDeliveryNote:bt,fetchFaxInbox:Bs,fetchIntegrationSettings:ja,fetchInvoices:Oe,fetchJikomiList:Aa,fetchKenteiList:Ca,fetchLeadItems:pn,fetchLeadLists:un,fetchMailSenders:Ds,fetchMasterStats:ma,fetchMaterialList:it,fetchMyProfile:Us,fetchPayableList:La,fetchPaymentStatus:pa,fetchPipelineMeta:ya,fetchPrintLayouts:Cs,fetchProductABC:Sa,fetchProductPrice:Ja,fetchProspectActivities:tn,fetchProspects:Zs,fetchPurchaseList:Ia,fetchRawMaterialStock:Pa,fetchRawRecords:je,fetchRawTableList:Va,fetchSalesAnalytics:Ye,fetchSalesReport:He,fetchSalesSummary:ua,fetchShopifyOrders:Os,fetchSlackLogs:Ws,fetchSlackRules:Oa,fetchStoreOrders:Na,fetchStoreSales:_t,fetchSyncDashboard:ha,fetchTankList:Ea,fetchTaxDeclaration:$t,fetchTourInquiriesFromDb:bn,fetchUserProfiles:Js,fetchWorkflowOrdersFromDb:vn,generateTaxCSV:xs,generateTaxXML:Ta,ocrFaxImage:zs,recalculateTaxDeclaration:As,recordAudit:Xs,resolveProductPrice:_a,saveCalendarEvent:Ns,saveCallLog:Ba,saveDeliveryLocation:on,saveEmailCampaign:Re,saveFaxRecord:Vs,saveIntegrationSetting:Se,saveInvoice:va,saveLeadItem:za,saveLeadList:mn,saveMailSender:Ps,saveMaterial:sn,savePrintLayout:Is,saveProspect:Ma,saveProspectActivity:an,saveSlackRule:Qs,saveTaxDeclaration:Es,saveTourInquiry:gn,saveUserProfile:Ys,saveWorkflowOrder:fn,searchPlaces:yn,sendEmailCampaign:Ra,sendSlackNotification:Ks,submitFeatureRequest:fa,syncGoogleCalendar:Fs,syncIvryCallLogs:cn,syncPhoneBookToIvry:dn,syncShopifyOrders:js,updateCustomer:ba,updateProduct:ga},Symbol.toStringTag,{value:"Module"}));function le(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const _n={open:"未締め",closed:"締め済"};function wn(e,t){const n=e.customers.map(l=>`
      <tr>
        <td>
        ...
        <td>
          <span class="status-pill ${l.status==="closed"?"success":"warning"}">${_n[l.status]}</span>
        </td>
        <td>
    ...
    <section class="ledger-grid">
      <article class="panel ledger-summary">
        ...
        <dl class="summary-list">
          <div>
            <dt>売上累計</dt>
            <dd>${ge(e.salesTotal)}</dd>
          </div>
          <div>
            <dt>入金累計</dt>
            <dd>${ge(e.paymentTotal)}</dd>
          </div>
          <div>
            <dt>残高</dt>
            <dd class="${e.balanceAmount>0?"balance-warning":""}">${ge(e.balanceAmount)}</dd>
          </div>
        </dl>
      </article>
  ...
  `}const Ee={today:"当日",month:"当月","90days":"90日",year:"1年",all:"全期間",custom:"指定期間"};function jt(e,t){const n=new Date(e);return n.setFullYear(n.getFullYear()+t),n.toISOString()}function Cn(e,t,n){if(t==="all")return e;const l=new Date,r=l.toISOString().slice(0,10),a=new Date(l);switch(t){case"today":return e.filter(i=>i.date.slice(0,10)===r);case"month":return e.filter(i=>i.date.slice(0,7)===r.slice(0,7));case"90days":return a.setDate(a.getDate()-90),e.filter(i=>i.date>=a.toISOString());case"year":return a.setFullYear(a.getFullYear()-1),e.filter(i=>i.date>=a.toISOString());case"custom":return!n?.start||!n?.end?e:e.filter(i=>{const o=i.date.slice(0,10);return o>=n.start&&o<=n.end})}}function U(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ce(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function me(e,t){for(const n of t){const l=e[n];if(typeof l=="number"&&Number.isFinite(l))return l;if(typeof l=="string"){const r=Number(l);if(Number.isFinite(r))return r}}return null}function In(e){const t=e?.productTotals;if(!t||t.length===0)return"―";const n=t.reduce((r,a)=>{const i=me(a,["amount","salesAmount"]),o=me(a,["marginRate","grossMarginRate"]);return i===null||i<=0||o===null?r:{weightedAmount:r.weightedAmount+i,weightedRate:r.weightedRate+i*o}},{weightedAmount:0,weightedRate:0});if(n.weightedAmount>0)return`${(n.weightedRate/n.weightedAmount).toFixed(1)}%`;const l=t.reduce((r,a)=>{const i=a,o=me(i,["amount","salesAmount"]),c=me(i,["grossProfit","grossAmount","margin"]),d=me(i,["costAmount","cost","costPrice"]);if(o===null||o<=0)return r;const u=c??(d!==null?o-d:null);return u===null?r:{sales:r.sales+o,gross:r.gross+u}},{sales:0,gross:0});return l.sales>0?`${(l.gross/l.sales*100).toFixed(1)}%`:"―"}function Ln(e){const l={top:20,right:20,bottom:30,left:50},r=760-l.left-l.right,a=260-l.top-l.bottom,i=Math.max(...e.map(u=>u.amount),1),o=r/e.length,c=e.map((u,p)=>{const h=u.amount/i*a,v=l.left+p*o+4,f=l.top+a-h,w=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(u.date));return`
        <g>
  ...
  `}function Dn(e,t,n,l,r="month",a){const i={success:"正常",warning:"注意",error:"異常",running:"実行中"},o=Cn(e.allDailySales,r,a),c=o.reduce((C,k)=>C+k.amount,0),d=o.reduce((C,k)=>C+k.bottles,0),u=o.reduce((C,k)=>C+k.volumeMl,0),p=o.length,h=d>0?Math.round(c/d):0,v=u>0?Math.round(c/(u/1e3)):0,w=(o.length>0?e.allDailySales.filter(C=>{const k=o[0]?.date??"",O=o[o.length-1]?.date??"",Q=jt(k,-1),pe=jt(O,-1);return C.date>=Q&&C.date<=pe}):[]).reduce((C,k)=>C+k.amount,0),$=w>0?(c-w)/w*100:0,E=$>0?"+":"",M=e.salesRecords.slice(0,10).map(C=>`
            <tr>
              <td class="mono">${C.documentNo}</td>
              <td>${Ce(C.date)}</td>
              <td>${C.customerName}</td>
              <td class="numeric">${U(C.amount)}</td>
            </tr>
          `).join(""),T=["today","month","90days","year","all"].map(C=>`<button class="button ${C===r?"primary":"secondary"} small" type="button" data-period="${C}">${Ee[C]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card">
        <p class="panel-title">${Ee[r]}売上</p>
        <p class="kpi-value">${U(c)}</p>
        <p class="kpi-sub">${p}日間${p>0?` / 日平均 ${U(Math.round(c/p))}`:""}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">昨対比</p>
        <p class="kpi-value" style="color:${$>=0?"#2f855a":"#c53d3d"}">${w>0?`${E}${$.toFixed(1)}%`:"―"}</p>
        <p class="kpi-sub">前年同期 ${w>0?U(w):"データなし"}</p>
      </article>
    ...
    <section class="content-grid">
      <article class="panel">
        <div class="panel-header">
          <div>
            <h2>日次売上</h2>
            <p class="panel-caption">${Ee[r]} (${o.length}日分)</p>
          </div>
        </div>
        ${Ln(o.length>0?o:e.dailySales)}
      </article>
    ...
    <section class="panel">
      <div class="panel-header">
        <div>
          <h2>日次推移</h2>
          <p class="panel-caption">${Ee[r]} — 売上・本数・液体量・単価</p>
        </div>
      </div>
      <div class="table-wrap">
        <table>
          ...
          <tbody>${o.slice().reverse().slice(0,31).map(C=>`
            <tr>
              ...
              <td class="numeric">${U(C.pricePerBottle)}</td>
              <td class="numeric">${U(C.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
  ...
  `}function Pn(e){const t=e.prospects.reduce((i,o)=>i+o.expectedAmount*o.probability/100,0),n=e.prospects.filter(i=>i.stage==="hot"||i.stage==="negotiating").length,l=new Date().toISOString().slice(0,10),r=e.upcomingEvents.filter(i=>i.startsAt.slice(0,10)>=l).slice(0,5),a=e.tourInquiries.filter(i=>i.status==="new").length;return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
      ...
      <article class="panel">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(100px, 1fr));gap:8px;">
          ${["cold","warm","hot","contacted","negotiating","won"].map(i=>{const o=e.prospects.filter(d=>d.stage===i).length,c=e.prospects.filter(d=>d.stage===i).reduce((d,u)=>d+u.expectedAmount,0);return`
              <div style="background:${Xe[i]};color:white;padding:12px;border-radius:6px;text-align:center;">
                <div style="font-size:11px;">${xe[i]}</div>
  ...
  `}function qn(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function oe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Tn(e,t){const n=e.lines.length?e.lines.map((r,a)=>`
          <tr>
      ...
      <div class="delivery-header">
        ...
        <div class="delivery-meta">
          <table class="delivery-meta-table">
            ...
            <tr><th>納品日</th><td>${qn(e.invoiceDate)}</td></tr>
  ...
  `}function H(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Nn(e){return H(e).replaceAll(`
`,"<br />")}function Rn(e){const n=[...Object.values(yt),{id:"custom",season:"カスタム",subject:"",body:""}].map(r=>`
        <button
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="email-preview">
          ...
          <div class="preview-box">${e.body?Nn(e.body):"本文未入力"}</div>
        </div>
  ...
  `}function jn(e,t){const n=[Ie("得意先",t.customers.map(r=>`
          <button
  ...
  `}function ye(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ya(e){const t=e.resultsHtml.trim()?e.resultsHtml:`<p class="empty-note">${ye(e.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function Le(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ot(e){return e.trim().toLowerCase()}function On(e,t){const n=Ot(t),l=e.filter(a=>n?[a.code,a.name,a.name].map(Ot).some(i=>i.includes(n)):!0).slice(0,50),r=l.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Ya({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:r,emptyMessage:"該当する得意先が見つかりません。"})}function Mn(e){return e.toISOString().slice(0,10)}function ie(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ee(e,t){return e[t]?`<div class="field-error">${ie(e[t])}</div>`:""}function re(e,t,n=""){return[n,e[t]?"has-error":""].filter(Boolean).join(" ")}function Fn(e,t,n,l){const r=Object.keys(nt).map(c=>`<option value="${c}" ${e.invoiceType===c?"selected":""}>${nt[c]}</option>`).join(""),a=e.lines.map((c,d)=>`
      <tr>
        <td>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${re(l,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||Mn(new Date)}" />
          ${ee(l,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
    ...
    <div class="quote-preview" id="quote-preview-area">
      <div class="quote-preview-inner">
        ...
        <div class="quote-preview-total-banner">
          <span>合計金額</span>
          <span class="quote-preview-total-value">${X(l)}（税込）</span>
        </div>
        ...
        <table class="quote-preview-table">
          ...
          <tbody>
            ${e.lines.map((i,o)=>`
              <tr>
                ...
                <td style="text-align:right;">${X(i.unitPrice)}</td>
                <td style="text-align:right;">${X(i.amount)}</td>
              </tr>
            `).join("")}
          ...
          <tfoot>
            ...
            <tr class="quote-preview-total-row"><td colspan="5" style="text-align:right;font-weight:700;">合計</td><td style="text-align:right;font-weight:700;">${X(l)}</td></tr>
          </tfoot>
        </table>
  ...
  `}function Jn(e,t,n,l,r,a){const i=e.lines.reduce((h,v)=>h+v.amount,0),o=Math.round(i*e.taxRate/100),c=i+o,d=l.length>=1?t.filter(h=>h.name.includes(l)||h.code.includes(l)).slice(0,8):[],u=r.length>=1?n.filter(h=>h.name.includes(r)||h.code.includes(r)).slice(0,8):[],p=e.fieldConfig;return e.previewMode?`
      <section class="page-head">
        <div>
    ...
    <section class="panel">
      ...
      ${u.length>0?`
        <div class="search-results">
          ${u.map(h=>{const v=a?_a(h,a):{price:h.salePrice||0,label:"標準価格"},f=v.label!=="標準価格";return`
          ...
          <tbody>
            ${e.lines.map((h,v)=>`
              <tr>
                ...
                <td class="numeric">${X(h.amount)}</td>
    ...
    <section class="panel">
      <div class="quote-summary">
        ...
        <div class="quote-totals">
          <div><span>小計</span><span class="numeric">${X(i)}</span></div>
          <div><span>消費税(${e.taxRate}%)</span><span class="numeric">${X(o)}</span></div>
          <div class="total-row"><span>合計</span><span class="numeric">${X(c)}</span></div>
        </div>
      </div>
    </section>
    ...
    ${zn(p)}
    ${Vn(e.sealSettings)}
  `}function Un(e){const t=Xa(e),n=window.open("","_blank","width=800,height=1100");if(!n){alert("ポップアップがブロックされました。許可してください。");return}n.document.write(`<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8" />
...
<\/script>
...
</html>`),n.document.close()}function Yn(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function Hn(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Xn(e,t){const n=e.length?e.map(l=>`
            <tr>
              ...
              <td class="numeric">${Hn(l.amount)}</td>
            </tr>
  ...
  `}function Gn(e){return new Date(e.getFullYear(),e.getMonth(),1)}function Qn(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function Ga(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function Qa(e){const t=new Date(e),n=t.getDay();return t.setDate(t.getDate()-n),t.setHours(0,0,0,0),t}function Mt(e){const t=Ga(Qa(e),6);return t.setHours(23,59,59,999),t}function Ft(e){return new Date(`${e}T00:00:00`)}function Bt(e){return`${e.getMonth()+1}/${e.getDate()}`}function Wn(e){return e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function Kn(){const e=new Date,t=Qa(Qn(Gn(e),-3)),n=Mt(new Date(e.getFullYear(),e.getMonth()+4,0)),l=[];let r=new Date(t);for(;r<=n;){const a=Mt(r);l.push({start:new Date(r),end:a,label:`${Bt(r)} - ${Bt(a)}`}),r=Ga(r,7)}return l}function Zn(e){const t=Kn(),n=`160px repeat(${t.length}, minmax(56px, 1fr))`,l=t.map(a=>`
        <div class="gantt-week">
          <span>${a.label}</span>
        </div>
      `).join(""),r=e.length?e.map(a=>{const i=Ft(a.startDate),o=Ft(a.expectedDoneDate),c=Math.max(0,t.findIndex(p=>p.end>=i)),d=Math.max(c,t.reduce((p,h,v)=>h.start<=o?v:p,c)),u=[`仕込番号: ${a.jikomiNo}`,`銘柄: ${a.productName}`,`期間: ${a.startDate} - ${a.expectedDoneDate}`,`タンク: ${a.tankNo}`,`備考: ${a.note||"なし"}`].join(`
`);return`
  ...
  `}function zt(e,t){const n={planned:"neutral",active:"warning",done:"success"},l=e.map(o=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${n[o.status]}">${xa[o.status]}</span>
        </td>
        <td>${o.note||"―"}</td>
      </tr>
  ...
  `}function ei(e){const t={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},l=e.map(c=>`
      <tr>
  ...
  `}function ti(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ai(e,t){return`
  ...
  `}const St={query:"",businessType:"",areaCode:"",activeOnly:"",page:1},$e=50;function ii(e,t){let n=e;if(t.query){const o=t.query.toLowerCase();n=n.filter(c=>c.code.toLowerCase().includes(o)||c.name.toLowerCase().includes(o)||c.kanaName&&c.kanaName.toLowerCase().includes(o)||c.address1&&c.address1.toLowerCase().includes(o)||c.phone&&c.phone.toLowerCase().includes(o))}t.businessType&&(n=n.filter(o=>o.businessType===t.businessType)),t.areaCode&&(n=n.filter(o=>o.areaCode===t.areaCode)),t.activeOnly==="active"?n=n.filter(o=>o.isActive):t.activeOnly==="inactive"&&(n=n.filter(o=>!o.isActive));const l=Math.max(1,Math.ceil(n.length/$e)),a=(Math.min(t.page,l)-1)*$e,i=n.slice(a,a+$e);return{filtered:n,paged:i,totalPages:l}}function Vt(e,t,n){if(n<=1)return`<div class="master-pagination"><span>${e}件</span></div>`;const l=(t-1)*$e+1,r=Math.min(t*$e,e),a=[];for(let i=1;i<=n;i++)i===1||i===n||i>=t-2&&i<=t+2?a.push(`<button class="button ${i===t?"primary":"secondary"}" type="button" data-action="master-page" data-page="${i}" style="min-width:36px;padding:4px 8px;">${i}</button>`):(i===t-3||i===t+3)&&a.push('<span style="padding:0 4px;color:var(--text-secondary);">…</span>');return`
  ...
  `}function li(e,t){const n=[...new Set(e.map(r=>r.businessType).filter(Boolean))].sort(),l=[...new Set(e.map(r=>r.areaCode).filter(Boolean))].sort();return`
  ...
  `}function Wa(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function oi(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
          <td>${t.phone||""}</td>
          <td title="${t.address1||""}">${Wa(t.address1||"",20)}</td>
      ...
      `).join("")}function ri(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${Wa(t.name,25)}</td>
          <td>${t.category}</td>
      ...
      `).join("")}function ci(e,t,n=St){const{filtered:l,paged:r,totalPages:a}=ii(e.customers,n);return`
    <section class="page-head">
      <div>
  ...
  `}function Qe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function di(e,t){if(!e&&!t)return"";const n=e;return`
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 160px;">
              ...
              <select id="mat-type">
                ...
                ${Fa.map(l=>`<option ${n?.materialType===l?"selected":""}>${l}</option>`).join("")}
              </select>
            </label>
  ...
  `}function ui(e){const t=e.map(r=>{const i=(r.minimumStock>0?r.currentStock/r.minimumStock:1/0)<1.5;return`
        <tr>
          ...
          <td class="numeric">${Qe(r.unitCost)}</td>
          <td class="numeric">${Qe(r.currentStock*r.unitCost)}</td>
          <td>${r.lastUpdated}</td>
          <td>
  ...
  `}function pi(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function We(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const mi={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function yi(e){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td class="numeric">${We(n.billedAmount)}</td>
          <td class="numeric">${We(n.paymentAmount)}</td>
          <td class="numeric">${We(n.balanceAmount)}</td>
          <td>${pi(n.lastPaymentDate)}</td>
          <td><span class="status-pill ${n.status==="paid"?"success":n.status==="partial"?"warning":"danger"}">${mi[n.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function ce(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Jt(e){return e.trim().toLowerCase()}function hi(e,t){const n=Jt(t),l=e.filter(a=>n?[a.code,a.name,a.janCode].map(Jt).some(i=>i.includes(n)):!0),r=l.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Ya({title:"商品検索",searchQuery:t,placeholder:"コード・名前・JANで検索",resultsHtml:r,emptyMessage:"該当する商品が見つかりません。"})}function te(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function vi(e,t){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},l={pending:"warning",confirmed:"neutral",paid:"success"},r={unpaid:"未払い",partial:"一部支払",paid:"支払済"},a={unpaid:"warning",partial:"neutral",paid:"success"},i=e.map(p=>`
      <tr>
  ...
  `}function he(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function fi(e,t){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},l={holding:"neutral",due:"warning",cleared:"success"},r=e.map(u=>`
      <tr>
    ...
    `).join(""),a=t.map(u=>{const p=u.minimumStock>0&&u.currentStock<u.minimumStock*1.2;return`
        <tr>
          ...
          <td class="numeric">${he(u.unitCost)}</td>
          <td class="numeric">${he(u.currentStock*u.unitCost)}</td>
  ...
  `}function rt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function j(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ct(e){return`
  ...
  `}function qe(e){if(!e)return"error";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"success":n<24?"warning":"error"}function Ut(e){if(!e)return"未同期";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"正常":n<24?"注意":"要確認"}function gi(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${e.lastOverallSync?rt(e.lastOverallSync):"---"}</p>
        <p class="kpi-sub">全テーブル最新</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">データ鮮度</p>
        <p class="kpi-value">
          <span class="status-pill ${qe(e.lastOverallSync)}">${Ut(e.lastOverallSync)}</span>
        </p>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>${t.lastSyncAt?rt(t.lastSyncAt):"---"}</td>
              <td><span class="status-pill ${qe(t.lastSyncAt)}">${Ut(t.lastSyncAt)}</span></td>
            </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function $i(e,t,n,l){const r={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${rt(e.lastSyncAt)}</p>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function be(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function _i(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function wi(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),n=Math.max(...t.map(p=>p.amount),1),l=28,r=6,a=140,i=100,o=760,c=o-a-i,d=t.length*(l+r)+16,u=t.map((p,h)=>{const v=p.amount/n*c,f=h*(l+r)+8,w=p.abcRank==="A"?"#2F855A":p.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
  ...
  `}function ki(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(l=>`<th class="numeric">${l}</th>`).join(""),n=e.monthlyByCustomer.map(l=>{const r=l.values.reduce((i,o)=>i+o,0),a=l.values.map(i=>`<td class="numeric">${i>0?(i/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${l.label}</td>
          ${a}
  ...
  `}function Si(e){e.ranking.reduce((c,d)=>c+d.amount,0);const t=e.ranking.filter(c=>c.abcRank==="A").length,n=e.ranking.filter(c=>c.abcRank==="B").length,l=e.ranking.filter(c=>c.abcRank==="C").length,r=e.ranking.filter(c=>c.abcRank==="A").reduce((c,d)=>c+d.amount,0),a=e.ranking.filter(c=>c.abcRank==="B").reduce((c,d)=>c+d.amount,0),i=e.ranking.filter(c=>c.abcRank==="C").reduce((c,d)=>c+d.amount,0),o=e.ranking.map(c=>`
        <tr>
          ...
          <td><span class="status-pill ${_i(c.abcRank)}">${c.abcRank}</span></td>
        </tr>
      `).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-row">
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value kpi-warning">${n}社 <span class="kpi-sub">${be(a)}</span></div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label">Cランク</div>
        <div class="kpi-value">${l}社 <span class="kpi-sub">${be(i)}</span></div>
      </div>
    </section>
  ...
  `}function Yt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function xi(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function Ai(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,20),n=760,l=320,r={top:24,right:56,bottom:60,left:72},a=n-r.left-r.right,i=l-r.top-r.bottom,o=Math.max(...t.map(f=>f.amount),1),c=a/t.length,d=[0,.25,.5,.75,1].map(f=>{const w=r.top+i-i*f,$=`${Math.round(o*f/1e4)}万`;return`
      ...
      `}).join(""),p=t.map((f,w)=>{const $=f.amount/o*i,E=Math.max(c-10,16),M=r.left+w*c+(c-E)/2,T=r.top+i-$,C=f.abcRank==="A"?"#2F855A":f.abcRank==="B"?"#B7791F":"#718096",k=f.name.length>6?f.name.slice(0,6)+"…":f.name;return`
        <g>
          <rect x="${M}" y="${T}" width="${E}" height="${$}" rx="4" fill="${C}" opacity="0.8" />
          <text x="${M+E/2}" y="${l-8}" class="chart-axis centered-axis pareto-label" transform="rotate(-35 ${M+E/2} ${l-16})">${k}</text>
        </g>
      `}).join(""),h=t.map((f,w)=>{const $=r.left+w*c+c/2,E=r.top+i-i*f.cumRatio/100;return`${$},${E}`}).join(" "),v=t.map((f,w)=>{const $=r.left+w*c+c/2,E=r.top+i-i*f.cumRatio/100;return`<circle cx="${$}" cy="${E}" r="3.5" fill="#C53D3D" />`}).join("");return`
  ...
  `}function Ei(e){const t=e.ranking.filter(o=>o.abcRank==="A").length,n=e.ranking.filter(o=>o.abcRank==="B").length,l=e.ranking.filter(o=>o.abcRank==="C").length,r=e.ranking.filter(o=>o.abcRank==="A").reduce((o,c)=>o+c.amount,0),a=e.ranking.map(o=>`
        <tr>
          <td class="mono">${o.code}</td>
          <td>${o.name}</td>
          <td class="numeric">${Yt(o.amount)}</td>
      ...
      `).join(""),i=e.monthlyByProduct.length>0?(()=>{const o=e.months.map(d=>`<th class="numeric">${d}</th>`).join(""),c=e.monthlyByProduct.map(d=>{const u=d.values.reduce((h,v)=>h+v,0),p=d.values.map(h=>`<td class="numeric">${h>0?(h/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`<tr><td>${d.label}</td>${p}<td class="numeric"><strong>${Yt(u)}</strong></td></tr>`}).join("");return`
          <div class="table-wrap">
            <table>
  ...
  `}function Ci(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ii(e){return e.replace("-","/")}function Li(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,l={top:16,right:24,bottom:36,left:64},r=t-l.left-l.right,a=n-l.top-l.bottom,i=Math.max(...e.map(u=>u.amount),1),o=r/e.length,c=[0,.25,.5,.75,1].map(u=>{const p=l.top+a-a*u,h=`${Math.round(i*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
      ...
      `}).join(""),d=e.map((u,p)=>{const h=u.amount/i*a,v=Math.max(o-18,24),f=l.left+p*o+(o-v)/2,w=l.top+a-h;return`
        <g>
          ...
          <text x="${f+v/2}" y="${n-10}" class="chart-axis centered-axis">${Ii(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function Di(e){return e.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':e.map(t=>`
      ...
      `).join("")}function Pi(e,t){const n=t==="products"?"商品別集計":"得意先別集計",l=t==="products"?e.productTotals:e.customerTotals;return`
    <section class="page-head">
      <div>
  ...
  `}function ve(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function qi(e){const t=Math.max(...e.salesByProduct.flatMap(a=>a.values),1),n=e.salesByProduct.map(a=>{const i=a.values.map((o,c)=>`
          <div class="bar-col">
            <div class="bar" style="height:${Math.round(o/t*120)}px" title="${e.months[c]}: ${ve(o)}"></div>
      ...
      <tr>
        ...
        <td>${a.productName}</td>
        <td class="numeric">${ve(a.costPrice)}</td>
        <td class="numeric">${ve(a.sellPrice)}</td>
        <td class="numeric">${ve(a.margin)}</td>
        <td class="numeric">
    ...
    `).join(""),r=e.salesByCustomer.map(a=>{const i=a.values.reduce((o,c)=>o+c,0);return`
        <tr>
          ...
          <td class="numeric"><strong>${ve(i)}</strong></td>
        </tr>
      `}).join("");return`
    <section class="page-head">
      <div>
  ...
  `}function Ti(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function Ni(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ht(e){return e.toISOString().slice(0,10)}function Ri(e,t,n){const l=e.length?e.map(r=>`
            <tr>
              ...
              <td class="numeric">${Ni(r.amount)}</td>
            </tr>
  ...
  `}function Te(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ji(e,t,n,l){const r={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},a={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},i={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},o=e.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
  ...
  `}const Ke={customers:"得意先マスタ",products:"商品マスタ",suppliers:"仕入先マスタ",staff:"担当者マスタ"},Oi={customers:{required:["legacy_customer_code","name"],optional:["kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"]},products:{required:["legacy_product_code","name"],optional:["kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"]},suppliers:{required:["legacy_supplier_code","name"],optional:["kana_name","phone","postal_code","address1","closing_day","payment_day","email"]},staff:{required:["legacy_staff_code","name"],optional:["kana_name","department"]}};function Mi(e,t,n,l){const r=Oi[e],a=Object.keys(Ke).map(o=>`
  ...
  `}function Ze(e){const t={};return e.querySelectorAll("[data-fd-id]").forEach(n=>{const l=n.dataset.fdId??"",r=parseFloat(n.style.left)||0,a=parseFloat(n.style.top)||0;t[l]={x:r,y:a}}),t}function zi(e,t,n,l,r){const a=Array.from(new Set([...e.map(d=>d.businessType??""),...t.map(d=>d.businessType??"")].filter(Boolean))),i=e.filter(d=>d.lat&&d.lng).length,o=t.filter(d=>d.lat&&d.lng).length,c=n.filter(d=>d.lat&&d.lng).length;return`
    <section class="page-head">
      <div>
  ...
  `}const Vi={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},Ji=["new","picking","packed","shipped","delivered"];function Ui(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(a=>t[a.stage].push(a));const n=Ji.map(a=>{const i=Vi[a],o=t[a];return`
  ...
  `}function Yi(e,t,n){const l=e.cart.reduce((a,i)=>a+i.amount,0);return`
  ...
  `}function Hi(e,t,n){if(e.step==="customer"){const l=e.customerQuery.toLowerCase(),r=l?t.filter(a=>a.name.toLowerCase().includes(l)||a.code.toLowerCase().includes(l)):t.slice(0,20);return`
      <section class="panel">
  ...
  `}const Xt={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},Gt={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},Qt={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function Xi(e,t){const n=e.find(a=>a.id===t)??e[0],l=e.filter(a=>a.status==="new").length,r=e.filter(a=>a.status==="confirmed").length;return`
    <section class="page-head">
      <div>
          ...
          ${e.map(a=>`
            <button class="tour-item ${n?.id===a.id?"active":""}" data-tour-id="${a.id}">
              <div class="tour-item-head">
                ...
                <span class="status-pill ${Gt[a.status]}">${Xt[a.status]}</span>
              </div>
              <div class="tour-item-sub">
                ${Qt[a.language]} · 👥 ${a.partySize}名
              </div>
      ...
      <div class="panel">
        ${n?`
          <div class="panel-header">
            ...
            <span class="status-pill ${Gt[n.status]}">${Xt[n.status]}</span>
          </div>
          <dl class="summary-list">
...
金井酒造店`;function Wi(e,t){const n=t?e.find(r=>r.id===t):null,l=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${n||l?`
      ...
      `:""}
  `}function Ki(e,t,n,l){const[r,a]=t.split("-").map(k=>parseInt(k,10)),i=new Date(r,a-1,1),o=new Date(r,a,0),c=i.getDay(),d=o.getDate(),u=[];for(let k=0;k<c;k++)u.push({isOutside:!0});for(let k=1;k<=d;k++)u.push({date:new Date(r,a-1,k)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter(k=>k.category===n):e,h={};p.forEach(k=>{const O=k.startsAt.slice(0,10);h[O]??=[],h[O].push(k)});const v=new Date().toISOString().slice(0,10),f=u.map(k=>{if(k.isOutside)return'<div class="cal-cell cal-outside"></div>';const O=k.date,Q=`${O.getFullYear()}-${String(O.getMonth()+1).padStart(2,"0")}-${String(O.getDate()).padStart(2,"0")}`,pe=h[Q]??[],os=Q===v,It=O.getDay();return`
        <div class="cal-cell ${os?"cal-today":""} ${It===0?"cal-sun":It===6?"cal-sat":""}"
             data-cal-date="${Q}">
          <div class="cal-day-num">${O.getDate()}</div>
          <div class="cal-events">
            ${pe.slice(0,3).map(K=>`
              <button class="cal-event" data-cal-event-id="${K.id}"
                      style="background:${K.color||kt[K.category]||"#0F5B8D"};"
                      title="${K.title}">
            ...
            `).join("")}
            ${pe.length>3?`<button class="cal-event-more" data-cal-date="${Q}">+${pe.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),w=l?.isOpen?Zi(l):"",$=new Date(r,a-2,1),E=new Date(r,a,1),M=`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`,T=`${E.getFullYear()}-${String(E.getMonth()+1).padStart(2,"0")}`,C=(()=>{const k=new Date;return`${k.getFullYear()}-${String(k.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(wt).map(([k,O])=>`<option value="${k}" ${n===k?"selected":""}>${O}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
    ...
    ${w}
  `}function Zi(e){const t=e.event;return`
          ...
          <div style="display:flex;gap:8px;">
            <label class="field" style="flex:1;">
              ...
              <select id="cal-category">
                ${Object.entries(wt).map(([n,l])=>`<option value="${n}" ${t.category===n?"selected":""}>${l}</option>`).join("")}
              </select>
            </label>
  ...
  `}function tl(e,t){const n=e.reduce((a,i)=>a+i.totalAmount,0),l=e.filter(a=>a.financialStatus==="paid").length,r=e.filter(a=>a.fulfillmentStatus!=="fulfilled"&&a.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function sl(e,t,n){const l=t==="__new__"?null:e.find(i=>i.id===t),r=t==="__new__";return n?.role==="admin"?`
    <section class="page-head">
      <div>
      ...
      <section class="panel">
        ...
        <div class="filter-grid filter-grid--wide">
          ...
          <label class="field" style="flex:1 1 140px;">
            <span>部署</span>
            <select id="user-dept">
              ${Object.entries(Fe).map(([i,o])=>`<option value="${i}" ${l?.department===i?"selected":""}>${o}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 140px;">
            <span>権限</span>
            <select id="user-role">
              ${Object.entries(Me).map(([i,o])=>`<option value="${i}" ${l?.role===i?"selected":""}>${o}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 160px;">
            <span>電話</span>
  ...
  `:`
    ...
    <section class="panel">
      ...
      <dl class="summary-list">
        ...
        <div><dt>部署</dt><dd>${Fe[e.department]}</dd></div>
        <div><dt>権限</dt><dd>${Me[e.role]}</dd></div>
  ...
  `:`
    ...
    `}function il(e){const t={};return e.forEach(n=>{const l=n.userEmail??"(anonymous)";t[l]=(t[l]??0)+1}),`
    <section class="page-head">
      <div>
  ...
  `}function ll(e){const t=e.prospects.reduce((a,i)=>a+i.expectedAmount,0),n=e.prospects.reduce((a,i)=>a+i.expectedAmount*i.probability/100,0),l=e.prospects.filter(a=>a.stage==="won").length,r=e.prospects.filter(a=>a.stage==="hot"||a.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    ${e.viewMode==="kanban"?ol(e.prospects):rl(e.prospects)}
    ...
    <section class="panel" style="padding:12px;">
      ...
      <div class="pk-board">${["cold","warm","hot","contacted","negotiating","won","lost"].map(l=>{const r=e.filter(i=>i.stage===l),a=r.reduce((i,o)=>i+o.expectedAmount,0);return`
        <div class="pk-col" data-prospect-stage="${l}">
          <div class="pk-col-header" style="--pk-color:${Xe[l]};">
            <span class="pk-col-label">${xe[l]}</span>
          ...
          <tbody>
            ${e.map(t=>`
              <tr>
                ...
                <td><span class="status-pill" style="background:${Xe[t.stage]};color:white;">${xe[t.stage]}</span></td>
  ...
  `}function cl(e){if(!e.editingId)return"";const t=e.editingId==="__new__",n=t?null:e.prospects.find(l=>l.id===e.editingId);return!t&&!n?"":`
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 140px;">
              ...
              <select id="prospect-stage">
                ${Object.entries(xe).map(([l,r])=>`<option value="${l}" ${n?.stage===l?"selected":""}>${r}</option>`).join("")}
              </select>
            </label>
            <label class="field" style="flex:1 1 120px;">
              <span>流入元</span>
  ...
  `}function dl(e,t,n){const l=e?.config.webhook_url??"",r=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${t.map(a=>`
              <tr>
                <td>${Be[a.eventType]||a.eventType}</td>
                <td>
  ...
  `}function ul(e,t,n,l){const r=new Map(t.map(p=>[p.code,p])),a=e.filter(p=>p.callDirection==="inbound").length,i=e.filter(p=>p.callDirection==="outbound").length,o=e.filter(p=>p.callStatus==="missed").length,c=e.reduce((p,h)=>p+(h.durationSeconds??0),0),d=p=>{if(p===0)return"―";const h=Math.floor(p/60),v=p%60;return h>0?`${h}分${v}秒`:`${v}秒`},u=p=>{if(p.matchedCustomerCode){const h=r.get(p.matchedCustomerCode);if(h)return`${h.name} (既存)`}return"未登録番号"};return`
    <section class="page-head">
      <div>
  ...
  `}const pl=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function ml(e){const t=e.activeListId?e.lists.find(a=>a.id===e.activeListId):null,n=e.items.filter(a=>a.status==="new").length,l=e.items.filter(a=>a.status==="imported").length,r=e.items.filter(a=>a.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
    ...
    <section class="panel">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:flex-end;">
        <label class="field" style="flex:1 1 180px;">
          ...
          <select id="lb-type">
            <option value="">選択</option>
            ${pl.map(a=>`<option value="${a}" ${e.searchBusinessType===a?"selected":""}>${a}</option>`).join("")}
          </select>
        </label>
        <label class="field" style="flex:1 1 180px;">
          <span>エリア</span>
  ...
  `}function fl(e,t,n){const{subtotal:l,taxAmount:r,total:a}=Ka(e.lines,e.taxRate),i=e.previousBalance??0,o=e.paymentAmount??0,c=i-o+a,d=e.lines.map(p=>`
      <tr>
    ...
    <div class="print-page invoice-freee ${n.fontSize}">
      ...
      <!-- 日付 -->
      <dl class="freee-meta">
        <div><dt>請求日</dt><dd>${_e(e.documentDate)}</dd></div>
        ${e.dueDate?`<div><dt>お支払期限</dt><dd>${_e(e.dueDate)}</dd></div>`:""}
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${N(c)}</span>
      ...
      <div class="freee-summary">
        <div>
          ${n.showRegistrationNo?`
            <div class="freee-tax-breakdown">
              <p>＜税率内訳＞</p>
              <p>${Math.round(e.taxRate*100)}%対象: ${N(l)} / 消費税: ${N(r)}</p>
            </div>`:""}
        </div>
        <table class="freee-summary-table">
          ...
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${N(r)}</td></tr>
          <tr class="freee-sum-grand"><th>合計請求額</th><td>${N(c)}</td></tr>
        </table>
      </div>
  ...
  `}function bl(e,t,n){const{subtotal:l,taxAmount:r,total:a}=Ka(e.lines,e.taxRate),i=e.lines.map(c=>`
      <tr>
        ...
        <td class="numeric">${N(c.unitPrice)}</td>
        <td class="numeric">${N(c.amount)}</td>
      </tr>
    ...
    <div class="print-page quotation-freee ${n.fontSize}">
      ...
      <dl class="freee-meta">
        <div><dt>見積日</dt><dd>${_e(e.documentDate)}</dd></div>
        ${e.expireDate?`<div><dt>有効期限</dt><dd>${_e(e.expireDate)}</dd></div>`:""}
      ...
      <p class="freee-footer">本見積書は ${e.expireDate?_e(e.expireDate)+" まで":"発行日から30日間"} 有効です。</p>
    </div>
  `}function gl(e,t,n,l){let r="";switch(e){case"chain_store":r=vl(l,n,t);break;case"quotation":r=bl(l,n,t);break;case"invoice_monthly":r=fl(l,n,t);break}const a=Object.keys(Kt).map(c=>`<button class="tab-button ${e===c?"active":""}" data-print-template="${c}">${Kt[c]}</button>`).join(""),i=l.lines.map((c,d)=>`
      <tr>
  ...
  `}const $l={customers:["legacy_customer_code","name"],products:["legacy_product_code","name"],suppliers:["legacy_supplier_code","name"],staff:["legacy_staff_code","name"]},_l={customers:["legacy_customer_code","name","kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"],products:["legacy_product_code","name","kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"],suppliers:["legacy_supplier_code","name","kana_name","phone","postal_code","address1","closing_day","payment_day","email"],staff:["legacy_staff_code","name","kana_name","department"]};function wl(e){e.charCodeAt(0)===65279&&(e=e.slice(1));const t=[];let n=[],l="",r=!1;for(let o=0;o<e.length;o++){const c=e[o];r?c==='"'?e[o+1]==='"'?(l+='"',o++):r=!1:l+=c:c==='"'?r=!0:c===","?(n.push(l),l=""):c===`
`||c==="\r"?(c==="\r"&&e[o+1]===`
`&&o++,n.push(l),n.some(d=>d!=="")&&t.push(n),n=[],l=""):l+=c}if((l!==""||n.length>0)&&(n.push(l),n.some(o=>o!=="")&&t.push(n)),t.length===0)return{columns:[],rows:[]};const a=t[0].map(o=>o.trim()),i=[];for(let o=1;o<t.length;o++){const c={};a.forEach((d,u)=>{c[d]=(t[o][u]??"").trim()}),i.push(c)}return{columns:a,rows:i}}function kl(e,t,n){const l=$l[e],r=l.filter(o=>!t.includes(o)),a=n.map(o=>{const c=[];r.length>0&&c.push(`必須列欠損: ${r.join(",")}`);for(const d of l)t.includes(d)&&!o[d]&&c.push(`${d}が空`);return{...o,_valid:c.length===0,_error:c[0]}}),i=a.filter(o=>o._valid).length;return{entity:e,columns:t,rows:a,totalRows:n.length,validRows:i,invalidRows:a.length-i}}function Sl(e){const n=_l[e],r={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[e];return"\uFEFF"+n.join(",")+`
`+r.join(",")+`
`}async function xl(e,t){const{supabaseInsert:n}=await b(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>q);return{supabaseInsert:o}},void 0);let l=0,r=0;const i={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const o of t){if(!o._valid)continue;const{_valid:c,_error:d,...u}=o,p={...u};if(!p.id){const h=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[h]??`${e}-${Date.now()}-${l+r}`)}for(const h of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[h]=="string"&&p[h]!==""){const v=Number(p[h]);Number.isFinite(v)&&(p[h]=v)}try{await n(i,p)!==null?l++:r++}catch{r++}}return{inserted:l,failed:r}}function tt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function Al(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function El(e,t,n,l,r){const a=n.reduce((d,u)=>d+u.rowCount,0),i=n.map(d=>d.lastSyncAt).filter(d=>d!==null).sort().reverse()[0]??null,o=100,c=Math.max(1,Math.ceil(r/o));return`
    <section class="page-head">
      <div>
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:8px;padding:0 0 16px;">
        ${n.map(d=>`
          ...
          >
            ...
            <p class="kpi-sub" style="font-size:11px;">${d.lastSyncAt?tt(d.lastSyncAt):"未同期"}</p>
          </button>
        `).join("")}
      </div>
    </section>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>${d._synced_at?tt(d._synced_at):"---"}</td>
              <td class="mono" style="font-size:11px;max-width:300px;overflow:hidden;text-overflow:ellipsis;" title="${d._raw_b64?d._raw_b64.slice(0,200):""}">${Al(d._raw_b64)}</td>
            </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function at(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Il(e,t,n){const l=e.rows.map((d,u)=>`
      <tr>
        ...
        <td class="numeric"><strong>${at(d.taxAmount)}</strong></td>
        <td>
      ...
      <tr>
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="type">
            ${Object.keys(lt).map(p=>`<option value="${p}" ${p===d.type?"selected":""}>${lt[p]}</option>`).join("")}
          </select>
        </td>
        <td>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${at(e.totalTax)}</p>
        ...
        <table class="entry-table">
          ...
          <tfoot>
            <tr>
              ...
              <th></th>
              <th class="numeric">${at(e.totalTax)}</th>
              <th></th>
            </tr>
          </tfoot>
        </table>
  ...
  `;const o={id:r,message:e,type:t,el:i};dt.push(o),l.appendChild(i),requestAnimationFrame(()=>{i.classList.add("toast-enter")});const c=()=>ql(o);i.querySelector(".toast-dismiss").addEventListener("click",c),setTimeout(()=>{i.classList.add("toast-exit"),i.addEventListener("animationend",c,{once:!0})},a)}function ql(e){const t=dt.indexOf(e);t!==-1&&(dt.splice(t,1),e.el.remove())}function Tl(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function W(e,t={}){const{title:n="確認",confirmLabel:l="OK",cancelLabel:r="キャンセル",variant:a="primary"}=t;return new Promise(i=>{const o=document.createElement("div");o.className="modal-backdrop confirm-backdrop",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),o.innerHTML=`
      <div class="modal-panel confirm-panel">
        ...
        <div class="confirm-actions">
          <button class="button secondary confirm-cancel">${Ne(r)}</button>
          <button class="button ${a} confirm-ok">${Ne(l)}</button>
        </div>
      </div>
    `;const c=u=>{o.classList.add("confirm-exit"),o.addEventListener("animationend",()=>{o.remove()},{once:!0}),i(u)};o.querySelector(".confirm-cancel").addEventListener("click",()=>c(!1)),o.querySelector(".confirm-ok").addEventListener("click",()=>c(!0)),o.addEventListener("click",u=>{u.target===o&&c(!1)});const d=u=>{u.key==="Escape"&&(document.removeEventListener("keydown",d),c(!1))};document.addEventListener("keydown",d),document.body.appendChild(o),requestAnimationFrame(()=>{o.querySelector(".confirm-ok")?.focus()})})}const Nl=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
...
`)}`,i=new Blob([a],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(i),c=document.createElement("a");c.href=o,c.download=e,document.body.append(c),c.click(),c.remove(),window.setTimeout(()=>URL.revokeObjectURL(o),0)}const Ol=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/product-abc","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser"];let ue=[];async function Ml(){const{supabaseQueryAll:e}=await b(async()=>{const{supabaseQueryAll:n}=await Promise.resolve().then(()=>q);return{supabaseQueryAll:n}},void 0);ue=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(n=>typeof n.email=="string"&&n.email.length>0).map(n=>({name:String(n.name??""),email:String(n.email??""),area:String(n.delivery_area_code??""),historySegment:"seasonal"}))}const ea=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/product-abc",title:"商品ABC分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"}];function Za(e){const t=yt[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function xt(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function Fl(){const e=Za("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const Ge=new Date,Bl=Ge.toISOString().slice(0,7),zl=Ge.getFullYear(),Vl=Ge.getMonth()+1,Jl=Ge.toISOString().slice(0,10),Ul="C0011",se=Fl();function es(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return Ol.includes(n)?n:"/"}function At(e){switch(e){case"/invoice-entry":case"/quote":case"/delivery":case"/billing":case"/invoice":case"/ledger":return"sales";case"/analytics":case"/customer-analysis":case"/product-abc":case"/report":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const ta=es(location.pathname),s={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:xt(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:Bl,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:zl,taxMonth:Vl,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],callLogs:[],mapFilters:{showCustomers:!0,showProspects:!0,showDelivery:!0,filterRegion:"",filterBusinessType:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...yl,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...hl},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:Jl,route:ta,currentCategory:At(ta),sidebarOpen:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:Ul,salesPeriod:"month",customRange:{start:"",end:""},quoteState:(()=>{const e={...Ha};try{const t=localStorage.getItem("quote-seal");t&&(e.sealSettings=JSON.parse(t))}catch{}return e})(),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,masterTab:"customers",masterFilter:{...St},analyticsTab:"products",emailAudienceMode:se.mode,emailRegion:se.region,emailHistorySegment:se.historySegment,emailTemplateId:se.templateId,emailSubject:se.subject,emailBody:se.body,emailSaveMessage:se.saveMessage,emailSending:!1,globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function aa(e){return e.slice(0,10)}function Yl(e){return{...e}}function ze(){s.pickerMode=null,s.pickerQuery="",s.pickerTargetLine=null}function ts(){s.invoiceForm=xt(),s.invoiceSavedDocNo=null,s.invoicePriceGroup="",s.invoiceErrors={},ze()}function as(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,l)=>{n.productCode.trim()||(t[`lines.${l}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${l}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${l}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${l}.unitPrice`]="単価は0円以上で入力してください。")}),t}function Hl(e){const t=s.invoiceForm.lines[e];t&&s.invoiceForm.lines.splice(e+1,0,Yl(t))}function Xl(){const e=s.invoiceRecords[0],t=s.masterStats?.customers[0],n=s.masterStats?.products.slice(0,2)??[];s.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:s.invoiceForm.staffCode||"S001",lines:n.map((l,r)=>{const a=r===0?1:2,i=1200*(r+1);return{productCode:l.code,productName:l.name,quantity:a,unitPrice:i,unit:"本",amount:a*i}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},s.invoiceSavedDocNo=null,s.invoiceErrors={}}function Gl(e){const t=s.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function Ql(e){const t=s.masterStats?.customers.find(n=>n.name===e.trim());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function ss(e){if(G(e),s.invoiceErrors=as(s.invoiceForm),Object.keys(s.invoiceErrors).length>0){y();return}s.invoiceSaving=!0,y(),va(s.invoiceForm).then(t=>{s.invoiceSavedDocNo=t.documentNo,s.invoiceSaving=!1,s.invoiceErrors={},s.invoiceForm=xt(),y()}).catch(()=>{s.invoiceSaving=!1,y()})}function ns(e){const t=s.salesFilter.startDate?new Date(s.salesFilter.startDate):null,n=s.salesFilter.endDate?new Date(`${s.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((l,r)=>new Date(r.date).getTime()-new Date(l.date).getTime()).filter(l=>{const r=new Date(l.date);return!(t&&r<t||n&&r>n)})}function is(){switch(s.emailAudienceMode){case"area":return s.emailRegion==="all"?ue:ue.filter(e=>e.area===s.emailRegion);case"history":return ue.filter(e=>e.historySegment===s.emailHistorySegment);default:return ue}}function Wl(){const e=is();return{audienceMode:s.emailAudienceMode,region:s.emailRegion,historySegment:s.emailHistorySegment,selectedTemplateId:s.emailTemplateId,subject:s.emailSubject,body:s.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:s.emailSaveMessage,sending:s.emailSending,senderId:s.emailSenderId,senders:s.mailSenders}}function st(e){const t=is(),n=s.emailAudienceMode==="area"?s.emailRegion:s.emailAudienceMode==="history"?s.emailHistorySegment:"all";return{subject:s.emailSubject.trim(),body:s.emailBody.trim(),templateId:s.emailTemplateId,audienceMode:s.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(l=>l.email),status:e}}function Et(){return s.user,!1}function ke(){s.globalSearchOpen=!1,s.globalQuery=""}function Kl(){const e=s.globalQuery.trim().toLowerCase();return e?{customers:s.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:s.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:s.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:ea.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:ea}}function Zl(){let e=[],t,n="export.csv";switch(s.route){case"/sales":e=(s.salesSummary?ns(s.salesSummary):[]).map(l=>({documentNo:l.documentNo,date:l.date,customerCode:l.customerCode,customerName:l.customerName,amount:l.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...s.paymentStatus?.records??[]].sort((l,r)=>r.balanceAmount-l.balanceAmount).map(l=>({...l})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=s.invoiceRecords.map(l=>({...l})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=s.purchaseList.map(l=>({...l})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=s.jikomiList.map(l=>({...l})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=s.tankList.map(l=>({...l})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=s.kenteiList.map(l=>({...l})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=s.materialList.map(l=>({...l})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":s.masterTab==="customers"?(e=s.masterStats?.customers.map(l=>({...l}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=s.masterStats?.products.map(l=>({...l}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}jl(n,e,t)}function sa(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),s.route=e,s.currentCategory=At(e),s.sidebarOpen=!1,ke(),Ct(e)}async function Ct(e){s.actionLoading=!0,y();try{switch(e){case"/delivery":s.deliveryNote||(s.deliveryNote=await bt(s.deliverySearchDocNo||"D240122"));break;case"/billing":s.billingSummary||(s.billingSummary=await gt(s.billingYearMonth));break;case"/report":s.salesReport||(s.salesReport=await He());break;case"/customer-analysis":s.customerAnalysis||(s.customerAnalysis=await ka());break;case"/product-abc":s.productABC||(s.productABC=await Sa());break;case"/jikomi":s.jikomiList.length===0&&(s.jikomiList=await Aa());break;case"/tanks":s.tankList.length===0&&(s.tankList=await Ea());break;case"/kentei":s.kenteiList.length===0&&(s.kenteiList=await Ca());break;case"/materials":s.materialList.length===0&&(s.materialList=await it());break;case"/purchase":(s.purchaseList.length===0||s.payableList.length===0)&&([s.purchaseList,s.payableList]=await Promise.all([Ia(),La()]));break;case"/raw-material":(s.billList.length===0||s.rawStockList.length===0)&&([s.billList,s.rawStockList]=await Promise.all([Da(),Pa()]));break;case"/tax":s.taxDeclaration||(s.taxDeclaration=await $t(s.taxYear,s.taxMonth));break;case"/store":(s.storeSales.length===0||s.storeOrders.length===0)&&([s.storeSales,s.storeOrders]=await Promise.all([_t(s.storeSalesDate),Na()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await b(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>_);return{fetchMailSenders:n}},void 0);if(s.mailSenders=await t(),!s.emailSenderId||!s.mailSenders.find(n=>n.id===s.emailSenderId)){const n=s.mailSenders.find(l=>l.isDefault)??s.mailSenders[0];n&&(s.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await b(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>_);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await b(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>_);return{fetchIntegrationSettings:n}},void 0);s.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await b(async()=>{const{fetchShopifyOrders:l,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>_);return{fetchShopifyOrders:l,fetchIntegrationSettings:r}},void 0);s.shopifyOrders=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await b(async()=>{const{fetchFaxInbox:l,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>_);return{fetchFaxInbox:l,fetchIntegrationSettings:r}},void 0);s.faxRecords=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await b(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>_);return{fetchUserProfiles:n}},void 0);s.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:l}=await b(async()=>{const{fetchMyProfile:a,fetchAuditLogs:i,fetchMailSenders:o}=await Promise.resolve().then(()=>_);return{fetchMyProfile:a,fetchAuditLogs:i,fetchMailSenders:o}},void 0),r=s.user?.email??s.myProfile?.email??"";r&&(s.myProfile=await t(r)),s.mailSenders.length===0&&(s.mailSenders=await l()),s.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await b(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>_);return{fetchAuditLogs:n}},void 0);s.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await b(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>_);return{fetchProspects:n}},void 0);s.prospects=await t()}break;case"/map":{const{fetchProspects:t,fetchDeliveryLocations:n,fetchIntegrationSettings:l}=await b(async()=>{const{fetchProspects:r,fetchDeliveryLocations:a,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>_);return{fetchProspects:r,fetchDeliveryLocations:a,fetchIntegrationSettings:i}},void 0);s.prospects=await t(),s.deliveryLocations=await n(),s.integrations.length===0&&(s.integrations=await l())}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:n}=await b(async()=>{const{fetchCallLogs:l,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>_);return{fetchCallLogs:l,fetchIntegrationSettings:r}},void 0);s.callLogs=await t(100),s.integrations.length===0&&(s.integrations=await n())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:n}=await b(async()=>{const{fetchLeadLists:l,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>_);return{fetchLeadLists:l,fetchIntegrationSettings:r}},void 0);s.leadLists=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await b(async()=>{const{fetchWorkflowOrdersFromDb:n}=await Promise.resolve().then(()=>_);return{fetchWorkflowOrdersFromDb:n}},void 0);s.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await b(async()=>{const{fetchTourInquiriesFromDb:n}=await Promise.resolve().then(()=>_);return{fetchTourInquiriesFromDb:n}},void 0);s.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:l}=await b(async()=>{const{fetchSlackRules:r,fetchSlackLogs:a,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>_);return{fetchSlackRules:r,fetchSlackLogs:a,fetchIntegrationSettings:i}},void 0);s.slackRules=await t(),s.slackLogs=await n(50),s.integrations.length===0&&(s.integrations=await l())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:n,fetchWorkflowOrdersFromDb:l,fetchTourInquiriesFromDb:r}=await b(async()=>{const{fetchProspects:a,fetchCalendarEvents:i,fetchWorkflowOrdersFromDb:o,fetchTourInquiriesFromDb:c}=await Promise.resolve().then(()=>_);return{fetchProspects:a,fetchCalendarEvents:i,fetchWorkflowOrdersFromDb:o,fetchTourInquiriesFromDb:c}},void 0);s.prospects.length===0&&(s.prospects=await t()),s.calendarEvents.length===0&&(s.calendarEvents=await n(s.calendarYearMonth)),s.materialList.length===0&&(s.materialList=await it()),s.workflowOrders.length===0&&(s.workflowOrders=await l()),s.tourInquiries.length===0&&(s.tourInquiries=await r())}break;default:break}}catch(t){console.warn("Route data load error",t)}finally{s.actionLoading=!1,y()}}function na(){if(Et())return ai(s.authError,s.authSubmitting);if(s.loading)return`
    ...
    `;switch(s.route){case"/cat/sales":return Ae("sales");case"/cat/brewery":return Ae("brewery");case"/cat/purchase":return Ae("purchase");case"/cat/more":return Ae("more");case"/invoice-entry":return Fn(s.invoiceForm,s.invoiceSavedDocNo,s.invoiceSaving,s.invoiceErrors);case"/quote":return Jn(s.quoteState,s.masterStats?.customers??[],s.masterStats?.products??[],s.quoteCustomerQuery,s.quoteProductQuery,s.quotePricing);case"/email":return Rn(Wl());case"/delivery":return s.deliveryNote?Tn(s.deliveryNote,s.deliverySearchDocNo):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/billing":return s.billingSummary?wn(s.billingSummary,s.billingYearMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/report":return s.salesReport?qi(s.salesReport):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/customer-analysis":return s.customerAnalysis?Si(s.customerAnalysis):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-abc":return s.productABC?Ei(s.productABC):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/jikomi":return s.jikomiView==="calendar"?`${zt(s.jikomiList,s.jikomiView)}${Zn(s.jikomiList)}`:zt(s.jikomiList,s.jikomiView);case"/tanks":return Cl(s.tankList);case"/kentei":return ei(s.kenteiList);case"/materials":return ui(s.materialList)+di(s.materialEditing,s.materialEditingIsNew);case"/purchase":return vi(s.purchaseList,s.payableList);case"/raw-material":return fi(s.billList,s.rawStockList);case"/tax":return s.taxDeclaration?Il(s.taxDeclaration,s.taxYear,s.taxMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/store":return ji(s.storeSales,s.storeOrders,s.storeTab,s.storeSalesDate);case"/setup":return s.pipelineMeta?$i(s.pipelineMeta,V,R,s.syncDashboard):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/raw-browser":return El(s.rawSelectedTable,s.rawRecords,s.rawTableList,s.rawPage,s.rawTotalCount);case"/import":return Mi(s.importEntity,s.importPreview,s.importing,s.importResult);case"/print":return gl(s.printTemplate,s.printOptions,s.printCompany,s.printData);case"/form-designer":return Bi(s.printData,s.printCompany,s.printOptions,s.fdSavedPositions,s.fdDesignMode);case"/map":{const e=(s.masterStats?.customers??[]).slice(0,200).map((l,r)=>{const a=l;return{...l,lat:a.lat??35.37+r%12*.05+(Math.random()-.5)*.02,lng:a.lng??139.29+Math.floor(r/12)*.05+(Math.random()-.5)*.02,address1:a.address1??"",businessType:a.businessType??"",lastOrderAmount:0}}),n=!!s.integrations.find(l=>l.provider==="google_maps")?.config.api_key;return zi(e,s.prospects,s.deliveryLocations,s.mapFilters,n)}case"/workflow":return Ui(s.workflowOrders);case"/mobile-order":return Yi(s.mobileOrder,s.masterStats?.customers??[],s.masterStats?.products??[]);case"/tour":return Xi(s.tourInquiries,s.tourActiveId);case"/mail-senders":return Wi(s.mailSenders,s.mailSenderEditingId);case"/calendar":return Ki(s.calendarEvents,s.calendarYearMonth,s.calendarFilterCategory,s.calendarEdit);case"/integrations":return el(s.integrations,s.integrationEditingId);case"/shopify":{const e=s.integrations.find(t=>t.id==="shopify");return tl(s.shopifyOrders,e?.lastSyncAt??null)}case"/fax":return al(s.faxRecords,s.faxProcessing,s.faxOcrText);case"/users":return sl(s.userProfiles,s.userEditingId,s.myProfile);case"/profile":return nl(s.myProfile,s.auditLogs.filter(e=>e.userEmail===s.myProfile?.email),s.mailSenders);case"/audit":return il(s.auditLogs);case"/prospects":{const e={prospects:s.prospects,activities:s.prospectActivities,editingId:s.prospectEditingId,viewMode:s.prospectViewMode};return ll(e)}case"/slack":{const e=s.integrations.find(t=>t.provider==="slack")??null;return dl(e,s.slackRules,s.slackLogs)}case"/calls":{const e=s.integrations.find(t=>t.provider==="ivry");return ul(s.callLogs,s.masterStats?.customers??[],e?.lastSyncAt??null,e?.isEnabled??!1)}case"/list-builder":{const e={lists:s.leadLists,activeListId:s.leadActiveListId,items:s.leadItems,searchQuery:s.leadSearchQuery,searchArea:s.leadSearchArea,searchBusinessType:s.leadSearchType,searching:s.leadSearching,searchResults:s.leadSearchResults};return ml(e)}}if(!s.salesSummary||!s.paymentStatus||!s.masterStats||!s.pipelineMeta||!s.customerLedger||!s.salesAnalytics)return"";switch(s.route){case"/sales":return Ri(ns(s.salesSummary),s.salesFilter.startDate,s.salesFilter.endDate);case"/payment":return yi([...s.paymentStatus.records].sort((e,t)=>t.balanceAmount-e.balanceAmount));case"/master":return ci(s.masterStats,s.masterTab,s.masterFilter);case"/invoice":return Xn(s.invoiceRecords,s.invoiceFilter);case"/ledger":return En(s.customerLedger,s.ledgerCustomerCode);case"/analytics":return Pi(s.salesAnalytics,s.analyticsTab);default:return Dn(s.salesSummary,s.pipelineMeta,s.salesAnalytics,{prospects:s.prospects,upcomingEvents:s.calendarEvents,tourInquiries:s.tourInquiries,workflowOrdersCount:{new:s.workflowOrders.filter(e=>e.stage==="new").length,picking:s.workflowOrders.filter(e=>e.stage==="picking").length,packed:s.workflowOrders.filter(e=>e.stage==="packed").length,shipped:s.workflowOrders.filter(e=>e.stage==="shipped").length,total:s.workflowOrders.length},lowStockCount:s.materialList.filter(e=>e.currentStock<e.minimumStock*1.5).length,masterCounts:s.masterStats?{customers:s.masterStats.summary.customerCount,products:s.masterStats.summary.productCount,suppliers:s.syncDashboard?.tables.find(e=>e.tableName==="suppliers")?.rowCount??0,specialPrices:s.syncDashboard?.tables.find(e=>e.tableName==="customer_product_prices")?.rowCount??0}:void 0},s.salesPeriod,s.customRange)}}function eo(){if(Et())return`
    ...
    `;const e={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売業務",items:[{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/quote",label:"見積作成",kicker:"Quote"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],analytics:[{label:"分析",items:[{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/customer-analysis",label:"得意先分析",kicker:"CustABC"},{path:"/product-abc",label:"商品ABC",kicker:"ProdABC"},{path:"/report",label:"集計帳票",kicker:"Report"}]}],crm:[{label:"営業・顧客",items:[{path:"/prospects",label:"新規営業",kicker:"Prospects"},{path:"/map",label:"取引先マップ",kicker:"Map"},{path:"/list-builder",label:"リスト取得",kicker:"ListBuild"},{path:"/calls",label:"通話履歴",kicker:"Calls"},{path:"/email",label:"メール配信",kicker:"Mail"}]},{label:"受注・出荷",items:[{path:"/workflow",label:"受注ワークフロー",kicker:"Workflow"},{path:"/mobile-order",label:"モバイル受注",kicker:"Mobile"},{path:"/shopify",label:"Shopify注文",kicker:"Shopify"},{path:"/fax",label:"FAX OCR",kicker:"FAX"}]}],orders:[{label:"仕入・調達",items:[{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],brewery:[{label:"製造管理",items:[{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"},{path:"/tax",label:"酒税申告",kicker:"Tax"}]}],master:[{label:"マスタ・ツール",items:[{path:"/master",label:"マスタ管理",kicker:"Master"},{path:"/calendar",label:"カレンダー",kicker:"Calendar"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/tour",label:"酒蔵見学",kicker:"Tour"},{path:"/print",label:"印刷",kicker:"Print"}]}],settings:[{label:"システム設定",items:[{path:"/setup",label:"連動設定",kicker:"Setup"},{path:"/integrations",label:"外部連携",kicker:"API"},{path:"/slack",label:"Slack通知",kicker:"Slack"},{path:"/import",label:"データ取込",kicker:"Import"},{path:"/raw-browser",label:"データブラウザ",kicker:"RawData"},{path:"/users",label:"ユーザー管理",kicker:"Users"},{path:"/profile",label:"プロフィール",kicker:"Profile"},{path:"/audit",label:"操作ログ",kicker:"Audit"}]}]},t=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/invoice-entry",label:"販売"},{category:"analytics",path:"/analytics",label:"分析"},{category:"crm",path:"/prospects",label:"営業"},{category:"orders",path:"/purchase",label:"仕入"},{category:"brewery",path:"/jikomi",label:"製造"},{category:"master",path:"/master",label:"マスタ"},{category:"settings",path:"/setup",label:"設定"}],n=e[s.currentCategory].map(o=>`
      ...
      `).join(""),r=s.pickerMode&&s.masterStats?s.pickerMode==="customer"?On(s.masterStats.customers,s.pickerQuery):hi(s.masterStats.products,s.pickerQuery):"",a=s.globalSearchOpen?jn(s.globalQuery,Kl()):"",i=s.user?`
