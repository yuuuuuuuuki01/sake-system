...
`}function Fs(e){const t=String(e);return/[,"\n]/.test(t)?`"${t.replaceAll('"','""')}"`:t}function Bs(e){const n=["酒類コード","区分名","アルコール度数","製造数量","前月繰越","当月調整","輸出控除","見本等控除","課税数量","税率(円/L)","税額(円)"].join(","),l=e.rows.map(c=>[c.taxCategory,c.taxCategoryName,c.alcoholDegree,c.productionVolume,c.previousBalance,c.currentAdjustment,c.exportDeduction,c.sampleDeduction,c.taxableVolume,c.taxRate,c.taxAmount].map(Fs).join(",")),r=`,合計,,${e.rows.reduce((c,a)=>c+a.productionVolume,0)},,,${e.rows.reduce((c,a)=>c+a.exportDeduction,0)},${e.rows.reduce((c,a)=>c+a.sampleDeduction,0)},${e.totalVolume},,${e.totalTax}`;return"\uFEFF"+[n,...l,r].join(`
`)+`
`}function zs(e){const t=e.rows.map(r=>{const c=Math.max(0,r.productionVolume+r.previousBalance+r.currentAdjustment-r.exportDeduction-r.sampleDeduction),a=Math.round(c*r.taxRate);return{...r,taxableVolume:c,volume:c,taxAmount:a}}),n=t.reduce((r,c)=>r+c.taxableVolume,0),l=t.reduce((r,c)=>r+c.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:l}}async function Vs(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>q);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:ja(e),submitted_at:e.submittedAt})}async function xt(e){const t=await k("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(n=>({id:m(n,["id"],""),saleDate:m(n,["sale_date"],e),saleTime:m(n,["sale_time"],""),productCode:m(n,["product_code"],""),productName:m(n,["product_name"],""),quantity:A(n,["quantity"],0),unitPrice:A(n,["unit_price"],0),amount:A(n,["amount"],0),paymentMethod:m(n,["payment_method"],"cash")})):[]}async function Ma(){const e=await k("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),orderDate:F(t,["order_date"],""),customerName:m(t,["customer_name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["shipping_address"],""),items:[],totalAmount:A(t,["total_amount"],0),status:m(t,["status"],"new"),shippingDate:F(t,["shipping_date"],"")})):[]}async function je(e){const t=await Ue("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function Fa(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function Js(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await k("print_layouts",t)).map(l=>({id:m(l,["id"],""),name:m(l,["name"],""),templateKey:m(l,["template_key"],""),positions:l.positions??{},isDefault:B(l,["is_default"],!1),note:m(l,["note"],""),updatedAt:m(l,["updated_at"],"")}))}async function Us(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:r}=await Promise.resolve().then(()=>q);return{supabaseInsert:r}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},l=await t("print_layouts",n);return l?{id:m(l,["id"],e.id),name:m(l,["name"],e.name),templateKey:m(l,["template_key"],e.templateKey),positions:l.positions??e.positions,isDefault:B(l,["is_default"],!1),note:m(l,["note"],""),updatedAt:m(l,["updated_at"],"")}:null}async function Ys(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function Hs(){return(await k("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),signature:m(t,["signature"],""),replyTo:m(t,["reply_to"],""),isDefault:B(t,["is_default"],!1),isVerified:B(t,["is_verified"],!1),note:m(t,["note"],"")}))}async function Xs(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:m(n,["id"],e.id),name:m(n,["name"],e.name),email:m(n,["email"],e.email),displayName:m(n,["display_name"],""),signature:m(n,["signature"],""),replyTo:m(n,["reply_to"],""),isDefault:B(n,["is_default"],!1),isVerified:B(n,["is_verified"],!1)}:null}async function Gs(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const At={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},Et={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Qs(e){const t=`${e}-01T00:00:00Z`,[n,l]=e.split("-").map(i=>parseInt(i,10)),r=new Date(n,l,0).getDate(),c=`${e}-${String(r).padStart(2,"0")}T23:59:59Z`;return(await k("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${c})`,order:"starts_at.asc"})).map(i=>({id:m(i,["id"],""),title:m(i,["title"],""),description:m(i,["description"],""),category:m(i,["category"],"general")||"general",startsAt:m(i,["starts_at"],new Date().toISOString()),endsAt:m(i,["ends_at"],""),isAllDay:B(i,["is_all_day"],!1),location:m(i,["location"],""),attendees:i.attendees??[],relatedCustomerCode:m(i,["related_customer_code"],""),relatedOrderId:m(i,["related_order_id"],""),color:m(i,["color"],""),googleEventId:m(i,["google_event_id"],"")}))}async function Ws(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??Et[e.category],updated_at:new Date().toISOString()})?e:null}async function Ks(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Ba(){return(await k("integration_settings",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),provider:m(t,["provider"],""),config:t.config??{},isEnabled:B(t,["is_enabled"],!1),lastSyncAt:m(t,["last_sync_at"],""),lastStatus:m(t,["last_status"],"")}))}async function xe(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function Zs(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const l=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,r=await fetch(l,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const c=await r.json(),{supabaseInsert:a}=await f(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>q);return{supabaseInsert:o}},void 0);let i=0;for(const o of c.orders){const d=`shopify_${o.id}`;await a("shopify_orders",{id:d,shopify_order_id:String(o.id),order_number:String(o.order_number??""),order_date:String(o.created_at??new Date().toISOString()),customer_name:String(o.customer?.first_name??"")+" "+String(o.customer?.last_name??""),customer_email:String(o.customer?.email??""),total_amount:Math.round(parseFloat(String(o.total_price??"0"))),financial_status:String(o.financial_status??""),fulfillment_status:String(o.fulfillment_status??"unfulfilled"),line_items:o.line_items??[],shipping_address:o.shipping_address??null,raw_payload:o}),i++}return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${i}件取得成功`}),{count:i}}catch(l){return{count:0,error:l instanceof Error?l.message:String(l)}}}async function en(){return(await k("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),shopifyOrderId:m(t,["shopify_order_id"],""),orderNumber:m(t,["order_number"],""),orderDate:m(t,["order_date"],""),customerName:m(t,["customer_name"],""),customerEmail:m(t,["customer_email"],""),totalAmount:E(t.total_amount),financialStatus:m(t,["financial_status"],""),fulfillmentStatus:m(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function tn(e){const t=e.config.refresh_token,n=e.config.client_id,l=e.config.client_secret;if(!t||!n||!l)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const r=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:n,client_secret:l})});if(!r.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${r.status}`};const a=(await r.json()).access_token;return await xe({...e,config:{...e.config,oauth_token:a}}),e.config.oauth_token=a,{token:a}}async function an(e){let t=e.config.oauth_token;const n=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const l=new Date().toISOString(),r=new Date(Date.now()+30*86400*1e3).toISOString(),c=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${l}&timeMax=${r}&singleEvents=true&orderBy=startTime`;let a=await fetch(c,{headers:{Authorization:`Bearer ${t}`}});if(a.status===401){const u=await tn(e);if(u.error)return{count:0,error:u.error};t=u.token,a=await fetch(c,{headers:{Authorization:`Bearer ${t}`}})}if(!a.ok)return{count:0,error:`HTTP ${a.status}`};const i=await a.json(),{supabaseInsert:o}=await f(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>q);return{supabaseInsert:u}},void 0);let d=0;for(const u of i.items){const p=`gcal_${u.id}`,y=u.start?.dateTime??u.start?.date??"",v=u.end?.dateTime??u.end?.date??"";await o("calendar_events",{id:p,title:String(u.summary??"(無題)"),description:String(u.description??""),category:"general",starts_at:String(y),ends_at:String(v),location:String(u.location??""),google_event_id:String(u.id??""),updated_at:new Date().toISOString()}),d++}return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${d}件取得`}),{count:d}}catch(l){return{count:0,error:l instanceof Error?l.message:String(l)}}}async function sn(){return(await k("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:m(t,["id"],""),receivedAt:m(t,["received_at"],""),senderPhone:m(t,["sender_phone"],""),senderName:m(t,["sender_name"],""),imageUrl:m(t,["image_url"],""),ocrStatus:m(t,["ocr_status"],"pending")||"pending",ocrText:m(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:m(t,["linked_invoice_id"],"")}))}async function nn(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const l=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,r=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return r.ok?{text:(await r.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${r.status}`}}catch(l){return{text:"",error:l instanceof Error?l.message:String(l)}}}async function ln(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Be={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},ze={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function on(){return(await k("user_profiles",{order:"display_name.asc"})).map(t=>({id:m(t,["id"],""),email:m(t,["email"],""),displayName:m(t,["display_name"],""),staffCode:m(t,["staff_code"],""),department:m(t,["department"],"all")||"all",role:m(t,["role"],"staff")||"staff",defaultMailSenderId:m(t,["default_mail_sender_id"],""),phone:m(t,["phone"],""),avatarUrl:m(t,["avatar_url"],""),isActive:B(t,["is_active"],!0),lastSignInAt:m(t,["last_sign_in_at"],""),createdAt:m(t,["created_at"],"")}))}async function rn(e){if(!e)return null;const t=await k("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:m(n,["id"],""),email:m(n,["email"],""),displayName:m(n,["display_name"],""),staffCode:m(n,["staff_code"],""),department:m(n,["department"],"all")||"all",role:m(n,["role"],"staff")||"staff",defaultMailSenderId:m(n,["default_mail_sender_id"],""),phone:m(n,["phone"],""),avatarUrl:m(n,["avatar_url"],""),isActive:B(n,["is_active"],!0),lastSignInAt:m(n,["last_sign_in_at"],"")}}async function cn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function dn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function un(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>q);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function pn(e=100){return(await k("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),action:m(n,["action"],""),entityType:m(n,["entity_type"],""),entityId:m(n,["entity_id"],""),userEmail:m(n,["user_email"],""),changes:n.changes??{},createdAt:m(n,["created_at"],"")}))}const Ve={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function za(){return(await k("slack_notifications",{order:"event_type.asc"})).map(t=>({id:m(t,["id"],""),eventType:m(t,["event_type"],"new_order"),enabled:B(t,["enabled"],!0),channel:m(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:m(t,["last_triggered_at"],"")}))}async function mn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function yn(e=50){return(await k("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),eventType:m(n,["event_type"],""),channel:m(n,["channel"],""),message:m(n,["message"],""),status:m(n,["status"],"sent"),error:m(n,["error"],""),sentAt:m(n,["sent_at"],"")}))}async function hn(e,t,n){const r=(await Ba()).find(d=>d.provider==="slack");if(!r||!r.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const c=r.config.webhook_url;if(!c)return{ok:!1,error:"Webhook URL未設定"};const i=(await za()).find(d=>d.eventType===e&&d.enabled);if(!i)return{ok:!1,error:"通知ルールが無効"};const o=n??i.channel??r.config.default_channel??"#general";try{const d=await fetch(c,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${Ve[e]} ${t}`,channel:o})}),u=d.ok,{supabaseInsert:p}=await f(async()=>{const{supabaseInsert:y}=await Promise.resolve().then(()=>q);return{supabaseInsert:y}},void 0);return await p("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:o,message:t,status:u?"sent":"failed",error:u?null:`HTTP ${d.status}`}),u?{ok:!0}:{ok:!1,error:`HTTP ${d.status}`}}catch(d){return{ok:!1,error:d instanceof Error?d.message:String(d)}}}const Ae={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Qe={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function vn(){return(await k("prospects",{order:"updated_at.desc"})).map(t=>({id:m(t,["id"],""),companyName:m(t,["company_name"],""),contactName:m(t,["contact_name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),address:m(t,["address"],""),website:m(t,["website"],""),businessType:m(t,["business_type"],""),stage:m(t,["stage"],"cold"),source:m(t,["source"],""),expectedAmount:E(t.expected_amount),probability:E(t.probability),assignedStaffCode:m(t,["assigned_staff_code"],""),nextActionDate:m(t,["next_action_date"],""),nextAction:m(t,["next_action"],""),note:m(t,["note"],""),lastContactAt:m(t,["last_contact_at"],""),wonAt:m(t,["won_at"],""),lostAt:m(t,["lost_at"],""),lostReason:m(t,["lost_reason"],""),convertedCustomerCode:m(t,["converted_customer_code"],""),createdAt:m(t,["created_at"],"")}))}async function Va(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function fn(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function bn(e){return(await k("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:m(n,["id"],""),prospectId:m(n,["prospect_id"],""),activityType:m(n,["activity_type"],"call"),title:m(n,["title"],""),description:m(n,["description"],""),activityDate:m(n,["activity_date"],""),result:m(n,["result"],""),staffCode:m(n,["staff_code"],"")}))}async function gn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const Ja=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function $n(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function _n(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function wn(){return(await k("delivery_locations",{order:"name.asc"})).map(t=>({id:m(t,["id"],""),customerCode:m(t,["customer_code"],""),name:m(t,["name"],""),postalCode:m(t,["postal_code"],""),address:m(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:m(t,["contact_name"],""),phone:m(t,["phone"],""),deliveryNote:m(t,["delivery_note"],""),isActive:B(t,["is_active"],!0)}))}async function kn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function Sn(e=50){return(await k("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:m(n,["id"],""),callDirection:m(n,["call_direction"],"inbound"),fromNumber:m(n,["from_number"],""),toNumber:m(n,["to_number"],""),matchedCustomerCode:m(n,["matched_customer_code"],""),matchedProspectId:m(n,["matched_prospect_id"],""),durationSeconds:E(n.duration_seconds),callStatus:m(n,["call_status"],"answered"),recordingUrl:m(n,["recording_url"],""),transcript:m(n,["transcript"],""),ivryCallId:m(n,["ivry_call_id"],""),startedAt:m(n,["started_at"],""),endedAt:m(n,["ended_at"],""),notes:m(n,["notes"],"")}))}async function Ua(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function xn(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const l=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,r=await fetch(l,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!r.ok)return{count:0,error:`HTTP ${r.status}`};const a=(await r.json()).calls??[];let i=0;for(const o of a)await Ua({id:`ivry_${o.id}`,callDirection:String(o.direction??"inbound"),fromNumber:String(o.from??""),toNumber:String(o.to??""),durationSeconds:Number(o.duration??0),callStatus:String(o.status??"answered"),recordingUrl:String(o.recording_url??""),startedAt:String(o.started_at??""),endedAt:String(o.ended_at??""),ivryCallId:String(o.id??"")}),i++;return await xe({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${i}件取得`}),{count:i}}catch(l){return{count:0,error:l instanceof Error?l.message:String(l)}}}async function An(e,t){const n=e.config.api_key,l=e.config.team_id;if(!n||!l)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let r=0;for(const c of t){if(!c.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${l}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:c.name,phone_number:c.phone,external_id:c.customerCode??"",note:c.note??""})})).ok&&r++}return{synced:r}}catch(r){return{synced:0,error:r instanceof Error?r.message:String(r)}}}async function En(){return(await k("lead_lists",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),query:m(t,["query"],""),area:m(t,["area"],""),businessType:m(t,["business_type"],""),totalCount:E(t.total_count),source:m(t,["source"],"manual"),createdAt:m(t,["created_at"],"")}))}async function Ln(e){return(await k("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:m(n,["id"],""),listId:m(n,["list_id"],""),companyName:m(n,["company_name"],""),address:m(n,["address"],""),phone:m(n,["phone"],""),website:m(n,["website"],""),email:m(n,["email"],""),businessType:m(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:E(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:m(n,["place_id"],""),status:m(n,["status"],"new"),convertedProspectId:m(n,["converted_prospect_id"],""),note:m(n,["note"],"")}))}async function In(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function Ya(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function Cn(e,t,n){const l=e.config.api_key;if(!l)return{results:[],error:"Google Maps API key 未設定"};const r=`${t} ${n}`.trim(),c=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(r)}&language=ja&key=${l}`;try{const a=await fetch(c);if(!a.ok)return{results:[],error:`HTTP ${a.status}`};const i=await a.json();return i.status!=="OK"&&i.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${i.status}`}:{results:i.results.map(d=>{const u=d.geometry?.location;return{id:`place_${d.place_id}`,listId:"",companyName:String(d.name??""),address:String(d.formatted_address??""),rating:d.rating?Number(d.rating):void 0,reviewCount:d.user_ratings_total?Number(d.user_ratings_total):void 0,lat:u?.lat,lng:u?.lng,placeId:String(d.place_id??""),status:"new"}})}}catch(a){return{results:[],error:a instanceof Error?a.message:String(a)}}}async function Dn(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await Va(t);return n&&await Ya({...e,status:"imported",convertedProspectId:t.id}),n}async function Pn(){return(await k("workflow_orders",{order:"order_date.desc"})).map(t=>({id:m(t,["id"],""),orderNo:m(t,["order_no"],""),customerName:m(t,["customer_name"],""),customerCode:m(t,["customer_code"],""),orderDate:m(t,["order_date"],""),deliveryDate:m(t,["delivery_date"],""),stage:m(t,["stage"],"new"),totalAmount:E(t.total_amount),itemCount:E(t.item_count),priority:m(t,["priority"],"normal"),staffName:m(t,["staff_name"],""),notes:m(t,["notes"],"")}))}async function qn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function Tn(){return(await k("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:m(t,["id"],""),name:m(t,["name"],""),email:m(t,["email"],""),phone:m(t,["phone"],""),visitDate:m(t,["visit_date"],""),partySize:E(t.party_size)||1,language:m(t,["language"],"ja"),purpose:m(t,["purpose"],""),message:m(t,["message"],""),status:m(t,["status"],"new"),repliedAt:m(t,["replied_at"],""),confirmedTime:m(t,["confirmed_time"],""),createdAt:m(t,["created_at"],new Date().toISOString())}))}async function Nn(e){const{supabaseInsert:t}=await f(async()=>{const{supabaseInsert:l}=await Promise.resolve().then(()=>q);return{supabaseInsert:l}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const Rn=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function Ha(){return(await Promise.all(Rn.map(async t=>{const[n,l]=await Promise.all([vt(t.table),k(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:l[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function Me(e,t,n=100){const l=(t-1)*n,[r,c]=await Promise.all([k(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(l)}),vt(e)]);return{records:r,total:c}}async function dt(e){const t=await k("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const l=JSON.parse(n);return String(l.price_group??"")}catch{return""}return""}async function Xa(e,t){if(e){const l=await k("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(l.length>0&&l[0].special_price)return E(l[0].special_price)}const n=await k("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?E(n[0].default_sale_price):0}const _=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:Et,CALENDAR_CATEGORY_LABELS:At,DEPT_LABELS:ze,INVOICE_TYPE_LABELS:ot,JIKOMI_STATUS_LABELS:Ia,MATERIAL_CATEGORIES:Ja,PROSPECT_STAGE_COLORS:Qe,PROSPECT_STAGE_LABELS:Ae,ROLE_LABELS:Be,SEASONAL_TEMPLATES:bt,SLACK_EVENT_LABELS:Ve,TAX_DEDUCTION_LABELS:ct,TAX_RATE_CATEGORIES:Oa,convertLeadToProspect:Dn,deleteCalendarEvent:Ks,deleteMailSender:Gs,deleteMaterial:_n,deletePrintLayout:Ys,deleteProspect:fn,deleteUserProfile:dn,fetchAnnouncements:_a,fetchAuditLogs:pn,fetchBillList:Na,fetchBillingSummary:kt,fetchCalendarEvents:Qs,fetchCallLogs:Sn,fetchCustomerAnalysis:La,fetchCustomerEfficiency:Os,fetchCustomerLedger:_t,fetchCustomerPriceGroup:dt,fetchCustomerPricing:xa,fetchDeliveryLocations:wn,fetchDeliveryNote:wt,fetchDeliverySchedule:Ns,fetchFaxInbox:sn,fetchIntegrationSettings:Ba,fetchInvoices:Fe,fetchJikomiList:Ca,fetchKenteiList:Pa,fetchLeadItems:Ln,fetchLeadLists:En,fetchMailSenders:Hs,fetchMasterStats:fa,fetchMaterialList:rt,fetchMyProfile:rn,fetchPayableList:Ta,fetchPaymentStatus:va,fetchPipelineMeta:ba,fetchPrintLayouts:Js,fetchProductABC:js,fetchProductMonthlyShipments:Ts,fetchProductPower:Rs,fetchProductPrice:Xa,fetchProspectActivities:bn,fetchProspects:vn,fetchPurchaseList:qa,fetchRawMaterialStock:Ra,fetchRawRecords:Me,fetchRawTableList:Ha,fetchSalesAnalytics:Xe,fetchSalesReport:Ge,fetchSalesSummary:ha,fetchShopifyOrders:en,fetchSlackLogs:yn,fetchSlackRules:za,fetchStoreOrders:Ma,fetchStoreSales:xt,fetchSyncDashboard:ga,fetchTankList:Da,fetchTaxDeclaration:St,fetchTourInquiriesFromDb:Tn,fetchUserProfiles:on,fetchWorkflowOrdersFromDb:Pn,generateTaxCSV:Bs,generateTaxXML:ja,ocrFaxImage:nn,recalculateTaxDeclaration:zs,recordAudit:un,resolveProductPrice:Aa,saveCalendarEvent:Ws,saveCallLog:Ua,saveDeliveryLocation:kn,saveEmailCampaign:je,saveFaxRecord:ln,saveIntegrationSetting:xe,saveInvoice:$a,saveLeadItem:Ya,saveLeadList:In,saveMailSender:Xs,saveMaterial:$n,savePrintLayout:Us,saveProspect:Va,saveProspectActivity:gn,saveSlackRule:mn,saveTaxDeclaration:Vs,saveTourInquiry:Nn,saveUserProfile:cn,saveWorkflowOrder:qn,searchPlaces:Cn,sendEmailCampaign:Fa,sendSlackNotification:hn,submitFeatureRequest:wa,syncGoogleCalendar:an,syncIvryCallLogs:xn,syncPhoneBookToIvry:An,syncShopifyOrders:Zs,updateCustomer:ka,updateProduct:Sa},Symbol.toStringTag,{value:"Module"}));function oe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const On={open:"未締め",closed:"締め済"};function jn(e,t){const n=e.customers.map(l=>`
      <tr>
        <td>
        ...
        <td>
          <span class="status-pill ${l.status==="closed"?"success":"warning"}">${On[l.status]}</span>
        </td>
        <td>
  ...
  `}const Jn={forecasts:[],deliveries:[],calendarMonth:new Date().toISOString().slice(0,7),selectedSegment:"all"},Ft={monthly:"月次生産","made-to-order":"受注生産","november-only":"11月限定","annual-batch":"年間一括"},me={monthly:"#0F5B8D","made-to-order":"#6b46c1","november-only":"#c05621","annual-batch":"#2f855a"};function Un(e){const t=e.filter(r=>r>0).length,n=e.reduce((r,c)=>r+c,0);if(n===0)return"made-to-order";const l=e[10]/n;return e[11]/n,l>.5?"november-only":t<=3?"made-to-order":t<=4&&l<.3?"annual-batch":"monthly"}function Qa(e,t){if(t==="monthly"){const r=e.filter((a,i)=>i!==11).filter(a=>a>0);if(r.length===0)return 0;const c=[...r].sort((a,i)=>a-i);if(c.length>2){const a=c.slice(0,-1);return Math.round(a.reduce((i,o)=>i+o,0)/a.length)}return Math.round(r.reduce((a,i)=>a+i,0)/r.length)}if(t==="november-only")return e[10];if(t==="annual-batch")return e.reduce((l,r)=>l+r,0);const n=e.filter(l=>l>0);return n.length>0?Math.round(n.reduce((l,r)=>l+r,0)/n.length):0}function Yn(e,t){const n=(new Date().getMonth()+1)%12;if(t==="november-only")return n===10?e[10]:0;if(t==="annual-batch"){const l=e.indexOf(Math.max(...e));return n===l?e.reduce((r,c)=>r+c,0):0}return t==="made-to-order"?0:e[n]>0?e[n]:Qa(e,t)}function Hn(e){return e.slice(0,50).map(t=>{const n=t.monthlyQuantity,l=Un(n),r=Math.round(t.totalQuantity/12),c=Qa(n,l),a=Yn(n,l),i=l==="monthly"?c*11+n[11]:t.totalQuantity,o=l==="monthly"?Math.round(c*1.5):l==="november-only"?Math.round(n[10]*.1):0;return{code:t.code,name:t.name,segment:l,monthlyQuantity:n,avgMonthly:r,adjustedAvg:c,nextMonthForecast:a,annualForecast:i,safetyStock:o}})}function Xn(e){const t=new Date().toISOString().slice(0,10);return e.map(n=>({date:n.date,customerName:n.customerName,productName:n.productName,quantity:n.quantity,status:n.date>t?"scheduled":"delivered"}))}function Gn(e){const[t,n]=e.split("-").map(Number);return new Date(t,n,0).getDate()}function Qn(e){const[t,n]=e.split("-").map(Number);return new Date(t,n-1,1).getDay()}function Wa(e,t){const n=Gn(t),l=Qn(t),[r,c]=t.split("-").map(Number),a=new Map;e.forEach(x=>{if(x.date.slice(0,7)===t){const w=x.date.slice(0,10);a.has(w)||a.set(w,[]),a.get(w).push(x)}});const i=e.filter(x=>x.date.slice(0,7)===t),o=i.reduce((x,w)=>x+w.quantity,0),d=new Set(i.map(x=>x.date)).size,u=new Date().toISOString().slice(0,10),p=["日","月","火","水","木","金","土"].map(x=>`<th class="dcal-header">${x}</th>`).join("");let y="",v=1;for(let x=0;x<6&&!(v>n&&x>0);x++){y+="<tr>";for(let w=0;w<7;w++)if(x===0&&w<l||v>n)y+='<td class="dcal-cell dcal-empty"></td>';else{const N=`${r}-${String(c).padStart(2,"0")}-${String(v).padStart(2,"0")}`,V=a.get(N)||[],Z=N===u,Ke=V.reduce((Ee,W)=>Ee+W.quantity,0);y+=`
  ...
  `}function si(e,t,n,l,r="month",c){const a={success:"正常",warning:"注意",error:"異常",running:"実行中"},i=ei(e.allDailySales,r,c),o=i.reduce((x,w)=>x+w.amount,0),d=i.reduce((x,w)=>x+w.bottles,0),u=i.reduce((x,w)=>x+w.volumeMl,0),p=i.length,y=d>0?Math.round(o/d):0,v=u>0?Math.round(o/(u/1e3)):0,S=(i.length>0?e.allDailySales.filter(x=>{const w=i[0]?.date??"",N=i[i.length-1]?.date??"",V=zt(w,-1),Z=zt(N,-1);return x.date>=V&&x.date<=Z}):[]).reduce((x,w)=>x+w.amount,0),$=S>0?(o-S)/S*100:0,I=$>0?"+":"",z=e.salesRecords.slice(0,10).map(x=>`
            <tr>
  ...
  `}function ni(e){const t=e.prospects.reduce((a,i)=>a+i.expectedAmount*i.probability/100,0),n=e.prospects.filter(a=>a.stage==="hot"||a.stage==="negotiating").length,l=new Date().toISOString().slice(0,10),r=e.upcomingEvents.filter(a=>a.startsAt.slice(0,10)>=l).slice(0,5),c=e.tourInquiries.filter(a=>a.status==="new").length;return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
  ...
  `}function ii(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function re(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function li(e,t){const n=e.lines.length?e.lines.map((r,c)=>`
          <tr>
      ...
      <div class="delivery-header">
        ...
        <div class="delivery-meta">
          <table class="delivery-meta-table">
            ...
            <tr><th>納品日</th><td>${ii(e.invoiceDate)}</td></tr>
  ...
  `}function X(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function oi(e){return X(e).replaceAll(`
`,"<br />")}function ri(e){const n=[...Object.values(bt),{id:"custom",season:"カスタム",subject:"",body:""}].map(r=>`
        <button
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="email-preview">
          ...
          <div class="preview-box">${e.body?oi(e.body):"本文未入力"}</div>
        </div>
  ...
  `}function ci(e,t){const n=[De("得意先",t.customers.map(r=>`
          <button
  ...
  `}function he(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ka(e){const t=e.resultsHtml.trim()?e.resultsHtml:`<p class="empty-note">${he(e.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function Pe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Vt(e){return e.trim().toLowerCase()}function di(e,t){const n=Vt(t),l=e.filter(c=>n?[c.code,c.name,c.name].map(Vt).some(a=>a.includes(n)):!0).slice(0,50),r=l.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Ka({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:r,emptyMessage:"該当する得意先が見つかりません。"})}function ui(e){return e.toISOString().slice(0,10)}function le(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function te(e,t){return e[t]?`<div class="field-error">${le(e[t])}</div>`:""}function ce(e,t,n=""){return[n,e[t]?"has-error":""].filter(Boolean).join(" ")}function pi(e,t,n,l){const r=Object.keys(ot).map(o=>`<option value="${o}" ${e.invoiceType===o?"selected":""}>${ot[o]}</option>`).join(""),c=e.lines.map((o,d)=>`
      <tr>
        <td>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${ce(l,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||ui(new Date)}" />
          ${te(l,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
  ...
  `}function vi(e,t,n,l,r,c){const a=e.lines.reduce((y,v)=>y+v.amount,0),i=Math.round(a*e.taxRate/100),o=a+i,d=l.length>=1?t.filter(y=>y.name.includes(l)||y.code.includes(l)).slice(0,8):[],u=r.length>=1?n.filter(y=>y.name.includes(r)||y.code.includes(r)).slice(0,8):[],p=e.fieldConfig;return e.previewMode?`
      <section class="page-head">
        <div>
    ...
    <section class="panel">
      ...
      <div class="form-row">
        <input type="text" id="q-cust-search" value="${L(l)}" placeholder="得意先名またはコードで検索" />
      </div>
      ${d.length>0?`
    ...
    ${yi(p)}
    ${hi(e.sealSettings)}
  `}function fi(e){const t=es(e),n=window.open("","_blank","width=800,height=1100");if(!n){alert("ポップアップがブロックされました。許可してください。");return}n.document.write(`<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8" />
...
<\/script>
...
</html>`),n.document.close()}function ts(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function as(e){return`<span style="display:inline-block;width:24px;height:24px;border-radius:50%;background:${{A:"#2f855a",B:"#2b6cb0",C:"#b7791f",D:"#9aa5b1"}[e]||"#9aa5b1"};color:white;text-align:center;line-height:24px;font-weight:700;font-size:12px;">${e}</span>`}function ss(e){return e==null?'<span style="color:#9aa5b1;">新規</span>':`<span style="color:${e>=0?"#2f855a":"#c53d3d"};font-weight:700;">${e>=0?"+":""}${e.toFixed(1)}%</span>`}function bi(e,t){return e===t?"":e<t?`<span style="color:#2f855a;font-size:11px;">↑${t}→${e}</span>`:`<span style="color:#c53d3d;font-size:11px;">↓${t}→${e}</span>`}function ns(e){const t={A:0,B:0,C:0,D:0},n=e.filter(r=>r.growthRate!=null&&r.growthRate>10).length,l=e.filter(r=>r.growthRate!=null&&r.growthRate<-10).length;return e.forEach(r=>{t[r.rank]++}),`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>商品力分析</h1>
          ...
          <tbody>
            ${e.slice(0,50).map(r=>`
              <tr>
                ...
                <td class="numeric">${ts(r.recentAmount)}</td>
                <td class="numeric">${r.recentQty.toLocaleString()}</td>
                <td class="numeric">${ss(r.growthRate)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function is(e){const t={A:0,B:0,C:0,D:0},n=e.filter(r=>r.currentRank<r.prevRank).length,l=e.filter(r=>r.currentRank>r.prevRank&&r.prevRank!=="D").length;return e.forEach(r=>{t[r.currentRank]++}),`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>営業効率分析</h1>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${e.slice(0,50).map(r=>`
              <tr>
                <td>${as(r.currentRank)}</td>
                <td>${r.name||r.code}</td>
                <td class="numeric">${ts(r.recentAmount)}</td>
                <td class="numeric">${r.orderDays}日</td>
                <td class="numeric">${ss(r.growthRate)}</td>
                <td>${bi(r.currentRank,r.prevRank)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
...
`);return`
  ...
  `}function qi(e,t){const n=[...new Set(e.map(r=>r.businessType).filter(Boolean))].sort(),l=[...new Set(e.map(r=>r.areaCode).filter(Boolean))].sort();return`
  ...
  `}function rs(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Ti(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
          <td>${t.phone||""}</td>
          <td title="${t.address1||""}">${rs(t.address1||"",20)}</td>
      ...
      `).join("")}function Ni(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${rs(t.name,25)}</td>
          <td>${t.category}</td>
      ...
      `).join("")}function Ri(e,t,n=Lt){const{filtered:l,paged:r,totalPages:c}=Pi(e.customers,n);return`
    <section class="page-head">
      <div>
      ...
      `:`
        <div class="table-wrap">
          <table>
            ...
            <tbody>${Ni(e.products)}</tbody>
          </table>
        </div>
      `}
    </section>
  `}function Ze(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Oi(e,t){if(!e&&!t)return"";const n=e;return`
  ...
  `}function ji(e){const t=e.map(r=>{const a=(r.minimumStock>0?r.currentStock/r.minimumStock:1/0)<1.5;return`
        <tr>
  ...
  `}function Mi(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function et(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Fi={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Bi(e){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td><span class="status-pill ${n.status==="paid"?"success":n.status==="partial"?"warning":"danger"}">${Fi[n.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function de(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Gt(e){return e.trim().toLowerCase()}function zi(e,t){const n=Gt(t),l=e.filter(c=>n?[c.code,c.name,c.janCode].map(Gt).some(a=>a.includes(n)):!0),r=l.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
  ...
  `}function ve(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ji(e,t){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},l={holding:"neutral",due:"warning",cleared:"success"},r=e.map(u=>`
      <tr>
  ...
  `}function Ne(e){if(!e)return"error";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"success":n<24?"warning":"error"}function Qt(e){if(!e)return"未同期";const n=(Date.now()-new Date(e).getTime())/(1e3*60*60);return n<1?"正常":n<24?"注意":"要確認"}function Yi(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">
          <span class="status-pill ${Ne(e.lastOverallSync)}">${Qt(e.lastOverallSync)}</span>
        </p>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="status-pill ${Ne(t.lastSyncAt)}">${Qt(t.lastSyncAt)}</span></td>
            </tr>
            `).join("")}
          </tbody>
        </table>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function Qi(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(l=>`<th class="numeric">${l}</th>`).join(""),n=e.monthlyByCustomer.map(l=>{const r=l.values.reduce((a,i)=>a+i,0),c=l.values.map(a=>`<td class="numeric">${a>0?(a/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${l.label}</td>
          ${c}
  ...
  `}function Ki(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Zi(e){return e.replace("-","/")}function el(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=760,n=280,l={top:16,right:24,bottom:36,left:64},r=t-l.left-l.right,c=n-l.top-l.bottom,a=Math.max(...e.map(u=>u.amount),1),i=r/e.length,o=[0,.25,.5,.75,1].map(u=>{const p=l.top+c-c*u,y=`${Math.round(a*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
      ...
      `}).join(""),d=e.map((u,p)=>{const y=u.amount/a*c,v=Math.max(i-18,24),b=l.left+p*i+(i-v)/2,S=l.top+c-y;return`
        <g>
          ...
          <text x="${b+v/2}" y="${n-10}" class="chart-axis centered-axis">${Zi(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function tl(e){return e.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${t.name}</td>
      ...
      `).join("")}function al(e,t){const n=t==="products"?"商品別集計":"得意先別集計",l=t==="products"?e.productTotals:e.customerTotals;return`
    <section class="page-head">
      <div>
  ...
  `}function fe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function sl(e){const t=Math.max(...e.salesByProduct.flatMap(c=>c.values),1),n=e.salesByProduct.map(c=>{const a=c.values.map((i,o)=>`
          <div class="bar-col">
  ...
  `}function nl(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function il(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Wt(e){return e.toISOString().slice(0,10)}function ll(e,t,n){const l=e.length?e.map(r=>`
            <tr>
  ...
  `}function Re(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ol(e,t,n,l){const r={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},c={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},a={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},i=e.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
  ...
  `}const tt={customers:"得意先マスタ",products:"商品マスタ",suppliers:"仕入先マスタ",staff:"担当者マスタ"},rl={customers:{required:["legacy_customer_code","name"],optional:["kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"]},products:{required:["legacy_product_code","name"],optional:["kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"]},suppliers:{required:["legacy_supplier_code","name"],optional:["kana_name","phone","postal_code","address1","closing_day","payment_day","email"]},staff:{required:["legacy_staff_code","name"],optional:["kana_name","department"]}};function cl(e,t,n,l){const r=rl[e],c=Object.keys(tt).map(i=>`
  ...
  `}const ml={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},yl=["new","picking","packed","shipped","delivered"];function hl(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(c=>t[c.stage].push(c));const n=yl.map(c=>{const a=ml[c],i=t[c];return`
  ...
  `}function vl(e,t,n){const l=e.cart.reduce((c,a)=>c+a.amount,0);return`
  ...
  `}function fl(e,t,n){if(e.step==="customer"){const l=e.customerQuery.toLowerCase(),r=l?t.filter(c=>c.name.toLowerCase().includes(l)||c.code.toLowerCase().includes(l)):t.slice(0,20);return`
      <section class="panel">
  ...
  `}const Kt={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},Zt={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},ea={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function bl(e,t){const n=e.find(c=>c.id===t)??e[0],l=e.filter(c=>c.status==="new").length,r=e.filter(c=>c.status==="confirmed").length;return`
    <section class="page-head">
      <div>
...
金井酒造店`;function _l(e,t){const n=t?e.find(r=>r.id===t):null,l=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${n||l?`
      ...
      `:""}
  `}function wl(e,t,n,l){const[r,c]=t.split("-").map(w=>parseInt(w,10)),a=new Date(r,c-1,1),i=new Date(r,c,0),o=a.getDay(),d=i.getDate(),u=[];for(let w=0;w<o;w++)u.push({isOutside:!0});for(let w=1;w<=d;w++)u.push({date:new Date(r,c-1,w)});for(;u.length%7!==0;)u.push({isOutside:!0});const p=n?e.filter(w=>w.category===n):e,y={};p.forEach(w=>{const N=w.startsAt.slice(0,10);y[N]??=[],y[N].push(w)});const v=new Date().toISOString().slice(0,10),b=u.map(w=>{if(w.isOutside)return'<div class="cal-cell cal-outside"></div>';const N=w.date,V=`${N.getFullYear()}-${String(N.getMonth()+1).padStart(2,"0")}-${String(N.getDate()).padStart(2,"0")}`,Z=y[V]??[],Ke=V===v,Ee=N.getDay();return`
      ...
      `}).join(""),S=l?.isOpen?kl(l):"",$=new Date(r,c-2,1),I=new Date(r,c,1),z=`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`,T=`${I.getFullYear()}-${String(I.getMonth()+1).padStart(2,"0")}`,x=(()=>{const w=new Date;return`${w.getFullYear()}-${String(w.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(At).map(([w,N])=>`<option value="${w}" ${n===w?"selected":""}>${N}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
  ...
  `}function xl(e,t){const n=e.reduce((c,a)=>c+a.totalAmount,0),l=e.filter(c=>c.financialStatus==="paid").length,r=e.filter(c=>c.fulfillmentStatus!=="fulfilled"&&c.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function El(e,t,n){const l=t==="__new__"?null:e.find(a=>a.id===t),r=t==="__new__";return n?.role==="admin"?`
    <section class="page-head">
      <div>
  ...
  `}function Cl(e){const t=e.prospects.reduce((c,a)=>c+a.expectedAmount,0),n=e.prospects.reduce((c,a)=>c+a.expectedAmount*a.probability/100,0),l=e.prospects.filter(c=>c.stage==="won").length,r=e.prospects.filter(c=>c.stage==="hot"||c.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    ${e.viewMode==="kanban"?Dl(e.prospects):Pl(e.prospects)}
  ...
  `}function Tl(e,t,n){const l=e?.config.webhook_url??"",r=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
  ...
  `}const Rl=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function Ol(e){const t=e.activeListId?e.lists.find(c=>c.id===e.activeListId):null,n=e.items.filter(c=>c.status==="new").length,l=e.items.filter(c=>c.status==="imported").length,r=e.items.filter(c=>c.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
  ...
  `}const aa={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},jl={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},Ml={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function R(e){return"¥"+e.toLocaleString("ja-JP")}function we(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function cs(e,t){const n=e.reduce((c,a)=>c+a.amount,0),l=Math.floor(n*t),r=n+l;return{subtotal:n,taxAmount:l,total:r}}const C={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function D(e,t){const n=e.align??"left",l=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${l}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function st(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),l=n-2018;return{y:l>0?String(l).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function Fl(e,t,n){const l=st(e.documentDate),r=st(e.orderDate??e.documentDate),c=st(e.deliveryDate??e.documentDate),a=e.lines.slice(0,6).map(($,I)=>{const z=C.detailStartY+I*C.detailRowH,T=C.detailCols,x=[],w=(N,V)=>{V&&x.push(D({...N,y:z,x:N.x+0},V))};return w(T.productName,$.productName+($.spec?` ${$.spec}`:"")),w(T.productCode,$.productCode),w(T.color,$.color??""),w(T.size,[$.size,$.caseQty?`×${$.caseQty}`:""].filter(Boolean).join(" ")),w(T.unit,$.unit),w(T.quantity,$.quantity>0?$.quantity.toLocaleString("ja-JP"):""),w(T.correctedQty,$.correctedQuantity?$.correctedQuantity.toLocaleString("ja-JP"):""),w(T.discount,$.discount?$.discount.toLocaleString("ja-JP"):""),w(T.unitPrice,$.unitPrice>0?$.unitPrice.toLocaleString("ja-JP"):""),w(T.costAmount,$.amount>0?$.amount.toLocaleString("ja-JP"):""),w(T.retailPrice,$.retailPrice?$.retailPrice.toLocaleString("ja-JP"):""),w(T.note,$.receivedAmount?$.receivedAmount.toLocaleString("ja-JP"):""),x.join("")}).join(""),i=e.lines.reduce(($,I)=>$+(I.amount||0),0),o=e.lines.reduce(($,I)=>$+(I.retailPrice||0)*(I.correctedQuantity??I.quantity),0),d=e.lines.reduce(($,I)=>$+(I.receivedAmount||0),0),u=e.lines.reduce(($,I)=>$+(I.returnAmount||0),0),p=e.lines.reduce(($,I)=>$+I.quantity,0),y=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",v=n.calibrationOffsetX||0,b=n.calibrationOffsetY||0,S=`transform: translate(${v}mm, ${b}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${y}">
        ...
        ${D(C.currentDateY,l.y)}
        ${D(C.currentDateM,l.m)}
        ${D(C.currentDateD,l.d)}
        ${D(C.documentNo,e.documentNo)}
        ${e.settlementPrint?D(C.settlementCheck,"✓"):""}

        ${D(C.vendorName,t.name)}
        ${D(C.vendorAddress,t.address1)}
        ${D(C.chainStoreCode,e.chainStoreCode??"")}
        ${D(C.categoryCode,e.categoryCode??"")}
        ${D(C.slipNumber,e.documentNo)}
        ${D(C.vendorCode,e.slipTypeCode??"")}

        ${D(C.customerName,`${e.customerName} ${e.customerHonorific}`)}
        ${D(C.orderDateY,r.y)}
        ${D(C.orderDateM,r.m)}
        ${D(C.orderDateD,r.d)}
        ${D(C.deliveryDateY,c.y)}
        ${D(C.deliveryDateM,c.m)}
        ${D(C.deliveryDateD,c.d)}
        ${D(C.orderNo,e.orderNo??"")}
        ${D(C.partnerCode,e.vendorCode??"")}

        ${a}

        ${D(C.totalQty,p.toLocaleString("ja-JP"))}
        ${D(C.receivedTotal,d.toLocaleString("ja-JP"))}
        ${D(C.returnTotal,u.toLocaleString("ja-JP"))}
        ${D(C.correctedCostTotal,i.toLocaleString("ja-JP"))}
        ${D(C.correctedRetailTotal,o.toLocaleString("ja-JP"))}
        </div>
      </div>
    </div>
  `}function Bl(e,t,n){const{subtotal:l,taxAmount:r,total:c}=cs(e.lines,e.taxRate),a=e.previousBalance??0,i=e.paymentAmount??0,o=a-i+c,d=e.lines.map(p=>`
      <tr>
  ...
  `}function zl(e,t,n){const{subtotal:l,taxAmount:r,total:c}=cs(e.lines,e.taxRate),a=e.lines.map(o=>`
      <tr>
  ...
  `}function Vl(e,t,n,l){let r="";switch(e){case"chain_store":r=Fl(l,n,t);break;case"quotation":r=zl(l,n,t);break;case"invoice_monthly":r=Bl(l,n,t);break}const c=Object.keys(aa).map(o=>`<button class="tab-button ${e===o?"active":""}" data-print-template="${o}">${aa[o]}</button>`).join(""),a=l.lines.map((o,d)=>`
      <tr>
...
`}async function Gl(e,t){const{supabaseInsert:n}=await f(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>q);return{supabaseInsert:i}},void 0);let l=0,r=0;const a={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const i of t){if(!i._valid)continue;const{_valid:o,_error:d,...u}=i,p={...u};if(!p.id){const y=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[y]??`${e}-${Date.now()}-${l+r}`)}for(const y of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[y]=="string"&&p[y]!==""){const v=Number(p[y]);Number.isFinite(v)&&(p[y]=v)}try{await n(a,p)!==null?l++:r++}catch{r++}}return{inserted:l,failed:r}}function nt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function Ql(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Wl(e,t,n,l,r){const c=n.reduce((d,u)=>d+u.rowCount,0),a=n.map(d=>d.lastSyncAt).filter(d=>d!==null).sort().reverse()[0]??null,i=100,o=Math.max(1,Math.ceil(r/i));return`
  ...
  `}function it(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Zl(e,t,n){const l=e.rows.map((d,u)=>`
      <tr>
      ...
      <tr>
        ...
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="categoryCode">
            ${Oa.map(p=>`<option value="${p.code}" ${p.code===d.categoryCode?"selected":""}>${p.code}:${p.name}</option>`).join("")}
          </select>
        </td>
        <td class="numeric">
  ...
  `;const i={id:r,message:e,type:t,el:a};mt.push(i),l.appendChild(a),requestAnimationFrame(()=>{a.classList.add("toast-enter")});const o=()=>so(i);a.querySelector(".toast-dismiss").addEventListener("click",o),setTimeout(()=>{a.classList.add("toast-exit"),a.addEventListener("animationend",o,{once:!0})},c)}function so(e){const t=mt.indexOf(e);t!==-1&&(mt.splice(t,1),e.el.remove())}function no(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function K(e,t={}){const{title:n="確認",confirmLabel:l="OK",cancelLabel:r="キャンセル",variant:c="primary"}=t;return new Promise(a=>{const i=document.createElement("div");i.className="modal-backdrop confirm-backdrop",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    ...
    `;const o=u=>{i.classList.add("confirm-exit"),i.addEventListener("animationend",()=>{i.remove()},{once:!0}),a(u)};i.querySelector(".confirm-cancel").addEventListener("click",()=>o(!1)),i.querySelector(".confirm-ok").addEventListener("click",()=>o(!0)),i.addEventListener("click",u=>{u.target===i&&o(!1)});const d=u=>{u.key==="Escape"&&(document.removeEventListener("keydown",d),o(!1))};document.addEventListener("keydown",d),document.body.appendChild(i),requestAnimationFrame(()=>{i.querySelector(".confirm-ok")?.focus()})})}const io=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
...
</svg>`,lo=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
  <circle cx="14" cy="14" r="13" stroke="currentColor" stroke-width="1.5"/>
...
`)}`,a=new Blob([c],{type:"text/csv;charset=utf-8;"}),i=URL.createObjectURL(a),o=document.createElement("a");o.href=i,o.download=e,document.body.append(o),o.click(),o.remove(),window.setTimeout(()=>URL.revokeObjectURL(i),0)}const ro=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/product-abc","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser","/demand-forecast"];let pe=[];async function co(){const{supabaseQueryAll:e}=await f(async()=>{const{supabaseQueryAll:n}=await Promise.resolve().then(()=>q);return{supabaseQueryAll:n}},void 0);pe=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(n=>typeof n.email=="string"&&n.email.length>0).map(n=>({name:String(n.name??""),email:String(n.email??""),area:String(n.delivery_area_code??""),historySegment:"seasonal"}))}const na=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/product-abc",title:"商品ABC分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"},{path:"/demand-forecast",title:"需要予測・納品カレンダー"}];function ds(e){const t=bt[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function It(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function uo(){const e=ds("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const We=new Date,po=We.toISOString().slice(0,7),mo=We.getFullYear(),yo=We.getMonth()+1,ho=We.toISOString().slice(0,10),vo="C0011",ne=uo();function us(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return ro.includes(n)?n:"/"}function Ct(e){switch(e){case"/invoice-entry":case"/quote":case"/delivery":case"/billing":case"/invoice":case"/ledger":return"sales";case"/analytics":case"/customer-analysis":case"/product-abc":case"/product-power":case"/customer-efficiency":case"/report":case"/demand-forecast":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const ia=us(location.pathname),s={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:It(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:po,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:mo,taxMonth:yo,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],callLogs:[],mapFilters:{showCustomers:!0,showProspects:!0,showDelivery:!0,filterRegion:"",filterBusinessType:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...jl,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...Ml},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:ho,route:ia,currentCategory:Ct(ia),sidebarOpen:!1,announcements:[],dismissedAnnouncements:new Set,updateAvailable:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:vo,salesPeriod:"month",customRange:{start:"",end:""},quoteState:(()=>{const e={...Za};try{const t=localStorage.getItem("quote-seal");t&&(e.sealSettings=JSON.parse(t))}catch{}return e})(),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,productPower:[],customerEfficiency:[],masterTab:"customers",masterFilter:{...Lt},analyticsTab:"products",emailAudienceMode:ne.mode,emailRegion:ne.region,emailHistorySegment:ne.historySegment,emailTemplateId:ne.templateId,emailSubject:ne.subject,emailBody:ne.body,emailSaveMessage:ne.saveMessage,emailSending:!1,demandForecast:{...Jn},globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function la(e){return e.slice(0,10)}function fo(e){return{...e}}function Je(){s.pickerMode=null,s.pickerQuery="",s.pickerTargetLine=null}function ps(){s.invoiceForm=It(),s.invoiceSavedDocNo=null,s.invoicePriceGroup="",s.invoiceErrors={},Je()}function ms(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,l)=>{n.productCode.trim()||(t[`lines.${l}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${l}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${l}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${l}.unitPrice`]="単価は0円以上で入力してください。")}),t}function bo(e){const t=s.invoiceForm.lines[e];t&&s.invoiceForm.lines.splice(e+1,0,fo(t))}function go(){const e=s.invoiceRecords[0],t=s.masterStats?.customers[0],n=s.masterStats?.products.slice(0,2)??[];s.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:s.invoiceForm.staffCode||"S001",lines:n.map((l,r)=>{const c=r===0?1:2,a=1200*(r+1);return{productCode:l.code,productName:l.name,quantity:c,unitPrice:a,unit:"本",amount:c*a}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},s.invoiceSavedDocNo=null,s.invoiceErrors={}}function $o(e){const t=s.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function _o(e){const t=s.masterStats?.customers.find(n=>n.name===e.trim());return t?(s.invoiceForm.customerCode=t.code,s.invoiceForm.customerName=t.name,s.invoicePriceGroup=t.priceGroup||"",!0):!1}function ys(e){if(Q(e),s.invoiceErrors=ms(s.invoiceForm),Object.keys(s.invoiceErrors).length>0){h();return}s.invoiceSaving=!0,h(),$a(s.invoiceForm).then(t=>{s.invoiceSavedDocNo=t.documentNo,s.invoiceSaving=!1,s.invoiceErrors={},s.invoiceForm=It(),h()}).catch(()=>{s.invoiceSaving=!1,h()})}function hs(e){const t=s.salesFilter.startDate?new Date(s.salesFilter.startDate):null,n=s.salesFilter.endDate?new Date(`${s.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((l,r)=>new Date(r.date).getTime()-new Date(l.date).getTime()).filter(l=>{const r=new Date(l.date);return!(t&&r<t||n&&r>n)})}function vs(){switch(s.emailAudienceMode){case"area":return s.emailRegion==="all"?pe:pe.filter(e=>e.area===s.emailRegion);case"history":return pe.filter(e=>e.historySegment===s.emailHistorySegment);default:return pe}}function wo(){const e=vs();return{audienceMode:s.emailAudienceMode,region:s.emailRegion,historySegment:s.emailHistorySegment,selectedTemplateId:s.emailTemplateId,subject:s.emailSubject,body:s.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:s.emailSaveMessage,sending:s.emailSending,senderId:s.emailSenderId,senders:s.mailSenders}}function lt(e){const t=vs(),n=s.emailAudienceMode==="area"?s.emailRegion:s.emailAudienceMode==="history"?s.emailHistorySegment:"all";return{subject:s.emailSubject.trim(),body:s.emailBody.trim(),templateId:s.emailTemplateId,audienceMode:s.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(l=>l.email),status:e}}function Dt(){return s.user,!1}function Se(){s.globalSearchOpen=!1,s.globalQuery=""}function ko(){const e=s.globalQuery.trim().toLowerCase();return e?{customers:s.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:s.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:s.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:na.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:na}}function So(){let e=[],t,n="export.csv";switch(s.route){case"/sales":e=(s.salesSummary?hs(s.salesSummary):[]).map(l=>({documentNo:l.documentNo,date:l.date,customerCode:l.customerCode,customerName:l.customerName,amount:l.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...s.paymentStatus?.records??[]].sort((l,r)=>r.balanceAmount-l.balanceAmount).map(l=>({...l})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=s.invoiceRecords.map(l=>({...l})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=s.purchaseList.map(l=>({...l})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=s.jikomiList.map(l=>({...l})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=s.tankList.map(l=>({...l})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=s.kenteiList.map(l=>({...l})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=s.materialList.map(l=>({...l})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":s.masterTab==="customers"?(e=s.masterStats?.customers.map(l=>({...l}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=s.masterStats?.products.map(l=>({...l}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}oo(n,e,t)}function oa(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),s.route=e,s.currentCategory=Ct(e),s.sidebarOpen=!1,Se(),Pt(e)}async function Pt(e){s.actionLoading=!0,h();try{switch(e){case"/delivery":s.deliveryNote||(s.deliveryNote=await wt(s.deliverySearchDocNo||"D240122"));break;case"/billing":s.billingSummary||(s.billingSummary=await kt(s.billingYearMonth));break;case"/report":s.salesReport||(s.salesReport=await Ge());break;case"/product-power":return ns(s.productPower);case"/customer-efficiency":return is(s.customerEfficiency);case"/customer-analysis":s.customerAnalysis||(s.customerAnalysis=await La());break;case"/demand-forecast":if(s.demandForecast.forecasts.length===0){const{fetchProductMonthlyShipments:t,fetchDeliverySchedule:n}=await f(async()=>{const{fetchProductMonthlyShipments:c,fetchDeliverySchedule:a}=await Promise.resolve().then(()=>_);return{fetchProductMonthlyShipments:c,fetchDeliverySchedule:a}},void 0),[l,r]=await Promise.all([t(),n()]);s.demandForecast.forecasts=Hn(l),s.demandForecast.deliveries=Xn(r)}break;case"/jikomi":s.jikomiList.length===0&&(s.jikomiList=await Ca());break;case"/tanks":s.tankList.length===0&&(s.tankList=await Da());break;case"/kentei":s.kenteiList.length===0&&(s.kenteiList=await Pa());break;case"/materials":s.materialList.length===0&&(s.materialList=await rt());break;case"/purchase":(s.purchaseList.length===0||s.payableList.length===0)&&([s.purchaseList,s.payableList]=await Promise.all([qa(),Ta()]));break;case"/raw-material":(s.billList.length===0||s.rawStockList.length===0)&&([s.billList,s.rawStockList]=await Promise.all([Na(),Ra()]));break;case"/tax":s.taxDeclaration||(s.taxDeclaration=await St(s.taxYear,s.taxMonth));break;case"/store":(s.storeSales.length===0||s.storeOrders.length===0)&&([s.storeSales,s.storeOrders]=await Promise.all([xt(s.storeSalesDate),Ma()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await f(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>_);return{fetchMailSenders:n}},void 0);if(s.mailSenders=await t(),!s.emailSenderId||!s.mailSenders.find(n=>n.id===s.emailSenderId)){const n=s.mailSenders.find(l=>l.isDefault)??s.mailSenders[0];n&&(s.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await f(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>_);return{fetchCalendarEvents:n}},void 0);s.calendarEvents=await t(s.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await f(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>_);return{fetchIntegrationSettings:n}},void 0);s.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchShopifyOrders:l,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>_);return{fetchShopifyOrders:l,fetchIntegrationSettings:r}},void 0);s.shopifyOrders=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchFaxInbox:l,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>_);return{fetchFaxInbox:l,fetchIntegrationSettings:r}},void 0);s.faxRecords=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await f(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>_);return{fetchUserProfiles:n}},void 0);s.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:l}=await f(async()=>{const{fetchMyProfile:c,fetchAuditLogs:a,fetchMailSenders:i}=await Promise.resolve().then(()=>_);return{fetchMyProfile:c,fetchAuditLogs:a,fetchMailSenders:i}},void 0),r=s.user?.email??s.myProfile?.email??"";r&&(s.myProfile=await t(r)),s.mailSenders.length===0&&(s.mailSenders=await l()),s.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await f(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>_);return{fetchAuditLogs:n}},void 0);s.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await f(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>_);return{fetchProspects:n}},void 0);s.prospects=await t()}break;case"/map":{const{fetchProspects:t,fetchDeliveryLocations:n,fetchIntegrationSettings:l}=await f(async()=>{const{fetchProspects:r,fetchDeliveryLocations:c,fetchIntegrationSettings:a}=await Promise.resolve().then(()=>_);return{fetchProspects:r,fetchDeliveryLocations:c,fetchIntegrationSettings:a}},void 0);s.prospects=await t(),s.deliveryLocations=await n(),s.integrations.length===0&&(s.integrations=await l())}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchCallLogs:l,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>_);return{fetchCallLogs:l,fetchIntegrationSettings:r}},void 0);s.callLogs=await t(100),s.integrations.length===0&&(s.integrations=await n())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:n}=await f(async()=>{const{fetchLeadLists:l,fetchIntegrationSettings:r}=await Promise.resolve().then(()=>_);return{fetchLeadLists:l,fetchIntegrationSettings:r}},void 0);s.leadLists=await t(),s.integrations.length===0&&(s.integrations=await n())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await f(async()=>{const{fetchWorkflowOrdersFromDb:n}=await Promise.resolve().then(()=>_);return{fetchWorkflowOrdersFromDb:n}},void 0);s.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await f(async()=>{const{fetchTourInquiriesFromDb:n}=await Promise.resolve().then(()=>_);return{fetchTourInquiriesFromDb:n}},void 0);s.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:l}=await f(async()=>{const{fetchSlackRules:r,fetchSlackLogs:c,fetchIntegrationSettings:a}=await Promise.resolve().then(()=>_);return{fetchSlackRules:r,fetchSlackLogs:c,fetchIntegrationSettings:a}},void 0);s.slackRules=await t(),s.slackLogs=await n(50),s.integrations.length===0&&(s.integrations=await l())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:n,fetchWorkflowOrdersFromDb:l,fetchTourInquiriesFromDb:r}=await f(async()=>{const{fetchProspects:c,fetchCalendarEvents:a,fetchWorkflowOrdersFromDb:i,fetchTourInquiriesFromDb:o}=await Promise.resolve().then(()=>_);return{fetchProspects:c,fetchCalendarEvents:a,fetchWorkflowOrdersFromDb:i,fetchTourInquiriesFromDb:o}},void 0);s.prospects.length===0&&(s.prospects=await t()),s.calendarEvents.length===0&&(s.calendarEvents=await n(s.calendarYearMonth)),s.materialList.length===0&&(s.materialList=await rt()),s.workflowOrders.length===0&&(s.workflowOrders=await l()),s.tourInquiries.length===0&&(s.tourInquiries=await r())}break;default:break}}catch(t){console.warn("Route data load error",t)}finally{s.actionLoading=!1,h()}}function ra(){if(Dt())return Ii(s.authError,s.authSubmitting);if(s.loading)return`
    ...
    `;switch(s.route){case"/cat/sales":return Le("sales");case"/cat/brewery":return Le("brewery");case"/cat/purchase":return Le("purchase");case"/cat/more":return Le("more");case"/invoice-entry":return pi(s.invoiceForm,s.invoiceSavedDocNo,s.invoiceSaving,s.invoiceErrors);case"/quote":return vi(s.quoteState,s.masterStats?.customers??[],s.masterStats?.products??[],s.quoteCustomerQuery,s.quoteProductQuery,s.quotePricing);case"/email":return ri(wo());case"/delivery":return s.deliveryNote?li(s.deliveryNote,s.deliverySearchDocNo):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/billing":return s.billingSummary?jn(s.billingSummary,s.billingYearMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/report":return s.salesReport?sl(s.salesReport):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":return ns(s.productPower);case"/customer-efficiency":return is(s.customerEfficiency);case"/customer-analysis":return s.customerAnalysis?Wi(s.customerAnalysis):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-abc":case"/product-power":case"/customer-efficiency":return'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/demand-forecast":return Kn(s.demandForecast);case"/jikomi":return s.jikomiView==="calendar"?`${Ht(s.jikomiList,s.jikomiView)}${Ai(s.jikomiList)}`:Ht(s.jikomiList,s.jikomiView);case"/tanks":return Kl(s.tankList);case"/kentei":return Ei(s.kenteiList);case"/materials":return ji(s.materialList)+Oi(s.materialEditing,s.materialEditingIsNew);case"/purchase":return Vi(s.purchaseList,s.payableList);case"/raw-material":return Ji(s.billList,s.rawStockList);case"/tax":return s.taxDeclaration?Zl(s.taxDeclaration,s.taxYear,s.taxMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/store":return ol(s.storeSales,s.storeOrders,s.storeTab,s.storeSalesDate);case"/setup":return s.pipelineMeta?Hi(s.pipelineMeta,J,j,s.syncDashboard):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/raw-browser":return Wl(s.rawSelectedTable,s.rawRecords,s.rawTableList,s.rawPage,s.rawTotalCount);case"/import":return cl(s.importEntity,s.importPreview,s.importing,s.importResult);case"/print":return Vl(s.printTemplate,s.printOptions,s.printCompany,s.printData);case"/form-designer":return ul(s.printData,s.printCompany,s.printOptions,s.fdSavedPositions,s.fdDesignMode);case"/map":{const e=(s.masterStats?.customers??[]).slice(0,200).map((l,r)=>{const c=l;return{...l,lat:c.lat??35.37+r%12*.05+(Math.random()-.5)*.02,lng:c.lng??139.29+Math.floor(r/12)*.05+(Math.random()-.5)*.02,address1:c.address1??"",businessType:c.businessType??"",lastOrderAmount:0}}),n=!!s.integrations.find(l=>l.provider==="google_maps")?.config.api_key;return pl(e,s.prospects,s.deliveryLocations,s.mapFilters,n)}case"/workflow":return hl(s.workflowOrders);case"/mobile-order":return vl(s.mobileOrder,s.masterStats?.customers??[],s.masterStats?.products??[]);case"/tour":return bl(s.tourInquiries,s.tourActiveId);case"/mail-senders":return _l(s.mailSenders,s.mailSenderEditingId);case"/calendar":return wl(s.calendarEvents,s.calendarYearMonth,s.calendarFilterCategory,s.calendarEdit);case"/integrations":return Sl(s.integrations,s.integrationEditingId);case"/shopify":{const e=s.integrations.find(t=>t.id==="shopify");return xl(s.shopifyOrders,e?.lastSyncAt??null)}case"/fax":return Al(s.faxRecords,s.faxProcessing,s.faxOcrText);case"/users":return El(s.userProfiles,s.userEditingId,s.myProfile);case"/profile":return Ll(s.myProfile,s.auditLogs.filter(e=>e.userEmail===s.myProfile?.email),s.mailSenders);case"/audit":return Il(s.auditLogs);case"/prospects":{const e={prospects:s.prospects,activities:s.prospectActivities,editingId:s.prospectEditingId,viewMode:s.prospectViewMode};return Cl(e)}case"/slack":{const e=s.integrations.find(t=>t.provider==="slack")??null;return Tl(e,s.slackRules,s.slackLogs)}case"/calls":{const e=s.integrations.find(t=>t.provider==="ivry");return Nl(s.callLogs,s.masterStats?.customers??[],e?.lastSyncAt??null,e?.isEnabled??!1)}case"/list-builder":{const e={lists:s.leadLists,activeListId:s.leadActiveListId,items:s.leadItems,searchQuery:s.leadSearchQuery,searchArea:s.leadSearchArea,searchBusinessType:s.leadSearchType,searching:s.leadSearching,searchResults:s.leadSearchResults};return Ol(e)}}if(!s.salesSummary||!s.paymentStatus||!s.masterStats||!s.pipelineMeta||!s.customerLedger||!s.salesAnalytics)return"";switch(s.route){case"/sales":return ll(hs(s.salesSummary),s.salesFilter.startDate,s.salesFilter.endDate);case"/payment":return Bi([...s.paymentStatus.records].sort((e,t)=>t.balanceAmount-e.balanceAmount));case"/master":return Ri(s.masterStats,s.masterTab,s.masterFilter);case"/invoice":return _i(s.invoiceRecords,s.invoiceFilter);case"/ledger":return Vn(s.customerLedger,s.ledgerCustomerCode);case"/analytics":return al(s.salesAnalytics,s.analyticsTab);default:return si(s.salesSummary,s.pipelineMeta,s.salesAnalytics,{prospects:s.prospects,upcomingEvents:s.calendarEvents,tourInquiries:s.tourInquiries,workflowOrdersCount:{new:s.workflowOrders.filter(e=>e.stage==="new").length,picking:s.workflowOrders.filter(e=>e.stage==="picking").length,packed:s.workflowOrders.filter(e=>e.stage==="packed").length,shipped:s.workflowOrders.filter(e=>e.stage==="shipped").length,total:s.workflowOrders.length},lowStockCount:s.materialList.filter(e=>e.currentStock<e.minimumStock*1.5).length,masterCounts:s.masterStats?{customers:s.masterStats.summary.customerCount,products:s.masterStats.summary.productCount,suppliers:s.syncDashboard?.tables.find(e=>e.tableName==="suppliers")?.rowCount??0,specialPrices:s.syncDashboard?.tables.find(e=>e.tableName==="customer_product_prices")?.rowCount??0}:void 0},s.salesPeriod,s.customRange)}}function xo(){const e={info:{bg:"#edf6ff",border:"#b8d4e8",icon:"ℹ️"},warning:{bg:"#fff8e6",border:"#e6c54d",icon:"⚠️"},maintenance:{bg:"#fff3e0",border:"#f5a623",icon:"🔧"},update:{bg:"#e8f5e9",border:"#66bb6a",icon:"🆕"}},n=s.announcements.filter(r=>!s.dismissedAnnouncements.has(r.id)).map(r=>{const c=e[r.level]??e.info;return`
      ...
      </div>`:"";return n+l}function Ao(){if(Dt())return`
    ...
    `;const e={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売業務",items:[{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/quote",label:"見積作成",kicker:"Quote"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],analytics:[{label:"分析",items:[{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/customer-analysis",label:"得意先分析",kicker:"CustABC"},{path:"/product-abc",label:"商品ABC",kicker:"ProdABC"},{path:"/product-power",label:"商品力分析",kicker:"Power"},{path:"/customer-efficiency",label:"営業効率",kicker:"Efficiency"},{path:"/demand-forecast",label:"需要予測",kicker:"Forecast"},{path:"/report",label:"集計帳票",kicker:"Report"}]}],crm:[{label:"営業・顧客",items:[{path:"/prospects",label:"新規営業",kicker:"Prospects"},{path:"/map",label:"取引先マップ",kicker:"Map"},{path:"/list-builder",label:"リスト取得",kicker:"ListBuild"},{path:"/calls",label:"通話履歴",kicker:"Calls"},{path:"/email",label:"メール配信",kicker:"Mail"}]},{label:"受注・出荷",items:[{path:"/workflow",label:"受注ワークフロー",kicker:"Workflow"},{path:"/mobile-order",label:"モバイル受注",kicker:"Mobile"},{path:"/shopify",label:"Shopify注文",kicker:"Shopify"},{path:"/fax",label:"FAX OCR",kicker:"FAX"}]}],orders:[{label:"仕入・調達",items:[{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],brewery:[{label:"製造管理",items:[{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"},{path:"/tax",label:"酒税申告",kicker:"Tax"}]}],master:[{label:"マスタ・ツール",items:[{path:"/master",label:"マスタ管理",kicker:"Master"},{path:"/calendar",label:"カレンダー",kicker:"Calendar"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/tour",label:"酒蔵見学",kicker:"Tour"},{path:"/print",label:"印刷",kicker:"Print"}]}],settings:[{label:"システム設定",items:[{path:"/setup",label:"連動設定",kicker:"Setup"},{path:"/integrations",label:"外部連携",kicker:"API"},{path:"/slack",label:"Slack通知",kicker:"Slack"},{path:"/import",label:"データ取込",kicker:"Import"},{path:"/raw-browser",label:"データブラウザ",kicker:"RawData"},{path:"/users",label:"ユーザー管理",kicker:"Users"},{path:"/profile",label:"プロフィール",kicker:"Profile"},{path:"/audit",label:"操作ログ",kicker:"Audit"}]}]},t=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/invoice-entry",label:"販売"},{category:"analytics",path:"/analytics",label:"分析"},{category:"crm",path:"/prospects",label:"営業"},{category:"orders",path:"/purchase",label:"仕入"},{category:"brewery",path:"/jikomi",label:"製造"},{category:"master",path:"/master",label:"マスタ"},{category:"settings",path:"/setup",label:"設定"}],n=e[s.currentCategory].map(i=>`
      ...
      `).join(""),r=s.pickerMode&&s.masterStats?s.pickerMode==="customer"?di(s.masterStats.customers,s.pickerQuery):zi(s.masterStats.products,s.pickerQuery):"",c=s.globalSearchOpen?ci(s.globalQuery,ko()):"",a=s.user?`
