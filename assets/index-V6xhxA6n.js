(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}})();const Yn="modulepreload",Un=function(e){return"/"+e},Ra={},E=function(t,s,n){let i=Promise.resolve();if(s&&s.length>0){let y=function(f){return Promise.all(f.map(v=>Promise.resolve(v).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};var c=y;document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),u=p?.nonce||p?.getAttribute("nonce");i=y(s.map(f=>{if(f=Un(f),f in Ra)return;Ra[f]=!0;const v=f.endsWith(".css"),b=v?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${b}`))return;const x=document.createElement("link");if(x.rel=v?"stylesheet":Yn,v||(x.as="script"),x.crossOrigin="",x.href=f,u&&x.setAttribute("nonce",u),document.head.appendChild(x),v)return new Promise((k,o)=>{x.addEventListener("load",k),x.addEventListener("error",()=>o(new Error(`Unable to preload CSS for ${f}`)))})}))}function r(p){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=p,window.dispatchEvent(u),!u.defaultPrevented)throw p}return i.then(p=>{for(const u of p||[])u.status==="rejected"&&r(u.reason);return t().catch(r)})},se="https://loarwnuyvfxiscjjsmiz.supabase.co",J="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";async function rt(e,t){try{const s=new URL(`/rest/v1/${e}`,se),n=await fetch(s.toString(),{method:"POST",headers:{apikey:J,Authorization:`Bearer ${J}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(t)});if(!n.ok)throw new Error(`HTTP ${n.status}`);return(await n.json())[0]??null}catch(s){return console.warn(`Failed to insert into Supabase table ${e}`,s),null}}async function ma(e,t){try{const s=new URL(`/rest/v1/${e}`,se),n=await fetch(s.toString(),{method:"POST",headers:{apikey:J,Authorization:`Bearer ${J}`,"Content-Type":"application/json",Prefer:"return=representation,resolution=merge-duplicates"},body:JSON.stringify(t)});if(!n.ok)throw new Error(`HTTP ${n.status}`);return(await n.json())[0]??null}catch(s){return console.warn(`Failed to upsert into Supabase table ${e}`,s),null}}async function ya(e,t,s){try{const n=new URL(`/rest/v1/${e}?id=eq.${t}`,se);return(await fetch(n.toString(),{method:"PATCH",headers:{apikey:J,Authorization:`Bearer ${J}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(s)})).ok}catch{return!1}}async function le(e,t={}){try{const s=new URL(`/rest/v1/rpc/${e}`,se),n=await fetch(s.toString(),{method:"POST",headers:{apikey:J,Authorization:`Bearer ${J}`,"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(s){return console.warn(`Failed to call Supabase RPC ${e}`,s),null}}async function ha(e){try{const t=new URL(`/rest/v1/${e}`,se);t.searchParams.set("select","*"),t.searchParams.set("limit","0");const s=await fetch(t.toString(),{method:"GET",headers:{apikey:J,Authorization:`Bearer ${J}`,Accept:"application/json",Prefer:"count=exact"}});if(!s.ok)return 0;const n=s.headers.get("Content-Range");if(n){const i=n.match(/\/(\d+)/);if(i)return parseInt(i[1],10)}return 0}catch{return 0}}async function N(e,t={}){try{const s=new URL(`/rest/v1/${e}`,se);Object.entries(t).forEach(([i,r])=>{s.searchParams.set(i,r)});const n=await fetch(s.toString(),{method:"GET",headers:{apikey:J,Authorization:`Bearer ${J}`,Accept:"application/json",Prefer:"return=representation"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(s){return console.warn(`Failed to query Supabase table ${e}`,s),[]}}async function ws(e,t){try{const s=new URL(`/rest/v1/${e}?id=eq.${encodeURIComponent(t)}`,se);return(await fetch(s.toString(),{method:"DELETE",headers:{apikey:J,Authorization:`Bearer ${J}`}})).ok}catch{return!1}}async function ee(e,t={},s=1e3){const n=[];let i=0;try{for(;;){const r=new URL(`/rest/v1/${e}`,se);Object.entries(t).forEach(([u,y])=>{r.searchParams.set(u,y)}),r.searchParams.set("limit",String(s)),r.searchParams.set("offset",String(i));const c=await fetch(r.toString(),{method:"GET",headers:{apikey:J,Authorization:`Bearer ${J}`,Accept:"application/json",Prefer:"return=representation"}});if(!c.ok)throw new Error(`HTTP ${c.status}`);const p=await c.json();if(n.push(...p),p.length<s)break;i+=s}return n}catch(r){return console.warn(`Failed to query all rows from Supabase table ${e}`,r),n.length>0?n:[]}}const B=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:J,SUPABASE_URL:se,supabaseCount:ha,supabaseDelete:ws,supabaseInsert:rt,supabaseQuery:N,supabaseQueryAll:ee,supabaseRpc:le,supabaseUpdate:ya,supabaseUpsert:ma},Symbol.toStringTag,{value:"Module"})),fa="sake_auth";function xs(e){localStorage.setItem(fa,JSON.stringify(e))}function Ss(){return{apikey:J,"Content-Type":"application/json"}}function Qn(e){try{const[,t]=e.split(".");if(!t)return null;const s=t.replaceAll("-","+").replaceAll("_","/"),n=s.padEnd(Math.ceil(s.length/4)*4,"=");return JSON.parse(atob(n))}catch{return null}}async function ks(e,t){const s=await fetch(`${se}/auth/v1/${e}`,{method:"POST",headers:Ss(),body:JSON.stringify(t)}),n=await s.json().catch(()=>({}));if(!s.ok)throw new Error(n.error_description??n.msg??`HTTP ${s.status}`);return n}async function Hn(e,t){const s=await ks("token?grant_type=password",{email:e,password:t});return xs({access_token:s.access_token,refresh_token:s.refresh_token}),{email:s.user?.email??e}}async function ja(e,t){const s=await ks("signup",{email:e,password:t});return s.access_token&&s.refresh_token&&xs({access_token:s.access_token,refresh_token:s.refresh_token}),{email:s.user?.email??e}}async function Gn(){const e=Dt();if(localStorage.removeItem(fa),!!e?.access_token)try{await fetch(`${se}/auth/v1/logout`,{method:"POST",headers:{...Ss(),Authorization:`Bearer ${e.access_token}`}})}catch(t){console.warn("Supabase sign out failed",t)}}function Dt(){const e=localStorage.getItem(fa);if(!e)return null;try{const t=JSON.parse(e);return!t.access_token||!t.refresh_token?null:{access_token:t.access_token,refresh_token:t.refresh_token}}catch{return null}}function Xn(){const e=Dt();if(!e)return null;const t=Qn(e.access_token),s=typeof t?.email=="string"?t.email:null;return s?{email:s}:null}async function Kn(e){const t=Dt();if(!t)throw new Error("not signed in");const s=await fetch(`${se}/auth/v1/user`,{method:"PUT",headers:{apikey:J,Authorization:`Bearer ${t.access_token}`,"Content-Type":"application/json"},body:JSON.stringify({password:e})});if(!s.ok){const n=await s.json().catch(()=>({}));throw new Error(n.msg??`HTTP ${s.status}`)}}const va={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
`),s=e.deductions.map(n=>`    <Deduction type="${he(n.type)}">
      <CategoryCode>${he(n.categoryCode)}</CategoryCode>
      <Volume>${n.volume}</Volume>
      <Reason>${he(n.reason)}</Reason>${n.documentNo?`
      <DocumentNo>${he(n.documentNo)}</DocumentNo>`:""}
    </Deduction>`).join(`
...
<TaxDeclaration>
  <Header>
    ...
    <TaxpayerId>${he(e.companyNo)}</TaxpayerId>
    <TaxpayerName>${he(e.companyName)}</TaxpayerName>
    <TaxpayerAddress>${he(e.companyAddress)}</TaxpayerAddress>
    <TaxpayerRepresentative>${he(e.companyRepresentative)}</TaxpayerRepresentative>
    <TaxOffice>${he(e.taxOffice)}</TaxOffice>
...
`}function zo(e){const t=e.rows.map(i=>{const r=Math.max(0,i.productionVolume+i.previousBalance+i.currentAdjustment-i.exportDeduction-i.sampleDeduction),c=Math.round(r*i.taxRate);return{...i,taxableVolume:r,volume:r,taxAmount:c}}),s=t.reduce((i,r)=>i+r.taxableVolume,0),n=t.reduce((i,r)=>i+r.taxAmount,0);return{...e,rows:t,totalVolume:s,totalTax:n}}async function Bo(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>B);return{supabaseInsert:s}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:Ks(e),submitted_at:e.submittedAt})}async function ka(e){const t=await N("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(s=>({id:h(s,["id"],""),saleDate:h(s,["sale_date"],e),saleTime:h(s,["sale_time"],""),productCode:h(s,["product_code"],""),productName:h(s,["product_name"],""),quantity:P(s,["quantity"],0),unitPrice:P(s,["unit_price"],0),amount:P(s,["amount"],0),paymentMethod:h(s,["payment_method"],"cash")})):[]}async function Ws(){const e=await N("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:h(t,["id"],""),orderNo:h(t,["order_no"],""),orderDate:Z(t,["order_date"],""),customerName:h(t,["customer_name"],""),postalCode:h(t,["postal_code"],""),address:h(t,["shipping_address"],""),items:[],totalAmount:P(t,["total_amount"],0),status:h(t,["status"],"new"),shippingDate:Z(t,["shipping_date"],"")})):[]}async function wt(e){const t=await rt("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function Zs(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function Vo(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await N("print_layouts",t)).map(n=>({id:h(n,["id"],""),name:h(n,["name"],""),templateKey:h(n,["template_key"],""),positions:n.positions??{},isDefault:te(n,["is_default"],!1),note:h(n,["note"],""),updatedAt:h(n,["updated_at"],"")}))}async function Jo(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>B);return{supabaseInsert:i}},void 0),s={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},n=await t("print_layouts",s);return n?{id:h(n,["id"],e.id),name:h(n,["name"],e.name),templateKey:h(n,["template_key"],e.templateKey),positions:n.positions??e.positions,isDefault:te(n,["is_default"],!1),note:h(n,["note"],""),updatedAt:h(n,["updated_at"],"")}:null}async function Yo(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const s="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:s,Authorization:`Bearer ${s}`}})).ok}catch{return!1}}async function Uo(){return(await N("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),email:h(t,["email"],""),displayName:h(t,["display_name"],""),signature:h(t,["signature"],""),replyTo:h(t,["reply_to"],""),isDefault:te(t,["is_default"],!1),isVerified:te(t,["is_verified"],!1),note:h(t,["note"],"")}))}async function Qo(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0),s=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return s?{id:h(s,["id"],e.id),name:h(s,["name"],e.name),email:h(s,["email"],e.email),displayName:h(s,["display_name"],""),signature:h(s,["signature"],""),replyTo:h(s,["reply_to"],""),isDefault:te(s,["is_default"],!1),isVerified:te(s,["is_verified"],!1)}:null}async function Ho(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const Pa={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},Ca={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Go(e){const t=`${e}-01T00:00:00Z`,[s,n]=e.split("-").map(p=>parseInt(p,10)),i=new Date(s,n,0).getDate(),r=`${e}-${String(i).padStart(2,"0")}T23:59:59Z`;return(await N("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${r})`,order:"starts_at.asc"})).map(p=>({id:h(p,["id"],""),title:h(p,["title"],""),description:h(p,["description"],""),category:h(p,["category"],"general")||"general",startsAt:h(p,["starts_at"],new Date().toISOString()),endsAt:h(p,["ends_at"],""),isAllDay:te(p,["is_all_day"],!1),location:h(p,["location"],""),attendees:p.attendees??[],relatedCustomerCode:h(p,["related_customer_code"],""),relatedOrderId:h(p,["related_order_id"],""),color:h(p,["color"],""),googleEventId:h(p,["google_event_id"],"")}))}async function Xo(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??Ca[e.category],updated_at:new Date().toISOString()})?e:null}async function Ko(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function en(){return(await N("integration_settings",{order:"name.asc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),provider:h(t,["provider"],""),config:t.config??{},isEnabled:te(t,["is_enabled"],!1),lastSyncAt:h(t,["last_sync_at"],""),lastStatus:h(t,["last_status"],"")}))}async function lt(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function Wo(e){const t=e.config.shop_domain,s=e.config.admin_token;if(!t||!s)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const n=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,i=await fetch(n,{headers:{"X-Shopify-Access-Token":s,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const r=await i.json(),{supabaseInsert:c}=await E(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>B);return{supabaseInsert:u}},void 0);let p=0;for(const u of r.orders){const y=`shopify_${u.id}`;await c("shopify_orders",{id:y,shopify_order_id:String(u.id),order_number:String(u.order_number??""),order_date:String(u.created_at??new Date().toISOString()),customer_name:String(u.customer?.first_name??"")+" "+String(u.customer?.last_name??""),customer_email:String(u.customer?.email??""),total_amount:Math.round(parseFloat(String(u.total_price??"0"))),financial_status:String(u.financial_status??""),fulfillment_status:String(u.fulfillment_status??"unfulfilled"),line_items:u.line_items??[],shipping_address:u.shipping_address??null,raw_payload:u}),p++}return await lt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得成功`}),{count:p}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function Zo(){return(await N("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:h(t,["id"],""),shopifyOrderId:h(t,["shopify_order_id"],""),orderNumber:h(t,["order_number"],""),orderDate:h(t,["order_date"],""),customerName:h(t,["customer_name"],""),customerEmail:h(t,["customer_email"],""),totalAmount:Y(t.total_amount),financialStatus:h(t,["financial_status"],""),fulfillmentStatus:h(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function ei(e){const t=e.config.refresh_token,s=e.config.client_id,n=e.config.client_secret;if(!t||!s||!n)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:s,client_secret:n})});if(!i.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${i.status}`};const c=(await i.json()).access_token;return await lt({...e,config:{...e.config,oauth_token:c}}),e.config.oauth_token=c,{token:c}}async function ti(e){let t=e.config.oauth_token;const s=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const n=new Date().toISOString(),i=new Date(Date.now()+30*86400*1e3).toISOString(),r=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(s)}/events?timeMin=${n}&timeMax=${i}&singleEvents=true&orderBy=startTime`;let c=await fetch(r,{headers:{Authorization:`Bearer ${t}`}});if(c.status===401){const f=await ei(e);if(f.error)return{count:0,error:f.error};t=f.token,c=await fetch(r,{headers:{Authorization:`Bearer ${t}`}})}if(!c.ok)return{count:0,error:`HTTP ${c.status}`};const p=await c.json(),{supabaseInsert:u}=await E(async()=>{const{supabaseInsert:f}=await Promise.resolve().then(()=>B);return{supabaseInsert:f}},void 0);let y=0;for(const f of p.items){const v=`gcal_${f.id}`,b=f.start?.dateTime??f.start?.date??"",x=f.end?.dateTime??f.end?.date??"";await u("calendar_events",{id:v,title:String(f.summary??"(無題)"),description:String(f.description??""),category:"general",starts_at:String(b),ends_at:String(x),location:String(f.location??""),google_event_id:String(f.id??""),updated_at:new Date().toISOString()}),y++}return await lt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${y}件取得`}),{count:y}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function ai(){return(await N("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:h(t,["id"],""),receivedAt:h(t,["received_at"],""),senderPhone:h(t,["sender_phone"],""),senderName:h(t,["sender_name"],""),imageUrl:h(t,["image_url"],""),ocrStatus:h(t,["ocr_status"],"pending")||"pending",ocrText:h(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:h(t,["linked_invoice_id"],"")}))}async function si(e,t){const s=e.config.api_key;if(!s)return{text:"",error:"Cloud Vision API key 未設定"};try{const n=`https://vision.googleapis.com/v1/images:annotate?key=${s}`,i=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return i.ok?{text:(await i.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${i.status}`}}catch(n){return{text:"",error:n instanceof Error?n.message:String(n)}}}async function ni(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Pt={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Ct={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function oi(){return(await N("user_profiles",{order:"display_name.asc"})).map(t=>({id:h(t,["id"],""),email:h(t,["email"],""),displayName:h(t,["display_name"],""),staffCode:h(t,["staff_code"],""),department:h(t,["department"],"all")||"all",role:h(t,["role"],"staff")||"staff",defaultMailSenderId:h(t,["default_mail_sender_id"],""),phone:h(t,["phone"],""),avatarUrl:h(t,["avatar_url"],""),isActive:te(t,["is_active"],!0),lastSignInAt:h(t,["last_sign_in_at"],""),createdAt:h(t,["created_at"],"")}))}async function ii(e){if(!e)return null;const t=await N("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const s=t[0];return{id:h(s,["id"],""),email:h(s,["email"],""),displayName:h(s,["display_name"],""),staffCode:h(s,["staff_code"],""),department:h(s,["department"],"all")||"all",role:h(s,["role"],"staff")||"staff",defaultMailSenderId:h(s,["default_mail_sender_id"],""),phone:h(s,["phone"],""),avatarUrl:h(s,["avatar_url"],""),isActive:te(s,["is_active"],!0),lastSignInAt:h(s,["last_sign_in_at"],"")}}async function ri(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function li(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ci(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>B);return{supabaseInsert:s}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function di(e=100){return(await N("audit_logs",{order:"created_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),action:h(s,["action"],""),entityType:h(s,["entity_type"],""),entityId:h(s,["entity_id"],""),userEmail:h(s,["user_email"],""),changes:s.changes??{},createdAt:h(s,["created_at"],"")}))}const At={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function tn(){return(await N("slack_notifications",{order:"event_type.asc"})).map(t=>({id:h(t,["id"],""),eventType:h(t,["event_type"],"new_order"),enabled:te(t,["enabled"],!0),channel:h(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:h(t,["last_triggered_at"],"")}))}async function ui(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function pi(e=50){return(await N("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),eventType:h(s,["event_type"],""),channel:h(s,["channel"],""),message:h(s,["message"],""),status:h(s,["status"],"sent"),error:h(s,["error"],""),sentAt:h(s,["sent_at"],"")}))}async function mi(e,t,s){const i=(await en()).find(y=>y.provider==="slack");if(!i||!i.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const r=i.config.webhook_url;if(!r)return{ok:!1,error:"Webhook URL未設定"};const p=(await tn()).find(y=>y.eventType===e&&y.enabled);if(!p)return{ok:!1,error:"通知ルールが無効"};const u=s??p.channel??i.config.default_channel??"#general";try{const y=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${At[e]} ${t}`,channel:u})}),f=y.ok,{supabaseInsert:v}=await E(async()=>{const{supabaseInsert:b}=await Promise.resolve().then(()=>B);return{supabaseInsert:b}},void 0);return await v("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:u,message:t,status:f?"sent":"failed",error:f?null:`HTTP ${y.status}`}),f?{ok:!0}:{ok:!1,error:`HTTP ${y.status}`}}catch(y){return{ok:!1,error:y instanceof Error?y.message:String(y)}}}const It={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Aa={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function yi(){return(await N("prospects",{order:"updated_at.desc"})).map(t=>({id:h(t,["id"],""),companyName:h(t,["company_name"],""),contactName:h(t,["contact_name"],""),email:h(t,["email"],""),phone:h(t,["phone"],""),address:h(t,["address"],""),website:h(t,["website"],""),businessType:h(t,["business_type"],""),stage:h(t,["stage"],"cold"),source:h(t,["source"],""),expectedAmount:Y(t.expected_amount),probability:Y(t.probability),assignedStaffCode:h(t,["assigned_staff_code"],""),nextActionDate:h(t,["next_action_date"],""),nextAction:h(t,["next_action"],""),note:h(t,["note"],""),lastContactAt:h(t,["last_contact_at"],""),wonAt:h(t,["won_at"],""),lostAt:h(t,["lost_at"],""),lostReason:h(t,["lost_reason"],""),convertedCustomerCode:h(t,["converted_customer_code"],""),createdAt:h(t,["created_at"],"")}))}async function an(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function hi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function fi(e){return(await N("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(s=>({id:h(s,["id"],""),prospectId:h(s,["prospect_id"],""),activityType:h(s,["activity_type"],"call"),title:h(s,["title"],""),description:h(s,["description"],""),activityDate:h(s,["activity_date"],""),result:h(s,["result"],""),staffCode:h(s,["staff_code"],"")}))}async function vi(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const sn=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function gi(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function bi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function $i(){return(await ee("v_customer_map")).filter(t=>t.lat&&t.lng).map(t=>({customerCode:h(t,["customer_code"],""),name:h(t,["name"],""),phone:h(t,["phone"],""),areaCode:h(t,["area_code"],""),businessType:h(t,["business_type"],""),businessTypeName:h(t,["business_type_name"],""),address1:h(t,["address1"],""),lat:Number(t.lat),lng:Number(t.lng),isAtRisk:te(t,["is_at_risk"],!1),isDormant:te(t,["is_dormant"],!1),amount12m:P(t,["amount_12m"],0),daysSinceOrder:t.days_since_order!=null?Number(t.days_since_order):null}))}const Tt=[{value:"price",label:"価格が高い"},{value:"competitor",label:"競合に切り替え"},{value:"closed",label:"廃業・閉店"},{value:"contact",label:"担当者交代"},{value:"seasonal",label:"季節要因"},{value:"pause",label:"一時的な休止"},{value:"complaint",label:"クレーム・不満"},{value:"unreachable",label:"連絡が取れない"},{value:"other",label:"その他"}];async function _i(){return(await ee("customer_churn_notes")).map(t=>({customerCode:h(t,["customer_code"],""),reason:h(t,["reason"],""),memo:h(t,["memo"],""),actionedAt:t.actioned_at?String(t.actioned_at):null,updatedAt:h(t,["updated_at"],"")}))}async function wi(e){const{supabaseUpsert:t}=await E(async()=>{const{supabaseUpsert:s}=await Promise.resolve().then(()=>B);return{supabaseUpsert:s}},void 0);await t("customer_churn_notes",{customer_code:e.customerCode,reason:e.reason,memo:e.memo,actioned_at:e.actionedAt||null,updated_at:new Date().toISOString()},"customer_code")}async function xi(){return(await N("delivery_locations",{order:"name.asc"})).map(t=>({id:h(t,["id"],""),customerCode:h(t,["customer_code"],""),name:h(t,["name"],""),postalCode:h(t,["postal_code"],""),address:h(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:h(t,["contact_name"],""),phone:h(t,["phone"],""),deliveryNote:h(t,["delivery_note"],""),isActive:te(t,["is_active"],!0)}))}async function Si(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function ki(e=50){return(await N("call_logs",{order:"started_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),callDirection:h(s,["call_direction"],"inbound"),fromNumber:h(s,["from_number"],""),toNumber:h(s,["to_number"],""),matchedCustomerCode:h(s,["matched_customer_code"],""),matchedProspectId:h(s,["matched_prospect_id"],""),durationSeconds:Y(s.duration_seconds),callStatus:h(s,["call_status"],"answered"),recordingUrl:h(s,["recording_url"],""),transcript:h(s,["transcript"],""),ivryCallId:h(s,["ivry_call_id"],""),startedAt:h(s,["started_at"],""),endedAt:h(s,["ended_at"],""),notes:h(s,["notes"],"")}))}async function nn(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function Pi(e){const t=e.config.api_key,s=e.config.team_id;if(!t||!s)return{count:0,error:"IVRy API key または team_id 未設定"};try{const n=`https://api.ivry.jp/v1/teams/${s}/calls?limit=100`,i=await fetch(n,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const c=(await i.json()).calls??[];let p=0;for(const u of c)await nn({id:`ivry_${u.id}`,callDirection:String(u.direction??"inbound"),fromNumber:String(u.from??""),toNumber:String(u.to??""),durationSeconds:Number(u.duration??0),callStatus:String(u.status??"answered"),recordingUrl:String(u.recording_url??""),startedAt:String(u.started_at??""),endedAt:String(u.ended_at??""),ivryCallId:String(u.id??"")}),p++;return await lt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得`}),{count:p}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function Ci(e,t){const s=e.config.api_key,n=e.config.team_id;if(!s||!n)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let i=0;for(const r of t){if(!r.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${n}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({name:r.name,phone_number:r.phone,external_id:r.customerCode??"",note:r.note??""})})).ok&&i++}return{synced:i}}catch(i){return{synced:0,error:i instanceof Error?i.message:String(i)}}}async function Ai(){return(await N("lead_lists",{order:"created_at.desc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),query:h(t,["query"],""),area:h(t,["area"],""),businessType:h(t,["business_type"],""),totalCount:Y(t.total_count),source:h(t,["source"],"manual"),createdAt:h(t,["created_at"],"")}))}async function Ei(e){return(await N("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(s=>({id:h(s,["id"],""),listId:h(s,["list_id"],""),companyName:h(s,["company_name"],""),address:h(s,["address"],""),phone:h(s,["phone"],""),website:h(s,["website"],""),email:h(s,["email"],""),businessType:h(s,["business_type"],""),rating:s.rating?Number(s.rating):void 0,reviewCount:Y(s.review_count),lat:s.lat?Number(s.lat):void 0,lng:s.lng?Number(s.lng):void 0,placeId:h(s,["place_id"],""),status:h(s,["status"],"new"),convertedProspectId:h(s,["converted_prospect_id"],""),note:h(s,["note"],"")}))}async function Li(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function on(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function Di(e,t,s){const n=e.config.api_key;if(!n)return{results:[],error:"Google Maps API key 未設定"};const i=`${t} ${s}`.trim(),r=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(i)}&language=ja&key=${n}`;try{const c=await fetch(r);if(!c.ok)return{results:[],error:`HTTP ${c.status}`};const p=await c.json();return p.status!=="OK"&&p.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${p.status}`}:{results:p.results.map(y=>{const f=y.geometry?.location;return{id:`place_${y.place_id}`,listId:"",companyName:String(y.name??""),address:String(y.formatted_address??""),rating:y.rating?Number(y.rating):void 0,reviewCount:y.user_ratings_total?Number(y.user_ratings_total):void 0,lat:f?.lat,lng:f?.lng,placeId:String(y.place_id??""),status:"new"}})}}catch(c){return{results:[],error:c instanceof Error?c.message:String(c)}}}async function qi(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},s=await an(t);return s&&await on({...e,status:"imported",convertedProspectId:t.id}),s}async function Ii(){return(await N("workflow_orders",{order:"order_date.desc"})).map(t=>({id:h(t,["id"],""),orderNo:h(t,["order_no"],""),customerName:h(t,["customer_name"],""),customerCode:h(t,["customer_code"],""),orderDate:h(t,["order_date"],""),deliveryDate:h(t,["delivery_date"],""),stage:h(t,["stage"],"new"),totalAmount:Y(t.total_amount),itemCount:Y(t.item_count),priority:h(t,["priority"],"normal"),staffName:h(t,["staff_name"],""),notes:h(t,["notes"],"")}))}async function Ti(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function Ni(){return(await N("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),email:h(t,["email"],""),phone:h(t,["phone"],""),visitDate:h(t,["visit_date"],""),partySize:Y(t.party_size)||1,language:h(t,["language"],"ja"),purpose:h(t,["purpose"],""),message:h(t,["message"],""),status:h(t,["status"],"new"),repliedAt:h(t,["replied_at"],""),confirmedTime:h(t,["confirmed_time"],""),createdAt:h(t,["created_at"],new Date().toISOString())}))}async function Mi(e){const{supabaseInsert:t}=await E(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>B);return{supabaseInsert:n}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const Oi=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function rn(){return(await Promise.all(Oi.map(async t=>{const[s,n]=await Promise.all([ha(t.table),N(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:s,lastSyncAt:n[0]?._synced_at??null}}))).sort((t,s)=>s.rowCount-t.rowCount)}async function xt(e,t,s=100){const n=(t-1)*s,[i,r]=await Promise.all([N(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(s),offset:String(n)}),ha(e)]);return{records:i,total:r}}async function ea(e){const t=await N("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const s=t[0].memo;if(typeof s=="string"&&s)try{const n=JSON.parse(s);return String(n.price_group??"")}catch{return""}return""}async function ln(e,t){if(e){const n=await N("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(n.length>0&&n[0].special_price)return Y(n[0].special_price)}const s=await N("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return s.length>0&&s[0].default_sale_price?Y(s[0].default_sale_price):0}const Ri=[{code:"SAK001",name:"純米大吟醸　金井"},{code:"SAK002",name:"純米吟醸　金井"},{code:"SAK003",name:"本醸造　金井"},{code:"SAK004",name:"純米酒　金井"}],ji=[1.6,.7,1.3,1.2,.9,.7,.6,.7,.9,1,1.1,1.5],Fi={SAK001:80,SAK002:150,SAK003:220,SAK004:180};function zi(){const e=new Date,t=[];for(let u=11;u>=0;u--){const y=new Date(e.getFullYear(),e.getMonth()-u,1);t.push(`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`)}const s=Ri,n={},i={};for(const u of s){n[u.code]={};for(const y of t){const f=parseInt(y.split("-")[1])-1,v=Fi[u.code]??100,b=Math.round(v*ji[f]*(.85+Math.random()*.3));n[u.code][y]=b,i[y]=(i[y]??0)+b}}const r={},c={},p={};for(const u of s){const y=t.map(b=>n[u.code][b]??0),f=y.reduce((b,x)=>b+x,0)/y.length,v=y.reduce((b,x)=>b+(x-f)**2,0)/y.length;r[u.code]=y.reduce((b,x)=>b+x,0),c[u.code]=f,p[u.code]=Math.sqrt(v)}return{months:t,products:s,matrix:n,totals:i,productTotals:r,productAvg:c,productStdDev:p}}async function Bi(e=36){const t=(()=>{const b=new Date;return b.setMonth(b.getMonth()-e),`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}`})(),s=await ee("product_monthly_sales",{select:"year_month,product_code,product_name,quantity",year_month:`gte.${t}`,order:"year_month.asc"});if(s.length===0)return zi();const n=new Set,i=new Map,r={},c={};for(const b of s){const x=h(b,["year_month"],""),k=h(b,["product_code"],""),o=h(b,["product_name"],k),l=P(b,["quantity"],0);!x||!k||(n.add(x),i.set(k,o),r[k]||(r[k]={}),r[k][x]=l,c[x]=(c[x]??0)+l)}const p=[...n].sort(),u=[...i.entries()].map(([b,x])=>({code:b,name:x})),y={},f={},v={};for(const b of u){const x=p.map(l=>r[b.code]?.[l]??0),k=x.reduce((l,d)=>l+d,0)/(x.length||1),o=x.reduce((l,d)=>l+(d-k)**2,0)/(x.length||1);y[b.code]=x.reduce((l,d)=>l+d,0),f[b.code]=k,v[b.code]=Math.sqrt(o)}return{months:p,products:u,matrix:r,totals:c,productTotals:y,productAvg:f,productStdDev:v}}async function Vi(){return(await N("product_safety_stock_params",{order:"product_code.asc"})).map(t=>({productCode:h(t,["product_code"],""),productName:h(t,["product_name"],""),unit:h(t,["unit"],"本"),avgMonthlyDemand:P(t,["avg_monthly_demand"],0),demandStdDev:P(t,["demand_std_dev"],0),leadTimeDays:P(t,["lead_time_days"],30),serviceLevel:P(t,["service_level"],.95),safetyStockQty:P(t,["safety_stock_qty"],0),reorderPoint:P(t,["reorder_point"],0),memo:h(t,["memo"],""),productionType:h(t,["production_type"],"monthly")}))}async function Ji(e){return(await N("production_plan",{year_month:`eq.${e}`,order:"product_code.asc"})).map(s=>({id:h(s,["id"],""),yearMonth:h(s,["year_month"],e),productCode:h(s,["product_code"],""),productName:h(s,["product_name"],""),demandForecast:P(s,["demand_forecast"],0),safetyStockTarget:P(s,["safety_stock_target"],0),openingStock:P(s,["opening_stock"],0),requiredProduction:P(s,["required_production"],0),plannedQty:P(s,["planned_qty"],0),actualQty:P(s,["actual_qty"],0),status:h(s,["status"],"draft"),productionType:h(s,["production_type"],"monthly"),notes:h(s,["notes"],"")}))}async function Yi(e){const{SUPABASE_URL:t,SUPABASE_ANON_KEY:s}=await E(async()=>{const{SUPABASE_URL:n,SUPABASE_ANON_KEY:i}=await Promise.resolve().then(()=>B);return{SUPABASE_URL:n,SUPABASE_ANON_KEY:i}},void 0);if(!s||e.length===0)return!1;try{const n=e.map(c=>({product_code:c.productCode,product_name:c.productName,unit:c.unit,avg_monthly_demand:c.avgMonthlyDemand,demand_std_dev:c.demandStdDev,lead_time_days:c.leadTimeDays,service_level:c.serviceLevel,safety_stock_qty:c.safetyStockQty,reorder_point:c.reorderPoint,production_type:c.productionType,memo:c.memo,last_calc_at:new Date().toISOString(),updated_at:new Date().toISOString()})),i=new URL("/rest/v1/product_safety_stock_params",t),r=await fetch(i.toString(),{method:"POST",headers:{apikey:s,Authorization:`Bearer ${s}`,"Content-Type":"application/json",Prefer:"return=minimal,resolution=merge-duplicates"},body:JSON.stringify(n)});if(!r.ok){const c=await r.text();return console.error("saveSafetyStockParamsBulk failed:",r.status,c),!1}return!0}catch(n){return console.error("saveSafetyStockParamsBulk error:",n),!1}}async function Ui(e){const{supabaseUpsert:t}=await E(async()=>{const{supabaseUpsert:n}=await Promise.resolve().then(()=>B);return{supabaseUpsert:n}},void 0);return await t("production_plan",{...e.id?{id:e.id}:{},year_month:e.yearMonth,product_code:e.productCode,product_name:e.productName,demand_forecast:e.demandForecast,safety_stock_target:e.safetyStockTarget,opening_stock:e.openingStock,required_production:e.requiredProduction,planned_qty:e.plannedQty,actual_qty:e.actualQty,status:e.status,production_type:e.productionType,notes:e.notes,updated_at:new Date().toISOString()})!==null}function Qi(e){if(!e)return"不明";const t=e.replace(/^.+?[都道府県]/,""),s=t.match(/^(.+?郡.+?[町村]|.+?[市区町村])/);return s?s[1]:t.substring(0,6)}async function Hi(e){const[t,s]=e.split("-").map(Number),n=`${e}-01`,i=new Date(t,s,0).getDate(),r=`${e}-${String(i).padStart(2,"0")}`,c=await ee("sales_document_headers",{select:"sales_date,customer_name,legacy_customer_code,total_amount",and:`(sales_date.gte.${n},sales_date.lte.${r})`,order:"sales_date.asc"}),p=await ee("customers",{select:"id,address1",address1:"not.is.null"}),u={};for(const f of p)f.address1&&(u[f.id]=Qi(f.address1));const y={};for(const f of c){const v=f.sales_date;if(!v)continue;const b=u[f.legacy_customer_code]||"住所未登録",x=Number(f.total_amount)||0;y[v]||(y[v]={date:v,entries:[],cityGroups:[],totalAmount:0,count:0}),y[v].entries.push({customerCode:f.legacy_customer_code||"",customerName:f.customer_name||"",city:b,amount:x}),y[v].totalAmount+=x,y[v].count++}for(const f of Object.values(y)){const v={};for(const b of f.entries)v[b.city]=(v[b.city]||0)+1;f.cityGroups=Object.entries(v).sort((b,x)=>x[1]-b[1]).map(([b,x])=>({city:b,count:x}))}return y}async function Ea(){return N("quotes",{select:"id,quote_no,quote_date,valid_until,customer_name,subject,total_amount,template_type,status,created_at",order:"quote_date.desc,created_at.desc",limit:"200"})}async function cn(e){const t=await N("quotes",{select:"*",id:`eq.${e}`});if(!t[0])return null;const s=await N("quote_lines",{select:"*",quote_id:`eq.${e}`,order:"line_no.asc"});return{...t[0],lines:s}}async function Gi(){const e=new Date().toISOString().slice(0,7)+"-01";return ee("sales_document_headers",{select:"legacy_document_no,sales_date,customer_name,legacy_customer_code,total_amount",sales_date:`gte.${e}`,order:"sales_date.asc"})}const I=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:Ca,CALENDAR_CATEGORY_LABELS:Pa,CHURN_REASONS:Tt,DEPT_LABELS:Ct,INVOICE_TYPE_LABELS:Xt,JIKOMI_STATUS_LABELS:Bs,MATERIAL_CATEGORIES:sn,PROSPECT_STAGE_COLORS:Aa,PROSPECT_STAGE_LABELS:It,ROLE_LABELS:Pt,SEASONAL_TEMPLATES:va,SLACK_EVENT_LABELS:At,TAX_DEDUCTION_LABELS:Zt,TAX_RATE_CATEGORIES:Xs,addBrewingCustomCategory:xo,convertLeadToProspect:qi,deleteBrewingCustomCategory:So,deleteCalendarEvent:Ko,deleteMailSender:Ho,deleteMaterial:bi,deletePrintLayout:Yo,deleteProspect:hi,deleteUserProfile:li,fetchAnalyticsByPeriod:oo,fetchAnnouncements:Ns,fetchAuditLogs:di,fetchAvailablePeriods:io,fetchBillList:Hs,fetchBillingSummary:wa,fetchBrewingCategoryOverrides:Po,fetchBrewingCustomCategories:wo,fetchBrewingMonthlyTrend:vo,fetchBrewingPlanSummary:fo,fetchBrewingProductDetail:go,fetchBrewingSchedule:bo,fetchCalendarEvents:Go,fetchCallLogs:ki,fetchChurnAlerts:qo,fetchChurnNotes:_i,fetchCustomerAnalysis:zs,fetchCustomerEfficiency:Fs,fetchCustomerLedger:ba,fetchCustomerPriceGroup:ea,fetchCustomerPricing:Kt,fetchCustomerProductBreakdown:mo,fetchDeliveryLocations:xi,fetchDeliveryNote:_a,fetchDeliverySchedule:Do,fetchDemandAnalysis:Bi,fetchDemandForecasts:Lo,fetchEntityMonthlySales:ho,fetchFaxInbox:ai,fetchIntegrationSettings:en,fetchInvoices:ot,fetchJikomiList:Vs,fetchKenteiList:Ys,fetchLeadItems:Ei,fetchLeadLists:Ai,fetchMailSenders:Uo,fetchMapCustomers:$i,fetchMasterStats:ga,fetchMaterialList:Wt,fetchMyProfile:ii,fetchOrderHeaders:Gi,fetchPayableList:Qs,fetchPaymentStatus:Es,fetchPeriodChartData:uo,fetchPipelineMeta:Ls,fetchPrintLayouts:Vo,fetchProductABC:Oo,fetchProductCustomerBreakdown:yo,fetchProductDaily:Mo,fetchProductMonthlyShipments:Eo,fetchProductPower:js,fetchProductPrice:ln,fetchProductShipmentsFromTable:No,fetchProductionPlan:Ji,fetchProspectActivities:fi,fetchProspects:yi,fetchPurchaseList:Us,fetchQuoteList:Ea,fetchQuoteWithLines:cn,fetchRawMaterialStock:Gs,fetchRawRecords:xt,fetchRawTableList:rn,fetchSafetyStockParams:Vi,fetchSalesAnalytics:$a,fetchSalesReport:qt,fetchSalesSummary:As,fetchSeasonalProfiles:To,fetchShipmentCalendar:Hi,fetchShopifyOrders:Zo,fetchSlackLogs:pi,fetchSlackRules:tn,fetchStaffCustomerBreakdown:lo,fetchStaffProductBreakdown:co,fetchStaffTotalsByPeriod:ro,fetchStoreOrders:Ws,fetchStoreSales:ka,fetchSyncDashboard:Ds,fetchSystemSetting:Cs,fetchTankList:Js,fetchTaxDeclaration:Sa,fetchTourInquiriesFromDb:Ni,fetchUserProfiles:oi,fetchVisitPriorities:Io,fetchWorkflowOrdersFromDb:Ii,generateTaxCSV:Fo,generateTaxXML:Ks,ocrFaxImage:si,periodToDateRange:qs,prevYearFilter:po,recalculateTaxDeclaration:zo,recordAudit:ci,resolveProductPrice:xa,saveBrewingSchedule:$o,saveCalendarEvent:Xo,saveCallLog:nn,saveChurnNote:wi,saveDeliveryLocation:Si,saveEmailCampaign:wt,saveFaxRecord:ni,saveIntegrationSetting:lt,saveInvoice:Ts,saveLeadItem:on,saveLeadList:Li,saveMailSender:Qo,saveMaterial:gi,savePrintLayout:Jo,saveProductionPlan:Ui,saveProspect:an,saveProspectActivity:vi,saveSafetyStockParamsBulk:Yi,saveSlackRule:ui,saveTaxDeclaration:Bo,saveTourInquiry:Mi,saveUserProfile:ri,saveWorkflowOrder:Ti,searchPlaces:Di,sendEmailCampaign:Zs,sendSlackNotification:mi,setBrewingCategoryOverride:ko,submitFeatureRequest:Ms,syncGoogleCalendar:ti,syncIvryCallLogs:Pi,syncPhoneBookToIvry:Ci,syncShopifyOrders:Wo,updateCustomer:Os,updateProduct:Rs,upsertBrewingStock:_o,upsertSystemSetting:Fe},Symbol.toStringTag,{value:"Module"}));function Ne(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Xi={open:"未締め",closed:"締め済"};function Ki(e,t){const s=e.customers.map(n=>`
      <tr>
        ...
        <td class="numeric">${Ne(n.salesAmount)}</td>
        <td class="numeric">${Ne(n.taxAmount)}</td>
        <td class="numeric">${Ne(n.prevBalance)}</td>
        <td class="numeric">${Ne(n.paymentAmount)}</td>
        <td class="numeric"><strong>${Ne(n.billingAmount)}</strong></td>
        <td>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${Ne(e.totalBilling)}</p>
  ...
  `}function lr(e,t){const s=t==="all"?e:e.filter(p=>p.segment===t),n={all:e.length};e.forEach(p=>{n[p.segment]=(n[p.segment]??0)+1});const r=["all",...[...new Set(e.map(p=>p.segment))]].map(p=>`
    ...
    `).join(""),c=s.map(p=>`
      <tr>
        ...
        <td>${p.name}</td>
        <td><span class="segment-badge" style="background:${Ge[p.segment]??"#718096"};">${Ja[p.segment]??p.segment}</span></td>
  ...
  `}function pr(e,t,s,n,i="month",r,c=[]){const p={success:"正常",warning:"注意",error:"異常",running:"実行中"},u=Ot(e.allDailySales,i,r),y=u.reduce((O,K)=>O+K.amount,0),f=u.reduce((O,K)=>O+K.bottles,0),v=u.reduce((O,K)=>O+K.volumeMl,0),b=u.length,x=f>0?Math.round(y/f):0,k=v>0?Math.round(y/(v/1e3)):0,o=new Date,l=o.toISOString().slice(0,10),d=l.slice(0,7),m=Ot(e.allDailySales,"month").filter(O=>O.date.slice(0,10)<=l),g=m.reduce((O,K)=>O+K.amount,0);m.reduce((O,K)=>O+K.bottles,0);const $=o.getDate();new Date(o.getFullYear(),o.getMonth()+1,0).getDate();const C=(n?.orderHeaders??[]).filter(O=>O.sales_date.slice(0,7)===d),S=C.reduce((O,K)=>O+Number(K.total_amount),0),A=C.length,q=Ot(e.allDailySales,"month"),L=q.reduce((O,K)=>O+K.bottles,0),T=S>0?S:q.reduce((O,K)=>O+K.amount,0),M=S>0?"orders":"extrapolation",z=(u.length>0?e.allDailySales.filter(O=>{const K=u[0]?.date??"",Qe=u[u.length-1]?.date??"",qe=Ya(K,-1),Ie=Ya(Qe,-1);return O.date>=qe&&O.date<=Ie}):[]).reduce((O,K)=>O+K.amount,0),W=z>0?(y-z)/z*100:0,ne=W>0?"+":"",pe=e.salesRecords.slice(0,10).map(O=>`
            <tr>
              <td class="mono">${O.documentNo}</td>
              <td>${Rt(O.date)}</td>
              <td>${O.customerName}</td>
              <td class="numeric">${de(O.amount)}</td>
            </tr>
          `).join(""),oe=["today","month","future","90days","year","all"].map(O=>`<button class="button ${O===i?"primary":"secondary"} small" type="button" data-period="${O}">${pt[O]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${de(g)}</p>
        <p class="kpi-sub">${$}日経過 / ${m.length}営業日 / 日平均 ${m.length>0?de(Math.round(g/m.length)):"―"}</p>
      </article>
      <article class="panel kpi-card" style="border-left:3px solid #0968e5;">
        <p class="panel-title">月末受注見込</p>
        <p class="kpi-value">${de(T)}</p>
        <p class="kpi-sub">${M==="orders"?`受注確定 ${A}件`:`出荷見込 ${L.toLocaleString("ja-JP")}本（日割り外挿）`}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">昨対比</p>
        <p class="kpi-value" style="color:${W>=0?"#2f855a":"#c53d3d"}">${z>0?`${ne}${W.toFixed(1)}%`:"―"}</p>
        <p class="kpi-sub">前年同期 ${z>0?de(z):"データなし"}</p>
      </article>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        <p class="panel-title">${pt[i]}売上</p>
        <p class="kpi-value">${de(y)}</p>
        <p class="kpi-sub">${b}日間${b>0?` / 日平均 ${de(Math.round(y/b))}`:""}</p>
      </article>
    </section>
    `:""}
    ...
    <section class="content-grid">
      <article class="panel">
        <div class="panel-header">
          <div>
            <h2>日次売上</h2>
            <p class="panel-caption">${pt[i]} (${u.length}日分)</p>
          </div>
        </div>
    ...
    <details class="panel collapsible-panel">
      <summary class="panel-header clickable">
        <div>
          <h2>日次推移</h2>
          <p class="panel-caption">${pt[i]} — 売上・本数・液体量・単価（${u.length}日分）</p>
        </div>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>${Je(c.length>0?u:u.slice().reverse(),c,{date:"date",amount:"amount",bottles:"bottles",volumeMl:"volumeMl",pricePerBottle:"pricePerBottle",pricePerLiter:"pricePerLiter"}).slice(0,31).map(O=>`
            <tr>
              ...
              <td class="numeric">${de(O.pricePerBottle)}</td>
              <td class="numeric">${de(O.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
  ...
  `}function hr(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function Me(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function fr(e,t){const s=e.lines.length?e.lines.map((i,r)=>`
          <tr>
            ...
            <td>${i.unit}</td>
            <td class="numeric">${Me(i.unitPrice)}</td>
            <td class="numeric">${Me(i.amount)}</td>
          </tr>
    ...
    <article class="panel delivery-note-body" id="delivery-print-area">
      ...
      <div class="delivery-footer">
        <div class="delivery-totals">
          <div class="total-stack"><span class="total-label">小計</span><span class="total-value">${Me(n)}</span></div>
  ...
  `}function ve(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function vr(e){return ve(e).replaceAll(`
`,"<br />")}function gr(e){const s=[...Object.values(va),{id:"custom",season:"カスタム",subject:"",body:""}].map(i=>`
        ...
        >
          ...
          <strong>${ve(i.subject||"空テンプレート")}</strong>
        </button>
      `).join(""),n=e.previewRecipients.length?e.previewRecipients.map(i=>`
            <li>
              <span>${ve(i.name)}</span>
              <span class="table-sub">${ve(i.email)} / ${ve(i.area)}</span>
            </li>
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="field">
          <span>件名</span>
          <input id="email-subject" type="text" value="${ve(e.subject)}" />
        </div>
        <div class="field">
          <span>本文</span>
          <textarea id="email-body" rows="12">${ve(e.body)}</textarea>
        </div>
      ...
      <article class="panel">
        ...
        <label class="field" style="margin-bottom:12px;">
          ...
          <select id="email-sender">
            ${e.senders.map(i=>`<option value="${i.id}" ${i.id===e.senderId?"selected":""}>${ve(i.name)} &lt;${ve(i.email)}&gt;${i.isVerified?"":" ⚠️未認証"}</option>`).join("")}
        ...
        <div class="email-preview">
          <p class="panel-title">${ve(e.subject||"件名未入力")}</p>
          <div class="preview-box">${e.body?vr(e.body):"本文未入力"}</div>
        </div>
        ${e.saveMessage?`<p class="meta-note">${ve(e.saveMessage)}</p>`:""}
        <div class="action-bar">
  ...
  `}function fe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function mt(e,t){return t.length===0?"":`
  ...
  `}function br(e,t){const s=[mt("得意先",t.customers.map(i=>`
          <button
            ...
            data-path="/master"
          >
            <strong>${fe(i.name)}</strong>
            <span class="table-sub mono">${fe(i.code)}</span>
          </button>
        `)),mt("商品",t.products.map(i=>`
          <button
            class="search-result-item"
            type="button"
            data-action="global-nav"
        ...
        `)),mt("伝票",t.documents.map(i=>`
          <button
            ...
            data-path="/invoice"
          >
            <strong>${fe(i.documentNo)}</strong>
            <span class="table-sub">${fe(i.customerName)} / ${fe(i.date)}</span>
          </button>
        `)),mt("ページ",t.pages.map(i=>`
          <button
            class="search-result-item"
            type="button"
            data-action="global-nav"
            data-path="${fe(i.path)}"
          >
            <strong>${fe(i.title)}</strong>
            <span class="table-sub mono">${fe(i.path)}</span>
          </button>
  ...
  `}function Xe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function pn(e){const t=e.resultsHtml.trim()?e.resultsHtml:`<p class="empty-note">${Xe(e.emptyMessage??"該当データがありません。")}</p>`;return`
  ...
  `}function yt(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ua(e){return e.trim().toLowerCase()}function $r(e,t){const s=Ua(t),n=e.filter(r=>s?[r.code,r.name,r.name].map(Ua).some(c=>c.includes(s)):!0).slice(0,50),i=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return pn({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:i,emptyMessage:"該当する得意先が見つかりません。"})}function _r(e){return e.toISOString().slice(0,10)}function Le(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ke(e,t){return e[t]?`<div class="field-error">${Le(e[t])}</div>`:""}function Oe(e,t,s=""){return[s,e[t]?"has-error":""].filter(Boolean).join(" ")}function wr(e,t,s,n){const i=Object.keys(Xt).map(u=>`<option value="${u}" ${e.invoiceType===u?"selected":""}>${Xt[u]}</option>`).join(""),r=e.lines.map((u,y)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${Oe(n,`lines.${y}.productCode`,"input-cell")}" type="text" data-line="${y}" data-field="productCode" value="${Le(u.productCode)}" placeholder="P00001" />
        ...
        <td>
          <input class="${Oe(n,`lines.${y}.productName`,"input-cell")}" type="text" data-line="${y}" data-field="productName" value="${Le(u.productName)}" placeholder="商品名" />
          ${ke(n,`lines.${y}.productName`)}
        </td>
        <td>
          <input class="${Oe(n,`lines.${y}.quantity`,"input-cell numeric")}" type="number" data-line="${y}" data-field="quantity" value="${u.quantity}" min="0" />
          ${ke(n,`lines.${y}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${y}" data-field="unit" value="${u.unit}" placeholder="本" /></td>
        <td>
          <input class="${Oe(n,`lines.${y}.unitPrice`,"input-cell numeric")}" type="number" data-line="${y}" data-field="unitPrice" value="${u.unitPrice}" min="0" />
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${Oe(n,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||_r(new Date)}" />
          ${ke(n,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
  ...
  `}const mn="kanei-quote-settings",yn=[{label:"青（標準）",value:"#0968e5"},{label:"紺",value:"#1e3a8a"},{label:"藍",value:"#1d4ed8"},{label:"緑",value:"#15803d"},{label:"金",value:"#b45309"},{label:"朱",value:"#c2410c"},{label:"ワイン",value:"#881337"},{label:"墨",value:"#1f2937"}],St={companyName:"金井酒造店",companyPostal:"257-0014",companyAddress1:"神奈川県秦野市堀山下182",companyAddress2:"",companyTel:"0463-88-1511",companyFax:"0463-88-5885",companyEmail:"info@kaneishuzo.co.jp",companyRegistrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"",bankAccountHolder:"カ）カナイシュゾウテン",defaultPaymentTerms:"月末締め翌月末払い",defaultHeaderNote:"下記のとおりお見積り申し上げます。",defaultFooterNote:"",sealImageDataUrl:"",sealSize:72,accentColor:"#0968e5"};function ta(){try{const e=localStorage.getItem(mn);if(e)return{...St,...JSON.parse(e)}}catch{}try{const e=localStorage.getItem("quote-seal");if(e){const t=JSON.parse(e);return{...St,sealImageDataUrl:t.imageDataUrl??"",sealSize:t.size??72}}}catch{}return{...St}}function De(e){localStorage.setItem(mn,JSON.stringify(e))}function $e(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function re(e,t,s,n="text",i=""){return`<div class="form-row"><label>${t}</label><input type="${n}" id="${e}" value="${$e(s)}" placeholder="${$e(i)}" /></div>`}function Er(e,t,s,n){const i=n.map(r=>`<option value="${$e(r)}" ${s===r?"selected":""}>${$e(r)}</option>`).join("");return`<div class="form-row"><label>${t}</label><select id="${e}">${i}</select></div>`}function Lr(e){return`
    <section class="page-head">
  ...
  `}function Dr(){const e=new Date;return new Date(e.getFullYear(),e.getMonth()+3,0).toISOString().slice(0,10)}function La(e){return{id:null,quoteNo:"",quoteDate:new Date().toISOString().slice(0,10),validUntil:Dr(),customerCode:"",customerName:"",customerAddress:"",subject:"",lines:[],remarks:"",taxRate:10,deliveryDate:"",paymentTerms:e?.defaultPaymentTerms??"月末締め翌月末払い",deliveryPlace:"",templateType:"sake",previewMode:!1}}La();function R(e){return(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function me(e){return"¥"+e.toLocaleString("ja-JP")}function Qa(e){if(!e)return"";const t=new Date(e);return isNaN(t.getTime())?e:`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function hn(e){const t=e.replace("#","");return[parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16)]}function fn(e,t,s){return"#"+[e,t,s].map(n=>Math.max(0,Math.min(255,Math.round(n))).toString(16).padStart(2,"0")).join("")}function Et(e,t){const[s,n,i]=hn(e);return fn(s+(255-s)*t,n+(255-n)*t,i+(255-i)*t)}function vn(e,t){const[s,n,i]=hn(e);return fn(s*(1-t),n*(1-t),i*(1-t))}function qr(e){const t=vn(e,.15),s=Et(e,.88),n=Et(e,.96);return`
...
`}function Ir(e){const t=vn(e,.15),s=Et(e,.88),n=Et(e,.96);return`
...
`}function gn(e,t){const s=e.lines.reduce((k,o)=>k+o.amount,0),n=Math.round(s*e.taxRate/100),i=s+n,r=e.templateType==="sake",c=r?'<th style="width:90px;">JANコード</th><th style="width:40px;">入数</th><th style="width:70px;">希望小売価格</th>':"",p=r?9:6,u=e.lines.map((k,o)=>{const l=r?`<td style="font-size:9px;">${R(k.janCode)}</td><td style="text-align:center;">${k.caseQty??""}</td><td style="text-align:right;">${k.retailPrice!=null?me(k.retailPrice):""}</td>`:"";return`<tr>
      <td style="text-align:center;">${o+1}</td>
      <td class="mono" style="font-size:9px;">${R(k.productCode)}</td>
      <td>${R(k.productName)}</td>
      ${l}
      <td style="text-align:right;">${k.quantity.toLocaleString()}</td>
      <td style="text-align:center;">${R(k.unit)}</td>
      <td style="text-align:right;">${me(k.unitPrice)}</td>
  ...
  `:"",v=t.sealImageDataUrl?`<img src="${t.sealImageDataUrl}" style="width:${t.sealSize}px;height:${t.sealSize}px;opacity:0.9;flex-shrink:0;" />`:"",b=[];e.validUntil&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">有効期限</div><div class="q-cond-value">${Qa(e.validUntil)}</div></div>`),e.paymentTerms&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">支払条件</div><div class="q-cond-value">${R(e.paymentTerms)}</div></div>`),e.deliveryDate&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">納期</div><div class="q-cond-value">${R(e.deliveryDate)}</div></div>`),e.deliveryPlace&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">納品場所</div><div class="q-cond-value">${R(e.deliveryPlace)}</div></div>`);const x=b.length>0?`<div class="q-cond-grid" style="grid-template-columns:repeat(${Math.min(b.length,4)},1fr);">${b.join("")}</div>`:"";return`
<div class="q-doc">
  <!-- タイトル行: 左=御見積書、右=見積番号・日付（右寄せ） -->
  <div class="q-title-row">
    <h1 class="q-title">御 見 積 書</h1>
    <table class="q-meta-table">
      ${e.quoteNo?`<tr><th>見積番号</th><td>${R(e.quoteNo)}</td></tr>`:""}
  ...
  <div class="q-parties">
    <div class="q-customer">
      <p class="q-customer-name">${R(e.customerName||"（得意先未選択）")} 御中</p>
      ${e.customerAddress?`<p class="q-customer-addr">${R(e.customerAddress)}</p>`:""}
    </div>
    <div class="q-seller-col">
      <!-- 自社情報: 社名の右に印鑑 -->
      <div class="q-seller-name-row">
        <span class="q-seller-name">${R(t.companyName)}</span>
        ${v}
      </div>
      ${t.companyPostal?`<p class="q-seller-sub">〒${R(t.companyPostal)}</p>`:""}
      ${t.companyAddress1?`<p class="q-seller-sub">${R(t.companyAddress1)}${t.companyAddress2?" "+R(t.companyAddress2):""}</p>`:""}
      ${t.companyTel?`<p class="q-seller-sub">TEL: ${R(t.companyTel)}</p>`:""}
      ${t.companyFax?`<p class="q-seller-sub">FAX: ${R(t.companyFax)}</p>`:""}
      ${t.companyRegistrationNo?`<p class="q-seller-sub q-regno">登録番号: ${R(t.companyRegistrationNo)}</p>`:""}
    </div>
  </div>
  ...
  <div class="q-total-banner">
    ...
    <span class="q-total-amount">${me(i)}（税込）</span>
  </div>

  ${e.subject?`<p class="q-subject">件名：${R(e.subject)}</p>`:""}
  ${t.defaultHeaderNote?`<p class="q-note">${R(t.defaultHeaderNote)}</p>`:""}
  ...
  <table class="q-items">
    ...
    <tbody>${u}</tbody>
    <tfoot>
      <tr><td colspan="${p-1}" style="text-align:right;">小計</td><td style="text-align:right;">${me(s)}</td></tr>
      <tr><td colspan="${p-1}" style="text-align:right;">消費税(${e.taxRate}%)</td><td style="text-align:right;">${me(n)}</td></tr>
      <tr class="q-total-row"><td colspan="${p-1}" style="text-align:right;">合計</td><td style="text-align:right;">${me(i)}</td></tr>
    </tfoot>
  </table>
  </div>

  ${e.remarks?`<div class="q-remarks"><p class="q-remarks-label">備考</p><p>${R(e.remarks).replace(/\n/g,"<br/>")}</p></div>`:""}

  ${t.defaultFooterNote?`<p class="q-footer-note">${R(t.defaultFooterNote)}</p>`:""}
  ...
  ${f}
    ...
    `}const x=e.lines.map((k,o)=>{const l=f?`
      <td><input type="text" class="jan-input" data-line-idx="${o}" value="${R(k.janCode)}" style="width:85px;" /></td>
    ...
    `:"";return`<tr>
      <td class="mono" style="font-size:11px;">${R(k.productCode)}</td>
      <td>${R(k.productName)}</td>
      ${l}
      ...
      <td class="numeric">${me(k.amount)}</td>
    ...
    <section class="panel">
      ...
      <div class="form-row" style="margin-bottom:12px;">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:4px;align-items:center;">
          ${yn.map(k=>`
            <button type="button" data-action="set-accent-color" data-color="${R(k.value)}" title="${R(k.label)}"
              style="width:28px;height:28px;border-radius:4px;border:3px solid ${c.accentColor===k.value?"#333":"transparent"};background:${R(k.value)};cursor:pointer;"></button>
          `).join("")}
        </div>
      </div>
      <div class="form-grid-2">
        ...
        <div class="form-row"><label>見積番号</label>
          <input type="text" id="q-no" value="${R(e.quoteNo)}" placeholder="保存時に自動採番" />
        </div>
        ...
        <div class="form-row"><label>件名</label>
          <input type="text" id="q-subject" value="${R(e.subject)}" placeholder="御見積の件" />
        </div>
        <div class="form-row"><label>支払条件</label>
          <input type="text" id="q-payment-terms" value="${R(e.paymentTerms)}" />
        </div>
        <div class="form-row"><label>納期</label>
          <input type="text" id="q-delivery-date" value="${R(e.deliveryDate)}" placeholder="受注後2週間等" />
        </div>
        <div class="form-row"><label>納品場所</label>
          <input type="text" id="q-delivery-place" value="${R(e.deliveryPlace)}" />
        </div>
      </div>
    </section>
    ...
    <section class="panel">
      ...
      <div class="form-row">
        <input type="text" id="q-cust-search" value="${R(n)}" placeholder="得意先名またはコードで検索" />
      </div>
      ${v.length>0?`<div class="search-results">${v.map(k=>`
        <button class="search-item" type="button" data-select-customer="${k.code}" data-cust-name="${R(k.name)}" data-cust-addr="${R(k.address1||"")}">
          <span class="mono">${k.code}</span> ${R(k.name)}
        </button>`).join("")}</div>`:""}
      ${e.customerName?`<div class="selected-item"><span class="mono">${R(e.customerCode)}</span> <strong>${R(e.customerName)}</strong>${e.customerAddress?`<br/><span style="color:var(--text-secondary);font-size:13px;">${R(e.customerAddress)}</span>`:""}</div>`:""}
    </section>

    <section class="panel">
      <div class="panel-header"><h2>明細</h2></div>
      <div class="form-row">
        <input type="text" id="q-prod-search" value="${R(i)}" placeholder="商品名またはコードで検索して追加" />
      </div>
      ${b.length>0?`<div class="search-results">${b.map(k=>{const o=r?xa(k,r):{price:k.salePrice||0,label:"卸価格"},l=k.listPrice||0,d=o.label!=="標準価格"&&o.label!=="卸価格";return`<button class="search-item" type="button" data-add-product="${k.code}" data-prod-name="${R(k.name)}" data-prod-price="${o.price}" data-prod-retail="${l}" data-prod-jan="${R(k.janCode??"")}" data-prod-unit="${R(k.unit??"本")}" data-prod-case="${k.caseQty??""}">
          <span class="mono">${k.code}</span> ${R(k.name)}
          <span class="numeric" ${d?'style="color:#2f855a;font-weight:700;"':""}>納入 ${o.price?me(o.price):"未設定"} <small>(${o.label})</small>${l?`　定価 ${me(l)}`:""}</span>
        </button>`}).join("")}</div>`:""}
    ...
    <section class="panel">
      <div class="quote-summary">
        <div class="form-row">
          <label>備考</label>
          <textarea id="q-remarks" rows="3">${R(e.remarks)}</textarea>
        </div>
        <div class="quote-totals">
          <div><span>小計</span><span class="numeric">${me(p)}</span></div>
          <div><span>消費税(${e.taxRate}%)</span><span class="numeric">${me(u)}</span></div>
          <div class="total-row"><span>合計</span><span class="numeric">${me(y)}</span></div>
        </div>
      </div>
    </section>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${Je(k,c,{rank:"rank",name:"name",amount:"amount",sharePct:"sharePct",qty:"qty",growthRate:"growthRate"}).slice(0,100).map(m=>`
              <tr>
                <td>${_n(m.rank)}</td>
...
`);return`
  ...
  `}const Da={query:"",businessType:"",areaCode:"",activeOnly:"",page:1},st=50;function Zr(e,t){let s=e;if(t.query){const p=t.query.toLowerCase();s=s.filter(u=>u.code.toLowerCase().includes(p)||u.name.toLowerCase().includes(p)||u.kanaName&&u.kanaName.toLowerCase().includes(p)||u.address1&&u.address1.toLowerCase().includes(p)||u.phone&&u.phone.toLowerCase().includes(p))}t.businessType&&(s=s.filter(p=>p.businessType===t.businessType)),t.areaCode&&(s=s.filter(p=>p.areaCode===t.areaCode)),t.activeOnly==="active"?s=s.filter(p=>p.isActive):t.activeOnly==="inactive"&&(s=s.filter(p=>!p.isActive));const n=Math.max(1,Math.ceil(s.length/st)),r=(Math.min(t.page,n)-1)*st,c=s.slice(r,r+st);return{filtered:s,paged:c,totalPages:n}}function Wa(e,t,s){if(s<=1)return`<div class="master-pagination"><span>${e}件</span></div>`;const n=(t-1)*st+1,i=Math.min(t*st,e),r=[];for(let c=1;c<=s;c++)c===1||c===s||c>=t-2&&c<=t+2?r.push(`<button class="button ${c===t?"primary":"secondary"}" type="button" data-action="master-page" data-page="${c}" style="min-width:36px;padding:4px 8px;">${c}</button>`):(c===t-3||c===t+3)&&r.push('<span style="padding:0 4px;color:var(--text-secondary);">…</span>');return`
  ...
  `}function aa(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function tl(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function al(e){return e.map(t=>`
        <tr>
      ...
      `).join("")}function ft(e){return e?`¥${e.toLocaleString("ja-JP")}`:"―"}function sl(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${aa(t.name,20)}</td>
          <td>${t.kanaName||""}</td>
          ...
          <td>${t.unit||""}</td>
          <td>${t.bottleType||""}</td>
          <td class="numeric">${ft(t.purchasePrice)}</td>
          <td class="numeric">${ft(t.salePrice)}</td>
          <td class="numeric">${ft(t.listPrice)}</td>
          <td class="numeric">${ft(t.costPrice)}</td>
          <td>${t.riceType||""}</td>
      ...
      ${t==="customers"?`
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>${al(Je(r,n,{code:"code",name:"name",kanaName:"kanaName",businessType:"businessType",areaName:"areaName",closingDay:"closingDay",paymentDay:"paymentDay"}))}</tbody>
          </table>
        </div>
        ${Wa(i.length,s.page,c)}
      `:`
        <div class="table-wrap">
          <table>
            ...
            <tbody>${sl(Je(e.products,n,{code:"code",name:"name",category:"category",alcoholDegree:"alcoholDegree",volumeMl:"volumeMl",purchasePrice:"purchasePrice",salePrice:"salePrice",listPrice:"listPrice"}))}</tbody>
          </table>
        </div>
      `}
    </section>
  `}function jt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ol(e,t){if(!e&&!t)return"";const s=e;return`
  ...
  `}function rl(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function Ft(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const ll={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function cl(e){return`
    <section class="page-head">
      <div>
  ...
  `}function Re(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Za(e){return e.trim().toLowerCase()}function dl(e,t){const s=Za(t),n=e.filter(r=>s?[r.code,r.name,r.janCode].map(Za).some(c=>c.includes(s)):!0),i=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
  ...
  `}function Ke(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function pl(e,t){const s={holding:"保有中",due:"期日到来",cleared:"決済済"},n={holding:"neutral",due:"warning",cleared:"success"},i=e.map(f=>`
      <tr>
    ...
    `).join(""),r=t.map(f=>{const v=f.minimumStock>0&&f.currentStock<f.minimumStock*1.2;return`
        <tr>
          ...
          <td class="numeric">${Ke(f.unitCost)}</td>
          <td class="numeric">${Ke(f.currentStock*f.unitCost)}</td>
  ...
  `}function sa(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function ie(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function na(e){return`
  ...
  `}function vt(e){return`
    <div class="setup-command-row">
      <code class="inline-code">${ie(e)}</code>
      ${ml(e)}
    </div>
  `}function je(e){return`
    <div class="setup-step" data-step="${e.step}">
      ...
      <div class="setup-step-section">
        ...
        <ol class="setup-list">
          ${e.instructions.map(t=>`<li>${ie(t)}</li>`).join("")}
        </ol>
      </div>
      ${e.code?na(e.code):""}
      <div class="setup-step-section">
        ...
        <ul class="setup-list">
          ${e.success.map(t=>`<li>${ie(t)}</li>`).join("")}
        </ul>
      </div>
      <div class="setup-step-section">
        <p class="panel-title">よくあるエラー</p>
        <ul class="setup-list">
          ${e.errors.map(t=>`<li>${ie(t)}</li>`).join("")}
        </ul>
      </div>
    </div>
  `}function gt(e){return`
    <div class="setup-step setup-step-compact" data-step="${ie(e.stepLabel)}">
      <h3>${ie(e.title)}</h3>
      <div class="setup-step-section">
        <p class="panel-title">目的</p>
        <p>${ie(e.purpose)}</p>
  ...
  `}function bt(e){if(!e)return"error";const s=(Date.now()-new Date(e).getTime())/(1e3*60*60);return s<1?"success":s<24?"warning":"error"}function es(e){if(!e)return"未同期";const s=(Date.now()-new Date(e).getTime())/(1e3*60*60);return s<1?"正常":s<24?"注意":"要確認"}function yl(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">
          <span class="status-pill ${bt(e.lastOverallSync)}">${es(e.lastOverallSync)}</span>
        </p>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="status-pill ${bt(t.lastSyncAt)}">${es(t.lastSyncAt)}</span></td>
            </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function hl(e,t,s,n){const i={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    ...
    <section class="kpi-grid compact">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-sub">${ie(e.message)}</p>
      </article>
      <article class="panel kpi-card">
    ...
    <section class="panel">
      ...
      ${gt({stepLabel:"準備1",title:"Git（ソースコード取得に使用）",purpose:"GitHubからファイルをダウンロードするためのツール",body:`
        ...
        `})}
      ${gt({stepLabel:"準備2",title:"Python（同期スクリプトの実行環境）",purpose:"リレースクリプトを動かす",body:`
          <p class="panel-title">確認方法</p>
        ...
        `})}
      ${gt({stepLabel:"準備3",title:"pip（Pythonのパッケージ管理ツール）",purpose:"requests, pyodbc などのライブラリを入れる",body:`
          <p class="panel-title">確認方法</p>
          ...
          ${vt("python get-pip.py")}
        `})}
      ${gt({stepLabel:"準備4",title:"テキストエディタ（設定ファイル編集用）",purpose:"relay_config.json を編集するため",body:`
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
      ...
      <div class="relay-config-list">
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${ie(t)}</span>
          </div>
          <button
            class="button secondary"
            type="button"
            data-action="copy-config"
            data-config-value="${ie(t)}"
          >
            コピー
          </button>
        </div>
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${ie(s)}</span>
          </div>
          <button
            class="button secondary"
            type="button"
            data-action="copy-config"
            data-config-value="${ie(s)}"
          >
            コピー
          </button>
        </div>
  ...
  `}function gl(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(n=>`<th class="numeric">${n}</th>`).join(""),s=e.monthlyByCustomer.map(n=>{const i=n.values.reduce((c,p)=>c+p,0),r=n.values.map(c=>`<td class="numeric">${c>0?(c/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${n.label}</td>
          ${r}
          <td class="numeric"><strong>${tt(i)}</strong></td>
        </tr>
      `}).join("");return`
    <div class="table-wrap">
      <table>
  ...
  `}function bl(e){e.ranking.reduce((u,y)=>u+y.amount,0);const t=e.ranking.filter(u=>u.abcRank==="A").length,s=e.ranking.filter(u=>u.abcRank==="B").length,n=e.ranking.filter(u=>u.abcRank==="C").length,i=e.ranking.filter(u=>u.abcRank==="A").reduce((u,y)=>u+y.amount,0),r=e.ranking.filter(u=>u.abcRank==="B").reduce((u,y)=>u+y.amount,0),c=e.ranking.filter(u=>u.abcRank==="C").reduce((u,y)=>u+y.amount,0),p=e.ranking.map(u=>`
    ...
    <section class="kpi-row">
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value kpi-success">${t}社 <span class="kpi-sub">${tt(i)}</span></div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label">Bランク</div>
        <div class="kpi-value kpi-warning">${s}社 <span class="kpi-sub">${tt(r)}</span></div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label">Cランク</div>
        <div class="kpi-value">${n}社 <span class="kpi-sub">${tt(c)}</span></div>
      </div>
    </section>
  ...
  `}function Nt(e){return e>=1e3?`${(e/1e3).toLocaleString("ja-JP",{maximumFractionDigits:1})} L`:`${e.toLocaleString("ja-JP")} ml`}function Pl(e,t=!1){const s=t?7:6;return e.length===0?`<tr><td colspan="${s}" class="empty-row">データなし</td></tr>`:e.map(n=>`
    <tr>
      <td class="mono">${n.code}</td>
      <td>${n.name}</td>
      <td class="numeric">${Ye(n.amount)}</td>
      <td class="numeric">${n.quantity.toLocaleString("ja-JP")}</td>
      <td class="numeric">${Nt(n.volumeMl)}</td>
  ...
  `).join("")}function Cl(e){return e.length===0?'<tr><td colspan="7" class="empty-row">データなし</td></tr>':e.map(t=>`
    <tr>
      ...
      <td class="numeric">${Nt(t.volumeMl)}</td>
  ...
  `}function kn(e,t,s="all",n="",i=[],r=[],c="",p="",u=null,y="all",f="",v=[],b=[],x=[],k=null,o=[],l=[],d="amount",m="calendar"){const g=t==="products"?"商品別集計":t==="customers"?"得意先別集計":"担当別集計",$=t==="products"?e.productTotals:t==="customers"?e.customerTotals:e.staffTotals,C=s!=="all"&&i.length>0&&t!=="staff"?i:$,S=Je(C,x,$l),A={all:"月別",yearly:"月別推移",monthly:"日別推移",weekly:"日別推移",daily:"当日"},q=ts[d],L=V=>d==="quantity"?V.quantity:d==="volume"?V.volumeMl:V.amount,T=V=>d==="quantity"?`${V.toLocaleString()}本`:d==="volume"?Nt(V):Ye(V);let M,j=[],z,W,ne;if(k&&k.monthlySales.length>0)M=k.monthlySales.slice(-24).map(V=>({month:V.month,amount:L(V)})),z=`${k.name} の月別${q}`,W=`${k.tab==="customers"?"得意先":"商品"}: ${k.code}`,ne="#0968e5";else if(o.length>0&&s!=="all"){M=o.map(ce=>({month:ce.month,amount:L(ce)})),j=l.map(ce=>({month:ce.month,amount:L(ce)}));const V=M.reduce((ce,H)=>ce+H.amount,0),_e=j.reduce((ce,H)=>ce+H.amount,0),dt=_e>0?(V-_e)/_e*100:0,Te=dt>0?"+":"";z=`${A[s]} ${q}（${n}）`,W=`${T(V)}${_e>0?` / 前年比 ${Te}${dt.toFixed(1)}%`:""}`,ne="#2f855a"}else{M=wl(e.monthlySales,d,m).curr,j=[];const _e=M.reduce((Te,ce)=>Te+ce.amount,0);z=`${m==="fiscal"?"決算年度別":"暦年別"}${q}`,W=`累計 ${T(_e)}（${M.length}${m==="fiscal"?"期":"年"}）`,ne="#0F5B8D"}const pe=["amount","quantity","volume"].map(V=>`<button class="tab-button ${V===d?"active":""}" data-chart-metric="${V}">${ts[V]}</button>`).join(""),oe=["all","yearly","monthly","weekly","daily"].map(V=>`<button class="button ${V===s?"primary":"secondary"} small" type="button" data-analytics-period="${V}">${as[V]}</button>`).join(""),O=m==="fiscal"&&s==="yearly"?xl(e.monthlySales):r,K=m==="fiscal"&&s==="yearly"&&!O.includes(n)?O[0]??"":n,Qe=s!=="all"&&O.length>0&&t!=="staff"?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
        ${O.map(V=>`<option value="${V}" ${V===K?"selected":""}>${m==="fiscal"&&s==="yearly"?V+"年度":V}</option>`).join("")}
      </select>`:"";let qe="",Ie="";if(t==="staff"){const V=["all","yearly","monthly","weekly","daily"].map(H=>`<button class="button ${H===y?"primary":"secondary"} small" type="button" data-staff-period="${H}">${as[H]}</button>`).join(""),_e=y!=="all"&&v.length>0?`<select id="staff-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
          ${v.map(H=>`<option value="${H}" ${H===f?"selected":""}>${H}</option>`).join("")}
        </select>`:"",Te=(b.length>0?b:e.staffTotals).filter(H=>!c||H.name.includes(c)||H.code.includes(c)),ce=y!=="all"&&f?` (${f})`:"";if(qe=`
      ...
      <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;align-items:center;">
        ...
        ${ce?`<span style="font-size:12px;color:var(--text-secondary);">${ce}</span>`:""}
      </div>
      <div class="table-wrap">
        <table>
          <thead>
          ...
          <tbody>
            ${Te.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':Te.map(H=>`
                <tr>
                  <td class="mono">${H.code||"―"}</td>
                  <td>${H.name||"未設定"}</td>
                  <td class="numeric">${Ye(H.amount)}</td>
    ...
    `,u){const H=u.breakdownTab,Jn=y!=="all"&&f?`<span style="font-size:12px;color:var(--text-secondary);margin-left:8px;">${f}</span>`:"";Ie=`
        <article class="panel" style="margin-top:16px;">
          ...
          ${H==="customers"?ss(u.customerRows,p,"得意先名"):ss(u.productRows,p,"商品名")}
        </article>
      `}}return`
    <section class="page-head">
      <div>
    ...
    <section class="analytics-grid">
      <article class="panel">
        <div class="panel-header" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
          <div>
            <h2>${z}</h2>
            <p class="panel-caption">${W}</p>
          </div>
          <div style="display:flex;gap:8px;align-items:center;">
            <div class="tab-group">${pe}</div>
  ...
  `}const ns=Object.freeze(Object.defineProperty({__proto__:null,fiscalYearToDateRange:_l,monthToFiscalYear:qa,renderSalesAnalytics:kn},Symbol.toStringTag,{value:"Module"}));function We(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Al(e){const t=Math.max(...e.salesByProduct.flatMap(r=>r.values),1),s=e.salesByProduct.map(r=>{const c=r.values.map((p,u)=>`
      ...
      <tr>
        ...
        <td>${r.productName}</td>
        <td class="numeric">${We(r.costPrice)}</td>
        <td class="numeric">${We(r.sellPrice)}</td>
        <td class="numeric">${We(r.margin)}</td>
        <td class="numeric">
    ...
    `).join(""),i=e.salesByCustomer.map(r=>{const c=r.values.reduce((p,u)=>p+u,0);return`
        <tr>
          ...
          <td class="numeric"><strong>${We(c)}</strong></td>
        </tr>
      `}).join("");return`
    <section class="page-head">
      <div>
  ...
  `}function $t(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ql(e,t,s,n){const i={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},r={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},c={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},p=e.map(v=>`
      <tr>
        ...
        <td class="numeric">${$t(v.unitPrice)}</td>
        <td class="numeric"><strong>${$t(v.amount)}</strong></td>
    ...
    `).join(""),u=t.map(v=>`
      <tr>
        ...
        <td class="numeric"><strong>${$t(v.totalAmount)}</strong></td>
        <td>
  ...
  `}const X={header:"#2196F3",code:"#4CAF50",date:"#FF9800",detail:"#9C27B0",total:"#F44336"};function Nl(e,t,s){const n=[{id:"documentNo",label:"伝票番号",x:155,y:4,fontSize:9,value:e.documentNo,color:X.header},{id:"vendorName",label:"社名",x:4,y:12,fontSize:10,value:t.name,color:X.header},{id:"vendorAddress",label:"住所",x:4,y:17,fontSize:7,value:t.address1,color:X.header},{id:"customerName",label:"取引先名",x:4,y:20,fontSize:10,value:`${e.customerName} ${e.customerHonorific}`,color:X.header},{id:"chainStoreCode",label:"柱店CD",x:63,y:13,fontSize:9,value:e.chainStoreCode??"",color:X.code},{id:"categoryCode",label:"分類CD",x:87,y:13,fontSize:9,value:e.categoryCode??"",color:X.code},{id:"slipNumber",label:"伝票No.",x:117,y:13,fontSize:9,value:e.documentNo,color:X.code},{id:"vendorCode",label:"取引CD",x:151,y:13,fontSize:9,value:e.slipTypeCode??"",color:X.code},{id:"partnerCode",label:"取引先CD",x:94,y:20,fontSize:10,value:e.vendorCode??"",color:X.code},{id:"orderNo",label:"受注No.",x:143,y:20,fontSize:9,value:e.orderNo??"",color:X.code},{id:"currentDate",label:"当日日付",x:10,y:3.5,fontSize:8,value:e.documentDate.replace(/-/g,"/"),color:X.date},{id:"orderDate",label:"発注日",x:180,y:13,fontSize:7.5,value:(e.orderDate??"").replace(/-/g,"/"),color:X.date},{id:"deliveryDate",label:"納品日",x:204,y:13,fontSize:7.5,value:(e.deliveryDate??"").replace(/-/g,"/"),color:X.date}];e.lines.slice(0,6).forEach((c,p)=>{const u=33+p*8.5;n.push({id:`line${p}_name`,label:`明細${p+1} 品名`,x:5,y:u,fontSize:7.5,value:c.productName+(c.spec?` ${c.spec}`:""),color:X.detail},{id:`line${p}_code`,label:`明細${p+1} CD`,x:64,y:u,fontSize:7.5,value:c.productCode,color:X.detail},{id:`line${p}_qty`,label:`明細${p+1} 数量`,x:124,y:u,fontSize:8,value:c.quantity>0?String(c.quantity):"",color:X.detail},{id:`line${p}_price`,label:`明細${p+1} 原単価`,x:163,y:u,fontSize:8,value:c.unitPrice>0?c.unitPrice.toLocaleString("ja-JP"):"",color:X.detail},{id:`line${p}_amount`,label:`明細${p+1} 原価金額`,x:176,y:u,fontSize:8,value:c.amount>0?c.amount.toLocaleString("ja-JP"):"",color:X.detail},{id:`line${p}_retail`,label:`明細${p+1} 売単価`,x:193,y:u,fontSize:8,value:c.retailPrice?c.retailPrice.toLocaleString("ja-JP"):"",color:X.detail})});const i=e.lines.reduce((c,p)=>c+(p.amount||0),0),r=e.lines.reduce((c,p)=>c+p.quantity,0);return n.push({id:"totalQty",label:"合計数量",x:125,y:89,fontSize:9,value:String(r),color:X.total},{id:"costTotal",label:"原価金額合計",x:179,y:89,fontSize:10,value:i.toLocaleString("ja-JP"),color:X.total}),s&&n.forEach(c=>{const p=s[c.id];p&&(c.x=p.x,c.y=p.y)}),n}function Ml(e,t,s,n,i){const c=Nl(e,t,n).map(u=>`
    ...
    <section class="panel no-print">
      ...
      <p class="form-hint" style="margin:12px 0 0;">
        ...
        色: <span style="color:${X.header}">■ヘッダ</span>
        <span style="color:${X.code}">■コード</span>
        <span style="color:${X.date}">■日付</span>
        <span style="color:${X.detail}">■明細</span>
        <span style="color:${X.total}">■合計</span>
      </p>
    </section>
    `:""}
...
金井酒造店`;function Ul(e,t){const s=t?e.find(i=>i.id===t):null,n=t==="__new__";return`
  ...
  `}function cs(e){const t=new Date(e),s=n=>String(n).padStart(2,"0");return`${t.getFullYear()}-${s(t.getMonth()+1)}-${s(t.getDate())}T${s(t.getHours())}:${s(t.getMinutes())}`}const Ze={shopify:{description:"Shopifyストアの注文・商品を自動同期します。",setupUrl:"https://shopify.dev/docs/apps/auth/admin-app-access-tokens",fields:[{key:"shop_domain",label:"ショップドメイン",placeholder:"your-store.myshopify.com"},{key:"admin_token",label:"Admin API アクセストークン",placeholder:"shpat_xxx..."}]},google_calendar:{description:"Googleカレンダーの予定を取込・書き戻しします。OAuth2.0トークンが必要です。",setupUrl:"https://console.cloud.google.com/apis/credentials",fields:[{key:"calendar_id",label:"カレンダーID",placeholder:"primary または xxx@group.calendar.google.com"},{key:"oauth_token",label:"OAuth Access Token",placeholder:"ya29.xxx..."}]},cloud_vision:{description:"FAX画像をOCRしてテキスト化、伝票を自動起票します。",setupUrl:"https://console.cloud.google.com/apis/credentials",fields:[{key:"api_key",label:"Cloud Vision API Key",placeholder:"AIzaSyxxx..."}]},resend:{description:"メール送信サービス。Webhook受信用エンドポイントもこちらから。",setupUrl:"https://resend.com/api-keys",fields:[{key:"api_key",label:"Resend API Key",placeholder:"re_xxx..."}]},slack:{description:"Slackに各種業務通知を送信します (受注/入金遅延/低在庫 等)。",setupUrl:"https://api.slack.com/messaging/webhooks",fields:[{key:"webhook_url",label:"Webhook URL",placeholder:"https://hooks.slack.com/services/..."},{key:"default_channel",label:"デフォルトチャンネル",placeholder:"#general"}]},ivry:{description:"IVRy電話システム連携。通話履歴取得と電話帳同期。",setupUrl:"https://ivry.jp/",fields:[{key:"api_key",label:"IVRy API Key",placeholder:"sk_live_..."},{key:"team_id",label:"チームID",placeholder:"team_..."},{key:"phone_number",label:"代表電話番号",placeholder:"0463-88-1511"}]},google_maps:{description:"Google Maps APIで地図表示。設定するとLeafletからGoogle Mapsに切替。",setupUrl:"https://console.cloud.google.com/apis/credentials",fields:[{key:"api_key",label:"Google Maps API Key",placeholder:"AIzaSyxxx..."}]}};function Gl(e,t){const s=t?e.find(n=>n.id===t):null;return`
    ...
    ${s?`
      <section class="panel">
        ...
        <p class="form-hint">${Ze[s.provider]?.description??""}</p>
        ${Ze[s.provider]?.setupUrl?`<p class="form-hint">📖 取得方法: <a href="${Ze[s.provider].setupUrl}" target="_blank">${Ze[s.provider].setupUrl}</a></p>`:""}
        <div class="filter-grid filter-grid--wide" style="margin-top:12px;">
          ${(Ze[s.provider]?.fields??[]).map(n=>`
            <label class="field" style="flex:1 1 100%;">
              <span>${n.label}</span>
      ...
      <section class="panel">
        ...
        <div class="filter-grid filter-grid--wide">
          ...
          <label class="field" style="flex:1 1 140px;">
            <span>部署</span>
            <select id="user-dept">
              ${Object.entries(Ct).map(([c,p])=>`<option value="${c}" ${n?.department===c?"selected":""}>${p}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 140px;">
            <span>権限</span>
            <select id="user-role">
              ${Object.entries(Pt).map(([c,p])=>`<option value="${c}" ${n?.role===c?"selected":""}>${p}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 160px;">
            <span>電話</span>
      ...
      <div class="pk-board">${["cold","warm","hot","contacted","negotiating","won","lost"].map(n=>{const i=e.filter(c=>c.stage===n),r=i.reduce((c,p)=>c+p.expectedAmount,0);return`
        <div class="pk-col" data-prospect-stage="${n}">
          <div class="pk-col-header" style="--pk-color:${Aa[n]};">
            <span class="pk-col-label">${It[n]}</span>
          ...
          <tbody>
            ${e.map(t=>`
              <tr>
                ...
                <td>${t.businessType??"―"}</td>
                <td><span class="status-pill" style="background:${Aa[t.stage]};color:white;">${It[t.stage]}</span></td>
          ...
          <div class="filter-grid filter-grid--wide">
            ...
            <label class="field" style="flex:1 1 140px;">
              ...
              <select id="prospect-stage">
                ${Object.entries(It).map(([n,i])=>`<option value="${n}" ${s?.stage===n?"selected":""}>${i}</option>`).join("")}
              </select>
            </label>
            <label class="field" style="flex:1 1 120px;">
              <span>流入元</span>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${t.map(r=>`
              <tr>
                <td>${At[r.eventType]||r.eventType}</td>
                <td>
  ...
  `}const ds={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},cc={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},dc={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function ae(e){return"¥"+e.toLocaleString("ja-JP")}function nt(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function Pn(e,t){const s=e.reduce((r,c)=>r+c.amount,0),n=Math.floor(s*t),i=s+n;return{subtotal:s,taxAmount:n,total:i}}const U={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function G(e,t){const s=e.align??"left",n=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${s}`,`font-size:${n}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function Vt(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),s=t.getFullYear(),n=s-2018;return{y:n>0?String(n).padStart(2,"0"):String(s).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function uc(e,t,s){const n=Vt(e.documentDate),i=Vt(e.orderDate??e.documentDate),r=Vt(e.deliveryDate??e.documentDate),c=e.lines.slice(0,6).map((l,d)=>{const m=U.detailStartY+d*U.detailRowH,g=U.detailCols,$=[],w=(C,S)=>{S&&$.push(G({...C,y:m,x:C.x+0},S))};return w(g.productName,l.productName+(l.spec?` ${l.spec}`:"")),w(g.productCode,l.productCode),w(g.color,l.color??""),w(g.size,[l.size,l.caseQty?`×${l.caseQty}`:""].filter(Boolean).join(" ")),w(g.unit,l.unit),w(g.quantity,l.quantity>0?l.quantity.toLocaleString("ja-JP"):""),w(g.correctedQty,l.correctedQuantity?l.correctedQuantity.toLocaleString("ja-JP"):""),w(g.discount,l.discount?l.discount.toLocaleString("ja-JP"):""),w(g.unitPrice,l.unitPrice>0?l.unitPrice.toLocaleString("ja-JP"):""),w(g.costAmount,l.amount>0?l.amount.toLocaleString("ja-JP"):""),w(g.retailPrice,l.retailPrice?l.retailPrice.toLocaleString("ja-JP"):""),w(g.note,l.receivedAmount?l.receivedAmount.toLocaleString("ja-JP"):""),$.join("")}).join(""),p=e.lines.reduce((l,d)=>l+(d.amount||0),0),u=e.lines.reduce((l,d)=>l+(d.retailPrice||0)*(d.correctedQuantity??d.quantity),0),y=e.lines.reduce((l,d)=>l+(d.receivedAmount||0),0),f=e.lines.reduce((l,d)=>l+(d.returnAmount||0),0),v=e.lines.reduce((l,d)=>l+d.quantity,0),b=s.showReferenceOverlay?`background-image: url('${s.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",x=s.calibrationOffsetX||0,k=s.calibrationOffsetY||0,o=`transform: translate(${x}mm, ${k}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${b}">
        ...
        ${G(U.currentDateY,n.y)}
        ${G(U.currentDateM,n.m)}
        ${G(U.currentDateD,n.d)}
        ${G(U.documentNo,e.documentNo)}
        ${e.settlementPrint?G(U.settlementCheck,"✓"):""}

        ${G(U.vendorName,t.name)}
        ${G(U.vendorAddress,t.address1)}
        ${G(U.chainStoreCode,e.chainStoreCode??"")}
        ${G(U.categoryCode,e.categoryCode??"")}
        ${G(U.slipNumber,e.documentNo)}
        ${G(U.vendorCode,e.slipTypeCode??"")}

        ${G(U.customerName,`${e.customerName} ${e.customerHonorific}`)}
        ${G(U.orderDateY,i.y)}
        ${G(U.orderDateM,i.m)}
        ${G(U.orderDateD,i.d)}
        ${G(U.deliveryDateY,r.y)}
        ${G(U.deliveryDateM,r.m)}
        ${G(U.deliveryDateD,r.d)}
        ${G(U.orderNo,e.orderNo??"")}
        ${G(U.partnerCode,e.vendorCode??"")}

        ${c}

        ${G(U.totalQty,v.toLocaleString("ja-JP"))}
        ${G(U.receivedTotal,y.toLocaleString("ja-JP"))}
        ${G(U.returnTotal,f.toLocaleString("ja-JP"))}
        ${G(U.correctedCostTotal,p.toLocaleString("ja-JP"))}
        ${G(U.correctedRetailTotal,u.toLocaleString("ja-JP"))}
        </div>
      </div>
    </div>
  `}function pc(e,t,s){const{subtotal:n,taxAmount:i,total:r}=Pn(e.lines,e.taxRate),c=e.previousBalance??0,p=e.paymentAmount??0,u=c-p+r,y=e.lines.map(v=>`
      <tr>
        ...
        <td class="numeric">${ae(v.unitPrice)}</td>
        <td class="numeric">${ae(v.amount)}</td>
      </tr>
    ...
    <div class="print-page invoice-freee ${s.fontSize}">
      ...
      <!-- 日付 -->
      <dl class="freee-meta">
        <div><dt>請求日</dt><dd>${nt(e.documentDate)}</dd></div>
        ${e.dueDate?`<div><dt>お支払期限</dt><dd>${nt(e.dueDate)}</dd></div>`:""}
        ...
        <div>
          ${s.showRegistrationNo?`
            <div class="freee-tax-breakdown">
              <p>＜税率内訳＞</p>
              <p>${Math.round(e.taxRate*100)}%対象: ${ae(n)} / 消費税: ${ae(i)}</p>
            </div>`:""}
        </div>
        <table class="freee-summary-table">
          ${c?`<tr><th>前回御請求額</th><td>${ae(c)}</td></tr>`:""}
          ${p?`<tr><th>ご入金額</th><td>▲ ${ae(p)}</td></tr>`:""}
          <tr><th>今回御請求 小計</th><td>${ae(n)}</td></tr>
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${ae(i)}</td></tr>
  ...
  `}function mc(e,t,s){const{subtotal:n,taxAmount:i,total:r}=Pn(e.lines,e.taxRate),c=e.lines.map(u=>`
    ...
    <div class="print-page quotation-freee ${s.fontSize}">
      ...
      <dl class="freee-meta">
        <div><dt>見積日</dt><dd>${nt(e.documentDate)}</dd></div>
        ${e.expireDate?`<div><dt>有効期限</dt><dd>${nt(e.expireDate)}</dd></div>`:""}
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${ae(r)}</span>
          <span class="freee-total-tax">（税込）</span>
        </div>
      </div>
      ...
      <div class="freee-summary">
        ...
        <table class="freee-summary-table">
          <tr><th>小計</th><td>${ae(n)}</td></tr>
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${ae(i)}</td></tr>
          <tr class="freee-sum-grand"><th>合計</th><td>${ae(r)}</td></tr>
        </table>
      </div>
      ...
      <p class="freee-footer">本見積書は ${e.expireDate?nt(e.expireDate)+" まで":"発行日から30日間"} 有効です。</p>
    </div>
...
`}async function Ln(e,t){const{supabaseInsert:s}=await E(async()=>{const{supabaseInsert:p}=await Promise.resolve().then(()=>B);return{supabaseInsert:p}},void 0);let n=0,i=0;const c={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const p of t){if(!p._valid)continue;const{_valid:u,_error:y,...f}=p,v={...f};if(!v.id){const b=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";v.id=String(f[b]??`${e}-${Date.now()}-${n+i}`)}for(const b of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof v[b]=="string"&&v[b]!==""){const x=Number(v[b]);Number.isFinite(x)&&(v[b]=x)}try{await s(c,v)!==null?n++:i++}catch{i++}}return{inserted:n,failed:i}}const vc=Object.freeze(Object.defineProperty({__proto__:null,generateTemplateCSV:En,importToSupabase:Ln,parseCSV:Cn,validateImport:An},Symbol.toStringTag,{value:"Module"}));function Jt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function gc(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function bc(e,t,s,n,i){const r=s.reduce((y,f)=>y+f.rowCount,0),c=s.map(y=>y.lastSyncAt).filter(y=>y!==null).sort().reverse()[0]??null,p=100,u=Math.max(1,Math.ceil(i/p));return`
  ...
  `}function Sc(e,t){const n=e.slice().sort((r,c)=>{if(!t)return 0;const p=t.dir==="asc"?1:-1;switch(t.column){case"ss-name":return p*r.productName.localeCompare(c.productName,"ja");case"ss-avg":return p*(r.avgMonthlyDemand-c.avgMonthlyDemand);case"ss-std":return p*(r.demandStdDev-c.demandStdDev);case"ss-ss":{const u=Math.ceil(et(r.serviceLevel)*r.demandStdDev*Math.sqrt(r.leadTimeDays/30)),y=Math.ceil(et(c.serviceLevel)*c.demandStdDev*Math.sqrt(c.leadTimeDays/30));return p*(u-y)}case"ss-rop":{const u=Math.ceil(r.avgMonthlyDemand*(r.leadTimeDays/30)+et(r.serviceLevel)*r.demandStdDev*Math.sqrt(r.leadTimeDays/30)),y=Math.ceil(c.avgMonthlyDemand*(c.leadTimeDays/30)+et(c.serviceLevel)*c.demandStdDev*Math.sqrt(c.leadTimeDays/30));return p*(u-y)}default:return 0}}).map(r=>{const c=et(r.serviceLevel),p=r.leadTimeDays/30,u=Math.ceil(c*r.demandStdDev*Math.sqrt(p)),y=Math.ceil(r.avgMonthlyDemand*p+u),f=u-r.safetyStockQty,v=f>0?"text-danger":f<-u*.3?"text-warning":"",b=[.9,.95,.99].map(x=>`<option value="${x}" ${Math.abs(r.serviceLevel-x)<.01?"selected":""}>${(x*100).toFixed(0)}%</option>`).join("");return`
      <tr>
        <td style="white-space:nowrap;">${r.productName}</td>
        <td class="numeric">${Q(Math.round(r.avgMonthlyDemand))}</td>
        <td class="numeric">${Q(Math.round(r.demandStdDev))}</td>
        <td>
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
              ${ge("商品名","ss-name",t)}
              ${ge("月平均需要","ss-avg",t,"numeric")}
              ${ge("標準偏差","ss-std",t,"numeric")}
              <th class="numeric">リードタイム(日)</th>
              <th>サービス率</th>
              ${ge("安全在庫[算出]","ss-ss",t,"numeric")}
              ${ge("発注点","ss-rop",t,"numeric")}
  ...
  `}const kc={monthly:"月次",annual:"年次",make_to_order:"受注生産",november:"11月生産"};function Pc(e,t,s,n){const i={draft:"下書き",confirmed:"確定",actual:"実績入力済"},r={draft:"neutral",confirmed:"info",actual:"success"},c=S=>Object.entries(kc).map(([A,q])=>`<option value="${A}" ${A===S?"selected":""}>${q}</option>`).join(""),p=640,u=S=>S.map(A=>{const q=Math.max(0,A.demandForecast+A.safetyStockTarget-A.openingStock),L=A.plannedQty>0?A.plannedQty:Math.round(q),T=L>0?Math.ceil(L/p*10)/10:0,M=A.plannedQty>0?(A.actualQty-A.plannedQty)/A.plannedQty*100:null,j=M!==null?M>=0?"text-success":"text-danger":"";return`
      <tr>
        ...
        <td class="numeric">${Q(Math.round(A.demandForecast))}</td>
        <td class="numeric">${Q(Math.round(A.safetyStockTarget))}</td>
        <td class="numeric">${Q(Math.round(A.openingStock))}</td>
        <td class="numeric"><strong>${Q(Math.round(q))}</strong></td>
        <td>
        ...
        <td class="numeric">${A.actualQty>0?Q(A.actualQty):"—"}</td>
        <td class="numeric ${j}">
    ...
    `}).join(""),f=(s==="all"?e:e.filter(S=>S.productionType===s)).slice().sort((S,A)=>{if(!n)return 0;const q=n.dir==="asc"?1:-1,L=Math.max(0,S.demandForecast+S.safetyStockTarget-S.openingStock),T=Math.max(0,A.demandForecast+A.safetyStockTarget-A.openingStock);switch(n.column){case"plan-name":return q*S.productName.localeCompare(A.productName,"ja");case"plan-forecast":return q*(S.demandForecast-A.demandForecast);case"plan-required":return q*(L-T);case"plan-planned":return q*(S.plannedQty-A.plannedQty);case"plan-actual":return q*(S.actualQty-A.actualQty);case"plan-label":{const M=S.plannedQty>0?S.plannedQty:Math.round(L),j=A.plannedQty>0?A.plannedQty:Math.round(T);return q*(M-j)}default:return 0}}),v=u(f),b=[{key:"all",label:"全て"},{key:"monthly",label:"月次"},{key:"annual",label:"年次"},{key:"november",label:"11月生産"},{key:"make_to_order",label:"受注生産"}],x=S=>{const q=(S==="all"?e:e.filter(L=>L.productionType===S)).reduce((L,T)=>{const M=Math.max(0,T.demandForecast+T.safetyStockTarget-T.openingStock);return L+(T.plannedQty>0?T.plannedQty:Math.round(M))},0);return Math.ceil(q/p*10)/10},k=b.filter(S=>S.key!=="all").map(S=>{const A=x(S.key),q=e.filter(T=>T.productionType===S.key).length,L=S.key==="make_to_order"?e.filter(T=>T.productionType==="make_to_order"&&T.plannedQty>0).length:null;return`
        ...
        <table>
          <thead>
            <tr>
              ${ge("商品名","plan-name",n)}
              <th>生産区分</th>
              ${ge("需要予測","plan-forecast",n,"numeric")}
              <th class="numeric">安全在庫目標</th>
              <th class="numeric">期首在庫</th>
              ${ge("必要生産数","plan-required",n,"numeric")}
              ${ge("計画数","plan-planned",n,"numeric")}
              ${ge("実績数","plan-actual",n,"numeric")}
              <th class="numeric">達成率</th>
              ${ge("ラベル工数","plan-label",n,"numeric")}
              <th>状態</th>
            </tr>
          </thead>
          <tbody>
            ...
            ${f.length>0?`
              <tr style="background:var(--surface-alt);font-weight:700;">
                ...
                <td class="numeric">—</td>
                <td class="numeric">—</td>
                <td class="numeric">${Q(Math.round(l))}</td>
  ...
  `}function Dn(e){const[t,s]=e.split("-").map(Number),n=new Date(t,s,0).getDate();return Array.from({length:n},(i,r)=>{const c=r+1;return`${e}-${String(c).padStart(2,"0")}`})}function us(e){const t=new Date(e).getDay();return["日","月","火","水","木","金","土"][t]}function ps(e){const t=new Date(e).getDay();return t===0||t===6}function Cc(e){return e.partTimers*ia+e.employees*ra}function qn(e){return e.partTimers+e.employees}function Ac(e,t){const s=t.filter(c=>qn(c)>0).map(c=>c.date).sort();if(s.length===0)return t.map(c=>({date:c.date,partTimers:c.partTimers,employees:c.employees,confirmed:c.confirmed,capacity:0,items:[],totalQty:0,utilization:0}));const n={monthly:0,november:1,annual:2,make_to_order:3},i=e.filter(c=>c.plannedQty>0||Math.max(0,c.demandForecast+c.safetyStockTarget-c.openingStock)>0).map(c=>({productCode:c.productCode,productName:c.productName,productionType:c.productionType,remaining:c.plannedQty>0?c.plannedQty:Math.max(0,c.demandForecast+c.safetyStockTarget-c.openingStock)})).filter(c=>c.remaining>0).sort((c,p)=>(n[c.productionType]??99)-(n[p.productionType]??99)||p.remaining-c.remaining),r=new Map;for(const c of t){const p=Cc(c);r.set(c.date,{date:c.date,partTimers:c.partTimers,employees:c.employees,confirmed:c.confirmed,capacity:p,items:[],totalQty:0,utilization:0})}for(const c of i){let p=c.remaining;if(p<=0)continue;if(s.reduce((y,f)=>{const v=r.get(f);return y+Math.max(0,v.capacity-v.totalQty)},0)<=0)break;for(const y of s){if(p<=0)break;const f=r.get(y),v=Math.max(0,f.capacity-f.totalQty);if(v<=0)continue;const b=Math.min(p,v);f.items.push({productCode:c.productCode,productName:c.productName,productionType:c.productionType,qty:b}),f.totalQty+=b,f.utilization=f.capacity>0?f.totalQty/f.capacity:0,p-=b}}return t.map(c=>r.get(c.date))}function kt(e,t=1,s=1){return Dn(e).map(n=>({date:n,partTimers:ps(n)?0:t,employees:ps(n)?0:s,confirmed:!1}))}function Ec(e,t,s,n=null){const i=Dn(t),r=Ac(e,s),c=new Map(r.map(L=>[L.date,L])),p=e.reduce((L,T)=>L+(T.plannedQty>0?T.plannedQty:Math.max(0,T.demandForecast+T.safetyStockTarget-T.openingStock)),0),u=r.reduce((L,T)=>L+T.totalQty,0),y=s.filter(L=>qn(L)>0).length,f=r.reduce((L,T)=>L+T.capacity,0),v=s.reduce((L,T)=>L+T.partTimers,0),b=s.reduce((L,T)=>L+T.employees,0),x=s.find(L=>L.partTimers>0)?.partTimers??1,k=s.find(L=>L.employees>0)?.employees??1,o=[0,1,2,3,4,5].map(L=>`<option value="${L}" ${L===x?"selected":""}>${L}</option>`).join(""),l=[0,1,2,3].map(L=>`<option value="${L}" ${L===k?"selected":""}>${L}</option>`).join(""),d=new Date,m=Array.from({length:24},(L,T)=>{const M=new Date(d.getFullYear(),d.getMonth()-6+T,1),j=`${M.getFullYear()}-${String(M.getMonth()+1).padStart(2,"0")}`;return`<option value="${j}" ${j===t?"selected":""}>${j.replace("-","年")}月</option>`}).join(""),g=new Date(i[0]).getDay(),$=[];for(let L=0;L<g;L++)$.push('<div style="min-height:44px;"></div>');for(const L of i){const T=c.get(L),M=new Date(L).getDay(),j=parseInt(L.split("-")[2]),z=T?.partTimers??0,W=T?.employees??0,ne=z+W,pe=T?.totalQty??0,oe=T?.utilization??0,O=L===n,K=ne===0?"var(--surface-alt)":oe>.95?"rgba(197,61,61,0.12)":oe>.7?"rgba(183,121,31,0.10)":oe>0?"rgba(47,133,90,0.08)":"var(--surface)",Qe=ne===0?"transparent":oe>.95?"#c53d3d":oe>.7?"#b7791f":oe>0?"#2f855a":"var(--border)",qe=M===0?"#c53d3d":M===6?"#0F5B8D":"var(--text)",Ie=ne>0?`<span style="font-size:8px;color:var(--text-secondary);line-height:1;">${z>0?`パ${z}`:""}${W>0?`社${W}`:""}</span>`:"";$.push(`
      <div data-action="cal-select-day" data-date="${L}"
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;">
          <span style="font-size:12px;font-weight:600;color:${qe};line-height:1;">${j}</span>
          ${Ie}
        </div>
        ${ne>0?`
          <div style="font-size:10px;font-weight:600;color:var(--text);margin-top:auto;line-height:1;">${pe>0?Q(pe):""}</div>
          <div style="height:3px;background:var(--border);border-radius:2px;margin-top:2px;">
            <div style="height:100%;width:${Math.min(oe*100,100)}%;background:${Qe};border-radius:2px;"></div>
          </div>
        `:'<div style="font-size:9px;color:var(--text-disabled);margin-top:auto;">休</div>'}
      </div>
    `)}const C=$.length%7;if(C>0)for(let L=0;L<7-C;L++)$.push('<div style="min-height:44px;"></div>');const S=n?c.get(n):null;n&&s.find(L=>L.date===n);const A=n&&S?(()=>{const L=S,T=parseInt(n.split("-")[2]),M=us(n),j=Math.round(L.utilization*100),z=s.find(O=>O.date===n),W={monthly:"#0F5B8D",november:"#B7791F",annual:"#6B46C1",make_to_order:"#999"},ne={monthly:"月次",november:"11月",annual:"年次",make_to_order:"受注"},pe=L.items.map(O=>`
      <div style="display:flex;align-items:center;gap:8px;padding:8px 0;border-bottom:1px solid var(--border);">
        <span style="width:8px;height:8px;border-radius:50%;background:${W[O.productionType]??"#999"};flex-shrink:0;"></span>
        <div style="flex:1;min-width:0;">
          <div style="font-size:13px;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${O.productName}</div>
          <div style="font-size:11px;color:var(--text-secondary);">${ne[O.productionType]??O.productionType}</div>
        </div>
        <div style="font-size:14px;font-weight:700;white-space:nowrap;">${Q(O.qty)}<span style="font-size:11px;font-weight:400;">本</span></div>
      </div>
    `).join(""),oe=`パート${L.partTimers}人×${ia} + 社員${L.employees}人×${ra} = ${Q(L.capacity)}本`;return`
  ...
  `:"",q=[{color:"#0F5B8D",label:"月次"},{color:"#B7791F",label:"11月"},{color:"#6B46C1",label:"年次"},{color:"#999",label:"受注"}].map(L=>`<span style="display:inline-flex;align-items:center;gap:2px;font-size:10px;">
    ...
    <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;font-size:12px;">
      <span><strong>${Q(Math.round(p))}</strong>本予定</span>
      <span><strong>${Q(Math.round(u))}</strong>本配分${p>0?`（${Math.round(u/p*100)}%）`:""}</span>
      <span><strong>${y}</strong>日稼働</span>
      <span>パ<strong>${v}</strong> 社<strong>${b}</strong>人日</span>
      <span>キャパ<strong>${Q(f)}</strong>本</span>
    </div>
    <div style="font-size:10px;color:var(--text-secondary);margin-bottom:8px;">
      パート: 80本/時×5h=<strong>${ia}</strong>本/人日　社員: 80本/時×3h=<strong>${ra}</strong>本/人日
    </div>
...
${x?.stack??""}</div></section>`}return`
    ...
    ${b}
  `}const Ue={純米大吟醸:"#7c3aed",大吟醸:"#a855f7",純米吟醸:"#2563eb",純米:"#059669",本醸造:"#d97706",普通酒:"#6b7280",リキュール:"#e11d48",その他:"#9ca3af"},ct=["純米大吟醸","大吟醸","純米吟醸","純米","本醸造","普通酒","リキュール","その他"];function ze(e){return e.toLocaleString("ja-JP")}function ye(e){return(e/1e3).toLocaleString("ja-JP",{maximumFractionDigits:1})}function Ia(e){return e<2?"#ef4444":e<=4?"#eab308":"#22c55e"}function Dc(e){return e<2?"要醸造":e<=4?"注意":"余裕あり"}function qc(e){if(e.length===0)return'<div class="chart-empty">出荷データなし</div>';const t=[...new Set(e.map(l=>l.month))].sort(),s=ct.filter(l=>e.some(d=>d.brewCategory===l)),n={};for(const l of e)n[l.month]||(n[l.month]={}),n[l.month][l.brewCategory]=l.shipmentMl;const i=820,r=300,c={top:20,right:20,bottom:50,left:70},p=i-c.left-c.right,u=r-c.top-c.bottom,y=t.map(l=>s.reduce((d,m)=>d+(n[l]?.[m]??0),0)),f=Math.max(...y,1),v=p/t.length,b=Math.max(v-8,14),x=[0,.25,.5,.75,1].map(l=>{const d=c.top+u-u*l,m=f*l/1e3;return`
    ...
    `}).join(""),k=t.map((l,d)=>{let m=c.top+u;const g=c.left+d*v+(v-b)/2,$=s.map(L=>{const T=n[l]?.[L]??0,M=T/f*u;return m-=M,M>0?`<rect x="${g}" y="${m}" width="${b}" height="${M}" fill="${Ue[L]??"#9ca3af"}" opacity="0.85" rx="1"><title>${L}: ${ye(T)}L</title></rect>`:""}).join(""),[w,C]=l.split("-"),S=parseInt(C),A=S===10||d%2===0,q=S===10?`${w}年度`:`${S}月`;return`<g>${$}${A?`<text x="${g+b/2}" y="${r-12}" class="chart-axis centered-axis" style="font-size:10px;">${q}</text>`:""}</g>`}).join(""),o=s.map(l=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
       <span style="display:inline-block;width:10px;height:10px;border-radius:2px;background:${Ue[l]??"#9ca3af"};"></span>
       ${l}
     </span>`).join("");return`
    <div style="overflow-x:auto;">
  ...
  `}function Ic(e){const t=new Map;for(const n of e){const i=n.brewCategory;t.has(i)||t.set(i,{rows:[],totalMl:0,avgMl:0,stockL:0,months:0});const r=t.get(i);r.rows.push(n),r.totalMl+=n.totalShipmentMl,r.avgMl+=n.monthlyAvgMl,r.stockL=n.currentStockL,r.months=n.monthsRemaining}for(const[,n]of t)n.avgMl>0&&(n.months=Math.round(n.stockL*1e3/n.avgMl*10)/10);return`<div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:16px;">${ct.filter(n=>t.has(n)).map(n=>{const i=t.get(n),r=Ue[n]??"#9ca3af",c=Ia(i.months),p=Dc(i.months),u=Math.min(i.months/6*100,100);return`
        <div class="card" style="border-top:3px solid ${r};min-width:220px;flex:1;">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;font-size:12px;margin-bottom:8px;">
            <div><span style="color:#6b7280;">現在庫</span><br><strong>${ze(i.stockL)}L</strong></div>
            <div><span style="color:#6b7280;">月平均移出</span><br><strong>${ye(i.avgMl)}L</strong></div>
          </div>
  ...
  `,n=[];for(const i of ct){const r=t.get(i);if(!r)continue;const c=Ue[i]??"#9ca3af",p=r.length>1,u=r.reduce((l,d)=>l+d.totalShipmentQty,0),y=r.reduce((l,d)=>l+d.totalShipmentMl,0),f=r.reduce((l,d)=>l+d.monthlyAvgQty,0),v=r.reduce((l,d)=>l+d.monthlyAvgMl,0),b=r.reduce((l,d)=>l+d.productCount,0),x=r[0].currentStockL,k=v>0?Math.round(x*1e3/v*10)/10:0,o=Ia(k);if(n.push(`
    ...
    `),p)for(const l of r)n.push(`
          <tr class="sub-row-${i.replace(/[^a-zA-Z0-9]/g,"_")}" style="display:none;font-size:12px;">
            ...
            <td style="text-align:right;">${ze(l.totalShipmentQty)}</td>
            <td style="text-align:right;">${ye(l.totalShipmentMl)}</td>
            <td style="text-align:right;">${ze(l.monthlyAvgQty)}</td>
  ...
  `}function Nc(e){const t=new Map;for(const n of e)t.has(n.brewCategory)||t.set(n.brewCategory,{avgMl:0,stockL:n.currentStockL}),t.get(n.brewCategory).avgMl+=n.monthlyAvgMl;return`
    <div class="card" style="margin-bottom:16px;">
      ...
      ${ct.filter(n=>t.has(n)).map(n=>{const i=t.get(n),r=i.avgMl>0?Math.round(i.stockL*1e3/i.avgMl*10)/10:0,c=Ue[n]??"#9ca3af",p=Ia(r),u=Math.min(r/8*100,100);return`
  ...
  `}function Mc(e,t,s,n){if(e.length===0)return"";const i=[...ct,...s],r=new Map;for(const u of e)r.has(u.brewCategory)||r.set(u.brewCategory,[]),r.get(u.brewCategory).push(u);for(const u of s)r.has(u)||r.set(u,[]);const c=(u,y)=>i.map(f=>`<option value="${f}" ${f===u?"selected":""}>${f}${f===y?"（自動）":""}</option>`).join("");return`
    <div class="card" style="margin-bottom:16px;">
      ...
      ${i.filter(u=>r.has(u)).map(u=>{const y=r.get(u),f=Ue[u]??"#6366f1",v=s.includes(u),b=y.filter(l=>!t.has(l.productCode)),x=b.reduce((l,d)=>l+d.annualMl,0);b.reduce((l,d)=>l+d.annualQty,0);const k=b.reduce((l,d)=>l+d.monthlyAvgMl,0),o=y.map(l=>{const d=t.has(l.productCode),m=l.productCode in n;return`
          <tr style="${d?"opacity:0.4;text-decoration:line-through;":""}">
            ...
            <td style="text-align:right;">${ye(l.annualMl)}</td>
            <td style="text-align:right;">${ye(l.monthlyAvgMl)}</td>
            <td>
        ...
        <div style="margin-bottom:20px;">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;flex-wrap:wrap;">
            ...
            <span style="font-size:12px;color:var(--text-secondary);">
              ${b.length}銘柄 ・ 年間${ye(x)}L ・ 月平均${ye(k)}L
            </span>
          </div>
          ${y.length>0?`
            <div class="table-wrap">
              <table class="data-table" style="font-size:12px;">
                ...
                <tfoot>
                  <tr style="font-weight:600;background:var(--surface-alt);">
                    ...
                    <td style="text-align:right;">${ye(k)}</td>
                    <td></td>
                  </tr>
                </tfoot>
              </table>
  ...
  `}function la(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e4?`${Math.round(e/1e4)}万`:new Intl.NumberFormat("ja-JP").format(e)+"円"}function Rc(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function In(e){return e?Tt.find(t=>t.value===e)?.label??e:""}function jc(e){const t=[],s=[],n=[];for(const i of e){const r=i.amount_last_year_same_month>0?i.amount_this_month/i.amount_last_year_same_month:1,c={code:i.customer_code,name:i.customer_name,businessType:i.business_type,areaCode:i.area_code,phone:i.phone,lastOrderDate:i.last_order_date,daysSinceLastOrder:i.days_since_order,totalAmountLast12m:i.amount_12m,amount3m:i.amount_3m,amountThisMonth:i.amount_this_month,amountLastYearSameMonth:i.amount_last_year_same_month,annualRevenue:i.annual_revenue,yoyRatio:r,status:"dormant"};i.is_at_risk?t.push({...c,status:"at-risk"}):i.is_dormant?s.push({...c,status:"dormant"}):i.amount_last_year_same_month>0&&r<.8&&n.push({...c,status:"declining"})}return t.sort((i,r)=>r.totalAmountLast12m-i.totalAmountLast12m),s.sort((i,r)=>r.daysSinceLastOrder-i.daysSinceLastOrder),n.sort((i,r)=>i.yoyRatio-r.yoyRatio),{atRiskCustomers:t,dormantCustomers:s,decliningCustomers:n}}function Fc(e,t){const s=t?.reason??"",n=Tt.map(i=>`<option value="${i.value}" ${s===i.value?"selected":""}>${i.label}</option>`).join("");return`
    ...
    </tr>`}function Ut(e,t,s,n,i,r,c,p){if(i.length===0)return"";const u=i.map(y=>zc(y,p.get(y.code))).join("");return`
...
<div class="panel">
  ...
  <div style="display:flex;gap:4px;margin-bottom:1.5rem;flex-wrap:wrap">
    ${xe.map((v,b)=>{const x=b===i,k=b===n;return`<button class="button" style="padding:4px 10px;background:${k?"#0F5B8D":x?"#e2e8f0":"transparent"};color:${k?"#fff":"#333"};border:${x&&!k?"2px solid #0F5B8D":"1px solid #cbd5e0"};border-radius:4px;font-size:0.8rem;cursor:pointer" data-action="select-month" data-month="${b}">${v}${x?" ●":""}</button>`}).join("")}
  </div>
  ...
  ${Xc(c)}
      ...
      <span class="status-pill" style="background:${we[i]}15;color:${we[i]};padding:2px 8px;border-radius:9px;font-size:0.75rem">${ca[i]}</span>
        ...
        <td style="padding:4px"><span class="status-pill" style="font-size:0.65rem;padding:1px 5px;background:${we[c.seasonType]}15;color:${we[c.seasonType]}">${ca[c.seasonType]}</span></td>
        ${p}
    ...
    <div class="table-wrap" style="margin-bottom:1rem">
      <h4 style="margin-bottom:0.5rem;display:flex;align-items:center;gap:8px">
        <span class="status-pill" style="background:${we[i]}15;color:${we[i]}">${ca[i]}</span>
    ...
    </div>`}).filter(Boolean);return n.length===0?`<div style="padding:1rem;color:#666;text-align:center">${xe[t]}に提案対象の商品はありません</div>`:n.join("")}function Xc(e){return!e||e.targetCustomers.length===0?`
  ...
  `}function Ht(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function cd(e,t,s){const n=e.rows.map((y,f)=>`
      <tr>
      ...
      <tr>
        <td>
          <select class="input-cell" data-ded-row="${f}" data-ded-field="type">
            ${Object.keys(Zt).map(v=>`<option value="${v}" ${v===y.type?"selected":""}>${Zt[v]}</option>`).join("")}
          </select>
        </td>
        <td>
  ...
  `;const p={id:i,message:e,type:t,el:c};da.push(p),n.appendChild(c),requestAnimationFrame(()=>{c.classList.add("toast-enter")});const u=()=>md(p);c.querySelector(".toast-dismiss").addEventListener("click",u),setTimeout(()=>{c.classList.add("toast-exit"),c.addEventListener("animationend",u,{once:!0})},r)}function md(e){const t=da.indexOf(e);t!==-1&&(da.splice(t,1),e.el.remove())}function yd(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ue(e,t={}){const{title:s="確認",confirmLabel:n="OK",cancelLabel:i="キャンセル",variant:r="primary"}=t;return new Promise(c=>{const p=document.createElement("div");p.className="modal-backdrop confirm-backdrop",p.setAttribute("role","dialog"),p.setAttribute("aria-modal","true"),p.innerHTML=`
      <div class="modal-panel confirm-panel">
        <div class="confirm-body">
          ...
          <h3 class="confirm-title">${_t(s)}</h3>
          <p class="confirm-message">${_t(e)}</p>
        </div>
        <div class="confirm-actions">
          <button class="button secondary confirm-cancel">${_t(i)}</button>
          <button class="button ${r} confirm-ok">${_t(n)}</button>
        </div>
      </div>
