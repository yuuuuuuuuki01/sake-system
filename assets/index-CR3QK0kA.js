...
`,"<br />")}function da(t){const s=[...Object.values(Bt),{id:"custom",season:"カスタム",subject:"",body:""}].map(i=>`
  ...
  `}function f(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function U(t,e){return e.length===0?"":`
  ...
  `}function ua(t,e){const s=[U("得意先",e.customers.map(i=>`
          ...
          >
            ...
            <span class="table-sub mono">${f(i.code)}</span>
          </button>
        ...
        `)),U("伝票",e.documents.map(i=>`
          <button
            ...
            data-path="/invoice"
          >
            <strong>${f(i.documentNo)}</strong>
            <span class="table-sub">${f(i.customerName)} / ${f(i.date)}</span>
          </button>
        `)),U("ページ",e.pages.map(i=>`
          <button
            class="search-result-item"
            ...
            data-path="${f(i.path)}"
          >
            <strong>${f(i.title)}</strong>
            <span class="table-sub mono">${f(i.path)}</span>
          </button>
  ...
  `}function ga(t){return new Date(t.getFullYear(),t.getMonth(),1)}function fa(t,e){return new Date(t.getFullYear(),t.getMonth()+e,1)}function Xt(t,e){const s=new Date(t);return s.setDate(s.getDate()+e),s}function te(t){const e=new Date(t),s=e.getDay();return e.setDate(e.getDate()-s),e.setHours(0,0,0,0),e}function Dt(t){const e=Xt(te(t),6);return e.setHours(23,59,59,999),e}function Nt(t){return new Date(`${t}T00:00:00`)}function At(t){return`${t.getMonth()+1}/${t.getDate()}`}function $a(t){return t.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function ka(){const t=new Date,e=te(fa(ga(t),-3)),s=Dt(new Date(t.getFullYear(),t.getMonth()+4,0)),n=[];let i=new Date(e);for(;i<=s;){const l=Dt(i);n.push({start:new Date(i),end:l,label:`${At(i)} - ${At(l)}`}),i=Xt(i,7)}return n}function Sa(t){const e=ka(),s=`160px repeat(${e.length}, minmax(56px, 1fr))`,n=e.map(l=>`
...
`);return`
  ...
  `}function qa(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function b(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function rt(t){return`
      ...
      <div class="relay-config-list">
        ...
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${b("（未設定：Supabaseダッシュボードから取得してください）")}</span>
          </div>
          <button
            class="button secondary"
            type="button"
