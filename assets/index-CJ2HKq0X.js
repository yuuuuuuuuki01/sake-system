...
`}function ii(e){const t=e.rows.map(i=>{const l=Math.max(0,i.productionVolume+i.previousBalance+i.currentAdjustment-i.exportDeduction-i.sampleDeduction),c=Math.round(l*i.taxRate);return{...i,taxableVolume:l,volume:l,taxAmount:c}}),n=t.reduce((i,l)=>i+l.taxableVolume,0),s=t.reduce((i,l)=>i+l.taxAmount,0);return{...e,rows:t,totalVolume:n,totalTax:s}}async function ri(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>X);return{supabaseInsert:n}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:ts(e),submitted_at:e.submittedAt})}async function La(e){const t=await R("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(n=>({id:h(n,["id"],""),saleDate:h(n,["sale_date"],e),saleTime:h(n,["sale_time"],""),productCode:h(n,["product_code"],""),productName:h(n,["product_name"],""),quantity:C(n,["quantity"],0),unitPrice:C(n,["unit_price"],0),amount:C(n,["amount"],0),paymentMethod:h(n,["payment_method"],"cash")})):[]}async function as(){const e=await R("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:h(t,["id"],""),orderNo:h(t,["order_no"],""),orderDate:ce(t,["order_date"],""),customerName:h(t,["customer_name"],""),postalCode:h(t,["postal_code"],""),address:h(t,["shipping_address"],""),items:[],totalAmount:C(t,["total_amount"],0),status:h(t,["status"],"new"),shippingDate:ce(t,["shipping_date"],"")})):[]}async function Et(e){const t=await We("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function ns(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function li(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await R("print_layouts",t)).map(s=>({id:h(s,["id"],""),name:h(s,["name"],""),templateKey:h(s,["template_key"],""),positions:s.positions??{},isDefault:ue(s,["is_default"],!1),note:h(s,["note"],""),updatedAt:h(s,["updated_at"],"")}))}async function ci(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>X);return{supabaseInsert:i}},void 0),n={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},s=await t("print_layouts",n);return s?{id:h(s,["id"],e.id),name:h(s,["name"],e.name),templateKey:h(s,["template_key"],e.templateKey),positions:s.positions??e.positions,isDefault:ue(s,["is_default"],!1),note:h(s,["note"],""),updatedAt:h(s,["updated_at"],"")}:null}async function di(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const n="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:n,Authorization:`Bearer ${n}`}})).ok}catch{return!1}}async function pi(){return(await R("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),email:h(t,["email"],""),displayName:h(t,["display_name"],""),signature:h(t,["signature"],""),replyTo:h(t,["reply_to"],""),isDefault:ue(t,["is_default"],!1),isVerified:ue(t,["is_verified"],!1),note:h(t,["note"],"")}))}async function ui(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0),n=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return n?{id:h(n,["id"],e.id),name:h(n,["name"],e.name),email:h(n,["email"],e.email),displayName:h(n,["display_name"],""),signature:h(n,["signature"],""),replyTo:h(n,["reply_to"],""),isDefault:ue(n,["is_default"],!1),isVerified:ue(n,["is_verified"],!1)}:null}async function mi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const Da={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},qa={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function yi(e){const t=`${e}-01T00:00:00Z`,[n,s]=e.split("-").map(p=>parseInt(p,10)),i=new Date(n,s,0).getDate(),l=`${e}-${String(i).padStart(2,"0")}T23:59:59Z`;return(await R("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${l})`,order:"starts_at.asc"})).map(p=>({id:h(p,["id"],""),title:h(p,["title"],""),description:h(p,["description"],""),category:h(p,["category"],"general")||"general",startsAt:h(p,["starts_at"],new Date().toISOString()),endsAt:h(p,["ends_at"],""),isAllDay:ue(p,["is_all_day"],!1),location:h(p,["location"],""),attendees:p.attendees??[],relatedCustomerCode:h(p,["related_customer_code"],""),relatedOrderId:h(p,["related_order_id"],""),color:h(p,["color"],""),googleEventId:h(p,["google_event_id"],"")}))}async function hi(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??qa[e.category],updated_at:new Date().toISOString()})?e:null}async function fi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ss(){return(await R("integration_settings",{order:"name.asc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),provider:h(t,["provider"],""),config:t.config??{},isEnabled:ue(t,["is_enabled"],!1),lastSyncAt:h(t,["last_sync_at"],""),lastStatus:h(t,["last_status"],"")}))}async function ht(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function gi(e){const t=e.config.shop_domain,n=e.config.admin_token;if(!t||!n)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const s=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,i=await fetch(s,{headers:{"X-Shopify-Access-Token":n,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const l=await i.json(),{supabaseInsert:c}=await D(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>X);return{supabaseInsert:u}},void 0);let p=0;for(const u of l.orders){const y=`shopify_${u.id}`;await c("shopify_orders",{id:y,shopify_order_id:String(u.id),order_number:String(u.order_number??""),order_date:String(u.created_at??new Date().toISOString()),customer_name:String(u.customer?.first_name??"")+" "+String(u.customer?.last_name??""),customer_email:String(u.customer?.email??""),total_amount:Math.round(parseFloat(String(u.total_price??"0"))),financial_status:String(u.financial_status??""),fulfillment_status:String(u.fulfillment_status??"unfulfilled"),line_items:u.line_items??[],shipping_address:u.shipping_address??null,raw_payload:u}),p++}return await ht({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得成功`}),{count:p}}catch(s){return{count:0,error:s instanceof Error?s.message:String(s)}}}async function vi(){return(await R("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:h(t,["id"],""),shopifyOrderId:h(t,["shopify_order_id"],""),orderNumber:h(t,["order_number"],""),orderDate:h(t,["order_date"],""),customerName:h(t,["customer_name"],""),customerEmail:h(t,["customer_email"],""),totalAmount:te(t.total_amount),financialStatus:h(t,["financial_status"],""),fulfillmentStatus:h(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function bi(e){const t=e.config.refresh_token,n=e.config.client_id,s=e.config.client_secret;if(!t||!n||!s)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:n,client_secret:s})});if(!i.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${i.status}`};const c=(await i.json()).access_token;return await ht({...e,config:{...e.config,oauth_token:c}}),e.config.oauth_token=c,{token:c}}async function $i(e){let t=e.config.oauth_token;const n=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const s=new Date().toISOString(),i=new Date(Date.now()+30*86400*1e3).toISOString(),l=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(n)}/events?timeMin=${s}&timeMax=${i}&singleEvents=true&orderBy=startTime`;let c=await fetch(l,{headers:{Authorization:`Bearer ${t}`}});if(c.status===401){const v=await bi(e);if(v.error)return{count:0,error:v.error};t=v.token,c=await fetch(l,{headers:{Authorization:`Bearer ${t}`}})}if(!c.ok)return{count:0,error:`HTTP ${c.status}`};const p=await c.json(),{supabaseInsert:u}=await D(async()=>{const{supabaseInsert:v}=await Promise.resolve().then(()=>X);return{supabaseInsert:v}},void 0);let y=0;for(const v of p.items){const f=`gcal_${v.id}`,b=v.start?.dateTime??v.start?.date??"",k=v.end?.dateTime??v.end?.date??"";await u("calendar_events",{id:f,title:String(v.summary??"(無題)"),description:String(v.description??""),category:"general",starts_at:String(b),ends_at:String(k),location:String(v.location??""),google_event_id:String(v.id??""),updated_at:new Date().toISOString()}),y++}return await ht({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${y}件取得`}),{count:y}}catch(s){return{count:0,error:s instanceof Error?s.message:String(s)}}}async function wi(){return(await R("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:h(t,["id"],""),receivedAt:h(t,["received_at"],""),senderPhone:h(t,["sender_phone"],""),senderName:h(t,["sender_name"],""),imageUrl:h(t,["image_url"],""),ocrStatus:h(t,["ocr_status"],"pending")||"pending",ocrText:h(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:h(t,["linked_invoice_id"],"")}))}async function xi(e,t){const n=e.config.api_key;if(!n)return{text:"",error:"Cloud Vision API key 未設定"};try{const s=`https://vision.googleapis.com/v1/images:annotate?key=${n}`,i=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return i.ok?{text:(await i.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${i.status}`}}catch(s){return{text:"",error:s instanceof Error?s.message:String(s)}}}async function _i(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Dt={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},qt={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function Si(){return(await R("user_profiles",{order:"display_name.asc"})).map(t=>({id:h(t,["id"],""),email:h(t,["email"],""),displayName:h(t,["display_name"],""),staffCode:h(t,["staff_code"],""),department:h(t,["department"],"all")||"all",role:h(t,["role"],"staff")||"staff",defaultMailSenderId:h(t,["default_mail_sender_id"],""),phone:h(t,["phone"],""),avatarUrl:h(t,["avatar_url"],""),isActive:ue(t,["is_active"],!0),lastSignInAt:h(t,["last_sign_in_at"],""),createdAt:h(t,["created_at"],"")}))}async function ki(e){if(!e)return null;const t=await R("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const n=t[0];return{id:h(n,["id"],""),email:h(n,["email"],""),displayName:h(n,["display_name"],""),staffCode:h(n,["staff_code"],""),department:h(n,["department"],"all")||"all",role:h(n,["role"],"staff")||"staff",defaultMailSenderId:h(n,["default_mail_sender_id"],""),phone:h(n,["phone"],""),avatarUrl:h(n,["avatar_url"],""),isActive:ue(n,["is_active"],!0),lastSignInAt:h(n,["last_sign_in_at"],"")}}async function Pi(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function Ei(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Ci(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>X);return{supabaseInsert:n}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function Ai(e=100){return(await R("audit_logs",{order:"created_at.desc",limit:String(e)})).map(n=>({id:h(n,["id"],""),action:h(n,["action"],""),entityType:h(n,["entity_type"],""),entityId:h(n,["entity_id"],""),userEmail:h(n,["user_email"],""),changes:n.changes??{},createdAt:h(n,["created_at"],"")}))}const It={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function os(){return(await R("slack_notifications",{order:"event_type.asc"})).map(t=>({id:h(t,["id"],""),eventType:h(t,["event_type"],"new_order"),enabled:ue(t,["enabled"],!0),channel:h(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:h(t,["last_triggered_at"],"")}))}async function Li(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function Di(e=50){return(await R("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(n=>({id:h(n,["id"],""),eventType:h(n,["event_type"],""),channel:h(n,["channel"],""),message:h(n,["message"],""),status:h(n,["status"],"sent"),error:h(n,["error"],""),sentAt:h(n,["sent_at"],"")}))}async function qi(e,t,n){const i=(await ss()).find(y=>y.provider==="slack");if(!i||!i.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const l=i.config.webhook_url;if(!l)return{ok:!1,error:"Webhook URL未設定"};const p=(await os()).find(y=>y.eventType===e&&y.enabled);if(!p)return{ok:!1,error:"通知ルールが無効"};const u=n??p.channel??i.config.default_channel??"#general";try{const y=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${It[e]} ${t}`,channel:u})}),v=y.ok,{supabaseInsert:f}=await D(async()=>{const{supabaseInsert:b}=await Promise.resolve().then(()=>X);return{supabaseInsert:b}},void 0);return await f("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:u,message:t,status:v?"sent":"failed",error:v?null:`HTTP ${y.status}`}),v?{ok:!0}:{ok:!1,error:`HTTP ${y.status}`}}catch(y){return{ok:!1,error:y instanceof Error?y.message:String(y)}}}const jt={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Ia={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function Ii(){return(await R("prospects",{order:"updated_at.desc"})).map(t=>({id:h(t,["id"],""),companyName:h(t,["company_name"],""),contactName:h(t,["contact_name"],""),email:h(t,["email"],""),phone:h(t,["phone"],""),address:h(t,["address"],""),website:h(t,["website"],""),businessType:h(t,["business_type"],""),stage:h(t,["stage"],"cold"),source:h(t,["source"],""),expectedAmount:te(t.expected_amount),probability:te(t.probability),assignedStaffCode:h(t,["assigned_staff_code"],""),nextActionDate:h(t,["next_action_date"],""),nextAction:h(t,["next_action"],""),note:h(t,["note"],""),lastContactAt:h(t,["last_contact_at"],""),wonAt:h(t,["won_at"],""),lostAt:h(t,["lost_at"],""),lostReason:h(t,["lost_reason"],""),convertedCustomerCode:h(t,["converted_customer_code"],""),createdAt:h(t,["created_at"],"")}))}async function is(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function Ti(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Ni(e){return(await R("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(n=>({id:h(n,["id"],""),prospectId:h(n,["prospect_id"],""),activityType:h(n,["activity_type"],"call"),title:h(n,["title"],""),description:h(n,["description"],""),activityDate:h(n,["activity_date"],""),result:h(n,["result"],""),staffCode:h(n,["staff_code"],"")}))}async function Mi(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const rs=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function Oi(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function Ri(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const n=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return n.searchParams.set("id",`eq.${e}`),(await fetch(n.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function ji(){return(await pe("v_customer_map")).filter(t=>t.lat&&t.lng).map(t=>({customerCode:h(t,["customer_code"],""),name:h(t,["name"],""),phone:h(t,["phone"],""),areaCode:h(t,["area_code"],""),businessType:h(t,["business_type"],""),businessTypeName:h(t,["business_type_name"],""),address1:h(t,["address1"],""),lat:Number(t.lat),lng:Number(t.lng),isAtRisk:ue(t,["is_at_risk"],!1),isDormant:ue(t,["is_dormant"],!1),amount12m:C(t,["amount_12m"],0),daysSinceOrder:t.days_since_order!=null?Number(t.days_since_order):null}))}const zt=[{value:"price",label:"価格が高い"},{value:"competitor",label:"競合に切り替え"},{value:"closed",label:"廃業・閉店"},{value:"contact",label:"担当者交代"},{value:"seasonal",label:"季節要因"},{value:"pause",label:"一時的な休止"},{value:"complaint",label:"クレーム・不満"},{value:"unreachable",label:"連絡が取れない"},{value:"other",label:"その他"}];async function zi(){return(await pe("customer_churn_notes")).map(t=>({customerCode:h(t,["customer_code"],""),reason:h(t,["reason"],""),memo:h(t,["memo"],""),actionedAt:t.actioned_at?String(t.actioned_at):null,updatedAt:h(t,["updated_at"],"")}))}async function Bi(e){const{supabaseUpsert:t}=await D(async()=>{const{supabaseUpsert:n}=await Promise.resolve().then(()=>X);return{supabaseUpsert:n}},void 0);await t("customer_churn_notes",{customer_code:e.customerCode,reason:e.reason,memo:e.memo,actioned_at:e.actionedAt||null,updated_at:new Date().toISOString()},"customer_code")}async function Fi(){return(await R("delivery_locations",{order:"name.asc"})).map(t=>({id:h(t,["id"],""),customerCode:h(t,["customer_code"],""),name:h(t,["name"],""),postalCode:h(t,["postal_code"],""),address:h(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:h(t,["contact_name"],""),phone:h(t,["phone"],""),deliveryNote:h(t,["delivery_note"],""),isActive:ue(t,["is_active"],!0)}))}async function Vi(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function Yi(e=50){return(await R("call_logs",{order:"started_at.desc",limit:String(e)})).map(n=>({id:h(n,["id"],""),callDirection:h(n,["call_direction"],"inbound"),fromNumber:h(n,["from_number"],""),toNumber:h(n,["to_number"],""),matchedCustomerCode:h(n,["matched_customer_code"],""),matchedProspectId:h(n,["matched_prospect_id"],""),durationSeconds:te(n.duration_seconds),callStatus:h(n,["call_status"],"answered"),recordingUrl:h(n,["recording_url"],""),transcript:h(n,["transcript"],""),ivryCallId:h(n,["ivry_call_id"],""),startedAt:h(n,["started_at"],""),endedAt:h(n,["ended_at"],""),notes:h(n,["notes"],"")}))}async function ls(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function Ji(e){const t=e.config.api_key,n=e.config.team_id;if(!t||!n)return{count:0,error:"IVRy API key または team_id 未設定"};try{const s=`https://api.ivry.jp/v1/teams/${n}/calls?limit=100`,i=await fetch(s,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const c=(await i.json()).calls??[];let p=0;for(const u of c)await ls({id:`ivry_${u.id}`,callDirection:String(u.direction??"inbound"),fromNumber:String(u.from??""),toNumber:String(u.to??""),durationSeconds:Number(u.duration??0),callStatus:String(u.status??"answered"),recordingUrl:String(u.recording_url??""),startedAt:String(u.started_at??""),endedAt:String(u.ended_at??""),ivryCallId:String(u.id??"")}),p++;return await ht({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得`}),{count:p}}catch(s){return{count:0,error:s instanceof Error?s.message:String(s)}}}async function Ui(e,t){const n=e.config.api_key,s=e.config.team_id;if(!n||!s)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let i=0;for(const l of t){if(!l.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${s}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({name:l.name,phone_number:l.phone,external_id:l.customerCode??"",note:l.note??""})})).ok&&i++}return{synced:i}}catch(i){return{synced:0,error:i instanceof Error?i.message:String(i)}}}async function Qi(){return(await R("lead_lists",{order:"created_at.desc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),query:h(t,["query"],""),area:h(t,["area"],""),businessType:h(t,["business_type"],""),totalCount:te(t.total_count),source:h(t,["source"],"manual"),createdAt:h(t,["created_at"],"")}))}async function Hi(e){return(await R("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(n=>({id:h(n,["id"],""),listId:h(n,["list_id"],""),companyName:h(n,["company_name"],""),address:h(n,["address"],""),phone:h(n,["phone"],""),website:h(n,["website"],""),email:h(n,["email"],""),businessType:h(n,["business_type"],""),rating:n.rating?Number(n.rating):void 0,reviewCount:te(n.review_count),lat:n.lat?Number(n.lat):void 0,lng:n.lng?Number(n.lng):void 0,placeId:h(n,["place_id"],""),status:h(n,["status"],"new"),convertedProspectId:h(n,["converted_prospect_id"],""),note:h(n,["note"],"")}))}async function Gi(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function cs(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function Xi(e,t,n){const s=e.config.api_key;if(!s)return{results:[],error:"Google Maps API key 未設定"};const i=`${t} ${n}`.trim(),l=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(i)}&language=ja&key=${s}`;try{const c=await fetch(l);if(!c.ok)return{results:[],error:`HTTP ${c.status}`};const p=await c.json();return p.status!=="OK"&&p.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${p.status}`}:{results:p.results.map(y=>{const v=y.geometry?.location;return{id:`place_${y.place_id}`,listId:"",companyName:String(y.name??""),address:String(y.formatted_address??""),rating:y.rating?Number(y.rating):void 0,reviewCount:y.user_ratings_total?Number(y.user_ratings_total):void 0,lat:v?.lat,lng:v?.lng,placeId:String(y.place_id??""),status:"new"}})}}catch(c){return{results:[],error:c instanceof Error?c.message:String(c)}}}async function Ki(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},n=await is(t);return n&&await cs({...e,status:"imported",convertedProspectId:t.id}),n}async function Wi(){return(await R("workflow_orders",{order:"order_date.desc"})).map(t=>({id:h(t,["id"],""),orderNo:h(t,["order_no"],""),customerName:h(t,["customer_name"],""),customerCode:h(t,["customer_code"],""),orderDate:h(t,["order_date"],""),deliveryDate:h(t,["delivery_date"],""),stage:h(t,["stage"],"new"),totalAmount:te(t.total_amount),itemCount:te(t.item_count),priority:h(t,["priority"],"normal"),staffName:h(t,["staff_name"],""),notes:h(t,["notes"],"")}))}async function Zi(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function er(){return(await R("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),email:h(t,["email"],""),phone:h(t,["phone"],""),visitDate:h(t,["visit_date"],""),partySize:te(t.party_size)||1,language:h(t,["language"],"ja"),purpose:h(t,["purpose"],""),message:h(t,["message"],""),status:h(t,["status"],"new"),repliedAt:h(t,["replied_at"],""),confirmedTime:h(t,["confirmed_time"],""),createdAt:h(t,["created_at"],new Date().toISOString())}))}async function tr(e){const{supabaseInsert:t}=await D(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>X);return{supabaseInsert:s}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const ar=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function ds(){return(await Promise.all(ar.map(async t=>{const[n,s]=await Promise.all([$a(t.table),R(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:n,lastSyncAt:s[0]?._synced_at??null}}))).sort((t,n)=>n.rowCount-t.rowCount)}async function Ct(e,t,n=100){const s=(t-1)*n,[i,l]=await Promise.all([R(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(n),offset:String(s)}),$a(e)]);return{records:i,total:l}}async function ra(e){const t=await R("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const n=t[0].memo;if(typeof n=="string"&&n)try{const s=JSON.parse(n);return String(s.price_group??"")}catch{return""}return""}async function ps(e,t){if(e){const s=await R("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(s.length>0&&s[0].special_price)return te(s[0].special_price)}const n=await R("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return n.length>0&&n[0].default_sale_price?te(n[0].default_sale_price):0}const nr=[{code:"SAK001",name:"純米大吟醸　金井"},{code:"SAK002",name:"純米吟醸　金井"},{code:"SAK003",name:"本醸造　金井"},{code:"SAK004",name:"純米酒　金井"}],sr=[1.6,.7,1.3,1.2,.9,.7,.6,.7,.9,1,1.1,1.5],or={SAK001:80,SAK002:150,SAK003:220,SAK004:180};function ir(){const e=new Date,t=[];for(let u=11;u>=0;u--){const y=new Date(e.getFullYear(),e.getMonth()-u,1);t.push(`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`)}const n=nr,s={},i={};for(const u of n){s[u.code]={};for(const y of t){const v=parseInt(y.split("-")[1])-1,f=or[u.code]??100,b=Math.round(f*sr[v]*(.85+Math.random()*.3));s[u.code][y]=b,i[y]=(i[y]??0)+b}}const l={},c={},p={};for(const u of n){const y=t.map(b=>s[u.code][b]??0),v=y.reduce((b,k)=>b+k,0)/y.length,f=y.reduce((b,k)=>b+(k-v)**2,0)/y.length;l[u.code]=y.reduce((b,k)=>b+k,0),c[u.code]=v,p[u.code]=Math.sqrt(f)}return{months:t,products:n,matrix:s,totals:i,productTotals:l,productAvg:c,productStdDev:p}}async function rr(e=36){const t=(()=>{const b=new Date;return b.setMonth(b.getMonth()-e),`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}`})(),n=await pe("product_monthly_sales",{select:"year_month,product_code,product_name,quantity",year_month:`gte.${t}`,order:"year_month.asc"});if(n.length===0)return ir();const s=new Set,i=new Map,l={},c={};for(const b of n){const k=h(b,["year_month"],""),P=h(b,["product_code"],""),o=h(b,["product_name"],P),r=C(b,["quantity"],0);!k||!P||(s.add(k),i.set(P,o),l[P]||(l[P]={}),l[P][k]=r,c[k]=(c[k]??0)+r)}const p=[...s].sort(),u=[...i.entries()].map(([b,k])=>({code:b,name:k})),y={},v={},f={};for(const b of u){const k=p.map(r=>l[b.code]?.[r]??0),P=k.reduce((r,d)=>r+d,0)/(k.length||1),o=k.reduce((r,d)=>r+(d-P)**2,0)/(k.length||1);y[b.code]=k.reduce((r,d)=>r+d,0),v[b.code]=P,f[b.code]=Math.sqrt(o)}return{months:p,products:u,matrix:l,totals:c,productTotals:y,productAvg:v,productStdDev:f}}async function lr(){return(await R("product_safety_stock_params",{order:"product_code.asc"})).map(t=>({productCode:h(t,["product_code"],""),productName:h(t,["product_name"],""),unit:h(t,["unit"],"本"),avgMonthlyDemand:C(t,["avg_monthly_demand"],0),demandStdDev:C(t,["demand_std_dev"],0),leadTimeDays:C(t,["lead_time_days"],30),serviceLevel:C(t,["service_level"],.95),safetyStockQty:C(t,["safety_stock_qty"],0),reorderPoint:C(t,["reorder_point"],0),memo:h(t,["memo"],""),productionType:h(t,["production_type"],"monthly")}))}async function cr(e){return(await R("production_plan",{year_month:`eq.${e}`,order:"product_code.asc"})).map(n=>({id:h(n,["id"],""),yearMonth:h(n,["year_month"],e),productCode:h(n,["product_code"],""),productName:h(n,["product_name"],""),demandForecast:C(n,["demand_forecast"],0),safetyStockTarget:C(n,["safety_stock_target"],0),openingStock:C(n,["opening_stock"],0),requiredProduction:C(n,["required_production"],0),plannedQty:C(n,["planned_qty"],0),actualQty:C(n,["actual_qty"],0),status:h(n,["status"],"draft"),productionType:h(n,["production_type"],"monthly"),notes:h(n,["notes"],"")}))}async function dr(e){const{SUPABASE_URL:t,SUPABASE_ANON_KEY:n}=await D(async()=>{const{SUPABASE_URL:s,SUPABASE_ANON_KEY:i}=await Promise.resolve().then(()=>X);return{SUPABASE_URL:s,SUPABASE_ANON_KEY:i}},void 0);if(!n||e.length===0)return!1;try{const s=e.map(c=>({product_code:c.productCode,product_name:c.productName,unit:c.unit,avg_monthly_demand:c.avgMonthlyDemand,demand_std_dev:c.demandStdDev,lead_time_days:c.leadTimeDays,service_level:c.serviceLevel,safety_stock_qty:c.safetyStockQty,reorder_point:c.reorderPoint,production_type:c.productionType,memo:c.memo,last_calc_at:new Date().toISOString(),updated_at:new Date().toISOString()})),i=new URL("/rest/v1/product_safety_stock_params",t),l=await fetch(i.toString(),{method:"POST",headers:{apikey:n,Authorization:`Bearer ${n}`,"Content-Type":"application/json",Prefer:"return=minimal,resolution=merge-duplicates"},body:JSON.stringify(s)});if(!l.ok){const c=await l.text();return console.error("saveSafetyStockParamsBulk failed:",l.status,c),!1}return!0}catch(s){return console.error("saveSafetyStockParamsBulk error:",s),!1}}async function pr(e){const{supabaseUpsert:t}=await D(async()=>{const{supabaseUpsert:s}=await Promise.resolve().then(()=>X);return{supabaseUpsert:s}},void 0);return await t("production_plan",{...e.id?{id:e.id}:{},year_month:e.yearMonth,product_code:e.productCode,product_name:e.productName,demand_forecast:e.demandForecast,safety_stock_target:e.safetyStockTarget,opening_stock:e.openingStock,required_production:e.requiredProduction,planned_qty:e.plannedQty,actual_qty:e.actualQty,status:e.status,production_type:e.productionType,notes:e.notes,updated_at:new Date().toISOString()})!==null}function ur(e){if(!e)return"不明";const t=e.replace(/^.+?[都道府県]/,""),n=t.match(/^(.+?郡.+?[町村]|.+?[市区町村])/);return n?n[1]:t.substring(0,6)}async function mr(e){const[t,n]=e.split("-").map(Number),s=`${e}-01`,i=new Date(t,n,0).getDate(),l=`${e}-${String(i).padStart(2,"0")}`,c=await pe("sales_document_headers",{select:"sales_date,customer_name,legacy_customer_code,total_amount",and:`(sales_date.gte.${s},sales_date.lte.${l})`,order:"sales_date.asc"}),p=await pe("customers",{select:"id,address1",address1:"not.is.null"}),u={};for(const v of p)v.address1&&(u[v.id]=ur(v.address1));const y={};for(const v of c){const f=v.sales_date;if(!f)continue;const b=u[v.legacy_customer_code]||"住所未登録",k=Number(v.total_amount)||0;y[f]||(y[f]={date:f,entries:[],cityGroups:[],totalAmount:0,count:0}),y[f].entries.push({customerCode:v.legacy_customer_code||"",customerName:v.customer_name||"",city:b,amount:k}),y[f].totalAmount+=k,y[f].count++}for(const v of Object.values(y)){const f={};for(const b of v.entries)f[b.city]=(f[b.city]||0)+1;v.cityGroups=Object.entries(f).sort((b,k)=>k[1]-b[1]).map(([b,k])=>({city:b,count:k}))}return y}async function Ta(){return R("quotes",{select:"id,quote_no,quote_date,valid_until,customer_name,subject,total_amount,template_type,status,created_at",order:"quote_date.desc,created_at.desc",limit:"200"})}async function us(e){const t=await R("quotes",{select:"*",id:`eq.${e}`});if(!t[0])return null;const n=await R("quote_lines",{select:"*",quote_id:`eq.${e}`,order:"line_no.asc"});return{...t[0],lines:n}}async function yr(){const e=new Date().toISOString().slice(0,7)+"-01";return pe("sales_document_headers",{select:"legacy_document_no,sales_date,customer_name,legacy_customer_code,total_amount",sales_date:`gte.${e}`,order:"sales_date.asc"})}const N=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:qa,CALENDAR_CATEGORY_LABELS:Da,CHURN_REASONS:zt,DEPT_LABELS:qt,INVOICE_TYPE_LABELS:na,JIKOMI_STATUS_LABELS:Un,MATERIAL_CATEGORIES:rs,PROSPECT_STAGE_COLORS:Ia,PROSPECT_STAGE_LABELS:jt,ROLE_LABELS:Dt,SEASONAL_TEMPLATES:xa,SLACK_EVENT_LABELS:It,TAX_DEDUCTION_LABELS:ia,TAX_RATE_CATEGORIES:es,addBrewingCustomCategory:Ro,addBrewingStockEntry:To,convertLeadToProspect:Ki,deleteBrewingCustomCategory:zo,deleteBrewingStockEntry:Mo,deleteCalendarEvent:fi,deleteMailSender:mi,deleteMaterial:Ri,deletePrintLayout:di,deleteProspect:Ti,deleteUserProfile:Ei,fetchAllBrewingStockEntries:Io,fetchAnalyticsByPeriod:ro,fetchAnnouncements:zn,fetchAuditLogs:Ai,fetchAvailablePeriods:lo,fetchAvailableProductionTypes:Eo,fetchBillList:Wn,fetchBillingSummary:Ea,fetchBrewingAlcoholSettings:Co,fetchBrewingCategoryOverrides:Fo,fetchBrewingCustomCategories:Oo,fetchBrewingMonthlyTrend:bo,fetchBrewingPlanSummary:vo,fetchBrewingProductDetail:$o,fetchBrewingSchedule:wo,fetchBrewingSeasonalPattern:Do,fetchBrewingStockEntries:qo,fetchBrewingYearlyShipments:Lo,fetchCalendarEvents:yi,fetchCallLogs:Yi,fetchCategoryTypeLinks:So,fetchChurnAlerts:Xo,fetchChurnNotes:zi,fetchCustomerAnalysis:Jn,fetchCustomerEfficiency:ti,fetchCustomerEfficiencyByYear:ct,fetchCustomerLedger:Sa,fetchCustomerPriceGroup:ra,fetchCustomerPricing:sa,fetchCustomerProductBreakdown:ho,fetchDeliveryLocations:Fi,fetchDeliveryNote:Pa,fetchDeliverySchedule:Go,fetchDemandAnalysis:rr,fetchDemandForecasts:Ho,fetchEntityMonthlySales:go,fetchFaxInbox:wi,fetchIntegrationSettings:ss,fetchInvoices:mt,fetchJikomiList:Qn,fetchKenteiList:Gn,fetchLabelExclusions:Vo,fetchLeadItems:Hi,fetchLeadLists:Qi,fetchMailSenders:pi,fetchMapCustomers:ji,fetchMasterStats:_a,fetchMaterialList:oa,fetchMyProfile:ki,fetchOrderHeaders:yr,fetchPayableList:Kn,fetchPaymentStatus:Tn,fetchPeriodChartData:mo,fetchPipelineMeta:Nn,fetchPrintLayouts:li,fetchProductABC:ai,fetchProductCustomerBreakdown:fo,fetchProductDaily:ei,fetchProductMonthlyShipments:Qo,fetchProductPower:Yn,fetchProductPrice:ps,fetchProductShipmentsFromTable:Zo,fetchProductionPlan:cr,fetchProspectActivities:Ni,fetchProspects:Ii,fetchPurchaseList:Xn,fetchQuoteList:Ta,fetchQuoteWithLines:us,fetchRawMaterialStock:Zn,fetchRawRecords:Ct,fetchRawTableList:ds,fetchSafetyStockParams:lr,fetchSalesAnalytics:ka,fetchSalesReport:Rt,fetchSalesSummary:In,fetchSeasonalProfiles:Wo,fetchShipmentCalendar:mr,fetchShopifyOrders:vi,fetchSlackLogs:Di,fetchSlackRules:os,fetchStaffCustomerBreakdown:po,fetchStaffProductBreakdown:uo,fetchStaffTotalsByPeriod:co,fetchStoreOrders:as,fetchStoreSales:La,fetchSyncDashboard:Mn,fetchSystemSetting:qn,fetchTankList:Hn,fetchTaxDeclaration:Aa,fetchTourInquiriesFromDb:er,fetchTypesInCategory:jo,fetchUserProfiles:Si,fetchVisitPriorities:Ko,fetchWorkflowOrdersFromDb:Wi,generateTaxCSV:oi,generateTaxXML:ts,linkTypeToCategory:ko,ocrFaxImage:xi,periodToDateRange:On,prevYearFilter:yo,reassignBrewingStockEntry:No,recalculateTaxDeclaration:ii,recordAudit:Ci,resolveProductPrice:Ca,saveBrewingAlcoholSetting:Ao,saveBrewingSchedule:xo,saveCalendarEvent:hi,saveCallLog:ls,saveChurnNote:Bi,saveDeliveryLocation:Vi,saveEmailCampaign:Et,saveFaxRecord:_i,saveIntegrationSetting:ht,saveInvoice:jn,saveLabelExclusions:Yo,saveLeadItem:cs,saveLeadList:Gi,saveMailSender:ui,saveMaterial:Oi,savePrintLayout:ci,saveProductionPlan:pr,saveProspect:is,saveProspectActivity:Mi,saveSafetyStockParamsBulk:dr,saveSlackRule:Li,saveTaxDeclaration:ri,saveTourInquiry:tr,saveUserProfile:Pi,saveWorkflowOrder:Zi,searchPlaces:Xi,sendEmailCampaign:ns,sendSlackNotification:qi,setBrewingCategoryOverride:Bo,submitFeatureRequest:Bn,syncGoogleCalendar:$i,syncIvryCallLogs:Ji,syncPhoneBookToIvry:Ui,syncShopifyOrders:gi,unlinkTypeFromCategory:Po,updateCustomer:Fn,updateProduct:Vn,upsertBrewingStock:_o,upsertSystemSetting:Qe},Symbol.toStringTag,{value:"Module"}));function Fe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const hr={open:"未締め",closed:"締め済"};function fr(e,t){const n=e.customers.map(s=>`
  ...
  `}function Dr(e,t,n,s,i="month",l,c=[]){const p={success:"正常",warning:"注意",error:"異常",running:"実行中"},u=Vt(e.allDailySales,i,l),y=u.reduce((j,F)=>j+F.amount,0),v=u.reduce((j,F)=>j+F.bottles,0),f=u.reduce((j,F)=>j+F.volumeMl,0),b=u.length,k=v>0?Math.round(y/v):0,P=f>0?Math.round(y/(f/1e3)):0,o=new Date,r=o.toISOString().slice(0,10),d=r.slice(0,7),m=Vt(e.allDailySales,"month").filter(j=>j.date.slice(0,10)<=r),g=m.reduce((j,F)=>j+F.amount,0);m.reduce((j,F)=>j+F.bottles,0);const $=o.getDate();new Date(o.getFullYear(),o.getMonth()+1,0).getDate();const S=(s?.orderHeaders??[]).filter(j=>j.sales_date.slice(0,7)===d),_=S.reduce((j,F)=>j+Number(F.total_amount),0),E=S.length,A=Vt(e.allDailySales,"month"),q=A.reduce((j,F)=>j+F.bottles,0),M=_>0?_:A.reduce((j,F)=>j+F.amount,0),L=_>0?"orders":"extrapolation",O=(u.length>0?e.allDailySales.filter(j=>{const F=u[0]?.date??"",U=u[u.length-1]?.date??"",ie=Xa(F,-1),me=Xa(U,-1);return j.date>=ie&&j.date<=me}):[]).reduce((j,F)=>j+F.amount,0),V=O>0?(y-O)/O*100:0,z=V>0?"+":"",H=e.salesRecords.slice(0,10).map(j=>`
            <tr>
          ...
          `).join(""),B=["today","month","future","90days","year","all"].map(j=>`<button class="button ${j===i?"primary":"secondary"} small" type="button" data-period="${j}">${gt[j]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card">
        ...
        <p class="kpi-value" style="color:${V>=0?"#2f855a":"#c53d3d"}">${O>0?`${z}${V.toFixed(1)}%`:"―"}</p>
        <p class="kpi-sub">前年同期 ${O>0?ve(O):"データなし"}</p>
      </article>
...
`,"<br />")}function Or(e){const n=[...Object.values(xa),{id:"custom",season:"カスタム",subject:"",body:""}].map(i=>`
        <button
  ...
  `}function xe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function vt(e,t){return t.length===0?"":`
  ...
  `}function Rr(e,t){const n=[vt("得意先",t.customers.map(i=>`
          <button
            ...
            data-path="/master"
          >
            <strong>${xe(i.name)}</strong>
            <span class="table-sub mono">${xe(i.code)}</span>
          </button>
        ...
        `)),vt("伝票",t.documents.map(i=>`
          <button
            ...
            data-path="/invoice"
          >
            <strong>${xe(i.documentNo)}</strong>
            <span class="table-sub">${xe(i.customerName)} / ${xe(i.date)}</span>
          </button>
        `)),vt("ページ",t.pages.map(i=>`
          <button
            ...
            data-path="${xe(i.path)}"
          >
            <strong>${xe(i.title)}</strong>
            <span class="table-sub mono">${xe(i.path)}</span>
          </button>
...
`}function ws(e,t){const n=e.lines.reduce((P,o)=>P+o.amount,0),s=Math.round(n*e.taxRate/100),i=n+s,l=e.templateType==="sake",c=l?'<th style="width:90px;">JANコード</th><th style="width:40px;">入数</th><th style="width:70px;">希望小売価格</th>':"",p=l?9:6,u=e.lines.map((P,o)=>{const r=l?`<td style="font-size:9px;">${Y(P.janCode)}</td><td style="text-align:center;">${P.caseQty??""}</td><td style="text-align:right;">${P.retailPrice!=null?$e(P.retailPrice):""}</td>`:"";return`<tr>
      ...
      <td style="text-align:right;">${$e(P.unitPrice)}</td>
  ...
  `:"",f=t.sealImageDataUrl?`<img src="${t.sealImageDataUrl}" style="width:${t.sealSize}px;height:${t.sealSize}px;opacity:0.9;flex-shrink:0;" />`:"",b=[];e.validUntil&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">有効期限</div><div class="q-cond-value">${Wa(e.validUntil)}</div></div>`),e.paymentTerms&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">支払条件</div><div class="q-cond-value">${Y(e.paymentTerms)}</div></div>`),e.deliveryDate&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">納期</div><div class="q-cond-value">${Y(e.deliveryDate)}</div></div>`),e.deliveryPlace&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">納品場所</div><div class="q-cond-value">${Y(e.deliveryPlace)}</div></div>`);const k=b.length>0?`<div class="q-cond-grid" style="grid-template-columns:repeat(${Math.min(b.length,4)},1fr);">${b.join("")}</div>`:"";return`
<div class="q-doc">
  <!-- タイトル行: 左=御見積書、右=見積番号・日付（右寄せ） -->
  ...
  ${v}
</div>`}function xs(e,t,n,s,i,l,c){const p=e.lines.reduce((P,o)=>P+o.amount,0),u=Math.round(p*e.taxRate/100),y=p+u,v=e.templateType==="sake",f=s.length>=1?t.filter(P=>P.name.includes(s)||P.code.includes(s)).slice(0,8):[],b=i.length>=1?n.filter(P=>P.name.includes(i)||P.code.includes(i)).slice(0,8):[];if(e.previewMode){const P=c.accentColor||"#0968e5";return`
    ...
    `:"";return`<tr>
      ...
      <td class="numeric">${$e(P.amount)}</td>
          ...
          <tbody>
            ${Xe(P,c,{rank:"rank",name:"name",amount:"amount",sharePct:"sharePct",qty:"qty",growthRate:"growthRate"}).slice(0,100).map(m=>`
              <tr>
                ...
                <td class="numeric">${_s(m.amount)}</td>
  ...
  `}function ll(e){return new Date(e.getFullYear(),e.getMonth(),1)}function cl(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function Ps(e,t){const n=new Date(e);return n.setDate(n.getDate()+t),n}function Es(e){const t=new Date(e),n=t.getDay();return t.setDate(t.getDate()-n),t.setHours(0,0,0,0),t}function Za(e){const t=Ps(Es(e),6);return t.setHours(23,59,59,999),t}function en(e){return new Date(`${e}T00:00:00`)}function tn(e){return`${e.getMonth()+1}/${e.getDate()}`}function dl(e){return e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function pl(){const e=new Date,t=Es(cl(ll(e),-3)),n=Za(new Date(e.getFullYear(),e.getMonth()+4,0)),s=[];let i=new Date(t);for(;i<=n;){const l=Za(i);s.push({start:new Date(i),end:l,label:`${tn(i)} - ${tn(l)}`}),i=Ps(i,7)}return s}function ul(e){const t=pl(),n=`160px repeat(${t.length}, minmax(56px, 1fr))`,s=t.map(l=>`
      ...
      `).join(""),i=e.length?e.map(l=>{const c=en(l.startDate),p=en(l.expectedDoneDate),u=Math.max(0,t.findIndex(f=>f.end>=c)),y=Math.max(u,t.reduce((f,b,k)=>b.start<=p?k:f,u)),v=[`仕込番号: ${l.jikomiNo}`,`銘柄: ${l.productName}`,`期間: ${l.startDate} - ${l.expectedDoneDate}`,`タンク: ${l.tankNo}`,`備考: ${l.note||"なし"}`].join(`
`);return`
  ...
  `}function ca(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function $l(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function wl(e){return e.map(t=>`
      ...
      `).join("")}function wt(e){return e?`¥${e.toLocaleString("ja-JP")}`:"―"}function xl(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${ca(t.name,20)}</td>
          <td>${t.kanaName||""}</td>
      ...
      `).join("")}function _l(e,t,n=Na,s=[]){const{filtered:i,paged:l,totalPages:c}=vl(e.customers,n);return`
    <section class="page-head">
      <div>
      ...
      `:`
        <div class="table-wrap">
          <table>
            ...
            <tbody>${xl(Xe(e.products,s,{code:"code",name:"name",category:"category",alcoholDegree:"alcoholDegree",volumeMl:"volumeMl",purchasePrice:"purchasePrice",salePrice:"salePrice",listPrice:"listPrice"}))}</tbody>
          </table>
        </div>
      `}
    </section>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function Cs(e,t,n="all",s="",i=[],l=[],c="",p="",u=null,y="all",v="",f=[],b=[],k=[],P=null,o=[],r=[],d="amount",m="calendar"){const g=t==="products"?"商品別集計":t==="customers"?"得意先別集計":"担当別集計",$=t==="products"?e.productTotals:t==="customers"?e.customerTotals:e.staffTotals,S=n!=="all"&&i.length>0&&t!=="staff"?i:$,_=Xe(S,k,jl),E={all:"月別",yearly:"月別推移",monthly:"日別推移",weekly:"日別推移",daily:"当日"},A=rn[d],q=G=>d==="quantity"?G.quantity:d==="volume"?G.volumeMl:G.amount,M=G=>d==="quantity"?`${G.toLocaleString()}本`:d==="volume"?Bt(G):Ke(G);let L,T=[],O,V,z;if(P&&P.monthlySales.length>0)L=P.monthlySales.slice(-24).map(G=>({month:G.month,amount:q(G)})),O=`${P.name} の月別${A}`,V=`${P.tab==="customers"?"得意先":"商品"}: ${P.code}`,z="#0968e5";else if(o.length>0&&n!=="all"){L=o.map(J=>({month:J.month,amount:q(J)})),T=r.map(J=>({month:J.month,amount:q(J)}));const G=L.reduce((J,W)=>J+W.amount,0),Z=T.reduce((J,W)=>J+W.amount,0),de=Z>0?(G-Z)/Z*100:0,ke=de>0?"+":"";O=`${E[n]} ${A}（${s}）`,V=`${M(G)}${Z>0?` / 前年比 ${ke}${de.toFixed(1)}%`:""}`,z="#2f855a"}else{L=Bl(e.monthlySales,d,m).curr,T=[];const Z=L.reduce((ke,J)=>ke+J.amount,0);O=`${m==="fiscal"?"決算年度別":"暦年別"}${A}`,V=`累計 ${M(Z)}（${L.length}${m==="fiscal"?"期":"年"}）`,z="#0F5B8D"}const H=["amount","quantity","volume"].map(G=>`<button class="tab-button ${G===d?"active":""}" data-chart-metric="${G}">${rn[G]}</button>`).join(""),B=["all","yearly","monthly","weekly","daily"].map(G=>`<button class="button ${G===n?"primary":"secondary"} small" type="button" data-analytics-period="${G}">${ln[G]}</button>`).join(""),j=m==="fiscal"&&n==="yearly"?Fl(e.monthlySales):l,F=m==="fiscal"&&n==="yearly"&&!j.includes(s)?j[0]??"":s,U=n!=="all"&&j.length>0&&t!=="staff"?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
        ${j.map(G=>`<option value="${G}" ${G===F?"selected":""}>${m==="fiscal"&&n==="yearly"?G+"年度":G}</option>`).join("")}
      </select>`:"";let ie="",me="";if(t==="staff"){const G=["all","yearly","monthly","weekly","daily"].map(W=>`<button class="button ${W===y?"primary":"secondary"} small" type="button" data-staff-period="${W}">${ln[W]}</button>`).join(""),Z=y!=="all"&&f.length>0?`<select id="staff-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
          ${f.map(W=>`<option value="${W}" ${W===v?"selected":""}>${W}</option>`).join("")}
        </select>`:"",ke=(b.length>0?b:e.staffTotals).filter(W=>!c||W.name.includes(c)||W.code.includes(c)),J=y!=="all"&&v?` (${v})`:"";if(ie=`
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${ke.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':ke.map(W=>`
                <tr>
                  <td class="mono">${W.code||"―"}</td>
                  <td>${W.name||"未設定"}</td>
                  <td class="numeric">${Ke(W.amount)}</td>
                  <td class="numeric">${W.quantity.toLocaleString("ja-JP")}</td>
                  <td class="numeric">${W.documents.toLocaleString("ja-JP")}</td>
                  <td><button class="button secondary small" data-staff-drilldown="${W.code}" data-staff-name="${W.name}">詳細</button></td>
                </tr>
              `).join("")}
          </tbody>
        </table>
      </div>
    `,u){const W=u.breakdownTab,qe=y!=="all"&&v?`<span style="font-size:12px;color:var(--text-secondary);margin-left:8px;">${v}</span>`:"";me=`
        <article class="panel" style="margin-top:16px;">
          ...
          <div style="display:flex;gap:8px;align-items:center;margin-bottom:12px;flex-wrap:wrap;">
            <div class="tab-group">
              <button class="tab-button ${W==="customers"?"active":""}" data-staff-breakdown-tab="customers">得意先別</button>
              <button class="tab-button ${W==="products"?"active":""}" data-staff-breakdown-tab="products">商品別</button>
            </div>
          ...
          ${W==="customers"?cn(u.customerRows,p,"得意先名"):cn(u.productRows,p,"商品名")}
        </article>
      `}}return`
    <section class="page-head">
      <div>
...
金井酒造店`;function pc(e,t){const n=t?e.find(i=>i.id===t):null,s=t==="__new__";return`
    ...
    ${n||s?`
      ...
      `:""}
  `}function uc(e,t,n,s){const[i,l]=t.split("-").map(w=>parseInt(w,10)),c=new Date(i,l-1,1),p=new Date(i,l,0),u=c.getDay(),y=p.getDate(),v=[];for(let w=0;w<u;w++)v.push({isOutside:!0});for(let w=1;w<=y;w++)v.push({date:new Date(i,l-1,w)});for(;v.length%7!==0;)v.push({isOutside:!0});const f=n?e.filter(w=>w.category===n):e,b={};f.forEach(w=>{const S=w.startsAt.slice(0,10);b[S]??=[],b[S].push(w)});const k=new Date().toISOString().slice(0,10),P=v.map(w=>{if(w.isOutside)return'<div class="cal-cell cal-outside"></div>';const S=w.date,_=`${S.getFullYear()}-${String(S.getMonth()+1).padStart(2,"0")}-${String(S.getDate()).padStart(2,"0")}`,E=b[_]??[],A=_===k,q=S.getDay();return`
        <div class="cal-cell ${A?"cal-today":""} ${q===0?"cal-sun":q===6?"cal-sat":""}"
             data-cal-date="${_}">
          <div class="cal-day-num">${S.getDate()}</div>
          <div class="cal-events">
            ...
            `).join("")}
            ${E.length>3?`<button class="cal-event-more" data-cal-date="${_}">+${E.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),o=s?.isOpen?mc(s):"",r=new Date(i,l-2,1),d=new Date(i,l,1),m=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`,g=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}`,$=(()=>{const w=new Date;return`${w.getFullYear()}-${String(w.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(Da).map(([w,S])=>`<option value="${w}" ${n===w?"selected":""}>${S}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
  ...
  `}function $c(e){const t=e.prospects.reduce((l,c)=>l+c.expectedAmount,0),n=e.prospects.reduce((l,c)=>l+c.expectedAmount*c.probability/100,0),s=e.prospects.filter(l=>l.stage==="won").length,i=e.prospects.filter(l=>l.stage==="hot"||l.stage==="negotiating").length;return`
    ...
    ${e.viewMode==="kanban"?wc(e.prospects):xc(e.prospects)}
  ...
  `}const fn={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},Cc={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},Ac={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function ye(e){return"¥"+e.toLocaleString("ja-JP")}function ut(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function As(e,t){const n=e.reduce((l,c)=>l+c.amount,0),s=Math.floor(n*t),i=n+s;return{subtotal:n,taxAmount:s,total:i}}const ae={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function se(e,t){const n=e.align??"left",s=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${n}`,`font-size:${s}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function Gt(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),n=t.getFullYear(),s=n-2018;return{y:s>0?String(s).padStart(2,"0"):String(n).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function Lc(e,t,n){const s=Gt(e.documentDate),i=Gt(e.orderDate??e.documentDate),l=Gt(e.deliveryDate??e.documentDate),c=e.lines.slice(0,6).map((r,d)=>{const m=ae.detailStartY+d*ae.detailRowH,g=ae.detailCols,$=[],w=(S,_)=>{_&&$.push(se({...S,y:m,x:S.x+0},_))};return w(g.productName,r.productName+(r.spec?` ${r.spec}`:"")),w(g.productCode,r.productCode),w(g.color,r.color??""),w(g.size,[r.size,r.caseQty?`×${r.caseQty}`:""].filter(Boolean).join(" ")),w(g.unit,r.unit),w(g.quantity,r.quantity>0?r.quantity.toLocaleString("ja-JP"):""),w(g.correctedQty,r.correctedQuantity?r.correctedQuantity.toLocaleString("ja-JP"):""),w(g.discount,r.discount?r.discount.toLocaleString("ja-JP"):""),w(g.unitPrice,r.unitPrice>0?r.unitPrice.toLocaleString("ja-JP"):""),w(g.costAmount,r.amount>0?r.amount.toLocaleString("ja-JP"):""),w(g.retailPrice,r.retailPrice?r.retailPrice.toLocaleString("ja-JP"):""),w(g.note,r.receivedAmount?r.receivedAmount.toLocaleString("ja-JP"):""),$.join("")}).join(""),p=e.lines.reduce((r,d)=>r+(d.amount||0),0),u=e.lines.reduce((r,d)=>r+(d.retailPrice||0)*(d.correctedQuantity??d.quantity),0),y=e.lines.reduce((r,d)=>r+(d.receivedAmount||0),0),v=e.lines.reduce((r,d)=>r+(d.returnAmount||0),0),f=e.lines.reduce((r,d)=>r+d.quantity,0),b=n.showReferenceOverlay?`background-image: url('${n.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",k=n.calibrationOffsetX||0,P=n.calibrationOffsetY||0,o=`transform: translate(${k}mm, ${P}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${b}">
        ...
        ${se(ae.totalQty,f.toLocaleString("ja-JP"))}
...
`}async function Is(e,t){const{supabaseInsert:n}=await D(async()=>{const{supabaseInsert:p}=await Promise.resolve().then(()=>X);return{supabaseInsert:p}},void 0);let s=0,i=0;const c={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const p of t){if(!p._valid)continue;const{_valid:u,_error:y,...v}=p,f={...v};if(!f.id){const b=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";f.id=String(v[b]??`${e}-${Date.now()}-${s+i}`)}for(const b of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof f[b]=="string"&&f[b]!==""){const k=Number(f[b]);Number.isFinite(k)&&(f[b]=k)}try{await n(c,f)!==null?s++:i++}catch{i++}}return{inserted:s,failed:i}}const Mc=Object.freeze(Object.defineProperty({__proto__:null,generateTemplateCSV:qs,importToSupabase:Is,parseCSV:Ls,validateImport:Ds},Symbol.toStringTag,{value:"Module"}));function Xt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function Oc(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function Rc(e,t,n,s,i){const l=n.reduce((y,v)=>y+v.rowCount,0),c=n.map(y=>y.lastSyncAt).filter(y=>y!==null).sort().reverse()[0]??null,p=100,u=Math.max(1,Math.ceil(i/p));return`
    ...
    `}
  `}const Ze=400,et=240;function K(e){return e.toLocaleString("ja-JP")}function Kt(e){const[t,n]=e.split("-");return`${t.slice(2)}/${n}`}function jc(e,t){return!e||e.column!==t?'<span style="opacity:0.3;margin-left:2px;">⇅</span>':e.dir==="asc"?'<span style="margin-left:2px;">↑</span>':'<span style="margin-left:2px;">↓</span>'}function Se(e,t,n,s=""){return`<th class="${s}" style="cursor:pointer;user-select:none;white-space:nowrap;"
    data-action="demand-sort" data-sort-col="${t}">${e}${jc(n,t)}</th>`}function rt(e){return e>=.99?2.33:e>=.97?1.88:e>=.95?1.65:e>=.9?1.28:1.04}function zc(e){const{months:t,matrix:n}=e;if(t.length===0||e.products.length===0)return'<div class="chart-empty">データなし</div>';const s=e.products.slice().sort((d,m)=>(e.productTotals[m.code]??0)-(e.productTotals[d.code]??0)).slice(0,6),i=["#0F5B8D","#2F855A","#B7791F","#C53D3D","#6B46C1","#2B6CB0"],l=820,c=280,p={top:20,right:20,bottom:40,left:60},u=l-p.left-p.right,y=c-p.top-p.bottom,v=t.map(d=>s.reduce((m,g)=>m+(n[g.code]?.[d]??0),0)),f=Math.max(...v,1),b=u/t.length,k=Math.max(b-10,14),P=[0,.25,.5,.75,1].map(d=>{const m=p.top+y-y*d,g=`${Math.round(f*d/100)*100}`;return`
      <line x1="${p.left}" y1="${m}" x2="${l-p.right}" y2="${m}" class="chart-grid" />
      <text x="6" y="${m+4}" class="chart-axis">${Number(g).toLocaleString("ja-JP")}</text>
    `}).join(""),o=t.map((d,m)=>{let g=p.top+y;const $=p.left+m*b+(b-k)/2,w=s.map((M,L)=>{const O=(n[M.code]?.[d]??0)/f*y;return g-=O,`<rect x="${$}" y="${g}" width="${k}" height="${O}" fill="${i[L%i.length]}" opacity="0.85" rx="${L===s.length-1?3:0}" />`}).join(""),[S,_]=d.split("-"),E=parseInt(_),A=E===1||m%3===0,q=E===1?`${S.slice(2)}年`:`${E}月`;return`<g>${w}${A?`<text x="${$+k/2}" y="${c-10}" class="chart-axis centered-axis">${q}</text>`:""}</g>`}).join(""),r=s.map((d,m)=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}function Bc(e){const{months:t,products:n}=e,s=n.slice().sort((c,p)=>(e.productTotals[p.code]??0)-(e.productTotals[c.code]??0)).slice(0,50),i=t.map(c=>{const[p,u]=c.split("-"),y=parseInt(u);return`<th class="numeric" style="min-width:52px;white-space:nowrap;">${y===1?`${p.slice(2)}年1月`:`${y}月`}</th>`}).join(""),l=s.map(c=>{const p=t.map(u=>{const y=e.matrix[c.code]?.[u]??0;return`<td class="numeric">${y>0?K(y):"—"}</td>`}).join("");return`
      <tr>
        <td class="mono">${c.code}</td>
        <td style="white-space:nowrap;">${c.name}</td>
        ${p}
        <td class="numeric"><strong>${K(e.productTotals[c.code]??0)}</strong></td>
        <td class="numeric">${K(Math.round(e.productAvg[c.code]??0))}</td>
        <td class="numeric">${K(Math.round(e.productStdDev[c.code]??0))}</td>
      </tr>
    `}).join("");return`
  ...
  `}function Vc(e,t){const s=e.slice().sort((l,c)=>{if(!t)return 0;const p=t.dir==="asc"?1:-1;switch(t.column){case"ss-name":return p*l.productName.localeCompare(c.productName,"ja");case"ss-avg":return p*(l.avgMonthlyDemand-c.avgMonthlyDemand);case"ss-std":return p*(l.demandStdDev-c.demandStdDev);case"ss-ss":{const u=Math.ceil(rt(l.serviceLevel)*l.demandStdDev*Math.sqrt(l.leadTimeDays/30)),y=Math.ceil(rt(c.serviceLevel)*c.demandStdDev*Math.sqrt(c.leadTimeDays/30));return p*(u-y)}case"ss-rop":{const u=Math.ceil(l.avgMonthlyDemand*(l.leadTimeDays/30)+rt(l.serviceLevel)*l.demandStdDev*Math.sqrt(l.leadTimeDays/30)),y=Math.ceil(c.avgMonthlyDemand*(c.leadTimeDays/30)+rt(c.serviceLevel)*c.demandStdDev*Math.sqrt(c.leadTimeDays/30));return p*(u-y)}default:return 0}}).map(l=>{const c=rt(l.serviceLevel),p=l.leadTimeDays/30,u=Math.ceil(c*l.demandStdDev*Math.sqrt(p)),y=Math.ceil(l.avgMonthlyDemand*p+u),v=u-l.safetyStockQty,f=v>0?"text-danger":v<-u*.3?"text-warning":"",b=[.9,.95,.99].map(k=>`<option value="${k}" ${Math.abs(l.serviceLevel-k)<.01?"selected":""}>${(k*100).toFixed(0)}%</option>`).join("");return`
      <tr>
        ...
        <td class="numeric"><strong>${K(u)}</strong></td>
        <td class="numeric">${K(y)}</td>
        <td class="numeric ${f}">
          ${v>0?`+${K(v)}`:K(v)}
  ...
  `}const Yc={monthly:"月次",annual:"年次",make_to_order:"受注生産",november:"11月生産"};function Jc(e,t,n,s){const i={draft:"下書き",confirmed:"確定",actual:"実績入力済"},l={draft:"neutral",confirmed:"info",actual:"success"},c=_=>Object.entries(Yc).map(([E,A])=>`<option value="${E}" ${E===_?"selected":""}>${A}</option>`).join(""),p=640,u=_=>_.map(E=>{const A=Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock),q=E.plannedQty>0?E.plannedQty:Math.round(A),M=q>0?Math.ceil(q/p*10)/10:0,L=E.plannedQty>0?(E.actualQty-E.plannedQty)/E.plannedQty*100:null,T=L!==null?L>=0?"text-success":"text-danger":"";return`
      <tr>
        ...
        <td class="numeric">${K(Math.round(E.demandForecast))}</td>
        <td class="numeric">${K(Math.round(E.safetyStockTarget))}</td>
        <td class="numeric">${K(Math.round(E.openingStock))}</td>
        <td class="numeric"><strong>${K(Math.round(A))}</strong></td>
        <td>
        ...
        <td class="numeric">${E.actualQty>0?K(E.actualQty):"—"}</td>
        <td class="numeric ${T}">
    ...
    `}).join(""),v=(n==="all"?e:e.filter(_=>_.productionType===n)).slice().sort((_,E)=>{if(!s)return 0;const A=s.dir==="asc"?1:-1,q=Math.max(0,_.demandForecast+_.safetyStockTarget-_.openingStock),M=Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock);switch(s.column){case"plan-name":return A*_.productName.localeCompare(E.productName,"ja");case"plan-forecast":return A*(_.demandForecast-E.demandForecast);case"plan-required":return A*(q-M);case"plan-planned":return A*(_.plannedQty-E.plannedQty);case"plan-actual":return A*(_.actualQty-E.actualQty);case"plan-label":{const L=_.plannedQty>0?_.plannedQty:Math.round(q),T=E.plannedQty>0?E.plannedQty:Math.round(M);return A*(L-T)}default:return 0}}),f=u(v),b=[{key:"all",label:"全て"},{key:"monthly",label:"月次"},{key:"annual",label:"年次"},{key:"november",label:"11月生産"},{key:"make_to_order",label:"受注生産"}],k=_=>{const A=(_==="all"?e:e.filter(q=>q.productionType===_)).reduce((q,M)=>{const L=Math.max(0,M.demandForecast+M.safetyStockTarget-M.openingStock);return q+(M.plannedQty>0?M.plannedQty:Math.round(L))},0);return Math.ceil(A/p*10)/10},P=b.filter(_=>_.key!=="all").map(_=>{const E=k(_.key),A=e.filter(M=>M.productionType===_.key).length,q=_.key==="make_to_order"?e.filter(M=>M.productionType==="make_to_order"&&M.plannedQty>0).length:null;return`
      <div style="background:var(--surface-alt);border-radius:8px;padding:12px 16px;min-width:130px;">
        <p style="font-size:11px;color:var(--text-secondary);margin:0 0 4px;">${_.label}</p>
    ...
    `}).join(""),o=v.reduce((_,E)=>_+E.demandForecast,0),r=v.reduce((_,E)=>_+Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock),0),d=v.reduce((_,E)=>_+E.plannedQty,0),m=v.reduce((_,E)=>_+E.actualQty,0),g=k(n),$=new Date,w=Array.from({length:24},(_,E)=>{const A=new Date($.getFullYear(),$.getMonth()-6+E,1),q=`${A.getFullYear()}-${String(A.getMonth()+1).padStart(2,"0")}`;return`<option value="${q}" ${q===t?"selected":""}>${q.replace("-","年")}月</option>`}).join(""),S=b.map(_=>`<button class="button ${n===_.key?"primary":"secondary"}" type="button"
       data-action="plan-type-filter" data-filter="${_.key}"
       style="padding:4px 12px;font-size:13px;">${_.label}</button>`).join("");return`
    ...
    <section class="panel">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;padding:0 0 12px;">${S}</div>
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            ...
            ${v.length>0?`
              <tr style="background:var(--surface-alt);font-weight:700;">
                <td>合計</td>
                <td>—</td>
                <td class="numeric">${K(Math.round(o))}</td>
                <td class="numeric">—</td>
                <td class="numeric">—</td>
                <td class="numeric">${K(Math.round(r))}</td>
                <td class="numeric">${K(d)}</td>
                <td class="numeric">${m>0?K(m):"—"}</td>
                <td class="numeric">—</td>
  ...
  `}function Ts(e){const[t,n]=e.split("-").map(Number),s=new Date(t,n,0).getDate();return Array.from({length:s},(i,l)=>{const c=l+1;return`${e}-${String(c).padStart(2,"0")}`})}function gn(e){const t=new Date(e).getDay();return["日","月","火","水","木","金","土"][t]}function vn(e){const t=new Date(e).getDay();return t===0||t===6}function Uc(e,t){return e.partTimers*t.partCapacity+e.employees*t.empCapacity}function Ns(e){return e.partTimers+e.employees}function Pe(e,t,n={partCapacity:Ze,empCapacity:et}){const s=e.filter(v=>v.partTimers>0||v.employees>0);if(s.length===0)return;const i=t.reduce((v,f)=>{const b=f.plannedQty>0?f.plannedQty:Math.max(0,f.demandForecast+f.safetyStockTarget-f.openingStock);return v+b},0);if(i<=0)return;const l=i/s.length;let c=0,p=0,u=1/0;const y=Math.ceil(l/n.partCapacity);for(let v=0;v<=y;v++){const f=l-v*n.partCapacity,b=f>0?Math.ceil(f/n.empCapacity):0,k=v+b;k<u&&(u=k,c=v,p=b)}for(const v of e)v.confirmed||(v.partTimers>0||v.employees>0)&&(v.partTimers=c,v.employees=p)}function Qc(e,t,n={partCapacity:Ze,empCapacity:et}){const s=t.filter(p=>Ns(p)>0).map(p=>p.date).sort();if(s.length===0)return t.map(p=>({date:p.date,partTimers:p.partTimers,employees:p.employees,confirmed:p.confirmed,capacity:0,items:[],totalQty:0,utilization:0}));const i={monthly:0,november:1,annual:2,make_to_order:3},l=e.filter(p=>p.plannedQty>0||Math.max(0,p.demandForecast+p.safetyStockTarget-p.openingStock)>0).map(p=>({productCode:p.productCode,productName:p.productName,productionType:p.productionType,remaining:p.plannedQty>0?p.plannedQty:Math.max(0,p.demandForecast+p.safetyStockTarget-p.openingStock)})).filter(p=>p.remaining>0).sort((p,u)=>(i[p.productionType]??99)-(i[u.productionType]??99)||u.remaining-p.remaining),c=new Map;for(const p of t){const u=Uc(p,n);c.set(p.date,{date:p.date,partTimers:p.partTimers,employees:p.employees,confirmed:p.confirmed,capacity:u,items:[],totalQty:0,utilization:0})}for(const p of l){let u=p.remaining;if(u<=0)continue;if(s.reduce((v,f)=>{const b=c.get(f);return v+Math.max(0,b.capacity-b.totalQty)},0)<=0)break;for(const v of s){if(u<=0)break;const f=c.get(v),b=Math.max(0,f.capacity-f.totalQty);if(b<=0)continue;const k=Math.min(u,b);f.items.push({productCode:p.productCode,productName:p.productName,productionType:p.productionType,qty:k}),f.totalQty+=k,f.utilization=f.capacity>0?f.totalQty/f.capacity:0,u-=k}}return t.map(p=>c.get(p.date))}function Lt(e,t=1,n=1){return Ts(e).map(s=>({date:s,partTimers:vn(s)?0:t,employees:vn(s)?0:n,confirmed:!1}))}function Hc(e,t,n,s=null,i=new Set,l={partCapacity:Ze,empCapacity:et}){const c=Ts(t),p=e.filter(L=>!i.has(L.productCode)),u=Qc(p,n,l),y=new Map(u.map(L=>[L.date,L])),v=p.reduce((L,T)=>L+(T.plannedQty>0?T.plannedQty:Math.max(0,T.demandForecast+T.safetyStockTarget-T.openingStock)),0),b=e.reduce((L,T)=>L+(T.plannedQty>0?T.plannedQty:Math.max(0,T.demandForecast+T.safetyStockTarget-T.openingStock)),0)-v,k=u.reduce((L,T)=>L+T.totalQty,0),P=n.filter(L=>Ns(L)>0).length,o=u.reduce((L,T)=>L+T.capacity,0),r=n.reduce((L,T)=>L+T.partTimers,0),d=n.reduce((L,T)=>L+T.employees,0),m=P>0?Math.ceil(v/P):0,g=new Date,$=Array.from({length:24},(L,T)=>{const O=new Date(g.getFullYear(),g.getMonth()-6+T,1),V=`${O.getFullYear()}-${String(O.getMonth()+1).padStart(2,"0")}`;return`<option value="${V}" ${V===t?"selected":""}>${V.replace("-","年")}月</option>`}).join(""),w=new Date(c[0]).getDay(),S=[];for(let L=0;L<w;L++)S.push('<div style="min-height:44px;"></div>');for(const L of c){const T=y.get(L),O=new Date(L).getDay(),V=parseInt(L.split("-")[2]),z=T?.partTimers??0,H=T?.employees??0,B=z+H,j=T?.totalQty??0,F=T?.utilization??0,U=L===s,ie=B===0?"var(--surface-alt)":F>.95?"rgba(197,61,61,0.12)":F>.7?"rgba(183,121,31,0.10)":F>0?"rgba(47,133,90,0.08)":"var(--surface)",me=B===0?"transparent":F>.95?"#c53d3d":F>.7?"#b7791f":F>0?"#2f855a":"var(--border)",G=O===0?"#c53d3d":O===6?"#0F5B8D":"var(--text)",Z=B>0?`<span style="font-size:8px;color:var(--text-secondary);line-height:1;">${z>0?`パ${z}`:""}${H>0?`社${H}`:""}</span>`:"";S.push(`
      <div data-action="cal-toggle-day" data-date="${L}"
        style="min-height:44px;padding:3px;border:${U?"2px solid #0F5B8D":"1px solid var(--border)"};border-radius:6px;
          background:${ie};cursor:pointer;display:flex;flex-direction:column;
          ${U?"box-shadow:0 0 0 2px rgba(15,91,141,0.2);":""}">
        <div style="display:flex;justify-content:space-between;align-items:center;">
          <span style="font-size:12px;font-weight:600;color:${G};line-height:1;">${V}</span>
          ${Z}
        </div>
        ${B>0?`
          <div style="font-size:10px;font-weight:600;color:var(--text);margin-top:auto;line-height:1;">${j>0?K(j):""}</div>
          <div style="height:3px;background:var(--border);border-radius:2px;margin-top:2px;">
            <div style="height:100%;width:${Math.min(F*100,100)}%;background:${me};border-radius:2px;"></div>
          </div>
        `:'<div style="font-size:9px;color:var(--text-disabled);margin-top:auto;">休</div>'}
      </div>
    `)}const E=S.length%7;if(E>0)for(let L=0;L<7-E;L++)S.push('<div style="min-height:44px;"></div>');const A=s?y.get(s):null;s&&n.find(L=>L.date===s);const q=s&&A?(()=>{const L=A,T=parseInt(s.split("-")[2]),O=gn(s),V=Math.round(L.utilization*100),z=n.find(J=>J.date===s),H=s===new Date().toISOString().slice(0,10),B={monthly:"#0F5B8D",november:"#B7791F",annual:"#6B46C1",make_to_order:"#999"},j={monthly:"月次",november:"11月",annual:"年次",make_to_order:"受注"},F=L.items.map(J=>`
      <div style="display:flex;align-items:center;gap:8px;padding:10px 0;border-bottom:1px solid var(--border);">
        ...
        <div style="font-size:16px;font-weight:700;white-space:nowrap;">${K(J.qty)}<span style="font-size:12px;font-weight:400;">本</span></div>
      </div>
    `).join(""),U=`パ${L.partTimers}×${l.partCapacity} 社${L.employees}×${l.empCapacity} = ${K(L.capacity)}本`,ie=L.totalQty>0?Math.ceil(L.totalQty/l.partCapacity):0,me=[];if(L.totalQty>0)for(let J=0;J<=ie;J++){const W=L.totalQty-J*l.partCapacity;if(W<=0){me.push({p:J,e:0});break}const qe=Math.ceil(W/l.empCapacity);me.push({p:J,e:qe})}const G=L.totalQty-L.capacity,Z=L.totalQty===0?"":G>0?`<span style="color:#c53d3d;font-weight:600;">⚠ ${K(G)}本 不足</span>`:'<span style="color:#2f855a;">✓ キャパ内</span>',de=me.filter(J=>J.p+J.e>0).sort((J,W)=>J.p+J.e-(W.p+W.e)).slice(0,3),ke=L.totalQty>0?`
      <div style="background:var(--surface-alt);border-radius:6px;padding:10px 12px;margin:0 4px 8px;">
        <div style="font-size:12px;font-weight:600;margin-bottom:6px;">
          ${K(L.totalQty)}本を収めるには ${Z}
        </div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
          ${de.map((J,W)=>{const qe=J.p===L.partTimers&&J.e===L.employees;return`<button data-action="cal-apply-pattern" data-date="${s}" data-part="${J.p}" data-emp="${J.e}"
              ...
              <span style="color:var(--text-secondary);margin-left:2px;">${K(J.p*l.partCapacity+J.e*l.empCapacity)}本</span>
            </button>`}).join("")}
        </div>
      </div>
    `:"";return`
      <section class="panel" style="margin-top:12px;border:2px solid ${H?"#2f855a":"#0F5B8D"};">
        <div style="padding:12px 16px 8px;${H?"background:rgba(47,133,90,0.06);":""}">
          ...
          <div style="font-size:12px;color:var(--text-secondary);">${U} ・ 稼働率${V}%</div>
          ${L.totalQty>0?`<div style="font-size:20px;font-weight:700;margin-top:6px;">${K(L.totalQty)}<span style="font-size:13px;font-weight:400;">本</span> <span style="font-size:13px;font-weight:400;">/ ${L.items.length}品</span></div>`:""}
        </div>
        ${ke}
  ...
  `:"",M=[{color:"#0F5B8D",label:"月次"},{color:"#B7791F",label:"11月"},{color:"#6B46C1",label:"年次"},{color:"#999",label:"受注"}].map(L=>`<span style="display:inline-flex;align-items:center;gap:2px;font-size:10px;">
    ...
    <div style="background:var(--surface-alt);border-radius:8px;padding:10px 14px;margin-bottom:12px;font-size:12px;line-height:1.8;">
      <div><strong>${K(Math.round(v))}</strong>本 ÷ <strong>${P}</strong>稼働日 = 日当たり<strong>${K(m)}</strong>本</div>
      <div>→ パ<strong>${r}</strong> 社<strong>${d}</strong>人日 ・ キャパ<strong>${K(o)}</strong>本
        ${k<v?` <span style="color:#c53d3d;">（${K(Math.round(v-k))}本 未配分）</span>`:' <span style="color:#2f855a;">✓ 全量配分済</span>'}
      </div>
    ...
    <section class="panel" style="margin-top:12px;" id="cal-label-section">
      <div class="panel-header" style="padding-bottom:4px;">
        <div>
          ...
          <p class="panel-caption">区分ごとにまとめて外す or 個別に外せます${i.size>0?`（<strong>${i.size}</strong>品除外中 = ${K(Math.round(b))}本）`:""}</p>
        </div>
      ...
      <div id="cal-label-list" style="max-height:500px;overflow-y:auto;">
        ${(()=>{const L=[{key:"monthly",label:"月次",color:"#0F5B8D"},{key:"november",label:"11月生産",color:"#B7791F"},{key:"annual",label:"年次",color:"#6B46C1"},{key:"make_to_order",label:"受注生産",color:"#999"}],T=new Map;for(const O of e){if((O.plannedQty>0?O.plannedQty:Math.max(0,O.demandForecast+O.safetyStockTarget-O.openingStock))<=0)continue;const z=O.productionType||"monthly";T.has(z)||T.set(z,[]),T.get(z).push(O)}return L.filter(O=>T.has(O.key)).map(O=>{const V=T.get(O.key),z=V.reduce((U,ie)=>U+(ie.plannedQty>0?ie.plannedQty:Math.max(0,ie.demandForecast+ie.safetyStockTarget-ie.openingStock)),0),H=V.filter(U=>i.has(U.productCode)).length,B=H===V.length,j=H===0,F=V.map(U=>{const ie=U.plannedQty>0?U.plannedQty:Math.max(0,U.demandForecast+U.safetyStockTarget-U.openingStock),me=i.has(U.productCode);return`
                <div style="display:flex;align-items:center;gap:8px;padding:7px 4px 7px 28px;border-bottom:1px solid var(--border);${me?"opacity:0.4;":""}">
                  ...
                  <div style="flex:1;min-width:0;">
                    <div style="font-size:13px;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;${me?"text-decoration:line-through;":""}">${U.productName}</div>
                  </div>
                  <div style="font-size:13px;font-weight:600;flex-shrink:0;">${K(Math.round(ie))}</div>
                </div>
              `}).join("");return`
              <div style="border-bottom:2px solid var(--border);">
                <div style="display:flex;align-items:center;gap:8px;padding:10px 4px;background:var(--surface-alt);position:sticky;top:0;z-index:1;">
                  ...
                  <div style="flex:1;font-size:13px;font-weight:600;">${O.label}<span style="font-weight:400;color:var(--text-secondary);margin-left:6px;">${V.length}品 ${K(Math.round(z))}本</span></div>
                  ${H>0&&!B?`<span style="font-size:11px;color:#b7791f;">${H}品除外</span>`:""}
...
${o?.stack??""}</div></section>`}return`
    ...
    ${P}
  `}const Be={純米大吟醸:"#7c3aed",大吟醸:"#a855f7",純米吟醸:"#2563eb",純米:"#059669",本醸造:"#d97706",普通酒:"#6b7280",リキュール:"#e11d48",その他:"#9ca3af"},Ae=["純米大吟醸","大吟醸","純米吟醸","純米","本醸造","普通酒","リキュール","その他"];function ne(e){return e.toLocaleString("ja-JP")}function re(e){return(e/1e3).toLocaleString("ja-JP",{maximumFractionDigits:1})}function Oa(e){return e<2?"#ef4444":e<=4?"#eab308":"#22c55e"}function Xc(e){return e<2?"要醸造":e<=4?"注意":"余裕あり"}function Ra(e){return"bc-"+encodeURIComponent(e).replace(/%/g,"-")}function Kc(e){if(e.length===0)return'<div class="chart-empty">出荷データなし</div>';const t=[...new Set(e.map(r=>r.month))].sort(),n=Ae.filter(r=>e.some(d=>d.brewCategory===r)),s={};for(const r of e)s[r.month]||(s[r.month]={}),s[r.month][r.brewCategory]=r.shipmentMl;const i=820,l=300,c={top:20,right:20,bottom:50,left:70},p=i-c.left-c.right,u=l-c.top-c.bottom,y=t.map(r=>n.reduce((d,m)=>d+(s[r]?.[m]??0),0)),v=Math.max(...y,1),f=p/t.length,b=Math.max(f-8,14),k=[0,.25,.5,.75,1].map(r=>{const d=c.top+u-u*r,m=v*r/1e3;return`
    ...
    `}).join(""),P=t.map((r,d)=>{let m=c.top+u;const g=c.left+d*f+(f-b)/2,$=n.map(q=>{const M=s[r]?.[q]??0,L=M/v*u;return m-=L,L>0?`<rect x="${g}" y="${m}" width="${b}" height="${L}" fill="${Be[q]??"#9ca3af"}" opacity="0.85" rx="1"><title>${q}: ${re(M)}L</title></rect>`:""}).join(""),[w,S]=r.split("-"),_=parseInt(S),E=_===10||d%2===0,A=_===10?`${w}年度`:`${_}月`;return`<g>${$}${E?`<text x="${g+b/2}" y="${l-12}" class="chart-axis centered-axis" style="font-size:10px;">${A}</text>`:""}</g>`}).join(""),o=n.map(r=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}function Wc(e,t,n,s){const i=new Map;for(const p of e){const u=p.brewCategory;i.has(u)||i.set(u,{rows:[],totalMl:0,avgMl:0,stockL:0});const y=i.get(u);y.rows.push(p),y.totalMl+=p.totalShipmentMl,y.avgMl+=p.monthlyAvgMl,y.stockL=p.currentStockL}const l=new Map;for(const p of t)l.has(p.brewCategory)||l.set(p.brewCategory,[]),l.get(p.brewCategory).push(p);return`<div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:16px;">${Ae.filter(p=>i.has(p)).map(p=>{const u=i.get(p),y=Be[p]??"#9ca3af",v=Ra(p);l.get(p);const f=n[p]??{rawAlcoholPct:18,targetAlcoholPct:15},b=f.targetAlcoholPct>0?f.rawAlcoholPct/f.targetAlcoholPct:1;u.stockL*1e3;const k=u.totalMl,P=u.avgMl,o=k/1e3,r=Math.round(u.stockL*b*10)/10,d=r*1e3,m=P>0?Math.round(d/P*10)/10:0,g=r-o,$=P>0?Math.round(P*2/1e3*10)/10:0,w=r<$,S=Oa(m),_=Xc(m),E=Math.min(m/12*100,100),A=g>=0?"#22c55e":"#ef4444",q=g>=0?`+${ne(Math.round(g))}L 余裕`:`${ne(Math.round(g))}L 不足`,M=b>1.001;return`
        <div class="card" style="border-top:3px solid ${y};min-width:260px;flex:1;">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;">
            <h4 style="margin:0;font-size:14px;color:${y};">${p}</h4>
            <div style="display:flex;gap:4px;align-items:center;">
              <span style="font-size:11px;padding:2px 8px;border-radius:9999px;background:${S}20;color:${S};font-weight:600;">${_}</span>
          ...
          <div id="stock-display-${v}">
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:4px;font-size:11px;margin-bottom:4px;">
              ...
              <div><span style="color:#6b7280;">月平均</span><br><strong style="font-size:15px;">${re(P)}L</strong></div>
            </div>
            ${M?`
            ...
            `:""}
            ${(()=>{const L=s.filter(T=>T.parentCategory===p);return L.length===0?"":L.map(T=>{const V=t.filter(z=>z.brewCategory===T.name).reduce((z,H)=>z+H.volumeL,0);return`<div style="font-size:11px;border-left:3px solid #6366f1;padding-left:8px;margin-bottom:4px;">
                  <span style="color:#6366f1;font-weight:600;">${T.name}</span>
                  ${V>0?`<span style="margin-left:4px;">${ne(V)}L</span>`:'<span style="color:var(--text-secondary);margin-left:4px;">在庫未設定</span>'}
                </div>`}).join("")})()}
          </div>

          <div id="stock-edit-${v}" style="display:none;margin-bottom:8px;">
            ${(()=>{const L=s.filter(z=>z.parentCategory===p),T=[{name:p,label:p},...L.map(z=>({name:z.name,label:z.name}))],O=T.flatMap(z=>t.filter(B=>B.brewCategory===z.name).map(B=>({...B,catLabel:z.label}))),V=T.map(z=>`<option value="${z.name}">${z.label}</option>`).join("");return`
                    ...
                    <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;flex-wrap:wrap;">
                      ...
                      ${T.length>1?`
                        <select data-action="brew-reassign-entry" data-id="${z.id}"
                          ...
                          ${T.map(H=>`<option value="${H.name}" ${H.name===z.brewCategory?"selected":""}>${H.label}</option>`).join("")}
                        </select>
                ...
                <div style="display:flex;gap:4px;align-items:center;margin-top:6px;flex-wrap:wrap;">
                  ${T.length>1?`<select id="new-entry-target-${v}" style="height:28px;font-size:11px;border:1px solid var(--border);border-radius:4px;padding:0 4px;">${V}</select>`:""}
          ...
          <div style="margin-bottom:4px;display:flex;justify-content:space-between;font-size:11px;">
            ...
            <span style="font-weight:600;color:${S};">${m.toFixed(1)}ヶ月</span>
          </div>
          <div style="background:#e5e7eb;border-radius:4px;height:8px;overflow:hidden;">
            <div style="background:${S};height:100%;width:${E}%;border-radius:4px;transition:width 0.3s;"></div>
          </div>
        </div>
  ...
  `}function ed(e,t,n,s,i){if(e.length===0)return"";const l=new Date,c=l.getMonth()+1,p=c>=10?l.getFullYear():l.getFullYear()-1,u=p+1,y=new Map;for(const _ of e)y.has(_.brewCategory)||y.set(_.brewCategory,new Map),y.get(_.brewCategory).set(_.fy,{shipL:_.shipmentL,annualL:_.annualizedL});const v=new Map;for(const _ of i)v.has(_.brewCategory)||v.set(_.brewCategory,new Map),v.get(_.brewCategory).set(_.monthNum,_.avgMonthlyL);const f=[...new Set(e.map(_=>_.fy))].sort(),b=[...y.keys()].sort((_,E)=>{const A=[...Ae,...s.map(q=>q.name)];return(A.indexOf(_)===-1?99:A.indexOf(_))-(A.indexOf(E)===-1?99:A.indexOf(E))}),k=[];for(let _=c;_<=9;_++)k.push(_);if(c>=10)for(let _=1;_<=9;_++)k.push(_);const P=f.filter(_=>_<p),o=f.includes(p),r=b.map(_=>{const E=y.get(_);f.filter(Z=>E.has(Z));const A=Be[_]??"#6366f1",q=v.get(_)??new Map,M=P.filter(Z=>E.has(Z)).map(Z=>E.get(Z).shipL);let L=0;if(M.length>=2){const Z=[];for(let de=1;de<M.length;de++)M[de-1]>0&&Z.push((M[de]-M[de-1])/M[de-1]);L=Z.length>0?Z.reduce((de,ke)=>de+ke,0)/Z.length:0}const T=M.length>0?M[M.length-1]:E.get(p)?.annualL??0,O=k.reduce((Z,de)=>Z+(q.get(de)??0),0),V=t.filter(Z=>Z.brewCategory===_).reduce((Z,de)=>Z+de.volumeL,0),z=n[_],H=z&&z.targetAlcoholPct>0?z.rawAlcoholPct/z.targetAlcoholPct:1,B=Math.round(V*H),j=Math.max(0,B-Math.round(O)),F=Math.round(T*(1+L)),U=Math.max(0,F-j),ie=Math.round(L*100),me=ie>0?"#22c55e":ie<0?"#ef4444":"#6b7280",G=E.get(p)?.annualL??0;return`
      <tr>
        <td style="color:${A};font-weight:600;white-space:nowrap;">${_}</td>
        ${P.map(Z=>`<td style="text-align:right;">${E.has(Z)?ne(Math.round(E.get(Z).shipL)):"—"}</td>`).join("")}
        ${o?`<td style="text-align:right;color:var(--text-secondary);" title="年換算">${ne(Math.round(G))}*</td>`:""}
        <td style="text-align:right;color:${me};font-weight:600;">${ie>=0?"+":""}${ie}%</td>
        <td style="text-align:right;">${ne(B)}</td>
        <td style="text-align:right;color:var(--text-secondary);">-${ne(Math.round(O))}</td>
        <td style="text-align:right;font-weight:600;">${ne(j)}</td>
        <td style="text-align:right;">${ne(F)}</td>
        <td style="text-align:right;color:${U>0?"#ef4444":"#22c55e"};font-weight:700;">${U>0?ne(U):"余裕"}</td>
      </tr>
    `}).join("");let d=0,m=0,g=0,$=0,w=0;for(const _ of b){const E=y.get(_),A=v.get(_)??new Map,q=P.filter(F=>E.has(F)).map(F=>E.get(F).shipL);let M=0;if(q.length>=2){const F=[];for(let U=1;U<q.length;U++)q[U-1]>0&&F.push((q[U]-q[U-1])/q[U-1]);M=F.length>0?F.reduce((U,ie)=>U+ie,0)/F.length:0}const L=q.length>0?q[q.length-1]:E.get(p)?.annualL??0,T=t.filter(F=>F.brewCategory===_).reduce((F,U)=>F+U.volumeL,0),O=n[_],V=O&&O.targetAlcoholPct>0?O.rawAlcoholPct/O.targetAlcoholPct:1,z=Math.round(T*V),H=k.reduce((F,U)=>F+(A.get(U)??0),0),B=Math.max(0,z-Math.round(H)),j=Math.round(L*(1+M));d+=z,m+=Math.round(H),g+=B,$+=j,w+=Math.max(0,j-B)}const S=c<=9?`${c}月〜9月`:`${c}月〜翌9月`;return`
      ...
      <div class="table-wrap">
        <table class="data-table" style="font-size:12px;">
          <thead>
            <tr>
              <th>区分</th>
              ${P.map(_=>`<th style="text-align:right;">${_}(L)</th>`).join("")}
              ${o?`<th style="text-align:right;">${p}*</th>`:""}
              <th style="text-align:right;">増減率</th>
              <th style="text-align:right;">現在庫</th>
              <th style="text-align:right;">${S}</th>
              <th style="text-align:right;">10月予想</th>
              <th style="text-align:right;">${u}予測</th>
          ...
          <tfoot>
            <tr style="font-weight:700;background:var(--surface-alt);">
              ...
              <td style="text-align:right;color:var(--text-secondary);">-${ne(m)}</td>
              <td style="text-align:right;">${ne(g)}</td>
              <td style="text-align:right;">${ne($)}</td>
              <td style="text-align:right;color:#ef4444;">${ne(w)}</td>
            </tr>
          </tfoot>
        </table>
      </div>
  ...
  `}function td(e){const t=new Map;for(const s of e){t.has(s.brewCategory)||t.set(s.brewCategory,{avgMl:0,totalMl:0,stockL:s.currentStockL});const i=t.get(s.brewCategory);i.avgMl+=s.monthlyAvgMl,i.totalMl+=s.totalShipmentMl}return`
    <div class="card" style="margin-bottom:16px;">
      ...
      ${Ae.filter(s=>t.has(s)).map(s=>{const i=t.get(s),l=i.avgMl>0?Math.round(i.stockL*1e3/i.avgMl*10)/10:0,c=i.totalMl/1e3,p=c>0?Math.round(i.stockL/c*100):0,u=Be[s]??"#9ca3af",y=Oa(l),v=Math.min(l/12*100,100);return`
  ...
  `}function ad(e,t,n,s,i){if(e.length===0)return"";const l=n.map(f=>f.name);[...Ae,...l];const c=new Map;for(const f of n)c.has(f.parentCategory)||c.set(f.parentCategory,[]),c.get(f.parentCategory).push(f);const p=new Map;for(const f of e)p.has(f.brewCategory)||p.set(f.brewCategory,[]),p.get(f.brewCategory).push(f);for(const f of l)p.has(f)||p.set(f,[]);const u=new Set;for(const f of n)for(const b of p.get(f.name)??[])u.add(b.productCode);const y=new Map;for(const f of Ae)y.set(f,p.get(f)??[]);const v=Ae.filter(f=>p.has(f)).map(f=>{const b=p.get(f)??[],k=Be[f]??"#9ca3af",P=c.get(f)??[],o=P.length>0,r=b.reduce((A,q)=>A+q.annualMl,0),d=b.reduce((A,q)=>A+q.monthlyAvgMl,0),m=b.filter(A=>!u.has(A.productCode)),g=m.filter(A=>!t.has(A.productCode)),$=g.reduce((A,q)=>A+q.annualMl,0),w=g.reduce((A,q)=>A+q.monthlyAvgMl,0),S=m.filter(A=>t.has(A.productCode)),_=m.map(A=>{const q=t.has(A.productCode);return`
          <tr style="${q?"opacity:0.5;background:rgba(183,121,31,0.06);":""}">
            ...
            <td style="text-align:right;">${re(A.annualMl)}</td>
            <td style="text-align:right;">${re(A.monthlyAvgMl)}</td>
          </tr>
        `}).join(""),E=P.map(A=>{const q=p.get(A.name)??[],M=q.reduce((B,j)=>B+j.annualMl,0),L=q.reduce((B,j)=>B+j.monthlyAvgMl,0),T=i.filter(B=>B.brewCategory===A.name),O=T.reduce((B,j)=>B+j.volumeL,0),V=Ra(A.name),z=q.map(B=>`
          <tr style="background:rgba(99,102,241,0.04);">
            <td style="width:32px;text-align:center;">
              <input type="checkbox" checked data-action="brew-unconfirm" data-code="${B.productCode}" data-cat="${A.name}"
            ...
            <td style="text-align:right;">${re(B.annualMl)}</td>
            <td style="text-align:right;">${re(B.monthlyAvgMl)}</td>
          </tr>
        `).join(""),H=S.filter(B=>!q.some(j=>j.productCode===B.productCode)).map(B=>`
            <tr style="opacity:0.4;">
              <td style="width:32px;text-align:center;">
                <input type="checkbox" data-action="brew-confirm-to-child" data-code="${B.productCode}" data-cat="${A.name}"
                  style="cursor:pointer;" />
              </td>
              <td style="white-space:nowrap;max-width:180px;overflow:hidden;text-overflow:ellipsis;" title="${B.productName}">${B.productName}</td>
              <td style="font-size:11px;color:var(--text-secondary);">${B.subCategory}</td>
              <td style="text-align:right;color:var(--text-secondary);">${re(B.annualMl)}</td>
              <td style="text-align:right;color:var(--text-secondary);">${re(B.monthlyAvgMl)}</td>
            </tr>
          `).join("");return`
          <tr><td colspan="5" style="padding:0;">
            <div style="border-left:3px solid #6366f1;margin:8px 0 8px 16px;padding:6px 0 6px 12px;">
              <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;flex-wrap:wrap;">
                ...
                <span style="font-size:11px;color:var(--text-secondary);">${q.length}品 ・ ${re(M)}L/年${O>0?` ・ 在庫${ne(O)}L`:""}</span>
                <button class="btn-edit-stock" data-cat-id="${V}" data-cat="${A.name}"
              ...
              <div id="stock-edit-${V}" style="display:none;margin-bottom:6px;padding:4px;background:var(--surface-alt);border-radius:4px;">
                ...
                ${T.map(B=>`
                  <div style="display:flex;align-items:center;gap:4px;margin-bottom:2px;">
                    ...
                    <strong style="font-size:11px;">${ne(B.volumeL)}L</strong>
                    <button data-action="brew-delete-entry" data-id="${B.id}" data-cat="${A.name}"
                ...
                <div style="display:flex;gap:3px;align-items:center;margin-top:3px;">
                  ...
                  <button data-action="brew-add-entry" data-cat="${A.name}" data-cat-id="${V}"
          ...
          <div class="table-wrap">
            <table class="data-table" style="font-size:12px;">
              ...
              <tfoot>
                ...
                ${S.length>0?`<tr style="font-size:11px;color:#b7791f;"><td></td><td>　未振分</td><td>${S.length}品</td>
                  <td style="text-align:right;">${re(S.reduce((A,q)=>A+q.annualMl,0))}</td>
                  <td style="text-align:right;">${re(S.reduce((A,q)=>A+q.monthlyAvgMl,0))}</td></tr>`:""}
              </tfoot>
            </table>
          </div>
        </div>
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;flex-wrap:wrap;gap:8px;">
        ...
        <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
          <select id="brew-new-category-parent" style="font-size:12px;padding:4px;border:1px solid var(--border);border-radius:4px;">
            ...
            ${Ae.filter(f=>f!=="その他").map(f=>`<option value="${f}">${f}</option>`).join("")}
          </select>
...
<div class="panel">
  ...
  <div style="display:flex;gap:4px;margin-bottom:1.5rem;flex-wrap:wrap">
    ${De.map((f,b)=>{const k=b===i,P=b===s;return`<button class="button" style="padding:4px 10px;background:${P?"#0F5B8D":k?"#e2e8f0":"transparent"};color:${P?"#fff":"#333"};border:${k&&!P?"2px solid #0F5B8D":"1px solid #cbd5e0"};border-radius:4px;font-size:0.8rem;cursor:pointer" data-action="select-month" data-month="${b}">${f}${k?" ●":""}</button>`}).join("")}
  </div>
      ...
      <table style="width:100%;border-collapse:collapse;font-size:0.8rem">
        <thead>
          <tr>
            ...
            ${De.map((f,b)=>`<th style="text-align:center;padding:6px 2px;border-bottom:2px solid #e2e8f0;min-width:36px;${b===i?"background:#f0f7ff;":""}">${f.replace("月","")}</th>`).join("")}
          </tr>
        </thead>
        <tbody>
          ${yd(l,i)}
  ...
  ${fd(c)}
      ...
      <span class="status-pill" style="background:${Le[i]}15;color:${Le[i]};padding:2px 8px;border-radius:9px;font-size:0.75rem">${ya[i]}</span>
    </td></tr>`);for(const c of l){const p=De.map((u,y)=>{const v=c.peakMonths.includes(y),f=Os(c,y),b=y===t?"outline:2px solid #0F5B8D;outline-offset:-1px;":"";let k="transparent";v?k=Le[c.seasonType]:f&&(k=Le[c.seasonType]+"40");const P=v||f?`background:${k};border-radius:3px;height:18px;width:100%;`:"";return`<td style="padding:2px;text-align:center;${b}"><div style="${P}" title="${v?"ピーク":f?"提案期間":""}"></div></td>`}).join("");n.push(`<tr style="border-bottom:1px solid #f0f0f0">
        ...
        <td style="padding:6px 8px">${u.peakMonths.map(b=>De[b]).join(", ")}</td>
      </tr>`}).join("");return`
    <div class="table-wrap" style="margin-bottom:1rem">
      <h4 style="margin-bottom:0.5rem;display:flex;align-items:center;gap:8px">
        <span class="status-pill" style="background:${Le[i]}15;color:${Le[i]}">${ya[i]}</span>
        <span style="font-size:0.85rem;color:#666">${De[t]}の対象: ${c.length}品</span>
      </h4>
      <table style="width:100%;border-collapse:collapse;font-size:0.8rem">
        <thead>
    ...
    </div>`}).filter(Boolean);return s.length===0?`<div style="padding:1rem;color:#666;text-align:center">${De[t]}に提案対象の商品はありません</div>`:s.join("")}function fd(e){return!e||e.targetCustomers.length===0?`
  ...
  `).join("")}</tbody>
      ...
      <div class="sc-cell ${$?"sc-today":""} ${w?"sc-selected":""} ${g?"sc-has-data":""}"
        ...
        <div class="sc-cities">${_}</div>
      </div>
    `}).join(""),b=n&&e?.[n]?$d(e[n]):n?`<div class="sc-detail-empty"><p>📦 ${n.slice(5)} は出荷なし</p></div>`:'<div class="sc-detail-empty"><p>日付を選択すると出荷先一覧が表示されます</p></div>',k=Object.values(e??{}).reduce((o,r)=>o+r.count,0),P=Object.values(e??{}).reduce((o,r)=>o+r.totalAmount,0);return`
  ...
  `}function $d(e){const t=e.date.replace(/-/g,"/").slice(5),n={};for(const i of e.entries)(n[i.city]??=[]).push(i);const s=Object.entries(n).sort((i,l)=>l[1].length-i[1].length).map(([i,l])=>{const c=l.sort((p,u)=>u.amount-p.amount).map(p=>`
    ...
    ${s}
  `}const wd=new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}),Zt=["月","火","水","木","金"],$n=6;function xd(e,t){if(!e)return 9999;const n=new Date(e);return isNaN(n.getTime())?9999:Math.floor((t.getTime()-n.getTime())/(1e3*60*60*24))}function _d(e,t){if(t.length===0)return 0;const n=[...t].sort((i,l)=>i-l);return n.filter(i=>i<=e).length/n.length}function Sd(e,t){return e.includes("離反リスク")?"緊急訪問 - 離反防止ヒアリング":e.includes("季節提案タイミング")?"季節商品の提案・試飲サンプル持参":t>30?"定期巡回 - 状況確認・追加注文確認":"関係維持 - ご挨拶"}function wn(e){const t=new Date,n=e.map(u=>u.annualRevenue),s=e.map(u=>{const y=xd(u.lastOrderDate,t);let v=0;const f=[];y>=60&&(v+=50,f.push("離反リスク")),u.hasSeasonalProposal&&(v+=30,f.push("季節提案タイミング")),y>=30&&y<60&&(v+=20,f.push("定期巡回"));const b=_d(u.annualRevenue,n),k=Math.round(b*20);k>0&&(v+=k,f.push("金額ウェイト"));const P=Sd(f,y);return{code:u.code,name:u.name,phone:u.phone,address:u.address1,areaCode:u.areaCode,businessType:u.businessType,priorityScore:v,reasons:f,lastOrderDate:u.lastOrderDate,daysSinceOrder:y,annualRevenue:u.annualRevenue,recommendedAction:P}}).filter(u=>u.priorityScore>0).sort((u,y)=>y.priorityScore-u.priorityScore),i=new Map;for(const u of s){const y=u.areaCode||"その他";i.has(y)||i.set(y,[]),i.get(y).push(u)}const l=[...i.entries()].sort((u,y)=>y[1].reduce((v,f)=>v+f.priorityScore,0)-u[1].reduce((v,f)=>v+f.priorityScore,0)),c=[];let p=0;for(const[u,y]of l){const v=y.sort((f,b)=>b.priorityScore-f.priorityScore);for(let f=0;f<v.length&&!(p>=Zt.length);f+=$n){const b=v.slice(f,f+$n);c.push({dayLabel:Zt[p],area:u,visits:b}),p++}if(p>=Zt.length)break}return{candidates:s,weekPlan:c,filterArea:"",filterMinScore:0}}function kd(e){const{candidates:t,weekPlan:n,filterArea:s,filterMinScore:i}=e,l=t.filter(f=>!(s&&f.areaCode!==s||i>0&&f.priorityScore<i)),c=Array.from(new Set(t.map(f=>f.areaCode))).sort(),p=l.length,u=l.filter(f=>f.priorityScore>=50).length,y=l.filter(f=>f.reasons.includes("離反リスク")).length,v=n.reduce((f,b)=>f+b.visits.length,0);return`
    <section class="page-head">
      <div>
...
`)}`,c=new Blob([l],{type:"text/csv;charset=utf-8;"}),p=URL.createObjectURL(c),u=document.createElement("a");u.href=p,u.download=e,document.body.append(u),u.click(),u.remove(),window.setTimeout(()=>URL.revokeObjectURL(p),0)}const Od=Object.fromEntries(zt.map(e=>[e.value,e.label])),Rd=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/invoice-entry","/quote","/quote-settings","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser","/demand-forecast","/churn-alert","/seasonal-calendar","/visit-planner","/demand","/shipment-calendar","/brewing-plan"];let He=[];async function jd(){const{supabaseQueryAll:e}=await D(async()=>{const{supabaseQueryAll:n}=await Promise.resolve().then(()=>X);return{supabaseQueryAll:n}},void 0);He=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(n=>typeof n.email=="string"&&n.email.length>0).map(n=>({name:String(n.name??""),email:String(n.email??""),area:String(n.delivery_area_code??""),historySegment:"seasonal"}))}const _n=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"},{path:"/churn-alert",title:"離反アラート・休眠顧客"},{path:"/seasonal-calendar",title:"季節提案カレンダー"},{path:"/visit-planner",title:"訪問計画・ルート最適化"},{path:"/demand",title:"需要分析・安全在庫・生産計画"},{path:"/shipment-calendar",title:"出荷カレンダー"},{path:"/brewing-plan",title:"醸造計画"}];function Rs(e){const t=xa[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function ja(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function zd(){const e=Rs("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const Ft=new Date,Bd=Ft.toISOString().slice(0,7),Fd=Ft.getFullYear(),Vd=Ft.getMonth()+1,Yd=Ft.toISOString().slice(0,10),Jd="C0011",Oe=zd();function js(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",n=e.startsWith(t)?e.slice(t.length)||"/":e;return Rd.includes(n)?n:"/"}function za(e){switch(e){case"/invoice-entry":case"/quote":case"/quote-settings":case"/delivery":case"/billing":case"/invoice":case"/ledger":case"/shipment-calendar":return"sales";case"/analytics":case"/customer-analysis":case"/product-power":case"/customer-efficiency":case"/report":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":case"/churn-alert":case"/seasonal-calendar":case"/visit-planner":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":case"/demand":case"/brewing-plan":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const Sn=js(location.pathname),a={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:ja(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:Bd,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:Fd,taxMonth:Vd,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],mapCustomers:[],callLogs:[],mapFilters:{filterStatus:"all",filterArea:"",filterBiz:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...Cc,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...Ac},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:Yd,route:Sn,currentCategory:za(Sn),sidebarOpen:!1,announcements:[],dismissedAnnouncements:new Set,updateAvailable:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:Jd,salesPeriod:"month",customRange:{start:"",end:""},quoteState:Tt(la()),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,quoteList:[],quoteListLoading:!1,quoteEditId:null,quoteCompanySettings:la(),productPower:[],productFilter:"all",productPeriod:"year",productDaily:[],productCustomStart:"",productCustomEnd:"",productSortState:[],customerSortState:[],dashboardSortState:[],masterSortState:[],analyticsSortState:[],customerEfficiency:[],customerEfficiencyYear:(()=>{const e=new Date;return e.getMonth()>=3?e.getFullYear():e.getFullYear()-1})(),customerEfficiencyGroupBy:"billing",masterTab:"customers",masterFilter:{...Na},analyticsTab:"products",analyticsPeriod:"all",analyticsPeriodFilter:"",analyticsPeriodRows:[],analyticsPeriodChartData:[],analyticsPrevYearChartData:[],analyticsChartMetric:"amount",analyticsFiscalMode:"calendar",analyticsPeriodOptions:[],analyticsStaffFilter:"",analyticsTagFilter:"",analyticsStaffPeriod:"all",analyticsStaffPeriodFilter:"",analyticsStaffPeriodOptions:[],analyticsStaffTotals:[],analyticsStaffDrilldown:null,analyticsDrilldown:null,emailAudienceMode:Oe.mode,emailRegion:Oe.region,emailHistorySegment:Oe.historySegment,emailTemplateId:Oe.templateId,emailSubject:Oe.subject,emailBody:Oe.body,emailSaveMessage:Oe.saveMessage,emailSending:!1,demandForecast:{..._r},shipmentCalendarData:null,shipmentCalendarYearMonth:new Date().toISOString().slice(0,7),shipmentCalendarSelectedDate:null,churnAlert:null,churnNotes:[],seasonalCalendar:null,visitPlanner:null,demandAnalysis:null,safetyStockParams:[],productionPlan:[],demandTab:"demand",demandPlanYearMonth:new Date().toISOString().slice(0,7),demandYearsBack:3,demandPlanTypeFilter:"monthly",brewingPlanData:[],brewingMonthlyTrend:[],brewingPlanFY:(()=>{const e=new Date;return e.getMonth()>=9?e.getFullYear():e.getFullYear()-1})(),demandSort:null,calendarShifts:Lt(new Date().toISOString().slice(0,7),1,0),calendarDefaultPart:1,calendarDefaultEmp:0,calendarSelectedDate:null,calendarLabelExcluded:new Set,calendarCapacity:{partCapacity:Ze,empCapacity:et},brewingSchedule:[],brewingProductDetail:[],brewingExcludedProducts:new Set,brewingCustomCategories:[],brewingOverrides:{},brewingStockEntries:[],brewingTypeLinks:{},brewingAvailableTypes:[],brewingAlcoholSettings:{},brewingYearlyShipments:[],brewingSeasonalPattern:[],globalSearchOpen:!1,globalQuery:"",orderHeaders:[],authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function kn(e){return e.slice(0,10)}function Ud(e){return{...e}}function Mt(){a.pickerMode=null,a.pickerQuery="",a.pickerTargetLine=null}function zs(){a.invoiceForm=ja(),a.invoiceSavedDocNo=null,a.invoicePriceGroup="",a.invoiceErrors={},Mt()}function Bs(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((n,s)=>{n.productCode.trim()||(t[`lines.${s}.productCode`]="商品コードは必須です。"),n.productName.trim()||(t[`lines.${s}.productName`]="商品名は必須です。"),n.quantity<=0&&(t[`lines.${s}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(t[`lines.${s}.unitPrice`]="単価は0円以上で入力してください。")}),t}function Qd(e){const t=a.invoiceForm.lines[e];t&&a.invoiceForm.lines.splice(e+1,0,Ud(t))}function Hd(){const e=a.invoiceRecords[0],t=a.masterStats?.customers[0],n=a.masterStats?.products.slice(0,2)??[];a.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:a.invoiceForm.staffCode||"S001",lines:n.map((s,i)=>{const l=i===0?1:2,c=1200*(i+1);return{productCode:s.code,productName:s.name,quantity:l,unitPrice:c,unit:"本",amount:l*c}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},a.invoiceSavedDocNo=null,a.invoiceErrors={}}function Gd(e){const t=a.masterStats?.customers.find(n=>n.code.toLowerCase()===e.trim().toLowerCase());return t?(a.invoiceForm.customerCode=t.code,a.invoiceForm.customerName=t.name,a.invoicePriceGroup=t.priceGroup||"",!0):!1}function Xd(e){const t=a.masterStats?.customers.find(n=>n.name===e.trim());return t?(a.invoiceForm.customerCode=t.code,a.invoiceForm.customerName=t.name,a.invoicePriceGroup=t.priceGroup||"",!0):!1}function Fs(e){if(Ee(e),a.invoiceErrors=Bs(a.invoiceForm),Object.keys(a.invoiceErrors).length>0){x();return}a.invoiceSaving=!0,x(),jn(a.invoiceForm).then(t=>{a.invoiceSavedDocNo=t.documentNo,a.invoiceSaving=!1,a.invoiceErrors={},a.invoiceForm=ja(),x()}).catch(()=>{a.invoiceSaving=!1,x()})}function Vs(e){const t=a.salesFilter.startDate?new Date(a.salesFilter.startDate):null,n=a.salesFilter.endDate?new Date(`${a.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((s,i)=>new Date(i.date).getTime()-new Date(s.date).getTime()).filter(s=>{const i=new Date(s.date);return!(t&&i<t||n&&i>n)})}function Ys(){switch(a.emailAudienceMode){case"area":return a.emailRegion==="all"?He:He.filter(e=>e.area===a.emailRegion);case"history":return He.filter(e=>e.historySegment===a.emailHistorySegment);default:return He}}function Kd(){const e=Ys();return{audienceMode:a.emailAudienceMode,region:a.emailRegion,historySegment:a.emailHistorySegment,selectedTemplateId:a.emailTemplateId,subject:a.emailSubject,body:a.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:a.emailSaveMessage,sending:a.emailSending,senderId:a.emailSenderId,senders:a.mailSenders}}function ta(e){const t=Ys(),n=a.emailAudienceMode==="area"?a.emailRegion:a.emailAudienceMode==="history"?a.emailHistorySegment:"all";return{subject:a.emailSubject.trim(),body:a.emailBody.trim(),templateId:a.emailTemplateId,audienceMode:a.emailAudienceMode,audienceFilter:n,recipientCount:t.length,recipients:t.map(s=>s.email),status:e}}function Ba(){return a.user,!1}function yt(){a.globalSearchOpen=!1,a.globalQuery=""}function Wd(){const e=a.globalQuery.trim().toLowerCase();return e?{customers:a.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:a.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:a.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:_n.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:_n}}function Zd(){let e=[],t,n="export.csv";switch(a.route){case"/sales":e=(a.salesSummary?Vs(a.salesSummary):[]).map(s=>({documentNo:s.documentNo,date:s.date,customerCode:s.customerCode,customerName:s.customerName,amount:s.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":e=[...a.paymentStatus?.records??[]].sort((s,i)=>i.balanceAmount-s.balanceAmount).map(s=>({...s})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":e=a.invoiceRecords.map(s=>({...s})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":e=a.purchaseList.map(s=>({...s})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":e=a.jikomiList.map(s=>({...s})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":e=a.tankList.map(s=>({...s})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":e=a.kenteiList.map(s=>({...s})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":e=a.materialList.map(s=>({...s})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":a.masterTab==="customers"?(e=a.masterStats?.customers.map(s=>({...s}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(e=a.masterStats?.products.map(s=>({...s}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}fa(n,e,t)}function aa(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),a.route=e,a.currentCategory=za(e),a.sidebarOpen=!1,yt(),Fa(e)}async function Fa(e){a.actionLoading=!0,x();try{switch(e){case"/quote":if(a.quoteEditId===null&&a.quoteList.length===0&&(a.quoteListLoading=!0,x(),a.quoteList=await Ta(),a.quoteListLoading=!1),a.prospects.length===0){const{fetchProspects:t}=await D(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>N);return{fetchProspects:n}},void 0);a.prospects=await t()}break;case"/invoice":a.invoiceRecords.length===0&&(a.invoiceRecords=await mt(a.invoiceFilter));break;case"/analytics":(!a.salesAnalytics||a.salesAnalytics.monthlySales.length===0)&&(a.salesAnalytics=await ka());break;case"/delivery":a.deliveryNote||(a.deliveryNote=await Pa(a.deliverySearchDocNo));break;case"/shipment-calendar":{const{fetchShipmentCalendar:t}=await D(async()=>{const{fetchShipmentCalendar:n}=await Promise.resolve().then(()=>N);return{fetchShipmentCalendar:n}},void 0);a.shipmentCalendarData=await t(a.shipmentCalendarYearMonth);break}case"/billing":a.billingSummary||(a.billingSummary=await Ea(a.billingYearMonth));break;case"/report":a.salesReport||(a.salesReport=await Rt());break;case"/product-power":a.productPower.length===0&&(a.productPower=await Yn());break;case"/customer-efficiency":a.customerEfficiency=await ct(a.customerEfficiencyYear,a.customerEfficiencyGroupBy);break;case"/customer-analysis":a.customerAnalysis||(a.customerAnalysis=await Jn());break;case"/demand-forecast":if(a.demandForecast.forecasts.length===0){const{fetchDemandForecasts:t,fetchDeliverySchedule:n}=await D(async()=>{const{fetchDemandForecasts:l,fetchDeliverySchedule:c}=await Promise.resolve().then(()=>N);return{fetchDemandForecasts:l,fetchDeliverySchedule:c}},void 0),[s,i]=await Promise.all([t(),n()]);a.demandForecast.forecasts=s.map(l=>({code:l.productCode,name:l.productName,segment:l.segment,monthlyQuantity:new Array(12).fill(0),avgMonthly:Math.round(l.avgMonthly),adjustedAvg:Math.round(l.avgMonthly),nextMonthForecast:Math.round(l.forecastQuantity),annualForecast:Math.round(l.avgMonthly*12),safetyStock:Math.round(l.safetyStock)})),a.demandForecast.deliveries=Sr(i)}break;case"/churn-alert":{const{fetchChurnAlerts:t,fetchChurnNotes:n}=await D(async()=>{const{fetchChurnAlerts:s,fetchChurnNotes:i}=await Promise.resolve().then(()=>N);return{fetchChurnAlerts:s,fetchChurnNotes:i}},void 0);if(!a.churnAlert){const s=await t();a.churnAlert=od(s)}a.churnNotes=await n();break}case"/seasonal-calendar":if(!a.seasonalCalendar){const{fetchProductShipmentsFromTable:t}=await D(async()=>{const{fetchProductShipmentsFromTable:s}=await Promise.resolve().then(()=>N);return{fetchProductShipmentsFromTable:s}},void 0),n=await t();if(n.length>0)a.seasonalCalendar=bn(n.map(s=>({code:s.code,name:s.name,category:"",monthlyQuantity:s.monthlyQuantity})));else{const{fetchProductMonthlyShipments:s}=await D(async()=>{const{fetchProductMonthlyShipments:l}=await Promise.resolve().then(()=>N);return{fetchProductMonthlyShipments:l}},void 0),i=await s();a.seasonalCalendar=bn(i.map(l=>({code:l.code,name:l.name,category:"",monthlyQuantity:l.monthlyQuantity})))}}break;case"/visit-planner":if(!a.visitPlanner){const{fetchVisitPriorities:t}=await D(async()=>{const{fetchVisitPriorities:s}=await Promise.resolve().then(()=>N);return{fetchVisitPriorities:s}},void 0),n=await t();if(n.length>0)a.visitPlanner={candidates:n.map(s=>({code:s.customer_code,name:s.customer_name,phone:s.phone,address:s.address,areaCode:s.area_code,businessType:s.business_type,priorityScore:s.priority_score,reasons:s.reasons,lastOrderDate:s.last_order_date,daysSinceOrder:s.days_since_order,annualRevenue:s.annual_revenue,recommendedAction:s.recommended_action})),weekPlan:[],filterArea:"",filterMinScore:0},a.visitPlanner=wn(n.map(s=>({code:s.customer_code,name:s.customer_name,phone:s.phone,address1:s.address,areaCode:s.area_code,businessType:s.business_type,annualRevenue:s.annual_revenue,lastOrderDate:s.last_order_date,hasSeasonalProposal:s.reasons.some(i=>i.includes("季節"))})));else{const{supabaseQueryAll:s}=await D(async()=>{const{supabaseQueryAll:u}=await Promise.resolve().then(()=>X);return{supabaseQueryAll:u}},void 0),[i,l]=await Promise.all([s("sales_document_headers",{select:"sales_date,legacy_customer_code,total_amount"}),a.masterStats?Promise.resolve(a.masterStats.customers):_a().then(u=>u.customers)]),c=a.masterStats?.customers??l,p=new Map;i.forEach(u=>{const y=u.legacy_customer_code||"",v=u.sales_date||"",f=Number(u.total_amount)||0,b=p.get(y);!b||v>b.lastDate?p.set(y,{lastDate:v,total:(b?.total??0)+f}):b.total+=f}),a.visitPlanner=wn(c.filter(u=>u.isActive).map(u=>({code:u.code,name:u.name,phone:u.phone,address1:u.address1,areaCode:u.areaCode,businessType:u.businessType,annualRevenue:p.get(u.code)?.total??0,lastOrderDate:p.get(u.code)?.lastDate??"",hasSeasonalProposal:!1})))}}break;case"/demand":{const{fetchDemandAnalysis:t,fetchSafetyStockParams:n,fetchProductionPlan:s,fetchLabelExclusions:i}=await D(async()=>{const{fetchDemandAnalysis:c,fetchSafetyStockParams:p,fetchProductionPlan:u,fetchLabelExclusions:y}=await Promise.resolve().then(()=>N);return{fetchDemandAnalysis:c,fetchSafetyStockParams:p,fetchProductionPlan:u,fetchLabelExclusions:y}},void 0);if(!a.demandAnalysis){const[c,p]=await Promise.all([t(a.demandYearsBack*12),n()]);a.demandAnalysis=c,a.safetyStockParams=p}if(a.productionPlan.length===0){const c=await s(a.demandPlanYearMonth);c.length>0?a.productionPlan=c:a.demandAnalysis&&a.safetyStockParams.length>0&&(a.productionPlan=buildPlanFromAnalysis(a.demandPlanYearMonth))}const l=await i(a.demandPlanYearMonth);if(a.calendarLabelExcluded=new Set(l),a.productionPlan.length>0){const c=a.productionPlan.filter(p=>!a.calendarLabelExcluded.has(p.productCode));Pe(a.calendarShifts,c,a.calendarCapacity)}break}case"/brewing-plan":{const{fetchBrewingPlanSummary:t,fetchBrewingMonthlyTrend:n,fetchBrewingSchedule:s,fetchBrewingProductDetail:i,fetchBrewingCustomCategories:l,fetchBrewingCategoryOverrides:c,fetchAllBrewingStockEntries:p,fetchCategoryTypeLinks:u,fetchAvailableProductionTypes:y,fetchBrewingAlcoholSettings:v,fetchBrewingYearlyShipments:f,fetchBrewingSeasonalPattern:b}=await D(async()=>{const{fetchBrewingPlanSummary:L,fetchBrewingMonthlyTrend:T,fetchBrewingSchedule:O,fetchBrewingProductDetail:V,fetchBrewingCustomCategories:z,fetchBrewingCategoryOverrides:H,fetchAllBrewingStockEntries:B,fetchCategoryTypeLinks:j,fetchAvailableProductionTypes:F,fetchBrewingAlcoholSettings:U,fetchBrewingYearlyShipments:ie,fetchBrewingSeasonalPattern:me}=await Promise.resolve().then(()=>N);return{fetchBrewingPlanSummary:L,fetchBrewingMonthlyTrend:T,fetchBrewingSchedule:O,fetchBrewingProductDetail:V,fetchBrewingCustomCategories:z,fetchBrewingCategoryOverrides:H,fetchAllBrewingStockEntries:B,fetchCategoryTypeLinks:j,fetchAvailableProductionTypes:F,fetchBrewingAlcoholSettings:U,fetchBrewingYearlyShipments:ie,fetchBrewingSeasonalPattern:me}},void 0),k=a.brewingPlanFY,P=`${k}-10-01`,o=`${k+1}-09-30`,[r,d,m,g,$,w,S,_,E,A,q,M]=await Promise.all([t(P,o),n(P,o),s(k),i(P,o),l(),c(),p(),u(),y(),v(),f(),b()]);a.brewingPlanData=r,a.brewingMonthlyTrend=d,a.brewingSchedule=m,a.brewingProductDetail=g,a.brewingCustomCategories=$,a.brewingOverrides=w,a.brewingStockEntries=S,a.brewingTypeLinks=_,a.brewingAvailableTypes=E,a.brewingYearlyShipments=q,a.brewingSeasonalPattern=M,a.brewingAlcoholSettings=A;break}case"/jikomi":a.jikomiList.length===0&&(a.jikomiList=await Qn());break;case"/tanks":a.tankList.length===0&&(a.tankList=await Hn());break;case"/kentei":a.kenteiList.length===0&&(a.kenteiList=await Gn());break;case"/materials":a.materialList.length===0&&(a.materialList=await oa());break;case"/purchase":(a.purchaseList.length===0||a.payableList.length===0)&&([a.purchaseList,a.payableList]=await Promise.all([Xn(),Kn()]));break;case"/raw-material":(a.billList.length===0||a.rawStockList.length===0)&&([a.billList,a.rawStockList]=await Promise.all([Wn(),Zn()]));break;case"/tax":a.taxDeclaration||(a.taxDeclaration=await Aa(a.taxYear,a.taxMonth));break;case"/store":(a.storeSales.length===0||a.storeOrders.length===0)&&([a.storeSales,a.storeOrders]=await Promise.all([La(a.storeSalesDate),as()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await D(async()=>{const{fetchMailSenders:n}=await Promise.resolve().then(()=>N);return{fetchMailSenders:n}},void 0);if(a.mailSenders=await t(),!a.emailSenderId||!a.mailSenders.find(n=>n.id===a.emailSenderId)){const n=a.mailSenders.find(s=>s.isDefault)??a.mailSenders[0];n&&(a.emailSenderId=n.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await D(async()=>{const{fetchCalendarEvents:n}=await Promise.resolve().then(()=>N);return{fetchCalendarEvents:n}},void 0);a.calendarEvents=await t(a.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await D(async()=>{const{fetchIntegrationSettings:n}=await Promise.resolve().then(()=>N);return{fetchIntegrationSettings:n}},void 0);a.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:n}=await D(async()=>{const{fetchShopifyOrders:s,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>N);return{fetchShopifyOrders:s,fetchIntegrationSettings:i}},void 0);a.shopifyOrders=await t(),a.integrations.length===0&&(a.integrations=await n())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:n}=await D(async()=>{const{fetchFaxInbox:s,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>N);return{fetchFaxInbox:s,fetchIntegrationSettings:i}},void 0);a.faxRecords=await t(),a.integrations.length===0&&(a.integrations=await n())}break;case"/users":{const{fetchUserProfiles:t}=await D(async()=>{const{fetchUserProfiles:n}=await Promise.resolve().then(()=>N);return{fetchUserProfiles:n}},void 0);a.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:n,fetchMailSenders:s}=await D(async()=>{const{fetchMyProfile:l,fetchAuditLogs:c,fetchMailSenders:p}=await Promise.resolve().then(()=>N);return{fetchMyProfile:l,fetchAuditLogs:c,fetchMailSenders:p}},void 0),i=a.user?.email??a.myProfile?.email??"";i&&(a.myProfile=await t(i)),a.mailSenders.length===0&&(a.mailSenders=await s()),a.auditLogs=await n(50)}break;case"/audit":{const{fetchAuditLogs:t}=await D(async()=>{const{fetchAuditLogs:n}=await Promise.resolve().then(()=>N);return{fetchAuditLogs:n}},void 0);a.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await D(async()=>{const{fetchProspects:n}=await Promise.resolve().then(()=>N);return{fetchProspects:n}},void 0);a.prospects=await t()}break;case"/map":{const{fetchMapCustomers:t,fetchDeliveryLocations:n}=await D(async()=>{const{fetchMapCustomers:l,fetchDeliveryLocations:c}=await Promise.resolve().then(()=>N);return{fetchMapCustomers:l,fetchDeliveryLocations:c}},void 0),[s,i]=await Promise.all([t(),n()]);a.mapCustomers=s,a.deliveryLocations=i}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:n}=await D(async()=>{const{fetchCallLogs:s,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>N);return{fetchCallLogs:s,fetchIntegrationSettings:i}},void 0);a.callLogs=await t(100),a.integrations.length===0&&(a.integrations=await n())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:n}=await D(async()=>{const{fetchLeadLists:s,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>N);return{fetchLeadLists:s,fetchIntegrationSettings:i}},void 0);a.leadLists=await t(),a.integrations.length===0&&(a.integrations=await n())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await D(async()=>{const{fetchWorkflowOrdersFromDb:n}=await Promise.resolve().then(()=>N);return{fetchWorkflowOrdersFromDb:n}},void 0);a.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await D(async()=>{const{fetchTourInquiriesFromDb:n}=await Promise.resolve().then(()=>N);return{fetchTourInquiriesFromDb:n}},void 0);a.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:n,fetchIntegrationSettings:s}=await D(async()=>{const{fetchSlackRules:i,fetchSlackLogs:l,fetchIntegrationSettings:c}=await Promise.resolve().then(()=>N);return{fetchSlackRules:i,fetchSlackLogs:l,fetchIntegrationSettings:c}},void 0);a.slackRules=await t(),a.slackLogs=await n(50),a.integrations.length===0&&(a.integrations=await s())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:n,fetchWorkflowOrdersFromDb:s,fetchTourInquiriesFromDb:i,fetchOrderHeaders:l}=await D(async()=>{const{fetchProspects:c,fetchCalendarEvents:p,fetchWorkflowOrdersFromDb:u,fetchTourInquiriesFromDb:y,fetchOrderHeaders:v}=await Promise.resolve().then(()=>N);return{fetchProspects:c,fetchCalendarEvents:p,fetchWorkflowOrdersFromDb:u,fetchTourInquiriesFromDb:y,fetchOrderHeaders:v}},void 0);a.prospects.length===0&&(a.prospects=await t()),a.calendarEvents.length===0&&(a.calendarEvents=await n(a.calendarYearMonth)),a.materialList.length===0&&(a.materialList=await oa()),a.workflowOrders.length===0&&(a.workflowOrders=await s()),a.tourInquiries.length===0&&(a.tourInquiries=await i()),a.orderHeaders.length===0&&(a.orderHeaders=await l())}break;default:break}}catch(t){console.error("Route data load error:",e,t),I(`データ読み込みエラー: ${t.message??"不明"}`,"error")}finally{a.actionLoading=!1,x()}}function Pn(){if(Ba())return hl(a.authError,a.authSubmitting);if(a.loading)return`
  ...
  `}async function np(){a.actionLoading=!0,x();try{const{fetchSalesSummary:e}=await D(async()=>{const{fetchSalesSummary:t}=await Promise.resolve().then(()=>N);return{fetchSalesSummary:t}},void 0);a.salesSummary=await e()}finally{a.actionLoading=!1,x()}}async function sp(e){a.actionLoading=!0,x();try{a.invoiceRecords=await mt(e)}finally{a.actionLoading=!1,x()}}async function op(e){a.actionLoading=!0,x();try{a.customerLedger=await Sa(e)}finally{a.actionLoading=!1,x()}}function Ee(e){a.invoiceForm={invoiceType:e.querySelector("#inv-type")?.value??a.invoiceForm.invoiceType,invoiceDate:e.querySelector("#inv-date")?.value??a.invoiceForm.invoiceDate,customerCode:e.querySelector("#inv-customer-code")?.value??a.invoiceForm.customerCode,customerName:e.querySelector("#inv-customer-name")?.value??a.invoiceForm.customerName,staffCode:e.querySelector("#inv-staff")?.value??a.invoiceForm.staffCode,lines:a.invoiceForm.lines.map((t,n)=>{const s=parseFloat(e.querySelector(`[data-line="${n}"][data-field="quantity"]`)?.value??"")||0,i=parseFloat(e.querySelector(`[data-line="${n}"][data-field="unitPrice"]`)?.value??"")||0;return{...t,productCode:e.querySelector(`[data-line="${n}"][data-field="productCode"]`)?.value??t.productCode,productName:e.querySelector(`[data-line="${n}"][data-field="productName"]`)?.value??t.productName,unit:e.querySelector(`[data-line="${n}"][data-field="unit"]`)?.value??t.unit,quantity:s,unitPrice:i,amount:s*i}}),note:e.querySelector("#inv-note")?.value??a.invoiceForm.note},a.invoiceForm.customerCode=a.invoiceForm.customerCode.trim().toUpperCase(),a.invoiceForm.customerName=a.invoiceForm.customerName.trim()}function Re(e){const t=e.querySelector("input[name='email-audience-mode']:checked")?.value??a.emailAudienceMode;a.emailAudienceMode=t,a.emailRegion=e.querySelector("#email-region")?.value??a.emailRegion,a.emailHistorySegment=e.querySelector("#email-history-segment")?.value??a.emailHistorySegment,a.emailSubject=e.querySelector("#email-subject")?.value??a.emailSubject,a.emailBody=e.querySelector("#email-body")?.value??a.emailBody}function ip(e){e.querySelector("[data-action='global-search-open']")?.addEventListener("click",()=>{a.globalSearchOpen=!0,x()}),e.querySelectorAll("[data-action='global-search-close']").forEach(o=>{o.addEventListener("click",r=>{o.classList.contains("global-search")&&r.target instanceof HTMLElement&&!r.target.classList.contains("global-search")||(yt(),x())})}),e.querySelector("#global-search-input")?.addEventListener("input",o=>{a.globalQuery=o.target.value,x()}),e.querySelectorAll("[data-action='global-nav']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.path;r&&(yt(),aa(r))})}),e.querySelector("[data-action='csv-export']")?.addEventListener("click",()=>{Zd()}),e.querySelectorAll("[data-jikomi-tab]").forEach(o=>{o.addEventListener("click",()=>{a.jikomiView=o.dataset.jikomiTab,x()})}),e.querySelector("[data-action='auth-login']")?.addEventListener("click",()=>{const o=e.querySelector("#auth-email")?.value.trim()??"",r=e.querySelector("#auth-password")?.value??"";a.authSubmitting=!0,a.authError=null,x(),Xs(o,r).then(async d=>{a.user=d,a.authSkipped=!1,a.authSubmitting=!1,a.authError=null;const{fetchMyProfile:m,recordAudit:g}=await D(async()=>{const{fetchMyProfile:$,recordAudit:w}=await Promise.resolve().then(()=>N);return{fetchMyProfile:$,recordAudit:w}},void 0);a.myProfile=await m(d.email),await g({action:"sign_in",userEmail:d.email}),x()}).catch(async d=>{try{const m=await Ya(o,r);a.user=m,a.authSkipped=!1,a.authError=null;const{fetchMyProfile:g}=await D(async()=>{const{fetchMyProfile:$}=await Promise.resolve().then(()=>N);return{fetchMyProfile:$}},void 0);a.myProfile=await g(m.email)}catch{a.authError=d instanceof Error?d.message:"ログインに失敗しました。"}finally{a.authSubmitting=!1,x()}})}),e.querySelector("[data-action='auth-skip']")?.addEventListener("click",()=>{a.authSkipped=!0,a.authError=null,x()}),e.querySelector("[data-action='auth-logout']")?.addEventListener("click",()=>{Ks().finally(()=>{location.reload()})}),e.querySelector("[data-action='sidebar-open']")?.addEventListener("click",()=>{a.sidebarOpen=!0,x()}),e.querySelectorAll("[data-action='sidebar-close']").forEach(o=>{o.addEventListener("click",()=>{a.sidebarOpen=!1,x()})});const t=e.querySelector(".sidebar");if(t&&a.sidebarOpen){let o=0;t.addEventListener("touchstart",r=>{o=r.touches[0].clientX},{passive:!0}),t.addEventListener("touchend",r=>{r.changedTouches[0].clientX-o<-60&&(a.sidebarOpen=!1,x())},{passive:!0})}e.querySelectorAll("[data-action='dismiss-announcement']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.id??"";a.dismissedAnnouncements.add(r),x()})}),e.querySelector("[data-action='reload-app']")?.addEventListener("click",()=>{location.reload()}),e.querySelectorAll("[data-link]").forEach(o=>{o.addEventListener("click",r=>{r.preventDefault(),aa(o.dataset.link)})}),e.querySelector("#feature-request-form")?.addEventListener("submit",async o=>{o.preventDefault();const r=e.querySelector("#fr-title")?.value??"",d=e.querySelector("#fr-category")?.value??"feature",m=e.querySelector("#fr-description")?.value??"",g=e.querySelector("#fr-result");if(!r.trim())return;const $=await Bn(r,d,m);if(g&&(g.textContent=$?"送信しました":"送信に失敗しました",g.className=`fr-result ${$?"success":"error"}`),$){const w=e.querySelector("#feature-request-form");w&&w.reset()}}),e.querySelectorAll("[data-period]").forEach(o=>{o.addEventListener("click",()=>{a.salesPeriod=o.dataset.period,x()})}),e.querySelector("[data-action='apply-range']")?.addEventListener("click",()=>{const o=e.querySelector("#range-start")?.value??"",r=e.querySelector("#range-end")?.value??"";o&&r&&(a.customRange={start:o,end:r},a.salesPeriod="custom",x())}),e.querySelectorAll("[data-edit-customer]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.editCustomer??"",d=a.masterStats?.customers.find(g=>g.id===r);if(!d)return;const m=document.createElement("div");m.innerHTML=fl(d),document.body.appendChild(m.firstElementChild),document.querySelector("[data-action='close-modal']")?.addEventListener("click",()=>{document.getElementById("edit-modal")?.remove()}),document.getElementById("edit-customer-form")?.addEventListener("submit",async g=>{g.preventDefault();const $=document.getElementById("edit-result"),w=await Fn(r,{name:document.getElementById("ec-name").value,kana_name:document.getElementById("ec-kana").value,phone:document.getElementById("ec-phone").value,fax:document.getElementById("ec-fax").value,postal_code:document.getElementById("ec-postal").value,address1:document.getElementById("ec-address").value,closing_day:parseInt(document.getElementById("ec-closing").value)||null,payment_day:parseInt(document.getElementById("ec-payment").value)||null,manual_override:!0});$&&($.textContent=w?"保存しました":"保存に失敗",$.className=`fr-result ${w?"success":"error"}`),w&&(document.getElementById("edit-modal")?.remove(),Ge())})})}),e.querySelectorAll("[data-edit-product]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.editProduct??"",d=a.masterStats?.products.find(g=>g.id===r);if(!d)return;const m=document.createElement("div");m.innerHTML=gl(d),document.body.appendChild(m.firstElementChild),document.querySelector("[data-action='close-modal']")?.addEventListener("click",()=>{document.getElementById("edit-modal")?.remove()}),document.getElementById("edit-product-form")?.addEventListener("submit",async g=>{g.preventDefault();const $=document.getElementById("edit-result"),w=await Vn(r,{name:document.getElementById("ep-name").value,category_code:document.getElementById("ep-category").value,alcohol_degree:parseFloat(document.getElementById("ep-alcohol").value)||null,volume_ml:parseInt(document.getElementById("ep-volume").value)||null,bottle_type:document.getElementById("ep-bottle").value,purchase_price:parseInt(document.getElementById("ep-purchase").value)||null,default_sale_price:parseInt(document.getElementById("ep-sale").value)||null,manual_override:!0});$&&($.textContent=w?"保存しました":"保存に失敗",$.className=`fr-result ${w?"success":"error"}`),w&&(document.getElementById("edit-modal")?.remove(),Ge())})})}),e.querySelector("[data-action='quote-new']")?.addEventListener("click",()=>{a.quoteState=Tt(a.quoteCompanySettings),a.quoteEditId="new",a.quoteCustomerQuery="",a.quoteProductQuery="",a.quotePricing=null,x()}),e.querySelectorAll("[data-open-quote]").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.openQuote,d=await us(r);if(!d){I("見積の読み込みに失敗しました","error");return}a.quoteState={id:d.id,quoteNo:d.quote_no,quoteDate:d.quote_date,validUntil:d.valid_until??"",customerCode:d.legacy_customer_code??"",customerName:d.customer_name,customerAddress:d.customer_address,subject:d.subject,lines:d.lines.map(m=>({productCode:m.legacy_product_code??"",productName:m.product_name,janCode:m.jan_code??"",caseQty:m.case_qty,quantity:m.quantity,unit:m.unit,unitPrice:m.unit_price,retailPrice:m.retail_price,amount:m.amount})),remarks:d.remarks,taxRate:d.tax_rate,deliveryDate:d.delivery_date,paymentTerms:d.payment_terms,deliveryPlace:d.delivery_place,templateType:d.template_type??"sake",previewMode:!1},a.quoteEditId=r,a.quoteCustomerQuery="",a.quoteProductQuery="",a.quotePricing=null,x()})}),e.querySelectorAll("[data-delete-quote]").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.deleteQuote,d=o.dataset.quoteNo??r;if(!await be(`見積 ${d} を削除しますか？`))return;await En("quotes",r)?(a.quoteList=a.quoteList.filter($=>$.id!==r),I("削除しました","success"),x()):I("削除に失敗しました","error")})}),e.querySelector("[data-action='quote-back-list']")?.addEventListener("click",()=>{a.quoteEditId=null,a.quoteListLoading=!0,x(),Ta().then(o=>{a.quoteList=o,a.quoteListLoading=!1,x()})}),e.querySelectorAll("[name='q-template']").forEach(o=>{o.addEventListener("change",()=>{a.quoteState.templateType=o.value,x()})});function n(o){return(o??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function s(o){return o.length?o.map(r=>`<button class="search-item" type="button" data-select-customer="${n(r.code)}" data-cust-name="${n(r.name)}" data-cust-addr="${n(r.address1||"")}"><span class="mono">${n(r.code)}</span><span style="font-size:13px;font-weight:600;">${n(r.name)}</span></button>`).join(""):'<p style="padding:10px 12px;color:var(--text-secondary);font-size:13px;">該当なし</p>'}function i(o){o.querySelectorAll("[data-select-customer]").forEach(r=>{r.addEventListener("click",async()=>{const d=r.dataset.selectCustomer??"";a.quoteState.customerCode=d,a.quoteState.customerName=r.dataset.custName??"",a.quoteState.customerAddress=r.dataset.custAddr??"",a.quoteCustomerQuery="";const m=e.querySelector("#q-cust-search");m&&(m.value=""),o.remove(),a.quotePricing=await sa(a.masterStats?.customers??[],d),x()})})}function l(o){const r=e.querySelector("#q-cust-search")?.closest(".form-row");if(!r)return;let d=document.getElementById("cust-search-results");d||(d=document.createElement("div"),d.id="cust-search-results",d.className="search-results",r.after(d));const m=a.masterStats?.customers??[],g=o.trim().toLowerCase(),$=g.length===0?m:m.filter(w=>w.name.includes(o)||w.kanaName.includes(o)||w.code.includes(o)||w.name.toLowerCase().includes(g)||w.kanaName.toLowerCase().includes(g));d.innerHTML=s($),i(d)}function c(o,r){return o.length?o.map(d=>{const m=r?Ca(d,r):{price:d.salePrice||0,label:"卸価格"},g=d.listPrice||0,$=m.label!=="標準価格"&&m.label!=="卸価格";return`<button class="search-item" type="button" data-add-product="${n(d.code)}" data-prod-name="${n(d.name)}" data-prod-price="${m.price}" data-prod-retail="${g}" data-prod-jan="${n(d.janCode??"")}" data-prod-unit="${n(d.unit)}" data-prod-case="${d.caseQty??""}"><span class="mono">${n(d.code)}</span><span style="font-size:13px;font-weight:600;line-height:1.4;">${n(d.name)}</span><span class="numeric"${$?' style="color:#2f855a;font-weight:700;"':""}>納入 ¥${m.price?m.price.toLocaleString("ja-JP"):"未設定"}<small style="font-weight:400;margin-left:4px;">(${n(m.label)})</small>${g?`　定価 ¥${g.toLocaleString("ja-JP")}`:""}</span></button>`}).join(""):'<p style="padding:10px 12px;color:var(--text-secondary);font-size:13px;">該当なし</p>'}function p(o){o.querySelectorAll("[data-add-product]").forEach(r=>{r.addEventListener("click",()=>{const d=r.dataset.addProduct??"",m=r.dataset.prodName??"",g=parseInt(r.dataset.prodPrice??"0"),$=parseInt(r.dataset.prodRetail??"0")||null,w=r.dataset.prodJan??"",S=r.dataset.prodUnit||"本",_=r.dataset.prodCase??"",E=_?parseInt(_):null;a.quoteState.lines.push({productCode:d,productName:m,janCode:w,caseQty:E,quantity:1,unit:S,unitPrice:g,retailPrice:$,amount:g}),a.quoteProductQuery="";const A=e.querySelector("#q-prod-search");A&&(A.value=""),x()})})}function u(o){const r=e.querySelector("#q-prod-search")?.closest(".form-row");if(!r)return;let d=document.getElementById("prod-search-results");if(d||(d=document.createElement("div"),d.id="prod-search-results",d.className="search-results",r.after(d)),!a.masterStats){d.innerHTML='<p style="padding:10px 12px;color:var(--text-secondary);font-size:13px;">マスタ読込中…</p>';return}const m=a.masterStats.products,g=o.trim().toLowerCase(),$=g.length===0?m:m.filter(w=>w.name.includes(o)||w.kanaName.includes(o)||w.code.includes(o)||w.name.toLowerCase().includes(g)||w.kanaName.toLowerCase().includes(g));d.innerHTML=c($,a.quotePricing),p(d)}function y(o,r){let d=null;function m(){d||(d=g=>{const $=document.getElementById(r);if(!$){document.removeEventListener("touchstart",d),document.removeEventListener("mousedown",d),d=null;return}o.contains(g.target)||$.contains(g.target)||($.remove(),document.removeEventListener("touchstart",d),document.removeEventListener("mousedown",d),d=null)},document.addEventListener("touchstart",d,{passive:!0}),document.addEventListener("mousedown",d))}return m}(function(){const o=e.querySelector("#q-cust-search");if(!o)return;const r=y(o,"cust-search-results");o.addEventListener("focus",()=>{l(o.value),r()}),o.addEventListener("compositionend",()=>{a.quoteCustomerQuery=o.value,l(o.value)}),o.addEventListener("input",d=>{d.isComposing||(a.quoteCustomerQuery=o.value,l(o.value))}),o.value&&l(o.value)})(),(function(){const o=e.querySelector("#q-prod-search");if(!o)return;const r=y(o,"prod-search-results");o.addEventListener("focus",()=>{u(o.value),r()}),o.addEventListener("compositionend",()=>{a.quoteProductQuery=o.value,u(o.value)}),o.addEventListener("input",d=>{d.isComposing||(a.quoteProductQuery=o.value,u(o.value))}),o.value&&u(o.value)})(),e.querySelectorAll("[data-select-customer]").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.selectCustomer??"";a.quoteState.customerCode=r,a.quoteState.customerName=o.dataset.custName??"",a.quoteState.customerAddress=o.dataset.custAddr??"",a.quoteState.isProspect=!1,a.quoteState.manualPriceType=void 0,a.quoteCustomerQuery="",a.quotePricing=await sa(a.masterStats?.customers??[],r),x()})}),e.querySelector("#q-price-type")?.addEventListener("change",o=>{const r=o.target.value;a.quoteState.manualPriceType=r,a.quotePricing?a.quotePricing={...a.quotePricing,priceType:r}:a.quotePricing={priceType:r,priceGroup:"",individualPrices:new Map},x()}),e.querySelectorAll("[data-add-product]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.addProduct??"",d=o.dataset.prodName??"",m=parseInt(o.dataset.prodPrice??"0"),g=parseInt(o.dataset.prodRetail??"0")||null,$=o.dataset.prodJan??"",w=o.dataset.prodUnit||"本",S=o.dataset.prodCase??"",_=S?parseInt(S):null;a.quoteState.lines.push({productCode:r,productName:d,janCode:$,caseQty:_,quantity:1,unit:w,unitPrice:m,retailPrice:g,amount:m}),a.quoteProductQuery="",x()})}),(()=>{const o=e.querySelector("#q-prospect-search");if(!o)return;const r=y(o,"q-prospect-results");function d(m){let g=document.getElementById("q-prospect-results");if(!g)return;const $=m.trim(),w=$.length===0?a.prospects.slice(0,8):a.prospects.filter(S=>S.companyName.includes($)||(S.contactName??"").includes($)).slice(0,8);if(w.length===0){g.innerHTML="";return}g.className="search-results",g.innerHTML=w.map(S=>`<button class="search-item" type="button" data-select-prospect="${S.id}" data-prospect-name="${n(S.companyName)}" data-prospect-addr="${n(S.address??"")}"><span style="font-size:13px;font-weight:600;">${n(S.companyName)}</span><span style="font-size:11px;color:var(--text-secondary);margin-left:8px;">${n(S.contactName??"")} ${S.address?"· "+S.address.slice(0,20):""}</span></button>`).join(""),g.querySelectorAll("[data-select-prospect]").forEach(S=>{S.addEventListener("click",()=>{a.quoteState.customerCode="",a.quoteState.customerName=S.dataset.prospectName??"",a.quoteState.customerAddress=S.dataset.prospectAddr??"",a.quoteState.isProspect=!0,a.quoteState.prospectId=S.dataset.selectProspect??"";const _=a.quoteState.manualPriceType??"";a.quotePricing={priceType:_,priceGroup:"",individualPrices:new Map},o.value="",g&&(g.innerHTML=""),x()})})}o.addEventListener("focus",()=>{d(o.value),r()}),o.addEventListener("input",m=>{m.isComposing||d(o.value)}),o.addEventListener("compositionend",()=>d(o.value))})(),e.querySelector("[data-action='new-prospect-from-quote']")?.addEventListener("click",()=>{const o=e.querySelector("#q-prospect-search")?.value.trim()??"",r=document.createElement("div");r.className="modal-backdrop",r.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);display:flex;align-items:flex-start;justify-content:center;z-index:9999;overflow-y:auto;padding:16px 0;",r.innerHTML=`
    ...
    `,document.body.appendChild(r),r.querySelector("#pq-company")?.focus();const d=()=>r.remove();r.addEventListener("click",m=>{m.target===r&&d()}),r.querySelector("#prospect-quick-close")?.addEventListener("click",d),r.querySelector("#prospect-quick-close2")?.addEventListener("click",d),r.querySelector("#prospect-quick-save")?.addEventListener("click",async()=>{const m=(r.querySelector("#pq-company")?.value??"").trim();if(!m){I("会社名は必須です","warning");return}const g={id:`p_${Date.now()}`,companyName:m,contactName:r.querySelector("#pq-contact")?.value.trim()||void 0,address:r.querySelector("#pq-address")?.value.trim()||void 0,phone:r.querySelector("#pq-phone")?.value.trim()||void 0,note:r.querySelector("#pq-note")?.value.trim()||void 0,stage:"warm",expectedAmount:0,probability:30},{saveProspect:$,fetchProspects:w}=await D(async()=>{const{saveProspect:E,fetchProspects:A}=await Promise.resolve().then(()=>N);return{saveProspect:E,fetchProspects:A}},void 0),S=await $(g);if(!S){I("登録失敗","error");return}a.prospects=await w(),a.quoteState.customerCode="",a.quoteState.customerName=S.companyName,a.quoteState.customerAddress=S.address??"",a.quoteState.isProspect=!0,a.quoteState.prospectId=S.id;const _=a.quoteState.manualPriceType??"";a.quotePricing={priceType:_,priceGroup:"",individualPrices:new Map},d(),I(`${S.companyName} を見込み顧客として登録しました`,"success"),x()})});function v(){$t(a.quoteState);const o=e.querySelector("#q-preview-scaler");if(!o)return;o.innerHTML=xs(a.quoteState,a.masterStats?.customers??[],a.masterStats?.products??[],a.quoteCustomerQuery,a.quoteProductQuery,a.quotePricing,a.quoteCompanySettings);const r=o.querySelector(".q-preview-doc"),d=o.parentElement?.clientWidth??0,m=r?.offsetWidth??0;if(d>0&&m>0&&m>d-24){const g=(d-24)/m;o.style.transform=`scale(${g})`,o.style.transformOrigin="top left",o.style.height=`${((r?.offsetHeight??0)+48)*g}px`}else o.style.transform="",o.style.height=""}for(const o of["q-no","q-date","q-valid","q-subject","q-payment-terms","q-delivery-date","q-delivery-place"])e.querySelector(`#${o}`)?.addEventListener("input",v);e.querySelector("#q-remarks")?.addEventListener("input",v),e.querySelectorAll(".qty-input").forEach(o=>{o.addEventListener("change",()=>{const r=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[r];d&&(d.quantity=parseFloat(o.value)||0,d.amount=d.quantity*d.unitPrice,v())})}),e.querySelectorAll(".price-input").forEach(o=>{o.addEventListener("change",()=>{const r=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[r];d&&(d.unitPrice=parseInt(o.value)||0,d.amount=d.quantity*d.unitPrice,v())})}),e.querySelectorAll(".jan-input").forEach(o=>{o.addEventListener("change",()=>{const r=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[r];d&&(d.janCode=o.value,v())})}),e.querySelectorAll(".case-qty-input").forEach(o=>{o.addEventListener("change",()=>{const r=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[r];d&&(d.caseQty=o.value?parseInt(o.value):null,v())})}),e.querySelectorAll(".retail-price-input").forEach(o=>{o.addEventListener("change",()=>{const r=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[r];d&&(d.retailPrice=o.value?parseInt(o.value):null,v())})}),e.querySelectorAll("[data-remove-line]").forEach(o=>{o.addEventListener("click",()=>{const r=parseInt(o.dataset.removeLine??"0");a.quoteState.lines.splice(r,1),x()})}),e.querySelector("[data-action='quote-preview-mode']")?.addEventListener("click",()=>{$t(a.quoteState),a.quoteState.previewMode=!0,x()}),e.querySelector("[data-action='quote-edit-mode']")?.addEventListener("click",()=>{a.quoteState.previewMode=!1,x()}),e.querySelector("[data-action='quote-download-pdf']")?.addEventListener("click",async o=>{const r=o.currentTarget;r.disabled=!0,r.textContent="生成中…",$t(a.quoteState);try{await Zr(a.quoteState,a.quoteCompanySettings)}finally{r.disabled=!1,r.textContent="PDF"}}),e.querySelector("[data-action='save-quote']")?.addEventListener("click",async()=>{$t(a.quoteState);const o=a.quoteState,r=o.lines.reduce((S,_)=>S+_.amount,0),d=Math.round(r*o.taxRate/100),m=r+d;if(!o.quoteNo)try{const{supabaseRpc:S}=await D(async()=>{const{supabaseRpc:E}=await Promise.resolve().then(()=>X);return{supabaseRpc:E}},void 0),_=await S("generate_quote_no",{});o.quoteNo=_??`Q${new Date().toISOString().slice(0,10).replace(/-/g,"")}-${Math.floor(Math.random()*1e3).toString().padStart(3,"0")}`}catch{o.quoteNo=`Q${new Date().toISOString().slice(0,10).replace(/-/g,"")}-${Math.floor(Math.random()*1e3).toString().padStart(3,"0")}`}const g=new Date().toISOString().slice(0,10),$=o.templateType==="sake"||o.templateType==="standard"?o.templateType:"sake",w={quote_no:o.quoteNo,quote_date:o.quoteDate||g,valid_until:o.validUntil||null,legacy_customer_code:o.customerCode||null,customer_name:o.customerName||"",customer_address:o.customerAddress||"",subject:o.subject||"",template_type:$,subtotal:r,tax_amount:d,total_amount:m,tax_rate:o.taxRate||10,remarks:o.remarks||"",delivery_date:o.deliveryDate||"",payment_terms:o.paymentTerms||"",delivery_place:o.deliveryPlace||"",updated_at:new Date().toISOString()};try{let S=o.id;if(o.id){const _=await fetch(`${he}/rest/v1/quotes?id=eq.${encodeURIComponent(o.id)}`,{method:"PATCH",headers:{apikey:ee,Authorization:`Bearer ${ee}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(w)});if(!_.ok){const E=await _.text();throw new Error(`quotes更新失敗 ${_.status}: ${E}`)}await fetch(`${he}/rest/v1/quote_lines?quote_id=eq.${encodeURIComponent(o.id)}`,{method:"DELETE",headers:{apikey:ee,Authorization:`Bearer ${ee}`}})}else{const _=await fetch(`${he}/rest/v1/quotes`,{method:"POST",headers:{apikey:ee,Authorization:`Bearer ${ee}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(w)});if(!_.ok){const A=await _.text();throw new Error(`quotes作成失敗 ${_.status}: ${A}`)}const E=await _.json();if(!E?.[0]?.id)throw new Error("IDが返りませんでした");S=E[0].id,o.id=S}if(o.lines.length>0){const _=o.lines.map((A,q)=>({quote_id:S,line_no:q+1,legacy_product_code:A.productCode||null,product_name:A.productName,jan_code:A.janCode||null,case_qty:A.caseQty??null,quantity:A.quantity,unit:A.unit,unit_price:A.unitPrice,retail_price:A.retailPrice??null,amount:A.amount})),E=await fetch(`${he}/rest/v1/quote_lines`,{method:"POST",headers:{apikey:ee,Authorization:`Bearer ${ee}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(_)});if(!E.ok){const A=await E.text();throw new Error(`明細保存失敗 ${E.status}: ${A}`)}}I(`見積 ${o.quoteNo} を保存しました`,"success"),x()}catch(S){console.error("[save-quote]",S),I(`保存失敗: ${String(S).slice(0,120)}`,"error")}}),e.querySelector("[data-action='save-quote-settings']")?.addEventListener("click",()=>{const o=d=>document.getElementById(d)?.value??"",r={...a.quoteCompanySettings,companyName:o("qs-company-name"),companyPostal:o("qs-company-postal"),companyAddress1:o("qs-company-addr1"),companyAddress2:o("qs-company-addr2"),companyTel:o("qs-company-tel"),companyFax:o("qs-company-fax"),companyEmail:o("qs-company-email"),companyRegistrationNo:o("qs-company-regno"),bankName:o("qs-bank-name"),bankBranch:o("qs-bank-branch"),bankAccountType:o("qs-bank-type"),bankAccountNo:o("qs-bank-no"),bankAccountHolder:o("qs-bank-holder"),defaultPaymentTerms:o("qs-payment-terms"),defaultHeaderNote:o("qs-header-note"),defaultFooterNote:o("qs-footer-note"),accentColor:document.getElementById("qs-accent-color")?.value||a.quoteCompanySettings.accentColor||"#0968e5"};ze(r),Qe("quote_company",r),a.quoteCompanySettings=r,I("設定を保存しました","success"),x()}),e.querySelectorAll("[data-action='set-accent-color']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.color??"#0968e5";a.quoteCompanySettings={...a.quoteCompanySettings,accentColor:r},ze(a.quoteCompanySettings),Qe("quote_company",a.quoteCompanySettings),x()})}),e.querySelector("#qs-accent-color")?.addEventListener("input",o=>{const r=o.target.value;a.quoteCompanySettings={...a.quoteCompanySettings,accentColor:r},ze(a.quoteCompanySettings),x()}),e.querySelector("#qs-seal-file")?.addEventListener("change",o=>{const r=o.target.files?.[0];if(!r)return;const d=new FileReader;d.onload=()=>{a.quoteCompanySettings={...a.quoteCompanySettings,sealImageDataUrl:d.result},ze(a.quoteCompanySettings),Qe("quote_company",a.quoteCompanySettings),x()},d.readAsDataURL(r)}),e.querySelector("#qs-seal-size")?.addEventListener("input",o=>{const r=parseInt(o.target.value);a.quoteCompanySettings={...a.quoteCompanySettings,sealSize:r},ze(a.quoteCompanySettings),Qe("quote_company",a.quoteCompanySettings),x()}),e.querySelector("[data-action='remove-company-seal']")?.addEventListener("click",()=>{a.quoteCompanySettings={...a.quoteCompanySettings,sealImageDataUrl:""},ze(a.quoteCompanySettings),Qe("quote_company",a.quoteCompanySettings),x()}),e.querySelectorAll("[data-action='dcal-prev'],[data-action='dcal-next']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.month;r&&(a.demandForecast.calendarMonth=r,x())})}),e.querySelectorAll("[data-action='forecast-segment']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.segment;a.demandForecast.selectedSegment=r,x()})}),e.querySelectorAll("[data-demand-tab]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.demandTab;if(r){if(a.demandTab=r,r==="calendar"){const d=new Date().toISOString().slice(0,10);d.startsWith(a.demandPlanYearMonth)&&(a.calendarSelectedDate=d)}x()}})});function f(o){const r=a.demandAnalysis,d=a.safetyStockParams;if(!r||d.length===0)return[];const[m,g]=o.split("-"),$=`${parseInt(m)-1}-${g}`,w=r.months.filter(S=>S<o).slice(-3);return d.map(S=>{const _=S.productionType==="make_to_order",E=r.matrix[S.productCode]?.[$]??0,A=w.map(O=>r.matrix[S.productCode]?.[O]??0),q=A.length>0?A.reduce((O,V)=>O+V,0)/A.length:S.avgMonthlyDemand,M=_?0:E>0?Math.ceil(E):Math.ceil(q),L=_?0:Math.ceil(S.safetyStockQty),T=Math.max(0,M+L);return{id:"",yearMonth:o,productCode:S.productCode,productName:S.productName,demandForecast:M,safetyStockTarget:L,openingStock:0,requiredProduction:T,plannedQty:_?0:T,actualQty:0,status:"draft",productionType:S.productionType??"monthly",notes:""}})}e.querySelector("[data-action='demand-years-back']")?.addEventListener("change",async o=>{const r=parseInt(o.target.value)||3;a.demandYearsBack=r,a.demandAnalysis=null;const{fetchDemandAnalysis:d}=await D(async()=>{const{fetchDemandAnalysis:m}=await Promise.resolve().then(()=>N);return{fetchDemandAnalysis:m}},void 0);a.demandAnalysis=await d(r*12),x()}),e.querySelectorAll("[data-action='ss-lead-time']").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.code??"",d=parseInt(o.value)||30;a.safetyStockParams=a.safetyStockParams.map(m=>{if(m.productCode!==r)return m;const g=m.serviceLevel>=.99?2.33:m.serviceLevel>=.97?1.88:m.serviceLevel>=.95?1.65:m.serviceLevel>=.9?1.28:1.04,$=d/30,w=Math.ceil(g*m.demandStdDev*Math.sqrt($)),S=Math.ceil(m.avgMonthlyDemand*$+w);return{...m,leadTimeDays:d,safetyStockQty:w,reorderPoint:S}}),x()})}),e.querySelectorAll("[data-action='ss-service-level']").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.code??"",d=parseFloat(o.value)||.95;a.safetyStockParams=a.safetyStockParams.map(m=>{if(m.productCode!==r)return m;const g=d>=.99?2.33:d>=.97?1.88:d>=.95?1.65:d>=.9?1.28:1.04,$=m.leadTimeDays/30,w=Math.ceil(g*m.demandStdDev*Math.sqrt($)),S=Math.ceil(m.avgMonthlyDemand*$+w);return{...m,serviceLevel:d,safetyStockQty:w,reorderPoint:S}}),x()})}),e.querySelector("[data-action='ss-save-all']")?.addEventListener("click",async o=>{if(a.safetyStockParams.length===0)return;const r=o.currentTarget;r.disabled=!0,r.textContent="保存中…";const{saveSafetyStockParamsBulk:d}=await D(async()=>{const{saveSafetyStockParamsBulk:g}=await Promise.resolve().then(()=>N);return{saveSafetyStockParamsBulk:g}},void 0),m=await d(a.safetyStockParams);r.disabled=!1,r.textContent=m?"✓ 保存しました":"✗ 保存失敗",setTimeout(()=>{r.textContent="安全在庫を保存"},2500)}),e.querySelector("[data-action='bulk-apply-safety']")?.addEventListener("click",()=>{const o=parseFloat(document.getElementById("bulk-service-level")?.value??"0.95"),r=parseInt(document.getElementById("bulk-lead-time")?.value??"30");a.safetyStockParams=a.safetyStockParams.map(d=>{const m=o>=.99?2.33:o>=.97?1.88:o>=.95?1.65:o>=.9?1.28:1.04,g=r/30,$=Math.ceil(m*d.demandStdDev*Math.sqrt(g)),w=Math.ceil(d.avgMonthlyDemand*g+$);return{...d,serviceLevel:o,leadTimeDays:r,safetyStockQty:$,reorderPoint:w}}),x()}),e.querySelectorAll("[data-action='plan-prod-type']").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.code??"",d=o.value;a.productionPlan=a.productionPlan.map(m=>m.productCode===r?{...m,productionType:d}:m)})}),e.querySelector("[data-action='plan-year-month']")?.addEventListener("change",async o=>{const r=o.target.value;if(!r)return;a.demandPlanYearMonth=r,a.calendarShifts=Lt(r,1,0);const{fetchProductionPlan:d}=await D(async()=>{const{fetchProductionPlan:g}=await Promise.resolve().then(()=>N);return{fetchProductionPlan:g}},void 0),m=await d(r);a.productionPlan=m.length>0?m:f(r),Pe(a.calendarShifts,a.productionPlan.filter(g=>!a.calendarLabelExcluded.has(g.productCode)),a.calendarCapacity),x()}),e.querySelectorAll("[data-action='plan-type-filter']").forEach(o=>{o.addEventListener("click",()=>{a.demandPlanTypeFilter=o.dataset.filter??"all",x()})}),e.querySelectorAll("[data-action='demand-sort']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.sortCol??"";a.demandSort?.column===r?a.demandSort=a.demandSort.dir==="desc"?{column:r,dir:"asc"}:null:a.demandSort={column:r,dir:"desc"},x()})}),e.querySelector("[data-action='plan-recalc']")?.addEventListener("click",()=>{a.productionPlan=f(a.demandPlanYearMonth),x()}),e.querySelector("[data-action='plan-csv-import']")?.addEventListener("change",o=>{const r=o.target.files?.[0];if(!r)return;const d=new FileReader;d.onload=async()=>{const{parseCSV:m}=await D(async()=>{const{parseCSV:L}=await Promise.resolve().then(()=>Mc);return{parseCSV:L}},void 0),{columns:g,rows:$}=m(d.result),w=document.getElementById("csv-import-status"),S=g.find(L=>/商品コード|product_code|code|コード/i.test(L)),_=g.find(L=>/在庫|stock|期首|opening/i.test(L)),E=g.find(L=>/計画|plan|planned|生産/i.test(L));if(!S){w&&(w.style.display="block",w.style.background="rgba(197,61,61,0.1)",w.style.color="#c53d3d",w.textContent=`エラー: 商品コード列が見つかりません。列名: ${g.join(", ")}`);return}let A=0,q=0,M=0;for(const L of $){const T=(L[S]??"").trim();if(!T)continue;const O=a.productionPlan.find(V=>V.productCode===T);if(O){if(A++,_&&L[_]!==void 0&&L[_]!==""){const V=parseFloat(L[_])||0;O.openingStock=V,O.requiredProduction=Math.max(0,O.demandForecast+O.safetyStockTarget-V),O.plannedQty>0&&!E&&(O.plannedQty=O.requiredProduction),q++}E&&L[E]!==void 0&&L[E]!==""&&(O.plannedQty=parseFloat(L[E])||0,M++)}}w&&(w.style.display="block",A===0?(w.style.background="rgba(183,121,31,0.1)",w.style.color="#b7791f",w.textContent=`一致する商品コードが見つかりませんでした（CSV: ${$.length}行）`):(w.style.background="rgba(47,133,90,0.1)",w.style.color="#2f855a",w.textContent=`${A}商品に反映: 在庫${q}件${M>0?` / 計画${M}件`:""} 更新`),setTimeout(()=>{w.style.display="none"},5e3)),x()},d.readAsText(r,"UTF-8"),o.target.value=""}),e.querySelector("[data-action='plan-save']")?.addEventListener("click",async()=>{if(a.productionPlan.length===0)return;e.querySelectorAll("[data-action='plan-qty']").forEach(d=>{const m=d.dataset.code??"",g=a.productionPlan.find($=>$.productCode===m);g&&(g.plannedQty=parseFloat(d.value)||0)});const{saveProductionPlan:o}=await D(async()=>{const{saveProductionPlan:d}=await Promise.resolve().then(()=>N);return{saveProductionPlan:d}},void 0);await Promise.all(a.productionPlan.map(d=>o(d)));const{fetchProductionPlan:r}=await D(async()=>{const{fetchProductionPlan:d}=await Promise.resolve().then(()=>N);return{fetchProductionPlan:d}},void 0);a.productionPlan=await r(a.demandPlanYearMonth),x()}),e.querySelectorAll("[data-action='cal-toggle-day']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.date??"",d=a.calendarShifts.find(m=>m.date===r);d&&(d.confirmed?a.calendarSelectedDate=a.calendarSelectedDate===r?null:r:d.partTimers>0||d.employees>0?(d.partTimers=0,d.employees=0,Pe(a.calendarShifts,a.productionPlan.filter(m=>!a.calendarLabelExcluded.has(m.productCode)),a.calendarCapacity),a.calendarSelectedDate=r):(d.partTimers=1,d.employees=0,Pe(a.calendarShifts,a.productionPlan.filter(m=>!a.calendarLabelExcluded.has(m.productCode)),a.calendarCapacity),a.calendarSelectedDate=r),x())})}),e.querySelector("[data-action='cal-save-exclusions']")?.addEventListener("click",async o=>{const r=o.currentTarget;r.disabled=!0,r.textContent="保存中…";const{saveLabelExclusions:d}=await D(async()=>{const{saveLabelExclusions:$}=await Promise.resolve().then(()=>N);return{saveLabelExclusions:$}},void 0),m=[...a.calendarLabelExcluded],g=await d(a.demandPlanYearMonth,m);r.disabled=!1,r.textContent=g?"✓ 保存しました":"✗ 保存失敗",setTimeout(()=>{r.textContent="設定を保存"},2500)}),e.querySelectorAll("[data-action='cal-label-toggle']").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.code??"",m=document.getElementById("cal-label-list")?.scrollTop??0;o.checked?a.calendarLabelExcluded.delete(r):a.calendarLabelExcluded.add(r);const g=a.productionPlan.filter($=>!a.calendarLabelExcluded.has($.productCode));Pe(a.calendarShifts,g,a.calendarCapacity),x(),requestAnimationFrame(()=>{const $=document.getElementById("cal-label-list");$&&($.scrollTop=m)})})}),e.querySelectorAll("[data-action='cal-label-toggle-group']").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.type??"",m=document.getElementById("cal-label-list")?.scrollTop??0,g=a.productionPlan.filter(w=>w.productionType===r);if(o.checked)for(const w of g)a.calendarLabelExcluded.delete(w.productCode);else for(const w of g)a.calendarLabelExcluded.add(w.productCode);const $=a.productionPlan.filter(w=>!a.calendarLabelExcluded.has(w.productCode));Pe(a.calendarShifts,$,a.calendarCapacity),x(),requestAnimationFrame(()=>{const w=document.getElementById("cal-label-list");w&&(w.scrollTop=m)})})}),e.querySelector("[data-action='cal-cap-part']")?.addEventListener("change",o=>{const r=parseInt(o.target.value)||Ze;a.calendarCapacity.partCapacity=r;const d=a.productionPlan.filter(m=>!a.calendarLabelExcluded.has(m.productCode));Pe(a.calendarShifts,d,a.calendarCapacity),x()}),e.querySelector("[data-action='cal-cap-emp']")?.addEventListener("change",o=>{const r=parseInt(o.target.value)||et;a.calendarCapacity.empCapacity=r;const d=a.productionPlan.filter(m=>!a.calendarLabelExcluded.has(m.productCode));Pe(a.calendarShifts,d,a.calendarCapacity),x()}),e.querySelectorAll("[data-action='cal-shift-part']").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.date??"",d=parseInt(o.value)||0,m=a.calendarShifts.find(g=>g.date===r);m&&(m.partTimers=d),x()})}),e.querySelectorAll("[data-action='cal-shift-emp']").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.date??"",d=parseInt(o.value)||0,m=a.calendarShifts.find(g=>g.date===r);m&&(m.employees=d),x()})}),e.querySelector("[data-action='cal-year-month']")?.addEventListener("change",async o=>{const r=o.target.value;if(!r)return;a.demandPlanYearMonth=r,a.calendarSelectedDate=null,a.calendarShifts=Lt(r,1,0);const{fetchProductionPlan:d,fetchLabelExclusions:m}=await D(async()=>{const{fetchProductionPlan:w,fetchLabelExclusions:S}=await Promise.resolve().then(()=>N);return{fetchProductionPlan:w,fetchLabelExclusions:S}},void 0),[g,$]=await Promise.all([d(r),m(r)]);a.productionPlan=g.length>0?g:f(r),a.calendarLabelExcluded=new Set($),Pe(a.calendarShifts,a.productionPlan.filter(w=>!a.calendarLabelExcluded.has(w.productCode)),a.calendarCapacity),x()}),e.querySelector("[data-action='cal-default-part']")?.addEventListener("change",o=>{const r=parseInt(o.target.value)||0;a.calendarDefaultPart=r;for(const d of a.calendarShifts)if(!d.confirmed){const m=new Date(d.date).getDay()===0||new Date(d.date).getDay()===6;d.partTimers=m?0:r}x()}),e.querySelector("[data-action='cal-default-emp']")?.addEventListener("change",o=>{const r=parseInt(o.target.value)||0;a.calendarDefaultEmp=r;for(const d of a.calendarShifts)if(!d.confirmed){const m=new Date(d.date).getDay()===0||new Date(d.date).getDay()===6;d.employees=m?0:r}x()}),e.querySelector("[data-action='cal-reset-shifts']")?.addEventListener("click",()=>{a.calendarShifts=Lt(a.demandPlanYearMonth,1,0),Pe(a.calendarShifts,a.productionPlan.filter(o=>!a.calendarLabelExcluded.has(o.productCode)),a.calendarCapacity),x()}),e.querySelector("[data-action='cal-confirm-all']")?.addEventListener("click",()=>{for(const o of a.calendarShifts)o.confirmed=!0;x()}),e.querySelectorAll("[data-action='select-month']").forEach(o=>{o.addEventListener("click",()=>{const r=parseInt(o.dataset.month??"0");a.seasonalCalendar&&(a.seasonalCalendar.selectedMonth=r,x())})}),e.querySelector("#visit-filter-area")?.addEventListener("change",o=>{a.visitPlanner&&(a.visitPlanner.filterArea=o.target.value,x())}),e.querySelector("#visit-filter-score")?.addEventListener("change",o=>{a.visitPlanner&&(a.visitPlanner.filterMinScore=parseInt(o.target.value)||0,x())}),e.querySelectorAll("[data-sort-col]").forEach(o=>{o.addEventListener("click",r=>{const d=o.dataset.sortCol??"",m=r.shiftKey;a.route==="/product-power"?a.productSortState=tt(a.productSortState,d,m):a.route==="/customer-efficiency"?a.customerSortState=tt(a.customerSortState,d,m):a.route==="/"||a.route==="/sales"?a.dashboardSortState=tt(a.dashboardSortState,d,m):a.route==="/master"?a.masterSortState=tt(a.masterSortState,d,m):a.route==="/analytics"&&(a.analyticsSortState=tt(a.analyticsSortState,d,m)),x()})}),e.querySelectorAll("[data-action='efficiency-year-change']").forEach(o=>{o.addEventListener("click",async()=>{const r=parseInt(o.dataset.year??"",10);r&&(a.customerEfficiencyYear=r,a.customerEfficiency=await ct(r,a.customerEfficiencyGroupBy),x())})}),e.querySelector("[data-action='efficiency-year-select']")?.addEventListener("change",async o=>{const r=parseInt(o.target.value,10);r&&(a.customerEfficiencyYear=r,a.customerEfficiency=await ct(r,a.customerEfficiencyGroupBy),x())}),e.querySelectorAll("[data-action='efficiency-groupby-change']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.groupby??"billing";a.customerEfficiencyGroupBy=r,a.customerEfficiency=await ct(a.customerEfficiencyYear,r),x()})}),e.querySelectorAll("[data-product-period]").forEach(o=>{o.addEventListener("click",()=>{a.productPeriod=o.dataset.productPeriod??"year",x()})}),e.querySelector("[data-action='pp-apply-range']")?.addEventListener("click",()=>{const o=document.getElementById("pp-range-start")?.value??"",r=document.getElementById("pp-range-end")?.value??"";o&&r&&(a.productCustomStart=o,a.productCustomEnd=r,a.productPeriod="custom",x())}),e.querySelectorAll("[data-product-filter]").forEach(o=>{o.addEventListener("click",()=>{a.productFilter=o.dataset.productFilter??"all",x()})}),e.querySelector("[data-action='dashboard-refresh']")?.addEventListener("click",async o=>{const r=o.currentTarget;r.disabled=!0,r.textContent="更新中…",await Ge(),r.disabled=!1,r.textContent="↻ 更新",I("ダッシュボードを更新しました","success")}),e.querySelector("[data-action='sales-filter']")?.addEventListener("click",()=>{const o=e.querySelector("#sales-start")?.value??"",r=e.querySelector("#sales-end")?.value??"";a.salesFilter={startDate:o,endDate:r},np()}),e.querySelector("[data-action='invoice-filter']")?.addEventListener("click",()=>{const o={documentNo:e.querySelector("#invoice-document-no")?.value??"",startDate:e.querySelector("#invoice-start")?.value??"",endDate:e.querySelector("#invoice-end")?.value??"",customerCode:e.querySelector("#invoice-customer-code")?.value??""};a.invoiceFilter=o,sp(o)}),e.querySelector("[data-action='ledger-search']")?.addEventListener("click",()=>{const o=e.querySelector("#ledger-customer-code")?.value??"";a.ledgerCustomerCode=o.trim().toUpperCase(),op(a.ledgerCustomerCode)}),e.querySelectorAll("[data-tab]").forEach(o=>{o.addEventListener("click",()=>{a.masterTab=o.dataset.tab,a.masterFilter={...Na},x()})}),e.querySelector("[data-action='master-filter']")?.addEventListener("click",()=>{a.masterFilter={query:e.querySelector("#master-search")?.value??"",businessType:e.querySelector("#master-business-type")?.value??"",areaCode:e.querySelector("#master-area-code")?.value??"",activeOnly:e.querySelector("#master-active-only")?.value??"",page:1},x()}),e.querySelector("#master-search")?.addEventListener("keydown",o=>{o.key==="Enter"&&e.querySelector("[data-action='master-filter']")?.click()}),e.querySelectorAll("[data-action='master-page']").forEach(o=>{o.addEventListener("click",()=>{const r=Number(o.dataset.page);r>=1&&(a.masterFilter={...a.masterFilter,page:r},x())})}),e.querySelectorAll("[data-action='raw-select-table']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.table;if(!r)return;a.rawSelectedTable=r,a.rawPage=1;const d=await Ct(r,1);a.rawRecords=d.records,a.rawTotalCount=d.total,x()})}),e.querySelector("[data-action='raw-page-prev']")?.addEventListener("click",async()=>{if(!a.rawSelectedTable||a.rawPage<=1)return;a.rawPage-=1;const o=await Ct(a.rawSelectedTable,a.rawPage);a.rawRecords=o.records,a.rawTotalCount=o.total,x()}),e.querySelector("[data-action='raw-page-next']")?.addEventListener("click",async()=>{if(!a.rawSelectedTable)return;a.rawPage+=1;const o=await Ct(a.rawSelectedTable,a.rawPage);a.rawRecords=o.records,a.rawTotalCount=o.total,x()}),e.querySelectorAll("[data-analytics-tab]").forEach(o=>{o.addEventListener("click",async()=>{if(a.analyticsTab=o.dataset.analyticsTab,a.analyticsStaffDrilldown=null,a.analyticsDrilldown=null,a.analyticsPeriodChartData=[],a.analyticsPrevYearChartData=[],a.analyticsTab!=="staff"){if(a.analyticsPeriod!=="all"){const{fetchAnalyticsByPeriod:r,fetchAvailablePeriods:d}=await D(async()=>{const{fetchAnalyticsByPeriod:m,fetchAvailablePeriods:g}=await Promise.resolve().then(()=>N);return{fetchAnalyticsByPeriod:m,fetchAvailablePeriods:g}},void 0);a.analyticsPeriodOptions=await d(a.analyticsTab,a.analyticsPeriod),a.analyticsPeriodFilter=a.analyticsPeriodOptions[0]??"",a.analyticsPeriodRows=await r(a.analyticsTab,a.analyticsPeriod,a.analyticsPeriodFilter)}}x()})}),e.querySelectorAll("[data-analytics-period]").forEach(o=>{o.addEventListener("click",async()=>{const{fetchAnalyticsByPeriod:r,fetchAvailablePeriods:d,fetchPeriodChartData:m,prevYearFilter:g}=await D(async()=>{const{fetchAnalyticsByPeriod:w,fetchAvailablePeriods:S,fetchPeriodChartData:_,prevYearFilter:E}=await Promise.resolve().then(()=>N);return{fetchAnalyticsByPeriod:w,fetchAvailablePeriods:S,fetchPeriodChartData:_,prevYearFilter:E}},void 0),$=o.dataset.analyticsPeriod;if(a.analyticsPeriod=$,a.analyticsDrilldown=null,$==="all")a.analyticsPeriodRows=[],a.analyticsPeriodOptions=[],a.analyticsPeriodFilter="",a.analyticsPeriodChartData=[],a.analyticsPrevYearChartData=[];else{a.analyticsPeriodOptions=await d(a.analyticsTab,$),a.analyticsPeriodFilter=a.analyticsPeriodOptions[0]??"";const w=a.analyticsPeriodFilter,[S,_,E]=await Promise.all([r(a.analyticsTab,$,w),m($,w),m($,g(w))]);a.analyticsPeriodRows=S,a.analyticsPeriodChartData=_,a.analyticsPrevYearChartData=E}x()})}),e.querySelector("#analytics-period-select")?.addEventListener("change",async o=>{const{fetchAnalyticsByPeriod:r,fetchPeriodChartData:d,prevYearFilter:m}=await D(async()=>{const{fetchAnalyticsByPeriod:w,fetchPeriodChartData:S,prevYearFilter:_}=await Promise.resolve().then(()=>N);return{fetchAnalyticsByPeriod:w,fetchPeriodChartData:S,prevYearFilter:_}},void 0);a.analyticsPeriodFilter=o.target.value,a.analyticsDrilldown=null;const g=a.analyticsPeriodFilter;if(a.analyticsFiscalMode==="fiscal"&&a.analyticsPeriod==="yearly"){const{fiscalYearToDateRange:w}=await D(async()=>{const{fiscalYearToDateRange:T}=await Promise.resolve().then(()=>dn);return{fiscalYearToDateRange:T}},void 0),S=parseInt(g),_=w(S);w(S-1);const E=a.analyticsTab==="customers"?"get_customer_totals_by_period":"get_product_totals_by_period",{supabaseRpc:A}=await D(async()=>{const{supabaseRpc:T}=await Promise.resolve().then(()=>X);return{supabaseRpc:T}},void 0),[q,M,L]=await Promise.all([A(E,{p_date_from:_.from,p_date_to:_.to}),d("yearly",g),d("yearly",String(S-1))]);a.analyticsPeriodRows=(q??[]).map(T=>({code:String(T.code??""),name:String(T.name??""),amount:Number(T.amount??0),quantity:Number(T.quantity??0),documents:Number(T.documents??0),volumeMl:Number(T.volume_ml??0)})),a.analyticsPeriodChartData=(M??[]).map(T=>({...T})),a.analyticsPrevYearChartData=(L??[]).map(T=>({...T}))}else{const[w,S,_]=await Promise.all([r(a.analyticsTab,a.analyticsPeriod,g),d(a.analyticsPeriod,g),d(a.analyticsPeriod,m(g))]);a.analyticsPeriodRows=w,a.analyticsPeriodChartData=S,a.analyticsPrevYearChartData=_}x()}),e.querySelectorAll("[data-fiscal-mode]").forEach(o=>{o.addEventListener("click",async()=>{if(a.analyticsFiscalMode=o.dataset.fiscalMode,a.analyticsPeriod==="yearly")if(a.analyticsPeriodRows=[],a.analyticsPeriodChartData=[],a.analyticsPrevYearChartData=[],a.analyticsPeriodFilter="",a.analyticsFiscalMode==="fiscal"){const{monthToFiscalYear:r}=await D(async()=>{const{monthToFiscalYear:m}=await Promise.resolve().then(()=>dn);return{monthToFiscalYear:m}},void 0),d=new Set;for(const m of a.salesAnalytics.monthlySales)d.add(r(m.month));a.analyticsPeriodOptions=[...d].sort((m,g)=>g-m).map(String)}else{const{fetchAvailablePeriods:r}=await D(async()=>{const{fetchAvailablePeriods:d}=await Promise.resolve().then(()=>N);return{fetchAvailablePeriods:d}},void 0);a.analyticsPeriodOptions=await r(a.analyticsTab,"yearly")}x()})}),e.querySelectorAll("[data-chart-metric]").forEach(o=>{o.addEventListener("click",()=>{a.analyticsChartMetric=o.dataset.chartMetric,x()})}),e.querySelectorAll("[data-analytics-drilldown]").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.analyticsDrilldown??"",d=o.dataset.drilldownName??r,m=a.analyticsTab,{fetchCustomerProductBreakdown:g,fetchProductCustomerBreakdown:$,fetchEntityMonthlySales:w,periodToDateRange:S}=await D(async()=>{const{fetchCustomerProductBreakdown:q,fetchProductCustomerBreakdown:M,fetchEntityMonthlySales:L,periodToDateRange:T}=await Promise.resolve().then(()=>N);return{fetchCustomerProductBreakdown:q,fetchProductCustomerBreakdown:M,fetchEntityMonthlySales:L,periodToDateRange:T}},void 0),_=a.analyticsPeriod!=="all"&&a.analyticsPeriodFilter?S(a.analyticsPeriod,a.analyticsPeriodFilter):null,[E,A]=await Promise.all([w(r,m==="customers"?"customer":"product"),m==="customers"?g(r,_?.from,_?.to):$(r,_?.from,_?.to)]);a.analyticsDrilldown={tab:m,code:r,name:d,monthlySales:E,breakdownRows:A},x()})}),e.querySelector("[data-action='close-analytics-drilldown']")?.addEventListener("click",()=>{a.analyticsDrilldown=null,x()}),e.querySelector("#staff-filter-input")?.addEventListener("input",o=>{a.analyticsStaffFilter=o.target.value,x()}),e.querySelectorAll("[data-staff-drilldown]").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.staffDrilldown??"",d=o.dataset.staffName??"",{fetchStaffCustomerBreakdown:m,fetchStaffProductBreakdown:g,periodToDateRange:$}=await D(async()=>{const{fetchStaffCustomerBreakdown:A,fetchStaffProductBreakdown:q,periodToDateRange:M}=await Promise.resolve().then(()=>N);return{fetchStaffCustomerBreakdown:A,fetchStaffProductBreakdown:q,periodToDateRange:M}},void 0),w=$(a.analyticsStaffPeriod,a.analyticsStaffPeriodFilter),S=a.analyticsStaffDrilldown?.breakdownTab??"customers",[_,E]=await Promise.all([m(r,w?.from,w?.to),g(r,w?.from,w?.to)]);a.analyticsStaffDrilldown={code:r,name:d,breakdownTab:S,customerRows:_,productRows:E},x()})}),e.querySelectorAll("[data-staff-breakdown-tab]").forEach(o=>{o.addEventListener("click",()=>{a.analyticsStaffDrilldown&&(a.analyticsStaffDrilldown={...a.analyticsStaffDrilldown,breakdownTab:o.dataset.staffBreakdownTab},x())})}),e.querySelector("[data-action='close-staff-drilldown']")?.addEventListener("click",()=>{a.analyticsStaffDrilldown=null,x()}),e.querySelector("[data-analytics-tag-filter]")?.addEventListener("input",o=>{a.analyticsTagFilter=o.target.value,x()}),e.querySelectorAll("[data-staff-period]").forEach(o=>{o.addEventListener("click",async()=>{const{fetchAvailablePeriods:r,fetchStaffTotalsByPeriod:d,periodToDateRange:m}=await D(async()=>{const{fetchAvailablePeriods:$,fetchStaffTotalsByPeriod:w,periodToDateRange:S}=await Promise.resolve().then(()=>N);return{fetchAvailablePeriods:$,fetchStaffTotalsByPeriod:w,periodToDateRange:S}},void 0),g=o.dataset.staffPeriod;if(a.analyticsStaffPeriod=g,a.analyticsStaffDrilldown=null,g==="all")a.analyticsStaffPeriodFilter="",a.analyticsStaffPeriodOptions=[],a.analyticsStaffTotals=[];else{a.analyticsStaffPeriodOptions=await r("staff",g),a.analyticsStaffPeriodFilter=a.analyticsStaffPeriodOptions[0]??"";const $=m(g,a.analyticsStaffPeriodFilter);a.analyticsStaffTotals=await d($?.from,$?.to)}x()})}),e.querySelector("#staff-period-select")?.addEventListener("change",async o=>{const{fetchStaffTotalsByPeriod:r,periodToDateRange:d}=await D(async()=>{const{fetchStaffTotalsByPeriod:g,periodToDateRange:$}=await Promise.resolve().then(()=>N);return{fetchStaffTotalsByPeriod:g,periodToDateRange:$}},void 0);a.analyticsStaffPeriodFilter=o.target.value;const m=d(a.analyticsStaffPeriod,a.analyticsStaffPeriodFilter);a.analyticsStaffTotals=await r(m?.from,m?.to),a.analyticsStaffDrilldown=null,x()}),e.querySelector("[data-action='add-line']")?.addEventListener("click",()=>{Ee(e),a.invoiceForm.lines.push({productCode:"",productName:"",quantity:0,unitPrice:0,unit:"本",amount:0}),a.invoiceErrors={},x()}),e.querySelectorAll("[data-action='remove-line']").forEach(o=>{o.addEventListener("click",()=>{Ee(e);const r=parseInt(o.dataset.line??"0",10);a.invoiceForm.lines.splice(r,1),a.invoiceErrors=Bs(a.invoiceForm),x()})}),e.querySelectorAll("[data-action='duplicate-line']").forEach(o=>{o.addEventListener("click",()=>{Ee(e),Qd(parseInt(o.dataset.line??"0",10)),a.invoiceErrors={},x()})}),e.querySelector("[data-action='copy-past-invoice']")?.addEventListener("click",()=>{Hd(),x()}),e.querySelector("[data-action='open-customer-picker']")?.addEventListener("click",()=>{Ee(e),a.pickerMode="customer",a.pickerTargetLine=null,a.pickerQuery=a.invoiceForm.customerCode||a.invoiceForm.customerName,x()}),e.querySelectorAll("[data-action='open-product-picker']").forEach(o=>{o.addEventListener("click",()=>{Ee(e);const r=parseInt(o.dataset.line??"0",10),d=a.invoiceForm.lines[r];a.pickerMode="product",a.pickerTargetLine=r,a.pickerQuery=d?d.productCode||d.productName:"",x()})}),e.querySelectorAll("[data-action='modal-close']").forEach(o=>{o.addEventListener("click",r=>{o.classList.contains("modal-backdrop")&&r.target instanceof HTMLElement&&!r.target.classList.contains("modal-backdrop")||(Mt(),x())})}),e.querySelectorAll("[data-action='picker-select']").forEach(o=>{const r=async()=>{const d=o.dataset.code??"",m=o.dataset.name??"";if(a.pickerMode==="customer"){a.invoiceForm.customerCode=d,a.invoiceForm.customerName=m,delete a.invoiceErrors.customerCode;const g=a.masterStats?.customers.find($=>$.code===d);a.invoicePriceGroup=g?.priceGroup||"",!a.invoicePriceGroup&&d&&(a.invoicePriceGroup=await ra(d))}else if(a.pickerMode==="product"&&a.pickerTargetLine!==null){const g=a.invoiceForm.lines[a.pickerTargetLine];if(g){g.productCode=d,g.productName=m;const $=await ps(a.invoicePriceGroup,d);$>0&&(g.unitPrice=$),g.amount=g.quantity*g.unitPrice,delete a.invoiceErrors[`lines.${a.pickerTargetLine}.productCode`],delete a.invoiceErrors[`lines.${a.pickerTargetLine}.productName`]}}Mt(),x()};o.addEventListener("click",r),o.addEventListener("keydown",d=>{d.key==="Enter"&&r()})}),e.querySelector("#modal-search")?.addEventListener("input",o=>{a.pickerQuery=o.target.value,x()}),e.querySelector("[data-action='invoice-clear']")?.addEventListener("click",()=>{zs(),x()}),e.querySelector("[data-action='invoice-save']")?.addEventListener("click",()=>{Fs(e)}),e.querySelector("#inv-customer-code")?.addEventListener("blur",async()=>{Ee(e),Gd(a.invoiceForm.customerCode)&&(delete a.invoiceErrors.customerCode,!a.invoicePriceGroup&&a.invoiceForm.customerCode&&(a.invoicePriceGroup=await ra(a.invoiceForm.customerCode)),x())}),e.querySelector("#inv-customer-name")?.addEventListener("blur",()=>{Ee(e),Xd(a.invoiceForm.customerName)&&(delete a.invoiceErrors.customerCode,x())}),e.querySelectorAll("#inv-date, #inv-customer-code, #inv-customer-name, #inv-staff, #inv-note, [data-field], #inv-type").forEach(o=>{o.addEventListener("input",()=>{Ee(e),a.invoiceSavedDocNo=null;const r=o.dataset.field;(r==="quantity"||r==="unitPrice")&&x()})}),e.querySelector("#inv-type")?.addEventListener("change",()=>{Ee(e),a.invoiceSavedDocNo=null}),e.querySelector("[data-action='delivery-search']")?.addEventListener("click",()=>{const o=e.querySelector("#delivery-docno")?.value??"";if(a.deliverySearchDocNo=o.trim(),a.deliveryNote=null,a.actionLoading=!0,x(),!a.deliverySearchDocNo){I("伝票番号を入力してください","error"),a.actionLoading=!1,x();return}Pa(a.deliverySearchDocNo).then(r=>{a.deliveryNote=r,a.actionLoading=!1,x()})}),e.querySelector("[data-action='billing-load']")?.addEventListener("click",()=>{const o=e.querySelector("#billing-month")?.value??a.billingYearMonth;a.billingYearMonth=o,a.billingSummary=null,a.actionLoading=!0,x(),Ea(o).then(r=>{a.billingSummary=r,a.actionLoading=!1,x()})}),e.querySelector("[data-action='tax-load']")?.addEventListener("click",()=>{const o=parseInt(e.querySelector("#tax-year")?.value??String(a.taxYear),10),r=parseInt(e.querySelector("#tax-month")?.value??String(a.taxMonth),10);a.taxYear=o,a.taxMonth=r,a.taxDeclaration=null,a.actionLoading=!0,x(),Aa(o,r).then(d=>{a.taxDeclaration=d,a.actionLoading=!1,x()})}),e.querySelector("[data-action='tax-export-xml']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{generateTaxXML:o}=await D(async()=>{const{generateTaxXML:$}=await Promise.resolve().then(()=>N);return{generateTaxXML:$}},void 0),r=o(a.taxDeclaration),d=new Blob([r],{type:"application/xml;charset=utf-8"}),m=URL.createObjectURL(d),g=document.createElement("a");g.href=m,g.download=`tax-${a.taxYear}-${String(a.taxMonth).padStart(2,"0")}.xml`,g.click(),URL.revokeObjectURL(m)}),e.querySelector("[data-action='tax-export-csv']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{generateTaxCSV:o}=await D(async()=>{const{generateTaxCSV:$}=await Promise.resolve().then(()=>N);return{generateTaxCSV:$}},void 0),r=o(a.taxDeclaration),d=new Blob([r],{type:"text/csv;charset=utf-8"}),m=URL.createObjectURL(d),g=document.createElement("a");g.href=m,g.download=`tax-${a.taxYear}-${String(a.taxMonth).padStart(2,"0")}.csv`,g.click(),URL.revokeObjectURL(m)}),e.querySelector("[data-action='tax-save-draft']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{saveTaxDeclaration:o}=await D(async()=>{const{saveTaxDeclaration:r}=await Promise.resolve().then(()=>N);return{saveTaxDeclaration:r}},void 0);try{await o(a.taxDeclaration),I("下書き保存しました")}catch(r){I("保存に失敗: "+(r instanceof Error?r.message:String(r)),"error")}}),e.querySelectorAll("[data-tax-row][data-tax-field]").forEach(o=>{o.addEventListener("change",async()=>{if(!a.taxDeclaration)return;const r=Number(o.dataset.taxRow),d=o.dataset.taxField,m=o.type==="number"?Number(o.value)||0:o.value,g=[...a.taxDeclaration.rows];g[r]={...g[r],[d]:m};const{recalculateTaxDeclaration:$}=await D(async()=>{const{recalculateTaxDeclaration:w}=await Promise.resolve().then(()=>N);return{recalculateTaxDeclaration:w}},void 0);a.taxDeclaration=$({...a.taxDeclaration,rows:g}),x()})}),e.querySelectorAll("[data-ded-row][data-ded-field]").forEach(o=>{o.addEventListener("change",()=>{if(!a.taxDeclaration)return;const r=Number(o.dataset.dedRow),d=o.dataset.dedField,m=o.type==="number"?Number(o.value)||0:o.value,g=[...a.taxDeclaration.deductions];g[r]={...g[r],[d]:m},a.taxDeclaration={...a.taxDeclaration,deductions:g},x()})}),e.querySelectorAll("input[data-tax-field]:not([data-tax-row])").forEach(o=>{o.addEventListener("change",()=>{if(!a.taxDeclaration)return;const r=o.dataset.taxField;a.taxDeclaration={...a.taxDeclaration,[r]:o.value}})}),e.querySelector("[data-action='tax-add-category']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{recalculateTaxDeclaration:o,TAX_RATE_CATEGORIES:r}=await D(async()=>{const{recalculateTaxDeclaration:g,TAX_RATE_CATEGORIES:$}=await Promise.resolve().then(()=>N);return{recalculateTaxDeclaration:g,TAX_RATE_CATEGORIES:$}},void 0),d=r[0],m={taxCategory:d.code,taxCategoryName:d.name,alcoholDegree:15,productionVolume:0,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:0,taxableVolume:0,volume:0,taxRate:d.taxRatePerLiter,taxAmount:0};a.taxDeclaration=o({...a.taxDeclaration,rows:[...a.taxDeclaration.rows,m]}),x()}),e.querySelectorAll("[data-action='tax-remove-category']").forEach(o=>{o.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const r=Number(o.dataset.taxRow),{recalculateTaxDeclaration:d}=await D(async()=>{const{recalculateTaxDeclaration:g}=await Promise.resolve().then(()=>N);return{recalculateTaxDeclaration:g}},void 0),m=a.taxDeclaration.rows.filter((g,$)=>$!==r);a.taxDeclaration=d({...a.taxDeclaration,rows:m}),x()})}),e.querySelector("[data-action='tax-add-deduction']")?.addEventListener("click",()=>{if(!a.taxDeclaration)return;const o={type:"export",categoryCode:"01",volume:0,reason:"",documentNo:""};a.taxDeclaration={...a.taxDeclaration,deductions:[...a.taxDeclaration.deductions,o]},x()}),e.querySelectorAll("[data-action='tax-remove-deduction']").forEach(o=>{o.addEventListener("click",()=>{if(!a.taxDeclaration)return;const r=Number(o.dataset.dedRow),d=a.taxDeclaration.deductions.filter((m,g)=>g!==r);a.taxDeclaration={...a.taxDeclaration,deductions:d},x()})}),e.querySelectorAll("[data-store-tab]").forEach(o=>{o.addEventListener("click",()=>{a.storeTab=o.dataset.storeTab,x()})}),e.querySelectorAll("[data-import-entity]").forEach(o=>{o.addEventListener("click",()=>{a.importEntity=o.dataset.importEntity,a.importPreview=null,a.importResult=null,x()})}),e.querySelector("[data-action='download-template']")?.addEventListener("click",()=>{const o=qs(a.importEntity),r=new Blob([o],{type:"text/csv;charset=utf-8"}),d=URL.createObjectURL(r),m=document.createElement("a");m.href=d,m.download=`template_${a.importEntity}.csv`,m.click(),URL.revokeObjectURL(d)}),e.querySelector("[data-action='import-parse']")?.addEventListener("click",()=>{const r=e.querySelector("#import-file")?.files?.[0];if(!r){I("CSVファイルを選択してください","warning");return}const d=new FileReader;d.onload=()=>{const m=String(d.result??""),{columns:g,rows:$}=Ls(m);a.importPreview=Ds(a.importEntity,g,$),a.importResult=null,x()},d.readAsText(r,"utf-8")}),e.querySelector("[data-action='import-cancel']")?.addEventListener("click",()=>{a.importPreview=null,a.importResult=null,x()}),e.querySelectorAll("[data-print-template]").forEach(o=>{o.addEventListener("click",()=>{a.printTemplate=o.dataset.printTemplate,x()})}),e.querySelectorAll("[data-print-field]").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.printField;let d=o.value;(r==="taxRate"||r==="previousBalance"||r==="paymentAmount")&&(d=Number(o.value)||0),a.printData={...a.printData,[r]:d},x()})}),e.querySelectorAll("[data-print-opt]").forEach(o=>{const r=()=>{const d=o.dataset.printOpt;let m;o.type==="checkbox"?m=o.checked:d==="copies"?m=Number(o.value)||1:d==="overlayOpacity"||d==="calibrationOffsetX"||d==="calibrationOffsetY"?m=Number(o.value)||0:m=o.value,a.printOptions={...a.printOptions,[d]:m},x()};o.addEventListener("change",r),o.type==="range"&&o.addEventListener("input",r)}),e.querySelectorAll("[data-print-line][data-print-lfield]").forEach(o=>{o.addEventListener("change",()=>{const r=Number(o.dataset.printLine),d=o.dataset.printLfield,m=[...a.printData.lines];let g=o.value;(d==="quantity"||d==="unitPrice")&&(g=Number(o.value)||0),m[r]={...m[r],[d]:g},m[r].amount=(Number(m[r].quantity)||0)*(Number(m[r].unitPrice)||0),a.printData={...a.printData,lines:m},x()})}),e.querySelector("[data-action='print-add-line']")?.addEventListener("click",()=>{a.printData={...a.printData,lines:[...a.printData.lines,{productCode:"",productName:"",spec:"",quantity:0,unit:"本",unitPrice:0,amount:0}]},x()}),e.querySelectorAll("[data-action='print-remove-line']").forEach(o=>{o.addEventListener("click",()=>{const r=Number(o.dataset.printLine);a.printData={...a.printData,lines:a.printData.lines.filter((d,m)=>m!==r)},x()})}),e.querySelector("[data-action='print-save-settings']")?.addEventListener("click",()=>{try{localStorage.setItem("sake_print_options",JSON.stringify(a.printOptions)),localStorage.setItem("sake_print_company",JSON.stringify(a.printCompany)),I("印刷設定を保存しました")}catch(o){I("保存失敗: "+(o instanceof Error?o.message:String(o)),"error")}}),e.querySelector("[data-action='print-open-company']")?.addEventListener("click",()=>{const o=a.printCompany,r=prompt("会社名",o.name);if(r===null)return;const d=prompt("郵便番号",o.postalCode)??o.postalCode,m=prompt("住所",o.address1)??o.address1,g=prompt("TEL",o.tel)??o.tel,$=prompt("FAX",o.fax)??o.fax,w=prompt("適格請求書登録番号 (T+13桁)",o.registrationNo)??o.registrationNo,S=prompt("取引銀行名",o.bankName)??o.bankName,_=prompt("支店名",o.bankBranch)??o.bankBranch,E=prompt("口座番号",o.bankAccountNo)??o.bankAccountNo,A=prompt("口座名義",o.bankAccountHolder)??o.bankAccountHolder;a.printCompany={...o,name:r,postalCode:d,address1:m,tel:g,fax:$,registrationNo:w,bankName:S,bankBranch:_,bankAccountNo:E,bankAccountHolder:A},x()}),e.querySelector("[data-action='fd-toggle-design']")?.addEventListener("click",()=>{a.fdDesignMode=!a.fdDesignMode,x()}),e.querySelector("[data-action='fd-save-cloud']")?.addEventListener("click",async()=>{const o=e.querySelector(".fd-canvas");if(!o)return;const d=(e.querySelector("#fd-layout-name")?.value??"").trim()||"デフォルト",m=Ht(o),{savePrintLayout:g}=await D(async()=>{const{savePrintLayout:w}=await Promise.resolve().then(()=>N);return{savePrintLayout:w}},void 0),$={id:`bp1701_${d.replaceAll(/[^a-zA-Z0-9_-]/g,"_")}_${Date.now()}`,name:d,templateKey:"chain_store",positions:m};try{await g($)?(I(`クラウド保存成功: ${d}`),a.fdSavedPositions=m,localStorage.setItem("sake_fd_positions",JSON.stringify(m)),x()):(I("クラウド保存に失敗しました。ローカルには保存されました","warning"),localStorage.setItem("sake_fd_positions",JSON.stringify(m)))}catch(w){I("保存エラー: "+(w instanceof Error?w.message:""),"error")}}),e.querySelector("[data-action='fd-save-local']")?.addEventListener("click",()=>{const o=e.querySelector(".fd-canvas");if(!o)return;const r=Ht(o);a.fdSavedPositions=r;try{localStorage.setItem("sake_fd_positions",JSON.stringify(r)),I(`ローカル保存完了: ${Object.keys(r).length}件`)}catch(d){I("保存失敗: "+(d instanceof Error?d.message:""),"error")}}),e.querySelector("[data-action='fd-export-json']")?.addEventListener("click",()=>{const o=e.querySelector(".fd-canvas");if(!o)return;const d={templateKey:"chain_store",positions:Ht(o),exportedAt:new Date().toISOString()},m=new Blob([JSON.stringify(d,null,2)],{type:"application/json"}),g=URL.createObjectURL(m),$=document.createElement("a");$.href=g,$.download=`bp1701_layout_${new Date().toISOString().slice(0,10)}.json`,$.click(),URL.revokeObjectURL(g)}),e.querySelector("[data-action='fd-import-json']")?.addEventListener("click",()=>{e.querySelector("#fd-import-file")?.click()}),e.querySelector("#fd-import-file")?.addEventListener("change",async o=>{const r=o.target.files?.[0];if(r)try{const d=await r.text(),g=JSON.parse(d).positions;if(!g)throw new Error("positions field not found");a.fdSavedPositions=g,localStorage.setItem("sake_fd_positions",JSON.stringify(g)),I(`インポート成功: ${Object.keys(g).length}件`),x()}catch(d){I("インポート失敗: "+(d instanceof Error?d.message:""),"error")}});const b=e.querySelector("#fd-saved-layouts");b&&a.route==="/form-designer"&&a.fdDesignMode&&(async()=>{const{fetchPrintLayouts:o}=await D(async()=>{const{fetchPrintLayouts:d}=await Promise.resolve().then(()=>N);return{fetchPrintLayouts:d}},void 0),r=await o("chain_store");r.length===0?b.innerHTML="☁️ クラウドに保存されたレイアウトはありません":(b.innerHTML=`☁️ クラウド保存済み (${r.length}件):<br/>`+r.map(d=>`<button class="button-sm secondary" data-action="fd-load-layout" data-layout-id="${d.id}" style="margin:4px 4px 0 0;">${d.name}</button>
                 <button class="button-sm secondary" data-action="fd-delete-layout" data-layout-id="${d.id}" title="削除" style="margin:4px 8px 0 0;color:var(--danger);">✕</button>`).join(""),b.querySelectorAll("[data-action='fd-load-layout']").forEach(d=>{d.addEventListener("click",()=>{const m=d.dataset.layoutId,g=r.find($=>$.id===m);g&&(a.fdSavedPositions=g.positions,localStorage.setItem("sake_fd_positions",JSON.stringify(g.positions)),I(`読込完了: ${g.name}`),x())})}),b.querySelectorAll("[data-action='fd-delete-layout']").forEach(d=>{d.addEventListener("click",async()=>{const m=d.dataset.layoutId;if(!m||!await be("このレイアウトを削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deletePrintLayout:g}=await D(async()=>{const{deletePrintLayout:w}=await Promise.resolve().then(()=>N);return{deletePrintLayout:w}},void 0);await g(m)?(I("削除しました"),x()):I("削除失敗","error")})}))})(),e.querySelector("[data-action='fd-reset-positions']")?.addEventListener("click",async()=>{await be("フィールド位置を初期値に戻しますか？")&&(a.fdSavedPositions=null,localStorage.removeItem("sake_fd_positions"),x())});const k=e.querySelector("#fd-sel-x"),P=e.querySelector("#fd-sel-y");[k,P].forEach(o=>{o?.addEventListener("change",()=>{if(!a.fdActiveFieldId)return;const r=document.querySelector(`[data-fd-id="${a.fdActiveFieldId}"]`);r&&(k&&(r.style.left=k.value+"mm"),P&&(r.style.top=P.value+"mm"))})}),e.querySelectorAll(".wf-card").forEach(o=>{o.addEventListener("dragstart",r=>{o.classList.add("wf-dragging"),r.dataTransfer?.setData("text/plain",o.dataset.wfOrder??"")}),o.addEventListener("dragend",()=>o.classList.remove("wf-dragging"))}),e.querySelectorAll(".wf-col").forEach(o=>{o.addEventListener("dragover",r=>r.preventDefault()),o.addEventListener("drop",r=>{r.preventDefault();const d=r.dataTransfer?.getData("text/plain"),m=o.dataset.wfStage;if(!d||!m)return;const g=a.workflowOrders.find($=>$.id===d);g&&(g.stage=m,x())})}),e.querySelectorAll("[data-mo-step]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.moStep;o.disabled||(a.mobileOrder.step=r,x())})}),e.querySelector("#mo-customer-q")?.addEventListener("input",o=>{a.mobileOrder.customerQuery=o.target.value,x()}),e.querySelector("#mo-product-q")?.addEventListener("input",o=>{a.mobileOrder.productQuery=o.target.value,x()}),e.querySelectorAll("[data-mo-select-customer]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.moSelectCustomer,d=a.masterStats?.customers.find(m=>m.id===r);d&&(a.mobileOrder.selectedCustomer=d),x()})}),e.querySelectorAll("[data-mo-add-product]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.moAddProduct,d=a.masterStats?.products.find(g=>g.code===r);if(!d)return;const m=1800;a.mobileOrder.cart.push({productCode:d.code,productName:d.name,quantity:1,unit:"本",unitPrice:m,amount:m}),x()})}),e.querySelectorAll("[data-mo-qty]").forEach(o=>{o.addEventListener("click",()=>{const r=Number(o.dataset.moQty),d=o.dataset.moProduct,m=a.mobileOrder.cart.find(g=>g.productCode===d);m&&(m.quantity=Math.max(0,m.quantity+r),m.amount=m.quantity*m.unitPrice,m.quantity===0&&(a.mobileOrder.cart=a.mobileOrder.cart.filter(g=>g.productCode!==d)),x())})}),e.querySelectorAll("[data-mo-remove]").forEach(o=>{o.addEventListener("click",()=>{const r=Number(o.dataset.moRemove);a.mobileOrder.cart.splice(r,1),x()})}),e.querySelector("[data-action='mo-submit']")?.addEventListener("click",async()=>{const o=e.querySelector("#mo-memo");a.mobileOrder.memo=o?.value??"";const r="MO"+Date.now().toString().slice(-8);a.mobileOrder.submittedDocNo=r,a.mobileOrder.step="done",x()}),e.querySelector("[data-action='mo-reset']")?.addEventListener("click",()=>{a.mobileOrder={step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},x()}),e.querySelectorAll("[data-tour-id]").forEach(o=>{o.addEventListener("click",()=>{a.tourActiveId=o.dataset.tourId??null,x()})}),e.querySelectorAll("[data-action='tour-insert-template']").forEach(o=>{o.addEventListener("click",()=>{const r=a.tourInquiries.find(w=>w.id===a.tourActiveId);if(!r)return;const d=o.dataset.template==="confirm"?cc:dc,m=e.querySelector("#tour-confirmed-time"),g=d.replaceAll("{name}",r.name).replaceAll("{partySize}",String(r.partySize)).replaceAll("{confirmedTime}",m?.value??r.visitDate),$=e.querySelector("#tour-reply-body");$&&($.value=g)})}),e.querySelector("[data-action='tour-send-reply']")?.addEventListener("click",()=>{const o=document.querySelector("[data-action='tour-send-reply']")?.dataset.tourId??"",r=a.tourInquiries.find(m=>m.id===o);if(!r)return;const d=e.querySelector("#tour-confirmed-time");r.status="confirmed",r.repliedAt=new Date().toISOString(),r.confirmedTime=d?.value??"",I("返信メールを下書き保存し、ステータスを確定にしました"),x()}),e.querySelector("[data-action='lb-search']")?.addEventListener("click",async()=>{const o=e.querySelector("#lb-type")?.value??"",r=e.querySelector("#lb-area")?.value??"",d=e.querySelector("#lb-keyword")?.value??"";if(!o&&!d){I("業種かキーワードを入力してください","warning");return}a.leadSearchType=o,a.leadSearchArea=r,a.leadSearchQuery=d,a.leadSearching=!0,x();const m=a.integrations.find(S=>S.provider==="google_maps");if(!m||!m.config.api_key){I("Google Maps APIキーが /integrations で未設定です","warning"),a.leadSearching=!1,x();return}const{searchPlaces:g}=await D(async()=>{const{searchPlaces:S}=await Promise.resolve().then(()=>N);return{searchPlaces:S}},void 0),$=[o,d].filter(Boolean).join(" "),w=await g(m,$,r);a.leadSearching=!1,w.error?I("検索失敗: "+w.error,"error"):a.leadSearchResults=w.results,x()}),e.querySelector("[data-action='lb-clear-search']")?.addEventListener("click",()=>{a.leadSearchResults=[],x()}),e.querySelector("[data-action='lb-save-list']")?.addEventListener("click",async()=>{if(a.leadSearchResults.length===0)return;const o=prompt("リスト名を入力:",`${a.leadSearchType} ${a.leadSearchArea}`);if(!o)return;const r=`ll_${Date.now()}`,d={id:r,name:o,query:a.leadSearchQuery,area:a.leadSearchArea,businessType:a.leadSearchType,totalCount:a.leadSearchResults.length,source:"google_places"},{saveLeadList:m,saveLeadItem:g,fetchLeadLists:$,fetchLeadItems:w}=await D(async()=>{const{saveLeadList:E,saveLeadItem:A,fetchLeadLists:q,fetchLeadItems:M}=await Promise.resolve().then(()=>N);return{saveLeadList:E,saveLeadItem:A,fetchLeadLists:q,fetchLeadItems:M}},void 0);await m(d);const S=e.querySelectorAll(".lb-search-check:checked"),_=Array.from(S).map(E=>Number(E.dataset.idx));for(const E of _){const A=a.leadSearchResults[E];A&&await g({...A,id:`li_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,listId:r,businessType:a.leadSearchType})}a.leadLists=await $(),a.leadActiveListId=r,a.leadItems=await w(r),a.leadSearchResults=[],I(`${_.length}件を「${o}」として保存しました`),x()}),e.querySelectorAll("[data-action='lb-select-list']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.id??null;if(a.leadActiveListId=r,r){const{fetchLeadItems:d}=await D(async()=>{const{fetchLeadItems:m}=await Promise.resolve().then(()=>N);return{fetchLeadItems:m}},void 0);a.leadItems=await d(r)}x()})}),e.querySelectorAll("[data-action='lb-exclude']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.id??"",d=a.leadItems.find($=>$.id===r);if(!d)return;const{saveLeadItem:m,fetchLeadItems:g}=await D(async()=>{const{saveLeadItem:$,fetchLeadItems:w}=await Promise.resolve().then(()=>N);return{saveLeadItem:$,fetchLeadItems:w}},void 0);await m({...d,status:"excluded"}),a.leadActiveListId&&(a.leadItems=await g(a.leadActiveListId)),x()})}),e.querySelectorAll("[data-action='lb-convert-one']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.id??"",d=a.leadItems.find(w=>w.id===r);if(!d)return;const{convertLeadToProspect:m,fetchLeadItems:g}=await D(async()=>{const{convertLeadToProspect:w,fetchLeadItems:S}=await Promise.resolve().then(()=>N);return{convertLeadToProspect:w,fetchLeadItems:S}},void 0);await m(d)&&(I("見込客に追加しました: "+d.companyName),a.leadActiveListId&&(a.leadItems=await g(a.leadActiveListId)),x())})}),e.querySelector("[data-action='lb-bulk-convert']")?.addEventListener("click",async()=>{const o=e.querySelectorAll(".lb-item-check:checked");if(o.length===0&&!await be("全ての新規アイテムを見込客に変換しますか？"))return;const r=o.length>0?Array.from(o).map($=>$.dataset.id):a.leadItems.filter($=>$.status==="new").map($=>$.id),{convertLeadToProspect:d,fetchLeadItems:m}=await D(async()=>{const{convertLeadToProspect:$,fetchLeadItems:w}=await Promise.resolve().then(()=>N);return{convertLeadToProspect:$,fetchLeadItems:w}},void 0);let g=0;for(const $ of r){const w=a.leadItems.find(S=>S.id===$);w&&w.status==="new"&&await d(w)&&g++}I(`${g}件を見込客に変換しました`),a.leadActiveListId&&(a.leadItems=await m(a.leadActiveListId)),x()}),e.querySelectorAll("[data-map-filter]").forEach(o=>{o.addEventListener("change",()=>{const r=o.dataset.mapFilter;let d;o.type==="checkbox"?d=o.checked:d=o.value,a.mapFilters={...a.mapFilters,[r]:d},x()})}),e.querySelectorAll(".churn-reason-select").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.churnCode??"",d=o.value;try{const{saveChurnNote:m}=await D(async()=>{const{saveChurnNote:w}=await Promise.resolve().then(()=>N);return{saveChurnNote:w}},void 0);await m({customerCode:r,reason:d,memo:"",actionedAt:null});const g=a.churnNotes.find(w=>w.customerCode===r);g?g.reason=d:a.churnNotes.push({customerCode:r,reason:d,memo:"",actionedAt:null,updatedAt:new Date().toISOString()});const $=o.closest("tr");if($){const w=$.querySelector("td:nth-child(2)");if(w){let S=w.querySelector(".reason-badge");!S&&d&&(S=document.createElement("span"),S.className="status-pill info reason-badge",S.style.fontSize="0.72rem",w.appendChild(S)),S&&(S.textContent=d?Od[d]??"":"")}}I("理由を保存しました")}catch(m){I("保存に失敗しました","error"),console.error(m)}})}),e.querySelectorAll(".churn-actioned-check").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.churnCode??"",d=o.checked,m=o.closest("tr");m&&(m.style.opacity=d?"0.45":"",m.setAttribute("data-actioned",d?"1":"0"));try{const{saveChurnNote:g}=await D(async()=>{const{saveChurnNote:_}=await Promise.resolve().then(()=>N);return{saveChurnNote:_}},void 0),$=a.churnNotes.find(_=>_.customerCode===r),w=$?.reason??"",S=new Date().toISOString().slice(0,10);await g({customerCode:r,reason:w,memo:"",actionedAt:d?S:null}),$?$.actionedAt=d?S:null:a.churnNotes.push({customerCode:r,reason:w,memo:"",actionedAt:d?S:null,updatedAt:new Date().toISOString()}),I(d?"対応済みにしました":"対応済みを解除しました")}catch(g){I("保存に失敗しました","error"),console.error(g)}})}),e.querySelector("[data-action='ivry-sync']")?.addEventListener("click",async()=>{const o=a.integrations.find(g=>g.provider==="ivry");if(!o||!o.isEnabled){I("IVRy連携が無効です。/integrations で有効化してください","warning");return}const{syncIvryCallLogs:r,fetchCallLogs:d}=await D(async()=>{const{syncIvryCallLogs:g,fetchCallLogs:$}=await Promise.resolve().then(()=>N);return{syncIvryCallLogs:g,fetchCallLogs:$}},void 0),m=await r(o);m.error?I("同期失敗: "+m.error,"error"):(I(`${m.count}件の通話履歴を同期しました`),a.callLogs=await d(100),x())}),e.querySelector("[data-action='ivry-push-phonebook']")?.addEventListener("click",async()=>{const o=a.integrations.find(g=>g.provider==="ivry");if(!o||!o.isEnabled){I("IVRy連携が無効です","warning");return}if(!await be("全ての取引先と見込客の電話帳をIVRyに送信しますか？"))return;const{syncPhoneBookToIvry:r}=await D(async()=>{const{syncPhoneBookToIvry:g}=await Promise.resolve().then(()=>N);return{syncPhoneBookToIvry:g}},void 0),d=[];a.masterStats?.customers.forEach(g=>{d.push({name:g.name,phone:"",customerCode:g.code,note:"既存取引先"})}),a.prospects.forEach(g=>{g.phone&&d.push({name:g.companyName,phone:g.phone,customerCode:g.id,note:`見込客 (${g.stage})`})});const m=await r(o,d);m.error?I("送信失敗: "+m.error,"error"):I(`${m.synced}件の連絡先を送信しました`)}),e.querySelectorAll("[data-action='call-link-customer']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.id??"",d=o.dataset.phone??"",m=prompt(`電話番号 ${d} を顧客コードに紐付け
顧客コードを入力:`);if(!m)return;const g=a.callLogs.find(S=>S.id===r);if(!g)return;const{saveCallLog:$,fetchCallLogs:w}=await D(async()=>{const{saveCallLog:S,fetchCallLogs:_}=await Promise.resolve().then(()=>N);return{saveCallLog:S,fetchCallLogs:_}},void 0);await $({...g,matchedCustomerCode:m}),a.callLogs=await w(100),x()})}),e.querySelectorAll("[data-action='call-memo']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.id??"",d=a.callLogs.find(w=>w.id===r);if(!d)return;const m=prompt("メモを入力:",d.notes??"");if(m===null)return;const{saveCallLog:g,fetchCallLogs:$}=await D(async()=>{const{saveCallLog:w,fetchCallLogs:S}=await Promise.resolve().then(()=>N);return{saveCallLog:w,fetchCallLogs:S}},void 0);await g({...d,notes:m}),a.callLogs=await $(100),x()})}),e.querySelectorAll("[data-prospect-view]").forEach(o=>{o.addEventListener("click",()=>{a.prospectViewMode=o.dataset.prospectView,x()})}),e.querySelector("[data-action='prospect-new']")?.addEventListener("click",()=>{a.prospectEditingId="__new__",x()}),e.querySelectorAll("[data-action='prospect-edit']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.id??null;if(a.prospectEditingId=r,r){const{fetchProspectActivities:d}=await D(async()=>{const{fetchProspectActivities:m}=await Promise.resolve().then(()=>N);return{fetchProspectActivities:m}},void 0);a.prospectActivities=await d(r)}x()})}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.prospectId??null;if(a.prospectEditingId=r,r){const{fetchProspectActivities:d}=await D(async()=>{const{fetchProspectActivities:m}=await Promise.resolve().then(()=>N);return{fetchProspectActivities:m}},void 0);a.prospectActivities=await d(r)}x()})}),e.querySelectorAll("[data-action='prospect-close']").forEach(o=>{o.addEventListener("click",r=>{r.currentTarget!==r.target&&!r.target.matches("button")||(a.prospectEditingId=null,a.prospectActivities=[],x())})}),e.querySelector("[data-action='prospect-save']")?.addEventListener("click",async()=>{const o=a.prospectEditingId==="__new__",r=o?`p_${Date.now()}`:a.prospectEditingId??"",d={id:r,companyName:e.querySelector("#prospect-company")?.value??"",contactName:e.querySelector("#prospect-contact")?.value??"",email:e.querySelector("#prospect-email")?.value??"",phone:e.querySelector("#prospect-phone")?.value??"",businessType:e.querySelector("#prospect-business-type")?.value??"",stage:e.querySelector("#prospect-stage")?.value??"cold",source:e.querySelector("#prospect-source")?.value??"",expectedAmount:Number(e.querySelector("#prospect-amount")?.value)||0,probability:Number(e.querySelector("#prospect-probability")?.value)||0,assignedStaffCode:e.querySelector("#prospect-staff")?.value??"",nextActionDate:e.querySelector("#prospect-next-date")?.value??"",nextAction:e.querySelector("#prospect-next-action")?.value??"",note:e.querySelector("#prospect-note")?.value??""};if(!d.companyName){I("会社名は必須です","warning");return}const{saveProspect:m,fetchProspects:g,recordAudit:$,sendSlackNotification:w}=await D(async()=>{const{saveProspect:_,fetchProspects:E,recordAudit:A,sendSlackNotification:q}=await Promise.resolve().then(()=>N);return{saveProspect:_,fetchProspects:E,recordAudit:A,sendSlackNotification:q}},void 0);await m(d)?(o&&await w("new_prospect",`新規見込客: ${d.companyName} / 想定 ¥${d.expectedAmount.toLocaleString("ja-JP")}`).catch(()=>{}),await $({action:o?"prospect_create":"prospect_update",entityType:"prospect",entityId:r,userEmail:a.user?.email}),a.prospects=await g(),a.prospectEditingId=null,x()):I("保存失敗","error")}),e.querySelectorAll("[data-action='prospect-delete']").forEach(o=>{o.addEventListener("click",async()=>{if(!await be("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const r=o.dataset.id??"",{deleteProspect:d,fetchProspects:m}=await D(async()=>{const{deleteProspect:g,fetchProspects:$}=await Promise.resolve().then(()=>N);return{deleteProspect:g,fetchProspects:$}},void 0);await d(r)&&(a.prospects=await m(),x())})}),e.querySelectorAll("[data-action='prospect-quote-create']").forEach(o=>{o.addEventListener("click",r=>{r.stopPropagation();const d=o.dataset.id??"",m=o.dataset.name??"",g=o.dataset.addr??"";a.quoteState=Tt(a.quoteCompanySettings),a.quoteState.customerCode="",a.quoteState.customerName=m,a.quoteState.customerAddress=g,a.quoteState.isProspect=!0,a.quoteState.prospectId=d,a.quotePricing=null,a.quoteEditId="new",aa("/quote")})}),e.querySelector("[data-action='prospect-add-activity']")?.addEventListener("click",async()=>{const o=e.querySelector("[data-action='prospect-add-activity']")?.dataset.id??"",r=e.querySelector("#prospect-activity-type")?.value??"call",d=e.querySelector("#prospect-activity-title")?.value??"";if(!d){I("内容を入力してください","warning");return}const{saveProspectActivity:m,fetchProspectActivities:g}=await D(async()=>{const{saveProspectActivity:$,fetchProspectActivities:w}=await Promise.resolve().then(()=>N);return{saveProspectActivity:$,fetchProspectActivities:w}},void 0);await m({id:`act_${Date.now()}`,prospectId:o,activityType:r,title:d,activityDate:new Date().toISOString(),staffCode:a.myProfile?.staffCode}),a.prospectActivities=await g(o),x()}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(o=>{o.addEventListener("dragstart",r=>{r.dataTransfer?.setData("text/plain",o.dataset.prospectId??"")})}),e.querySelectorAll(".pk-col[data-prospect-stage]").forEach(o=>{o.addEventListener("dragover",r=>r.preventDefault()),o.addEventListener("drop",async r=>{r.preventDefault();const d=r.dataTransfer?.getData("text/plain"),m=o.dataset.prospectStage;if(!d)return;const g=a.prospects.find($=>$.id===d);if(g&&g.stage!==m){const $={...g,stage:m},{saveProspect:w}=await D(async()=>{const{saveProspect:S}=await Promise.resolve().then(()=>N);return{saveProspect:S}},void 0);await w($),g.stage=m,x()}})}),e.querySelector("[data-action='slack-save']")?.addEventListener("click",async()=>{const{fetchIntegrationSettings:o,saveIntegrationSetting:r}=await D(async()=>{const{fetchIntegrationSettings:S,saveIntegrationSetting:_}=await Promise.resolve().then(()=>N);return{fetchIntegrationSettings:S,saveIntegrationSetting:_}},void 0),m=(a.integrations.length>0?a.integrations:await o()).find(S=>S.provider==="slack");if(!m)return;const g=e.querySelector("#slack-webhook")?.value??"",$=e.querySelector("#slack-default-channel")?.value??"",w=e.querySelector("#slack-enabled")?.checked??!1;await r({...m,config:{...m.config,webhook_url:g,default_channel:$},isEnabled:w}),a.integrations=await o(),I("保存しました"),x()}),e.querySelector("[data-action='slack-save-rules']")?.addEventListener("click",async()=>{const{saveSlackRule:o,fetchSlackRules:r}=await D(async()=>{const{saveSlackRule:d,fetchSlackRules:m}=await Promise.resolve().then(()=>N);return{saveSlackRule:d,fetchSlackRules:m}},void 0);for(const d of a.slackRules){const m=e.querySelector(`[data-slack-rule-id="${d.id}"][data-slack-field="enabled"]`)?.checked??d.enabled,g=e.querySelector(`[data-slack-rule-id="${d.id}"][data-slack-field="channel"]`)?.value??d.channel;await o({...d,enabled:m,channel:g})}a.slackRules=await r(),I("ルールを保存しました"),x()}),e.querySelector("[data-action='slack-test']")?.addEventListener("click",async()=>{const{sendSlackNotification:o}=await D(async()=>{const{sendSlackNotification:d}=await Promise.resolve().then(()=>N);return{sendSlackNotification:d}},void 0),r=await o("new_order","🧪 これはテスト通知です (syusen-cloud)");r.ok?I("テスト送信成功"):I("送信失敗: "+(r.error??""),"error")}),e.querySelector("[data-action='material-receive']")?.addEventListener("click",()=>{a.materialEditing=null,a.materialEditingIsNew=!0,x()}),e.querySelectorAll("[data-action='material-adjust']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.id??"",d=a.materialList.find(m=>m.id===r);d&&(a.materialEditing=d,a.materialEditingIsNew=!1,x())})}),e.querySelectorAll("[data-action='material-close']").forEach(o=>{o.addEventListener("click",r=>{r.currentTarget!==r.target&&!r.target.matches("button")||(a.materialEditing=null,a.materialEditingIsNew=!1,x())})}),e.querySelector("[data-action='material-save']")?.addEventListener("click",async()=>{const r={id:a.materialEditingIsNew?`mat_${Date.now()}`:a.materialEditing?.id??"",code:e.querySelector("#mat-code")?.value??"",name:e.querySelector("#mat-name")?.value??"",unit:e.querySelector("#mat-unit")?.value??"個",currentStock:Number(e.querySelector("#mat-stock")?.value)||0,minimumStock:Number(e.querySelector("#mat-min")?.value)||0,unitCost:Number(e.querySelector("#mat-cost")?.value)||0,lastUpdated:e.querySelector("#mat-last-date")?.value??new Date().toISOString().slice(0,10)};if(r.materialType=e.querySelector("#mat-type")?.value??"",!r.code||!r.name){I("コードと品名は必須です","warning");return}const{saveMaterial:d,fetchMaterialList:m}=await D(async()=>{const{saveMaterial:$,fetchMaterialList:w}=await Promise.resolve().then(()=>N);return{saveMaterial:$,fetchMaterialList:w}},void 0);await d(r)?(a.materialList=await m(),a.materialEditing=null,a.materialEditingIsNew=!1,I("保存しました"),x()):I("保存失敗","error")}),e.querySelector("[data-action='material-delete']")?.addEventListener("click",async()=>{const o=document.querySelector("[data-action='material-delete']")?.dataset.id??"";if(!o||!await be("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deleteMaterial:r,fetchMaterialList:d}=await D(async()=>{const{deleteMaterial:m,fetchMaterialList:g}=await Promise.resolve().then(()=>N);return{deleteMaterial:m,fetchMaterialList:g}},void 0);await r(o)&&(a.materialList=await d(),a.materialEditing=null,x())}),e.querySelector("[data-action='user-new']")?.addEventListener("click",()=>{a.userEditingId="__new__",x()}),e.querySelectorAll("[data-action='user-edit']").forEach(o=>{o.addEventListener("click",()=>{a.userEditingId=o.dataset.id??null,x()})}),e.querySelector("[data-action='user-cancel']")?.addEventListener("click",()=>{a.userEditingId=null,x()}),e.querySelector("[data-action='user-save']")?.addEventListener("click",async()=>{const o=a.userEditingId==="__new__",r=o?crypto.randomUUID():a.userEditingId??"",d=e.querySelector("#user-email")?.value.trim()??"",m=e.querySelector("#user-name")?.value.trim()??"";if(!d||!m){I("名前とメールアドレスは必須です","warning");return}const g={id:r,email:d,displayName:m,staffCode:e.querySelector("#user-code")?.value??"",department:e.querySelector("#user-dept")?.value??"all",role:e.querySelector("#user-role")?.value??"staff",phone:e.querySelector("#user-phone")?.value??"",isActive:e.querySelector("#user-active")?.checked??!0};if(o){const E=e.querySelector("#user-password")?.value??"";if(E.length<8){I("パスワードは8文字以上必要です","warning");return}try{await Ya(d,E)}catch(A){I("Auth登録失敗: "+(A instanceof Error?A.message:""),"error");return}}const{saveUserProfile:$,fetchUserProfiles:w,recordAudit:S}=await D(async()=>{const{saveUserProfile:E,fetchUserProfiles:A,recordAudit:q}=await Promise.resolve().then(()=>N);return{saveUserProfile:E,fetchUserProfiles:A,recordAudit:q}},void 0);await $(g)?(await S({action:o?"user_create":"user_update",entityType:"user",entityId:r,userEmail:a.user?.email}),a.userProfiles=await w(),a.userEditingId=null,I("保存しました"),x()):I("保存失敗","error")}),e.querySelectorAll("[data-action='user-delete']").forEach(o=>{o.addEventListener("click",async()=>{if(!await be("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const r=o.dataset.id??"",{deleteUserProfile:d,fetchUserProfiles:m,recordAudit:g}=await D(async()=>{const{deleteUserProfile:w,fetchUserProfiles:S,recordAudit:_}=await Promise.resolve().then(()=>N);return{deleteUserProfile:w,fetchUserProfiles:S,recordAudit:_}},void 0);await d(r)?(await g({action:"user_delete",entityType:"user",entityId:r,userEmail:a.user?.email}),a.userProfiles=await m(),x()):I("削除失敗","error")})}),e.querySelector("[data-action='profile-save-sender']")?.addEventListener("click",async()=>{if(!a.myProfile)return;const o=e.querySelector("#profile-sender")?.value??"",r={...a.myProfile,defaultMailSenderId:o},{saveUserProfile:d}=await D(async()=>{const{saveUserProfile:m}=await Promise.resolve().then(()=>N);return{saveUserProfile:m}},void 0);await d(r),a.myProfile=r,I("保存しました"),x()}),e.querySelector("[data-action='profile-change-password']")?.addEventListener("click",async()=>{const o=e.querySelector("#profile-new-password")?.value??"";if(o.length<8){I("8文字以上のパスワードを入力してください","warning");return}try{await Zs(o),I("パスワードを変更しました")}catch(r){I("変更失敗: "+(r instanceof Error?r.message:""),"error")}}),e.querySelectorAll("[data-action='int-edit']").forEach(o=>{o.addEventListener("click",()=>{a.integrationEditingId=o.dataset.id??null,x()})}),e.querySelector("[data-action='int-cancel']")?.addEventListener("click",()=>{a.integrationEditingId=null,x()}),e.querySelector("[data-action='int-save']")?.addEventListener("click",async()=>{const o=document.querySelector("[data-action='int-save']")?.dataset.id??"",r=a.integrations.find(S=>S.id===o);if(!r)return;const d={...r.config};Object.keys(d).forEach(S=>{const _=e.querySelector(`#int-${S}`);_&&(d[S]=_.value)});const m=e.querySelector("#int-enabled")?.checked??!1,{saveIntegrationSetting:g,fetchIntegrationSettings:$}=await D(async()=>{const{saveIntegrationSetting:S,fetchIntegrationSettings:_}=await Promise.resolve().then(()=>N);return{saveIntegrationSetting:S,fetchIntegrationSettings:_}},void 0);await g({...r,config:d,isEnabled:m})?(a.integrations=await $(),a.integrationEditingId=null,I("保存しました"),x()):I("保存失敗","error")}),e.querySelectorAll("[data-action='int-sync-shopify'], [data-action='shopify-sync']").forEach(o=>{o.addEventListener("click",async()=>{const r=a.integrations.find($=>$.provider==="shopify");if(!r){I("Shopify連携が未設定です","warning");return}o.textContent="同期中…",o.disabled=!0;const{syncShopifyOrders:d,fetchShopifyOrders:m}=await D(async()=>{const{syncShopifyOrders:$,fetchShopifyOrders:w}=await Promise.resolve().then(()=>N);return{syncShopifyOrders:$,fetchShopifyOrders:w}},void 0),g=await d(r);g.error?I("同期失敗: "+g.error,"error"):(I(`${g.count}件を同期しました`),a.shopifyOrders=await m()),x()})}),e.querySelectorAll("[data-action='int-sync-gcal']").forEach(o=>{o.addEventListener("click",async()=>{const r=a.integrations.find($=>$.provider==="google_calendar");if(!r)return;o.textContent="同期中…",o.disabled=!0;const{syncGoogleCalendar:d,fetchCalendarEvents:m}=await D(async()=>{const{syncGoogleCalendar:$,fetchCalendarEvents:w}=await Promise.resolve().then(()=>N);return{syncGoogleCalendar:$,fetchCalendarEvents:w}},void 0),g=await d(r);g.error?I("同期失敗: "+g.error,"error"):(I(`${g.count}件を同期しました`),a.calendarEvents=await m(a.calendarYearMonth)),x()})}),e.querySelector("[data-action='fax-upload']")?.addEventListener("click",async()=>{const r=e.querySelector("#fax-file")?.files?.[0];if(!r){I("FAX画像を選択してください","warning");return}const d=a.integrations.find(m=>m.provider==="cloud_vision");if(!d||!d.config.api_key){I("Cloud Vision API Key が設定されていません。/integrations で設定してください","warning");return}a.faxProcessing=!0,a.faxOcrText=null,x();try{const m=new FileReader;m.onload=async()=>{const g=String(m.result??""),{ocrFaxImage:$,saveFaxRecord:w,fetchFaxInbox:S}=await D(async()=>{const{ocrFaxImage:q,saveFaxRecord:M,fetchFaxInbox:L}=await Promise.resolve().then(()=>N);return{ocrFaxImage:q,saveFaxRecord:M,fetchFaxInbox:L}},void 0),_=await $(d,g),E=e.querySelector("#fax-sender-name")?.value??"",A=e.querySelector("#fax-sender-phone")?.value??"";await w({id:`fax_${Date.now()}`,receivedAt:new Date().toISOString(),senderName:E,senderPhone:A,ocrStatus:_.error?"failed":"done",ocrText:_.text}),a.faxOcrText=_.error?`エラー: ${_.error}`:_.text,a.faxRecords=await S(),a.faxProcessing=!1,x()},m.readAsDataURL(r)}catch(m){I("OCR失敗: "+(m instanceof Error?m.message:""),"error"),a.faxProcessing=!1,x()}}),e.querySelector("[data-action='ms-new']")?.addEventListener("click",()=>{a.mailSenderEditingId="__new__",x()}),e.querySelectorAll("[data-action='ms-edit']").forEach(o=>{o.addEventListener("click",()=>{a.mailSenderEditingId=o.dataset.id??null,x()})}),e.querySelector("[data-action='ms-cancel']")?.addEventListener("click",()=>{a.mailSenderEditingId=null,x()}),e.querySelector("[data-action='ms-save']")?.addEventListener("click",async()=>{const o=e.querySelector("[data-action='ms-save']")?.dataset.id||`sender_${Date.now()}`,r={id:o,name:e.querySelector("#ms-name")?.value||"",email:e.querySelector("#ms-email")?.value||"",displayName:e.querySelector("#ms-display-name")?.value||"",replyTo:e.querySelector("#ms-reply-to")?.value||"",signature:e.querySelector("#ms-signature")?.value||"",isDefault:e.querySelector("#ms-default")?.checked??!1,isVerified:a.mailSenders.find($=>$.id===o)?.isVerified??!1};if(!r.name||!r.email){I("名前とメールアドレスは必須です","warning");return}const{saveMailSender:d,fetchMailSenders:m}=await D(async()=>{const{saveMailSender:$,fetchMailSenders:w}=await Promise.resolve().then(()=>N);return{saveMailSender:$,fetchMailSenders:w}},void 0);await d(r)?(a.mailSenders=await m(),a.mailSenderEditingId=null,I("保存しました"),x()):I("保存に失敗しました","error")}),e.querySelectorAll("[data-action='ms-delete']").forEach(o=>{o.addEventListener("click",async()=>{if(!await be("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const r=o.dataset.id??"",{deleteMailSender:d,fetchMailSenders:m}=await D(async()=>{const{deleteMailSender:$,fetchMailSenders:w}=await Promise.resolve().then(()=>N);return{deleteMailSender:$,fetchMailSenders:w}},void 0);await d(r)?(a.mailSenders=await m(),x()):I("削除失敗","error")})}),e.querySelector("[data-action='delivery-print']")?.addEventListener("click",()=>{window.print()}),e.querySelector("[data-action='billing-print']")?.addEventListener("click",()=>{window.print()}),e.querySelector("[data-action='tax-print']")?.addEventListener("click",()=>{window.print()}),e.querySelector("[data-action='print-page']")?.addEventListener("click",()=>{e.querySelectorAll("details").forEach(o=>{o.open=!0}),window.print()}),e.querySelector("[data-action='demand-csv-export']")?.addEventListener("click",()=>{if(!a.demandAnalysis){I("データなし","error");return}const o=a.demandAnalysis,r=Object.entries(o.matrix).map(([m,g])=>{const $={productCode:m};return o.months.forEach(w=>{$[w]=g[w]??0}),$}),d=[{key:"productCode",label:"商品コード"},...o.months.map(m=>({key:m,label:m}))];fa("demand-analysis.csv",r,d)}),e.querySelector("[data-action='plan-csv-export']")?.addEventListener("click",()=>{if(a.productionPlan.length===0){I("データなし","error");return}const o=a.productionPlan.map(d=>({...d}));fa("production-plan.csv",o,[{key:"productCode",label:"商品コード"},{key:"productName",label:"商品名"},{key:"productionType",label:"生産区分"},{key:"demandForecast",label:"需要予測"},{key:"safetyStockTarget",label:"安全在庫"},{key:"openingStock",label:"在庫数"},{key:"requiredProduction",label:"必要生産量"},{key:"plannedQty",label:"計画数"},{key:"actualQty",label:"実績"},{key:"status",label:"ステータス"}])}),e.querySelector("[data-action='billing-close-all']")?.addEventListener("click",async()=>{await be("当月の全請求を締め切りますか？")&&I("締め処理はデータベース側の設定が必要です","info")}),e.querySelector("#brewing-fy-select")?.addEventListener("change",async o=>{const r=parseInt(o.target.value);a.brewingPlanFY=r;const{fetchBrewingPlanSummary:d,fetchBrewingMonthlyTrend:m,fetchBrewingSchedule:g,fetchBrewingProductDetail:$,fetchBrewingCustomCategories:w,fetchBrewingCategoryOverrides:S,fetchAllBrewingStockEntries:_}=await D(async()=>{const{fetchBrewingPlanSummary:V,fetchBrewingMonthlyTrend:z,fetchBrewingSchedule:H,fetchBrewingProductDetail:B,fetchBrewingCustomCategories:j,fetchBrewingCategoryOverrides:F,fetchAllBrewingStockEntries:U}=await Promise.resolve().then(()=>N);return{fetchBrewingPlanSummary:V,fetchBrewingMonthlyTrend:z,fetchBrewingSchedule:H,fetchBrewingProductDetail:B,fetchBrewingCustomCategories:j,fetchBrewingCategoryOverrides:F,fetchAllBrewingStockEntries:U}},void 0),[E,A,q,M,L,T,O]=await Promise.all([d(`${r}-10-01`,`${r+1}-09-30`),m(`${r}-10-01`,`${r+1}-09-30`),g(r),$(`${r}-10-01`,`${r+1}-09-30`),w(),S(),_()]);a.brewingPlanData=E,a.brewingMonthlyTrend=A,a.brewingSchedule=q,a.brewingProductDetail=M,a.brewingStockEntries=O,a.brewingCustomCategories=L,a.brewingOverrides=T,a.brewingExcludedProducts=new Set,x()}),e.querySelectorAll("[data-action='brew-move-to-child']").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.code??"",d=o.dataset.parent??"";if(!r||!d)return;if(o.checked){a.brewingExcludedProducts.delete(r),x();return}a.brewingExcludedProducts.add(r);const m=a.brewingCustomCategories.filter(g=>g.parentCategory===d);if(m.length===1){const{setBrewingCategoryOverride:g,fetchBrewingPlanSummary:$,fetchBrewingProductDetail:w,fetchBrewingCategoryOverrides:S}=await D(async()=>{const{setBrewingCategoryOverride:M,fetchBrewingPlanSummary:L,fetchBrewingProductDetail:T,fetchBrewingCategoryOverrides:O}=await Promise.resolve().then(()=>N);return{setBrewingCategoryOverride:M,fetchBrewingPlanSummary:L,fetchBrewingProductDetail:T,fetchBrewingCategoryOverrides:O}},void 0);await g(r,m[0].name);const _=a.brewingPlanFY,[E,A,q]=await Promise.all([$(`${_}-10-01`,`${_+1}-09-30`),w(`${_}-10-01`,`${_+1}-09-30`),S()]);a.brewingPlanData=E,a.brewingProductDetail=A,a.brewingOverrides=q,a.brewingExcludedProducts.delete(r)}x()})}),e.querySelectorAll("[data-action='brew-confirm-to-child']").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.code??"",d=o.dataset.cat??"";if(!r||!d)return;const{setBrewingCategoryOverride:m,fetchBrewingPlanSummary:g,fetchBrewingProductDetail:$,fetchBrewingCategoryOverrides:w}=await D(async()=>{const{setBrewingCategoryOverride:q,fetchBrewingPlanSummary:M,fetchBrewingProductDetail:L,fetchBrewingCategoryOverrides:T}=await Promise.resolve().then(()=>N);return{setBrewingCategoryOverride:q,fetchBrewingPlanSummary:M,fetchBrewingProductDetail:L,fetchBrewingCategoryOverrides:T}},void 0);await m(r,d);const S=a.brewingPlanFY,[_,E,A]=await Promise.all([g(`${S}-10-01`,`${S+1}-09-30`),$(`${S}-10-01`,`${S+1}-09-30`),w()]);a.brewingPlanData=_,a.brewingProductDetail=E,a.brewingOverrides=A,x()})}),e.querySelectorAll("[data-action='brew-unconfirm']").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.code??"";if(!r)return;const{setBrewingCategoryOverride:d,fetchBrewingPlanSummary:m,fetchBrewingProductDetail:g,fetchBrewingCategoryOverrides:$}=await D(async()=>{const{setBrewingCategoryOverride:A,fetchBrewingPlanSummary:q,fetchBrewingProductDetail:M,fetchBrewingCategoryOverrides:L}=await Promise.resolve().then(()=>N);return{setBrewingCategoryOverride:A,fetchBrewingPlanSummary:q,fetchBrewingProductDetail:M,fetchBrewingCategoryOverrides:L}},void 0);await d(r,null);const w=a.brewingPlanFY,[S,_,E]=await Promise.all([m(`${w}-10-01`,`${w+1}-09-30`),g(`${w}-10-01`,`${w+1}-09-30`),$()]);a.brewingPlanData=S,a.brewingProductDetail=_,a.brewingOverrides=E,x()})}),e.querySelectorAll("[data-action='brew-alc-save']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.cat??"",d="bc-"+encodeURIComponent(r).replace(/%/g,"-"),m=e.querySelector(`#alc-raw-${d}`),g=e.querySelector(`#alc-target-${d}`),$=parseFloat(m?.value??"18")||18,w=parseFloat(g?.value??"15")||15,{saveBrewingAlcoholSetting:S}=await D(async()=>{const{saveBrewingAlcoholSetting:E}=await Promise.resolve().then(()=>N);return{saveBrewingAlcoholSetting:E}},void 0);await S(r,$,w)&&(a.brewingAlcoholSettings[r]={brewCategory:r,rawAlcoholPct:$,targetAlcoholPct:w}),x()})}),e.querySelectorAll("[data-action='brew-move-product']").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.code??"",d=o.value,m=o.dataset.current??"";if(d===m)return;const{setBrewingCategoryOverride:g,fetchBrewingPlanSummary:$,fetchBrewingProductDetail:w,fetchBrewingCategoryOverrides:S}=await D(async()=>{const{setBrewingCategoryOverride:E,fetchBrewingPlanSummary:A,fetchBrewingProductDetail:q,fetchBrewingCategoryOverrides:M}=await Promise.resolve().then(()=>N);return{setBrewingCategoryOverride:E,fetchBrewingPlanSummary:A,fetchBrewingProductDetail:q,fetchBrewingCategoryOverrides:M}},void 0);if(await g(r,d)){const E=a.brewingPlanFY,[A,q,M]=await Promise.all([$(`${E}-10-01`,`${E+1}-09-30`),w(`${E}-10-01`,`${E+1}-09-30`),S()]);a.brewingPlanData=A,a.brewingProductDetail=q,a.brewingOverrides=M}x()})}),e.querySelectorAll("[data-action='brew-link-type']").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.cat??"",d=o.value;if(!r||!d)return;const{linkTypeToCategory:m,fetchBrewingPlanSummary:g,fetchBrewingProductDetail:$,fetchBrewingCategoryOverrides:w,fetchCategoryTypeLinks:S}=await D(async()=>{const{linkTypeToCategory:L,fetchBrewingPlanSummary:T,fetchBrewingProductDetail:O,fetchBrewingCategoryOverrides:V,fetchCategoryTypeLinks:z}=await Promise.resolve().then(()=>N);return{linkTypeToCategory:L,fetchBrewingPlanSummary:T,fetchBrewingProductDetail:O,fetchBrewingCategoryOverrides:V,fetchCategoryTypeLinks:z}},void 0);await m(r,d);const _=a.brewingPlanFY,[E,A,q,M]=await Promise.all([g(`${_}-10-01`,`${_+1}-09-30`),$(`${_}-10-01`,`${_+1}-09-30`),w(),S()]);a.brewingPlanData=E,a.brewingProductDetail=A,a.brewingOverrides=q,a.brewingTypeLinks=M,x()})}),e.querySelectorAll("[data-action='brew-unlink-type']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.cat??"",d=o.dataset.type??"";if(!r||!d)return;const{unlinkTypeFromCategory:m,fetchBrewingPlanSummary:g,fetchBrewingProductDetail:$,fetchBrewingCategoryOverrides:w,fetchCategoryTypeLinks:S}=await D(async()=>{const{unlinkTypeFromCategory:L,fetchBrewingPlanSummary:T,fetchBrewingProductDetail:O,fetchBrewingCategoryOverrides:V,fetchCategoryTypeLinks:z}=await Promise.resolve().then(()=>N);return{unlinkTypeFromCategory:L,fetchBrewingPlanSummary:T,fetchBrewingProductDetail:O,fetchBrewingCategoryOverrides:V,fetchCategoryTypeLinks:z}},void 0);await m(r,d);const _=a.brewingPlanFY,[E,A,q,M]=await Promise.all([g(`${_}-10-01`,`${_+1}-09-30`),$(`${_}-10-01`,`${_+1}-09-30`),w(),S()]);a.brewingPlanData=E,a.brewingProductDetail=A,a.brewingOverrides=q,a.brewingTypeLinks=M,x()})}),e.querySelector("[data-action='brew-add-category']")?.addEventListener("click",async()=>{const o=e.querySelector("#brew-new-category-name"),r=e.querySelector("#brew-new-category-parent"),d=o?.value.trim()??"",m=r?.value??"";if(!d)return;if(!m){I("親区分を選択してください","warning");return}if(["純米大吟醸","大吟醸","純米吟醸","純米","本醸造","普通酒","リキュール","その他",...a.brewingCustomCategories.map(S=>S.name)].includes(d)){I("同名の区分が既に存在します","warning");return}const{addBrewingCustomCategory:$}=await D(async()=>{const{addBrewingCustomCategory:S}=await Promise.resolve().then(()=>N);return{addBrewingCustomCategory:S}},void 0);await $(d,m)?(a.brewingCustomCategories.push({name:d,parentCategory:m}),o&&(o.value=""),I(`「${d}」を追加しました（${m}系）`)):I("追加に失敗しました","error"),x()}),e.querySelectorAll("[data-action='brew-delete-category']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.cat??"";if(!r)return;const{deleteBrewingCustomCategory:d,fetchBrewingPlanSummary:m,fetchBrewingProductDetail:g}=await D(async()=>{const{deleteBrewingCustomCategory:w,fetchBrewingPlanSummary:S,fetchBrewingProductDetail:_}=await Promise.resolve().then(()=>N);return{deleteBrewingCustomCategory:w,fetchBrewingPlanSummary:S,fetchBrewingProductDetail:_}},void 0);if(await d(r)){a.brewingCustomCategories=a.brewingCustomCategories.filter(E=>E.name!==r);for(const[E,A]of Object.entries(a.brewingOverrides))A===r&&delete a.brewingOverrides[E];const w=a.brewingPlanFY,[S,_]=await Promise.all([m(`${w}-10-01`,`${w+1}-09-30`),g(`${w}-10-01`,`${w+1}-09-30`)]);a.brewingPlanData=S,a.brewingProductDetail=_,I(`「${r}」を削除しました`)}x()})}),e.querySelectorAll("[data-action='brew-add-entry']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.cat??"",d=o.dataset.catId??"",g=e.querySelector(`#new-entry-target-${d}`)?.value??r,$=e.querySelector(`#new-entry-label-${d}`),w=e.querySelector(`#new-entry-vol-${d}`),S=$?.value.trim()??"",_=parseFloat(w?.value??"0");if(_<=0)return;const{addBrewingStockEntry:E,fetchBrewingPlanSummary:A,fetchAllBrewingStockEntries:q}=await D(async()=>{const{addBrewingStockEntry:L,fetchBrewingPlanSummary:T,fetchAllBrewingStockEntries:O}=await Promise.resolve().then(()=>N);return{addBrewingStockEntry:L,fetchBrewingPlanSummary:T,fetchAllBrewingStockEntries:O}},void 0);if(await E(g,S||`タンク${a.brewingStockEntries.filter(L=>L.brewCategory===g).length+1}`,_)){const L=a.brewingPlanFY,[T,O]=await Promise.all([A(`${L}-10-01`,`${L+1}-09-30`),q()]);a.brewingPlanData=T,a.brewingStockEntries=O}x(),requestAnimationFrame(()=>{const L=document.getElementById(`stock-display-${d}`),T=document.getElementById(`stock-edit-${d}`),O=document.querySelector(`.btn-edit-stock[data-cat-id="${d}"]`);L&&(L.style.display="none"),T&&(T.style.display=""),O&&(O.style.display="none")})})}),e.querySelectorAll("[data-action='brew-reassign-entry']").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.id??"",d=o.value;if(!r||!d)return;const{reassignBrewingStockEntry:m,fetchBrewingPlanSummary:g,fetchAllBrewingStockEntries:$}=await D(async()=>{const{reassignBrewingStockEntry:S,fetchBrewingPlanSummary:_,fetchAllBrewingStockEntries:E}=await Promise.resolve().then(()=>N);return{reassignBrewingStockEntry:S,fetchBrewingPlanSummary:_,fetchAllBrewingStockEntries:E}},void 0);if(await m(r,d)){const S=a.brewingPlanFY,[_,E]=await Promise.all([g(`${S}-10-01`,`${S+1}-09-30`),$()]);a.brewingPlanData=_,a.brewingStockEntries=E}x(),requestAnimationFrame(()=>{e.querySelectorAll(".btn-edit-stock").forEach(S=>{const _=document.getElementById(`stock-display-${S.dataset.catId}`),E=document.getElementById(`stock-edit-${S.dataset.catId}`);E&&E.querySelector(`[data-id="${r}"]`)&&(_&&(_.style.display="none"),E.style.display="",S.style.display="none")})})})}),e.querySelectorAll("[data-action='brew-delete-entry']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.id??"",d=o.dataset.cat??"",m="bc-"+encodeURIComponent(d).replace(/%/g,"-"),{deleteBrewingStockEntry:g,fetchBrewingPlanSummary:$,fetchAllBrewingStockEntries:w}=await D(async()=>{const{deleteBrewingStockEntry:_,fetchBrewingPlanSummary:E,fetchAllBrewingStockEntries:A}=await Promise.resolve().then(()=>N);return{deleteBrewingStockEntry:_,fetchBrewingPlanSummary:E,fetchAllBrewingStockEntries:A}},void 0);if(await g(r)){const _=a.brewingPlanFY,[E,A]=await Promise.all([$(`${_}-10-01`,`${_+1}-09-30`),w()]);a.brewingPlanData=E,a.brewingStockEntries=A}x(),requestAnimationFrame(()=>{const _=document.getElementById(`stock-display-${m}`),E=document.getElementById(`stock-edit-${m}`),A=document.querySelector(`.btn-edit-stock[data-cat-id="${m}"]`);_&&(_.style.display="none"),E&&(E.style.display=""),A&&(A.style.display="none")})})}),e.querySelectorAll(".btn-edit-stock").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.catId??"",d=e.querySelector(`#stock-display-${r}`),m=e.querySelector(`#stock-edit-${r}`);d&&(d.style.display="none"),m&&(m.style.display=""),o.style.display="none"})}),e.querySelectorAll(".btn-cancel-stock").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.catId??"",d=e.querySelector(`#stock-display-${r}`),m=e.querySelector(`#stock-edit-${r}`),g=e.querySelector(`.btn-edit-stock[data-cat-id="${r}"]`);d&&(d.style.display=""),m&&(m.style.display="none"),g&&(g.style.display="")})}),e.querySelectorAll(".btn-add-schedule-row").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.catId??"",d=e.querySelector(`#schedule-rows-${r}`);if(!d)return;const m=d.querySelectorAll(".schedule-edit-row").length,g=document.createElement("div");g.innerHTML=buildScheduleEditRowHTML(r,m,9,2,0,"");const $=g.firstElementChild;d.appendChild($),$.querySelector(".btn-remove-schedule-row")?.addEventListener("click",()=>$.remove())})}),e.querySelectorAll(".btn-remove-schedule-row").forEach(o=>{o.addEventListener("click",()=>o.closest(".schedule-edit-row")?.remove())}),e.querySelectorAll(".btn-save-stock").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.cat??"",d=o.dataset.catId??"",m=e.querySelector(`#stock-input-${d}`),g=parseFloat(m?.value??"");if(isNaN(g)||g<0){alert("有効な数値を入力してください");return}o.textContent="保存中...",o.setAttribute("disabled","true");try{const{upsertBrewingStock:$,fetchBrewingPlanSummary:w,fetchBrewingMonthlyTrend:S}=await D(async()=>{const{upsertBrewingStock:q,fetchBrewingPlanSummary:M,fetchBrewingMonthlyTrend:L}=await Promise.resolve().then(()=>N);return{upsertBrewingStock:q,fetchBrewingPlanSummary:M,fetchBrewingMonthlyTrend:L}},void 0),_=a.brewingPlanFY;await $(r,g,0);const[E,A]=await Promise.all([w(`${_}-10-01`,`${_+1}-09-30`),S(`${_}-10-01`,`${_+1}-09-30`)]);a.brewingPlanData=E,a.brewingMonthlyTrend=A,x()}catch($){console.error("[brewing save]",$),alert(`保存エラー: ${String($)}`),o.textContent="保存",o.removeAttribute("disabled")}})}),e.querySelectorAll("[data-toggle-cat]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.toggleCat??"",d=`sub-row-${"bc-"+encodeURIComponent(r).replace(/%/g,"-")}`,m=e.querySelectorAll(`.${d}`),g=o.querySelector(".toggle-icon"),$=m[0]?.style.display!=="none";m.forEach(w=>{w.style.display=$?"none":""}),g&&(g.innerHTML=$?"&#9654;":"&#9660;")})}),e.querySelector("[data-action='jikomi-new']")?.addEventListener("click",()=>{I("新規仕込の登録はマスタ管理から行ってください","info")}),e.querySelector("[data-action='kentei-new']")?.addEventListener("click",()=>{I("新規検定の登録はマスタ管理から行ってください","info")}),e.querySelectorAll("[data-action='kentei-edit']").forEach(o=>{o.addEventListener("click",()=>{I("検定の編集はマスタ管理から行ってください","info")})}),e.querySelector("[data-action='purchase-new']")?.addEventListener("click",()=>{I("新規仕入の登録はマスタ管理から行ってください","info")}),e.querySelectorAll("[data-action='payable-pay']").forEach(o=>{o.addEventListener("click",async()=>{await be("この買掛を入金済みにしますか？")&&I("入金処理はデータベース側の設定が必要です","info")})}),e.querySelectorAll("[data-action='bill-detail']").forEach(o=>{o.addEventListener("click",()=>{I("請求書詳細は印刷センターから確認してください","info")})}),e.querySelector("[data-action='bill-new']")?.addEventListener("click",()=>{I("新規請求書の作成は伝票入力から行ってください","info")}),e.querySelectorAll("[data-action='tank-detail']").forEach(o=>{o.addEventListener("click",()=>{const r=o.closest("tr")?.querySelector("td")?.textContent??"";I(`タンク ${r} の詳細: 仕込台帳を参照してください`,"info")})}),e.querySelector("[data-action='order-new']")?.addEventListener("click",()=>{I("新規注文はモバイル注文画面から行ってください","info")}),e.querySelectorAll("[data-action='order-detail']").forEach(o=>{o.addEventListener("click",()=>{const r=o.closest("tr")?.querySelector("td")?.textContent??"";I(`注文 ${r} の詳細を表示します`,"info")})}),e.querySelector("[data-action='fax-create-invoice']")?.addEventListener("click",()=>{I("FAXから伝票を起票するには、伝票入力画面をご利用ください","info")}),e.querySelectorAll("[data-action='fax-view']").forEach(o=>{o.addEventListener("click",()=>{I("FAX詳細の表示は準備中です","info")})}),e.querySelector("[data-action='tour-show-form']")?.addEventListener("click",()=>{window.open("/tour-form","_blank")}),e.querySelector("[data-action='prospect-convert']")?.addEventListener("click",()=>{I("得意先化するにはマスタ管理で得意先を作成してください","info")}),e.querySelectorAll("[data-action='create-proposal']").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.customer??"";I(`得意先 ${r} への提案書を作成するには見積作成画面をご利用ください`,"info")})}),e.querySelector("[data-action='lb-new-manual']")?.addEventListener("click",()=>{I("手動リスト作成は準備中です","info")}),e.querySelector("[data-action='lb-delete-list']")?.addEventListener("click",async()=>{const o=e.querySelector("[data-action='lb-delete-list']")?.dataset.id;if(!o||!await be("このリストを削除しますか？"))return;const{supabaseDelete:d}=await D(async()=>{const{supabaseDelete:g}=await Promise.resolve().then(()=>X);return{supabaseDelete:g}},void 0);if(await d("lead_lists",o)){const{fetchLeadLists:g}=await D(async()=>{const{fetchLeadLists:$}=await Promise.resolve().then(()=>N);return{fetchLeadLists:$}},void 0);a.leadLists=await g(),I("削除しました","success"),x()}else I("削除に失敗しました","error")}),e.querySelector("[data-action='wf-new-order']")?.addEventListener("click",()=>{I("新規受注の登録はモバイル注文画面から行ってください","info")}),e.querySelectorAll("[data-sc-ym]").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.scYm;if(!r)return;a.shipmentCalendarYearMonth=r,a.shipmentCalendarData=null,a.shipmentCalendarSelectedDate=null,x();const{fetchShipmentCalendar:d}=await D(async()=>{const{fetchShipmentCalendar:m}=await Promise.resolve().then(()=>N);return{fetchShipmentCalendar:m}},void 0);a.shipmentCalendarData=await d(r),x()})}),e.querySelectorAll("[data-sc-date]").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.scDate;r&&(a.shipmentCalendarSelectedDate=a.shipmentCalendarSelectedDate===r?null:r,x())})}),e.querySelectorAll("[data-action='cal-prev'], [data-action='cal-next'], [data-action='cal-today']").forEach(o=>{o.addEventListener("click",async()=>{a.calendarYearMonth=o.dataset.ym??a.calendarYearMonth;const{fetchCalendarEvents:r}=await D(async()=>{const{fetchCalendarEvents:d}=await Promise.resolve().then(()=>N);return{fetchCalendarEvents:d}},void 0);a.calendarEvents=await r(a.calendarYearMonth),x()})}),e.querySelector("#cal-month-input")?.addEventListener("change",async o=>{a.calendarYearMonth=o.target.value;const{fetchCalendarEvents:r}=await D(async()=>{const{fetchCalendarEvents:d}=await Promise.resolve().then(()=>N);return{fetchCalendarEvents:d}},void 0);a.calendarEvents=await r(a.calendarYearMonth),x()}),e.querySelector("#cal-filter-category")?.addEventListener("change",o=>{a.calendarFilterCategory=o.target.value,x()}),e.querySelector("[data-action='cal-new']")?.addEventListener("click",()=>{const o=new Date;a.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:new Date(o.getTime()+3600*1e3).toISOString(),isAllDay:!1}},x()}),e.querySelectorAll("[data-cal-date]").forEach(o=>{o.tagName!=="BUTTON"&&o.addEventListener("click",r=>{if(r.target.closest(".cal-event"))return;const d=o.dataset.calDate??"";a.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:`${d}T10:00:00`,isAllDay:!1}},x()})}),e.querySelectorAll("[data-cal-event-id]").forEach(o=>{o.addEventListener("click",r=>{r.stopPropagation();const d=o.dataset.calEventId,m=a.calendarEvents.find(g=>g.id===d);m&&(a.calendarEdit={isOpen:!0,isNew:!1,event:{...m}},x())})}),e.querySelectorAll("[data-action='cal-close']").forEach(o=>{o.addEventListener("click",r=>{r.currentTarget!==r.target&&!r.target.matches("button")||(a.calendarEdit=null,x())})}),e.querySelector("[data-action='cal-save']")?.addEventListener("click",async()=>{if(!a.calendarEdit)return;const{saveCalendarEvent:o,fetchCalendarEvents:r,CALENDAR_CATEGORY_COLORS:d}=await D(async()=>{const{saveCalendarEvent:S,fetchCalendarEvents:_,CALENDAR_CATEGORY_COLORS:E}=await Promise.resolve().then(()=>N);return{saveCalendarEvent:S,fetchCalendarEvents:_,CALENDAR_CATEGORY_COLORS:E}},void 0),m=document.querySelector("[data-action='cal-save']")?.dataset.id||a.calendarEdit.event.id||`evt_${Date.now()}`,g=e.querySelector("#cal-category")?.value??"general",$={id:m,title:e.querySelector("#cal-title")?.value??"",category:g,startsAt:new Date(e.querySelector("#cal-starts")?.value??new Date().toISOString()).toISOString(),endsAt:e.querySelector("#cal-ends")?.value?new Date(e.querySelector("#cal-ends").value).toISOString():void 0,isAllDay:e.querySelector("#cal-allday")?.checked??!1,location:e.querySelector("#cal-location")?.value??"",relatedCustomerCode:e.querySelector("#cal-customer")?.value??"",description:e.querySelector("#cal-description")?.value??"",color:d[g]};if(!$.title){I("タイトルは必須です","warning");return}await o($)?(a.calendarEvents=await r(a.calendarYearMonth),a.calendarEdit=null,I("保存しました"),x()):I("保存失敗","error")}),e.querySelector("[data-action='cal-delete']")?.addEventListener("click",async()=>{const o=document.querySelector("[data-action='cal-delete']")?.dataset.id??"";if(!o||!await be("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deleteCalendarEvent:r,fetchCalendarEvents:d}=await D(async()=>{const{deleteCalendarEvent:g,fetchCalendarEvents:$}=await Promise.resolve().then(()=>N);return{deleteCalendarEvent:g,fetchCalendarEvents:$}},void 0);await r(o)?(a.calendarEvents=await d(a.calendarYearMonth),a.calendarEdit=null,I("削除しました"),x()):I("削除失敗","error")}),e.querySelector("[data-action='import-execute']")?.addEventListener("click",async()=>{if(a.importPreview){a.importing=!0,x();try{const o=a.importPreview.rows.filter(d=>d._valid),r=await Is(a.importEntity,o);a.importResult=`取り込み完了: ${r.inserted}件成功 / ${r.failed}件失敗`,a.importPreview=null}catch(o){a.importResult=`エラー: ${o instanceof Error?o.message:String(o)}`}finally{a.importing=!1,x()}}}),e.querySelector("[data-action='store-load']")?.addEventListener("click",()=>{const o=e.querySelector("#store-date")?.value??a.storeSalesDate;a.storeSalesDate=o,a.storeSales=[],a.actionLoading=!0,x(),La(o).then(r=>{a.storeSales=r,a.actionLoading=!1,x()})}),e.querySelectorAll("[data-action='copy-config']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.configValue??"";if(r)try{await navigator.clipboard.writeText(r),o.textContent="コピー済み",window.setTimeout(()=>{o.textContent="コピー"},1600)}catch(d){console.warn("Clipboard copy failed",d)}})}),e.querySelector("[data-action='download-relay-config']")?.addEventListener("click",()=>{const r=JSON.stringify({supabase_url:he,supabase_anon_key:ee,z_drive_path:"Z:\\",sync_modules:["sk","sh","k5","h5"],interval_minutes:5,use_odbc:!1,odbc_dsn:"MagicSake",log_level:"INFO"},null,2),d=new Blob([r],{type:"application/json;charset=utf-8"}),m=URL.createObjectURL(d),g=document.createElement("a");g.href=m,g.download="relay_config.json",g.click(),URL.revokeObjectURL(m)}),e.querySelectorAll("[data-action='copy-code']").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.code??"";if(r)try{await navigator.clipboard.writeText(decodeURIComponent(r)),o.textContent="コピー済み",window.setTimeout(()=>{o.textContent="コピー"},1600)}catch(d){console.warn("Clipboard code copy failed",d)}})}),e.querySelectorAll("input[name='email-audience-mode']").forEach(o=>{o.addEventListener("change",()=>{Re(e),a.emailSaveMessage=null,x()})}),e.querySelectorAll("#email-region, #email-history-segment").forEach(o=>{o.addEventListener("change",()=>{Re(e),a.emailSaveMessage=null,x()})}),e.querySelector("#email-subject")?.addEventListener("input",()=>{Re(e),a.emailSaveMessage=null}),e.querySelector("#email-body")?.addEventListener("input",()=>{Re(e),a.emailSaveMessage=null}),e.querySelectorAll("[data-action='template-select']").forEach(o=>{o.addEventListener("click",()=>{a.emailTemplateId=o.dataset.templateId??"custom";const r=Rs(a.emailTemplateId);a.emailSubject=r.subject,a.emailBody=r.body,a.emailSaveMessage=null,x()})}),e.querySelector("[data-action='email-insert-link']")?.addEventListener("click",()=>{Re(e);const o=`

商品詳細はこちら: https://kaneishuzo.co.jp/products`;a.emailBody.includes("https://kaneishuzo.co.jp/products")||(a.emailBody=`${a.emailBody.trimEnd()}${o}`),a.emailSaveMessage=null,x()}),e.querySelector("[data-action='email-save']")?.addEventListener("click",()=>{Re(e),a.actionLoading=!0,x(),Et(ta("draft")).then(o=>{a.emailSaveMessage=`下書きを保存しました。${new Intl.DateTimeFormat("ja-JP",{month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(o.updatedAt??new Date().toISOString()))}`,a.actionLoading=!1,x()})}),e.querySelector("#email-sender")?.addEventListener("change",o=>{a.emailSenderId=o.target.value}),e.querySelector("[data-action='email-send']")?.addEventListener("click",()=>{Re(e),a.actionLoading=!0,a.emailSending=!0,x();const o=ta("sent");a.mailSenders.find(r=>r.id===a.emailSenderId),ns().then(async r=>{await Et({...o,recipientCount:r.sent}),a.emailSaveMessage=`${r.sent.toLocaleString("ja-JP")} 件送信しました。`,a.actionLoading=!1,a.emailSending=!1,x(),I(`${r.sent}件送信完了`)}).catch(async()=>{await Et(ta("draft")),a.emailSaveMessage="APIキー未設定のため下書きを保存しました。",a.actionLoading=!1,a.emailSending=!1,x(),I("APIキー未設定のため下書き保存しました","warning")})})}function x(){const e=document.querySelector("#app");if(!e)return;try{e.innerHTML=ap()}catch(n){console.error("[renderApp] render error:",n),e.innerHTML=`<div style="padding:32px;color:red;font-family:monospace;white-space:pre-wrap;">[描画エラー] ${String(n)}

${n?.stack??""}</div>`;return}ip(e),a.pickerMode&&e.querySelector("#modal-search")?.focus(),a.globalSearchOpen&&e.querySelector("#global-search-input")?.focus(),Ba()&&e.querySelector("#auth-email")?.focus(),requestAnimationFrame(()=>{for(const n of["fd-scaler","print-scaler","q-preview-scaler"]){const s=e.querySelector(`#${n}`),i=s?.querySelector(".fd-canvas, .print-preview, .q-preview-doc"),l=i?.querySelector(".print-page")??i;if(!s||!l)continue;const c=s.parentElement?.clientWidth??0,p=l.offsetWidth;if(c>0&&p>0&&p>c-24){const u=(c-24)/p;s.style.transform=`scale(${u})`,s.style.transformOrigin="top left",s.style.height=`${(l.offsetHeight+48)*u}px`}else s.style.transform="",s.style.height=""}});const t=a.sidebarOpen||a.pickerMode!==null||a.globalSearchOpen;document.body.style.overflow=t?"hidden":"",document.body.style.touchAction=t?"none":""}const Js="sake-cloud-cache",rp=300*1e3;function lp(){try{const e={ts:Date.now(),masterStats:a.masterStats,pipelineMeta:a.pipelineMeta};localStorage.setItem(Js,JSON.stringify(e))}catch{}}function cp(){try{const e=localStorage.getItem(Js);if(!e)return!1;const t=JSON.parse(e);return Date.now()-t.ts>rp?!1:(t.masterStats&&(a.masterStats=t.masterStats),t.pipelineMeta&&(a.pipelineMeta=t.pipelineMeta),!0)}catch{return!1}}let Us=0;async function Ge(){const e=cp();e&&(a.loading=!1,x()),a.loading=!e,e||x();try{const[t,n,s,i,l,c,p,u,y]=await Promise.all([In(),Tn(),_a(),Nn(),mt(a.invoiceFilter),Sa(a.ledgerCustomerCode),ka(),Mn(),qn("quote_company")]);if(a.salesSummary=t,a.paymentStatus=n,a.masterStats=s,a.pipelineMeta=i,a.invoiceRecords=l,a.customerLedger=c,a.salesAnalytics=p,a.syncDashboard=u,y){const v={...At,...la(),...y};a.quoteCompanySettings=v,ze(v)}if(zn().then(v=>{a.announcements=v,x()}),He.length===0&&jd(),a.rawTableList.length===0&&ds().then(v=>{a.rawTableList=v,a.route==="/raw-browser"&&x()}),!a.salesFilter.startDate||!a.salesFilter.endDate){const f=[...t.salesRecords].sort((P,o)=>new Date(o.date).getTime()-new Date(P.date).getTime())[0]?.date??new Date().toISOString(),b=new Date(f),k=new Date(b);k.setDate(b.getDate()-30),a.salesFilter={startDate:kn(k.toISOString()),endDate:kn(b.toISOString())}}(!a.invoiceFilter.startDate||!a.invoiceFilter.endDate)&&(a.invoiceFilter={...a.invoiceFilter,startDate:a.salesFilter.startDate,endDate:a.salesFilter.endDate},a.invoiceRecords=await mt(a.invoiceFilter)),a.error=null,lp()}catch(t){e||(a.error=t instanceof Error?t.message:"データの取得に失敗しました。")}finally{a.loading=!1,x(),Fa(a.route),Us=Date.now()}}window.addEventListener("popstate",()=>{a.route=js(location.pathname),a.currentCategory=za(a.route),a.sidebarOpen=!1,yt(),Fa(a.route)});window.addEventListener("keydown",e=>{if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="k"){e.preventDefault(),a.globalSearchOpen=!0,x();return}if(e.key==="Escape"){if(a.globalSearchOpen){yt(),x();return}if(a.pickerMode){Mt(),x();return}a.route==="/invoice-entry"&&!a.invoiceSaving&&(zs(),x());return}if(a.route==="/invoice-entry"&&!a.invoiceSaving&&(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault();const t=document.querySelector("#app");t&&Fs(t)}});a.user=Ot()?Ws():null;a.user?.email&&(async()=>{const{fetchMyProfile:e}=await D(async()=>{const{fetchMyProfile:t}=await Promise.resolve().then(()=>N);return{fetchMyProfile:t}},void 0);a.myProfile=await e(a.user.email),x()})();try{const e=localStorage.getItem("sake_print_options");e&&(a.printOptions={...a.printOptions,...JSON.parse(e)});const t=localStorage.getItem("sake_print_company");t&&(a.printCompany={...a.printCompany,...JSON.parse(t)});const n=localStorage.getItem("sake_fd_positions");n&&(a.fdSavedPositions=JSON.parse(n))}catch{}(function(){let t=null,n=0,s=0,i=0,l=0,c=1;document.addEventListener("mousedown",p=>{const u=p.target.closest(".fd-draggable");if(!u||!a.fdDesignMode)return;p.preventDefault();const y=u.closest(".fd-canvas");if(!y)return;const v=y.getBoundingClientRect();if(v.width===0)return;c=228.6/v.width,t=u,n=p.clientX,s=p.clientY,i=parseFloat(u.style.left)||0,l=parseFloat(u.style.top)||0,document.querySelectorAll(".fd-active").forEach(P=>P.classList.remove("fd-active")),u.classList.add("fd-active","fd-dragging"),a.fdActiveFieldId=u.dataset.fdId??null;const f=document.querySelector("#fd-selected-info");f&&(f.textContent=`選択中: ${u.title}`);const b=document.querySelector("#fd-sel-x"),k=document.querySelector("#fd-sel-y");b&&(b.value=String(i)),k&&(k.value=String(l))}),document.addEventListener("mousemove",p=>{if(!t)return;const u=(p.clientX-n)*c,y=(p.clientY-s)*c,v=Math.round((i+u)*2)/2,f=Math.round((l+y)*2)/2;t.style.left=v+"mm",t.style.top=f+"mm";const b=document.querySelector("#fd-sel-x"),k=document.querySelector("#fd-sel-y");b&&(b.value=String(v)),k&&(k.value=String(f))}),document.addEventListener("mouseup",()=>{t&&(t.classList.remove("fd-dragging"),t=null)}),document.addEventListener("keydown",p=>{if(!a.fdDesignMode||!a.fdActiveFieldId||p.key!=="ArrowLeft"&&p.key!=="ArrowRight"&&p.key!=="ArrowUp"&&p.key!=="ArrowDown"||p.target.tagName==="INPUT"||p.target.tagName==="TEXTAREA")return;const u=document.querySelector(`[data-fd-id="${a.fdActiveFieldId}"]`);if(!u)return;p.preventDefault();const y=.5;let v=parseFloat(u.style.left)||0,f=parseFloat(u.style.top)||0;p.key==="ArrowLeft"?v-=y:p.key==="ArrowRight"?v+=y:p.key==="ArrowUp"?f-=y:p.key==="ArrowDown"&&(f+=y),u.style.left=v+"mm",u.style.top=f+"mm";const b=document.querySelector("#fd-sel-x"),k=document.querySelector("#fd-sel-y");b&&(b.value=String(v)),k&&(k.value=String(f))})})();Ge();const dp=300*1e3;setInterval(()=>{!a.loading&&!document.hidden&&Ge()},dp);document.addEventListener("visibilitychange",()=>{!document.hidden&&Date.now()-Us>60*1e3&&Ge()});let ga="";fetch(`${location.origin}/index.html?_t=${Date.now()}`).then(e=>e.text()).then(e=>{ga=e}).catch(()=>{});setInterval(async()=>{if(!(!ga||document.hidden))try{await(await fetch(`${location.origin}/index.html?_t=${Date.now()}`)).text()!==ga&&!a.updateAvailable&&(a.updateAvailable=!0,x())}catch{}},120*1e3);export{D as _};
