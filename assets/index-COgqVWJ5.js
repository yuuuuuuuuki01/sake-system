(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}})();const Un="modulepreload",Qn=function(e){return"/"+e},Fa={},A=function(t,s,n){let i=Promise.resolve();if(s&&s.length>0){let y=function(f){return Promise.all(f.map(v=>Promise.resolve(v).then($=>({status:"fulfilled",value:$}),$=>({status:"rejected",reason:$}))))};var c=y;document.getElementsByTagName("link");const p=document.querySelector("meta[property=csp-nonce]"),u=p?.nonce||p?.getAttribute("nonce");i=y(s.map(f=>{if(f=Qn(f),f in Fa)return;Fa[f]=!0;const v=f.endsWith(".css"),$=v?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${$}`))return;const x=document.createElement("link");if(x.rel=v?"stylesheet":Un,v||(x.as="script"),x.crossOrigin="",x.href=f,u&&x.setAttribute("nonce",u),document.head.appendChild(x),v)return new Promise((k,o)=>{x.addEventListener("load",k),x.addEventListener("error",()=>o(new Error(`Unable to preload CSS for ${f}`)))})}))}function r(p){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=p,window.dispatchEvent(u),!u.defaultPrevented)throw p}return i.then(p=>{for(const u of p||[])u.status==="rejected"&&r(u.reason);return t().catch(r)})},re="https://loarwnuyvfxiscjjsmiz.supabase.co",H="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";async function ut(e,t){try{const s=new URL(`/rest/v1/${e}`,re),n=await fetch(s.toString(),{method:"POST",headers:{apikey:H,Authorization:`Bearer ${H}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(t)});if(!n.ok)throw new Error(`HTTP ${n.status}`);return(await n.json())[0]??null}catch(s){return console.warn(`Failed to insert into Supabase table ${e}`,s),null}}async function ha(e,t){try{const s=new URL(`/rest/v1/${e}`,re),n=await fetch(s.toString(),{method:"POST",headers:{apikey:H,Authorization:`Bearer ${H}`,"Content-Type":"application/json",Prefer:"return=representation,resolution=merge-duplicates"},body:JSON.stringify(t)});if(!n.ok)throw new Error(`HTTP ${n.status}`);return(await n.json())[0]??null}catch(s){return console.warn(`Failed to upsert into Supabase table ${e}`,s),null}}async function fa(e,t,s){try{const n=new URL(`/rest/v1/${e}?id=eq.${t}`,re);return(await fetch(n.toString(),{method:"PATCH",headers:{apikey:H,Authorization:`Bearer ${H}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(s)})).ok}catch{return!1}}async function ue(e,t={}){try{const s=new URL(`/rest/v1/rpc/${e}`,re),n=await fetch(s.toString(),{method:"POST",headers:{apikey:H,Authorization:`Bearer ${H}`,"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(s){return console.warn(`Failed to call Supabase RPC ${e}`,s),null}}async function va(e){try{const t=new URL(`/rest/v1/${e}`,re);t.searchParams.set("select","*"),t.searchParams.set("limit","0");const s=await fetch(t.toString(),{method:"GET",headers:{apikey:H,Authorization:`Bearer ${H}`,Accept:"application/json",Prefer:"count=exact"}});if(!s.ok)return 0;const n=s.headers.get("Content-Range");if(n){const i=n.match(/\/(\d+)/);if(i)return parseInt(i[1],10)}return 0}catch{return 0}}async function N(e,t={}){try{const s=new URL(`/rest/v1/${e}`,re);Object.entries(t).forEach(([i,r])=>{s.searchParams.set(i,r)});const n=await fetch(s.toString(),{method:"GET",headers:{apikey:H,Authorization:`Bearer ${H}`,Accept:"application/json",Prefer:"return=representation"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(s){return console.warn(`Failed to query Supabase table ${e}`,s),[]}}async function xs(e,t){try{const s=new URL(`/rest/v1/${e}?id=eq.${encodeURIComponent(t)}`,re);return(await fetch(s.toString(),{method:"DELETE",headers:{apikey:H,Authorization:`Bearer ${H}`}})).ok}catch{return!1}}async function ne(e,t={},s=1e3){const n=[];let i=0;try{for(;;){const r=new URL(`/rest/v1/${e}`,re);Object.entries(t).forEach(([u,y])=>{r.searchParams.set(u,y)}),r.searchParams.set("limit",String(s)),r.searchParams.set("offset",String(i));const c=await fetch(r.toString(),{method:"GET",headers:{apikey:H,Authorization:`Bearer ${H}`,Accept:"application/json",Prefer:"return=representation"}});if(!c.ok)throw new Error(`HTTP ${c.status}`);const p=await c.json();if(n.push(...p),p.length<s)break;i+=s}return n}catch(r){return console.warn(`Failed to query all rows from Supabase table ${e}`,r),n.length>0?n:[]}}const U=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:H,SUPABASE_URL:re,supabaseCount:va,supabaseDelete:xs,supabaseInsert:ut,supabaseQuery:N,supabaseQueryAll:ne,supabaseRpc:ue,supabaseUpdate:fa,supabaseUpsert:ha},Symbol.toStringTag,{value:"Module"})),ga="sake_auth";function Ss(e){localStorage.setItem(ga,JSON.stringify(e))}function ks(){return{apikey:H,"Content-Type":"application/json"}}function Hn(e){try{const[,t]=e.split(".");if(!t)return null;const s=t.replaceAll("-","+").replaceAll("_","/"),n=s.padEnd(Math.ceil(s.length/4)*4,"=");return JSON.parse(atob(n))}catch{return null}}async function Ps(e,t){const s=await fetch(`${re}/auth/v1/${e}`,{method:"POST",headers:ks(),body:JSON.stringify(t)}),n=await s.json().catch(()=>({}));if(!s.ok)throw new Error(n.error_description??n.msg??`HTTP ${s.status}`);return n}async function Gn(e,t){const s=await Ps("token?grant_type=password",{email:e,password:t});return Ss({access_token:s.access_token,refresh_token:s.refresh_token}),{email:s.user?.email??e}}async function za(e,t){const s=await Ps("signup",{email:e,password:t});return s.access_token&&s.refresh_token&&Ss({access_token:s.access_token,refresh_token:s.refresh_token}),{email:s.user?.email??e}}async function Xn(){const e=Tt();if(localStorage.removeItem(ga),!!e?.access_token)try{await fetch(`${re}/auth/v1/logout`,{method:"POST",headers:{...ks(),Authorization:`Bearer ${e.access_token}`}})}catch(t){console.warn("Supabase sign out failed",t)}}function Tt(){const e=localStorage.getItem(ga);if(!e)return null;try{const t=JSON.parse(e);return!t.access_token||!t.refresh_token?null:{access_token:t.access_token,refresh_token:t.refresh_token}}catch{return null}}function Kn(){const e=Tt();if(!e)return null;const t=Hn(e.access_token),s=typeof t?.email=="string"?t.email:null;return s?{email:s}:null}async function Wn(e){const t=Tt();if(!t)throw new Error("not signed in");const s=await fetch(`${re}/auth/v1/user`,{method:"PUT",headers:{apikey:H,Authorization:`Bearer ${t.access_token}`,"Content-Type":"application/json"},body:JSON.stringify({password:e})});if(!s.ok){const n=await s.json().catch(()=>({}));throw new Error(n.msg??`HTTP ${s.status}`)}}const ba={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
`}function Bo(e){const t=String(e);return/[,"\n]/.test(t)?`"${t.replaceAll('"','""')}"`:t}function Vo(e){const s=["酒類コード","区分名","アルコール度数","製造数量","前月繰越","当月調整","輸出控除","見本等控除","課税数量","税率(円/L)","税額(円)"].join(","),n=e.rows.map(r=>[r.taxCategory,r.taxCategoryName,r.alcoholDegree,r.productionVolume,r.previousBalance,r.currentAdjustment,r.exportDeduction,r.sampleDeduction,r.taxableVolume,r.taxRate,r.taxAmount].map(Bo).join(",")),i=`,合計,,${e.rows.reduce((r,c)=>r+c.productionVolume,0)},,,${e.rows.reduce((r,c)=>r+c.exportDeduction,0)},${e.rows.reduce((r,c)=>r+c.sampleDeduction,0)},${e.totalVolume},,${e.totalTax}`;return"\uFEFF"+[s,...n,i].join(`
`)+`
`}function Jo(e){const t=e.rows.map(i=>{const r=Math.max(0,i.productionVolume+i.previousBalance+i.currentAdjustment-i.exportDeduction-i.sampleDeduction),c=Math.round(r*i.taxRate);return{...i,taxableVolume:r,volume:r,taxAmount:c}}),s=t.reduce((i,r)=>i+r.taxableVolume,0),n=t.reduce((i,r)=>i+r.taxAmount,0);return{...e,rows:t,totalVolume:s,totalTax:n}}async function Yo(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>U);return{supabaseInsert:s}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:Ws(e),submitted_at:e.submittedAt})}async function Ca(e){const t=await N("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(s=>({id:h(s,["id"],""),saleDate:h(s,["sale_date"],e),saleTime:h(s,["sale_time"],""),productCode:h(s,["product_code"],""),productName:h(s,["product_name"],""),quantity:P(s,["quantity"],0),unitPrice:P(s,["unit_price"],0),amount:P(s,["amount"],0),paymentMethod:h(s,["payment_method"],"cash")})):[]}async function Zs(){const e=await N("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:h(t,["id"],""),orderNo:h(t,["order_no"],""),orderDate:ae(t,["order_date"],""),customerName:h(t,["customer_name"],""),postalCode:h(t,["postal_code"],""),address:h(t,["shipping_address"],""),items:[],totalAmount:P(t,["total_amount"],0),status:h(t,["status"],"new"),shippingDate:ae(t,["shipping_date"],"")})):[]}async function kt(e){const t=await ut("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function en(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function Uo(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await N("print_layouts",t)).map(n=>({id:h(n,["id"],""),name:h(n,["name"],""),templateKey:h(n,["template_key"],""),positions:n.positions??{},isDefault:oe(n,["is_default"],!1),note:h(n,["note"],""),updatedAt:h(n,["updated_at"],"")}))}async function Qo(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>U);return{supabaseInsert:i}},void 0),s={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},n=await t("print_layouts",s);return n?{id:h(n,["id"],e.id),name:h(n,["name"],e.name),templateKey:h(n,["template_key"],e.templateKey),positions:n.positions??e.positions,isDefault:oe(n,["is_default"],!1),note:h(n,["note"],""),updatedAt:h(n,["updated_at"],"")}:null}async function Ho(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const s="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:s,Authorization:`Bearer ${s}`}})).ok}catch{return!1}}async function Go(){return(await N("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),email:h(t,["email"],""),displayName:h(t,["display_name"],""),signature:h(t,["signature"],""),replyTo:h(t,["reply_to"],""),isDefault:oe(t,["is_default"],!1),isVerified:oe(t,["is_verified"],!1),note:h(t,["note"],"")}))}async function Xo(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0),s=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return s?{id:h(s,["id"],e.id),name:h(s,["name"],e.name),email:h(s,["email"],e.email),displayName:h(s,["display_name"],""),signature:h(s,["signature"],""),replyTo:h(s,["reply_to"],""),isDefault:oe(s,["is_default"],!1),isVerified:oe(s,["is_verified"],!1)}:null}async function Ko(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const Ea={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},Aa={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Wo(e){const t=`${e}-01T00:00:00Z`,[s,n]=e.split("-").map(p=>parseInt(p,10)),i=new Date(s,n,0).getDate(),r=`${e}-${String(i).padStart(2,"0")}T23:59:59Z`;return(await N("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${r})`,order:"starts_at.asc"})).map(p=>({id:h(p,["id"],""),title:h(p,["title"],""),description:h(p,["description"],""),category:h(p,["category"],"general")||"general",startsAt:h(p,["starts_at"],new Date().toISOString()),endsAt:h(p,["ends_at"],""),isAllDay:oe(p,["is_all_day"],!1),location:h(p,["location"],""),attendees:p.attendees??[],relatedCustomerCode:h(p,["related_customer_code"],""),relatedOrderId:h(p,["related_order_id"],""),color:h(p,["color"],""),googleEventId:h(p,["google_event_id"],"")}))}async function Zo(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??Aa[e.category],updated_at:new Date().toISOString()})?e:null}async function ei(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function tn(){return(await N("integration_settings",{order:"name.asc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),provider:h(t,["provider"],""),config:t.config??{},isEnabled:oe(t,["is_enabled"],!1),lastSyncAt:h(t,["last_sync_at"],""),lastStatus:h(t,["last_status"],"")}))}async function pt(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function ti(e){const t=e.config.shop_domain,s=e.config.admin_token;if(!t||!s)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const n=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,i=await fetch(n,{headers:{"X-Shopify-Access-Token":s,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const r=await i.json(),{supabaseInsert:c}=await A(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>U);return{supabaseInsert:u}},void 0);let p=0;for(const u of r.orders){const y=`shopify_${u.id}`;await c("shopify_orders",{id:y,shopify_order_id:String(u.id),order_number:String(u.order_number??""),order_date:String(u.created_at??new Date().toISOString()),customer_name:String(u.customer?.first_name??"")+" "+String(u.customer?.last_name??""),customer_email:String(u.customer?.email??""),total_amount:Math.round(parseFloat(String(u.total_price??"0"))),financial_status:String(u.financial_status??""),fulfillment_status:String(u.fulfillment_status??"unfulfilled"),line_items:u.line_items??[],shipping_address:u.shipping_address??null,raw_payload:u}),p++}return await pt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得成功`}),{count:p}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function ai(){return(await N("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:h(t,["id"],""),shopifyOrderId:h(t,["shopify_order_id"],""),orderNumber:h(t,["order_number"],""),orderDate:h(t,["order_date"],""),customerName:h(t,["customer_name"],""),customerEmail:h(t,["customer_email"],""),totalAmount:G(t.total_amount),financialStatus:h(t,["financial_status"],""),fulfillmentStatus:h(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function si(e){const t=e.config.refresh_token,s=e.config.client_id,n=e.config.client_secret;if(!t||!s||!n)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:s,client_secret:n})});if(!i.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${i.status}`};const c=(await i.json()).access_token;return await pt({...e,config:{...e.config,oauth_token:c}}),e.config.oauth_token=c,{token:c}}async function ni(e){let t=e.config.oauth_token;const s=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const n=new Date().toISOString(),i=new Date(Date.now()+30*86400*1e3).toISOString(),r=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(s)}/events?timeMin=${n}&timeMax=${i}&singleEvents=true&orderBy=startTime`;let c=await fetch(r,{headers:{Authorization:`Bearer ${t}`}});if(c.status===401){const f=await si(e);if(f.error)return{count:0,error:f.error};t=f.token,c=await fetch(r,{headers:{Authorization:`Bearer ${t}`}})}if(!c.ok)return{count:0,error:`HTTP ${c.status}`};const p=await c.json(),{supabaseInsert:u}=await A(async()=>{const{supabaseInsert:f}=await Promise.resolve().then(()=>U);return{supabaseInsert:f}},void 0);let y=0;for(const f of p.items){const v=`gcal_${f.id}`,$=f.start?.dateTime??f.start?.date??"",x=f.end?.dateTime??f.end?.date??"";await u("calendar_events",{id:v,title:String(f.summary??"(無題)"),description:String(f.description??""),category:"general",starts_at:String($),ends_at:String(x),location:String(f.location??""),google_event_id:String(f.id??""),updated_at:new Date().toISOString()}),y++}return await pt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${y}件取得`}),{count:y}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function oi(){return(await N("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:h(t,["id"],""),receivedAt:h(t,["received_at"],""),senderPhone:h(t,["sender_phone"],""),senderName:h(t,["sender_name"],""),imageUrl:h(t,["image_url"],""),ocrStatus:h(t,["ocr_status"],"pending")||"pending",ocrText:h(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:h(t,["linked_invoice_id"],"")}))}async function ii(e,t){const s=e.config.api_key;if(!s)return{text:"",error:"Cloud Vision API key 未設定"};try{const n=`https://vision.googleapis.com/v1/images:annotate?key=${s}`,i=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return i.ok?{text:(await i.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${i.status}`}}catch(n){return{text:"",error:n instanceof Error?n.message:String(n)}}}async function ri(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const At={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},Lt={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function li(){return(await N("user_profiles",{order:"display_name.asc"})).map(t=>({id:h(t,["id"],""),email:h(t,["email"],""),displayName:h(t,["display_name"],""),staffCode:h(t,["staff_code"],""),department:h(t,["department"],"all")||"all",role:h(t,["role"],"staff")||"staff",defaultMailSenderId:h(t,["default_mail_sender_id"],""),phone:h(t,["phone"],""),avatarUrl:h(t,["avatar_url"],""),isActive:oe(t,["is_active"],!0),lastSignInAt:h(t,["last_sign_in_at"],""),createdAt:h(t,["created_at"],"")}))}async function ci(e){if(!e)return null;const t=await N("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const s=t[0];return{id:h(s,["id"],""),email:h(s,["email"],""),displayName:h(s,["display_name"],""),staffCode:h(s,["staff_code"],""),department:h(s,["department"],"all")||"all",role:h(s,["role"],"staff")||"staff",defaultMailSenderId:h(s,["default_mail_sender_id"],""),phone:h(s,["phone"],""),avatarUrl:h(s,["avatar_url"],""),isActive:oe(s,["is_active"],!0),lastSignInAt:h(s,["last_sign_in_at"],"")}}async function di(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function ui(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function pi(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>U);return{supabaseInsert:s}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function mi(e=100){return(await N("audit_logs",{order:"created_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),action:h(s,["action"],""),entityType:h(s,["entity_type"],""),entityId:h(s,["entity_id"],""),userEmail:h(s,["user_email"],""),changes:s.changes??{},createdAt:h(s,["created_at"],"")}))}const Dt={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function an(){return(await N("slack_notifications",{order:"event_type.asc"})).map(t=>({id:h(t,["id"],""),eventType:h(t,["event_type"],"new_order"),enabled:oe(t,["enabled"],!0),channel:h(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:h(t,["last_triggered_at"],"")}))}async function yi(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function hi(e=50){return(await N("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),eventType:h(s,["event_type"],""),channel:h(s,["channel"],""),message:h(s,["message"],""),status:h(s,["status"],"sent"),error:h(s,["error"],""),sentAt:h(s,["sent_at"],"")}))}async function fi(e,t,s){const i=(await tn()).find(y=>y.provider==="slack");if(!i||!i.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const r=i.config.webhook_url;if(!r)return{ok:!1,error:"Webhook URL未設定"};const p=(await an()).find(y=>y.eventType===e&&y.enabled);if(!p)return{ok:!1,error:"通知ルールが無効"};const u=s??p.channel??i.config.default_channel??"#general";try{const y=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${Dt[e]} ${t}`,channel:u})}),f=y.ok,{supabaseInsert:v}=await A(async()=>{const{supabaseInsert:$}=await Promise.resolve().then(()=>U);return{supabaseInsert:$}},void 0);return await v("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:u,message:t,status:f?"sent":"failed",error:f?null:`HTTP ${y.status}`}),f?{ok:!0}:{ok:!1,error:`HTTP ${y.status}`}}catch(y){return{ok:!1,error:y instanceof Error?y.message:String(y)}}}const Mt={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},La={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function vi(){return(await N("prospects",{order:"updated_at.desc"})).map(t=>({id:h(t,["id"],""),companyName:h(t,["company_name"],""),contactName:h(t,["contact_name"],""),email:h(t,["email"],""),phone:h(t,["phone"],""),address:h(t,["address"],""),website:h(t,["website"],""),businessType:h(t,["business_type"],""),stage:h(t,["stage"],"cold"),source:h(t,["source"],""),expectedAmount:G(t.expected_amount),probability:G(t.probability),assignedStaffCode:h(t,["assigned_staff_code"],""),nextActionDate:h(t,["next_action_date"],""),nextAction:h(t,["next_action"],""),note:h(t,["note"],""),lastContactAt:h(t,["last_contact_at"],""),wonAt:h(t,["won_at"],""),lostAt:h(t,["lost_at"],""),lostReason:h(t,["lost_reason"],""),convertedCustomerCode:h(t,["converted_customer_code"],""),createdAt:h(t,["created_at"],"")}))}async function sn(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function gi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function bi(e){return(await N("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(s=>({id:h(s,["id"],""),prospectId:h(s,["prospect_id"],""),activityType:h(s,["activity_type"],"call"),title:h(s,["title"],""),description:h(s,["description"],""),activityDate:h(s,["activity_date"],""),result:h(s,["result"],""),staffCode:h(s,["staff_code"],"")}))}async function $i(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const nn=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function _i(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function wi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function xi(){return(await ne("v_customer_map")).filter(t=>t.lat&&t.lng).map(t=>({customerCode:h(t,["customer_code"],""),name:h(t,["name"],""),phone:h(t,["phone"],""),areaCode:h(t,["area_code"],""),businessType:h(t,["business_type"],""),businessTypeName:h(t,["business_type_name"],""),address1:h(t,["address1"],""),lat:Number(t.lat),lng:Number(t.lng),isAtRisk:oe(t,["is_at_risk"],!1),isDormant:oe(t,["is_dormant"],!1),amount12m:P(t,["amount_12m"],0),daysSinceOrder:t.days_since_order!=null?Number(t.days_since_order):null}))}const Ot=[{value:"price",label:"価格が高い"},{value:"competitor",label:"競合に切り替え"},{value:"closed",label:"廃業・閉店"},{value:"contact",label:"担当者交代"},{value:"seasonal",label:"季節要因"},{value:"pause",label:"一時的な休止"},{value:"complaint",label:"クレーム・不満"},{value:"unreachable",label:"連絡が取れない"},{value:"other",label:"その他"}];async function Si(){return(await ne("customer_churn_notes")).map(t=>({customerCode:h(t,["customer_code"],""),reason:h(t,["reason"],""),memo:h(t,["memo"],""),actionedAt:t.actioned_at?String(t.actioned_at):null,updatedAt:h(t,["updated_at"],"")}))}async function ki(e){const{supabaseUpsert:t}=await A(async()=>{const{supabaseUpsert:s}=await Promise.resolve().then(()=>U);return{supabaseUpsert:s}},void 0);await t("customer_churn_notes",{customer_code:e.customerCode,reason:e.reason,memo:e.memo,actioned_at:e.actionedAt||null,updated_at:new Date().toISOString()},"customer_code")}async function Pi(){return(await N("delivery_locations",{order:"name.asc"})).map(t=>({id:h(t,["id"],""),customerCode:h(t,["customer_code"],""),name:h(t,["name"],""),postalCode:h(t,["postal_code"],""),address:h(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:h(t,["contact_name"],""),phone:h(t,["phone"],""),deliveryNote:h(t,["delivery_note"],""),isActive:oe(t,["is_active"],!0)}))}async function Ci(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function Ei(e=50){return(await N("call_logs",{order:"started_at.desc",limit:String(e)})).map(s=>({id:h(s,["id"],""),callDirection:h(s,["call_direction"],"inbound"),fromNumber:h(s,["from_number"],""),toNumber:h(s,["to_number"],""),matchedCustomerCode:h(s,["matched_customer_code"],""),matchedProspectId:h(s,["matched_prospect_id"],""),durationSeconds:G(s.duration_seconds),callStatus:h(s,["call_status"],"answered"),recordingUrl:h(s,["recording_url"],""),transcript:h(s,["transcript"],""),ivryCallId:h(s,["ivry_call_id"],""),startedAt:h(s,["started_at"],""),endedAt:h(s,["ended_at"],""),notes:h(s,["notes"],"")}))}async function on(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function Ai(e){const t=e.config.api_key,s=e.config.team_id;if(!t||!s)return{count:0,error:"IVRy API key または team_id 未設定"};try{const n=`https://api.ivry.jp/v1/teams/${s}/calls?limit=100`,i=await fetch(n,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const c=(await i.json()).calls??[];let p=0;for(const u of c)await on({id:`ivry_${u.id}`,callDirection:String(u.direction??"inbound"),fromNumber:String(u.from??""),toNumber:String(u.to??""),durationSeconds:Number(u.duration??0),callStatus:String(u.status??"answered"),recordingUrl:String(u.recording_url??""),startedAt:String(u.started_at??""),endedAt:String(u.ended_at??""),ivryCallId:String(u.id??"")}),p++;return await pt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得`}),{count:p}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function Li(e,t){const s=e.config.api_key,n=e.config.team_id;if(!s||!n)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let i=0;for(const r of t){if(!r.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${n}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({name:r.name,phone_number:r.phone,external_id:r.customerCode??"",note:r.note??""})})).ok&&i++}return{synced:i}}catch(i){return{synced:0,error:i instanceof Error?i.message:String(i)}}}async function Di(){return(await N("lead_lists",{order:"created_at.desc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),query:h(t,["query"],""),area:h(t,["area"],""),businessType:h(t,["business_type"],""),totalCount:G(t.total_count),source:h(t,["source"],"manual"),createdAt:h(t,["created_at"],"")}))}async function qi(e){return(await N("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(s=>({id:h(s,["id"],""),listId:h(s,["list_id"],""),companyName:h(s,["company_name"],""),address:h(s,["address"],""),phone:h(s,["phone"],""),website:h(s,["website"],""),email:h(s,["email"],""),businessType:h(s,["business_type"],""),rating:s.rating?Number(s.rating):void 0,reviewCount:G(s.review_count),lat:s.lat?Number(s.lat):void 0,lng:s.lng?Number(s.lng):void 0,placeId:h(s,["place_id"],""),status:h(s,["status"],"new"),convertedProspectId:h(s,["converted_prospect_id"],""),note:h(s,["note"],"")}))}async function Ii(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function rn(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function Ti(e,t,s){const n=e.config.api_key;if(!n)return{results:[],error:"Google Maps API key 未設定"};const i=`${t} ${s}`.trim(),r=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(i)}&language=ja&key=${n}`;try{const c=await fetch(r);if(!c.ok)return{results:[],error:`HTTP ${c.status}`};const p=await c.json();return p.status!=="OK"&&p.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${p.status}`}:{results:p.results.map(y=>{const f=y.geometry?.location;return{id:`place_${y.place_id}`,listId:"",companyName:String(y.name??""),address:String(y.formatted_address??""),rating:y.rating?Number(y.rating):void 0,reviewCount:y.user_ratings_total?Number(y.user_ratings_total):void 0,lat:f?.lat,lng:f?.lng,placeId:String(y.place_id??""),status:"new"}})}}catch(c){return{results:[],error:c instanceof Error?c.message:String(c)}}}async function Ni(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},s=await sn(t);return s&&await rn({...e,status:"imported",convertedProspectId:t.id}),s}async function Mi(){return(await N("workflow_orders",{order:"order_date.desc"})).map(t=>({id:h(t,["id"],""),orderNo:h(t,["order_no"],""),customerName:h(t,["customer_name"],""),customerCode:h(t,["customer_code"],""),orderDate:h(t,["order_date"],""),deliveryDate:h(t,["delivery_date"],""),stage:h(t,["stage"],"new"),totalAmount:G(t.total_amount),itemCount:G(t.item_count),priority:h(t,["priority"],"normal"),staffName:h(t,["staff_name"],""),notes:h(t,["notes"],"")}))}async function Oi(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function Ri(){return(await N("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:h(t,["id"],""),name:h(t,["name"],""),email:h(t,["email"],""),phone:h(t,["phone"],""),visitDate:h(t,["visit_date"],""),partySize:G(t.party_size)||1,language:h(t,["language"],"ja"),purpose:h(t,["purpose"],""),message:h(t,["message"],""),status:h(t,["status"],"new"),repliedAt:h(t,["replied_at"],""),confirmedTime:h(t,["confirmed_time"],""),createdAt:h(t,["created_at"],new Date().toISOString())}))}async function ji(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>U);return{supabaseInsert:n}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const Fi=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function ln(){return(await Promise.all(Fi.map(async t=>{const[s,n]=await Promise.all([va(t.table),N(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:s,lastSyncAt:n[0]?._synced_at??null}}))).sort((t,s)=>s.rowCount-t.rowCount)}async function Pt(e,t,s=100){const n=(t-1)*s,[i,r]=await Promise.all([N(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(s),offset:String(n)}),va(e)]);return{records:i,total:r}}async function sa(e){const t=await N("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const s=t[0].memo;if(typeof s=="string"&&s)try{const n=JSON.parse(s);return String(n.price_group??"")}catch{return""}return""}async function cn(e,t){if(e){const n=await N("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(n.length>0&&n[0].special_price)return G(n[0].special_price)}const s=await N("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return s.length>0&&s[0].default_sale_price?G(s[0].default_sale_price):0}const zi=[{code:"SAK001",name:"純米大吟醸　金井"},{code:"SAK002",name:"純米吟醸　金井"},{code:"SAK003",name:"本醸造　金井"},{code:"SAK004",name:"純米酒　金井"}],Bi=[1.6,.7,1.3,1.2,.9,.7,.6,.7,.9,1,1.1,1.5],Vi={SAK001:80,SAK002:150,SAK003:220,SAK004:180};function Ji(){const e=new Date,t=[];for(let u=11;u>=0;u--){const y=new Date(e.getFullYear(),e.getMonth()-u,1);t.push(`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`)}const s=zi,n={},i={};for(const u of s){n[u.code]={};for(const y of t){const f=parseInt(y.split("-")[1])-1,v=Vi[u.code]??100,$=Math.round(v*Bi[f]*(.85+Math.random()*.3));n[u.code][y]=$,i[y]=(i[y]??0)+$}}const r={},c={},p={};for(const u of s){const y=t.map($=>n[u.code][$]??0),f=y.reduce(($,x)=>$+x,0)/y.length,v=y.reduce(($,x)=>$+(x-f)**2,0)/y.length;r[u.code]=y.reduce(($,x)=>$+x,0),c[u.code]=f,p[u.code]=Math.sqrt(v)}return{months:t,products:s,matrix:n,totals:i,productTotals:r,productAvg:c,productStdDev:p}}async function Yi(e=36){const t=(()=>{const $=new Date;return $.setMonth($.getMonth()-e),`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`})(),s=await ne("product_monthly_sales",{select:"year_month,product_code,product_name,quantity",year_month:`gte.${t}`,order:"year_month.asc"});if(s.length===0)return Ji();const n=new Set,i=new Map,r={},c={};for(const $ of s){const x=h($,["year_month"],""),k=h($,["product_code"],""),o=h($,["product_name"],k),l=P($,["quantity"],0);!x||!k||(n.add(x),i.set(k,o),r[k]||(r[k]={}),r[k][x]=l,c[x]=(c[x]??0)+l)}const p=[...n].sort(),u=[...i.entries()].map(([$,x])=>({code:$,name:x})),y={},f={},v={};for(const $ of u){const x=p.map(l=>r[$.code]?.[l]??0),k=x.reduce((l,d)=>l+d,0)/(x.length||1),o=x.reduce((l,d)=>l+(d-k)**2,0)/(x.length||1);y[$.code]=x.reduce((l,d)=>l+d,0),f[$.code]=k,v[$.code]=Math.sqrt(o)}return{months:p,products:u,matrix:r,totals:c,productTotals:y,productAvg:f,productStdDev:v}}async function Ui(){return(await N("product_safety_stock_params",{order:"product_code.asc"})).map(t=>({productCode:h(t,["product_code"],""),productName:h(t,["product_name"],""),unit:h(t,["unit"],"本"),avgMonthlyDemand:P(t,["avg_monthly_demand"],0),demandStdDev:P(t,["demand_std_dev"],0),leadTimeDays:P(t,["lead_time_days"],30),serviceLevel:P(t,["service_level"],.95),safetyStockQty:P(t,["safety_stock_qty"],0),reorderPoint:P(t,["reorder_point"],0),memo:h(t,["memo"],""),productionType:h(t,["production_type"],"monthly")}))}async function Qi(e){return(await N("production_plan",{year_month:`eq.${e}`,order:"product_code.asc"})).map(s=>({id:h(s,["id"],""),yearMonth:h(s,["year_month"],e),productCode:h(s,["product_code"],""),productName:h(s,["product_name"],""),demandForecast:P(s,["demand_forecast"],0),safetyStockTarget:P(s,["safety_stock_target"],0),openingStock:P(s,["opening_stock"],0),requiredProduction:P(s,["required_production"],0),plannedQty:P(s,["planned_qty"],0),actualQty:P(s,["actual_qty"],0),status:h(s,["status"],"draft"),productionType:h(s,["production_type"],"monthly"),notes:h(s,["notes"],"")}))}async function Hi(e){const{SUPABASE_URL:t,SUPABASE_ANON_KEY:s}=await A(async()=>{const{SUPABASE_URL:n,SUPABASE_ANON_KEY:i}=await Promise.resolve().then(()=>U);return{SUPABASE_URL:n,SUPABASE_ANON_KEY:i}},void 0);if(!s||e.length===0)return!1;try{const n=e.map(c=>({product_code:c.productCode,product_name:c.productName,unit:c.unit,avg_monthly_demand:c.avgMonthlyDemand,demand_std_dev:c.demandStdDev,lead_time_days:c.leadTimeDays,service_level:c.serviceLevel,safety_stock_qty:c.safetyStockQty,reorder_point:c.reorderPoint,production_type:c.productionType,memo:c.memo,last_calc_at:new Date().toISOString(),updated_at:new Date().toISOString()})),i=new URL("/rest/v1/product_safety_stock_params",t),r=await fetch(i.toString(),{method:"POST",headers:{apikey:s,Authorization:`Bearer ${s}`,"Content-Type":"application/json",Prefer:"return=minimal,resolution=merge-duplicates"},body:JSON.stringify(n)});if(!r.ok){const c=await r.text();return console.error("saveSafetyStockParamsBulk failed:",r.status,c),!1}return!0}catch(n){return console.error("saveSafetyStockParamsBulk error:",n),!1}}async function Gi(e){const{supabaseUpsert:t}=await A(async()=>{const{supabaseUpsert:n}=await Promise.resolve().then(()=>U);return{supabaseUpsert:n}},void 0);return await t("production_plan",{...e.id?{id:e.id}:{},year_month:e.yearMonth,product_code:e.productCode,product_name:e.productName,demand_forecast:e.demandForecast,safety_stock_target:e.safetyStockTarget,opening_stock:e.openingStock,required_production:e.requiredProduction,planned_qty:e.plannedQty,actual_qty:e.actualQty,status:e.status,production_type:e.productionType,notes:e.notes,updated_at:new Date().toISOString()})!==null}function Xi(e){if(!e)return"不明";const t=e.replace(/^.+?[都道府県]/,""),s=t.match(/^(.+?郡.+?[町村]|.+?[市区町村])/);return s?s[1]:t.substring(0,6)}async function Ki(e){const[t,s]=e.split("-").map(Number),n=`${e}-01`,i=new Date(t,s,0).getDate(),r=`${e}-${String(i).padStart(2,"0")}`,c=await ne("sales_document_headers",{select:"sales_date,customer_name,legacy_customer_code,total_amount",and:`(sales_date.gte.${n},sales_date.lte.${r})`,order:"sales_date.asc"}),p=await ne("customers",{select:"id,address1",address1:"not.is.null"}),u={};for(const f of p)f.address1&&(u[f.id]=Xi(f.address1));const y={};for(const f of c){const v=f.sales_date;if(!v)continue;const $=u[f.legacy_customer_code]||"住所未登録",x=Number(f.total_amount)||0;y[v]||(y[v]={date:v,entries:[],cityGroups:[],totalAmount:0,count:0}),y[v].entries.push({customerCode:f.legacy_customer_code||"",customerName:f.customer_name||"",city:$,amount:x}),y[v].totalAmount+=x,y[v].count++}for(const f of Object.values(y)){const v={};for(const $ of f.entries)v[$.city]=(v[$.city]||0)+1;f.cityGroups=Object.entries(v).sort(($,x)=>x[1]-$[1]).map(([$,x])=>({city:$,count:x}))}return y}async function Da(){return N("quotes",{select:"id,quote_no,quote_date,valid_until,customer_name,subject,total_amount,template_type,status,created_at",order:"quote_date.desc,created_at.desc",limit:"200"})}async function dn(e){const t=await N("quotes",{select:"*",id:`eq.${e}`});if(!t[0])return null;const s=await N("quote_lines",{select:"*",quote_id:`eq.${e}`,order:"line_no.asc"});return{...t[0],lines:s}}async function Wi(){const e=new Date().toISOString().slice(0,7)+"-01";return ne("sales_document_headers",{select:"legacy_document_no,sales_date,customer_name,legacy_customer_code,total_amount",sales_date:`gte.${e}`,order:"sales_date.asc"})}const T=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:Aa,CALENDAR_CATEGORY_LABELS:Ea,CHURN_REASONS:Ot,DEPT_LABELS:Lt,INVOICE_TYPE_LABELS:Zt,JIKOMI_STATUS_LABELS:Vs,MATERIAL_CATEGORIES:nn,PROSPECT_STAGE_COLORS:La,PROSPECT_STAGE_LABELS:Mt,ROLE_LABELS:At,SEASONAL_TEMPLATES:ba,SLACK_EVENT_LABELS:Dt,TAX_DEDUCTION_LABELS:aa,TAX_RATE_CATEGORIES:Ks,addBrewingCustomCategory:So,convertLeadToProspect:Ni,deleteBrewingCustomCategory:ko,deleteCalendarEvent:ei,deleteMailSender:Ko,deleteMaterial:wi,deletePrintLayout:Ho,deleteProspect:gi,deleteUserProfile:ui,fetchAnalyticsByPeriod:io,fetchAnnouncements:Ms,fetchAuditLogs:mi,fetchAvailablePeriods:ro,fetchBillList:Gs,fetchBillingSummary:Sa,fetchBrewingCategoryOverrides:Co,fetchBrewingCustomCategories:xo,fetchBrewingMonthlyTrend:go,fetchBrewingPlanSummary:vo,fetchBrewingProductDetail:bo,fetchBrewingSchedule:$o,fetchCalendarEvents:Wo,fetchCallLogs:Ei,fetchChurnAlerts:No,fetchChurnNotes:Si,fetchCustomerAnalysis:Bs,fetchCustomerEfficiency:zs,fetchCustomerLedger:_a,fetchCustomerPriceGroup:sa,fetchCustomerPricing:ea,fetchCustomerProductBreakdown:yo,fetchDeliveryLocations:Pi,fetchDeliveryNote:xa,fetchDeliverySchedule:To,fetchDemandAnalysis:Yi,fetchDemandForecasts:Io,fetchEntityMonthlySales:fo,fetchFaxInbox:oi,fetchIntegrationSettings:tn,fetchInvoices:ct,fetchJikomiList:Js,fetchKenteiList:Us,fetchLabelExclusions:Eo,fetchLeadItems:qi,fetchLeadLists:Di,fetchMailSenders:Go,fetchMapCustomers:xi,fetchMasterStats:$a,fetchMaterialList:ta,fetchMyProfile:ci,fetchOrderHeaders:Wi,fetchPayableList:Hs,fetchPaymentStatus:Ls,fetchPeriodChartData:po,fetchPipelineMeta:Ds,fetchPrintLayouts:Uo,fetchProductABC:Fo,fetchProductCustomerBreakdown:ho,fetchProductDaily:jo,fetchProductMonthlyShipments:qo,fetchProductPower:Fs,fetchProductPrice:cn,fetchProductShipmentsFromTable:Ro,fetchProductionPlan:Qi,fetchProspectActivities:bi,fetchProspects:vi,fetchPurchaseList:Qs,fetchQuoteList:Da,fetchQuoteWithLines:dn,fetchRawMaterialStock:Xs,fetchRawRecords:Pt,fetchRawTableList:ln,fetchSafetyStockParams:Ui,fetchSalesAnalytics:wa,fetchSalesReport:Nt,fetchSalesSummary:As,fetchSeasonalProfiles:Oo,fetchShipmentCalendar:Ki,fetchShopifyOrders:ai,fetchSlackLogs:hi,fetchSlackRules:an,fetchStaffCustomerBreakdown:co,fetchStaffProductBreakdown:uo,fetchStaffTotalsByPeriod:lo,fetchStoreOrders:Zs,fetchStoreSales:Ca,fetchSyncDashboard:qs,fetchSystemSetting:Es,fetchTankList:Ys,fetchTaxDeclaration:Pa,fetchTourInquiriesFromDb:Ri,fetchUserProfiles:li,fetchVisitPriorities:Mo,fetchWorkflowOrdersFromDb:Mi,generateTaxCSV:Vo,generateTaxXML:Ws,ocrFaxImage:ii,periodToDateRange:Is,prevYearFilter:mo,recalculateTaxDeclaration:Jo,recordAudit:pi,resolveProductPrice:ka,saveBrewingSchedule:_o,saveCalendarEvent:Zo,saveCallLog:on,saveChurnNote:ki,saveDeliveryLocation:Ci,saveEmailCampaign:kt,saveFaxRecord:ri,saveIntegrationSetting:pt,saveInvoice:Ns,saveLabelExclusions:Ao,saveLeadItem:rn,saveLeadList:Ii,saveMailSender:Xo,saveMaterial:_i,savePrintLayout:Qo,saveProductionPlan:Gi,saveProspect:sn,saveProspectActivity:$i,saveSafetyStockParamsBulk:Hi,saveSlackRule:yi,saveTaxDeclaration:Yo,saveTourInquiry:ji,saveUserProfile:di,saveWorkflowOrder:Oi,searchPlaces:Ti,sendEmailCampaign:en,sendSlackNotification:fi,setBrewingCategoryOverride:Po,submitFeatureRequest:Os,syncGoogleCalendar:ni,syncIvryCallLogs:Ai,syncPhoneBookToIvry:Li,syncShopifyOrders:ti,updateCustomer:Rs,updateProduct:js,upsertBrewingStock:wo,upsertSystemSetting:Ye},Symbol.toStringTag,{value:"Module"}));function Fe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const Zi={open:"未締め",closed:"締め済"};function er(e,t){const s=e.customers.map(n=>`
      <tr>
        <td>
        ...
        <td>
          <span class="status-pill ${n.status==="closed"?"success":"warning"}">${Zi[n.status]}</span>
        </td>
        <td>
  ...
  `}function un(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function it(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function sr(e){return e.salesHistory.length===0?'<tr><td colspan="3" class="empty-row">データなし</td></tr>':e.salesHistory.map(t=>`
        <tr>
          <td>${un(t.date)}</td>
  ...
  `}function We(e,t,s){const n=e.findIndex(r=>r.column===t);if(n>=0){if(e[n].direction==="asc"){const c=[...e];return c[n]={column:t,direction:"desc"},c}return e.filter((c,p)=>p!==n)}const i={column:t,direction:"asc"};return s?[...e,i]:[i]}function ir(e,t){const s=e.findIndex(r=>r.column===t);if(s<0)return'<span class="sort-icon">⇅</span>';const n=e[s].direction==="asc"?"↑":"↓",i=e.length>1?`<small class="sort-badge">${s+1}</small>`:"";return`<span class="sort-icon active">${n}${i}</span>`}function B(e,t,s,n=""){return`<th class="sortable ${n}" data-sort-col="${e}">${t} ${ir(s,e)}</th>`}function Ya(e){if(e==null)return"";const t=String(e).replace(/[¥,円%本日L]/g,"").trim(),s=Number(t);return Number.isFinite(s)?s:t.toLowerCase()}function Ge(e,t,s){return t.length===0?e:[...e].sort((n,i)=>{for(const{column:r,direction:c}of t){const p=s[r];if(!p)continue;const u=Ya(n[p]),y=Ya(i[p]);let f=0;if(typeof u=="number"&&typeof y=="number"?f=u-y:f=String(u).localeCompare(String(y),"ja"),f!==0)return c==="asc"?f:-f}return 0})}const rr={forecasts:[],deliveries:[],calendarMonth:new Date().toISOString().slice(0,7),selectedSegment:"all"},Ua={monthly:"通年出荷","made-to-order":"受注生産","november-only":"歳暮（11月生産）","annual-batch":"季節集中","december-settlement":"歳暮（11月生産）","seasonal-batch":"季節集中"},Ze={monthly:"#0F5B8D","made-to-order":"#6b46c1","november-only":"#c05621","annual-batch":"#2f855a","december-settlement":"#c05621","seasonal-batch":"#2f855a"};function lr(e){const t=new Date().toISOString().slice(0,10);return e.map(s=>({date:s.date,customerName:s.customerName,productName:s.productName,quantity:s.quantity,status:s.date>t?"scheduled":"delivered"}))}function cr(e){const[t,s]=e.split("-").map(Number);return new Date(t,s,0).getDate()}function dr(e){const[t,s]=e.split("-").map(Number);return new Date(t,s-1,1).getDay()}function pn(e,t){const s=cr(t),n=dr(t),[i,r]=t.split("-").map(Number),c=new Map;e.forEach(b=>{if(b.date.slice(0,7)===t){const _=b.date.slice(0,10);c.has(_)||c.set(_,[]),c.get(_).push(b)}});const p=e.filter(b=>b.date.slice(0,7)===t),u=p.reduce((b,_)=>b+_.quantity,0),y=new Set(p.map(b=>b.date)).size,f=new Date().toISOString().slice(0,10),v=["日","月","火","水","木","金","土"].map(b=>`<th class="dcal-header">${b}</th>`).join("");let $="",x=1;for(let b=0;b<6&&!(x>s&&b>0);b++){$+="<tr>";for(let _=0;_<7;_++)if(b===0&&_<n||x>s)$+='<td class="dcal-cell dcal-empty"></td>';else{const C=`${i}-${String(r).padStart(2,"0")}-${String(x).padStart(2,"0")}`,S=c.get(C)||[],E=C===f,I=S.reduce((M,L)=>M+L.quantity,0);$+=`
          <td class="dcal-cell ${E?"dcal-today":""}">
            ...
            `:""}
          </td>`,x++}$+="</tr>"}const[k,o]=r===1?[i-1,12]:[i,r-1],[l,d]=r===12?[i+1,1]:[i,r+1],m=`${k}-${String(o).padStart(2,"0")}`,g=`${l}-${String(d).padStart(2,"0")}`;return`
    <section class="panel">
      <div class="panel-header">
        <div>
          <h2>納品カレンダー</h2>
  ...
  `}function ur(e,t){const s=t==="all"?e:e.filter(p=>p.segment===t),n={all:e.length};e.forEach(p=>{n[p.segment]=(n[p.segment]??0)+1});const r=["all",...[...new Set(e.map(p=>p.segment))]].map(p=>`
  ...
  `}function hr(e,t,s,n,i="month",r,c=[]){const p={success:"正常",warning:"注意",error:"異常",running:"実行中"},u=Ft(e.allDailySales,i,r),y=u.reduce((R,z)=>R+z.amount,0),f=u.reduce((R,z)=>R+z.bottles,0),v=u.reduce((R,z)=>R+z.volumeMl,0),$=u.length,x=f>0?Math.round(y/f):0,k=v>0?Math.round(y/(v/1e3)):0,o=new Date,l=o.toISOString().slice(0,10),d=l.slice(0,7),m=Ft(e.allDailySales,"month").filter(R=>R.date.slice(0,10)<=l),g=m.reduce((R,z)=>R+z.amount,0);m.reduce((R,z)=>R+z.bottles,0);const b=o.getDate();new Date(o.getFullYear(),o.getMonth()+1,0).getDate();const C=(n?.orderHeaders??[]).filter(R=>R.sales_date.slice(0,7)===d),S=C.reduce((R,z)=>R+Number(z.total_amount),0),E=C.length,I=Ft(e.allDailySales,"month"),M=I.reduce((R,z)=>R+z.bottles,0),L=S>0?S:I.reduce((R,z)=>R+z.amount,0),q=S>0?"orders":"extrapolation",j=(u.length>0?e.allDailySales.filter(R=>{const z=u[0]?.date??"",le=u[u.length-1]?.date??"",ye=Qa(z,-1),Pe=Qa(le,-1);return R.date>=ye&&R.date<=Pe}):[]).reduce((R,z)=>R+z.amount,0),Q=j>0?(y-j)/j*100:0,ee=Q>0?"+":"",se=e.salesRecords.slice(0,10).map(R=>`
            <tr>
          ...
          `).join(""),pe=["today","month","future","90days","year","all"].map(R=>`<button class="button ${R===i?"primary":"secondary"} small" type="button" data-period="${R}">${ht[R]}</button>`).join("");return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${me(e.kpis.todaySales)}</p>
        <p class="kpi-sub">${e.kpis.todaySales>0?`${new Date().getMonth()+1}/${new Date().getDate()} 時点`:"本日データなし"}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">当月実績（本日まで）</p>
        <p class="kpi-value">${me(g)}</p>
        <p class="kpi-sub">${b}日経過 / ${m.length}営業日 / 日平均 ${m.length>0?me(Math.round(g/m.length)):"―"}</p>
      </article>
      <article class="panel kpi-card" style="border-left:3px solid #0968e5;">
        <p class="panel-title">月末受注見込</p>
        <p class="kpi-value">${me(L)}</p>
        <p class="kpi-sub">${q==="orders"?`受注確定 ${E}件`:`出荷見込 ${M.toLocaleString("ja-JP")}本（日割り外挿）`}</p>
      </article>
      <article class="panel kpi-card">
        <p class="panel-title">昨対比</p>
        <p class="kpi-value" style="color:${Q>=0?"#2f855a":"#c53d3d"}">${j>0?`${ee}${Q.toFixed(1)}%`:"―"}</p>
        <p class="kpi-sub">前年同期 ${j>0?me(j):"データなし"}</p>
      </article>
      <article class="panel kpi-card kpi-alert">
        ...
        <p class="kpi-sub">残高 ${me(e.kpis.unpaidAmount)}</p>
      </article>
    </section>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${me(y)}</p>
        <p class="kpi-sub">${$}日間${$>0?` / 日平均 ${me(Math.round(y/$))}`:""}</p>
      </article>
    </section>
    `:""}
    ...
    <details class="panel collapsible-panel">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>${Ge(c.length>0?u:u.slice().reverse(),c,{date:"date",amount:"amount",bottles:"bottles",volumeMl:"volumeMl",pricePerBottle:"pricePerBottle",pricePerLiter:"pricePerLiter"}).slice(0,31).map(R=>`
            <tr>
              ...
              <td class="numeric">${me(R.pricePerBottle)}</td>
              <td class="numeric">${me(R.pricePerLiter)}</td>
            </tr>
          `).join("")}</tbody>
        </table>
      </div>
  ...
  `}function fr(e){const t=new Date().toISOString().slice(0,10),s=e.upcomingEvents.filter(p=>p.startsAt.slice(0,10)>=t).slice(0,5),n=e.tourInquiries.filter(p=>p.status==="new").length,i=e.churnSummary,r=i?i.atRiskCount+i.dormantCount+i.decliningCount:null,c=i?`<article class="panel kpi-card ${i.atRiskCount>0?"kpi-alert":""}" style="cursor:pointer;" data-link="/churn-alert">
    ...
    ${e.deliveries&&e.deliveries.length>0?mr(e.deliveries,e.deliveryCalendarMonth||new Date().toISOString().slice(0,7)):""}

    ${e.orderHeaders&&e.orderHeaders.length>0?vr(e.orderHeaders):""}
  `}function vr(e){const t=new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}),n=new Date().toISOString().slice(0,10),i=n.slice(0,7),r=new Map;for(const v of e){const $=v.sales_date.slice(0,7),x=r.get($)??{count:0,total:0};r.set($,{count:x.count+1,total:x.total+Number(v.total_amount)})}const c=[...r.keys()].sort(),p=e.reduce((v,$)=>v+Number($.total_amount),0),u=c.map(v=>{const{count:$,total:x}=r.get(v);return`<tr>
  ...
  `}function gr(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function ze(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function br(e,t){const s=e.lines.length?e.lines.map((i,r)=>`
          <tr>
  ...
  `}function _e(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function $r(e){return _e(e).replaceAll(`
`,"<br />")}function _r(e){const s=[...Object.values(ba),{id:"custom",season:"カスタム",subject:"",body:""}].map(i=>`
        <button
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="email-preview">
          ...
          <div class="preview-box">${e.body?$r(e.body):"本文未入力"}</div>
        </div>
  ...
  `}function $e(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ft(e,t){return t.length===0?"":`
  ...
  `}function wr(e,t){const s=[ft("得意先",t.customers.map(i=>`
          <button
  ...
  `}function vt(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ha(e){return e.trim().toLowerCase()}function xr(e,t){const s=Ha(t),n=e.filter(r=>s?[r.code,r.name,r.name].map(Ha).some(c=>c.includes(s)):!0).slice(0,50),i=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return mn({title:"得意先検索",searchQuery:t,placeholder:"コード・名前で検索",resultsHtml:i,emptyMessage:"該当する得意先が見つかりません。"})}function Sr(e){return e.toISOString().slice(0,10)}function Oe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function qe(e,t){return e[t]?`<div class="field-error">${Oe(e[t])}</div>`:""}function Be(e,t,s=""){return[s,e[t]?"has-error":""].filter(Boolean).join(" ")}function kr(e,t,s,n){const i=Object.keys(Zt).map(u=>`<option value="${u}" ${e.invoiceType===u?"selected":""}>${Zt[u]}</option>`).join(""),r=e.lines.map((u,y)=>`
      <tr>
        <td>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${Be(n,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||Sr(new Date)}" />
          ${qe(n,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
  ...
  `}function Pr(e){return"¥"+e.toLocaleString("ja-JP")}function Cr(e){if(!e)return"";const t=new Date(e);return`${t.getFullYear()}/${String(t.getMonth()+1).padStart(2,"0")}/${String(t.getDate()).padStart(2,"0")}`}const Er={draft:"下書き",sent:"送付済",accepted:"受注",rejected:"失注"},Ar={draft:"badge-gray",sent:"badge-blue",accepted:"badge-green",rejected:"badge-red"},Lr={sake:"酒販用",standard:"通常"};function Dr(e,t){return`
    <section class="page-head">
    ...
    <section class="panel">
      ...
      <tr>
        ...
        <td>${Cr(n.quote_date)}</td>
        <td>${n.customer_name||"（未選択）"}</td>
        <td>${n.subject||""}</td>
        <td class="numeric">${Pr(n.total_amount)}</td>
        <td><span class="badge ${Ar[n.status]??"badge-gray"}">${Er[n.status]??n.status}</span></td>
        <td>${Lr[n.template_type]??n.template_type}</td>
        <td>
  ...
  `}function Tr(){const e=new Date;return new Date(e.getFullYear(),e.getMonth()+3,0).toISOString().slice(0,10)}function qa(e){return{id:null,quoteNo:"",quoteDate:new Date().toISOString().slice(0,10),validUntil:Tr(),customerCode:"",customerName:"",customerAddress:"",subject:"",lines:[],remarks:"",taxRate:10,deliveryDate:"",paymentTerms:e?.defaultPaymentTerms??"月末締め翌月末払い",deliveryPlace:"",templateType:"sake",previewMode:!1}}qa();function F(e){return(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ve(e){return"¥"+e.toLocaleString("ja-JP")}function Ga(e){if(!e)return"";const t=new Date(e);return isNaN(t.getTime())?e:`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function fn(e){const t=e.replace("#","");return[parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16)]}function vn(e,t,s){return"#"+[e,t,s].map(n=>Math.max(0,Math.min(255,Math.round(n))).toString(16).padStart(2,"0")).join("")}function qt(e,t){const[s,n,i]=fn(e);return vn(s+(255-s)*t,n+(255-n)*t,i+(255-i)*t)}function gn(e,t){const[s,n,i]=fn(e);return vn(s*(1-t),n*(1-t),i*(1-t))}function Nr(e){const t=gn(e,.15),s=qt(e,.88),n=qt(e,.96);return`
...
`}function Mr(e){const t=gn(e,.15),s=qt(e,.88),n=qt(e,.96);return`
...
`}function bn(e,t){const s=e.lines.reduce((k,o)=>k+o.amount,0),n=Math.round(s*e.taxRate/100),i=s+n,r=e.templateType==="sake",c=r?'<th style="width:90px;">JANコード</th><th style="width:40px;">入数</th><th style="width:70px;">希望小売価格</th>':"",p=r?9:6,u=e.lines.map((k,o)=>{const l=r?`<td style="font-size:9px;">${F(k.janCode)}</td><td style="text-align:center;">${k.caseQty??""}</td><td style="text-align:right;">${k.retailPrice!=null?ve(k.retailPrice):""}</td>`:"";return`<tr>
  ...
  `:"",v=t.sealImageDataUrl?`<img src="${t.sealImageDataUrl}" style="width:${t.sealSize}px;height:${t.sealSize}px;opacity:0.9;flex-shrink:0;" />`:"",$=[];e.validUntil&&$.push(`<div class="q-cond-cell"><div class="q-cond-label">有効期限</div><div class="q-cond-value">${Ga(e.validUntil)}</div></div>`),e.paymentTerms&&$.push(`<div class="q-cond-cell"><div class="q-cond-label">支払条件</div><div class="q-cond-value">${F(e.paymentTerms)}</div></div>`),e.deliveryDate&&$.push(`<div class="q-cond-cell"><div class="q-cond-label">納期</div><div class="q-cond-value">${F(e.deliveryDate)}</div></div>`),e.deliveryPlace&&$.push(`<div class="q-cond-cell"><div class="q-cond-label">納品場所</div><div class="q-cond-value">${F(e.deliveryPlace)}</div></div>`);const x=$.length>0?`<div class="q-cond-grid" style="grid-template-columns:repeat(${Math.min($.length,4)},1fr);">${$.join("")}</div>`:"";return`
<div class="q-doc">
  <!-- タイトル行: 左=御見積書、右=見積番号・日付（右寄せ） -->
  ...
  ${f}
    ...
    <section class="panel">
      ...
      ${$.length>0?`<div class="search-results">${$.map(k=>{const o=r?ka(k,r):{price:k.salePrice||0,label:"卸価格"},l=k.listPrice||0,d=o.label!=="標準価格"&&o.label!=="卸価格";return`<button class="search-item" type="button" data-add-product="${k.code}" data-prod-name="${F(k.name)}" data-prod-price="${o.price}" data-prod-retail="${l}" data-prod-jan="${F(k.janCode??"")}" data-prod-unit="${F(k.unit??"本")}" data-prod-case="${k.caseQty??""}">
          <span class="mono">${k.code}</span> ${F(k.name)}
          <span class="numeric" ${d?'style="color:#2f855a;font-weight:700;"':""}>納入 ${o.price?ve(o.price):"未設定"} <small>(${o.label})</small>${l?`　定価 ${ve(l)}`:""}</span>
        </button>`}).join("")}</div>`:""}
...
<script>window.onload=function(){window.print();}<\/script>
  ...
  `}function Br(e,t=[]){const s=e.filter(r=>r.currentRank==="A").length,n=e.filter(r=>r.prevRank&&r.currentRank<r.prevRank).length,i=e.filter(r=>r.prevRank&&r.currentRank>r.prevRank).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">分析</p>
        <h1>営業効率分析</h1>
          ...
          <tbody>
            ${Ge(e,t,{currentRank:"currentRank",name:"name",yearAmount:"yearAmount",sharePct:"sharePct",orderDays:"orderDays",growthRate:"growthRate"}).map(r=>`
              <tr>
                ...
                <td>${Rr(r.currentRank,r.prevRank)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
  ...
  `}function Vr(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function Jr(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Yr(e,t){const s=e.length?e.map(n=>`
            <tr>
              ...
              <td class="numeric">${Jr(n.amount)}</td>
            </tr>
  ...
  `}function Ur(e){return new Date(e.getFullYear(),e.getMonth(),1)}function Qr(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function Sn(e,t){const s=new Date(e);return s.setDate(s.getDate()+t),s}function kn(e){const t=new Date(e),s=t.getDay();return t.setDate(t.getDate()-s),t.setHours(0,0,0,0),t}function Xa(e){const t=Sn(kn(e),6);return t.setHours(23,59,59,999),t}function Ka(e){return new Date(`${e}T00:00:00`)}function Wa(e){return`${e.getMonth()+1}/${e.getDate()}`}function Hr(e){return e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function Gr(){const e=new Date,t=kn(Qr(Ur(e),-3)),s=Xa(new Date(e.getFullYear(),e.getMonth()+4,0)),n=[];let i=new Date(t);for(;i<=s;){const r=Xa(i);n.push({start:new Date(i),end:r,label:`${Wa(i)} - ${Wa(r)}`}),i=Sn(i,7)}return n}function Xr(e){const t=Gr(),s=`160px repeat(${t.length}, minmax(56px, 1fr))`,n=t.map(r=>`
        <div class="gantt-week">
          <span>${r.label}</span>
        </div>
      `).join(""),i=e.length?e.map(r=>{const c=Ka(r.startDate),p=Ka(r.expectedDoneDate),u=Math.max(0,t.findIndex(v=>v.end>=c)),y=Math.max(u,t.reduce((v,$,x)=>$.start<=p?x:v,u)),f=[`仕込番号: ${r.jikomiNo}`,`銘柄: ${r.productName}`,`期間: ${r.startDate} - ${r.expectedDoneDate}`,`タンク: ${r.tankNo}`,`備考: ${r.note||"なし"}`].join(`
`);return`
  ...
  `}function Kr(e){const t={pending:"未実施",submitted:"申請中",approved:"承認済"},s={pending:"neutral",submitted:"warning",approved:"success"},n=e.map(u=>`
      <tr>
  ...
  `}function Wr(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Zr(e,t){return`
  ...
  `}function sl(e,t){const s=[...new Set(e.map(i=>i.businessType).filter(Boolean))].sort(),n=[...new Set(e.map(i=>i.areaCode).filter(Boolean))].sort();return`
  ...
  `}function oa(e,t){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function nl(e){switch(e){case"000":return"生産者";case"001":return"小売";case"002":return"卸";default:return e||"―"}}function ol(e){return e.map(t=>`
        <tr>
      ...
      `).join("")}function bt(e){return e?`¥${e.toLocaleString("ja-JP")}`:"―"}function il(e){return e.map(t=>`
        <tr>
          <td class="mono">${t.code}</td>
          <td>${oa(t.name,20)}</td>
          <td>${t.kanaName||""}</td>
      ...
      `).join("")}function rl(e,t,s=Ia,n=[]){const{filtered:i,paged:r,totalPages:c}=al(e.customers,s);return`
    <section class="page-head">
      <div>
      ...
      ${t==="customers"?`
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>${ol(Ge(r,n,{code:"code",name:"name",kanaName:"kanaName",businessType:"businessType",areaName:"areaName",closingDay:"closingDay",paymentDay:"paymentDay"}))}</tbody>
          </table>
        </div>
        ${es(i.length,s.page,c)}
      `:`
        <div class="table-wrap">
          <table>
            ...
            <tbody>${il(Ge(e.products,n,{code:"code",name:"name",category:"category",alcoholDegree:"alcoholDegree",volumeMl:"volumeMl",purchasePrice:"purchasePrice",salePrice:"salePrice",listPrice:"listPrice"}))}</tbody>
          </table>
        </div>
      `}
    </section>
  `}function Bt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function ll(e,t){if(!e&&!t)return"";const s=e;return`
  ...
  `}function dl(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e)):"-"}function Vt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const ul={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function pl(e){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td>${dl(s.lastPaymentDate)}</td>
          <td><span class="status-pill ${s.status==="paid"?"success":s.status==="partial"?"warning":"danger"}">${ul[s.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function Ve(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ts(e){return e.trim().toLowerCase()}function ml(e,t){const s=ts(t),n=e.filter(r=>s?[r.code,r.name,r.janCode].map(ts).some(c=>c.includes(s)):!0),i=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              ${n.map(r=>`
                    <tr
                      ...
                      data-name="${Ve(r.name)}"
                    >
                      <td class="mono">${Ve(r.code)}</td>
                      <td>${Ve(r.name)}</td>
                      <td class="mono">${Ve(r.janCode)}</td>
                      <td>${Ve(r.category)}</td>
                    </tr>
                  `).join("")}
            </tbody>
      ...
      `:"";return mn({title:"商品検索",searchQuery:t,placeholder:"コード・名前・JANで検索",resultsHtml:i,emptyMessage:"該当する商品が見つかりません。"})}function Ie(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function yl(e,t){const s={pending:"未確定",confirmed:"確定",paid:"支払済"},n={pending:"warning",confirmed:"neutral",paid:"success"},i={unpaid:"未払い",partial:"一部支払",paid:"支払済"},r={unpaid:"warning",partial:"neutral",paid:"success"},c=e.map(v=>`
      <tr>
    ...
    `).join(""),u=e.reduce((v,$)=>v+$.amount,0),y=t.reduce((v,$)=>v+$.balance,0),f=t.filter(v=>v.status!=="paid").length;return`
    <section class="page-head">
      <div>
  ...
  `}function tt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function hl(e,t){const s={holding:"保有中",due:"期日到来",cleared:"決済済"},n={holding:"neutral",due:"warning",cleared:"success"},i=e.map(f=>`
      <tr>
  ...
  `}function ia(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function ce(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ra(e){return`
  ...
  `}function wt(e){if(!e)return"error";const s=(Date.now()-new Date(e).getTime())/(1e3*60*60);return s<1?"success":s<24?"warning":"error"}function as(e){if(!e)return"未同期";const s=(Date.now()-new Date(e).getTime())/(1e3*60*60);return s<1?"正常":s<24?"注意":"要確認"}function vl(e){return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
  ...
  `}function gl(e,t,s,n){const i={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
      ...
      <div class="relay-config-list">
        ...
        <div class="relay-config-row">
          <div>
            ...
            <span class="config-value">${ce(s)}</span>
          </div>
          <button
            class="button secondary"
            type="button"
            data-action="copy-config"
            data-config-value="${ce(s)}"
          >
            コピー
          </button>
        </div>
  ...
  `}function ot(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function bl(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function $l(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),s=Math.max(...t.map(v=>v.amount),1),n=28,i=6,r=140,c=100,p=760,u=p-r-c,y=t.length*(n+i)+16,f=t.map((v,$)=>{const x=v.amount/s*u,k=$*(n+i)+8,o=v.abcRank==="A"?"#2F855A":v.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
  ...
  `}function _l(e){if(e.monthlyByCustomer.length===0)return'<p class="empty-row">データなし</p>';const t=e.months.map(n=>`<th class="numeric">${n}</th>`).join(""),s=e.monthlyByCustomer.map(n=>{const i=n.values.reduce((c,p)=>c+p,0),r=n.values.map(c=>`<td class="numeric">${c>0?(c/1e4).toFixed(0)+"万":"—"}</td>`).join("");return`
        <tr>
          <td>${n.label}</td>
          ${r}
  ...
  `}function wl(e){e.ranking.reduce((u,y)=>u+y.amount,0);const t=e.ranking.filter(u=>u.abcRank==="A").length,s=e.ranking.filter(u=>u.abcRank==="B").length,n=e.ranking.filter(u=>u.abcRank==="C").length,i=e.ranking.filter(u=>u.abcRank==="A").reduce((u,y)=>u+y.amount,0),r=e.ranking.filter(u=>u.abcRank==="B").reduce((u,y)=>u+y.amount,0),c=e.ranking.filter(u=>u.abcRank==="C").reduce((u,y)=>u+y.amount,0),p=e.ranking.map(u=>`
        <tr>
          ...
          <td><span class="status-pill ${bl(u.abcRank)}">${u.abcRank}</span></td>
        </tr>
      `).join("");return`
    <section class="page-head">
      <div>
  ...
  `}const xl={code:"code",name:"name",amount:"amount",quantity:"quantity",documents:"documents",volumeMl:"volumeMl"},ss={amount:"売上額",quantity:"出荷本数",volume:"移出量"},la=10;function Ta(e){const[t,s]=e.split("-").map(Number);return s>=la?t:t-1}function Sl(e){const t=la-1,s=new Date(e+1,t,0).getDate();return{from:`${e}-${String(la).padStart(2,"0")}-01`,to:`${e+1}-${String(t).padStart(2,"0")}-${String(s).padStart(2,"0")}`}}function kl(e,t,s){const n=c=>t==="quantity"?c.quantity:t==="volume"?c.volumeMl:c.amount,i=new Map;for(const c of e){const p=s==="fiscal"?`${Ta(c.month)}年度`:c.month.slice(0,4);i.set(p,(i.get(p)??0)+n(c))}return{curr:[...i.entries()].sort((c,p)=>c[0].localeCompare(p[0])).map(([c,p])=>({month:c,amount:p}))}}function Pl(e){const t=new Set;for(const s of e)t.add(Ta(s.month));return[...t].sort((s,n)=>n-s).map(String)}function Xe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Cl(e){return e.replace("-","/")}const ns={all:"全期間",yearly:"年次",monthly:"月次",weekly:"週次",daily:"日次"};function El(e,t="#0F5B8D",s=[],n="amount"){if(e.length===0)return'<div class="chart-empty">データなし</div>';const i=s.length>0&&s.some(m=>m.amount>0),r=760,c=280,p={top:16,right:24,bottom:36,left:n==="amount"?64:56},u=r-p.left-p.right,y=c-p.top-p.bottom,f=[...e.map(m=>m.amount),...s.map(m=>m.amount)],v=Math.max(...f,1),$=u/e.length;function x(m){if(n==="quantity")return m>=1e4?`${(m/1e4).toFixed(1)}万本`:`${Math.round(m).toLocaleString()}本`;if(n==="volume"){const g=m/1e3;return g>=1e4?`${(g/1e3).toFixed(0)}kL`:`${Math.round(g).toLocaleString()} L`}return`${Math.round(m/1e4).toLocaleString("ja-JP")}万円`}function k(m){return n==="quantity"?`${m.toLocaleString()}本`:n==="volume"?Rt(m):Xe(m)}const o=[0,.25,.5,.75,1].map(m=>{const g=p.top+y-y*m,b=x(v*m);return`<g>
        <line x1="${p.left}" y1="${g}" x2="${r-p.right}" y2="${g}" class="chart-grid" />
        <text x="4" y="${g+4}" class="chart-axis">${b}</text>
      </g>`}).join(""),l=e.map((m,g)=>{const b=i?Math.max(($-18)/2,10):Math.max($-18,24),_=i?2:0,C=p.left+g*$+($-(i?b*2+_:b))/2,S=m.amount/v*y,E=p.top+y-S,I=s[g]?.amount??0,M=I/v*y,L=p.top+y-M,q=i?`<rect x="${C}" y="${L}" width="${b}" height="${M}" rx="4" fill="#ccc" opacity="0.6"><title>前年 ${k(I)}</title></rect>`:"",O=i?C+b+_:C;return`<g>
      ${q}
      <rect x="${O}" y="${E}" width="${b}" height="${S}" rx="4" fill="${t}" opacity="${.6+g/e.length*.35}"><title>${k(m.amount)}</title></rect>
      <text x="${p.left+g*$+$/2}" y="${c-8}" class="chart-axis centered-axis">${Cl(m.month)}</text>
    </g>`}).join(""),d=i?`
  ...
  `}function Rt(e){return e>=1e3?`${(e/1e3).toLocaleString("ja-JP",{maximumFractionDigits:1})} L`:`${e.toLocaleString("ja-JP")} ml`}function Al(e,t=!1){const s=t?7:6;return e.length===0?`<tr><td colspan="${s}" class="empty-row">データなし</td></tr>`:e.map(n=>`
    <tr>
  ...
  `).join("")}function Ll(e){return e.length===0?'<tr><td colspan="7" class="empty-row">データなし</td></tr>':e.map(t=>`
    <tr>
      <td class="mono">${t.code||"―"}</td>
      <td>${t.name||"不明"}</td>
  ...
  `}function Pn(e,t,s="all",n="",i=[],r=[],c="",p="",u=null,y="all",f="",v=[],$=[],x=[],k=null,o=[],l=[],d="amount",m="calendar"){const g=t==="products"?"商品別集計":t==="customers"?"得意先別集計":"担当別集計",b=t==="products"?e.productTotals:t==="customers"?e.customerTotals:e.staffTotals,C=s!=="all"&&i.length>0&&t!=="staff"?i:b,S=Ge(C,x,xl),E={all:"月別",yearly:"月別推移",monthly:"日別推移",weekly:"日別推移",daily:"当日"},I=ss[d],M=Y=>d==="quantity"?Y.quantity:d==="volume"?Y.volumeMl:Y.amount,L=Y=>d==="quantity"?`${Y.toLocaleString()}本`:d==="volume"?Rt(Y):Xe(Y);let q,O=[],j,Q,ee;if(k&&k.monthlySales.length>0)q=k.monthlySales.slice(-24).map(Y=>({month:Y.month,amount:M(Y)})),j=`${k.name} の月別${I}`,Q=`${k.tab==="customers"?"得意先":"商品"}: ${k.code}`,ee="#0968e5";else if(o.length>0&&s!=="all"){q=o.map(te=>({month:te.month,amount:M(te)})),O=l.map(te=>({month:te.month,amount:M(te)}));const Y=q.reduce((te,K)=>te+K.amount,0),xe=O.reduce((te,K)=>te+K.amount,0),V=xe>0?(Y-xe)/xe*100:0,he=V>0?"+":"";j=`${E[s]} ${I}（${n}）`,Q=`${L(Y)}${xe>0?` / 前年比 ${he}${V.toFixed(1)}%`:""}`,ee="#2f855a"}else{q=kl(e.monthlySales,d,m).curr,O=[];const xe=q.reduce((he,te)=>he+te.amount,0);j=`${m==="fiscal"?"決算年度別":"暦年別"}${I}`,Q=`累計 ${L(xe)}（${q.length}${m==="fiscal"?"期":"年"}）`,ee="#0F5B8D"}const se=["amount","quantity","volume"].map(Y=>`<button class="tab-button ${Y===d?"active":""}" data-chart-metric="${Y}">${ss[Y]}</button>`).join(""),pe=["all","yearly","monthly","weekly","daily"].map(Y=>`<button class="button ${Y===s?"primary":"secondary"} small" type="button" data-analytics-period="${Y}">${ns[Y]}</button>`).join(""),R=m==="fiscal"&&s==="yearly"?Pl(e.monthlySales):r,z=m==="fiscal"&&s==="yearly"&&!R.includes(n)?R[0]??"":n,le=s!=="all"&&R.length>0&&t!=="staff"?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
        ${R.map(Y=>`<option value="${Y}" ${Y===z?"selected":""}>${m==="fiscal"&&s==="yearly"?Y+"年度":Y}</option>`).join("")}
      </select>`:"";let ye="",Pe="";if(t==="staff"){const Y=["all","yearly","monthly","weekly","daily"].map(K=>`<button class="button ${K===y?"primary":"secondary"} small" type="button" data-staff-period="${K}">${ns[K]}</button>`).join(""),xe=y!=="all"&&v.length>0?`<select id="staff-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
          ${v.map(K=>`<option value="${K}" ${K===f?"selected":""}>${K}</option>`).join("")}
        </select>`:"",he=($.length>0?$:e.staffTotals).filter(K=>!c||K.name.includes(c)||K.code.includes(c)),te=y!=="all"&&f?` (${f})`:"";if(ye=`
      ...
      <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;align-items:center;">
        ...
        ${te?`<span style="font-size:12px;color:var(--text-secondary);">${te}</span>`:""}
      </div>
      <div class="table-wrap">
        <table>
          <thead>
          ...
          <tbody>
            ${he.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':he.map(K=>`
                <tr>
      ...
      <article class="panel">
        ...
        <div class="table-wrap">
          <table>
            ...
            <tbody>${Ll(k.breakdownRows)}</tbody>
          </table>
        </div>
      </article>
    </section>
    ...
    ${Pe}
  `}const is=Object.freeze(Object.defineProperty({__proto__:null,fiscalYearToDateRange:Sl,monthToFiscalYear:Ta,renderSalesAnalytics:Pn},Symbol.toStringTag,{value:"Module"}));function at(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Dl(e){const t=Math.max(...e.salesByProduct.flatMap(r=>r.values),1),s=e.salesByProduct.map(r=>{const c=r.values.map((p,u)=>`
          <div class="bar-col">
  ...
  `}function ql(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(e))}function Il(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function rs(e){return e.toISOString().slice(0,10)}function Tl(e,t,s){const n=e.length?e.map(i=>`
            <tr>
              ...
              <td class="numeric">${Il(i.amount)}</td>
            </tr>
  ...
  `}function xt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Nl(e,t,s,n){const i={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},r={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},c={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},p=e.map(v=>`
      <tr>
        <td>${v.saleTime}</td>
    ...
    `).join(""),y=e.reduce((v,$)=>v+$.amount,0),f=t.filter(v=>v.status==="new").length;return`
    <section class="page-head">
      <div>
  ...
  `}function Yt(e){const t={};return e.querySelectorAll("[data-fd-id]").forEach(s=>{const n=s.dataset.fdId??"",i=parseFloat(s.style.left)||0,r=parseFloat(s.style.top)||0;t[n]={x:i,y:r}}),t}function Fl(e,t,s){const n=[...new Set(e.map($=>$.areaCode).filter(Boolean))].sort(),i=[...new Set(e.map($=>$.businessTypeName||$.businessType).filter(Boolean))].sort(),r=e.filter($=>$.isAtRisk),c=e.filter($=>!$.isAtRisk&&$.isDormant),p=e.filter($=>!$.isAtRisk&&!$.isDormant&&$.amount12m>0),u=e.filter($=>!$.isAtRisk&&!$.isDormant&&$.amount12m===0),y=t.filter($=>$.lat&&$.lng),f=JSON.stringify(e),v=JSON.stringify(y.map($=>({name:$.name,address:$.address,lat:$.lat,lng:$.lng,phone:$.phone})));return`
    <section class="page-head">
      <div>
    ...
    <\/script>`}const zl={new:{label:"新規受注",color:"#2196F3",icon:"📥"},picking:{label:"ピッキング中",color:"#FF9800",icon:"🔍"},packed:{label:"梱包完了",color:"#4CAF50",icon:"📦"},shipped:{label:"発送済",color:"#9C27B0",icon:"🚚"},delivered:{label:"配達完了",color:"#4CAF50",icon:"✅"}},Bl=["new","picking","packed","shipped","delivered"];function Vl(e){const t={new:[],picking:[],packed:[],shipped:[],delivered:[]};e.forEach(r=>t[r.stage].push(r));const s=Bl.map(r=>{const c=zl[r],p=t[r];return`
  ...
  `}function Jl(e,t,s){const n=e.cart.reduce((r,c)=>r+c.amount,0);return`
  ...
  `}function Yl(e,t,s){if(e.step==="customer"){const n=e.customerQuery.toLowerCase(),i=n?t.filter(r=>r.name.toLowerCase().includes(n)||r.code.toLowerCase().includes(n)):t.slice(0,20);return`
      <section class="panel">
  ...
  `}const ls={new:"新規",replied:"返信済",confirmed:"確定",completed:"来訪済",cancelled:"キャンセル"},cs={new:"warning",replied:"neutral",confirmed:"success",completed:"success",cancelled:"neutral"},ds={ja:"🇯🇵 日本語",en:"🇬🇧 English",zh:"🇨🇳 中文",ko:"🇰🇷 한국어"};function Ul(e,t){const s=e.find(r=>r.id===t)??e[0],n=e.filter(r=>r.status==="new").length,i=e.filter(r=>r.status==="confirmed").length;return`
    <section class="page-head">
      <div>
...
金井酒造店`;function Gl(e,t){const s=t?e.find(i=>i.id===t):null,n=t==="__new__";return`
    <section class="page-head">
      <div>
    ...
    ${s||n?`
      ...
      `:""}
  `}function Xl(e,t,s,n){const[i,r]=t.split("-").map(_=>parseInt(_,10)),c=new Date(i,r-1,1),p=new Date(i,r,0),u=c.getDay(),y=p.getDate(),f=[];for(let _=0;_<u;_++)f.push({isOutside:!0});for(let _=1;_<=y;_++)f.push({date:new Date(i,r-1,_)});for(;f.length%7!==0;)f.push({isOutside:!0});const v=s?e.filter(_=>_.category===s):e,$={};v.forEach(_=>{const C=_.startsAt.slice(0,10);$[C]??=[],$[C].push(_)});const x=new Date().toISOString().slice(0,10),k=f.map(_=>{if(_.isOutside)return'<div class="cal-cell cal-outside"></div>';const C=_.date,S=`${C.getFullYear()}-${String(C.getMonth()+1).padStart(2,"0")}-${String(C.getDate()).padStart(2,"0")}`,E=$[S]??[],I=S===x,M=C.getDay();return`
        <div class="cal-cell ${I?"cal-today":""} ${M===0?"cal-sun":M===6?"cal-sat":""}"
             data-cal-date="${S}">
          <div class="cal-day-num">${C.getDate()}</div>
          <div class="cal-events">
            ${E.slice(0,3).map(L=>`
              <button class="cal-event" data-cal-event-id="${L.id}"
                      style="background:${L.color||Aa[L.category]||"#0F5B8D"};"
                      title="${L.title}">
                <span class="cal-event-time">${L.isAllDay?"終日":new Date(L.startsAt).toTimeString().slice(0,5)}</span>
                <span class="cal-event-title">${L.title}</span>
              </button>
            `).join("")}
            ${E.length>3?`<button class="cal-event-more" data-cal-date="${S}">+${E.length-3}件</button>`:""}
          </div>
        </div>
      `}).join(""),o=n?.isOpen?Kl(n):"",l=new Date(i,r-2,1),d=new Date(i,r,1),m=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}`,g=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}`,b=(()=>{const _=new Date;return`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
        ...
        <div class="cal-filter">
          <label style="display:flex;align-items:center;gap:8px;">
            ...
            <select id="cal-filter-category">
              <option value="">すべて</option>
              ${Object.entries(Ea).map(([_,C])=>`<option value="${_}" ${s===_?"selected":""}>${C}</option>`).join("")}
            </select>
          </label>
        </div>
      </div>
    ...
    ${o}
  `}function Kl(e){const t=e.event;return`
          ...
          <div style="display:flex;gap:8px;">
            <label class="field" style="flex:1;">
              ...
              <select id="cal-category">
                ${Object.entries(Ea).map(([s,n])=>`<option value="${s}" ${t.category===s?"selected":""}>${n}</option>`).join("")}
              </select>
            </label>
  ...
  `}function Zl(e,t){const s=e.reduce((r,c)=>r+c.totalAmount,0),n=e.filter(r=>r.financialStatus==="paid").length,i=e.filter(r=>r.fulfillmentStatus!=="fulfilled"&&r.fulfillmentStatus!=="shipped").length;return`
    <section class="page-head">
      <div>
  ...
  `}function tc(e,t,s){const n=t==="__new__"?null:e.find(c=>c.id===t),i=t==="__new__";return s?.role==="admin"?`
    <section class="page-head">
      <div>
      ...
      <section class="panel">
        ...
        <div class="filter-grid filter-grid--wide">
          ...
          <label class="field" style="flex:1 1 140px;">
            <span>権限</span>
            <select id="user-role">
              ${Object.entries(At).map(([c,p])=>`<option value="${c}" ${n?.role===c?"selected":""}>${p}</option>`).join("")}
            </select>
          </label>
          <label class="field" style="flex:1 1 160px;">
            <span>電話</span>
  ...
  `:`
    ...
    <section class="panel">
      ...
      <dl class="summary-list">
        ...
        <div><dt>権限</dt><dd>${At[e.role]}</dd></div>
  ...
  `:`
    ...
    `}function sc(e){const t={};return e.forEach(s=>{const n=s.userEmail??"(anonymous)";t[n]=(t[n]??0)+1}),`
    <section class="page-head">
      <div>
  ...
  `}function nc(e){const t=e.prospects.reduce((r,c)=>r+c.expectedAmount,0),s=e.prospects.reduce((r,c)=>r+c.expectedAmount*c.probability/100,0),n=e.prospects.filter(r=>r.stage==="won").length,i=e.prospects.filter(r=>r.stage==="hot"||r.stage==="negotiating").length;return`
    <section class="page-head">
      <div>
    ...
    ${e.viewMode==="kanban"?oc(e.prospects):ic(e.prospects)}
  ...
  `}function rc(e){if(!e.editingId)return"";const t=e.editingId==="__new__",s=t?null:e.prospects.find(n=>n.id===e.editingId);return!t&&!s?"":`
  ...
  `}function lc(e,t,s){const n=e?.config.webhook_url??"",i=e?.config.default_channel??"#general";return`
    <section class="page-head">
      <div>
  ...
  `}const dc=["飲食店","居酒屋","寿司屋","和食","焼肉","フレンチ","イタリアン","バー","酒販店","ワインショップ","百貨店","スーパー","ホテル","旅館","ブライダル","セレクトショップ"];function uc(e){const t=e.activeListId?e.lists.find(r=>r.id===e.activeListId):null,s=e.items.filter(r=>r.status==="new").length,n=e.items.filter(r=>r.status==="imported").length,i=e.items.filter(r=>r.status==="excluded").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">新規営業</p>
        <h1>リスト取得ツール</h1>
    ...
    <section class="panel">
      ...
      <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:flex-end;">
        <label class="field" style="flex:1 1 180px;">
          ...
          <select id="lb-type">
            <option value="">選択</option>
            ${dc.map(r=>`<option value="${r}" ${e.searchBusinessType===r?"selected":""}>${r}</option>`).join("")}
          </select>
        </label>
        <label class="field" style="flex:1 1 180px;">
          <span>エリア</span>
  ...
  `}const ps={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},pc={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png",calibrationOffsetX:0,calibrationOffsetY:0},mc={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function ie(e){return"¥"+e.toLocaleString("ja-JP")}function lt(e){const t=new Date(e);return`${t.getFullYear()}年${t.getMonth()+1}月${t.getDate()}日`}function Cn(e,t){const s=e.reduce((r,c)=>r+c.amount,0),n=Math.floor(s*t),i=s+n;return{subtotal:s,taxAmount:n,total:i}}const X={currentDateY:{x:10,y:3.5,size:8},currentDateM:{x:17,y:3.5,size:8},currentDateD:{x:24,y:3.5,size:8},documentNo:{x:155,y:4,size:9,bold:!0},settlementCheck:{x:217,y:4,size:9},vendorName:{x:4,y:12,size:10,bold:!0},vendorAddress:{x:4,y:16.5,size:6.5},chainStoreCode:{x:63,y:13,size:9},categoryCode:{x:87,y:13,size:9},slipNumber:{x:117,y:13,size:9},vendorCode:{x:151,y:13,size:9},orderDateY:{x:180,y:13,size:7.5},orderDateM:{x:186,y:13,size:7.5},orderDateD:{x:192,y:13,size:7.5},deliveryDateY:{x:204,y:13,size:7.5},deliveryDateM:{x:211,y:13,size:7.5},deliveryDateD:{x:218,y:13,size:7.5},customerName:{x:4,y:20,size:10,bold:!0},partnerCode:{x:94,y:20,size:10,bold:!0},orderNo:{x:143,y:20,size:9},detailStartY:33,detailRowH:8.5,detailCols:{productName:{x:5,w:58,align:"left",size:7.5},productCode:{x:64,w:25,align:"left",size:7.5},color:{x:92,w:6,align:"center",size:7},size:{x:99,w:15,align:"center",size:7},unit:{x:115,w:8,align:"center",size:7},quantity:{x:124,w:10,align:"right",size:8},correctedQty:{x:137,w:14,align:"right",size:8},discount:{x:153,w:9,align:"right",size:7.5},unitPrice:{x:163,w:12,align:"right",size:8},costAmount:{x:176,w:16,align:"right",size:8,bold:!0},retailPrice:{x:193,w:12,align:"right",size:8},note:{x:206,w:18,align:"right",size:8}},totalQty:{x:125,y:89,size:9,bold:!0},receivedTotal:{x:150,y:89,size:9},returnTotal:{x:165,y:89,size:9},correctedCostTotal:{x:179,y:89,size:10,bold:!0},correctedRetailTotal:{x:207,y:89,size:10,bold:!0}};function W(e,t){const s=e.align??"left",n=e.size??8;return`<div class="bp-fld" style="${["position:absolute",`left:${e.x}mm`,`top:${e.y}mm`,e.w?`width:${e.w}mm`:"",`text-align:${s}`,`font-size:${n}pt`,e.bold?"font-weight:700":"","line-height:1","white-space:nowrap","overflow:hidden"].filter(Boolean).join(";")}">${t}</div>`}function Ut(e){if(!e)return{y:"",m:"",d:""};const t=new Date(e),s=t.getFullYear(),n=s-2018;return{y:n>0?String(n).padStart(2,"0"):String(s).slice(-2),m:String(t.getMonth()+1).padStart(2,"0"),d:String(t.getDate()).padStart(2,"0")}}function yc(e,t,s){const n=Ut(e.documentDate),i=Ut(e.orderDate??e.documentDate),r=Ut(e.deliveryDate??e.documentDate),c=e.lines.slice(0,6).map((l,d)=>{const m=X.detailStartY+d*X.detailRowH,g=X.detailCols,b=[],_=(C,S)=>{S&&b.push(W({...C,y:m,x:C.x+0},S))};return _(g.productName,l.productName+(l.spec?` ${l.spec}`:"")),_(g.productCode,l.productCode),_(g.color,l.color??""),_(g.size,[l.size,l.caseQty?`×${l.caseQty}`:""].filter(Boolean).join(" ")),_(g.unit,l.unit),_(g.quantity,l.quantity>0?l.quantity.toLocaleString("ja-JP"):""),_(g.correctedQty,l.correctedQuantity?l.correctedQuantity.toLocaleString("ja-JP"):""),_(g.discount,l.discount?l.discount.toLocaleString("ja-JP"):""),_(g.unitPrice,l.unitPrice>0?l.unitPrice.toLocaleString("ja-JP"):""),_(g.costAmount,l.amount>0?l.amount.toLocaleString("ja-JP"):""),_(g.retailPrice,l.retailPrice?l.retailPrice.toLocaleString("ja-JP"):""),_(g.note,l.receivedAmount?l.receivedAmount.toLocaleString("ja-JP"):""),b.join("")}).join(""),p=e.lines.reduce((l,d)=>l+(d.amount||0),0),u=e.lines.reduce((l,d)=>l+(d.retailPrice||0)*(d.correctedQuantity??d.quantity),0),y=e.lines.reduce((l,d)=>l+(d.receivedAmount||0),0),f=e.lines.reduce((l,d)=>l+(d.returnAmount||0),0),v=e.lines.reduce((l,d)=>l+d.quantity,0),$=s.showReferenceOverlay?`background-image: url('${s.overlayImageUrl}'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 1;`:"",x=s.calibrationOffsetX||0,k=s.calibrationOffsetY||0,o=`transform: translate(${x}mm, ${k}mm);`;return`
    <div class="print-page bp1701-overlay">
      <div class="bp-sheet" style="${$}">
        ...
        ${W(X.currentDateY,n.y)}
        ${W(X.currentDateM,n.m)}
        ${W(X.currentDateD,n.d)}
        ${W(X.documentNo,e.documentNo)}
        ${e.settlementPrint?W(X.settlementCheck,"✓"):""}

        ${W(X.vendorName,t.name)}
        ${W(X.vendorAddress,t.address1)}
        ${W(X.chainStoreCode,e.chainStoreCode??"")}
        ${W(X.categoryCode,e.categoryCode??"")}
        ${W(X.slipNumber,e.documentNo)}
        ${W(X.vendorCode,e.slipTypeCode??"")}

        ${W(X.customerName,`${e.customerName} ${e.customerHonorific}`)}
        ${W(X.orderDateY,i.y)}
        ${W(X.orderDateM,i.m)}
        ${W(X.orderDateD,i.d)}
        ${W(X.deliveryDateY,r.y)}
        ${W(X.deliveryDateM,r.m)}
        ${W(X.deliveryDateD,r.d)}
        ${W(X.orderNo,e.orderNo??"")}
        ${W(X.partnerCode,e.vendorCode??"")}

        ${c}

        ${W(X.totalQty,v.toLocaleString("ja-JP"))}
        ${W(X.receivedTotal,y.toLocaleString("ja-JP"))}
        ${W(X.returnTotal,f.toLocaleString("ja-JP"))}
        ${W(X.correctedCostTotal,p.toLocaleString("ja-JP"))}
        ${W(X.correctedRetailTotal,u.toLocaleString("ja-JP"))}
        </div>
      </div>
    </div>
  `}function hc(e,t,s){const{subtotal:n,taxAmount:i,total:r}=Cn(e.lines,e.taxRate),c=e.previousBalance??0,p=e.paymentAmount??0,u=c-p+r,y=e.lines.map(v=>`
      <tr>
  ...
  `}function fc(e,t,s){const{subtotal:n,taxAmount:i,total:r}=Cn(e.lines,e.taxRate),c=e.lines.map(u=>`
      <tr>
    ...
    <div class="print-page quotation-freee ${s.fontSize}">
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${ie(r)}</span>
          <span class="freee-total-tax">（税込）</span>
        </div>
      </div>
      ...
      <div class="freee-summary">
        ...
        <table class="freee-summary-table">
          ...
          <tr><th>消費税 (${Math.round(e.taxRate*100)}%)</th><td>${ie(i)}</td></tr>
          <tr class="freee-sum-grand"><th>合計</th><td>${ie(r)}</td></tr>
        </table>
      </div>
  ...
  `}function vc(e,t,s,n){let i="";switch(e){case"chain_store":i=yc(n,s,t);break;case"quotation":i=fc(n,s,t);break;case"invoice_monthly":i=hc(n,s,t);break}const r=Object.keys(ps).map(u=>`<button class="tab-button ${e===u?"active":""}" data-print-template="${u}">${ps[u]}</button>`).join(""),c=n.lines.map((u,y)=>`
      <tr>
  ...
  `}const gc={customers:["legacy_customer_code","name"],products:["legacy_product_code","name"],suppliers:["legacy_supplier_code","name"],staff:["legacy_staff_code","name"]},bc={customers:["legacy_customer_code","name","kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"],products:["legacy_product_code","name","kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"],suppliers:["legacy_supplier_code","name","kana_name","phone","postal_code","address1","closing_day","payment_day","email"],staff:["legacy_staff_code","name","kana_name","department"]};function En(e){e.charCodeAt(0)===65279&&(e=e.slice(1));const t=[];let s=[],n="",i=!1;for(let p=0;p<e.length;p++){const u=e[p];i?u==='"'?e[p+1]==='"'?(n+='"',p++):i=!1:n+=u:u==='"'?i=!0:u===","?(s.push(n),n=""):u===`
`||u==="\r"?(u==="\r"&&e[p+1]===`
`&&p++,s.push(n),s.some(y=>y!=="")&&t.push(s),s=[],n=""):n+=u}if((n!==""||s.length>0)&&(s.push(n),s.some(p=>p!=="")&&t.push(s)),t.length===0)return{columns:[],rows:[]};const r=t[0].map(p=>p.trim()),c=[];for(let p=1;p<t.length;p++){const u={};r.forEach((y,f)=>{u[y]=(t[p][f]??"").trim()}),c.push(u)}return{columns:r,rows:c}}function An(e,t,s){const n=gc[e],i=n.filter(p=>!t.includes(p)),r=s.map(p=>{const u=[];i.length>0&&u.push(`必須列欠損: ${i.join(",")}`);for(const y of n)t.includes(y)&&!p[y]&&u.push(`${y}が空`);return{...p,_valid:u.length===0,_error:u[0]}}),c=r.filter(p=>p._valid).length;return{entity:e,columns:t,rows:r,totalRows:s.length,validRows:c,invalidRows:r.length-c}}function Ln(e){const s=bc[e],i={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[e];return"\uFEFF"+s.join(",")+`
`+i.join(",")+`
`}async function Dn(e,t){const{supabaseInsert:s}=await A(async()=>{const{supabaseInsert:p}=await Promise.resolve().then(()=>U);return{supabaseInsert:p}},void 0);let n=0,i=0;const c={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const p of t){if(!p._valid)continue;const{_valid:u,_error:y,...f}=p,v={...f};if(!v.id){const $=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";v.id=String(f[$]??`${e}-${Date.now()}-${n+i}`)}for(const $ of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof v[$]=="string"&&v[$]!==""){const x=Number(v[$]);Number.isFinite(x)&&(v[$]=x)}try{await s(c,v)!==null?n++:i++}catch{i++}}return{inserted:n,failed:i}}const $c=Object.freeze(Object.defineProperty({__proto__:null,generateTemplateCSV:Ln,importToSupabase:Dn,parseCSV:En,validateImport:An},Symbol.toStringTag,{value:"Module"}));function Qt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function _c(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function wc(e,t,s,n,i){const r=s.reduce((y,f)=>y+f.rowCount,0),c=s.map(y=>y.lastSyncAt).filter(y=>y!==null).sort().reverse()[0]??null,p=100,u=Math.max(1,Math.ceil(i/p));return`
    <section class="page-head">
      <div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="mono" style="font-size:11px;max-width:300px;overflow:hidden;text-overflow:ellipsis;" title="${y._raw_b64?y._raw_b64.slice(0,200):""}">${_c(y._raw_b64)}</td>
            </tr>
            `).join("")}
          </tbody>
        </table>
    ...
    `}
  `}const Ae=400,je=240;function J(e){return e.toLocaleString("ja-JP")}function Ht(e){const[t,s]=e.split("-");return`${t.slice(2)}/${s}`}function xc(e,t){return!e||e.column!==t?'<span style="opacity:0.3;margin-left:2px;">⇅</span>':e.dir==="asc"?'<span style="margin-left:2px;">↑</span>':'<span style="margin-left:2px;">↓</span>'}function we(e,t,s,n=""){return`<th class="${n}" style="cursor:pointer;user-select:none;white-space:nowrap;"
    data-action="demand-sort" data-sort-col="${t}">${e}${xc(s,t)}</th>`}function nt(e){return e>=.99?2.33:e>=.97?1.88:e>=.95?1.65:e>=.9?1.28:1.04}function Sc(e){const{months:t,matrix:s}=e;if(t.length===0||e.products.length===0)return'<div class="chart-empty">データなし</div>';const n=e.products.slice().sort((d,m)=>(e.productTotals[m.code]??0)-(e.productTotals[d.code]??0)).slice(0,6),i=["#0F5B8D","#2F855A","#B7791F","#C53D3D","#6B46C1","#2B6CB0"],r=820,c=280,p={top:20,right:20,bottom:40,left:60},u=r-p.left-p.right,y=c-p.top-p.bottom,f=t.map(d=>n.reduce((m,g)=>m+(s[g.code]?.[d]??0),0)),v=Math.max(...f,1),$=u/t.length,x=Math.max($-10,14),k=[0,.25,.5,.75,1].map(d=>{const m=p.top+y-y*d,g=`${Math.round(v*d/100)*100}`;return`
      <line x1="${p.left}" y1="${m}" x2="${r-p.right}" y2="${m}" class="chart-grid" />
      <text x="6" y="${m+4}" class="chart-axis">${Number(g).toLocaleString("ja-JP")}</text>
    `}).join(""),o=t.map((d,m)=>{let g=p.top+y;const b=p.left+m*$+($-x)/2,_=n.map((L,q)=>{const j=(s[L.code]?.[d]??0)/v*y;return g-=j,`<rect x="${b}" y="${g}" width="${x}" height="${j}" fill="${i[q%i.length]}" opacity="0.85" rx="${q===n.length-1?3:0}" />`}).join(""),[C,S]=d.split("-"),E=parseInt(S),I=E===1||m%3===0,M=E===1?`${C.slice(2)}年`:`${E}月`;return`<g>${_}${I?`<text x="${b+x/2}" y="${c-10}" class="chart-axis centered-axis">${M}</text>`:""}</g>`}).join(""),l=n.map((d,m)=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}function kc(e){const{months:t,products:s}=e,n=s.slice().sort((c,p)=>(e.productTotals[p.code]??0)-(e.productTotals[c.code]??0)).slice(0,50),i=t.map(c=>{const[p,u]=c.split("-"),y=parseInt(u);return`<th class="numeric" style="min-width:52px;white-space:nowrap;">${y===1?`${p.slice(2)}年1月`:`${y}月`}</th>`}).join(""),r=n.map(c=>{const p=t.map(u=>{const y=e.matrix[c.code]?.[u]??0;return`<td class="numeric">${y>0?J(y):"—"}</td>`}).join("");return`
      <tr>
  ...
  `}function Pc(e,t){const s=e.months[e.months.length-1]??"",n=e.months[e.months.length-2]??"",i=e.months.length-13,r=i>=0?e.months[i]:"",c=e.products.reduce((x,k)=>x+(e.matrix[k.code]?.[s]??0),0),p=e.products.reduce((x,k)=>x+(e.matrix[k.code]?.[n]??0),0),u=r?e.products.reduce((x,k)=>x+(e.matrix[k.code]?.[r]??0),0):0,y=p>0?(c-p)/p*100:0,f=u>0?(c-u)/u*100:0,v=x=>x>=0?"+":"",$=[1,2,3,5].map(x=>`<option value="${x}" ${x===t?"selected":""}>${x}年</option>`).join("");return`
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
  ...
  `}const Ec={monthly:"月次",annual:"年次",make_to_order:"受注生産",november:"11月生産"};function Ac(e,t,s,n){const i={draft:"下書き",confirmed:"確定",actual:"実績入力済"},r={draft:"neutral",confirmed:"info",actual:"success"},c=S=>Object.entries(Ec).map(([E,I])=>`<option value="${E}" ${E===S?"selected":""}>${I}</option>`).join(""),p=640,u=S=>S.map(E=>{const I=Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock),M=E.plannedQty>0?E.plannedQty:Math.round(I),L=M>0?Math.ceil(M/p*10)/10:0,q=E.plannedQty>0?(E.actualQty-E.plannedQty)/E.plannedQty*100:null,O=q!==null?q>=0?"text-success":"text-danger":"";return`
      <tr>
        ...
        <td class="numeric" style="white-space:nowrap;">
          ${L>0?`${L.toFixed(1)}<span style="font-size:11px;color:var(--text-secondary);margin-left:2px;">人日</span>`:"—"}
        </td>
        <td>
          <span class="status-pill ${r[E.status]??"neutral"}">${i[E.status]??E.status}</span>
        </td>
      </tr>
    `}).join(""),f=(s==="all"?e:e.filter(S=>S.productionType===s)).slice().sort((S,E)=>{if(!n)return 0;const I=n.dir==="asc"?1:-1,M=Math.max(0,S.demandForecast+S.safetyStockTarget-S.openingStock),L=Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock);switch(n.column){case"plan-name":return I*S.productName.localeCompare(E.productName,"ja");case"plan-forecast":return I*(S.demandForecast-E.demandForecast);case"plan-required":return I*(M-L);case"plan-planned":return I*(S.plannedQty-E.plannedQty);case"plan-actual":return I*(S.actualQty-E.actualQty);case"plan-label":{const q=S.plannedQty>0?S.plannedQty:Math.round(M),O=E.plannedQty>0?E.plannedQty:Math.round(L);return I*(q-O)}default:return 0}}),v=u(f),$=[{key:"all",label:"全て"},{key:"monthly",label:"月次"},{key:"annual",label:"年次"},{key:"november",label:"11月生産"},{key:"make_to_order",label:"受注生産"}],x=S=>{const I=(S==="all"?e:e.filter(M=>M.productionType===S)).reduce((M,L)=>{const q=Math.max(0,L.demandForecast+L.safetyStockTarget-L.openingStock);return M+(L.plannedQty>0?L.plannedQty:Math.round(q))},0);return Math.ceil(I/p*10)/10},k=$.filter(S=>S.key!=="all").map(S=>{const E=x(S.key),I=e.filter(L=>L.productionType===S.key).length,M=S.key==="make_to_order"?e.filter(L=>L.productionType==="make_to_order"&&L.plannedQty>0).length:null;return`
    ...
    `}).join(""),o=f.reduce((S,E)=>S+E.demandForecast,0),l=f.reduce((S,E)=>S+Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock),0),d=f.reduce((S,E)=>S+E.plannedQty,0),m=f.reduce((S,E)=>S+E.actualQty,0),g=x(s),b=new Date,_=Array.from({length:24},(S,E)=>{const I=new Date(b.getFullYear(),b.getMonth()-6+E,1),M=`${I.getFullYear()}-${String(I.getMonth()+1).padStart(2,"0")}`;return`<option value="${M}" ${M===t?"selected":""}>${M.replace("-","年")}月</option>`}).join(""),C=$.map(S=>`<button class="button ${s===S.key?"primary":"secondary"}" type="button"
  ...
  `}function qn(e){const[t,s]=e.split("-").map(Number),n=new Date(t,s,0).getDate();return Array.from({length:n},(i,r)=>{const c=r+1;return`${e}-${String(c).padStart(2,"0")}`})}function ms(e){const t=new Date(e).getDay();return["日","月","火","水","木","金","土"][t]}function ca(e){const t=new Date(e).getDay();return t===0||t===6}function Lc(e){return e.partTimers*Ae+e.employees*je}function In(e){return e.partTimers+e.employees}function Ce(e,t){e.filter(y=>y.partTimers>0||y.employees>0||!ca(y.date));const s=e.filter(y=>y.partTimers>0||y.employees>0);if(s.length===0)return;const n=t.reduce((y,f)=>{const v=f.plannedQty>0?f.plannedQty:Math.max(0,f.demandForecast+f.safetyStockTarget-f.openingStock);return y+v},0);if(n<=0)return;const i=n/s.length;let r=0,c=0,p=1/0;const u=Math.ceil(i/Ae);for(let y=0;y<=u;y++){const f=i-y*Ae,v=f>0?Math.ceil(f/je):0,$=y+v;$<p&&(p=$,r=y,c=v)}for(const y of e)y.confirmed||(y.partTimers>0||y.employees>0)&&(y.partTimers=r,y.employees=c)}function Dc(e,t){const s=t.filter(c=>In(c)>0).map(c=>c.date).sort();if(s.length===0)return t.map(c=>({date:c.date,partTimers:c.partTimers,employees:c.employees,confirmed:c.confirmed,capacity:0,items:[],totalQty:0,utilization:0}));const n={monthly:0,november:1,annual:2,make_to_order:3},i=e.filter(c=>c.plannedQty>0||Math.max(0,c.demandForecast+c.safetyStockTarget-c.openingStock)>0).map(c=>({productCode:c.productCode,productName:c.productName,productionType:c.productionType,remaining:c.plannedQty>0?c.plannedQty:Math.max(0,c.demandForecast+c.safetyStockTarget-c.openingStock)})).filter(c=>c.remaining>0).sort((c,p)=>(n[c.productionType]??99)-(n[p.productionType]??99)||p.remaining-c.remaining),r=new Map;for(const c of t){const p=Lc(c);r.set(c.date,{date:c.date,partTimers:c.partTimers,employees:c.employees,confirmed:c.confirmed,capacity:p,items:[],totalQty:0,utilization:0})}for(const c of i){let p=c.remaining;if(p<=0)continue;if(s.reduce((y,f)=>{const v=r.get(f);return y+Math.max(0,v.capacity-v.totalQty)},0)<=0)break;for(const y of s){if(p<=0)break;const f=r.get(y),v=Math.max(0,f.capacity-f.totalQty);if(v<=0)continue;const $=Math.min(p,v);f.items.push({productCode:c.productCode,productName:c.productName,productionType:c.productionType,qty:$}),f.totalQty+=$,f.utilization=f.capacity>0?f.totalQty/f.capacity:0,p-=$}}return t.map(c=>r.get(c.date))}function Et(e,t=1,s=1){return qn(e).map(n=>({date:n,partTimers:ca(n)?0:t,employees:ca(n)?0:s,confirmed:!1}))}function qc(e,t,s,n=null,i=new Set){const r=qn(t),c=e.filter(L=>!i.has(L.productCode)),p=Dc(c,s),u=new Map(p.map(L=>[L.date,L])),y=c.reduce((L,q)=>L+(q.plannedQty>0?q.plannedQty:Math.max(0,q.demandForecast+q.safetyStockTarget-q.openingStock)),0),v=e.reduce((L,q)=>L+(q.plannedQty>0?q.plannedQty:Math.max(0,q.demandForecast+q.safetyStockTarget-q.openingStock)),0)-y,$=p.reduce((L,q)=>L+q.totalQty,0),x=s.filter(L=>In(L)>0).length,k=p.reduce((L,q)=>L+q.capacity,0),o=s.reduce((L,q)=>L+q.partTimers,0),l=s.reduce((L,q)=>L+q.employees,0),d=x>0?Math.ceil(y/x):0,m=new Date,g=Array.from({length:24},(L,q)=>{const O=new Date(m.getFullYear(),m.getMonth()-6+q,1),j=`${O.getFullYear()}-${String(O.getMonth()+1).padStart(2,"0")}`;return`<option value="${j}" ${j===t?"selected":""}>${j.replace("-","年")}月</option>`}).join(""),b=new Date(r[0]).getDay(),_=[];for(let L=0;L<b;L++)_.push('<div style="min-height:44px;"></div>');for(const L of r){const q=u.get(L),O=new Date(L).getDay(),j=parseInt(L.split("-")[2]),Q=q?.partTimers??0,ee=q?.employees??0,se=Q+ee,pe=q?.totalQty??0,R=q?.utilization??0,z=L===n,le=se===0?"var(--surface-alt)":R>.95?"rgba(197,61,61,0.12)":R>.7?"rgba(183,121,31,0.10)":R>0?"rgba(47,133,90,0.08)":"var(--surface)",ye=se===0?"transparent":R>.95?"#c53d3d":R>.7?"#b7791f":R>0?"#2f855a":"var(--border)",Pe=O===0?"#c53d3d":O===6?"#0F5B8D":"var(--text)",Y=se>0?`<span style="font-size:8px;color:var(--text-secondary);line-height:1;">${Q>0?`パ${Q}`:""}${ee>0?`社${ee}`:""}</span>`:"";_.push(`
      <div data-action="cal-toggle-day" data-date="${L}"
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;">
          <span style="font-size:12px;font-weight:600;color:${Pe};line-height:1;">${j}</span>
          ${Y}
        </div>
        ${se>0?`
          <div style="font-size:10px;font-weight:600;color:var(--text);margin-top:auto;line-height:1;">${pe>0?J(pe):""}</div>
          <div style="height:3px;background:var(--border);border-radius:2px;margin-top:2px;">
            <div style="height:100%;width:${Math.min(R*100,100)}%;background:${ye};border-radius:2px;"></div>
          </div>
        `:'<div style="font-size:9px;color:var(--text-disabled);margin-top:auto;">休</div>'}
      </div>
    `)}const S=_.length%7;if(S>0)for(let L=0;L<7-S;L++)_.push('<div style="min-height:44px;"></div>');const E=n?u.get(n):null;n&&s.find(L=>L.date===n);const I=n&&E?(()=>{const L=E,q=parseInt(n.split("-")[2]),O=ms(n),j=Math.round(L.utilization*100),Q=s.find(V=>V.date===n),ee={monthly:"#0F5B8D",november:"#B7791F",annual:"#6B46C1",make_to_order:"#999"},se={monthly:"月次",november:"11月",annual:"年次",make_to_order:"受注"},pe=L.items.map(V=>`
      <div style="display:flex;align-items:center;gap:8px;padding:8px 0;border-bottom:1px solid var(--border);">
        <span style="width:8px;height:8px;border-radius:50%;background:${ee[V.productionType]??"#999"};flex-shrink:0;"></span>
        <div style="flex:1;min-width:0;">
          <div style="font-size:13px;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${V.productName}</div>
          <div style="font-size:11px;color:var(--text-secondary);">${se[V.productionType]??V.productionType}</div>
        </div>
        <div style="font-size:14px;font-weight:700;white-space:nowrap;">${J(V.qty)}<span style="font-size:11px;font-weight:400;">本</span></div>
      </div>
    `).join(""),R=`パート${L.partTimers}人×${Ae} + 社員${L.employees}人×${je} = ${J(L.capacity)}本`,z=L.totalQty>0?Math.ceil(L.totalQty/Ae):0;L.totalQty>0&&Math.ceil(L.totalQty/je);const le=[];if(L.totalQty>0)for(let V=0;V<=z;V++){const he=L.totalQty-V*Ae;if(he<=0){le.push({p:V,e:0});break}const te=Math.ceil(he/je);le.push({p:V,e:te})}const ye=L.totalQty-L.capacity,Pe=L.totalQty===0?"":ye>0?`<span style="color:#c53d3d;font-weight:600;">⚠ ${J(ye)}本 不足</span>`:'<span style="color:#2f855a;">✓ キャパ内</span>',Y=le.filter(V=>V.p+V.e>0).sort((V,he)=>V.p+V.e-(he.p+he.e)).slice(0,3),xe=L.totalQty>0?`
      <div style="background:var(--surface-alt);border-radius:6px;padding:10px 12px;margin:0 4px 8px;">
        <div style="font-size:12px;font-weight:600;margin-bottom:6px;">
          ${J(L.totalQty)}本を収めるには ${Pe}
        </div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
          ${Y.map((V,he)=>{const te=V.p===L.partTimers&&V.e===L.employees;return`<button data-action="cal-apply-pattern" data-date="${n}" data-part="${V.p}" data-emp="${V.e}"
              ...
              <span style="color:var(--text-secondary);margin-left:2px;">${J(V.p*Ae+V.e*je)}本</span>
            </button>`}).join("")}
        </div>
      </div>
    `:"";return`
      <section class="panel" style="margin-top:12px;border:2px solid #0F5B8D;">
        <div class="panel-header" style="padding-bottom:8px;">
          <h2>${q}日（${O}）の生産内訳</h2>
          <p class="panel-caption">${R} ・ 稼働率${j}%</p>
        </div>
        ${xe}
        <div style="display:flex;gap:12px;padding:0 4px 8px;flex-wrap:wrap;">
          <label style="font-size:12px;color:var(--text-secondary);display:flex;align-items:center;gap:4px;">
            パート
            <input type="number" min="0" max="10" value="${Q?.partTimers??0}"
          ...
          <label style="font-size:12px;color:var(--text-secondary);display:flex;align-items:center;gap:4px;">
            社員
            <input type="number" min="0" max="10" value="${Q?.employees??0}"
  ...
  `:"",M=[{color:"#0F5B8D",label:"月次"},{color:"#B7791F",label:"11月"},{color:"#6B46C1",label:"年次"},{color:"#999",label:"受注"}].map(L=>`<span style="display:inline-flex;align-items:center;gap:2px;font-size:10px;">
    ...
    <div style="background:var(--surface-alt);border-radius:8px;padding:10px 14px;margin-bottom:12px;font-size:12px;line-height:1.8;">
      ...
      <div>→ パ<strong>${o}</strong> 社<strong>${l}</strong>人日 ・ キャパ<strong>${J(k)}</strong>本
        ${$<y?` <span style="color:#c53d3d;">（${J(Math.round(y-$))}本 未配分）</span>`:' <span style="color:#2f855a;">✓ 全量配分済</span>'}
      </div>
      <div style="color:var(--text-secondary);font-size:10px;">パート ${Ae}本/人日 ・ 社員 ${je}本/人日 ｜ 日付タップで稼働ON/OFF → 人数自動計算</div>
    </div>
    ...
    <section class="panel" style="margin-top:12px;" id="cal-label-section">
      <div class="panel-header" style="padding-bottom:4px;">
        <div>
          ...
          <p class="panel-caption">区分ごとにまとめて外す or 個別に外せます${i.size>0?`（<strong>${i.size}</strong>品除外中 = ${J(Math.round(v))}本）`:""}</p>
        </div>
      ...
      <div id="cal-label-list" style="max-height:500px;overflow-y:auto;">
        ${(()=>{const L=[{key:"monthly",label:"月次",color:"#0F5B8D"},{key:"november",label:"11月生産",color:"#B7791F"},{key:"annual",label:"年次",color:"#6B46C1"},{key:"make_to_order",label:"受注生産",color:"#999"}],q=new Map;for(const O of e){if((O.plannedQty>0?O.plannedQty:Math.max(0,O.demandForecast+O.safetyStockTarget-O.openingStock))<=0)continue;const Q=O.productionType||"monthly";q.has(Q)||q.set(Q,[]),q.get(Q).push(O)}return L.filter(O=>q.has(O.key)).map(O=>{const j=q.get(O.key),Q=j.reduce((z,le)=>z+(le.plannedQty>0?le.plannedQty:Math.max(0,le.demandForecast+le.safetyStockTarget-le.openingStock)),0),ee=j.filter(z=>i.has(z.productCode)).length,se=ee===j.length,pe=ee===0,R=j.map(z=>{const le=z.plannedQty>0?z.plannedQty:Math.max(0,z.demandForecast+z.safetyStockTarget-z.openingStock),ye=i.has(z.productCode);return`
                <div style="display:flex;align-items:center;gap:8px;padding:7px 4px 7px 28px;border-bottom:1px solid var(--border);${ye?"opacity:0.4;":""}">
                  ...
                  <div style="flex:1;min-width:0;">
                    <div style="font-size:13px;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;${ye?"text-decoration:line-through;":""}">${z.productName}</div>
                  </div>
                  <div style="font-size:13px;font-weight:600;flex-shrink:0;">${J(Math.round(le))}</div>
                </div>
              `}).join("");return`
              <div style="border-bottom:2px solid var(--border);">
                <div style="display:flex;align-items:center;gap:8px;padding:10px 4px;background:var(--surface-alt);position:sticky;top:0;z-index:1;">
                  <input type="checkbox" data-action="cal-label-toggle-group" data-type="${O.key}"
                    ${se?"":"checked"} ${!pe&&!se?'class="indeterminate"':""}
                  ...
                  <div style="flex:1;font-size:13px;font-weight:600;">${O.label}<span style="font-weight:400;color:var(--text-secondary);margin-left:6px;">${j.length}品 ${J(Math.round(Q))}本</span></div>
                  ${ee>0&&!se?`<span style="font-size:11px;color:#b7791f;">${ee}品除外</span>`:""}
                  ${se?'<span style="font-size:11px;color:var(--text-secondary);">全除外</span>':""}
                </div>
                ${R}
              </div>
            `}).join("")})()}
  ...
  `}function Ic(e,t,s,n,i,r,c="all",p=null,u=[],y=null,f=new Set){const $=[{key:"demand",label:"需要実績"},{key:"safety",label:"安全在庫"},{key:"plan",label:"生産計画"},{key:"calendar",label:"生産カレンダー"}].map(k=>`<button class="tab-button ${n===k.key?"active":""}"
       data-demand-tab="${k.key}">${k.label}</button>`).join("");let x="";if(n==="demand")x=e?Pc(e,r):'<section class="panel"><p>データを読み込んでいます…</p></section>';else if(n==="safety")x=Cc(t,p);else if(n==="plan")x=Ac(s,i,c,p);else if(n==="calendar")try{x=qc(s,i,u,y,f)}catch(k){console.error("[renderCalendarTab] error:",k),x=`<section class="panel"><div style="color:red;padding:16px;white-space:pre-wrap;">[カレンダー描画エラー] ${String(k)}
${k?.stack??""}</div></section>`}return`
    ...
    ${x}
  `}const Ke={純米大吟醸:"#7c3aed",大吟醸:"#a855f7",純米吟醸:"#2563eb",純米:"#059669",本醸造:"#d97706",普通酒:"#6b7280",リキュール:"#e11d48",その他:"#9ca3af"},mt=["純米大吟醸","大吟醸","純米吟醸","純米","本醸造","普通酒","リキュール","その他"];function Ue(e){return e.toLocaleString("ja-JP")}function ge(e){return(e/1e3).toLocaleString("ja-JP",{maximumFractionDigits:1})}function Na(e){return e<2?"#ef4444":e<=4?"#eab308":"#22c55e"}function Tc(e){return e<2?"要醸造":e<=4?"注意":"余裕あり"}function Nc(e){if(e.length===0)return'<div class="chart-empty">出荷データなし</div>';const t=[...new Set(e.map(l=>l.month))].sort(),s=mt.filter(l=>e.some(d=>d.brewCategory===l)),n={};for(const l of e)n[l.month]||(n[l.month]={}),n[l.month][l.brewCategory]=l.shipmentMl;const i=820,r=300,c={top:20,right:20,bottom:50,left:70},p=i-c.left-c.right,u=r-c.top-c.bottom,y=t.map(l=>s.reduce((d,m)=>d+(n[l]?.[m]??0),0)),f=Math.max(...y,1),v=p/t.length,$=Math.max(v-8,14),x=[0,.25,.5,.75,1].map(l=>{const d=c.top+u-u*l,m=f*l/1e3;return`
    ...
    `}).join(""),k=t.map((l,d)=>{let m=c.top+u;const g=c.left+d*v+(v-$)/2,b=s.map(M=>{const L=n[l]?.[M]??0,q=L/f*u;return m-=q,q>0?`<rect x="${g}" y="${m}" width="${$}" height="${q}" fill="${Ke[M]??"#9ca3af"}" opacity="0.85" rx="1"><title>${M}: ${ge(L)}L</title></rect>`:""}).join(""),[_,C]=l.split("-"),S=parseInt(C),E=S===10||d%2===0,I=S===10?`${_}年度`:`${S}月`;return`<g>${b}${E?`<text x="${g+$/2}" y="${r-12}" class="chart-axis centered-axis" style="font-size:10px;">${I}</text>`:""}</g>`}).join(""),o=s.map(l=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}function Mc(e){const t=new Map;for(const n of e){const i=n.brewCategory;t.has(i)||t.set(i,{rows:[],totalMl:0,avgMl:0,stockL:0,months:0});const r=t.get(i);r.rows.push(n),r.totalMl+=n.totalShipmentMl,r.avgMl+=n.monthlyAvgMl,r.stockL=n.currentStockL,r.months=n.monthsRemaining}for(const[,n]of t)n.avgMl>0&&(n.months=Math.round(n.stockL*1e3/n.avgMl*10)/10);return`<div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:16px;">${mt.filter(n=>t.has(n)).map(n=>{const i=t.get(n),r=Ke[n]??"#9ca3af",c=Na(i.months),p=Tc(i.months),u=Math.min(i.months/6*100,100);return`
      ...
      `}).join("")}</div>`}function Oc(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=new Map;for(const i of e)t.has(i.brewCategory)||t.set(i.brewCategory,[]),t.get(i.brewCategory).push(i);const s=`
    <tr>
  ...
  `,n=[];for(const i of mt){const r=t.get(i);if(!r)continue;const c=Ke[i]??"#9ca3af",p=r.length>1,u=r.reduce((l,d)=>l+d.totalShipmentQty,0),y=r.reduce((l,d)=>l+d.totalShipmentMl,0),f=r.reduce((l,d)=>l+d.monthlyAvgQty,0),v=r.reduce((l,d)=>l+d.monthlyAvgMl,0),$=r.reduce((l,d)=>l+d.productCount,0),x=r[0].currentStockL,k=v>0?Math.round(x*1e3/v*10)/10:0,o=Na(k);if(n.push(`
    ...
    `),p)for(const l of r)n.push(`
          <tr class="sub-row-${i.replace(/[^a-zA-Z0-9]/g,"_")}" style="display:none;font-size:12px;">
            ...
            <td style="text-align:right;">${ge(l.totalShipmentMl)}</td>
            <td style="text-align:right;">${Ue(l.monthlyAvgQty)}</td>
            <td style="text-align:right;">${ge(l.monthlyAvgMl)}</td>
  ...
  `}function Rc(e){const t=new Map;for(const n of e)t.has(n.brewCategory)||t.set(n.brewCategory,{avgMl:0,stockL:n.currentStockL}),t.get(n.brewCategory).avgMl+=n.monthlyAvgMl;return`
  ...
  `}function jc(e,t,s,n){if(e.length===0)return"";const i=[...mt,...s],r=new Map;for(const u of e)r.has(u.brewCategory)||r.set(u.brewCategory,[]),r.get(u.brewCategory).push(u);for(const u of s)r.has(u)||r.set(u,[]);const c=(u,y)=>i.map(f=>`<option value="${f}" ${f===u?"selected":""}>${f}${f===y?"（自動）":""}</option>`).join("");return`
    <div class="card" style="margin-bottom:16px;">
      ...
      ${i.filter(u=>r.has(u)).map(u=>{const y=r.get(u),f=Ke[u]??"#6366f1",v=s.includes(u),$=y.filter(l=>!t.has(l.productCode)),x=$.reduce((l,d)=>l+d.annualMl,0);$.reduce((l,d)=>l+d.annualQty,0);const k=$.reduce((l,d)=>l+d.monthlyAvgMl,0),o=y.map(l=>{const d=t.has(l.productCode),m=l.productCode in n;return`
          <tr style="${d?"opacity:0.4;text-decoration:line-through;":""}">
            ...
            <td style="text-align:right;">${ge(l.annualMl)}</td>
            <td style="text-align:right;">${ge(l.monthlyAvgMl)}</td>
            <td>
        ...
        <div style="margin-bottom:20px;">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;flex-wrap:wrap;">
            ...
            <span style="font-size:12px;color:var(--text-secondary);">
              ${$.length}銘柄 ・ 年間${ge(x)}L ・ 月平均${ge(k)}L
            </span>
          </div>
          ${y.length>0?`
            <div class="table-wrap">
  ...
  `}function Fc(e,t,s,n=[],i=new Set,r=[],c={}){const p=new Date,u=p.getMonth()>=9?p.getFullYear():p.getFullYear()-1,y=Array.from({length:5},(v,$)=>{const x=u-$;return`<option value="${x}" ${x===s?"selected":""}>${x}年度 (${x}/10-${x+1}/9)</option>`}).join(""),f=e.length===0&&t.length===0?'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます...</p></div></section>':"";return f||`
    <section class="panel">
  ...
  `}function da(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e4?`${Math.round(e/1e4)}万`:new Intl.NumberFormat("ja-JP").format(e)+"円"}function zc(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Tn(e){return e?Ot.find(t=>t.value===e)?.label??e:""}function Bc(e){const t=[],s=[],n=[];for(const i of e){const r=i.amount_last_year_same_month>0?i.amount_this_month/i.amount_last_year_same_month:1,c={code:i.customer_code,name:i.customer_name,businessType:i.business_type,areaCode:i.area_code,phone:i.phone,lastOrderDate:i.last_order_date,daysSinceLastOrder:i.days_since_order,totalAmountLast12m:i.amount_12m,amount3m:i.amount_3m,amountThisMonth:i.amount_this_month,amountLastYearSameMonth:i.amount_last_year_same_month,annualRevenue:i.annual_revenue,yoyRatio:r,status:"dormant"};i.is_at_risk?t.push({...c,status:"at-risk"}):i.is_dormant?s.push({...c,status:"dormant"}):i.amount_last_year_same_month>0&&r<.8&&n.push({...c,status:"declining"})}return t.sort((i,r)=>r.totalAmountLast12m-i.totalAmountLast12m),s.sort((i,r)=>r.daysSinceLastOrder-i.daysSinceLastOrder),n.sort((i,r)=>i.yoyRatio-r.yoyRatio),{atRiskCustomers:t,dormantCustomers:s,decliningCustomers:n}}function Vc(e,t){const s=t?.reason??"",n=Ot.map(i=>`<option value="${i.value}" ${s===i.value?"selected":""}>${i.label}</option>`).join("");return`
    <select
    ...
    >
      ...
      ${n}
    </select>`}function Jc(e,t){const s={"at-risk":{label:"離反リスク",cls:"danger"},dormant:{label:"休眠",cls:"warning"},declining:{label:"下落中",cls:"info"}}[e.status],n=e.status==="declining"&&e.amountLastYearSameMonth>0?`<td class="numeric" style="color:var(--color-danger);font-weight:700;">${Math.round(e.yoyRatio*100)}%</td>`:e.status==="dormant"?`<td class="numeric" style="color:var(--color-warning);">${e.daysSinceLastOrder}日</td>`:'<td class="numeric" style="color:var(--color-danger);">今月未注文</td>',i=!!t?.actionedAt,r=i?'style="opacity:0.45;"':"",c=t?.reason?`<br><span class="status-pill info" style="font-size:0.72rem;">${Tn(t.reason)}</span>`:"";return`
    ...
    </tr>`}function Gt(e,t,s,n,i,r,c,p){if(i.length===0)return"";const u=i.map(y=>Jc(y,p.get(y.code))).join("");return`
    <section class="panel" id="${e}-section">
      <div class="panel-header">
        <div>
          <h2><span class="status-pill ${n}" style="margin-right:8px;">${i.length}社</span>${t}</h2>
          <p class="panel-caption">${s} — 対象売上合計: ${zc(r)}</p>
        </div>
      </div>
      <div class="table-wrap">
    ...
    </section>`}function Yc(e,t=[]){const{atRiskCustomers:s,dormantCustomers:n,decliningCustomers:i}=e,r=s.length+n.length+i.length,c=s.reduce((l,d)=>l+d.totalAmountLast12m,0),p=n.reduce((l,d)=>l+d.totalAmountLast12m,0),u=i.reduce((l,d)=>l+d.totalAmountLast12m,0),y=[...s,...n,...i],f=[...new Set(y.map(l=>l.areaCode).filter(Boolean))].sort(),v=[...new Set(y.map(l=>l.businessType).filter(Boolean))].sort(),$=new Map(t.map(l=>[l.customerCode,l])),x=t.filter(l=>l.actionedAt).length,k=new Map;t.forEach(l=>{l.reason&&k.set(l.reason,(k.get(l.reason)??0)+1)});const o=[...k.entries()].sort((l,d)=>d[1]-l[1]).slice(0,5).map(([l,d])=>`<span class="status-pill info" style="font-size:0.75rem;">${Tn(l)} ${d}社</span>`).join(" ");return`
    <section class="page-head">
      <div>
    ...
    ${Gt("at-risk","離反リスク","前年同月に注文があったが今月まだない顧客","danger",s,c,"状況",$)}
    ${Gt("dormant","休眠顧客","12ヶ月以内に注文があったが3ヶ月以上空白がある顧客","warning",n,p,"経過日数",$)}
    ${Gt("declining","売上下落中","前年同月比80%未満の顧客（離反・休眠を除く）","info",i,u,"前年同月比",$)}
    ...
    <\/script>`}const Le=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],ua={"year-round":"通年品",seasonal:"季節品","year-end":"歳暮品"},Ee={"year-round":"#0F5B8D",seasonal:"#2f855a","year-end":"#c05621"};function Uc(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Qc(e){const t=e.reduce((r,c)=>r+c,0);if(t===0)return"year-round";if((e[10]+e[11])/t>.5)return"year-end";const n=Math.max(...e);return e.filter(r=>r>n*.1).length<=6?"seasonal":"year-round"}function Hc(e){const t=e.reduce((r,c)=>r+c,0);if(t===0)return[];const n=t/12*1.5,i=[];for(let r=0;r<12;r++)e[r]>n&&i.push(r);if(i.length===0){const r=Math.max(...e);r>0&&i.push(e.indexOf(r))}return i.sort((r,c)=>r-c)}function Gc(e){return e.length===0?0:(e[0]-2+12)%12}function ys(e){const t=new Date().getMonth(),s=e.map(i=>{const r=Qc(i.monthlyQuantity),c=Hc(i.monthlyQuantity),p=Gc(c);return{code:i.code,name:i.name,category:i.category,peakMonths:c,proposalStartMonth:p,seasonType:r,monthlyQuantity:i.monthlyQuantity}}),n=[];for(let i=0;i<12;i++){const r=s.filter(c=>{if(c.peakMonths.length===0)return!1;const p=c.proposalStartMonth,u=c.peakMonths[0];return p<=u?i>=p&&i<=u:i>=p||i<=u});n.push({month:i,products:r,targetCustomers:[]})}return{products:s,proposals:n,selectedMonth:t}}function Xc(e){const{products:t,proposals:s,selectedMonth:n}=e,i=new Date().getMonth(),r={"year-round":[],seasonal:[],"year-end":[]};t.forEach(v=>r[v.seasonType].push(v));const c=s[n],p=t.length,u=c?.products.length??0,y=t.filter(v=>v.peakMonths.includes(n)).length,f=c?.targetCustomers.length??0;return`
<div class="panel">
  <div class="page-head">
    <div>
  ...
  <div style="display:flex;gap:4px;margin-bottom:1.5rem;flex-wrap:wrap">
    ${Le.map((v,$)=>{const x=$===i,k=$===n;return`<button class="button" style="padding:4px 10px;background:${k?"#0F5B8D":x?"#e2e8f0":"transparent"};color:${k?"#fff":"#333"};border:${x&&!k?"2px solid #0F5B8D":"1px solid #cbd5e0"};border-radius:4px;font-size:0.8rem;cursor:pointer" data-action="select-month" data-month="${$}">${v}${x?" ●":""}</button>`}).join("")}
  </div>
      ...
      <table style="width:100%;border-collapse:collapse;font-size:0.8rem">
        <thead>
          <tr>
            ...
            ${Le.map((v,$)=>`<th style="text-align:center;padding:6px 2px;border-bottom:2px solid #e2e8f0;min-width:36px;${$===i?"background:#f0f7ff;":""}">${v.replace("月","")}</th>`).join("")}
          </tr>
        </thead>
        <tbody>
          ${Kc(r,i)}
  ...
  ${Zc(c)}
</div>`}function Kc(e,t){const s=[],n=["year-round","seasonal","year-end"];for(const i of n){const r=e[i];if(r.length!==0){s.push(`<tr><td colspan="14" style="padding:8px 8px 4px;font-weight:600;background:#f7fafc;border-bottom:1px solid #e2e8f0">
      <span class="status-pill" style="background:${Ee[i]}15;color:${Ee[i]};padding:2px 8px;border-radius:9px;font-size:0.75rem">${ua[i]}</span>
    </td></tr>`);for(const c of r){const p=Le.map((u,y)=>{const f=c.peakMonths.includes(y),v=Nn(c,y),$=y===t?"outline:2px solid #0F5B8D;outline-offset:-1px;":"";let x="transparent";f?x=Ee[c.seasonType]:v&&(x=Ee[c.seasonType]+"40");const k=f||v?`background:${x};border-radius:3px;height:18px;width:100%;`:"";return`<td style="padding:2px;text-align:center;${$}"><div style="${k}" title="${f?"ピーク":v?"提案期間":""}"></div></td>`}).join("");s.push(`<tr style="border-bottom:1px solid #f0f0f0">
    ...
    <div class="table-wrap" style="margin-bottom:1rem">
      <h4 style="margin-bottom:0.5rem;display:flex;align-items:center;gap:8px">
        <span class="status-pill" style="background:${Ee[i]}15;color:${Ee[i]}">${ua[i]}</span>
    ...
    </div>`}).filter(Boolean);return n.length===0?`<div style="padding:1rem;color:#666;text-align:center">${Le[t]}に提案対象の商品はありません</div>`:n.join("")}function Zc(e){return!e||e.targetCustomers.length===0?`
  ...
  <div class="table-wrap" style="margin-top:1rem">
    ...
    <tr style="border-bottom:1px solid #f0f0f0">
      ...
      <td class="mono numeric" style="padding:6px 8px">${Uc(s.lastYearAmount)}</td>
  ...
  `).join("")}</tbody>
  ...
  </div>`}const ed=["日","月","火","水","木","金","土"];function td(e){const[t,s]=e.split("-").map(Number),n=new Date(t,s-1,1),i=new Date(t,s,0),r=[];for(let c=0;c<n.getDay();c++)r.push({outside:!0});for(let c=1;c<=i.getDate();c++)r.push({date:`${e}-${String(c).padStart(2,"0")}`});for(;r.length%7!==0;)r.push({outside:!0});return r}function ad(e,t,s){const[n,i]=t.split("-").map(Number),r=new Date(n,i-2,1),c=new Date(n,i,1),p=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`,u=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`,y=new Date().toISOString().slice(0,10),v=td(t).map(o=>{if(o.outside)return'<div class="sc-cell sc-outside"></div>';const l=o.date,d=Number(l.split("-")[2]),m=new Date(`${l}T00:00:00`).getDay(),g=e?.[l],b=l===y,_=l===s;let C="",S="";return g&&(C=`<span class="sc-badge">${g.count}件</span>`,S=g.cityGroups.slice(0,3).map(E=>`<span class="sc-city-tag">${E.city}<em>${E.count}</em></span>`).join(""),g.cityGroups.length>3&&(S+=`<span class="sc-city-more">+${g.cityGroups.length-3}</span>`)),`
    ...
    `}).join(""),$=s&&e?.[s]?sd(e[s]):s?`<div class="sc-detail-empty"><p>📦 ${s.slice(5)} は出荷なし</p></div>`:'<div class="sc-detail-empty"><p>日付を選択すると出荷先一覧が表示されます</p></div>',x=Object.values(e??{}).reduce((o,l)=>o+l.count,0),k=Object.values(e??{}).reduce((o,l)=>o+l.totalAmount,0);return`
      ...
      <div class="sc-body">
        <div class="sc-calendar-col">
          <div class="sc-weekdays">
            ${ed.map((o,l)=>`<div class="sc-weekday ${l===0?"sc-sun":l===6?"sc-sat":""}">${o}</div>`).join("")}
          </div>
          <div class="sc-grid">
  ...
  `}function sd(e){const t=e.date.replace(/-/g,"/").slice(5),s={};for(const i of e.entries)(s[i.city]??=[]).push(i);const n=Object.entries(s).sort((i,r)=>r[1].length-i[1].length).map(([i,r])=>{const c=r.sort((p,u)=>u.amount-p.amount).map(p=>`
    ...
    ${n}
  `}const nd=new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}),Xt=["月","火","水","木","金"],hs=6;function od(e,t){if(!e)return 9999;const s=new Date(e);return isNaN(s.getTime())?9999:Math.floor((t.getTime()-s.getTime())/(1e3*60*60*24))}function id(e,t){if(t.length===0)return 0;const s=[...t].sort((i,r)=>i-r);return s.filter(i=>i<=e).length/s.length}function rd(e,t){return e.includes("離反リスク")?"緊急訪問 - 離反防止ヒアリング":e.includes("季節提案タイミング")?"季節商品の提案・試飲サンプル持参":t>30?"定期巡回 - 状況確認・追加注文確認":"関係維持 - ご挨拶"}function fs(e){const t=new Date,s=e.map(u=>u.annualRevenue),n=e.map(u=>{const y=od(u.lastOrderDate,t);let f=0;const v=[];y>=60&&(f+=50,v.push("離反リスク")),u.hasSeasonalProposal&&(f+=30,v.push("季節提案タイミング")),y>=30&&y<60&&(f+=20,v.push("定期巡回"));const $=id(u.annualRevenue,s),x=Math.round($*20);x>0&&(f+=x,v.push("金額ウェイト"));const k=rd(v,y);return{code:u.code,name:u.name,phone:u.phone,address:u.address1,areaCode:u.areaCode,businessType:u.businessType,priorityScore:f,reasons:v,lastOrderDate:u.lastOrderDate,daysSinceOrder:y,annualRevenue:u.annualRevenue,recommendedAction:k}}).filter(u=>u.priorityScore>0).sort((u,y)=>y.priorityScore-u.priorityScore),i=new Map;for(const u of n){const y=u.areaCode||"その他";i.has(y)||i.set(y,[]),i.get(y).push(u)}const r=[...i.entries()].sort((u,y)=>y[1].reduce((f,v)=>f+v.priorityScore,0)-u[1].reduce((f,v)=>f+v.priorityScore,0)),c=[];let p=0;for(const[u,y]of r){const f=y.sort((v,$)=>$.priorityScore-v.priorityScore);for(let v=0;v<f.length&&!(p>=Xt.length);v+=hs){const $=f.slice(v,v+hs);c.push({dayLabel:Xt[p],area:u,visits:$}),p++}if(p>=Xt.length)break}return{candidates:n,weekPlan:c,filterArea:"",filterMinScore:0}}function ld(e){const{candidates:t,weekPlan:s,filterArea:n,filterMinScore:i}=e,r=t.filter(v=>!(n&&v.areaCode!==n||i>0&&v.priorityScore<i)),c=Array.from(new Set(t.map(v=>v.areaCode))).sort(),p=r.length,u=r.filter(v=>v.priorityScore>=50).length,y=r.filter(v=>v.reasons.includes("離反リスク")).length,f=s.reduce((v,$)=>v+$.visits.length,0);return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      ${s.length===0?"<p>訪問候補がありません。</p>":cd(s)}
    </section>
  ...
  `}function ud(e){const t={empty:"空",in_use:"使用中",aging:"熟成中"},s={empty:"neutral",in_use:"warning",aging:"success"},n=e.map(y=>{const f=y.capacity>0?Math.round(y.currentVolume/y.capacity*100):0;return`
        <tr>
  ...
  `}function Kt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function pd(e,t,s){const n=e.rows.map((y,f)=>`
      <tr>
  ...
  `;const p={id:i,message:e,type:t,el:c};pa.push(p),n.appendChild(c),requestAnimationFrame(()=>{c.classList.add("toast-enter")});const u=()=>fd(p);c.querySelector(".toast-dismiss").addEventListener("click",u),setTimeout(()=>{c.classList.add("toast-exit"),c.addEventListener("animationend",u,{once:!0})},r)}function fd(e){const t=pa.indexOf(e);t!==-1&&(pa.splice(t,1),e.el.remove())}function vd(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function fe(e,t={}){const{title:s="確認",confirmLabel:n="OK",cancelLabel:i="キャンセル",variant:r="primary"}=t;return new Promise(c=>{const p=document.createElement("div");p.className="modal-backdrop confirm-backdrop",p.setAttribute("role","dialog"),p.setAttribute("aria-modal","true"),p.innerHTML=`
    ...
    `;const u=f=>{p.classList.add("confirm-exit"),p.addEventListener("animationend",()=>{p.remove()},{once:!0}),c(f)};p.querySelector(".confirm-cancel").addEventListener("click",()=>u(!1)),p.querySelector(".confirm-ok").addEventListener("click",()=>u(!0)),p.addEventListener("click",f=>{f.target===p&&u(!1)});const y=f=>{f.key==="Escape"&&(document.removeEventListener("keydown",y),u(!1))};document.addEventListener("keydown",y),document.body.appendChild(p),requestAnimationFrame(()=>{p.querySelector(".confirm-ok")?.focus()})})}const gd=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
...
</svg>`,bd=`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
  <circle cx="14" cy="14" r="13" stroke="currentColor" stroke-width="1.5"/>
...
`)}`,c=new Blob([r],{type:"text/csv;charset=utf-8;"}),p=URL.createObjectURL(c),u=document.createElement("a");u.href=p,u.download=e,document.body.append(u),u.click(),u.remove(),window.setTimeout(()=>URL.revokeObjectURL(p),0)}const $d=Object.fromEntries(Ot.map(e=>[e.value,e.label])),_d=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/customer-analysis","/invoice-entry","/quote","/quote-settings","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print","/form-designer","/map","/workflow","/mobile-order","/tour","/mail-senders","/calendar","/integrations","/shopify","/fax","/users","/profile","/audit","/prospects","/slack","/calls","/list-builder","/raw-browser","/demand-forecast","/churn-alert","/seasonal-calendar","/visit-planner","/demand","/shipment-calendar","/brewing-plan"];let Qe=[];async function wd(){const{supabaseQueryAll:e}=await A(async()=>{const{supabaseQueryAll:s}=await Promise.resolve().then(()=>U);return{supabaseQueryAll:s}},void 0);Qe=(await e("customers",{select:"name,email,delivery_area_code",email:"neq.",is_active:"eq.true"})).filter(s=>typeof s.email=="string"&&s.email.length>0).map(s=>({name:String(s.name??""),email:String(s.email??""),area:String(s.delivery_area_code??""),historySegment:"seasonal"}))}const gs=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/customer-analysis",title:"得意先分析"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"},{path:"/form-designer",title:"帳票デザイナー"},{path:"/map",title:"取引先マップ"},{path:"/workflow",title:"受注ワークフロー"},{path:"/mobile-order",title:"モバイル受注"},{path:"/tour",title:"酒蔵見学"},{path:"/mail-senders",title:"メール送信元管理"},{path:"/calendar",title:"カレンダー"},{path:"/integrations",title:"外部連携設定"},{path:"/shopify",title:"Shopify注文"},{path:"/fax",title:"FAX OCR"},{path:"/users",title:"ユーザー管理"},{path:"/profile",title:"プロフィール"},{path:"/audit",title:"操作ログ"},{path:"/prospects",title:"新規営業"},{path:"/slack",title:"Slack通知"},{path:"/calls",title:"通話履歴(IVRy)"},{path:"/list-builder",title:"リスト取得ツール"},{path:"/raw-browser",title:"データブラウザ"},{path:"/churn-alert",title:"離反アラート・休眠顧客"},{path:"/seasonal-calendar",title:"季節提案カレンダー"},{path:"/visit-planner",title:"訪問計画・ルート最適化"},{path:"/demand",title:"需要分析・安全在庫・生産計画"},{path:"/shipment-calendar",title:"出荷カレンダー"},{path:"/brewing-plan",title:"醸造計画"}];function Mn(e){const t=ba[e];return t?{subject:t.subject,body:t.body}:{subject:"",body:""}}function Ma(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function xd(){const e=Mn("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:e.subject,body:e.body,saveMessage:null}}const jt=new Date,Sd=jt.toISOString().slice(0,7),kd=jt.getFullYear(),Pd=jt.getMonth()+1,Cd=jt.toISOString().slice(0,10),Ed="C0011",Ne=xd();function On(e){const t="/".endsWith("/")?"/".slice(0,-1):"/",s=e.startsWith(t)?e.slice(t.length)||"/":e;return _d.includes(s)?s:"/"}function Oa(e){switch(e){case"/invoice-entry":case"/quote":case"/quote-settings":case"/delivery":case"/billing":case"/invoice":case"/ledger":case"/shipment-calendar":return"sales";case"/analytics":case"/customer-analysis":case"/product-power":case"/customer-efficiency":case"/report":return"analytics";case"/prospects":case"/map":case"/list-builder":case"/calls":case"/email":case"/mail-senders":case"/workflow":case"/mobile-order":case"/shopify":case"/fax":case"/churn-alert":case"/seasonal-calendar":case"/visit-planner":return"crm";case"/purchase":case"/raw-material":return"orders";case"/jikomi":case"/tanks":case"/kentei":case"/materials":case"/tax":case"/demand":case"/brewing-plan":return"brewery";case"/master":case"/calendar":case"/store":case"/tour":case"/print":case"/form-designer":return"master";case"/setup":case"/integrations":case"/slack":case"/import":case"/raw-browser":case"/users":case"/profile":case"/audit":return"settings";default:return"dashboard"}}const bs=On(location.pathname),a={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,syncDashboard:null,rawTableList:[],rawRecords:[],rawSelectedTable:null,rawPage:1,rawTotalCount:0,invoiceRecords:[],customerLedger:null,salesAnalytics:null,customerAnalysis:null,productABC:null,invoiceForm:Ma(),invoiceSaving:!1,invoiceSavedDocNo:null,invoicePriceGroup:"",pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:Sd,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:kd,taxMonth:Pd,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,fdDesignMode:!0,fdSavedPositions:null,fdActiveFieldId:null,mapRegionFilter:"",workflowOrders:[],mobileOrder:{step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},tourInquiries:[],tourActiveId:null,mailSenders:[],mailSenderEditingId:null,emailSenderId:"default",calendarEvents:[],calendarYearMonth:new Date().toISOString().slice(0,7),calendarFilterCategory:"",calendarEdit:null,integrations:[],integrationEditingId:null,shopifyOrders:[],faxRecords:[],faxProcessing:!1,faxOcrText:null,userProfiles:[],userEditingId:null,myProfile:null,auditLogs:[],prospects:[],prospectActivities:[],prospectEditingId:null,prospectViewMode:"kanban",slackRules:[],slackLogs:[],materialEditing:null,materialEditingIsNew:!1,deliveryLocations:[],mapCustomers:[],callLogs:[],mapFilters:{filterStatus:"all",filterArea:"",filterBiz:""},leadLists:[],leadItems:[],leadActiveListId:null,leadSearchQuery:"",leadSearchArea:"",leadSearchType:"",leadSearching:!1,leadSearchResults:[],printTemplate:"chain_store",printOptions:{...pc,overlayImageUrl:`${"/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...mc},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:Cd,route:bs,currentCategory:Oa(bs),sidebarOpen:!1,announcements:[],dismissedAnnouncements:new Set,updateAvailable:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:Ed,salesPeriod:"month",customRange:{start:"",end:""},quoteState:qa(na()),quoteCustomerQuery:"",quoteProductQuery:"",quotePricing:null,quoteList:[],quoteListLoading:!1,quoteEditId:null,quoteCompanySettings:na(),productPower:[],productFilter:"all",productPeriod:"year",productDaily:[],productCustomStart:"",productCustomEnd:"",productSortState:[],customerSortState:[],dashboardSortState:[],masterSortState:[],analyticsSortState:[],customerEfficiency:[],masterTab:"customers",masterFilter:{...Ia},analyticsTab:"products",analyticsPeriod:"all",analyticsPeriodFilter:"",analyticsPeriodRows:[],analyticsPeriodChartData:[],analyticsPrevYearChartData:[],analyticsChartMetric:"amount",analyticsFiscalMode:"calendar",analyticsPeriodOptions:[],analyticsStaffFilter:"",analyticsTagFilter:"",analyticsStaffPeriod:"all",analyticsStaffPeriodFilter:"",analyticsStaffPeriodOptions:[],analyticsStaffTotals:[],analyticsStaffDrilldown:null,analyticsDrilldown:null,emailAudienceMode:Ne.mode,emailRegion:Ne.region,emailHistorySegment:Ne.historySegment,emailTemplateId:Ne.templateId,emailSubject:Ne.subject,emailBody:Ne.body,emailSaveMessage:Ne.saveMessage,emailSending:!1,demandForecast:{...rr},shipmentCalendarData:null,shipmentCalendarYearMonth:new Date().toISOString().slice(0,7),shipmentCalendarSelectedDate:null,churnAlert:null,churnNotes:[],seasonalCalendar:null,visitPlanner:null,demandAnalysis:null,safetyStockParams:[],productionPlan:[],demandTab:"demand",demandPlanYearMonth:new Date().toISOString().slice(0,7),demandYearsBack:3,demandPlanTypeFilter:"monthly",brewingPlanData:[],brewingMonthlyTrend:[],brewingPlanFY:(()=>{const e=new Date;return e.getMonth()>=9?e.getFullYear():e.getFullYear()-1})(),demandSort:null,calendarShifts:Et(new Date().toISOString().slice(0,7),1,0),calendarDefaultPart:1,calendarDefaultEmp:0,calendarSelectedDate:null,calendarLabelExcluded:new Set,brewingSchedule:[],brewingProductDetail:[],brewingExcludedProducts:new Set,brewingCustomCategories:[],brewingOverrides:{},globalSearchOpen:!1,globalQuery:"",orderHeaders:[],authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function $s(e){return e.slice(0,10)}function Ad(e){return{...e}}function It(){a.pickerMode=null,a.pickerQuery="",a.pickerTargetLine=null}function Rn(){a.invoiceForm=Ma(),a.invoiceSavedDocNo=null,a.invoicePriceGroup="",a.invoiceErrors={},It()}function jn(e){const t={};return e.invoiceDate.trim()||(t.invoiceDate="伝票日付は必須です。"),e.customerCode.trim()||(t.customerCode="得意先コードは必須です。"),e.lines.length===0&&(t.lines="明細を1行以上入力してください。"),e.lines.forEach((s,n)=>{s.productCode.trim()||(t[`lines.${n}.productCode`]="商品コードは必須です。"),s.productName.trim()||(t[`lines.${n}.productName`]="商品名は必須です。"),s.quantity<=0&&(t[`lines.${n}.quantity`]="数量は1以上を入力してください。"),s.unitPrice<0&&(t[`lines.${n}.unitPrice`]="単価は0円以上で入力してください。")}),t}function Ld(e){const t=a.invoiceForm.lines[e];t&&a.invoiceForm.lines.splice(e+1,0,Ad(t))}function Dd(){const e=a.invoiceRecords[0],t=a.masterStats?.customers[0],s=a.masterStats?.products.slice(0,2)??[];a.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:e?.customerCode??t?.code??"",customerName:e?.customerName??t?.name??"",staffCode:a.invoiceForm.staffCode||"S001",lines:s.map((n,i)=>{const r=i===0?1:2,c=1200*(i+1);return{productCode:n.code,productName:n.name,quantity:r,unitPrice:c,unit:"本",amount:r*c}}),note:e?`過去伝票 ${e.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},a.invoiceSavedDocNo=null,a.invoiceErrors={}}function qd(e){const t=a.masterStats?.customers.find(s=>s.code.toLowerCase()===e.trim().toLowerCase());return t?(a.invoiceForm.customerCode=t.code,a.invoiceForm.customerName=t.name,a.invoicePriceGroup=t.priceGroup||"",!0):!1}function Id(e){const t=a.masterStats?.customers.find(s=>s.name===e.trim());return t?(a.invoiceForm.customerCode=t.code,a.invoiceForm.customerName=t.name,a.invoicePriceGroup=t.priceGroup||"",!0):!1}function Fn(e){if(Se(e),a.invoiceErrors=jn(a.invoiceForm),Object.keys(a.invoiceErrors).length>0){w();return}a.invoiceSaving=!0,w(),Ns(a.invoiceForm).then(t=>{a.invoiceSavedDocNo=t.documentNo,a.invoiceSaving=!1,a.invoiceErrors={},a.invoiceForm=Ma(),w()}).catch(()=>{a.invoiceSaving=!1,w()})}function zn(e){const t=a.salesFilter.startDate?new Date(a.salesFilter.startDate):null,s=a.salesFilter.endDate?new Date(`${a.salesFilter.endDate}T23:59:59`):null;return[...e.salesRecords].sort((n,i)=>new Date(i.date).getTime()-new Date(n.date).getTime()).filter(n=>{const i=new Date(n.date);return!(t&&i<t||s&&i>s)})}function Bn(){switch(a.emailAudienceMode){case"area":return a.emailRegion==="all"?Qe:Qe.filter(e=>e.area===a.emailRegion);case"history":return Qe.filter(e=>e.historySegment===a.emailHistorySegment);default:return Qe}}function Td(){const e=Bn();return{audienceMode:a.emailAudienceMode,region:a.emailRegion,historySegment:a.emailHistorySegment,selectedTemplateId:a.emailTemplateId,subject:a.emailSubject,body:a.emailBody,recipientCount:e.length,previewRecipients:e.slice(0,5),saveMessage:a.emailSaveMessage,sending:a.emailSending,senderId:a.emailSenderId,senders:a.mailSenders}}function Wt(e){const t=Bn(),s=a.emailAudienceMode==="area"?a.emailRegion:a.emailAudienceMode==="history"?a.emailHistorySegment:"all";return{subject:a.emailSubject.trim(),body:a.emailBody.trim(),templateId:a.emailTemplateId,audienceMode:a.emailAudienceMode,audienceFilter:s,recipientCount:t.length,recipients:t.map(n=>n.email),status:e}}function Ra(){return a.user,!1}function dt(){a.globalSearchOpen=!1,a.globalQuery=""}function Nd(){const e=a.globalQuery.trim().toLowerCase();return e?{customers:a.masterStats?.customers.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],products:a.masterStats?.products.filter(t=>t.code.toLowerCase().includes(e)||t.name.toLowerCase().includes(e))??[],documents:a.invoiceRecords.filter(t=>t.documentNo.toLowerCase().includes(e)||t.customerName.toLowerCase().includes(e)||t.date.toLowerCase().includes(e)),pages:gs.filter(t=>t.path.toLowerCase().includes(e)||t.title.toLowerCase().includes(e))}:{customers:[],products:[],documents:[],pages:gs}}function Md(){let e=[],t,s="export.csv";switch(a.route){case"/sales":e=(a.salesSummary?zn(a.salesSummary):[]).map(n=>({documentNo:n.documentNo,date:n.date,customerCode:n.customerCode,customerName:n.customerName,amount:n.amount})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],s="sales.csv";break;case"/payment":e=[...a.paymentStatus?.records??[]].sort((n,i)=>i.balanceAmount-n.balanceAmount).map(n=>({...n})),t=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],s="payment-status.csv";break;case"/invoice":e=a.invoiceRecords.map(n=>({...n})),t=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],s="invoices.csv";break;case"/purchase":e=a.purchaseList.map(n=>({...n})),t=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],s="purchase.csv";break;case"/jikomi":e=a.jikomiList.map(n=>({...n})),t=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],s="jikomi.csv";break;case"/tanks":e=a.tankList.map(n=>({...n})),t=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],s="tanks.csv";break;case"/kentei":e=a.kenteiList.map(n=>({...n})),t=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],s="kentei.csv";break;case"/materials":e=a.materialList.map(n=>({...n})),t=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],s="materials.csv";break;case"/master":a.masterTab==="customers"?(e=a.masterStats?.customers.map(n=>({...n}))??[],t=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],s="master-customers.csv"):(e=a.masterStats?.products.map(n=>({...n}))??[],t=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],s="master-products.csv");break;default:return}ma(s,e,t)}function _s(e){const t=`${"/".replace(/\/$/,"")}${e==="/"?"/":e}`;history.pushState(null,"",t),a.route=e,a.currentCategory=Oa(e),a.sidebarOpen=!1,dt(),ja(e)}async function ja(e){a.actionLoading=!0,w();try{switch(e){case"/quote":a.quoteEditId===null&&a.quoteList.length===0&&(a.quoteListLoading=!0,w(),a.quoteList=await Da(),a.quoteListLoading=!1);break;case"/invoice":a.invoiceRecords.length===0&&(a.invoiceRecords=await ct(a.invoiceFilter));break;case"/analytics":(!a.salesAnalytics||a.salesAnalytics.monthlySales.length===0)&&(a.salesAnalytics=await wa());break;case"/delivery":a.deliveryNote||(a.deliveryNote=await xa(a.deliverySearchDocNo));break;case"/shipment-calendar":{const{fetchShipmentCalendar:t}=await A(async()=>{const{fetchShipmentCalendar:s}=await Promise.resolve().then(()=>T);return{fetchShipmentCalendar:s}},void 0);a.shipmentCalendarData=await t(a.shipmentCalendarYearMonth);break}case"/billing":a.billingSummary||(a.billingSummary=await Sa(a.billingYearMonth));break;case"/report":a.salesReport||(a.salesReport=await Nt());break;case"/product-power":a.productPower.length===0&&(a.productPower=await Fs());break;case"/customer-efficiency":a.customerEfficiency.length===0&&(a.customerEfficiency=await zs());break;case"/customer-analysis":a.customerAnalysis||(a.customerAnalysis=await Bs());break;case"/demand-forecast":if(a.demandForecast.forecasts.length===0){const{fetchDemandForecasts:t,fetchDeliverySchedule:s}=await A(async()=>{const{fetchDemandForecasts:r,fetchDeliverySchedule:c}=await Promise.resolve().then(()=>T);return{fetchDemandForecasts:r,fetchDeliverySchedule:c}},void 0),[n,i]=await Promise.all([t(),s()]);a.demandForecast.forecasts=n.map(r=>({code:r.productCode,name:r.productName,segment:r.segment,monthlyQuantity:new Array(12).fill(0),avgMonthly:Math.round(r.avgMonthly),adjustedAvg:Math.round(r.avgMonthly),nextMonthForecast:Math.round(r.forecastQuantity),annualForecast:Math.round(r.avgMonthly*12),safetyStock:Math.round(r.safetyStock)})),a.demandForecast.deliveries=lr(i)}break;case"/churn-alert":{const{fetchChurnAlerts:t,fetchChurnNotes:s}=await A(async()=>{const{fetchChurnAlerts:n,fetchChurnNotes:i}=await Promise.resolve().then(()=>T);return{fetchChurnAlerts:n,fetchChurnNotes:i}},void 0);if(!a.churnAlert){const n=await t();a.churnAlert=Bc(n)}a.churnNotes=await s();break}case"/seasonal-calendar":if(!a.seasonalCalendar){const{fetchProductShipmentsFromTable:t}=await A(async()=>{const{fetchProductShipmentsFromTable:n}=await Promise.resolve().then(()=>T);return{fetchProductShipmentsFromTable:n}},void 0),s=await t();if(s.length>0)a.seasonalCalendar=ys(s.map(n=>({code:n.code,name:n.name,category:"",monthlyQuantity:n.monthlyQuantity})));else{const{fetchProductMonthlyShipments:n}=await A(async()=>{const{fetchProductMonthlyShipments:r}=await Promise.resolve().then(()=>T);return{fetchProductMonthlyShipments:r}},void 0),i=await n();a.seasonalCalendar=ys(i.map(r=>({code:r.code,name:r.name,category:"",monthlyQuantity:r.monthlyQuantity})))}}break;case"/visit-planner":if(!a.visitPlanner){const{fetchVisitPriorities:t}=await A(async()=>{const{fetchVisitPriorities:n}=await Promise.resolve().then(()=>T);return{fetchVisitPriorities:n}},void 0),s=await t();if(s.length>0)a.visitPlanner={candidates:s.map(n=>({code:n.customer_code,name:n.customer_name,phone:n.phone,address:n.address,areaCode:n.area_code,businessType:n.business_type,priorityScore:n.priority_score,reasons:n.reasons,lastOrderDate:n.last_order_date,daysSinceOrder:n.days_since_order,annualRevenue:n.annual_revenue,recommendedAction:n.recommended_action})),weekPlan:[],filterArea:"",filterMinScore:0},a.visitPlanner=fs(s.map(n=>({code:n.customer_code,name:n.customer_name,phone:n.phone,address1:n.address,areaCode:n.area_code,businessType:n.business_type,annualRevenue:n.annual_revenue,lastOrderDate:n.last_order_date,hasSeasonalProposal:n.reasons.some(i=>i.includes("季節"))})));else{const{supabaseQueryAll:n}=await A(async()=>{const{supabaseQueryAll:u}=await Promise.resolve().then(()=>U);return{supabaseQueryAll:u}},void 0),[i,r]=await Promise.all([n("sales_document_headers",{select:"sales_date,legacy_customer_code,total_amount"}),a.masterStats?Promise.resolve(a.masterStats.customers):$a().then(u=>u.customers)]),c=a.masterStats?.customers??r,p=new Map;i.forEach(u=>{const y=u.legacy_customer_code||"",f=u.sales_date||"",v=Number(u.total_amount)||0,$=p.get(y);!$||f>$.lastDate?p.set(y,{lastDate:f,total:($?.total??0)+v}):$.total+=v}),a.visitPlanner=fs(c.filter(u=>u.isActive).map(u=>({code:u.code,name:u.name,phone:u.phone,address1:u.address1,areaCode:u.areaCode,businessType:u.businessType,annualRevenue:p.get(u.code)?.total??0,lastOrderDate:p.get(u.code)?.lastDate??"",hasSeasonalProposal:!1})))}}break;case"/demand":{const{fetchDemandAnalysis:t,fetchSafetyStockParams:s,fetchProductionPlan:n,fetchLabelExclusions:i}=await A(async()=>{const{fetchDemandAnalysis:c,fetchSafetyStockParams:p,fetchProductionPlan:u,fetchLabelExclusions:y}=await Promise.resolve().then(()=>T);return{fetchDemandAnalysis:c,fetchSafetyStockParams:p,fetchProductionPlan:u,fetchLabelExclusions:y}},void 0);if(!a.demandAnalysis){const[c,p]=await Promise.all([t(a.demandYearsBack*12),s()]);a.demandAnalysis=c,a.safetyStockParams=p}if(a.productionPlan.length===0){const c=await n(a.demandPlanYearMonth);c.length>0?a.productionPlan=c:a.demandAnalysis&&a.safetyStockParams.length>0&&(a.productionPlan=buildPlanFromAnalysis(a.demandPlanYearMonth))}const r=await i(a.demandPlanYearMonth);if(a.calendarLabelExcluded=new Set(r),a.productionPlan.length>0){const c=a.productionPlan.filter(p=>!a.calendarLabelExcluded.has(p.productCode));Ce(a.calendarShifts,c)}break}case"/brewing-plan":{const{fetchBrewingPlanSummary:t,fetchBrewingMonthlyTrend:s,fetchBrewingSchedule:n,fetchBrewingProductDetail:i,fetchBrewingCustomCategories:r,fetchBrewingCategoryOverrides:c}=await A(async()=>{const{fetchBrewingPlanSummary:l,fetchBrewingMonthlyTrend:d,fetchBrewingSchedule:m,fetchBrewingProductDetail:g,fetchBrewingCustomCategories:b,fetchBrewingCategoryOverrides:_}=await Promise.resolve().then(()=>T);return{fetchBrewingPlanSummary:l,fetchBrewingMonthlyTrend:d,fetchBrewingSchedule:m,fetchBrewingProductDetail:g,fetchBrewingCustomCategories:b,fetchBrewingCategoryOverrides:_}},void 0),p=a.brewingPlanFY,u=`${p}-10-01`,y=`${p+1}-09-30`,[f,v,$,x,k,o]=await Promise.all([t(u,y),s(u,y),n(p),i(u,y),r(),c()]);a.brewingPlanData=f,a.brewingMonthlyTrend=v,a.brewingSchedule=$,a.brewingProductDetail=x,a.brewingCustomCategories=k,a.brewingOverrides=o;break}case"/jikomi":a.jikomiList.length===0&&(a.jikomiList=await Js());break;case"/tanks":a.tankList.length===0&&(a.tankList=await Ys());break;case"/kentei":a.kenteiList.length===0&&(a.kenteiList=await Us());break;case"/materials":a.materialList.length===0&&(a.materialList=await ta());break;case"/purchase":(a.purchaseList.length===0||a.payableList.length===0)&&([a.purchaseList,a.payableList]=await Promise.all([Qs(),Hs()]));break;case"/raw-material":(a.billList.length===0||a.rawStockList.length===0)&&([a.billList,a.rawStockList]=await Promise.all([Gs(),Xs()]));break;case"/tax":a.taxDeclaration||(a.taxDeclaration=await Pa(a.taxYear,a.taxMonth));break;case"/store":(a.storeSales.length===0||a.storeOrders.length===0)&&([a.storeSales,a.storeOrders]=await Promise.all([Ca(a.storeSalesDate),Zs()]));break;case"/mail-senders":case"/email":{const{fetchMailSenders:t}=await A(async()=>{const{fetchMailSenders:s}=await Promise.resolve().then(()=>T);return{fetchMailSenders:s}},void 0);if(a.mailSenders=await t(),!a.emailSenderId||!a.mailSenders.find(s=>s.id===a.emailSenderId)){const s=a.mailSenders.find(n=>n.isDefault)??a.mailSenders[0];s&&(a.emailSenderId=s.id)}}break;case"/calendar":{const{fetchCalendarEvents:t}=await A(async()=>{const{fetchCalendarEvents:s}=await Promise.resolve().then(()=>T);return{fetchCalendarEvents:s}},void 0);a.calendarEvents=await t(a.calendarYearMonth)}break;case"/integrations":{const{fetchIntegrationSettings:t}=await A(async()=>{const{fetchIntegrationSettings:s}=await Promise.resolve().then(()=>T);return{fetchIntegrationSettings:s}},void 0);a.integrations=await t()}break;case"/shopify":{const{fetchShopifyOrders:t,fetchIntegrationSettings:s}=await A(async()=>{const{fetchShopifyOrders:n,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>T);return{fetchShopifyOrders:n,fetchIntegrationSettings:i}},void 0);a.shopifyOrders=await t(),a.integrations.length===0&&(a.integrations=await s())}break;case"/fax":{const{fetchFaxInbox:t,fetchIntegrationSettings:s}=await A(async()=>{const{fetchFaxInbox:n,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>T);return{fetchFaxInbox:n,fetchIntegrationSettings:i}},void 0);a.faxRecords=await t(),a.integrations.length===0&&(a.integrations=await s())}break;case"/users":{const{fetchUserProfiles:t}=await A(async()=>{const{fetchUserProfiles:s}=await Promise.resolve().then(()=>T);return{fetchUserProfiles:s}},void 0);a.userProfiles=await t()}break;case"/profile":{const{fetchMyProfile:t,fetchAuditLogs:s,fetchMailSenders:n}=await A(async()=>{const{fetchMyProfile:r,fetchAuditLogs:c,fetchMailSenders:p}=await Promise.resolve().then(()=>T);return{fetchMyProfile:r,fetchAuditLogs:c,fetchMailSenders:p}},void 0),i=a.user?.email??a.myProfile?.email??"";i&&(a.myProfile=await t(i)),a.mailSenders.length===0&&(a.mailSenders=await n()),a.auditLogs=await s(50)}break;case"/audit":{const{fetchAuditLogs:t}=await A(async()=>{const{fetchAuditLogs:s}=await Promise.resolve().then(()=>T);return{fetchAuditLogs:s}},void 0);a.auditLogs=await t(200)}break;case"/prospects":{const{fetchProspects:t}=await A(async()=>{const{fetchProspects:s}=await Promise.resolve().then(()=>T);return{fetchProspects:s}},void 0);a.prospects=await t()}break;case"/map":{const{fetchMapCustomers:t,fetchDeliveryLocations:s}=await A(async()=>{const{fetchMapCustomers:r,fetchDeliveryLocations:c}=await Promise.resolve().then(()=>T);return{fetchMapCustomers:r,fetchDeliveryLocations:c}},void 0),[n,i]=await Promise.all([t(),s()]);a.mapCustomers=n,a.deliveryLocations=i}break;case"/calls":{const{fetchCallLogs:t,fetchIntegrationSettings:s}=await A(async()=>{const{fetchCallLogs:n,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>T);return{fetchCallLogs:n,fetchIntegrationSettings:i}},void 0);a.callLogs=await t(100),a.integrations.length===0&&(a.integrations=await s())}break;case"/list-builder":{const{fetchLeadLists:t,fetchIntegrationSettings:s}=await A(async()=>{const{fetchLeadLists:n,fetchIntegrationSettings:i}=await Promise.resolve().then(()=>T);return{fetchLeadLists:n,fetchIntegrationSettings:i}},void 0);a.leadLists=await t(),a.integrations.length===0&&(a.integrations=await s())}break;case"/workflow":{const{fetchWorkflowOrdersFromDb:t}=await A(async()=>{const{fetchWorkflowOrdersFromDb:s}=await Promise.resolve().then(()=>T);return{fetchWorkflowOrdersFromDb:s}},void 0);a.workflowOrders=await t()}break;case"/tour":{const{fetchTourInquiriesFromDb:t}=await A(async()=>{const{fetchTourInquiriesFromDb:s}=await Promise.resolve().then(()=>T);return{fetchTourInquiriesFromDb:s}},void 0);a.tourInquiries=await t()}break;case"/slack":{const{fetchSlackRules:t,fetchSlackLogs:s,fetchIntegrationSettings:n}=await A(async()=>{const{fetchSlackRules:i,fetchSlackLogs:r,fetchIntegrationSettings:c}=await Promise.resolve().then(()=>T);return{fetchSlackRules:i,fetchSlackLogs:r,fetchIntegrationSettings:c}},void 0);a.slackRules=await t(),a.slackLogs=await s(50),a.integrations.length===0&&(a.integrations=await n())}break;case"/":{const{fetchProspects:t,fetchCalendarEvents:s,fetchWorkflowOrdersFromDb:n,fetchTourInquiriesFromDb:i,fetchOrderHeaders:r}=await A(async()=>{const{fetchProspects:c,fetchCalendarEvents:p,fetchWorkflowOrdersFromDb:u,fetchTourInquiriesFromDb:y,fetchOrderHeaders:f}=await Promise.resolve().then(()=>T);return{fetchProspects:c,fetchCalendarEvents:p,fetchWorkflowOrdersFromDb:u,fetchTourInquiriesFromDb:y,fetchOrderHeaders:f}},void 0);a.prospects.length===0&&(a.prospects=await t()),a.calendarEvents.length===0&&(a.calendarEvents=await s(a.calendarYearMonth)),a.materialList.length===0&&(a.materialList=await ta()),a.workflowOrders.length===0&&(a.workflowOrders=await n()),a.tourInquiries.length===0&&(a.tourInquiries=await i()),a.orderHeaders.length===0&&(a.orderHeaders=await r())}break;default:break}}catch(t){console.error("Route data load error:",e,t),D(`データ読み込みエラー: ${t.message??"不明"}`,"error")}finally{a.actionLoading=!1,w()}}function ws(){if(Ra())return Zr(a.authError,a.authSubmitting);if(a.loading)return`
    ...
    `;switch(a.route){case"/cat/sales":return yt("sales");case"/cat/brewery":return yt("brewery");case"/cat/purchase":return yt("purchase");case"/cat/more":return yt("more");case"/invoice-entry":return kr(a.invoiceForm,a.invoiceSavedDocNo,a.invoiceSaving,a.invoiceErrors);case"/quote":return a.quoteEditId===null?Dr(a.quoteList,a.quoteListLoading):$n(a.quoteState,a.masterStats?.customers??[],a.masterStats?.products??[],a.quoteCustomerQuery,a.quoteProductQuery,a.quotePricing,a.quoteCompanySettings);case"/quote-settings":return Ir(a.quoteCompanySettings);case"/email":return _r(Td());case"/delivery":return a.deliveryNote?br(a.deliveryNote,a.deliverySearchDocNo):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/shipment-calendar":return ad(a.shipmentCalendarData,a.shipmentCalendarYearMonth,a.shipmentCalendarSelectedDate);case"/billing":return a.billingSummary?er(a.billingSummary,a.billingYearMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/report":return a.salesReport?Dl(a.salesReport):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/product-power":return zr(a.productPower,a.productFilter,a.productDaily,a.productPeriod,a.productCustomStart,a.productCustomEnd,a.productSortState);case"/customer-efficiency":return Br(a.customerEfficiency,a.customerSortState);case"/customer-analysis":return a.customerAnalysis?wl(a.customerAnalysis):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/demand-forecast":return pr(a.demandForecast);case"/demand":return Ic(a.demandAnalysis,a.safetyStockParams,a.productionPlan,a.demandTab,a.demandPlanYearMonth,a.demandYearsBack,a.demandPlanTypeFilter,a.demandSort,a.calendarShifts,a.calendarSelectedDate,a.calendarLabelExcluded);case"/brewing-plan":return Fc(a.brewingPlanData,a.brewingMonthlyTrend,a.brewingPlanFY,a.brewingProductDetail,a.brewingExcludedProducts,a.brewingCustomCategories,a.brewingOverrides);case"/churn-alert":return a.churnAlert?Yc(a.churnAlert,a.churnNotes):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">離反データを分析中…</p></div></section>';case"/seasonal-calendar":return a.seasonalCalendar?Xc(a.seasonalCalendar):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">季節データを分析中…</p></div></section>';case"/visit-planner":return a.visitPlanner?ld(a.visitPlanner):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">訪問計画を生成中…</p></div></section>';case"/jikomi":return a.jikomiView==="calendar"?`${Za(a.jikomiList,a.jikomiView)}${Xr(a.jikomiList)}`:Za(a.jikomiList,a.jikomiView);case"/tanks":return ud(a.tankList);case"/kentei":return Kr(a.kenteiList);case"/materials":return cl(a.materialList)+ll(a.materialEditing,a.materialEditingIsNew);case"/purchase":return yl(a.purchaseList,a.payableList);case"/raw-material":return hl(a.billList,a.rawStockList);case"/tax":return a.taxDeclaration?pd(a.taxDeclaration,a.taxYear,a.taxMonth):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/store":return Nl(a.storeSales,a.storeOrders,a.storeTab,a.storeSalesDate);case"/setup":return a.pipelineMeta?gl(a.pipelineMeta,re,H,a.syncDashboard):'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます…</p></div></section>';case"/raw-browser":return wc(a.rawSelectedTable,a.rawRecords,a.rawTableList,a.rawPage,a.rawTotalCount);case"/import":return Ol(a.importEntity,a.importPreview,a.importing,a.importResult);case"/print":return vc(a.printTemplate,a.printOptions,a.printCompany,a.printData);case"/form-designer":return jl(a.printData,a.printCompany,a.printOptions,a.fdSavedPositions,a.fdDesignMode);case"/map":return a.mapCustomers.length===0?'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">マップデータを読み込み中…</p></div></section>':Fl(a.mapCustomers,a.deliveryLocations,a.mapFilters);case"/workflow":return Vl(a.workflowOrders);case"/mobile-order":return Jl(a.mobileOrder,a.masterStats?.customers??[],a.masterStats?.products??[]);case"/tour":return Ul(a.tourInquiries,a.tourActiveId);case"/mail-senders":return Gl(a.mailSenders,a.mailSenderEditingId);case"/calendar":return Xl(a.calendarEvents,a.calendarYearMonth,a.calendarFilterCategory,a.calendarEdit);case"/integrations":return Wl(a.integrations,a.integrationEditingId);case"/shopify":{const e=a.integrations.find(t=>t.id==="shopify");return Zl(a.shopifyOrders,e?.lastSyncAt??null)}case"/fax":return ec(a.faxRecords,a.faxProcessing,a.faxOcrText);case"/users":return tc(a.userProfiles,a.userEditingId,a.myProfile);case"/profile":return ac(a.myProfile,a.auditLogs.filter(e=>e.userEmail===a.myProfile?.email),a.mailSenders);case"/audit":return sc(a.auditLogs);case"/prospects":{const e={prospects:a.prospects,activities:a.prospectActivities,editingId:a.prospectEditingId,viewMode:a.prospectViewMode};return nc(e)}case"/slack":{const e=a.integrations.find(t=>t.provider==="slack")??null;return lc(e,a.slackRules,a.slackLogs)}case"/calls":{const e=a.integrations.find(t=>t.provider==="ivry");return cc(a.callLogs,a.masterStats?.customers??[],e?.lastSyncAt??null,e?.isEnabled??!1)}case"/list-builder":{const e={lists:a.leadLists,activeListId:a.leadActiveListId,items:a.leadItems,searchQuery:a.leadSearchQuery,searchArea:a.leadSearchArea,searchBusinessType:a.leadSearchType,searching:a.leadSearching,searchResults:a.leadSearchResults};return uc(e)}}if(!a.salesSummary||!a.paymentStatus||!a.masterStats||!a.pipelineMeta||!a.customerLedger||!a.salesAnalytics)return"";switch(a.route){case"/sales":return Tl(zn(a.salesSummary),a.salesFilter.startDate,a.salesFilter.endDate);case"/payment":return pl([...a.paymentStatus.records].sort((e,t)=>t.balanceAmount-e.balanceAmount));case"/master":return rl(a.masterStats,a.masterTab,a.masterFilter,a.masterSortState);case"/invoice":return Yr(a.invoiceRecords,a.invoiceFilter);case"/ledger":return or(a.customerLedger,a.ledgerCustomerCode);case"/analytics":return Pn(a.salesAnalytics,a.analyticsTab,a.analyticsPeriod,a.analyticsPeriodFilter,a.analyticsPeriodRows,a.analyticsPeriodOptions,a.analyticsStaffFilter,a.analyticsTagFilter,a.analyticsStaffDrilldown,a.analyticsStaffPeriod,a.analyticsStaffPeriodFilter,a.analyticsStaffPeriodOptions,a.analyticsStaffTotals,a.analyticsSortState,a.analyticsDrilldown,a.analyticsPeriodChartData,a.analyticsPrevYearChartData,a.analyticsChartMetric,a.analyticsFiscalMode);case"/":return Rd();default:return hr(a.salesSummary,a.pipelineMeta,a.salesAnalytics,{upcomingEvents:a.calendarEvents,tourInquiries:a.tourInquiries,workflowOrdersCount:{new:a.workflowOrders.filter(e=>e.stage==="new").length,picking:a.workflowOrders.filter(e=>e.stage==="picking").length,packed:a.workflowOrders.filter(e=>e.stage==="packed").length,shipped:a.workflowOrders.filter(e=>e.stage==="shipped").length,total:a.workflowOrders.length},lowStockCount:a.materialList.filter(e=>e.currentStock<e.minimumStock*1.5).length,masterCounts:a.masterStats?{customers:a.masterStats.summary.customerCount,products:a.masterStats.summary.productCount,suppliers:a.syncDashboard?.tables.find(e=>e.tableName==="suppliers")?.rowCount??0,specialPrices:a.syncDashboard?.tables.find(e=>e.tableName==="customer_product_prices")?.rowCount??0}:void 0,churnSummary:a.churnAlert?{atRiskCount:a.churnAlert.atRiskCustomers.length,dormantCount:a.churnAlert.dormantCustomers.length,decliningCount:a.churnAlert.decliningCustomers.length,totalImpact:[...a.churnAlert.atRiskCustomers,...a.churnAlert.dormantCustomers,...a.churnAlert.decliningCustomers].reduce((e,t)=>e+t.totalAmountLast12m,0)}:void 0,orderHeaders:a.orderHeaders},a.salesPeriod,a.customRange,a.dashboardSortState)}}function Od(){const e={info:{bg:"#edf6ff",border:"#b8d4e8",icon:"ℹ️"},warning:{bg:"#fff8e6",border:"#e6c54d",icon:"⚠️"},maintenance:{bg:"#fff3e0",border:"#f5a623",icon:"🔧"},update:{bg:"#e8f5e9",border:"#66bb6a",icon:"🆕"}},s=a.announcements.filter(i=>!a.dismissedAnnouncements.has(i.id)).map(i=>{const r=e[i.level]??e.info;return`
      ...
      </div>`:"";return s+n}function Rd(){function e(s,n,i,r){return`<a href="${`${"/".replace(/\/$/,"")||"/"}${s}`}" data-link="${s}" class="home-card">
  ...
  `}async function Fd(){a.actionLoading=!0,w();try{const{fetchSalesSummary:e}=await A(async()=>{const{fetchSalesSummary:t}=await Promise.resolve().then(()=>T);return{fetchSalesSummary:t}},void 0);a.salesSummary=await e()}finally{a.actionLoading=!1,w()}}async function zd(e){a.actionLoading=!0,w();try{a.invoiceRecords=await ct(e)}finally{a.actionLoading=!1,w()}}async function Bd(e){a.actionLoading=!0,w();try{a.customerLedger=await _a(e)}finally{a.actionLoading=!1,w()}}function Se(e){a.invoiceForm={invoiceType:e.querySelector("#inv-type")?.value??a.invoiceForm.invoiceType,invoiceDate:e.querySelector("#inv-date")?.value??a.invoiceForm.invoiceDate,customerCode:e.querySelector("#inv-customer-code")?.value??a.invoiceForm.customerCode,customerName:e.querySelector("#inv-customer-name")?.value??a.invoiceForm.customerName,staffCode:e.querySelector("#inv-staff")?.value??a.invoiceForm.staffCode,lines:a.invoiceForm.lines.map((t,s)=>{const n=parseFloat(e.querySelector(`[data-line="${s}"][data-field="quantity"]`)?.value??"")||0,i=parseFloat(e.querySelector(`[data-line="${s}"][data-field="unitPrice"]`)?.value??"")||0;return{...t,productCode:e.querySelector(`[data-line="${s}"][data-field="productCode"]`)?.value??t.productCode,productName:e.querySelector(`[data-line="${s}"][data-field="productName"]`)?.value??t.productName,unit:e.querySelector(`[data-line="${s}"][data-field="unit"]`)?.value??t.unit,quantity:n,unitPrice:i,amount:n*i}}),note:e.querySelector("#inv-note")?.value??a.invoiceForm.note},a.invoiceForm.customerCode=a.invoiceForm.customerCode.trim().toUpperCase(),a.invoiceForm.customerName=a.invoiceForm.customerName.trim()}function Me(e){const t=e.querySelector("input[name='email-audience-mode']:checked")?.value??a.emailAudienceMode;a.emailAudienceMode=t,a.emailRegion=e.querySelector("#email-region")?.value??a.emailRegion,a.emailHistorySegment=e.querySelector("#email-history-segment")?.value??a.emailHistorySegment,a.emailSubject=e.querySelector("#email-subject")?.value??a.emailSubject,a.emailBody=e.querySelector("#email-body")?.value??a.emailBody}function Vd(e){e.querySelector("[data-action='global-search-open']")?.addEventListener("click",()=>{a.globalSearchOpen=!0,w()}),e.querySelectorAll("[data-action='global-search-close']").forEach(o=>{o.addEventListener("click",l=>{o.classList.contains("global-search")&&l.target instanceof HTMLElement&&!l.target.classList.contains("global-search")||(dt(),w())})}),e.querySelector("#global-search-input")?.addEventListener("input",o=>{a.globalQuery=o.target.value,w()}),e.querySelectorAll("[data-action='global-nav']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.path;l&&(dt(),_s(l))})}),e.querySelector("[data-action='csv-export']")?.addEventListener("click",()=>{Md()}),e.querySelectorAll("[data-jikomi-tab]").forEach(o=>{o.addEventListener("click",()=>{a.jikomiView=o.dataset.jikomiTab,w()})}),e.querySelector("[data-action='auth-login']")?.addEventListener("click",()=>{const o=e.querySelector("#auth-email")?.value.trim()??"",l=e.querySelector("#auth-password")?.value??"";a.authSubmitting=!0,a.authError=null,w(),Gn(o,l).then(async d=>{a.user=d,a.authSkipped=!1,a.authSubmitting=!1,a.authError=null;const{fetchMyProfile:m,recordAudit:g}=await A(async()=>{const{fetchMyProfile:b,recordAudit:_}=await Promise.resolve().then(()=>T);return{fetchMyProfile:b,recordAudit:_}},void 0);a.myProfile=await m(d.email),await g({action:"sign_in",userEmail:d.email}),w()}).catch(async d=>{try{const m=await za(o,l);a.user=m,a.authSkipped=!1,a.authError=null;const{fetchMyProfile:g}=await A(async()=>{const{fetchMyProfile:b}=await Promise.resolve().then(()=>T);return{fetchMyProfile:b}},void 0);a.myProfile=await g(m.email)}catch{a.authError=d instanceof Error?d.message:"ログインに失敗しました。"}finally{a.authSubmitting=!1,w()}})}),e.querySelector("[data-action='auth-skip']")?.addEventListener("click",()=>{a.authSkipped=!0,a.authError=null,w()}),e.querySelector("[data-action='auth-logout']")?.addEventListener("click",()=>{Xn().finally(()=>{location.reload()})}),e.querySelector("[data-action='sidebar-open']")?.addEventListener("click",()=>{a.sidebarOpen=!0,w()}),e.querySelectorAll("[data-action='sidebar-close']").forEach(o=>{o.addEventListener("click",()=>{a.sidebarOpen=!1,w()})});const t=e.querySelector(".sidebar");if(t&&a.sidebarOpen){let o=0;t.addEventListener("touchstart",l=>{o=l.touches[0].clientX},{passive:!0}),t.addEventListener("touchend",l=>{l.changedTouches[0].clientX-o<-60&&(a.sidebarOpen=!1,w())},{passive:!0})}e.querySelectorAll("[data-action='dismiss-announcement']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.id??"";a.dismissedAnnouncements.add(l),w()})}),e.querySelector("[data-action='reload-app']")?.addEventListener("click",()=>{location.reload()}),e.querySelectorAll("[data-link]").forEach(o=>{o.addEventListener("click",l=>{l.preventDefault(),_s(o.dataset.link)})}),e.querySelector("#feature-request-form")?.addEventListener("submit",async o=>{o.preventDefault();const l=e.querySelector("#fr-title")?.value??"",d=e.querySelector("#fr-category")?.value??"feature",m=e.querySelector("#fr-description")?.value??"",g=e.querySelector("#fr-result");if(!l.trim())return;const b=await Os(l,d,m);if(g&&(g.textContent=b?"送信しました":"送信に失敗しました",g.className=`fr-result ${b?"success":"error"}`),b){const _=e.querySelector("#feature-request-form");_&&_.reset()}}),e.querySelectorAll("[data-period]").forEach(o=>{o.addEventListener("click",()=>{a.salesPeriod=o.dataset.period,w()})}),e.querySelector("[data-action='apply-range']")?.addEventListener("click",()=>{const o=e.querySelector("#range-start")?.value??"",l=e.querySelector("#range-end")?.value??"";o&&l&&(a.customRange={start:o,end:l},a.salesPeriod="custom",w())}),e.querySelectorAll("[data-edit-customer]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.editCustomer??"",d=a.masterStats?.customers.find(g=>g.id===l);if(!d)return;const m=document.createElement("div");m.innerHTML=el(d),document.body.appendChild(m.firstElementChild),document.querySelector("[data-action='close-modal']")?.addEventListener("click",()=>{document.getElementById("edit-modal")?.remove()}),document.getElementById("edit-customer-form")?.addEventListener("submit",async g=>{g.preventDefault();const b=document.getElementById("edit-result"),_=await Rs(l,{name:document.getElementById("ec-name").value,kana_name:document.getElementById("ec-kana").value,phone:document.getElementById("ec-phone").value,fax:document.getElementById("ec-fax").value,postal_code:document.getElementById("ec-postal").value,address1:document.getElementById("ec-address").value,closing_day:parseInt(document.getElementById("ec-closing").value)||null,payment_day:parseInt(document.getElementById("ec-payment").value)||null,manual_override:!0});b&&(b.textContent=_?"保存しました":"保存に失敗",b.className=`fr-result ${_?"success":"error"}`),_&&(document.getElementById("edit-modal")?.remove(),He())})})}),e.querySelectorAll("[data-edit-product]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.editProduct??"",d=a.masterStats?.products.find(g=>g.id===l);if(!d)return;const m=document.createElement("div");m.innerHTML=tl(d),document.body.appendChild(m.firstElementChild),document.querySelector("[data-action='close-modal']")?.addEventListener("click",()=>{document.getElementById("edit-modal")?.remove()}),document.getElementById("edit-product-form")?.addEventListener("submit",async g=>{g.preventDefault();const b=document.getElementById("edit-result"),_=await js(l,{name:document.getElementById("ep-name").value,category_code:document.getElementById("ep-category").value,alcohol_degree:parseFloat(document.getElementById("ep-alcohol").value)||null,volume_ml:parseInt(document.getElementById("ep-volume").value)||null,bottle_type:document.getElementById("ep-bottle").value,purchase_price:parseInt(document.getElementById("ep-purchase").value)||null,default_sale_price:parseInt(document.getElementById("ep-sale").value)||null,manual_override:!0});b&&(b.textContent=_?"保存しました":"保存に失敗",b.className=`fr-result ${_?"success":"error"}`),_&&(document.getElementById("edit-modal")?.remove(),He())})})}),e.querySelector("[data-action='quote-new']")?.addEventListener("click",()=>{a.quoteState=qa(a.quoteCompanySettings),a.quoteEditId="new",a.quoteCustomerQuery="",a.quoteProductQuery="",a.quotePricing=null,w()}),e.querySelectorAll("[data-open-quote]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.openQuote,d=await dn(l);if(!d){D("見積の読み込みに失敗しました","error");return}a.quoteState={id:d.id,quoteNo:d.quote_no,quoteDate:d.quote_date,validUntil:d.valid_until??"",customerCode:d.legacy_customer_code??"",customerName:d.customer_name,customerAddress:d.customer_address,subject:d.subject,lines:d.lines.map(m=>({productCode:m.legacy_product_code??"",productName:m.product_name,janCode:m.jan_code??"",caseQty:m.case_qty,quantity:m.quantity,unit:m.unit,unitPrice:m.unit_price,retailPrice:m.retail_price,amount:m.amount})),remarks:d.remarks,taxRate:d.tax_rate,deliveryDate:d.delivery_date,paymentTerms:d.payment_terms,deliveryPlace:d.delivery_place,templateType:d.template_type??"sake",previewMode:!1},a.quoteEditId=l,a.quoteCustomerQuery="",a.quoteProductQuery="",a.quotePricing=null,w()})}),e.querySelectorAll("[data-delete-quote]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.deleteQuote,d=o.dataset.quoteNo??l;if(!await fe(`見積 ${d} を削除しますか？`))return;await xs("quotes",l)?(a.quoteList=a.quoteList.filter(b=>b.id!==l),D("削除しました","success"),w()):D("削除に失敗しました","error")})}),e.querySelector("[data-action='quote-back-list']")?.addEventListener("click",()=>{a.quoteEditId=null,a.quoteListLoading=!0,w(),Da().then(o=>{a.quoteList=o,a.quoteListLoading=!1,w()})}),e.querySelectorAll("[name='q-template']").forEach(o=>{o.addEventListener("change",()=>{a.quoteState.templateType=o.value,w()})});function s(o){return(o??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function n(o){return o.length?o.map(l=>`<button class="search-item" type="button" data-select-customer="${s(l.code)}" data-cust-name="${s(l.name)}" data-cust-addr="${s(l.address1||"")}"><span class="mono">${s(l.code)}</span><span style="font-size:13px;font-weight:600;">${s(l.name)}</span></button>`).join(""):'<p style="padding:10px 12px;color:var(--text-secondary);font-size:13px;">該当なし</p>'}function i(o){o.querySelectorAll("[data-select-customer]").forEach(l=>{l.addEventListener("click",async()=>{const d=l.dataset.selectCustomer??"";a.quoteState.customerCode=d,a.quoteState.customerName=l.dataset.custName??"",a.quoteState.customerAddress=l.dataset.custAddr??"",a.quoteCustomerQuery="";const m=e.querySelector("#q-cust-search");m&&(m.value=""),o.remove(),a.quotePricing=await ea(a.masterStats?.customers??[],d),w()})})}function r(o){const l=e.querySelector("#q-cust-search")?.closest(".form-row");if(!l)return;let d=document.getElementById("cust-search-results");d||(d=document.createElement("div"),d.id="cust-search-results",d.className="search-results",l.after(d));const m=a.masterStats?.customers??[],g=o.trim().toLowerCase(),b=g.length===0?m:m.filter(_=>_.name.includes(o)||_.kanaName.includes(o)||_.code.includes(o)||_.name.toLowerCase().includes(g)||_.kanaName.toLowerCase().includes(g));d.innerHTML=n(b),i(d)}function c(o,l){return o.length?o.map(d=>{const m=l?ka(d,l):{price:d.salePrice||0,label:"卸価格"},g=d.listPrice||0,b=m.label!=="標準価格"&&m.label!=="卸価格";return`<button class="search-item" type="button" data-add-product="${s(d.code)}" data-prod-name="${s(d.name)}" data-prod-price="${m.price}" data-prod-retail="${g}" data-prod-jan="${s(d.janCode??"")}" data-prod-unit="${s(d.unit)}" data-prod-case="${d.caseQty??""}"><span class="mono">${s(d.code)}</span><span style="font-size:13px;font-weight:600;line-height:1.4;">${s(d.name)}</span><span class="numeric"${b?' style="color:#2f855a;font-weight:700;"':""}>納入 ¥${m.price?m.price.toLocaleString("ja-JP"):"未設定"}<small style="font-weight:400;margin-left:4px;">(${s(m.label)})</small>${g?`　定価 ¥${g.toLocaleString("ja-JP")}`:""}</span></button>`}).join(""):'<p style="padding:10px 12px;color:var(--text-secondary);font-size:13px;">該当なし</p>'}function p(o){o.querySelectorAll("[data-add-product]").forEach(l=>{l.addEventListener("click",()=>{const d=l.dataset.addProduct??"",m=l.dataset.prodName??"",g=parseInt(l.dataset.prodPrice??"0"),b=parseInt(l.dataset.prodRetail??"0")||null,_=l.dataset.prodJan??"",C=l.dataset.prodUnit||"本",S=l.dataset.prodCase??"",E=S?parseInt(S):null;a.quoteState.lines.push({productCode:d,productName:m,janCode:_,caseQty:E,quantity:1,unit:C,unitPrice:g,retailPrice:b,amount:g}),a.quoteProductQuery="";const I=e.querySelector("#q-prod-search");I&&(I.value=""),w()})})}function u(o){const l=e.querySelector("#q-prod-search")?.closest(".form-row");if(!l)return;let d=document.getElementById("prod-search-results");if(d||(d=document.createElement("div"),d.id="prod-search-results",d.className="search-results",l.after(d)),!a.masterStats){d.innerHTML='<p style="padding:10px 12px;color:var(--text-secondary);font-size:13px;">マスタ読込中…</p>';return}const m=a.masterStats.products,g=o.trim().toLowerCase(),b=g.length===0?m:m.filter(_=>_.name.includes(o)||_.kanaName.includes(o)||_.code.includes(o)||_.name.toLowerCase().includes(g)||_.kanaName.toLowerCase().includes(g));d.innerHTML=c(b,a.quotePricing),p(d)}function y(o,l){let d=null;function m(){d||(d=g=>{const b=document.getElementById(l);if(!b){document.removeEventListener("touchstart",d),document.removeEventListener("mousedown",d),d=null;return}o.contains(g.target)||b.contains(g.target)||(b.remove(),document.removeEventListener("touchstart",d),document.removeEventListener("mousedown",d),d=null)},document.addEventListener("touchstart",d,{passive:!0}),document.addEventListener("mousedown",d))}return m}(function(){const o=e.querySelector("#q-cust-search");if(!o)return;const l=y(o,"cust-search-results");o.addEventListener("focus",()=>{r(o.value),l()}),o.addEventListener("compositionend",()=>{a.quoteCustomerQuery=o.value,r(o.value)}),o.addEventListener("input",d=>{d.isComposing||(a.quoteCustomerQuery=o.value,r(o.value))}),o.value&&r(o.value)})(),(function(){const o=e.querySelector("#q-prod-search");if(!o)return;const l=y(o,"prod-search-results");o.addEventListener("focus",()=>{u(o.value),l()}),o.addEventListener("compositionend",()=>{a.quoteProductQuery=o.value,u(o.value)}),o.addEventListener("input",d=>{d.isComposing||(a.quoteProductQuery=o.value,u(o.value))}),o.value&&u(o.value)})(),e.querySelectorAll("[data-select-customer]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.selectCustomer??"";a.quoteState.customerCode=l,a.quoteState.customerName=o.dataset.custName??"",a.quoteState.customerAddress=o.dataset.custAddr??"",a.quoteCustomerQuery="",a.quotePricing=await ea(a.masterStats?.customers??[],l),w()})}),e.querySelectorAll("[data-add-product]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.addProduct??"",d=o.dataset.prodName??"",m=parseInt(o.dataset.prodPrice??"0"),g=parseInt(o.dataset.prodRetail??"0")||null,b=o.dataset.prodJan??"",_=o.dataset.prodUnit||"本",C=o.dataset.prodCase??"",S=C?parseInt(C):null;a.quoteState.lines.push({productCode:l,productName:d,janCode:b,caseQty:S,quantity:1,unit:_,unitPrice:m,retailPrice:g,amount:m}),a.quoteProductQuery="",w()})});function f(){gt(a.quoteState);const o=e.querySelector("#q-preview-scaler");if(!o)return;o.innerHTML=$n(a.quoteState,a.masterStats?.customers??[],a.masterStats?.products??[],a.quoteCustomerQuery,a.quoteProductQuery,a.quotePricing,a.quoteCompanySettings);const l=o.querySelector(".q-preview-doc"),d=o.parentElement?.clientWidth??0,m=l?.offsetWidth??0;if(d>0&&m>0&&m>d-24){const g=(d-24)/m;o.style.transform=`scale(${g})`,o.style.transformOrigin="top left",o.style.height=`${((l?.offsetHeight??0)+48)*g}px`}else o.style.transform="",o.style.height=""}for(const o of["q-no","q-date","q-valid","q-subject","q-payment-terms","q-delivery-date","q-delivery-place"])e.querySelector(`#${o}`)?.addEventListener("input",f);e.querySelector("#q-remarks")?.addEventListener("input",f),e.querySelectorAll(".qty-input").forEach(o=>{o.addEventListener("change",()=>{const l=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[l];d&&(d.quantity=parseFloat(o.value)||0,d.amount=d.quantity*d.unitPrice,f())})}),e.querySelectorAll(".price-input").forEach(o=>{o.addEventListener("change",()=>{const l=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[l];d&&(d.unitPrice=parseInt(o.value)||0,d.amount=d.quantity*d.unitPrice,f())})}),e.querySelectorAll(".jan-input").forEach(o=>{o.addEventListener("change",()=>{const l=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[l];d&&(d.janCode=o.value,f())})}),e.querySelectorAll(".case-qty-input").forEach(o=>{o.addEventListener("change",()=>{const l=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[l];d&&(d.caseQty=o.value?parseInt(o.value):null,f())})}),e.querySelectorAll(".retail-price-input").forEach(o=>{o.addEventListener("change",()=>{const l=parseInt(o.dataset.lineIdx??"0"),d=a.quoteState.lines[l];d&&(d.retailPrice=o.value?parseInt(o.value):null,f())})}),e.querySelectorAll("[data-remove-line]").forEach(o=>{o.addEventListener("click",()=>{const l=parseInt(o.dataset.removeLine??"0");a.quoteState.lines.splice(l,1),w()})}),e.querySelector("[data-action='quote-preview-mode']")?.addEventListener("click",()=>{gt(a.quoteState),a.quoteState.previewMode=!0,w()}),e.querySelector("[data-action='quote-edit-mode']")?.addEventListener("click",()=>{a.quoteState.previewMode=!1,w()}),e.querySelector("[data-action='quote-download-pdf']")?.addEventListener("click",()=>{gt(a.quoteState),Or(a.quoteState,a.quoteCompanySettings)}),e.querySelector("[data-action='save-quote']")?.addEventListener("click",async()=>{gt(a.quoteState);const o=a.quoteState,l=o.lines.reduce((C,S)=>C+S.amount,0),d=Math.round(l*o.taxRate/100),m=l+d;if(!o.quoteNo)try{const{supabaseRpc:C}=await A(async()=>{const{supabaseRpc:E}=await Promise.resolve().then(()=>U);return{supabaseRpc:E}},void 0),S=await C("generate_quote_no",{});o.quoteNo=S??`Q${new Date().toISOString().slice(0,10).replace(/-/g,"")}-${Math.floor(Math.random()*1e3).toString().padStart(3,"0")}`}catch{o.quoteNo=`Q${new Date().toISOString().slice(0,10).replace(/-/g,"")}-${Math.floor(Math.random()*1e3).toString().padStart(3,"0")}`}const g=new Date().toISOString().slice(0,10),b=o.templateType==="sake"||o.templateType==="standard"?o.templateType:"sake",_={quote_no:o.quoteNo,quote_date:o.quoteDate||g,valid_until:o.validUntil||null,legacy_customer_code:o.customerCode||null,customer_name:o.customerName||"",customer_address:o.customerAddress||"",subject:o.subject||"",template_type:b,subtotal:l,tax_amount:d,total_amount:m,tax_rate:o.taxRate||10,remarks:o.remarks||"",delivery_date:o.deliveryDate||"",payment_terms:o.paymentTerms||"",delivery_place:o.deliveryPlace||"",updated_at:new Date().toISOString()};try{let C=o.id;if(o.id){const S=await fetch(`${re}/rest/v1/quotes?id=eq.${encodeURIComponent(o.id)}`,{method:"PATCH",headers:{apikey:H,Authorization:`Bearer ${H}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(_)});if(!S.ok){const E=await S.text();throw new Error(`quotes更新失敗 ${S.status}: ${E}`)}await fetch(`${re}/rest/v1/quote_lines?quote_id=eq.${encodeURIComponent(o.id)}`,{method:"DELETE",headers:{apikey:H,Authorization:`Bearer ${H}`}})}else{const S=await fetch(`${re}/rest/v1/quotes`,{method:"POST",headers:{apikey:H,Authorization:`Bearer ${H}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(_)});if(!S.ok){const I=await S.text();throw new Error(`quotes作成失敗 ${S.status}: ${I}`)}const E=await S.json();if(!E?.[0]?.id)throw new Error("IDが返りませんでした");C=E[0].id,o.id=C}if(o.lines.length>0){const S=o.lines.map((I,M)=>({quote_id:C,line_no:M+1,legacy_product_code:I.productCode||null,product_name:I.productName,jan_code:I.janCode||null,case_qty:I.caseQty??null,quantity:I.quantity,unit:I.unit,unit_price:I.unitPrice,retail_price:I.retailPrice??null,amount:I.amount})),E=await fetch(`${re}/rest/v1/quote_lines`,{method:"POST",headers:{apikey:H,Authorization:`Bearer ${H}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify(S)});if(!E.ok){const I=await E.text();throw new Error(`明細保存失敗 ${E.status}: ${I}`)}}D(`見積 ${o.quoteNo} を保存しました`,"success"),w()}catch(C){console.error("[save-quote]",C),D(`保存失敗: ${String(C).slice(0,120)}`,"error")}}),e.querySelector("[data-action='save-quote-settings']")?.addEventListener("click",()=>{const o=d=>document.getElementById(d)?.value??"",l={...a.quoteCompanySettings,companyName:o("qs-company-name"),companyPostal:o("qs-company-postal"),companyAddress1:o("qs-company-addr1"),companyAddress2:o("qs-company-addr2"),companyTel:o("qs-company-tel"),companyFax:o("qs-company-fax"),companyEmail:o("qs-company-email"),companyRegistrationNo:o("qs-company-regno"),bankName:o("qs-bank-name"),bankBranch:o("qs-bank-branch"),bankAccountType:o("qs-bank-type"),bankAccountNo:o("qs-bank-no"),bankAccountHolder:o("qs-bank-holder"),defaultPaymentTerms:o("qs-payment-terms"),defaultHeaderNote:o("qs-header-note"),defaultFooterNote:o("qs-footer-note"),accentColor:document.getElementById("qs-accent-color")?.value||a.quoteCompanySettings.accentColor||"#0968e5"};Re(l),Ye("quote_company",l),a.quoteCompanySettings=l,D("設定を保存しました","success"),w()}),e.querySelectorAll("[data-action='set-accent-color']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.color??"#0968e5";a.quoteCompanySettings={...a.quoteCompanySettings,accentColor:l},Re(a.quoteCompanySettings),Ye("quote_company",a.quoteCompanySettings),w()})}),e.querySelector("#qs-accent-color")?.addEventListener("input",o=>{const l=o.target.value;a.quoteCompanySettings={...a.quoteCompanySettings,accentColor:l},Re(a.quoteCompanySettings),w()}),e.querySelector("#qs-seal-file")?.addEventListener("change",o=>{const l=o.target.files?.[0];if(!l)return;const d=new FileReader;d.onload=()=>{a.quoteCompanySettings={...a.quoteCompanySettings,sealImageDataUrl:d.result},Re(a.quoteCompanySettings),Ye("quote_company",a.quoteCompanySettings),w()},d.readAsDataURL(l)}),e.querySelector("#qs-seal-size")?.addEventListener("input",o=>{const l=parseInt(o.target.value);a.quoteCompanySettings={...a.quoteCompanySettings,sealSize:l},Re(a.quoteCompanySettings),Ye("quote_company",a.quoteCompanySettings),w()}),e.querySelector("[data-action='remove-company-seal']")?.addEventListener("click",()=>{a.quoteCompanySettings={...a.quoteCompanySettings,sealImageDataUrl:""},Re(a.quoteCompanySettings),Ye("quote_company",a.quoteCompanySettings),w()}),e.querySelectorAll("[data-action='dcal-prev'],[data-action='dcal-next']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.month;l&&(a.demandForecast.calendarMonth=l,w())})}),e.querySelectorAll("[data-action='forecast-segment']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.segment;a.demandForecast.selectedSegment=l,w()})}),e.querySelectorAll("[data-demand-tab]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.demandTab;l&&(a.demandTab=l,w())})});function v(o){const l=a.demandAnalysis,d=a.safetyStockParams;if(!l||d.length===0)return[];const[m,g]=o.split("-"),b=`${parseInt(m)-1}-${g}`,_=l.months.filter(C=>C<o).slice(-3);return d.map(C=>{const S=C.productionType==="make_to_order",E=l.matrix[C.productCode]?.[b]??0,I=_.map(j=>l.matrix[C.productCode]?.[j]??0),M=I.length>0?I.reduce((j,Q)=>j+Q,0)/I.length:C.avgMonthlyDemand,L=S?0:E>0?Math.ceil(E):Math.ceil(M),q=S?0:Math.ceil(C.safetyStockQty),O=Math.max(0,L+q);return{id:"",yearMonth:o,productCode:C.productCode,productName:C.productName,demandForecast:L,safetyStockTarget:q,openingStock:0,requiredProduction:O,plannedQty:S?0:O,actualQty:0,status:"draft",productionType:C.productionType??"monthly",notes:""}})}e.querySelector("[data-action='demand-years-back']")?.addEventListener("change",async o=>{const l=parseInt(o.target.value)||3;a.demandYearsBack=l,a.demandAnalysis=null;const{fetchDemandAnalysis:d}=await A(async()=>{const{fetchDemandAnalysis:m}=await Promise.resolve().then(()=>T);return{fetchDemandAnalysis:m}},void 0);a.demandAnalysis=await d(l*12),w()}),e.querySelectorAll("[data-action='ss-lead-time']").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.code??"",d=parseInt(o.value)||30;a.safetyStockParams=a.safetyStockParams.map(m=>{if(m.productCode!==l)return m;const g=m.serviceLevel>=.99?2.33:m.serviceLevel>=.97?1.88:m.serviceLevel>=.95?1.65:m.serviceLevel>=.9?1.28:1.04,b=d/30,_=Math.ceil(g*m.demandStdDev*Math.sqrt(b)),C=Math.ceil(m.avgMonthlyDemand*b+_);return{...m,leadTimeDays:d,safetyStockQty:_,reorderPoint:C}}),w()})}),e.querySelectorAll("[data-action='ss-service-level']").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.code??"",d=parseFloat(o.value)||.95;a.safetyStockParams=a.safetyStockParams.map(m=>{if(m.productCode!==l)return m;const g=d>=.99?2.33:d>=.97?1.88:d>=.95?1.65:d>=.9?1.28:1.04,b=m.leadTimeDays/30,_=Math.ceil(g*m.demandStdDev*Math.sqrt(b)),C=Math.ceil(m.avgMonthlyDemand*b+_);return{...m,serviceLevel:d,safetyStockQty:_,reorderPoint:C}}),w()})}),e.querySelector("[data-action='ss-save-all']")?.addEventListener("click",async o=>{if(a.safetyStockParams.length===0)return;const l=o.currentTarget;l.disabled=!0,l.textContent="保存中…";const{saveSafetyStockParamsBulk:d}=await A(async()=>{const{saveSafetyStockParamsBulk:g}=await Promise.resolve().then(()=>T);return{saveSafetyStockParamsBulk:g}},void 0),m=await d(a.safetyStockParams);l.disabled=!1,l.textContent=m?"✓ 保存しました":"✗ 保存失敗",setTimeout(()=>{l.textContent="安全在庫を保存"},2500)}),e.querySelector("[data-action='bulk-apply-safety']")?.addEventListener("click",()=>{const o=parseFloat(document.getElementById("bulk-service-level")?.value??"0.95"),l=parseInt(document.getElementById("bulk-lead-time")?.value??"30");a.safetyStockParams=a.safetyStockParams.map(d=>{const m=o>=.99?2.33:o>=.97?1.88:o>=.95?1.65:o>=.9?1.28:1.04,g=l/30,b=Math.ceil(m*d.demandStdDev*Math.sqrt(g)),_=Math.ceil(d.avgMonthlyDemand*g+b);return{...d,serviceLevel:o,leadTimeDays:l,safetyStockQty:b,reorderPoint:_}}),w()}),e.querySelectorAll("[data-action='plan-prod-type']").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.code??"",d=o.value;a.productionPlan=a.productionPlan.map(m=>m.productCode===l?{...m,productionType:d}:m)})}),e.querySelector("[data-action='plan-year-month']")?.addEventListener("change",async o=>{const l=o.target.value;if(!l)return;a.demandPlanYearMonth=l,a.calendarShifts=Et(l,1,0);const{fetchProductionPlan:d}=await A(async()=>{const{fetchProductionPlan:g}=await Promise.resolve().then(()=>T);return{fetchProductionPlan:g}},void 0),m=await d(l);a.productionPlan=m.length>0?m:v(l),Ce(a.calendarShifts,a.productionPlan.filter(g=>!a.calendarLabelExcluded.has(g.productCode))),w()}),e.querySelectorAll("[data-action='plan-type-filter']").forEach(o=>{o.addEventListener("click",()=>{a.demandPlanTypeFilter=o.dataset.filter??"all",w()})}),e.querySelectorAll("[data-action='demand-sort']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.sortCol??"";a.demandSort?.column===l?a.demandSort=a.demandSort.dir==="desc"?{column:l,dir:"asc"}:null:a.demandSort={column:l,dir:"desc"},w()})}),e.querySelector("[data-action='plan-recalc']")?.addEventListener("click",()=>{a.productionPlan=v(a.demandPlanYearMonth),w()}),e.querySelector("[data-action='plan-csv-import']")?.addEventListener("change",o=>{const l=o.target.files?.[0];if(!l)return;const d=new FileReader;d.onload=async()=>{const{parseCSV:m}=await A(async()=>{const{parseCSV:q}=await Promise.resolve().then(()=>$c);return{parseCSV:q}},void 0),{columns:g,rows:b}=m(d.result),_=document.getElementById("csv-import-status"),C=g.find(q=>/商品コード|product_code|code|コード/i.test(q)),S=g.find(q=>/在庫|stock|期首|opening/i.test(q)),E=g.find(q=>/計画|plan|planned|生産/i.test(q));if(!C){_&&(_.style.display="block",_.style.background="rgba(197,61,61,0.1)",_.style.color="#c53d3d",_.textContent=`エラー: 商品コード列が見つかりません。列名: ${g.join(", ")}`);return}let I=0,M=0,L=0;for(const q of b){const O=(q[C]??"").trim();if(!O)continue;const j=a.productionPlan.find(Q=>Q.productCode===O);if(j){if(I++,S&&q[S]!==void 0&&q[S]!==""){const Q=parseFloat(q[S])||0;j.openingStock=Q,j.requiredProduction=Math.max(0,j.demandForecast+j.safetyStockTarget-Q),j.plannedQty>0&&!E&&(j.plannedQty=j.requiredProduction),M++}E&&q[E]!==void 0&&q[E]!==""&&(j.plannedQty=parseFloat(q[E])||0,L++)}}_&&(_.style.display="block",I===0?(_.style.background="rgba(183,121,31,0.1)",_.style.color="#b7791f",_.textContent=`一致する商品コードが見つかりませんでした（CSV: ${b.length}行）`):(_.style.background="rgba(47,133,90,0.1)",_.style.color="#2f855a",_.textContent=`${I}商品に反映: 在庫${M}件${L>0?` / 計画${L}件`:""} 更新`),setTimeout(()=>{_.style.display="none"},5e3)),w()},d.readAsText(l,"UTF-8"),o.target.value=""}),e.querySelector("[data-action='plan-save']")?.addEventListener("click",async()=>{if(a.productionPlan.length===0)return;e.querySelectorAll("[data-action='plan-qty']").forEach(d=>{const m=d.dataset.code??"",g=a.productionPlan.find(b=>b.productCode===m);g&&(g.plannedQty=parseFloat(d.value)||0)});const{saveProductionPlan:o}=await A(async()=>{const{saveProductionPlan:d}=await Promise.resolve().then(()=>T);return{saveProductionPlan:d}},void 0);await Promise.all(a.productionPlan.map(d=>o(d)));const{fetchProductionPlan:l}=await A(async()=>{const{fetchProductionPlan:d}=await Promise.resolve().then(()=>T);return{fetchProductionPlan:d}},void 0);a.productionPlan=await l(a.demandPlanYearMonth),w()}),e.querySelectorAll("[data-action='cal-toggle-day']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.date??"",d=a.calendarShifts.find(m=>m.date===l);d&&(d.confirmed?a.calendarSelectedDate=a.calendarSelectedDate===l?null:l:d.partTimers>0||d.employees>0?(d.partTimers=0,d.employees=0,Ce(a.calendarShifts,a.productionPlan.filter(m=>!a.calendarLabelExcluded.has(m.productCode))),a.calendarSelectedDate=l):(d.partTimers=1,d.employees=0,Ce(a.calendarShifts,a.productionPlan.filter(m=>!a.calendarLabelExcluded.has(m.productCode))),a.calendarSelectedDate=l),w())})}),e.querySelector("[data-action='cal-save-exclusions']")?.addEventListener("click",async o=>{const l=o.currentTarget;l.disabled=!0,l.textContent="保存中…";const{saveLabelExclusions:d}=await A(async()=>{const{saveLabelExclusions:b}=await Promise.resolve().then(()=>T);return{saveLabelExclusions:b}},void 0),m=[...a.calendarLabelExcluded],g=await d(a.demandPlanYearMonth,m);l.disabled=!1,l.textContent=g?"✓ 保存しました":"✗ 保存失敗",setTimeout(()=>{l.textContent="設定を保存"},2500)}),e.querySelectorAll("[data-action='cal-label-toggle']").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.code??"",m=document.getElementById("cal-label-list")?.scrollTop??0;o.checked?a.calendarLabelExcluded.delete(l):a.calendarLabelExcluded.add(l);const g=a.productionPlan.filter(b=>!a.calendarLabelExcluded.has(b.productCode));Ce(a.calendarShifts,g),w(),requestAnimationFrame(()=>{const b=document.getElementById("cal-label-list");b&&(b.scrollTop=m)})})}),e.querySelectorAll("[data-action='cal-label-toggle-group']").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.type??"",m=document.getElementById("cal-label-list")?.scrollTop??0,g=a.productionPlan.filter(_=>_.productionType===l);if(o.checked)for(const _ of g)a.calendarLabelExcluded.delete(_.productCode);else for(const _ of g)a.calendarLabelExcluded.add(_.productCode);const b=a.productionPlan.filter(_=>!a.calendarLabelExcluded.has(_.productCode));Ce(a.calendarShifts,b),w(),requestAnimationFrame(()=>{const _=document.getElementById("cal-label-list");_&&(_.scrollTop=m)})})}),e.querySelectorAll("[data-action='cal-shift-part']").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.date??"",d=parseInt(o.value)||0,m=a.calendarShifts.find(g=>g.date===l);m&&(m.partTimers=d),w()})}),e.querySelectorAll("[data-action='cal-shift-emp']").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.date??"",d=parseInt(o.value)||0,m=a.calendarShifts.find(g=>g.date===l);m&&(m.employees=d),w()})}),e.querySelector("[data-action='cal-year-month']")?.addEventListener("change",async o=>{const l=o.target.value;if(!l)return;a.demandPlanYearMonth=l,a.calendarSelectedDate=null,a.calendarShifts=Et(l,1,0);const{fetchProductionPlan:d,fetchLabelExclusions:m}=await A(async()=>{const{fetchProductionPlan:_,fetchLabelExclusions:C}=await Promise.resolve().then(()=>T);return{fetchProductionPlan:_,fetchLabelExclusions:C}},void 0),[g,b]=await Promise.all([d(l),m(l)]);a.productionPlan=g.length>0?g:v(l),a.calendarLabelExcluded=new Set(b),Ce(a.calendarShifts,a.productionPlan.filter(_=>!a.calendarLabelExcluded.has(_.productCode))),w()}),e.querySelector("[data-action='cal-default-part']")?.addEventListener("change",o=>{const l=parseInt(o.target.value)||0;a.calendarDefaultPart=l;for(const d of a.calendarShifts)if(!d.confirmed){const m=new Date(d.date).getDay()===0||new Date(d.date).getDay()===6;d.partTimers=m?0:l}w()}),e.querySelector("[data-action='cal-default-emp']")?.addEventListener("change",o=>{const l=parseInt(o.target.value)||0;a.calendarDefaultEmp=l;for(const d of a.calendarShifts)if(!d.confirmed){const m=new Date(d.date).getDay()===0||new Date(d.date).getDay()===6;d.employees=m?0:l}w()}),e.querySelector("[data-action='cal-reset-shifts']")?.addEventListener("click",()=>{a.calendarShifts=Et(a.demandPlanYearMonth,1,0),Ce(a.calendarShifts,a.productionPlan.filter(o=>!a.calendarLabelExcluded.has(o.productCode))),w()}),e.querySelector("[data-action='cal-confirm-all']")?.addEventListener("click",()=>{for(const o of a.calendarShifts)o.confirmed=!0;w()}),e.querySelectorAll("[data-action='select-month']").forEach(o=>{o.addEventListener("click",()=>{const l=parseInt(o.dataset.month??"0");a.seasonalCalendar&&(a.seasonalCalendar.selectedMonth=l,w())})}),e.querySelector("#visit-filter-area")?.addEventListener("change",o=>{a.visitPlanner&&(a.visitPlanner.filterArea=o.target.value,w())}),e.querySelector("#visit-filter-score")?.addEventListener("change",o=>{a.visitPlanner&&(a.visitPlanner.filterMinScore=parseInt(o.target.value)||0,w())}),e.querySelectorAll("[data-sort-col]").forEach(o=>{o.addEventListener("click",l=>{const d=o.dataset.sortCol??"",m=l.shiftKey;a.route==="/product-power"?a.productSortState=We(a.productSortState,d,m):a.route==="/customer-efficiency"?a.customerSortState=We(a.customerSortState,d,m):a.route==="/"||a.route==="/sales"?a.dashboardSortState=We(a.dashboardSortState,d,m):a.route==="/master"?a.masterSortState=We(a.masterSortState,d,m):a.route==="/analytics"&&(a.analyticsSortState=We(a.analyticsSortState,d,m)),w()})}),e.querySelectorAll("[data-product-period]").forEach(o=>{o.addEventListener("click",()=>{a.productPeriod=o.dataset.productPeriod??"year",w()})}),e.querySelector("[data-action='pp-apply-range']")?.addEventListener("click",()=>{const o=document.getElementById("pp-range-start")?.value??"",l=document.getElementById("pp-range-end")?.value??"";o&&l&&(a.productCustomStart=o,a.productCustomEnd=l,a.productPeriod="custom",w())}),e.querySelectorAll("[data-product-filter]").forEach(o=>{o.addEventListener("click",()=>{a.productFilter=o.dataset.productFilter??"all",w()})}),e.querySelector("[data-action='dashboard-refresh']")?.addEventListener("click",async o=>{const l=o.currentTarget;l.disabled=!0,l.textContent="更新中…",await He(),l.disabled=!1,l.textContent="↻ 更新",D("ダッシュボードを更新しました","success")}),e.querySelector("[data-action='sales-filter']")?.addEventListener("click",()=>{const o=e.querySelector("#sales-start")?.value??"",l=e.querySelector("#sales-end")?.value??"";a.salesFilter={startDate:o,endDate:l},Fd()}),e.querySelector("[data-action='invoice-filter']")?.addEventListener("click",()=>{const o={documentNo:e.querySelector("#invoice-document-no")?.value??"",startDate:e.querySelector("#invoice-start")?.value??"",endDate:e.querySelector("#invoice-end")?.value??"",customerCode:e.querySelector("#invoice-customer-code")?.value??""};a.invoiceFilter=o,zd(o)}),e.querySelector("[data-action='ledger-search']")?.addEventListener("click",()=>{const o=e.querySelector("#ledger-customer-code")?.value??"";a.ledgerCustomerCode=o.trim().toUpperCase(),Bd(a.ledgerCustomerCode)}),e.querySelectorAll("[data-tab]").forEach(o=>{o.addEventListener("click",()=>{a.masterTab=o.dataset.tab,a.masterFilter={...Ia},w()})}),e.querySelector("[data-action='master-filter']")?.addEventListener("click",()=>{a.masterFilter={query:e.querySelector("#master-search")?.value??"",businessType:e.querySelector("#master-business-type")?.value??"",areaCode:e.querySelector("#master-area-code")?.value??"",activeOnly:e.querySelector("#master-active-only")?.value??"",page:1},w()}),e.querySelector("#master-search")?.addEventListener("keydown",o=>{o.key==="Enter"&&e.querySelector("[data-action='master-filter']")?.click()}),e.querySelectorAll("[data-action='master-page']").forEach(o=>{o.addEventListener("click",()=>{const l=Number(o.dataset.page);l>=1&&(a.masterFilter={...a.masterFilter,page:l},w())})}),e.querySelectorAll("[data-action='raw-select-table']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.table;if(!l)return;a.rawSelectedTable=l,a.rawPage=1;const d=await Pt(l,1);a.rawRecords=d.records,a.rawTotalCount=d.total,w()})}),e.querySelector("[data-action='raw-page-prev']")?.addEventListener("click",async()=>{if(!a.rawSelectedTable||a.rawPage<=1)return;a.rawPage-=1;const o=await Pt(a.rawSelectedTable,a.rawPage);a.rawRecords=o.records,a.rawTotalCount=o.total,w()}),e.querySelector("[data-action='raw-page-next']")?.addEventListener("click",async()=>{if(!a.rawSelectedTable)return;a.rawPage+=1;const o=await Pt(a.rawSelectedTable,a.rawPage);a.rawRecords=o.records,a.rawTotalCount=o.total,w()}),e.querySelectorAll("[data-analytics-tab]").forEach(o=>{o.addEventListener("click",async()=>{if(a.analyticsTab=o.dataset.analyticsTab,a.analyticsStaffDrilldown=null,a.analyticsDrilldown=null,a.analyticsPeriodChartData=[],a.analyticsPrevYearChartData=[],a.analyticsTab!=="staff"){if(a.analyticsPeriod!=="all"){const{fetchAnalyticsByPeriod:l,fetchAvailablePeriods:d}=await A(async()=>{const{fetchAnalyticsByPeriod:m,fetchAvailablePeriods:g}=await Promise.resolve().then(()=>T);return{fetchAnalyticsByPeriod:m,fetchAvailablePeriods:g}},void 0);a.analyticsPeriodOptions=await d(a.analyticsTab,a.analyticsPeriod),a.analyticsPeriodFilter=a.analyticsPeriodOptions[0]??"",a.analyticsPeriodRows=await l(a.analyticsTab,a.analyticsPeriod,a.analyticsPeriodFilter)}}w()})}),e.querySelectorAll("[data-analytics-period]").forEach(o=>{o.addEventListener("click",async()=>{const{fetchAnalyticsByPeriod:l,fetchAvailablePeriods:d,fetchPeriodChartData:m,prevYearFilter:g}=await A(async()=>{const{fetchAnalyticsByPeriod:_,fetchAvailablePeriods:C,fetchPeriodChartData:S,prevYearFilter:E}=await Promise.resolve().then(()=>T);return{fetchAnalyticsByPeriod:_,fetchAvailablePeriods:C,fetchPeriodChartData:S,prevYearFilter:E}},void 0),b=o.dataset.analyticsPeriod;if(a.analyticsPeriod=b,a.analyticsDrilldown=null,b==="all")a.analyticsPeriodRows=[],a.analyticsPeriodOptions=[],a.analyticsPeriodFilter="",a.analyticsPeriodChartData=[],a.analyticsPrevYearChartData=[];else{a.analyticsPeriodOptions=await d(a.analyticsTab,b),a.analyticsPeriodFilter=a.analyticsPeriodOptions[0]??"";const _=a.analyticsPeriodFilter,[C,S,E]=await Promise.all([l(a.analyticsTab,b,_),m(b,_),m(b,g(_))]);a.analyticsPeriodRows=C,a.analyticsPeriodChartData=S,a.analyticsPrevYearChartData=E}w()})}),e.querySelector("#analytics-period-select")?.addEventListener("change",async o=>{const{fetchAnalyticsByPeriod:l,fetchPeriodChartData:d,prevYearFilter:m}=await A(async()=>{const{fetchAnalyticsByPeriod:_,fetchPeriodChartData:C,prevYearFilter:S}=await Promise.resolve().then(()=>T);return{fetchAnalyticsByPeriod:_,fetchPeriodChartData:C,prevYearFilter:S}},void 0);a.analyticsPeriodFilter=o.target.value,a.analyticsDrilldown=null;const g=a.analyticsPeriodFilter;if(a.analyticsFiscalMode==="fiscal"&&a.analyticsPeriod==="yearly"){const{fiscalYearToDateRange:_}=await A(async()=>{const{fiscalYearToDateRange:O}=await Promise.resolve().then(()=>is);return{fiscalYearToDateRange:O}},void 0),C=parseInt(g),S=_(C);_(C-1);const E=a.analyticsTab==="customers"?"get_customer_totals_by_period":"get_product_totals_by_period",{supabaseRpc:I}=await A(async()=>{const{supabaseRpc:O}=await Promise.resolve().then(()=>U);return{supabaseRpc:O}},void 0),[M,L,q]=await Promise.all([I(E,{p_date_from:S.from,p_date_to:S.to}),d("yearly",g),d("yearly",String(C-1))]);a.analyticsPeriodRows=(M??[]).map(O=>({code:String(O.code??""),name:String(O.name??""),amount:Number(O.amount??0),quantity:Number(O.quantity??0),documents:Number(O.documents??0),volumeMl:Number(O.volume_ml??0)})),a.analyticsPeriodChartData=(L??[]).map(O=>({...O})),a.analyticsPrevYearChartData=(q??[]).map(O=>({...O}))}else{const[_,C,S]=await Promise.all([l(a.analyticsTab,a.analyticsPeriod,g),d(a.analyticsPeriod,g),d(a.analyticsPeriod,m(g))]);a.analyticsPeriodRows=_,a.analyticsPeriodChartData=C,a.analyticsPrevYearChartData=S}w()}),e.querySelectorAll("[data-fiscal-mode]").forEach(o=>{o.addEventListener("click",async()=>{if(a.analyticsFiscalMode=o.dataset.fiscalMode,a.analyticsPeriod==="yearly")if(a.analyticsPeriodRows=[],a.analyticsPeriodChartData=[],a.analyticsPrevYearChartData=[],a.analyticsPeriodFilter="",a.analyticsFiscalMode==="fiscal"){const{monthToFiscalYear:l}=await A(async()=>{const{monthToFiscalYear:m}=await Promise.resolve().then(()=>is);return{monthToFiscalYear:m}},void 0),d=new Set;for(const m of a.salesAnalytics.monthlySales)d.add(l(m.month));a.analyticsPeriodOptions=[...d].sort((m,g)=>g-m).map(String)}else{const{fetchAvailablePeriods:l}=await A(async()=>{const{fetchAvailablePeriods:d}=await Promise.resolve().then(()=>T);return{fetchAvailablePeriods:d}},void 0);a.analyticsPeriodOptions=await l(a.analyticsTab,"yearly")}w()})}),e.querySelectorAll("[data-chart-metric]").forEach(o=>{o.addEventListener("click",()=>{a.analyticsChartMetric=o.dataset.chartMetric,w()})}),e.querySelectorAll("[data-analytics-drilldown]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.analyticsDrilldown??"",d=o.dataset.drilldownName??l,m=a.analyticsTab,{fetchCustomerProductBreakdown:g,fetchProductCustomerBreakdown:b,fetchEntityMonthlySales:_,periodToDateRange:C}=await A(async()=>{const{fetchCustomerProductBreakdown:M,fetchProductCustomerBreakdown:L,fetchEntityMonthlySales:q,periodToDateRange:O}=await Promise.resolve().then(()=>T);return{fetchCustomerProductBreakdown:M,fetchProductCustomerBreakdown:L,fetchEntityMonthlySales:q,periodToDateRange:O}},void 0),S=a.analyticsPeriod!=="all"&&a.analyticsPeriodFilter?C(a.analyticsPeriod,a.analyticsPeriodFilter):null,[E,I]=await Promise.all([_(l,m==="customers"?"customer":"product"),m==="customers"?g(l,S?.from,S?.to):b(l,S?.from,S?.to)]);a.analyticsDrilldown={tab:m,code:l,name:d,monthlySales:E,breakdownRows:I},w()})}),e.querySelector("[data-action='close-analytics-drilldown']")?.addEventListener("click",()=>{a.analyticsDrilldown=null,w()}),e.querySelector("#staff-filter-input")?.addEventListener("input",o=>{a.analyticsStaffFilter=o.target.value,w()}),e.querySelectorAll("[data-staff-drilldown]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.staffDrilldown??"",d=o.dataset.staffName??"",{fetchStaffCustomerBreakdown:m,fetchStaffProductBreakdown:g,periodToDateRange:b}=await A(async()=>{const{fetchStaffCustomerBreakdown:I,fetchStaffProductBreakdown:M,periodToDateRange:L}=await Promise.resolve().then(()=>T);return{fetchStaffCustomerBreakdown:I,fetchStaffProductBreakdown:M,periodToDateRange:L}},void 0),_=b(a.analyticsStaffPeriod,a.analyticsStaffPeriodFilter),C=a.analyticsStaffDrilldown?.breakdownTab??"customers",[S,E]=await Promise.all([m(l,_?.from,_?.to),g(l,_?.from,_?.to)]);a.analyticsStaffDrilldown={code:l,name:d,breakdownTab:C,customerRows:S,productRows:E},w()})}),e.querySelectorAll("[data-staff-breakdown-tab]").forEach(o=>{o.addEventListener("click",()=>{a.analyticsStaffDrilldown&&(a.analyticsStaffDrilldown={...a.analyticsStaffDrilldown,breakdownTab:o.dataset.staffBreakdownTab},w())})}),e.querySelector("[data-action='close-staff-drilldown']")?.addEventListener("click",()=>{a.analyticsStaffDrilldown=null,w()}),e.querySelector("[data-analytics-tag-filter]")?.addEventListener("input",o=>{a.analyticsTagFilter=o.target.value,w()}),e.querySelectorAll("[data-staff-period]").forEach(o=>{o.addEventListener("click",async()=>{const{fetchAvailablePeriods:l,fetchStaffTotalsByPeriod:d,periodToDateRange:m}=await A(async()=>{const{fetchAvailablePeriods:b,fetchStaffTotalsByPeriod:_,periodToDateRange:C}=await Promise.resolve().then(()=>T);return{fetchAvailablePeriods:b,fetchStaffTotalsByPeriod:_,periodToDateRange:C}},void 0),g=o.dataset.staffPeriod;if(a.analyticsStaffPeriod=g,a.analyticsStaffDrilldown=null,g==="all")a.analyticsStaffPeriodFilter="",a.analyticsStaffPeriodOptions=[],a.analyticsStaffTotals=[];else{a.analyticsStaffPeriodOptions=await l("staff",g),a.analyticsStaffPeriodFilter=a.analyticsStaffPeriodOptions[0]??"";const b=m(g,a.analyticsStaffPeriodFilter);a.analyticsStaffTotals=await d(b?.from,b?.to)}w()})}),e.querySelector("#staff-period-select")?.addEventListener("change",async o=>{const{fetchStaffTotalsByPeriod:l,periodToDateRange:d}=await A(async()=>{const{fetchStaffTotalsByPeriod:g,periodToDateRange:b}=await Promise.resolve().then(()=>T);return{fetchStaffTotalsByPeriod:g,periodToDateRange:b}},void 0);a.analyticsStaffPeriodFilter=o.target.value;const m=d(a.analyticsStaffPeriod,a.analyticsStaffPeriodFilter);a.analyticsStaffTotals=await l(m?.from,m?.to),a.analyticsStaffDrilldown=null,w()}),e.querySelector("[data-action='add-line']")?.addEventListener("click",()=>{Se(e),a.invoiceForm.lines.push({productCode:"",productName:"",quantity:0,unitPrice:0,unit:"本",amount:0}),a.invoiceErrors={},w()}),e.querySelectorAll("[data-action='remove-line']").forEach(o=>{o.addEventListener("click",()=>{Se(e);const l=parseInt(o.dataset.line??"0",10);a.invoiceForm.lines.splice(l,1),a.invoiceErrors=jn(a.invoiceForm),w()})}),e.querySelectorAll("[data-action='duplicate-line']").forEach(o=>{o.addEventListener("click",()=>{Se(e),Ld(parseInt(o.dataset.line??"0",10)),a.invoiceErrors={},w()})}),e.querySelector("[data-action='copy-past-invoice']")?.addEventListener("click",()=>{Dd(),w()}),e.querySelector("[data-action='open-customer-picker']")?.addEventListener("click",()=>{Se(e),a.pickerMode="customer",a.pickerTargetLine=null,a.pickerQuery=a.invoiceForm.customerCode||a.invoiceForm.customerName,w()}),e.querySelectorAll("[data-action='open-product-picker']").forEach(o=>{o.addEventListener("click",()=>{Se(e);const l=parseInt(o.dataset.line??"0",10),d=a.invoiceForm.lines[l];a.pickerMode="product",a.pickerTargetLine=l,a.pickerQuery=d?d.productCode||d.productName:"",w()})}),e.querySelectorAll("[data-action='modal-close']").forEach(o=>{o.addEventListener("click",l=>{o.classList.contains("modal-backdrop")&&l.target instanceof HTMLElement&&!l.target.classList.contains("modal-backdrop")||(It(),w())})}),e.querySelectorAll("[data-action='picker-select']").forEach(o=>{const l=async()=>{const d=o.dataset.code??"",m=o.dataset.name??"";if(a.pickerMode==="customer"){a.invoiceForm.customerCode=d,a.invoiceForm.customerName=m,delete a.invoiceErrors.customerCode;const g=a.masterStats?.customers.find(b=>b.code===d);a.invoicePriceGroup=g?.priceGroup||"",!a.invoicePriceGroup&&d&&(a.invoicePriceGroup=await sa(d))}else if(a.pickerMode==="product"&&a.pickerTargetLine!==null){const g=a.invoiceForm.lines[a.pickerTargetLine];if(g){g.productCode=d,g.productName=m;const b=await cn(a.invoicePriceGroup,d);b>0&&(g.unitPrice=b),g.amount=g.quantity*g.unitPrice,delete a.invoiceErrors[`lines.${a.pickerTargetLine}.productCode`],delete a.invoiceErrors[`lines.${a.pickerTargetLine}.productName`]}}It(),w()};o.addEventListener("click",l),o.addEventListener("keydown",d=>{d.key==="Enter"&&l()})}),e.querySelector("#modal-search")?.addEventListener("input",o=>{a.pickerQuery=o.target.value,w()}),e.querySelector("[data-action='invoice-clear']")?.addEventListener("click",()=>{Rn(),w()}),e.querySelector("[data-action='invoice-save']")?.addEventListener("click",()=>{Fn(e)}),e.querySelector("#inv-customer-code")?.addEventListener("blur",async()=>{Se(e),qd(a.invoiceForm.customerCode)&&(delete a.invoiceErrors.customerCode,!a.invoicePriceGroup&&a.invoiceForm.customerCode&&(a.invoicePriceGroup=await sa(a.invoiceForm.customerCode)),w())}),e.querySelector("#inv-customer-name")?.addEventListener("blur",()=>{Se(e),Id(a.invoiceForm.customerName)&&(delete a.invoiceErrors.customerCode,w())}),e.querySelectorAll("#inv-date, #inv-customer-code, #inv-customer-name, #inv-staff, #inv-note, [data-field], #inv-type").forEach(o=>{o.addEventListener("input",()=>{Se(e),a.invoiceSavedDocNo=null;const l=o.dataset.field;(l==="quantity"||l==="unitPrice")&&w()})}),e.querySelector("#inv-type")?.addEventListener("change",()=>{Se(e),a.invoiceSavedDocNo=null}),e.querySelector("[data-action='delivery-search']")?.addEventListener("click",()=>{const o=e.querySelector("#delivery-docno")?.value??"";if(a.deliverySearchDocNo=o.trim(),a.deliveryNote=null,a.actionLoading=!0,w(),!a.deliverySearchDocNo){D("伝票番号を入力してください","error"),a.actionLoading=!1,w();return}xa(a.deliverySearchDocNo).then(l=>{a.deliveryNote=l,a.actionLoading=!1,w()})}),e.querySelector("[data-action='billing-load']")?.addEventListener("click",()=>{const o=e.querySelector("#billing-month")?.value??a.billingYearMonth;a.billingYearMonth=o,a.billingSummary=null,a.actionLoading=!0,w(),Sa(o).then(l=>{a.billingSummary=l,a.actionLoading=!1,w()})}),e.querySelector("[data-action='tax-load']")?.addEventListener("click",()=>{const o=parseInt(e.querySelector("#tax-year")?.value??String(a.taxYear),10),l=parseInt(e.querySelector("#tax-month")?.value??String(a.taxMonth),10);a.taxYear=o,a.taxMonth=l,a.taxDeclaration=null,a.actionLoading=!0,w(),Pa(o,l).then(d=>{a.taxDeclaration=d,a.actionLoading=!1,w()})}),e.querySelector("[data-action='tax-export-xml']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{generateTaxXML:o}=await A(async()=>{const{generateTaxXML:b}=await Promise.resolve().then(()=>T);return{generateTaxXML:b}},void 0),l=o(a.taxDeclaration),d=new Blob([l],{type:"application/xml;charset=utf-8"}),m=URL.createObjectURL(d),g=document.createElement("a");g.href=m,g.download=`tax-${a.taxYear}-${String(a.taxMonth).padStart(2,"0")}.xml`,g.click(),URL.revokeObjectURL(m)}),e.querySelector("[data-action='tax-export-csv']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{generateTaxCSV:o}=await A(async()=>{const{generateTaxCSV:b}=await Promise.resolve().then(()=>T);return{generateTaxCSV:b}},void 0),l=o(a.taxDeclaration),d=new Blob([l],{type:"text/csv;charset=utf-8"}),m=URL.createObjectURL(d),g=document.createElement("a");g.href=m,g.download=`tax-${a.taxYear}-${String(a.taxMonth).padStart(2,"0")}.csv`,g.click(),URL.revokeObjectURL(m)}),e.querySelector("[data-action='tax-save-draft']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{saveTaxDeclaration:o}=await A(async()=>{const{saveTaxDeclaration:l}=await Promise.resolve().then(()=>T);return{saveTaxDeclaration:l}},void 0);try{await o(a.taxDeclaration),D("下書き保存しました")}catch(l){D("保存に失敗: "+(l instanceof Error?l.message:String(l)),"error")}}),e.querySelectorAll("[data-tax-row][data-tax-field]").forEach(o=>{o.addEventListener("change",async()=>{if(!a.taxDeclaration)return;const l=Number(o.dataset.taxRow),d=o.dataset.taxField,m=o.type==="number"?Number(o.value)||0:o.value,g=[...a.taxDeclaration.rows];g[l]={...g[l],[d]:m};const{recalculateTaxDeclaration:b}=await A(async()=>{const{recalculateTaxDeclaration:_}=await Promise.resolve().then(()=>T);return{recalculateTaxDeclaration:_}},void 0);a.taxDeclaration=b({...a.taxDeclaration,rows:g}),w()})}),e.querySelectorAll("[data-ded-row][data-ded-field]").forEach(o=>{o.addEventListener("change",()=>{if(!a.taxDeclaration)return;const l=Number(o.dataset.dedRow),d=o.dataset.dedField,m=o.type==="number"?Number(o.value)||0:o.value,g=[...a.taxDeclaration.deductions];g[l]={...g[l],[d]:m},a.taxDeclaration={...a.taxDeclaration,deductions:g},w()})}),e.querySelectorAll("input[data-tax-field]:not([data-tax-row])").forEach(o=>{o.addEventListener("change",()=>{if(!a.taxDeclaration)return;const l=o.dataset.taxField;a.taxDeclaration={...a.taxDeclaration,[l]:o.value}})}),e.querySelector("[data-action='tax-add-category']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{recalculateTaxDeclaration:o,TAX_RATE_CATEGORIES:l}=await A(async()=>{const{recalculateTaxDeclaration:g,TAX_RATE_CATEGORIES:b}=await Promise.resolve().then(()=>T);return{recalculateTaxDeclaration:g,TAX_RATE_CATEGORIES:b}},void 0),d=l[0],m={taxCategory:d.code,taxCategoryName:d.name,alcoholDegree:15,productionVolume:0,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:0,taxableVolume:0,volume:0,taxRate:d.taxRatePerLiter,taxAmount:0};a.taxDeclaration=o({...a.taxDeclaration,rows:[...a.taxDeclaration.rows,m]}),w()}),e.querySelectorAll("[data-action='tax-remove-category']").forEach(o=>{o.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const l=Number(o.dataset.taxRow),{recalculateTaxDeclaration:d}=await A(async()=>{const{recalculateTaxDeclaration:g}=await Promise.resolve().then(()=>T);return{recalculateTaxDeclaration:g}},void 0),m=a.taxDeclaration.rows.filter((g,b)=>b!==l);a.taxDeclaration=d({...a.taxDeclaration,rows:m}),w()})}),e.querySelector("[data-action='tax-add-deduction']")?.addEventListener("click",()=>{if(!a.taxDeclaration)return;const o={type:"export",categoryCode:"01",volume:0,reason:"",documentNo:""};a.taxDeclaration={...a.taxDeclaration,deductions:[...a.taxDeclaration.deductions,o]},w()}),e.querySelectorAll("[data-action='tax-remove-deduction']").forEach(o=>{o.addEventListener("click",()=>{if(!a.taxDeclaration)return;const l=Number(o.dataset.dedRow),d=a.taxDeclaration.deductions.filter((m,g)=>g!==l);a.taxDeclaration={...a.taxDeclaration,deductions:d},w()})}),e.querySelectorAll("[data-store-tab]").forEach(o=>{o.addEventListener("click",()=>{a.storeTab=o.dataset.storeTab,w()})}),e.querySelectorAll("[data-import-entity]").forEach(o=>{o.addEventListener("click",()=>{a.importEntity=o.dataset.importEntity,a.importPreview=null,a.importResult=null,w()})}),e.querySelector("[data-action='download-template']")?.addEventListener("click",()=>{const o=Ln(a.importEntity),l=new Blob([o],{type:"text/csv;charset=utf-8"}),d=URL.createObjectURL(l),m=document.createElement("a");m.href=d,m.download=`template_${a.importEntity}.csv`,m.click(),URL.revokeObjectURL(d)}),e.querySelector("[data-action='import-parse']")?.addEventListener("click",()=>{const l=e.querySelector("#import-file")?.files?.[0];if(!l){D("CSVファイルを選択してください","warning");return}const d=new FileReader;d.onload=()=>{const m=String(d.result??""),{columns:g,rows:b}=En(m);a.importPreview=An(a.importEntity,g,b),a.importResult=null,w()},d.readAsText(l,"utf-8")}),e.querySelector("[data-action='import-cancel']")?.addEventListener("click",()=>{a.importPreview=null,a.importResult=null,w()}),e.querySelectorAll("[data-print-template]").forEach(o=>{o.addEventListener("click",()=>{a.printTemplate=o.dataset.printTemplate,w()})}),e.querySelectorAll("[data-print-field]").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.printField;let d=o.value;(l==="taxRate"||l==="previousBalance"||l==="paymentAmount")&&(d=Number(o.value)||0),a.printData={...a.printData,[l]:d},w()})}),e.querySelectorAll("[data-print-opt]").forEach(o=>{const l=()=>{const d=o.dataset.printOpt;let m;o.type==="checkbox"?m=o.checked:d==="copies"?m=Number(o.value)||1:d==="overlayOpacity"||d==="calibrationOffsetX"||d==="calibrationOffsetY"?m=Number(o.value)||0:m=o.value,a.printOptions={...a.printOptions,[d]:m},w()};o.addEventListener("change",l),o.type==="range"&&o.addEventListener("input",l)}),e.querySelectorAll("[data-print-line][data-print-lfield]").forEach(o=>{o.addEventListener("change",()=>{const l=Number(o.dataset.printLine),d=o.dataset.printLfield,m=[...a.printData.lines];let g=o.value;(d==="quantity"||d==="unitPrice")&&(g=Number(o.value)||0),m[l]={...m[l],[d]:g},m[l].amount=(Number(m[l].quantity)||0)*(Number(m[l].unitPrice)||0),a.printData={...a.printData,lines:m},w()})}),e.querySelector("[data-action='print-add-line']")?.addEventListener("click",()=>{a.printData={...a.printData,lines:[...a.printData.lines,{productCode:"",productName:"",spec:"",quantity:0,unit:"本",unitPrice:0,amount:0}]},w()}),e.querySelectorAll("[data-action='print-remove-line']").forEach(o=>{o.addEventListener("click",()=>{const l=Number(o.dataset.printLine);a.printData={...a.printData,lines:a.printData.lines.filter((d,m)=>m!==l)},w()})}),e.querySelector("[data-action='print-save-settings']")?.addEventListener("click",()=>{try{localStorage.setItem("sake_print_options",JSON.stringify(a.printOptions)),localStorage.setItem("sake_print_company",JSON.stringify(a.printCompany)),D("印刷設定を保存しました")}catch(o){D("保存失敗: "+(o instanceof Error?o.message:String(o)),"error")}}),e.querySelector("[data-action='print-open-company']")?.addEventListener("click",()=>{const o=a.printCompany,l=prompt("会社名",o.name);if(l===null)return;const d=prompt("郵便番号",o.postalCode)??o.postalCode,m=prompt("住所",o.address1)??o.address1,g=prompt("TEL",o.tel)??o.tel,b=prompt("FAX",o.fax)??o.fax,_=prompt("適格請求書登録番号 (T+13桁)",o.registrationNo)??o.registrationNo,C=prompt("取引銀行名",o.bankName)??o.bankName,S=prompt("支店名",o.bankBranch)??o.bankBranch,E=prompt("口座番号",o.bankAccountNo)??o.bankAccountNo,I=prompt("口座名義",o.bankAccountHolder)??o.bankAccountHolder;a.printCompany={...o,name:l,postalCode:d,address1:m,tel:g,fax:b,registrationNo:_,bankName:C,bankBranch:S,bankAccountNo:E,bankAccountHolder:I},w()}),e.querySelector("[data-action='fd-toggle-design']")?.addEventListener("click",()=>{a.fdDesignMode=!a.fdDesignMode,w()}),e.querySelector("[data-action='fd-save-cloud']")?.addEventListener("click",async()=>{const o=e.querySelector(".fd-canvas");if(!o)return;const d=(e.querySelector("#fd-layout-name")?.value??"").trim()||"デフォルト",m=Yt(o),{savePrintLayout:g}=await A(async()=>{const{savePrintLayout:_}=await Promise.resolve().then(()=>T);return{savePrintLayout:_}},void 0),b={id:`bp1701_${d.replaceAll(/[^a-zA-Z0-9_-]/g,"_")}_${Date.now()}`,name:d,templateKey:"chain_store",positions:m};try{await g(b)?(D(`クラウド保存成功: ${d}`),a.fdSavedPositions=m,localStorage.setItem("sake_fd_positions",JSON.stringify(m)),w()):(D("クラウド保存に失敗しました。ローカルには保存されました","warning"),localStorage.setItem("sake_fd_positions",JSON.stringify(m)))}catch(_){D("保存エラー: "+(_ instanceof Error?_.message:""),"error")}}),e.querySelector("[data-action='fd-save-local']")?.addEventListener("click",()=>{const o=e.querySelector(".fd-canvas");if(!o)return;const l=Yt(o);a.fdSavedPositions=l;try{localStorage.setItem("sake_fd_positions",JSON.stringify(l)),D(`ローカル保存完了: ${Object.keys(l).length}件`)}catch(d){D("保存失敗: "+(d instanceof Error?d.message:""),"error")}}),e.querySelector("[data-action='fd-export-json']")?.addEventListener("click",()=>{const o=e.querySelector(".fd-canvas");if(!o)return;const d={templateKey:"chain_store",positions:Yt(o),exportedAt:new Date().toISOString()},m=new Blob([JSON.stringify(d,null,2)],{type:"application/json"}),g=URL.createObjectURL(m),b=document.createElement("a");b.href=g,b.download=`bp1701_layout_${new Date().toISOString().slice(0,10)}.json`,b.click(),URL.revokeObjectURL(g)}),e.querySelector("[data-action='fd-import-json']")?.addEventListener("click",()=>{e.querySelector("#fd-import-file")?.click()}),e.querySelector("#fd-import-file")?.addEventListener("change",async o=>{const l=o.target.files?.[0];if(l)try{const d=await l.text(),g=JSON.parse(d).positions;if(!g)throw new Error("positions field not found");a.fdSavedPositions=g,localStorage.setItem("sake_fd_positions",JSON.stringify(g)),D(`インポート成功: ${Object.keys(g).length}件`),w()}catch(d){D("インポート失敗: "+(d instanceof Error?d.message:""),"error")}});const $=e.querySelector("#fd-saved-layouts");$&&a.route==="/form-designer"&&a.fdDesignMode&&(async()=>{const{fetchPrintLayouts:o}=await A(async()=>{const{fetchPrintLayouts:d}=await Promise.resolve().then(()=>T);return{fetchPrintLayouts:d}},void 0),l=await o("chain_store");l.length===0?$.innerHTML="☁️ クラウドに保存されたレイアウトはありません":($.innerHTML=`☁️ クラウド保存済み (${l.length}件):<br/>`+l.map(d=>`<button class="button-sm secondary" data-action="fd-load-layout" data-layout-id="${d.id}" style="margin:4px 4px 0 0;">${d.name}</button>
                 <button class="button-sm secondary" data-action="fd-delete-layout" data-layout-id="${d.id}" title="削除" style="margin:4px 8px 0 0;color:var(--danger);">✕</button>`).join(""),$.querySelectorAll("[data-action='fd-load-layout']").forEach(d=>{d.addEventListener("click",()=>{const m=d.dataset.layoutId,g=l.find(b=>b.id===m);g&&(a.fdSavedPositions=g.positions,localStorage.setItem("sake_fd_positions",JSON.stringify(g.positions)),D(`読込完了: ${g.name}`),w())})}),$.querySelectorAll("[data-action='fd-delete-layout']").forEach(d=>{d.addEventListener("click",async()=>{const m=d.dataset.layoutId;if(!m||!await fe("このレイアウトを削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deletePrintLayout:g}=await A(async()=>{const{deletePrintLayout:_}=await Promise.resolve().then(()=>T);return{deletePrintLayout:_}},void 0);await g(m)?(D("削除しました"),w()):D("削除失敗","error")})}))})(),e.querySelector("[data-action='fd-reset-positions']")?.addEventListener("click",async()=>{await fe("フィールド位置を初期値に戻しますか？")&&(a.fdSavedPositions=null,localStorage.removeItem("sake_fd_positions"),w())});const x=e.querySelector("#fd-sel-x"),k=e.querySelector("#fd-sel-y");[x,k].forEach(o=>{o?.addEventListener("change",()=>{if(!a.fdActiveFieldId)return;const l=document.querySelector(`[data-fd-id="${a.fdActiveFieldId}"]`);l&&(x&&(l.style.left=x.value+"mm"),k&&(l.style.top=k.value+"mm"))})}),e.querySelectorAll(".wf-card").forEach(o=>{o.addEventListener("dragstart",l=>{o.classList.add("wf-dragging"),l.dataTransfer?.setData("text/plain",o.dataset.wfOrder??"")}),o.addEventListener("dragend",()=>o.classList.remove("wf-dragging"))}),e.querySelectorAll(".wf-col").forEach(o=>{o.addEventListener("dragover",l=>l.preventDefault()),o.addEventListener("drop",l=>{l.preventDefault();const d=l.dataTransfer?.getData("text/plain"),m=o.dataset.wfStage;if(!d||!m)return;const g=a.workflowOrders.find(b=>b.id===d);g&&(g.stage=m,w())})}),e.querySelectorAll("[data-mo-step]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.moStep;o.disabled||(a.mobileOrder.step=l,w())})}),e.querySelector("#mo-customer-q")?.addEventListener("input",o=>{a.mobileOrder.customerQuery=o.target.value,w()}),e.querySelector("#mo-product-q")?.addEventListener("input",o=>{a.mobileOrder.productQuery=o.target.value,w()}),e.querySelectorAll("[data-mo-select-customer]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.moSelectCustomer,d=a.masterStats?.customers.find(m=>m.id===l);d&&(a.mobileOrder.selectedCustomer=d),w()})}),e.querySelectorAll("[data-mo-add-product]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.moAddProduct,d=a.masterStats?.products.find(g=>g.code===l);if(!d)return;const m=1800;a.mobileOrder.cart.push({productCode:d.code,productName:d.name,quantity:1,unit:"本",unitPrice:m,amount:m}),w()})}),e.querySelectorAll("[data-mo-qty]").forEach(o=>{o.addEventListener("click",()=>{const l=Number(o.dataset.moQty),d=o.dataset.moProduct,m=a.mobileOrder.cart.find(g=>g.productCode===d);m&&(m.quantity=Math.max(0,m.quantity+l),m.amount=m.quantity*m.unitPrice,m.quantity===0&&(a.mobileOrder.cart=a.mobileOrder.cart.filter(g=>g.productCode!==d)),w())})}),e.querySelectorAll("[data-mo-remove]").forEach(o=>{o.addEventListener("click",()=>{const l=Number(o.dataset.moRemove);a.mobileOrder.cart.splice(l,1),w()})}),e.querySelector("[data-action='mo-submit']")?.addEventListener("click",async()=>{const o=e.querySelector("#mo-memo");a.mobileOrder.memo=o?.value??"";const l="MO"+Date.now().toString().slice(-8);a.mobileOrder.submittedDocNo=l,a.mobileOrder.step="done",w()}),e.querySelector("[data-action='mo-reset']")?.addEventListener("click",()=>{a.mobileOrder={step:"customer",selectedCustomer:null,cart:[],customerQuery:"",productQuery:"",memo:"",submittedDocNo:null},w()}),e.querySelectorAll("[data-tour-id]").forEach(o=>{o.addEventListener("click",()=>{a.tourActiveId=o.dataset.tourId??null,w()})}),e.querySelectorAll("[data-action='tour-insert-template']").forEach(o=>{o.addEventListener("click",()=>{const l=a.tourInquiries.find(_=>_.id===a.tourActiveId);if(!l)return;const d=o.dataset.template==="confirm"?Ql:Hl,m=e.querySelector("#tour-confirmed-time"),g=d.replaceAll("{name}",l.name).replaceAll("{partySize}",String(l.partySize)).replaceAll("{confirmedTime}",m?.value??l.visitDate),b=e.querySelector("#tour-reply-body");b&&(b.value=g)})}),e.querySelector("[data-action='tour-send-reply']")?.addEventListener("click",()=>{const o=document.querySelector("[data-action='tour-send-reply']")?.dataset.tourId??"",l=a.tourInquiries.find(m=>m.id===o);if(!l)return;const d=e.querySelector("#tour-confirmed-time");l.status="confirmed",l.repliedAt=new Date().toISOString(),l.confirmedTime=d?.value??"",D("返信メールを下書き保存し、ステータスを確定にしました"),w()}),e.querySelector("[data-action='lb-search']")?.addEventListener("click",async()=>{const o=e.querySelector("#lb-type")?.value??"",l=e.querySelector("#lb-area")?.value??"",d=e.querySelector("#lb-keyword")?.value??"";if(!o&&!d){D("業種かキーワードを入力してください","warning");return}a.leadSearchType=o,a.leadSearchArea=l,a.leadSearchQuery=d,a.leadSearching=!0,w();const m=a.integrations.find(C=>C.provider==="google_maps");if(!m||!m.config.api_key){D("Google Maps APIキーが /integrations で未設定です","warning"),a.leadSearching=!1,w();return}const{searchPlaces:g}=await A(async()=>{const{searchPlaces:C}=await Promise.resolve().then(()=>T);return{searchPlaces:C}},void 0),b=[o,d].filter(Boolean).join(" "),_=await g(m,b,l);a.leadSearching=!1,_.error?D("検索失敗: "+_.error,"error"):a.leadSearchResults=_.results,w()}),e.querySelector("[data-action='lb-clear-search']")?.addEventListener("click",()=>{a.leadSearchResults=[],w()}),e.querySelector("[data-action='lb-save-list']")?.addEventListener("click",async()=>{if(a.leadSearchResults.length===0)return;const o=prompt("リスト名を入力:",`${a.leadSearchType} ${a.leadSearchArea}`);if(!o)return;const l=`ll_${Date.now()}`,d={id:l,name:o,query:a.leadSearchQuery,area:a.leadSearchArea,businessType:a.leadSearchType,totalCount:a.leadSearchResults.length,source:"google_places"},{saveLeadList:m,saveLeadItem:g,fetchLeadLists:b,fetchLeadItems:_}=await A(async()=>{const{saveLeadList:E,saveLeadItem:I,fetchLeadLists:M,fetchLeadItems:L}=await Promise.resolve().then(()=>T);return{saveLeadList:E,saveLeadItem:I,fetchLeadLists:M,fetchLeadItems:L}},void 0);await m(d);const C=e.querySelectorAll(".lb-search-check:checked"),S=Array.from(C).map(E=>Number(E.dataset.idx));for(const E of S){const I=a.leadSearchResults[E];I&&await g({...I,id:`li_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,listId:l,businessType:a.leadSearchType})}a.leadLists=await b(),a.leadActiveListId=l,a.leadItems=await _(l),a.leadSearchResults=[],D(`${S.length}件を「${o}」として保存しました`),w()}),e.querySelectorAll("[data-action='lb-select-list']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.id??null;if(a.leadActiveListId=l,l){const{fetchLeadItems:d}=await A(async()=>{const{fetchLeadItems:m}=await Promise.resolve().then(()=>T);return{fetchLeadItems:m}},void 0);a.leadItems=await d(l)}w()})}),e.querySelectorAll("[data-action='lb-exclude']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.id??"",d=a.leadItems.find(b=>b.id===l);if(!d)return;const{saveLeadItem:m,fetchLeadItems:g}=await A(async()=>{const{saveLeadItem:b,fetchLeadItems:_}=await Promise.resolve().then(()=>T);return{saveLeadItem:b,fetchLeadItems:_}},void 0);await m({...d,status:"excluded"}),a.leadActiveListId&&(a.leadItems=await g(a.leadActiveListId)),w()})}),e.querySelectorAll("[data-action='lb-convert-one']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.id??"",d=a.leadItems.find(_=>_.id===l);if(!d)return;const{convertLeadToProspect:m,fetchLeadItems:g}=await A(async()=>{const{convertLeadToProspect:_,fetchLeadItems:C}=await Promise.resolve().then(()=>T);return{convertLeadToProspect:_,fetchLeadItems:C}},void 0);await m(d)&&(D("見込客に追加しました: "+d.companyName),a.leadActiveListId&&(a.leadItems=await g(a.leadActiveListId)),w())})}),e.querySelector("[data-action='lb-bulk-convert']")?.addEventListener("click",async()=>{const o=e.querySelectorAll(".lb-item-check:checked");if(o.length===0&&!await fe("全ての新規アイテムを見込客に変換しますか？"))return;const l=o.length>0?Array.from(o).map(b=>b.dataset.id):a.leadItems.filter(b=>b.status==="new").map(b=>b.id),{convertLeadToProspect:d,fetchLeadItems:m}=await A(async()=>{const{convertLeadToProspect:b,fetchLeadItems:_}=await Promise.resolve().then(()=>T);return{convertLeadToProspect:b,fetchLeadItems:_}},void 0);let g=0;for(const b of l){const _=a.leadItems.find(C=>C.id===b);_&&_.status==="new"&&await d(_)&&g++}D(`${g}件を見込客に変換しました`),a.leadActiveListId&&(a.leadItems=await m(a.leadActiveListId)),w()}),e.querySelectorAll("[data-map-filter]").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.mapFilter;let d;o.type==="checkbox"?d=o.checked:d=o.value,a.mapFilters={...a.mapFilters,[l]:d},w()})}),e.querySelectorAll(".churn-reason-select").forEach(o=>{o.addEventListener("change",async()=>{const l=o.dataset.churnCode??"",d=o.value;try{const{saveChurnNote:m}=await A(async()=>{const{saveChurnNote:_}=await Promise.resolve().then(()=>T);return{saveChurnNote:_}},void 0);await m({customerCode:l,reason:d,memo:"",actionedAt:null});const g=a.churnNotes.find(_=>_.customerCode===l);g?g.reason=d:a.churnNotes.push({customerCode:l,reason:d,memo:"",actionedAt:null,updatedAt:new Date().toISOString()});const b=o.closest("tr");if(b){const _=b.querySelector("td:nth-child(2)");if(_){let C=_.querySelector(".reason-badge");!C&&d&&(C=document.createElement("span"),C.className="status-pill info reason-badge",C.style.fontSize="0.72rem",_.appendChild(C)),C&&(C.textContent=d?$d[d]??"":"")}}D("理由を保存しました")}catch(m){D("保存に失敗しました","error"),console.error(m)}})}),e.querySelectorAll(".churn-actioned-check").forEach(o=>{o.addEventListener("change",async()=>{const l=o.dataset.churnCode??"",d=o.checked,m=o.closest("tr");m&&(m.style.opacity=d?"0.45":"",m.setAttribute("data-actioned",d?"1":"0"));try{const{saveChurnNote:g}=await A(async()=>{const{saveChurnNote:S}=await Promise.resolve().then(()=>T);return{saveChurnNote:S}},void 0),b=a.churnNotes.find(S=>S.customerCode===l),_=b?.reason??"",C=new Date().toISOString().slice(0,10);await g({customerCode:l,reason:_,memo:"",actionedAt:d?C:null}),b?b.actionedAt=d?C:null:a.churnNotes.push({customerCode:l,reason:_,memo:"",actionedAt:d?C:null,updatedAt:new Date().toISOString()}),D(d?"対応済みにしました":"対応済みを解除しました")}catch(g){D("保存に失敗しました","error"),console.error(g)}})}),e.querySelector("[data-action='ivry-sync']")?.addEventListener("click",async()=>{const o=a.integrations.find(g=>g.provider==="ivry");if(!o||!o.isEnabled){D("IVRy連携が無効です。/integrations で有効化してください","warning");return}const{syncIvryCallLogs:l,fetchCallLogs:d}=await A(async()=>{const{syncIvryCallLogs:g,fetchCallLogs:b}=await Promise.resolve().then(()=>T);return{syncIvryCallLogs:g,fetchCallLogs:b}},void 0),m=await l(o);m.error?D("同期失敗: "+m.error,"error"):(D(`${m.count}件の通話履歴を同期しました`),a.callLogs=await d(100),w())}),e.querySelector("[data-action='ivry-push-phonebook']")?.addEventListener("click",async()=>{const o=a.integrations.find(g=>g.provider==="ivry");if(!o||!o.isEnabled){D("IVRy連携が無効です","warning");return}if(!await fe("全ての取引先と見込客の電話帳をIVRyに送信しますか？"))return;const{syncPhoneBookToIvry:l}=await A(async()=>{const{syncPhoneBookToIvry:g}=await Promise.resolve().then(()=>T);return{syncPhoneBookToIvry:g}},void 0),d=[];a.masterStats?.customers.forEach(g=>{d.push({name:g.name,phone:"",customerCode:g.code,note:"既存取引先"})}),a.prospects.forEach(g=>{g.phone&&d.push({name:g.companyName,phone:g.phone,customerCode:g.id,note:`見込客 (${g.stage})`})});const m=await l(o,d);m.error?D("送信失敗: "+m.error,"error"):D(`${m.synced}件の連絡先を送信しました`)}),e.querySelectorAll("[data-action='call-link-customer']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.id??"",d=o.dataset.phone??"",m=prompt(`電話番号 ${d} を顧客コードに紐付け
顧客コードを入力:`);if(!m)return;const g=a.callLogs.find(C=>C.id===l);if(!g)return;const{saveCallLog:b,fetchCallLogs:_}=await A(async()=>{const{saveCallLog:C,fetchCallLogs:S}=await Promise.resolve().then(()=>T);return{saveCallLog:C,fetchCallLogs:S}},void 0);await b({...g,matchedCustomerCode:m}),a.callLogs=await _(100),w()})}),e.querySelectorAll("[data-action='call-memo']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.id??"",d=a.callLogs.find(_=>_.id===l);if(!d)return;const m=prompt("メモを入力:",d.notes??"");if(m===null)return;const{saveCallLog:g,fetchCallLogs:b}=await A(async()=>{const{saveCallLog:_,fetchCallLogs:C}=await Promise.resolve().then(()=>T);return{saveCallLog:_,fetchCallLogs:C}},void 0);await g({...d,notes:m}),a.callLogs=await b(100),w()})}),e.querySelectorAll("[data-prospect-view]").forEach(o=>{o.addEventListener("click",()=>{a.prospectViewMode=o.dataset.prospectView,w()})}),e.querySelector("[data-action='prospect-new']")?.addEventListener("click",()=>{a.prospectEditingId="__new__",w()}),e.querySelectorAll("[data-action='prospect-edit']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.id??null;if(a.prospectEditingId=l,l){const{fetchProspectActivities:d}=await A(async()=>{const{fetchProspectActivities:m}=await Promise.resolve().then(()=>T);return{fetchProspectActivities:m}},void 0);a.prospectActivities=await d(l)}w()})}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.prospectId??null;if(a.prospectEditingId=l,l){const{fetchProspectActivities:d}=await A(async()=>{const{fetchProspectActivities:m}=await Promise.resolve().then(()=>T);return{fetchProspectActivities:m}},void 0);a.prospectActivities=await d(l)}w()})}),e.querySelectorAll("[data-action='prospect-close']").forEach(o=>{o.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(a.prospectEditingId=null,a.prospectActivities=[],w())})}),e.querySelector("[data-action='prospect-save']")?.addEventListener("click",async()=>{const o=a.prospectEditingId==="__new__",l=o?`p_${Date.now()}`:a.prospectEditingId??"",d={id:l,companyName:e.querySelector("#prospect-company")?.value??"",contactName:e.querySelector("#prospect-contact")?.value??"",email:e.querySelector("#prospect-email")?.value??"",phone:e.querySelector("#prospect-phone")?.value??"",businessType:e.querySelector("#prospect-business-type")?.value??"",stage:e.querySelector("#prospect-stage")?.value??"cold",source:e.querySelector("#prospect-source")?.value??"",expectedAmount:Number(e.querySelector("#prospect-amount")?.value)||0,probability:Number(e.querySelector("#prospect-probability")?.value)||0,assignedStaffCode:e.querySelector("#prospect-staff")?.value??"",nextActionDate:e.querySelector("#prospect-next-date")?.value??"",nextAction:e.querySelector("#prospect-next-action")?.value??"",note:e.querySelector("#prospect-note")?.value??""};if(!d.companyName){D("会社名は必須です","warning");return}const{saveProspect:m,fetchProspects:g,recordAudit:b,sendSlackNotification:_}=await A(async()=>{const{saveProspect:S,fetchProspects:E,recordAudit:I,sendSlackNotification:M}=await Promise.resolve().then(()=>T);return{saveProspect:S,fetchProspects:E,recordAudit:I,sendSlackNotification:M}},void 0);await m(d)?(o&&await _("new_prospect",`新規見込客: ${d.companyName} / 想定 ¥${d.expectedAmount.toLocaleString("ja-JP")}`).catch(()=>{}),await b({action:o?"prospect_create":"prospect_update",entityType:"prospect",entityId:l,userEmail:a.user?.email}),a.prospects=await g(),a.prospectEditingId=null,w()):D("保存失敗","error")}),e.querySelectorAll("[data-action='prospect-delete']").forEach(o=>{o.addEventListener("click",async()=>{if(!await fe("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=o.dataset.id??"",{deleteProspect:d,fetchProspects:m}=await A(async()=>{const{deleteProspect:g,fetchProspects:b}=await Promise.resolve().then(()=>T);return{deleteProspect:g,fetchProspects:b}},void 0);await d(l)&&(a.prospects=await m(),w())})}),e.querySelector("[data-action='prospect-add-activity']")?.addEventListener("click",async()=>{const o=e.querySelector("[data-action='prospect-add-activity']")?.dataset.id??"",l=e.querySelector("#prospect-activity-type")?.value??"call",d=e.querySelector("#prospect-activity-title")?.value??"";if(!d){D("内容を入力してください","warning");return}const{saveProspectActivity:m,fetchProspectActivities:g}=await A(async()=>{const{saveProspectActivity:b,fetchProspectActivities:_}=await Promise.resolve().then(()=>T);return{saveProspectActivity:b,fetchProspectActivities:_}},void 0);await m({id:`act_${Date.now()}`,prospectId:o,activityType:l,title:d,activityDate:new Date().toISOString(),staffCode:a.myProfile?.staffCode}),a.prospectActivities=await g(o),w()}),e.querySelectorAll(".pk-card[data-prospect-id]").forEach(o=>{o.addEventListener("dragstart",l=>{l.dataTransfer?.setData("text/plain",o.dataset.prospectId??"")})}),e.querySelectorAll(".pk-col[data-prospect-stage]").forEach(o=>{o.addEventListener("dragover",l=>l.preventDefault()),o.addEventListener("drop",async l=>{l.preventDefault();const d=l.dataTransfer?.getData("text/plain"),m=o.dataset.prospectStage;if(!d)return;const g=a.prospects.find(b=>b.id===d);if(g&&g.stage!==m){const b={...g,stage:m},{saveProspect:_}=await A(async()=>{const{saveProspect:C}=await Promise.resolve().then(()=>T);return{saveProspect:C}},void 0);await _(b),g.stage=m,w()}})}),e.querySelector("[data-action='slack-save']")?.addEventListener("click",async()=>{const{fetchIntegrationSettings:o,saveIntegrationSetting:l}=await A(async()=>{const{fetchIntegrationSettings:C,saveIntegrationSetting:S}=await Promise.resolve().then(()=>T);return{fetchIntegrationSettings:C,saveIntegrationSetting:S}},void 0),m=(a.integrations.length>0?a.integrations:await o()).find(C=>C.provider==="slack");if(!m)return;const g=e.querySelector("#slack-webhook")?.value??"",b=e.querySelector("#slack-default-channel")?.value??"",_=e.querySelector("#slack-enabled")?.checked??!1;await l({...m,config:{...m.config,webhook_url:g,default_channel:b},isEnabled:_}),a.integrations=await o(),D("保存しました"),w()}),e.querySelector("[data-action='slack-save-rules']")?.addEventListener("click",async()=>{const{saveSlackRule:o,fetchSlackRules:l}=await A(async()=>{const{saveSlackRule:d,fetchSlackRules:m}=await Promise.resolve().then(()=>T);return{saveSlackRule:d,fetchSlackRules:m}},void 0);for(const d of a.slackRules){const m=e.querySelector(`[data-slack-rule-id="${d.id}"][data-slack-field="enabled"]`)?.checked??d.enabled,g=e.querySelector(`[data-slack-rule-id="${d.id}"][data-slack-field="channel"]`)?.value??d.channel;await o({...d,enabled:m,channel:g})}a.slackRules=await l(),D("ルールを保存しました"),w()}),e.querySelector("[data-action='slack-test']")?.addEventListener("click",async()=>{const{sendSlackNotification:o}=await A(async()=>{const{sendSlackNotification:d}=await Promise.resolve().then(()=>T);return{sendSlackNotification:d}},void 0),l=await o("new_order","🧪 これはテスト通知です (syusen-cloud)");l.ok?D("テスト送信成功"):D("送信失敗: "+(l.error??""),"error")}),e.querySelector("[data-action='material-receive']")?.addEventListener("click",()=>{a.materialEditing=null,a.materialEditingIsNew=!0,w()}),e.querySelectorAll("[data-action='material-adjust']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.id??"",d=a.materialList.find(m=>m.id===l);d&&(a.materialEditing=d,a.materialEditingIsNew=!1,w())})}),e.querySelectorAll("[data-action='material-close']").forEach(o=>{o.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(a.materialEditing=null,a.materialEditingIsNew=!1,w())})}),e.querySelector("[data-action='material-save']")?.addEventListener("click",async()=>{const l={id:a.materialEditingIsNew?`mat_${Date.now()}`:a.materialEditing?.id??"",code:e.querySelector("#mat-code")?.value??"",name:e.querySelector("#mat-name")?.value??"",unit:e.querySelector("#mat-unit")?.value??"個",currentStock:Number(e.querySelector("#mat-stock")?.value)||0,minimumStock:Number(e.querySelector("#mat-min")?.value)||0,unitCost:Number(e.querySelector("#mat-cost")?.value)||0,lastUpdated:e.querySelector("#mat-last-date")?.value??new Date().toISOString().slice(0,10)};if(l.materialType=e.querySelector("#mat-type")?.value??"",!l.code||!l.name){D("コードと品名は必須です","warning");return}const{saveMaterial:d,fetchMaterialList:m}=await A(async()=>{const{saveMaterial:b,fetchMaterialList:_}=await Promise.resolve().then(()=>T);return{saveMaterial:b,fetchMaterialList:_}},void 0);await d(l)?(a.materialList=await m(),a.materialEditing=null,a.materialEditingIsNew=!1,D("保存しました"),w()):D("保存失敗","error")}),e.querySelector("[data-action='material-delete']")?.addEventListener("click",async()=>{const o=document.querySelector("[data-action='material-delete']")?.dataset.id??"";if(!o||!await fe("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deleteMaterial:l,fetchMaterialList:d}=await A(async()=>{const{deleteMaterial:m,fetchMaterialList:g}=await Promise.resolve().then(()=>T);return{deleteMaterial:m,fetchMaterialList:g}},void 0);await l(o)&&(a.materialList=await d(),a.materialEditing=null,w())}),e.querySelector("[data-action='user-new']")?.addEventListener("click",()=>{a.userEditingId="__new__",w()}),e.querySelectorAll("[data-action='user-edit']").forEach(o=>{o.addEventListener("click",()=>{a.userEditingId=o.dataset.id??null,w()})}),e.querySelector("[data-action='user-cancel']")?.addEventListener("click",()=>{a.userEditingId=null,w()}),e.querySelector("[data-action='user-save']")?.addEventListener("click",async()=>{const o=a.userEditingId==="__new__",l=o?crypto.randomUUID():a.userEditingId??"",d=e.querySelector("#user-email")?.value.trim()??"",m=e.querySelector("#user-name")?.value.trim()??"";if(!d||!m){D("名前とメールアドレスは必須です","warning");return}const g={id:l,email:d,displayName:m,staffCode:e.querySelector("#user-code")?.value??"",department:e.querySelector("#user-dept")?.value??"all",role:e.querySelector("#user-role")?.value??"staff",phone:e.querySelector("#user-phone")?.value??"",isActive:e.querySelector("#user-active")?.checked??!0};if(o){const E=e.querySelector("#user-password")?.value??"";if(E.length<8){D("パスワードは8文字以上必要です","warning");return}try{await za(d,E)}catch(I){D("Auth登録失敗: "+(I instanceof Error?I.message:""),"error");return}}const{saveUserProfile:b,fetchUserProfiles:_,recordAudit:C}=await A(async()=>{const{saveUserProfile:E,fetchUserProfiles:I,recordAudit:M}=await Promise.resolve().then(()=>T);return{saveUserProfile:E,fetchUserProfiles:I,recordAudit:M}},void 0);await b(g)?(await C({action:o?"user_create":"user_update",entityType:"user",entityId:l,userEmail:a.user?.email}),a.userProfiles=await _(),a.userEditingId=null,D("保存しました"),w()):D("保存失敗","error")}),e.querySelectorAll("[data-action='user-delete']").forEach(o=>{o.addEventListener("click",async()=>{if(!await fe("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=o.dataset.id??"",{deleteUserProfile:d,fetchUserProfiles:m,recordAudit:g}=await A(async()=>{const{deleteUserProfile:_,fetchUserProfiles:C,recordAudit:S}=await Promise.resolve().then(()=>T);return{deleteUserProfile:_,fetchUserProfiles:C,recordAudit:S}},void 0);await d(l)?(await g({action:"user_delete",entityType:"user",entityId:l,userEmail:a.user?.email}),a.userProfiles=await m(),w()):D("削除失敗","error")})}),e.querySelector("[data-action='profile-save-sender']")?.addEventListener("click",async()=>{if(!a.myProfile)return;const o=e.querySelector("#profile-sender")?.value??"",l={...a.myProfile,defaultMailSenderId:o},{saveUserProfile:d}=await A(async()=>{const{saveUserProfile:m}=await Promise.resolve().then(()=>T);return{saveUserProfile:m}},void 0);await d(l),a.myProfile=l,D("保存しました"),w()}),e.querySelector("[data-action='profile-change-password']")?.addEventListener("click",async()=>{const o=e.querySelector("#profile-new-password")?.value??"";if(o.length<8){D("8文字以上のパスワードを入力してください","warning");return}try{await Wn(o),D("パスワードを変更しました")}catch(l){D("変更失敗: "+(l instanceof Error?l.message:""),"error")}}),e.querySelectorAll("[data-action='int-edit']").forEach(o=>{o.addEventListener("click",()=>{a.integrationEditingId=o.dataset.id??null,w()})}),e.querySelector("[data-action='int-cancel']")?.addEventListener("click",()=>{a.integrationEditingId=null,w()}),e.querySelector("[data-action='int-save']")?.addEventListener("click",async()=>{const o=document.querySelector("[data-action='int-save']")?.dataset.id??"",l=a.integrations.find(C=>C.id===o);if(!l)return;const d={...l.config};Object.keys(d).forEach(C=>{const S=e.querySelector(`#int-${C}`);S&&(d[C]=S.value)});const m=e.querySelector("#int-enabled")?.checked??!1,{saveIntegrationSetting:g,fetchIntegrationSettings:b}=await A(async()=>{const{saveIntegrationSetting:C,fetchIntegrationSettings:S}=await Promise.resolve().then(()=>T);return{saveIntegrationSetting:C,fetchIntegrationSettings:S}},void 0);await g({...l,config:d,isEnabled:m})?(a.integrations=await b(),a.integrationEditingId=null,D("保存しました"),w()):D("保存失敗","error")}),e.querySelectorAll("[data-action='int-sync-shopify'], [data-action='shopify-sync']").forEach(o=>{o.addEventListener("click",async()=>{const l=a.integrations.find(b=>b.provider==="shopify");if(!l){D("Shopify連携が未設定です","warning");return}o.textContent="同期中…",o.disabled=!0;const{syncShopifyOrders:d,fetchShopifyOrders:m}=await A(async()=>{const{syncShopifyOrders:b,fetchShopifyOrders:_}=await Promise.resolve().then(()=>T);return{syncShopifyOrders:b,fetchShopifyOrders:_}},void 0),g=await d(l);g.error?D("同期失敗: "+g.error,"error"):(D(`${g.count}件を同期しました`),a.shopifyOrders=await m()),w()})}),e.querySelectorAll("[data-action='int-sync-gcal']").forEach(o=>{o.addEventListener("click",async()=>{const l=a.integrations.find(b=>b.provider==="google_calendar");if(!l)return;o.textContent="同期中…",o.disabled=!0;const{syncGoogleCalendar:d,fetchCalendarEvents:m}=await A(async()=>{const{syncGoogleCalendar:b,fetchCalendarEvents:_}=await Promise.resolve().then(()=>T);return{syncGoogleCalendar:b,fetchCalendarEvents:_}},void 0),g=await d(l);g.error?D("同期失敗: "+g.error,"error"):(D(`${g.count}件を同期しました`),a.calendarEvents=await m(a.calendarYearMonth)),w()})}),e.querySelector("[data-action='fax-upload']")?.addEventListener("click",async()=>{const l=e.querySelector("#fax-file")?.files?.[0];if(!l){D("FAX画像を選択してください","warning");return}const d=a.integrations.find(m=>m.provider==="cloud_vision");if(!d||!d.config.api_key){D("Cloud Vision API Key が設定されていません。/integrations で設定してください","warning");return}a.faxProcessing=!0,a.faxOcrText=null,w();try{const m=new FileReader;m.onload=async()=>{const g=String(m.result??""),{ocrFaxImage:b,saveFaxRecord:_,fetchFaxInbox:C}=await A(async()=>{const{ocrFaxImage:M,saveFaxRecord:L,fetchFaxInbox:q}=await Promise.resolve().then(()=>T);return{ocrFaxImage:M,saveFaxRecord:L,fetchFaxInbox:q}},void 0),S=await b(d,g),E=e.querySelector("#fax-sender-name")?.value??"",I=e.querySelector("#fax-sender-phone")?.value??"";await _({id:`fax_${Date.now()}`,receivedAt:new Date().toISOString(),senderName:E,senderPhone:I,ocrStatus:S.error?"failed":"done",ocrText:S.text}),a.faxOcrText=S.error?`エラー: ${S.error}`:S.text,a.faxRecords=await C(),a.faxProcessing=!1,w()},m.readAsDataURL(l)}catch(m){D("OCR失敗: "+(m instanceof Error?m.message:""),"error"),a.faxProcessing=!1,w()}}),e.querySelector("[data-action='ms-new']")?.addEventListener("click",()=>{a.mailSenderEditingId="__new__",w()}),e.querySelectorAll("[data-action='ms-edit']").forEach(o=>{o.addEventListener("click",()=>{a.mailSenderEditingId=o.dataset.id??null,w()})}),e.querySelector("[data-action='ms-cancel']")?.addEventListener("click",()=>{a.mailSenderEditingId=null,w()}),e.querySelector("[data-action='ms-save']")?.addEventListener("click",async()=>{const o=e.querySelector("[data-action='ms-save']")?.dataset.id||`sender_${Date.now()}`,l={id:o,name:e.querySelector("#ms-name")?.value||"",email:e.querySelector("#ms-email")?.value||"",displayName:e.querySelector("#ms-display-name")?.value||"",replyTo:e.querySelector("#ms-reply-to")?.value||"",signature:e.querySelector("#ms-signature")?.value||"",isDefault:e.querySelector("#ms-default")?.checked??!1,isVerified:a.mailSenders.find(b=>b.id===o)?.isVerified??!1};if(!l.name||!l.email){D("名前とメールアドレスは必須です","warning");return}const{saveMailSender:d,fetchMailSenders:m}=await A(async()=>{const{saveMailSender:b,fetchMailSenders:_}=await Promise.resolve().then(()=>T);return{saveMailSender:b,fetchMailSenders:_}},void 0);await d(l)?(a.mailSenders=await m(),a.mailSenderEditingId=null,D("保存しました"),w()):D("保存に失敗しました","error")}),e.querySelectorAll("[data-action='ms-delete']").forEach(o=>{o.addEventListener("click",async()=>{if(!await fe("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const l=o.dataset.id??"",{deleteMailSender:d,fetchMailSenders:m}=await A(async()=>{const{deleteMailSender:b,fetchMailSenders:_}=await Promise.resolve().then(()=>T);return{deleteMailSender:b,fetchMailSenders:_}},void 0);await d(l)?(a.mailSenders=await m(),w()):D("削除失敗","error")})}),e.querySelector("[data-action='delivery-print']")?.addEventListener("click",()=>{window.print()}),e.querySelector("[data-action='billing-print']")?.addEventListener("click",()=>{window.print()}),e.querySelector("[data-action='tax-print']")?.addEventListener("click",()=>{window.print()}),e.querySelector("[data-action='print-page']")?.addEventListener("click",()=>{e.querySelectorAll("details").forEach(o=>{o.open=!0}),window.print()}),e.querySelector("[data-action='demand-csv-export']")?.addEventListener("click",()=>{if(!a.demandAnalysis){D("データなし","error");return}const o=a.demandAnalysis,l=Object.entries(o.matrix).map(([m,g])=>{const b={productCode:m};return o.months.forEach(_=>{b[_]=g[_]??0}),b}),d=[{key:"productCode",label:"商品コード"},...o.months.map(m=>({key:m,label:m}))];ma("demand-analysis.csv",l,d)}),e.querySelector("[data-action='plan-csv-export']")?.addEventListener("click",()=>{if(a.productionPlan.length===0){D("データなし","error");return}const o=a.productionPlan.map(d=>({...d}));ma("production-plan.csv",o,[{key:"productCode",label:"商品コード"},{key:"productName",label:"商品名"},{key:"productionType",label:"生産区分"},{key:"demandForecast",label:"需要予測"},{key:"safetyStockTarget",label:"安全在庫"},{key:"openingStock",label:"在庫数"},{key:"requiredProduction",label:"必要生産量"},{key:"plannedQty",label:"計画数"},{key:"actualQty",label:"実績"},{key:"status",label:"ステータス"}])}),e.querySelector("[data-action='billing-close-all']")?.addEventListener("click",async()=>{await fe("当月の全請求を締め切りますか？")&&D("締め処理はデータベース側の設定が必要です","info")}),e.querySelector("#brewing-fy-select")?.addEventListener("change",async o=>{const l=parseInt(o.target.value);a.brewingPlanFY=l;const{fetchBrewingPlanSummary:d,fetchBrewingMonthlyTrend:m,fetchBrewingSchedule:g,fetchBrewingProductDetail:b,fetchBrewingCustomCategories:_,fetchBrewingCategoryOverrides:C}=await A(async()=>{const{fetchBrewingPlanSummary:O,fetchBrewingMonthlyTrend:j,fetchBrewingSchedule:Q,fetchBrewingProductDetail:ee,fetchBrewingCustomCategories:se,fetchBrewingCategoryOverrides:pe}=await Promise.resolve().then(()=>T);return{fetchBrewingPlanSummary:O,fetchBrewingMonthlyTrend:j,fetchBrewingSchedule:Q,fetchBrewingProductDetail:ee,fetchBrewingCustomCategories:se,fetchBrewingCategoryOverrides:pe}},void 0),[S,E,I,M,L,q]=await Promise.all([d(`${l}-10-01`,`${l+1}-09-30`),m(`${l}-10-01`,`${l+1}-09-30`),g(l),b(`${l}-10-01`,`${l+1}-09-30`),_(),C()]);a.brewingPlanData=S,a.brewingMonthlyTrend=E,a.brewingSchedule=I,a.brewingProductDetail=M,a.brewingCustomCategories=L,a.brewingOverrides=q,a.brewingExcludedProducts=new Set,w()}),e.querySelectorAll("[data-action='brew-product-toggle']").forEach(o=>{o.addEventListener("change",()=>{const l=o.dataset.code??"";o.checked?a.brewingExcludedProducts.delete(l):a.brewingExcludedProducts.add(l),w()})}),e.querySelectorAll("[data-action='brew-move-product']").forEach(o=>{o.addEventListener("change",async()=>{const l=o.dataset.code??"",d=o.value,m=o.dataset.original??"",{setBrewingCategoryOverride:g,fetchBrewingPlanSummary:b,fetchBrewingProductDetail:_}=await A(async()=>{const{setBrewingCategoryOverride:S,fetchBrewingPlanSummary:E,fetchBrewingProductDetail:I}=await Promise.resolve().then(()=>T);return{setBrewingCategoryOverride:S,fetchBrewingPlanSummary:E,fetchBrewingProductDetail:I}},void 0);if(await g(l,d===m?null:d)){const S=a.brewingPlanFY,[E,I]=await Promise.all([b(`${S}-10-01`,`${S+1}-09-30`),_(`${S}-10-01`,`${S+1}-09-30`)]);a.brewingPlanData=E,a.brewingProductDetail=I,d===m?delete a.brewingOverrides[l]:a.brewingOverrides[l]=d}w()})}),e.querySelector("[data-action='brew-add-category']")?.addEventListener("click",async()=>{const o=e.querySelector("#brew-new-category-name"),l=o?.value.trim()??"";if(!l)return;if(["純米大吟醸","大吟醸","純米吟醸","純米","本醸造","普通酒","リキュール","その他",...a.brewingCustomCategories].includes(l)){D("同名の区分が既に存在します","warning");return}const{addBrewingCustomCategory:m}=await A(async()=>{const{addBrewingCustomCategory:b}=await Promise.resolve().then(()=>T);return{addBrewingCustomCategory:b}},void 0);await m(l)?(a.brewingCustomCategories.push(l),o&&(o.value=""),D(`「${l}」を追加しました`)):D("追加に失敗しました","error"),w()}),e.querySelectorAll("[data-action='brew-delete-category']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.cat??"";if(!l)return;const{deleteBrewingCustomCategory:d,fetchBrewingPlanSummary:m,fetchBrewingProductDetail:g}=await A(async()=>{const{deleteBrewingCustomCategory:_,fetchBrewingPlanSummary:C,fetchBrewingProductDetail:S}=await Promise.resolve().then(()=>T);return{deleteBrewingCustomCategory:_,fetchBrewingPlanSummary:C,fetchBrewingProductDetail:S}},void 0);if(await d(l)){a.brewingCustomCategories=a.brewingCustomCategories.filter(E=>E!==l);for(const[E,I]of Object.entries(a.brewingOverrides))I===l&&delete a.brewingOverrides[E];const _=a.brewingPlanFY,[C,S]=await Promise.all([m(`${_}-10-01`,`${_+1}-09-30`),g(`${_}-10-01`,`${_+1}-09-30`)]);a.brewingPlanData=C,a.brewingProductDetail=S,D(`「${l}」を削除しました`)}w()})}),e.querySelectorAll(".btn-edit-stock").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.catId??"";e.querySelector(`#stock-display-${l}`).style.display="none",e.querySelector(`#stock-edit-${l}`).style.display="",o.style.display="none"})}),e.querySelectorAll(".btn-cancel-stock").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.catId??"";e.querySelector(`#stock-display-${l}`).style.display="",e.querySelector(`#stock-edit-${l}`).style.display="none",e.querySelector(`.btn-edit-stock[data-cat-id="${l}"]`).style.display=""})}),e.querySelectorAll(".btn-add-schedule-row").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.catId??"",d=e.querySelector(`#schedule-rows-${l}`);if(!d)return;const m=d.querySelectorAll(".schedule-edit-row").length,g=document.createElement("div");g.innerHTML=buildScheduleEditRowHTML(l,m,9,2,0,"");const b=g.firstElementChild;d.appendChild(b),b.querySelector(".btn-remove-schedule-row")?.addEventListener("click",()=>b.remove())})}),e.querySelectorAll(".btn-remove-schedule-row").forEach(o=>{o.addEventListener("click",()=>o.closest(".schedule-edit-row")?.remove())}),e.querySelectorAll(".btn-save-stock").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.cat??"",d=o.dataset.catId??"",m=e.querySelector(`#stock-input-${d}`),g=e.querySelector(`#cost-input-${d}`),b=parseFloat(m?.value??""),_=parseFloat(g?.value??"0")||0;if(isNaN(b)||b<0){alert("有効な数値を入力してください");return}const C=[...e.querySelectorAll(`#schedule-rows-${d} .schedule-edit-row`)].map(S=>({brewMonth:parseInt(S.querySelector(".schedule-month")?.value??"0"),durationMonths:parseInt(S.querySelector(".schedule-duration")?.value??"2"),plannedVolumeL:parseFloat(S.querySelector(".schedule-volume")?.value??"0")})).filter(S=>S.brewMonth>=1&&S.brewMonth<=12);o.textContent="保存中...",o.setAttribute("disabled","true");try{const{upsertBrewingStock:S,saveBrewingSchedule:E,fetchBrewingPlanSummary:I,fetchBrewingMonthlyTrend:M,fetchBrewingSchedule:L}=await A(async()=>{const{upsertBrewingStock:ee,saveBrewingSchedule:se,fetchBrewingPlanSummary:pe,fetchBrewingMonthlyTrend:R,fetchBrewingSchedule:z}=await Promise.resolve().then(()=>T);return{upsertBrewingStock:ee,saveBrewingSchedule:se,fetchBrewingPlanSummary:pe,fetchBrewingMonthlyTrend:R,fetchBrewingSchedule:z}},void 0),q=a.brewingPlanFY;await Promise.all([S(l,b,_),E(l,q,C)]);const[O,j,Q]=await Promise.all([I(`${q}-10-01`,`${q+1}-09-30`),M(`${q}-10-01`,`${q+1}-09-30`),L(q)]);a.brewingPlanData=O,a.brewingMonthlyTrend=j,a.brewingSchedule=Q,w()}catch(S){console.error("[brewing save]",S),alert(`保存エラー: ${String(S)}`),o.textContent="保存",o.removeAttribute("disabled")}})}),e.querySelectorAll("[data-toggle-cat]").forEach(o=>{o.addEventListener("click",()=>{const d=`sub-row-${(o.dataset.toggleCat??"").replace(/[^a-zA-Z0-9]/g,"_")}`,m=e.querySelectorAll(`.${d}`),g=o.querySelector(".toggle-icon"),b=m[0]?.style.display!=="none";m.forEach(_=>{_.style.display=b?"none":""}),g&&(g.innerHTML=b?"&#9654;":"&#9660;")})}),e.querySelector("[data-action='jikomi-new']")?.addEventListener("click",()=>{D("新規仕込の登録はマスタ管理から行ってください","info")}),e.querySelector("[data-action='kentei-new']")?.addEventListener("click",()=>{D("新規検定の登録はマスタ管理から行ってください","info")}),e.querySelectorAll("[data-action='kentei-edit']").forEach(o=>{o.addEventListener("click",()=>{D("検定の編集はマスタ管理から行ってください","info")})}),e.querySelector("[data-action='purchase-new']")?.addEventListener("click",()=>{D("新規仕入の登録はマスタ管理から行ってください","info")}),e.querySelectorAll("[data-action='payable-pay']").forEach(o=>{o.addEventListener("click",async()=>{await fe("この買掛を入金済みにしますか？")&&D("入金処理はデータベース側の設定が必要です","info")})}),e.querySelectorAll("[data-action='bill-detail']").forEach(o=>{o.addEventListener("click",()=>{D("請求書詳細は印刷センターから確認してください","info")})}),e.querySelector("[data-action='bill-new']")?.addEventListener("click",()=>{D("新規請求書の作成は伝票入力から行ってください","info")}),e.querySelectorAll("[data-action='tank-detail']").forEach(o=>{o.addEventListener("click",()=>{const l=o.closest("tr")?.querySelector("td")?.textContent??"";D(`タンク ${l} の詳細: 仕込台帳を参照してください`,"info")})}),e.querySelector("[data-action='order-new']")?.addEventListener("click",()=>{D("新規注文はモバイル注文画面から行ってください","info")}),e.querySelectorAll("[data-action='order-detail']").forEach(o=>{o.addEventListener("click",()=>{const l=o.closest("tr")?.querySelector("td")?.textContent??"";D(`注文 ${l} の詳細を表示します`,"info")})}),e.querySelector("[data-action='fax-create-invoice']")?.addEventListener("click",()=>{D("FAXから伝票を起票するには、伝票入力画面をご利用ください","info")}),e.querySelectorAll("[data-action='fax-view']").forEach(o=>{o.addEventListener("click",()=>{D("FAX詳細の表示は準備中です","info")})}),e.querySelector("[data-action='tour-show-form']")?.addEventListener("click",()=>{window.open("/tour-form","_blank")}),e.querySelector("[data-action='prospect-convert']")?.addEventListener("click",()=>{D("得意先化するにはマスタ管理で得意先を作成してください","info")}),e.querySelectorAll("[data-action='create-proposal']").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.customer??"";D(`得意先 ${l} への提案書を作成するには見積作成画面をご利用ください`,"info")})}),e.querySelector("[data-action='lb-new-manual']")?.addEventListener("click",()=>{D("手動リスト作成は準備中です","info")}),e.querySelector("[data-action='lb-delete-list']")?.addEventListener("click",async()=>{const o=e.querySelector("[data-action='lb-delete-list']")?.dataset.id;if(!o||!await fe("このリストを削除しますか？"))return;const{supabaseDelete:d}=await A(async()=>{const{supabaseDelete:g}=await Promise.resolve().then(()=>U);return{supabaseDelete:g}},void 0);if(await d("lead_lists",o)){const{fetchLeadLists:g}=await A(async()=>{const{fetchLeadLists:b}=await Promise.resolve().then(()=>T);return{fetchLeadLists:b}},void 0);a.leadLists=await g(),D("削除しました","success"),w()}else D("削除に失敗しました","error")}),e.querySelector("[data-action='wf-new-order']")?.addEventListener("click",()=>{D("新規受注の登録はモバイル注文画面から行ってください","info")}),e.querySelectorAll("[data-sc-ym]").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.scYm;if(!l)return;a.shipmentCalendarYearMonth=l,a.shipmentCalendarData=null,a.shipmentCalendarSelectedDate=null,w();const{fetchShipmentCalendar:d}=await A(async()=>{const{fetchShipmentCalendar:m}=await Promise.resolve().then(()=>T);return{fetchShipmentCalendar:m}},void 0);a.shipmentCalendarData=await d(l),w()})}),e.querySelectorAll("[data-sc-date]").forEach(o=>{o.addEventListener("click",()=>{const l=o.dataset.scDate;l&&(a.shipmentCalendarSelectedDate=a.shipmentCalendarSelectedDate===l?null:l,w())})}),e.querySelectorAll("[data-action='cal-prev'], [data-action='cal-next'], [data-action='cal-today']").forEach(o=>{o.addEventListener("click",async()=>{a.calendarYearMonth=o.dataset.ym??a.calendarYearMonth;const{fetchCalendarEvents:l}=await A(async()=>{const{fetchCalendarEvents:d}=await Promise.resolve().then(()=>T);return{fetchCalendarEvents:d}},void 0);a.calendarEvents=await l(a.calendarYearMonth),w()})}),e.querySelector("#cal-month-input")?.addEventListener("change",async o=>{a.calendarYearMonth=o.target.value;const{fetchCalendarEvents:l}=await A(async()=>{const{fetchCalendarEvents:d}=await Promise.resolve().then(()=>T);return{fetchCalendarEvents:d}},void 0);a.calendarEvents=await l(a.calendarYearMonth),w()}),e.querySelector("#cal-filter-category")?.addEventListener("change",o=>{a.calendarFilterCategory=o.target.value,w()}),e.querySelector("[data-action='cal-new']")?.addEventListener("click",()=>{const o=new Date;a.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:new Date(o.getTime()+3600*1e3).toISOString(),isAllDay:!1}},w()}),e.querySelectorAll("[data-cal-date]").forEach(o=>{o.tagName!=="BUTTON"&&o.addEventListener("click",l=>{if(l.target.closest(".cal-event"))return;const d=o.dataset.calDate??"";a.calendarEdit={isOpen:!0,isNew:!0,event:{id:`evt_${Date.now()}`,title:"",category:"general",startsAt:`${d}T10:00:00`,isAllDay:!1}},w()})}),e.querySelectorAll("[data-cal-event-id]").forEach(o=>{o.addEventListener("click",l=>{l.stopPropagation();const d=o.dataset.calEventId,m=a.calendarEvents.find(g=>g.id===d);m&&(a.calendarEdit={isOpen:!0,isNew:!1,event:{...m}},w())})}),e.querySelectorAll("[data-action='cal-close']").forEach(o=>{o.addEventListener("click",l=>{l.currentTarget!==l.target&&!l.target.matches("button")||(a.calendarEdit=null,w())})}),e.querySelector("[data-action='cal-save']")?.addEventListener("click",async()=>{if(!a.calendarEdit)return;const{saveCalendarEvent:o,fetchCalendarEvents:l,CALENDAR_CATEGORY_COLORS:d}=await A(async()=>{const{saveCalendarEvent:C,fetchCalendarEvents:S,CALENDAR_CATEGORY_COLORS:E}=await Promise.resolve().then(()=>T);return{saveCalendarEvent:C,fetchCalendarEvents:S,CALENDAR_CATEGORY_COLORS:E}},void 0),m=document.querySelector("[data-action='cal-save']")?.dataset.id||a.calendarEdit.event.id||`evt_${Date.now()}`,g=e.querySelector("#cal-category")?.value??"general",b={id:m,title:e.querySelector("#cal-title")?.value??"",category:g,startsAt:new Date(e.querySelector("#cal-starts")?.value??new Date().toISOString()).toISOString(),endsAt:e.querySelector("#cal-ends")?.value?new Date(e.querySelector("#cal-ends").value).toISOString():void 0,isAllDay:e.querySelector("#cal-allday")?.checked??!1,location:e.querySelector("#cal-location")?.value??"",relatedCustomerCode:e.querySelector("#cal-customer")?.value??"",description:e.querySelector("#cal-description")?.value??"",color:d[g]};if(!b.title){D("タイトルは必須です","warning");return}await o(b)?(a.calendarEvents=await l(a.calendarYearMonth),a.calendarEdit=null,D("保存しました"),w()):D("保存失敗","error")}),e.querySelector("[data-action='cal-delete']")?.addEventListener("click",async()=>{const o=document.querySelector("[data-action='cal-delete']")?.dataset.id??"";if(!o||!await fe("削除しますか？",{variant:"danger",confirmLabel:"削除する"}))return;const{deleteCalendarEvent:l,fetchCalendarEvents:d}=await A(async()=>{const{deleteCalendarEvent:g,fetchCalendarEvents:b}=await Promise.resolve().then(()=>T);return{deleteCalendarEvent:g,fetchCalendarEvents:b}},void 0);await l(o)?(a.calendarEvents=await d(a.calendarYearMonth),a.calendarEdit=null,D("削除しました"),w()):D("削除失敗","error")}),e.querySelector("[data-action='import-execute']")?.addEventListener("click",async()=>{if(a.importPreview){a.importing=!0,w();try{const o=a.importPreview.rows.filter(d=>d._valid),l=await Dn(a.importEntity,o);a.importResult=`取り込み完了: ${l.inserted}件成功 / ${l.failed}件失敗`,a.importPreview=null}catch(o){a.importResult=`エラー: ${o instanceof Error?o.message:String(o)}`}finally{a.importing=!1,w()}}}),e.querySelector("[data-action='store-load']")?.addEventListener("click",()=>{const o=e.querySelector("#store-date")?.value??a.storeSalesDate;a.storeSalesDate=o,a.storeSales=[],a.actionLoading=!0,w(),Ca(o).then(l=>{a.storeSales=l,a.actionLoading=!1,w()})}),e.querySelectorAll("[data-action='copy-config']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.configValue??"";if(l)try{await navigator.clipboard.writeText(l),o.textContent="コピー済み",window.setTimeout(()=>{o.textContent="コピー"},1600)}catch(d){console.warn("Clipboard copy failed",d)}})}),e.querySelector("[data-action='download-relay-config']")?.addEventListener("click",()=>{const l=JSON.stringify({supabase_url:re,supabase_anon_key:H,z_drive_path:"Z:\\",sync_modules:["sk","sh","k5","h5"],interval_minutes:5,use_odbc:!1,odbc_dsn:"MagicSake",log_level:"INFO"},null,2),d=new Blob([l],{type:"application/json;charset=utf-8"}),m=URL.createObjectURL(d),g=document.createElement("a");g.href=m,g.download="relay_config.json",g.click(),URL.revokeObjectURL(m)}),e.querySelectorAll("[data-action='copy-code']").forEach(o=>{o.addEventListener("click",async()=>{const l=o.dataset.code??"";if(l)try{await navigator.clipboard.writeText(decodeURIComponent(l)),o.textContent="コピー済み",window.setTimeout(()=>{o.textContent="コピー"},1600)}catch(d){console.warn("Clipboard code copy failed",d)}})}),e.querySelectorAll("input[name='email-audience-mode']").forEach(o=>{o.addEventListener("change",()=>{Me(e),a.emailSaveMessage=null,w()})}),e.querySelectorAll("#email-region, #email-history-segment").forEach(o=>{o.addEventListener("change",()=>{Me(e),a.emailSaveMessage=null,w()})}),e.querySelector("#email-subject")?.addEventListener("input",()=>{Me(e),a.emailSaveMessage=null}),e.querySelector("#email-body")?.addEventListener("input",()=>{Me(e),a.emailSaveMessage=null}),e.querySelectorAll("[data-action='template-select']").forEach(o=>{o.addEventListener("click",()=>{a.emailTemplateId=o.dataset.templateId??"custom";const l=Mn(a.emailTemplateId);a.emailSubject=l.subject,a.emailBody=l.body,a.emailSaveMessage=null,w()})}),e.querySelector("[data-action='email-insert-link']")?.addEventListener("click",()=>{Me(e);const o=`

商品詳細はこちら: https://kaneishuzo.co.jp/products`;a.emailBody.includes("https://kaneishuzo.co.jp/products")||(a.emailBody=`${a.emailBody.trimEnd()}${o}`),a.emailSaveMessage=null,w()}),e.querySelector("[data-action='email-save']")?.addEventListener("click",()=>{Me(e),a.actionLoading=!0,w(),kt(Wt("draft")).then(o=>{a.emailSaveMessage=`下書きを保存しました。${new Intl.DateTimeFormat("ja-JP",{month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(o.updatedAt??new Date().toISOString()))}`,a.actionLoading=!1,w()})}),e.querySelector("#email-sender")?.addEventListener("change",o=>{a.emailSenderId=o.target.value}),e.querySelector("[data-action='email-send']")?.addEventListener("click",()=>{Me(e),a.actionLoading=!0,a.emailSending=!0,w();const o=Wt("sent");a.mailSenders.find(l=>l.id===a.emailSenderId),en().then(async l=>{await kt({...o,recipientCount:l.sent}),a.emailSaveMessage=`${l.sent.toLocaleString("ja-JP")} 件送信しました。`,a.actionLoading=!1,a.emailSending=!1,w(),D(`${l.sent}件送信完了`)}).catch(async()=>{await kt(Wt("draft")),a.emailSaveMessage="APIキー未設定のため下書きを保存しました。",a.actionLoading=!1,a.emailSending=!1,w(),D("APIキー未設定のため下書き保存しました","warning")})})}function w(){const e=document.querySelector("#app");if(!e)return;try{e.innerHTML=jd()}catch(s){console.error("[renderApp] render error:",s),e.innerHTML=`<div style="padding:32px;color:red;font-family:monospace;white-space:pre-wrap;">[描画エラー] ${String(s)}

${s?.stack??""}</div>`;return}Vd(e),a.pickerMode&&e.querySelector("#modal-search")?.focus(),a.globalSearchOpen&&e.querySelector("#global-search-input")?.focus(),Ra()&&e.querySelector("#auth-email")?.focus(),requestAnimationFrame(()=>{for(const s of["fd-scaler","print-scaler","q-preview-scaler"]){const n=e.querySelector(`#${s}`),i=n?.querySelector(".fd-canvas, .print-preview, .q-preview-doc"),r=i?.querySelector(".print-page")??i;if(!n||!r)continue;const c=n.parentElement?.clientWidth??0,p=r.offsetWidth;if(c>0&&p>0&&p>c-24){const u=(c-24)/p;n.style.transform=`scale(${u})`,n.style.transformOrigin="top left",n.style.height=`${(r.offsetHeight+48)*u}px`}else n.style.transform="",n.style.height=""}});const t=a.sidebarOpen||a.pickerMode!==null||a.globalSearchOpen;document.body.style.overflow=t?"hidden":"",document.body.style.touchAction=t?"none":""}const Vn="sake-cloud-cache",Jd=300*1e3;function Yd(){try{const e={ts:Date.now(),masterStats:a.masterStats,pipelineMeta:a.pipelineMeta};localStorage.setItem(Vn,JSON.stringify(e))}catch{}}function Ud(){try{const e=localStorage.getItem(Vn);if(!e)return!1;const t=JSON.parse(e);return Date.now()-t.ts>Jd?!1:(t.masterStats&&(a.masterStats=t.masterStats),t.pipelineMeta&&(a.pipelineMeta=t.pipelineMeta),!0)}catch{return!1}}let Jn=0;async function He(){const e=Ud();e&&(a.loading=!1,w()),a.loading=!e,e||w();try{const[t,s,n,i,r,c,p,u,y]=await Promise.all([As(),Ls(),$a(),Ds(),ct(a.invoiceFilter),_a(a.ledgerCustomerCode),wa(),qs(),Es("quote_company")]);if(a.salesSummary=t,a.paymentStatus=s,a.masterStats=n,a.pipelineMeta=i,a.invoiceRecords=r,a.customerLedger=c,a.salesAnalytics=p,a.syncDashboard=u,y){const f={...Ct,...na(),...y};a.quoteCompanySettings=f,Re(f)}if(Ms().then(f=>{a.announcements=f,w()}),Qe.length===0&&wd(),a.rawTableList.length===0&&ln().then(f=>{a.rawTableList=f,a.route==="/raw-browser"&&w()}),!a.salesFilter.startDate||!a.salesFilter.endDate){const v=[...t.salesRecords].sort((k,o)=>new Date(o.date).getTime()-new Date(k.date).getTime())[0]?.date??new Date().toISOString(),$=new Date(v),x=new Date($);x.setDate($.getDate()-30),a.salesFilter={startDate:$s(x.toISOString()),endDate:$s($.toISOString())}}(!a.invoiceFilter.startDate||!a.invoiceFilter.endDate)&&(a.invoiceFilter={...a.invoiceFilter,startDate:a.salesFilter.startDate,endDate:a.salesFilter.endDate},a.invoiceRecords=await ct(a.invoiceFilter)),a.error=null,Yd()}catch(t){e||(a.error=t instanceof Error?t.message:"データの取得に失敗しました。")}finally{a.loading=!1,w(),ja(a.route),Jn=Date.now()}}window.addEventListener("popstate",()=>{a.route=On(location.pathname),a.currentCategory=Oa(a.route),a.sidebarOpen=!1,dt(),ja(a.route)});window.addEventListener("keydown",e=>{if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="k"){e.preventDefault(),a.globalSearchOpen=!0,w();return}if(e.key==="Escape"){if(a.globalSearchOpen){dt(),w();return}if(a.pickerMode){It(),w();return}a.route==="/invoice-entry"&&!a.invoiceSaving&&(Rn(),w());return}if(a.route==="/invoice-entry"&&!a.invoiceSaving&&(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==="s"){e.preventDefault();const t=document.querySelector("#app");t&&Fn(t)}});a.user=Tt()?Kn():null;a.user?.email&&(async()=>{const{fetchMyProfile:e}=await A(async()=>{const{fetchMyProfile:t}=await Promise.resolve().then(()=>T);return{fetchMyProfile:t}},void 0);a.myProfile=await e(a.user.email),w()})();try{const e=localStorage.getItem("sake_print_options");e&&(a.printOptions={...a.printOptions,...JSON.parse(e)});const t=localStorage.getItem("sake_print_company");t&&(a.printCompany={...a.printCompany,...JSON.parse(t)});const s=localStorage.getItem("sake_fd_positions");s&&(a.fdSavedPositions=JSON.parse(s))}catch{}(function(){let t=null,s=0,n=0,i=0,r=0,c=1;document.addEventListener("mousedown",p=>{const u=p.target.closest(".fd-draggable");if(!u||!a.fdDesignMode)return;p.preventDefault();const y=u.closest(".fd-canvas");if(!y)return;const f=y.getBoundingClientRect();if(f.width===0)return;c=228.6/f.width,t=u,s=p.clientX,n=p.clientY,i=parseFloat(u.style.left)||0,r=parseFloat(u.style.top)||0,document.querySelectorAll(".fd-active").forEach(k=>k.classList.remove("fd-active")),u.classList.add("fd-active","fd-dragging"),a.fdActiveFieldId=u.dataset.fdId??null;const v=document.querySelector("#fd-selected-info");v&&(v.textContent=`選択中: ${u.title}`);const $=document.querySelector("#fd-sel-x"),x=document.querySelector("#fd-sel-y");$&&($.value=String(i)),x&&(x.value=String(r))}),document.addEventListener("mousemove",p=>{if(!t)return;const u=(p.clientX-s)*c,y=(p.clientY-n)*c,f=Math.round((i+u)*2)/2,v=Math.round((r+y)*2)/2;t.style.left=f+"mm",t.style.top=v+"mm";const $=document.querySelector("#fd-sel-x"),x=document.querySelector("#fd-sel-y");$&&($.value=String(f)),x&&(x.value=String(v))}),document.addEventListener("mouseup",()=>{t&&(t.classList.remove("fd-dragging"),t=null)}),document.addEventListener("keydown",p=>{if(!a.fdDesignMode||!a.fdActiveFieldId||p.key!=="ArrowLeft"&&p.key!=="ArrowRight"&&p.key!=="ArrowUp"&&p.key!=="ArrowDown"||p.target.tagName==="INPUT"||p.target.tagName==="TEXTAREA")return;const u=document.querySelector(`[data-fd-id="${a.fdActiveFieldId}"]`);if(!u)return;p.preventDefault();const y=.5;let f=parseFloat(u.style.left)||0,v=parseFloat(u.style.top)||0;p.key==="ArrowLeft"?f-=y:p.key==="ArrowRight"?f+=y:p.key==="ArrowUp"?v-=y:p.key==="ArrowDown"&&(v+=y),u.style.left=f+"mm",u.style.top=v+"mm";const $=document.querySelector("#fd-sel-x"),x=document.querySelector("#fd-sel-y");$&&($.value=String(f)),x&&(x.value=String(v))})})();He();const Qd=300*1e3;setInterval(()=>{!a.loading&&!document.hidden&&He()},Qd);document.addEventListener("visibilitychange",()=>{!document.hidden&&Date.now()-Jn>60*1e3&&He()});let ya="";fetch(`${location.origin}/index.html?_t=${Date.now()}`).then(e=>e.text()).then(e=>{ya=e}).catch(()=>{});setInterval(async()=>{if(!(!ya||document.hidden))try{await(await fetch(`${location.origin}/index.html?_t=${Date.now()}`)).text()!==ya&&!a.updateAvailable&&(a.updateAvailable=!0,w())}catch{}},120*1e3);
