    ...
    `).join("");e=`
      <div class="cw-home">
        <div class="cw-current-page">
          ...
          <span class="cw-page-label">${wa(o)}</span>
        </div>
