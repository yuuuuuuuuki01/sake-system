...
`}function Yo(e){const t=e.rows.map(i=>{const l=Math.max(0,i.productionVolume+i.previousBalance+i.currentAdjustment-i.exportDeduction-i.sampleDeduction),c=Math.round(l*i.taxRate);return{...i,taxableVolume:l,volume:l,taxAmount:c}}),s=t.reduce((i,l)=>i+l.taxableVolume,0),n=t.reduce((i,l)=>i+l.taxAmount,0);return{...e,rows:t,totalVolume:s,totalTax:n}}async function Uo(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>Q);return{supabaseInsert:s}},void 0);await t("tax_declarations",{target_year:e.targetYear,target_month:e.targetMonth,company_name:e.companyName,company_no:e.companyNo,company_address:e.companyAddress,company_representative:e.companyRepresentative,tax_office:e.taxOffice,total_taxable_volume:e.totalVolume,total_tax_amount:e.totalTax,status:e.status,xml_data:Zs(e),submitted_at:e.submittedAt})}async function Ea(e){const t=await N("store_sales",{sale_date:`eq.${e}`,order:"sale_time.asc"});return t.length>0?t.map(s=>({id:f(s,["id"],""),saleDate:f(s,["sale_date"],e),saleTime:f(s,["sale_time"],""),productCode:f(s,["product_code"],""),productName:f(s,["product_name"],""),quantity:C(s,["quantity"],0),unitPrice:C(s,["unit_price"],0),amount:C(s,["amount"],0),paymentMethod:f(s,["payment_method"],"cash")})):[]}async function en(){const e=await N("store_orders",{order:"order_date.desc",limit:"100"});return e.length>0?e.map(t=>({id:f(t,["id"],""),orderNo:f(t,["order_no"],""),orderDate:ae(t,["order_date"],""),customerName:f(t,["customer_name"],""),postalCode:f(t,["postal_code"],""),address:f(t,["shipping_address"],""),items:[],totalAmount:C(t,["total_amount"],0),status:f(t,["status"],"new"),shippingDate:ae(t,["shipping_date"],"")})):[]}async function Pt(e){const t=await mt("email_campaigns",{subject:e.subject,body:e.body,template_id:e.templateId,audience_mode:e.audienceMode,audience_filter:e.audienceFilter,recipient_count:e.recipientCount,sent_count:e.status==="sent"?e.recipientCount:0,status:e.status,sent_at:e.status==="sent"?new Date().toISOString():null});return{id:t?.id??`local-email-${Date.now()}`,subject:t?.subject??e.subject,body:t?.body??e.body,templateId:t?.template_id??e.templateId,audienceMode:t?.audience_mode??e.audienceMode,audienceFilter:t?.audience_filter??e.audienceFilter,recipientCount:t?.recipient_count??e.recipientCount,status:t?.status??e.status,createdAt:t?.created_at??new Date().toISOString(),updatedAt:t?.updated_at??new Date().toISOString()}}async function tn(e,t){throw new Error("VITE_RESEND_API_KEY is not configured")}async function Qo(e){const t={order:"updated_at.desc"};return e&&(t.template_key=`eq.${e}`),(await N("print_layouts",t)).map(n=>({id:f(n,["id"],""),name:f(n,["name"],""),templateKey:f(n,["template_key"],""),positions:n.positions??{},isDefault:oe(n,["is_default"],!1),note:f(n,["note"],""),updatedAt:f(n,["updated_at"],"")}))}async function Ho(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:i}=await Promise.resolve().then(()=>Q);return{supabaseInsert:i}},void 0),s={id:e.id,name:e.name,template_key:e.templateKey,positions:e.positions,is_default:e.isDefault??!1,note:e.note??"",updated_at:new Date().toISOString()},n=await t("print_layouts",s);return n?{id:f(n,["id"],e.id),name:f(n,["name"],e.name),templateKey:f(n,["template_key"],e.templateKey),positions:n.positions??e.positions,isDefault:oe(n,["is_default"],!1),note:f(n,["note"],""),updatedAt:f(n,["updated_at"],"")}:null}async function Go(e){const t=new URL("/rest/v1/print_layouts","https://loarwnuyvfxiscjjsmiz.supabase.co");t.searchParams.set("id",`eq.${e}`);const s="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{return(await fetch(t.toString(),{method:"DELETE",headers:{apikey:s,Authorization:`Bearer ${s}`}})).ok}catch{return!1}}async function Xo(){return(await N("mail_senders",{order:"is_default.desc,name.asc"})).map(t=>({id:f(t,["id"],""),name:f(t,["name"],""),email:f(t,["email"],""),displayName:f(t,["display_name"],""),signature:f(t,["signature"],""),replyTo:f(t,["reply_to"],""),isDefault:oe(t,["is_default"],!1),isVerified:oe(t,["is_verified"],!1),note:f(t,["note"],"")}))}async function Ko(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0),s=await t("mail_senders",{id:e.id,name:e.name,email:e.email,display_name:e.displayName??"",signature:e.signature??"",reply_to:e.replyTo??"",is_default:e.isDefault??!1,is_verified:e.isVerified??!1,note:e.note??"",updated_at:new Date().toISOString()});return s?{id:f(s,["id"],e.id),name:f(s,["name"],e.name),email:f(s,["email"],e.email),displayName:f(s,["display_name"],""),signature:f(s,["signature"],""),replyTo:f(s,["reply_to"],""),isDefault:oe(s,["is_default"],!1),isVerified:oe(s,["is_verified"],!1)}:null}async function Wo(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/mail_senders","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}const Aa={delivery:"🚚 納品",tour:"🏭 蔵見学",meeting:"📋 商談",brewing:"🍶 仕込",general:"📌 その他"},La={delivery:"#9C27B0",tour:"#FF9800",meeting:"#2196F3",brewing:"#4CAF50",general:"#0F5B8D"};async function Zo(e){const t=`${e}-01T00:00:00Z`,[s,n]=e.split("-").map(p=>parseInt(p,10)),i=new Date(s,n,0).getDate(),l=`${e}-${String(i).padStart(2,"0")}T23:59:59Z`;return(await N("calendar_events",{starts_at:`gte.${t}`,and:`(starts_at.lte.${l})`,order:"starts_at.asc"})).map(p=>({id:f(p,["id"],""),title:f(p,["title"],""),description:f(p,["description"],""),category:f(p,["category"],"general")||"general",startsAt:f(p,["starts_at"],new Date().toISOString()),endsAt:f(p,["ends_at"],""),isAllDay:oe(p,["is_all_day"],!1),location:f(p,["location"],""),attendees:p.attendees??[],relatedCustomerCode:f(p,["related_customer_code"],""),relatedOrderId:f(p,["related_order_id"],""),color:f(p,["color"],""),googleEventId:f(p,["google_event_id"],"")}))}async function ei(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("calendar_events",{id:e.id,title:e.title,description:e.description??"",category:e.category,starts_at:e.startsAt,ends_at:e.endsAt||null,is_all_day:e.isAllDay??!1,location:e.location??"",attendees:e.attendees??[],related_customer_code:e.relatedCustomerCode??null,related_order_id:e.relatedOrderId??null,color:e.color??La[e.category],updated_at:new Date().toISOString()})?e:null}async function ti(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/calendar_events","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function an(){return(await N("integration_settings",{order:"name.asc"})).map(t=>({id:f(t,["id"],""),name:f(t,["name"],""),provider:f(t,["provider"],""),config:t.config??{},isEnabled:oe(t,["is_enabled"],!1),lastSyncAt:f(t,["last_sync_at"],""),lastStatus:f(t,["last_status"],"")}))}async function yt(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("integration_settings",{id:e.id,name:e.name,provider:e.provider,config:e.config,is_enabled:e.isEnabled,last_sync_at:e.lastSyncAt||null,last_status:e.lastStatus||null,updated_at:new Date().toISOString()})?e:null}async function ai(e){const t=e.config.shop_domain,s=e.config.admin_token;if(!t||!s)return{count:0,error:"shop_domain と admin_token を設定してください"};try{const n=`https://${t}/admin/api/2024-01/orders.json?status=any&limit=50`,i=await fetch(n,{headers:{"X-Shopify-Access-Token":s,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const l=await i.json(),{supabaseInsert:c}=await A(async()=>{const{supabaseInsert:u}=await Promise.resolve().then(()=>Q);return{supabaseInsert:u}},void 0);let p=0;for(const u of l.orders){const y=`shopify_${u.id}`;await c("shopify_orders",{id:y,shopify_order_id:String(u.id),order_number:String(u.order_number??""),order_date:String(u.created_at??new Date().toISOString()),customer_name:String(u.customer?.first_name??"")+" "+String(u.customer?.last_name??""),customer_email:String(u.customer?.email??""),total_amount:Math.round(parseFloat(String(u.total_price??"0"))),financial_status:String(u.financial_status??""),fulfillment_status:String(u.fulfillment_status??"unfulfilled"),line_items:u.line_items??[],shipping_address:u.shipping_address??null,raw_payload:u}),p++}return await yt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得成功`}),{count:p}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function si(){return(await N("shopify_orders",{order:"order_date.desc",limit:"50"})).map(t=>({id:f(t,["id"],""),shopifyOrderId:f(t,["shopify_order_id"],""),orderNumber:f(t,["order_number"],""),orderDate:f(t,["order_date"],""),customerName:f(t,["customer_name"],""),customerEmail:f(t,["customer_email"],""),totalAmount:X(t.total_amount),financialStatus:f(t,["financial_status"],""),fulfillmentStatus:f(t,["fulfillment_status"],""),lineItems:t.line_items??[]}))}async function ni(e){const t=e.config.refresh_token,s=e.config.client_id,n=e.config.client_secret;if(!t||!s||!n)return{token:"",error:"refresh_token / client_id / client_secret が未設定です"};const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"refresh_token",refresh_token:t,client_id:s,client_secret:n})});if(!i.ok)return{token:"",error:`トークンリフレッシュ失敗: HTTP ${i.status}`};const c=(await i.json()).access_token;return await yt({...e,config:{...e.config,oauth_token:c}}),e.config.oauth_token=c,{token:c}}async function oi(e){let t=e.config.oauth_token;const s=e.config.calendar_id||"primary";if(!t&&!e.config.refresh_token)return{count:0,error:"oauth_token または refresh_token を設定してください"};try{const n=new Date().toISOString(),i=new Date(Date.now()+30*86400*1e3).toISOString(),l=`https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(s)}/events?timeMin=${n}&timeMax=${i}&singleEvents=true&orderBy=startTime`;let c=await fetch(l,{headers:{Authorization:`Bearer ${t}`}});if(c.status===401){const h=await ni(e);if(h.error)return{count:0,error:h.error};t=h.token,c=await fetch(l,{headers:{Authorization:`Bearer ${t}`}})}if(!c.ok)return{count:0,error:`HTTP ${c.status}`};const p=await c.json(),{supabaseInsert:u}=await A(async()=>{const{supabaseInsert:h}=await Promise.resolve().then(()=>Q);return{supabaseInsert:h}},void 0);let y=0;for(const h of p.items){const v=`gcal_${h.id}`,b=h.start?.dateTime??h.start?.date??"",x=h.end?.dateTime??h.end?.date??"";await u("calendar_events",{id:v,title:String(h.summary??"(無題)"),description:String(h.description??""),category:"general",starts_at:String(b),ends_at:String(x),location:String(h.location??""),google_event_id:String(h.id??""),updated_at:new Date().toISOString()}),y++}return await yt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${y}件取得`}),{count:y}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function ii(){return(await N("fax_inbox",{order:"received_at.desc",limit:"50"})).map(t=>({id:f(t,["id"],""),receivedAt:f(t,["received_at"],""),senderPhone:f(t,["sender_phone"],""),senderName:f(t,["sender_name"],""),imageUrl:f(t,["image_url"],""),ocrStatus:f(t,["ocr_status"],"pending")||"pending",ocrText:f(t,["ocr_text"],""),extractedData:t.extracted_data??{},linkedInvoiceId:f(t,["linked_invoice_id"],"")}))}async function ri(e,t){const s=e.config.api_key;if(!s)return{text:"",error:"Cloud Vision API key 未設定"};try{const n=`https://vision.googleapis.com/v1/images:annotate?key=${s}`,i=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requests:[{image:{content:t.replace(/^data:image\/\w+;base64,/,"")},features:[{type:"DOCUMENT_TEXT_DETECTION"}],imageContext:{languageHints:["ja"]}}]})});return i.ok?{text:(await i.json()).responses?.[0]?.fullTextAnnotation?.text??""}:{text:"",error:`HTTP ${i.status}`}}catch(n){return{text:"",error:n instanceof Error?n.message:String(n)}}}async function li(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("fax_inbox",{id:e.id,received_at:e.receivedAt,sender_phone:e.senderPhone||null,sender_name:e.senderName||null,image_url:e.imageUrl||null,ocr_status:e.ocrStatus,ocr_text:e.ocrText||null,extracted_data:e.extractedData||null,linked_invoice_id:e.linkedInvoiceId||null})?e:null}const Dt={admin:"👑 管理者",manager:"📋 マネージャー",staff:"👤 スタッフ"},qt={all:"全体",sales:"営業",brewery:"蔵人",management:"管理"};async function ci(){return(await N("user_profiles",{order:"display_name.asc"})).map(t=>({id:f(t,["id"],""),email:f(t,["email"],""),displayName:f(t,["display_name"],""),staffCode:f(t,["staff_code"],""),department:f(t,["department"],"all")||"all",role:f(t,["role"],"staff")||"staff",defaultMailSenderId:f(t,["default_mail_sender_id"],""),phone:f(t,["phone"],""),avatarUrl:f(t,["avatar_url"],""),isActive:oe(t,["is_active"],!0),lastSignInAt:f(t,["last_sign_in_at"],""),createdAt:f(t,["created_at"],"")}))}async function di(e){if(!e)return null;const t=await N("user_profiles",{email:`eq.${e}`});if(t.length===0)return null;const s=t[0];return{id:f(s,["id"],""),email:f(s,["email"],""),displayName:f(s,["display_name"],""),staffCode:f(s,["staff_code"],""),department:f(s,["department"],"all")||"all",role:f(s,["role"],"staff")||"staff",defaultMailSenderId:f(s,["default_mail_sender_id"],""),phone:f(s,["phone"],""),avatarUrl:f(s,["avatar_url"],""),isActive:oe(s,["is_active"],!0),lastSignInAt:f(s,["last_sign_in_at"],"")}}async function ui(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("user_profiles",{id:e.id,email:e.email,display_name:e.displayName,staff_code:e.staffCode||null,department:e.department,role:e.role,default_mail_sender_id:e.defaultMailSenderId||null,phone:e.phone||null,avatar_url:e.avatarUrl||null,is_active:e.isActive,updated_at:new Date().toISOString()})?e:null}async function pi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/user_profiles","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function mi(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:s}=await Promise.resolve().then(()=>Q);return{supabaseInsert:s}},void 0);await t("audit_logs",{action:e.action,entity_type:e.entityType??null,entity_id:e.entityId??null,user_email:e.userEmail??null,changes:e.changes??null})}async function yi(e=100){return(await N("audit_logs",{order:"created_at.desc",limit:String(e)})).map(s=>({id:f(s,["id"],""),action:f(s,["action"],""),entityType:f(s,["entity_type"],""),entityId:f(s,["entity_id"],""),userEmail:f(s,["user_email"],""),changes:s.changes??{},createdAt:f(s,["created_at"],"")}))}const It={new_order:"🛒 新規受注",payment_overdue:"⚠️ 入金遅延",low_stock:"📦 低在庫",fax_received:"📠 FAX受信",tour_inquiry:"🏭 見学問合せ",new_prospect:"🎯 新規見込客"};async function sn(){return(await N("slack_notifications",{order:"event_type.asc"})).map(t=>({id:f(t,["id"],""),eventType:f(t,["event_type"],"new_order"),enabled:oe(t,["enabled"],!0),channel:f(t,["channel"],""),condition:t.condition??{},lastTriggeredAt:f(t,["last_triggered_at"],"")}))}async function hi(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("slack_notifications",{id:e.id,event_type:e.eventType,enabled:e.enabled,channel:e.channel,condition:e.condition})?e:null}async function fi(e=50){return(await N("slack_notification_logs",{order:"sent_at.desc",limit:String(e)})).map(s=>({id:f(s,["id"],""),eventType:f(s,["event_type"],""),channel:f(s,["channel"],""),message:f(s,["message"],""),status:f(s,["status"],"sent"),error:f(s,["error"],""),sentAt:f(s,["sent_at"],"")}))}async function vi(e,t,s){const i=(await an()).find(y=>y.provider==="slack");if(!i||!i.isEnabled)return{ok:!1,error:"Slack連携が無効です"};const l=i.config.webhook_url;if(!l)return{ok:!1,error:"Webhook URL未設定"};const p=(await sn()).find(y=>y.eventType===e&&y.enabled);if(!p)return{ok:!1,error:"通知ルールが無効"};const u=s??p.channel??i.config.default_channel??"#general";try{const y=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:`${It[e]} ${t}`,channel:u})}),h=y.ok,{supabaseInsert:v}=await A(async()=>{const{supabaseInsert:b}=await Promise.resolve().then(()=>Q);return{supabaseInsert:b}},void 0);return await v("slack_notification_logs",{id:`slack_${Date.now()}`,event_type:e,channel:u,message:t,status:h?"sent":"failed",error:h?null:`HTTP ${y.status}`}),h?{ok:!0}:{ok:!1,error:`HTTP ${y.status}`}}catch(y){return{ok:!1,error:y instanceof Error?y.message:String(y)}}}const Rt={cold:"❄️ 未接触",warm:"🌡️ 関心あり",hot:"🔥 見込み高",contacted:"📞 アプローチ中",negotiating:"💬 商談中",won:"🎉 受注",lost:"💔 失注"},Da={cold:"#90A4AE",warm:"#FFA726",hot:"#EF5350",contacted:"#42A5F5",negotiating:"#AB47BC",won:"#66BB6A",lost:"#757575"};async function gi(){return(await N("prospects",{order:"updated_at.desc"})).map(t=>({id:f(t,["id"],""),companyName:f(t,["company_name"],""),contactName:f(t,["contact_name"],""),email:f(t,["email"],""),phone:f(t,["phone"],""),address:f(t,["address"],""),website:f(t,["website"],""),businessType:f(t,["business_type"],""),stage:f(t,["stage"],"cold"),source:f(t,["source"],""),expectedAmount:X(t.expected_amount),probability:X(t.probability),assignedStaffCode:f(t,["assigned_staff_code"],""),nextActionDate:f(t,["next_action_date"],""),nextAction:f(t,["next_action"],""),note:f(t,["note"],""),lastContactAt:f(t,["last_contact_at"],""),wonAt:f(t,["won_at"],""),lostAt:f(t,["lost_at"],""),lostReason:f(t,["lost_reason"],""),convertedCustomerCode:f(t,["converted_customer_code"],""),createdAt:f(t,["created_at"],"")}))}async function nn(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("prospects",{id:e.id,company_name:e.companyName,contact_name:e.contactName||null,email:e.email||null,phone:e.phone||null,address:e.address||null,website:e.website||null,business_type:e.businessType||null,stage:e.stage,source:e.source||null,expected_amount:e.expectedAmount,probability:e.probability,assigned_staff_code:e.assignedStaffCode||null,next_action_date:e.nextActionDate||null,next_action:e.nextAction||null,note:e.note||null,updated_at:new Date().toISOString()})?e:null}async function bi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/prospects","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function $i(e){return(await N("prospect_activities",{prospect_id:`eq.${e}`,order:"activity_date.desc"})).map(s=>({id:f(s,["id"],""),prospectId:f(s,["prospect_id"],""),activityType:f(s,["activity_type"],"call"),title:f(s,["title"],""),description:f(s,["description"],""),activityDate:f(s,["activity_date"],""),result:f(s,["result"],""),staffCode:f(s,["staff_code"],"")}))}async function _i(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("prospect_activities",{id:e.id,prospect_id:e.prospectId,activity_type:e.activityType,title:e.title||null,description:e.description||null,activity_date:e.activityDate,result:e.result||null,staff_code:e.staffCode||null})?e:null}const on=["瓶 (720ml)","瓶 (1.8L)","瓶 (300ml)","瓶 (500ml)","キャップ・栓","ラベル(表)","ラベル(裏)","首掛け","化粧箱","ダンボール","包装紙","熨斗・水引","和紙","リボン","その他"];async function wi(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("materials",{id:e.id,legacy_material_code:e.code,material_code:e.code,name:e.name,unit:e.unit,material_type:e.materialType||null,current_stock:e.currentStock,minimum_stock:e.minimumStock,unit_cost:e.unitCost,last_purchase_date:e.lastUpdated,is_active:!0,updated_at:new Date().toISOString()})?e:null}async function xi(e){const t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvYXJ3bnV5dmZ4aXNjampzbWl6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyMTM0MDYsImV4cCI6MjA5MTc4OTQwNn0.7XofVlIiTjlzA9Oz-3lTX1ghLL1qqCcDRadf_a__ys8 ";try{const s=new URL("/rest/v1/materials","https://loarwnuyvfxiscjjsmiz.supabase.co");return s.searchParams.set("id",`eq.${e}`),(await fetch(s.toString(),{method:"DELETE",headers:{apikey:t,Authorization:`Bearer ${t}`}})).ok}catch{return!1}}async function Si(){return(await ne("v_customer_map")).filter(t=>t.lat&&t.lng).map(t=>({customerCode:f(t,["customer_code"],""),name:f(t,["name"],""),phone:f(t,["phone"],""),areaCode:f(t,["area_code"],""),businessType:f(t,["business_type"],""),businessTypeName:f(t,["business_type_name"],""),address1:f(t,["address1"],""),lat:Number(t.lat),lng:Number(t.lng),isAtRisk:oe(t,["is_at_risk"],!1),isDormant:oe(t,["is_dormant"],!1),amount12m:C(t,["amount_12m"],0),daysSinceOrder:t.days_since_order!=null?Number(t.days_since_order):null}))}const jt=[{value:"price",label:"価格が高い"},{value:"competitor",label:"競合に切り替え"},{value:"closed",label:"廃業・閉店"},{value:"contact",label:"担当者交代"},{value:"seasonal",label:"季節要因"},{value:"pause",label:"一時的な休止"},{value:"complaint",label:"クレーム・不満"},{value:"unreachable",label:"連絡が取れない"},{value:"other",label:"その他"}];async function ki(){return(await ne("customer_churn_notes")).map(t=>({customerCode:f(t,["customer_code"],""),reason:f(t,["reason"],""),memo:f(t,["memo"],""),actionedAt:t.actioned_at?String(t.actioned_at):null,updatedAt:f(t,["updated_at"],"")}))}async function Ci(e){const{supabaseUpsert:t}=await A(async()=>{const{supabaseUpsert:s}=await Promise.resolve().then(()=>Q);return{supabaseUpsert:s}},void 0);await t("customer_churn_notes",{customer_code:e.customerCode,reason:e.reason,memo:e.memo,actioned_at:e.actionedAt||null,updated_at:new Date().toISOString()},"customer_code")}async function Pi(){return(await N("delivery_locations",{order:"name.asc"})).map(t=>({id:f(t,["id"],""),customerCode:f(t,["customer_code"],""),name:f(t,["name"],""),postalCode:f(t,["postal_code"],""),address:f(t,["address"],""),lat:t.lat?Number(t.lat):void 0,lng:t.lng?Number(t.lng):void 0,contactName:f(t,["contact_name"],""),phone:f(t,["phone"],""),deliveryNote:f(t,["delivery_note"],""),isActive:oe(t,["is_active"],!0)}))}async function Ei(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("delivery_locations",{id:e.id,customer_code:e.customerCode||null,name:e.name,postal_code:e.postalCode||null,address:e.address||null,lat:e.lat??null,lng:e.lng??null,contact_name:e.contactName||null,phone:e.phone||null,delivery_note:e.deliveryNote||null,is_active:e.isActive})?e:null}async function Ai(e=50){return(await N("call_logs",{order:"started_at.desc",limit:String(e)})).map(s=>({id:f(s,["id"],""),callDirection:f(s,["call_direction"],"inbound"),fromNumber:f(s,["from_number"],""),toNumber:f(s,["to_number"],""),matchedCustomerCode:f(s,["matched_customer_code"],""),matchedProspectId:f(s,["matched_prospect_id"],""),durationSeconds:X(s.duration_seconds),callStatus:f(s,["call_status"],"answered"),recordingUrl:f(s,["recording_url"],""),transcript:f(s,["transcript"],""),ivryCallId:f(s,["ivry_call_id"],""),startedAt:f(s,["started_at"],""),endedAt:f(s,["ended_at"],""),notes:f(s,["notes"],"")}))}async function rn(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("call_logs",{id:e.id,call_direction:e.callDirection,from_number:e.fromNumber||null,to_number:e.toNumber||null,matched_customer_code:e.matchedCustomerCode||null,matched_prospect_id:e.matchedProspectId||null,duration_seconds:e.durationSeconds??0,call_status:e.callStatus??"answered",started_at:e.startedAt||null,ended_at:e.endedAt||null,notes:e.notes||null,ivry_call_id:e.ivryCallId||null})?e:null}async function Li(e){const t=e.config.api_key,s=e.config.team_id;if(!t||!s)return{count:0,error:"IVRy API key または team_id 未設定"};try{const n=`https://api.ivry.jp/v1/teams/${s}/calls?limit=100`,i=await fetch(n,{headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}});if(!i.ok)return{count:0,error:`HTTP ${i.status}`};const c=(await i.json()).calls??[];let p=0;for(const u of c)await rn({id:`ivry_${u.id}`,callDirection:String(u.direction??"inbound"),fromNumber:String(u.from??""),toNumber:String(u.to??""),durationSeconds:Number(u.duration??0),callStatus:String(u.status??"answered"),recordingUrl:String(u.recording_url??""),startedAt:String(u.started_at??""),endedAt:String(u.ended_at??""),ivryCallId:String(u.id??"")}),p++;return await yt({...e,lastSyncAt:new Date().toISOString(),lastStatus:`${p}件取得`}),{count:p}}catch(n){return{count:0,error:n instanceof Error?n.message:String(n)}}}async function Di(e,t){const s=e.config.api_key,n=e.config.team_id;if(!s||!n)return{synced:0,error:"IVRy API key または team_id 未設定"};try{let i=0;for(const l of t){if(!l.phone)continue;(await fetch(`https://api.ivry.jp/v1/teams/${n}/contacts`,{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({name:l.name,phone_number:l.phone,external_id:l.customerCode??"",note:l.note??""})})).ok&&i++}return{synced:i}}catch(i){return{synced:0,error:i instanceof Error?i.message:String(i)}}}async function qi(){return(await N("lead_lists",{order:"created_at.desc"})).map(t=>({id:f(t,["id"],""),name:f(t,["name"],""),query:f(t,["query"],""),area:f(t,["area"],""),businessType:f(t,["business_type"],""),totalCount:X(t.total_count),source:f(t,["source"],"manual"),createdAt:f(t,["created_at"],"")}))}async function Ii(e){return(await N("lead_items",{list_id:`eq.${e}`,order:"rating.desc.nullslast"})).map(s=>({id:f(s,["id"],""),listId:f(s,["list_id"],""),companyName:f(s,["company_name"],""),address:f(s,["address"],""),phone:f(s,["phone"],""),website:f(s,["website"],""),email:f(s,["email"],""),businessType:f(s,["business_type"],""),rating:s.rating?Number(s.rating):void 0,reviewCount:X(s.review_count),lat:s.lat?Number(s.lat):void 0,lng:s.lng?Number(s.lng):void 0,placeId:f(s,["place_id"],""),status:f(s,["status"],"new"),convertedProspectId:f(s,["converted_prospect_id"],""),note:f(s,["note"],"")}))}async function Ti(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("lead_lists",{id:e.id,name:e.name,query:e.query||null,area:e.area||null,business_type:e.businessType||null,total_count:e.totalCount,source:e.source})?e:null}async function ln(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("lead_items",{id:e.id,list_id:e.listId,company_name:e.companyName,address:e.address||null,phone:e.phone||null,website:e.website||null,email:e.email||null,business_type:e.businessType||null,rating:e.rating??null,review_count:e.reviewCount??null,lat:e.lat??null,lng:e.lng??null,place_id:e.placeId||null,status:e.status,converted_prospect_id:e.convertedProspectId||null,note:e.note||null})?e:null}async function Ni(e,t,s){const n=e.config.api_key;if(!n)return{results:[],error:"Google Maps API key 未設定"};const i=`${t} ${s}`.trim(),l=`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${encodeURIComponent(i)}&language=ja&key=${n}`;try{const c=await fetch(l);if(!c.ok)return{results:[],error:`HTTP ${c.status}`};const p=await c.json();return p.status!=="OK"&&p.status!=="ZERO_RESULTS"?{results:[],error:`API status: ${p.status}`}:{results:p.results.map(y=>{const h=y.geometry?.location;return{id:`place_${y.place_id}`,listId:"",companyName:String(y.name??""),address:String(y.formatted_address??""),rating:y.rating?Number(y.rating):void 0,reviewCount:y.user_ratings_total?Number(y.user_ratings_total):void 0,lat:h?.lat,lng:h?.lng,placeId:String(y.place_id??""),status:"new"}})}}catch(c){return{results:[],error:c instanceof Error?c.message:String(c)}}}async function Mi(e){const t={id:`p_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,companyName:e.companyName,phone:e.phone,address:e.address,lat:e.lat,lng:e.lng,businessType:e.businessType,stage:"cold",source:"リスト",expectedAmount:1e5,probability:10,note:e.note??(e.rating?`Google評価: ⭐${e.rating} (${e.reviewCount}件)`:"")},s=await nn(t);return s&&await ln({...e,status:"imported",convertedProspectId:t.id}),s}async function Oi(){return(await N("workflow_orders",{order:"order_date.desc"})).map(t=>({id:f(t,["id"],""),orderNo:f(t,["order_no"],""),customerName:f(t,["customer_name"],""),customerCode:f(t,["customer_code"],""),orderDate:f(t,["order_date"],""),deliveryDate:f(t,["delivery_date"],""),stage:f(t,["stage"],"new"),totalAmount:X(t.total_amount),itemCount:X(t.item_count),priority:f(t,["priority"],"normal"),staffName:f(t,["staff_name"],""),notes:f(t,["notes"],"")}))}async function Ri(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("workflow_orders",{id:e.id,order_no:e.orderNo,customer_name:e.customerName,customer_code:e.customerCode||null,order_date:e.orderDate,delivery_date:e.deliveryDate||null,stage:e.stage,total_amount:e.totalAmount,item_count:e.itemCount,priority:e.priority,staff_name:e.staffName||null,notes:e.notes||null,updated_at:new Date().toISOString()})?e:null}async function ji(){return(await N("tour_inquiries",{order:"created_at.desc"})).map(t=>({id:f(t,["id"],""),name:f(t,["name"],""),email:f(t,["email"],""),phone:f(t,["phone"],""),visitDate:f(t,["visit_date"],""),partySize:X(t.party_size)||1,language:f(t,["language"],"ja"),purpose:f(t,["purpose"],""),message:f(t,["message"],""),status:f(t,["status"],"new"),repliedAt:f(t,["replied_at"],""),confirmedTime:f(t,["confirmed_time"],""),createdAt:f(t,["created_at"],new Date().toISOString())}))}async function Fi(e){const{supabaseInsert:t}=await A(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>Q);return{supabaseInsert:n}},void 0);return await t("tour_inquiries",{id:e.id,name:e.name,email:e.email,phone:e.phone||null,visit_date:e.visitDate||null,party_size:e.partySize,language:e.language,purpose:e.purpose||null,message:e.message||null,status:e.status,replied_at:e.repliedAt||null,confirmed_time:e.confirmedTime||null})?e:null}const zi=[{table:"sake_sales_document_lines",display:"売上伝票明細"},{table:"sake_purchase_document_lines",display:"仕入伝票明細"},{table:"sake_sales_document_headers",display:"売上伝票ヘッダ"},{table:"sake_purchase_document_headers",display:"仕入伝票ヘッダ"},{table:"sake_inventory_movements_sk",display:"在庫移動(SK)"},{table:"sake_current_stock_sh",display:"在庫(SH)"},{table:"sake_inventory_movements_k5",display:"在庫移動(K5)"},{table:"sake_current_stock_h5",display:"在庫(H5)"},{table:"sake_special_prices_sh",display:"特価(SH)"},{table:"sake_products_sh",display:"商品(SH)"},{table:"sake_special_prices_h5",display:"特価(H5)"},{table:"sake_products_sk",display:"商品(SK)"},{table:"sake_products_k5",display:"商品(K5)"},{table:"sake_products_h5",display:"商品(H5)"},{table:"sake_customers",display:"得意先"},{table:"sake_suppliers",display:"仕入先"},{table:"sake_delivery_destinations",display:"納品先"},{table:"sake_trading_partners",display:"取引先"},{table:"sake_current_stock_sk",display:"在庫(SK)"}];async function cn(){return(await Promise.all(zi.map(async t=>{const[s,n]=await Promise.all([ga(t.table),N(t.table,{select:"_synced_at",order:"_synced_at.desc",limit:"1"})]);return{tableName:t.table,displayName:t.display,rowCount:s,lastSyncAt:n[0]?._synced_at??null}}))).sort((t,s)=>s.rowCount-t.rowCount)}async function Et(e,t,s=100){const n=(t-1)*s,[i,l]=await Promise.all([N(e,{select:"_source_file,_record_index,_record_size,_raw_b64,_source_path,_source_file_mtime,_synced_at",order:"_record_index.asc",limit:String(s),offset:String(n)}),ga(e)]);return{records:i,total:l}}async function oa(e){const t=await N("customers",{select:"memo",or:`legacy_customer_code.eq.${e},customer_code.eq.${e}`,limit:"1"});if(t.length===0)return"";const s=t[0].memo;if(typeof s=="string"&&s)try{const n=JSON.parse(s);return String(n.price_group??"")}catch{return""}return""}async function dn(e,t){if(e){const n=await N("customer_product_prices",{select:"special_price",price_group:`eq.${e}`,legacy_product_code:`eq.${t}`,limit:"1"});if(n.length>0&&n[0].special_price)return X(n[0].special_price)}const s=await N("products",{select:"default_sale_price",or:`legacy_product_code.eq.${t},product_code.eq.${t}`,limit:"1"});return s.length>0&&s[0].default_sale_price?X(s[0].default_sale_price):0}const Bi=[{code:"SAK001",name:"純米大吟醸　金井"},{code:"SAK002",name:"純米吟醸　金井"},{code:"SAK003",name:"本醸造　金井"},{code:"SAK004",name:"純米酒　金井"}],Vi=[1.6,.7,1.3,1.2,.9,.7,.6,.7,.9,1,1.1,1.5],Ji={SAK001:80,SAK002:150,SAK003:220,SAK004:180};function Yi(){const e=new Date,t=[];for(let u=11;u>=0;u--){const y=new Date(e.getFullYear(),e.getMonth()-u,1);t.push(`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`)}const s=Bi,n={},i={};for(const u of s){n[u.code]={};for(const y of t){const h=parseInt(y.split("-")[1])-1,v=Ji[u.code]??100,b=Math.round(v*Vi[h]*(.85+Math.random()*.3));n[u.code][y]=b,i[y]=(i[y]??0)+b}}const l={},c={},p={};for(const u of s){const y=t.map(b=>n[u.code][b]??0),h=y.reduce((b,x)=>b+x,0)/y.length,v=y.reduce((b,x)=>b+(x-h)**2,0)/y.length;l[u.code]=y.reduce((b,x)=>b+x,0),c[u.code]=h,p[u.code]=Math.sqrt(v)}return{months:t,products:s,matrix:n,totals:i,productTotals:l,productAvg:c,productStdDev:p}}async function Ui(e=36){const t=(()=>{const b=new Date;return b.setMonth(b.getMonth()-e),`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}`})(),s=await ne("product_monthly_sales",{select:"year_month,product_code,product_name,quantity",year_month:`gte.${t}`,order:"year_month.asc"});if(s.length===0)return Yi();const n=new Set,i=new Map,l={},c={};for(const b of s){const x=f(b,["year_month"],""),S=f(b,["product_code"],""),o=f(b,["product_name"],S),r=C(b,["quantity"],0);!x||!S||(n.add(x),i.set(S,o),l[S]||(l[S]={}),l[S][x]=r,c[x]=(c[x]??0)+r)}const p=[...n].sort(),u=[...i.entries()].map(([b,x])=>({code:b,name:x})),y={},h={},v={};for(const b of u){const x=p.map(r=>l[b.code]?.[r]??0),S=x.reduce((r,d)=>r+d,0)/(x.length||1),o=x.reduce((r,d)=>r+(d-S)**2,0)/(x.length||1);y[b.code]=x.reduce((r,d)=>r+d,0),h[b.code]=S,v[b.code]=Math.sqrt(o)}return{months:p,products:u,matrix:l,totals:c,productTotals:y,productAvg:h,productStdDev:v}}async function Qi(){return(await N("product_safety_stock_params",{order:"product_code.asc"})).map(t=>({productCode:f(t,["product_code"],""),productName:f(t,["product_name"],""),unit:f(t,["unit"],"本"),avgMonthlyDemand:C(t,["avg_monthly_demand"],0),demandStdDev:C(t,["demand_std_dev"],0),leadTimeDays:C(t,["lead_time_days"],30),serviceLevel:C(t,["service_level"],.95),safetyStockQty:C(t,["safety_stock_qty"],0),reorderPoint:C(t,["reorder_point"],0),memo:f(t,["memo"],""),productionType:f(t,["production_type"],"monthly")}))}async function Hi(e){return(await N("production_plan",{year_month:`eq.${e}`,order:"product_code.asc"})).map(s=>({id:f(s,["id"],""),yearMonth:f(s,["year_month"],e),productCode:f(s,["product_code"],""),productName:f(s,["product_name"],""),demandForecast:C(s,["demand_forecast"],0),safetyStockTarget:C(s,["safety_stock_target"],0),openingStock:C(s,["opening_stock"],0),requiredProduction:C(s,["required_production"],0),plannedQty:C(s,["planned_qty"],0),actualQty:C(s,["actual_qty"],0),status:f(s,["status"],"draft"),productionType:f(s,["production_type"],"monthly"),notes:f(s,["notes"],"")}))}async function Gi(e){const{SUPABASE_URL:t,SUPABASE_ANON_KEY:s}=await A(async()=>{const{SUPABASE_URL:n,SUPABASE_ANON_KEY:i}=await Promise.resolve().then(()=>Q);return{SUPABASE_URL:n,SUPABASE_ANON_KEY:i}},void 0);if(!s||e.length===0)return!1;try{const n=e.map(c=>({product_code:c.productCode,product_name:c.productName,unit:c.unit,avg_monthly_demand:c.avgMonthlyDemand,demand_std_dev:c.demandStdDev,lead_time_days:c.leadTimeDays,service_level:c.serviceLevel,safety_stock_qty:c.safetyStockQty,reorder_point:c.reorderPoint,production_type:c.productionType,memo:c.memo,last_calc_at:new Date().toISOString(),updated_at:new Date().toISOString()})),i=new URL("/rest/v1/product_safety_stock_params",t),l=await fetch(i.toString(),{method:"POST",headers:{apikey:s,Authorization:`Bearer ${s}`,"Content-Type":"application/json",Prefer:"return=minimal,resolution=merge-duplicates"},body:JSON.stringify(n)});if(!l.ok){const c=await l.text();return console.error("saveSafetyStockParamsBulk failed:",l.status,c),!1}return!0}catch(n){return console.error("saveSafetyStockParamsBulk error:",n),!1}}async function Xi(e){const{supabaseUpsert:t}=await A(async()=>{const{supabaseUpsert:n}=await Promise.resolve().then(()=>Q);return{supabaseUpsert:n}},void 0);return await t("production_plan",{...e.id?{id:e.id}:{},year_month:e.yearMonth,product_code:e.productCode,product_name:e.productName,demand_forecast:e.demandForecast,safety_stock_target:e.safetyStockTarget,opening_stock:e.openingStock,required_production:e.requiredProduction,planned_qty:e.plannedQty,actual_qty:e.actualQty,status:e.status,production_type:e.productionType,notes:e.notes,updated_at:new Date().toISOString()})!==null}function Ki(e){if(!e)return"不明";const t=e.replace(/^.+?[都道府県]/,""),s=t.match(/^(.+?郡.+?[町村]|.+?[市区町村])/);return s?s[1]:t.substring(0,6)}async function Wi(e){const[t,s]=e.split("-").map(Number),n=`${e}-01`,i=new Date(t,s,0).getDate(),l=`${e}-${String(i).padStart(2,"0")}`,c=await ne("sales_document_headers",{select:"sales_date,customer_name,legacy_customer_code,total_amount",and:`(sales_date.gte.${n},sales_date.lte.${l})`,order:"sales_date.asc"}),p=await ne("customers",{select:"id,address1",address1:"not.is.null"}),u={};for(const h of p)h.address1&&(u[h.id]=Ki(h.address1));const y={};for(const h of c){const v=h.sales_date;if(!v)continue;const b=u[h.legacy_customer_code]||"住所未登録",x=Number(h.total_amount)||0;y[v]||(y[v]={date:v,entries:[],cityGroups:[],totalAmount:0,count:0}),y[v].entries.push({customerCode:h.legacy_customer_code||"",customerName:h.customer_name||"",city:b,amount:x}),y[v].totalAmount+=x,y[v].count++}for(const h of Object.values(y)){const v={};for(const b of h.entries)v[b.city]=(v[b.city]||0)+1;h.cityGroups=Object.entries(v).sort((b,x)=>x[1]-b[1]).map(([b,x])=>({city:b,count:x}))}return y}async function qa(){return N("quotes",{select:"id,quote_no,quote_date,valid_until,customer_name,subject,total_amount,template_type,status,created_at",order:"quote_date.desc,created_at.desc",limit:"200"})}async function un(e){const t=await N("quotes",{select:"*",id:`eq.${e}`});if(!t[0])return null;const s=await N("quote_lines",{select:"*",quote_id:`eq.${e}`,order:"line_no.asc"});return{...t[0],lines:s}}async function Zi(){const e=new Date().toISOString().slice(0,7)+"-01";return ne("sales_document_headers",{select:"legacy_document_no,sales_date,customer_name,legacy_customer_code,total_amount",sales_date:`gte.${e}`,order:"sales_date.asc"})}const I=Object.freeze(Object.defineProperty({__proto__:null,CALENDAR_CATEGORY_COLORS:La,CALENDAR_CATEGORY_LABELS:Aa,CHURN_REASONS:jt,DEPT_LABELS:qt,INVOICE_TYPE_LABELS:ta,JIKOMI_STATUS_LABELS:Js,MATERIAL_CATEGORIES:on,PROSPECT_STAGE_COLORS:Da,PROSPECT_STAGE_LABELS:Rt,ROLE_LABELS:Dt,SEASONAL_TEMPLATES:$a,SLACK_EVENT_LABELS:It,TAX_DEDUCTION_LABELS:na,TAX_RATE_CATEGORIES:Ws,addBrewingCustomCategory:So,convertLeadToProspect:Mi,deleteBrewingCustomCategory:ko,deleteCalendarEvent:ti,deleteMailSender:Wo,deleteMaterial:xi,deletePrintLayout:Go,deleteProspect:bi,deleteUserProfile:pi,fetchAnalyticsByPeriod:io,fetchAnnouncements:Rs,fetchAuditLogs:yi,fetchAvailablePeriods:ro,fetchBillList:Xs,fetchBillingSummary:ka,fetchBrewingCategoryOverrides:Po,fetchBrewingCustomCategories:xo,fetchBrewingMonthlyTrend:go,fetchBrewingPlanSummary:vo,fetchBrewingProductDetail:bo,fetchBrewingSchedule:$o,fetchCalendarEvents:Zo,fetchCallLogs:Ai,fetchChurnAlerts:No,fetchChurnNotes:ki,fetchCustomerAnalysis:Vs,fetchCustomerEfficiency:Fo,fetchCustomerEfficiencyByYear:rt,fetchCustomerLedger:wa,fetchCustomerPriceGroup:oa,fetchCustomerPricing:aa,fetchCustomerProductBreakdown:yo,fetchDeliveryLocations:Pi,fetchDeliveryNote:Sa,fetchDeliverySchedule:To,fetchDemandAnalysis:Ui,fetchDemandForecasts:Io,fetchEntityMonthlySales:fo,fetchFaxInbox:ii,fetchIntegrationSettings:an,fetchInvoices:ut,fetchJikomiList:Ys,fetchKenteiList:Qs,fetchLabelExclusions:Eo,fetchLeadItems:Ii,fetchLeadLists:qi,fetchMailSenders:Xo,fetchMapCustomers:Si,fetchMasterStats:_a,fetchMaterialList:sa,fetchMyProfile:di,fetchOrderHeaders:Zi,fetchPayableList:Gs,fetchPaymentStatus:qs,fetchPeriodChartData:po,fetchPipelineMeta:Is,fetchPrintLayouts:Qo,fetchProductABC:zo,fetchProductCustomerBreakdown:ho,fetchProductDaily:jo,fetchProductMonthlyShipments:qo,fetchProductPower:Bs,fetchProductPrice:dn,fetchProductShipmentsFromTable:Ro,fetchProductionPlan:Hi,fetchProspectActivities:$i,fetchProspects:gi,fetchPurchaseList:Hs,fetchQuoteList:qa,fetchQuoteWithLines:un,fetchRawMaterialStock:Ks,fetchRawRecords:Et,fetchRawTableList:cn,fetchSafetyStockParams:Qi,fetchSalesAnalytics:xa,fetchSalesReport:Ot,fetchSalesSummary:Ds,fetchSeasonalProfiles:Oo,fetchShipmentCalendar:Wi,fetchShopifyOrders:si,fetchSlackLogs:fi,fetchSlackRules:sn,fetchStaffCustomerBreakdown:co,fetchStaffProductBreakdown:uo,fetchStaffTotalsByPeriod:lo,fetchStoreOrders:en,fetchStoreSales:Ea,fetchSyncDashboard:Ts,fetchSystemSetting:Ls,fetchTankList:Us,fetchTaxDeclaration:Pa,fetchTourInquiriesFromDb:ji,fetchUserProfiles:ci,fetchVisitPriorities:Mo,fetchWorkflowOrdersFromDb:Oi,generateTaxCSV:Jo,generateTaxXML:Zs,ocrFaxImage:ri,periodToDateRange:Ns,prevYearFilter:mo,recalculateTaxDeclaration:Yo,recordAudit:mi,resolveProductPrice:Ca,saveBrewingSchedule:_o,saveCalendarEvent:ei,saveCallLog:rn,saveChurnNote:Ci,saveDeliveryLocation:Ei,saveEmailCampaign:Pt,saveFaxRecord:li,saveIntegrationSetting:yt,saveInvoice:Os,saveLabelExclusions:Ao,saveLeadItem:ln,saveLeadList:Ti,saveMailSender:Ko,saveMaterial:wi,savePrintLayout:Ho,saveProductionPlan:Xi,saveProspect:nn,saveProspectActivity:_i,saveSafetyStockParamsBulk:Gi,saveSlackRule:hi,saveTaxDeclaration:Uo,saveTourInquiry:Fi,saveUserProfile:ui,saveWorkflowOrder:Ri,searchPlaces:Ni,sendEmailCampaign:tn,sendSlackNotification:vi,setBrewingCategoryOverride:Co,submitFeatureRequest:js,syncGoogleCalendar:oi,syncIvryCallLogs:Li,syncPhoneBookToIvry:Di,syncShopifyOrders:ai,updateCustomer:Fs,updateProduct:zs,upsertBrewingStock:wo,upsertSystemSetting:Ye},Symbol.toStringTag,{value:"Module"}));function Fe(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}const er={open:"未締め",closed:"締め済"};function tr(e,t){const s=e.customers.map(n=>`
  ...
  `}function Ze(e,t,s){const n=e.findIndex(l=>l.column===t);if(n>=0){if(e[n].direction==="asc"){const c=[...e];return c[n]={column:t,direction:"desc"},c}return e.filter((c,p)=>p!==n)}const i={column:t,direction:"asc"};return s?[...e,i]:[i]}function rr(e,t){const s=e.findIndex(l=>l.column===t);if(s<0)return'<span class="sort-icon">⇅</span>';const n=e[s].direction==="asc"?"↑":"↓",i=e.length>1?`<small class="sort-badge">${s+1}</small>`:"";return`<span class="sort-icon active">${n}${i}</span>`}function B(e,t,s,n=""){return`<th class="sortable ${n}" data-sort-col="${e}">${t} ${rr(s,e)}</th>`}function Ua(e){if(e==null)return"";const t=String(e).replace(/[¥,円%本日L]/g,"").trim(),s=Number(t);return Number.isFinite(s)?s:t.toLowerCase()}function He(e,t,s){return t.length===0?e:[...e].sort((n,i)=>{for(const{column:l,direction:c}of t){const p=s[l];if(!p)continue;const u=Ua(n[p]),y=Ua(i[p]);let h=0;if(typeof u=="number"&&typeof y=="number"?h=u-y:h=String(u).localeCompare(String(y),"ja"),h!==0)return c==="asc"?h:-h}return 0})}const lr={forecasts:[],deliveries:[],calendarMonth:new Date().toISOString().slice(0,7),selectedSegment:"all"},Qa={monthly:"通年出荷","made-to-order":"受注生産","november-only":"歳暮（11月生産）","annual-batch":"季節集中","december-settlement":"歳暮（11月生産）","seasonal-batch":"季節集中"},et={monthly:"#0F5B8D","made-to-order":"#6b46c1","november-only":"#c05621","annual-batch":"#2f855a","december-settlement":"#c05621","seasonal-batch":"#2f855a"};function cr(e){const t=new Date().toISOString().slice(0,10);return e.map(s=>({date:s.date,customerName:s.customerName,productName:s.productName,quantity:s.quantity,status:s.date>t?"scheduled":"delivered"}))}function dr(e){const[t,s]=e.split("-").map(Number);return new Date(t,s,0).getDate()}function ur(e){const[t,s]=e.split("-").map(Number);return new Date(t,s-1,1).getDay()}function mn(e,t){const s=dr(t),n=ur(t),[i,l]=t.split("-").map(Number),c=new Map;e.forEach($=>{if($.date.slice(0,7)===t){const _=$.date.slice(0,10);c.has(_)||c.set(_,[]),c.get(_).push($)}});const p=e.filter($=>$.date.slice(0,7)===t),u=p.reduce(($,_)=>$+_.quantity,0),y=new Set(p.map($=>$.date)).size,h=new Date().toISOString().slice(0,10),v=["日","月","火","水","木","金","土"].map($=>`<th class="dcal-header">${$}</th>`).join("");let b="",x=1;for(let $=0;$<6&&!(x>s&&$>0);$++){b+="<tr>";for(let _=0;_<7;_++)if($===0&&_<n||x>s)b+='<td class="dcal-cell dcal-empty"></td>';else{const P=`${i}-${String(l).padStart(2,"0")}-${String(x).padStart(2,"0")}`,k=c.get(P)||[],E=P===h,q=k.reduce((M,O)=>M+O.quantity,0);b+=`
          <td class="dcal-cell ${E?"dcal-today":""}">
            ...
            `:""}
          </td>`,x++}b+="</tr>"}const[S,o]=l===1?[i-1,12]:[i,l-1],[r,d]=l===12?[i+1,1]:[i,l+1],m=`${S}-${String(o).padStart(2,"0")}`,g=`${r}-${String(d).padStart(2,"0")}`;return`
    <section class="panel">
      <div class="panel-header">
        <div>
          <h2>納品カレンダー</h2>
  ...
  `}function fr(e,t,s,n,i="month",l,c=[]){const p={success:"正常",warning:"注意",error:"異常",running:"実行中"},u=Bt(e.allDailySales,i,l),y=u.reduce((j,Y)=>j+Y.amount,0),h=u.reduce((j,Y)=>j+Y.bottles,0),v=u.reduce((j,Y)=>j+Y.volumeMl,0),b=u.length,x=h>0?Math.round(y/h):0,S=v>0?Math.round(y/(v/1e3)):0,o=new Date,r=o.toISOString().slice(0,10),d=r.slice(0,7),m=Bt(e.allDailySales,"month").filter(j=>j.date.slice(0,10)<=r),g=m.reduce((j,Y)=>j+Y.amount,0);m.reduce((j,Y)=>j+Y.bottles,0);const $=o.getDate();new Date(o.getFullYear(),o.getMonth()+1,0).getDate();const P=(n?.orderHeaders??[]).filter(j=>j.sales_date.slice(0,7)===d),k=P.reduce((j,Y)=>j+Number(Y.total_amount),0),E=P.length,q=Bt(e.allDailySales,"month"),M=q.reduce((j,Y)=>j+Y.bottles,0),O=k>0?k:q.reduce((j,Y)=>j+Y.amount,0),L=k>0?"orders":"extrapolation",R=(u.length>0?e.allDailySales.filter(j=>{const Y=u[0]?.date??"",te=u[u.length-1]?.date??"",ce=Ha(Y,-1),me=Ha(te,-1);return j.date>=ce&&j.date<=me}):[]).reduce((j,Y)=>j+Y.amount,0),H=R>0?(y-R)/R*100:0,ee=H>0?"+":"",se=e.salesRecords.slice(0,10).map(j=>`
            <tr>
    ...
    <section class="kpi-grid">
      ...
      <article class="panel kpi-card" style="border-left:3px solid #0968e5;">
        ...
        <p class="kpi-value">${ye(O)}</p>
        <p class="kpi-sub">${L==="orders"?`受注確定 ${E}件`:`出荷見込 ${M.toLocaleString("ja-JP")}本（日割り外挿）`}</p>
      </article>
      <article class="panel kpi-card">
  ...
  `}function br(e){return e?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(e)):""}function ze(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function $r(e,t){const s=e.lines.length?e.lines.map((i,l)=>`
          <tr>
    ...
    <article class="panel delivery-note-body" id="delivery-print-area">
      ...
      <div class="delivery-footer">
        <div class="delivery-totals">
          <div class="total-stack"><span class="total-label">小計</span><span class="total-value">${ze(n)}</span></div>
...
`,"<br />")}function wr(e){const s=[...Object.values($a),{id:"custom",season:"カスタム",subject:"",body:""}].map(i=>`
  ...
  `}function bt(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ga(e){return e.trim().toLowerCase()}function Sr(e,t){const s=Ga(t),n=e.filter(l=>s?[l.code,l.name,l.name].map(Ga).some(c=>c.includes(s)):!0).slice(0,50),i=n.length?`
      ...
      <tr>
        ...
        <td>
          <input class="${Be(n,`lines.${y}.productName`,"input-cell")}" type="text" data-line="${y}" data-field="productName" value="${Oe(u.productName)}" placeholder="商品名" />
          ${qe(n,`lines.${y}.productName`)}
        </td>
        <td>
          <input class="${Be(n,`lines.${y}.quantity`,"input-cell numeric")}" type="number" data-line="${y}" data-field="quantity" value="${u.quantity}" min="0" />
          ${qe(n,`lines.${y}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${y}" data-field="unit" value="${u.unit}" placeholder="本" /></td>
        <td>
          <input class="${Be(n,`lines.${y}.unitPrice`,"input-cell numeric")}" type="number" data-line="${y}" data-field="unitPrice" value="${u.unitPrice}" min="0" />
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${Be(n,"invoiceDate")}" id="inv-date" type="date" value="${e.invoiceDate||kr(new Date)}" />
          ${qe(n,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:center;margin-bottom:12px;">
        ${fn.map(t=>`
          <button
            ...
            data-color="${Ce(t.value)}"
            title="${Ce(t.label)}"
            style="width:36px;height:36px;border-radius:6px;border:3px solid ${e.accentColor===t.value?"#333":"transparent"};background:${Ce(t.value)};cursor:pointer;transition:border-color 0.15s;"
          ></button>
        `).join("")}
        <label style="display:flex;align-items:center;gap:6px;font-size:13px;">
          カスタム
          <input type="color" id="qs-accent-color" value="${Ce(e.accentColor||"#0968e5")}" style="width:36px;height:36px;border:none;border-radius:4px;cursor:pointer;padding:2px;" />
        </label>
      </div>
      <div style="display:flex;align-items:center;gap:12px;">
        <span style="font-size:12px;color:var(--text-secondary);">現在の色:</span>
        <span style="display:inline-flex;align-items:center;gap:6px;">
          <span style="display:inline-block;width:20px;height:20px;border-radius:4px;background:${Ce(e.accentColor||"#0968e5")};border:1px solid rgba(0,0,0,0.15);"></span>
          <code style="font-size:12px;">${Ce(e.accentColor||"#0968e5")}</code>
        </span>
      </div>
    </section>
...
`}function Or(e){const t=bn(e,.15),s=Tt(e,.88),n=Tt(e,.96);return`
...
`}function $n(e,t){const s=e.lines.reduce((S,o)=>S+o.amount,0),n=Math.round(s*e.taxRate/100),i=s+n,l=e.templateType==="sake",c=l?'<th style="width:90px;">JANコード</th><th style="width:40px;">入数</th><th style="width:70px;">希望小売価格</th>':"",p=l?9:6,u=e.lines.map((S,o)=>{const r=l?`<td style="font-size:9px;">${F(S.janCode)}</td><td style="text-align:center;">${S.caseQty??""}</td><td style="text-align:right;">${S.retailPrice!=null?ve(S.retailPrice):""}</td>`:"";return`<tr>
  ...
  `:"",v=t.sealImageDataUrl?`<img src="${t.sealImageDataUrl}" style="width:${t.sealSize}px;height:${t.sealSize}px;opacity:0.9;flex-shrink:0;" />`:"",b=[];e.validUntil&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">有効期限</div><div class="q-cond-value">${Xa(e.validUntil)}</div></div>`),e.paymentTerms&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">支払条件</div><div class="q-cond-value">${F(e.paymentTerms)}</div></div>`),e.deliveryDate&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">納期</div><div class="q-cond-value">${F(e.deliveryDate)}</div></div>`),e.deliveryPlace&&b.push(`<div class="q-cond-cell"><div class="q-cond-label">納品場所</div><div class="q-cond-value">${F(e.deliveryPlace)}</div></div>`);const x=b.length>0?`<div class="q-cond-grid" style="grid-template-columns:repeat(${Math.min(b.length,4)},1fr);">${b.join("")}</div>`:"";return`
<div class="q-doc">
  <!-- タイトル行: 左=御見積書、右=見積番号・日付（右寄せ） -->
...
<script>window.onload=function(){window.print();}<\/script>
  ...
  `}function Qr(e){return new Date(e.getFullYear(),e.getMonth(),1)}function Hr(e,t){return new Date(e.getFullYear(),e.getMonth()+t,1)}function kn(e,t){const s=new Date(e);return s.setDate(s.getDate()+t),s}function Cn(e){const t=new Date(e),s=t.getDay();return t.setDate(t.getDate()-s),t.setHours(0,0,0,0),t}function Ka(e){const t=kn(Cn(e),6);return t.setHours(23,59,59,999),t}function Wa(e){return new Date(`${e}T00:00:00`)}function Za(e){return`${e.getMonth()+1}/${e.getDate()}`}function Gr(e){return e.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function Xr(){const e=new Date,t=Cn(Hr(Qr(e),-3)),s=Ka(new Date(e.getFullYear(),e.getMonth()+4,0)),n=[];let i=new Date(t);for(;i<=s;){const l=Ka(i);n.push({start:new Date(i),end:l,label:`${Za(i)} - ${Za(l)}`}),i=kn(i,7)}return n}function Kr(e){const t=Xr(),s=`160px repeat(${t.length}, minmax(56px, 1fr))`,n=t.map(l=>`
      ...
      `).join(""),i=e.length?e.map(l=>{const c=Wa(l.startDate),p=Wa(l.expectedDoneDate),u=Math.max(0,t.findIndex(v=>v.end>=c)),y=Math.max(u,t.reduce((v,b,x)=>b.start<=p?x:v,u)),h=[`仕込番号: ${l.jikomiNo}`,`銘柄: ${l.productName}`,`期間: ${l.startDate} - ${l.expectedDoneDate}`,`タンク: ${l.tankNo}`,`備考: ${l.note||"なし"}`].join(`
`);return`
  ...
  `}function Ve(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function as(e){return e.trim().toLowerCase()}function yl(e,t){const s=as(t),n=e.filter(l=>s?[l.code,l.name,l.janCode].map(as).some(c=>c.includes(s)):!0),i=n.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
    ...
    `).join(""),u=e.reduce((v,b)=>v+b.amount,0),y=t.reduce((v,b)=>v+b.balance,0),h=t.filter(v=>v.status!=="paid").length;return`
    <section class="page-head">
      <div>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function it(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function $l(e){switch(e){case"A":return"success";case"B":return"warning";case"C":return"neutral"}}function _l(e){if(e.length===0)return'<div class="chart-empty">データなし</div>';const t=e.slice(0,15),s=Math.max(...t.map(v=>v.amount),1),n=28,i=6,l=140,c=100,p=760,u=p-l-c,y=t.length*(n+i)+16,h=t.map((v,b)=>{const x=v.amount/s*u,S=b*(n+i)+8,o=v.abcRank==="A"?"#2F855A":v.abcRank==="B"?"#B7791F":"#718096";return`
        <g>
  ...
  `}function Pn(e,t,s="all",n="",i=[],l=[],c="",p="",u=null,y="all",h="",v=[],b=[],x=[],S=null,o=[],r=[],d="amount",m="calendar"){const g=t==="products"?"商品別集計":t==="customers"?"得意先別集計":"担当別集計",$=t==="products"?e.productTotals:t==="customers"?e.customerTotals:e.staffTotals,P=s!=="all"&&i.length>0&&t!=="staff"?i:$,k=He(P,x,Sl),E={all:"月別",yearly:"月別推移",monthly:"日別推移",weekly:"日別推移",daily:"当日"},q=ns[d],M=J=>d==="quantity"?J.quantity:d==="volume"?J.volumeMl:J.amount,O=J=>d==="quantity"?`${J.toLocaleString()}本`:d==="volume"?Ft(J):Ge(J);let L,T=[],R,H,ee;if(S&&S.monthlySales.length>0)L=S.monthlySales.slice(-24).map(J=>({month:J.month,amount:M(J)})),R=`${S.name} の月別${q}`,H=`${S.tab==="customers"?"得意先":"商品"}: ${S.code}`,ee="#0968e5";else if(o.length>0&&s!=="all"){L=o.map(z=>({month:z.month,amount:M(z)})),T=r.map(z=>({month:z.month,amount:M(z)}));const J=L.reduce((z,U)=>z+U.amount,0),fe=T.reduce((z,U)=>z+U.amount,0),je=fe>0?(J-fe)/fe*100:0,Pe=je>0?"+":"";R=`${E[s]} ${q}（${n}）`,H=`${O(J)}${fe>0?` / 前年比 ${Pe}${je.toFixed(1)}%`:""}`,ee="#2f855a"}else{L=Cl(e.monthlySales,d,m).curr,T=[];const fe=L.reduce((Pe,z)=>Pe+z.amount,0);R=`${m==="fiscal"?"決算年度別":"暦年別"}${q}`,H=`累計 ${O(fe)}（${L.length}${m==="fiscal"?"期":"年"}）`,ee="#0F5B8D"}const se=["amount","quantity","volume"].map(J=>`<button class="tab-button ${J===d?"active":""}" data-chart-metric="${J}">${ns[J]}</button>`).join(""),le=["all","yearly","monthly","weekly","daily"].map(J=>`<button class="button ${J===s?"primary":"secondary"} small" type="button" data-analytics-period="${J}">${os[J]}</button>`).join(""),j=m==="fiscal"&&s==="yearly"?Pl(e.monthlySales):l,Y=m==="fiscal"&&s==="yearly"&&!j.includes(n)?j[0]??"":n,te=s!=="all"&&j.length>0&&t!=="staff"?`<select id="analytics-period-select" style="padding:6px 10px;border:1px solid var(--border);border-radius:6px;font-size:13px;">
        ...
        </select>`:"",Pe=(b.length>0?b:e.staffTotals).filter(U=>!c||U.name.includes(c)||U.code.includes(c)),z=y!=="all"&&h?` (${h})`:"";if(ce=`
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${Pe.length===0?'<tr><td colspan="6" class="empty-row">データなし</td></tr>':Pe.map(U=>`
                <tr>
                  <td class="mono">${U.code||"―"}</td>
                  <td>${U.name||"未設定"}</td>
    ...
    `,u){const U=u.breakdownTab,Le=y!=="all"&&h?`<span style="font-size:12px;color:var(--text-secondary);margin-left:8px;">${h}</span>`:"";me=`
  ...
  `}function kt(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Ml(e,t,s,n){const i={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},l={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},c={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},p=e.map(v=>`
      <tr>
        <td>${v.saleTime}</td>
    ...
    `).join(""),y=e.reduce((v,b)=>v+b.amount,0),h=t.filter(v=>v.status==="new").length;return`
    <section class="page-head">
      <div>
  ...
  `}const Ut={customers:"得意先マスタ",products:"商品マスタ",suppliers:"仕入先マスタ",staff:"担当者マスタ"},Ol={customers:{required:["legacy_customer_code","name"],optional:["kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"]},products:{required:["legacy_product_code","name"],optional:["kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"]},suppliers:{required:["legacy_supplier_code","name"],optional:["kana_name","phone","postal_code","address1","closing_day","payment_day","email"]},staff:{required:["legacy_staff_code","name"],optional:["kana_name","department"]}};function Rl(e,t,s,n){const i=Ol[e],l=Object.keys(Ut).map(p=>`
  ...
  `}function Qt(e){const t={};return e.querySelectorAll("[data-fd-id]").forEach(s=>{const n=s.dataset.fdId??"",i=parseFloat(s.style.left)||0,l=parseFloat(s.style.top)||0;t[n]={x:i,y:l}}),t}function zl(e,t,s){const n=[...new Set(e.map(b=>b.areaCode).filter(Boolean))].sort(),i=[...new Set(e.map(b=>b.businessTypeName||b.businessType).filter(Boolean))].sort(),l=e.filter(b=>b.isAtRisk),c=e.filter(b=>!b.isAtRisk&&b.isDormant),p=e.filter(b=>!b.isAtRisk&&!b.isDormant&&b.amount12m>0),u=e.filter(b=>!b.isAtRisk&&!b.isDormant&&b.amount12m===0),y=t.filter(b=>b.lat&&b.lng),h=JSON.stringify(e),v=JSON.stringify(y.map(b=>({name:b.name,address:b.address,lat:b.lat,lng:b.lng,phone:b.phone})));return`
    <section class="page-head">
      <div>
...
金井酒造店`;function Xl(e,t){const s=t?e.find(i=>i.id===t):null,n=t==="__new__";return`
    ...
    ${s||n?`
      ...
      `:""}
  `}function Kl(e,t,s,n){const[i,l]=t.split("-").map(_=>parseInt(_,10)),c=new Date(i,l-1,1),p=new Date(i,l,0),u=c.getDay(),y=p.getDate(),h=[];for(let _=0;_<u;_++)h.push({isOutside:!0});for(let _=1;_<=y;_++)h.push({date:new Date(i,l-1,_)});for(;h.length%7!==0;)h.push({isOutside:!0});const v=s?e.filter(_=>_.category===s):e,b={};v.forEach(_=>{const P=_.startsAt.slice(0,10);b[P]??=[],b[P].push(_)});const x=new Date().toISOString().slice(0,10),S=h.map(_=>{if(_.isOutside)return'<div class="cal-cell cal-outside"></div>';const P=_.date,k=`${P.getFullYear()}-${String(P.getMonth()+1).padStart(2,"0")}-${String(P.getDate()).padStart(2,"0")}`,E=b[k]??[],q=k===x,M=P.getDay();return`
        <div class="cal-cell ${q?"cal-today":""} ${M===0?"cal-sun":M===6?"cal-sat":""}"
             data-cal-date="${k}">
          <div class="cal-day-num">${P.getDate()}</div>
          <div class="cal-events">
            ${E.slice(0,3).map(O=>`
              <button class="cal-event" data-cal-event-id="${O.id}"
                      style="background:${O.color||La[O.category]||"#0F5B8D"};"
                      title="${O.title}">
      ...
      `}).join(""),o=n?.isOpen?Wl(n):"",r=new Date(i,l-2,1),d=new Date(i,l,1),m=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`,g=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}`,$=(()=>{const _=new Date;return`${_.getFullYear()}-${String(_.getMonth()+1).padStart(2,"0")}`})();return`
    <section class="page-head">
      <div>
...
`}async function qn(e,t){const{supabaseInsert:s}=await A(async()=>{const{supabaseInsert:p}=await Promise.resolve().then(()=>Q);return{supabaseInsert:p}},void 0);let n=0,i=0;const c={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[e];for(const p of t){if(!p._valid)continue;const{_valid:u,_error:y,...h}=p,v={...h};if(!v.id){const b=e==="customers"?"legacy_customer_code":e==="products"?"legacy_product_code":e==="suppliers"?"legacy_supplier_code":"legacy_staff_code";v.id=String(h[b]??`${e}-${Date.now()}-${n+i}`)}for(const b of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof v[b]=="string"&&v[b]!==""){const x=Number(v[b]);Number.isFinite(x)&&(v[b]=x)}try{await s(c,v)!==null?n++:i++}catch{i++}}return{inserted:n,failed:i}}const _c=Object.freeze(Object.defineProperty({__proto__:null,generateTemplateCSV:Dn,importToSupabase:qn,parseCSV:An,validateImport:Ln},Symbol.toStringTag,{value:"Module"}));function Gt(e){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}function wc(e,t=40){return!e||e.length<=t?e||"":e.slice(0,t)+"…"}function xc(e,t,s,n,i){const l=s.reduce((y,h)=>y+h.rowCount,0),c=s.map(y=>y.lastSyncAt).filter(y=>y!==null).sort().reverse()[0]??null,p=100,u=Math.max(1,Math.ceil(i/p));return`
  ...
  `}const Ac={monthly:"月次",annual:"年次",make_to_order:"受注生産",november:"11月生産"};function Lc(e,t,s,n){const i={draft:"下書き",confirmed:"確定",actual:"実績入力済"},l={draft:"neutral",confirmed:"info",actual:"success"},c=k=>Object.entries(Ac).map(([E,q])=>`<option value="${E}" ${E===k?"selected":""}>${q}</option>`).join(""),p=640,u=k=>k.map(E=>{const q=Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock),M=E.plannedQty>0?E.plannedQty:Math.round(q),O=M>0?Math.ceil(M/p*10)/10:0,L=E.plannedQty>0?(E.actualQty-E.plannedQty)/E.plannedQty*100:null,T=L!==null?L>=0?"text-success":"text-danger":"";return`
    ...
    `}).join(""),h=(s==="all"?e:e.filter(k=>k.productionType===s)).slice().sort((k,E)=>{if(!n)return 0;const q=n.dir==="asc"?1:-1,M=Math.max(0,k.demandForecast+k.safetyStockTarget-k.openingStock),O=Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock);switch(n.column){case"plan-name":return q*k.productName.localeCompare(E.productName,"ja");case"plan-forecast":return q*(k.demandForecast-E.demandForecast);case"plan-required":return q*(M-O);case"plan-planned":return q*(k.plannedQty-E.plannedQty);case"plan-actual":return q*(k.actualQty-E.actualQty);case"plan-label":{const L=k.plannedQty>0?k.plannedQty:Math.round(M),T=E.plannedQty>0?E.plannedQty:Math.round(O);return q*(L-T)}default:return 0}}),v=u(h),b=[{key:"all",label:"全て"},{key:"monthly",label:"月次"},{key:"annual",label:"年次"},{key:"november",label:"11月生産"},{key:"make_to_order",label:"受注生産"}],x=k=>{const q=(k==="all"?e:e.filter(M=>M.productionType===k)).reduce((M,O)=>{const L=Math.max(0,O.demandForecast+O.safetyStockTarget-O.openingStock);return M+(O.plannedQty>0?O.plannedQty:Math.round(L))},0);return Math.ceil(q/p*10)/10},S=b.filter(k=>k.key!=="all").map(k=>{const E=x(k.key),q=e.filter(O=>O.productionType===k.key).length,M=k.key==="make_to_order"?e.filter(O=>O.productionType==="make_to_order"&&O.plannedQty>0).length:null;return`
      <div style="background:var(--surface-alt);border-radius:8px;padding:12px 16px;min-width:130px;">
        ...
        <p style="font-size:11px;color:var(--text-secondary);margin:4px 0 0;">${q}商品${M!==null?` · 受注${M}件`:""}</p>
      </div>
    `}).join(""),o=h.reduce((k,E)=>k+E.demandForecast,0),r=h.reduce((k,E)=>k+Math.max(0,E.demandForecast+E.safetyStockTarget-E.openingStock),0),d=h.reduce((k,E)=>k+E.plannedQty,0),m=h.reduce((k,E)=>k+E.actualQty,0),g=x(s),$=new Date,_=Array.from({length:24},(k,E)=>{const q=new Date($.getFullYear(),$.getMonth()-6+E,1),M=`${q.getFullYear()}-${String(q.getMonth()+1).padStart(2,"0")}`;return`<option value="${M}" ${M===t?"selected":""}>${M.replace("-","年")}月</option>`}).join(""),P=b.map(k=>`<button class="button ${s===k.key?"primary":"secondary"}" type="button"
  ...
  `}function In(e){const[t,s]=e.split("-").map(Number),n=new Date(t,s,0).getDate();return Array.from({length:n},(i,l)=>{const c=l+1;return`${e}-${String(c).padStart(2,"0")}`})}function ys(e){const t=new Date(e).getDay();return["日","月","火","水","木","金","土"][t]}function hs(e){const t=new Date(e).getDay();return t===0||t===6}function Dc(e,t){return e.partTimers*t.partCapacity+e.employees*t.empCapacity}function Tn(e){return e.partTimers+e.employees}function Se(e,t,s={partCapacity:Ke,empCapacity:We}){const n=e.filter(h=>h.partTimers>0||h.employees>0);if(n.length===0)return;const i=t.reduce((h,v)=>{const b=v.plannedQty>0?v.plannedQty:Math.max(0,v.demandForecast+v.safetyStockTarget-v.openingStock);return h+b},0);if(i<=0)return;const l=i/n.length;let c=0,p=0,u=1/0;const y=Math.ceil(l/s.partCapacity);for(let h=0;h<=y;h++){const v=l-h*s.partCapacity,b=v>0?Math.ceil(v/s.empCapacity):0,x=h+b;x<u&&(u=x,c=h,p=b)}for(const h of e)h.confirmed||(h.partTimers>0||h.employees>0)&&(h.partTimers=c,h.employees=p)}function qc(e,t,s={partCapacity:Ke,empCapacity:We}){const n=t.filter(p=>Tn(p)>0).map(p=>p.date).sort();if(n.length===0)return t.map(p=>({date:p.date,partTimers:p.partTimers,employees:p.employees,confirmed:p.confirmed,capacity:0,items:[],totalQty:0,utilization:0}));const i={monthly:0,november:1,annual:2,make_to_order:3},l=e.filter(p=>p.plannedQty>0||Math.max(0,p.demandForecast+p.safetyStockTarget-p.openingStock)>0).map(p=>({productCode:p.productCode,productName:p.productName,productionType:p.productionType,remaining:p.plannedQty>0?p.plannedQty:Math.max(0,p.demandForecast+p.safetyStockTarget-p.openingStock)})).filter(p=>p.remaining>0).sort((p,u)=>(i[p.productionType]??99)-(i[u.productionType]??99)||u.remaining-p.remaining),c=new Map;for(const p of t){const u=Dc(p,s);c.set(p.date,{date:p.date,partTimers:p.partTimers,employees:p.employees,confirmed:p.confirmed,capacity:u,items:[],totalQty:0,utilization:0})}for(const p of l){let u=p.remaining;if(u<=0)continue;if(n.reduce((h,v)=>{const b=c.get(v);return h+Math.max(0,b.capacity-b.totalQty)},0)<=0)break;for(const h of n){if(u<=0)break;const v=c.get(h),b=Math.max(0,v.capacity-v.totalQty);if(b<=0)continue;const x=Math.min(u,b);v.items.push({productCode:p.productCode,productName:p.productName,productionType:p.productionType,qty:x}),v.totalQty+=x,v.utilization=v.capacity>0?v.totalQty/v.capacity:0,u-=x}}return t.map(p=>c.get(p.date))}function Lt(e,t=1,s=1){return In(e).map(n=>({date:n,partTimers:hs(n)?0:t,employees:hs(n)?0:s,confirmed:!1}))}function Ic(e,t,s,n=null,i=new Set,l={partCapacity:Ke,empCapacity:We}){const c=In(t),p=e.filter(L=>!i.has(L.productCode)),u=qc(p,s,l),y=new Map(u.map(L=>[L.date,L])),h=p.reduce((L,T)=>L+(T.plannedQty>0?T.plannedQty:Math.max(0,T.demandForecast+T.safetyStockTarget-T.openingStock)),0),b=e.reduce((L,T)=>L+(T.plannedQty>0?T.plannedQty:Math.max(0,T.demandForecast+T.safetyStockTarget-T.openingStock)),0)-h,x=u.reduce((L,T)=>L+T.totalQty,0),S=s.filter(L=>Tn(L)>0).length,o=u.reduce((L,T)=>L+T.capacity,0),r=s.reduce((L,T)=>L+T.partTimers,0),d=s.reduce((L,T)=>L+T.employees,0),m=S>0?Math.ceil(h/S):0,g=new Date,$=Array.from({length:24},(L,T)=>{const R=new Date(g.getFullYear(),g.getMonth()-6+T,1),H=`${R.getFullYear()}-${String(R.getMonth()+1).padStart(2,"0")}`;return`<option value="${H}" ${H===t?"selected":""}>${H.replace("-","年")}月</option>`}).join(""),_=new Date(c[0]).getDay(),P=[];for(let L=0;L<_;L++)P.push('<div style="min-height:44px;"></div>');for(const L of c){const T=y.get(L),R=new Date(L).getDay(),H=parseInt(L.split("-")[2]),ee=T?.partTimers??0,se=T?.employees??0,le=ee+se,j=T?.totalQty??0,Y=T?.utilization??0,te=L===n,ce=le===0?"var(--surface-alt)":Y>.95?"rgba(197,61,61,0.12)":Y>.7?"rgba(183,121,31,0.10)":Y>0?"rgba(47,133,90,0.08)":"var(--surface)",me=le===0?"transparent":Y>.95?"#c53d3d":Y>.7?"#b7791f":Y>0?"#2f855a":"var(--border)",J=R===0?"#c53d3d":R===6?"#0F5B8D":"var(--text)",fe=le>0?`<span style="font-size:8px;color:var(--text-secondary);line-height:1;">${ee>0?`パ${ee}`:""}${se>0?`社${se}`:""}</span>`:"";P.push(`
    ...
    `).join(""),te=`パ${L.partTimers}×${l.partCapacity} 社${L.employees}×${l.empCapacity} = ${V(L.capacity)}本`,ce=L.totalQty>0?Math.ceil(L.totalQty/l.partCapacity):0,me=[];if(L.totalQty>0)for(let z=0;z<=ce;z++){const U=L.totalQty-z*l.partCapacity;if(U<=0){me.push({p:z,e:0});break}const Le=Math.ceil(U/l.empCapacity);me.push({p:z,e:Le})}const J=L.totalQty-L.capacity,fe=L.totalQty===0?"":J>0?`<span style="color:#c53d3d;font-weight:600;">⚠ ${V(J)}本 不足</span>`:'<span style="color:#2f855a;">✓ キャパ内</span>',je=me.filter(z=>z.p+z.e>0).sort((z,U)=>z.p+z.e-(U.p+U.e)).slice(0,3),Pe=L.totalQty>0?`
      <div style="background:var(--surface-alt);border-radius:6px;padding:10px 12px;margin:0 4px 8px;">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
          ${je.map((z,U)=>{const Le=z.p===L.partTimers&&z.e===L.employees;return`<button data-action="cal-apply-pattern" data-date="${n}" data-part="${z.p}" data-emp="${z.e}"
    ...
    <section class="panel" style="margin-top:12px;" id="cal-label-section">
      <div class="panel-header" style="padding-bottom:4px;">
        <div>
          ...
          <p class="panel-caption">区分ごとにまとめて外す or 個別に外せます${i.size>0?`（<strong>${i.size}</strong>品除外中 = ${V(Math.round(b))}本）`:""}</p>
        </div>
...
${o?.stack??""}</div></section>`}return`
    ...
    ${S}
  `}const Xe={純米大吟醸:"#7c3aed",大吟醸:"#a855f7",純米吟醸:"#2563eb",純米:"#059669",本醸造:"#d97706",普通酒:"#6b7280",リキュール:"#e11d48",その他:"#9ca3af"},ht=["純米大吟醸","大吟醸","純米吟醸","純米","本醸造","普通酒","リキュール","その他"];function xe(e){return e.toLocaleString("ja-JP")}function ge(e){return(e/1e3).toLocaleString("ja-JP",{maximumFractionDigits:1})}function Ma(e){return e<2?"#ef4444":e<=4?"#eab308":"#22c55e"}function Nc(e){return e<2?"要醸造":e<=4?"注意":"余裕あり"}function Mc(e){if(e.length===0)return'<div class="chart-empty">出荷データなし</div>';const t=[...new Set(e.map(r=>r.month))].sort(),s=ht.filter(r=>e.some(d=>d.brewCategory===r)),n={};for(const r of e)n[r.month]||(n[r.month]={}),n[r.month][r.brewCategory]=r.shipmentMl;const i=820,l=300,c={top:20,right:20,bottom:50,left:70},p=i-c.left-c.right,u=l-c.top-c.bottom,y=t.map(r=>s.reduce((d,m)=>d+(n[r]?.[m]??0),0)),h=Math.max(...y,1),v=p/t.length,b=Math.max(v-8,14),x=[0,.25,.5,.75,1].map(r=>{const d=c.top+u-u*r,m=h*r/1e3;return`
    ...
    `}).join(""),S=t.map((r,d)=>{let m=c.top+u;const g=c.left+d*v+(v-b)/2,$=s.map(M=>{const O=n[r]?.[M]??0,L=O/h*u;return m-=L,L>0?`<rect x="${g}" y="${m}" width="${b}" height="${L}" fill="${Xe[M]??"#9ca3af"}" opacity="0.85" rx="1"><title>${M}: ${ge(O)}L</title></rect>`:""}).join(""),[_,P]=r.split("-"),k=parseInt(P),E=k===10||d%2===0,q=k===10?`${_}年度`:`${k}月`;return`<g>${$}${E?`<text x="${g+b/2}" y="${l-12}" class="chart-axis centered-axis" style="font-size:10px;">${q}</text>`:""}</g>`}).join(""),o=s.map(r=>`<span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;font-size:11px;">
  ...
  `}function Oc(e){const t=new Map;for(const n of e){const i=n.brewCategory;t.has(i)||t.set(i,{rows:[],totalMl:0,avgMl:0,stockL:0});const l=t.get(i);l.rows.push(n),l.totalMl+=n.totalShipmentMl,l.avgMl+=n.monthlyAvgMl,l.stockL=n.currentStockL}return`<div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:16px;">${ht.filter(n=>t.has(n)).map(n=>{const i=t.get(n),l=Xe[n]??"#9ca3af",c=n.replace(/[^a-zA-Z0-9]/g,"_"),p=i.stockL*1e3,u=i.totalMl,y=i.avgMl,h=u/1e3,v=y>0?Math.round(p/y*10)/10:0,b=i.stockL-h,x=y>0?Math.round(y*2/1e3*10)/10:0,S=i.stockL<x,o=Ma(v),r=Nc(v),d=Math.min(v/12*100,100),m=b>=0?"#22c55e":"#ef4444",g=b>=0?`+${xe(Math.round(b))}L 余裕`:`${xe(Math.round(b))}L 不足`;return`
        <div class="card" style="border-top:3px solid ${l};min-width:260px;flex:1;">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;">
            <h4 style="margin:0;font-size:14px;color:${l};">${n}</h4>
            <div style="display:flex;gap:4px;align-items:center;">
              <span style="font-size:11px;padding:2px 8px;border-radius:9999px;background:${o}20;color:${o};font-weight:600;">${r}</span>
              <button class="btn-edit-stock" data-cat-id="${c}" data-cat="${n}"
          ...
          <div id="stock-display-${c}">
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:4px;font-size:11px;margin-bottom:8px;">
              <div><span style="color:#6b7280;">現在庫</span><br><strong style="font-size:15px;">${xe(i.stockL)}L</strong></div>
              <div><span style="color:#6b7280;">年間出荷</span><br><strong style="font-size:15px;">${xe(Math.round(h))}L</strong></div>
              <div><span style="color:#6b7280;">月平均</span><br><strong style="font-size:15px;">${ge(y)}L</strong></div>
            </div>
          </div>

          <div id="stock-edit-${c}" style="display:none;margin-bottom:8px;">
            <div style="display:flex;gap:8px;align-items:center;margin-bottom:6px;">
              <label style="font-size:11px;color:#6b7280;display:flex;align-items:center;gap:4px;">
                現在庫(L)
                <input id="stock-input-${c}" type="number" min="0" step="1" value="${i.stockL}"
          ...
          <div style="display:flex;gap:8px;margin-bottom:6px;font-size:11px;flex-wrap:wrap;">
            <span style="color:${m};font-weight:600;">年間比 ${g}</span>
            <span style="color:${S?"#ef4444":"#6b7280"};">安全在庫${xe(x)}L${S?" ⚠下回り":" ✓"}</span>
          </div>

          <div style="margin-bottom:4px;display:flex;justify-content:space-between;font-size:11px;">
            <span style="color:#6b7280;">残月数</span>
            <span style="font-weight:600;color:${o};">${v.toFixed(1)}ヶ月</span>
          </div>
          <div style="background:#e5e7eb;border-radius:4px;height:8px;overflow:hidden;">
            <div style="background:${o};height:100%;width:${d}%;border-radius:4px;transition:width 0.3s;"></div>
          </div>
        </div>
  ...
  `,n=[];for(const i of ht){const l=t.get(i);if(!l)continue;const c=Xe[i]??"#9ca3af",p=l.length>1,u=l.reduce((r,d)=>r+d.totalShipmentQty,0),y=l.reduce((r,d)=>r+d.totalShipmentMl,0),h=l.reduce((r,d)=>r+d.monthlyAvgQty,0),v=l.reduce((r,d)=>r+d.monthlyAvgMl,0),b=l.reduce((r,d)=>r+d.productCount,0),x=l[0].currentStockL,S=v>0?Math.round(x*1e3/v*10)/10:0,o=Ma(S);if(n.push(`
      <tr style="font-weight:600;background:#f9fafb;cursor:${p?"pointer":"default"};" ${p?`data-toggle-cat="${i}"`:""}>
        ...
        <td style="text-align:right;">${xe(u)}</td>
        <td style="text-align:right;">${ge(y)}</td>
        <td style="text-align:right;">${xe(h)}</td>
        <td style="text-align:right;">${ge(v)}</td>
        <td style="text-align:right;">${xe(x)}</td>
    ...
    `),p)for(const r of l)n.push(`
          <tr class="sub-row-${i.replace(/[^a-zA-Z0-9]/g,"_")}" style="display:none;font-size:12px;">
            ...
            <td style="text-align:right;">${xe(r.totalShipmentQty)}</td>
            <td style="text-align:right;">${ge(r.totalShipmentMl)}</td>
            <td style="text-align:right;">${xe(r.monthlyAvgQty)}</td>
  ...
  `}function jc(e){const t=new Map;for(const n of e){t.has(n.brewCategory)||t.set(n.brewCategory,{avgMl:0,totalMl:0,stockL:n.currentStockL});const i=t.get(n.brewCategory);i.avgMl+=n.monthlyAvgMl,i.totalMl+=n.totalShipmentMl}return`
    <div class="card" style="margin-bottom:16px;">
      ...
      ${ht.filter(n=>t.has(n)).map(n=>{const i=t.get(n),l=i.avgMl>0?Math.round(i.stockL*1e3/i.avgMl*10)/10:0,c=i.totalMl/1e3,p=c>0?Math.round(i.stockL/c*100):0,u=Xe[n]??"#9ca3af",y=Ma(l),h=Math.min(l/12*100,100);return`
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;">
          <span style="width:80px;font-size:12px;font-weight:500;color:${u};text-align:right;">${n}</span>
          <div style="flex:1;background:#e5e7eb;border-radius:4px;height:24px;overflow:hidden;position:relative;">
            <div style="background:${y};height:100%;width:${h}%;border-radius:4px;transition:width 0.3s;"></div>
            <span style="position:absolute;top:3px;left:8px;font-size:11px;font-weight:600;color:#374151;">
              ${l.toFixed(1)}ヶ月 / 年間の${p}%
            </span>
          </div>
          <span style="width:60px;font-size:11px;text-align:right;color:${i.stockL>0?"var(--text)":"#ef4444"};">${xe(i.stockL)}L</span>
        </div>
      `}).join("")}
    </div>
  `}function Fc(e,t,s,n){if(e.length===0)return"";const i=[...ht,...s],l=new Map;for(const u of e)l.has(u.brewCategory)||l.set(u.brewCategory,[]),l.get(u.brewCategory).push(u);for(const u of s)l.has(u)||l.set(u,[]);const c=(u,y)=>i.map(h=>`<option value="${h}" ${h===u?"selected":""}>${h}${h===y?"（自動）":""}</option>`).join("");return`
    <div class="card" style="margin-bottom:16px;">
      ...
      ${i.filter(u=>l.has(u)).map(u=>{const y=l.get(u),h=Xe[u]??"#6366f1",v=s.includes(u),b=y.filter(r=>!t.has(r.productCode)),x=b.reduce((r,d)=>r+d.annualMl,0);b.reduce((r,d)=>r+d.annualQty,0);const S=b.reduce((r,d)=>r+d.monthlyAvgMl,0),o=y.map(r=>{const d=t.has(r.productCode),m=r.productCode in n;return`
        ...
        <div style="margin-bottom:20px;">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;flex-wrap:wrap;">
            ...
            <span style="font-size:12px;color:var(--text-secondary);">
              ${b.length}銘柄 ・ 年間${ge(x)}L ・ 月平均${ge(S)}L
            </span>
          </div>
          ${y.length>0?`
            <div class="table-wrap">
  ...
  `}function zc(e,t,s,n=[],i=new Set,l=[],c={}){const p=new Date,u=p.getMonth()>=9?p.getFullYear():p.getFullYear()-1,y=Array.from({length:5},(v,b)=>{const x=u-b;return`<option value="${x}" ${x===s?"selected":""}>${x}年度 (${x}/10-${x+1}/9)</option>`}).join(""),h=e.length===0&&t.length===0?'<section class="panel"><div class="loading-overlay"><div class="loading-spinner"></div><p class="loading-text">データを読み込んでいます...</p></div></section>':"";return h||`
    <section class="panel">
  ...
  `}function ua(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e4?`${Math.round(e/1e4)}万`:new Intl.NumberFormat("ja-JP").format(e)+"円"}function Bc(e){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(e)}function Nn(e){return e?jt.find(t=>t.value===e)?.label??e:""}function Vc(e){const t=[],s=[],n=[];for(const i of e){const l=i.amount_last_year_same_month>0?i.amount_this_month/i.amount_last_year_same_month:1,c={code:i.customer_code,name:i.customer_name,businessType:i.business_type,areaCode:i.area_code,phone:i.phone,lastOrderDate:i.last_order_date,daysSinceLastOrder:i.days_since_order,totalAmountLast12m:i.amount_12m,amount3m:i.amount_3m,amountThisMonth:i.amount_this_month,amountLastYearSameMonth:i.amount_last_year_same_month,annualRevenue:i.annual_revenue,yoyRatio:l,status:"dormant"};i.is_at_risk?t.push({...c,status:"at-risk"}):i.is_dormant?s.push({...c,status:"dormant"}):i.amount_last_year_same_month>0&&l<.8&&n.push({...c,status:"declining"})}return t.sort((i,l)=>l.totalAmountLast12m-i.totalAmountLast12m),s.sort((i,l)=>l.daysSinceLastOrder-i.daysSinceLastOrder),n.sort((i,l)=>i.yoyRatio-l.yoyRatio),{atRiskCustomers:t,dormantCustomers:s,decliningCustomers:n}}function Jc(e,t){const s=t?.reason??"",n=jt.map(i=>`<option value="${i.value}" ${s===i.value?"selected":""}>${i.label}</option>`).join("");return`
    ...
    ${Kt("at-risk","離反リスク","前年同月に注文があったが今月まだない顧客","danger",s,c,"状況",b)}
    ${Kt("dormant","休眠顧客","12ヶ月以内に注文があったが3ヶ月以上空白がある顧客","warning",n,p,"経過日数",b)}
    ${Kt("declining","売上下落中","前年同月比80%未満の顧客（離反・休眠を除く）","info",i,u,"前年同月比",b)}
...
<div class="panel">
  ...
  <div style="display:flex;gap:4px;margin-bottom:1.5rem;flex-wrap:wrap">
    ${Ae.map((v,b)=>{const x=b===i,S=b===n;return`<button class="button" style="padding:4px 10px;background:${S?"#0F5B8D":x?"#e2e8f0":"transparent"};color:${S?"#fff":"#333"};border:${x&&!S?"2px solid #0F5B8D":"1px solid #cbd5e0"};border-radius:4px;font-size:0.8rem;cursor:pointer" data-action="select-month" data-month="${b}">${v}${x?" ●":""}</button>`}).join("")}
  </div>
  ...
  ${ed(c)}
      ...
      <span class="status-pill" style="background:${Ee[i]}15;color:${Ee[i]};padding:2px 8px;border-radius:9px;font-size:0.75rem">${pa[i]}</span>
    </td></tr>`);for(const c of l){const p=Ae.map((u,y)=>{const h=c.peakMonths.includes(y),v=Mn(c,y),b=y===t?"outline:2px solid #0F5B8D;outline-offset:-1px;":"";let x="transparent";h?x=Ee[c.seasonType]:v&&(x=Ee[c.seasonType]+"40");const S=h||v?`background:${x};border-radius:3px;height:18px;width:100%;`:"";return`<td style="padding:2px;text-align:center;${b}"><div style="${S}" title="${h?"ピーク":v?"提案期間":""}"></div></td>`}).join("");s.push(`<tr style="border-bottom:1px solid #f0f0f0">
        ...
        <td style="padding:4px"><span class="status-pill" style="font-size:0.65rem;padding:1px 5px;background:${Ee[c.seasonType]}15;color:${Ee[c.seasonType]}">${pa[c.seasonType]}</span></td>
        ${p}
      </tr>`)}}}return s.join("")}function Mn(e,t){if(e.peakMonths.length===0||e.peakMonths.includes(t))return!1;const s=e.proposalStartMonth,n=e.peakMonths[0];return s<=n?t>=s&&t<n:t>=s||t<n}function Zc(e,t){const n=["year-round","seasonal","year-end"].map(i=>{const l=e[i];if(l.length===0)return"";const c=l.filter(u=>u.peakMonths.includes(t)||Mn(u,t));if(c.length===0)return"";const p=c.map(u=>{const h=u.peakMonths.includes(t)?'<span class="status-pill" style="background:#c0562115;color:#c05621">ピーク月</span>':'<span class="status-pill" style="background:#2f855a15;color:#2f855a">提案開始</span>',v=u.monthlyQuantity.reduce((b,x)=>b+x,0);return`<tr>
        ...
        <td style="padding:6px 8px">${u.peakMonths.map(b=>Ae[b]).join(", ")}</td>
      </tr>`}).join("");return`
    <div class="table-wrap" style="margin-bottom:1rem">
      <h4 style="margin-bottom:0.5rem;display:flex;align-items:center;gap:8px">
        <span class="status-pill" style="background:${Ee[i]}15;color:${Ee[i]}">${pa[i]}</span>
    ...
    </div>`}).filter(Boolean);return n.length===0?`<div style="padding:1rem;color:#666;text-align:center">${Ae[t]}に提案対象の商品はありません</div>`:n.join("")}function ed(e){return!e||e.targetCustomers.length===0?`
  ...
  `).join("")}</tbody>
    ...
    `}).join(""),b=s&&e?.[s]?nd(e[s]):s?`<div class="sc-detail-empty"><p>📦 ${s.slice(5)} は出荷なし</p></div>`:'<div class="sc-detail-empty"><p>日付を選択すると出荷先一覧が表示されます</p></div>',x=Object.values(e??{}).reduce((o,r)=>o+r.count,0),S=Object.values(e??{}).reduce((o,r)=>o+r.totalAmount,0);return`
  ...
  `}function nd(e){const t=e.date.replace(/-/g,"/").slice(5),s={};for(const i of e.entries)(s[i.city]??=[]).push(i);const n=Object.entries(s).sort((i,l)=>l[1].length-i[1].length).map(([i,l])=>{const c=l.sort((p,u)=>u.amount-p.amount).map(p=>`
    ...
    ${n}
  `}const od=new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}),Wt=["月","火","水","木","金"],vs=6;function id(e,t){if(!e)return 9999;const s=new Date(e);return isNaN(s.getTime())?9999:Math.floor((t.getTime()-s.getTime())/(1e3*60*60*24))}function rd(e,t){if(t.length===0)return 0;const s=[...t].sort((i,l)=>i-l);return s.filter(i=>i<=e).length/s.length}function ld(e,t){return e.includes("離反リスク")?"緊急訪問 - 離反防止ヒアリング":e.includes("季節提案タイミング")?"季節商品の提案・試飲サンプル持参":t>30?"定期巡回 - 状況確認・追加注文確認":"関係維持 - ご挨拶"}function gs(e){const t=new Date,s=e.map(u=>u.annualRevenue),n=e.map(u=>{const y=id(u.lastOrderDate,t);let h=0;const v=[];y>=60&&(h+=50,v.push("離反リスク")),u.hasSeasonalProposal&&(h+=30,v.push("季節提案タイミング")),y>=30&&y<60&&(h+=20,v.push("定期巡回"));const b=rd(u.annualRevenue,s),x=Math.round(b*20);x>0&&(h+=x,v.push("金額ウェイト"));const S=ld(v,y);return{code:u.code,name:u.name,phone:u.phone,address:u.address1,areaCode:u.areaCode,businessType:u.businessType,priorityScore:h,reasons:v,lastOrderDate:u.lastOrderDate,daysSinceOrder:y,annualRevenue:u.annualRevenue,recommendedAction:S}}).filter(u=>u.priorityScore>0).sort((u,y)=>y.priorityScore-u.priorityScore),i=new Map;for(const u of n){const y=u.areaCode||"その他";i.has(y)||i.set(y,[]),i.get(y).push(u)}const l=[...i.entries()].sort((u,y)=>y[1].reduce((h,v)=>h+v.priorityScore,0)-u[1].reduce((h,v)=>h+v.priorityScore,0)),c=[];let p=0;for(const[u,y]of l){const h=y.sort((v,b)=>b.priorityScore-v.priorityScore);for(let v=0;v<h.length&&!(p>=Wt.length);v+=vs){const b=h.slice(v,v+vs);c.push({dayLabel:Wt[p],area:u,visits:b}),p++}if(p>=Wt.length)break}return{candidates:n,weekPlan:c,filterArea:"",filterMinScore:0}}function cd(e){const{candidates:t,weekPlan:s,filterArea:n,filterMinScore:i}=e,l=t.filter(v=>!(n&&v.areaCode!==n||i>0&&v.priorityScore<i)),c=Array.from(new Set(t.map(v=>v.areaCode))).sort(),p=l.length,u=l.filter(v=>v.priorityScore>=50).length,y=l.filter(v=>v.reasons.includes("離反リスク")).length,h=s.reduce((v,b)=>v+b.visits.length,0);return`
    <section class="page-head">
      <div>
