(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const i of l)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function n(l){const i={};return l.integrity&&(i.integrity=l.integrity),l.referrerPolicy&&(i.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?i.credentials="include":l.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(l){if(l.ep)return;l.ep=!0;const i=n(l);fetch(l.href,i)}})();const Je="modulepreload",Ve=function(t){return"/sake-system/"+t},Et={},N=function(e,n,s){let l=Promise.resolve();if(n&&n.length>0){let r=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};var d=r;document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),c=o?.nonce||o?.getAttribute("nonce");l=r(n.map(u=>{if(u=Ve(u),u in Et)return;Et[u]=!0;const p=u.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${h}`))return;const v=document.createElement("link");if(v.rel=p?"stylesheet":Je,p||(v.as="script"),v.crossOrigin="",v.href=u,c&&v.setAttribute("nonce",c),document.head.appendChild(v),p)return new Promise((y,_)=>{v.addEventListener("load",y),v.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${u}`)))})}))}function i(o){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=o,window.dispatchEvent(c),!c.defaultPrevented)throw o}return l.then(o=>{for(const c of o||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})},z="https://loarwnuyvfxiscjjsmiz.supabase.co",gt="";async function ft(t,e){return null}async function k(t,e={}){return[]}const ae=Object.freeze(Object.defineProperty({__proto__:null,SUPABASE_ANON_KEY:gt,SUPABASE_URL:z,supabaseInsert:ft,supabaseQuery:k},Symbol.toStringTag,{value:"Module"})),$t="sake_auth";function se(t){localStorage.setItem($t,JSON.stringify(t))}function ne(){return{apikey:gt,"Content-Type":"application/json"}}function Be(t){try{const[,e]=t.split(".");if(!e)return null;const n=e.replaceAll("-","+").replaceAll("_","/"),s=n.padEnd(Math.ceil(n.length/4)*4,"=");return JSON.parse(atob(s))}catch{return null}}async function le(t,e){const n=await fetch(`${z}/auth/v1/${t}`,{method:"POST",headers:ne(),body:JSON.stringify(e)}),s=await n.json().catch(()=>({}));if(!n.ok)throw new Error(s.error_description??s.msg??`HTTP ${n.status}`);return s}async function Ue(t,e){const n=await le("token?grant_type=password",{email:t,password:e});return se({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??t}}async function He(t,e){const n=await le("signup",{email:t,password:e});return n.access_token&&n.refresh_token&&se({access_token:n.access_token,refresh_token:n.refresh_token}),{email:n.user?.email??t}}async function Ye(){const t=kt();if(localStorage.removeItem($t),!!t?.access_token)try{await fetch(`${z}/auth/v1/logout`,{method:"POST",headers:{...ne(),Authorization:`Bearer ${t.access_token}`}})}catch(e){console.warn("Supabase sign out failed",e)}}function kt(){const t=localStorage.getItem($t);if(!t)return null;try{const e=JSON.parse(t);return!e.access_token||!e.refresh_token?null:{access_token:e.access_token,refresh_token:e.refresh_token}}catch{return null}}function Ke(){const t=kt();if(!t)return null;const e=Be(t.access_token),n=typeof e?.email=="string"?e.email:null;return n?{email:n}:null}const St={spring:{id:"spring",season:"春",subject:"新酒のご案内",body:`いつもお世話になっております。
...
ご注文締切や納品希望日がございましたら、あわせてお知らせください。`}},lt={generatedAt:"2026-04-15T09:15:00+09:00",kpis:{todaySales:1248e3,todayDelta:8.2,monthSales:18245e3,monthDelta:5.6,unpaidCount:7,unpaidAmount:264e4},dailySales:Array.from({length:30},(t,e)=>{const n=new Date("2026-03-17T00:00:00+09:00");return n.setDate(n.getDate()+e),{date:n.toISOString(),amount:42e4+e*73123%62e4}}),salesRecords:Array.from({length:20},(t,e)=>{const n=new Date("2026-04-15T00:00:00+09:00");return n.setDate(n.getDate()-e),{id:`sale-${e+1}`,documentNo:`D${String(240100+e).padStart(6,"0")}`,date:n.toISOString(),customerCode:`C${String(e+11).padStart(4,"0")}`,customerName:["青葉商事","北斗酒販","中央フーズ","東海酒店"][e%4],amount:68e3+e%6*24500}})},ze={generatedAt:"2026-04-15T09:15:00+09:00",records:[{id:"pay-1",customerCode:"C0011",customerName:"青葉商事",billedAmount:54e4,paymentAmount:0,balanceAmount:54e4,lastPaymentDate:null,status:"unpaid"},{id:"pay-2",customerCode:"C0012",customerName:"北斗酒販",billedAmount:72e4,paymentAmount:3e5,balanceAmount:42e4,lastPaymentDate:"2026-04-11T14:30:00+09:00",status:"partial"},{id:"pay-3",customerCode:"C0013",customerName:"中央フーズ",billedAmount:68e4,paymentAmount:68e4,balanceAmount:0,lastPaymentDate:"2026-04-14T10:00:00+09:00",status:"paid"},{id:"pay-4",customerCode:"C0014",customerName:"東海酒店",billedAmount:41e4,paymentAmount:18e4,balanceAmount:23e4,lastPaymentDate:"2026-04-10T09:10:00+09:00",status:"partial"}]},A={generatedAt:"2026-04-15T09:15:00+09:00",summary:{customerCount:164,activeCustomerCount:152,productCount:486,activeProductCount:461},customers:Array.from({length:12},(t,e)=>({id:`customer-${e+1}`,code:`C${String(e+1).padStart(4,"0")}`,name:["青葉商事","北斗酒販","中央フーズ","東海酒店","三和物産","南星リカー"][e%6],closingDay:[15,20,25,31][e%4],paymentDay:[5,10,15,20][e%4],isActive:e%5!==0})),products:Array.from({length:12},(t,e)=>({id:`product-${e+1}`,code:`P${String(e+1).padStart(5,"0")}`,janCode:`4901234567${String(e).padStart(3,"0")}`,name:["純米吟醸 720ml","本醸造 1.8L","特別純米 300ml","梅酒 500ml"][e%4],category:["清酒","焼酎","リキュール"][e%3],isActive:e%6!==0}))},Qe={generatedAt:"2026-04-15T09:15:00+09:00",lastSyncAt:"2026-04-15T09:12:21+09:00",status:"success",jobName:"daily-sync",message:"同期完了。売上・入金・マスタを最新化しました。"},ie=lt.salesRecords.map((t,e)=>({...t,itemCount:e%4+1})),We={C0011:{customerCode:"C0011",customerName:"青葉商事",balanceAmount:54e4,salesTotal:114e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-1",date:"2026-04-15T00:00:00+09:00",documentNo:"D240100",amount:42e4},{id:"ledger-sale-2",date:"2026-04-08T00:00:00+09:00",documentNo:"D240087",amount:39e4},{id:"ledger-sale-3",date:"2026-03-28T00:00:00+09:00",documentNo:"D240059",amount:33e4}],paymentHistory:[{id:"ledger-payment-1",date:"2026-04-10T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-2",date:"2026-03-31T00:00:00+09:00",amount:3e5,method:"振込"}]},C0012:{customerCode:"C0012",customerName:"北斗酒販",balanceAmount:42e4,salesTotal:102e4,paymentTotal:6e5,salesHistory:[{id:"ledger-sale-4",date:"2026-04-14T00:00:00+09:00",documentNo:"D240101",amount:36e4},{id:"ledger-sale-5",date:"2026-04-05T00:00:00+09:00",documentNo:"D240082",amount:32e4},{id:"ledger-sale-6",date:"2026-03-25T00:00:00+09:00",documentNo:"D240054",amount:34e4}],paymentHistory:[{id:"ledger-payment-3",date:"2026-04-11T00:00:00+09:00",amount:3e5,method:"振込"},{id:"ledger-payment-4",date:"2026-03-30T00:00:00+09:00",amount:3e5,method:"現金"}]}},it={productTotals:[{code:"P00001",name:"純米吟醸 720ml",amount:584e4,quantity:820,documents:148},{code:"P00002",name:"本醸造 1.8L",amount:498e4,quantity:610,documents:131},{code:"P00003",name:"特別純米 300ml",amount:356e4,quantity:1240,documents:112},{code:"P00004",name:"梅酒 500ml",amount:287e4,quantity:540,documents:89}],customerTotals:[{code:"C0011",name:"青葉商事",amount:462e4,quantity:320,documents:54},{code:"C0012",name:"北斗酒販",amount:438e4,quantity:294,documents:49},{code:"C0013",name:"中央フーズ",amount:391e4,quantity:276,documents:45},{code:"C0014",name:"東海酒店",amount:324e4,quantity:221,documents:37}]};function f(t){if(typeof t=="number"&&Number.isFinite(t))return t;if(typeof t=="string"){const e=Number(t);return Number.isFinite(e)?e:0}return 0}function Ge(t){switch((t??"").toLowerCase()){case"paid":case"complete":case"completed":return"paid";case"partial":case"partially_paid":case"partially paid":return"partial";default:return"unpaid"}}function Xe(t){return typeof t=="boolean"?t:typeof t=="number"?t!==0:typeof t=="string"?["true","1","active","enabled","yes","y"].includes(t.toLowerCase()):!1}function x(t,e,n=""){for(const s of e){const l=t[s];if(typeof l=="string"&&l.length>0)return l}return n}function Rt(t,e,n=0){for(const s of e)if(s in t)return f(t[s]);return n}function qt(t,e,n=!0){for(const s of e)if(s in t)return Xe(t[s]);return n}function oe(t,e,n){for(const s of e){const l=t[s];if(typeof l!="string"||l.length===0)continue;if(/^\d{4}-\d{2}-\d{2}$/.test(l))return new Date(`${l}T00:00:00Z`).toISOString();const i=new Date(l);if(!Number.isNaN(i.getTime()))return i.toISOString()}return n}function ce(t){return t.slice(0,7)}function wt(t,e){return{id:String(t.id??`invoice-${e+1}`),documentNo:t.document_no??t.legacy_document_no??`D${String(240100+e).padStart(6,"0")}`,date:oe(t,["sales_date","document_date"],new Date().toISOString()),customerCode:t.customer_code??t.legacy_customer_code??`C${String(e+1).padStart(4,"0")}`,customerName:t.customer_name??t.customer_code??t.legacy_customer_code??"不明",itemCount:0,amount:f(t.total_amount??t.billed_amount)}}function Mt(t,e){const n=e.startDate?new Date(`${e.startDate}T00:00:00`):null,s=e.endDate?new Date(`${e.endDate}T23:59:59`):null,l=e.documentNo.trim().toLowerCase(),i=e.customerCode.trim().toLowerCase();return t.filter(d=>{const o=new Date(d.date);return!(n&&o<n||s&&o>s||l&&!d.documentNo.toLowerCase().includes(l)||i&&!d.customerCode.toLowerCase().includes(i))}).sort((d,o)=>new Date(o.date).getTime()-new Date(d.date).getTime())}function It(t){const e=t.trim().toUpperCase(),n=We[e];if(n)return n;const s=lt.salesRecords.find(l=>l.customerCode.toUpperCase()===e);return{customerCode:e||"未指定",customerName:s?.customerName??"該当得意先なし",balanceAmount:0,salesTotal:0,paymentTotal:0,salesHistory:[],paymentHistory:[]}}function Ze(){const t=new Map,e=new Map,n=new Map;return ie.forEach((s,l)=>{const i=ce(s.date);t.set(i,(t.get(i)??0)+s.amount);const d=e.get(s.customerCode)??{code:s.customerCode,name:s.customerName,amount:0,quantity:0,documents:0};d.amount+=s.amount,d.quantity+=s.itemCount,d.documents+=1,e.set(s.customerCode,d);const o=`P${String(l%4+1).padStart(5,"0")}`,c=it.productTotals[l%it.productTotals.length],r=n.get(o)??{code:o,name:c?.name??`商品${l+1}`,amount:0,quantity:0,documents:0};r.amount+=s.amount,r.quantity+=s.itemCount*12,r.documents+=1,n.set(o,r)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(t.entries()).sort(([s],[l])=>s.localeCompare(l)).map(([s,l])=>({month:s,amount:l})),productTotals:Array.from(n.values()).sort((s,l)=>l.amount-s.amount),customerTotals:Array.from(e.values()).sort((s,l)=>l.amount-s.amount)}}async function g(t,e){try{const n=await fetch(`/sake-system/${t}`,{headers:{Accept:"application/json"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);return await n.json()}catch(n){return console.warn(`Failed to fetch ${t}, using fallback data`,n),e}}async function re(){const t=await k("daily_sales_fact",{});if(t.length>0){const e=await k("customer_payment_status",{}),s=new Date().toISOString().slice(0,10),l=s.slice(0,7),i=[...t].sort((r,u)=>r.sales_date.localeCompare(u.sales_date)).slice(-30).map(r=>({date:new Date(`${r.sales_date}T00:00:00Z`).toISOString(),amount:f(r.sales_amount)})),d=t.reduce((r,u)=>u.sales_date===s?r+f(u.sales_amount):r,0),o=t.reduce((r,u)=>u.sales_date.startsWith(l)?r+f(u.sales_amount):r,0),c=e.filter(r=>f(r.balance_amount)>0);return{generatedAt:new Date().toISOString(),kpis:{todaySales:d,todayDelta:0,monthSales:o,monthDelta:0,unpaidCount:c.length,unpaidAmount:c.reduce((r,u)=>r+f(u.balance_amount),0)},dailySales:i,salesRecords:lt.salesRecords}}return g("data/api/latest/sales-summary.json",lt)}async function de(){const t=await k("customer_payment_status",{});return t.length>0?{generatedAt:new Date().toISOString(),records:t.map((e,n)=>{const s=e.legacy_customer_code??`UNKNOWN-${n+1}`;return{id:`payment-${s}-${n+1}`,customerCode:s,customerName:s,billedAmount:f(e.billed_amount),paymentAmount:f(e.paid_amount),balanceAmount:f(e.balance_amount),lastPaymentDate:null,status:Ge(e.payment_status)}})}:g("data/api/latest/payment-status.json",ze)}async function ue(){const[t,e]=await Promise.all([k(),k()]);if(t.length>0||e.length>0){const n=t.length?t.map((l,i)=>({id:x(l,["id","customer_id","code"],`customer-${i+1}`),code:x(l,["code","customer_code","legacy_customer_code"],`C${String(i+1).padStart(4,"0")}`),name:x(l,["name","customer_name","display_name"],`Customer ${i+1}`),closingDay:Rt(l,["closing_day","close_day"],31),paymentDay:Rt(l,["payment_day","due_day"],15),isActive:qt(l,["is_active","active","enabled"],!0)})):A.customers,s=e.length?e.map((l,i)=>({id:x(l,["id","product_id","code"],`product-${i+1}`),code:x(l,["code","product_code"],`P${String(i+1).padStart(5,"0")}`),janCode:x(l,["jan_code","jan","barcode"],""),name:x(l,["name","product_name","display_name"],`Product ${i+1}`),category:x(l,["category","category_name"],"未分類"),isActive:qt(l,["is_active","active","enabled"],!0)})):A.products;return{generatedAt:new Date().toISOString(),summary:{customerCount:t.length||A.summary.customerCount,activeCustomerCount:t.length?n.filter(l=>l.isActive).length:A.summary.activeCustomerCount,productCount:e.length||A.summary.productCount,activeProductCount:e.length?s.filter(l=>l.isActive).length:A.summary.activeProductCount},customers:n,products:s}}return g("data/api/latest/master-stats.json",A)}function pe(){return g("data/api/latest/pipeline-meta.json",Qe)}async function ot(t){const[e,n]=await Promise.all([k("sales_document_headers",{}),k("sales_document_lines",{})]);if(e.length>0){const s=new Map;n.forEach(i=>{const d=String(i.header_id??i.document_header_id??i.document_no??i.id??"");d&&s.set(d,(s.get(d)??0)+1)});const l=e.map((i,d)=>{const o=wt(i,d),c=String(i.id??i.document_no??i.legacy_document_no??"");return{...o,itemCount:s.get(c)??o.itemCount}});return Mt(l,t)}return Mt(ie,t)}async function xt(t){const e=t.trim().toUpperCase();if(!e)return It("");const[n,s,l]=await Promise.all([k("sales_document_headers",{}),k("customer_payments",{}),k("customer_payment_status",{})]);if(n.length>0||s.length>0){const i=n.map((c,r)=>{const u=wt(c,r);return{id:u.id,date:u.date,documentNo:u.documentNo,amount:u.amount}}),d=s.map((c,r)=>({id:String(c.id??`payment-${r+1}`),date:oe(c,["payment_date","received_date"],new Date().toISOString()),amount:f(c.payment_amount??c.amount),method:c.payment_method??c.method??"入金"})),o=l.find(c=>(c.legacy_customer_code??"").toUpperCase()===e);return{customerCode:e,customerName:n[0]?.customer_name??n[0]?.customer_code??n[0]?.legacy_customer_code??e,balanceAmount:f(o?.balance_amount),salesTotal:i.reduce((c,r)=>c+r.amount,0),paymentTotal:d.reduce((c,r)=>c+r.amount,0),salesHistory:i,paymentHistory:d}}return It(e)}async function me(){const[t,e,n]=await Promise.all([k("daily_sales_fact",{}),k("sales_document_headers",{}),k("sales_document_lines",{})]);if(t.length>0){const s=new Map;t.forEach(d=>{const o=ce(d.sales_date);s.set(o,(s.get(o)??0)+f(d.sales_amount))});const l=new Map;e.forEach((d,o)=>{const c=wt(d,o),r=l.get(c.customerCode)??{code:c.customerCode,name:c.customerName,amount:0,quantity:0,documents:0};r.amount+=c.amount,r.documents+=1,l.set(c.customerCode,r)});const i=new Map;return n.forEach((d,o)=>{const c=d.product_code??d.legacy_product_code??`P${String(o+1).padStart(5,"0")}`,r=i.get(c)??{code:c,name:d.product_name??c,amount:0,quantity:0,documents:0};r.amount+=f(d.line_amount??d.amount),r.quantity+=f(d.quantity),r.documents+=1,i.set(c,r)}),{generatedAt:new Date().toISOString(),monthlySales:Array.from(s.entries()).sort(([d],[o])=>d.localeCompare(o)).map(([d,o])=>({month:d,amount:o})).slice(-12),productTotals:i.size>0?Array.from(i.values()).sort((d,o)=>o.amount-d.amount):it.productTotals,customerTotals:l.size>0?Array.from(l.values()).sort((d,o)=>o.amount-d.amount):it.customerTotals}}return Ze()}const vt={sales:"売上",return:"返品",export_return:"輸出戻入"};async function he(t){const e=t.lines.reduce((l,i)=>l+i.amount,0),n=`D${Date.now().toString().slice(-6)}`;return{id:(await ft("sales_document_headers",{legacy_customer_code:t.customerCode,sales_date:t.invoiceDate,document_type:t.invoiceType,staff_code:t.staffCode}))?.id??`local-${n}`,documentNo:n,totalAmount:e,status:"confirmed",createdAt:new Date().toISOString()}}const Ot={documentNo:"D240122",invoiceDate:"2026-04-14",customerCode:"C0011",customerName:"青葉商事 株式会社",customerAddress:"〒123-4567 東京都千代田区〇〇 1-2-3",lines:[{productCode:"P00012",productName:"純米吟醸 720ml",quantity:6,unitPrice:12e3,unit:"本",amount:72e3},{productCode:"P00008",productName:"本醸造 1.8L",quantity:4,unitPrice:8500,unit:"本",amount:34e3},{productCode:"P00021",productName:"梅酒 500ml",quantity:12,unitPrice:5800,unit:"本",amount:69600}],totalAmount:175600,taxAmount:15960,note:""};async function Ct(t){const e=await k("sales_document_headers",{});if(e.length>0){const n=e[0],s=f(n.total_amount);return{documentNo:t,invoiceDate:x(n,["sales_date","document_date"],""),customerCode:x(n,["legacy_customer_code","customer_code"],""),customerName:x(n,["customer_name","legacy_customer_code"],""),customerAddress:"",lines:[],totalAmount:s,taxAmount:Math.floor(s*10/110),note:""}}return{...Ot,documentNo:t||Ot.documentNo}}const ta={targetYearMonth:"2026-04",closingDay:15,totalBilling:482e4,customers:[{customerCode:"C0011",customerName:"青葉商事",closingDay:15,salesAmount:54e4,taxAmount:54e3,prevBalance:28e4,paymentAmount:28e4,billingAmount:594e3,status:"open"},{customerCode:"C0012",customerName:"北斗酒販",closingDay:15,salesAmount:72e4,taxAmount:72e3,prevBalance:14e4,paymentAmount:14e4,billingAmount:792e3,status:"closed"},{customerCode:"C0013",customerName:"中央フーズ",closingDay:15,salesAmount:38e4,taxAmount:38e3,prevBalance:0,paymentAmount:0,billingAmount:418e3,status:"open"},{customerCode:"C0014",customerName:"東海酒店",closingDay:15,salesAmount:61e4,taxAmount:61e3,prevBalance:23e4,paymentAmount:15e4,billingAmount:751e3,status:"open"}]};async function Dt(t){return g(`data/api/latest/billing-${t}.json`,{...ta,targetYearMonth:t})}const ea=["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],aa={generatedAt:new Date().toISOString(),months:ea,salesByProduct:[{label:"純米吟醸 720ml",values:[380,410,520,480,390,320,450,480,510,420,380,350].map(t=>t*1e4)},{label:"本醸造 1.8L",values:[290,310,380,340,280,250,320,360,390,310,280,260].map(t=>t*1e4)},{label:"梅酒 500ml",values:[210,240,310,290,230,180,260,300,320,250,200,190].map(t=>t*1e4)}],salesByCustomer:[{label:"青葉商事",values:[480,510,620,590,480,390,540,580,610,510,460,430].map(t=>t*1e4)},{label:"北斗酒販",values:[390,420,520,490,400,330,460,500,530,430,380,360].map(t=>t*1e4)}],costSimulation:[{productCode:"P00012",productName:"純米吟醸 720ml",costPrice:7200,sellPrice:12e3,margin:4800,marginRate:40},{productCode:"P00008",productName:"本醸造 1.8L",costPrice:4800,sellPrice:8500,margin:3700,marginRate:43.5},{productCode:"P00021",productName:"梅酒 500ml",costPrice:3200,sellPrice:5800,margin:2600,marginRate:44.8}]};async function ve(){return g("data/api/latest/sales-report.json",aa)}const ye={planned:"計画中",active:"仕込中",done:"完了"},sa=[{id:"j1",jikomiNo:"J2026-01",productName:"純米吟醸",riceType:"山田錦",plannedKg:400,actualKg:400,startDate:"2026-01-10",expectedDoneDate:"2026-02-20",status:"done",tankNo:"T01",note:""},{id:"j2",jikomiNo:"J2026-02",productName:"本醸造",riceType:"日本晴",plannedKg:600,actualKg:600,startDate:"2026-02-01",expectedDoneDate:"2026-03-15",status:"done",tankNo:"T02",note:""},{id:"j3",jikomiNo:"J2026-03",productName:"特別純米",riceType:"五百万石",plannedKg:500,actualKg:480,startDate:"2026-03-05",expectedDoneDate:"2026-04-20",status:"active",tankNo:"T03",note:"経過良好"},{id:"j4",jikomiNo:"J2026-04",productName:"純米大吟醸",riceType:"山田錦",plannedKg:300,actualKg:0,startDate:"2026-04-15",expectedDoneDate:"2026-06-01",status:"planned",tankNo:"T04",note:""}];async function be(){return g("data/api/latest/jikomi.json",sa)}const na=[{id:"t1",tankNo:"T01",capacity:3e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-01"},{id:"t2",tankNo:"T02",capacity:4e3,currentVolume:0,productName:"",jikomiNo:"",status:"empty",lastUpdated:"2026-03-20"},{id:"t3",tankNo:"T03",capacity:3500,currentVolume:2800,productName:"特別純米",jikomiNo:"J2026-03",status:"in_use",lastUpdated:"2026-04-10"},{id:"t4",tankNo:"T04",capacity:2e3,currentVolume:0,productName:"純米大吟醸",jikomiNo:"J2026-04",status:"in_use",lastUpdated:"2026-04-15"},{id:"t5",tankNo:"T05",capacity:5e3,currentVolume:3200,productName:"本醸造（貯蔵）",jikomiNo:"J2026-02",status:"aging",lastUpdated:"2026-03-20"}];async function ge(){return g("data/api/latest/tanks.json",na)}const la=[{id:"k1",kenteiNo:"K2026-001",jikomiNo:"J2026-01",productName:"純米吟醸",kenteiDate:"2026-02-25",alcoholDegree:16.2,extractDegree:3.8,sakaMeterValue:2.5,volume:2850,taxCategory:"清酒",status:"approved"},{id:"k2",kenteiNo:"K2026-002",jikomiNo:"J2026-02",productName:"本醸造",kenteiDate:"2026-03-18",alcoholDegree:15.5,extractDegree:4.1,sakaMeterValue:1.8,volume:3600,taxCategory:"清酒",status:"submitted"},{id:"k3",kenteiNo:"K2026-003",jikomiNo:"J2026-03",productName:"特別純米",kenteiDate:"2026-04-18",alcoholDegree:0,extractDegree:0,sakaMeterValue:0,volume:0,taxCategory:"清酒",status:"pending"}];async function fe(){return g("data/api/latest/kentei.json",la)}const ia=[{id:"m1",code:"M001",name:"720ml瓶",unit:"本",currentStock:2400,minimumStock:500,unitCost:85,lastUpdated:"2026-04-10"},{id:"m2",code:"M002",name:"1.8L瓶",unit:"本",currentStock:1800,minimumStock:300,unitCost:140,lastUpdated:"2026-04-10"},{id:"m3",code:"M003",name:"300ml瓶",unit:"本",currentStock:3600,minimumStock:600,unitCost:55,lastUpdated:"2026-04-08"},{id:"m4",code:"M004",name:"キャップ（金）",unit:"個",currentStock:8e3,minimumStock:1e3,unitCost:12,lastUpdated:"2026-04-05"},{id:"m5",code:"M005",name:"ラベル（純米吟醸）",unit:"枚",currentStock:1200,minimumStock:300,unitCost:28,lastUpdated:"2026-04-01"},{id:"m6",code:"M006",name:"化粧箱（720ml）",unit:"個",currentStock:180,minimumStock:100,unitCost:320,lastUpdated:"2026-04-01"}];async function $e(){return g("data/api/latest/materials.json",ia)}const oa=[{id:"p1",documentNo:"K240050",purchaseDate:"2026-04-05",supplierCode:"S001",supplierName:"山田農場",itemName:"山田錦（精米65%）",quantity:500,unitPrice:480,amount:24e4,status:"confirmed"},{id:"p2",documentNo:"K240051",purchaseDate:"2026-04-06",supplierCode:"S002",supplierName:"日本瓶工業",itemName:"720ml瓶",quantity:1200,unitPrice:85,amount:102e3,status:"confirmed"},{id:"p3",documentNo:"K240052",purchaseDate:"2026-04-10",supplierCode:"S003",supplierName:"山本麹店",itemName:"米麹",quantity:80,unitPrice:1200,amount:96e3,status:"pending"},{id:"p4",documentNo:"K240053",purchaseDate:"2026-04-12",supplierCode:"S001",supplierName:"山田農場",itemName:"五百万石（精米60%）",quantity:300,unitPrice:420,amount:126e3,status:"pending"}],ca=[{supplierCode:"S001",supplierName:"山田農場",totalPurchase:366e3,paidAmount:24e4,balance:126e3,nextPaymentDate:"2026-04-30",status:"partial"},{supplierCode:"S002",supplierName:"日本瓶工業",totalPurchase:102e3,paidAmount:102e3,balance:0,nextPaymentDate:"",status:"paid"},{supplierCode:"S003",supplierName:"山本麹店",totalPurchase:96e3,paidAmount:0,balance:96e3,nextPaymentDate:"2026-04-30",status:"unpaid"}],ra=[{id:"b1",billNo:"H240001",supplierName:"山田農場",amount:24e4,issueDate:"2026-03-31",dueDate:"2026-04-30",status:"holding"},{id:"b2",billNo:"H240002",supplierName:"大阪資材",amount:185e3,issueDate:"2026-03-31",dueDate:"2026-05-31",status:"holding"},{id:"b3",billNo:"H230045",supplierName:"中部農業",amount:32e4,issueDate:"2026-02-28",dueDate:"2026-03-31",status:"cleared"}],da=[{code:"R001",name:"山田錦（精米65%）",unit:"kg",currentStock:380,minimumStock:100,lastPurchaseDate:"2026-04-05",unitCost:480},{code:"R002",name:"五百万石（精米60%）",unit:"kg",currentStock:290,minimumStock:100,lastPurchaseDate:"2026-04-12",unitCost:420},{code:"R003",name:"米麹",unit:"kg",currentStock:62,minimumStock:20,lastPurchaseDate:"2026-04-10",unitCost:1200},{code:"R004",name:"醸造用アルコール",unit:"L",currentStock:240,minimumStock:50,lastPurchaseDate:"2026-03-20",unitCost:180},{code:"R005",name:"清酒用酵母",unit:"g",currentStock:500,minimumStock:100,lastPurchaseDate:"2026-02-15",unitCost:3200}];async function ke(){return g("data/api/latest/purchases.json",oa)}async function Se(){return g("data/api/latest/payables.json",ca)}async function we(){return g("data/api/latest/bills.json",ra)}async function xe(){return g("data/api/latest/raw-stock.json",da)}const Ce=[{code:"01",name:"清酒（普通酒）",taxRatePerLiter:100},{code:"02",name:"清酒（純米酒）",taxRatePerLiter:100},{code:"03",name:"清酒（吟醸酒）",taxRatePerLiter:100},{code:"04",name:"清酒（大吟醸酒）",taxRatePerLiter:100},{code:"05",name:"本格焼酎",taxRatePerLiter:250},{code:"06",name:"リキュール",taxRatePerLiter:200},{code:"07",name:"果実酒",taxRatePerLiter:100},{code:"08",name:"その他醸造酒",taxRatePerLiter:100}],yt={export:"輸出",sample:"見本",research:"試験醸造",loss:"欠減"},ua={targetYear:2026,targetMonth:3,companyName:"金井酒造店",companyNo:"1234567890123",companyAddress:"神奈川県秦野市堀山下182",companyRepresentative:"金井 和雄",taxOffice:"小田原税務署",rows:[{taxCategory:"01",taxCategoryName:"清酒（普通酒）",alcoholDegree:15.5,productionVolume:3800,previousBalance:0,currentAdjustment:0,exportDeduction:100,sampleDeduction:100,taxableVolume:3600,volume:3600,taxRate:100,taxAmount:36e4},{taxCategory:"02",taxCategoryName:"清酒（純米酒）",alcoholDegree:16.2,productionVolume:2900,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:50,taxableVolume:2850,volume:2850,taxRate:100,taxAmount:285e3},{taxCategory:"03",taxCategoryName:"清酒（吟醸酒）",alcoholDegree:16.5,productionVolume:1250,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:50,taxableVolume:1200,volume:1200,taxRate:100,taxAmount:12e4}],deductions:[{type:"export",categoryCode:"01",volume:100,reason:"シンガポール向け輸出",documentNo:"EX2026-003"},{type:"sample",categoryCode:"01",volume:100,reason:"展示会サンプル出荷"},{type:"sample",categoryCode:"02",volume:50,reason:"品評会出品"},{type:"sample",categoryCode:"03",volume:50,reason:"全国新酒鑑評会出品"}],totalVolume:7650,totalTax:765e3,status:"draft",submittedAt:null};async function _t(t,e){return g(`data/api/latest/tax-${t}-${String(e).padStart(2,"0")}.json`,{...ua,targetYear:t,targetMonth:e})}function S(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;")}function De(t){const e=t.rows.map(s=>`    <Category>
      <Code>${S(s.taxCategory)}</Code>
      <Name>${S(s.taxCategoryName)}</Name>
...
`),n=t.deductions.map(s=>`    <Deduction type="${S(s.type)}">
      <CategoryCode>${S(s.categoryCode)}</CategoryCode>
      <Volume>${s.volume}</Volume>
      <Reason>${S(s.reason)}</Reason>${s.documentNo?`
      <DocumentNo>${S(s.documentNo)}</DocumentNo>`:""}
    </Deduction>`).join(`
...
`}function pa(t){const e=String(t);return/[,"\n]/.test(e)?`"${e.replaceAll('"','""')}"`:e}function ma(t){const n=["酒類コード","区分名","アルコール度数","製造数量","前月繰越","当月調整","輸出控除","見本等控除","課税数量","税率(円/L)","税額(円)"].join(","),s=t.rows.map(i=>[i.taxCategory,i.taxCategoryName,i.alcoholDegree,i.productionVolume,i.previousBalance,i.currentAdjustment,i.exportDeduction,i.sampleDeduction,i.taxableVolume,i.taxRate,i.taxAmount].map(pa).join(",")),l=`,合計,,${t.rows.reduce((i,d)=>i+d.productionVolume,0)},,,${t.rows.reduce((i,d)=>i+d.exportDeduction,0)},${t.rows.reduce((i,d)=>i+d.sampleDeduction,0)},${t.totalVolume},,${t.totalTax}`;return"\uFEFF"+[n,...s,l].join(`
`)+`
`}function ha(t){const e=t.rows.map(l=>{const i=Math.max(0,l.productionVolume+l.previousBalance+l.currentAdjustment-l.exportDeduction-l.sampleDeduction),d=Math.round(i*l.taxRate);return{...l,taxableVolume:i,volume:i,taxAmount:d}}),n=e.reduce((l,i)=>l+i.taxableVolume,0),s=e.reduce((l,i)=>l+i.taxAmount,0);return{...t,rows:e,totalVolume:n,totalTax:s}}async function va(t){const{supabaseInsert:e}=await N(async()=>{const{supabaseInsert:n}=await Promise.resolve().then(()=>ae);return{supabaseInsert:n}},void 0);await e("tax_declarations",{target_year:t.targetYear,target_month:t.targetMonth,company_name:t.companyName,company_no:t.companyNo,company_address:t.companyAddress,company_representative:t.companyRepresentative,tax_office:t.taxOffice,total_taxable_volume:t.totalVolume,total_tax_amount:t.totalTax,status:t.status,xml_data:De(t),submitted_at:t.submittedAt})}const ya=Array.from({length:10},(t,e)=>({id:`ss${e+1}`,saleDate:"2026-04-15",saleTime:`${9+e}:${String(e*7%60).padStart(2,"0")}`,productCode:`P${String(e%4+1).padStart(5,"0")}`,productName:["純米吟醸 720ml","本醸造 1.8L","梅酒 500ml","特別純米 300ml"][e%4],quantity:1+e%3,unitPrice:[2200,1800,980,680][e%4],amount:(1+e%3)*[2200,1800,980,680][e%4],paymentMethod:["cash","card","paypay","cash"][e%4]})),ba=[{id:"o1",orderNo:"ORD-2604001",orderDate:"2026-04-13",customerName:"鈴木 太郎",postalCode:"150-0001",address:"東京都渋谷区〇〇1-1",items:[{productName:"純米吟醸 720ml",quantity:2,amount:4400}],totalAmount:4400,status:"shipped",shippingDate:"2026-04-14"},{id:"o2",orderNo:"ORD-2604002",orderDate:"2026-04-14",customerName:"田中 花子",postalCode:"530-0001",address:"大阪府大阪市北区〇〇2-3",items:[{productName:"梅酒 500ml",quantity:3,amount:2940},{productName:"本醸造 1.8L",quantity:1,amount:1800}],totalAmount:4740,status:"processing",shippingDate:""},{id:"o3",orderNo:"ORD-2604003",orderDate:"2026-04-15",customerName:"佐藤 一郎",postalCode:"460-0001",address:"愛知県名古屋市中区〇〇3-5",items:[{productName:"特別純米 300ml ×6本セット",quantity:1,amount:3980}],totalAmount:3980,status:"new",shippingDate:""}];async function Nt(t){return g(`data/api/latest/store-sales-${t}.json`,ya)}async function _e(){return g("data/api/latest/store-orders.json",ba)}async function nt(t){const e=await ft("email_campaigns",{subject:t.subject,body:t.body,template_id:t.templateId,audience_mode:t.audienceMode,audience_filter:t.audienceFilter,recipient_count:t.recipientCount,sent_count:t.status==="sent"?t.recipientCount:0,status:t.status,sent_at:t.status==="sent"?new Date().toISOString():null});return{id:e?.id??`local-email-${Date.now()}`,subject:e?.subject??t.subject,body:e?.body??t.body,templateId:e?.template_id??t.templateId,audienceMode:e?.audience_mode??t.audienceMode,audienceFilter:e?.audience_filter??t.audienceFilter,recipientCount:e?.recipient_count??t.recipientCount,status:e?.status??t.status,createdAt:e?.created_at??new Date().toISOString(),updatedAt:e?.updated_at??new Date().toISOString()}}async function Ne(t){throw new Error("VITE_RESEND_API_KEY is not configured")}const R=Object.freeze(Object.defineProperty({__proto__:null,INVOICE_TYPE_LABELS:vt,JIKOMI_STATUS_LABELS:ye,SEASONAL_TEMPLATES:St,TAX_DEDUCTION_LABELS:yt,TAX_RATE_CATEGORIES:Ce,fetchBillList:we,fetchBillingSummary:Dt,fetchCustomerLedger:xt,fetchDeliveryNote:Ct,fetchInvoices:ot,fetchJikomiList:be,fetchKenteiList:fe,fetchMasterStats:ue,fetchMaterialList:$e,fetchPayableList:Se,fetchPaymentStatus:de,fetchPipelineMeta:pe,fetchPurchaseList:ke,fetchRawMaterialStock:xe,fetchSalesAnalytics:me,fetchSalesReport:ve,fetchSalesSummary:re,fetchStoreOrders:_e,fetchStoreSales:Nt,fetchTankList:ge,fetchTaxDeclaration:_t,generateTaxCSV:ma,generateTaxXML:De,recalculateTaxDeclaration:ha,saveEmailCampaign:nt,saveInvoice:he,saveTaxDeclaration:va,sendEmailCampaign:Ne},Symbol.toStringTag,{value:"Module"}));function q(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}const ga={open:"未締め",closed:"締め済"};function fa(t,e){const n=t.customers.map(s=>`
      <tr>
        <td>
        ...
        <td class="numeric">${q(s.salesAmount)}</td>
        <td class="numeric">${q(s.taxAmount)}</td>
        <td class="numeric">${q(s.prevBalance)}</td>
        <td class="numeric">${q(s.paymentAmount)}</td>
        <td class="numeric"><strong>${q(s.billingAmount)}</strong></td>
        <td>
          <span class="status-pill ${s.status==="closed"?"success":"warning"}">${ga[s.status]}</span>
        </td>
        <td>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${q(t.totalBilling)}</p>
  ...
  `}function W(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function G(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function J(t,e){for(const n of e){const s=t[n];if(typeof s=="number"&&Number.isFinite(s))return s;if(typeof s=="string"){const l=Number(s);if(Number.isFinite(l))return l}}return null}function Ca(t){const e=t?.productTotals;if(!e||e.length===0)return"―";const n=e.reduce((l,i)=>{const d=J(i,["amount","salesAmount"]),o=J(i,["marginRate","grossMarginRate"]);return d===null||d<=0||o===null?l:{weightedAmount:l.weightedAmount+d,weightedRate:l.weightedRate+d*o}},{weightedAmount:0,weightedRate:0});if(n.weightedAmount>0)return`${(n.weightedRate/n.weightedAmount).toFixed(1)}%`;const s=e.reduce((l,i)=>{const d=i,o=J(d,["amount","salesAmount"]),c=J(d,["grossProfit","grossAmount","margin"]),r=J(d,["costAmount","cost","costPrice"]);if(o===null||o<=0)return l;const u=c??(r!==null?o-r:null);return u===null?l:{sales:l.sales+o,gross:l.gross+u}},{sales:0,gross:0});return s.sales>0?`${(s.gross/s.sales*100).toFixed(1)}%`:"―"}function Da(t){const s={top:20,right:20,bottom:30,left:50},l=760-s.left-s.right,i=260-s.top-s.bottom,d=Math.max(...t.map(u=>u.amount),1),o=l/t.length,c=t.map((u,p)=>{const h=u.amount/d*i,v=s.left+p*o+4,y=s.top+i-h,_=new Intl.DateTimeFormat("ja-JP",{month:"numeric",day:"numeric"}).format(new Date(u.date));return`
        <g>
          <rect x="${v}" y="${y}" width="${Math.max(o-8,8)}" height="${h}" rx="4" fill="#0F5B8D" opacity="${.58+p/t.length*.34}" />
  ...
  `}function _a(t,e,n){const s={success:"正常",warning:"注意",error:"異常",running:"実行中"},l=t.salesRecords.slice(0,10).map(i=>`
            <tr>
  ...
  `}function Na(t){return t?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"long",day:"numeric"}).format(new Date(t)):""}function M(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Aa(t,e){const n=t.lines.length?t.lines.map((l,i)=>`
          <tr>
    ...
    <article class="panel delivery-note-body" id="delivery-print-area">
      <div class="delivery-header">
        ...
        <div class="delivery-meta">
          <table class="delivery-meta-table">
            ...
            <tr><th>納品日</th><td>${Na(t.invoiceDate)}</td></tr>
            <tr><th>合計金額</th><td class="numeric">${M(t.totalAmount)}（税込）</td></tr>
          </table>
      ...
      <div class="delivery-footer">
        <div class="delivery-totals">
          <div class="total-stack"><span class="total-label">小計</span><span class="total-value">${M(s)}</span></div>
          <div class="total-stack"><span class="total-label">消費税（10%）</span><span class="total-value">${M(t.taxAmount)}</span></div>
          <div class="total-stack total-grand"><span class="total-label">合計（税込）</span><span class="total-value">${M(t.totalAmount)}</span></div>
        </div>
        ${t.note?`<p class="delivery-note-text">備考：${t.note}</p>`:""}
      </div>
    </article>
  `}function D(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function La(t){return D(t).replaceAll(`
`,"<br />")}function Pa(t){const n=[...Object.values(St),{id:"custom",season:"カスタム",subject:"",body:""}].map(l=>`
        <button
        ...
        >
          ...
          <strong>${D(l.subject||"空テンプレート")}</strong>
        </button>
      `).join(""),s=t.previewRecipients.length?t.previewRecipients.map(l=>`
            <li>
              <span>${D(l.name)}</span>
              <span class="table-sub">${D(l.email)} / ${D(l.area)}</span>
            </li>
    ...
    <section class="broadcast-grid">
      ...
      <article class="panel">
        ...
        <div class="field">
          <span>件名</span>
          <input id="email-subject" type="text" value="${D(t.subject)}" />
        </div>
        <div class="field">
          <span>本文</span>
          <textarea id="email-body" rows="12">${D(t.body)}</textarea>
        </div>
      ...
      <article class="panel">
        ...
        <div class="email-preview">
          <p class="panel-title">${D(t.subject||"件名未入力")}</p>
          <div class="preview-box">${t.body?La(t.body):"本文未入力"}</div>
        </div>
        ${t.saveMessage?`<p class="meta-note">${D(t.saveMessage)}</p>`:""}
        <div class="action-bar">
  ...
  `}function ja(t,e){const n=[X("得意先",e.customers.map(l=>`
          <button
  ...
  `}function V(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Le(t){const e=t.resultsHtml.trim()?t.resultsHtml:`<p class="empty-note">${V(t.emptyMessage??"該当データがありません。")}</p>`;return`
    <div class="modal-backdrop" data-action="modal-close">
      <div class="modal-panel" role="dialog" aria-modal="true" aria-label="${V(t.title)}">
        <div class="modal-header">
          <h2>${V(t.title)}</h2>
  ...
  `}function Z(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Jt(t){return t.trim().toLowerCase()}function Ta(t,e){const n=Jt(e),s=t.filter(i=>n?[i.code,i.name,i.name].map(Jt).some(d=>d.includes(n)):!0).slice(0,50),l=s.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
      ...
      `:"";return Le({title:"得意先検索",searchQuery:e,placeholder:"コード・名前で検索",resultsHtml:l,emptyMessage:"該当する得意先が見つかりません。"})}function Ea(t){return t.toISOString().slice(0,10)}function E(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function L(t,e){return t[e]?`<div class="field-error">${E(t[e])}</div>`:""}function I(t,e,n=""){return[n,t[e]?"has-error":""].filter(Boolean).join(" ")}function Ra(t,e,n,s){const l=Object.keys(vt).map(c=>`<option value="${c}" ${t.invoiceType===c?"selected":""}>${vt[c]}</option>`).join(""),i=t.lines.map((c,r)=>`
      <tr>
        <td>
          <div class="input-group">
            <input class="${I(s,`lines.${r}.productCode`,"input-cell")}" type="text" data-line="${r}" data-field="productCode" value="${E(c.productCode)}" placeholder="P00001" />
            <button class="picker-btn" type="button" data-action="open-product-picker" data-line="${r}" aria-label="商品検索">🔍</button>
          </div>
          ${L(s,`lines.${r}.productCode`)}
        </td>
        <td>
          <input class="${I(s,`lines.${r}.productName`,"input-cell")}" type="text" data-line="${r}" data-field="productName" value="${E(c.productName)}" placeholder="商品名" />
          ${L(s,`lines.${r}.productName`)}
        </td>
        <td>
          <input class="${I(s,`lines.${r}.quantity`,"input-cell numeric")}" type="number" data-line="${r}" data-field="quantity" value="${c.quantity}" min="0" />
          ${L(s,`lines.${r}.quantity`)}
        </td>
        <td><input class="input-cell" type="text" data-line="${r}" data-field="unit" value="${c.unit}" placeholder="本" /></td>
        <td>
          <input class="${I(s,`lines.${r}.unitPrice`,"input-cell numeric")}" type="number" data-line="${r}" data-field="unitPrice" value="${c.unitPrice}" min="0" />
          ${L(s,`lines.${r}.unitPrice`)}
        </td>
    ...
    `).join(""),d=t.lines.reduce((c,r)=>c+r.amount,0),o=Math.floor(d*10/110);return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="filter-grid filter-grid--wide">
        ...
        <label class="field">
          <span>伝票日付</span>
          <input class="${I(s,"invoiceDate")}" id="inv-date" type="date" value="${t.invoiceDate||Ea(new Date)}" />
          ${L(s,"invoiceDate")}
        </label>
        <label class="field">
          <span>得意先コード</span>
          <div class="input-group">
            <input
              class="${I(s,"customerCode")}"
              id="inv-customer-code"
              data-autofill="customer"
              type="text"
              placeholder="C0011"
              value="${E(t.customerCode)}"
            />
        ...
        <label class="field">
          ...
          <input
            ...
            type="text"
            placeholder="青葉商事"
            value="${E(t.customerName)}"
          />
        </label>
        <label class="field">
          <span>担当者コード</span>
          <input id="inv-staff" type="text" placeholder="S001" value="${E(t.staffCode)}" />
        </label>
      </div>
      ${L(s,"lines")}
    </section>
    ...
    <section class="panel">
      ...
      <div class="invoice-total-row">
        <div class="total-stack">
          ...
          <span class="total-value">${(d-o).toLocaleString("ja-JP")} 円</span>
        </div>
        <div class="total-stack">
    ...
    <section class="panel">
      <label class="field">
        <span>備考</span>
        <textarea id="inv-note" rows="2" placeholder="備考・特記事項">${E(t.note)}</textarea>
      </label>
    </section>
  ...
  `}function qa(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function Ma(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Ia(t,e){const n=t.length?t.map(s=>`
            <tr>
              ...
              <td class="numeric">${Ma(s.amount)}</td>
            </tr>
  ...
  `}function Oa(t){return new Date(t.getFullYear(),t.getMonth(),1)}function Fa(t,e){return new Date(t.getFullYear(),t.getMonth()+e,1)}function Pe(t,e){const n=new Date(t);return n.setDate(n.getDate()+e),n}function je(t){const e=new Date(t),n=e.getDay();return e.setDate(e.getDate()-n),e.setHours(0,0,0,0),e}function Vt(t){const e=Pe(je(t),6);return e.setHours(23,59,59,999),e}function Bt(t){return new Date(`${t}T00:00:00`)}function Ut(t){return`${t.getMonth()+1}/${t.getDate()}`}function Ja(t){return t.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}function Va(){const t=new Date,e=je(Fa(Oa(t),-3)),n=Vt(new Date(t.getFullYear(),t.getMonth()+4,0)),s=[];let l=new Date(e);for(;l<=n;){const i=Vt(l);s.push({start:new Date(l),end:i,label:`${Ut(l)} - ${Ut(i)}`}),l=Pe(l,7)}return s}function Ba(t){const e=Va(),n=`160px repeat(${e.length}, minmax(56px, 1fr))`,s=e.map(i=>`
        <div class="gantt-week">
          <span>${i.label}</span>
        </div>
      `).join(""),l=t.length?t.map(i=>{const d=Bt(i.startDate),o=Bt(i.expectedDoneDate),c=Math.max(0,e.findIndex(p=>p.end>=d)),r=Math.max(c,e.reduce((p,h,v)=>h.start<=o?v:p,c)),u=[`仕込番号: ${i.jikomiNo}`,`銘柄: ${i.productName}`,`期間: ${i.startDate} - ${i.expectedDoneDate}`,`タンク: ${i.tankNo}`,`備考: ${i.note||"なし"}`].join(`
`);return`
  ...
  `}function Ht(t,e){const n={planned:"neutral",active:"warning",done:"success"},s=t.map(o=>`
      <tr>
        ...
        <td>
          <span class="status-pill ${n[o.status]}">${ye[o.status]}</span>
        </td>
        <td>${o.note||"―"}</td>
      </tr>
    `).join(""),l=t.filter(o=>o.status==="active").length,i=t.filter(o=>o.status==="done").length,d=t.filter(o=>o.status==="planned").length;return`
    <section class="page-head">
      <div>
  ...
  `}function Ua(t){const e={pending:"未実施",submitted:"申請中",approved:"承認済"},n={pending:"neutral",submitted:"warning",approved:"success"},s=t.map(c=>`
      <tr>
    ...
    `).join(""),l=t.filter(c=>c.status==="approved").length,i=t.filter(c=>c.status==="submitted").length,d=t.filter(c=>c.status==="pending").length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>検定管理</h1>
  ...
  `}function Ha(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ya(t,e){return`
  ...
  `}function Ka(t){return t.map(e=>`
      ...
      `).join("")}function za(t){return t.map(e=>`
        <tr>
          <td class="mono">${e.code}</td>
      ...
      <div class="table-wrap">
        ...
        `:`
          <table>
            ...
            <tbody>${za(t.products)}</tbody>
          </table>
        `}
      </div>
    </section>
  `}function dt(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Wa(t){const e=t.map(l=>{const d=(l.minimumStock>0?l.currentStock/l.minimumStock:1/0)<1.5;return`
        <tr>
      ...
      `}).join(""),n=t.filter(l=>l.minimumStock>0&&l.currentStock/l.minimumStock<1.5).length,s=t.reduce((l,i)=>l+i.currentStock*i.unitCost,0);return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>資材在庫管理</h1>
  ...
  `}function Ga(t){return t?new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t)):"-"}function ut(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}const Xa={unpaid:"未入金",partial:"一部入金",paid:"入金済"};function Za(t){return`
    <section class="page-head">
      <div>
    ...
    <section class="panel">
      ...
      <div class="table-wrap">
        ...
        <tr>
          ...
          <td>${Ga(n.lastPaymentDate)}</td>
          <td><span class="status-pill ${n.status==="paid"?"success":n.status==="partial"?"warning":"danger"}">${Xa[n.status]}</span></td>
        </tr>
      `).join("")}</tbody>
        </table>
      </div>
    </section>
  `}function O(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Yt(t){return t.trim().toLowerCase()}function ts(t,e){const n=Yt(e),s=t.filter(i=>n?[i.code,i.name,i.janCode].map(Yt).some(d=>d.includes(n)):!0),l=s.length?`
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              ${s.map(i=>`
                    <tr
                      ...
                      data-name="${O(i.name)}"
                    >
                      <td class="mono">${O(i.code)}</td>
                      <td>${O(i.name)}</td>
                      <td class="mono">${O(i.janCode)}</td>
                      <td>${O(i.category)}</td>
                    </tr>
                  `).join("")}
            </tbody>
      ...
      `:"";return Le({title:"商品検索",searchQuery:e,placeholder:"コード・名前・JANで検索",resultsHtml:l,emptyMessage:"該当する商品が見つかりません。"})}function P(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function es(t,e){const n={pending:"未確定",confirmed:"確定",paid:"支払済"},s={pending:"warning",confirmed:"neutral",paid:"success"},l={unpaid:"未払い",partial:"一部支払",paid:"支払済"},i={unpaid:"warning",partial:"neutral",paid:"success"},d=t.map(p=>`
      <tr>
        ...
        <td class="numeric"><strong>${P(p.amount)}</strong></td>
        <td>
    ...
    `).join(""),o=e.map(p=>`
      <tr>
        <td class="mono">${p.supplierCode}</td>
        <td>${p.supplierName}</td>
        <td class="numeric">${P(p.totalPurchase)}</td>
        <td class="numeric">${P(p.paidAmount)}</td>
        <td class="numeric"><strong>${P(p.balance)}</strong></td>
        <td>${p.nextPaymentDate||"―"}</td>
        <td>
          <span class="status-pill ${i[p.status]}">${l[p.status]}</span>
        </td>
        <td>
  ...
  `}function B(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function as(t,e){const n={holding:"保有中",due:"期日到来",cleared:"決済済"},s={holding:"neutral",due:"warning",cleared:"success"},l=t.map(u=>`
      <tr>
        <td class="mono">${u.billNo}</td>
        <td>${u.supplierName}</td>
        <td class="numeric">${B(u.amount)}</td>
        <td>${u.issueDate}</td>
        <td>${u.dueDate}</td>
        <td>
    ...
    `).join(""),i=e.map(u=>{const p=u.minimumStock>0&&u.currentStock<u.minimumStock*1.2;return`
        <tr>
          ...
          <td class="numeric">${B(u.unitCost)}</td>
          <td class="numeric">${B(u.currentStock*u.unitCost)}</td>
          <td>${u.lastPurchaseDate}</td>
        </tr>
      `}).join(""),d=t.filter(u=>u.status==="holding"),o=d.reduce((u,p)=>u+p.amount,0),c=e.reduce((u,p)=>u+p.currentStock*p.unitCost,0),r=e.filter(u=>u.minimumStock>0&&u.currentStock<u.minimumStock*1.2).length;return`
    <section class="page-head">
      <div>
        <p class="eyebrow">仕入管理</p>
        <h1>手形管理・原料在庫</h1>
  ...
  `}function ss(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(t))}function $(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function bt(t){return`
  ...
  `}function ls(t,e,n){const s={success:"正常",warning:"注意",error:"異常",running:"実行中"};return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${ss(t.lastSyncAt)}</p>
...
cd sake-system\\relay`,success:["エクスプローラーで sake-system\\\\relay フォルダが見える状態になっていれば成功です。","cd を実行したあと、コマンドプロンプトの行頭が relay フォルダを指していれば問題ありません。"],errors:["git コマンドが使えない場合は Git for Windows が未導入です。先に Git をインストールしてください。","アクセス拒否が出る場合は C:\\\\Program Files 配下ではなく C:\\\\sake-relay\\\\ などに配置してください。"]})}
  ...
  `}function is(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function os(t){return t.replace("-","/")}function cs(t){if(t.length===0)return'<div class="chart-empty">データなし</div>';const e=760,n=280,s={top:16,right:24,bottom:36,left:64},l=e-s.left-s.right,i=n-s.top-s.bottom,d=Math.max(...t.map(u=>u.amount),1),o=l/t.length,c=[0,.25,.5,.75,1].map(u=>{const p=s.top+i-i*u,h=`${Math.round(d*u/1e4).toLocaleString("ja-JP")}万円`;return`
        <g>
          <line x1="${s.left}" y1="${p}" x2="${e-s.right}" y2="${p}" class="chart-grid" />
          <text x="8" y="${p+4}" class="chart-axis">${h}</text>
        </g>
      `}).join(""),r=t.map((u,p)=>{const h=u.amount/d*i,v=Math.max(o-18,24),y=s.left+p*o+(o-v)/2,_=s.top+i-h;return`
        <g>
          <rect x="${y}" y="${_}" width="${v}" height="${h}" rx="6" class="analytics-bar" />
          <text x="${y+v/2}" y="${n-10}" class="chart-axis centered-axis">${os(u.month)}</text>
        </g>
      `}).join("");return`
  ...
  `}function rs(t){return t.length===0?'<tr><td colspan="5" class="empty-row">データなし</td></tr>':t.map(e=>`
        <tr>
          <td class="mono">${e.code}</td>
          <td>${e.name}</td>
      ...
      `).join("")}function ds(t,e){const n=e==="products"?"商品別集計":"得意先別集計",s=e==="products"?t.productTotals:t.customerTotals;return`
    <section class="page-head">
      <div>
  ...
  `}function U(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function us(t){const e=Math.max(...t.salesByProduct.flatMap(i=>i.values),1),n=t.salesByProduct.map(i=>{const d=i.values.map((o,c)=>`
          <div class="bar-col">
            <div class="bar" style="height:${Math.round(o/e*120)}px" title="${t.months[c]}: ${U(o)}"></div>
      ...
      <tr>
        ...
        <td>${i.productName}</td>
        <td class="numeric">${U(i.costPrice)}</td>
        <td class="numeric">${U(i.sellPrice)}</td>
        <td class="numeric">${U(i.margin)}</td>
        <td class="numeric">
          <span class="status-pill ${i.marginRate>=40?"success":"warning"}">${i.marginRate.toFixed(1)}%</span>
        </td>
      </tr>
    `).join(""),l=t.salesByCustomer.map(i=>{const d=i.values.reduce((o,c)=>o+c,0);return`
        <tr>
          <td>${i.label}</td>
          ${i.values.map(o=>`<td class="numeric">${(o/1e4).toFixed(0)}万</td>`).join("")}
  ...
  `}function ps(t){return new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(t))}function ms(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function Kt(t){return t.toISOString().slice(0,10)}function hs(t,e,n){const s=t.length?t.map(l=>`
            <tr>
              ...
              <td class="numeric">${ms(l.amount)}</td>
            </tr>
    ...
    <section class="panel filter-panel">
      <div class="filter-grid">
        <label class="field">
          <span>開始日</span>
          <input id="sales-start" type="date" value="${e||Kt(new Date(Date.now()-1e3*60*60*24*30))}" />
        </label>
        <label class="field">
          <span>終了日</span>
  ...
  `}function at(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function vs(t,e,n,s){const l={cash:"現金",card:"カード",paypay:"PayPay",other:"その他"},i={new:"新規",processing:"処理中",shipped:"発送済",delivered:"配達済"},d={new:"warning",processing:"neutral",shipped:"success",delivered:"success"},o=t.map(p=>`
      <tr>
        <td>${p.saleTime}</td>
  ...
  `}const pt={customers:"得意先マスタ",products:"商品マスタ",suppliers:"仕入先マスタ",staff:"担当者マスタ"},ys={customers:{required:["legacy_customer_code","name"],optional:["kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"]},products:{required:["legacy_product_code","name"],optional:["kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"]},suppliers:{required:["legacy_supplier_code","name"],optional:["kana_name","phone","postal_code","address1","closing_day","payment_day","email"]},staff:{required:["legacy_staff_code","name"],optional:["kana_name","department"]}};function bs(t,e,n,s){const l=ys[t],i=Object.keys(pt).map(o=>`
      <button class="tab-button ${t===o?"active":""}" data-import-entity="${o}">
        ${pt[o]}
      </button>
    `).join(""),d=e?`
    <section class="panel">
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
              <th>#</th>
              ${e.columns.map(o=>`<th>${o}</th>`).join("")}
              <th>検証</th>
            </tr>
          </thead>
          <tbody>
            ${e.rows.slice(0,10).map((o,c)=>`
              <tr class="${o._valid?"":"has-error"}">
                <td>${c+1}</td>
                ${e.columns.map(r=>`<td>${String(o[r]??"")}</td>`).join("")}
  ...
  `:"";return`
    ...
    <section class="panel">
      ...
      <div class="summary-list">
        <div>
          <dt>必須列</dt>
          <dd>${l.required.map(o=>`<code class="config-value">${o}</code>`).join(" / ")}</dd>
        </div>
        <div>
          <dt>任意列</dt>
          <dd>${l.optional.map(o=>`<code class="config-value">${o}</code>`).join(" / ")}</dd>
        </div>
      </div>
      <div class="action-bar">
  ...
  `}const zt={chain_store:"チェーンストア伝票",quotation:"見積書",invoice_monthly:"請求書（月次）"},gs={pageSize:"A4",orientation:"portrait",fontSize:"medium",showSeal:!0,showRegistrationNo:!0,showBankInfo:!0,showRemarks:!0,showJanCode:!0,showUnit:!0,colorMode:"color",copies:1,showReferenceOverlay:!1,overlayOpacity:.4,overlayImageUrl:"reference/chainstore_ref.png"},fs={name:"金井酒造店",postalCode:"257-0014",address1:"神奈川県秦野市堀山下182",address2:"",tel:"0463-88-1511",fax:"0463-88-5885",email:"info@kaneishuzo.co.jp",registrationNo:"T1234567890123",bankName:"横浜銀行",bankBranch:"秦野支店",bankAccountType:"普通",bankAccountNo:"1234567",bankAccountHolder:"カ）カナイシュゾウテン",sealImageUrl:""};function b(t){return"¥"+t.toLocaleString("ja-JP")}function Y(t){const e=new Date(t);return`${e.getFullYear()}年${e.getMonth()+1}月${e.getDate()}日`}function Te(t,e){const n=t.reduce((i,d)=>i+d.amount,0),s=Math.floor(n*e),l=n+s;return{subtotal:n,taxAmount:s,total:l}}const $s=6;function Qt(t){if(!t)return{era:"",month:"",day:""};const e=new Date(t),n=e.getFullYear(),s=n-2018;return{era:s>0?`令${s}`:String(n).slice(-2),month:String(e.getMonth()+1).padStart(2,"0"),day:String(e.getDate()).padStart(2,"0")}}function ks(t,e,n){const s=Qt(t.orderDate??t.documentDate),l=Qt(t.deliveryDate??t.documentDate),i=t.lines.reduce((h,v)=>h+(v.amount||0),0),d=t.lines.reduce((h,v)=>h+(v.retailPrice||0)*(v.correctedQuantity??v.quantity),0),o=t.lines.reduce((h,v)=>h+(v.receivedAmount||0),0),c=t.lines.reduce((h,v)=>h+(v.returnAmount||0),0),r=t.lines.reduce((h,v)=>h+v.quantity,0),u=Array.from({length:$s},(h,v)=>{const y=t.lines[v],_=v+1;if(!y)return`
        <tr class="bp-empty-row">
          ...
          <td class="bp-note"></td>
        </tr>`;const Tt=y.caseQty&&y.caseQty>1?String(y.caseQty):"";return`
      <tr>
        <td class="bp-name">${y.productName}${y.spec?`<br/><span class="bp-spec">${y.spec}</span>`:""}</td>
        <td class="bp-pcode mono">${y.productCode}</td>
        <td class="bp-color">${y.color??""}</td>
        <td class="bp-size">
          ${y.size??""}
          ${Tt?`<div class="bp-subdiv">入${Tt}</div>`:""}
        </td>
        <td class="bp-unit">${y.unit}</td>
        <td class="bp-qty numeric">${y.quantity>0?y.quantity.toLocaleString("ja-JP"):""}</td>
        <td class="bp-rowno">${_}</td>
        <td class="bp-corr-qty numeric">${y.correctedQuantity?y.correctedQuantity.toLocaleString("ja-JP"):""}</td>
        <td class="bp-discount numeric">${y.discount?y.discount.toLocaleString("ja-JP"):""}</td>
        <td class="bp-cost-price numeric">${y.unitPrice>0?y.unitPrice.toLocaleString("ja-JP"):""}</td>
        <td class="bp-cost-amount numeric">${y.amount>0?y.amount.toLocaleString("ja-JP"):""}</td>
        <td class="bp-retail-price numeric">${y.retailPrice?y.retailPrice.toLocaleString("ja-JP"):""}</td>
        <td class="bp-note numeric">${y.receivedAmount?y.receivedAmount.toLocaleString("ja-JP"):""}</td>
      </tr>`}).join(""),p=n.showReferenceOverlay&&n.overlayImageUrl?`<img class="bp-overlay" src="${n.overlayImageUrl}" style="opacity:${n.overlayOpacity};" alt="参考" />`:"";return`
    <div class="print-page bp1701 ${n.fontSize}">
      <div class="bp1701-slip">
        ...
        <div class="bp-topbar">
          ...
          <div class="bp-settle">
            <div class="bp-settle-box ${t.settlementPrint?"checked":""}">${t.settlementPrint?"✓":""}</div>
        ...
        <div class="bp-vendor-row">
          <div class="bp-vendor-name">
            ...
            <div class="bp-val">${e.name}</div>
          </div>
          <div class="bp-code-cell">
            <div class="bp-label">柱店コード</div>
            <div class="bp-val mono">${t.chainStoreCode??""}</div>
          </div>
          <div class="bp-code-cell">
            <div class="bp-label">分類コード伝票</div>
            <div class="bp-val mono">${t.categoryCode??""}</div>
          </div>
          <div class="bp-code-cell">
            <div class="bp-label">伝票番号</div>
            <div class="bp-val mono">${t.documentNo}</div>
          </div>
          <div class="bp-code-cell">
            <div class="bp-label">取引コード</div>
            <div class="bp-val mono">${t.slipTypeCode??""}</div>
          </div>
        </div>
        ...
        <div class="bp-vendor-row">
          <div class="bp-vendor-address">
            <div class="bp-val">${t.customerName} ${t.customerHonorific}</div>
            <div class="bp-val-sub">${t.customerAddress??""}</div>
          </div>
          <div class="bp-code-cell">
            <div class="bp-label">発注日</div>
            <div class="bp-date-boxes">
              <span>${s.era}</span><span>${s.month}</span><span>${s.day}</span>
            </div>
          </div>
          <div class="bp-code-cell">
            <div class="bp-label">納品日</div>
            <div class="bp-date-boxes">
              <span>${l.era}</span><span>${l.month}</span><span>${l.day}</span>
            </div>
          </div>
          <div class="bp-code-cell">
            <div class="bp-label">受注No.</div>
            <div class="bp-val mono">${t.orderNo??""}</div>
          </div>
          <div class="bp-code-cell">
            <div class="bp-label">取引先コード</div>
            <div class="bp-val mono">${t.vendorCode??e.registrationNo.slice(-7)}</div>
          </div>
        </div>
        ...
        <div class="bp-footer">
          ...
          <div class="bp-totals">
            <div class="bp-total-row">
              ...
              <span class="bp-val numeric">${r.toLocaleString("ja-JP")}</span>
            </div>
            <div class="bp-total-row">
              <span class="bp-label">受領金額合計</span>
              <span class="bp-val numeric">${o.toLocaleString("ja-JP")}</span>
            </div>
            <div class="bp-total-row">
              <span class="bp-label">返品金額合計</span>
              <span class="bp-val numeric">${c.toLocaleString("ja-JP")}</span>
            </div>
            <div class="bp-total-row bp-grand-cost">
              <span class="bp-label">訂正後原価金額合計</span>
              <span class="bp-val numeric">${i.toLocaleString("ja-JP")}</span>
            </div>
            <div class="bp-total-row bp-grand-retail">
              <span class="bp-label">訂正後売価金額合計</span>
              <span class="bp-val numeric">${d.toLocaleString("ja-JP")}</span>
            </div>
          </div>
        </div>
      </div>
    </div>
  `}function Ss(t,e,n){const{subtotal:s,taxAmount:l,total:i}=Te(t.lines,t.taxRate),d=t.previousBalance??0,o=t.paymentAmount??0,c=d-o+i,r=t.lines.map(p=>`
      <tr>
  ...
  `}function ws(t,e,n){const{subtotal:s,taxAmount:l,total:i}=Te(t.lines,t.taxRate),d=t.lines.map(c=>`
      <tr>
    ...
    `).join(""),o=Array.from({length:Math.max(0,5-t.lines.length)}).map(()=>`
      <tr class="freee-empty">
    ...
    <div class="print-page quotation-freee ${n.fontSize}">
      ...
      <div class="freee-total-highlight">
        ...
        <div>
          <span class="freee-total-value">${b(i)}</span>
          <span class="freee-total-tax">（税込）</span>
        </div>
      </div>
      ...
      <div class="freee-summary">
        ...
        <table class="freee-summary-table">
          <tr><th>小計</th><td>${b(s)}</td></tr>
          <tr><th>消費税 (${Math.round(t.taxRate*100)}%)</th><td>${b(l)}</td></tr>
          <tr class="freee-sum-grand"><th>合計</th><td>${b(i)}</td></tr>
        </table>
      </div>
  ...
  `}function xs(t,e,n,s){const l=Object.keys(zt).map(o=>`
      <button class="tab-button ${t===o?"active":""}" data-print-template="${o}">
        ${zt[o]}
      </button>
    `).join("");let i="";switch(t){case"chain_store":i=ks(s,n,e);break;case"quotation":i=ws(s,n,e);break;case"invoice_monthly":i=Ss(s,n,e);break}const d=s.lines.map((o,c)=>`
      <tr>
        <td><input class="input-cell mono" type="text" data-print-line="${c}" data-print-lfield="productCode" value="${o.productCode}" /></td>
        <td><input class="input-cell" type="text" data-print-line="${c}" data-print-lfield="productName" value="${o.productName}" /></td>
        <td><input class="input-cell" type="text" data-print-line="${c}" data-print-lfield="spec" value="${o.spec??""}" placeholder="720ml" /></td>
        <td><input class="input-cell numeric" type="number" data-print-line="${c}" data-print-lfield="quantity" value="${o.quantity}" /></td>
        <td><input class="input-cell" type="text" data-print-line="${c}" data-print-lfield="unit" value="${o.unit}" placeholder="本" /></td>
        <td><input class="input-cell numeric" type="number" data-print-line="${c}" data-print-lfield="unitPrice" value="${o.unitPrice}" /></td>
    ...
    <section class="panel no-print">
      ...
      <div style="margin-top:16px; padding:12px; background:var(--surface-alt); border-radius:8px; border:1px dashed var(--border-strong);">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:16px; align-items:center;">
          <label><input type="checkbox" data-print-opt="showReferenceOverlay" ${e.showReferenceOverlay?"checked":""} /> 参考画像をオーバーレイ表示</label>
  ...
  `}const Cs={customers:["legacy_customer_code","name"],products:["legacy_product_code","name"],suppliers:["legacy_supplier_code","name"],staff:["legacy_staff_code","name"]},Ds={customers:["legacy_customer_code","name","kana_name","phone","postal_code","address1","address2","closing_day","payment_day","email"],products:["legacy_product_code","name","kana_name","jan_code","category_code","volume_ml","alcohol_degree","list_price","default_sale_price"],suppliers:["legacy_supplier_code","name","kana_name","phone","postal_code","address1","closing_day","payment_day","email"],staff:["legacy_staff_code","name","kana_name","department"]};function _s(t){t.charCodeAt(0)===65279&&(t=t.slice(1));const e=[];let n=[],s="",l=!1;for(let o=0;o<t.length;o++){const c=t[o];l?c==='"'?t[o+1]==='"'?(s+='"',o++):l=!1:s+=c:c==='"'?l=!0:c===","?(n.push(s),s=""):c===`
`||c==="\r"?(c==="\r"&&t[o+1]===`
`&&o++,n.push(s),n.some(r=>r!=="")&&e.push(n),n=[],s=""):s+=c}if((s!==""||n.length>0)&&(n.push(s),n.some(o=>o!=="")&&e.push(n)),e.length===0)return{columns:[],rows:[]};const i=e[0].map(o=>o.trim()),d=[];for(let o=1;o<e.length;o++){const c={};i.forEach((r,u)=>{c[r]=(e[o][u]??"").trim()}),d.push(c)}return{columns:i,rows:d}}function Ns(t,e,n){const s=Cs[t],l=s.filter(o=>!e.includes(o)),i=n.map(o=>{const c=[];l.length>0&&c.push(`必須列欠損: ${l.join(",")}`);for(const r of s)e.includes(r)&&!o[r]&&c.push(`${r}が空`);return{...o,_valid:c.length===0,_error:c[0]}}),d=i.filter(o=>o._valid).length;return{entity:t,columns:e,rows:i,totalRows:n.length,validRows:d,invalidRows:i.length-d}}function As(t){const n=Ds[t],l={customers:["C0001","青葉商事","アオバショウジ","03-1234-5678","100-0001","東京都千代田区","","15","末","aoba@example.com"],products:["P00001","純米吟醸 720ml","ジュンマイギンジョウ","4901234567891","01","720","16","2200","1500"],suppliers:["S001","山田農場","ヤマダノウジョウ","03-9999-0000","150-0001","東京都渋谷区","末","25","yamada@farm.example.com"],staff:["S001","金井和雄","カナイカズオ","製造部"]}[t];return"\uFEFF"+n.join(",")+`
`+l.join(",")+`
`}async function Ls(t,e){const{supabaseInsert:n}=await N(async()=>{const{supabaseInsert:o}=await Promise.resolve().then(()=>ae);return{supabaseInsert:o}},void 0);let s=0,l=0;const d={customers:"customers",products:"products",suppliers:"suppliers",staff:"staff"}[t];for(const o of e){if(!o._valid)continue;const{_valid:c,_error:r,...u}=o,p={...u};if(!p.id){const h=t==="customers"?"legacy_customer_code":t==="products"?"legacy_product_code":t==="suppliers"?"legacy_supplier_code":"legacy_staff_code";p.id=String(u[h]??`${t}-${Date.now()}-${s+l}`)}for(const h of["volume_ml","closing_day","payment_day","list_price","default_sale_price"])if(typeof p[h]=="string"&&p[h]!==""){const v=Number(p[h]);Number.isFinite(v)&&(p[h]=v)}try{await n(d,p)!==null?s++:l++}catch{l++}}return{inserted:s,failed:l}}function Ps(t){const e={empty:"空",in_use:"使用中",aging:"熟成中"},n={empty:"neutral",in_use:"warning",aging:"success"},s=t.map(r=>{const u=r.capacity>0?Math.round(r.currentVolume/r.capacity*100):0;return`
        <tr>
      ...
      `}).join(""),l=t.filter(r=>r.status==="in_use").length,i=t.filter(r=>r.status==="aging").length,d=t.filter(r=>r.status==="empty").length,o=t.reduce((r,u)=>r+u.capacity,0),c=t.reduce((r,u)=>r+u.currentVolume,0);return`
    <section class="page-head">
      <div>
        <p class="eyebrow">蔵内管理</p>
        <h1>タンク管理</h1>
  ...
  `}function mt(t){return new Intl.NumberFormat("ja-JP",{style:"currency",currency:"JPY",maximumFractionDigits:0}).format(t)}function js(t,e,n){const s=t.rows.map((r,u)=>`
      <tr>
        ...
        <td class="numeric"><strong>${mt(r.taxAmount)}</strong></td>
        <td>
      ...
      <tr>
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="type">
            ${Object.keys(yt).map(p=>`<option value="${p}" ${p===r.type?"selected":""}>${yt[p]}</option>`).join("")}
          </select>
        </td>
        <td>
          <select class="input-cell" data-ded-row="${u}" data-ded-field="categoryCode">
            ${Ce.map(p=>`<option value="${p.code}" ${p.code===r.categoryCode?"selected":""}>${p.code}:${p.name}</option>`).join("")}
          </select>
        </td>
        <td class="numeric">
    ...
    `).join(""),i=Array.from({length:12},(r,u)=>u+1),d=t.rows.reduce((r,u)=>r+u.exportDeduction+u.sampleDeduction,0),o=t.rows.reduce((r,u)=>r+u.productionVolume,0),c=o>0?d/o*100:0;return`
    <section class="page-head">
      <div>
    ...
    <section class="kpi-grid compact">
      <article class="panel kpi-card">
        ...
        <p class="kpi-value">${mt(t.totalTax)}</p>
        ...
        <table class="entry-table">
          ...
          <tfoot>
            <tr>
              ...
              <th></th>
              <th class="numeric">${mt(t.totalTax)}</th>
              <th></th>
            </tr>
          </tfoot>
        </table>
  ...
  `}function Wt(t){const n=(t==null?"":t instanceof Date?t.toISOString():String(t)).replaceAll('"','""');return/[",\n\r]/.test(n)?`"${n}"`:n}function Ts(t,e,n){if(e.length===0&&(!n||n.length===0))return;const s=n&&n.length>0?n:Object.keys(e[0]??{}).map(r=>({key:r,label:r})),i=`\uFEFF${[s.map(r=>Wt(r.label)).join(","),...e.map(r=>s.map(u=>Wt(r[u.key])).join(","))].join(`\r
`)}`,d=new Blob([i],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(d),c=document.createElement("a");c.href=o,c.download=t,document.body.append(c),c.click(),c.remove(),window.setTimeout(()=>URL.revokeObjectURL(o),0)}const Es=["/","/cat/sales","/cat/brewery","/cat/purchase","/cat/more","/sales","/payment","/master","/invoice","/ledger","/analytics","/invoice-entry","/delivery","/billing","/report","/jikomi","/tanks","/kentei","/materials","/purchase","/raw-material","/tax","/store","/setup","/email","/import","/print"],st=[{name:"青葉商事",email:"aoba@example.jp",area:"関東",historySegment:"seasonal"},{name:"北斗酒販",email:"hokuto@example.jp",area:"北海道",historySegment:"premium"},{name:"中央フーズ",email:"chuo@example.jp",area:"関東",historySegment:"seasonal"},{name:"東海酒店",email:"tokai@example.jp",area:"中部",historySegment:"premium"},{name:"三和物産",email:"sanwa@example.jp",area:"関西",historySegment:"liqueur"},{name:"南星リカー",email:"nansei@example.jp",area:"九州",historySegment:"seasonal"},{name:"山川酒店",email:"yamakawa@example.jp",area:"関西",historySegment:"premium"},{name:"瑞穂商店",email:"mizuho@example.jp",area:"中部",historySegment:"seasonal"}],Gt=[{path:"/sales",title:"売上一覧"},{path:"/payment",title:"入金状況"},{path:"/master",title:"マスタ"},{path:"/invoice",title:"伝票照会"},{path:"/ledger",title:"得意先台帳"},{path:"/analytics",title:"売上分析"},{path:"/invoice-entry",title:"伝票入力"},{path:"/delivery",title:"納品書"},{path:"/billing",title:"月次請求"},{path:"/report",title:"集計帳票"},{path:"/jikomi",title:"仕込管理"},{path:"/tanks",title:"タンク管理"},{path:"/kentei",title:"検定管理"},{path:"/materials",title:"資材管理"},{path:"/purchase",title:"仕入・買掛"},{path:"/raw-material",title:"手形・原料"},{path:"/tax",title:"酒税申告"},{path:"/store",title:"店舗・直売所"},{path:"/setup",title:"連動設定"},{path:"/import",title:"CSV/Excelインポート"},{path:"/print",title:"印刷センター"}];function Ee(t){const e=St[t];return e?{subject:e.subject,body:e.body}:{subject:"",body:""}}function At(){return{invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:"",customerName:"",staffCode:"",lines:[],note:""}}function Rs(){const t=Ee("spring");return{mode:"all",region:"all",historySegment:"seasonal",templateId:"spring",subject:t.subject,body:t.body,saveMessage:null}}const rt=new Date,qs=rt.toISOString().slice(0,7),Ms=rt.getFullYear(),Is=rt.getMonth()+1,Os=rt.toISOString().slice(0,10),Fs="C0011",j=Rs();function Re(t){const e="/sake-system/".endsWith("/")?"/sake-system/".slice(0,-1):"/sake-system/",n=t.startsWith(e)?t.slice(e.length)||"/":t;return Es.includes(n)?n:"/"}function Lt(t){switch(t){case"/cat/sales":case"/invoice":case"/ledger":case"/invoice-entry":case"/delivery":case"/billing":case"/report":return"sales";case"/cat/brewery":case"/jikomi":case"/tanks":case"/kentei":case"/materials":return"brewery";case"/cat/purchase":case"/purchase":case"/raw-material":return"purchase";case"/cat/more":case"/master":case"/analytics":case"/tax":case"/store":case"/setup":return"more";case"/email":return"email";default:return"dashboard"}}const Xt=Re(location.pathname),a={salesSummary:null,paymentStatus:null,masterStats:null,pipelineMeta:null,invoiceRecords:[],customerLedger:null,salesAnalytics:null,invoiceForm:At(),invoiceSaving:!1,invoiceSavedDocNo:null,pickerMode:null,pickerQuery:"",pickerTargetLine:null,invoiceErrors:{},deliveryNote:null,deliverySearchDocNo:"",billingSummary:null,billingYearMonth:qs,salesReport:null,jikomiList:[],jikomiView:"list",tankList:[],kenteiList:[],materialList:[],purchaseList:[],payableList:[],billList:[],rawStockList:[],taxDeclaration:null,taxYear:Ms,taxMonth:Is,storeSales:[],storeOrders:[],storeTab:"pos",importEntity:"customers",importPreview:null,importing:!1,importResult:null,printTemplate:"chain_store",printOptions:{...gs,overlayImageUrl:`${"/sake-system/".replace(/\/$/,"")}/reference/chainstore_ref.png`},printCompany:{...fs},printData:{documentNo:"D"+new Date().toISOString().slice(0,10).replaceAll("-",""),documentDate:new Date().toISOString().slice(0,10),orderDate:new Date().toISOString().slice(0,10),deliveryDate:new Date(Date.now()+2*864e5).toISOString().slice(0,10),customerName:"株式会社〇〇商事",customerHonorific:"御中",customerPostalCode:"100-0001",customerAddress:"東京都千代田区〇〇1-2-3",customerCode:"C0001",chainStoreCode:"0123",categoryCode:"21",slipTypeCode:"11",orderNo:"PO-"+new Date().toISOString().slice(5,10).replaceAll("-",""),vendorCode:"V0001",departmentCode:"101",settlementPrint:!1,title:"",remarks:"",lines:[{productCode:"P00012",productName:"純米吟醸 金井の雫",spec:"720ml",quantity:12,unit:"本",unitPrice:1500,amount:18e3,retailPrice:2200,janCode:"4901234567891",caseQty:6},{productCode:"P00008",productName:"本醸造 辛口",spec:"1.8L",quantity:6,unit:"本",unitPrice:1800,amount:10800,retailPrice:2400,janCode:"4901234567908",caseQty:6},{productCode:"P00021",productName:"梅酒 熟成",spec:"500ml",quantity:12,unit:"本",unitPrice:1200,amount:14400,retailPrice:1800,janCode:"4901234567915",caseQty:12}],taxRate:.1,previousBalance:0,paymentAmount:0},storeSalesDate:Os,route:Xt,currentCategory:Lt(Xt),sidebarOpen:!1,salesFilter:{startDate:"",endDate:""},invoiceFilter:{documentNo:"",startDate:"",endDate:"",customerCode:""},ledgerCustomerCode:Fs,masterTab:"customers",analyticsTab:"products",emailAudienceMode:j.mode,emailRegion:j.region,emailHistorySegment:j.historySegment,emailTemplateId:j.templateId,emailSubject:j.subject,emailBody:j.body,emailSaveMessage:j.saveMessage,emailSending:!1,globalSearchOpen:!1,globalQuery:"",authSkipped:!1,authSubmitting:!1,authError:null,user:null,loading:!0,actionLoading:!1,error:null};function Zt(t){return t.slice(0,10)}function Js(t){return{...t}}function ct(){a.pickerMode=null,a.pickerQuery="",a.pickerTargetLine=null}function qe(){a.invoiceForm=At(),a.invoiceSavedDocNo=null,a.invoiceErrors={},ct()}function Me(t){const e={};return t.invoiceDate.trim()||(e.invoiceDate="伝票日付は必須です。"),t.customerCode.trim()||(e.customerCode="得意先コードは必須です。"),t.lines.length===0&&(e.lines="明細を1行以上入力してください。"),t.lines.forEach((n,s)=>{n.productCode.trim()||(e[`lines.${s}.productCode`]="商品コードは必須です。"),n.productName.trim()||(e[`lines.${s}.productName`]="商品名は必須です。"),n.quantity<=0&&(e[`lines.${s}.quantity`]="数量は1以上を入力してください。"),n.unitPrice<0&&(e[`lines.${s}.unitPrice`]="単価は0円以上で入力してください。")}),e}function Vs(t){const e=a.invoiceForm.lines[t];e&&a.invoiceForm.lines.splice(t+1,0,Js(e))}function Bs(){const t=a.invoiceRecords[0],e=a.masterStats?.customers[0],n=a.masterStats?.products.slice(0,2)??[];a.invoiceForm={invoiceType:"sales",invoiceDate:new Date().toISOString().slice(0,10),customerCode:t?.customerCode??e?.code??"",customerName:t?.customerName??e?.name??"",staffCode:a.invoiceForm.staffCode||"S001",lines:n.map((s,l)=>{const i=l===0?1:2,d=1200*(l+1);return{productCode:s.code,productName:s.name,quantity:i,unitPrice:d,unit:"本",amount:i*d}}),note:t?`過去伝票 ${t.documentNo} をもとに複製`:"直近のサンプル伝票をもとに複製"},a.invoiceSavedDocNo=null,a.invoiceErrors={}}function Us(t){const e=a.masterStats?.customers.find(n=>n.code.toLowerCase()===t.trim().toLowerCase());return e?(a.invoiceForm.customerCode=e.code,a.invoiceForm.customerName=e.name,!0):!1}function Hs(t){const e=a.masterStats?.customers.find(n=>n.name===t.trim());return e?(a.invoiceForm.customerCode=e.code,a.invoiceForm.customerName=e.name,!0):!1}function Ie(t){if(C(t),a.invoiceErrors=Me(a.invoiceForm),Object.keys(a.invoiceErrors).length>0){m();return}a.invoiceSaving=!0,m(),he(a.invoiceForm).then(e=>{a.invoiceSavedDocNo=e.documentNo,a.invoiceSaving=!1,a.invoiceErrors={},a.invoiceForm=At(),m()}).catch(()=>{a.invoiceSaving=!1,m()})}function Oe(t){const e=a.salesFilter.startDate?new Date(a.salesFilter.startDate):null,n=a.salesFilter.endDate?new Date(`${a.salesFilter.endDate}T23:59:59`):null;return[...t.salesRecords].sort((s,l)=>new Date(l.date).getTime()-new Date(s.date).getTime()).filter(s=>{const l=new Date(s.date);return!(e&&l<e||n&&l>n)})}function Fe(){switch(a.emailAudienceMode){case"area":return a.emailRegion==="all"?st:st.filter(t=>t.area===a.emailRegion);case"history":return st.filter(t=>t.historySegment===a.emailHistorySegment);default:return st}}function Ys(){const t=Fe();return{audienceMode:a.emailAudienceMode,region:a.emailRegion,historySegment:a.emailHistorySegment,selectedTemplateId:a.emailTemplateId,subject:a.emailSubject,body:a.emailBody,recipientCount:t.length,previewRecipients:t.slice(0,5),saveMessage:a.emailSaveMessage,sending:a.emailSending}}function ht(t){const e=Fe(),n=a.emailAudienceMode==="area"?a.emailRegion:a.emailAudienceMode==="history"?a.emailHistorySegment:"all";return{subject:a.emailSubject.trim(),body:a.emailBody.trim(),templateId:a.emailTemplateId,audienceMode:a.emailAudienceMode,audienceFilter:n,recipientCount:e.length,recipients:e.map(s=>s.email),status:t}}function Pt(){return a.user,!1}function K(){a.globalSearchOpen=!1,a.globalQuery=""}function Ks(){const t=a.globalQuery.trim().toLowerCase();return t?{customers:a.masterStats?.customers.filter(e=>e.code.toLowerCase().includes(t)||e.name.toLowerCase().includes(t))??[],products:a.masterStats?.products.filter(e=>e.code.toLowerCase().includes(t)||e.name.toLowerCase().includes(t))??[],documents:a.invoiceRecords.filter(e=>e.documentNo.toLowerCase().includes(t)||e.customerName.toLowerCase().includes(t)||e.date.toLowerCase().includes(t)),pages:Gt.filter(e=>e.path.toLowerCase().includes(t)||e.title.toLowerCase().includes(t))}:{customers:[],products:[],documents:[],pages:Gt}}function zs(){let t=[],e,n="export.csv";switch(a.route){case"/sales":t=(a.salesSummary?Oe(a.salesSummary):[]).map(s=>({documentNo:s.documentNo,date:s.date,customerCode:s.customerCode,customerName:s.customerName,amount:s.amount})),e=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"amount",label:"金額"}],n="sales.csv";break;case"/payment":t=[...a.paymentStatus?.records??[]].sort((s,l)=>l.balanceAmount-s.balanceAmount).map(s=>({...s})),e=[{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"billedAmount",label:"請求額"},{key:"paymentAmount",label:"入金額"},{key:"balanceAmount",label:"請求残"},{key:"lastPaymentDate",label:"最終入金日"},{key:"status",label:"状態"}],n="payment-status.csv";break;case"/invoice":t=a.invoiceRecords.map(s=>({...s})),e=[{key:"documentNo",label:"伝票番号"},{key:"date",label:"日付"},{key:"customerCode",label:"得意先コード"},{key:"customerName",label:"得意先名"},{key:"itemCount",label:"明細数"},{key:"amount",label:"金額"}],n="invoices.csv";break;case"/purchase":t=a.purchaseList.map(s=>({...s})),e=[{key:"documentNo",label:"伝票番号"},{key:"purchaseDate",label:"仕入日"},{key:"supplierCode",label:"仕入先コード"},{key:"supplierName",label:"仕入先名"},{key:"itemName",label:"品目"},{key:"quantity",label:"数量"},{key:"unitPrice",label:"単価"},{key:"amount",label:"金額"},{key:"status",label:"状態"}],n="purchase.csv";break;case"/jikomi":t=a.jikomiList.map(s=>({...s})),e=[{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"riceType",label:"原料米"},{key:"plannedKg",label:"計画量"},{key:"actualKg",label:"実績量"},{key:"startDate",label:"開始日"},{key:"expectedDoneDate",label:"完了予定日"},{key:"tankNo",label:"タンク"},{key:"status",label:"状態"},{key:"note",label:"備考"}],n="jikomi.csv";break;case"/tanks":t=a.tankList.map(s=>({...s})),e=[{key:"tankNo",label:"タンクNo."},{key:"capacity",label:"容量"},{key:"currentVolume",label:"現在量"},{key:"productName",label:"銘柄"},{key:"jikomiNo",label:"仕込番号"},{key:"status",label:"状態"},{key:"lastUpdated",label:"更新日"}],n="tanks.csv";break;case"/kentei":t=a.kenteiList.map(s=>({...s})),e=[{key:"kenteiNo",label:"検定番号"},{key:"jikomiNo",label:"仕込番号"},{key:"productName",label:"銘柄"},{key:"kenteiDate",label:"検定日"},{key:"alcoholDegree",label:"アルコール度数"},{key:"extractDegree",label:"エキス分"},{key:"sakaMeterValue",label:"酒度"},{key:"volume",label:"容量"},{key:"taxCategory",label:"酒類区分"},{key:"status",label:"状態"}],n="kentei.csv";break;case"/materials":t=a.materialList.map(s=>({...s})),e=[{key:"code",label:"コード"},{key:"name",label:"品名"},{key:"unit",label:"単位"},{key:"currentStock",label:"現在庫"},{key:"minimumStock",label:"最低在庫"},{key:"unitCost",label:"単価"},{key:"lastUpdated",label:"更新日"}],n="materials.csv";break;case"/master":a.masterTab==="customers"?(t=a.masterStats?.customers.map(s=>({...s}))??[],e=[{key:"code",label:"得意先コード"},{key:"name",label:"得意先名"},{key:"closingDay",label:"締日"},{key:"paymentDay",label:"入金日"},{key:"isActive",label:"有効"}],n="master-customers.csv"):(t=a.masterStats?.products.map(s=>({...s}))??[],e=[{key:"code",label:"商品コード"},{key:"janCode",label:"JAN"},{key:"name",label:"商品名"},{key:"category",label:"カテゴリ"},{key:"isActive",label:"有効"}],n="master-products.csv");break;default:return}Ts(n,t,e)}function te(t){const e=`${"/sake-system/".replace(/\/$/,"")}${t==="/"?"/":t}`;history.pushState(null,"",e),a.route=t,a.currentCategory=Lt(t),a.sidebarOpen=!1,K(),jt(t)}async function jt(t){a.actionLoading=!0,m();try{switch(t){case"/delivery":a.deliveryNote||(a.deliveryNote=await Ct(a.deliverySearchDocNo||"D240122"));break;case"/billing":a.billingSummary||(a.billingSummary=await Dt(a.billingYearMonth));break;case"/report":a.salesReport||(a.salesReport=await ve());break;case"/jikomi":a.jikomiList.length===0&&(a.jikomiList=await be());break;case"/tanks":a.tankList.length===0&&(a.tankList=await ge());break;case"/kentei":a.kenteiList.length===0&&(a.kenteiList=await fe());break;case"/materials":a.materialList.length===0&&(a.materialList=await $e());break;case"/purchase":(a.purchaseList.length===0||a.payableList.length===0)&&([a.purchaseList,a.payableList]=await Promise.all([ke(),Se()]));break;case"/raw-material":(a.billList.length===0||a.rawStockList.length===0)&&([a.billList,a.rawStockList]=await Promise.all([we(),xe()]));break;case"/tax":a.taxDeclaration||(a.taxDeclaration=await _t(a.taxYear,a.taxMonth));break;case"/store":(a.storeSales.length===0||a.storeOrders.length===0)&&([a.storeSales,a.storeOrders]=await Promise.all([Nt(a.storeSalesDate),_e()]));break;default:break}}catch(e){console.warn("Route data load error",e)}finally{a.actionLoading=!1,m()}}function ee(){if(Pt())return Ya(a.authError,a.authSubmitting);if(a.loading)return'<section class="panel"><p>データを読み込んでいます。</p></section>';if(a.error)return`
      <section class="panel error-card">
        <p class="eyebrow">読込失敗</p>
        <h1>画面の初期化に失敗しました</h1>
        <p>${a.error}</p>
      </section>
    `;switch(a.route){case"/cat/sales":return Q("sales");case"/cat/brewery":return Q("brewery");case"/cat/purchase":return Q("purchase");case"/cat/more":return Q("more");case"/invoice-entry":return Ra(a.invoiceForm,a.invoiceSavedDocNo,a.invoiceSaving,a.invoiceErrors);case"/email":return Pa(Ys());case"/delivery":return a.deliveryNote?Aa(a.deliveryNote,a.deliverySearchDocNo):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/billing":return a.billingSummary?fa(a.billingSummary,a.billingYearMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/report":return a.salesReport?us(a.salesReport):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/jikomi":return a.jikomiView==="calendar"?`${Ht(a.jikomiList,a.jikomiView)}${Ba(a.jikomiList)}`:Ht(a.jikomiList,a.jikomiView);case"/tanks":return Ps(a.tankList);case"/kentei":return Ua(a.kenteiList);case"/materials":return Wa(a.materialList);case"/purchase":return es(a.purchaseList,a.payableList);case"/raw-material":return as(a.billList,a.rawStockList);case"/tax":return a.taxDeclaration?js(a.taxDeclaration,a.taxYear,a.taxMonth):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/store":return vs(a.storeSales,a.storeOrders,a.storeTab,a.storeSalesDate);case"/setup":return a.pipelineMeta?ls(a.pipelineMeta,z,gt):'<section class="panel"><p>データを読み込んでいます…</p></section>';case"/import":return bs(a.importEntity,a.importPreview,a.importing,a.importResult);case"/print":return xs(a.printTemplate,a.printOptions,a.printCompany,a.printData)}if(!a.salesSummary||!a.paymentStatus||!a.masterStats||!a.pipelineMeta||!a.customerLedger||!a.salesAnalytics)return"";switch(a.route){case"/sales":return hs(Oe(a.salesSummary),a.salesFilter.startDate,a.salesFilter.endDate);case"/payment":return Za([...a.paymentStatus.records].sort((t,e)=>e.balanceAmount-t.balanceAmount));case"/master":return Qa(a.masterStats,a.masterTab);case"/invoice":return Ia(a.invoiceRecords,a.invoiceFilter);case"/ledger":return xa(a.customerLedger,a.ledgerCustomerCode);case"/analytics":return ds(a.salesAnalytics,a.analyticsTab);default:return _a(a.salesSummary,a.pipelineMeta,a.salesAnalytics)}}function Qs(){if(Pt())return`
      <div class="shell auth-shell">
        <main class="main auth-main">
          <div class="view">${ee()}</div>
        </main>
      </div>
    `;const t={dashboard:[{label:"概要",items:[{path:"/",label:"ダッシュボード",kicker:"Home"},{path:"/sales",label:"売上一覧",kicker:"Sales"},{path:"/payment",label:"入金状況",kicker:"Payment"}]}],sales:[{label:"販売管理",items:[{path:"/cat/sales",label:"販売管理トップ",kicker:"Category"},{path:"/invoice-entry",label:"伝票入力",kicker:"Entry"},{path:"/delivery",label:"納品書",kicker:"Delivery"},{path:"/billing",label:"月次請求",kicker:"Billing"},{path:"/report",label:"集計帳票",kicker:"Report"},{path:"/invoice",label:"伝票照会",kicker:"Invoice"},{path:"/ledger",label:"得意先台帳",kicker:"Ledger"}]}],brewery:[{label:"蔵内管理",items:[{path:"/cat/brewery",label:"蔵内管理トップ",kicker:"Category"},{path:"/jikomi",label:"仕込管理",kicker:"Jikomi"},{path:"/tanks",label:"タンク管理",kicker:"Tank"},{path:"/kentei",label:"検定管理",kicker:"Kentei"},{path:"/materials",label:"資材管理",kicker:"Material"}]}],purchase:[{label:"仕入管理",items:[{path:"/cat/purchase",label:"仕入管理トップ",kicker:"Category"},{path:"/purchase",label:"仕入・買掛",kicker:"Purchase"},{path:"/raw-material",label:"手形・原料",kicker:"RawMat"}]}],more:[{label:"その他",items:[{path:"/cat/more",label:"その他トップ",kicker:"Category"},{path:"/tax",label:"酒税申告",kicker:"Tax"},{path:"/store",label:"店舗・直売所",kicker:"Store"},{path:"/analytics",label:"売上分析",kicker:"Analytics"},{path:"/master",label:"マスタ",kicker:"Master"},{path:"/email",label:"メール配信",kicker:"Mail"},{path:"/setup",label:"連動設定",kicker:"Setup"}]}],email:[{label:"メール配信",items:[{path:"/email",label:"季節商品案内",kicker:"Mail"}]}]},e=[{category:"dashboard",path:"/",label:"ダッシュボード"},{category:"sales",path:"/cat/sales",label:"販売管理"},{category:"brewery",path:"/cat/brewery",label:"蔵内管理"},{category:"purchase",path:"/cat/purchase",label:"仕入管理"},{category:"more",path:"/cat/more",label:"その他"},{category:"email",path:"/email",label:"メール配信"}],n=t[a.currentCategory].map(o=>`
        <div class="nav-group">
      ...
      `).join(""),s=e.map(o=>`
        <a
          ...
          class="category-link ${a.currentCategory===o.category?"active":""}"
          data-link="${o.path}"
        >
          ${o.label}
        </a>
      `).join(""),l=a.pickerMode&&a.masterStats?a.pickerMode==="customer"?Ta(a.masterStats.customers,a.pickerQuery):ts(a.masterStats.products,a.pickerQuery):"",i=a.globalSearchOpen?ja(a.globalQuery,Ks()):"",d=a.user?`
    ...
    <div class="shell">
      ...
      <main class="main">
        ...
        <div class="view ${a.actionLoading?"is-busy":""}">${ee()}</div>
      </main>
      ${l}
      ${i}
    </div>
  `}async function Ws(t){a.actionLoading=!0,m();try{a.invoiceRecords=await ot(t)}finally{a.actionLoading=!1,m()}}async function Gs(t){a.actionLoading=!0,m();try{a.customerLedger=await xt(t)}finally{a.actionLoading=!1,m()}}function C(t){a.invoiceForm={invoiceType:t.querySelector("#inv-type")?.value??a.invoiceForm.invoiceType,invoiceDate:t.querySelector("#inv-date")?.value??a.invoiceForm.invoiceDate,customerCode:t.querySelector("#inv-customer-code")?.value??a.invoiceForm.customerCode,customerName:t.querySelector("#inv-customer-name")?.value??a.invoiceForm.customerName,staffCode:t.querySelector("#inv-staff")?.value??a.invoiceForm.staffCode,lines:a.invoiceForm.lines.map((e,n)=>{const s=parseFloat(t.querySelector(`[data-line="${n}"][data-field="quantity"]`)?.value??"")||0,l=parseFloat(t.querySelector(`[data-line="${n}"][data-field="unitPrice"]`)?.value??"")||0;return{...e,productCode:t.querySelector(`[data-line="${n}"][data-field="productCode"]`)?.value??e.productCode,productName:t.querySelector(`[data-line="${n}"][data-field="productName"]`)?.value??e.productName,unit:t.querySelector(`[data-line="${n}"][data-field="unit"]`)?.value??e.unit,quantity:s,unitPrice:l,amount:s*l}}),note:t.querySelector("#inv-note")?.value??a.invoiceForm.note},a.invoiceForm.customerCode=a.invoiceForm.customerCode.trim().toUpperCase(),a.invoiceForm.customerName=a.invoiceForm.customerName.trim()}function T(t){const e=t.querySelector("input[name='email-audience-mode']:checked")?.value??a.emailAudienceMode;a.emailAudienceMode=e,a.emailRegion=t.querySelector("#email-region")?.value??a.emailRegion,a.emailHistorySegment=t.querySelector("#email-history-segment")?.value??a.emailHistorySegment,a.emailSubject=t.querySelector("#email-subject")?.value??a.emailSubject,a.emailBody=t.querySelector("#email-body")?.value??a.emailBody}function Xs(t){t.querySelector("[data-action='global-search-open']")?.addEventListener("click",()=>{a.globalSearchOpen=!0,m()}),t.querySelectorAll("[data-action='global-search-close']").forEach(e=>{e.addEventListener("click",n=>{e.classList.contains("global-search")&&n.target instanceof HTMLElement&&!n.target.classList.contains("global-search")||(K(),m())})}),t.querySelector("#global-search-input")?.addEventListener("input",e=>{a.globalQuery=e.target.value,m()}),t.querySelectorAll("[data-action='global-nav']").forEach(e=>{e.addEventListener("click",()=>{const n=e.dataset.path;n&&(K(),te(n))})}),t.querySelector("[data-action='csv-export']")?.addEventListener("click",()=>{zs()}),t.querySelectorAll("[data-jikomi-tab]").forEach(e=>{e.addEventListener("click",()=>{a.jikomiView=e.dataset.jikomiTab,m()})}),t.querySelector("[data-action='auth-login']")?.addEventListener("click",()=>{const e=t.querySelector("#auth-email")?.value.trim()??"",n=t.querySelector("#auth-password")?.value??"";a.authSubmitting=!0,a.authError=null,m(),Ue(e,n).then(s=>{a.user=s,a.authSkipped=!1,a.authSubmitting=!1,a.authError=null,m()}).catch(async s=>{try{const l=await He(e,n);a.user=l,a.authSkipped=!1,a.authError=null}catch{a.authError=s instanceof Error?s.message:"ログインに失敗しました。"}finally{a.authSubmitting=!1,m()}})}),t.querySelector("[data-action='auth-skip']")?.addEventListener("click",()=>{a.authSkipped=!0,a.authError=null,m()}),t.querySelector("[data-action='auth-logout']")?.addEventListener("click",()=>{Ye().finally(()=>{location.reload()})}),t.querySelector("[data-action='sidebar-open']")?.addEventListener("click",()=>{a.sidebarOpen=!0,m()}),t.querySelectorAll("[data-action='sidebar-close']").forEach(e=>{e.addEventListener("click",()=>{a.sidebarOpen=!1,m()})}),t.querySelectorAll("[data-link]").forEach(e=>{e.addEventListener("click",n=>{n.preventDefault(),te(e.dataset.link)})}),t.querySelector("[data-action='sales-filter']")?.addEventListener("click",()=>{const e=t.querySelector("#sales-start")?.value??"",n=t.querySelector("#sales-end")?.value??"";a.salesFilter={startDate:e,endDate:n},m()}),t.querySelector("[data-action='invoice-filter']")?.addEventListener("click",()=>{const e={documentNo:t.querySelector("#invoice-document-no")?.value??"",startDate:t.querySelector("#invoice-start")?.value??"",endDate:t.querySelector("#invoice-end")?.value??"",customerCode:t.querySelector("#invoice-customer-code")?.value??""};a.invoiceFilter=e,Ws(e)}),t.querySelector("[data-action='ledger-search']")?.addEventListener("click",()=>{const e=t.querySelector("#ledger-customer-code")?.value??"";a.ledgerCustomerCode=e.trim().toUpperCase(),Gs(a.ledgerCustomerCode)}),t.querySelectorAll("[data-tab]").forEach(e=>{e.addEventListener("click",()=>{a.masterTab=e.dataset.tab,m()})}),t.querySelectorAll("[data-analytics-tab]").forEach(e=>{e.addEventListener("click",()=>{a.analyticsTab=e.dataset.analyticsTab,m()})}),t.querySelector("[data-action='add-line']")?.addEventListener("click",()=>{C(t),a.invoiceForm.lines.push({productCode:"",productName:"",quantity:0,unitPrice:0,unit:"本",amount:0}),a.invoiceErrors={},m()}),t.querySelectorAll("[data-action='remove-line']").forEach(e=>{e.addEventListener("click",()=>{C(t);const n=parseInt(e.dataset.line??"0",10);a.invoiceForm.lines.splice(n,1),a.invoiceErrors=Me(a.invoiceForm),m()})}),t.querySelectorAll("[data-action='duplicate-line']").forEach(e=>{e.addEventListener("click",()=>{C(t),Vs(parseInt(e.dataset.line??"0",10)),a.invoiceErrors={},m()})}),t.querySelector("[data-action='copy-past-invoice']")?.addEventListener("click",()=>{Bs(),m()}),t.querySelector("[data-action='open-customer-picker']")?.addEventListener("click",()=>{C(t),a.pickerMode="customer",a.pickerTargetLine=null,a.pickerQuery=a.invoiceForm.customerCode||a.invoiceForm.customerName,m()}),t.querySelectorAll("[data-action='open-product-picker']").forEach(e=>{e.addEventListener("click",()=>{C(t);const n=parseInt(e.dataset.line??"0",10),s=a.invoiceForm.lines[n];a.pickerMode="product",a.pickerTargetLine=n,a.pickerQuery=s?s.productCode||s.productName:"",m()})}),t.querySelectorAll("[data-action='modal-close']").forEach(e=>{e.addEventListener("click",n=>{e.classList.contains("modal-backdrop")&&n.target instanceof HTMLElement&&!n.target.classList.contains("modal-backdrop")||(ct(),m())})}),t.querySelectorAll("[data-action='picker-select']").forEach(e=>{const n=()=>{const s=e.dataset.code??"",l=e.dataset.name??"";if(a.pickerMode==="customer")a.invoiceForm.customerCode=s,a.invoiceForm.customerName=l,delete a.invoiceErrors.customerCode;else if(a.pickerMode==="product"&&a.pickerTargetLine!==null){const i=a.invoiceForm.lines[a.pickerTargetLine];i&&(i.productCode=s,i.productName=l,i.amount=i.quantity*i.unitPrice,delete a.invoiceErrors[`lines.${a.pickerTargetLine}.productCode`],delete a.invoiceErrors[`lines.${a.pickerTargetLine}.productName`])}ct(),m()};e.addEventListener("click",n),e.addEventListener("keydown",s=>{s.key==="Enter"&&n()})}),t.querySelector("#modal-search")?.addEventListener("input",e=>{a.pickerQuery=e.target.value,m()}),t.querySelector("[data-action='invoice-clear']")?.addEventListener("click",()=>{qe(),m()}),t.querySelector("[data-action='invoice-save']")?.addEventListener("click",()=>{Ie(t)}),t.querySelector("#inv-customer-code")?.addEventListener("blur",()=>{C(t),Us(a.invoiceForm.customerCode)&&(delete a.invoiceErrors.customerCode,m())}),t.querySelector("#inv-customer-name")?.addEventListener("blur",()=>{C(t),Hs(a.invoiceForm.customerName)&&(delete a.invoiceErrors.customerCode,m())}),t.querySelectorAll("#inv-date, #inv-customer-code, #inv-customer-name, #inv-staff, #inv-note, [data-field], #inv-type").forEach(e=>{e.addEventListener("input",()=>{C(t),a.invoiceSavedDocNo=null})}),t.querySelector("#inv-type")?.addEventListener("change",()=>{C(t),a.invoiceSavedDocNo=null}),t.querySelector("[data-action='delivery-search']")?.addEventListener("click",()=>{const e=t.querySelector("#delivery-docno")?.value??"";a.deliverySearchDocNo=e.trim(),a.deliveryNote=null,a.actionLoading=!0,m(),Ct(a.deliverySearchDocNo||"D240122").then(n=>{a.deliveryNote=n,a.actionLoading=!1,m()})}),t.querySelector("[data-action='billing-load']")?.addEventListener("click",()=>{const e=t.querySelector("#billing-month")?.value??a.billingYearMonth;a.billingYearMonth=e,a.billingSummary=null,a.actionLoading=!0,m(),Dt(e).then(n=>{a.billingSummary=n,a.actionLoading=!1,m()})}),t.querySelector("[data-action='tax-load']")?.addEventListener("click",()=>{const e=parseInt(t.querySelector("#tax-year")?.value??String(a.taxYear),10),n=parseInt(t.querySelector("#tax-month")?.value??String(a.taxMonth),10);a.taxYear=e,a.taxMonth=n,a.taxDeclaration=null,a.actionLoading=!0,m(),_t(e,n).then(s=>{a.taxDeclaration=s,a.actionLoading=!1,m()})}),t.querySelector("[data-action='tax-export-xml']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{generateTaxXML:e}=await N(async()=>{const{generateTaxXML:d}=await Promise.resolve().then(()=>R);return{generateTaxXML:d}},void 0),n=e(a.taxDeclaration),s=new Blob([n],{type:"application/xml;charset=utf-8"}),l=URL.createObjectURL(s),i=document.createElement("a");i.href=l,i.download=`tax-${a.taxYear}-${String(a.taxMonth).padStart(2,"0")}.xml`,i.click(),URL.revokeObjectURL(l)}),t.querySelector("[data-action='tax-export-csv']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{generateTaxCSV:e}=await N(async()=>{const{generateTaxCSV:d}=await Promise.resolve().then(()=>R);return{generateTaxCSV:d}},void 0),n=e(a.taxDeclaration),s=new Blob([n],{type:"text/csv;charset=utf-8"}),l=URL.createObjectURL(s),i=document.createElement("a");i.href=l,i.download=`tax-${a.taxYear}-${String(a.taxMonth).padStart(2,"0")}.csv`,i.click(),URL.revokeObjectURL(l)}),t.querySelector("[data-action='tax-save-draft']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{saveTaxDeclaration:e}=await N(async()=>{const{saveTaxDeclaration:n}=await Promise.resolve().then(()=>R);return{saveTaxDeclaration:n}},void 0);try{await e(a.taxDeclaration),alert("下書き保存しました（Supabase tax_declarationsに保存）")}catch(n){alert("保存に失敗: "+(n instanceof Error?n.message:String(n)))}}),t.querySelectorAll("[data-tax-row][data-tax-field]").forEach(e=>{e.addEventListener("change",async()=>{if(!a.taxDeclaration)return;const n=Number(e.dataset.taxRow),s=e.dataset.taxField,l=e.type==="number"?Number(e.value)||0:e.value,i=[...a.taxDeclaration.rows];i[n]={...i[n],[s]:l};const{recalculateTaxDeclaration:d}=await N(async()=>{const{recalculateTaxDeclaration:o}=await Promise.resolve().then(()=>R);return{recalculateTaxDeclaration:o}},void 0);a.taxDeclaration=d({...a.taxDeclaration,rows:i}),m()})}),t.querySelectorAll("[data-ded-row][data-ded-field]").forEach(e=>{e.addEventListener("change",()=>{if(!a.taxDeclaration)return;const n=Number(e.dataset.dedRow),s=e.dataset.dedField,l=e.type==="number"?Number(e.value)||0:e.value,i=[...a.taxDeclaration.deductions];i[n]={...i[n],[s]:l},a.taxDeclaration={...a.taxDeclaration,deductions:i},m()})}),t.querySelectorAll("input[data-tax-field]:not([data-tax-row])").forEach(e=>{e.addEventListener("change",()=>{if(!a.taxDeclaration)return;const n=e.dataset.taxField;a.taxDeclaration={...a.taxDeclaration,[n]:e.value}})}),t.querySelector("[data-action='tax-add-category']")?.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const{recalculateTaxDeclaration:e,TAX_RATE_CATEGORIES:n}=await N(async()=>{const{recalculateTaxDeclaration:i,TAX_RATE_CATEGORIES:d}=await Promise.resolve().then(()=>R);return{recalculateTaxDeclaration:i,TAX_RATE_CATEGORIES:d}},void 0),s=n[0],l={taxCategory:s.code,taxCategoryName:s.name,alcoholDegree:15,productionVolume:0,previousBalance:0,currentAdjustment:0,exportDeduction:0,sampleDeduction:0,taxableVolume:0,volume:0,taxRate:s.taxRatePerLiter,taxAmount:0};a.taxDeclaration=e({...a.taxDeclaration,rows:[...a.taxDeclaration.rows,l]}),m()}),t.querySelectorAll("[data-action='tax-remove-category']").forEach(e=>{e.addEventListener("click",async()=>{if(!a.taxDeclaration)return;const n=Number(e.dataset.taxRow),{recalculateTaxDeclaration:s}=await N(async()=>{const{recalculateTaxDeclaration:i}=await Promise.resolve().then(()=>R);return{recalculateTaxDeclaration:i}},void 0),l=a.taxDeclaration.rows.filter((i,d)=>d!==n);a.taxDeclaration=s({...a.taxDeclaration,rows:l}),m()})}),t.querySelector("[data-action='tax-add-deduction']")?.addEventListener("click",()=>{if(!a.taxDeclaration)return;const e={type:"export",categoryCode:"01",volume:0,reason:"",documentNo:""};a.taxDeclaration={...a.taxDeclaration,deductions:[...a.taxDeclaration.deductions,e]},m()}),t.querySelectorAll("[data-action='tax-remove-deduction']").forEach(e=>{e.addEventListener("click",()=>{if(!a.taxDeclaration)return;const n=Number(e.dataset.dedRow),s=a.taxDeclaration.deductions.filter((l,i)=>i!==n);a.taxDeclaration={...a.taxDeclaration,deductions:s},m()})}),t.querySelectorAll("[data-store-tab]").forEach(e=>{e.addEventListener("click",()=>{a.storeTab=e.dataset.storeTab,m()})}),t.querySelectorAll("[data-import-entity]").forEach(e=>{e.addEventListener("click",()=>{a.importEntity=e.dataset.importEntity,a.importPreview=null,a.importResult=null,m()})}),t.querySelector("[data-action='download-template']")?.addEventListener("click",()=>{const e=As(a.importEntity),n=new Blob([e],{type:"text/csv;charset=utf-8"}),s=URL.createObjectURL(n),l=document.createElement("a");l.href=s,l.download=`template_${a.importEntity}.csv`,l.click(),URL.revokeObjectURL(s)}),t.querySelector("[data-action='import-parse']")?.addEventListener("click",()=>{const n=t.querySelector("#import-file")?.files?.[0];if(!n){alert("CSVファイルを選択してください");return}const s=new FileReader;s.onload=()=>{const l=String(s.result??""),{columns:i,rows:d}=_s(l);a.importPreview=Ns(a.importEntity,i,d),a.importResult=null,m()},s.readAsText(n,"utf-8")}),t.querySelector("[data-action='import-cancel']")?.addEventListener("click",()=>{a.importPreview=null,a.importResult=null,m()}),t.querySelectorAll("[data-print-template]").forEach(e=>{e.addEventListener("click",()=>{a.printTemplate=e.dataset.printTemplate,m()})}),t.querySelectorAll("[data-print-field]").forEach(e=>{e.addEventListener("change",()=>{const n=e.dataset.printField;let s=e.value;(n==="taxRate"||n==="previousBalance"||n==="paymentAmount")&&(s=Number(e.value)||0),a.printData={...a.printData,[n]:s},m()})}),t.querySelectorAll("[data-print-opt]").forEach(e=>{const n=()=>{const s=e.dataset.printOpt;let l;e.type==="checkbox"?l=e.checked:s==="copies"?l=Number(e.value)||1:s==="overlayOpacity"?l=Number(e.value)||0:l=e.value,a.printOptions={...a.printOptions,[s]:l},m()};e.addEventListener("change",n),e.type==="range"&&e.addEventListener("input",n)}),t.querySelectorAll("[data-print-line][data-print-lfield]").forEach(e=>{e.addEventListener("change",()=>{const n=Number(e.dataset.printLine),s=e.dataset.printLfield,l=[...a.printData.lines];let i=e.value;(s==="quantity"||s==="unitPrice")&&(i=Number(e.value)||0),l[n]={...l[n],[s]:i},l[n].amount=(Number(l[n].quantity)||0)*(Number(l[n].unitPrice)||0),a.printData={...a.printData,lines:l},m()})}),t.querySelector("[data-action='print-add-line']")?.addEventListener("click",()=>{a.printData={...a.printData,lines:[...a.printData.lines,{productCode:"",productName:"",spec:"",quantity:0,unit:"本",unitPrice:0,amount:0}]},m()}),t.querySelectorAll("[data-action='print-remove-line']").forEach(e=>{e.addEventListener("click",()=>{const n=Number(e.dataset.printLine);a.printData={...a.printData,lines:a.printData.lines.filter((s,l)=>l!==n)},m()})}),t.querySelector("[data-action='print-save-settings']")?.addEventListener("click",()=>{try{localStorage.setItem("sake_print_options",JSON.stringify(a.printOptions)),localStorage.setItem("sake_print_company",JSON.stringify(a.printCompany)),alert("印刷設定を保存しました（次回以降も使えます）")}catch(e){alert("保存失敗: "+(e instanceof Error?e.message:String(e)))}}),t.querySelector("[data-action='print-open-company']")?.addEventListener("click",()=>{const e=a.printCompany,n=prompt("会社名",e.name);if(n===null)return;const s=prompt("郵便番号",e.postalCode)??e.postalCode,l=prompt("住所",e.address1)??e.address1,i=prompt("TEL",e.tel)??e.tel,d=prompt("FAX",e.fax)??e.fax,o=prompt("適格請求書登録番号 (T+13桁)",e.registrationNo)??e.registrationNo,c=prompt("取引銀行名",e.bankName)??e.bankName,r=prompt("支店名",e.bankBranch)??e.bankBranch,u=prompt("口座番号",e.bankAccountNo)??e.bankAccountNo,p=prompt("口座名義",e.bankAccountHolder)??e.bankAccountHolder;a.printCompany={...e,name:n,postalCode:s,address1:l,tel:i,fax:d,registrationNo:o,bankName:c,bankBranch:r,bankAccountNo:u,bankAccountHolder:p},m()}),t.querySelector("[data-action='import-execute']")?.addEventListener("click",async()=>{if(a.importPreview){a.importing=!0,m();try{const e=a.importPreview.rows.filter(s=>s._valid),n=await Ls(a.importEntity,e);a.importResult=`取り込み完了: ${n.inserted}件成功 / ${n.failed}件失敗`,a.importPreview=null}catch(e){a.importResult=`エラー: ${e instanceof Error?e.message:String(e)}`}finally{a.importing=!1,m()}}}),t.querySelector("[data-action='store-load']")?.addEventListener("click",()=>{const e=t.querySelector("#store-date")?.value??a.storeSalesDate;a.storeSalesDate=e,a.storeSales=[],a.actionLoading=!0,m(),Nt(e).then(n=>{a.storeSales=n,a.actionLoading=!1,m()})}),t.querySelectorAll("[data-action='copy-config']").forEach(e=>{e.addEventListener("click",async()=>{const n=e.dataset.configValue??"";if(n)try{await navigator.clipboard.writeText(n),e.textContent="コピー済み",window.setTimeout(()=>{e.textContent="コピー"},1600)}catch(s){console.warn("Clipboard copy failed",s)}})}),t.querySelector("[data-action='download-relay-config']")?.addEventListener("click",()=>{const n=JSON.stringify({supabase_url:z,supabase_anon_key:"（Supabaseダッシュボードから取得して貼り付け）",z_drive_path:"Z:\\",sync_modules:["sk","sh","k5","h5"],interval_minutes:5,use_odbc:!1,odbc_dsn:"MagicSake",log_level:"INFO"},null,2),s=new Blob([n],{type:"application/json;charset=utf-8"}),l=URL.createObjectURL(s),i=document.createElement("a");i.href=l,i.download="relay_config.json",i.click(),URL.revokeObjectURL(l)}),t.querySelectorAll("[data-action='copy-code']").forEach(e=>{e.addEventListener("click",async()=>{const n=e.dataset.code??"";if(n)try{await navigator.clipboard.writeText(decodeURIComponent(n)),e.textContent="コピー済み",window.setTimeout(()=>{e.textContent="コピー"},1600)}catch(s){console.warn("Clipboard code copy failed",s)}})}),t.querySelectorAll("input[name='email-audience-mode']").forEach(e=>{e.addEventListener("change",()=>{T(t),a.emailSaveMessage=null,m()})}),t.querySelectorAll("#email-region, #email-history-segment").forEach(e=>{e.addEventListener("change",()=>{T(t),a.emailSaveMessage=null,m()})}),t.querySelector("#email-subject")?.addEventListener("input",()=>{T(t),a.emailSaveMessage=null}),t.querySelector("#email-body")?.addEventListener("input",()=>{T(t),a.emailSaveMessage=null}),t.querySelectorAll("[data-action='template-select']").forEach(e=>{e.addEventListener("click",()=>{a.emailTemplateId=e.dataset.templateId??"custom";const n=Ee(a.emailTemplateId);a.emailSubject=n.subject,a.emailBody=n.body,a.emailSaveMessage=null,m()})}),t.querySelector("[data-action='email-insert-link']")?.addEventListener("click",()=>{T(t);const e=`

商品詳細はこちら: https://example.jp/products/seasonal`;a.emailBody.includes("https://example.jp/products/seasonal")||(a.emailBody=`${a.emailBody.trimEnd()}${e}`),a.emailSaveMessage=null,m()}),t.querySelector("[data-action='email-save']")?.addEventListener("click",()=>{T(t),a.actionLoading=!0,m(),nt(ht("draft")).then(e=>{a.emailSaveMessage=`下書きを保存しました。${new Intl.DateTimeFormat("ja-JP",{month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(e.updatedAt??new Date().toISOString()))}`,a.actionLoading=!1,m()})}),t.querySelector("[data-action='email-send']")?.addEventListener("click",()=>{T(t),a.actionLoading=!0,a.emailSending=!0,m();const e=ht("sent");Ne().then(async n=>{await nt({...e,recipientCount:n.sent}),a.emailSaveMessage=`${n.sent.toLocaleString("ja-JP")} 件送信しました。`,a.actionLoading=!1,a.emailSending=!1,m(),window.alert(`${n.sent}件送信完了`)}).catch(async()=>{await nt(ht("draft")),a.emailSaveMessage="APIキー未設定のため下書きを保存しました。",a.actionLoading=!1,a.emailSending=!1,m(),window.alert("APIキー未設定のため下書き保存しました")})})}function m(){const t=document.querySelector("#app");t&&(t.innerHTML=Qs(),Xs(t),a.pickerMode&&t.querySelector("#modal-search")?.focus(),a.globalSearchOpen&&t.querySelector("#global-search-input")?.focus(),Pt()&&t.querySelector("#auth-email")?.focus())}async function Zs(){a.loading=!0,m();try{const[t,e,n,s,l,i,d]=await Promise.all([re(),de(),ue(),pe(),ot(a.invoiceFilter),xt(a.ledgerCustomerCode),me()]);if(a.salesSummary=t,a.paymentStatus=e,a.masterStats=n,a.pipelineMeta=s,a.invoiceRecords=l,a.customerLedger=i,a.salesAnalytics=d,!a.salesFilter.startDate||!a.salesFilter.endDate){const c=[...t.salesRecords].sort((p,h)=>new Date(h.date).getTime()-new Date(p.date).getTime())[0]?.date??new Date().toISOString(),r=new Date(c),u=new Date(r);u.setDate(r.getDate()-30),a.salesFilter={startDate:Zt(u.toISOString()),endDate:Zt(r.toISOString())}}(!a.invoiceFilter.startDate||!a.invoiceFilter.endDate)&&(a.invoiceFilter={...a.invoiceFilter,startDate:a.salesFilter.startDate,endDate:a.salesFilter.endDate},a.invoiceRecords=await ot(a.invoiceFilter)),a.error=null}catch(t){a.error=t instanceof Error?t.message:"データの取得に失敗しました。"}finally{a.loading=!1,m(),jt(a.route)}}window.addEventListener("popstate",()=>{a.route=Re(location.pathname),a.currentCategory=Lt(a.route),a.sidebarOpen=!1,K(),jt(a.route)});window.addEventListener("keydown",t=>{if((t.ctrlKey||t.metaKey)&&t.key.toLowerCase()==="k"){t.preventDefault(),a.globalSearchOpen=!0,m();return}if(t.key==="Escape"){if(a.globalSearchOpen){K(),m();return}if(a.pickerMode){ct(),m();return}a.route==="/invoice-entry"&&!a.invoiceSaving&&(qe(),m());return}if(a.route==="/invoice-entry"&&!a.invoiceSaving&&(t.ctrlKey||t.metaKey)&&t.key.toLowerCase()==="s"){t.preventDefault();const e=document.querySelector("#app");e&&Ie(e)}});a.user=kt()?Ke():null;try{const t=localStorage.getItem("sake_print_options");t&&(a.printOptions={...a.printOptions,...JSON.parse(t)});const e=localStorage.getItem("sake_print_company");e&&(a.printCompany={...a.printCompany,...JSON.parse(e)})}catch{}Zs();
