  ...
  try {
    switch (route) {
      ...
      case "/brewing-plan": {
        ...
        const [summary, trend, schedule, products, customCats, overrides, stockEntries, typeLinks, availTypes, alcSettings, yearlyShipments, seasonal, forecastOvr] = await Promise.all([
