...
export async function down(db: Kysely<unknown>): Promise<void> {
  await sql`drop table if exists sales_document_lines`.execute(db)
  await sql`drop table if exists invoice_candidate_batches`.execute(db)
  await sql`drop table if exists customer_payment_status`.execute(db)
  await sql`drop table if exists daily_sales_fact`.execute(db)
  await sql`drop table if exists sales_staff`.execute(db)
  await sql`drop table if exists tax_codes`.execute(db)
  await sql`drop table if exists accounts_receivable_balances`.execute(db)
  await sql`drop table if exists payment_receipts`.execute(db)
  await sql`drop table if exists sales_document_headers`.execute(db)
  await sql`drop table if exists products`.execute(db)
  await sql`drop table if exists customers`.execute(db)
  await sql`drop table if exists raw_file_ingestions`.execute(db)
}
